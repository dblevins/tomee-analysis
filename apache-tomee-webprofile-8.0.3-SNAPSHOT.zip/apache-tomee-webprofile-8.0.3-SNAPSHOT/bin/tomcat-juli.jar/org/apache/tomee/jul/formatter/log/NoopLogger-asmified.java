...
public class NoopLoggerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/tomee/jul/formatter/log/NoopLogger", null, "java/lang/Object", new String[] { "org/apache/juli/logging/Log" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/tomee/jul/formatter/log/NoopLogger;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/tomee/jul/formatter/log/NoopLogger");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/jul/formatter/log/NoopLogger", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomee/jul/formatter/log/NoopLogger", "INSTANCE", "Lorg/apache/tomee/jul/formatter/log/NoopLogger;");
methodVisitor.visitInsn(RETURN);
