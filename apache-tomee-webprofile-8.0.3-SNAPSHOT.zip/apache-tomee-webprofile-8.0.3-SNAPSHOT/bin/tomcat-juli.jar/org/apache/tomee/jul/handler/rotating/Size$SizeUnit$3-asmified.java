...
public class Size$SizeUnit$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER | ACC_ENUM, "org/apache/tomee/jul/handler/rotating/Size$SizeUnit$3", null, "org/apache/tomee/jul/handler/rotating/Size$SizeUnit", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomee/jul/handler/rotating/Size$SizeUnit$3", "x", "(JJJ)J", false);
...
methodVisitor.visitVarInsn(LLOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomee/jul/handler/rotating/Size$SizeUnit", "toMegabytes", "(J)J", false);
methodVisitor.visitInsn(LRETURN);
