...
public class AsyncChannelWrapperSecure$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/websocket/AsyncChannelWrapperSecure$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/websocket/AsyncChannelWrapperSecure", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/net/ssl/SSLEngineResult$HandshakeStatus", "values", "()[Ljavax/net/ssl/SSLEngineResult$HandshakeStatus;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/websocket/AsyncChannelWrapperSecure$1", "$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus", "[I");
