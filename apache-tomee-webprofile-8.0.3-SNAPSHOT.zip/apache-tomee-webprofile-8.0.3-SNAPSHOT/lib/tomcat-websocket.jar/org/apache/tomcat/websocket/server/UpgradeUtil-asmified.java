...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isWebSocketUpgradeRequest", "(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/websocket/server/UpgradeUtil", "headerContainsToken", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Ljava/lang/String;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "javax/websocket/server/ServerEndpointConfig", "java/util/Map", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/websocket/server/UpgradeUtil", "getTokensFromHeader", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/util/List;", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/tomcat/websocket/Transformation", "getExtensionResponse", "()Ljavax/websocket/Extension;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/tomcat/websocket/Transformation", "getExtensionResponse", "()Ljavax/websocket/Extension;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/websocket/server/UpgradeUtil", "append", "(Ljava/lang/StringBuilder;Ljavax/websocket/Extension;)V", false);
methodVisitor.visitVarInsn(ALOAD, 15);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/server/WsHandshakeRequest", "<init>", "(Ljavax/servlet/http/HttpServletRequest;Ljava/util/Map;)V", false);
methodVisitor.visitVarInsn(ASTORE, 18);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/server/WsPerSessionServerEndpointConfig", "<init>", "(Ljavax/websocket/server/ServerEndpointConfig;)V", false);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 22, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "javax/websocket/server/ServerEndpointConfig", "java/util/Map", "java/lang/String", "java/lang/String", "java/lang/String", "java/util/List", "java/util/List", "java/util/Enumeration", "java/util/List", "java/util/List", "java/util/List", "java/util/List", "org/apache/tomcat/websocket/Transformation", "java/lang/StringBuilder", Opcodes.INTEGER, "org/apache/tomcat/websocket/server/WsHandshakeRequest", "org/apache/tomcat/websocket/WsHandshakeResponse", "org/apache/tomcat/websocket/server/WsPerSessionServerEndpointConfig", "javax/websocket/Endpoint"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createTransformations", "(Ljava/util/List;)Ljava/util/List;", "(Ljava/util/List<Ljavax/websocket/Extension;>;)Ljava/util/List<Lorg/apache/tomcat/websocket/Transformation;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "append", "(Ljava/lang/StringBuilder;Ljavax/websocket/Extension;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "headerContainsToken", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpServletRequest", "getHeaders", "(Ljava/lang/String;)Ljava/util/Enumeration;", true);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"javax/servlet/http/HttpServletRequest", "java/lang/String", "java/lang/String", "java/util/Enumeration", "java/lang/String", "[Ljava/lang/String;", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/servlet/http/HttpServletRequest", "java/lang/String", "java/lang/String", "java/util/Enumeration"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getTokensFromHeader", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/util/List;", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/util/List<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"javax/servlet/http/HttpServletRequest", "java/lang/String", "java/util/List", "java/util/Enumeration", "java/lang/String", "[Ljava/lang/String;", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 8);
methodVisitor.visitVarInsn(ILOAD, 7);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label3);
...
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/servlet/http/HttpServletRequest", "java/lang/String", "java/util/List", "java/util/Enumeration"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
