...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", null, "javax/servlet/jsp/tagext/TagLibraryValidator", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "permittedTaglibs", "Ljava/util/Set;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "permittedTaglibs", "Ljava/util/Set;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV$PermittedTaglibsHandler");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV$PermittedTaglibsHandler", "<init>", "(Ljavax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "parser", "Ljavax/servlet/jsp/jstl/tlv/PageParser;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV$PermittedTaglibsHandler", "access$000", "(Ljavax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV$PermittedTaglibsHandler;)[Ljavax/servlet/jsp/tagext/ValidationMessage;", false);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "vmFromString", "(Ljava/lang/String;)[Ljavax/servlet/jsp/tagext/ValidationMessage;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Ljavax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV;)Ljava/util/Set;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "permittedTaglibs", "Ljava/util/Set;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$200", "(Ljavax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV;Ljava/lang/String;)[Ljavax/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "vmFromString", "(Ljava/lang/String;)[Ljavax/servlet/jsp/tagext/ValidationMessage;", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/servlet/jsp/jstl/tlv/PermittedTaglibsTLV", "parser", "Ljavax/servlet/jsp/jstl/tlv/PageParser;");
methodVisitor.visitInsn(RETURN);
