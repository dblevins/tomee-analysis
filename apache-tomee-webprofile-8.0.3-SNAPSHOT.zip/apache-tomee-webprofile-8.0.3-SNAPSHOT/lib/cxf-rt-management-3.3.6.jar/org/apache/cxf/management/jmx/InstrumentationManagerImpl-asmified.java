...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "mbs", "Ljavax/management/MBeanServer;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "busMBeans", "Ljava/util/Set;", "Ljava/util/Set<Ljavax/management/ObjectName;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/bus/ManagedBus", "getObjectName", "()Ljavax/management/ObjectName;", false);
...
methodVisitor.visitTryCatchBlock(label6, label7, label8, "javax/management/JMException");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "bus", "Lorg/apache/cxf/Bus;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "mbs", "Ljavax/management/MBeanServer;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "mbs", "Ljavax/management/MBeanServer;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "mbs", "Ljavax/management/MBeanServer;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "getDelegateName", "()Ljavax/management/ObjectName;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "mbs", "Ljavax/management/MBeanServer;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/MBServerConnectorFactory", "setMBeanServer", "(Ljavax/management/MBeanServer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "mcf", "Lorg/apache/cxf/management/jmx/MBServerConnectorFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "register", "(Lorg/apache/cxf/management/ManagedComponent;)Ljavax/management/ObjectName;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "INFO", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getDelegateName", "()Ljavax/management/ObjectName;", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/management/MBeanServerDelegate;"));
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitTypeInsn(NEW, "javax/management/JMException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/management/JMException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/management/JMException", "initCause", "(Ljava/lang/Throwable;)Ljava/lang/Throwable;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "register", "(Ljava/lang/Object;Ljavax/management/ObjectName;)V", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "register", "(Ljava/lang/Object;Ljavax/management/ObjectName;Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "register", "(Ljava/lang/Object;Ljavax/management/ObjectName;Z)V", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "persist", "(Ljavax/management/ObjectName;)Ljavax/management/ObjectName;", false);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "registerMBeanWithServer", "(Ljava/lang/Object;Ljavax/management/ObjectName;Z)V", false);
methodVisitor.visitLabel(label1);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "register", "(Ljava/lang/Object;Ljavax/management/ObjectName;Ljavax/management/modelmbean/ModelMBeanInfo;Z)V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "register", "(Lorg/apache/cxf/management/ManagedComponent;)Ljavax/management/ObjectName;", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "register", "(Lorg/apache/cxf/management/ManagedComponent;Z)Ljavax/management/ObjectName;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "register", "(Lorg/apache/cxf/management/ManagedComponent;Z)Ljavax/management/ObjectName;", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/management/ManagedComponent", "getObjectName", "()Ljavax/management/ObjectName;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unregister", "(Lorg/apache/cxf/management/ManagedComponent;)V", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/management/ManagedComponent", "getObjectName", "()Ljavax/management/ObjectName;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "persist", "(Ljavax/management/ObjectName;)Ljavax/management/ObjectName;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "unregister", "(Ljavax/management/ObjectName;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unregister", "(Ljavax/management/ObjectName;)V", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "isEnabled", "()Z", false);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setServer", "(Ljavax/management/MBeanServer;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "mbs", "Ljavax/management/MBeanServer;");
...
Label label4 = new Label();
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label5, "javax/management/JMException");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "isEnabled", "()Z", false);
Label label6 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/management/jmx/InstrumentationManagerImpl", "[Ljava/lang/Object;", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/Object"}, 1, new Object[] {"javax/management/JMException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/management/jmx/InstrumentationManagerImpl", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "register", "(Ljava/lang/Object;Ljavax/management/ObjectName;Ljavax/management/modelmbean/ModelMBeanInfo;Z)V", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/management/jmx/InstrumentationManagerImpl", "java/lang/Object", "javax/management/ObjectName", "javax/management/modelmbean/ModelMBeanInfo", Opcodes.INTEGER, "javax/management/modelmbean/RequiredModelMBean"}, 1, new Object[] {"javax/management/modelmbean/InvalidTargetObjectTypeException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitTypeInsn(NEW, "javax/management/JMException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "registerMBeanWithServer", "(Ljava/lang/Object;Ljavax/management/ObjectName;Z)V", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/management/InstanceAlreadyExistsException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "persist", "(Ljavax/management/ObjectName;)Ljavax/management/ObjectName;", null, new String[] { "javax/management/JMException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
