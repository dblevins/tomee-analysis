...
public class RowSetNavigatorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/hsqldb/navigator/RowSetNavigator", null, "java/lang/Object", new String[] { "org/hsqldb/navigator/RangeIterator" });
...
{
fieldVisitor = classWriter.visitField(0, "mode", "I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "isIterator", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/navigator/RowSetNavigator", "currentPos", "I");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/navigator/RowSetNavigator", "id", "J");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "id", "J");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "add", "([Ljava/lang/Object;)V", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/navigator/RowSetNavigator", "session", "Lorg/hsqldb/SessionInterface;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "session", "Lorg/hsqldb/SessionInterface;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "currentPos", "I");
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitLdcInsn("RowSetNavigator");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "afterLast", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "size", "I");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "first", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "last", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "size", "I");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getRowNumber", "()I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "currentPos", "I");
methodVisitor.visitInsn(IRETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "relative", "(I)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "currentPos", "I");
methodVisitor.visitVarInsn(ILOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "previous", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_M1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isAfterLast", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "size", "I");
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/navigator/RowSetNavigator", "rangePosition", "I");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
