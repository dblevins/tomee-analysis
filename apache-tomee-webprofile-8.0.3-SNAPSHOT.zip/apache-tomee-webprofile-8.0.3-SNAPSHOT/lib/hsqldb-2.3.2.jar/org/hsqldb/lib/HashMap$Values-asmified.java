...
public class HashMap$ValuesDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER, "org/hsqldb/lib/HashMap$Values", null, "java/lang/Object", new String[] { "org/hsqldb/lib/Collection" });
...
classWriter.visitInnerClass("org/hsqldb/lib/HashMap$Values", "org/hsqldb/lib/HashMap", "Values", 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/HashMap$Values", "this$0", "Lorg/hsqldb/lib/HashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/HashMap$Values", "this$0", "Lorg/hsqldb/lib/HashMap;");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/HashMap$Values", "size", "()I", false);
