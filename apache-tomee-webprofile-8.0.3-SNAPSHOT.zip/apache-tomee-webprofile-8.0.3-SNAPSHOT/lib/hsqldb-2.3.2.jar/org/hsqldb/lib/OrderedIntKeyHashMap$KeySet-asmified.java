...
public class OrderedIntKeyHashMap$KeySetDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER, "org/hsqldb/lib/OrderedIntKeyHashMap$KeySet", null, "java/lang/Object", new String[] { "org/hsqldb/lib/Set" });
...
classWriter.visitInnerClass("org/hsqldb/lib/OrderedIntKeyHashMap$KeySet", "org/hsqldb/lib/OrderedIntKeyHashMap", "KeySet", 0);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/hsqldb/lib/OrderedIntKeyHashMap;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/hsqldb/lib/OrderedIntKeyHashMap;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/OrderedIntKeyHashMap$KeySet", "this$0", "Lorg/hsqldb/lib/OrderedIntKeyHashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/OrderedIntKeyHashMap$KeySet", "this$0", "Lorg/hsqldb/lib/OrderedIntKeyHashMap;");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/OrderedIntKeyHashMap$KeySet", "size", "()I", false);
