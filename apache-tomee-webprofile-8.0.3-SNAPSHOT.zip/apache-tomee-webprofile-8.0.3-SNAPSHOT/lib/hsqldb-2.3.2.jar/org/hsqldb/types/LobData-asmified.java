...
public class LobDataDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/hsqldb/types/LobData", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "isBinary", "()Z", null, null);
methodVisitor.visitEnd();
}
