...
public class BatchingConstraintUpdateManagerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/jdbc/kernel/BatchingConstraintUpdateManager", null, "org/apache/openjpa/jdbc/kernel/ConstraintUpdateManager", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/jdbc/kernel/ConstraintUpdateManager", "<init>", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/kernel/BatchingConstraintUpdateManager", "dict", "Lorg/apache/openjpa/jdbc/sql/DBDictionary;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/jdbc/kernel/ConstraintUpdateManager", "flush", "(Lorg/apache/openjpa/jdbc/sql/RowManager;Lorg/apache/openjpa/jdbc/kernel/PreparedStatementManager;Ljava/util/Collection;)Ljava/util/Collection;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openjpa/jdbc/kernel/BatchingConstraintUpdateManager", "org/apache/openjpa/jdbc/sql/RowManager", "org/apache/openjpa/jdbc/kernel/PreparedStatementManager", "java/util/Collection", "org/apache/openjpa/jdbc/kernel/BatchingPreparedStatementManagerImpl"}, 1, new Object[] {"java/sql/SQLException"});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/jdbc/kernel/BatchingConstraintUpdateManager", "addException", "(Ljava/util/Collection;Ljava/lang/Exception;)Ljava/util/Collection;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitJumpInsn(GOTO, label4);
