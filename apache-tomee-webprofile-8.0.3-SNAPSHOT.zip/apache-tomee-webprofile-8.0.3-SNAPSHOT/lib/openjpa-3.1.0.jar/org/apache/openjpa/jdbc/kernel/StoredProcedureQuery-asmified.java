...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", null, "org/apache/openjpa/kernel/AbstractStoreQuery", null);
...
{
fieldVisitor = classWriter.visitField(0, "_store", "Lorg/apache/openjpa/jdbc/kernel/JDBCStore;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "_proc", "Lorg/apache/openjpa/jdbc/sql/StoredProcedure;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_meta", "Lorg/apache/openjpa/meta/MultiQueryMetaData;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "_store", "Lorg/apache/openjpa/jdbc/kernel/JDBCStore;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProcedure", "()Lorg/apache/openjpa/jdbc/sql/StoredProcedure;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/openjpa/meta/MultiQueryMetaData");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "_meta", "Lorg/apache/openjpa/meta/MultiQueryMetaData;");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "_meta", "Lorg/apache/openjpa/meta/MultiQueryMetaData;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "_meta", "Lorg/apache/openjpa/meta/MultiQueryMetaData;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/meta/MultiQueryMetaData", "getComponents", "()Ljava/util/List;", false);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "org/apache/openjpa/meta/ClassMetaData", Opcodes.INTEGER, "java/util/List", "java/util/List", "java/util/List", "org/apache/openjpa/jdbc/meta/MappingRepository", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "ctx", "Lorg/apache/openjpa/kernel/QueryContext;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/meta/QueryMetaData", "getResultSetMappingName", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/openjpa/meta/QueryMetaData", "org/apache/openjpa/jdbc/meta/QueryResultMapping"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery$StoredProcedureQueryExecutor");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery$StoredProcedureQueryExecutor", "<init>", "(Lorg/apache/openjpa/jdbc/kernel/StoredProcedureQuery;Lorg/apache/openjpa/jdbc/kernel/StoredProcedureQuery;Ljava/util/List;Ljava/util/List;)V", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "()[Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "NO_PARAM", "[Ljava/lang/Object;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/jdbc/kernel/StoredProcedureQuery", "NO_PARAM", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 0);
methodVisitor.visitEnd();
}
