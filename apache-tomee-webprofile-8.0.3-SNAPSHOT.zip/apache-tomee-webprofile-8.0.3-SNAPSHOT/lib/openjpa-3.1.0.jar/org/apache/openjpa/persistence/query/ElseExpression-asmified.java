...
public class ElseExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/query/ElseExpression", null, "org/apache/openjpa/persistence/query/ExpressionImpl", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_caseClause", "Lorg/apache/openjpa/persistence/query/CaseExpressionImpl;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_elseClause", "Lorg/apache/openjpa/persistence/query/Expression;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openjpa/persistence/query/CaseExpressionImpl;Lorg/apache/openjpa/persistence/query/Expression;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/query/ElseExpression", "_caseClause", "Lorg/apache/openjpa/persistence/query/CaseExpressionImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/query/ElseExpression", "_elseClause", "Lorg/apache/openjpa/persistence/query/Expression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/ElseExpression", "_caseClause", "Lorg/apache/openjpa/persistence/query/CaseExpressionImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/ElseExpression", "_elseClause", "Lorg/apache/openjpa/persistence/query/Expression;");
