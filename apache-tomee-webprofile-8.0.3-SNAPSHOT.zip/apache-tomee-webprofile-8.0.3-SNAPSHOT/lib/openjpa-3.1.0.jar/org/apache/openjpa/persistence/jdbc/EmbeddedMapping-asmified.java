...
public class EmbeddedMappingDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/openjpa/persistence/jdbc/EmbeddedMapping", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "overrides", "()[Lorg/apache/openjpa/persistence/jdbc/MappingOverride;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
