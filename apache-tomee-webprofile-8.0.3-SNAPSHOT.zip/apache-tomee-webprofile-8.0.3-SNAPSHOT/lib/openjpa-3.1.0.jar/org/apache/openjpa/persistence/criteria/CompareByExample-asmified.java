...
{
methodVisitor = classWriter.visitMethod(ACC_VARARGS, "<init>", "(Ljavax/persistence/criteria/CriteriaBuilder;Ljavax/persistence/metamodel/ManagedType;Ljavax/persistence/criteria/Path;Ljava/lang/Object;Lorg/apache/openjpa/persistence/criteria/ComparisonStyle;[Ljavax/persistence/metamodel/Attribute;)V", "(Ljavax/persistence/criteria/CriteriaBuilder;Ljavax/persistence/metamodel/ManagedType<TT;>;Ljavax/persistence/criteria/Path<TT;>;TT;Lorg/apache/openjpa/persistence/criteria/ComparisonStyle;[Ljavax/persistence/metamodel/Attribute<**>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/criteria/CompareByExample", "extractOperator", "(Lorg/apache/openjpa/persistence/criteria/ComparisonStyle;)Ljavax/persistence/criteria/Predicate$BooleanOperator;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openjpa/persistence/criteria/CompareByExample", "javax/persistence/criteria/CriteriaBuilder", "javax/persistence/metamodel/ManagedType", "javax/persistence/criteria/Path", "java/lang/Object", "org/apache/openjpa/persistence/criteria/ComparisonStyle", "[Ljavax/persistence/metamodel/Attribute;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/metamodel/ManagedType", "getSingularAttributes", "()Ljava/util/Set;", true);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/CompareByExample", "extractValue", "(Ljava/lang/Object;Ljavax/persistence/metamodel/SingularAttribute;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/criteria/Path", "get", "(Ljavax/persistence/metamodel/SingularAttribute;)Ljavax/persistence/criteria/Path;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/criteria/Path", "isNull", "()Ljavax/persistence/criteria/Predicate;", true);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/CompareByExample", "add", "(Ljavax/persistence/criteria/Expression;)Lorg/apache/openjpa/persistence/criteria/PredicateImpl;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/persistence/criteria/Predicate"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/metamodel/SingularAttribute", "isAssociation", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/criteria/CriteriaBuilder", "upper", "(Ljavax/persistence/criteria/Expression;)Ljavax/persistence/criteria/Expression;", true);
methodVisitor.visitVarInsn(ALOAD, 11);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/openjpa/persistence/criteria/CompareByExample", "javax/persistence/criteria/CriteriaBuilder", "javax/persistence/metamodel/ManagedType", "javax/persistence/criteria/Path", "java/lang/Object", "org/apache/openjpa/persistence/criteria/ComparisonStyle", "[Ljavax/persistence/metamodel/Attribute;", "java/util/List", "java/util/Set"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(8, 14);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "extractValue", "(Ljava/lang/Object;Ljavax/persistence/metamodel/SingularAttribute;)Ljava/lang/Object;", "(TT;Ljavax/persistence/metamodel/SingularAttribute<-TT;*>;)Ljava/lang/Object;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "extractOperator", "(Lorg/apache/openjpa/persistence/criteria/ComparisonStyle;)Ljavax/persistence/criteria/Predicate$BooleanOperator;", "<T:Ljava/lang/Object;>(Lorg/apache/openjpa/persistence/criteria/ComparisonStyle;)Ljavax/persistence/criteria/Predicate$BooleanOperator;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/criteria/Predicate$BooleanOperator", "AND", "Ljavax/persistence/criteria/Predicate$BooleanOperator;");
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/persistence/criteria/Predicate$BooleanOperator"});
methodVisitor.visitInsn(ARETURN);
