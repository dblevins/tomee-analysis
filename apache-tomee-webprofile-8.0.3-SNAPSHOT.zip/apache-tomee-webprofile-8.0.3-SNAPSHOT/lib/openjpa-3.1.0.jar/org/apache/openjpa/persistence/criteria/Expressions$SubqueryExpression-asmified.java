...
public class Expressions$SubqueryExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<TX;>;", "org/apache/openjpa/persistence/criteria/ExpressionImpl", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/criteria/Subquery", "getJavaType", "()Ljava/lang/Class;", true);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", "e", "Lorg/apache/openjpa/persistence/criteria/SubqueryImpl;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", "e", "Lorg/apache/openjpa/persistence/criteria/SubqueryImpl;");
