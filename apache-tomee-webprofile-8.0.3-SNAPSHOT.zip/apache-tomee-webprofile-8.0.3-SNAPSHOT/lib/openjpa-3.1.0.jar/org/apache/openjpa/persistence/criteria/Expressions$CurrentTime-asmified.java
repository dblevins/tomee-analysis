...
public class Expressions$CurrentTimeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$CurrentTime", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<Ljava/sql/Time;>;", "org/apache/openjpa/persistence/criteria/ExpressionImpl", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/Expressions$CurrentTime", "getJavaType", "()Ljava/lang/Class;", false);
