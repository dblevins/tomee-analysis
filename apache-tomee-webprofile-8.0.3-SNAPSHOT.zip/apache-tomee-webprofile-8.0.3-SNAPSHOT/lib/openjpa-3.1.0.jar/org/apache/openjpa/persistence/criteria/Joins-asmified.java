...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "clone", "(Ljakarta/persistence/criteria/Join;)Ljakarta/persistence/criteria/Join;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/criteria/Joins", "makeJoin", "(Lorg/apache/openjpa/persistence/criteria/FromImpl;Lorg/apache/openjpa/persistence/meta/Members$Member;Ljakarta/persistence/criteria/JoinType;)Ljakarta/persistence/criteria/Join;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ISTORE, 7);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"jakarta/persistence/criteria/Join", "java/util/List", "java/util/List", "org/apache/openjpa/persistence/criteria/FromImpl", "org/apache/openjpa/persistence/meta/Members$Member", "jakarta/persistence/criteria/JoinType", "jakarta/persistence/criteria/Join", Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "makeJoin", "(Lorg/apache/openjpa/persistence/criteria/FromImpl;Lorg/apache/openjpa/persistence/meta/Members$Member;Ljakarta/persistence/criteria/JoinType;)Ljakarta/persistence/criteria/Join;", "(Lorg/apache/openjpa/persistence/criteria/FromImpl<**>;Lorg/apache/openjpa/persistence/meta/Members$Member;Ljakarta/persistence/criteria/JoinType;)Ljakarta/persistence/criteria/Join<**>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getMembers", "(Lorg/apache/openjpa/persistence/criteria/PathImpl;Ljava/util/List;Ljava/util/List;)Lorg/apache/openjpa/persistence/criteria/FromImpl;", "(Lorg/apache/openjpa/persistence/criteria/PathImpl;Ljava/util/List<Lorg/apache/openjpa/persistence/meta/Members$Member;>;Ljava/util/List<Ljakarta/persistence/criteria/JoinType;>;)Lorg/apache/openjpa/persistence/criteria/FromImpl;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/PathImpl", "getParentPath", "()Ljakarta/persistence/criteria/Path;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openjpa/persistence/criteria/PathImpl");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openjpa/persistence/criteria/PathImpl", "java/util/List", "java/util/List", "org/apache/openjpa/persistence/criteria/PathImpl", "org/apache/openjpa/persistence/meta/Members$Member", "jakarta/persistence/criteria/JoinType", "org/apache/openjpa/persistence/criteria/FromImpl"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/criteria/Joins", "getMembers", "(Lorg/apache/openjpa/persistence/criteria/PathImpl;Ljava/util/List;Ljava/util/List;)Lorg/apache/openjpa/persistence/criteria/FromImpl;", false);
