...
public class Expressions$LengthDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$Length", "Lorg/apache/openjpa/persistence/criteria/Expressions$UnaryFunctionalExpression<Ljava/lang/Integer;>;", "org/apache/openjpa/persistence/criteria/Expressions$UnaryFunctionalExpression", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$Length", "e", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
