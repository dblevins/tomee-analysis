...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/persistence/UniqueConstraint;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/jdbc/AnnotationPersistenceMappingSerializer", "newAnnotationBuilder", "(Ljava/lang/Class;)Lorg/apache/openjpa/persistence/AnnotationBuilder;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/jdbc/AnnotationPersistenceMappingSerializer", "getTemporal", "(Lorg/apache/openjpa/jdbc/meta/FieldMapping;)Ljavax/persistence/TemporalType;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
Label label10 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label10);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/jdbc/AnnotationPersistenceMappingSerializer", "getEnumType", "(Lorg/apache/openjpa/jdbc/meta/FieldMapping;)Ljavax/persistence/EnumType;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
Label label11 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label11);
