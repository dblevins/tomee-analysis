...
public class ReferenceHashSetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/lib/util/ReferenceHashSet", null, "java/lang/Object", new String[] { "java/util/Set", "java/io/Serializable" });

classWriter.visitInnerClass("org/apache/openjpa/lib/util/ReferenceHashSet$1", null, null, ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "DUMMY_VAL", "Ljava/lang/Object;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_set", "Ljava/util/Set;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/collections4/map/AbstractReferenceMap$ReferenceStrength;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/lib/util/ReferenceHashSet", "_set", "Ljava/util/Set;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openjpa/lib/util/ReferenceHashSet", "org/apache/commons/collections4/map/AbstractReferenceMap$ReferenceStrength"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/lib/util/ReferenceHashSet", "DUMMY_VAL", "Ljava/lang/Object;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/util/ReferenceHashSet", "_set", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/openjpa/lib/util/ReferenceHashSet");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openjpa/lib/util/ReferenceHashSet");
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/util/ReferenceHashSet", "_set", "Ljava/util/Set;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openjpa/lib/util/ReferenceHashSet$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/lib/util/ReferenceHashSet$1", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/lib/util/ReferenceHashSet", "DUMMY_VAL", "Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
