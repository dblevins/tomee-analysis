...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/lib/util/OrderedMap", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/Map<TK;TV;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "java/util/Map", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_del", "Ljava/util/LinkedHashMap;", "Ljava/util/LinkedHashMap<TK;TV;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/lib/util/OrderedMap", "_del", "Ljava/util/LinkedHashMap;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/util/OrderedMap", "_del", "Ljava/util/LinkedHashMap;");
