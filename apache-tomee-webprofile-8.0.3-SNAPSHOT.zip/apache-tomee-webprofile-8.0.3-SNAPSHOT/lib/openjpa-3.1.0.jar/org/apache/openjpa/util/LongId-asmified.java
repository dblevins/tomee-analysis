...
public class LongIdDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/openjpa/util/LongId", null, "org/apache/openjpa/util/OpenJPAId", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "key", "J", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {Opcodes.UNINITIALIZED_THIS, "java/lang/Class", "java/lang/String"}, 3, new Object[] {Opcodes.UNINITIALIZED_THIS, "java/lang/Class", Opcodes.LONG});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/util/LongId", "<init>", "(Ljava/lang/Class;J)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/util/LongId", "key", "J");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/util/LongId", "key", "J");
