...
public class TLoadedStateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/kernel/TLoadedState", null, "org/apache/openjpa/kernel/PCState", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/kernel/TLoadedState", "TRANSIENT", "Lorg/apache/openjpa/kernel/PCState;");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("Transient-Loaded");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
