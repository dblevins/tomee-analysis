...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/kernel/exps/Min", null, "org/apache/openjpa/kernel/exps/AggregateVal", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Comparable", Opcodes.TOP, "java/util/Iterator"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openjpa/kernel/exps/Min", "java/util/Collection", "java/lang/Class", "java/lang/Comparable", "java/lang/Comparable", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ASTORE, 3);
