...
public class AbstractStoreQueryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/kernel/AbstractStoreQuery", null, "java/lang/Object", new String[] { "org/apache/openjpa/kernel/StoreQuery" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "ctx", "Lorg/apache/openjpa/kernel/QueryContext;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/AbstractStoreQuery", "ctx", "Lorg/apache/openjpa/kernel/QueryContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/AbstractStoreQuery", "ctx", "Lorg/apache/openjpa/kernel/QueryContext;");
