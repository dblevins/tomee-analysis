...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/event/JMSRemoteCommitProvider", null, "org/apache/openjpa/event/AbstractRemoteCommitProvider", new String[] { "org/apache/openjpa/lib/conf/Configurable", "org/apache/openjpa/lib/conf/GenericConfigurable", "jakarta/jms/ExceptionListener" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_connection", "Ljakarta/jms/TopicConnection;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_session", "Ljakarta/jms/TopicSession;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_publisher", "Ljakarta/jms/TopicPublisher;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_publisher", "Ljakarta/jms/TopicPublisher;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/event/JMSRemoteCommitProvider", "createMessage", "(Lorg/apache/openjpa/event/RemoteCommitEvent;)Ljakarta/jms/Message;", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicConnection", "close", "()V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "log", "Lorg/apache/openjpa/lib/log/Log;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicConnectionFactory", "createTopicConnection", "()Ljakarta/jms/TopicConnection;", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_session", "Ljakarta/jms/TopicSession;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_session", "Ljakarta/jms/TopicSession;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_publisher", "Ljakarta/jms/TopicPublisher;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_session", "Ljakarta/jms/TopicSession;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/event/JMSRemoteCommitProvider", "getMessageListener", "()Ljakarta/jms/MessageListener;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicSubscriber", "setMessageListener", "(Ljakarta/jms/MessageListener;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicConnection", "start", "()V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_connection", "Ljakarta/jms/TopicConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicConnection", "setExceptionListener", "(Ljakarta/jms/ExceptionListener;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "log", "Lorg/apache/openjpa/lib/log/Log;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openjpa/lib/log/Log", "isInfoEnabled", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getMessageListener", "()Ljakarta/jms/MessageListener;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createMessage", "(Lorg/apache/openjpa/event/RemoteCommitEvent;)Ljakarta/jms/Message;", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/event/JMSRemoteCommitProvider", "_session", "Ljakarta/jms/TopicSession;");
methodVisitor.visitVarInsn(ALOAD, 1);
