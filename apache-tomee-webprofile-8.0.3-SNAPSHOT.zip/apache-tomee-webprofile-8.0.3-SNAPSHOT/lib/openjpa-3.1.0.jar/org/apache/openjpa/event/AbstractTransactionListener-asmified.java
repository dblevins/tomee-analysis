...
public class AbstractTransactionListenerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/event/AbstractTransactionListener", null, "java/lang/Object", new String[] { "org/apache/openjpa/event/TransactionListener" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "eventOccurred", "(Lorg/apache/openjpa/event/TransactionEvent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/event/AbstractTransactionListener", "eventOccurred", "(Lorg/apache/openjpa/event/TransactionEvent;)V", false);
methodVisitor.visitInsn(RETURN);
