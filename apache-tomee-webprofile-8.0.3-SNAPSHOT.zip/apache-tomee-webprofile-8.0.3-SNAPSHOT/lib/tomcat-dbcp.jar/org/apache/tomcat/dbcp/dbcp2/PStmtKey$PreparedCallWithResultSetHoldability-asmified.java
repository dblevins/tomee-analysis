...
public class PStmtKey$PreparedCallWithResultSetHoldabilityDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomcat/dbcp/dbcp2/PStmtKey$PreparedCallWithResultSetHoldability", null, "java/lang/Object", new String[] { "org/apache/tomcat/dbcp/dbcp2/PStmtKey$StatementBuilder" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/dbcp/dbcp2/PStmtKey$PreparedCallWithResultSetHoldability", "this$0", "Lorg/apache/tomcat/dbcp/dbcp2/PStmtKey;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/dbcp/dbcp2/PStmtKey$PreparedCallWithResultSetHoldability", "this$0", "Lorg/apache/tomcat/dbcp/dbcp2/PStmtKey;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/dbcp/dbcp2/PStmtKey$PreparedCallWithResultSetHoldability", "<init>", "(Lorg/apache/tomcat/dbcp/dbcp2/PStmtKey;)V", false);
methodVisitor.visitInsn(RETURN);
