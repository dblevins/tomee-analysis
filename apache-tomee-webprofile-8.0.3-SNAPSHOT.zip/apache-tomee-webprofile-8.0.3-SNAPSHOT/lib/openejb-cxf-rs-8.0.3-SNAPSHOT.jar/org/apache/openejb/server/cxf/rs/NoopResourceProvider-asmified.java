...
public class NoopResourceProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/server/cxf/rs/NoopResourceProvider", null, "java/lang/Object", new String[] { "org/apache/cxf/jaxrs/lifecycle/ResourceProvider" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/cxf/rs/NoopResourceProvider", "instance", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/cxf/rs/NoopResourceProvider", "clazz", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/cxf/rs/NoopResourceProvider", "instance", "Ljava/lang/Object;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/cxf/rs/NoopResourceProvider", "clazz", "Ljava/lang/Class;");
methodVisitor.visitInsn(ARETURN);
