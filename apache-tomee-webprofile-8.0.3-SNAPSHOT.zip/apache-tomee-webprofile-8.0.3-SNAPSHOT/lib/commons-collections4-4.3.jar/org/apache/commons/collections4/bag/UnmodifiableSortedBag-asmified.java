...
public class UnmodifiableSortedBagDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/bag/UnmodifiableSortedBag", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/bag/AbstractSortedBagDecorator<TE;>;Lorg/apache/commons/collections4/Unmodifiable;", "org/apache/commons/collections4/bag/AbstractSortedBagDecorator", new String[] { "org/apache/commons/collections4/Unmodifiable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-3190437252665717841L));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/bag/UnmodifiableSortedBag");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/bag/UnmodifiableSortedBag", "<init>", "(Lorg/apache/commons/collections4/SortedBag;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/commons/collections4/SortedBag;)V", "(Lorg/apache/commons/collections4/SortedBag<TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/bag/AbstractSortedBagDecorator", "<init>", "(Lorg/apache/commons/collections4/SortedBag;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bag/UnmodifiableSortedBag", "decorated", "()Lorg/apache/commons/collections4/SortedBag;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bag/UnmodifiableSortedBag", "setCollection", "(Ljava/util/Collection;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bag/UnmodifiableSortedBag", "decorated", "()Lorg/apache/commons/collections4/SortedBag;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/commons/collections4/SortedBag", "iterator", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bag/UnmodifiableSortedBag", "decorated", "()Lorg/apache/commons/collections4/SortedBag;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/commons/collections4/SortedBag", "uniqueSet", "()Ljava/util/Set;", true);
