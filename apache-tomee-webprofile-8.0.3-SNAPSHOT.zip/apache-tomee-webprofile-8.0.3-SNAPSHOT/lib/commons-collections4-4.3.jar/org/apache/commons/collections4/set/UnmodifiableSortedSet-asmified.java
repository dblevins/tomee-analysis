...
public class UnmodifiableSortedSetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/set/UnmodifiableSortedSet", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/set/AbstractSortedSetDecorator<TE;>;Lorg/apache/commons/collections4/Unmodifiable;", "org/apache/commons/collections4/set/AbstractSortedSetDecorator", new String[] { "org/apache/commons/collections4/Unmodifiable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-725356885467962424L));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/set/UnmodifiableSortedSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/set/UnmodifiableSortedSet", "<init>", "(Ljava/util/SortedSet;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljava/util/SortedSet;)V", "(Ljava/util/SortedSet<TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableSortedSet", "decorated", "()Ljava/util/SortedSet;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableSortedSet", "setCollection", "(Ljava/util/Collection;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
