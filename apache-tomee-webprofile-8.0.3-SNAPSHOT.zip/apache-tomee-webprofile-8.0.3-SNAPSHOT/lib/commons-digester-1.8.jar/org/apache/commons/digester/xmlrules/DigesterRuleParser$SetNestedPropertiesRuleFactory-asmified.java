...
public class DigesterRuleParser$SetNestedPropertiesRuleFactoryDump implements Opcodes {
...
classWriter.visit(V1_2, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/digester/xmlrules/DigesterRuleParser$SetNestedPropertiesRuleFactory", null, "org/apache/commons/digester/AbstractObjectCreationFactory", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/digester/xmlrules/DigesterRuleParser$SetNestedPropertiesRuleFactory", "this$0", "Lorg/apache/commons/digester/xmlrules/DigesterRuleParser;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("allow-unknown-child-elements");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/digester/SetNestedPropertiesRule", "setAllowUnknownChildElements", "(Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
