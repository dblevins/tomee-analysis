...
public class JndiRequestHandler$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openejb/server/ejbd/JndiRequestHandler$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openejb/server/ejbd/JndiRequestHandler", null, null);

classWriter.visitInnerClass("org/apache/openejb/server/ejbd/JndiRequestHandler$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$client$RequestMethodCode", "[I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$InterfaceType", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/server/ejbd/JndiRequestHandler$1", "$SwitchMap$org$apache$openejb$InterfaceType", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/server/ejbd/JndiRequestHandler$1", "$SwitchMap$org$apache$openejb$client$RequestMethodCode", "[I");
