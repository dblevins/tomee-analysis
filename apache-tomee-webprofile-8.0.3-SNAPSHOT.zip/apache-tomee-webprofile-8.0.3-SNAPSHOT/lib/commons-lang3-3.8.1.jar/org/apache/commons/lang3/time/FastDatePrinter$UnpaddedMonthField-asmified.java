...
public class FastDatePrinter$UnpaddedMonthFieldDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField", null, "java/lang/Object", new String[] { "org/apache/commons/lang3/time/FastDatePrinter$NumberRule" });
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField;", null, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField", "appendTo", "(Ljava/lang/Appendable;I)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField", "INSTANCE", "Lorg/apache/commons/lang3/time/FastDatePrinter$UnpaddedMonthField;");
methodVisitor.visitInsn(RETURN);
