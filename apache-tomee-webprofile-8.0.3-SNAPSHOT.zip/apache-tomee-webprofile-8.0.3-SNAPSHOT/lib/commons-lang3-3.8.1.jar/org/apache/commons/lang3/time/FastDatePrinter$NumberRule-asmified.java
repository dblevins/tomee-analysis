...
public class FastDatePrinter$NumberRuleDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_ABSTRACT | ACC_INTERFACE, "org/apache/commons/lang3/time/FastDatePrinter$NumberRule", null, "java/lang/Object", new String[] { "org/apache/commons/lang3/time/FastDatePrinter$Rule" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "appendTo", "(Ljava/lang/Appendable;I)V", null, new String[] { "java/io/IOException" });
