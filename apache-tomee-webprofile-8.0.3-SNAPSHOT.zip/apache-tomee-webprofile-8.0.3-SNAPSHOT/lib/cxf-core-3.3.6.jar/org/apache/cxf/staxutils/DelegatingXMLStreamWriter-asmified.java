...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/staxutils/DelegatingXMLStreamWriter", null, "java/lang/Object", new String[] { "javax/xml/stream/XMLStreamWriter" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "delegate", "Ljavax/xml/stream/XMLStreamWriter;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/staxutils/DelegatingXMLStreamWriter", "delegate", "Ljavax/xml/stream/XMLStreamWriter;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/staxutils/DelegatingXMLStreamWriter", "delegate", "Ljavax/xml/stream/XMLStreamWriter;");
