...
public class MultiKeyPasswordKeyManagerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", null, "java/lang/Object", new String[] { "javax/net/ssl/X509KeyManager" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "mKeyStore", "Ljava/security/KeyStore;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "mKeyAlias", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "mKeyPassword", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "mKeyStore", "Ljava/security/KeyStore;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "mKeyAlias", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "mKeyPassword", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "mKeyAlias", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "mKeyStore", "Ljava/security/KeyStore;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "java/lang/String", "[Ljava/security/cert/Certificate;"}, 1, new Object[] {"java/security/KeyStoreException"});
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/configuration/jsse/MultiKeyPasswordKeyManager", "mKeyPassword", "Ljava/lang/String;");
