...
public class RolePrefixSecurityContextImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/interceptor/security/RolePrefixSecurityContextImpl", null, "java/lang/Object", new String[] { "org/apache/cxf/security/LoginSecurityContext" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/interceptor/security/RolePrefixSecurityContextImpl", "p", "Ljava/security/Principal;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/interceptor/security/RolePrefixSecurityContextImpl", "roles", "Ljava/util/Set;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/interceptor/security/RolePrefixSecurityContextImpl", "isRole", "(Ljava/security/Principal;Ljava/lang/String;Ljava/lang/String;)Z", false);
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isRole", "(Ljava/security/Principal;Ljava/lang/String;Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("prefix");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
