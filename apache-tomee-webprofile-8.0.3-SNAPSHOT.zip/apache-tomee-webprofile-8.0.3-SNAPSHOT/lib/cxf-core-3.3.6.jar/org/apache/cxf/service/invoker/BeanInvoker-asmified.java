...
public class BeanInvokerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/service/invoker/BeanInvoker", null, "org/apache/cxf/service/invoker/AbstractInvoker", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/service/invoker/BeanInvoker", "proxy", "Ljava/lang/Object;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/service/invoker/BeanInvoker", "proxy", "Ljava/lang/Object;");
