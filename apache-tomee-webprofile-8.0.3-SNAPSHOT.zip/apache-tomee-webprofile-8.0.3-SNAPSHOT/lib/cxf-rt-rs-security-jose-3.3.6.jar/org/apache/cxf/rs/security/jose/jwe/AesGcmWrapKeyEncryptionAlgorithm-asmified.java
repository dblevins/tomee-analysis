...
public class AesGcmWrapKeyEncryptionAlgorithmDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jwe/AesGcmWrapKeyEncryptionAlgorithm", null, "org/apache/cxf/rs/security/jose/jwe/AbstractWrapKeyEncryptionAlgorithm", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "SUPPORTED_ALGORITHMS", "Ljava/util/Set;", "Ljava/util/Set<Ljava/lang/String;>;", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jwe/AesGcmWrapKeyEncryptionAlgorithm", "<init>", "([BLorg/apache/cxf/rs/security/jose/jwa/KeyAlgorithm;)V", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/rs/security/jose/jwe/AesGcmWrapKeyEncryptionAlgorithm", "SUPPORTED_ALGORITHMS", "Ljava/util/Set;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jwe/AbstractWrapKeyEncryptionAlgorithm", "getEncryptedContentEncryptionKey", "(Lorg/apache/cxf/rs/security/jose/jwe/JweHeaders;[B)[B", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/rs/security/jose/jwe/AesGcmWrapKeyEncryptionAlgorithm", "SUPPORTED_ALGORITHMS", "Ljava/util/Set;");
methodVisitor.visitInsn(RETURN);
