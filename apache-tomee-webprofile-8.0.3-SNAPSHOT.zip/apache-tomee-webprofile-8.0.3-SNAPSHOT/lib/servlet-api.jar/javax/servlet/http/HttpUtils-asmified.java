...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "javax/servlet/http/HttpUtils", null, "java/lang/Object", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/servlet/http/HttpUtils", "parseName", "(Ljava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "parsePostData", "(ILjavax/servlet/ServletInputStream;)Ljava/util/Hashtable;", "(ILjavax/servlet/ServletInputStream;)Ljava/util/Hashtable<Ljava/lang/String;[Ljava/lang/String;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/servlet/http/HttpUtils", "lStrings", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {Opcodes.INTEGER, "javax/servlet/ServletInputStream", "[B"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/servlet/http/HttpUtils", "parseQueryString", "(Ljava/lang/String;)Ljava/util/Hashtable;", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label5);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/servlet/http/HttpServletRequest", "java/lang/StringBuffer", "java/lang/String", Opcodes.INTEGER, "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/servlet/http/HttpUtils", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
