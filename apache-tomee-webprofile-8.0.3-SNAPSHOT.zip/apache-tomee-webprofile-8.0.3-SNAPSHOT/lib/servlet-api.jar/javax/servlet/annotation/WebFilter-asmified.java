...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/servlet/annotation/WebFilter", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "initParams", "()[Ljavax/servlet/annotation/WebInitParam;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "dispatcherTypes", "()[Ljavax/servlet/DispatcherType;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
AnnotationVisitor annotationVisitor1 = annotationVisitor0.visitArray(null);
annotationVisitor1.visitEnum(null, "Ljavax/servlet/DispatcherType;", "REQUEST");
annotationVisitor1.visitEnd();
}
annotationVisitor0.visitEnd();
}
