...
public class WebServletDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/servlet/annotation/WebServlet", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "loadOnStartup", "()I", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
