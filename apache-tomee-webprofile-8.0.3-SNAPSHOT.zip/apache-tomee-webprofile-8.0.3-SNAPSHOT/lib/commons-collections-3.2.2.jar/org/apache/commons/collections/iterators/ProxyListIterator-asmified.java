...
public class ProxyListIteratorDump implements Opcodes {
...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "org/apache/commons/collections/iterators/ProxyListIterator", null, "java/lang/Object", new String[] { "java/util/ListIterator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/iterators/ProxyListIterator", "iterator", "Ljava/util/ListIterator;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/iterators/ProxyListIterator", "getListIterator", "()Ljava/util/ListIterator;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/iterators/ProxyListIterator", "iterator", "Ljava/util/ListIterator;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
