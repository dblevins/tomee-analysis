...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/map/StaticBucketMap$KeyIterator", null, "org/apache/commons/collections/map/StaticBucketMap$EntryIterator", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/map/StaticBucketMap$KeyIterator", "this$0", "Lorg/apache/commons/collections/map/StaticBucketMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/StaticBucketMap$KeyIterator", "nextEntry", "()Ljava/util/Map$Entry;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/map/StaticBucketMap$KeyIterator", "<init>", "(Lorg/apache/commons/collections/map/StaticBucketMap;)V", false);
methodVisitor.visitInsn(RETURN);
