...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", null, "org/apache/commons/collections/bidimap/AbstractOrderedBidiMapDecorator", new String[] { "org/apache/commons/collections/Unmodifiable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "inverse", "Lorg/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "decorate", "(Lorg/apache/commons/collections/OrderedBidiMap;)Lorg/apache/commons/collections/OrderedBidiMap;", null, null);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "<init>", "(Lorg/apache/commons/collections/OrderedBidiMap;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/commons/collections/OrderedBidiMap;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bidimap/AbstractOrderedBidiMapDecorator", "entrySet", "()Ljava/util/Set;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bidimap/AbstractOrderedBidiMapDecorator", "keySet", "()Ljava/util/Set;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bidimap/AbstractOrderedBidiMapDecorator", "values", "()Ljava/util/Collection;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "orderedMapIterator", "()Lorg/apache/commons/collections/OrderedMapIterator;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "inverseOrderedBidiMap", "()Lorg/apache/commons/collections/OrderedBidiMap;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "getOrderedBidiMap", "()Lorg/apache/commons/collections/OrderedBidiMap;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "inverse", "Lorg/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap;");
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "<init>", "(Lorg/apache/commons/collections/OrderedBidiMap;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "inverse", "Lorg/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "inverse", "Lorg/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap", "inverse", "Lorg/apache/commons/collections/bidimap/UnmodifiableOrderedBidiMap;");
