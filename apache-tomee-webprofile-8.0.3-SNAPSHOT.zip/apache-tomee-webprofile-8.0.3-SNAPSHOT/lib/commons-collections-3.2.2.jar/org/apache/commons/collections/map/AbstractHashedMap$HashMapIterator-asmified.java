...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections/map/AbstractHashedMap$HashMapIterator", null, "org/apache/commons/collections/map/AbstractHashedMap$HashIterator", new String[] { "org/apache/commons/collections/MapIterator" });

classWriter.visitInnerClass("org/apache/commons/collections/map/AbstractHashedMap$HashMapIterator", "org/apache/commons/collections/map/AbstractHashedMap", "HashMapIterator", ACC_PROTECTED | ACC_STATIC);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/AbstractHashedMap$HashMapIterator", "currentEntry", "()Lorg/apache/commons/collections/map/AbstractHashedMap$HashEntry;", false);
