...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/servlet/jsp/JspException", null, "java/lang/Exception", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/jsp/JspException", "getCause", "()Ljava/lang/Throwable;", false);
