...
public class EventConstantsDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/slf4j/event/EventConstants", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "NA_SUBST", "Ljava/lang/String;", null, "NA/SubstituteLogger");
fieldVisitor.visitEnd();
}
{
