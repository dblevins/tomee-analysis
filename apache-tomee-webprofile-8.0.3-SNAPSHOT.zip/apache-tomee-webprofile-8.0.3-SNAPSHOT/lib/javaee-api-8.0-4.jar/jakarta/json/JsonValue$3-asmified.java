...
public class JsonValue$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "jakarta/json/JsonValue$3", null, "java/lang/Object", new String[] { "jakarta/json/JsonValue" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/JsonValue$3", "getValueType", "()Ljakarta/json/JsonValue$ValueType;", false);
