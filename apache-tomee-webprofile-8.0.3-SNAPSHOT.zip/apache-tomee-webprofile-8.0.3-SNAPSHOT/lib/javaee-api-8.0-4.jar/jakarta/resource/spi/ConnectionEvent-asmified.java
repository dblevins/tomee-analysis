...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/resource/spi/ConnectionEvent", null, "java/util/EventObject", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/resource/spi/ManagedConnection;I)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/resource/spi/ConnectionEvent", "id", "I");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/resource/spi/ManagedConnection;ILjava/lang/Exception;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/resource/spi/ConnectionEvent", "exception", "Ljava/lang/Exception;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/resource/spi/ConnectionEvent", "connectionHandle", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/resource/spi/ConnectionEvent", "connectionHandle", "Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/resource/spi/ConnectionEvent", "exception", "Ljava/lang/Exception;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/resource/spi/ConnectionEvent", "id", "I");
