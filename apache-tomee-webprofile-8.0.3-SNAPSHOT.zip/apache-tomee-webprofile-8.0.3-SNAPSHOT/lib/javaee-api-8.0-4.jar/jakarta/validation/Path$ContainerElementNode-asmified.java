...
public class Path$ContainerElementNodeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/Path$ContainerElementNode", null, "java/lang/Object", new String[] { "jakarta/validation/Path$Node" });
