...
public class ClientErrorExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/ws/rs/ClientErrorException", null, "jakarta/ws/rs/WebApplicationException", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-4101970664444907990L));
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/ws/rs/ClientErrorException", "validate", "(Ljakarta/ws/rs/core/Response;Ljakarta/ws/rs/core/Response$Status$Family;)Ljakarta/ws/rs/core/Response;", false);
