...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljakarta/persistence/metamodel/Attribute$PersistentAttributeType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/metamodel/Attribute$PersistentAttributeType", "$VALUES", "[Ljakarta/persistence/metamodel/Attribute$PersistentAttributeType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljakarta/persistence/metamodel/Attribute$PersistentAttributeType;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/persistence/metamodel/Attribute$PersistentAttributeType;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/metamodel/Attribute$PersistentAttributeType", "$VALUES", "[Ljakarta/persistence/metamodel/Attribute$PersistentAttributeType;");
methodVisitor.visitInsn(RETURN);
