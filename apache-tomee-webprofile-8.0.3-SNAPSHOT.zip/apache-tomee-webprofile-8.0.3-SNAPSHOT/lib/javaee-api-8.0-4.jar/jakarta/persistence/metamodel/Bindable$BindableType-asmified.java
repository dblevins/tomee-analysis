...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljakarta/persistence/metamodel/Bindable$BindableType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/metamodel/Bindable$BindableType", "$VALUES", "[Ljakarta/persistence/metamodel/Bindable$BindableType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljakarta/persistence/metamodel/Bindable$BindableType;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/persistence/metamodel/Bindable$BindableType;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/metamodel/Bindable$BindableType", "$VALUES", "[Ljakarta/persistence/metamodel/Bindable$BindableType;");
methodVisitor.visitInsn(RETURN);
