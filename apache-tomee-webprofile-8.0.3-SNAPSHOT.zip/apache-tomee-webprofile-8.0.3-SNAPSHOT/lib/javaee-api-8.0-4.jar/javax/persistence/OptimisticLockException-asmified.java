...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/persistence/OptimisticLockException", null, "javax/persistence/PersistenceException", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/persistence/OptimisticLockException", "entity", "Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/persistence/OptimisticLockException", "entity", "Ljava/lang/Object;");
