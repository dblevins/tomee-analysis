...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljavax/persistence/metamodel/Bindable$BindableType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/metamodel/Bindable$BindableType", "$VALUES", "[Ljavax/persistence/metamodel/Bindable$BindableType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljavax/persistence/metamodel/Bindable$BindableType;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/persistence/metamodel/Bindable$BindableType;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/metamodel/Bindable$BindableType", "$VALUES", "[Ljavax/persistence/metamodel/Bindable$BindableType;");
methodVisitor.visitInsn(RETURN);
