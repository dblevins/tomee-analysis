...
public class Duration$1Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER | ACC_SYNTHETIC, "javax/cache/expiry/Duration$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("javax/cache/expiry/Duration", null, null);

classWriter.visitInnerClass("javax/cache/expiry/Duration$1", "javax/cache/expiry/Duration", null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$java$util$concurrent$TimeUnit", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/cache/expiry/Duration$1", "$SwitchMap$java$util$concurrent$TimeUnit", "[I");
