...
public class JAXRExceptionDump implements Opcodes {
...
classWriter.visit(V1_4, ACC_PUBLIC | ACC_SUPER, "javax/xml/registry/JAXRException", null, "java/lang/Exception", new String[] { "javax/xml/registry/JAXRResponse" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "cause", "Ljava/lang/Throwable;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/registry/JAXRException", "cause", "Ljava/lang/Throwable;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/registry/JAXRException", "cause", "Ljava/lang/Throwable;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Cannot overwrite cause.");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isAvailable", "()Z", null, new String[] { "javax/xml/registry/JAXRException" });
methodVisitor.visitCode();
