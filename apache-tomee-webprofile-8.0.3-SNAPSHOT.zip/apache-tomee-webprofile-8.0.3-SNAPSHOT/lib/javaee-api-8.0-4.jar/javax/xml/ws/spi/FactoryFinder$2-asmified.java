...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "javax/xml/ws/spi/FactoryFinder$2", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });

classWriter.visitOuterClass("javax/xml/ws/spi/FactoryFinder", "newInstance", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Object;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/ws/spi/FactoryFinder$2", "val$iClassName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/ws/spi/FactoryFinder$2", "val$iClassLoader", "Ljava/lang/ClassLoader;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/ws/spi/FactoryFinder$2", "val$iClassName", "Ljava/lang/String;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/xml/ws/spi/FactoryFinder;"));
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/ws/spi/FactoryFinder$2", "val$iClassLoader", "Ljava/lang/ClassLoader;");
