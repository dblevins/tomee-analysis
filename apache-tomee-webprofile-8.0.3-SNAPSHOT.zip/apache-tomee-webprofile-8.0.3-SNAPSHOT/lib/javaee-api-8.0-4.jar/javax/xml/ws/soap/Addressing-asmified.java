...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/ws/soap/Addressing", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
annotationVisitor0 = classWriter.visitAnnotation("Ljavax/xml/ws/spi/WebServiceFeatureAnnotation;", true);
annotationVisitor0.visit("id", "http://www.w3.org/2005/08/addressing/module");
annotationVisitor0.visit("bean", Type.getType("Ljavax/xml/ws/soap/AddressingFeature;"));
annotationVisitor0.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "responses", "()Ljavax/xml/ws/soap/AddressingFeature$Responses;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljavax/xml/ws/soap/AddressingFeature$Responses;", "ALL");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
