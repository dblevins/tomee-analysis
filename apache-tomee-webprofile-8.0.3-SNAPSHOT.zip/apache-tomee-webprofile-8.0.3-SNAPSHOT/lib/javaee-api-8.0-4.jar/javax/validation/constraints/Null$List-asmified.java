...
public class Null$ListDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/Null$List", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
classWriter.visitInnerClass("javax/validation/constraints/Null$List", "javax/validation/constraints/Null", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "value", "()[Ljavax/validation/constraints/Null;", null, null);
