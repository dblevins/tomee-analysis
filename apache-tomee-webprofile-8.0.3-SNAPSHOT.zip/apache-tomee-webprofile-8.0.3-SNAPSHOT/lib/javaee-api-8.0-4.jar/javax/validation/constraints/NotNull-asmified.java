...
public class NotNullDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/NotNull", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/validation/constraints/NotNull$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{javax.validation.constraints.NotNull.message}");
annotationVisitor0.visitEnd();
}
