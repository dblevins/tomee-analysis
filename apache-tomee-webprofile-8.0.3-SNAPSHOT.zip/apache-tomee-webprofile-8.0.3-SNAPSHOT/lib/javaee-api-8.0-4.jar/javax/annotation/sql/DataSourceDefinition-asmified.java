...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/annotation/sql/DataSourceDefinition", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/annotation/sql/DataSourceDefinitions;"));
annotationVisitor0.visitEnd();
}
{
