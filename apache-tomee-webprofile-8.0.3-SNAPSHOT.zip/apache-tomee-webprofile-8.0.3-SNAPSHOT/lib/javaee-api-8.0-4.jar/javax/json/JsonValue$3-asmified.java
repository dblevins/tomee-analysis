...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "javax/json/JsonValue$3", null, "java/lang/Object", new String[] { "javax/json/JsonValue" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/JsonValue$3", "getValueType", "()Ljavax/json/JsonValue$ValueType;", false);
