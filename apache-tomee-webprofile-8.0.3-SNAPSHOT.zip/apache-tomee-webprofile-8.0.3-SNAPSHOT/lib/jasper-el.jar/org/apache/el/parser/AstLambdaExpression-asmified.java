...
methodVisitor.visitTypeInsn(NEW, "javax/el/LambdaExpression");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/el/LambdaExpression", "<init>", "(Ljava/util/List;Ljavax/el/ValueExpression;)V", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/el/LambdaExpression", "setELContext", "(Ljavax/el/ELContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/el/parser/AstLambdaExpression", "jjtGetNumChildren", "()I", false);
methodVisitor.visitInsn(ICONST_2);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/el/LambdaExpression"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
