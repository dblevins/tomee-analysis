...
public class AstLessThanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/el/parser/AstLessThan", null, "org/apache/el/parser/BooleanNode", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/parser/AstLessThan", "children", "[Lorg/apache/el/parser/Node;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/el/parser/AstLessThan", "compare", "(Ljakarta/el/ELContext;Ljava/lang/Object;Ljava/lang/Object;)I", false);
