...
public class FunctionMapperImplDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "functions", "Ljava/util/concurrent/ConcurrentMap;", "Ljava/util/concurrent/ConcurrentMap<Ljava/lang/String;Lorg/apache/el/lang/FunctionMapperImpl$Function;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/lang/FunctionMapperImpl", "functions", "Ljava/util/concurrent/ConcurrentMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/lang/FunctionMapperImpl", "functions", "Ljava/util/concurrent/ConcurrentMap;");
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/el/lang/FunctionMapperImpl$Function");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/el/lang/FunctionMapperImpl$Function"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/el/lang/FunctionMapperImpl$Function");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/el/lang/FunctionMapperImpl$Function", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/reflect/Method;)V", false);
