...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/cxf/message/Exchange", "javax/ws/rs/core/Response"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxrs/interceptor/JAXRSInInterceptor", "createOutMessage", "(Lorg/apache/cxf/message/Message;Ljavax/ws/rs/core/Response;)Lorg/apache/cxf/message/Message;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/RequestPreprocessor", "preprocess", "(Lorg/apache/cxf/message/Message;Ljavax/ws/rs/core/UriInfo;)Ljava/lang/String;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label6);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxrs/interceptor/JAXRSInInterceptor", "setExchangeProperties", "(Lorg/apache/cxf/message/Message;Lorg/apache/cxf/message/Exchange;Lorg/apache/cxf/jaxrs/model/OperationResourceInfo;Ljavax/ws/rs/core/MultivaluedMap;I)V", false);
methodVisitor.visitLabel(label4);
Label label16 = new Label();
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/cxf/jaxrs/interceptor/JAXRSInInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/message/Exchange", "org/apache/cxf/jaxrs/provider/ServerProviderFactory", "org/apache/cxf/jaxrs/impl/RequestPreprocessor", "java/lang/String", "java/lang/String", "java/util/Map", "java/lang/String", "java/util/List", "java/lang/String", "java/util/List", "java/util/List", "java/util/List", "java/util/Map", "javax/ws/rs/core/MultivaluedMap", "org/apache/cxf/jaxrs/model/OperationResourceInfo"}, 1, new Object[] {"javax/ws/rs/WebApplicationException"});
methodVisitor.visitVarInsn(ASTORE, 17);
methodVisitor.visitVarInsn(ALOAD, 17);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createOutMessage", "(Lorg/apache/cxf/message/Message;Ljavax/ws/rs/core/Response;)Lorg/apache/cxf/message/Message;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/message/Message", "getExchange", "()Lorg/apache/cxf/message/Exchange;", true);
