...
public class PropertyHolderFactory$MessagePropertyHolderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", null, "java/lang/Object", new String[] { "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$PropertyHolder" });

classWriter.visitInnerClass("org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "org/apache/cxf/jaxrs/impl/PropertyHolderFactory", "MessagePropertyHolder", ACC_PRIVATE | ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "m", "Lorg/apache/cxf/message/Message;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "props", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "props", "Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "props", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "m", "Lorg/apache/cxf/message/Message;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/message/Message", "getExchange", "()Lorg/apache/cxf/message/Exchange;", true);
methodVisitor.visitLdcInsn("jaxrs.filter.properties");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "props", "Ljava/util/Map;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$MessagePropertyHolder", "removeProperty", "(Ljava/lang/String;)V", false);
