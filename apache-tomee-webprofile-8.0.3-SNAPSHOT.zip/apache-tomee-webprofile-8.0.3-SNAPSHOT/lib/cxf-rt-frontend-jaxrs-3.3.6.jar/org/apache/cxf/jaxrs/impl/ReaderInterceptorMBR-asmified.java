...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/impl/ReaderInterceptorMBR", null, "java/lang/Object", new String[] { "javax/ws/rs/ext/ReaderInterceptor" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "reader", "Ljavax/ws/rs/ext/MessageBodyReader;", "Ljavax/ws/rs/ext/MessageBodyReader<*>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/ws/rs/ext/MessageBodyReader;Lorg/apache/cxf/message/Message;)V", "(Ljavax/ws/rs/ext/MessageBodyReader<*>;Lorg/apache/cxf/message/Message;)V", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxrs/impl/ReaderInterceptorMBR", "javax/ws/rs/ext/MessageBodyReader", "org/apache/cxf/message/Message"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/ReaderInterceptorMBR", "reader", "Ljavax/ws/rs/ext/MessageBodyReader;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMBR", "()Ljavax/ws/rs/ext/MessageBodyReader;", "()Ljavax/ws/rs/ext/MessageBodyReader<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/ReaderInterceptorMBR", "reader", "Ljavax/ws/rs/ext/MessageBodyReader;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "aroundReadFrom", "(Ljavax/ws/rs/ext/ReaderInterceptorContext;)Ljava/lang/Object;", null, new String[] { "java/io/IOException", "javax/ws/rs/WebApplicationException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/ext/ReaderInterceptorContext", "getType", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/ext/ReaderInterceptorContext", "getGenericType", "()Ljava/lang/reflect/Type;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/ext/ReaderInterceptorContext", "getMediaType", "()Ljavax/ws/rs/core/MediaType;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/ext/ReaderInterceptorContext", "getAnnotations", "()[Ljava/lang/annotation/Annotation;", true);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/jaxrs/impl/ReaderInterceptorMBR", "javax/ws/rs/ext/ReaderInterceptorContext", "java/lang/Class", "java/lang/reflect/Type", "javax/ws/rs/core/MediaType", "[Ljava/lang/annotation/Annotation;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/ext/ReaderInterceptorContext", "getInputStream", "()Ljava/io/InputStream;", true);
