...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/nio/NioOutputStream", null, "java/io/OutputStream", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/nio/NioOutputStream", "out", "Ljava/io/OutputStream;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/nio/NioOutputStream", "out", "Ljava/io/OutputStream;");
methodVisitor.visitVarInsn(ALOAD, 1);
