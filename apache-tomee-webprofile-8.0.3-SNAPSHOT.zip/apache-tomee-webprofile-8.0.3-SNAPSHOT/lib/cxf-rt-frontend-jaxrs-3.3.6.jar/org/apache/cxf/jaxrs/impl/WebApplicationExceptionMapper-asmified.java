...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/impl/WebApplicationExceptionMapper", "Ljava/lang/Object;Ljakarta/ws/rs/ext/ExceptionMapper<Ljakarta/ws/rs/WebApplicationException;>;", "java/lang/Object", new String[] { "jakarta/ws/rs/ext/ExceptionMapper" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "toResponse", "(Ljakarta/ws/rs/WebApplicationException;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/WebApplicationExceptionMapper", "buildErrorMessage", "(Ljakarta/ws/rs/core/Response;Ljakarta/ws/rs/WebApplicationException;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/WebApplicationExceptionMapper", "getStackTraceLogLevel", "(Lorg/apache/cxf/message/Message;Ljakarta/ws/rs/core/Response;)Ljava/util/logging/Level;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/WebApplicationExceptionMapper", "buildResponse", "(Ljakarta/ws/rs/core/Response;Ljava/lang/String;)Ljakarta/ws/rs/core/Response;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getStackTraceLogLevel", "(Lorg/apache/cxf/message/Message;Ljakarta/ws/rs/core/Response;)Ljava/util/logging/Level;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildErrorMessage", "(Ljakarta/ws/rs/core/Response;Ljakarta/ws/rs/WebApplicationException;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ws/rs/WebApplicationException", "getMessage", "()Ljava/lang/String;", false);
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildResponse", "(Ljakarta/ws/rs/core/Response;Ljava/lang/String;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/WebApplicationExceptionMapper", "toResponse", "(Ljakarta/ws/rs/WebApplicationException;)Ljakarta/ws/rs/core/Response;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
