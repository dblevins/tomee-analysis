...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", null, "java/lang/Object", new String[] { "jakarta/ws/rs/ext/WriterInterceptor" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "writer", "Ljakarta/ws/rs/ext/MessageBodyWriter;", "Ljakarta/ws/rs/ext/MessageBodyWriter<Ljava/lang/Object;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/ws/rs/ext/MessageBodyWriter;Lorg/apache/cxf/message/Message;)V", "(Ljakarta/ws/rs/ext/MessageBodyWriter<Ljava/lang/Object;>;Lorg/apache/cxf/message/Message;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", "writer", "Ljakarta/ws/rs/ext/MessageBodyWriter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMBW", "()Ljakarta/ws/rs/ext/MessageBodyWriter;", "()Ljakarta/ws/rs/ext/MessageBodyWriter<Ljava/lang/Object;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", "writer", "Ljakarta/ws/rs/ext/MessageBodyWriter;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/ws/rs/core/MultivaluedMap", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/ext/WriterInterceptorContext", "getType", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/ext/WriterInterceptorContext", "getGenericType", "()Ljava/lang/reflect/Type;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/ext/WriterInterceptorContext", "getAnnotations", "()[Ljava/lang/annotation/Annotation;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", "jakarta/ws/rs/ext/WriterInterceptorContext", "jakarta/ws/rs/core/MultivaluedMap", "java/lang/Object", "jakarta/ws/rs/core/MediaType", "java/lang/Class", "java/lang/reflect/Type", "[Ljava/lang/annotation/Annotation;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", "m", "Lorg/apache/cxf/message/Message;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", "m", "Lorg/apache/cxf/message/Message;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/ProviderFactory", "createMessageBodyWriter", "(Ljava/lang/Class;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljakarta/ws/rs/core/MediaType;Lorg/apache/cxf/message/Message;)Ljakarta/ws/rs/ext/MessageBodyWriter;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/WriterInterceptorMBW", "writer", "Ljakarta/ws/rs/ext/MessageBodyWriter;");
