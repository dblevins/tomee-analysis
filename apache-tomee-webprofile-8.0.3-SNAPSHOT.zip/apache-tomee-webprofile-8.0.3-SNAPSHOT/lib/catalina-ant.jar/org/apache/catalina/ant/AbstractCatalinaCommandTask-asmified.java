...
public class AbstractCatalinaCommandTaskDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/catalina/ant/AbstractCatalinaCommandTask", null, "org/apache/catalina/ant/AbstractCatalinaTask", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/ant/AbstractCatalinaCommandTask", "path", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/ant/AbstractCatalinaCommandTask", "version", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/ant/AbstractCatalinaCommandTask", "path", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/ant/AbstractCatalinaCommandTask", "version", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createQueryString", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", null, new String[] { "org/apache/tools/ant/BuildException" });
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/ant/AbstractCatalinaCommandTask", "path", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/ant/AbstractCatalinaCommandTask", "getCharset", "()Ljava/lang/String;", false);
