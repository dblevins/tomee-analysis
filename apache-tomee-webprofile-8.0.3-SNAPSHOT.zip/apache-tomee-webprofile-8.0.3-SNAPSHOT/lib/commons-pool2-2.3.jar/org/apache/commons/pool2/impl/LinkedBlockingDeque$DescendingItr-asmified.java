...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/commons/pool2/impl/LinkedBlockingDeque$DescendingItr", "Lorg/apache/commons/pool2/impl/LinkedBlockingDeque<TE;>.AbstractItr;", "org/apache/commons/pool2/impl/LinkedBlockingDeque$AbstractItr", null);

classWriter.visitInnerClass("org/apache/commons/pool2/impl/LinkedBlockingDeque$DescendingItr", "org/apache/commons/pool2/impl/LinkedBlockingDeque", "DescendingItr", ACC_PRIVATE);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/impl/LinkedBlockingDeque$DescendingItr", "this$0", "Lorg/apache/commons/pool2/impl/LinkedBlockingDeque;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/LinkedBlockingDeque$DescendingItr", "this$0", "Lorg/apache/commons/pool2/impl/LinkedBlockingDeque;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/pool2/impl/LinkedBlockingDeque", "access$500", "(Lorg/apache/commons/pool2/impl/LinkedBlockingDeque;)Lorg/apache/commons/pool2/impl/LinkedBlockingDeque$Node;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/LinkedBlockingDeque$Node", "prev", "Lorg/apache/commons/pool2/impl/LinkedBlockingDeque$Node;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/pool2/impl/LinkedBlockingDeque$DescendingItr", "<init>", "(Lorg/apache/commons/pool2/impl/LinkedBlockingDeque;)V", false);
methodVisitor.visitInsn(RETURN);
