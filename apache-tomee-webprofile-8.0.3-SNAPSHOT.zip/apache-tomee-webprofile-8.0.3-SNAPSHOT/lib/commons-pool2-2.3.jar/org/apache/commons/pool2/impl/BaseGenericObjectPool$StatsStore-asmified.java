...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/pool2/impl/BaseGenericObjectPool;I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "this$0", "Lorg/apache/commons/pool2/impl/BaseGenericObjectPool;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "size", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/util/concurrent/atomic/AtomicLong");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "values", "[Ljava/util/concurrent/atomic/AtomicLong;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 3);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "org/apache/commons/pool2/impl/BaseGenericObjectPool", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitVarInsn(ILOAD, 2);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "values", "[Ljava/util/concurrent/atomic/AtomicLong;");
methodVisitor.visitVarInsn(ILOAD, 3);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "values", "[Ljava/util/concurrent/atomic/AtomicLong;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "index", "I");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool$StatsStore", "size", "I");
Label label0 = new Label();
