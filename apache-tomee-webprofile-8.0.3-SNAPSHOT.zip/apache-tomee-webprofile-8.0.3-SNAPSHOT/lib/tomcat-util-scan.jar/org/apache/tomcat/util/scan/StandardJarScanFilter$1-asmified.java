...
public class StandardJarScanFilter$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/scan/StandardJarScanFilter$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/scan/StandardJarScanFilter", null, null);

classWriter.visitInnerClass("org/apache/tomcat/util/scan/StandardJarScanFilter$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$JarScanType", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/JarScanType", "values", "()[Lorg/apache/tomcat/JarScanType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/scan/StandardJarScanFilter$1", "$SwitchMap$org$apache$tomcat$JarScanType", "[I");
