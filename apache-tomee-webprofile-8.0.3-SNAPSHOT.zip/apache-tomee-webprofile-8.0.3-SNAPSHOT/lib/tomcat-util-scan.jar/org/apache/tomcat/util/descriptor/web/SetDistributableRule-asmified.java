...
public class SetDistributableRuleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/tomcat/util/descriptor/web/SetDistributableRule", null, "org/apache/tomcat/util/digester/Rule", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/descriptor/web/SetDistributableRule", "digester", "Lorg/apache/tomcat/util/digester/Digester;");
...
methodVisitor.visitLdcInsn(".setDistributable(true)");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
