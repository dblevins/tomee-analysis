...
public class SoapHeaderRuleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/tomcat/util/descriptor/web/SoapHeaderRule", null, "org/apache/tomcat/util/digester/Rule", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/descriptor/web/SoapHeaderRule", "digester", "Lorg/apache/tomcat/util/digester/Digester;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/descriptor/web/ContextHandler", "addSoapHeaders", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
