...
public class SetDenyUncoveredHttpMethodsRuleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/tomcat/util/descriptor/web/SetDenyUncoveredHttpMethodsRule", null, "org/apache/tomcat/util/digester/Rule", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/descriptor/web/SetDenyUncoveredHttpMethodsRule", "digester", "Lorg/apache/tomcat/util/digester/Digester;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/descriptor/web/WebXml", "setDenyUncoveredHttpMethods", "(Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/descriptor/web/SetDenyUncoveredHttpMethodsRule", "digester", "Lorg/apache/tomcat/util/digester/Digester;");
...
methodVisitor.visitLdcInsn(".setDenyUncoveredHttpMethods(true)");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
