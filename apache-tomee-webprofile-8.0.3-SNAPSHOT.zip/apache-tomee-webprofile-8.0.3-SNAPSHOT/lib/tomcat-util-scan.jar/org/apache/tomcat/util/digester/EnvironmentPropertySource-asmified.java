...
public class EnvironmentPropertySourceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/util/digester/EnvironmentPropertySource", null, "java/lang/Object", new String[] { "org/apache/tomcat/util/IntrospectionUtils$SecurePropertySource" });
...
methodVisitor.visitLdcInsn("getenv.");
