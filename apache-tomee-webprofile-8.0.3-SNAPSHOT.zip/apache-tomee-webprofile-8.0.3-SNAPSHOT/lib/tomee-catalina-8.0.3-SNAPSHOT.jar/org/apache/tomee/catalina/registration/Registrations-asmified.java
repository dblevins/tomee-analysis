package asm.org.apache.tomee.catalina.registration;
...
public class RegistrationsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/tomee/catalina/registration/Registrations", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "addFilterConfig", "(Lorg/apache/catalina/Context;Lorg/apache/tomcat/util/descriptor/web/FilterDef;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/tomcat/util/descriptor/web/FilterDef;"));
methodVisitor.visitInsn(AASTORE);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("filterConfigs");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/catalina/Context", "org/apache/tomcat/util/descriptor/web/FilterDef"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
