...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/catalina/realm/CdiEventRealm", "beanManager", "()Ljakarta/enterprise/inject/spi/BeanManager;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/catalina/realm/event/FindSecurityConstraintsEvent", "<init>", "(Ljakarta/servlet/ServletRequest;Ljava/lang/String;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "beanManager", "()Ljakarta/enterprise/inject/spi/BeanManager;", null, null);
methodVisitor.visitCode();
