...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jaxrs/JweJsonWriterInterceptor", null, "org/apache/cxf/rs/security/jose/jaxrs/AbstractJweJsonWriterProvider", new String[] { "jakarta/ws/rs/ext/WriterInterceptor" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JweJsonWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/io/OutputStream", "org/apache/cxf/rs/security/jose/jwe/JweHeaders", "java/util/List", "java/util/List", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "java/lang/String", "jakarta/ws/rs/core/MediaType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JweJsonWriterInterceptor", "protectHttpHeadersIfNeeded", "(Ljakarta/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jwe/JweHeaders;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jaxrs/JweJsonWriterInterceptor", "setJoseMediaType", "(Ljakarta/ws/rs/ext/WriterInterceptorContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "protectHttpHeadersIfNeeded", "(Ljakarta/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jwe/JweHeaders;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
