...
public class Http11Processor$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/coyote/http11/Http11Processor$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/coyote/http11/Http11Processor", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$net$SendfileState", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/net/SendfileState", "values", "()[Lorg/apache/tomcat/util/net/SendfileState;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/coyote/http11/Http11Processor$1", "$SwitchMap$org$apache$tomcat$util$net$SendfileState", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/coyote/http11/Http11Processor$1", "$SwitchMap$org$apache$tomcat$util$log$UserDataHelper$Mode", "[I");
