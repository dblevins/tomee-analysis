...
public class FileItemStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/tomcat/util/http/fileupload/FileItemStream", null, "java/lang/Object", new String[] { "org/apache/tomcat/util/http/fileupload/FileItemHeadersSupport" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "openStream", "()Ljava/io/InputStream;", null, new String[] { "java/io/IOException" });
