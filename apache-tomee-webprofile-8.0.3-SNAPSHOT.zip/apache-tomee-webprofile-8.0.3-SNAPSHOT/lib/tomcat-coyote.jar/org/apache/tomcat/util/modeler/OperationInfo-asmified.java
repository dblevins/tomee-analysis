...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/modeler/OperationInfo", "info", "Ljakarta/management/MBeanFeatureInfo;");
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/concurrent/locks/Lock", "unlock", "()V", true);
...
{
methodVisitor = classWriter.visitMethod(0, "createOperationInfo", "()Ljakarta/management/MBeanOperationInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/modeler/OperationInfo", "info", "Ljakarta/management/MBeanFeatureInfo;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/modeler/OperationInfo", "getMBeanParameterInfo", "()[Ljakarta/management/MBeanParameterInfo;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/modeler/OperationInfo", "info", "Ljakarta/management/MBeanFeatureInfo;");
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/management/MBeanOperationInfo");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(8, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getMBeanParameterInfo", "()[Ljakarta/management/MBeanParameterInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Lorg/apache/tomcat/util/modeler/ParameterInfo;", "[Ljakarta/management/MBeanParameterInfo;", Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/modeler/ParameterInfo", "createParameterInfo", "()Ljakarta/management/MBeanParameterInfo;", false);
methodVisitor.visitInsn(AASTORE);
