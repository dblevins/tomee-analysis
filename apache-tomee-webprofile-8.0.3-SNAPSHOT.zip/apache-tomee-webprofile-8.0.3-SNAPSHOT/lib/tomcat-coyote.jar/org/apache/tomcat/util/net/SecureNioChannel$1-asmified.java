...
public class SecureNioChannel$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/net/SecureNioChannel$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/net/SecureNioChannel", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/net/SecureNioChannel$1", "$SwitchMap$org$apache$tomcat$util$net$TLSClientHelloExtractor$ExtractorResult", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/net/SecureNioChannel$1", "$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus", "[I");
