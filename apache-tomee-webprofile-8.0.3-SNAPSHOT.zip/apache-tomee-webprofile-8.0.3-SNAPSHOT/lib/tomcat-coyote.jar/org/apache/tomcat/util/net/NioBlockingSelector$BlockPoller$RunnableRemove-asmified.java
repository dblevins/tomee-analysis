...
public class NioBlockingSelector$BlockPoller$RunnableRemoveDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", null, "java/lang/Object", new String[] { "java/lang/Runnable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/tomcat/util/net/NioBlockingSelector$BlockPoller;Ljava/nio/channels/SocketChannel;Lorg/apache/tomcat/util/net/NioEndpoint$NioSocketWrapper;I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "this$0", "Lorg/apache/tomcat/util/net/NioBlockingSelector$BlockPoller;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "ch", "Ljava/nio/channels/SocketChannel;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "key", "Lorg/apache/tomcat/util/net/NioEndpoint$NioSocketWrapper;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "ops", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "ch", "Ljava/nio/channels/SocketChannel;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "this$0", "Lorg/apache/tomcat/util/net/NioBlockingSelector$BlockPoller;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "ops", "I");
methodVisitor.visitInsn(ICONST_4);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "this$0", "Lorg/apache/tomcat/util/net/NioBlockingSelector$BlockPoller;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/NioBlockingSelector$BlockPoller$RunnableRemove", "key", "Lorg/apache/tomcat/util/net/NioEndpoint$NioSocketWrapper;");
