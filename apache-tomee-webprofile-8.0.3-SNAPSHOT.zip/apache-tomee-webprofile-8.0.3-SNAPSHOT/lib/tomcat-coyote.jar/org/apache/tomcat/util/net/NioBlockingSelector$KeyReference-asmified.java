...
public class NioBlockingSelector$KeyReferenceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/util/net/NioBlockingSelector$KeyReference", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(0, "key", "Ljava/nio/channels/SelectionKey;", null, null);
...
methodVisitor.visitLdcInsn("nioBlockingSelector.possibleLeak");
