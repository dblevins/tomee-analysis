...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/taglibs/standard/lang/jstl/parser/Token", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "next", "Lorg/apache/taglibs/standard/lang/jstl/parser/Token;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "specialToken", "Lorg/apache/taglibs/standard/lang/jstl/parser/Token;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "newToken", "(I)Lorg/apache/taglibs/standard/lang/jstl/parser/Token;", null, null);
methodVisitor.visitCode();
