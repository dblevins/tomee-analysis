...
public class JobStoreSupport$44Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$44", "Ljava/lang/Object;Lorg/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$TransactionValidator<Ljava/util/List<Lorg/apache/openejb/quartz/spi/TriggerFiredResult;>;>;", "java/lang/Object", new String[] { "org/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$TransactionValidator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$44", "this$0", "Lorg/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "validate", "(Ljava/sql/Connection;Ljava/util/List;)Ljava/lang/Boolean;", "(Ljava/sql/Connection;Ljava/util/List<Lorg/apache/openejb/quartz/spi/TriggerFiredResult;>;)Ljava/lang/Boolean;", new String[] { "org/apache/openejb/quartz/JobPersistenceException" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$44", "this$0", "Lorg/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$44", "java/sql/Connection", "java/util/List"}, 1, new Object[] {"java/sql/SQLException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/impl/jdbcjobstore/JobStoreSupport$44", "validate", "(Ljava/sql/Connection;Ljava/util/List;)Ljava/lang/Boolean;", false);
methodVisitor.visitInsn(ARETURN);
