...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", null, "jakarta/faces/view/facelets/TagHandler", new String[] { "org/apache/myfaces/view/facelets/TemplateClient", "org/apache/myfaces/view/facelets/tag/ComponentContainerHandler" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "tag", "Ljakarta/faces/view/facelets/Tag;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "_vars", "[Ljakarta/faces/view/facelets/TagAttribute;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "nextHandler", "Ljakarta/faces/view/facelets/FaceletHandler;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "jakarta/faces/view/facelets/TagConfig", "java/net/URL", "java/util/Collection"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "_vars", "[Ljakarta/faces/view/facelets/TagAttribute;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "jakarta/faces/view/facelets/FaceletContext", "jakarta/faces/component/UIComponent", "jakarta/el/VariableMapper", "org/apache/myfaces/view/facelets/AbstractFaceletContext", "[Ljava/lang/String;", "[Ljakarta/el/ValueExpression;", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/el/VariableMapper", Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/view/facelets/tag/LegacyUserTagHandler", "jakarta/faces/view/facelets/FaceletContext", "jakarta/faces/component/UIComponent", "jakarta/el/VariableMapper", "org/apache/myfaces/view/facelets/AbstractFaceletContext"}, 1, new Object[] {"java/io/FileNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 5);
