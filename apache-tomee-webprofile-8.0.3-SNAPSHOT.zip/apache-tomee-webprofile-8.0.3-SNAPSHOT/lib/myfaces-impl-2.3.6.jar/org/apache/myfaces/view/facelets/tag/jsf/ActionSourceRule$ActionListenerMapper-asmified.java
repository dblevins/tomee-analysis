...
public class ActionSourceRule$ActionListenerMapperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/ActionSourceRule$ActionListenerMapper", null, "jakarta/faces/view/facelets/Metadata", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/jsf/ActionSourceRule$ActionListenerMapper", "attr", "Ljakarta/faces/view/facelets/TagAttribute;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/jsf/ActionSourceRule$ActionListenerMapper", "attr", "Ljakarta/faces/view/facelets/TagAttribute;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/el/LegacyMethodBinding", "<init>", "(Ljakarta/el/MethodExpression;)V", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/faces/component/ActionSource", "setActionListener", "(Ljakarta/faces/el/MethodBinding;)V", true);
methodVisitor.visitInsn(RETURN);
