...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", null, "javax/faces/view/facelets/MetaRuleset", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_attributes", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Ljavax/faces/view/facelets/TagAttribute;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_mappers", "Ljava/util/List;", "Ljava/util/List<Ljavax/faces/view/facelets/Metadata;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_rules", "Ljava/util/List;", "Ljava/util/List<Ljavax/faces/view/facelets/MetaRule;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_tag", "Ljavax/faces/view/facelets/Tag;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_meta", "Ljavax/faces/view/facelets/MetadataTarget;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getMetaData", "()Ljava/util/Map;", "()Ljava/util/Map<Ljava/lang/String;Ljavax/faces/view/facelets/MetadataTarget;>;", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/faces/context/FacesContext", "java/util/Map", "java/util/Map"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_tag", "Ljavax/faces/view/facelets/Tag;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_tag", "Ljavax/faces/view/facelets/Tag;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "javax/faces/view/facelets/Tag", "java/lang/Class", "java/beans/BeanInfo", "[Ljavax/faces/view/facelets/TagAttribute;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_getBaseMetadataTarget", "()Ljavax/faces/view/facelets/MetadataTarget;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetadataTargetImpl", "<init>", "(Ljavax/faces/view/facelets/MetadataTarget;Ljava/beans/BeanInfo;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_meta", "Ljavax/faces/view/facelets/MetadataTarget;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_getMetadataTarget", "()Ljavax/faces/view/facelets/MetadataTarget;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_rules", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "NONE", "Ljavax/faces/view/facelets/Metadata;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/MetadataImpl", "<init>", "([Ljavax/faces/view/facelets/Metadata;)V", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_FINAL, "_getMetadataTarget", "()Ljavax/faces/view/facelets/MetadataTarget;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "_meta", "Ljavax/faces/view/facelets/MetadataTarget;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_FINAL, "_getBaseMetadataTarget", "()Ljavax/faces/view/facelets/MetadataTarget;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "java/util/Map", "java/lang/String", "javax/faces/view/facelets/MetadataTarget"}, 1, new Object[] {"java/beans/IntrospectionException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitTypeInsn(NEW, "javax/faces/view/facelets/TagException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/view/facelets/tag/composite/CompositeMetaRulesetImpl", "NONE", "Ljavax/faces/view/facelets/Metadata;");
