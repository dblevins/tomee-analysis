...
public class ViewPoolFactoryDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getWrapped", "()Lorg/apache/myfaces/view/facelets/pool/ViewPoolFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/pool/ViewPoolFactory", "getWrapped", "()Lorg/apache/myfaces/view/facelets/pool/ViewPoolFactory;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
