...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/composite/CompositeResouceWrapper", "Ljakarta/faces/application/Resource;Ljakarta/faces/FacesWrapper<Ljakarta/faces/application/Resource;>;Ljava/io/Externalizable;", "jakarta/faces/application/Resource", new String[] { "jakarta/faces/FacesWrapper", "java/io/Externalizable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "_delegate", "Ljakarta/faces/application/Resource;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeResouceWrapper", "_delegate", "Ljakarta/faces/application/Resource;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/tag/composite/CompositeResouceWrapper", "getWrapped", "()Ljakarta/faces/application/Resource;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/composite/CompositeResouceWrapper", "_delegate", "Ljakarta/faces/application/Resource;");
