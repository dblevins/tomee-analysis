...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getParameters", "(Ljava/lang/String;)[Ljava/lang/Class;", null, new String[] { "javax/faces/FacesException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "markRenderedResources", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/UIViewRoot;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/view/facelets/util/FaceletsViewDeclarationLanguageUtils", "markRenderedResources", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/UIViewRoot;Ljava/util/List;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "markRenderedResources", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/UIViewRoot;Ljava/util/List;)V", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/UIViewRoot;Ljava/util/List<Ljavax/faces/component/UIComponent;>;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/context/FacesContext", "javax/faces/component/UIViewRoot", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
