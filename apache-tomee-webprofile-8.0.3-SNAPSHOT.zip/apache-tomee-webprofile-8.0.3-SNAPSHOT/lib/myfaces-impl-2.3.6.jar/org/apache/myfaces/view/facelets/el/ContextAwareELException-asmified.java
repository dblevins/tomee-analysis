...
public class ContextAwareELExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/el/ContextAwareELException", null, "jakarta/el/ELException", new String[] { "org/apache/myfaces/view/facelets/el/ContextAwareExceptionWrapper" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-2231893442274827689L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/el/ContextAwareELException", "_delegate", "Lorg/apache/myfaces/view/facelets/el/ContextAwareExceptionWrapper;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/el/ContextAwareELException", "_delegate", "Lorg/apache/myfaces/view/facelets/el/ContextAwareExceptionWrapper;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/el/ContextAwareELException", "getWrapped", "()Ljava/lang/Throwable;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
