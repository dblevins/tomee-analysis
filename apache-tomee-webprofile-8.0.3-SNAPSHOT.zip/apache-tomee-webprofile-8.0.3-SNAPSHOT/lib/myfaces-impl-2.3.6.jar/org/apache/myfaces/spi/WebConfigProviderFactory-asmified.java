...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getWebConfigProviderFactory", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/WebConfigProviderFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/WebConfigProviderFactory$1", "<init>", "(Ljakarta/faces/context/ExternalContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/spi/WebConfigProviderFactory", "setWebConfigProviderFactory", "(Ljakarta/faces/context/ExternalContext;Lorg/apache/myfaces/spi/WebConfigProviderFactory;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "setWebConfigProviderFactory", "(Ljakarta/faces/context/ExternalContext;Lorg/apache/myfaces/spi/WebConfigProviderFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/ExternalContext", "getApplicationMap", "()Ljava/util/Map;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/spi/WebConfigProviderFactory", "FACTORY_KEY", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getWebConfigProvider", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/WebConfigProvider;", null, null);
methodVisitor.visitEnd();
}
{
