...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_httpRequest", "Ljakarta/servlet/http/HttpServletRequest;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/SessionMap", "_httpRequest", "Ljakarta/servlet/http/HttpServletRequest;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/context/servlet/SessionMap", "_getSession", "()Ljakarta/servlet/http/HttpSession;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/SessionMap", "_httpRequest", "Ljakarta/servlet/http/HttpServletRequest;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_getSession", "()Ljakarta/servlet/http/HttpSession;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/SessionMap", "_httpRequest", "Ljakarta/servlet/http/HttpServletRequest;");
