...
public class CookieMapDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/context/servlet/CookieMap", "Lorg/apache/myfaces/util/AbstractAttributeMap<Ljava/lang/Object;>;", "org/apache/myfaces/util/AbstractAttributeMap", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "EMPTY_ARRAY", "[Ljakarta/servlet/http/Cookie;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_httpServletRequest", "Ljakarta/servlet/http/HttpServletRequest;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/CookieMap", "_httpServletRequest", "Ljakarta/servlet/http/HttpServletRequest;");
...
methodVisitor.visitLdcInsn("Cannot clear HttpRequest Cookies");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/CookieMap", "_httpServletRequest", "Ljakarta/servlet/http/HttpServletRequest;");
...
methodVisitor.visitTypeInsn(NEW, "java/lang/UnsupportedOperationException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Cannot set HttpRequest Cookies");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/UnsupportedOperationException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitTypeInsn(NEW, "java/lang/UnsupportedOperationException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Cannot remove HttpRequest Cookies");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/UnsupportedOperationException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/context/servlet/CookieMap$CookieNameEnumeration");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/context/servlet/CookieMap", "EMPTY_ARRAY", "[Ljakarta/servlet/http/Cookie;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/context/servlet/CookieMap$CookieNameEnumeration", "<init>", "([Ljakarta/servlet/http/Cookie;)V", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"[Ljakarta/servlet/http/Cookie;"}, 0, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/context/servlet/CookieMap", "EMPTY_ARRAY", "[Ljakarta/servlet/http/Cookie;");
methodVisitor.visitInsn(RETURN);
