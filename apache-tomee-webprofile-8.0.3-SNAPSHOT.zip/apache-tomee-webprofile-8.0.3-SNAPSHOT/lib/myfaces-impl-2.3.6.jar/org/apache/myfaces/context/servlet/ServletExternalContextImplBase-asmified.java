...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", null, "javax/faces/context/ExternalContext", new String[] { "org/apache/myfaces/context/ReleaseableExternalContext" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_clientWindow", "Ljavax/faces/lifecycle/ClientWindow;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_servletContext", "Ljavax/servlet/ServletContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_clientWindow", "Ljavax/faces/lifecycle/ClientWindow;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_servletContext", "Ljavax/servlet/ServletContext;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/context/servlet/ApplicationMap", "<init>", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_applicationMap", "Ljava/util/Map;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_servletContext", "Ljavax/servlet/ServletContext;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/context/servlet/InitParameterMap", "<init>", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_initParameterMap", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_servletContext", "Ljavax/servlet/ServletContext;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "INIT_PARAMETER_MAP_ATTRIBUTE", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/ServletExternalContextImplBase", "_clientWindow", "Ljavax/faces/lifecycle/ClientWindow;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
