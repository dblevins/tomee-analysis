...
public class DefaultFacesFlowProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/flow/impl/DefaultFacesFlowProvider", null, "org/apache/myfaces/spi/FacesFlowProvider", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FLOW_PREFIX", "Ljava/lang/String;", null, "oam.flow");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "FLOW_SESSION_MAP_SUBKEY_PREFIX", "Ljava/lang/String;", null, "oam.flow.SCOPE");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/flow/impl/DefaultFacesFlowProvider", "jakarta/faces/context/FacesContext", "jakarta/faces/flow/Flow", "java/lang/String", "java/lang/String", "java/lang/String", "java/util/Map"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/flow/util/FlowUtils", "getFlowMapKey", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/flow/Flow;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/flow/impl/FlowScopeMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/flow/impl/FlowScopeMap", "<init>", "(Lorg/apache/myfaces/flow/impl/DefaultFacesFlowProvider;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getAttributes", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/flow/Flow", "java/util/Map"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(0, "createOrRestoreMap", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Z)Ljava/util/Map;", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Z)Ljava/util/Map<Ljava/lang/Object;Ljava/lang/Object;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getExternalContext", "()Ljakarta/faces/context/ExternalContext;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/context/ExternalContext", "java/util/Map", "java/util/Map"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ARETURN);
