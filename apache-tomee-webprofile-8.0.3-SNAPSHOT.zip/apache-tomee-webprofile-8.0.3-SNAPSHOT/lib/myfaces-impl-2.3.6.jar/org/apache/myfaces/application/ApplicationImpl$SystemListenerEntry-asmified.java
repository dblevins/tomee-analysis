...
public class ApplicationImpl$SystemListenerEntryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/application/ApplicationImpl$SystemListenerEntry", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/application/ApplicationImpl$SystemListenerEntry", "_lstSystemEventListener", "Ljava/util/List;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/application/ApplicationImpl$SystemListenerEntry", "_lstSystemEventListener", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/application/ApplicationImpl$SystemListenerEntry", "_sourceClassMap", "Ljava/util/Map;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/application/ApplicationImpl$SystemListenerEntry", "_sourceClassMap", "Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/application/ApplicationImpl$SystemListenerEntry", "$assertionsDisabled", "Z");
methodVisitor.visitInsn(RETURN);
