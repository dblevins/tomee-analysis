...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/application/ViewHandlerImpl", null, "jakarta/faces/application/ViewHandler", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getViewHandler", "(Ljakarta/faces/context/FacesContext;)Ljakarta/faces/application/ViewHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/application/ViewHandlerImpl", "_vdlFactory", "Ljakarta/faces/view/ViewDeclarationLanguageFactory;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/application/ViewHandlerImpl", "getViewHandlerSupport", "(Ljakarta/faces/context/FacesContext;)Lorg/apache/myfaces/shared/application/ViewHandlerSupport;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/myfaces/shared/application/ViewHandlerSupport", "calculateAndCheckViewId", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/String;", true);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/application/ViewHandlerImpl", "sendSourceNotFound", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/application/ViewHandlerImpl", "getViewParameterList", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Ljava/util/Map;)Ljava/util/Map;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/application/ViewHandlerImpl", "getViewHandler", "(Ljakarta/faces/context/FacesContext;)Ljakarta/faces/application/ViewHandler;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/application/ViewHandlerImpl", "_vdlFactory", "Ljakarta/faces/view/ViewDeclarationLanguageFactory;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/application/ViewHandlerImpl", "getViewDeclarationLanguage", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)Ljakarta/faces/view/ViewDeclarationLanguage;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/myfaces/shared/application/ViewHandlerSupport", "calculateActionURL", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/String;", true);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/application/ViewHandlerImpl", "setWritingState", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/render/ResponseStateManager;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getApplication", "()Ljakarta/faces/application/Application;", false);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/application/viewstate/StateCacheUtils", "isMyFacesResponseStateManager", "(Ljakarta/faces/render/ResponseStateManager;)Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/application/viewstate/StateCacheUtils", "getMyFacesResponseStateManager", "(Ljakarta/faces/render/ResponseStateManager;)Lorg/apache/myfaces/renderkit/MyfacesResponseStateManager;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/renderkit/MyfacesResponseStateManager", "isWriteStateAfterRenderViewRequired", "(Ljakarta/faces/context/FacesContext;)Z", false);
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/render/ResponseStateManager", "jakarta/faces/application/StateManager"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "setWritingState", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/render/ResponseStateManager;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/view/facelets/StateWriter", "getCurrentInstance", "(Ljakarta/faces/context/FacesContext;)Lorg/apache/myfaces/view/facelets/StateWriter;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/myfaces/application/ViewHandlerImpl", "jakarta/faces/context/FacesContext", "java/lang/String", "java/util/Map", "jakarta/faces/component/UIViewRoot", "java/lang/String", "java/util/Collection", "java/util/Collection"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/application/ViewHandlerImpl", "getViewHandlerSupport", "(Ljakarta/faces/context/FacesContext;)Lorg/apache/myfaces/shared/application/ViewHandlerSupport;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/application/ViewHandlerImpl", "jakarta/faces/context/FacesContext", "java/lang/String", "jakarta/servlet/http/HttpServletResponse"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getViewHandlerSupport", "(Ljakarta/faces/context/FacesContext;)Lorg/apache/myfaces/shared/application/ViewHandlerSupport;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/faces/view/ViewDeclarationLanguage");
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/view/ViewDeclarationLanguage", "java/util/stream/Stream"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 8);
