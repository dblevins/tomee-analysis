...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getContextualStorage", "(Ljavax/enterprise/inject/spi/BeanManager;Ljava/lang/String;)Lorg/apache/myfaces/cdi/view/ViewScopeContextualStorage;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/cdi/view/ViewScopeContextualStorage", "<init>", "(Ljavax/enterprise/inject/spi/BeanManager;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/cdi/view/ViewScopeBeanHolder", "storageMap", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/cdi/JsfApplicationArtifactHolder", "getServletContext", "()Ljavax/servlet/ServletContext;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/cdi/view/ViewScopeBeanHolder", "java/lang/String", "org/apache/myfaces/cdi/view/ViewScopeContextualStorage", "javax/faces/context/FacesContext"}, 1, new Object[] {"java/lang/Throwable"});
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/cdi/view/ViewScopeBeanHolder", "java/util/Map", "javax/faces/context/FacesContext", "javax/servlet/ServletContext", "javax/faces/context/ExternalContext", "javax/faces/context/ExceptionHandler", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/cdi/view/ViewScopeBeanHolder", "java/util/Map", "javax/faces/context/FacesContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "release", "()V", false);
Label label7 = new Label();
