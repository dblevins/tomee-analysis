...
public class ManagedPropertyExtensionDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/cdi/managedproperty/ManagedPropertyExtension", "types", "Ljava/util/Set;");
...
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/cdi/managedproperty/ManagedPropertyInfo");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/faces/annotation/ManagedProperty;"));
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/cdi/managedproperty/ManagedPropertyProducer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
