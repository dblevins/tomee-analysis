...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/cdi/model/FacesDataModelExtension", null, "java/lang/Object", new String[] { "javax/enterprise/inject/spi/Extension" });
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/enterprise/inject/spi/Annotated", "java/lang/reflect/Type", "javax/faces/model/FacesDataModel"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/cdi/model/DynamicDataModelProducer", "<init>", "(Ljavax/enterprise/inject/spi/BeanManager;Lorg/apache/myfaces/cdi/model/DataModelInfo;)V", false);
