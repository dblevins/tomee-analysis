...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/push/WebsocketConfigurator", null, "jakarta/websocket/server/ServerEndpointConfig$Configurator", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/websocket/server/ServerEndpointConfig$Configurator", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("org.apache.myfaces.WEBSOCKET_MAX_IDLE_TIMEOUT");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/util/WebConfigParamUtils", "getLongInitParameter", "(Ljakarta/faces/context/ExternalContext;Ljava/lang/String;)J", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/websocket/server/HandshakeRequest", "getQueryString", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/websocket/server/HandshakeRequest", "getRequestURI", "()Ljava/net/URI;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/enterprise/inject/spi/BeanManager", "org/apache/myfaces/push/cdi/WebsocketSessionBean", "java/io/Serializable"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/websocket/server/ServerEndpointConfig", "getUserProperties", "()Ljava/util/Map;", true);
