...
public class AbstractWebsocketComponentDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getInitComponentId", "()Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/push/AbstractWebsocketComponent$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/push/AbstractWebsocketComponent$1", "<init>", "(Lorg/apache/myfaces/push/AbstractWebsocketComponent;)V", false);
