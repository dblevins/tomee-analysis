...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/el/convert/ELResolverToVariableResolver", null, "jakarta/faces/el/VariableResolver", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/myfaces/el/convert/ELResolverToVariableResolver", "jakarta/el/ELResolver"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/el/convert/ELResolverToVariableResolver", "elResolver", "Ljakarta/el/ELResolver;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/convert/ELResolverToVariableResolver", "elResolver", "Ljakarta/el/ELResolver;");
methodVisitor.visitVarInsn(ALOAD, 1);
