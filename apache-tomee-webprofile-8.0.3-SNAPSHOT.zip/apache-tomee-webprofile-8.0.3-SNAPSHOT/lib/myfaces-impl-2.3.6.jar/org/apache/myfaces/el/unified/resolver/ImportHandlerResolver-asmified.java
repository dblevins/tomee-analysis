...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn("jakarta.el.ELClass");
...
methodVisitor.visitVarInsn(ASTORE, 0);
methodVisitor.visitLdcInsn("jakarta.el.ImportHandler");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/util/ClassUtils", "classForName", "(Ljava/lang/String;)Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/el/ELContext;"));
