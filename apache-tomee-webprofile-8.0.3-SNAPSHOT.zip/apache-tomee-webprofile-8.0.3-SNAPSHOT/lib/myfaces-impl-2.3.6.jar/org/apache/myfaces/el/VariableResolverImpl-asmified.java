...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/el/VariableResolverImpl", null, "javax/faces/el/VariableResolver", null);
...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "javax/el/ELException");
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label5, label2, label2, "javax/el/ELException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/VariableResolverImpl", "getScope", "(Ljavax/faces/context/FacesContext;)Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope", "javax/el/ELContext", "javax/faces/application/Application"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/el/VariableResolverImpl", "javax/faces/context/FacesContext", "java/lang/String"}, 1, new Object[] {"javax/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getScope", "(Ljavax/faces/context/FacesContext;)Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
