...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/myfaces/config/element/FacesConfigExtension", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getFaceletsProcessingList", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/myfaces/config/element/FaceletsProcessing;>;", null);
methodVisitor.visitEnd();
}
{
