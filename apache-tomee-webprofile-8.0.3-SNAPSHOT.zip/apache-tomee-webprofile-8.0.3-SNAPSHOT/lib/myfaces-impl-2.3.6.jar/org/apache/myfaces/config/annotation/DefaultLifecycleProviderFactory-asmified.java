...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLifecycleProvider", "(Ljavax/faces/context/ExternalContext;)Lorg/apache/myfaces/config/annotation/LifecycleProvider;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/annotation/DefaultLifecycleProviderFactory", "resolveLifecycleProviderFromExternalContext", "(Ljavax/faces/context/ExternalContext;)Z", false);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNE, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/annotation/DefaultLifecycleProviderFactory", "resolveLifecycleProviderFromService", "(Ljavax/faces/context/ExternalContext;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveLifecycleProviderFromExternalContext", "(Ljavax/faces/context/ExternalContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/annotation/DefaultLifecycleProviderFactory", "createClass", "(Ljava/lang/String;Ljavax/faces/context/ExternalContext;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveLifecycleProviderFromService", "(Ljavax/faces/context/ExternalContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/annotation/DefaultLifecycleProviderFactory$1", "<init>", "(Lorg/apache/myfaces/config/annotation/DefaultLifecycleProviderFactory;Ljavax/faces/context/ExternalContext;)V", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/config/annotation/DefaultLifecycleProviderFactory", "java/lang/String", "javax/faces/context/ExternalContext", "java/lang/Class"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
