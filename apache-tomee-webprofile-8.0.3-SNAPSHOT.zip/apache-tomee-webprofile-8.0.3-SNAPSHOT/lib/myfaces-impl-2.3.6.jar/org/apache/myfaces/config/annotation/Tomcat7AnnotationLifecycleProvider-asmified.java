...
public class Tomcat7AnnotationLifecycleProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider", null, "java/lang/Object", new String[] { "org/apache/myfaces/config/annotation/DiscoverableLifecycleProvider", "org/apache/myfaces/config/annotation/LifecycleProvider2" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider", "instanceManagers", "Ljava/util/WeakHashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "newInstance", "(Ljava/lang/String;)Ljava/lang/Object;", null, new String[] { "java/lang/ClassNotFoundException", "java/lang/IllegalAccessException", "java/lang/InstantiationException", "javax/naming/NamingException", "java/lang/reflect/InvocationTargetException" });
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider", "log", "Ljava/util/logging/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider", "instanceManagers", "Ljava/util/WeakHashMap;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider", "initManager", "()Lorg/apache/tomcat/InstanceManager;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/logging/Logger", "getLogger", "(Ljava/lang/String;)Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/config/annotation/Tomcat7AnnotationLifecycleProvider", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
