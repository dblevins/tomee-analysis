...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/myfaces/shared/context/ResponseWriterWrapper", null, "javax/faces/context/ResponseWriter", null);

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "_responseWriter", "Ljavax/faces/context/ResponseWriter;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/context/ResponseWriterWrapper", "_responseWriter", "Ljavax/faces/context/ResponseWriter;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/ResponseWriterWrapper", "_responseWriter", "Ljavax/faces/context/ResponseWriter;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "cloneWithWriter", "(Ljava/io/Writer;)Ljavax/faces/context/ResponseWriter;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ResponseWriter", "write", "(I)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/ResponseWriterWrapper", "_responseWriter", "Ljavax/faces/context/ResponseWriter;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ResponseWriter", "write", "([C)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ResponseWriter", "write", "(Ljava/lang/String;II)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
