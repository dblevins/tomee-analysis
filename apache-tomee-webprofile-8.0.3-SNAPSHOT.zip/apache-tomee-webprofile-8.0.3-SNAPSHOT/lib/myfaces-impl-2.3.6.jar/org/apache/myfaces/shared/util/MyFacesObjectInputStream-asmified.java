...
public class MyFacesObjectInputStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/shared/util/MyFacesObjectInputStream", null, "java/io/ObjectInputStream", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "resolveClass", "(Ljava/io/ObjectStreamClass;)Ljava/lang/Class;", null, new String[] { "java/lang/ClassNotFoundException", "java/io/IOException" });
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/myfaces/shared/util/MyFacesObjectInputStream;"));
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/shared/util/MyFacesObjectInputStream", "[Ljava/lang/String;", "[Ljava/lang/Class;", "java/lang/Exception"}, 1, new Object[] {"java/lang/IllegalArgumentException"});
