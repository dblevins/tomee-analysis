...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/shared/util/SelectItemsIterator", "Ljava/lang/Object;Ljava/util/Iterator<Ljavax/faces/model/SelectItem;>;", "java/lang/Object", new String[] { "java/util/Iterator" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator", "javax/faces/component/UIComponent", "javax/faces/context/FacesContext"}, 1, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator", "javax/faces/component/UIComponent", "javax/faces/context/FacesContext"}, 2, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator", "java/util/Iterator"});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_nextItem", "Ljavax/faces/model/SelectItem;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_currentComponent", "Ljavax/faces/component/UIComponent;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator", "javax/faces/component/UIComponent", "javax/faces/component/UISelectItem", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator", "javax/faces/component/UIComponent", "javax/faces/component/UISelectItem", "java/lang/Object", "javax/el/ValueExpression"}, 3, new Object[] {label11, label11, "java/lang/StringBuilder"});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/el/ValueExpression", "getExpressionString", "()Ljava/lang/String;", false);
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/shared/util/SelectItemsIterator", "javax/faces/component/UIComponent", "javax/faces/component/UISelectItem", "java/lang/Object", "javax/el/ValueExpression"}, 4, new Object[] {label11, label11, "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitLdcInsn("' of UISelectItem : ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/util/DebugUtils", "getPathToComponent", "(Ljavax/faces/component/UIComponent;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_nextItem", "Ljavax/faces/model/SelectItem;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_currentComponent", "Ljavax/faces/component/UIComponent;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_currentUISelectItems", "Ljavax/faces/component/UISelectItems;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_currentUISelectItems", "Ljavax/faces/component/UISelectItems;");
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/shared/util/SelectItemsIterator", "getBooleanAttribute", "(Ljavax/faces/component/UIComponent;Ljava/lang/String;Z)Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/util/SelectItemsIterator", "_currentComponent", "Ljavax/faces/component/UIComponent;");
methodVisitor.visitInsn(ARETURN);
