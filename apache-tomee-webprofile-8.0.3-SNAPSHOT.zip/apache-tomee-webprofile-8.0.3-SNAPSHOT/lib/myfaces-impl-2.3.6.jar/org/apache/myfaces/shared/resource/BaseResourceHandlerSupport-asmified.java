...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "calculateResourceBasePath", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/shared/resource/BaseResourceHandlerSupport", "getFacesServletMapping", "(Ljavax/faces/context/FacesContext;)Lorg/apache/myfaces/shared/application/FacesServletMapping;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/myfaces/shared/application/FacesServletMapping", "javax/faces/context/ExternalContext", "java/lang/String"}, 0, null);
