...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/xml/bind/ServiceLoaderUtil", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "firstByServiceLoader", "(Ljava/lang/Class;Ljava/util/logging/Logger;Ljakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler;)Ljava/lang/Object;", "<P:Ljava/lang/Object;T:Ljava/lang/Exception;>(Ljava/lang/Class<TP;>;Ljava/util/logging/Logger;Ljakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler<TT;>;)TP;^TT;", new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler", "createException", "(Ljava/lang/Throwable;Ljava/lang/String;)Ljava/lang/Exception;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "newInstance", "(Ljava/lang/String;Ljava/lang/String;Ljakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler;)Ljava/lang/Object;", "<T:Ljava/lang/Exception;>(Ljava/lang/String;Ljava/lang/String;Ljakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler<TT;>;)Ljava/lang/Object;^TT;", new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/bind/ServiceLoaderUtil", "contextClassLoader", "(Ljakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler;)Ljava/lang/ClassLoader;", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/bind/ServiceLoaderUtil", "checkPackageAccess", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/bind/ServiceLoaderUtil", "nullSafeLoadClass", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Class;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "contextClassLoader", "(Ljakarta/xml/bind/ServiceLoaderUtil$ExceptionHandler;)Ljava/lang/ClassLoader;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
