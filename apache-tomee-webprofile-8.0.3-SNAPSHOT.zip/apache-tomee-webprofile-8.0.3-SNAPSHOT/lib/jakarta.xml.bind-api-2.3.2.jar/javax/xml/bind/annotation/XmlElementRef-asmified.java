...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/bind/annotation/XmlElementRef", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit(null, Type.getType("Ljavax/xml/bind/annotation/XmlElementRef$DEFAULT;"));
annotationVisitor0.visitEnd();
}
