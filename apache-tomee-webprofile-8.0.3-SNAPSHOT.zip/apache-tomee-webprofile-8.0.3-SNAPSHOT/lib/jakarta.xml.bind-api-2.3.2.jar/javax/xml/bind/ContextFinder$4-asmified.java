...
classWriter.visit(V1_8, ACC_SUPER, "javax/xml/bind/ContextFinder$4", null, "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/bind/ContextFinder$4", "val$c", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/bind/ContextFinder$4", "val$c", "Ljava/lang/Class;");
