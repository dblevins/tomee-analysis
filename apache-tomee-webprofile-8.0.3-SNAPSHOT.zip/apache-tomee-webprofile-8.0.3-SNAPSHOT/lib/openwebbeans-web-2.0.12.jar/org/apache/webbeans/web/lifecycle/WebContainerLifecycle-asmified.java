...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/web/lifecycle/WebContainerLifecycle", "getServletContext", "(Ljava/lang/Object;)Ljakarta/servlet/ServletContext;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/web/lifecycle/ServletContextBean", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljakarta/servlet/ServletContext;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/web/lifecycle/WebContainerLifecycle", "setJspELFactory", "(Ljakarta/servlet/ServletContext;Ljava/lang/Object;)V", false);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/web/lifecycle/WebContainerLifecycle", "getBeanManager", "()Ljakarta/enterprise/inject/spi/BeanManager;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/web/lifecycle/WebContainerLifecycle", "java/lang/Object", "jakarta/servlet/ServletContext"}, 2, new Object[] {"org/apache/webbeans/container/BeanManagerImpl", "java/lang/Object"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getServletContext", "(Ljava/lang/Object;)Ljakarta/servlet/ServletContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/servlet/ServletContextEvent");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setJspELFactory", "(Ljakarta/servlet/ServletContext;Ljava/lang/Object;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/webbeans/web/lifecycle/WebContainerLifecycle", "jakarta/servlet/ServletContext", "java/lang/Object", "jakarta/servlet/jsp/JspFactory"}, 1, new Object[] {"java/lang/Throwable"});
