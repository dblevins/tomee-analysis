...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/servlet/WebBeansConfigurationListener$Auto", null, "java/lang/Object", new String[] { "javax/servlet/ServletContainerInitializer" });
...
methodVisitor.visitTypeInsn(NEW, "javax/servlet/ServletContextEvent");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/ServletContextEvent", "<init>", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/servlet/WebBeansConfigurationListener", "access$000", "(Lorg/apache/webbeans/servlet/WebBeansConfigurationListener;Ljavax/servlet/ServletContextEvent;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
