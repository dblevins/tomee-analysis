...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/activation/URLDataSource", null, "java/lang/Object", new String[] { "jakarta/activation/DataSource" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/activation/URLDataSource", "url", "Ljava/net/URL;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/activation/URLDataSource", "url_conn", "Ljava/net/URLConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/activation/URLDataSource", "url_conn", "Ljava/net/URLConnection;");
methodVisitor.visitJumpInsn(IFNONNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/activation/URLDataSource", "url", "Ljava/net/URL;");
