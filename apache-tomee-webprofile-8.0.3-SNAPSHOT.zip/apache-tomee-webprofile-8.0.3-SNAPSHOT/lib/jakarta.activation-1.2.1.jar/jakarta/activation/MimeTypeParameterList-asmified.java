...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/activation/MimeTypeParameterList", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/activation/MimeTypeParameterList", "parameters", "Ljava/util/Hashtable;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/activation/MimeTypeParameterList", "parse", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "parse", "(Ljava/lang/String;)V", null, new String[] { "jakarta/activation/MimeTypeParseException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/activation/MimeTypeParameterList", "skipWhiteSpace", "(Ljava/lang/String;I)I", false);
...
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "charAt", "(I)C", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/activation/MimeTypeParameterList", "isTokenChar", "(C)Z", false);
...
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "substring", "(II)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/activation/MimeTypeParameterList", "unquote", "(Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/activation/MimeTypeParameterList", "parameters", "Ljava/util/Hashtable;");
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Hashtable", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/activation/MimeTypeParameterList", "quote", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitInsn(POP);
