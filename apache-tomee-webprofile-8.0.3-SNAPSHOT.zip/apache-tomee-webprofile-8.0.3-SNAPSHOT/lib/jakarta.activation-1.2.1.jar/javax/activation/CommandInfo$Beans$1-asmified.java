...
public class CommandInfo$Beans$1Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "javax/activation/CommandInfo$Beans$1", null, "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
classWriter.visitInnerClass("javax/activation/CommandInfo$Beans", "javax/activation/CommandInfo", "Beans", ACC_PRIVATE | ACC_FINAL | ACC_STATIC);

classWriter.visitInnerClass("javax/activation/CommandInfo$Beans$1", null, null, ACC_STATIC);
