...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "javax/activation/SecuritySupport$5", null, "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });

classWriter.visitOuterClass("javax/activation/SecuritySupport", "openStream", "(Ljava/net/URL;)Ljava/io/InputStream;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/activation/SecuritySupport$5", "val$url", "Ljava/net/URL;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/activation/SecuritySupport$5", "val$url", "Ljava/net/URL;");
