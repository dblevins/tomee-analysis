...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/servlet/AbstractHTTPServlet", "init", "(Ljakarta/servlet/ServletConfig;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/CXFNonSpringServlet", "loadBus", "(Ljakarta/servlet/ServletConfig;)V", false);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/CXFNonSpringServlet", "registerServletContextResolver", "(Ljakarta/servlet/ServletConfig;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/CXFNonSpringServlet", "createServletController", "(Ljakarta/servlet/ServletConfig;)Lorg/apache/cxf/transport/servlet/ServletController;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/CXFNonSpringServlet", "finalizeServletInit", "(Ljakarta/servlet/ServletConfig;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/servlet/AbstractHTTPServlet", "finalizeServletInit", "(Ljakarta/servlet/ServletConfig;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/servlet/CXFNonSpringServlet", "destinationRegistry", "Lorg/apache/cxf/transport/http/DestinationRegistry;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "registerServletContextResolver", "(Ljakarta/servlet/ServletConfig;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/servlet/ServletContextResourceResolver", "<init>", "(Ljakarta/servlet/ServletContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createServletController", "(Ljakarta/servlet/ServletConfig;)Lorg/apache/cxf/transport/servlet/ServletController;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/servlet/ServletController", "<init>", "(Lorg/apache/cxf/transport/http/DestinationRegistry;Ljakarta/servlet/ServletConfig;Ljakarta/servlet/http/HttpServlet;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/servlet/CXFNonSpringServlet$HttpServletRequestFilter", "<init>", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/servlet/http/HttpServletResponse");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/ServletController", "filter", "(Ljakarta/servlet/http/HttpServletRequest;Ljakarta/servlet/http/HttpServletResponse;)Z", false);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "invoke", "(Ljakarta/servlet/http/HttpServletRequest;Ljakarta/servlet/http/HttpServletResponse;)V", null, new String[] { "jakarta/servlet/ServletException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/ServletController", "invoke", "(Ljakarta/servlet/http/HttpServletRequest;Ljakarta/servlet/http/HttpServletResponse;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/servlet/CXFNonSpringServlet", "bus", "Lorg/apache/cxf/Bus;");
