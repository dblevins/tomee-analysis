...
public class ServletDestinationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/transport/servlet/ServletDestination", null, "org/apache/cxf/transport/http/AbstractHTTPDestination", new String[] { "org/apache/cxf/transport/servlet/ServletConfigAware" });
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/transport/servlet/ServletDestination", "LOG", "Ljava/util/logging/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/servlet/ServletDestination", "getAddress", "()Lorg/apache/cxf/ws/addressing/EndpointReferenceType;", false);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/transport/servlet/ServletDestination;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/LogUtils", "getL7dLogger", "(Ljava/lang/Class;)Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/transport/servlet/ServletDestination", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
