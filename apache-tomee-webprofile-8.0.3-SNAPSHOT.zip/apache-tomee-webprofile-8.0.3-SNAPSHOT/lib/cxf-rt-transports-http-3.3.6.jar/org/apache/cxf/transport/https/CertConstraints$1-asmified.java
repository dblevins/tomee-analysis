...
public class CertConstraints$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/cxf/transport/https/CertConstraints$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/cxf/transport/https/CertConstraints", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$cxf$transport$https$CertConstraints$Combinator", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/transport/https/CertConstraints$Combinator", "values", "()[Lorg/apache/cxf/transport/https/CertConstraints$Combinator;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/transport/https/CertConstraints$1", "$SwitchMap$org$apache$cxf$transport$https$CertConstraints$Combinator", "[I");
