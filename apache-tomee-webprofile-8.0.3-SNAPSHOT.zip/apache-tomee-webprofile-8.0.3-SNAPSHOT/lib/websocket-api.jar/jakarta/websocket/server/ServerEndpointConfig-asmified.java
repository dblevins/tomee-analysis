...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/websocket/server/ServerEndpointConfig", null, "java/lang/Object", new String[] { "jakarta/websocket/EndpointConfig" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getConfigurator", "()Ljakarta/websocket/server/ServerEndpointConfig$Configurator;", null, null);
methodVisitor.visitEnd();
}
