...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/websocket/server/ServerEndpoint", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "configurator", "()Ljava/lang/Class;", "()Ljava/lang/Class<+Ljakarta/websocket/server/ServerEndpointConfig$Configurator;>;", null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Ljakarta/websocket/server/ServerEndpointConfig$Configurator;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
