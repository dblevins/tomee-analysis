...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/ctc/wstx/api/ValidatorConfig", null, "com/ctc/wstx/api/CommonConfig", null);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "sInstance", "Lcom/ctc/wstx/api/ValidatorConfig;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lcom/ctc/wstx/api/ValidatorConfig;)V", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createDefaults", "()Lcom/ctc/wstx/api/ValidatorConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "com/ctc/wstx/api/ValidatorConfig", "sInstance", "Lcom/ctc/wstx/api/ValidatorConfig;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getProperty", "(I)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setProperty", "(Ljava/lang/String;ILjava/lang/Object;)Z", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/ctc/wstx/api/ValidatorConfig");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/ctc/wstx/api/ValidatorConfig", "<init>", "(Lcom/ctc/wstx/api/ValidatorConfig;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/ctc/wstx/api/ValidatorConfig", "sInstance", "Lcom/ctc/wstx/api/ValidatorConfig;");
methodVisitor.visitInsn(RETURN);
