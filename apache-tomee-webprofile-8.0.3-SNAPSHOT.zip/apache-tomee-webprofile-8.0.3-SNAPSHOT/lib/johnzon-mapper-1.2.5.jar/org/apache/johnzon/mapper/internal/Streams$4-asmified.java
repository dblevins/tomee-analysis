...
public class Streams$4Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/johnzon/mapper/internal/Streams$4", null, "java/io/InputStream", null);

classWriter.visitOuterClass("org/apache/johnzon/mapper/internal/Streams", "noClose", "(Ljava/io/InputStream;)Ljava/io/InputStream;");

classWriter.visitInnerClass("org/apache/johnzon/mapper/internal/Streams$4", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$from", "Ljava/io/InputStream;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/internal/Streams$4", "val$from", "Ljava/io/InputStream;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/internal/Streams$4", "val$from", "Ljava/io/InputStream;");
methodVisitor.visitVarInsn(ALOAD, 1);
