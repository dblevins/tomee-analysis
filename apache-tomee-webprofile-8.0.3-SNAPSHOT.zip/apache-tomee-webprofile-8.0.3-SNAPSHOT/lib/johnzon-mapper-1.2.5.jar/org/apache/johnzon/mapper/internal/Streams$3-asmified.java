...
public class Streams$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/johnzon/mapper/internal/Streams$3", null, "java/io/OutputStream", null);

classWriter.visitOuterClass("org/apache/johnzon/mapper/internal/Streams", "noClose", "(Ljava/io/OutputStream;)Ljava/io/OutputStream;");

classWriter.visitInnerClass("org/apache/johnzon/mapper/internal/Streams$3", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$from", "Ljava/io/OutputStream;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/internal/Streams$3", "val$from", "Ljava/io/OutputStream;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/internal/Streams$3", "val$from", "Ljava/io/OutputStream;");
