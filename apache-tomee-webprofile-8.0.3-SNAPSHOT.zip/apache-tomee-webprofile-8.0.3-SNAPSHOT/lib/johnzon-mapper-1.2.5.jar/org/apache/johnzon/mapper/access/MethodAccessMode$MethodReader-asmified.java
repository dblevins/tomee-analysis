...
public class MethodAccessMode$MethodReaderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/mapper/access/MethodAccessMode$MethodReader", null, "org/apache/johnzon/mapper/access/MethodAccessMode$MethodDecoratedType", new String[] { "org/apache/johnzon/mapper/access/AccessMode$Reader" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/mapper/access/MethodAccessMode$MethodDecoratedType", "<init>", "(Ljava/lang/reflect/Method;Ljava/lang/reflect/Type;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/access/MethodAccessMode$MethodReader", "method", "Ljava/lang/reflect/Method;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLdcInsn("Error calling ");
