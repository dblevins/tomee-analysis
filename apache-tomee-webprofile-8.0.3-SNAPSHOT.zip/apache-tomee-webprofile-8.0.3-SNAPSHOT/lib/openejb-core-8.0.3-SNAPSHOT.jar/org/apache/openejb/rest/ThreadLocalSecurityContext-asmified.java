...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/rest/ThreadLocalSecurityContext", "Lorg/apache/openejb/rest/AbstractRestThreadLocalProxy<Ljavax/ws/rs/core/SecurityContext;>;Ljavax/ws/rs/core/SecurityContext;", "org/apache/openejb/rest/AbstractRestThreadLocalProxy", new String[] { "javax/ws/rs/core/SecurityContext" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "defaultUser", "Ljava/lang/String;", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/rest/ThreadLocalSecurityContext", "service", "()Lorg/apache/openejb/spi/SecurityService;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/security/AbstractSecurityService", "getDefaultUser", "()Ljava/lang/String;", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openejb/rest/ThreadLocalSecurityContext", "org/apache/openejb/spi/SecurityService"}, 1, new Object[] {"org/apache/openejb/rest/ThreadLocalSecurityContext"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openejb/rest/ThreadLocalSecurityContext", "org/apache/openejb/spi/SecurityService"}, 2, new Object[] {"org/apache/openejb/rest/ThreadLocalSecurityContext", "java/lang/String"});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/rest/ThreadLocalSecurityContext", "defaultUser", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "service", "()Lorg/apache/openejb/spi/SecurityService;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/rest/ThreadLocalSecurityContext", "get", "()Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/rest/ThreadLocalSecurityContext", "defaultUser", "Ljava/lang/String;");
