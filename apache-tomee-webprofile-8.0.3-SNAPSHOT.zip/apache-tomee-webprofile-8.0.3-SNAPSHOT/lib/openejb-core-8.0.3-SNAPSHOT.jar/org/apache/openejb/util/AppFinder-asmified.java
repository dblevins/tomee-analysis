...
public class AppFinderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/openejb/util/AppFinder", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "findAppContextOrWeb", "(Ljava/lang/ClassLoader;Lorg/apache/openejb/util/AppFinder$Transformer;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/ClassLoader;Lorg/apache/openejb/util/AppFinder$Transformer<TT;>;)TT;", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/AppContext", "java/lang/ClassLoader", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/util/AppFinder$Transformer", "from", "(Lorg/apache/openejb/AppContext;)Ljava/lang/Object;", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/util/AppFinder$Transformer", "from", "(Lorg/apache/openejb/core/WebContext;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
