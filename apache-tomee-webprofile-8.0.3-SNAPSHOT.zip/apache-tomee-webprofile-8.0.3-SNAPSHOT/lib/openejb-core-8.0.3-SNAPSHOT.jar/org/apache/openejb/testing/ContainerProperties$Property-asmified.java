...
public class ContainerProperties$PropertyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/openejb/testing/ContainerProperties$Property", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "IGNORED", "Ljava/lang/String;", null, "__not__set__so__ignored");
...
annotationVisitor0.visit(null, "__not__set__so__ignored");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
