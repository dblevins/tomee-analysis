...
public class AnnotationDeployer$MethodMemberDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/AnnotationDeployer$MethodMember", null, "java/lang/Object", new String[] { "org/apache/openejb/config/AnnotationDeployer$Member" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/AnnotationDeployer$MethodMember", "setter", "Ljava/lang/reflect/Method;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/AnnotationDeployer$MethodMember", "setter", "Ljava/lang/reflect/Method;");
