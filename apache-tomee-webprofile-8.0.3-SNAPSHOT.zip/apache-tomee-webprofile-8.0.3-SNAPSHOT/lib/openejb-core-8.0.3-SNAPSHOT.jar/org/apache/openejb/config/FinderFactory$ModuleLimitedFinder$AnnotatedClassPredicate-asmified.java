...
public class FinderFactory$ModuleLimitedFinder$AnnotatedClassPredicateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$AnnotatedClassPredicate", "Lorg/apache/openejb/config/FinderFactory$ModuleLimitedFinder$Predicate<Lorg/apache/xbean/finder/Annotated<Ljava/lang/Class<*>;>;>;", "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$Predicate", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "name", "(Lorg/apache/xbean/finder/Annotated;)Ljava/lang/String;", "(Lorg/apache/xbean/finder/Annotated<Ljava/lang/Class<*>;>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$AnnotatedClassPredicate", "name", "(Lorg/apache/xbean/finder/Annotated;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
