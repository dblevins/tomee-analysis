...
public class VmDeploymentManager$DeploymentStatusImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", null, "java/lang/Object", new String[] { "jakarta/enterprise/deploy/spi/status/DeploymentStatus" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "command", "Ljakarta/enterprise/deploy/shared/CommandType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "state", "Ljakarta/enterprise/deploy/shared/StateType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "message", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "command", "Ljakarta/enterprise/deploy/shared/CommandType;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "message", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "state", "Ljakarta/enterprise/deploy/shared/StateType;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
