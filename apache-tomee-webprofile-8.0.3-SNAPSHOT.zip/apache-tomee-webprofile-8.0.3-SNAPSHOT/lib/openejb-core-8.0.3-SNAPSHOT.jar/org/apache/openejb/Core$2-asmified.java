...
public class Core$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/Core$2", null, "java/lang/Thread", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/ServiceUtils", "getServiceProviders", "()Ljava/util/List;", false);
