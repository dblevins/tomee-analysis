...
public class MathRuntimeException$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/math/MathRuntimeException$1", null, "java/lang/ArithmeticException", null);

classWriter.visitOuterClass("org/apache/openejb/math/MathRuntimeException", "createArithmeticException", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/ArithmeticException;");

classWriter.visitInnerClass("org/apache/openejb/math/MathRuntimeException$1", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(7705628723242533939L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/math/MathRuntimeException$1", "val$pattern", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/math/MathRuntimeException$1", "val$arguments", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/math/MathRuntimeException$1", "val$pattern", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/math/MathRuntimeException$1", "val$arguments", "[Ljava/lang/Object;");
