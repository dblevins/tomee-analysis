...
public class LazyEjbReference$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openejb/assembler/classic/LazyEjbReference$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openejb/assembler/classic/LazyEjbReference", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$assembler$classic$EjbResolver$Type", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/assembler/classic/EjbResolver$Type", "values", "()[Lorg/apache/openejb/assembler/classic/EjbResolver$Type;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/assembler/classic/LazyEjbReference$1", "$SwitchMap$org$apache$openejb$assembler$classic$EjbResolver$Type", "[I");
