...
public class BeansInfo$ExclusionEntryInfoDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/assembler/classic/BeansInfo$ExclusionEntryInfo", null, "org/apache/openejb/assembler/classic/InfoObject", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "exclusion", "Lorg/apache/openejb/assembler/classic/ExclusionInfo;", null, null);
fieldVisitor.visitEnd();
}
{
