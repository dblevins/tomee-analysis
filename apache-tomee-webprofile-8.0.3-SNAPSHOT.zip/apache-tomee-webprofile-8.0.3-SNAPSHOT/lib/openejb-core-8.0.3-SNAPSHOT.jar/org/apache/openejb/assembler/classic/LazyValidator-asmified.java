...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "factory", "Ljakarta/validation/ValidatorFactory;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE | ACC_TRANSIENT, "validator", "Ljakarta/validation/Validator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/assembler/classic/LazyValidator", "factory", "Ljakarta/validation/ValidatorFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/LazyValidator", "validator", "Ljakarta/validation/Validator;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/LazyValidator", "factory", "Ljakarta/validation/ValidatorFactory;");
Label label6 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/LazyValidator", "findFactory", "()Ljakarta/validation/ValidatorFactory;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openejb/assembler/classic/LazyValidator", "java/lang/Object"}, 2, new Object[] {"org/apache/openejb/assembler/classic/LazyValidator", "jakarta/validation/ValidatorFactory"});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/assembler/classic/LazyValidator", "validator", "Ljakarta/validation/Validator;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findFactory", "()Ljakarta/validation/ValidatorFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
