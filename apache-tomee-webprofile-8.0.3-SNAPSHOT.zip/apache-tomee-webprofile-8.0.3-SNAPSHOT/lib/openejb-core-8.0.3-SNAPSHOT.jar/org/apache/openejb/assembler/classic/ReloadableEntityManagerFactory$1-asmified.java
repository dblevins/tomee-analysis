...
public class ReloadableEntityManagerFactory$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$assembler$classic$ReloadableEntityManagerFactory$JMXReloadableEntityManagerFactory$Info", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$JMXReloadableEntityManagerFactory$Info", "values", "()[Lorg/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$JMXReloadableEntityManagerFactory$Info;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$1", "$SwitchMap$org$apache$openejb$assembler$classic$ReloadableEntityManagerFactory$JMXReloadableEntityManagerFactory$Info", "[I");
