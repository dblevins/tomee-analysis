...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "context", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Ljakarta/jms/JMSContext;", null, null);
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "newKey", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Lorg/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$Key;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "newKey", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Lorg/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$Key;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/jms/JMSConnectionFactory;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/jms/JMSConnectionFactory");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/jms/JMSSessionMode;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/Annotated", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/jms/JMSSessionMode");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/jms/JMSPasswordCredential;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/Annotated", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/jms/JMSPasswordCredential");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/Annotated", "jakarta/jms/JMSConnectionFactory", "jakarta/jms/JMSSessionMode", "jakarta/jms/JMSPasswordCredential"}, 1, new Object[] {"java/lang/StringBuilder"});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/JMSConnectionFactory", "value", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/Annotated", "jakarta/jms/JMSConnectionFactory", "jakarta/jms/JMSSessionMode", "jakarta/jms/JMSPasswordCredential"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/JMSPasswordCredential", "userName", "()Ljava/lang/String;", true);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/Annotated", "jakarta/jms/JMSConnectionFactory", "jakarta/jms/JMSSessionMode", "jakarta/jms/JMSPasswordCredential", "java/lang/String"}, 3, new Object[] {label2, label2, "java/lang/String"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/Annotated", "jakarta/jms/JMSConnectionFactory", "jakarta/jms/JMSSessionMode", "jakarta/jms/JMSPasswordCredential", "java/lang/String"}, 4, new Object[] {label2, label2, "java/lang/String", "java/lang/String"});
methodVisitor.visitVarInsn(ALOAD, 5);
Label label5 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/JMSPasswordCredential", "password", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/Annotated", "jakarta/jms/JMSConnectionFactory", "jakarta/jms/JMSSessionMode", "jakarta/jms/JMSPasswordCredential", "java/lang/String"}, 5, new Object[] {label2, label2, "java/lang/String", "java/lang/String", "java/lang/String"});
methodVisitor.visitVarInsn(ALOAD, 4);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label7);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/JMSSessionMode", "value", "()I", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/resource/activemq/jms2/cdi/JMS2CDIExtension$ContextProducer", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/Annotated", "jakarta/jms/JMSConnectionFactory", "jakarta/jms/JMSSessionMode", "jakarta/jms/JMSPasswordCredential", "java/lang/String"}, 6, new Object[] {label2, label2, "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/Integer"});
