...
public class OpenshiftMySQLPropertiesProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/resource/openshift/OpenshiftMySQLPropertiesProvider", null, "java/lang/Object", new String[] { "org/apache/openejb/api/resource/PropertiesResourceProvider" });
...
methodVisitor.visitLdcInsn("jdbc:mysql://%s:%s/%s?tcpKeepAlive=true");
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLdcInsn("OPENSHIFT_MYSQL_DB_HOST");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getenv", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn("OPENSHIFT_MYSQL_DB_PORT");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getenv", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitLdcInsn("OPENSHIFT_MYSQL_DB_USERNAME");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getenv", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/testng/PropertiesBuilder", "p", "(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/openejb/testng/PropertiesBuilder;", false);
methodVisitor.visitLdcInsn("Password");
methodVisitor.visitLdcInsn("OPENSHIFT_MYSQL_DB_PASSWORD");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getenv", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/testng/PropertiesBuilder", "p", "(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/openejb/testng/PropertiesBuilder;", false);
