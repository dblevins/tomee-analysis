...
public class NotSupportedInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/cdi/transactional/NotSupportedInterceptor", null, "org/apache/openejb/cdi/transactional/InterceptorBase", null);
...
annotationVisitor0.visitEnum("value", "Ljakarta/transaction/Transactional$TxType;", "NOT_SUPPORTED");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/transactional/NotSupportedInterceptor", "getTransactionManager", "()Ljakarta/transaction/TransactionManager;", false);
