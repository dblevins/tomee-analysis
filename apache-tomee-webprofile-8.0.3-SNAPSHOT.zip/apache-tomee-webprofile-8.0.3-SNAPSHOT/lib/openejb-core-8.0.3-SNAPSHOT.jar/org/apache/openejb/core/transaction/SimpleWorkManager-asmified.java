...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/transaction/SimpleWorkManager", null, "java/lang/Object", new String[] { "jakarta/resource/spi/work/WorkManager" });
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/SimpleWorkManager", "doWork", "(Ljakarta/resource/spi/work/Work;JLjakarta/resource/spi/work/ExecutionContext;Ljakarta/resource/spi/work/WorkListener;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/transaction/SimpleWorkManager", "executeWork", "(Lorg/apache/openejb/core/transaction/SimpleWorkManager$WorkType;Ljakarta/resource/spi/work/Work;JLjakarta/resource/spi/work/ExecutionContext;Ljakarta/resource/spi/work/WorkListener;)J", false);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/SimpleWorkManager", "startWork", "(Ljakarta/resource/spi/work/Work;JLjakarta/resource/spi/work/ExecutionContext;Ljakarta/resource/spi/work/WorkListener;)J", false);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/SimpleWorkManager", "scheduleWork", "(Ljakarta/resource/spi/work/Work;JLjakarta/resource/spi/work/ExecutionContext;Ljakarta/resource/spi/work/WorkListener;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(6, 2);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "executeWork", "(Lorg/apache/openejb/core/transaction/SimpleWorkManager$WorkType;Ljakarta/resource/spi/work/Work;JLjakarta/resource/spi/work/ExecutionContext;Ljakarta/resource/spi/work/WorkListener;)J", null, new String[] { "jakarta/resource/spi/work/WorkException" });
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "<init>", "(Lorg/apache/openejb/core/transaction/SimpleWorkManager;Ljakarta/resource/spi/work/Work;Ljakarta/resource/spi/work/WorkListener;J)V", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/transaction/SimpleWorkManager", "org/apache/openejb/core/transaction/SimpleWorkManager$WorkType", "jakarta/resource/spi/work/Work", Opcodes.LONG, "jakarta/resource/spi/work/ExecutionContext", "jakarta/resource/spi/work/WorkListener", "org/apache/openejb/core/transaction/SimpleWorkManager$Worker"}, 1, new Object[] {"java/lang/InterruptedException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitTypeInsn(NEW, "jakarta/resource/spi/work/WorkException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/resource/spi/work/WorkException", "setErrorCode", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "getWorkException", "()Ljakarta/resource/spi/work/WorkException;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/resource/spi/work/WorkRejectedException");
