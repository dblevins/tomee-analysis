...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "<init>", "(Lorg/apache/openejb/BeanContext;Ljavax/transaction/TransactionManager;Lorg/apache/openejb/core/timer/TimerStore;I)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/BeanContext;Ljavax/transaction/TransactionManager;Lorg/apache/openejb/core/timer/TimerStore;I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "transactionManager", "Ljavax/transaction/TransactionManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/BeanContext", "javax/transaction/TransactionManager", "org/apache/openejb/core/timer/TimerStore", Opcodes.INTEGER, "org/apache/openejb/core/transaction/TransactionType"}, 1, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl"});
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "java/util/Collection", "java/util/Iterator", "org/apache/openejb/core/timer/TimerData", "org/apache/openejb/quartz/Trigger", "org/apache/openejb/quartz/TriggerKey"}, 1, new Object[] {"javax/ejb/EJBException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "log", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "transactionManager", "Ljavax/transaction/TransactionManager;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/timer/TimerData", "getTimer", "()Ljavax/ejb/Timer;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getTimers", "(Ljava/lang/Object;)Ljava/util/Collection;", "(Ljava/lang/Object;)Ljava/util/Collection<Ljavax/ejb/Timer;>;", new String[] { "java/lang/IllegalStateException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createTimer", "(Ljava/lang/Object;Ljava/lang/reflect/Method;JLjavax/ejb/TimerConfig;)Ljavax/ejb/Timer;", null, new String[] { "java/lang/IllegalArgumentException", "java/lang/IllegalStateException", "javax/ejb/EJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/timer/TimerStore", "createSingleActionTimer", "(Lorg/apache/openejb/core/timer/EjbTimerServiceImpl;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/reflect/Method;Ljava/util/Date;Ljavax/ejb/TimerConfig;)Lorg/apache/openejb/core/timer/TimerData;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "initializeNewTimer", "(Lorg/apache/openejb/core/timer/TimerData;)V", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "java/lang/Object", "java/lang/reflect/Method", Opcodes.LONG, "javax/ejb/TimerConfig", "java/util/Date"}, 1, new Object[] {"org/apache/openejb/core/timer/TimerStoreException"});
methodVisitor.visitVarInsn(ASTORE, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createTimer", "(Ljava/lang/Object;Ljava/lang/reflect/Method;JJLjavax/ejb/TimerConfig;)Ljavax/ejb/Timer;", null, new String[] { "java/lang/IllegalArgumentException", "java/lang/IllegalStateException", "javax/ejb/EJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(LLOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/timer/TimerStore", "createIntervalTimer", "(Lorg/apache/openejb/core/timer/EjbTimerServiceImpl;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/reflect/Method;Ljava/util/Date;JLjavax/ejb/TimerConfig;)Lorg/apache/openejb/core/timer/TimerData;", true);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "initializeNewTimer", "(Lorg/apache/openejb/core/timer/TimerData;)V", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "java/lang/Object", "java/lang/reflect/Method", Opcodes.LONG, Opcodes.LONG, "javax/ejb/TimerConfig", "java/util/Date"}, 1, new Object[] {"org/apache/openejb/core/timer/TimerStoreException"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitTypeInsn(NEW, "javax/ejb/EJBException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 9);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createTimer", "(Ljava/lang/Object;Ljava/lang/reflect/Method;Ljava/util/Date;Ljavax/ejb/TimerConfig;)Ljavax/ejb/Timer;", null, new String[] { "java/lang/IllegalArgumentException", "java/lang/IllegalStateException", "javax/ejb/EJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createTimer", "(Ljava/lang/Object;Ljava/lang/reflect/Method;Ljava/util/Date;JLjavax/ejb/TimerConfig;)Ljavax/ejb/Timer;", null, new String[] { "java/lang/IllegalArgumentException", "java/lang/IllegalStateException", "javax/ejb/EJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTryCatchBlock(label31, label32, label33, "javax/transaction/SystemException");
...
methodVisitor.visitTryCatchBlock(label42, label43, label44, "javax/transaction/SystemException");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/timer/TimerData", "getId", "()J", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "getTimer", "(J)Ljavax/ejb/Timer;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/core/timer/TimerData", "java/lang/Thread", "java/lang/ClassLoader", "javax/ejb/Timer"}, 1, new Object[] {"org/apache/openejb/core/timer/TimerStoreException"});
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/core/timer/TimerData", "java/lang/Thread", "java/lang/ClassLoader", "javax/ejb/Timer", Opcodes.INTEGER, Opcodes.INTEGER}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "log", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/core/timer/TimerData", "java/lang/Thread", "java/lang/ClassLoader", "javax/ejb/Timer", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/openejb/RpcContainer", "java/lang/reflect/Method"}, 2, new Object[] {"java/lang/Thread", "java/lang/ClassLoader"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Thread", "setContextClassLoader", "(Ljava/lang/ClassLoader;)V", false);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/core/timer/TimerData", "java/lang/Thread", "java/lang/ClassLoader", "javax/ejb/Timer", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/RuntimeException"}, 1, new Object[] {"javax/transaction/SystemException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "log", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/core/timer/TimerData", "java/lang/Thread", "java/lang/ClassLoader", "javax/ejb/Timer", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/timer/TimerData", "getType", "()Lorg/apache/openejb/core/timer/TimerType;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/timer/TimerType", "Calendar", "Lorg/apache/openejb/core/timer/TimerType;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/timer/EjbTimerServiceImpl", "org/apache/openejb/core/timer/TimerData", "java/lang/Thread", "java/lang/ClassLoader", "javax/ejb/Timer", Opcodes.INTEGER}, 0, new Object[] {});
