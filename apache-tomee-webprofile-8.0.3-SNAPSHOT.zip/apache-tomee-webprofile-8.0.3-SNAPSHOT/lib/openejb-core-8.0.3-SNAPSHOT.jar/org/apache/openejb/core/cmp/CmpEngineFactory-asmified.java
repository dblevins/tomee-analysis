...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setTransactionManager", "(Ljavax/transaction/TransactionManager;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setTransactionSynchronizationRegistry", "(Ljavax/transaction/TransactionSynchronizationRegistry;)V", null, null);
methodVisitor.visitEnd();
}
{
