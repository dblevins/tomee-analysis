...
public class MdbPoolContainerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/mdb/MdbPoolContainer", null, "java/lang/Object", new String[] { "org/apache/openejb/RpcContainer", "org/apache/openejb/core/mdb/BaseMdbContainer" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Object;Lorg/apache/openejb/spi/SecurityService;Ljavax/resource/spi/ResourceAdapter;Ljava/lang/Class;Ljava/lang/Class;ZLorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Pool$Builder;IZI)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "deployments", "Ljava/util/concurrent/ConcurrentMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/util/Properties");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/Properties", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "properties", "Ljava/util/Properties;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "containerID", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "resourceAdapter", "Ljavax/resource/spi/ResourceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "messageListenerInterface", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "activationSpecClass", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 6);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "failOnUnknownActivationSpec", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "xaResourceWrapper", "Lorg/apache/openejb/resource/XAResourceWrapper;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/loader/SystemInstance", "get", "()Lorg/apache/openejb/loader/SystemInstance;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "inboundRecovery", "Lorg/apache/openejb/core/mdb/InboundRecovery;");
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/mdb/MdbInstanceManager");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "inboundRecovery", "Lorg/apache/openejb/core/mdb/InboundRecovery;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "org/apache/openejb/spi/SecurityService", "javax/resource/spi/ResourceAdapter", "java/lang/Class", "java/lang/Class", Opcodes.INTEGER, "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER}, 11, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", label0, label0, "org/apache/openejb/spi/SecurityService", "javax/resource/spi/ResourceAdapter", "org/apache/openejb/core/mdb/InboundRecovery", "java/lang/Object", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "org/apache/openejb/spi/SecurityService", "javax/resource/spi/ResourceAdapter", "java/lang/Class", "java/lang/Class", Opcodes.INTEGER, "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER}, 12, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", label0, label0, "org/apache/openejb/spi/SecurityService", "javax/resource/spi/ResourceAdapter", "org/apache/openejb/core/mdb/InboundRecovery", "java/lang/Object", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, "java/util/concurrent/ScheduledExecutorService"});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbInstanceManager", "<init>", "(Lorg/apache/openejb/spi/SecurityService;Ljavax/resource/spi/ResourceAdapter;Lorg/apache/openejb/core/mdb/InboundRecovery;Ljava/lang/Object;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Pool$Builder;ILjava/util/concurrent/ScheduledExecutorService;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "instanceManager", "Lorg/apache/openejb/core/mdb/MdbInstanceManager;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(18, 13);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "deployments", "Ljava/util/concurrent/ConcurrentMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "containerID", "Ljava/lang/Object;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "resourceAdapter", "Ljavax/resource/spi/ResourceAdapter;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "messageListenerInterface", "Ljava/lang/Class;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "activationSpecClass", "Ljava/lang/Class;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "properties", "Ljava/util/Properties;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "createActivationSpec", "(Lorg/apache/openejb/BeanContext;)Ljavax/resource/spi/ActivationSpec;", false);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "instanceManager", "Lorg/apache/openejb/core/mdb/MdbInstanceManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "xaResourceWrapper", "Lorg/apache/openejb/resource/XAResourceWrapper;");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/EndpointFactory", "<init>", "(Ljavax/resource/spi/ActivationSpec;Lorg/apache/openejb/core/mdb/BaseMdbContainer;Lorg/apache/openejb/BeanContext;Lorg/apache/openejb/core/mdb/MdbInstanceFactory;Lorg/apache/openejb/core/mdb/MdbInstanceManager;Lorg/apache/openejb/resource/XAResourceWrapper;Z)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbInstanceManager", "deploy", "(Lorg/apache/openejb/BeanContext;Ljavax/resource/spi/ActivationSpec;Lorg/apache/openejb/core/mdb/EndpointFactory;)V", false);
methodVisitor.visitLabel(label1);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "javax/resource/spi/ActivationSpec", "org/apache/openejb/core/mdb/EndpointFactory"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createActivationSpec", "(Lorg/apache/openejb/BeanContext;)Ljavax/resource/spi/ActivationSpec;", null, new String[] { "org/apache/openejb/OpenEJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "failOnUnknownActivationSpec", "Z");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/resource/spi/ActivationSpec", "java/util/Set", "java/lang/String"}, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "resourceAdapter", "Ljavax/resource/spi/ResourceAdapter;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ActivationSpec", "setResourceAdapter", "(Ljavax/resource/spi/ResourceAdapter;)V", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLabel(label7);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/OpenEJBException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "instanceManager", "Lorg/apache/openejb/core/mdb/MdbInstanceManager;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbInstanceManager", "undeploy", "(Lorg/apache/openejb/BeanContext;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/BeanContext", "setContainer", "(Lorg/apache/openejb/Container;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "getBeanContext", "(Ljava/lang/Object;)Lorg/apache/openejb/BeanContext;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "beforeDelivery", "(Lorg/apache/openejb/BeanContext;Ljava/lang/Object;Ljava/lang/reflect/Method;Ljavax/transaction/xa/XAResource;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;Lorg/apache/openejb/InterfaceType;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "afterDelivery", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbInstanceManager", "discardInstance", "(Lorg/apache/openejb/core/ThreadContext;Ljava/lang/Object;)V", false);
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "org/apache/openejb/InterfaceType", "java/lang/Class", "java/lang/reflect/Method", "[Ljava/lang/Object;", "java/lang/Object", "org/apache/openejb/BeanContext", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/mdb/Instance", "java/lang/Object", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "instanceManager", "Lorg/apache/openejb/core/mdb/MdbInstanceManager;");
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "org/apache/openejb/InterfaceType", "java/lang/Class", "java/lang/reflect/Method", "[Ljava/lang/Object;", "java/lang/Object", "org/apache/openejb/BeanContext", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/mdb/Instance"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "<init>", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$1;)V", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;"));
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "access$102", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "access$202", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;Lorg/apache/openejb/core/ThreadContext;)Lorg/apache/openejb/core/ThreadContext;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "access$302", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;Lorg/apache/openejb/core/transaction/TransactionPolicy;)Lorg/apache/openejb/core/transaction/TransactionPolicy;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "access$300", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;)Lorg/apache/openejb/core/transaction/TransactionPolicy;", false);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext"}, 0, null);
Label label5 = new Label();
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer", "NO_ARGS", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext");
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
Label label6 = new Label();
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/core/ThreadContext", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "access$100", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;)Ljava/lang/reflect/Method;", false);
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "org/apache/openejb/InterfaceType", "[Ljava/lang/Object;", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "java/lang/Object", "org/apache/openejb/OpenEJBException", "org/apache/openejb/core/Operation"}, 1, new Object[] {"org/apache/openejb/core/ThreadContext"});
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/Operation", "BUSINESS", "Lorg/apache/openejb/core/Operation;");
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "org/apache/openejb/InterfaceType", "[Ljava/lang/Object;", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "java/lang/Object", "org/apache/openejb/OpenEJBException", "org/apache/openejb/core/Operation"}, 2, new Object[] {"org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/Operation"});
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "_invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;Lorg/apache/openejb/BeanContext;Lorg/apache/openejb/InterfaceType;Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;Lorg/apache/openejb/core/ThreadContext;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "org/apache/openejb/InterfaceType", "[Ljava/lang/Object;", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "java/lang/Object", "org/apache/openejb/OpenEJBException", "org/apache/openejb/core/Operation"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 11);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "org/apache/openejb/InterfaceType", "[Ljava/lang/Object;", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "java/lang/Object", "org/apache/openejb/OpenEJBException", "org/apache/openejb/core/Operation", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/OpenEJBException", "getRootCause", "()Ljava/lang/Throwable;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_invoke", "(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;Lorg/apache/openejb/BeanContext;Lorg/apache/openejb/InterfaceType;Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;Lorg/apache/openejb/core/ThreadContext;)Ljava/lang/Object;", null, new String[] { "org/apache/openejb/SystemException", "org/apache/openejb/ApplicationException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "[Ljava/lang/Object;", "org/apache/openejb/BeanContext", "org/apache/openejb/InterfaceType", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "org/apache/openejb/core/ThreadContext", Opcodes.TOP, "java/util/List"}, 4, new Object[] {label3, label3, "java/lang/Object", "java/lang/reflect/Method"});
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/Operation", "BUSINESS", "Lorg/apache/openejb/core/Operation;");
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "[Ljava/lang/Object;", "org/apache/openejb/BeanContext", "org/apache/openejb/InterfaceType", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "org/apache/openejb/core/ThreadContext", Opcodes.TOP, "java/util/List"}, 5, new Object[] {label3, label3, "java/lang/Object", "java/lang/reflect/Method", "org/apache/openejb/core/Operation"});
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/core/mdb/Instance");
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "java/lang/reflect/Method", "[Ljava/lang/Object;", "org/apache/openejb/BeanContext", "org/apache/openejb/InterfaceType", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "org/apache/openejb/core/ThreadContext"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
...
Label label4 = new Label();
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label5, "org/apache/openejb/ApplicationException");
Label label6 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "instanceManager", "Lorg/apache/openejb/core/mdb/MdbInstanceManager;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/SystemException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Should never get an OpenEJBException exception");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/SystemException", "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", "access$200", "(Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext;)Lorg/apache/openejb/core/ThreadContext;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/ThreadContext", "exit", "(Lorg/apache/openejb/core/ThreadContext;)V", false);
Label label12 = new Label();
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label5);
...
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "org/apache/openejb/core/ThreadContext", Opcodes.INTEGER, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitJumpInsn(GOTO, label19);
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "org/apache/openejb/core/ThreadContext", Opcodes.INTEGER, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbCallContext", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitLdcInsn("error while releasing message endpoint");
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "org/apache/openejb/core/ThreadContext", Opcodes.INTEGER, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label20);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "org/apache/openejb/core/ThreadContext", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/core/mdb/MdbPoolContainer", "NO_ARGS", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
