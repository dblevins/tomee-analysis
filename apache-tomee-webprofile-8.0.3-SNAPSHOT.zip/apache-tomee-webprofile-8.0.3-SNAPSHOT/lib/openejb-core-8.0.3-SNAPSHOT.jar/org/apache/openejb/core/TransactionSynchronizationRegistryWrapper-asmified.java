...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/TransactionSynchronizationRegistryWrapper", null, "java/lang/Object", new String[] { "javax/transaction/TransactionSynchronizationRegistry" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "registry", "Ljavax/transaction/TransactionSynchronizationRegistry;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/TransactionSynchronizationRegistryWrapper", "registry", "Ljavax/transaction/TransactionSynchronizationRegistry;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getRegistry", "()Ljavax/transaction/TransactionSynchronizationRegistry;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/loader/SystemInstance", "get", "()Lorg/apache/openejb/loader/SystemInstance;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/TransactionSynchronizationRegistryWrapper", "registry", "Ljavax/transaction/TransactionSynchronizationRegistry;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/TransactionSynchronizationRegistryWrapper", "getRegistry", "()Ljavax/transaction/TransactionSynchronizationRegistry;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/TransactionSynchronizationRegistryWrapper", "getRegistry", "()Ljavax/transaction/TransactionSynchronizationRegistry;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/transaction/TransactionSynchronizationRegistry", "getRollbackOnly", "()Z", true);
