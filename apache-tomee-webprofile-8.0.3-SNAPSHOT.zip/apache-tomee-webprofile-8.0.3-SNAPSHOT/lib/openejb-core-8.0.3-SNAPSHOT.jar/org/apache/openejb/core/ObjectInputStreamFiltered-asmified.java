...
public class ObjectInputStreamFilteredDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/ObjectInputStreamFiltered", null, "java/io/ObjectInputStream", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/rmi/BlacklistClassResolver", "check", "(Ljava/io/ObjectStreamClass;)Ljava/io/ObjectStreamClass;", false);
