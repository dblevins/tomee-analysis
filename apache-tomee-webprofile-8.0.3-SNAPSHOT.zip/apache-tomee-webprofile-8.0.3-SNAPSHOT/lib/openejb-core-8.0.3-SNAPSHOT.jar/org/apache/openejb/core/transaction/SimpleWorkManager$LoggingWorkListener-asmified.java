...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/core/transaction/SimpleWorkManager$LoggingWorkListener", null, "jakarta/resource/spi/work/WorkAdapter", null);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/resource/spi/work/WorkException", "getMessage", "()Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/resource/spi/work/WorkException"}, 0, null);
methodVisitor.visitInsn(RETURN);
