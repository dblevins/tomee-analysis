...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/ejb/ScheduleExpression;)V", null, new String[] { "org/apache/openejb/core/timer/EJBCronTrigger$ParseException" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger", "jakarta/ejb/ScheduleExpression", "java/util/Map"}, 1, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger"});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ejb/ScheduleExpression", "getTimezone", "()Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger", "jakarta/ejb/ScheduleExpression", "java/util/Map"}, 2, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger", "java/util/TimeZone"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger", "jakarta/ejb/ScheduleExpression", "java/util/Map"}, 2, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger", "java/util/Date"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger", "jakarta/ejb/ScheduleExpression", "java/util/Map", "java/util/Map", Opcodes.INTEGER, "java/util/Iterator", "java/util/Map$Entry", Opcodes.INTEGER, "java/lang/String"}, 1, new Object[] {"org/apache/openejb/core/timer/EJBCronTrigger$ParseException"});
