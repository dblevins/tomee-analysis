...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateful/StatefulUserTransaction", "<init>", "(Ljavax/transaction/UserTransaction;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry;)V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateful/StatefulContext", "<init>", "(Lorg/apache/openejb/spi/SecurityService;Ljavax/transaction/UserTransaction;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateful/StatefulContainer", "sessionContext", "Ljavax/ejb/SessionContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer$Data", "javax/management/MBeanServer", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label4 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/core/stateful/StatefulContainer$Data", "javax/management/MBeanServer", "java/util/Iterator", "javax/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/management/MBeanServer", "unregisterMBean", "(Ljavax/management/ObjectName;)V", true);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "java/util/Map", "org/apache/openejb/core/stateful/StatefulContainer$Data", "org/apache/openejb/monitoring/StatsInterceptor", "javax/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder", "javax/management/ObjectName"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "java/util/Map", "org/apache/openejb/core/stateful/StatefulContainer$Data", "org/apache/openejb/monitoring/StatsInterceptor", "javax/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateful/StatefulContainer", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateful/StatefulContainer", "sessionContext", "Ljavax/ejb/SessionContext;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateful/Instance", "<init>", "(Lorg/apache/openejb/BeanContext;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljavax/enterprise/context/spi/CreationalContext;Ljava/util/Map;Ljava/util/Map;Lorg/apache/openejb/core/stateful/LockFactory$StatefulLock;)V", false);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitLabel(label4);
Label label24 = new Label();
methodVisitor.visitJumpInsn(GOTO, label24);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateful/StatefulContainer", "getTransaction", "(Lorg/apache/openejb/core/ThreadContext;)Ljavax/transaction/Transaction;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "java/lang/Object", "org/apache/openejb/core/ThreadContext", "java/lang/reflect/Method", Opcodes.INTEGER, "javax/transaction/Transaction", "org/apache/openejb/core/stateful/Instance", "java/lang/Object"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
...
methodVisitor.visitJumpInsn(GOTO, label15);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "java/lang/Object", "org/apache/openejb/core/ThreadContext", "java/lang/reflect/Method", Opcodes.INTEGER, "javax/transaction/Transaction", Opcodes.TOP, "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitInsn(MONITOREXIT);
methodVisitor.visitLabel(label7);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "java/lang/Object", "org/apache/openejb/core/ThreadContext", "java/lang/reflect/Method", Opcodes.INTEGER, "javax/transaction/Transaction", "org/apache/openejb/core/stateful/Instance"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateful/Instance", "getTransaction", "()Ljavax/transaction/Transaction;", false);
Label label20 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label20);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateful/Instance", "getTransaction", "()Ljavax/transaction/Transaction;", false);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "javax/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", Opcodes.TOP, "java/util/Map", "javax/persistence/SynchronizationType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "javax/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "javax/persistence/EntityManager", "java/util/Map", "javax/persistence/SynchronizationType"}, 0, new Object[] {});
...
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "javax/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "javax/persistence/EntityManager", "java/util/Map", "javax/persistence/SynchronizationType"}, 3, new Object[] {label5, label5, "javax/persistence/EntityManager"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/stateful/StatefulContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "javax/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "javax/persistence/EntityManager", "java/util/Map", "javax/persistence/SynchronizationType"}, 4, new Object[] {label5, label5, "javax/persistence/EntityManager", Opcodes.INTEGER});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "unregisterEntityManagers", "(Lorg/apache/openejb/core/stateful/Instance;Lorg/apache/openejb/core/ThreadContext;)Ljava/util/Map;", "(Lorg/apache/openejb/core/stateful/Instance;Lorg/apache/openejb/core/ThreadContext;)Ljava/util/Map<Ljavax/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateful/StatefulContainer", "entityManagerRegistry", "Lorg/apache/openejb/persistence/JtaEntityManagerRegistry;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "closeEntityManagers", "(Ljava/util/Map;)V", "(Ljava/util/Map<Ljavax/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
