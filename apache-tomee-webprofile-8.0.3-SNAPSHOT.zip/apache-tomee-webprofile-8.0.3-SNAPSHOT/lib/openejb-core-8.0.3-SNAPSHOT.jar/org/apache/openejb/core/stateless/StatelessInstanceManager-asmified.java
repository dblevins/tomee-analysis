...
public class StatelessInstanceManagerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/stateless/StatelessInstanceManager", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "removeSessionBeanMethod", "Ljava/lang/reflect/Method;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/spi/SecurityService;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Pool$Builder;ILjava/util/concurrent/ScheduledExecutorService;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "securityService", "Lorg/apache/openejb/spi/SecurityService;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "accessTimeout", "Lorg/apache/openejb/util/Duration;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "closeTimeout", "Lorg/apache/openejb/util/Duration;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "poolBuilder", "Lorg/apache/openejb/util/Pool$Builder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "scheduledExecutor", "Ljava/util/concurrent/ScheduledExecutorService;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/spi/SecurityService", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, "java/util/concurrent/ScheduledExecutorService"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLdcInsn("StatelessPool.worker.");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "executor", "Ljava/util/concurrent/ThreadPoolExecutor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "executor", "Ljava/util/concurrent/ThreadPoolExecutor;");
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/stateless/StatelessInstanceManager$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$1", "<init>", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "scheduledExecutor", "Ljava/util/concurrent/ScheduledExecutorService;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInstance", "(Lorg/apache/openejb/core/ThreadContext;)Lorg/apache/openejb/core/stateless/Instance;", null, new String[] { "org/apache/openejb/OpenEJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "poolPop", "()Lorg/apache/openejb/util/Pool$Entry;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateless/Instance", "setPoolEntry", "(Lorg/apache/openejb/util/Pool$Entry;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/BeanContext", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "org/apache/openejb/core/stateless/Instance"}, 0, null);
Label label4 = new Label();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("No instances available in Stateless Session Bean pool.  Waited ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "access$300", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager$Data;)Lorg/apache/openejb/util/Duration;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "createInstance", "(Lorg/apache/openejb/core/ThreadContext;Lorg/apache/openejb/BeanContext;)Lorg/apache/openejb/core/stateless/Instance;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createInstance", "(Lorg/apache/openejb/core/ThreadContext;Lorg/apache/openejb/BeanContext;)Lorg/apache/openejb/core/stateless/Instance;", null, new String[] { "org/apache/openejb/ApplicationException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/stateless/Instance");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/Instance", "<init>", "(Ljava/lang/Object;Ljava/util/Map;Ljavax/enterprise/context/spi/CreationalContext;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/openejb/core/stateless/Instance;"));
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/core/stateless/Instance");
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateless/Instance", "getPoolEntry", "()Lorg/apache/openejb/util/Pool$Entry;", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/core/ThreadContext", "java/lang/Object", "org/apache/openejb/core/stateless/Instance", "org/apache/openejb/BeanContext", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "org/apache/openejb/util/Pool"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/core/stateless/Instance", "org/apache/openejb/BeanContext", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data"}, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 7);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "freeInstance", "(Lorg/apache/openejb/core/ThreadContext;Lorg/apache/openejb/core/stateless/Instance;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "removeSessionBeanMethod", "Ljava/lang/reflect/Method;");
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/stateless/Instance", "org/apache/openejb/BeanContext", "java/lang/reflect/Method", "java/util/List", "org/apache/openejb/core/interceptor/InterceptorStack", "org/apache/openejb/cdi/CdiEjbBean"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
...
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/Instance", "creationalContext", "Ljavax/enterprise/context/spi/CreationalContext;");
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/Instance", "creationalContext", "Ljavax/enterprise/context/spi/CreationalContext;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/context/spi/CreationalContext", "release", "()V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/core/ThreadContext", "org/apache/openejb/core/stateless/Instance"}, 0, new Object[] {});
Label label6 = new Label();
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn("AccessTimeout");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn("Timeout");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "accessTimeout", "Lorg/apache/openejb/util/Duration;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/concurrent/TimeUnit", "MILLISECONDS", "Ljava/util/concurrent/TimeUnit;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "getDuration", "(Lorg/apache/openejb/loader/Options;Ljava/lang/String;Lorg/apache/openejb/util/Duration;Ljava/util/concurrent/TimeUnit;)Lorg/apache/openejb/util/Duration;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/concurrent/TimeUnit", "MILLISECONDS", "Ljava/util/concurrent/TimeUnit;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "getDuration", "(Lorg/apache/openejb/loader/Options;Ljava/lang/String;Lorg/apache/openejb/util/Duration;Ljava/util/concurrent/TimeUnit;)Lorg/apache/openejb/util/Duration;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "closeTimeout", "Lorg/apache/openejb/util/Duration;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/concurrent/TimeUnit", "MINUTES", "Ljava/util/concurrent/TimeUnit;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "getDuration", "(Lorg/apache/openejb/loader/Options;Ljava/lang/String;Lorg/apache/openejb/util/Duration;Ljava/util/concurrent/TimeUnit;)Lorg/apache/openejb/util/Duration;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "poolBuilder", "Lorg/apache/openejb/util/Pool$Builder;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "setDefault", "(Lorg/apache/openejb/util/Duration;Ljava/util/concurrent/TimeUnit;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/concurrent/TimeUnit", "MINUTES", "Ljava/util/concurrent/TimeUnit;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "setDefault", "(Lorg/apache/openejb/util/Duration;Ljava/util/concurrent/TimeUnit;)V", false);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "<init>", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;Lorg/apache/openejb/BeanContext;Lorg/apache/openejb/core/stateless/StatelessInstanceManager$1;)V", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "<init>", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;Lorg/apache/openejb/util/Pool;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/core/stateless/StatelessInstanceManager$1;)V", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "access$600", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager$Data;)Ljavax/ejb/SessionContext;", false);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/stateless/EjbWsContext");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "access$600", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager$Data;)Ljavax/ejb/SessionContext;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/EjbWsContext", "<init>", "(Ljavax/ejb/SessionContext;)V", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/naming/Context", "bind", "(Ljava/lang/String;Ljava/lang/Object;)V", true);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data"}, 1, new Object[] {"javax/naming/NamingException"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/OpenEJBException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/monitoring/ObjectNameBuilder", "javax/management/MBeanServer", "org/apache/openejb/monitoring/StatsInterceptor", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/openejb/monitoring/StatsInterceptor");
Label label15 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label15);
methodVisitor.visitVarInsn(ALOAD, 18);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/interceptor/InterceptorInstance", "getInterceptor", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/monitoring/StatsInterceptor");
methodVisitor.visitVarInsn(ASTORE, 16);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "add", "(Ljavax/management/ObjectName;)Ljavax/management/ObjectName;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label4);
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/monitoring/ObjectNameBuilder", "javax/management/MBeanServer", "org/apache/openejb/monitoring/StatsInterceptor"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 17);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "access$700", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager$Data;)Lorg/apache/openejb/util/Pool;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/monitoring/ManagedMBean", "<init>", "(Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/management/MBeanServer", "registerMBean", "(Ljava/lang/Object;Ljavax/management/ObjectName;)Ljavax/management/ObjectInstance;", true);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/monitoring/ObjectNameBuilder", "javax/management/MBeanServer"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitLdcInsn("Unable to register MBean ");
methodVisitor.visitVarInsn(ALOAD, 16);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/concurrent/ExecutorService", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 17);
methodVisitor.visitVarInsn(ILOAD, 9);
Label label21 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label21);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/stateless/StatelessInstanceManager$InstanceCreatorRunnable");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$InstanceCreatorRunnable", "<init>", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;JJJDLorg/apache/openejb/core/stateless/StatelessInstanceManager$Data;Lorg/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier;Lorg/apache/openejb/core/stateless/StatelessInstanceManager$1;)V", false);
...
methodVisitor.visitVarInsn(ASTORE, 17);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitLdcInsn("can't fill the stateless pool");
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/util/Logger", "error", "(Ljava/lang/String;Ljava/lang/Throwable;)Ljava/lang/String;", false);
methodVisitor.visitInsn(POP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getDuration", "(Lorg/apache/openejb/loader/Options;Ljava/lang/String;Lorg/apache/openejb/util/Duration;Ljava/util/concurrent/TimeUnit;)Lorg/apache/openejb/util/Duration;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/util/Duration", "setUnit", "(Ljava/util/concurrent/TimeUnit;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/String", "org/apache/openejb/util/Duration"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 7);
methodVisitor.visitEnd();
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager$Data"}, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/monitoring/LocalMBeanServer", "get", "()Ljavax/management/MBeanServer;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "access$900", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager$Data;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
Label label7 = new Label();
methodVisitor.visitLabel(label7);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "javax/management/MBeanServer", "java/util/Iterator", "javax/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "closePool", "()Z", false);
methodVisitor.visitJumpInsn(IFNE, label4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("Timed-out waiting for stateless pool to close: for deployment '");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/BeanContext", "getDeploymentID", "()Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/Object;)Ljava/lang/StringBuilder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;Lorg/apache/openejb/core/ThreadContext;Lorg/apache/openejb/core/stateless/Instance;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/stateless/StatelessInstanceManager", "freeInstance", "(Lorg/apache/openejb/core/ThreadContext;Lorg/apache/openejb/core/stateless/Instance;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$200", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;Lorg/apache/openejb/core/ThreadContext;Lorg/apache/openejb/BeanContext;)Lorg/apache/openejb/core/stateless/Instance;", null, new String[] { "org/apache/openejb/ApplicationException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$1000", "(Lorg/apache/openejb/core/stateless/StatelessInstanceManager;)Lorg/apache/openejb/spi/SecurityService;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/stateless/StatelessInstanceManager", "securityService", "Lorg/apache/openejb/spi/SecurityService;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "removeSessionBeanMethod", "Ljava/lang/reflect/Method;");
methodVisitor.visitInsn(RETURN);
