...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/spi/SecurityService;Ljakarta/resource/spi/ResourceAdapter;Lorg/apache/openejb/core/mdb/InboundRecovery;Ljava/lang/Object;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Pool$Builder;ILjava/util/concurrent/ScheduledExecutorService;)V", null, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceManager", "org/apache/openejb/spi/SecurityService", "jakarta/resource/spi/ResourceAdapter", "org/apache/openejb/core/mdb/InboundRecovery", "java/lang/Object", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, "java/util/concurrent/ScheduledExecutorService"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbInstanceManager", "resourceAdapter", "Ljakarta/resource/spi/ResourceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "deploy", "(Lorg/apache/openejb/BeanContext;Ljakarta/resource/spi/ActivationSpec;Lorg/apache/openejb/core/mdb/EndpointFactory;)V", null, new String[] { "org/apache/openejb/OpenEJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTryCatchBlock(label6, label7, label8, "jakarta/resource/ResourceException");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbInstanceManager", "inboundRecovery", "Lorg/apache/openejb/core/mdb/InboundRecovery;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbInstanceManager", "resourceAdapter", "Ljakarta/resource/spi/ResourceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceManager", "org/apache/openejb/BeanContext", "jakarta/resource/spi/ActivationSpec", "org/apache/openejb/core/mdb/EndpointFactory", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/mdb/MdbInstanceManager$InstanceSupplier", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/core/mdb/MdbInstanceManager$Data", "org/apache/openejb/core/mdb/MdbContext", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder", "org/apache/openejb/monitoring/StatsInterceptor", "jakarta/management/ObjectName"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 14);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceManager", "org/apache/openejb/BeanContext", "jakarta/resource/spi/ActivationSpec", "org/apache/openejb/core/mdb/EndpointFactory", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/mdb/MdbInstanceManager$InstanceSupplier", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/core/mdb/MdbInstanceManager$Data", "org/apache/openejb/core/mdb/MdbContext", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder", "org/apache/openejb/monitoring/StatsInterceptor"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 17);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbPoolContainer$MdbActivationContext", "<init>", "(Ljava/lang/ClassLoader;Lorg/apache/openejb/BeanContext;Ljakarta/resource/spi/ResourceAdapter;Lorg/apache/openejb/core/mdb/EndpointFactory;Ljakarta/resource/spi/ActivationSpec;)V", false);
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceManager", "org/apache/openejb/BeanContext", "jakarta/resource/spi/ActivationSpec", "org/apache/openejb/core/mdb/EndpointFactory", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/mdb/MdbInstanceManager$InstanceSupplier", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/core/mdb/MdbInstanceManager$Data", "org/apache/openejb/core/mdb/MdbContext", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder"}, 1, new Object[] {"jakarta/resource/ResourceException"});
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/OpenEJBException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 16);
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbInstanceManager$Data", "add", "(Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label13);
Label label27 = new Label();
methodVisitor.visitJumpInsn(GOTO, label27);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceManager", "org/apache/openejb/BeanContext", "jakarta/resource/spi/ActivationSpec", "org/apache/openejb/core/mdb/EndpointFactory", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/mdb/MdbInstanceManager$InstanceSupplier", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/core/mdb/MdbInstanceManager$Data", "org/apache/openejb/core/mdb/MdbContext", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder", "org/apache/openejb/loader/Options"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 17);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitLdcInsn("Unable to register MBean ");
methodVisitor.visitVarInsn(ALOAD, 17);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/openejb/core/mdb/EndpointFactory", "jakarta/management/ObjectName"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbInstanceManager", "activationContexts", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "remove", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbActivationContext", "org/apache/openejb/core/mdb/EndpointFactory", "jakarta/management/ObjectName", "org/apache/openejb/core/mdb/MdbPoolContainer$MdbActivationContext", "jakarta/management/MBeanServer", "java/util/Iterator", "jakarta/management/ObjectName"}, 1, new Object[] {"jakarta/management/InstanceNotFoundException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addJMxControl", "(Lorg/apache/openejb/BeanContext;Ljava/lang/String;Lorg/apache/openejb/core/mdb/MdbPoolContainer$MdbActivationContext;)V", null, new String[] { "jakarta/resource/ResourceException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
