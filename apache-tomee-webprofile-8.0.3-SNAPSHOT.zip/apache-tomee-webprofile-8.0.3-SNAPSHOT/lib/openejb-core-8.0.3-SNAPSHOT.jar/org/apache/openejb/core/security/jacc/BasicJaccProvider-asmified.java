...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/security/jacc/BasicJaccProvider", "getPolicyConfiguration", "(Ljava/lang/String;Z)Ljakarta/security/jacc/PolicyConfiguration;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/security/jacc/PolicyConfiguration", "inService", "()Z", true);
...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/security/jacc/PolicyContextException");
Label label3 = new Label();
Label label4 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label2, "jakarta/security/jacc/PolicyContextException");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/security/jacc/PolicyContext", "getContextID", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/core/security/jacc/BasicJaccProvider", "java/security/ProtectionDomain", "java/security/Permission", "java/lang/String"}, 1, new Object[] {"jakarta/security/jacc/PolicyContextException"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/security/jacc/PolicyContext;"));
