...
public class OpenEJBCommonsLogDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/log/commonslogging/OpenEJBCommonsLog", null, "java/lang/Object", new String[] { "org/apache/commons/logging/Log", "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "logger", "Lorg/apache/openejb/util/Logger;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "category", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/log/commonslogging/OpenEJBCommonsLog", "category", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/log/commonslogging/OpenEJBCommonsLog", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/log/commonslogging/OpenEJBCommonsLog", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/log/commonslogging/OpenEJBCommonsLog", "category", "Ljava/lang/String;");
