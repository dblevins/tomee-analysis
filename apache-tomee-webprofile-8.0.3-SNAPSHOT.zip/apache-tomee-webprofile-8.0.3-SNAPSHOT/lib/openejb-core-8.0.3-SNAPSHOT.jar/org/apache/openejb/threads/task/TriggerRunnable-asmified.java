...
public class TriggerRunnableDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/threads/task/TriggerRunnable", "Lorg/apache/openejb/threads/task/TriggerTask<Ljava/lang/Void;>;Ljava/lang/Runnable;", "org/apache/openejb/threads/task/TriggerTask", new String[] { "java/lang/Runnable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doInvoke", "()Ljava/lang/Void;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/threads/task/TriggerRunnable", "delegate", "Ljava/lang/Runnable;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/threads/task/TriggerRunnable", "invoke", "()Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_BRIDGE | ACC_SYNTHETIC, "doInvoke", "()Ljava/lang/Object;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/threads/task/TriggerRunnable", "doInvoke", "()Ljava/lang/Void;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
