...
public class VisibilityChecker$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "com/fasterxml/jackson/databind/introspect/VisibilityChecker$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/fasterxml/jackson/databind/introspect/VisibilityChecker", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/fasterxml/jackson/annotation/PropertyAccessor", "values", "()[Lcom/fasterxml/jackson/annotation/PropertyAccessor;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/introspect/VisibilityChecker$1", "$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor", "[I");
