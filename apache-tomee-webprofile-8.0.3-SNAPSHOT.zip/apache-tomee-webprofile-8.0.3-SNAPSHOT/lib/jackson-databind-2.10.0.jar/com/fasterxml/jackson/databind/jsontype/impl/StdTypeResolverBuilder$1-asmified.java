...
public class StdTypeResolverBuilder$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "com/fasterxml/jackson/databind/jsontype/impl/StdTypeResolverBuilder$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/fasterxml/jackson/databind/jsontype/impl/StdTypeResolverBuilder", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$Id", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/fasterxml/jackson/annotation/JsonTypeInfo$Id", "values", "()[Lcom/fasterxml/jackson/annotation/JsonTypeInfo$Id;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/jsontype/impl/StdTypeResolverBuilder$1", "$SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$Id", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/jsontype/impl/StdTypeResolverBuilder$1", "$SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As", "[I");
