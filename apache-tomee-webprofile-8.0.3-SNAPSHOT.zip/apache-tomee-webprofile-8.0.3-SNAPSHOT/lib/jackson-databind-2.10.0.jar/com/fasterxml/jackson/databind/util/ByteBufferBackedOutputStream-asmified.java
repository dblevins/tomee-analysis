...
public class ByteBufferBackedOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/fasterxml/jackson/databind/util/ByteBufferBackedOutputStream", null, "java/io/OutputStream", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/util/ByteBufferBackedOutputStream", "_b", "Ljava/nio/ByteBuffer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/util/ByteBufferBackedOutputStream", "_b", "Ljava/nio/ByteBuffer;");
