...
public class BasicPolymorphicTypeValidator$Builder$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder$1", null, "com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$TypeMatcher", null);

classWriter.visitOuterClass("com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder", "allowIfBaseType", "(Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder;");
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$baseOfBase", "Ljava/lang/Class;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder$1", "this$0", "Lcom/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder$1", "val$baseOfBase", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/jsontype/BasicPolymorphicTypeValidator$Builder$1", "val$baseOfBase", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 1);
