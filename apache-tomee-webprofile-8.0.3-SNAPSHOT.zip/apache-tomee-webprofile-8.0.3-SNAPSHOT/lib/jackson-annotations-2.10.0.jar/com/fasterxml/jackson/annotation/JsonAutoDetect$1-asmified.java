...
public class JsonAutoDetect$1Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER | ACC_SYNTHETIC, "com/fasterxml/jackson/annotation/JsonAutoDetect$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/fasterxml/jackson/annotation/JsonAutoDetect", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$fasterxml$jackson$annotation$JsonAutoDetect$Visibility", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/annotation/JsonAutoDetect$1", "$SwitchMap$com$fasterxml$jackson$annotation$PropertyAccessor", "[I");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/fasterxml/jackson/annotation/JsonAutoDetect$Visibility", "values", "()[Lcom/fasterxml/jackson/annotation/JsonAutoDetect$Visibility;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/annotation/JsonAutoDetect$1", "$SwitchMap$com$fasterxml$jackson$annotation$JsonAutoDetect$Visibility", "[I");
