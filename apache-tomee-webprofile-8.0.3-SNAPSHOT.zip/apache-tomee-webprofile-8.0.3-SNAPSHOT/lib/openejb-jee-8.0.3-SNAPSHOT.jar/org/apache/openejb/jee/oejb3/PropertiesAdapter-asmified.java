...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/oejb3/PropertiesAdapter", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter<Ljava/lang/String;Ljava/util/Properties;>;", "jakarta/xml/bind/annotation/adapters/XmlAdapter", null);

classWriter.visitInnerClass("org/apache/openejb/jee/oejb3/PropertiesAdapter$1", null, null, ACC_STATIC | ACC_SYNTHETIC);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/jee/oejb3/PropertiesAdapter$SortedProperties");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/jee/oejb3/PropertiesAdapter$SortedProperties", "<init>", "(Lorg/apache/openejb/jee/oejb3/PropertiesAdapter$1;)V", false);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/openejb/jee/oejb3/PropertiesAdapter$SortedProperties;"));
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/jee/oejb3/PropertiesAdapter$SortedProperties", "<init>", "(Ljava/util/Properties;Lorg/apache/openejb/jee/oejb3/PropertiesAdapter$1;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/oejb3/PropertiesAdapter", "marshal", "(Ljava/util/Properties;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/oejb3/PropertiesAdapter", "unmarshal", "(Ljava/lang/String;)Ljava/util/Properties;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
