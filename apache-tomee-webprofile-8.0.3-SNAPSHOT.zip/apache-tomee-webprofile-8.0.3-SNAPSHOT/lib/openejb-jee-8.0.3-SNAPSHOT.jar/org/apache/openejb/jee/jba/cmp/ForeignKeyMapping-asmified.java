...
public class ForeignKeyMappingDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/jba/cmp/ForeignKeyMapping", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "foreign-key-mapping");
annotationVisitor0.visitEnd();
}
{
