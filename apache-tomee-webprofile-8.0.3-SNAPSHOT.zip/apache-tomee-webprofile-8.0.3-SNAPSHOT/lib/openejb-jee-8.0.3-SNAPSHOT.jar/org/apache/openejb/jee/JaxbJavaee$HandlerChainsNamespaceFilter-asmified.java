...
public class JaxbJavaee$HandlerChainsNamespaceFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/JaxbJavaee$HandlerChainsNamespaceFilter", null, "org/xml/sax/helpers/XMLFilterImpl", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "effectiveNamespaces", "Ljava/util/Stack;", "Ljava/util/Stack<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/String;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/JaxbJavaee$HandlerChainsNamespaceFilter", "effectiveNamespaces", "Ljava/util/Stack;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/jee/JaxbJavaee$HandlerChainsNamespaceFilter", "EMPTY_INPUT_SOURCE", "Lorg/xml/sax/InputSource;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/JaxbJavaee$HandlerChainsNamespaceFilter", "effectiveNamespaces", "Ljava/util/Stack;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Stack", "pop", "()Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/xml/sax/helpers/XMLFilterImpl", "endPrefixMapping", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/jee/JaxbJavaee$HandlerChainsNamespaceFilter", "EMPTY_INPUT_SOURCE", "Lorg/xml/sax/InputSource;");
methodVisitor.visitInsn(RETURN);
