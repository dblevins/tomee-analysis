...
public class Beans$Scan$Exclude$ClassConditionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/Beans$Scan$Exclude$ClassCondition", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Beans$Scan$Exclude$ClassCondition", "name", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Beans$Scan$Exclude$ClassCondition", "name", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
