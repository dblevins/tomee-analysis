...
public class TimeoutDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/Timeout", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "access-timeoutType");
{
AnnotationVisitor annotationVisitor1 = annotationVisitor0.visitArray("propOrder");
annotationVisitor1.visit(null, "timeout");
annotationVisitor1.visit(null, "unit");
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "unit", "Ljava/util/concurrent/TimeUnit;", null, null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljavax/xml/bind/annotation/XmlElement;", true);
annotationVisitor0.visit("required", Boolean.TRUE);
annotationVisitor0.visitEnd();
...
annotationVisitor0.visit("value", Type.getType("Lorg/apache/openejb/jee/TimeUnitAdapter;"));
annotationVisitor0.visitEnd();
}
fieldVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Timeout", "timeout", "J");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Timeout", "timeout", "J");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Timeout", "unit", "Ljava/util/concurrent/TimeUnit;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Timeout", "unit", "Ljava/util/concurrent/TimeUnit;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Timeout", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Timeout", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
