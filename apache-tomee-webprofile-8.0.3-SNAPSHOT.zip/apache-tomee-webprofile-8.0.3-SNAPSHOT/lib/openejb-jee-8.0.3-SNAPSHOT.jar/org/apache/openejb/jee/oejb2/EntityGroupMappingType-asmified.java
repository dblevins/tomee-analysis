...
public class EntityGroupMappingTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/oejb2/EntityGroupMappingType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "entity-group-mappingType");
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/oejb2/EntityGroupMappingType", "groupName", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/oejb2/EntityGroupMappingType", "groupName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
