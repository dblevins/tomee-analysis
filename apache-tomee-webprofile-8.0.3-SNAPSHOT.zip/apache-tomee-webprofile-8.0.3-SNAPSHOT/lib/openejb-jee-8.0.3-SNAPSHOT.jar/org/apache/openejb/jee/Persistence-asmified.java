...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/Persistence", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "persistenceUnit", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/openejb/jee/Persistence$PersistenceUnit;>;", null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPersistenceUnit", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/openejb/jee/Persistence$PersistenceUnit;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Persistence", "persistenceUnit", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Persistence", "persistenceUnit", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Persistence", "version", "Ljava/lang/String;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Persistence", "version", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
