...
public class DbindexDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/jba/cmp/Dbindex", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "dbindex");
annotationVisitor0.visitEnd();
}
{
