...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/EjbRelation", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "ejbRelationshipRole", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/openejb/jee/EjbRelationshipRole;>;", null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljavax/xml/bind/annotation/XmlElement;", true);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/EjbRelation", "description", "Lorg/apache/openejb/jee/TextMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/EjbRelation", "description", "Lorg/apache/openejb/jee/TextMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/EjbRelation", "ejbRelationName", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/EjbRelation", "ejbRelationName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEjbRelationshipRole", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/openejb/jee/EjbRelationshipRole;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/EjbRelation", "ejbRelationshipRole", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/EjbRelation", "ejbRelationshipRole", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/EjbRelation", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/EjbRelation", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
