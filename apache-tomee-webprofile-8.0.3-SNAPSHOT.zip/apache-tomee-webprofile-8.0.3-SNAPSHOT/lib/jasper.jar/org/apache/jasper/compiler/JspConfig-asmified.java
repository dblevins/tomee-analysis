...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/JspConfig", "ctxt", "Ljakarta/servlet/ServletContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/JspConfig", "ctxt", "Ljakarta/servlet/ServletContext;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/JspConfig", "jspProperties", "Ljava/util/Vector;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspConfigDescriptor", "getJspPropertyGroups", "()Ljava/util/Collection;", true);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getUrlPatterns", "()Ljava/util/Collection;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "java/util/Collection"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "org/apache/jasper/compiler/JspConfig$JspProperty");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getIsXml", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getElIgnored", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getScriptingInvalid", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getPageEncoding", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getIncludePreludes", "()Ljava/util/Collection;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getIncludeCodas", "()Ljava/util/Collection;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getDeferredSyntaxAllowedAsLiteral", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getTrimDirectiveWhitespaces", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getDefaultContentType", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getBuffer", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/descriptor/JspPropertyGroupDescriptor", "getErrorOnUndeclaredNamespace", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/jasper/compiler/JspConfig", "jakarta/servlet/descriptor/JspConfigDescriptor", "java/util/Collection", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label4);
