...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", null, "javax/el/ELContext", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "wrapped", "Ljavax/el/ELContext;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljavax/el/ELContext;Ljavax/servlet/jsp/tagext/JspTag;Ljavax/servlet/jsp/PageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/el/ELContext", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "wrapped", "Ljavax/el/ELContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "jspTag", "Ljavax/servlet/jsp/tagext/JspTag;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "pageContext", "Ljavax/servlet/jsp/PageContext;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "getWrappedELContext", "()Ljavax/el/ELContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "wrapped", "Ljavax/el/ELContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "pageContext", "Ljavax/servlet/jsp/PageContext;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "importHandler", "Ljavax/el/ImportHandler;");
Label label0 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "importHandler", "Ljavax/el/ImportHandler;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "jspTag", "Ljavax/servlet/jsp/tagext/JspTag;");
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljavax/el/ELContext;Ljavax/servlet/jsp/tagext/JspTag;Ljavax/servlet/jsp/PageContext;Lorg/apache/jasper/runtime/JspContextWrapper$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/runtime/JspContextWrapper$ELContextWrapper", "<init>", "(Ljavax/el/ELContext;Ljavax/servlet/jsp/tagext/JspTag;Ljavax/servlet/jsp/PageContext;)V", false);
methodVisitor.visitInsn(RETURN);
