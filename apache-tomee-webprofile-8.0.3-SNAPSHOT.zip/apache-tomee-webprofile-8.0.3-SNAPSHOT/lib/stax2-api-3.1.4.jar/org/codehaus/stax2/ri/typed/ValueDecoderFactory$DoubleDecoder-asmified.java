...
public class ValueDecoderFactory$DoubleDecoderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/codehaus/stax2/ri/typed/ValueDecoderFactory$DoubleDecoder", null, "org/codehaus/stax2/ri/typed/ValueDecoderFactory$DecoderBase", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "mValue", "D", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/ri/typed/ValueDecoderFactory$DoubleDecoder", "mValue", "D");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/stax2/ri/typed/ValueDecoderFactory$DoubleDecoder", "mValue", "D");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/codehaus/stax2/ri/typed/ValueDecoderFactory$DoubleDecoder", "constructInvalidValue", "(Ljava/lang/String;)Ljava/lang/IllegalArgumentException;", false);
