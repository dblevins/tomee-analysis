...
public class ValueEncoderFactory$TokenEncoderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$TokenEncoder", null, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$ScalarEncoder", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "reset", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$TokenEncoder", "_value", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$TokenEncoder", "_value", "Ljava/lang/String;");
