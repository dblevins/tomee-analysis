...
public class StreamWriterDelegateDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/codehaus/stax2/util/StreamWriterDelegate", null, "java/lang/Object", new String[] { "javax/xml/stream/XMLStreamWriter" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "mDelegate", "Ljavax/xml/stream/XMLStreamWriter;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/stax2/util/StreamWriterDelegate", "mDelegate", "Ljavax/xml/stream/XMLStreamWriter;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getParent", "()Ljavax/xml/stream/XMLStreamWriter;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/util/StreamWriterDelegate", "mDelegate", "Ljavax/xml/stream/XMLStreamWriter;");
