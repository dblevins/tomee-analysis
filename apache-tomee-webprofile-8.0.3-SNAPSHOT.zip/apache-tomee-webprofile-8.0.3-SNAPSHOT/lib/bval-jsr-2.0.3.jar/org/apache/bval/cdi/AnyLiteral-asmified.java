...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/bval/cdi/AnyLiteral;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/bval/cdi/AnyLiteral");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/cdi/AnyLiteral", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/bval/cdi/AnyLiteral", "INSTANCE", "Lorg/apache/bval/cdi/AnyLiteral;");
methodVisitor.visitInsn(RETURN);
