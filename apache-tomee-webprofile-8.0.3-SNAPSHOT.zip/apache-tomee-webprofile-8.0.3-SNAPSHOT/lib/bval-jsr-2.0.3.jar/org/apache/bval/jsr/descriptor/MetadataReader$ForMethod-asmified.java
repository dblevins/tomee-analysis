...
{
methodVisitor = classWriter.visitMethod(0, "getParameterNames", "(Ljakarta/validation/ParameterNameProvider;Ljava/lang/reflect/Method;)Ljava/util/List;", "(Ljakarta/validation/ParameterNameProvider;Ljava/lang/reflect/Method;)Ljava/util/List<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/descriptor/MetadataReader$ForMethod", "getParameterNames", "(Ljakarta/validation/ParameterNameProvider;Ljava/lang/reflect/Method;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
