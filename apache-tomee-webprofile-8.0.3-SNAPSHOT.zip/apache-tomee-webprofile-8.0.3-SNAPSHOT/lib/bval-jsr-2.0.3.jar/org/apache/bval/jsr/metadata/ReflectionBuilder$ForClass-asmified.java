...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/validation/GroupSequence");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/validation/GroupSequence"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/validation/GroupSequence", "value", "()[Ljava/lang/Class;", true);
