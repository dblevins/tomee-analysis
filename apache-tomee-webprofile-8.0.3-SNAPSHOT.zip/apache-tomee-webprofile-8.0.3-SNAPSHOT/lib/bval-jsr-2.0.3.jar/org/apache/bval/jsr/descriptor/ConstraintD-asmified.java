...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/descriptor/ConstraintD", "<A::Ljava/lang/annotation/Annotation;>Ljava/lang/Object;Ljakarta/validation/metadata/ConstraintDescriptor<TA;>;", "java/lang/Object", new String[] { "jakarta/validation/metadata/ConstraintDescriptor" });
...
classWriter.visitInnerClass("jakarta/validation/valueextraction/Unwrapping$Unwrap", "jakarta/validation/valueextraction/Unwrapping", "Unwrap", ACC_PUBLIC | ACC_STATIC | ACC_ABSTRACT | ACC_INTERFACE);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "scope", "Ljakarta/validation/metadata/Scope;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "payload", "Ljava/util/Set;", "Ljava/util/Set<Ljava/lang/Class<+Ljakarta/validation/Payload;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "valueUnwrapping", "Ljakarta/validation/metadata/ValidateUnwrappedValue;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "validationAppliesTo", "Ljakarta/validation/ConstraintTarget;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "composingConstraints", "Ljava/util/Set;", "Ljava/util/Set<Ljakarta/validation/metadata/ConstraintDescriptor<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "constraintValidatorClasses", "Ljava/util/List;", "Ljava/util/List<Ljava/lang/Class<+Ljakarta/validation/ConstraintValidator<TA;*>;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/annotation/Annotation;Ljakarta/validation/metadata/Scope;Lorg/apache/bval/jsr/metadata/Meta;Lorg/apache/bval/jsr/ApacheValidatorFactory;)V", "(TA;Ljakarta/validation/metadata/Scope;Lorg/apache/bval/jsr/metadata/Meta<*>;Lorg/apache/bval/jsr/ApacheValidatorFactory;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/jsr/descriptor/ConstraintD", "scope", "Ljakarta/validation/metadata/Scope;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/validation/ReportAsSingleViolation;"));
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/descriptor/ConstraintD", "computeValidateUnwrappedValue", "()Ljakarta/validation/metadata/ValidateUnwrappedValue;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/jsr/descriptor/ConstraintD", "valueUnwrapping", "Ljakarta/validation/metadata/ValidateUnwrappedValue;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/descriptor/ConstraintD", "computeValidationAppliesTo", "(Ljava/lang/annotation/ElementType;)Ljakarta/validation/ConstraintTarget;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/jsr/descriptor/ConstraintD", "validationAppliesTo", "Ljakarta/validation/ConstraintTarget;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPayload", "()Ljava/util/Set;", "()Ljava/util/Set<Ljava/lang/Class<+Ljakarta/validation/Payload;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConstraintValidatorClasses", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/Class<+Ljakarta/validation/ConstraintValidator<TA;*>;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getComposingConstraints", "()Ljava/util/Set;", "()Ljava/util/Set<Ljakarta/validation/metadata/ConstraintDescriptor<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getValidationAppliesTo", "()Ljakarta/validation/ConstraintTarget;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/descriptor/ConstraintD", "validationAppliesTo", "Ljakarta/validation/ConstraintTarget;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getValueUnwrapping", "()Ljakarta/validation/metadata/ValidateUnwrappedValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/descriptor/ConstraintD", "valueUnwrapping", "Ljakarta/validation/metadata/ValidateUnwrappedValue;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unwrap", "(Ljava/lang/Class;)Ljava/lang/Object;", "<U:Ljava/lang/Object;>(Ljava/lang/Class<TU;>;)TU;", new String[] { "jakarta/validation/ValidationException" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getScope", "()Ljakarta/validation/metadata/Scope;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/descriptor/ConstraintD", "scope", "Ljakarta/validation/metadata/Scope;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "computeComposingConstraints", "(Lorg/apache/bval/jsr/ApacheValidatorFactory;)Ljava/util/Set;", "(Lorg/apache/bval/jsr/ApacheValidatorFactory;)Ljava/util/Set<Ljakarta/validation/metadata/ConstraintDescriptor<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "computeConstraintValidatorClasses", "(Lorg/apache/bval/jsr/ApacheValidatorFactory;)Ljava/util/List;", "(Lorg/apache/bval/jsr/ApacheValidatorFactory;)Ljava/util/List<Ljava/lang/Class<+Ljakarta/validation/ConstraintValidator<TA;*>;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "computeValidateUnwrappedValue", "()Ljakarta/validation/metadata/ValidateUnwrappedValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/validation/valueextraction/Unwrapping$Unwrap;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "contains", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitVarInsn(ISTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/validation/valueextraction/Unwrapping$Skip;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "contains", "(Ljava/lang/Object;)Z", true);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/validation/metadata/ValidateUnwrappedValue"});
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(6, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "computePayload", "()Ljava/util/Set;", "()Ljava/util/Set<Ljava/lang/Class<+Ljakarta/validation/Payload;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "computeValidationAppliesTo", "(Ljava/lang/annotation/ElementType;)Ljakarta/validation/ConstraintTarget;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/validation/ConstraintTarget", "java/lang/reflect/AnnotatedElement"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
