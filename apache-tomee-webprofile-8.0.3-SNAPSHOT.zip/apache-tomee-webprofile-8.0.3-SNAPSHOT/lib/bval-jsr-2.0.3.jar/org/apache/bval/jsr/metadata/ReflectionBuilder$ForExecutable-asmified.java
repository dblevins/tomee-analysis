...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getConstraints", "(Ljakarta/validation/ConstraintTarget;)[Ljava/lang/annotation/Annotation;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getConstraintsByTarget", "()Ljava/util/Map;", "()Ljava/util/Map<Ljakarta/validation/ConstraintTarget;Ljava/util/List<Ljava/lang/annotation/Annotation;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "meta", "Lorg/apache/bval/jsr/metadata/Meta;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "map", "(Ljava/util/function/Function;)Ljava/util/Optional;", false);
methodVisitor.visitInvokeDynamicInsn("test", "()Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "lambda$getConstraintsByTarget$4", "(Ljakarta/validation/ConstraintTarget;)Z", false), Type.getType("(Ljakarta/validation/ConstraintTarget;)Z")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "filter", "(Ljava/util/function/Predicate;)Ljava/util/Optional;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {Opcodes.TOP, "java/util/Set", "jakarta/validation/constraintvalidation/ValidationTarget"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "[Ljava/lang/annotation/Annotation;", "java/util/Map", "[Ljava/lang/annotation/Annotation;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/annotation/Annotation", "java/lang/Class", "java/util/Optional", "jakarta/validation/ConstraintTarget", "java/util/Set"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "impliedConstraintTarget", "()Ljakarta/validation/ConstraintTarget;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "[Ljava/lang/annotation/Annotation;", "java/util/Map", "[Ljava/lang/annotation/Annotation;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/annotation/Annotation", "java/lang/Class", "java/util/Optional", "jakarta/validation/ConstraintTarget"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "lambda$getConstraintsByTarget$5", "(Ljakarta/validation/ConstraintTarget;)Ljava/util/List;", false), Type.getType("(Ljakarta/validation/ConstraintTarget;)Ljava/util/List;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "impliedConstraintTarget", "()Ljakarta/validation/ConstraintTarget;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "meta", "Lorg/apache/bval/jsr/metadata/Meta;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/metadata/Meta", "getHost", "()Ljava/lang/reflect/AnnotatedElement;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getConstraintsByTarget$5", "(Ljakarta/validation/ConstraintTarget;)Ljava/util/List;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getConstraintsByTarget$4", "(Ljakarta/validation/ConstraintTarget;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getConstraintsByTarget$3", "(Ljava/lang/annotation/Annotation;Lorg/apache/bval/jsr/ConstraintAnnotationAttributes$Worker;)Ljakarta/validation/ConstraintTarget;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getConstraints$1", "(Ljakarta/validation/ConstraintTarget;Ljava/util/Map;)Ljava/util/List;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$200", "(Lorg/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable;Ljakarta/validation/ConstraintTarget;)[Ljava/lang/annotation/Annotation;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForExecutable", "getConstraints", "(Ljakarta/validation/ConstraintTarget;)[Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
