...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/ApacheValidationProvider", "Ljava/lang/Object;Ljakarta/validation/spi/ValidationProvider<Lorg/apache/bval/jsr/ApacheValidatorConfiguration;>;", "java/lang/Object", new String[] { "jakarta/validation/spi/ValidationProvider" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isSuitable", "(Ljava/lang/Class;)Z", "(Ljava/lang/Class<+Ljakarta/validation/Configuration<*>;>;)Z", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createSpecializedConfiguration", "(Ljakarta/validation/spi/BootstrapState;)Lorg/apache/bval/jsr/ApacheValidatorConfiguration;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/bval/jsr/ConfigurationImpl");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/ConfigurationImpl", "<init>", "(Ljakarta/validation/spi/BootstrapState;Ljakarta/validation/spi/ValidationProvider;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createGenericConfiguration", "(Ljakarta/validation/spi/BootstrapState;)Ljakarta/validation/Configuration;", "(Ljakarta/validation/spi/BootstrapState;)Ljakarta/validation/Configuration<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/bval/jsr/ConfigurationImpl");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildValidatorFactory", "(Ljakarta/validation/spi/ConfigurationState;)Ljakarta/validation/ValidatorFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/bval/jsr/ApacheValidationProvider", "jakarta/validation/spi/ConfigurationState", "java/lang/Class"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/bval/jsr/ApacheValidationProvider", "jakarta/validation/spi/ConfigurationState"}, 1, new Object[] {"jakarta/validation/ValidationException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/validation/spi/ConfigurationState;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_BRIDGE | ACC_SYNTHETIC, "createSpecializedConfiguration", "(Ljakarta/validation/spi/BootstrapState;)Ljakarta/validation/Configuration;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/ApacheValidationProvider", "createSpecializedConfiguration", "(Ljakarta/validation/spi/BootstrapState;)Lorg/apache/bval/jsr/ApacheValidatorConfiguration;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
