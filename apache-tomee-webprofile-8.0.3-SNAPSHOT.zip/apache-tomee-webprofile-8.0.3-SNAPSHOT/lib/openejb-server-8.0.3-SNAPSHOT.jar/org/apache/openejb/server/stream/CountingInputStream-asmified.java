...
public class CountingInputStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/server/stream/CountingInputStream", null, "java/io/InputStream", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/stream/CountingInputStream", "count", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/stream/CountingInputStream", "delegate", "Ljava/io/InputStream;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/stream/CountingInputStream", "delegate", "Ljava/io/InputStream;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/stream/CountingInputStream", "count", "I");
