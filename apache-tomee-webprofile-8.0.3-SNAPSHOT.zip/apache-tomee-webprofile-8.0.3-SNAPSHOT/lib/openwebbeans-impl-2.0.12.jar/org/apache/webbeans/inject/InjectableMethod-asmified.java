...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "dependentParameters", "Ljava/util/Map;", "Ljava/util/Map<Ljakarta/enterprise/inject/spi/Bean<*>;Ljava/lang/Object;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/Producer;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)V", "(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/Producer<TT;>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<TT;>;)V", null);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/inject/InjectableMethod", "createInjectionPoints", "(Ljakarta/enterprise/inject/spi/Producer;Ljava/lang/reflect/Member;)Ljava/util/List;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/Producer;Lorg/apache/webbeans/context/creational/CreationalContextImpl;Ljava/util/Set;)V", "(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/Producer<TT;>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<TT;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/InjectionPoint;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/AnnotatedParameter"}, 0, null);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/inject/InjectableMethod", "getBean", "()Ljakarta/enterprise/context/spi/Contextual;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/inject/InjectableMethod", "inject", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/inject/InjectableMethod", "getWebBeansContext", "()Lorg/apache/webbeans/config/WebBeansContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "org/apache/webbeans/container/InjectionResolver", "jakarta/enterprise/inject/spi/Bean"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDependentBeanParameters", "()Ljava/util/Map;", "()Ljava/util/Map<Ljakarta/enterprise/inject/spi/Bean<*>;Ljava/lang/Object;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/InjectableMethod", "dependentParameters", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
