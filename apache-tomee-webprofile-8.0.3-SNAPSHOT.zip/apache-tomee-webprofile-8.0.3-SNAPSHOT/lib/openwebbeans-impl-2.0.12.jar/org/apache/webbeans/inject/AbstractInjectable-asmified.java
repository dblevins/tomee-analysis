...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "owner", "Ljavax/enterprise/inject/spi/Producer;", "Ljavax/enterprise/inject/spi/Producer<*>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Ljavax/enterprise/inject/spi/Producer;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)V", "(Ljavax/enterprise/inject/spi/Producer<*>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/inject/AbstractInjectable", "owner", "Ljavax/enterprise/inject/spi/Producer;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/context/creational/CreationalContextImpl", "getContextual", "()Ljavax/enterprise/context/spi/Contextual;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "inject", "(Ljavax/enterprise/inject/spi/InjectionPoint;)Ljava/lang/Object;", "(Ljavax/enterprise/inject/spi/InjectionPoint;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/webbeans/inject/AbstractInjectable", "javax/enterprise/inject/spi/InjectionPoint", Opcodes.TOP, "org/apache/webbeans/container/BeanManagerImpl", "javax/enterprise/inject/spi/Bean", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/TransientReference;"));
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/webbeans/inject/AbstractInjectable", "javax/enterprise/inject/spi/InjectionPoint", "java/lang/Object", "org/apache/webbeans/container/BeanManagerImpl", "javax/enterprise/inject/spi/Bean", Opcodes.INTEGER, "javax/enterprise/context/spi/CreationalContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTypeInsn(NEW, "javax/enterprise/inject/IllegalProductException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/enterprise/inject/IllegalProductException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getBean", "()Ljavax/enterprise/context/spi/Contextual;", "()Ljavax/enterprise/context/spi/Contextual<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/AbstractInjectable", "creationalContext", "Lorg/apache/webbeans/context/creational/CreationalContextImpl;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/context/creational/CreationalContextImpl", "getBean", "()Ljavax/enterprise/inject/spi/Bean;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getInjectionPoints", "(Ljava/lang/reflect/Member;)Ljava/util/List;", "(Ljava/lang/reflect/Member;)Ljava/util/List<Ljavax/enterprise/inject/spi/InjectionPoint;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/AbstractInjectable", "owner", "Ljavax/enterprise/inject/spi/Producer;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/inject/AbstractInjectable", "createInjectionPoints", "(Ljavax/enterprise/inject/spi/Producer;Ljava/lang/reflect/Member;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "createInjectionPoints", "(Ljavax/enterprise/inject/spi/Producer;Ljava/lang/reflect/Member;)Ljava/util/List;", "(Ljavax/enterprise/inject/spi/Producer<*>;Ljava/lang/reflect/Member;)Ljava/util/List<Ljavax/enterprise/inject/spi/InjectionPoint;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/Producer", "getInjectionPoints", "()Ljava/util/Set;", true);
