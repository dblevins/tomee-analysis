...
public class WebBeansDeploymentExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/exception/WebBeansDeploymentException", null, "javax/enterprise/inject/spi/DeploymentException", new String[] { "org/apache/webbeans/exception/helper/DescriptiveException" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/enterprise/inject/spi/DeploymentException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/exception/WebBeansDeploymentException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/enterprise/inject/spi/DeploymentException", "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/exception/helper/ExceptionMessageBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/exception/helper/ExceptionMessageBuilder", "<init>", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/exception/WebBeansDeploymentException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/exception/WebBeansDeploymentException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/enterprise/inject/spi/DeploymentException", "getMessage", "()Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/exception/WebBeansDeploymentException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/enterprise/inject/spi/DeploymentException", "getLocalizedMessage", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/exception/helper/ExceptionMessageBuilder", "getAdditionalInformation", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
