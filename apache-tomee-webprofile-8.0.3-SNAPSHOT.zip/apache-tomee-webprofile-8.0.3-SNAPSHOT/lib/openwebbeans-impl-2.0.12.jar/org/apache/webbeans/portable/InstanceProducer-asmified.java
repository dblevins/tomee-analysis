...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/portable/InstanceProducer", "<T:Ljava/lang/Object;>Lorg/apache/webbeans/portable/AbstractProducer<Ljavax/enterprise/inject/Instance<TT;>;>;", "org/apache/webbeans/portable/AbstractProducer", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljavax/enterprise/inject/Instance;", "(Ljava/util/Map<Ljavax/enterprise/inject/spi/Interceptor<*>;*>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<Ljavax/enterprise/inject/Instance<TT;>;>;)Ljavax/enterprise/inject/Instance<TT;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/webbeans/context/creational/CreationalContextImpl", "javax/enterprise/inject/spi/InjectionPoint"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/inject/instance/InstanceImpl", "<init>", "(Ljava/lang/reflect/Type;Ljavax/enterprise/inject/spi/InjectionPoint;Lorg/apache/webbeans/config/WebBeansContext;[Ljava/lang/annotation/Annotation;)V", false);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/enterprise/inject/Instance"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "dispose", "(Ljavax/enterprise/inject/Instance;)V", "(Ljavax/enterprise/inject/Instance<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/InstanceProducer", "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljavax/enterprise/inject/Instance;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/InstanceProducer", "dispose", "(Ljavax/enterprise/inject/Instance;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
