...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/portable/AnnotatedConstructorImpl", "<X:Ljava/lang/Object;>Lorg/apache/webbeans/portable/AbstractAnnotatedCallable<TX;>;Ljavax/enterprise/inject/spi/AnnotatedConstructor<TX;>;", "org/apache/webbeans/portable/AbstractAnnotatedCallable", new String[] { "javax/enterprise/inject/spi/AnnotatedConstructor" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedConstructor;Ljavax/enterprise/inject/spi/AnnotatedType;)V", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedConstructor<TX;>;Ljavax/enterprise/inject/spi/AnnotatedType<TX;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedConstructor", "getBaseType", "()Ljava/lang/reflect/Type;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/portable/AnnotatedConstructorImpl", "org/apache/webbeans/config/WebBeansContext", "javax/enterprise/inject/spi/AnnotatedConstructor", "javax/enterprise/inject/spi/AnnotatedType", "java/util/Iterator"}, 0, new Object[] {});
