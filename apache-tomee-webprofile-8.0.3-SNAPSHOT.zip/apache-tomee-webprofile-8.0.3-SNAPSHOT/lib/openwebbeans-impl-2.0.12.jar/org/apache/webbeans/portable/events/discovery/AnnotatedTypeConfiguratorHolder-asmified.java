...
public class AnnotatedTypeConfiguratorHolderDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "annotatedTypeConfigurator", "Lorg/apache/webbeans/configurator/AnnotatedTypeConfiguratorImpl;", "Lorg/apache/webbeans/configurator/AnnotatedTypeConfiguratorImpl<TT;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/portable/events/discovery/AnnotatedTypeConfiguratorHolder", "annotatedTypeConfigurator", "Lorg/apache/webbeans/configurator/AnnotatedTypeConfiguratorImpl;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/events/discovery/AnnotatedTypeConfiguratorHolder", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getAnnotatedTypeConfigurator", "()Lorg/apache/webbeans/configurator/AnnotatedTypeConfiguratorImpl;", "()Lorg/apache/webbeans/configurator/AnnotatedTypeConfiguratorImpl<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/events/discovery/AnnotatedTypeConfiguratorHolder", "annotatedTypeConfigurator", "Lorg/apache/webbeans/configurator/AnnotatedTypeConfiguratorImpl;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
