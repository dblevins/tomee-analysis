...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "validateNoDisposerWithoutProducer", "(Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/Collection;)V", "(Ljava/util/Set<Ljavax/enterprise/inject/spi/AnnotatedMethod<-TT;>;>;Ljava/util/Set<Lorg/apache/webbeans/component/ProducerMethodBean<*>;>;Ljava/util/Set<Lorg/apache/webbeans/component/ProducerFieldBean<*>;>;Ljava/util/Collection<Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/enterprise/inject/spi/AnnotatedParameter", Opcodes.INTEGER, "java/util/Iterator"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "validateNoProducerOrObserverMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;)V", "(Ljavax/enterprise/inject/spi/AnnotatedType<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
