...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/enterprise/inject/spi/WithAnnotations");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/webbeans/event/ContainerEventObserverMethodImpl", "org/apache/webbeans/component/AbstractOwbBean", "jakarta/enterprise/inject/spi/AnnotatedMethod", "jakarta/enterprise/inject/spi/AnnotatedParameter", "jakarta/enterprise/inject/spi/WithAnnotations", "java/lang/reflect/Type"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/WithAnnotations", "value", "()[Ljava/lang/Class;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/webbeans/portable/events/discovery/ExtensionAware", "setExtension", "(Ljakarta/enterprise/inject/spi/Extension;)V", true);
methodVisitor.visitLabel(label0);
