...
public class SerializableBeanVaultDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/container/SerializableBeanVault", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "serializableBeans", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Lorg/apache/webbeans/container/SerializableBean<*>;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/container/SerializableBeanVault", "serializableBeans", "Ljava/util/Map;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/String", "org/apache/webbeans/container/SerializableBean"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
