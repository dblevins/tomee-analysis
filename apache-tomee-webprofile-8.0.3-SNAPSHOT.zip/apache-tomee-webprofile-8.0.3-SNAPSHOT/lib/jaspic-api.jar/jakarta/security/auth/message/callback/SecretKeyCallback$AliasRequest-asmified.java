...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/security/auth/message/callback/SecretKeyCallback$AliasRequest", null, "java/lang/Object", new String[] { "jakarta/security/auth/message/callback/SecretKeyCallback$Request" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/security/auth/message/callback/SecretKeyCallback$AliasRequest", "alias", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/security/auth/message/callback/SecretKeyCallback$AliasRequest", "alias", "Ljava/lang/String;");
