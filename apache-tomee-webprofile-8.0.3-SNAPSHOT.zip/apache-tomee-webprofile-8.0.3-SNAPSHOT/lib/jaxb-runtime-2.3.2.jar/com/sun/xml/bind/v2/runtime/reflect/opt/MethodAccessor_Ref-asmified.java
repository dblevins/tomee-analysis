...
public class MethodAccessor_RefDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/bind/v2/runtime/reflect/opt/MethodAccessor_Ref", null, "com/sun/xml/bind/v2/runtime/reflect/Accessor", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/reflect/opt/Bean", "get_ref", "()Lcom/sun/xml/bind/v2/runtime/reflect/opt/Ref;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/reflect/opt/Bean", "set_ref", "(Lcom/sun/xml/bind/v2/runtime/reflect/opt/Ref;)V", false);
methodVisitor.visitInsn(RETURN);
