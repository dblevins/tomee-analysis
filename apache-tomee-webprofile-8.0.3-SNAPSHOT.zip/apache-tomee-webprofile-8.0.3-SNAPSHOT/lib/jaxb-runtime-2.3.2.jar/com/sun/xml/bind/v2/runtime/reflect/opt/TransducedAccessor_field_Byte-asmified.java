...
public class TransducedAccessor_field_ByteDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/sun/xml/bind/v2/runtime/reflect/opt/TransducedAccessor_field_Byte", null, "com/sun/xml/bind/v2/runtime/reflect/DefaultTransducedAccessor", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/reflect/opt/TransducedAccessor_field_Byte", "print", "(Ljava/lang/Object;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
