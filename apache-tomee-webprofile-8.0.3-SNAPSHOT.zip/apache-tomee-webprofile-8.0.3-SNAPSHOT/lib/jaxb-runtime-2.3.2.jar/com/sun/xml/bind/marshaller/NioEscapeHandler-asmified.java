...
public class NioEscapeHandlerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/bind/marshaller/NioEscapeHandler", null, "java/lang/Object", new String[] { "com/sun/xml/bind/marshaller/CharacterEscapeHandler" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/marshaller/NioEscapeHandler", "encoder", "Ljava/nio/charset/CharsetEncoder;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/marshaller/NioEscapeHandler", "encoder", "Ljava/nio/charset/CharsetEncoder;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 7);
methodVisitor.visitInsn(CALOAD);
