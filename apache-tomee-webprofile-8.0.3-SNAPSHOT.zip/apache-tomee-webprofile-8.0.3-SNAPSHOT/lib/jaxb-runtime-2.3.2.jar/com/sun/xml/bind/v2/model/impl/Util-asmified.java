...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/bind/annotation/XmlSchemaType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/xml/bind/annotation/XmlSchemaTypes;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/bind/annotation/XmlSchemaTypes");
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/bind/annotation/XmlSchemaTypes", "value", "()[Ljavax/xml/bind/annotation/XmlSchemaType;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
Label label2 = new Label();
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/xml/bind/annotation/XmlSchemaTypes", "[Ljavax/xml/bind/annotation/XmlSchemaType;"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/xml/bind/annotation/XmlSchemaType;"));
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitTypeInsn(ANEWARRAY, "javax/xml/bind/annotation/XmlSchemaType");
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljavax/xml/bind/annotation/XmlSchemaType;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "calcExpectedMediaType", "(Lcom/sun/xml/bind/v2/model/annotation/AnnotationSource;Lcom/sun/xml/bind/v2/model/impl/ModelBuilder;)Ljavax/activation/MimeType;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/bind/annotation/XmlMimeType"}, 0, null);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/activation/MimeTypeParseException"});
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/activation/MimeTypeParseException", "getMessage", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(AASTORE);
