...
public class Accessor$GetterOnlyReflectionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/bind/v2/runtime/reflect/Accessor$GetterOnlyReflection", "<BeanT:Ljava/lang/Object;ValueT:Ljava/lang/Object;>Lcom/sun/xml/bind/v2/runtime/reflect/Accessor$GetterSetterReflection<TBeanT;TValueT;>;", "com/sun/xml/bind/v2/runtime/reflect/Accessor$GetterSetterReflection", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "set", "(Ljava/lang/Object;Ljava/lang/Object;)V", "(TBeanT;TValueT;)V", new String[] { "com/sun/xml/bind/api/AccessorException" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/reflect/Accessor$GetterOnlyReflection", "getter", "Ljava/lang/reflect/Method;");
