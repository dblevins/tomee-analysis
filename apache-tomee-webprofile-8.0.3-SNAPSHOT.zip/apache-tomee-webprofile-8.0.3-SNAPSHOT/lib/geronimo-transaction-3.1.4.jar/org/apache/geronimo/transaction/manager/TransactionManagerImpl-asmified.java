...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/transaction/manager/TransactionManagerImpl", null, "java/lang/Object", new String[] { "javax/transaction/TransactionManager", "javax/transaction/UserTransaction", "javax/transaction/TransactionSynchronizationRegistry", "org/apache/geronimo/transaction/manager/XidImporter", "org/apache/geronimo/transaction/manager/MonitorableTransactionManager", "org/apache/geronimo/transaction/manager/RecoverableTransactionManager" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "threadTx", "Ljava/lang/ThreadLocal;", "Ljava/lang/ThreadLocal<Ljavax/transaction/Transaction;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "associatedTransactions", "Ljava/util/concurrent/ConcurrentHashMap;", "Ljava/util/concurrent/ConcurrentHashMap<Ljavax/transaction/Transaction;Ljava/lang/Thread;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "associate", "(Lorg/apache/geronimo/transaction/manager/TransactionImpl;)V", null, new String[] { "javax/transaction/InvalidTransactionException" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/transaction/manager/TransactionManagerImpl", "fireThreadAssociated", "(Ljavax/transaction/Transaction;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/transaction/manager/TransactionManagerImpl", "getTransaction", "()Ljavax/transaction/Transaction;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/transaction/manager/TransactionManagerImpl", "fireThreadUnassociated", "(Ljavax/transaction/Transaction;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/transaction/manager/TransactionManagerImpl", "activeCount", "Ljava/util/concurrent/atomic/AtomicLong;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/transaction/manager/TransactionManagerImpl", "begin", "(J)Ljavax/transaction/Transaction;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 1);
methodVisitor.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "begin", "(J)Ljavax/transaction/Transaction;", null, new String[] { "javax/transaction/NotSupportedException", "javax/transaction/SystemException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/geronimo/transaction/manager/TransactionManagerImpl", Opcodes.LONG, "org/apache/geronimo/transaction/manager/TransactionImpl"}, 1, new Object[] {"javax/transaction/InvalidTransactionException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "importXid", "(Ljavax/transaction/xa/Xid;J)Ljavax/transaction/Transaction;", null, new String[] { "javax/transaction/xa/XAException", "javax/transaction/SystemException" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "commit", "(Ljavax/transaction/Transaction;Z)V", null, new String[] { "javax/transaction/xa/XAException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "javax/transaction/HeuristicMixedException");
Label label3 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label3, "javax/transaction/HeuristicRollbackException");
Label label4 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label4, "javax/transaction/RollbackException");
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label5, "java/lang/SecurityException");
Label label6 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label6, "javax/transaction/SystemException");
Label label7 = new Label();
Label label8 = new Label();
Label label9 = new Label();
methodVisitor.visitTryCatchBlock(label7, label8, label9, "javax/transaction/HeuristicMixedException");
Label label10 = new Label();
methodVisitor.visitTryCatchBlock(label7, label8, label10, "javax/transaction/HeuristicRollbackException");
Label label11 = new Label();
methodVisitor.visitTryCatchBlock(label7, label8, label11, "javax/transaction/SystemException");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "forget", "(Ljavax/transaction/Transaction;)V", null, new String[] { "javax/transaction/xa/XAException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "prepare", "(Ljavax/transaction/Transaction;)I", null, new String[] { "javax/transaction/xa/XAException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "rollback", "(Ljavax/transaction/Transaction;)V", null, new String[] { "javax/transaction/xa/XAException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "fireThreadAssociated", "(Ljavax/transaction/Transaction;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/geronimo/transaction/manager/TransactionManagerMonitor", "threadAssociated", "(Ljavax/transaction/Transaction;)V", true);
methodVisitor.visitLabel(label1);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/geronimo/transaction/manager/TransactionManagerImpl", "javax/transaction/Transaction", "java/util/Iterator", "org/apache/geronimo/transaction/manager/TransactionManagerMonitor"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "fireThreadUnassociated", "(Ljavax/transaction/Transaction;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/geronimo/transaction/manager/TransactionManagerMonitor", "threadUnassociated", "(Ljavax/transaction/Transaction;)V", true);
methodVisitor.visitLabel(label1);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
