...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "jakarta/mail/search/ComparisonTerm", null, "jakarta/mail/search/SearchTerm", null);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/mail/search/ComparisonTerm");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/search/ComparisonTerm", "comparison", "I");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/mail/search/ComparisonTerm");
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/search/ComparisonTerm", "comparison", "I");
