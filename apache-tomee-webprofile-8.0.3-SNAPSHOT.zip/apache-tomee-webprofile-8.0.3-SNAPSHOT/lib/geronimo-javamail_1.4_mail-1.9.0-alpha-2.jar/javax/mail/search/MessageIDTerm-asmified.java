...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "javax/mail/search/MessageIDTerm", null, "javax/mail/search/StringTerm", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/mail/search/MessageIDTerm", "match", "(Ljava/lang/String;)Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/mail/search/MessageIDTerm");
Label label0 = new Label();
