...
classWriter.visit(V1_5, ACC_SUPER, "javax/mail/util/SharedFileInputStream$SharedFileSource", null, "java/lang/Object", null);

classWriter.visitInnerClass("javax/mail/util/SharedFileInputStream$SharedFileSource", "javax/mail/util/SharedFileInputStream", "SharedFileSource", 0);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Ljavax/mail/util/SharedFileInputStream;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/mail/util/SharedFileInputStream;Ljava/io/File;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/SharedFileInputStream$SharedFileSource", "this$0", "Ljavax/mail/util/SharedFileInputStream;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/SharedFileInputStream$SharedFileSource", "instanceCount", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/SharedFileInputStream$SharedFileSource", "source", "Ljava/io/RandomAccessFile;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/util/SharedFileInputStream$SharedFileSource", "instanceCount", "I");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IADD);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/SharedFileInputStream$SharedFileSource", "instanceCount", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/util/SharedFileInputStream$SharedFileSource", "source", "Ljava/io/RandomAccessFile;");
