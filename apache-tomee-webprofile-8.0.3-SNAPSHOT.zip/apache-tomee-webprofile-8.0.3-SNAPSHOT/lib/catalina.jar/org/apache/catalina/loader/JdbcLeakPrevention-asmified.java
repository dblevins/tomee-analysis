...
public class JdbcLeakPreventionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/loader/JdbcLeakPrevention", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "clearJdbcDriverRegistrations", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/String;>;", new String[] { "java/sql/SQLException" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "java/util/Set", "java/util/Enumeration"}, 0, null);
