...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/catalina/mbeans/UserMBean", "org/apache/catalina/User", "java/util/List", "java/util/Iterator", "org/apache/catalina/Group"}, 1, new Object[] {"jakarta/management/MalformedObjectNameException"});
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/catalina/mbeans/UserMBean", "org/apache/catalina/User", "java/util/List", "java/util/Iterator", "org/apache/catalina/Role"}, 1, new Object[] {"jakarta/management/MalformedObjectNameException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/mbeans/UserMBean", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
