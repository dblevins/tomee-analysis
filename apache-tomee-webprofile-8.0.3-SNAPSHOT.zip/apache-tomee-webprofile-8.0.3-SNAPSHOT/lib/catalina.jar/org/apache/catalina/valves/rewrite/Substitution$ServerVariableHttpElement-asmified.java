...
public class Substitution$ServerVariableHttpElementDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/valves/rewrite/Substitution$ServerVariableHttpElement", null, "org/apache/catalina/valves/rewrite/Substitution$SubstitutionElement", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/valves/rewrite/Substitution$ServerVariableHttpElement", "this$0", "Lorg/apache/catalina/valves/rewrite/Substitution;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/valves/rewrite/Substitution$ServerVariableHttpElement", "key", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/valves/rewrite/Resolver", "resolveHttp", "(Ljava/lang/String;)Ljava/lang/String;", false);
