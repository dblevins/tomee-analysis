...
public class AbstractAccessLogValve$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/catalina/valves/AbstractAccessLogValve$2", "Ljava/lang/ThreadLocal<Ljava/util/Date;>;", "java/lang/ThreadLocal", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/valves/AbstractAccessLogValve$2", "initialValue", "()Ljava/util/Date;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
