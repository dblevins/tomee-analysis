...
public class AbstractAccessLogValve$ConnectionStatusElementDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/valves/AbstractAccessLogValve$ConnectionStatusElement", null, "java/lang/Object", new String[] { "org/apache/catalina/valves/AbstractAccessLogValve$AccessLogElement" });
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.INTEGER, "java/util/concurrent/atomic/AtomicBoolean"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
