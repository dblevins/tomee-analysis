...
public class RewriteCond$LexicalConditionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/valves/rewrite/RewriteCond$LexicalCondition", null, "org/apache/catalina/valves/rewrite/RewriteCond$Condition", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "condition", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/valves/rewrite/RewriteCond$LexicalCondition", "condition", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "compareTo", "(Ljava/lang/String;)I", false);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/valves/rewrite/RewriteCond$LexicalCondition", "type", "I");
