...
public class HTMLManagerServlet$7Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/manager/HTMLManagerServlet$7", "Lorg/apache/catalina/manager/util/BaseSessionComparator<Ljava/lang/String;>;", "org/apache/catalina/manager/util/BaseSessionComparator", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/manager/HTMLManagerServlet$7", "this$0", "Lorg/apache/catalina/manager/HTMLManagerServlet;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/catalina/manager/JspHelper", "guessDisplayUserFromSession", "(Lorg/apache/catalina/Session;)Ljava/lang/String;", false);
