...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/filters/FailedRequestFilter", "isGoodRequest", "(Ljakarta/servlet/ServletRequest;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isGoodRequest", "(Ljakarta/servlet/ServletRequest;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
