...
public class RequestFacade$GetAttributePrivilegedActionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/catalina/connector/RequestFacade$GetAttributePrivilegedAction", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/util/Enumeration<Ljava/lang/String;>;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/RequestFacade$GetAttributePrivilegedAction", "this$0", "Lorg/apache/catalina/connector/RequestFacade;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/RequestFacade$GetAttributePrivilegedAction", "this$0", "Lorg/apache/catalina/connector/RequestFacade;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/RequestFacade$GetAttributePrivilegedAction", "run", "()Ljava/util/Enumeration;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/connector/RequestFacade$GetAttributePrivilegedAction", "<init>", "(Lorg/apache/catalina/connector/RequestFacade;)V", false);
methodVisitor.visitInsn(RETURN);
