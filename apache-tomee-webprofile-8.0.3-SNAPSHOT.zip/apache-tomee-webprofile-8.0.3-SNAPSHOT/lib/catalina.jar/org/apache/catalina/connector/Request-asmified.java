...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/connector/Request", null, "java/lang/Object", new String[] { "jakarta/servlet/http/HttpServletRequest" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "cookies", "[Ljakarta/servlet/http/Cookie;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "internalDispatcherType", "Ljakarta/servlet/DispatcherType;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_TRANSIENT, "subject", "Ljakarta/security/auth/Subject;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "parts", "Ljava/util/Collection;", "Ljava/util/Collection<Ljakarta/servlet/http/Part;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "applicationRequest", "Ljakarta/servlet/http/HttpServletRequest;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "filterChain", "Ljakarta/servlet/FilterChain;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/Request", "cookies", "[Ljakarta/servlet/http/Cookie;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/Request", "subject", "Ljakarta/security/auth/Subject;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/Request", "applicationRequest", "Ljakarta/servlet/http/HttpServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/Request", "filterChain", "Ljakarta/servlet/FilterChain;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/catalina/connector/Request", "java/util/Iterator", "jakarta/servlet/http/Part"}, 1, new Object[] {"java/io/IOException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getFilterChain", "()Ljakarta/servlet/FilterChain;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "filterChain", "Ljakarta/servlet/FilterChain;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setFilterChain", "(Ljakarta/servlet/FilterChain;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/Request", "filterChain", "Ljakarta/servlet/FilterChain;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "applicationRequest", "Ljakarta/servlet/http/HttpServletRequest;");
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/servlet/http/HttpServletRequestWrapper");
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createInputStream", "()Ljakarta/servlet/ServletInputStream;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "inputStream", "Lorg/apache/catalina/connector/CoyoteInputStream;");
Label label0 = new Label();
...
Label label8 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label8);
methodVisitor.visitTypeInsn(NEW, "jakarta/servlet/ServletRequestAttributeEvent");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/Context", "getServletContext", "()Ljakarta/servlet/ServletContext;", true);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/ServletRequestAttributeEvent", "<init>", "(Ljakarta/servlet/ServletContext;Ljakarta/servlet/ServletRequest;Ljava/lang/String;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ASTORE, 7);
Label label9 = new Label();
methodVisitor.visitJumpInsn(GOTO, label9);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.INTEGER, "jakarta/servlet/ServletRequestAttributeEvent"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "jakarta/servlet/ServletRequestAttributeEvent");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/Context", "getServletContext", "()Ljakarta/servlet/ServletContext;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/servlet/ServletRequestAttributeListener");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/ServletRequestAttributeListener", "attributeReplaced", "(Ljakarta/servlet/ServletRequestAttributeEvent;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/servlet/ServletRequestAttributeListener"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/ServletRequestAttributeListener", "attributeAdded", "(Ljakarta/servlet/ServletRequestAttributeEvent;)V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitJumpInsn(GOTO, label13);
methodVisitor.visitLabel(label2);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/catalina/connector/Request", "java/lang/String", "java/lang/Object", "org/apache/catalina/Context", "[Ljava/lang/Object;", "jakarta/servlet/ServletRequestAttributeEvent", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/ServletRequestAttributeListener", "attributeRemoved", "(Ljakarta/servlet/ServletRequestAttributeEvent;)V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/catalina/connector/Request", "java/lang/String", "java/lang/Object", "org/apache/catalina/Context", "[Ljava/lang/Object;", "jakarta/servlet/ServletRequestAttributeEvent", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/Object", "jakarta/servlet/ServletRequestAttributeListener"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/ExceptionUtils", "handleThrowable", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/catalina/connector/Request", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse"}, 4, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "org/apache/catalina/Context", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/catalina/connector/Request", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse"}, 5, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "org/apache/catalina/Context", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse", Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncContextImpl", "setStarted", "(Lorg/apache/catalina/Context;Ljakarta/servlet/ServletRequest;Ljakarta/servlet/ServletResponse;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "asyncContext", "Lorg/apache/catalina/core/AsyncContextImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Request", "getFilterChain", "()Ljakarta/servlet/FilterChain;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/servlet/FilterChain"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/connector/Request", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
methodVisitor.visitVarInsn(ISTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "cookies", "[Ljakarta/servlet/http/Cookie;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "cookies", "[Ljakarta/servlet/http/Cookie;");
...
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "subject", "Ljakarta/security/auth/Subject;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/connector/Request", "newSubject", "(Ljava/security/Principal;)Ljakarta/security/auth/Subject;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/Request", "subject", "Ljakarta/security/auth/Subject;");
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "newSubject", "(Ljava/security/Principal;)Ljakarta/security/auth/Subject;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/core/ApplicationPushBuilder", "<init>", "(Lorg/apache/catalina/connector/Request;Ljakarta/servlet/http/HttpServletRequest;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/servlet/http/HttpUpgradeHandler");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label3);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/catalina/connector/Request", "java/lang/Class", "jakarta/servlet/http/HttpUpgradeHandler", "org/apache/tomcat/InstanceManager"}, 0, new Object[] {});
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Request", "isSecure", "()Z", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/catalina/core/ApplicationSessionCookieConfig", "createSessionCookie", "(Lorg/apache/catalina/Context;Ljava/lang/String;Z)Ljakarta/servlet/http/Cookie;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "response", "Lorg/apache/catalina/connector/Response;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Response", "addSessionCookieInternal", "(Ljakarta/servlet/http/Cookie;)V", false);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/Authenticator", "authenticate", "(Lorg/apache/catalina/connector/Request;Ljakarta/servlet/http/HttpServletResponse;)Z", true);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getParts", "()Ljava/util/Collection;", "()Ljava/util/Collection<Ljakarta/servlet/http/Part;>;", new String[] { "java/io/IOException", "java/lang/IllegalStateException", "jakarta/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Request", "getWrapper", "()Lorg/apache/catalina/Wrapper;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/Wrapper", "getMultipartConfigElement", "()Ljakarta/servlet/MultipartConfigElement;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/catalina/Context", "jakarta/servlet/MultipartConfigElement"}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 1);
...
methodVisitor.visitLabel(label12);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/MultipartConfigElement", "getLocation", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/catalina/connector/Request", Opcodes.INTEGER, "org/apache/catalina/Context", "jakarta/servlet/MultipartConfigElement", "org/apache/tomcat/util/http/Parameters", Opcodes.INTEGER, Opcodes.TOP, "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/Context", "getServletContext", "()Ljakarta/servlet/ServletContext;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/catalina/connector/Request", Opcodes.INTEGER, "org/apache/catalina/Context", "jakarta/servlet/MultipartConfigElement", "org/apache/tomcat/util/http/Parameters", Opcodes.INTEGER, "java/io/File", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/MultipartConfigElement", "getFileSizeThreshold", "()I", false);
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/MultipartConfigElement", "getMaxFileSize", "()J", false);
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/MultipartConfigElement", "getMaxRequestSize", "()J", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/catalina/connector/Request", Opcodes.INTEGER, "org/apache/catalina/Context", "jakarta/servlet/MultipartConfigElement", "org/apache/tomcat/util/http/Parameters", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/Request", "partsParseException", "Ljava/lang/Exception;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPart", "(Ljava/lang/String;)Ljakarta/servlet/http/Part;", null, new String[] { "java/io/IOException", "java/lang/IllegalStateException", "jakarta/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ILOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/http/Cookie", "setVersion", "(I)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/catalina/connector/Request", "org/apache/tomcat/util/http/ServerCookies", "org/apache/tomcat/util/http/CookieProcessor", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/tomcat/util/http/ServerCookie", "jakarta/servlet/http/Cookie", Opcodes.INTEGER, "java/lang/String", "java/lang/String"}, 1, new Object[] {"jakarta/servlet/http/Cookie"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/catalina/connector/Request", "org/apache/tomcat/util/http/ServerCookies", "org/apache/tomcat/util/http/CookieProcessor", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/tomcat/util/http/ServerCookie", "jakarta/servlet/http/Cookie", Opcodes.INTEGER, "java/lang/String", "java/lang/String"}, 2, new Object[] {"jakarta/servlet/http/Cookie", "java/lang/String"});
