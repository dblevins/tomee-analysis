...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedDispatch", "request", "Ljakarta/servlet/ServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedDispatch", "response", "Ljakarta/servlet/ServletResponse;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedDispatch", "request", "Ljakarta/servlet/ServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedDispatch", "response", "Ljakarta/servlet/ServletResponse;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/catalina/core/ApplicationDispatcher", "access$200", "(Lorg/apache/catalina/core/ApplicationDispatcher;Ljakarta/servlet/ServletRequest;Ljakarta/servlet/ServletResponse;)V", false);
