...
public class ApplicationMapping$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/catalina/core/ApplicationMapping$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/catalina/core/ApplicationMapping", null, null);

classWriter.visitInnerClass("org/apache/catalina/core/ApplicationMapping$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$javax$servlet$http$MappingMatch", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/http/MappingMatch", "values", "()[Ljakarta/servlet/http/MappingMatch;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/catalina/core/ApplicationMapping$1", "$SwitchMap$javax$servlet$http$MappingMatch", "[I");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/http/MappingMatch", "ordinal", "()I", false);
