...
public class AuthenticatorBase$JaspicStateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/authenticator/AuthenticatorBase$JaspicState", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/catalina/authenticator/AuthenticatorBase$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/authenticator/AuthenticatorBase$JaspicState", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
