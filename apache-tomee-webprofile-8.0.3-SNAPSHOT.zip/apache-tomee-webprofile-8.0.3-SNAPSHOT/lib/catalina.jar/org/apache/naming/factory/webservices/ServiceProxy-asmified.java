...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "service", "Ljavax/xml/rpc/Service;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/xml/rpc/Service;)V", null, new String[] { "javax/xml/rpc/ServiceException" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/naming/factory/webservices/ServiceProxy", "service", "Ljavax/xml/rpc/Service;");
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/xml/rpc/Service;"));
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/naming/factory/webservices/ServiceProxy", "javax/xml/rpc/Service"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/naming/factory/webservices/ServiceProxy", "service", "Ljavax/xml/rpc/Service;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getProxyPortQNameClass", "([Ljava/lang/Object;)Ljava/lang/Object;", null, new String[] { "javax/xml/rpc/ServiceException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/naming/factory/webservices/ServiceProxy", "service", "Ljavax/xml/rpc/Service;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/Service", "getPorts", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/Service", "getPort", "(Ljavax/xml/namespace/QName;Ljava/lang/Class;)Ljava/rmi/Remote;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/rpc/ServiceException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getProxyPortClass", "([Ljava/lang/Object;)Ljava/rmi/Remote;", null, new String[] { "javax/xml/rpc/ServiceException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(AALOAD);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/naming/factory/webservices/ServiceProxy", "service", "Ljavax/xml/rpc/Service;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/Service", "getPort", "(Ljava/lang/Class;)Ljava/rmi/Remote;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
