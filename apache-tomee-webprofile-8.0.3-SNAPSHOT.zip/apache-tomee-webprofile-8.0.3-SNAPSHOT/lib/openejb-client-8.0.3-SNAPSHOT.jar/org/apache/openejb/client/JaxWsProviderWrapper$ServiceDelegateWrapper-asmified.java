...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/client/JaxWsProviderWrapper$ServiceDelegateWrapper", null, "jakarta/xml/ws/spi/ServiceDelegate", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/client/JaxWsProviderWrapper;Ljakarta/xml/ws/spi/ServiceDelegate;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/JaxWsProviderWrapper$ServiceDelegateWrapper", "serviceDelegate", "Ljakarta/xml/ws/spi/ServiceDelegate;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/JaxWsProviderWrapper$ServiceDelegateWrapper", "serviceDelegate", "Ljakarta/xml/ws/spi/ServiceDelegate;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/client/JaxWsProviderWrapper$ServiceDelegateWrapper", "setProperties", "(Ljakarta/xml/ws/BindingProvider;Ljavax/xml/namespace/QName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/client/JaxWsProviderWrapper$ServiceDelegateWrapper", "jakarta/xml/ws/BindingProvider", "javax/xml/namespace/QName", "java/util/Iterator", "org/apache/openejb/client/PortRefMetaData", "java/lang/Class"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 6);
