...
public class XbeanAsmParameterNameLoaderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", null, "java/lang/Object", new String[] { "org/apache/xbean/recipe/ParameterNameLoader" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "constructorCache", "Ljava/util/WeakHashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/util/WeakHashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/WeakHashMap", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "methodCache", "Ljava/util/WeakHashMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "methodCache", "Ljava/util/WeakHashMap;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "getAllMethodParameters", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/util/Map;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "constructorCache", "Ljava/util/WeakHashMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/WeakHashMap", "containsKey", "(Ljava/lang/Object;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "getAllConstructorParameters", "(Ljava/lang/Class;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "createClassReader", "(Ljava/lang/Class;)Lorg/apache/xbean/asm7/ClassReader;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitTypeInsn(NEW, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader$AllParameterNamesDiscoveringVisitor");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader$AllParameterNamesDiscoveringVisitor", "<init>", "(Ljava/lang/Class;)V", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader$AllParameterNamesDiscoveringVisitor", "getExceptions", "()Ljava/util/Map;", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader$AllParameterNamesDiscoveringVisitor", "getConstructorParameters", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader", "getMethods", "(Ljava/lang/Class;Ljava/lang/String;)[Ljava/lang/reflect/Method;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader$AllParameterNamesDiscoveringVisitor", "<init>", "(Ljava/lang/Class;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xbean/recipe/XbeanAsmParameterNameLoader$AllParameterNamesDiscoveringVisitor", "getMethodParameters", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label1);
Label label9 = new Label();
methodVisitor.visitJumpInsn(GOTO, label9);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createClassReader", "(Ljava/lang/Class;)Lorg/apache/xbean/asm7/ClassReader;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
