...
public class DefaultRepositoryDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/recipe/DefaultRepository", null, "java/lang/Object", new String[] { "org/apache/xbean/recipe/Repository" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "instances", "Ljava/util/SortedMap;", "Ljava/util/SortedMap<Ljava/lang/String;Ljava/lang/Object;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/recipe/DefaultRepository", "instances", "Ljava/util/SortedMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/recipe/DefaultRepository", "instances", "Ljava/util/SortedMap;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitLdcInsn(" is already registered to instance ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
