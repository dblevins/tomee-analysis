...
public class TikaContentExtractor$IgnoreContentHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxrs/ext/search/tika/TikaContentExtractor$IgnoreContentHandler", null, "org/apache/tika/sax/ToTextContentHandler", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/cxf/jaxrs/ext/search/tika/TikaContentExtractor$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxrs/ext/search/tika/TikaContentExtractor$IgnoreContentHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
