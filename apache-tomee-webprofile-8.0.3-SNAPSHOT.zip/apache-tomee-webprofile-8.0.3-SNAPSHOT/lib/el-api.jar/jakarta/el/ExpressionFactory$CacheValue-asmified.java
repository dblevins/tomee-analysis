...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/el/ExpressionFactory$CacheValue", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/ExpressionFactory$CacheValue", "lock", "Ljava/util/concurrent/locks/ReadWriteLock;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/ExpressionFactory$CacheValue", "lock", "Ljava/util/concurrent/locks/ReadWriteLock;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/ExpressionFactory$CacheValue", "className", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/ExpressionFactory$CacheValue", "className", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/ExpressionFactory$CacheValue", "ref", "Ljava/lang/ref/WeakReference;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/ExpressionFactory$CacheValue", "ref", "Ljava/lang/ref/WeakReference;");
methodVisitor.visitInsn(RETURN);
