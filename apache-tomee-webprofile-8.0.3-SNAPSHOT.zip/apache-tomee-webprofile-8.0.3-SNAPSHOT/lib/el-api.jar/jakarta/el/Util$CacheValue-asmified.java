...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/el/Util$CacheValue", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "ref", "Ljava/lang/ref/WeakReference;", "Ljava/lang/ref/WeakReference<Ljakarta/el/ExpressionFactory;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/Util$CacheValue", "lock", "Ljava/util/concurrent/locks/ReadWriteLock;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/Util$CacheValue", "lock", "Ljava/util/concurrent/locks/ReadWriteLock;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/Util$CacheValue", "ref", "Ljava/lang/ref/WeakReference;");
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/el/ExpressionFactory"});
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/Util$CacheValue", "ref", "Ljava/lang/ref/WeakReference;");
methodVisitor.visitInsn(RETURN);
