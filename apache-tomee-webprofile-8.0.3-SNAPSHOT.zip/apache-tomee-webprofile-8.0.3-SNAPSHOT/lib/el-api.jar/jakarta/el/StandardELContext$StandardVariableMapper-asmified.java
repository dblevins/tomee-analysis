...
public class StandardELContext$StandardVariableMapperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/el/StandardELContext$StandardVariableMapper", null, "jakarta/el/VariableMapper", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/StandardELContext$StandardVariableMapper", "vars", "Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/StandardELContext$StandardVariableMapper", "vars", "Ljava/util/Map;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljakarta/el/StandardELContext$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/el/StandardELContext$StandardVariableMapper", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
