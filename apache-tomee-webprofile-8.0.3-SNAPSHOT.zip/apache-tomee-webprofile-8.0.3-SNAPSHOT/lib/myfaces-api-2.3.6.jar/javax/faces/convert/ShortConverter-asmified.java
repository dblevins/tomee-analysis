...
public class ShortConverterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/faces/convert/ShortConverter", null, "java/lang/Object", new String[] { "javax/faces/convert/Converter" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CONVERTER_ID", "Ljava/lang/String;", null, "javax.faces.Short");
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "SHORT_ID", "Ljava/lang/String;", null, "javax.faces.converter.ShortConverter.SHORT");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("javax.faces.converter.ShortConverter.SHORT");
