...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/application/Application;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/ApplicationWrapper", "delegate", "Ljavax/faces/application/Application;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/ApplicationWrapper", "delegate", "Ljavax/faces/application/Application;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
