...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/faces/application/ResourceHandler", "getRenderedResources", "(Ljavax/faces/context/FacesContext;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/application/ResourceHandler", "javax/faces/context/FacesContext", "java/lang/String", "java/lang/String"}, 2, new Object[] {"java/util/Map", "java/lang/Object"});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/application/ResourceHandler", "javax/faces/context/FacesContext", "java/lang/String", "java/lang/String"}, 2, new Object[] {"java/util/Map", "java/lang/String"});
