...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/lifecycle/Lifecycle;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/lifecycle/LifecycleWrapper", "delegate", "Ljavax/faces/lifecycle/Lifecycle;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/lifecycle/LifecycleWrapper", "delegate", "Ljavax/faces/lifecycle/Lifecycle;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
