...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/lifecycle/ClientWindow;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/lifecycle/ClientWindowWrapper", "delegate", "Ljavax/faces/lifecycle/ClientWindow;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/lifecycle/ClientWindowWrapper", "delegate", "Ljavax/faces/lifecycle/ClientWindow;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
