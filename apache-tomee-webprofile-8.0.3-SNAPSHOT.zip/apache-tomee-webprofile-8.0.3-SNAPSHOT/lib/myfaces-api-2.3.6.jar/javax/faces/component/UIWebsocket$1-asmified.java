...
public class UIWebsocket$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/UIWebsocket$1", "Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;", "java/lang/Object", new String[] { "java/util/Collection" });
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Ljavax/faces/component/UIWebsocket;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljavax/faces/component/UIWebsocket;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIWebsocket$1", "this$0", "Ljavax/faces/component/UIWebsocket;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIWebsocket$1", "add", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
