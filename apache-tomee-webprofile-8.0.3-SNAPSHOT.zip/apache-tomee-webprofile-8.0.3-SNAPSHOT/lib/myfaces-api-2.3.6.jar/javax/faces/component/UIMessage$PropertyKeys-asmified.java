...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC | ACC_ENUM, "forVal", "Ljavax/faces/component/UIMessage$PropertyKeys;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIMessage$PropertyKeys", "c", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIMessage$PropertyKeys", "c", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/component/UIMessage$PropertyKeys", "forVal", "Ljavax/faces/component/UIMessage$PropertyKeys;");
methodVisitor.visitTypeInsn(NEW, "javax/faces/component/UIMessage$PropertyKeys");
methodVisitor.visitInsn(DUP);
