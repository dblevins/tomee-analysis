...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/_DeltaStateHelper$InternalList", "<T:Ljava/lang/Object;>Ljava/util/ArrayList<TT;>;Ljavax/faces/component/StateHolder;", "java/util/ArrayList", new String[] { "javax/faces/component/StateHolder" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"javax/faces/component/_DeltaStateHelper$InternalList", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/lang/Object;", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/_DeltaStateHelper$InternalList", "add", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/_DeltaStateHelper$InternalList", "size", "()I", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/_DeltaStateHelper$InternalList", "get", "(I)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
