...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/_MethodExpressionToMethodBinding", null, "javax/faces/el/MethodBinding", new String[] { "javax/faces/component/StateHolder" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/_MethodExpressionToMethodBinding", "isTransient", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/_MethodExpressionToMethodBinding", "methodExpression", "Ljavax/el/MethodExpression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/_MethodExpressionToMethodBinding", "methodExpression", "Ljavax/el/MethodExpression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/_MethodExpressionToMethodBinding", "isTransient", "Z");
Label label0 = new Label();
