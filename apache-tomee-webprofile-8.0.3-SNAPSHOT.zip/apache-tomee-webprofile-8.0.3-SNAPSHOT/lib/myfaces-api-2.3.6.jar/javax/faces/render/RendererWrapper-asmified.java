...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/render/RendererWrapper", "delegate", "Ljavax/faces/render/Renderer;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/render/RendererWrapper", "delegate", "Ljavax/faces/render/Renderer;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
