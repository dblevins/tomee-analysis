...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "clientBehaviorRenderers", "Ljava/util/HashMap;", "Ljava/util/HashMap<Ljava/lang/String;Ljavax/faces/render/ClientBehaviorRenderer;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/render/RenderKit", "clientBehaviorRenderers", "Ljava/util/HashMap;");
...
methodVisitor.visitTypeInsn(NEW, "java/lang/NullPointerException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("renderer is null");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/NullPointerException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/render/RenderKit", "clientBehaviorRenderers", "Ljava/util/HashMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
