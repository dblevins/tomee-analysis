...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/validator/BeanValidator$FacesMessageInterpolator", null, "java/lang/Object", new String[] { "javax/validation/MessageInterpolator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/validator/BeanValidator$FacesMessageInterpolator", "interpolator", "Ljavax/validation/MessageInterpolator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/validator/BeanValidator$FacesMessageInterpolator", "facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/validator/BeanValidator$FacesMessageInterpolator", "facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/validator/BeanValidator$FacesMessageInterpolator", "interpolator", "Ljavax/validation/MessageInterpolator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
