...
public class _ValidationUtilsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "jakarta/faces/validator/_ValidationUtils", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "tryBuildDefaultValidatorFactory", "()V", null, null);
methodVisitor.visitCode();
