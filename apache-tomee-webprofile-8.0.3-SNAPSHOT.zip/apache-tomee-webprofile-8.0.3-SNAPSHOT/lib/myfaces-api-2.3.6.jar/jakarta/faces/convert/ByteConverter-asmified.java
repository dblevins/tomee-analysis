...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/faces/convert/ByteConverter", null, "java/lang/Object", new String[] { "jakarta/faces/convert/Converter" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CONVERTER_ID", "Ljava/lang/String;", null, "jakarta.faces.Byte");
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "BYTE_ID", "Ljava/lang/String;", null, "jakarta.faces.converter.ByteConverter.BYTE");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("jakarta.faces.converter.ByteConverter.BYTE");
