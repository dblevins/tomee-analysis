...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/view/facelets/FaceletCacheFactory;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/view/facelets/FaceletCacheFactory", "delegate", "Ljakarta/faces/view/facelets/FaceletCacheFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/view/facelets/FaceletCacheFactory", "delegate", "Ljakarta/faces/view/facelets/FaceletCacheFactory;");
