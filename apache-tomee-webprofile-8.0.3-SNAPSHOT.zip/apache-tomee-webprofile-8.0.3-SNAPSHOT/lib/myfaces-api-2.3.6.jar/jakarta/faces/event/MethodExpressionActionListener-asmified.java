...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/faces/event/MethodExpressionActionListener", null, "java/lang/Object", new String[] { "jakarta/faces/event/ActionListener", "jakarta/faces/component/StateHolder" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/event/MethodExpressionActionListener", "isTransient", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/event/MethodExpressionActionListener", "methodExpressionOneArg", "Ljakarta/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/MethodExpressionActionListener", "_createZeroArgsMethodExpression", "(Ljakarta/el/MethodExpression;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/event/MethodExpressionActionListener", "methodExpressionZeroArg", "Ljakarta/el/MethodExpression;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/faces/event/MethodExpressionActionListener", "jakarta/el/MethodExpression", "jakarta/el/MethodExpression"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/MethodExpressionActionListener", "_createZeroArgsMethodExpression", "(Ljakarta/el/MethodExpression;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/event/MethodExpressionActionListener", "methodExpressionOneArg", "Ljakarta/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/MethodExpressionActionListener", "getElContext", "()Ljakarta/el/ELContext;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/event/MethodExpressionActionListener", "methodExpressionZeroArg", "Ljakarta/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/MethodExpressionActionListener", "getElContext", "()Ljakarta/el/ELContext;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/event/MethodExpressionActionListener", "EMPTY_PARAMS", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/el/MethodExpression", "invoke", "(Ljakarta/el/ELContext;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/event/MethodExpressionActionListener", "isTransient", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/MethodExpressionActionListener", "getFacesContext", "()Ljakarta/faces/context/FacesContext;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/event/MethodExpressionActionListener", "EMPTY_CLASS_ARRAY", "[Ljava/lang/Class;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/event/MethodExpressionActionListener", "EMPTY_CLASS_ARRAY", "[Ljava/lang/Class;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/event/MethodExpressionActionListener", "EMPTY_PARAMS", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
