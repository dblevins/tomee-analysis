...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/event/PhaseId", "_name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/event/PhaseId", "_ordinal", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/event/PhaseId", "_ordinal", "I");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/event/PhaseId", "_name", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/event/PhaseId", "VALUES", "Ljava/util/List;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/event/PhaseId", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/PhaseId", "<init>", "(Ljava/lang/String;I)V", false);
