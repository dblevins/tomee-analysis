...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/context/ExceptionHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/context/ExceptionHandlerWrapper", "delegate", "Ljakarta/faces/context/ExceptionHandler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/context/ExceptionHandlerWrapper", "delegate", "Ljakarta/faces/context/ExceptionHandler;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
