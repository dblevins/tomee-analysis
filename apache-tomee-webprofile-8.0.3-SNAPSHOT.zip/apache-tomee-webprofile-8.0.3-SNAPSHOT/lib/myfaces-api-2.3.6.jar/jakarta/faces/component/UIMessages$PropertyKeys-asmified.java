...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC | ACC_ENUM, "forVal", "Ljakarta/faces/component/UIMessages$PropertyKeys;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIMessages$PropertyKeys", "c", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIMessages$PropertyKeys", "c", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/UIMessages$PropertyKeys", "forVal", "Ljakarta/faces/component/UIMessages$PropertyKeys;");
