...
public class _HtmlOutputLinkDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getFragment", "()Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
