...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/component/_ParametrizableFacesMessage", null, "jakarta/faces/application/FacesMessage", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"jakarta/faces/component/_ParametrizableFacesMessage", "java/lang/String", "java/lang/String", "[Ljava/lang/Object;", "java/util/Locale"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_locale", "Ljava/util/Locale;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_args", "[Ljava/lang/Object;");
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"jakarta/faces/component/_ParametrizableFacesMessage", "jakarta/faces/application/FacesMessage$Severity", "java/lang/String", "java/lang/String", "[Ljava/lang/Object;", "java/util/Locale"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_locale", "Ljava/util/Locale;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedArgs", "[Ljava/lang/Object;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_args", "[Ljava/lang/Object;");
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/_ParametrizableFacesMessage", "evaluateArgs", "()V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedDetail", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_locale", "Ljava/util/Locale;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedDetail", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedSummary", "Ljava/lang/String;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label1);
methodVisitor.visitTypeInsn(NEW, "java/text/MessageFormat");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedArgs", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/text/MessageFormat", "format", "(Ljava/lang/Object;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedSummary", "Ljava/lang/String;");
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedSummary", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ParametrizableFacesMessage", "_evaluatedArgs", "[Ljava/lang/Object;");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 1);
