...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/component/_PropertyDescriptorHolder", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_PropertyDescriptorHolder", "_descriptor", "Ljava/beans/PropertyDescriptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/lang/ref/SoftReference");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_PropertyDescriptorHolder", "_descriptor", "Ljava/beans/PropertyDescriptor;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_PropertyDescriptorHolder", "_readMethodRef", "Ljava/lang/ref/Reference;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_PropertyDescriptorHolder", "_readMethodRef", "Ljava/lang/ref/Reference;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_PropertyDescriptorHolder", "_writeMethodRef", "Ljava/lang/ref/Reference;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/ref/SoftReference", "<init>", "(Ljava/lang/Object;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_PropertyDescriptorHolder", "_writeMethodRef", "Ljava/lang/ref/Reference;");
