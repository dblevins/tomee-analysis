...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_stateHelper", "Ljakarta/faces/component/behavior/_DeltaStateHelper;", "Ljakarta/faces/component/behavior/_DeltaStateHelper<Ljakarta/faces/component/behavior/AjaxBehavior;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/behavior/AjaxBehavior", "_stateHelper", "Ljakarta/faces/component/behavior/_DeltaStateHelper;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/ClientBehaviorBase", "addBehaviorListener", "(Ljakarta/faces/event/BehaviorListener;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/AjaxBehavior", "evalForCollection", "(Ljava/lang/String;)Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/AjaxBehavior", "getStateHelper", "()Ljakarta/faces/component/StateHelper;", false);
methodVisitor.visitLdcInsn("execute");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/AjaxBehavior", "getStateHelper", "()Ljakarta/faces/component/StateHelper;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/behavior/AjaxBehavior$PropertyKeys", "bindings", "Ljakarta/faces/component/behavior/AjaxBehavior$PropertyKeys;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getStateHelper", "()Ljakarta/faces/component/StateHelper;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/AjaxBehavior", "getStateHelper", "(Z)Ljakarta/faces/component/StateHelper;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getStateHelper", "(Z)Ljakarta/faces/component/StateHelper;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/behavior/AjaxBehavior", "_stateHelper", "Ljakarta/faces/component/behavior/_DeltaStateHelper;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/component/behavior/_DeltaStateHelper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/_DeltaStateHelper", "<init>", "(Ljakarta/faces/component/behavior/AjaxBehavior;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/behavior/AjaxBehavior", "_stateHelper", "Ljakarta/faces/component/behavior/_DeltaStateHelper;");
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "java/lang/Object", "jakarta/faces/component/StateHelper"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/AjaxBehavior", "getCollectionFromSpaceSplitString", "(Ljava/lang/String;)Ljava/util/Collection;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_FORM_LIST", "Ljava/util/Collection;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_ALL_LIST", "Ljava/util/Collection;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_NONE_LIST", "Ljava/util/Collection;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_THIS_LIST", "Ljava/util/Collection;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_FORM_LIST", "Ljava/util/Collection;");
methodVisitor.visitLdcInsn("@all");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Collections", "singletonList", "(Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_ALL_LIST", "Ljava/util/Collection;");
methodVisitor.visitLdcInsn("@this");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Collections", "singletonList", "(Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_THIS_LIST", "Ljava/util/Collection;");
methodVisitor.visitLdcInsn("@none");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Collections", "singletonList", "(Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/behavior/AjaxBehavior", "VAL_NONE_LIST", "Ljava/util/Collection;");
methodVisitor.visitInsn(RETURN);
