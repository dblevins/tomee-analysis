...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/component/_ComponentFacetMap$ComponentFacetEntrySet", "Ljava/util/AbstractSet<Ljava/util/Map$Entry<Ljava/lang/String;TV;>;>;", "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/_ComponentFacetMap$ComponentFacetEntrySet", "this$0", "Ljakarta/faces/component/_ComponentFacetMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/_ComponentFacetMap$ComponentFacetEntrySet", "this$0", "Ljakarta/faces/component/_ComponentFacetMap;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/component/_ComponentFacetMap$ComponentFacetEntryIterator");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/_ComponentFacetMap$ComponentFacetEntryIterator", "<init>", "(Ljakarta/faces/component/_ComponentFacetMap;Ljava/util/Iterator;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Map$Entry");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/_ComponentFacetMap$ComponentFacetEntrySet", "add", "(Ljava/util/Map$Entry;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
