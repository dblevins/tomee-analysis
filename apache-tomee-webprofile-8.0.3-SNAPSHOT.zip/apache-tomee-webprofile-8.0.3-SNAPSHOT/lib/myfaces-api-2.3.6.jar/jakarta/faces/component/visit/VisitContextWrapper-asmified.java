...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/component/visit/VisitContext;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/visit/VisitContextWrapper", "delegate", "Ljakarta/faces/component/visit/VisitContext;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/visit/VisitContextWrapper", "delegate", "Ljakarta/faces/component/visit/VisitContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
