...
public class IBinaryFieldDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/jdt/internal/compiler/env/IBinaryField", null, "java/lang/Object", new String[] { "org/eclipse/jdt/internal/compiler/env/IGenericField" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getConstant", "()Lorg/eclipse/jdt/internal/compiler/impl/Constant;", null, null);
methodVisitor.visitEnd();
}
{
