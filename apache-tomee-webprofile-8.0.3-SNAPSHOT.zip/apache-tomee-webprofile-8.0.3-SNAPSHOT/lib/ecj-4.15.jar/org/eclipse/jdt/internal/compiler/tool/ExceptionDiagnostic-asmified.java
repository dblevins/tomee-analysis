...
public class ExceptionDiagnosticDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/eclipse/jdt/internal/compiler/tool/ExceptionDiagnostic", "Ljava/lang/Object;Ljavax/tools/Diagnostic<Ljavax/tools/JavaFileObject;>;", "java/lang/Object", new String[] { "javax/tools/Diagnostic" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "exception", "Ljava/lang/Exception;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/tool/ExceptionDiagnostic", "exception", "Ljava/lang/Exception;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/tool/ExceptionDiagnostic", "exception", "Ljava/lang/Exception;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/ExceptionDiagnostic", "getSource", "()Ljavax/tools/JavaFileObject;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
