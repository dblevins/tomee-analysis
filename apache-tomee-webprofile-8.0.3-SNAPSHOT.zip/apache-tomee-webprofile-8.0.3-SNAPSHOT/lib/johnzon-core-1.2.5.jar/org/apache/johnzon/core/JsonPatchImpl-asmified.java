...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/core/JsonPatchImpl", null, "java/lang/Object", new String[] { "javax/json/JsonPatch" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "json", "Ljavax/json/JsonArray;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_VARARGS, "<init>", "(Ljavax/json/spi/JsonProvider;[Lorg/apache/johnzon/core/JsonPatchImpl$PatchValue;)V", null, null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljavax/json/spi/JsonProvider;Ljava/util/List;)V", "(Ljavax/json/spi/JsonProvider;Ljava/util/List<Lorg/apache/johnzon/core/JsonPatchImpl$PatchValue;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonPatchImpl", "provider", "Ljavax/json/spi/JsonProvider;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/johnzon/core/JsonPatchImpl", "javax/json/spi/JsonProvider", "java/util/List"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "apply", "(Ljavax/json/JsonStructure;)Ljavax/json/JsonStructure;", "<T::Ljavax/json/JsonStructure;>(TT;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/json/JsonStructure", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/johnzon/core/JsonPatchImpl$PatchValue", "access$000", "(Lorg/apache/johnzon/core/JsonPatchImpl$PatchValue;)Ljavax/json/JsonPatch$Operation;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/johnzon/core/JsonPatchImpl$PatchValue", "access$100", "(Lorg/apache/johnzon/core/JsonPatchImpl$PatchValue;)Ljavax/json/JsonValue;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonPointerImpl", "add", "(Ljavax/json/JsonStructure;Ljavax/json/JsonValue;)Ljavax/json/JsonStructure;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/johnzon/core/JsonPatchImpl$PatchValue", "access$200", "(Lorg/apache/johnzon/core/JsonPatchImpl$PatchValue;)Lorg/apache/johnzon/core/JsonPointerImpl;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonPointerImpl", "remove", "(Ljavax/json/JsonStructure;)Ljavax/json/JsonStructure;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitJumpInsn(GOTO, label9);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "toJsonArray", "()Ljavax/json/JsonArray;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonPatchImpl", "json", "Ljavax/json/JsonArray;");
Label label5 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonPatchImpl", "provider", "Ljavax/json/spi/JsonProvider;");
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "javax/json/JsonArrayBuilder", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label8 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonPatchImpl$PatchValue", "toJson", "()Ljavax/json/JsonObject;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonPatchImpl", "json", "Ljavax/json/JsonArray;");
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonPatchImpl", "toJsonArray", "()Ljavax/json/JsonArray;", false);
