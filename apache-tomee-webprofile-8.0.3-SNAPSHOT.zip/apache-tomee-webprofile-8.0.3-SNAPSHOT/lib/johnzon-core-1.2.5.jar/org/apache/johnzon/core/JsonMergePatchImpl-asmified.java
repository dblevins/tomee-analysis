...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/core/JsonMergePatchImpl", null, "java/lang/Object", new String[] { "javax/json/JsonMergePatch", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "patch", "Ljavax/json/JsonValue;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/json/JsonValue;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider;)V", "(Ljavax/json/JsonValue;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider<[C>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonMergePatchImpl", "patch", "Ljavax/json/JsonValue;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "apply", "(Ljavax/json/JsonValue;)Ljavax/json/JsonValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonMergePatchImpl", "patch", "Ljavax/json/JsonValue;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JsonMergePatchImpl", "applyPatch", "(Ljavax/json/JsonValue;Ljavax/json/JsonValue;)Ljavax/json/JsonValue;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "applyPatch", "(Ljavax/json/JsonValue;Ljavax/json/JsonValue;)Ljavax/json/JsonValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JsonMergePatchImpl", "applyJsonObjectPatch", "(Ljavax/json/JsonObject;Ljavax/json/JsonObject;)Ljavax/json/JsonValue;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "applyJsonObjectPatch", "(Ljavax/json/JsonObject;Ljavax/json/JsonObject;)Ljavax/json/JsonValue;", null, null);
methodVisitor.visitCode();
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/json/JsonObjectBuilder", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/json/JsonObjectBuilder", "remove", "(Ljava/lang/String;)Ljavax/json/JsonObjectBuilder;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "toJsonValue", "()Ljavax/json/JsonValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonMergePatchImpl", "patch", "Ljavax/json/JsonValue;");
methodVisitor.visitInsn(ARETURN);
