...
public class JsonPatchImpl$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/johnzon/core/JsonPatchImpl$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/johnzon/core/JsonPatchImpl", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$javax$json$JsonPatch$Operation", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/johnzon/core/JsonPatchImpl$1", "$SwitchMap$javax$json$JsonPatch$Operation", "[I");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/JsonPatch$Operation", "ordinal", "()I", false);
