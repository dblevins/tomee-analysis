...
public class LogExceptionDump implements Opcodes {
...
classWriter.visit(V1_4, ACC_PUBLIC | ACC_SUPER, "org/objectweb/howl/log/LogException", null, "java/lang/Exception", null);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-7955598809372627369L));
