...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/server/httpd/OpenEJBAsyncContext", "access$300", "(Lorg/apache/openejb/server/httpd/OpenEJBAsyncContext;)Ljakarta/servlet/AsyncEvent;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/httpd/OpenEJBAsyncContext$1", "java/util/Iterator", "org/apache/openejb/server/httpd/OpenEJBAsyncContext", "java/util/Iterator", "jakarta/servlet/AsyncListener"}, 1, new Object[] {"java/io/IOException"});
