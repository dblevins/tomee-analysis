...
public class ServletSessionAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/server/httpd/ServletSessionAdapter", null, "java/lang/Object", new String[] { "org/apache/openejb/server/httpd/HttpSession" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "session", "Ljavax/servlet/http/HttpSession;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/httpd/ServletSessionAdapter", "session", "Ljavax/servlet/http/HttpSession;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletSessionAdapter", "session", "Ljavax/servlet/http/HttpSession;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSessionContext", "()Ljavax/servlet/http/HttpSessionContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletSessionAdapter", "session", "Ljavax/servlet/http/HttpSession;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletSessionAdapter", "session", "Ljavax/servlet/http/HttpSession;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpSession", "getValue", "(Ljava/lang/String;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpSession", "putValue", "(Ljava/lang/String;Ljava/lang/Object;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletSessionAdapter", "session", "Ljavax/servlet/http/HttpSession;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpSession", "removeValue", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
