...
public class ServletByteArrayOutputStreamDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/httpd/ServletByteArrayOutputStream", "outputStream", "Ljava/io/ByteArrayOutputStream;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletByteArrayOutputStream", "outputStream", "Ljava/io/ByteArrayOutputStream;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOutputStream", "()Ljava/io/ByteArrayOutputStream;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletByteArrayOutputStream", "outputStream", "Ljava/io/ByteArrayOutputStream;");
