...
public class SqlTimestampConverterDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/beanutils/converters/SqlTimestampConverter", null, "org/apache/commons/beanutils/converters/DateTimeConverter", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/converters/DateTimeConverter", "<init>", "()V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/converters/DateTimeConverter", "<init>", "(Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
