...
public class BigIntegerLocaleConverterDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter", null, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter", "<init>", "(Z)V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter", "<init>", "(Ljava/util/Locale;Ljava/lang/String;Z)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter", "<init>", "(Ljava/lang/Object;Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Locale", "getDefault", "()Ljava/util/Locale;", false);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter", "<init>", "(Ljava/lang/Object;Ljava/util/Locale;Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/BigIntegerLocaleConverter", "<init>", "(Ljava/lang/Object;Ljava/util/Locale;Ljava/lang/String;Z)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitLdcInsn("Suplied number is not of type BigInteger: ");
