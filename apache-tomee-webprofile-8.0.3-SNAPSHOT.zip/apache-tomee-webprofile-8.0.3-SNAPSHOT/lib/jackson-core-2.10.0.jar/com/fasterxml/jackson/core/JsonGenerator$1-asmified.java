...
public class JsonGenerator$1Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER | ACC_SYNTHETIC, "com/fasterxml/jackson/core/JsonGenerator$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/fasterxml/jackson/core/JsonGenerator", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/fasterxml/jackson/core/type/WritableTypeId$Inclusion", "values", "()[Lcom/fasterxml/jackson/core/type/WritableTypeId$Inclusion;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/core/JsonGenerator$1", "$SwitchMap$com$fasterxml$jackson$core$type$WritableTypeId$Inclusion", "[I");
