...
public class DefaultPrettyPrinter$FixedSpaceIndenterDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "com/fasterxml/jackson/core/util/DefaultPrettyPrinter$FixedSpaceIndenter", null, "com/fasterxml/jackson/core/util/DefaultPrettyPrinter$NopIndenter", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "instance", "Lcom/fasterxml/jackson/core/util/DefaultPrettyPrinter$FixedSpaceIndenter;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/fasterxml/jackson/core/util/DefaultPrettyPrinter$FixedSpaceIndenter");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/fasterxml/jackson/core/util/DefaultPrettyPrinter$FixedSpaceIndenter", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/core/util/DefaultPrettyPrinter$FixedSpaceIndenter", "instance", "Lcom/fasterxml/jackson/core/util/DefaultPrettyPrinter$FixedSpaceIndenter;");
methodVisitor.visitInsn(RETURN);
