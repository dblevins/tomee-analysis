...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/servlet/http/HttpServletResponse", null, "java/lang/Object", new String[] { "jakarta/servlet/ServletResponse" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addCookie", "(Ljakarta/servlet/http/Cookie;)V", null, null);
