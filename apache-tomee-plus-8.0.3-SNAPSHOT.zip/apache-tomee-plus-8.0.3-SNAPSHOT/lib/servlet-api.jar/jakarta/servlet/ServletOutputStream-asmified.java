...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "jakarta/servlet/ServletOutputStream", null, "java/io/OutputStream", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/ServletOutputStream", "lStrings", "Ljava/util/ResourceBundle;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setWriteListener", "(Ljakarta/servlet/WriteListener;)V", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/servlet/ServletOutputStream", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
