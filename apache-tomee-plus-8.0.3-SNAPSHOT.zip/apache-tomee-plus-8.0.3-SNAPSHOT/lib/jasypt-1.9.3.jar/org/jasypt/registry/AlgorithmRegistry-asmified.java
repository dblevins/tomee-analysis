package asm.org.jasypt.registry;
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/registry/AlgorithmRegistry", null, "java/lang/Object", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getAllDigestAlgorithms", "()Ljava/util/Set;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getAllPBEAlgorithms", "()Ljava/util/Set;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLdcInsn("PBE");
