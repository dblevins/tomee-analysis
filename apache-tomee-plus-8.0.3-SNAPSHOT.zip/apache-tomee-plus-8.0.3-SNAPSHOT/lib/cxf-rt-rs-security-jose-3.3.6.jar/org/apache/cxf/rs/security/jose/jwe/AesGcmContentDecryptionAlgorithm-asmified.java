...
public class AesGcmContentDecryptionAlgorithmDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jwe/AesGcmContentDecryptionAlgorithm", null, "org/apache/cxf/rs/security/jose/jwe/AbstractContentEncryptionCipherProperties", new String[] { "org/apache/cxf/rs/security/jose/jwe/ContentDecryptionProvider" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jwe/AesGcmContentDecryptionAlgorithm", "getAlgorithm", "()Lorg/apache/cxf/rs/security/jose/jwa/ContentAlgorithm;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jwa/ContentAlgorithm", "getJwaName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/rs/security/jose/jwe/AesGcmContentDecryptionAlgorithm", "LOG", "Ljava/util/logging/Logger;");
