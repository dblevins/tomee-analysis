...
public class AesWrapKeyEncryptionAlgorithmDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jwe/AesWrapKeyEncryptionAlgorithm", null, "org/apache/cxf/rs/security/jose/jwe/AbstractWrapKeyEncryptionAlgorithm", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/rs/security/jose/jwe/AesWrapKeyEncryptionAlgorithm", "SUPPORTED_ALGORITHMS", "Ljava/util/Set;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jwe/AbstractWrapKeyEncryptionAlgorithm", "<init>", "(Ljava/security/Key;Lorg/apache/cxf/rs/security/jose/jwa/KeyAlgorithm;Ljava/util/Set;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/rs/security/jose/jwe/AesWrapKeyEncryptionAlgorithm", "SUPPORTED_ALGORITHMS", "Ljava/util/Set;");
methodVisitor.visitInsn(RETURN);
