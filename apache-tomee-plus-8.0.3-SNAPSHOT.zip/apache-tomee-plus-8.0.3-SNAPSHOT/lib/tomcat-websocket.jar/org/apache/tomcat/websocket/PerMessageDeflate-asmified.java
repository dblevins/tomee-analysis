...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "negotiate", "(Ljava/util/List;Z)Lorg/apache/tomcat/websocket/PerMessageDeflate;", "(Ljava/util/List<Ljava/util/List<Ljakarta/websocket/Extension$Parameter;>;>;Z)Lorg/apache/tomcat/websocket/PerMessageDeflate;", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/websocket/Extension$Parameter"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/MessagePart", "getIntermediateHandler", "()Ljakarta/websocket/SendHandler;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "java/nio/ByteBuffer", "jakarta/websocket/SendHandler"}, 0, null);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label16);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {Opcodes.INTEGER});
...
methodVisitor.visitJumpInsn(GOTO, label19);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/tomcat/websocket/PerMessageDeflate", "java/util/List", "java/util/List", "java/util/Iterator", "org/apache/tomcat/websocket/MessagePart", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", "java/nio/ByteBuffer", "jakarta/websocket/SendHandler", Opcodes.INTEGER, Opcodes.INTEGER, "java/nio/ByteBuffer"}, 1, new Object[] {"java/lang/NullPointerException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/apache/tomcat/websocket/PerMessageDeflate", "java/util/List", "java/util/List", "java/util/Iterator", "org/apache/tomcat/websocket/MessagePart", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", "java/nio/ByteBuffer", "jakarta/websocket/SendHandler", Opcodes.INTEGER, Opcodes.INTEGER, "java/nio/ByteBuffer", "org/apache/tomcat/websocket/MessagePart", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.LONG}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label24);
methodVisitor.visitLabel(label27);
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/apache/tomcat/websocket/PerMessageDeflate", "java/util/List", "java/util/List", "java/util/Iterator", "org/apache/tomcat/websocket/MessagePart", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", "java/nio/ByteBuffer", "jakarta/websocket/SendHandler", Opcodes.INTEGER, Opcodes.INTEGER, "java/nio/ByteBuffer", Opcodes.TOP, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.LONG}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label17);
methodVisitor.visitLabel(label18);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/tomcat/websocket/PerMessageDeflate", "java/util/List", "java/util/List", "java/util/Iterator", "org/apache/tomcat/websocket/MessagePart", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", "java/nio/ByteBuffer", "jakarta/websocket/SendHandler", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/tomcat/websocket/MessagePart");
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/MessagePart", "setEndHandler", "(Ljakarta/websocket/SendHandler;)V", false);
methodVisitor.visitLabel(label31);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/websocket/SendHandler", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 7);
