...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/websocket/server/WsServerContainer", null, "org/apache/tomcat/websocket/WsWebSocketContainer", new String[] { "javax/websocket/server/ServerContainer" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "AUTHENTICATED_HTTP_SESSION_CLOSED", "Ljavax/websocket/CloseReason;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/websocket/server/WsServerContainer", "servletContext", "Ljavax/servlet/ServletContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "javax/servlet/ServletContext", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addEndpoint", "(Ljavax/websocket/server/ServerEndpointConfig;)V", null, new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer", "addEndpoint", "(Ljavax/websocket/server/ServerEndpointConfig;Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "addEndpoint", "(Ljavax/websocket/server/ServerEndpointConfig;Z)V", null, new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/websocket/server/WsServerContainer", "servletContext", "Ljavax/servlet/ServletContext;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/server/WsServerContainer$TemplatePathMatch", "<init>", "(Ljavax/websocket/server/ServerEndpointConfig;Lorg/apache/tomcat/websocket/server/UriTemplate;Z)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer$TemplatePathMatch", "getConfig", "()Ljavax/websocket/server/ServerEndpointConfig;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpointConfig", "getEndpointClass", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer$TemplatePathMatch", "getConfig", "()Ljavax/websocket/server/ServerEndpointConfig;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpointConfig", "getEndpointClass", "()Ljava/lang/Class;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "javax/websocket/server/ServerEndpointConfig", Opcodes.INTEGER, "java/lang/String", "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "org/apache/tomcat/websocket/server/UriTemplate"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/server/WsServerContainer$ExactPathMatch", "<init>", "(Ljavax/websocket/server/ServerEndpointConfig;Z)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer$ExactPathMatch", "getConfig", "()Ljavax/websocket/server/ServerEndpointConfig;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpointConfig", "getEndpointClass", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer$ExactPathMatch", "getConfig", "()Ljavax/websocket/server/ServerEndpointConfig;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpointConfig", "getEndpointClass", "()Ljava/lang/Class;", true);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "javax/websocket/server/ServerEndpointConfig", Opcodes.INTEGER}, 1, new Object[] {"javax/websocket/DeploymentException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addEndpoint", "(Ljava/lang/Class;)V", "(Ljava/lang/Class<*>;)V", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(0, "addEndpoint", "(Ljava/lang/Class;Z)V", "(Ljava/lang/Class<*>;Z)V", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/websocket/server/ServerEndpoint");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label6 = new Label();
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.TOP, "javax/websocket/server/ServerEndpoint"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpoint", "value", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpoint", "encoders", "()[Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpoint", "configurator", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "java/lang/Class", Opcodes.INTEGER, Opcodes.TOP, "javax/websocket/server/ServerEndpoint", "java/lang/String", "java/lang/Class", "javax/websocket/server/ServerEndpointConfig$Configurator"}, 1, new Object[] {"java/lang/ReflectiveOperationException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitTypeInsn(NEW, "javax/websocket/DeploymentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomcat/websocket/server/WsServerContainer", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpoint", "decoders", "()[Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/server/ServerEndpointConfig$Builder", "decoders", "(Ljava/util/List;)Ljavax/websocket/server/ServerEndpointConfig$Builder;", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpoint", "encoders", "()[Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/server/ServerEndpointConfig$Builder", "encoders", "(Ljava/util/List;)Ljavax/websocket/server/ServerEndpointConfig$Builder;", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/server/ServerEndpoint", "subprotocols", "()[Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/server/ServerEndpointConfig$Builder", "subprotocols", "(Ljava/util/List;)Ljavax/websocket/server/ServerEndpointConfig$Builder;", false);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "java/lang/Class", Opcodes.INTEGER}, 1, new Object[] {"javax/websocket/DeploymentException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer", "failDeployment", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/websocket/server/ServerEndpointConfig"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/server/WsServerContainer", "addEndpoint", "(Ljavax/websocket/server/ServerEndpointConfig;Z)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "doUpgrade", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljavax/websocket/server/ServerEndpointConfig;Ljava/util/Map;)V", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljavax/websocket/server/ServerEndpointConfig;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)V", new String[] { "javax/servlet/ServletException", "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/server/WsMappingResult", "<init>", "(Ljavax/websocket/server/ServerEndpointConfig;Ljava/util/Map;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/tomcat/websocket/server/WsServerContainer", "java/lang/String", "org/apache/tomcat/websocket/server/WsServerContainer$ExactPathMatch", "org/apache/tomcat/websocket/server/UriTemplate"}, 1, new Object[] {"javax/websocket/DeploymentException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label5);
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/websocket/server/ServerEndpointConfig", "java/util/Map", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomcat/websocket/server/WsServerContainer", "AUTHENTICATED_HTTP_SESSION_CLOSED", "Ljavax/websocket/CloseReason;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "validateEncoders", "([Ljava/lang/Class;)V", "([Ljava/lang/Class<+Ljavax/websocket/Encoder;>;)V", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/websocket/server/WsServerContainer", "AUTHENTICATED_HTTP_SESSION_CLOSED", "Ljavax/websocket/CloseReason;");
methodVisitor.visitInsn(RETURN);
