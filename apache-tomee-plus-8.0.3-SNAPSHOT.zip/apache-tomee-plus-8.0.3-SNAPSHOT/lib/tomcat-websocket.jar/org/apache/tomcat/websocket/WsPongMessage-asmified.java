...
public class WsPongMessageDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/websocket/WsPongMessage", "applicationData", "Ljava/nio/ByteBuffer;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getApplicationData", "()Ljava/nio/ByteBuffer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/websocket/WsPongMessage", "applicationData", "Ljava/nio/ByteBuffer;");
