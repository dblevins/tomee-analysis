...
public class ELExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "jakarta/servlet/jsp/el/ELException", null, "java/lang/Exception", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getRootCause", "()Ljava/lang/Throwable;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
