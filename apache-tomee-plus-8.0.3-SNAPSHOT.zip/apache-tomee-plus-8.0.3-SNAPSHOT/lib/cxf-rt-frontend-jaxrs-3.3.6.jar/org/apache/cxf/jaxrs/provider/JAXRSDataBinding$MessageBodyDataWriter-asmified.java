...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/provider/JAXRSDataBinding$MessageBodyDataWriter", "this$0", "Lorg/apache/cxf/jaxrs/provider/JAXRSDataBinding;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/provider/JAXRSDataBinding", "access$200", "(Lorg/apache/cxf/jaxrs/provider/JAXRSDataBinding;Lorg/apache/cxf/message/Message;)Ljavax/ws/rs/core/MultivaluedMap;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/provider/JAXRSDataBinding$MessageBodyDataWriter", "this$0", "Lorg/apache/cxf/jaxrs/provider/JAXRSDataBinding;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/provider/JAXRSDataBinding", "access$300", "(Lorg/apache/cxf/jaxrs/provider/JAXRSDataBinding;)Ljavax/ws/rs/ext/MessageBodyWriter;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
