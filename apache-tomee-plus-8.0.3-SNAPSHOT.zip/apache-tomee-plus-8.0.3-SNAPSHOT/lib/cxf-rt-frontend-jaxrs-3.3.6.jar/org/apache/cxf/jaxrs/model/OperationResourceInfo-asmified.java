...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "produceMimes", "Ljava/util/List;", "Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "consumeMimes", "Ljava/util/List;", "Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProduceTypes", "()Ljava/util/List;", "()Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/model/OperationResourceInfo", "produceMimes", "Ljava/util/List;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConsumeTypes", "()Ljava/util/List;", "()Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/model/OperationResourceInfo", "consumeMimes", "Ljava/util/List;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ws/rs/Consumes");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/Consumes", "value", "()[Ljava/lang/String;", true);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/ws/rs/Consumes"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/model/OperationResourceInfo", "classResourceInfo", "Lorg/apache/cxf/jaxrs/model/ClassResourceInfo;");
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/ws/rs/Produces"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/model/OperationResourceInfo", "classResourceInfo", "Lorg/apache/cxf/jaxrs/model/ClassResourceInfo;");
