...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "h", "Ljavax/ws/rs/core/HttpHeaders;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/AbstractRequestContextImpl", "h", "Ljavax/ws/rs/core/HttpHeaders;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "abortWith", "(Ljavax/ws/rs/core/Response;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/AbstractRequestContextImpl", "getHttpHeaders", "()Ljavax/ws/rs/core/HttpHeaders;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getHttpHeaders", "()Ljavax/ws/rs/core/HttpHeaders;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/AbstractRequestContextImpl", "h", "Ljavax/ws/rs/core/HttpHeaders;");
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/ws/rs/core/HttpHeaders"});
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
