...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxrs/provider/ProviderFactory$ContextResolverComparator", "Ljava/lang/Object;Ljava/util/Comparator<Lorg/apache/cxf/jaxrs/model/ProviderInfo<Ljakarta/ws/rs/ext/ContextResolver<*>;>;>;", "java/lang/Object", new String[] { "java/util/Comparator" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "compare", "(Lorg/apache/cxf/jaxrs/model/ProviderInfo;Lorg/apache/cxf/jaxrs/model/ProviderInfo;)I", "(Lorg/apache/cxf/jaxrs/model/ProviderInfo<Ljakarta/ws/rs/ext/ContextResolver<*>;>;Lorg/apache/cxf/jaxrs/model/ProviderInfo<Ljakarta/ws/rs/ext/ContextResolver<*>;>;)I", null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/utils/JAXRSUtils", "getProduceTypes", "(Ljakarta/ws/rs/Produces;)Ljava/util/List;", false);
