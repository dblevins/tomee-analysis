...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "isSupported", "(Ljava/lang/Class;Ljakarta/ws/rs/core/MediaType;)Z", false);
...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "jakarta/ws/rs/WebApplicationException");
Label label5 = new Label();
Label label6 = new Label();
methodVisitor.visitTryCatchBlock(label5, label6, label2, "jakarta/ws/rs/WebApplicationException");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/ws/rs/core/MediaType", "MULTIPART_FORM_DATA_TYPE", "Ljakarta/ws/rs/core/MediaType;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "createMap", "(Ljava/lang/Class;)Ljakarta/ws/rs/core/MultivaluedMap;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/jaxrs/provider/FormEncodingProvider", "java/lang/Class", "java/lang/reflect/Type", "[Ljava/lang/annotation/Annotation;", "jakarta/ws/rs/core/MediaType", "jakarta/ws/rs/core/MultivaluedMap", "java/io/InputStream", "jakarta/ws/rs/core/MultivaluedMap"}, 5, new Object[] {"org/apache/cxf/jaxrs/provider/FormEncodingProvider", "jakarta/ws/rs/core/MultivaluedMap", "[Ljava/lang/annotation/Annotation;", "java/io/InputStream", "jakarta/ws/rs/core/MediaType"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/jaxrs/provider/FormEncodingProvider", "java/lang/Class", "java/lang/reflect/Type", "[Ljava/lang/annotation/Annotation;", "jakarta/ws/rs/core/MediaType", "jakarta/ws/rs/core/MultivaluedMap", "java/io/InputStream", "jakarta/ws/rs/core/MultivaluedMap"}, 6, new Object[] {"org/apache/cxf/jaxrs/provider/FormEncodingProvider", "jakarta/ws/rs/core/MultivaluedMap", "[Ljava/lang/annotation/Annotation;", "java/io/InputStream", "jakarta/ws/rs/core/MediaType", Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "populateMap", "(Ljakarta/ws/rs/core/MultivaluedMap;[Ljava/lang/annotation/Annotation;Ljava/io/InputStream;Ljakarta/ws/rs/core/MediaType;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "validateMap", "(Ljakarta/ws/rs/core/MultivaluedMap;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "persistParamsOnMessage", "(Ljakarta/ws/rs/core/MultivaluedMap;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "getFormObject", "(Ljava/lang/Class;Ljakarta/ws/rs/core/MultivaluedMap;)Ljava/lang/Object;", false);
methodVisitor.visitLabel(label6);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxrs/provider/FormEncodingProvider", "java/lang/Class", "java/lang/reflect/Type", "[Ljava/lang/annotation/Annotation;", "jakarta/ws/rs/core/MediaType", "jakarta/ws/rs/core/MultivaluedMap", "java/io/InputStream"}, 1, new Object[] {"jakarta/ws/rs/WebApplicationException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "persistParamsOnMessage", "(Ljakarta/ws/rs/core/MultivaluedMap;)V", "(Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;)V", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createMap", "(Ljava/lang/Class;)Ljakarta/ws/rs/core/MultivaluedMap;", "(Ljava/lang/Class<*>;)Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;", new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getFormObject", "(Ljava/lang/Class;Ljakarta/ws/rs/core/MultivaluedMap;)Ljava/lang/Object;", "(Ljava/lang/Class<TT;>;Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/ws/rs/core/Form;"));
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxrs/provider/FormEncodingProvider", "java/lang/Class", "jakarta/ws/rs/core/MultivaluedMap"}, 2, new Object[] {"java/lang/Class", "java/lang/Object"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "populateMap", "(Ljakarta/ws/rs/core/MultivaluedMap;[Ljava/lang/annotation/Annotation;Ljava/io/InputStream;Ljakarta/ws/rs/core/MediaType;Z)V", "(Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;[Ljava/lang/annotation/Annotation;Ljava/io/InputStream;Ljakarta/ws/rs/core/MediaType;Z)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/ws/rs/core/MediaType", "MULTIPART_FORM_DATA_TYPE", "Ljakarta/ws/rs/core/MediaType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ws/rs/core/MediaType", "isCompatible", "(Ljakarta/ws/rs/core/MediaType;)Z", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/utils/FormUtils", "populateMapFromMultipart", "(Ljakarta/ws/rs/core/MultivaluedMap;Lorg/apache/cxf/jaxrs/ext/multipart/MultipartBody;Lorg/apache/cxf/message/Message;Z)V", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "validateMap", "(Ljakarta/ws/rs/core/MultivaluedMap;)V", "(Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/provider/FormEncodingProvider", "validator", "Lorg/apache/cxf/jaxrs/provider/FormValidator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/jaxrs/provider/FormValidator", "validate", "(Ljakarta/ws/rs/core/MultivaluedMap;)V", true);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isSupported", "(Ljava/lang/Class;Ljakarta/ws/rs/core/MediaType;)Z", "(Ljava/lang/Class<*>;Ljakarta/ws/rs/core/MediaType;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/ws/rs/core/MultivaluedMap;"));
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "isAssignableFrom", "(Ljava/lang/Class;)Z", false);
