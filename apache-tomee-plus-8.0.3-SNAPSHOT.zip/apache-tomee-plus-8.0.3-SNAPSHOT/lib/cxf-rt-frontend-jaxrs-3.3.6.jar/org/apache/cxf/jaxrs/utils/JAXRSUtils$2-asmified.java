...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/cxf/jaxrs/utils/JAXRSUtils$2", "Ljava/lang/Object;Ljava/util/Comparator<Ljakarta/ws/rs/core/MediaType;>;", "java/lang/Object", new String[] { "java/util/Comparator" });
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ws/rs/core/MediaType");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/utils/JAXRSUtils$2", "compare", "(Ljakarta/ws/rs/core/MediaType;Ljakarta/ws/rs/core/MediaType;)I", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
