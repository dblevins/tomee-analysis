...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/jose4j/lang/StringUtil", null, "java/lang/Object", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/jose4j/lang/StringUtil", "newISE", "(Ljava/lang/String;)Ljava/lang/IllegalStateException;", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "newString", "([BLjava/nio/charset/Charset;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getBytesAscii", "(Ljava/lang/String;)[B", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("US-ASCII");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/jose4j/lang/StringUtil", "getBytesUnchecked", "(Ljava/lang/String;Ljava/lang/String;)[B", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getBytes", "(Ljava/lang/String;Ljava/nio/charset/Charset;)[B", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "newISE", "(Ljava/lang/String;)Ljava/lang/IllegalStateException;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn("Unknown or unsupported character set name: ");
