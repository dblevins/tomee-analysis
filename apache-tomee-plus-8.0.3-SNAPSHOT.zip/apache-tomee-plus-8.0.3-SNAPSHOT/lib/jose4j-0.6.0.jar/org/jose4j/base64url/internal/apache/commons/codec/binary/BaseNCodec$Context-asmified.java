...
public class BaseNCodec$ContextDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/jose4j/base64url/internal/apache/commons/codec/binary/BaseNCodec$Context", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(0, "ibitWorkArea", "I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "lbitWorkArea", "J", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(0, "readPos", "I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "eof", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "currentLinePos", "I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "modulus", "I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("%s[buffer=%s, currentLinePos=%s, eof=%s, ibitWorkArea=%s, lbitWorkArea=%s, modulus=%s, pos=%s, readPos=%s]");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jose4j/base64url/internal/apache/commons/codec/binary/BaseNCodec$Context", "lbitWorkArea", "J");
