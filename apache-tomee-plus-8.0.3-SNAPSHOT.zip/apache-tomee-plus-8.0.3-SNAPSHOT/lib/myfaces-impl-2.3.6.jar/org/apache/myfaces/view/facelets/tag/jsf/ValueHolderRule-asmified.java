...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/ValueHolderRule", null, "javax/faces/view/facelets/MetaRule", null);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/jsf/ValueHolderRule$DynamicConverterMetadata2", "<init>", "(Ljavax/faces/view/facelets/TagAttribute;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/jsf/ValueHolderRule$DynamicValueExpressionMetadata", "<init>", "(Ljavax/faces/view/facelets/TagAttribute;)V", false);
methodVisitor.visitInsn(ARETURN);
