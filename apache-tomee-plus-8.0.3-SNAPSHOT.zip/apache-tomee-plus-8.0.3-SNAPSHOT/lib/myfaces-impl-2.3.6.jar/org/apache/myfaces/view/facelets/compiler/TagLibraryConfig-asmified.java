...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "create", "(Ljakarta/faces/context/FacesContext;Lorg/apache/myfaces/config/element/facelets/FaceletTagLibrary;)Lorg/apache/myfaces/view/facelets/tag/TagLibrary;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/faces/context/FacesContext", "org/apache/myfaces/config/element/facelets/FaceletTagLibrary", "org/apache/myfaces/view/facelets/tag/TagLibrary"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/compiler/TagLibraryConfig$TagLibraryImpl", "<init>", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/faces/view/facelets/TagHandler;"));
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/element/facelets/FaceletHandlerTag", "getHandlerClass", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/view/facelets/compiler/TagLibraryConfig", "createClass", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Class;", false);
