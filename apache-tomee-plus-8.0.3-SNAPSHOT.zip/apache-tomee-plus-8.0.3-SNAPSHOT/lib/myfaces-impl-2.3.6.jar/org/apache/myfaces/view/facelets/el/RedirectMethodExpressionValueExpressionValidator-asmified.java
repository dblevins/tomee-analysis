...
public class RedirectMethodExpressionValueExpressionValidatorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/el/RedirectMethodExpressionValueExpressionValidator", "Ljava/lang/Object;Ljavax/faces/validator/Validator;Ljavax/faces/FacesWrapper<Ljavax/el/ValueExpression;>;Ljava/io/Externalizable;", "java/lang/Object", new String[] { "javax/faces/validator/Validator", "javax/faces/FacesWrapper", "java/io/Externalizable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/el/RedirectMethodExpressionValueExpressionValidator", "valueExpression", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/el/RedirectMethodExpressionValueExpressionValidator", "getMethodExpression", "()Ljavax/el/MethodExpression;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/faces/context/FacesContext", "getCurrentInstance", "()Ljavax/faces/context/FacesContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getELContext", "()Ljavax/el/ELContext;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/el/RedirectMethodExpressionValueExpressionValidator", "getMethodExpression", "(Ljavax/el/ELContext;)Ljavax/el/MethodExpression;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/el/RedirectMethodExpressionValueExpressionValidator", "valueExpression", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/el/RedirectMethodExpressionValueExpressionValidator", "getWrapped", "()Ljavax/el/ValueExpression;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
