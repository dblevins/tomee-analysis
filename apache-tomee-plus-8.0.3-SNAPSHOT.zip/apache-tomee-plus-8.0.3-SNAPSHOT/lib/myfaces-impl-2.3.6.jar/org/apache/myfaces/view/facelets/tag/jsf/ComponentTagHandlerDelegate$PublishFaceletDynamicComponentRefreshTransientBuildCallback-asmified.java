...
public class ComponentTagHandlerDelegate$PublishFaceletDynamicComponentRefreshTransientBuildCallbackDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/ComponentTagHandlerDelegate$PublishFaceletDynamicComponentRefreshTransientBuildCallback", null, "java/lang/Object", new String[] { "jakarta/faces/component/visit/VisitCallback" });
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/myfaces/view/facelets/tag/jsf/ComponentTagHandlerDelegate$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/jsf/ComponentTagHandlerDelegate$PublishFaceletDynamicComponentRefreshTransientBuildCallback", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
