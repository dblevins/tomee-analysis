...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/view/impl/DefaultViewScopeHandler", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext", "java/util/Map", "java/lang/String", "java/util/Set", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/impl/DefaultViewScopeHandler", "destroyViewScopeMap", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", false);
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/myfaces/view/impl/DefaultViewScopeHandler", "jakarta/faces/context/FacesContext"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/impl/DefaultViewScopeHandler", "_createSubKeyMap", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/view/impl/DefaultViewScopeHandler", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext", "java/lang/Object", "java/lang/Integer", "java/lang/Object", "java/util/Map"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/myfaces/view/impl/DefaultViewScopeHandler", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext", "java/lang/Object", "java/lang/Integer", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(MONITOREXIT);
methodVisitor.visitLabel(label3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getExternalContext", "()Ljakarta/faces/context/ExternalContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/impl/DefaultViewScopeHandler", "getManagedBeanDestroyer", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/config/ManagedBeanDestroyer;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "entrySet", "()Ljava/util/Set;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/view/impl/DefaultViewScopeHandler", "jakarta/faces/context/FacesContext", "java/lang/String", "java/lang/String", "java/util/Map", "org/apache/myfaces/config/ManagedBeanDestroyer", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getManagedBeanDestroyer", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/config/ManagedBeanDestroyer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
