...
public class FaceletsVDLUtils$NullWriterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/FaceletsVDLUtils$NullWriter", null, "java/io/Writer", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/myfaces/view/facelets/FaceletsVDLUtils$NullWriter;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/view/facelets/FaceletsVDLUtils$NullWriter");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/FaceletsVDLUtils$NullWriter", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/view/facelets/FaceletsVDLUtils$NullWriter", "INSTANCE", "Lorg/apache/myfaces/view/facelets/FaceletsVDLUtils$NullWriter;");
methodVisitor.visitInsn(RETURN);
