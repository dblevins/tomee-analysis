...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/el/ValueExpressionMethodExpression", "Ljavax/el/MethodExpression;Ljavax/faces/FacesWrapper<Ljavax/el/ValueExpression;>;Ljava/io/Externalizable;", "javax/el/MethodExpression", new String[] { "javax/faces/FacesWrapper", "java/io/Externalizable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/el/ValueExpressionMethodExpression", "valueExpression", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/el/ValueExpressionMethodExpression", "getMethodExpression", "(Ljavax/el/ELContext;)Ljavax/el/MethodExpression;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/el/ValueExpressionMethodExpression", "getMethodExpression", "()Ljavax/el/MethodExpression;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/el/ValueExpressionMethodExpression", "valueExpression", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/el/ValueExpressionMethodExpression", "getWrapped", "()Ljavax/el/ValueExpression;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
