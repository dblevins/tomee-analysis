...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/ee/MyFacesContainerInitializer", null, "java/lang/Object", new String[] { "javax/servlet/ServletContainerInitializer" });

{
annotationVisitor0 = classWriter.visitAnnotation("Ljavax/servlet/annotation/HandlesTypes;", true);
{
AnnotationVisitor annotationVisitor1 = annotationVisitor0.visitArray("value");
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/ApplicationScoped;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/CustomScoped;"));
...
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/render/FacesRenderer;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/validator/FacesValidator;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/model/FacesDataModel;"));
...
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/ManagedProperty;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/event/NamedEvent;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/NoneScoped;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/ReferencedBean;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/RequestScoped;"));
...
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/SessionScoped;"));
annotationVisitor1.visit(null, Type.getType("Ljavax/faces/bean/ViewScoped;"));
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FACES_SERVLET_CLASS", "Ljava/lang/Class;", "Ljava/lang/Class<+Ljavax/servlet/Servlet;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/ee/MyFacesContainerInitializer", "shouldStartupRegardless", "(Ljavax/servlet/ServletContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/ee/MyFacesContainerInitializer", "isFacesConfigPresent", "(Ljavax/servlet/ServletContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/ee/MyFacesContainerInitializer", "isAutomaticXhtmlMappingDisabled", "(Ljavax/servlet/ServletContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/ServletRegistration$Dynamic", "addMapping", "([Ljava/lang/String;)Ljava/util/Set;", true);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/ee/MyFacesContainerInitializer", "java/util/Set", "javax/servlet/ServletContext", "java/lang/String", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 10);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "shouldStartupRegardless", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "shouldSkipJarFacesConfigScan", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/myfaces/ee/MyFacesContainerInitializer", "javax/servlet/ServletContext"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isAutomaticXhtmlMappingDisabled", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isFacesConfigPresent", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label10 = new Label();
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/ee/MyFacesContainerInitializer", "javax/servlet/ServletContext", "java/lang/String", "[Ljava/lang/String;", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/ee/MyFacesContainerInitializer", "javax/servlet/ServletContext", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/ee/MyFacesContainerInitializer", "shouldSkipJarFacesConfigScan", "(Ljavax/servlet/ServletContext;)Z", false);
