...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/resolver/GuiceResolver", "runtimeConfig", "(Ljavax/el/ELContext;)Lorg/apache/myfaces/config/RuntimeConfig;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/el/unified/resolver/GuiceResolver", "getValue", "(Ljavax/el/ELContext;Ljavax/faces/context/ExternalContext;Ljava/lang/Class;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getValue", "(Ljavax/el/ELContext;Ljavax/faces/context/ExternalContext;Ljava/lang/Class;)Ljava/lang/Object;", "(Ljavax/el/ELContext;Ljavax/faces/context/ExternalContext;Ljava/lang/Class<*>;)Ljava/lang/Object;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ExternalContext", "getApplicationMap", "()Ljava/util/Map;", false);
