...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/ResolverBuilderForJSP", "build", "(Ljakarta/faces/context/FacesContext;Ljakarta/el/CompositeELResolver;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/ResolverBuilderForJSP", "isReplaceImplicitObjectResolverWithCDIResolver", "(Ljakarta/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/el/unified/resolver/implicitobject/ImplicitObjectResolver", "makeResolverForJSP", "()Ljakarta/el/ELResolver;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
