...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/el/VariableResolverImpl", null, "jakarta/faces/el/VariableResolver", null);
...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "jakarta/el/ELException");
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label5, label2, label2, "jakarta/el/ELException");
...
methodVisitor.visitTypeInsn(NEW, "java/lang/NullPointerException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("name must not be null");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/NullPointerException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/VariableResolverImpl", "getScope", "(Ljakarta/faces/context/FacesContext;)Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope", "equals", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope", "jakarta/el/ELContext", "jakarta/faces/application/Application"}, 0, null);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("unknown scope defined: ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/el/VariableResolverImpl", "jakarta/faces/context/FacesContext", "java/lang/String"}, 1, new Object[] {"jakarta/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getScope", "(Ljakarta/faces/context/FacesContext;)Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
