...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/shared/context/AjaxExceptionHandlerImpl", null, "jakarta/faces/context/ExceptionHandler", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/AjaxExceptionHandlerImpl", "handledAndThrown", "Ljakarta/faces/event/ExceptionQueuedEvent;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/List", "jakarta/faces/context/FacesContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/AjaxExceptionHandlerImpl", "unhandled", "Ljava/util/Queue;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/context/AjaxExceptionHandlerImpl", "handledAndThrown", "Ljakarta/faces/event/ExceptionQueuedEvent;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/context/PartialResponseWriter", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/context/PartialViewContext", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/shared/context/AjaxExceptionHandlerImpl", "renderAjaxError", "(Ljakarta/faces/context/PartialResponseWriter;Ljava/lang/Throwable;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/myfaces/shared/context/AjaxExceptionHandlerImpl", "java/util/List", "jakarta/faces/context/FacesContext", "jakarta/faces/context/PartialResponseWriter", Opcodes.INTEGER, "jakarta/faces/context/ExternalContext", "jakarta/faces/context/PartialViewContext", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/io/IOException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "renderAjaxError", "(Ljakarta/faces/context/PartialResponseWriter;Ljava/lang/Throwable;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
