...
public class FlashImpl$MessageEntryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/shared/context/flash/FlashImpl$MessageEntry", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-690264660230199234L));
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/myfaces/shared/context/flash/FlashImpl$MessageEntry;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/flash/FlashImpl$MessageEntry", "clientId", "Ljava/lang/String;");
