...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/taglib/core/LoadBundleTag", null, "jakarta/servlet/jsp/tagext/TagSupport", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_basename", "Ljakarta/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/taglib/core/LoadBundleTag", "_basename", "Ljakarta/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/LoadBundleTag", "_basename", "Ljakarta/el/ValueExpression;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/taglib/core/LoadBundleTag", "jakarta/faces/context/FacesContext", "jakarta/faces/component/UIViewRoot", "java/util/Locale", "java/lang/String", Opcodes.TOP, "java/util/MissingResourceException"}, 1, new Object[] {"java/util/MissingResourceException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/myfaces/taglib/core/LoadBundleTag", "jakarta/faces/context/FacesContext", "jakarta/faces/component/UIViewRoot", "java/util/Locale", "java/lang/String", "java/util/ResourceBundle"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
