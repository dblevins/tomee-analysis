...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", null, "java/lang/Object", new String[] { "javax/faces/event/ValueChangeListener", "javax/faces/component/StateHolder" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", "_type", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", "_binding", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", "_type", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", "_binding", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_getDelegate", "()Ljavax/faces/event/ValueChangeListener;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", "_createValueChangeListener", "()Ljavax/faces/event/ValueChangeListener;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_createValueChangeListener", "()Ljavax/faces/event/ValueChangeListener;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/context/FacesContext", "javax/faces/event/ValueChangeListener"}, 0, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/taglib/core/DelegateValueChangeListener", "_getDelegate", "()Ljavax/faces/event/ValueChangeListener;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
