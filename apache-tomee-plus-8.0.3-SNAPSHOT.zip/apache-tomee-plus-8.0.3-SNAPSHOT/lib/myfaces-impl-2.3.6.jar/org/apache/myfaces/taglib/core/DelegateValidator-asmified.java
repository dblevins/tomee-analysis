...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/taglib/core/DelegateValidator", null, "java/lang/Object", new String[] { "javax/faces/validator/Validator", "javax/faces/component/StateHolder" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_validatorId", "Ljavax/el/ValueExpression;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/taglib/core/DelegateValidator", "_validatorId", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/taglib/core/DelegateValidator", "_binding", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/DelegateValidator", "_validatorId", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/DelegateValidator", "_binding", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_getDelegate", "()Ljavax/faces/validator/Validator;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/taglib/core/DelegateValidator", "_createValidator", "()Ljavax/faces/validator/Validator;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_createValidator", "()Ljavax/faces/validator/Validator;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/taglib/core/DelegateValidator", "javax/faces/context/FacesContext", "javax/el/ELContext"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/faces/validator/Validator");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/application/Application", "javax/faces/validator/Validator"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/DelegateValidator", "_validatorId", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/taglib/core/DelegateValidator", "_getDelegate", "()Ljavax/faces/validator/Validator;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
