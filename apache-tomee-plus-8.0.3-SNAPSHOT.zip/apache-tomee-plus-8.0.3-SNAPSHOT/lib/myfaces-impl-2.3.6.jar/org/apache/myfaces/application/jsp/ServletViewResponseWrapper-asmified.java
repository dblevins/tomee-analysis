...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/application/jsp/ServletViewResponseWrapper", null, "javax/servlet/http/HttpServletResponseWrapper", new String[] { "org/apache/myfaces/shared/view/ViewResponseWrapper" });
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/application/jsp/ServletViewResponseWrapper", "_charArrayWriter", "Ljava/io/CharArrayWriter;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/application/jsp/ServletViewResponseWrapper", "getResponse", "()Ljavax/servlet/ServletResponse;", false);
