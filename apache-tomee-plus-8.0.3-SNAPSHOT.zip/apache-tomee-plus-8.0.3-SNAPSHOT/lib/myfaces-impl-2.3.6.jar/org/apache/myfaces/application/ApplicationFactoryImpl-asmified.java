...
public class ApplicationFactoryImplDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_myfacesInstanceAddedToApplicationMap", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/application/ApplicationFactoryImpl", "createAndLogNewApplication", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createAndLogNewApplication", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/application/ApplicationFactoryImpl", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitLdcInsn("New ApplicationFactory instance created");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "purgeApplication", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/application/ApplicationFactoryImpl", "createAndLogNewApplication", "()V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/application/ApplicationFactoryImpl", "_myfacesInstanceAddedToApplicationMap", "Z");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Cannot set a null application in the ApplicationFactory");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/application/ApplicationFactoryImpl", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
