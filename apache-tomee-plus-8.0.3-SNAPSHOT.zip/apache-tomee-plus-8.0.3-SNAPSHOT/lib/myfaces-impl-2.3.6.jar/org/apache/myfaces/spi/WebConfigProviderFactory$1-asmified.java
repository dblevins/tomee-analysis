...
public class WebConfigProviderFactory$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/spi/WebConfigProviderFactory$1", "Ljava/lang/Object;Ljava/security/PrivilegedExceptionAction<Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });

classWriter.visitOuterClass("org/apache/myfaces/spi/WebConfigProviderFactory", "getWebConfigProviderFactory", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/WebConfigProviderFactory;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/spi/WebConfigProviderFactory$1", "val$ectx", "Ljakarta/faces/context/ExternalContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/spi/WebConfigProviderFactory$1", "val$ectx", "Ljakarta/faces/context/ExternalContext;");
