...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultFacesConfigurationProviderFactory$1", "<init>", "(Lorg/apache/myfaces/spi/impl/DefaultFacesConfigurationProviderFactory;Ljavax/faces/context/ExternalContext;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/myfaces/spi/FacesConfigurationProvider", "javax/faces/context/ExternalContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultFacesConfigurationProviderFactory", "resolveFacesConfigurationProviderFromService", "(Ljavax/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProvider;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/myfaces/spi/impl/DefaultFacesConfigurationProviderFactory;Ljavax/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProvider;", null, new String[] { "java/lang/ClassNotFoundException", "java/lang/NoClassDefFoundError", "java/lang/InstantiationException", "java/lang/IllegalAccessException", "java/lang/reflect/InvocationTargetException", "java/security/PrivilegedActionException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultFacesConfigurationProviderFactory", "resolveFacesConfigurationProviderFromService", "(Ljavax/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProvider;", false);
