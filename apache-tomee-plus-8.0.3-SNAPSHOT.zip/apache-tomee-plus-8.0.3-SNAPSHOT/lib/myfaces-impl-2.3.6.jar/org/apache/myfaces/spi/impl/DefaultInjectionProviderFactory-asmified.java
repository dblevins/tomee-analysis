...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInjectionProvider", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/InjectionProvider;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "resolveInjectionProviderFromExternalContext", "(Ljakarta/faces/context/ExternalContext;)Z", false);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNE, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "resolveInjectionProviderFromService", "(Ljakarta/faces/context/ExternalContext;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveInjectionProviderFromExternalContext", "(Ljakarta/faces/context/ExternalContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "createClass", "(Ljava/lang/String;Ljakarta/faces/context/ExternalContext;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveInjectionProviderFromService", "(Ljakarta/faces/context/ExternalContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory$1", "<init>", "(Lorg/apache/myfaces/spi/impl/DefaultInjectionProviderFactory;Ljakarta/faces/context/ExternalContext;)V", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "java/lang/String", "jakarta/faces/context/ExternalContext", "java/lang/Class"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "resolveFallbackInjectionProvider", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/InjectionProvider;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveFallbackInjectionProvider", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/InjectionProvider;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "jakarta/faces/context/ExternalContext", "javax/naming/Context"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "jakarta/faces/context/ExternalContext"}, 1, new Object[] {"javax/naming/NamingException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/spi/impl/DefaultInjectionProviderFactory", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
