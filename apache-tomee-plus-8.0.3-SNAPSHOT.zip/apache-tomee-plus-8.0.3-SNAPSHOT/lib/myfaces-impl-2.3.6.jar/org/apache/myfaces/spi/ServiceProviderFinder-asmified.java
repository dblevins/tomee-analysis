...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "calculateKnownServiceProviderMapInfo", "(Ljakarta/faces/context/ExternalContext;[Ljava/lang/String;)Ljava/util/Map;", "(Ljakarta/faces/context/ExternalContext;[Ljava/lang/String;)Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;", null);
methodVisitor.visitCode();
