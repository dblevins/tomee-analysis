...
public class AbstractThreadSafeAttributeMap$KeyIteratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/util/AbstractThreadSafeAttributeMap$KeyIterator", "Lorg/apache/myfaces/util/AbstractThreadSafeAttributeMap<TV;>.AbstractAttributeIterator<Ljava/lang/String;>;", "org/apache/myfaces/util/AbstractThreadSafeAttributeMap$AbstractAttributeIterator", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/util/AbstractThreadSafeAttributeMap$KeyIterator", "this$0", "Lorg/apache/myfaces/util/AbstractThreadSafeAttributeMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/util/AbstractThreadSafeAttributeMap$KeyIterator", "getValue", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/util/AbstractThreadSafeAttributeMap$KeyIterator", "<init>", "(Lorg/apache/myfaces/util/AbstractThreadSafeAttributeMap;)V", false);
methodVisitor.visitInsn(RETURN);
