...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/lifecycle/ClientWindowFactoryImpl", null, "javax/faces/lifecycle/ClientWindowFactory", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/lifecycle/ClientWindowFactory", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/ClientWindowFactoryImpl", "getWindowMode", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getWindowMode", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/config/FacesConfigurator", "isEnableDefaultWindowMode", "(Ljavax/faces/context/FacesContext;)Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
