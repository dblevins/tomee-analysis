...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getFacesInitializer", "(Ljakarta/servlet/ServletContext;)Lorg/apache/myfaces/webapp/FacesInitializer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/webapp/FacesInitializerFactory", "_getFacesInitializerFromInitParam", "(Ljakarta/servlet/ServletContext;)Lorg/apache/myfaces/webapp/FacesInitializer;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/webapp/FacesInitializerFactory", "_getDefaultFacesInitializer", "(Ljakarta/servlet/ServletContext;)Lorg/apache/myfaces/webapp/FacesInitializer;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "_getFacesInitializerFromInitParam", "(Ljakarta/servlet/ServletContext;)Lorg/apache/myfaces/webapp/FacesInitializer;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/servlet/ServletContext", "java/lang/String"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/FacesException");
methodVisitor.visitInsn(DUP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "_getDefaultFacesInitializer", "(Ljakarta/servlet/ServletContext;)Lorg/apache/myfaces/webapp/FacesInitializer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/util/ContainerUtils", "isJsp21", "(Ljakarta/servlet/ServletContext;)Z", false);
Label label1 = new Label();
