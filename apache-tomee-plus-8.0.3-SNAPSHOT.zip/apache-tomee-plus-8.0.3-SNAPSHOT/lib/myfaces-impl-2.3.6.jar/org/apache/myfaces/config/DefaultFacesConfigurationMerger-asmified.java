...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getFacesConfigData", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/config/element/FacesConfigData;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/spi/FacesConfigurationProviderFactory", "getFacesConfigurationProviderFactory", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProviderFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/spi/FacesConfigurationProviderFactory", "getFacesConfigurationProvider", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProvider;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "orderAndFeedArtifacts", "(Lorg/apache/myfaces/config/FacesConfigDispenser;Ljava/util/List;Lorg/apache/myfaces/config/element/FacesConfig;)V", "(Lorg/apache/myfaces/config/FacesConfigDispenser;Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;Lorg/apache/myfaces/config/element/FacesConfig;)V", new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "applySortingAlgorithm", "(Ljava/util/List;)Ljava/util/List;", "(Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;)Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;", new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "applyBeforeRule", "(Ljava/util/List;Lorg/apache/myfaces/config/element/FacesConfig;Z)V", "(Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;Lorg/apache/myfaces/config/element/FacesConfig;Z)V", new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 4);
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "applyAfterRule", "(Ljava/util/List;Lorg/apache/myfaces/config/element/FacesConfig;)V", "(Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;Lorg/apache/myfaces/config/element/FacesConfig;)V", new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getPostOrderedList", "(Ljava/util/List;)Ljava/util/List;", "(Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;)Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;", new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveConflicts", "(Ljava/util/List;I[ZLjava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Z)V", "(Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;I[ZLjava/util/List<Ljava/lang/String;>;Ljava/util/List<Ljava/lang/String;>;Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;Ljava/util/List<Lorg/apache/myfaces/config/element/FacesConfig;>;Z)V", new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
