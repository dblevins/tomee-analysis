...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/component/validate/WholeBeanValidator$FacesMessageInterpolator", null, "java/lang/Object", new String[] { "jakarta/validation/MessageInterpolator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/component/validate/WholeBeanValidator$FacesMessageInterpolator", "interpolator", "Ljakarta/validation/MessageInterpolator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/component/validate/WholeBeanValidator$FacesMessageInterpolator", "facesContext", "Ljakarta/faces/context/FacesContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/component/validate/WholeBeanValidator$FacesMessageInterpolator", "facesContext", "Ljakarta/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/component/validate/WholeBeanValidator$FacesMessageInterpolator", "interpolator", "Ljakarta/validation/MessageInterpolator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
