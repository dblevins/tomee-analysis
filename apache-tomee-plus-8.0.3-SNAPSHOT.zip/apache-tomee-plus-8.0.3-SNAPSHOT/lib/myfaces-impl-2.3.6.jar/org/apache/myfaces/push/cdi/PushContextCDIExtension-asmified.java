...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/push/cdi/PushContextCDIExtension", null, "java/lang/Object", new String[] { "javax/enterprise/inject/spi/Extension" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "pushContextProducers", "Ljava/util/List;", "Ljava/util/List<Ljavax/enterprise/inject/spi/Producer<Ljavax/faces/push/PushContext;>;>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPushContextProducers", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/enterprise/inject/spi/Producer<Ljavax/faces/push/PushContext;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(0, "findFlowDefinition", "(Ljavax/enterprise/inject/spi/ProcessProducer;)V", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/ProcessProducer<TT;Ljavax/faces/push/PushContext;>;)V", null);
