...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "EMPTY_ARRAY", "[Ljavax/servlet/http/Cookie;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/CookieMap", "_httpServletRequest", "Ljavax/servlet/http/HttpServletRequest;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/CookieMap", "_httpServletRequest", "Ljavax/servlet/http/HttpServletRequest;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/context/servlet/CookieMap", "EMPTY_ARRAY", "[Ljavax/servlet/http/Cookie;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/context/servlet/CookieMap$CookieNameEnumeration", "<init>", "([Ljavax/servlet/http/Cookie;)V", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"[Ljavax/servlet/http/Cookie;"}, 0, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/context/servlet/CookieMap", "EMPTY_ARRAY", "[Ljavax/servlet/http/Cookie;");
methodVisitor.visitInsn(RETURN);
