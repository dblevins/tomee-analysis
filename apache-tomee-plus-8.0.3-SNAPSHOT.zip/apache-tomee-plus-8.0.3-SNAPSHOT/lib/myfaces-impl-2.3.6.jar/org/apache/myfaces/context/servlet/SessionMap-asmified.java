...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/context/servlet/SessionMap", "Lorg/apache/myfaces/util/AbstractThreadSafeAttributeMap<Ljava/lang/Object;>;", "org/apache/myfaces/util/AbstractThreadSafeAttributeMap", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_httpRequest", "Ljavax/servlet/http/HttpServletRequest;", null, null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/util/AbstractThreadSafeAttributeMap", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/context/servlet/SessionMap", "_httpRequest", "Ljavax/servlet/http/HttpServletRequest;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/context/servlet/SessionMap", "_getSession", "()Ljavax/servlet/http/HttpSession;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/SessionMap", "_httpRequest", "Ljavax/servlet/http/HttpServletRequest;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_getSession", "()Ljavax/servlet/http/HttpSession;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/context/servlet/SessionMap", "_httpRequest", "Ljavax/servlet/http/HttpServletRequest;");
