...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", null, "javax/faces/render/ClientBehaviorRenderer", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "assertBehavior", "(Ljavax/faces/component/behavior/ClientBehavior;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "dispatchBehaviorEvent", "(Ljavax/faces/component/UIComponent;Ljavax/faces/component/behavior/AjaxBehavior;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "makeAjax", "(Ljavax/faces/component/behavior/ClientBehaviorContext;Ljavax/faces/component/behavior/AjaxBehavior;)Ljava/lang/StringBuilder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "dispatchBehaviorEvent", "(Ljavax/faces/component/UIComponent;Ljavax/faces/component/behavior/AjaxBehavior;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "javax/faces/event/AjaxBehaviorEvent");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/AjaxBehaviorEvent", "<init>", "(Ljavax/faces/component/UIComponent;Ljavax/faces/component/behavior/Behavior;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/event/AjaxBehaviorEvent", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "isComponentImmediate", "(Ljavax/faces/component/UIComponent;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 4);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isComponentImmediate", "(Ljavax/faces/component/UIComponent;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "makeAjax", "(Ljavax/faces/component/behavior/ClientBehaviorContext;Ljavax/faces/component/behavior/AjaxBehavior;)Ljava/lang/StringBuilder;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "mapToString", "(Ljavax/faces/component/behavior/ClientBehaviorContext;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/util/Collection;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "javax/faces/component/behavior/ClientBehaviorContext", "javax/faces/component/behavior/AjaxBehavior", "java/lang/StringBuilder", "java/lang/StringBuilder", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "javax/faces/component/UIComponent", "javax/faces/component/UIComponent"}, 1, new Object[] {"java/lang/IllegalArgumentException"});
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "append", "(Ljava/lang/StringBuilder;Ljava/util/List;Ljavax/faces/component/behavior/ClientBehaviorContext$Parameter;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "append", "(Ljava/lang/StringBuilder;Ljava/util/List;Ljavax/faces/component/behavior/ClientBehaviorContext$Parameter;)V", "(Ljava/lang/StringBuilder;Ljava/util/List<Ljava/lang/String;>;Ljavax/faces/component/behavior/ClientBehaviorContext$Parameter;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "setLength", "(I)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "mapToString", "(Ljavax/faces/component/behavior/ClientBehaviorContext;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/util/Collection;)Ljava/lang/String;", "(Ljavax/faces/component/behavior/ClientBehaviorContext;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/util/Collection<Ljava/lang/String;>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "setLength", "(I)V", false);
...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "javax/faces/component/behavior/ClientBehaviorContext", "java/lang/StringBuilder", "java/lang/String", "java/util/Collection", Opcodes.INTEGER, Opcodes.INTEGER, "javax/faces/component/search/SearchExpressionContext", "java/util/List"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/renderkit/html/HtmlAjaxBehaviorRenderer", "build", "(Ljavax/faces/component/behavior/ClientBehaviorContext;ILjava/lang/StringBuilder;ILjava/lang/String;Ljavax/faces/component/search/SearchExpressionContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "build", "(Ljavax/faces/component/behavior/ClientBehaviorContext;ILjava/lang/StringBuilder;ILjava/lang/String;Ljavax/faces/component/search/SearchExpressionContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "trim", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "assertBehavior", "(Ljavax/faces/component/behavior/ClientBehavior;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
