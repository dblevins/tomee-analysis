...
public class HtmlCompositeComponentRendererDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/renderkit/html/HtmlCompositeComponentRenderer", null, "org/apache/myfaces/shared/renderkit/html/HtmlRenderer", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/renderkit/html/HtmlCompositeComponentRenderer", "log", "Ljava/util/logging/Logger;");
...
methodVisitor.visitLdcInsn("facet UIComponent.COMPOSITE_FACET_NAME not found when rendering composite component ");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/myfaces/renderkit/html/HtmlCompositeComponentRenderer;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/logging/Logger", "getLogger", "(Ljava/lang/String;)Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/renderkit/html/HtmlCompositeComponentRenderer", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
