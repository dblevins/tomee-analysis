...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/rpc/ServiceFactory", "newInstance", "()Ljavax/xml/rpc/ServiceFactory;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/naming/factory/webservices/ServiceRefFactory", "java/lang/Object", "javax/naming/Name", "javax/naming/Context", "java/util/Hashtable", "org/apache/naming/ServiceRef", "java/lang/ClassLoader", "javax/xml/rpc/ServiceFactory", "javax/xml/rpc/Service", "javax/naming/RefAddr", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/ServiceFactory", "createService", "(Ljavax/xml/namespace/QName;)Ljavax/xml/rpc/Service;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/ServiceFactory", "createService", "(Ljava/net/URL;Ljavax/xml/namespace/QName;)Ljavax/xml/rpc/Service;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitTypeInsn(NEW, "javax/naming/NamingException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("service Interface should extend javax.xml.rpc.Service");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/naming/NamingException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/ServiceFactory", "loadService", "(Ljava/lang/Class;)Ljavax/xml/rpc/Service;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/ServiceFactory", "loadService", "(Ljava/net/URL;Ljava/lang/Class;Ljava/util/Properties;)Ljavax/xml/rpc/Service;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/Service", "getServiceName", "()Ljavax/xml/namespace/QName;", true);
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ASTORE, 14);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 22, new Object[] {"org/apache/naming/factory/webservices/ServiceRefFactory", "java/lang/Object", "javax/naming/Name", "javax/naming/Context", "java/util/Hashtable", "org/apache/naming/ServiceRef", "java/lang/ClassLoader", "javax/xml/rpc/ServiceFactory", "javax/xml/rpc/Service", "javax/naming/RefAddr", "java/lang/String", "java/lang/String", "java/util/Hashtable", "javax/xml/namespace/QName", "java/lang/Class", "javax/wsdl/factory/WSDLFactory", "javax/wsdl/xml/WSDLReader", "javax/wsdl/Definition", "javax/wsdl/Service", "java/util/Map", "java/lang/reflect/Method", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/naming/factory/webservices/ServiceRefFactory", "getSOAPLocation", "(Ljavax/wsdl/Port;)Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/naming/factory/webservices/ServiceRefFactory", "java/lang/Object", "javax/naming/Name", "javax/naming/Context", "java/util/Hashtable", "org/apache/naming/ServiceRef", "java/lang/ClassLoader", "javax/xml/rpc/ServiceFactory", "javax/xml/rpc/Service", "javax/naming/RefAddr", "java/lang/String", "java/lang/String", "java/util/Hashtable", "javax/xml/namespace/QName", "java/lang/Class"}, 0, new Object[] {});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/naming/factory/webservices/ServiceProxy", "<init>", "(Ljavax/xml/rpc/Service;)V", false);
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/Service", "getHandlerRegistry", "()Ljavax/xml/rpc/handler/HandlerRegistry;", true);
methodVisitor.visitVarInsn(ASTORE, 19);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/xml/rpc/handler/HandlerRegistry", "java/util/List"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/naming/ServiceRef", "getHandlersSize", "()I", false);
methodVisitor.visitJumpInsn(IFLE, label39);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ASTORE, 21);
methodVisitor.visitTypeInsn(NEW, "javax/xml/rpc/handler/HandlerInfo");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/rpc/handler/HandlerInfo", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 22);
methodVisitor.visitVarInsn(ALOAD, 21);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/naming/HandlerRef", "javax/xml/rpc/handler/HandlerInfo"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 23);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 24, new Object[] {"org/apache/naming/factory/webservices/ServiceRefFactory", "java/lang/Object", "javax/naming/Name", "javax/naming/Context", "java/util/Hashtable", "org/apache/naming/ServiceRef", "java/lang/ClassLoader", "javax/xml/rpc/ServiceFactory", "javax/xml/rpc/Service", "javax/naming/RefAddr", "java/lang/String", "java/lang/String", "java/util/Hashtable", "javax/xml/namespace/QName", "java/lang/Class", "org/apache/naming/factory/webservices/ServiceProxy", "[Ljava/lang/Class;", "[Ljava/lang/Class;", "java/lang/Object", "javax/xml/rpc/handler/HandlerRegistry", "java/util/List", "org/apache/naming/HandlerRef", "javax/xml/rpc/handler/HandlerInfo", "java/lang/Class"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 24);
methodVisitor.visitJumpInsn(GOTO, label39);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 28, new Object[] {"org/apache/naming/factory/webservices/ServiceRefFactory", "java/lang/Object", "javax/naming/Name", "javax/naming/Context", "java/util/Hashtable", "org/apache/naming/ServiceRef", "java/lang/ClassLoader", "javax/xml/rpc/ServiceFactory", "javax/xml/rpc/Service", "javax/naming/RefAddr", "java/lang/String", "java/lang/String", "java/util/Hashtable", "javax/xml/namespace/QName", "java/lang/Class", "org/apache/naming/factory/webservices/ServiceProxy", "[Ljava/lang/Class;", "[Ljava/lang/Class;", "java/lang/Object", "javax/xml/rpc/handler/HandlerRegistry", "java/util/List", "org/apache/naming/HandlerRef", "javax/xml/rpc/handler/HandlerInfo", "java/lang/Class", "java/util/List", "java/util/Hashtable", "java/util/List", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 22);
methodVisitor.visitVarInsn(ALOAD, 23);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/handler/HandlerInfo", "setHandlerClass", "(Ljava/lang/Class;)V", false);
methodVisitor.visitVarInsn(ALOAD, 22);
methodVisitor.visitVarInsn(ALOAD, 24);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/handler/HandlerInfo", "setHeaders", "([Ljavax/xml/namespace/QName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 22);
methodVisitor.visitVarInsn(ALOAD, 25);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/rpc/handler/HandlerInfo", "setHandlerConfig", "(Ljava/util/Map;)V", false);
methodVisitor.visitVarInsn(ALOAD, 26);
...
methodVisitor.visitVarInsn(ALOAD, 22);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/naming/factory/webservices/ServiceRefFactory", "initHandlerChain", "(Ljavax/xml/namespace/QName;Ljavax/xml/rpc/handler/HandlerRegistry;Ljavax/xml/rpc/handler/HandlerInfo;Ljava/util/List;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 21, new Object[] {"org/apache/naming/factory/webservices/ServiceRefFactory", "java/lang/Object", "javax/naming/Name", "javax/naming/Context", "java/util/Hashtable", "org/apache/naming/ServiceRef", "java/lang/ClassLoader", "javax/xml/rpc/ServiceFactory", "javax/xml/rpc/Service", "javax/naming/RefAddr", "java/lang/String", "java/lang/String", "java/util/Hashtable", "javax/xml/namespace/QName", "java/lang/Class", "org/apache/naming/factory/webservices/ServiceProxy", "[Ljava/lang/Class;", "[Ljava/lang/Class;", "java/lang/Object", "javax/xml/rpc/handler/HandlerRegistry", "java/util/List"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getSOAPLocation", "(Ljavax/wsdl/Port;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "initHandlerChain", "(Ljavax/xml/namespace/QName;Ljavax/xml/rpc/handler/HandlerRegistry;Ljavax/xml/rpc/handler/HandlerInfo;Ljava/util/List;)V", "(Ljavax/xml/namespace/QName;Ljavax/xml/rpc/handler/HandlerRegistry;Ljavax/xml/rpc/handler/HandlerInfo;Ljava/util/List<Ljava/lang/String;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/handler/HandlerRegistry", "getHandlerChain", "(Ljavax/xml/namespace/QName;)Ljava/util/List;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/rpc/handler/HandlerChain");
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/handler/HandlerChain", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/xml/rpc/handler/HandlerChain", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/rpc/handler/Handler");
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/handler/Handler", "init", "(Ljavax/xml/rpc/handler/HandlerInfo;)V", true);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/handler/HandlerChain", "getRoles", "()[Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/handler/HandlerChain", "setRoles", "([Ljava/lang/String;)V", true);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/handler/HandlerRegistry", "setHandlerChain", "(Ljavax/xml/namespace/QName;Ljava/util/List;)V", true);
methodVisitor.visitInsn(RETURN);
