...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/core/AsyncContextImpl", null, "java/lang/Object", new String[] { "javax/servlet/AsyncContext", "org/apache/coyote/AsyncContextCallback" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "servletRequest", "Ljavax/servlet/ServletRequest;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "servletResponse", "Ljavax/servlet/ServletResponse;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "event", "Ljavax/servlet/AsyncEvent;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/AsyncContextImpl", "servletRequest", "Ljavax/servlet/ServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/AsyncContextImpl", "servletResponse", "Ljavax/servlet/ServletResponse;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/AsyncContextImpl", "event", "Ljavax/servlet/AsyncEvent;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "event", "Ljavax/servlet/AsyncEvent;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "fireOnComplete", "(Ljavax/servlet/AsyncEvent;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "event", "Ljavax/servlet/AsyncEvent;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "fireOnTimeout", "(Ljavax/servlet/AsyncEvent;)V", false);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/core/AsyncContextImpl", "check", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncContextImpl", "getRequest", "()Ljavax/servlet/ServletRequest;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "java/lang/String", "java/lang/String", "javax/servlet/ServletRequest"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncContextImpl", "dispatch", "(Ljavax/servlet/ServletContext;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitLdcInsn("javax.servlet.async.request_uri");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitLdcInsn("javax.servlet.async.context_path");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Request", "getContextPath", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Request", "setAttribute", "(Ljava/lang/String;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitLdcInsn("javax.servlet.async.servlet_path");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitLdcInsn("javax.servlet.async.path_info");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitLdcInsn("javax.servlet.async.query_string");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncContextImpl", "getResponse", "()Ljavax/servlet/ServletResponse;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "context", "Lorg/apache/catalina/Context;");
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/core/AsyncContextImpl$AsyncRunnable", "<init>", "(Lorg/apache/catalina/connector/Request;Lorg/apache/catalina/AsyncDispatcher;Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/AsyncContextImpl", "dispatch", "Ljava/lang/Runnable;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "request", "Lorg/apache/catalina/connector/Request;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/Request", "getCoyoteRequest", "()Lorg/apache/coyote/Request;", false);
...
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "javax/servlet/ServletContext", "java/lang/String", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/core/AsyncContextImpl", "check", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "servletRequest", "Ljavax/servlet/ServletRequest;");
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/core/AsyncContextImpl", "check", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "servletResponse", "Ljavax/servlet/ServletResponse;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "setListener", "(Ljavax/servlet/AsyncListener;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "listeners", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "setServletRequest", "(Ljavax/servlet/ServletRequest;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "setServletResponse", "(Ljavax/servlet/ServletResponse;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "listeners", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "java/lang/Class", "javax/servlet/AsyncListener"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setStarted", "(Lorg/apache/catalina/Context;Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;Z)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "event", "Ljavax/servlet/AsyncEvent;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "fireOnStartAsync", "(Ljavax/servlet/AsyncEvent;)V", false);
methodVisitor.visitLabel(label1);
Label label10 = new Label();
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "org/apache/catalina/Context", "javax/servlet/ServletRequest", "javax/servlet/ServletResponse", Opcodes.INTEGER, "java/lang/Object", "java/util/List", "java/util/Iterator", "org/apache/catalina/core/AsyncListenerWrapper"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/ExceptionUtils", "handleThrowable", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/core/AsyncContextImpl", "log", "Lorg/apache/juli/logging/Log;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doInternalDispatch", "()V", null, new String[] { "javax/servlet/ServletException", "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "event", "Ljavax/servlet/AsyncEvent;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/AsyncEvent", "getSuppliedRequest", "()Ljavax/servlet/ServletRequest;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "event", "Ljavax/servlet/AsyncEvent;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/AsyncEvent", "getSuppliedResponse", "()Ljavax/servlet/ServletResponse;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/servlet/AsyncEvent", "java/util/List", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/AsyncListenerWrapper", "fireOnError", "(Ljavax/servlet/AsyncEvent;)V", false);
methodVisitor.visitLabel(label1);
Label label7 = new Label();
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/core/AsyncContextImpl", "java/lang/Throwable", Opcodes.INTEGER, "javax/servlet/AsyncEvent", "java/util/List", "java/util/Iterator", "org/apache/catalina/core/AsyncListenerWrapper"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/ExceptionUtils", "handleThrowable", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/core/AsyncContextImpl", "log", "Lorg/apache/juli/logging/Log;");
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/concurrent/atomic/AtomicBoolean", "javax/servlet/ServletResponse"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/AsyncContextImpl", "context", "Lorg/apache/catalina/Context;");
