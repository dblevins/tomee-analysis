...
public class CopyParentClassLoaderRuleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/startup/CopyParentClassLoaderRule", null, "org/apache/tomcat/util/digester/Rule", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/startup/CopyParentClassLoaderRule", "digester", "Lorg/apache/tomcat/util/digester/Digester;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/startup/CopyParentClassLoaderRule", "digester", "Lorg/apache/tomcat/util/digester/Digester;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/digester/Digester", "getLogger", "()Lorg/apache/juli/logging/Log;", false);
methodVisitor.visitLdcInsn("Copying parent class loader");
...
methodVisitor.visitLdcInsn("getParentClassLoader");
methodVisitor.visitInsn(ICONST_0);
