...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/filters/RemoteIpFilter$XForwardedRequest", null, "javax/servlet/http/HttpServletRequestWrapper", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/catalina/filters/RemoteIpFilter$XForwardedRequest", "javax/servlet/http/HttpServletRequest", "java/util/Enumeration"}, 0, new Object[] {});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/filters/RemoteIpFilter$XForwardedRequest", "getRequest", "()Ljavax/servlet/ServletRequest;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/ServletRequestWrapper", "getRequest", "()Ljavax/servlet/ServletRequest;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/RequestFacade", "newPushBuilder", "(Ljavax/servlet/http/HttpServletRequest;)Ljavax/servlet/http/PushBuilder;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
