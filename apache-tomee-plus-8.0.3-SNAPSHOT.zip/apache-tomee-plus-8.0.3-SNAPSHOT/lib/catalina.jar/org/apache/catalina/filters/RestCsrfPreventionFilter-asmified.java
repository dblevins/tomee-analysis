...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/filters/CsrfPreventionFilterBase", "init", "(Ljavax/servlet/FilterConfig;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/filters/RestCsrfPreventionFilter$RestCsrfPreventionStrategy", "apply", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)Z", true);
