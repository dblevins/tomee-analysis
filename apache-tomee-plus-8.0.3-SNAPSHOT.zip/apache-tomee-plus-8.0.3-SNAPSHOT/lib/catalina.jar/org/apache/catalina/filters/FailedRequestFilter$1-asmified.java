...
public class FailedRequestFilter$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/catalina/filters/FailedRequestFilter$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/catalina/filters/FailedRequestFilter", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$http$Parameters$FailReason", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/http/Parameters$FailReason", "values", "()[Lorg/apache/tomcat/util/http/Parameters$FailReason;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/catalina/filters/FailedRequestFilter$1", "$SwitchMap$org$apache$tomcat$util$http$Parameters$FailReason", "[I");
