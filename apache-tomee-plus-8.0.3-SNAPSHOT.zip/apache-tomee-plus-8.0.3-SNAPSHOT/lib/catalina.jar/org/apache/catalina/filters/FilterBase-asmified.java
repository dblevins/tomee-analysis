...
public class FilterBaseDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/catalina/filters/FilterBase", null, "java/lang/Object", new String[] { "javax/servlet/Filter" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "getLogger", "()Lorg/apache/juli/logging/Log;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("filterbase.noSuchProperty");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/filters/FilterBase", "isConfigProblemFatal", "()Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/filters/FilterBase", "getLogger", "()Lorg/apache/juli/logging/Log;", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/catalina/filters/FilterBase;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/res/StringManager", "getManager", "(Ljava/lang/Class;)Lorg/apache/tomcat/util/res/StringManager;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/catalina/filters/FilterBase", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
methodVisitor.visitInsn(RETURN);
