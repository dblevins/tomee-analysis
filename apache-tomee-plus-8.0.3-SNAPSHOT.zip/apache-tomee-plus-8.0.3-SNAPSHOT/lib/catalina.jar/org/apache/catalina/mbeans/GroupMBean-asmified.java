...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/catalina/mbeans/GroupMBean", "org/apache/catalina/Group", "java/util/List", "java/util/Iterator", "org/apache/catalina/Role"}, 1, new Object[] {"jakarta/management/MalformedObjectNameException"});
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/catalina/mbeans/GroupMBean", "org/apache/catalina/Group", "java/util/List", "java/util/Iterator", "org/apache/catalina/User"}, 1, new Object[] {"jakarta/management/MalformedObjectNameException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/mbeans/GroupMBean", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
