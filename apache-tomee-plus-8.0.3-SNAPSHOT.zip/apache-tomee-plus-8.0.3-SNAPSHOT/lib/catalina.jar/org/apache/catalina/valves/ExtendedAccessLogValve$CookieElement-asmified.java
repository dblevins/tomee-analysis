...
public class ExtendedAccessLogValve$CookieElementDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/valves/ExtendedAccessLogValve$CookieElement", null, "java/lang/Object", new String[] { "org/apache/catalina/valves/AbstractAccessLogValve$AccessLogElement" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/valves/ExtendedAccessLogValve$CookieElement", "name", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"[Ljakarta/servlet/http/Cookie;", Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/valves/ExtendedAccessLogValve$CookieElement", "name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ILOAD, 8);
