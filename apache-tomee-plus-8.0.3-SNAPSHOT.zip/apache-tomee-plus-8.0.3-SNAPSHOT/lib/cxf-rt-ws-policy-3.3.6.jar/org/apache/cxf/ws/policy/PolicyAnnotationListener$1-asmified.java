...
public class PolicyAnnotationListener$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/cxf/ws/policy/PolicyAnnotationListener$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/cxf/ws/policy/PolicyAnnotationListener", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$cxf$annotations$Policy$Placement", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/annotations/Policy$Placement", "values", "()[Lorg/apache/cxf/annotations/Policy$Placement;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/ws/policy/PolicyAnnotationListener$1", "$SwitchMap$org$apache$cxf$annotations$Policy$Placement", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/ws/policy/PolicyAnnotationListener$1", "$SwitchMap$org$apache$cxf$service$factory$FactoryBeanListener$Event", "[I");
