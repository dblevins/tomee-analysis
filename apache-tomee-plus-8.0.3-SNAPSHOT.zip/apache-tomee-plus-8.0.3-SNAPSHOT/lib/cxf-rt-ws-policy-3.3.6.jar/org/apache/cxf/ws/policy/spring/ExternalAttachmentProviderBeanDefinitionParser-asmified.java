...
public class ExternalAttachmentProviderBeanDefinitionParserDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/policy/spring/ExternalAttachmentProviderBeanDefinitionParser", null, "org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "shouldGenerateIdAsFallback", "()Z", null, null);
methodVisitor.visitCode();
