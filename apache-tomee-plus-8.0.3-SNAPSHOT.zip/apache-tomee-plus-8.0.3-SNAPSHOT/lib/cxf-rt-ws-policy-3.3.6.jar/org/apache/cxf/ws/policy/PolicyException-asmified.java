...
public class PolicyExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/policy/PolicyException", null, "org/apache/cxf/common/i18n/UncheckedException", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-6384955089085130084L));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/cxf/ws/policy/AssertionInfo;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/i18n/Message");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("ASSERTION_NOT_ASSERTED");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/ws/policy/PolicyException", "BUNDLE", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/ws/policy/PolicyException;"));
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/ws/policy/PolicyException", "BUNDLE", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
