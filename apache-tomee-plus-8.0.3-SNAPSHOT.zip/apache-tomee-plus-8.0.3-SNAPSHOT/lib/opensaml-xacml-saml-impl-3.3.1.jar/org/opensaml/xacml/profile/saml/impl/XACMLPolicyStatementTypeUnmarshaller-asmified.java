...
public class XACMLPolicyStatementTypeUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/profile/saml/XACMLPolicyStatementType", "getPolicies", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xacml/profile/saml/XACMLPolicyStatementType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/xacml/policy/PolicySetType");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/profile/saml/XACMLPolicyStatementType", "getPolicySets", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/profile/saml/XACMLPolicyStatementType", "setReferencedPolicies", "(Lorg/opensaml/xacml/profile/saml/ReferencedPoliciesType;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
