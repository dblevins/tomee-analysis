...
public class UnrecoverableLogDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/transaction/log/UnrecoverableLog", null, "java/lang/Object", new String[] { "org/apache/geronimo/transaction/manager/TransactionLog" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "recover", "(Lorg/apache/geronimo/transaction/manager/XidFactory;)Ljava/util/Collection;", null, new String[] { "org/apache/geronimo/transaction/manager/LogException" });
methodVisitor.visitCode();
