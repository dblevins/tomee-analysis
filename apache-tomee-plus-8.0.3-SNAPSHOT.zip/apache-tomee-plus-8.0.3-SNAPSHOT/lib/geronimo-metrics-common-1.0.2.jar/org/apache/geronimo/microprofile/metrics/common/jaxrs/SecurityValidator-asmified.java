...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "checkSecurity", "(Ljavax/ws/rs/core/SecurityContext;Ljavax/ws/rs/core/UriInfo;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/microprofile/metrics/common/jaxrs/SecurityValidator", "hasValidRole", "(Ljavax/ws/rs/core/SecurityContext;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "hasValidRole", "(Ljavax/ws/rs/core/SecurityContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInvokeDynamicInsn("test", "(Ljavax/ws/rs/core/SecurityContext;)Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKEINTERFACE, "javax/ws/rs/core/SecurityContext", "isUserInRole", "(Ljava/lang/String;)Z", true), Type.getType("(Ljava/lang/String;)Z")});
