...
public class HttpServletRequestResponseContextDump implements Opcodes {
...
methodVisitor.visitLdcInsn("HttpServletResponse may not be null");
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/logic/Constraint", "isNotNull", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "net/shibboleth/utilities/java/support/net/HttpServletRequestResponseContext", "currentRequest", "Ljava/lang/ThreadLocal;");
methodVisitor.visitTypeInsn(NEW, "java/lang/ThreadLocal");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/ThreadLocal", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "net/shibboleth/utilities/java/support/net/HttpServletRequestResponseContext", "currentResponse", "Ljava/lang/ThreadLocal;");
methodVisitor.visitInsn(RETURN);
