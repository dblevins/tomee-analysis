...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "net/shibboleth/utilities/java/support/net/ThreadLocalHttpServletResponseProxy", null, "java/lang/Object", new String[] { "jakarta/servlet/http/HttpServletResponse" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/shibboleth/utilities/java/support/net/ThreadLocalHttpServletResponseProxy", "getCurrent", "()Ljakarta/servlet/http/HttpServletResponse;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getCurrent", "()Ljakarta/servlet/http/HttpServletResponse;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/net/HttpServletRequestResponseContext", "getResponse", "()Ljakarta/servlet/http/HttpServletResponse;", false);
