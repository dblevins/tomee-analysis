...
public class StringDigester$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "net/shibboleth/utilities/java/support/codec/StringDigester$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("net/shibboleth/utilities/java/support/codec/StringDigester", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$net$shibboleth$utilities$java$support$codec$StringDigester$OutputFormat", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/codec/StringDigester$OutputFormat", "values", "()[Lnet/shibboleth/utilities/java/support/codec/StringDigester$OutputFormat;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "net/shibboleth/utilities/java/support/codec/StringDigester$1", "$SwitchMap$net$shibboleth$utilities$java$support$codec$StringDigester$OutputFormat", "[I");
