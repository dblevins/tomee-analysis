...
classWriter.visit(V1_2, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/logging/LogConfigurationException", null, "java/lang/RuntimeException", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(8486587136871052495L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/LogConfigurationException", "cause", "Ljava/lang/Throwable;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/LogConfigurationException", "cause", "Ljava/lang/Throwable;");
