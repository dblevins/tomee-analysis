...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$Values", null, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$View", new String[] { "java/util/Set" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$Values", "parent", "Lorg/apache/commons/collections/bidimap/AbstractDualBidiMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/AbstractDualBidiMap", "createValuesIterator", "(Ljava/util/Iterator;)Ljava/util/Iterator;", false);
