...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", null, "org/apache/commons/collections/iterators/AbstractIteratorDecorator", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "lastKey", "Ljava/lang/Object;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "lastKey", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "canRemove", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "parent", "Lorg/apache/commons/collections/bidimap/AbstractDualBidiMap;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "canRemove", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "lastKey", "Ljava/lang/Object;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "canRemove", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/AbstractDualBidiMap$KeySetIterator", "parent", "Lorg/apache/commons/collections/bidimap/AbstractDualBidiMap;");
