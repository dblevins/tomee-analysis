...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/set/UnmodifiableSortedSet", null, "org/apache/commons/collections/set/AbstractSortedSetDecorator", new String[] { "org/apache/commons/collections/Unmodifiable", "java/io/Serializable" });
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/set/UnmodifiableSortedSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/set/UnmodifiableSortedSet", "<init>", "(Ljava/util/SortedSet;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/set/UnmodifiableSortedSet", "collection", "Ljava/util/Collection;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/set/UnmodifiableSortedSet", "collection", "Ljava/util/Collection;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljava/util/SortedSet;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/set/AbstractSortedSetDecorator", "<init>", "(Ljava/util/Set;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/set/UnmodifiableSortedSet", "getCollection", "()Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/set/UnmodifiableSortedSet", "getSortedSet", "()Ljava/util/SortedSet;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
