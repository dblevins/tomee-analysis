...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections/bag/AbstractBagDecorator", null, "org/apache/commons/collections/collection/AbstractCollectionDecorator", new String[] { "org/apache/commons/collections/Bag" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/AbstractBagDecorator", "getCollection", "()Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/AbstractBagDecorator", "getBag", "()Lorg/apache/commons/collections/Bag;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
