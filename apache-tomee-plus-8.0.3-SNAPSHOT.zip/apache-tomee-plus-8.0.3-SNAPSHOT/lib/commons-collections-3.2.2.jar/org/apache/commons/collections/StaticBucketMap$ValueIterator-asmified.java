...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/StaticBucketMap$ValueIterator", null, "org/apache/commons/collections/StaticBucketMap$EntryIterator", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/StaticBucketMap$ValueIterator", "this$0", "Lorg/apache/commons/collections/StaticBucketMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/StaticBucketMap$ValueIterator", "nextEntry", "()Ljava/util/Map$Entry;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/StaticBucketMap$ValueIterator", "<init>", "(Lorg/apache/commons/collections/StaticBucketMap;)V", false);
methodVisitor.visitInsn(RETURN);
