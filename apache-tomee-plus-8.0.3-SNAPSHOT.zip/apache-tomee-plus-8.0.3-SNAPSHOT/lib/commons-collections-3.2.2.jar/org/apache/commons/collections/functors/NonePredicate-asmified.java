...
public class NonePredicateDump implements Opcodes {
...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/functors/NonePredicate", null, "java/lang/Object", new String[] { "org/apache/commons/collections/Predicate", "org/apache/commons/collections/functors/PredicateDecorator", "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(2007613066565892961L));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/functors/NonePredicate");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/functors/NonePredicate", "<init>", "([Lorg/apache/commons/collections/Predicate;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/functors/NonePredicate", "iPredicates", "[Lorg/apache/commons/collections/Predicate;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/functors/NonePredicate", "iPredicates", "[Lorg/apache/commons/collections/Predicate;");
methodVisitor.visitInsn(ARRAYLENGTH);
