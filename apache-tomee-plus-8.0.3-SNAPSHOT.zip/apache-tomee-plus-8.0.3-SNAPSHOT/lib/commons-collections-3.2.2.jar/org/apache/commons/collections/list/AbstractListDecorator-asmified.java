...
public class AbstractListDecoratorDump implements Opcodes {
...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections/list/AbstractListDecorator", null, "org/apache/commons/collections/collection/AbstractCollectionDecorator", new String[] { "java/util/List" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/list/AbstractListDecorator", "getCollection", "()Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/list/AbstractListDecorator", "getList", "()Ljava/util/List;", false);
