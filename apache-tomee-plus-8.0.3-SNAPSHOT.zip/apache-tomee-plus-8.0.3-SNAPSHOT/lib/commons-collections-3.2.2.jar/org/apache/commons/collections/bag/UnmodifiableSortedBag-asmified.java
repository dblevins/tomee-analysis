...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/bag/UnmodifiableSortedBag", null, "org/apache/commons/collections/bag/AbstractSortedBagDecorator", new String[] { "org/apache/commons/collections/Unmodifiable", "java/io/Serializable" });
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/bag/UnmodifiableSortedBag");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bag/UnmodifiableSortedBag", "<init>", "(Lorg/apache/commons/collections/SortedBag;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/commons/collections/SortedBag;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bag/AbstractSortedBagDecorator", "<init>", "(Lorg/apache/commons/collections/SortedBag;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bag/UnmodifiableSortedBag", "collection", "Ljava/util/Collection;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bag/UnmodifiableSortedBag", "collection", "Ljava/util/Collection;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/UnmodifiableSortedBag", "getCollection", "()Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/UnmodifiableSortedBag", "getBag", "()Lorg/apache/commons/collections/Bag;", false);
