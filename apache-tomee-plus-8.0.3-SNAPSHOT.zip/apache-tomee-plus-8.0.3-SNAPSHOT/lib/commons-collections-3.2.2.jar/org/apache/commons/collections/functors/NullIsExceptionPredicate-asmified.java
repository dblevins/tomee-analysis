...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/functors/NullIsExceptionPredicate", null, "java/lang/Object", new String[] { "org/apache/commons/collections/Predicate", "org/apache/commons/collections/functors/PredicateDecorator", "java/io/Serializable" });
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/functors/NullIsExceptionPredicate");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/functors/NullIsExceptionPredicate", "<init>", "(Lorg/apache/commons/collections/Predicate;)V", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/functors/NullIsExceptionPredicate", "iPredicate", "Lorg/apache/commons/collections/Predicate;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/functors/NullIsExceptionPredicate", "iPredicate", "Lorg/apache/commons/collections/Predicate;");
methodVisitor.visitVarInsn(ALOAD, 1);
