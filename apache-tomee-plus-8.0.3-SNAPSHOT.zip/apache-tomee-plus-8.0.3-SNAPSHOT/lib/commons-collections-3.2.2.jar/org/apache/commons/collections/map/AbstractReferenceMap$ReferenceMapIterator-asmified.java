...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/map/AbstractReferenceMap$ReferenceMapIterator", null, "org/apache/commons/collections/map/AbstractReferenceMap$ReferenceEntrySetIterator", new String[] { "org/apache/commons/collections/MapIterator" });

classWriter.visitInnerClass("org/apache/commons/collections/map/AbstractReferenceMap$ReferenceMapIterator", "org/apache/commons/collections/map/AbstractReferenceMap", "ReferenceMapIterator", ACC_STATIC);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/commons/collections/map/AbstractReferenceMap;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/map/AbstractReferenceMap$ReferenceEntrySetIterator", "<init>", "(Lorg/apache/commons/collections/map/AbstractReferenceMap;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/AbstractReferenceMap$ReferenceMapIterator", "nextEntry", "()Lorg/apache/commons/collections/map/AbstractReferenceMap$ReferenceEntry;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/AbstractReferenceMap$ReferenceMapIterator", "currentEntry", "()Lorg/apache/commons/collections/map/AbstractReferenceMap$ReferenceEntry;", false);
