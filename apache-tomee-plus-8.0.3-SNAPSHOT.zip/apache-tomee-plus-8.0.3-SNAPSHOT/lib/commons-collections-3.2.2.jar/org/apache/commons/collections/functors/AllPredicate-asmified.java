...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/functors/AllPredicate", null, "java/lang/Object", new String[] { "org/apache/commons/collections/Predicate", "org/apache/commons/collections/functors/PredicateDecorator", "java/io/Serializable" });
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/functors/AllPredicate");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/functors/AllPredicate", "<init>", "([Lorg/apache/commons/collections/Predicate;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/functors/AllPredicate", "iPredicates", "[Lorg/apache/commons/collections/Predicate;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/functors/AllPredicate", "iPredicates", "[Lorg/apache/commons/collections/Predicate;");
methodVisitor.visitInsn(ARRAYLENGTH);
Label label1 = new Label();
