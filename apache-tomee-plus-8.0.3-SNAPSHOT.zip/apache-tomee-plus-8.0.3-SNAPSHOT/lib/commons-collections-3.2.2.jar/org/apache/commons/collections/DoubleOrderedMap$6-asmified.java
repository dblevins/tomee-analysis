...
public class DoubleOrderedMap$6Dump implements Opcodes {
...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/DoubleOrderedMap$6", null, "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/DoubleOrderedMap$6", "this$0", "Lorg/apache/commons/collections/DoubleOrderedMap;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/DoubleOrderedMap$6$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/DoubleOrderedMap$6$1", "<init>", "(Lorg/apache/commons/collections/DoubleOrderedMap$6;I)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/DoubleOrderedMap$6", "this$0", "Lorg/apache/commons/collections/DoubleOrderedMap;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$2100", "(Lorg/apache/commons/collections/DoubleOrderedMap$6;)Lorg/apache/commons/collections/DoubleOrderedMap;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/DoubleOrderedMap$6", "this$0", "Lorg/apache/commons/collections/DoubleOrderedMap;");
methodVisitor.visitInsn(ARETURN);
