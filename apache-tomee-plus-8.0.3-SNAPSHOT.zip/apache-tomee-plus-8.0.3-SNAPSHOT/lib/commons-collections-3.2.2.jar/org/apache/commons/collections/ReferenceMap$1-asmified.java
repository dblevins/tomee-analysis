...
public class ReferenceMap$1Dump implements Opcodes {
...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/ReferenceMap$1", null, "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/ReferenceMap$1", "this$0", "Lorg/apache/commons/collections/ReferenceMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/ReferenceMap$1", "this$0", "Lorg/apache/commons/collections/ReferenceMap;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/collections/ReferenceMap", "access$000", "(Lorg/apache/commons/collections/ReferenceMap;Ljava/lang/Object;)Lorg/apache/commons/collections/ReferenceMap$Entry;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/ReferenceMap$1", "contains", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/ReferenceMap$EntryIterator");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/ReferenceMap$1", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/ReferenceMap$1", "iterator", "()Ljava/util/Iterator;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/commons/collections/ReferenceMap$Entry");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/keyvalue/DefaultMapEntry", "<init>", "(Ljava/lang/Object;Ljava/lang/Object;)V", false);
