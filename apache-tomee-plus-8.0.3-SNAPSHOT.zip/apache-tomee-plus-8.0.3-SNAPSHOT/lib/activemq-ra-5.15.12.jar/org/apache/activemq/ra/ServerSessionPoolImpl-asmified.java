...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/ra/ServerSessionPoolImpl", null, "java/lang/Object", new String[] { "jakarta/jms/ServerSessionPool" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createServerSessionImpl", "()Lorg/apache/activemq/ra/ServerSessionImpl;", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "jakarta/resource/spi/UnavailableException");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ra/ServerSessionPoolImpl", "createEndpoint", "(Lorg/apache/activemq/ra/LocalAndXATransaction;)Ljakarta/resource/spi/endpoint/MessageEndpoint;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ra/ServerSessionImpl", "<init>", "(Lorg/apache/activemq/ra/ServerSessionPoolImpl;Lorg/apache/activemq/ActiveMQSession;Ljakarta/resource/spi/work/WorkManager;Ljakarta/resource/spi/endpoint/MessageEndpoint;ZI)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/activemq/ra/ServerSessionPoolImpl", "org/apache/activemq/ra/MessageActivationSpec", Opcodes.INTEGER, "org/apache/activemq/ActiveMQConnection", "org/apache/activemq/ActiveMQSession"}, 1, new Object[] {"jakarta/resource/spi/UnavailableException"});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.TOP, "jakarta/resource/spi/UnavailableException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createEndpoint", "(Lorg/apache/activemq/ra/LocalAndXATransaction;)Ljakarta/resource/spi/endpoint/MessageEndpoint;", null, new String[] { "jakarta/resource/spi/UnavailableException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ra/ServerSessionPoolImpl", "activeMQAsfEndpointWorker", "Lorg/apache/activemq/ra/ActiveMQEndpointWorker;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ra/MessageEndpointProxy", "<init>", "(Ljakarta/resource/spi/endpoint/MessageEndpoint;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getServerSession", "()Ljakarta/jms/ServerSession;", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "dispatchToSession", "(Lorg/apache/activemq/command/MessageDispatch;)V", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ra/ServerSessionPoolImpl", "getServerSession", "()Ljakarta/jms/ServerSession;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/jms/JMSException", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
