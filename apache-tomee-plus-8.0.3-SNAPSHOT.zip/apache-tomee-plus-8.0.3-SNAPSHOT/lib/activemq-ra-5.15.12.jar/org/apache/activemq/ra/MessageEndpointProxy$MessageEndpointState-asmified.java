...
public class MessageEndpointProxy$MessageEndpointStateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/activemq/ra/MessageEndpointProxy$MessageEndpointState", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_FINAL, "transition", "(Lorg/apache/activemq/ra/MessageEndpointProxy;Lorg/apache/activemq/ra/MessageEndpointProxy$MessageEndpointState;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/ra/MessageEndpointProxy", "access$202", "(Lorg/apache/activemq/ra/MessageEndpointProxy;Lorg/apache/activemq/ra/MessageEndpointProxy$MessageEndpointState;)Lorg/apache/activemq/ra/MessageEndpointProxy$MessageEndpointState;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ra/MessageEndpointProxy$MessageEndpointState", "enter", "(Lorg/apache/activemq/ra/MessageEndpointProxy;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ra/MessageEndpointProxy$MessageEndpointState", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
