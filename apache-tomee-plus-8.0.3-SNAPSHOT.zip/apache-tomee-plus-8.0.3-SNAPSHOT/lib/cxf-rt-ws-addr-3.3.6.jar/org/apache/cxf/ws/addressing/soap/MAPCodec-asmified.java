...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/ws/addressing/VersionTransformer", "getExposedJAXBContext", "(Ljava/lang/String;)Ljavax/xml/bind/JAXBContext;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/addressing/soap/MAPCodec", "encodeAsExposed", "(Lorg/apache/cxf/ws/addressing/AddressingProperties;Lorg/apache/cxf/binding/soap/SoapMessage;Ljava/lang/Object;Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljavax/xml/bind/JAXBContext;)V", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/ws/addressing/Names", "WSA_ACTION_QNAME", "Ljavax/xml/namespace/QName;");
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/addressing/soap/MAPCodec", "encodeAsExposed", "(Lorg/apache/cxf/ws/addressing/AddressingProperties;Lorg/apache/cxf/binding/soap/SoapMessage;Ljava/lang/Object;Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljavax/xml/bind/JAXBContext;)V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "javax/xml/bind/JAXBContext", "javax/xml/namespace/QName"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/addressing/soap/MAPCodec", "encodeReferenceParameters", "(Lorg/apache/cxf/ws/addressing/AddressingProperties;Lorg/apache/cxf/binding/soap/SoapMessage;Ljavax/xml/bind/JAXBContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/ws/addressing/soap/MAPCodec", "org/apache/cxf/binding/soap/SoapMessage", "org/apache/cxf/ws/addressing/AddressingProperties"}, 1, new Object[] {"javax/xml/bind/JAXBException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/ws/addressing/soap/MAPCodec", "LOG", "Ljava/util/logging/Logger;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "encodeReferenceParameters", "(Lorg/apache/cxf/ws/addressing/AddressingProperties;Lorg/apache/cxf/binding/soap/SoapMessage;Ljavax/xml/bind/JAXBContext;)V", null, new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "encodeAsExposed", "(Lorg/apache/cxf/ws/addressing/AddressingProperties;Lorg/apache/cxf/binding/soap/SoapMessage;Ljava/lang/Object;Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljavax/xml/bind/JAXBContext;)V", "<T:Ljava/lang/Object;>(Lorg/apache/cxf/ws/addressing/AddressingProperties;Lorg/apache/cxf/binding/soap/SoapMessage;TT;Ljavax/xml/namespace/QName;Ljava/lang/Class<TT;>;Ljavax/xml/bind/JAXBContext;)V", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/addressing/soap/VersionTransformer", "encodeAsExposed", "(Lorg/apache/cxf/binding/soap/SoapMessage;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Class;Ljavax/xml/bind/JAXBContext;Z)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/ws/addressing/soap/MAPCodec", "org/apache/cxf/binding/soap/SoapMessage", "org/apache/cxf/ws/addressing/AddressingProperties", "javax/xml/bind/Unmarshaller", "java/util/List", "java/util/Set", "javax/xml/namespace/QName", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/addressing/soap/MAPCodec", "decodeAsNative", "(Ljava/lang/String;Ljava/lang/Class;Lorg/w3c/dom/Element;Ljavax/xml/bind/Unmarshaller;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/addressing/soap/MAPCodec", "decodeReferenceParameters", "(Ljava/util/Set;Lorg/apache/cxf/ws/addressing/AddressingProperties;Ljavax/xml/bind/Unmarshaller;)V", false);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/ws/addressing/soap/MAPCodec", "org/apache/cxf/binding/soap/SoapMessage", "org/apache/cxf/ws/addressing/AddressingProperties", "javax/xml/bind/Unmarshaller"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "decodeReferenceParameters", "(Ljava/util/Set;Lorg/apache/cxf/ws/addressing/AddressingProperties;Ljavax/xml/bind/Unmarshaller;)V", "(Ljava/util/Set<Lorg/w3c/dom/Element;>;Lorg/apache/cxf/ws/addressing/AddressingProperties;Ljavax/xml/bind/Unmarshaller;)V", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/addressing/AddressingProperties", "getToEndpointReference", "()Lorg/apache/cxf/ws/addressing/EndpointReferenceType;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/addressing/soap/VersionTransformer", "decodeAsNative", "(Ljava/lang/String;Ljava/lang/Class;Lorg/w3c/dom/Element;Ljavax/xml/bind/Unmarshaller;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "encodeMAP", "(Lorg/apache/cxf/binding/soap/SoapMessage;Ljava/lang/Object;Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljavax/xml/bind/JAXBContext;Z)V", "<T:Ljava/lang/Object;>(Lorg/apache/cxf/binding/soap/SoapMessage;TT;Ljavax/xml/namespace/QName;Ljava/lang/Class<TT;>;Ljavax/xml/bind/JAXBContext;Z)V", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "decodeMAP", "(Ljava/lang/Class;Lorg/w3c/dom/Element;Ljavax/xml/bind/Unmarshaller;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Lorg/w3c/dom/Element;Ljavax/xml/bind/Unmarshaller;)TT;", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
