...
public class InternalContextUtils$DecoupledDestinationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", null, "java/lang/Object", new String[] { "org/apache/cxf/transport/Destination" });
...
classWriter.visitInnerClass("org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination$1", null, null, 0);

classWriter.visitInnerClass("org/apache/cxf/ws/addressing/impl/InternalContextUtils$1", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "ei", "Lorg/apache/cxf/service/model/EndpointInfo;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "reference", "Lorg/apache/cxf/ws/addressing/EndpointReferenceType;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/cxf/service/model/EndpointInfo;Lorg/apache/cxf/ws/addressing/EndpointReferenceType;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", "ei", "Lorg/apache/cxf/service/model/EndpointInfo;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", "reference", "Lorg/apache/cxf/ws/addressing/EndpointReferenceType;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", "reference", "Lorg/apache/cxf/ws/addressing/EndpointReferenceType;");
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", "ei", "Lorg/apache/cxf/service/model/EndpointInfo;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", "reference", "Lorg/apache/cxf/ws/addressing/EndpointReferenceType;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination$1", "<init>", "(Lorg/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/cxf/service/model/EndpointInfo;Lorg/apache/cxf/ws/addressing/EndpointReferenceType;Lorg/apache/cxf/ws/addressing/impl/InternalContextUtils$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/addressing/impl/InternalContextUtils$DecoupledDestination", "<init>", "(Lorg/apache/cxf/service/model/EndpointInfo;Lorg/apache/cxf/ws/addressing/EndpointReferenceType;)V", false);
methodVisitor.visitInsn(RETURN);
