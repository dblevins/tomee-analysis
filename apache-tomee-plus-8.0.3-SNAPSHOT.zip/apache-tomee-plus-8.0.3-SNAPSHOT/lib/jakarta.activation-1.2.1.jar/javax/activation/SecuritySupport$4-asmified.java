...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "javax/activation/SecuritySupport$4", null, "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/activation/SecuritySupport$4", "val$name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/activation/SecuritySupport$4", "val$name", "Ljava/lang/String;");
