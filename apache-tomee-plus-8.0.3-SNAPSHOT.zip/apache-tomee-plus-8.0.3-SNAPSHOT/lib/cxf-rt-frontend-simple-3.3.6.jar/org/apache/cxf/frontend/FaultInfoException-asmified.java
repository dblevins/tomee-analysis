...
public class FaultInfoExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/frontend/FaultInfoException", null, "java/lang/Exception", new String[] { "org/apache/cxf/interceptor/FaultOutInterceptor$FaultInfoException" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(1392427062502667841L));
