...
classWriter.visit(V1_7, ACC_FINAL | ACC_SUPER, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", null, "java/lang/Object", new String[] { "java/lang/reflect/WildcardType" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "EMPTY_BOUNDS", "[Ljava/lang/reflect/Type;", null, null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "EMPTY_BOUNDS", "[Ljava/lang/reflect/Type;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "upperBounds", "[Ljava/lang/reflect/Type;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "EMPTY_BOUNDS", "[Ljava/lang/reflect/Type;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/lang3/ObjectUtils", "defaultIfNull", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljava/lang/reflect/Type;");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "lowerBounds", "[Ljava/lang/reflect/Type;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "upperBounds", "[Ljava/lang/reflect/Type;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "lowerBounds", "[Ljava/lang/reflect/Type;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljava/lang/reflect/Type;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljava/lang/reflect/Type;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/lang3/reflect/TypeUtils", "access$300", "(Ljava/lang/reflect/WildcardType;Ljava/lang/reflect/Type;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label1);
...
methodVisitor.visitCode();
methodVisitor.visitIntInsn(SIPUSH, 18688);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "([Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;Lorg/apache/commons/lang3/reflect/TypeUtils$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "<init>", "([Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/lang3/reflect/TypeUtils$WildcardTypeImpl", "EMPTY_BOUNDS", "[Ljava/lang/reflect/Type;");
methodVisitor.visitInsn(RETURN);
