...
public class ValueInstantiator$BaseDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/fasterxml/jackson/databind/deser/ValueInstantiator$Base", null, "com/fasterxml/jackson/databind/deser/ValueInstantiator", new String[] { "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "_valueType", "Ljava/lang/Class;", "Ljava/lang/Class<*>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/deser/ValueInstantiator$Base", "_valueType", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/deser/ValueInstantiator$Base", "_valueType", "Ljava/lang/Class;");
