...
public class NodeCursor$RootCursorDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", null, "com/fasterxml/jackson/databind/node/NodeCursor", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "_node", "Lcom/fasterxml/jackson/databind/JsonNode;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "_done", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", "_done", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", "_node", "Lcom/fasterxml/jackson/databind/JsonNode;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", "_done", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", "_done", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", "_node", "Lcom/fasterxml/jackson/databind/JsonNode;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/fasterxml/jackson/databind/node/NodeCursor$RootCursor", "nextToken", "()Lcom/fasterxml/jackson/core/JsonToken;", false);
methodVisitor.visitInsn(ARETURN);
