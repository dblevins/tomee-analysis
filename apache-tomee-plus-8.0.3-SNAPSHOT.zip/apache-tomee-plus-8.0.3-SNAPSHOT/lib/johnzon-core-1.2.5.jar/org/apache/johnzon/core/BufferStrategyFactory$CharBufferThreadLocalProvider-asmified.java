...
public class BufferStrategyFactory$CharBufferThreadLocalProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/core/BufferStrategyFactory$CharBufferThreadLocalProvider", "Lorg/apache/johnzon/core/BufferStrategyFactory$ThreadLocalProvider<[C>;", "org/apache/johnzon/core/BufferStrategyFactory$ThreadLocalProvider", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/BufferStrategyFactory$ThreadLocalProvider", "<init>", "(I)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/BufferStrategyFactory$CharBufferThreadLocalProvider", "newInstance", "(I)[C", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
