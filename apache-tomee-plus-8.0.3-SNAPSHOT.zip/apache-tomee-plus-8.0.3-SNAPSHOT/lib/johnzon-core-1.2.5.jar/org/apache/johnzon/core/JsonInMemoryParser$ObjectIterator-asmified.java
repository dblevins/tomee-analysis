...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/core/JsonInMemoryParser$ObjectIterator", "Ljava/lang/Object;Ljava/util/Iterator<Ljakarta/json/stream/JsonParser$Event;>;", "java/lang/Object", new String[] { "java/util/Iterator" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "oentries", "Ljava/util/Iterator;", "Ljava/util/Iterator<Ljava/util/Map$Entry<Ljava/lang/String;Ljakarta/json/JsonValue;>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "jsonValue", "Ljakarta/json/JsonValue;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/johnzon/core/JsonInMemoryParser;Ljakarta/json/JsonObject;)V", null, null);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonInMemoryParser$ObjectIterator", "jsonValue", "Ljakarta/json/JsonValue;");
Label label1 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonInMemoryParser$ObjectIterator", "jsonValue", "Ljakarta/json/JsonValue;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonInMemoryParser$ObjectIterator", "this$0", "Lorg/apache/johnzon/core/JsonInMemoryParser;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonInMemoryParser$ObjectIterator", "next", "()Ljakarta/json/stream/JsonParser$Event;", false);
methodVisitor.visitInsn(ARETURN);
