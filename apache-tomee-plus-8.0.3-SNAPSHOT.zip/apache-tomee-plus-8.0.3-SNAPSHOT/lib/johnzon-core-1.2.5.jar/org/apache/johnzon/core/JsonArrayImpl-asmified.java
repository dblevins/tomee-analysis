...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/core/JsonArrayImpl", "Ljava/util/AbstractList<Ljakarta/json/JsonValue;>;Ljakarta/json/JsonArray;Ljava/io/Serializable;", "java/util/AbstractList", new String[] { "jakarta/json/JsonArray", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "unmodifieableBackingList", "Ljava/util/List;", "Ljava/util/List<Ljakarta/json/JsonValue;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljava/util/List;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider;)V", "(Ljava/util/List<Ljakarta/json/JsonValue;>;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider<[C>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonArrayImpl", "size", "I");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/json/JsonValue", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonArrayImpl", "get", "(I)Ljakarta/json/JsonValue;", false);
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/json/JsonValue$ValueType"}, 0, null);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljakarta/json/stream/JsonGenerator;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKEINTERFACE, "jakarta/json/stream/JsonGenerator", "write", "(Ljakarta/json/JsonValue;)Ljakarta/json/stream/JsonGenerator;", true), Type.getType("(Ljakarta/json/JsonValue;)V")});
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/johnzon/core/JsonArrayImpl", "java/io/StringWriter", "jakarta/json/stream/JsonGenerator", "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/johnzon/core/JsonArrayImpl", "java/io/StringWriter", "jakarta/json/stream/JsonGenerator", "java/lang/Throwable", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Ljakarta/json/JsonValue;>;", null);
methodVisitor.visitCode();
