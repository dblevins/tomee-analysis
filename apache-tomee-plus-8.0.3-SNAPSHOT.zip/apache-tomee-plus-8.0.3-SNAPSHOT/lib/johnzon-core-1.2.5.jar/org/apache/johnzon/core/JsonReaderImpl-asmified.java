...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/core/JsonReaderImpl", null, "java/lang/Object", new String[] { "javax/json/JsonReader" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/json/stream/JsonParser;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider;)V", "(Ljavax/json/stream/JsonParser;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider<[C>;)V", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/json/stream/JsonParser;ZLorg/apache/johnzon/core/BufferStrategy$BufferProvider;)V", "(Ljavax/json/stream/JsonParser;ZLorg/apache/johnzon/core/BufferStrategy$BufferProvider<[C>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/johnzon/core/JsonReaderImpl", "javax/json/stream/JsonParser", Opcodes.INTEGER, "org/apache/johnzon/core/BufferStrategy$BufferProvider"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/johnzon/core/JohnzonJsonParser$JohnzonJsonParserWrapper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JohnzonJsonParser$JohnzonJsonParserWrapper", "<init>", "(Ljavax/json/stream/JsonParser;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonReaderImpl", "parser", "Lorg/apache/johnzon/core/JohnzonJsonParser;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonReaderImpl", "parser", "Lorg/apache/johnzon/core/JohnzonJsonParser;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/core/JohnzonJsonParser", "current", "()Ljavax/json/stream/JsonParser$Event;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonReaderImpl", "parser", "Lorg/apache/johnzon/core/JohnzonJsonParser;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/core/JohnzonJsonParser", "next", "()Ljavax/json/stream/JsonParser$Event;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JsonReaderImpl", "parseObject", "(Ljavax/json/JsonObjectBuilder;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonReaderImpl", "subStreamReader", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonReaderImpl", "parser", "Lorg/apache/johnzon/core/JohnzonJsonParser;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/core/JohnzonJsonParser", "getLocation", "()Ljavax/json/stream/JsonLocation;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JsonReaderImpl", "parseArray", "(Ljavax/json/JsonArrayBuilder;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonReaderImpl", "subStreamReader", "Z");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.TOP, "javax/json/JsonArrayBuilder"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/johnzon/core/JsonReaderImpl", "javax/json/stream/JsonParser$Event", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "javax/json/JsonNumber"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonReaderImpl", "subStreamReader", "Z");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/johnzon/core/JsonReaderImpl", "javax/json/stream/JsonParser$Event"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonReaderImpl", "read", "()Ljavax/json/JsonStructure;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/json/JsonObject;"));
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JsonReaderImpl", "checkType", "(Ljava/lang/Class;Ljavax/json/JsonStructure;)V", false);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/json/JsonObject;"));
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "checkType", "(Ljava/lang/Class;Ljavax/json/JsonStructure;)V", "(Ljava/lang/Class<*>;Ljavax/json/JsonStructure;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseObject", "(Ljavax/json/JsonObjectBuilder;)V", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseArray", "(Ljavax/json/JsonArrayBuilder;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
