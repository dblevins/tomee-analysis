...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/faces/event/MethodExpressionValueChangeListener", null, "java/lang/Object", new String[] { "javax/faces/event/ValueChangeListener", "javax/faces/component/StateHolder" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/event/MethodExpressionValueChangeListener", "isTransient", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/event/MethodExpressionValueChangeListener", "methodExpressionOneArg", "Ljavax/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionValueChangeListener", "_createZeroArgsMethodExpression", "(Ljavax/el/MethodExpression;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/event/MethodExpressionValueChangeListener", "methodExpressionZeroArg", "Ljavax/el/MethodExpression;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/event/MethodExpressionValueChangeListener", "javax/el/MethodExpression", "javax/el/MethodExpression"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionValueChangeListener", "_createZeroArgsMethodExpression", "(Ljavax/el/MethodExpression;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "processValueChange", "(Ljavax/faces/event/ValueChangeEvent;)V", null, new String[] { "javax/faces/event/AbortProcessingException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/event/MethodExpressionValueChangeListener", "methodExpressionOneArg", "Ljavax/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionValueChangeListener", "getElContext", "()Ljavax/el/ELContext;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/event/MethodExpressionValueChangeListener", "methodExpressionZeroArg", "Ljavax/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionValueChangeListener", "getElContext", "()Ljavax/el/ELContext;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/event/MethodExpressionValueChangeListener", "EMPTY_PARAMS", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/el/MethodExpression", "invoke", "(Ljavax/el/ELContext;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/el/ELException", "java/lang/Throwable", "javax/faces/event/AbortProcessingException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/event/MethodExpressionValueChangeListener", "isTransient", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getElContext", "()Ljavax/el/ELContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionValueChangeListener", "getFacesContext", "()Ljavax/faces/context/FacesContext;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getFacesContext", "()Ljavax/faces/context/FacesContext;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_createZeroArgsMethodExpression", "(Ljavax/el/MethodExpression;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionValueChangeListener", "getFacesContext", "()Ljavax/faces/context/FacesContext;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/event/MethodExpressionValueChangeListener", "EMPTY_CLASS_ARRAY", "[Ljava/lang/Class;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/event/MethodExpressionValueChangeListener", "EMPTY_CLASS_ARRAY", "[Ljava/lang/Class;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/event/MethodExpressionValueChangeListener", "EMPTY_PARAMS", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
