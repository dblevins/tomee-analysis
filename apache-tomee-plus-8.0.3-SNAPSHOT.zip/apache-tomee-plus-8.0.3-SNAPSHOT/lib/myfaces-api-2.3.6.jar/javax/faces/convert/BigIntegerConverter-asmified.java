...
public class BigIntegerConverterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/faces/convert/BigIntegerConverter", null, "java/lang/Object", new String[] { "javax/faces/convert/Converter" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CONVERTER_ID", "Ljava/lang/String;", null, "javax.faces.BigInteger");
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "BIGINTEGER_ID", "Ljava/lang/String;", null, "javax.faces.converter.BigIntegerConverter.BIGINTEGER");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("javax.faces.converter.BigIntegerConverter.BIGINTEGER");
...
methodVisitor.visitLdcInsn("2345");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
