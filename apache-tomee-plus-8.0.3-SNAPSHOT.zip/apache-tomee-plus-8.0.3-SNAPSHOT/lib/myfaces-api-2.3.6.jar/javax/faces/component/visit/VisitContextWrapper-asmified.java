...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/component/visit/VisitContext;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/visit/VisitContextWrapper", "delegate", "Ljavax/faces/component/visit/VisitContext;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/visit/VisitContextWrapper", "delegate", "Ljavax/faces/component/visit/VisitContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
