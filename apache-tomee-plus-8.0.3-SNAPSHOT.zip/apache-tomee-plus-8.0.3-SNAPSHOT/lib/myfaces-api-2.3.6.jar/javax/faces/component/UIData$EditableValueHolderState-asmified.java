...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/UIData$EditableValueHolderState", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_value", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/faces/component/EditableValueHolder", "isLocalValueSet", "()Z", true);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_localValueSet", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/faces/component/EditableValueHolder", "isValid", "()Z", true);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_valid", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_submittedValue", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_value", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_localValueSet", "Z");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/faces/component/EditableValueHolder", "setLocalValueSet", "(Z)V", true);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_valid", "Z");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/faces/component/EditableValueHolder", "setValid", "(Z)V", true);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIData$EditableValueHolderState", "_submittedValue", "Ljava/lang/Object;");
