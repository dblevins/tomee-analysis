...
public class _UISelectItemsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "javax/faces/component/_UISelectItems", null, "javax/faces/component/UIComponentBase", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/_UISelectItems", "getParent", "()Ljavax/faces/component/UIComponent;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isItemLabelEscaped", "()Z", null, null);
methodVisitor.visitCode();
