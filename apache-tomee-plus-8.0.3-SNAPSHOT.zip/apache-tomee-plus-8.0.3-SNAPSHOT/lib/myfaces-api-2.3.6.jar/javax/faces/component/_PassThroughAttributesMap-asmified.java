...
public class _PassThroughAttributesMapDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/_PassThroughAttributesMap", "Ljava/lang/Object;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "java/util/Map", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-9106932179394257866L));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_component", "Ljavax/faces/component/UIComponentBase;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljavax/faces/component/UIComponentBase;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/_PassThroughAttributesMap", "_component", "Ljavax/faces/component/UIComponentBase;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/_PassThroughAttributesMap", "_component", "Ljavax/faces/component/UIComponentBase;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIComponentBase", "getStateHelper", "(Z)Ljavax/faces/component/StateHelper;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/component/UIComponent$PropertyKeys", "passThroughAttributesMap", "Ljavax/faces/component/UIComponent$PropertyKeys;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/component/StateHelper", "java/util/Map"}, 0, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/_PassThroughAttributesMap", "getUnderlyingMap", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/_PassThroughAttributesMap", "put", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;", false);
