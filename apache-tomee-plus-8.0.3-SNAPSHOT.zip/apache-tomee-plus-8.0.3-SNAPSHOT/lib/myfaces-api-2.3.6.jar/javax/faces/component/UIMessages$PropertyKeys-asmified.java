...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC | ACC_ENUM, "forVal", "Ljavax/faces/component/UIMessages$PropertyKeys;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIMessages$PropertyKeys", "c", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIMessages$PropertyKeys", "c", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/component/UIMessages$PropertyKeys", "forVal", "Ljavax/faces/component/UIMessages$PropertyKeys;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_4);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/component/UIMessages$PropertyKeys", "forVal", "Ljavax/faces/component/UIMessages$PropertyKeys;");
methodVisitor.visitInsn(AASTORE);
