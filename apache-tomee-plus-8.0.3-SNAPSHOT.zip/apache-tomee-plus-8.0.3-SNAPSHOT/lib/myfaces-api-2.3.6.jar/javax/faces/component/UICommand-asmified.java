...
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UICommand", "getFacesContext", "()Ljavax/faces/context/FacesContext;", false);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/context/FacesContext", "javax/faces/el/MethodBinding"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
