...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_faceletFactory", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory;", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory<TV;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_viewMetadataFaceletFactory", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory;", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory<TV;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/view/facelets/FaceletCache", "_faceletFactory", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/view/facelets/FaceletCache", "_viewMetadataFaceletFactory", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/view/facelets/FaceletCache", "_faceletFactory", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/view/facelets/FaceletCache", "_viewMetadataFaceletFactory", "Ljavax/faces/view/facelets/FaceletCache$MemberFactory;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
