...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/lifecycle/LifecycleFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/lifecycle/LifecycleFactory", "delegate", "Ljavax/faces/lifecycle/LifecycleFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/lifecycle/LifecycleFactory", "delegate", "Ljavax/faces/lifecycle/LifecycleFactory;");
