...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_servletConfig", "Ljavax/servlet/ServletConfig;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_facesContextFactory", "Ljavax/faces/context/FacesContextFactory;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_lifecycle", "Ljavax/faces/lifecycle/Lifecycle;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/webapp/FacesServlet", "_servletConfig", "Ljavax/servlet/ServletConfig;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/webapp/FacesServlet", "_facesContextFactory", "Ljavax/faces/context/FacesContextFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/webapp/FacesServlet", "_lifecycle", "Ljavax/faces/lifecycle/Lifecycle;");
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/webapp/FacesServlet", "log", "Ljava/util/logging/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/FacesServlet", "_servletConfig", "Ljavax/servlet/ServletConfig;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/webapp/FacesServlet", "getLifecycleId", "()Ljava/lang/String;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "finest", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/faces/lifecycle/LifecycleFactory"}, 0, null);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/servlet/http/HttpServletRequest", "java/lang/String"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/webapp/FacesServlet", "prepareFacesContext", "(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)Ljavax/faces/context/FacesContext;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/context/FacesContext", "javax/faces/application/ResourceHandler"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/FacesServlet", "_lifecycle", "Ljavax/faces/lifecycle/Lifecycle;");
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/FacesException", "getLocalizedMessage", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"javax/faces/webapp/FacesServlet", "javax/servlet/ServletRequest", "javax/servlet/ServletResponse", "javax/servlet/http/HttpServletRequest", "java/lang/String", "javax/faces/context/FacesContext"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "prepareFacesContext", "(Ljavax/servlet/ServletRequest;Ljavax/servlet/ServletResponse;)Ljavax/faces/context/FacesContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/FacesServlet", "_facesContextFactory", "Ljavax/faces/context/FacesContextFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/FacesServlet", "_servletConfig", "Ljavax/servlet/ServletConfig;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/ServletConfig", "getServletContext", "()Ljavax/servlet/ServletContext;", true);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/webapp/FacesServlet", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
