...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/context/PartialViewContext;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/PartialViewContextWrapper", "delegate", "Ljavax/faces/context/PartialViewContext;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/PartialViewContextWrapper", "delegate", "Ljavax/faces/context/PartialViewContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
