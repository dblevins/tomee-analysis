...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/context/ExternalContext;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/ExternalContextWrapper", "delegate", "Ljavax/faces/context/ExternalContext;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/ExternalContextWrapper", "delegate", "Ljavax/faces/context/ExternalContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
