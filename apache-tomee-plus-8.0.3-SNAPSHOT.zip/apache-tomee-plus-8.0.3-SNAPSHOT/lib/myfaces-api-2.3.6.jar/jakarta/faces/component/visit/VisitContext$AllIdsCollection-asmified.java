...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/component/visit/VisitContext$AllIdsCollection", "Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "java/util/Collection", "java/io/Serializable" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/visit/VisitContext$AllIdsCollection", "add", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljakarta/faces/component/visit/VisitContext$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/visit/VisitContext$AllIdsCollection", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
