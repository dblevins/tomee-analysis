...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC | ACC_ENUM, "actionListener", "Ljakarta/faces/component/UICommand$PropertyKeys;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UICommand$PropertyKeys", "<init>", "(Ljava/lang/String;I)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/UICommand$PropertyKeys", "actionListener", "Ljakarta/faces/component/UICommand$PropertyKeys;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UICommand$PropertyKeys", "actionListener", "Ljakarta/faces/component/UICommand$PropertyKeys;");
methodVisitor.visitInsn(AASTORE);
