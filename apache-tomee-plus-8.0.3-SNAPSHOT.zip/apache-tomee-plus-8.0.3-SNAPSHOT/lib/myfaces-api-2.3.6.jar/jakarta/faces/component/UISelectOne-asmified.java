...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UISelectOne", "selectItemValueFound", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UISelectOne", "getRadioNestingForm", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UISelectOne;)Ljakarta/faces/component/UIComponent;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UISelectOne$1", "<init>", "(Ljakarta/faces/component/UISelectOne;Ljava/lang/String;Ljava/lang/String;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getRadioNestingForm", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UISelectOne;)Ljakarta/faces/component/UIComponent;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/convert/Converter", "java/util/Collection", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UISelectOne", "selectItemValueFound", "Z");
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$002", "(Ljakarta/faces/component/UISelectOne;Z)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
