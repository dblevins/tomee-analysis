...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC | ACC_ENUM, "uniqueIdCounter", "Ljakarta/faces/component/UIData$PropertyKeys;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIData$PropertyKeys", "<init>", "(Ljava/lang/String;I)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/UIData$PropertyKeys", "uniqueIdCounter", "Ljakarta/faces/component/UIData$PropertyKeys;");
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/component/UIData$PropertyKeys");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_4);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UIData$PropertyKeys", "uniqueIdCounter", "Ljakarta/faces/component/UIData$PropertyKeys;");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_5);
