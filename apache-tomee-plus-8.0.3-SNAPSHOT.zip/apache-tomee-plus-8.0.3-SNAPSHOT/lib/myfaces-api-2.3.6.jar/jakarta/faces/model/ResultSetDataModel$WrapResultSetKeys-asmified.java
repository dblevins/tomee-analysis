...
public class ResultSetDataModel$WrapResultSetKeysDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeys", "Ljava/util/AbstractSet<Ljava/lang/String;>;", "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeys", "_wrapMap", "Ljakarta/faces/model/ResultSetDataModel$WrapResultSetMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeys", "_wrapMap", "Ljakarta/faces/model/ResultSetDataModel$WrapResultSetMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeysIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeys", "_wrapMap", "Ljakarta/faces/model/ResultSetDataModel$WrapResultSetMap;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeysIterator", "<init>", "(Ljakarta/faces/model/ResultSetDataModel$WrapResultSetMap;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ResultSetDataModel$WrapResultSetKeys", "add", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
