...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/application/NavigationCase;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/application/NavigationCaseWrapper", "delegate", "Ljakarta/faces/application/NavigationCase;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/application/NavigationCaseWrapper", "delegate", "Ljakarta/faces/application/NavigationCase;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
