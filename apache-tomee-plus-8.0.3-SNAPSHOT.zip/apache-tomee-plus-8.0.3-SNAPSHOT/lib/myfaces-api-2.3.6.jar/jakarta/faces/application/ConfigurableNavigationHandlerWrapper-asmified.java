...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/application/ConfigurableNavigationHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/application/ConfigurableNavigationHandlerWrapper", "delegate", "Ljakarta/faces/application/ConfigurableNavigationHandler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/application/ConfigurableNavigationHandlerWrapper", "delegate", "Ljakarta/faces/application/ConfigurableNavigationHandler;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
