...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "jakarta/faces/validator/_ValueReferenceResolver", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "resolve", "(Ljakarta/el/ValueExpression;Ljakarta/el/ELContext;)Ljakarta/el/ValueReference;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
