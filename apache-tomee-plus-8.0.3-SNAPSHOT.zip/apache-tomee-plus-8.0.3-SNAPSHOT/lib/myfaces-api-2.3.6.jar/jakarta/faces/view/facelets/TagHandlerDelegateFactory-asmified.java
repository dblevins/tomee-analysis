...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/view/facelets/TagHandlerDelegateFactory;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/view/facelets/TagHandlerDelegateFactory", "delegate", "Ljakarta/faces/view/facelets/TagHandlerDelegateFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/view/facelets/TagHandlerDelegateFactory", "delegate", "Ljakarta/faces/view/facelets/TagHandlerDelegateFactory;");
