...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/render/RendererWrapper", "delegate", "Ljakarta/faces/render/Renderer;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/render/RendererWrapper", "delegate", "Ljakarta/faces/render/Renderer;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
