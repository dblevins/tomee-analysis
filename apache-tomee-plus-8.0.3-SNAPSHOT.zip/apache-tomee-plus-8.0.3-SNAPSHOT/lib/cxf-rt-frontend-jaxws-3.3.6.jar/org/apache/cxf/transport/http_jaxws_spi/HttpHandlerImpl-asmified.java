...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/transport/http_jaxws_spi/HttpHandlerImpl", null, "javax/xml/ws/spi/http/HttpHandler", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/ws/spi/http/HttpHandler", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "handle", "(Ljavax/xml/ws/spi/http/HttpExchange;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/transport/http_jaxws_spi/HttpHandlerImpl", "javax/xml/ws/spi/http/HttpExchange", "org/apache/cxf/service/model/EndpointInfo", "java/lang/String", "java/lang/String", "java/lang/Object", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/http_jaxws_spi/HttpServletRequestAdapter", "<init>", "(Ljavax/xml/ws/spi/http/HttpExchange;)V", false);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter", "<init>", "(Ljavax/xml/ws/spi/http/HttpExchange;)V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/http_jaxws_spi/JAXWSHttpSpiDestination", "doService", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", false);
methodVisitor.visitLabel(label5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/spi/http/HttpExchange", "close", "()V", false);
Label label11 = new Label();
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/transport/http_jaxws_spi/HttpHandlerImpl", "javax/xml/ws/spi/http/HttpExchange"}, 1, new Object[] {"java/lang/Throwable"});
