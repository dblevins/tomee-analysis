...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter", null, "java/lang/Object", new String[] { "jakarta/servlet/http/HttpServletResponse" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter", "exchange", "Ljakarta/xml/ws/spi/http/HttpExchange;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter", "exchange", "Ljakarta/xml/ws/spi/http/HttpExchange;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/http/HttpExchange", "getResponseBody", "()Ljava/io/OutputStream;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter", "exchange", "Ljakarta/xml/ws/spi/http/HttpExchange;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/http/HttpExchange", "getResponseHeaders", "()Ljava/util/Map;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/http/HttpExchange", "addResponseHeader", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/http_jaxws_spi/HttpServletResponseAdapter", "exchange", "Ljakarta/xml/ws/spi/http/HttpExchange;");
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/http/HttpExchange", "setStatus", "(I)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
