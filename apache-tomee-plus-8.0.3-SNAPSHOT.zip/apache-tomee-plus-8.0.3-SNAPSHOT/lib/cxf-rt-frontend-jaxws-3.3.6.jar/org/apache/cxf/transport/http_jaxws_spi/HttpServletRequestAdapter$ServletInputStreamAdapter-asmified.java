...
public class HttpServletRequestAdapter$ServletInputStreamAdapterDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljava/io/InputStream;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/http_jaxws_spi/HttpServletRequestAdapter$ServletInputStreamAdapter", "delegate", "Ljava/io/InputStream;");
