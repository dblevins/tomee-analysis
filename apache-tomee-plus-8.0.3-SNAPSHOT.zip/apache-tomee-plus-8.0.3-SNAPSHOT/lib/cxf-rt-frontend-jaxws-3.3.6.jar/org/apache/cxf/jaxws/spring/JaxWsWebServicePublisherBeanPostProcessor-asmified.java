...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "shadowCxfServlet", "Ljavax/servlet/Servlet;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/spring/JaxWsWebServicePublisherBeanPostProcessor", "shadowCxfServlet", "Ljavax/servlet/Servlet;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/spring/JaxWsWebServicePublisherBeanPostProcessor", "shadowCxfServlet", "Ljavax/servlet/Servlet;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/spring/JaxWsWebServicePublisherBeanPostProcessor$ServletAdapter", "<init>", "(Ljavax/servlet/Servlet;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setServletConfig", "(Ljavax/servlet/ServletConfig;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/spring/JaxWsWebServicePublisherBeanPostProcessor", "shadowCxfServlet", "Ljavax/servlet/Servlet;");
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
