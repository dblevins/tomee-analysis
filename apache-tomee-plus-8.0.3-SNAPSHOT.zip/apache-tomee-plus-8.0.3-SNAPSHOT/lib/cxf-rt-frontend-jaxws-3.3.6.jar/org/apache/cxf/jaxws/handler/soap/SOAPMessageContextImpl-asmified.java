...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxws/handler/soap/SOAPMessageContextImpl", null, "org/apache/cxf/jaxws/context/WrappedMessageContext", new String[] { "javax/xml/ws/handler/soap/SOAPMessageContext" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setMessage", "(Ljavax/xml/soap/SOAPMessage;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMessage", "()Ljavax/xml/soap/SOAPMessage;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getHeaders", "(Ljavax/xml/namespace/QName;Ljavax/xml/bind/JAXBContext;Z)[Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPHeader", "hasChildNodes", "()Z", true);
methodVisitor.visitJumpInsn(IFNE, label3);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/xml/soap/SOAPMessage", "javax/xml/soap/SOAPHeader"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPHeader", "examineAllHeaderElements", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPHeaderElement", "getActor", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPHeaderElement", "getElementQName", "()Ljavax/xml/namespace/QName;", true);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxws/handler/soap/SOAPMessageContextImpl", "javax/xml/namespace/QName", "javax/xml/bind/JAXBContext", Opcodes.INTEGER, "javax/xml/soap/SOAPMessage"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
