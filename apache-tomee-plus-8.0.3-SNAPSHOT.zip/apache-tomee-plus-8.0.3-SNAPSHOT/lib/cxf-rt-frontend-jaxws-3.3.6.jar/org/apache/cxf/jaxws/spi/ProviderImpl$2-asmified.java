...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxws/spi/ProviderImpl$2", "Ljava/lang/Object;Ljava/security/PrivilegedExceptionAction<Ljavax/xml/ws/EndpointReference;>;", "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });

classWriter.visitOuterClass("org/apache/cxf/jaxws/spi/ProviderImpl", "readEndpointReference", "(Ljavax/xml/transform/Source;)Ljavax/xml/ws/EndpointReference;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "run", "()Ljavax/xml/ws/EndpointReference;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxws/spi/ProviderImpl", "access$000", "()Ljavax/xml/bind/JAXBContext;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxws/spi/ProviderImpl$2", "javax/xml/bind/Unmarshaller", "javax/xml/ws/EndpointReference"}, 1, new Object[] {"javax/xml/stream/XMLStreamException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/jaxws/spi/ProviderImpl$2", "javax/xml/bind/Unmarshaller"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxws/spi/ProviderImpl$2", "javax/xml/bind/Unmarshaller", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"javax/xml/stream/XMLStreamException"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl$2", "run", "()Ljavax/xml/ws/EndpointReference;", false);
methodVisitor.visitInsn(ARETURN);
