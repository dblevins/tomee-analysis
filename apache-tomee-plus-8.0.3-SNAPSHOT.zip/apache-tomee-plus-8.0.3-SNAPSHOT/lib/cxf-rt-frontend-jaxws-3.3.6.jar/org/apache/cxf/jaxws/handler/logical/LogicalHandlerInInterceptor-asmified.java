...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/logical/LogicalHandlerInInterceptor", "binding", "Ljavax/xml/ws/Binding;");
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/handler/logical/LogicalMessageContextImpl", "getMessage", "()Ljavax/xml/ws/LogicalMessage;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/LogicalMessage", "getPayload", "()Ljavax/xml/transform/Source;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
