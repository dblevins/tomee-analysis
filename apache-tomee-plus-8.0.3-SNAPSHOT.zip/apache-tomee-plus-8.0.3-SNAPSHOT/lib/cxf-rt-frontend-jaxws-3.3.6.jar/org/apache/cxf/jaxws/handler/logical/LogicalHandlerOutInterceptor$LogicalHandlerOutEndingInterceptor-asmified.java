...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljavax/xml/ws/Binding;)V", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeLogicalHandlers", "(ZLjavax/xml/ws/handler/LogicalMessageContext;)Z", false);
