...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxws/DispatchImpl", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljakarta/xml/ws/Dispatch<TT;>;Ljakarta/xml/ws/BindingProvider;Ljava/io/Closeable;", "java/lang/Object", new String[] { "jakarta/xml/ws/Dispatch", "jakarta/xml/ws/BindingProvider", "java/io/Closeable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "binding", "Ljakarta/xml/ws/Binding;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "mode", "Ljakarta/xml/ws/Service$Mode;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/endpoint/Client;Ljakarta/xml/ws/Service$Mode;Ljakarta/xml/bind/JAXBContext;Ljava/lang/Class;)V", "(Lorg/apache/cxf/endpoint/Client;Ljakarta/xml/ws/Service$Mode;Ljakarta/xml/bind/JAXBContext;Ljava/lang/Class<TT;>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/DispatchImpl", "binding", "Ljakarta/xml/ws/Binding;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/DispatchImpl", "mode", "Ljakarta/xml/ws/Service$Mode;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/DispatchImpl", "context", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/DispatchImpl", "binding", "Ljakarta/xml/ws/Binding;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "org/apache/cxf/endpoint/Client", "jakarta/xml/ws/Service$Mode", "jakarta/xml/bind/JAXBContext", "java/lang/Class"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/xml/ws/Service$Mode", "MESSAGE", "Ljakarta/xml/ws/Service$Mode;");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/endpoint/Client;Ljakarta/xml/ws/Service$Mode;Ljava/lang/Class;)V", "(Lorg/apache/cxf/endpoint/Client;Ljakarta/xml/ws/Service$Mode;Ljava/lang/Class<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/DispatchImpl", "context", "Ljakarta/xml/bind/JAXBContext;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEndpointReference", "(Ljava/lang/Class;)Ljakarta/xml/ws/EndpointReference;", "<X:Ljakarta/xml/ws/EndpointReference;>(Ljava/lang/Class<TX;>;)TX;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/DispatchImpl", "builder", "Lorg/apache/cxf/jaxws/EndpointReferenceBuilder;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/DispatchImpl", "getBinding", "()Ljakarta/xml/ws/Binding;", false);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/xml/ws/soap/SOAPBinding");
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "jakarta/xml/soap/SOAPFault"}, 1, new Object[] {"jakarta/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "java/lang/Exception", "jakarta/xml/soap/SOAPFault"}, 1, new Object[] {"jakarta/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/DispatchImpl", "calculateOpName", "(Ljakarta/xml/ws/Holder;Ljavax/xml/namespace/QName;Z)Ljavax/xml/namespace/QName;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/DispatchImpl", "client", "Lorg/apache/cxf/endpoint/Client;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/ws/Holder", "value", "Ljava/lang/Object;");
methodVisitor.visitInsn(AASTORE);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/xml/ws/Holder", "[Ljava/lang/Object;"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateOpName", "(Ljakarta/xml/ws/Holder;Ljavax/xml/namespace/QName;Z)Ljavax/xml/namespace/QName;", "(Ljakarta/xml/ws/Holder<TT;>;Ljavax/xml/namespace/QName;Z)Ljavax/xml/namespace/QName;", new String[] { "javax/xml/stream/XMLStreamException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "jakarta/xml/ws/Holder", "javax/xml/namespace/QName", Opcodes.INTEGER, Opcodes.INTEGER, "javax/xml/transform/Source", "java/util/Map", "javax/xml/namespace/QName", "javax/xml/stream/XMLStreamReader"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitLabel(label4);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/staxutils/StaxUtils", "close", "(Ljavax/xml/stream/XMLStreamReader;)V", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/ws/Holder", "value", "Ljava/lang/Object;");
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/soap/SOAPMessage");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/DispatchImpl", "getPayloadElementName", "(Ljakarta/xml/soap/SOAPMessage;)Ljavax/xml/namespace/QName;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invokeAsync", "(Ljava/lang/Object;Ljakarta/xml/ws/AsyncHandler;)Ljava/util/concurrent/Future;", "(TT;Ljakarta/xml/ws/AsyncHandler<TT;>;)Ljava/util/concurrent/Future<*>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/DispatchImpl$1", "<init>", "(Lorg/apache/cxf/jaxws/DispatchImpl;Ljakarta/xml/ws/AsyncHandler;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "java/lang/Object", "jakarta/xml/ws/AsyncHandler", "org/apache/cxf/endpoint/ClientCallback", "jakarta/xml/ws/Response", Opcodes.TOP, "javax/xml/namespace/QName"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ISTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/DispatchImpl", "client", "Lorg/apache/cxf/endpoint/Client;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/DispatchImpl", "addInvokeOperation", "(Ljavax/xml/namespace/QName;Z)V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "java/lang/Object", "jakarta/xml/ws/AsyncHandler", "org/apache/cxf/endpoint/ClientCallback", "jakarta/xml/ws/Response", Opcodes.INTEGER, "javax/xml/namespace/QName"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "jakarta/xml/ws/Holder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/xml/ws/Holder", "<init>", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxws/DispatchImpl", "java/lang/Object", "jakarta/xml/ws/AsyncHandler", "org/apache/cxf/endpoint/ClientCallback", "jakarta/xml/ws/Response"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/DispatchImpl", "mapException", "(Ljava/lang/Exception;)Ljava/lang/RuntimeException;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invokeAsync", "(Ljava/lang/Object;)Ljakarta/xml/ws/Response;", "(TT;)Ljakarta/xml/ws/Response<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/DispatchImpl", "invokeAsync", "(Ljava/lang/Object;Ljakarta/xml/ws/AsyncHandler;)Ljava/util/concurrent/Future;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/ws/Response");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/DispatchImpl", "mode", "Ljakarta/xml/ws/Service$Mode;");
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/xml/ws/Service$Mode", "PAYLOAD", "Ljakarta/xml/ws/Service$Mode;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getPayloadElementName", "(Ljakarta/xml/soap/SOAPMessage;)Ljavax/xml/namespace/QName;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
