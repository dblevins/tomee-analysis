...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/wsdl/extensions/ExtensibilityElement", "org/w3c/dom/Element", "java/util/List"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/ws/EndpointReference", "readFrom", "(Ljavax/xml/transform/Source;)Ljavax/xml/ws/EndpointReference;", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/Binding", "getBindingID", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/ws/wsaddressing/W3CEndpointReferenceBuilder"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxws/EndpointReferenceBuilder", "java/util/List", "java/lang/String", "javax/xml/ws/wsaddressing/W3CEndpointReferenceBuilder", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
