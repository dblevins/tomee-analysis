...
public class CircuitBreakerInterceptor$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/safeguard/impl/circuitbreaker/CircuitBreakerInterceptor$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/safeguard/impl/circuitbreaker/CircuitBreakerInterceptor", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$safeguard$impl$circuitbreaker$CircuitBreakerInterceptor$CheckType", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/safeguard/impl/circuitbreaker/CircuitBreakerInterceptor$CheckType", "values", "()[Lorg/apache/safeguard/impl/circuitbreaker/CircuitBreakerInterceptor$CheckType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/safeguard/impl/circuitbreaker/CircuitBreakerInterceptor$1", "$SwitchMap$org$apache$safeguard$impl$circuitbreaker$CircuitBreakerInterceptor$CheckType", "[I");
