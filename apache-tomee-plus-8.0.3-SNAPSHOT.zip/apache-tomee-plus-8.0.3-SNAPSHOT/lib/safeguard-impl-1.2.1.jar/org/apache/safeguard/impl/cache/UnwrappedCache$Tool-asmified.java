...
public class UnwrappedCache$ToolDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/safeguard/impl/cache/UnwrappedCache$Tool", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "unwrap", "(Ljava/util/Map;Ljava/lang/Object;)Ljava/util/Optional;", "(Ljava/util/Map<Ljava/lang/Class<*>;Ljava/util/Optional<Ljava/lang/Class<*>;>;>;Ljava/lang/Object;)Ljava/util/Optional<Ljava/lang/Class<*>;>;", null);
methodVisitor.visitCode();
