...
public class SafeguardExtension$MockInvocationContextDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "NO_PARAM", "[Ljava/lang/Object;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/safeguard/impl/cdi/SafeguardExtension$MockInvocationContext", "method", "Ljava/lang/reflect/Method;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/safeguard/impl/cdi/SafeguardExtension$MockInvocationContext", "method", "Ljava/lang/reflect/Method;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/safeguard/impl/cdi/SafeguardExtension$MockInvocationContext", "NO_PARAM", "[Ljava/lang/Object;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "proceed", "()Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljava/lang/reflect/Method;Lorg/apache/safeguard/impl/cdi/SafeguardExtension$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/cdi/SafeguardExtension$MockInvocationContext", "<init>", "(Ljava/lang/reflect/Method;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/safeguard/impl/cdi/SafeguardExtension$MockInvocationContext", "NO_PARAM", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
