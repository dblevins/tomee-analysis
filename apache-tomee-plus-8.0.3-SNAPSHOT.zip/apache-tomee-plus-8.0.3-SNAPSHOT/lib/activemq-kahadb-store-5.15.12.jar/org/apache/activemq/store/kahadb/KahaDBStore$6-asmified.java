...
public class KahaDBStore$6Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/activemq/store/kahadb/KahaDBStore$6", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/activemq/store/kahadb/KahaDBStore", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$activemq$store$kahadb$data$KahaEntryType", "[I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$activemq$store$kahadb$data$KahaDestination$DestinationType", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/store/kahadb/data/KahaDestination$DestinationType", "values", "()[Lorg/apache/activemq/store/kahadb/data/KahaDestination$DestinationType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/store/kahadb/KahaDBStore$6", "$SwitchMap$org$apache$activemq$store$kahadb$data$KahaDestination$DestinationType", "[I");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/store/kahadb/data/KahaEntryType", "values", "()[Lorg/apache/activemq/store/kahadb/data/KahaEntryType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/store/kahadb/KahaDBStore$6", "$SwitchMap$org$apache$activemq$store$kahadb$data$KahaEntryType", "[I");
