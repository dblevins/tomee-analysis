...
public class Journal$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/kahadb/disk/journal/Journal$2", null, "java/lang/Object", new String[] { "java/util/concurrent/ThreadFactory" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/disk/journal/Journal$2", "this$0", "Lorg/apache/activemq/store/kahadb/disk/journal/Journal;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn("ActiveMQ Journal Scheduled executor");
