...
public class LegacyJobSchedulerImpl$ValueMarshallerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller", "Lorg/apache/activemq/store/kahadb/disk/util/VariableMarshaller<Ljava/util/List<Lorg/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation;>;>;", "org/apache/activemq/store/kahadb/disk/util/VariableMarshaller", null);
...
{
fieldVisitor = classWriter.visitField(ACC_STATIC, "INSTANCE", "Lorg/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller", "readPayload", "(Ljava/io/DataInput;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller", "writePayload", "(Ljava/util/List;Ljava/io/DataOutput;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller", "INSTANCE", "Lorg/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobSchedulerImpl$ValueMarshaller;");
methodVisitor.visitInsn(RETURN);
