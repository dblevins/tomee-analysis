...
public class ConnectionPool$PrivilegedNewTimerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomcat/jdbc/pool/ConnectionPool$PrivilegedNewTimer", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/util/Timer;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitLdcInsn("Tomcat JDBC Pool Cleaner[");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/ConnectionPool$PrivilegedNewTimer", "run", "()Ljava/util/Timer;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/tomcat/jdbc/pool/ConnectionPool$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/jdbc/pool/ConnectionPool$PrivilegedNewTimer", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
