...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", null, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReport", new String[] { "jakarta/management/NotificationEmitter", "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmxMBean" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_VOLATILE, "notifier", "Ljakarta/management/NotificationBroadcasterSupport;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", "notifier", "Ljakarta/management/NotificationBroadcasterSupport;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", "notifier", "Ljakarta/management/NotificationBroadcasterSupport;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", "notifier", "Ljakarta/management/NotificationBroadcasterSupport;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/management/NotificationBroadcasterSupport", "getNotificationInfo", "()[Ljakarta/management/MBeanNotificationInfo;", false);
...
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/management/RuntimeOperationsException");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/management/openmbean/CompositeDataSupport");
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
Label label3 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label3, "jakarta/management/RuntimeOperationsException");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", "poolName", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", "getObjectName", "(Ljava/lang/Class;Ljava/lang/String;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getObjectName", "(Ljava/lang/Class;Ljava/lang/String;)Ljakarta/management/ObjectName;", "(Ljava/lang/Class<*>;Ljava/lang/String;)Ljakarta/management/ObjectName;", new String[] { "jakarta/management/MalformedObjectNameException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/tomcat/jdbc/pool/interceptor/SlowQueryReportJmx", "java/lang/Class", "java/lang/String", "jakarta/management/ObjectName", "java/util/Map"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
