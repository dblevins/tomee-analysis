...
public class XSBase64BinaryUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/xml/schema/impl/XSBase64BinaryUnmarshaller", null, "org/opensaml/core/xml/io/AbstractXMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/core/xml/schema/XSBase64Binary", "setValue", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
