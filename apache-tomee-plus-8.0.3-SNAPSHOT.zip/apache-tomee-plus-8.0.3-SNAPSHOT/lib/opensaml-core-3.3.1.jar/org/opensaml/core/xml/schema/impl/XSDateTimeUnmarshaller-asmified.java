...
public class XSDateTimeUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/xml/schema/impl/XSDateTimeUnmarshaller", null, "org/opensaml/core/xml/io/BaseXMLObjectUnmarshaller", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/core/xml/io/BaseXMLObjectUnmarshaller", "<init>", "()V", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/core/xml/schema/XSDateTime", "setValue", "(Lorg/joda/time/DateTime;)V", true);
methodVisitor.visitInsn(RETURN);
