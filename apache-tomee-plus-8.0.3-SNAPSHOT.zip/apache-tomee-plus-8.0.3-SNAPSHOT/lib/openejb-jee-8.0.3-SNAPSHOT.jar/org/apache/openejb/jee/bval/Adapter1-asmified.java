...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/bval/Adapter1", "Ljavax/xml/bind/annotation/adapters/XmlAdapter<Ljava/lang/String;Ljavax/validation/executable/ExecutableType;>;", "javax/xml/bind/annotation/adapters/XmlAdapter", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/bval/Adapter1", "marshal", "(Ljavax/validation/executable/ExecutableType;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/bval/Adapter1", "unmarshal", "(Ljava/lang/String;)Ljavax/validation/executable/ExecutableType;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
