...
public class OrderingOthersDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/OrderingOthers", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "ordering-othersType");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/OrderingOthers", "id", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/OrderingOthers", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
