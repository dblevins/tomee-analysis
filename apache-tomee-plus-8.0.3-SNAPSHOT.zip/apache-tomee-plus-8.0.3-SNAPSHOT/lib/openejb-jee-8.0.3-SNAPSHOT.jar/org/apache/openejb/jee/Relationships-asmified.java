...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/Relationships", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "relationshipsType");
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "ejbRelation", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/openejb/jee/EjbRelation;>;", null);
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Relationships", "description", "Lorg/apache/openejb/jee/TextMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Relationships", "description", "Lorg/apache/openejb/jee/TextMap;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEjbRelation", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/openejb/jee/EjbRelation;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Relationships", "ejbRelation", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Relationships", "ejbRelation", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Relationships", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Relationships", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
