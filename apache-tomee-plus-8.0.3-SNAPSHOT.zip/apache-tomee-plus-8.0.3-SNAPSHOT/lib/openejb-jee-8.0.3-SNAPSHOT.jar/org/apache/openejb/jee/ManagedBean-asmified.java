...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/ManagedBean", null, "org/apache/openejb/jee/SessionBean", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/jee/SessionBean", "<init>", "(Ljava/lang/String;Ljava/lang/String;Lorg/apache/openejb/jee/SessionType;)V", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/ManagedBean", "hidden", "Z");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/jee/ManagedBean", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/ManagedBean", "hidden", "Z");
