...
public class EjbRelationshipRoleType$RelationshipRoleSourceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/oejb2/EjbRelationshipRoleType$RelationshipRoleSource", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/oejb2/EjbRelationshipRoleType$RelationshipRoleSource", "ejbName", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/oejb2/EjbRelationshipRoleType$RelationshipRoleSource", "ejbName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
