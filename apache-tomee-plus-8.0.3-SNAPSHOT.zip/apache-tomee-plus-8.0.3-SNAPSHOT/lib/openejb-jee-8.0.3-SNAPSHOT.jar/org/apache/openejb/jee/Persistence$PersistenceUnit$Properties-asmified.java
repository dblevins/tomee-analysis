...
public class Persistence$PersistenceUnit$PropertiesDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/Persistence$PersistenceUnit$Properties", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "property", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/openejb/jee/Persistence$PersistenceUnit$Properties$Property;>;", null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProperty", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/openejb/jee/Persistence$PersistenceUnit$Properties$Property;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/Persistence$PersistenceUnit$Properties", "property", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/Persistence$PersistenceUnit$Properties", "property", "Ljava/util/List;");
