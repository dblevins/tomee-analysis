...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/xml/bind/annotation/XmlType", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Ljakarta/xml/bind/annotation/XmlType$DEFAULT;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
