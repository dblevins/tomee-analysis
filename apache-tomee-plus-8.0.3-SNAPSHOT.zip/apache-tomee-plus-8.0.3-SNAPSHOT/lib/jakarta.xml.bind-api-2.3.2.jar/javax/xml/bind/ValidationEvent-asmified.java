...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/bind/ValidationEvent", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getLocator", "()Ljavax/xml/bind/ValidationEventLocator;", null, null);
methodVisitor.visitEnd();
}
