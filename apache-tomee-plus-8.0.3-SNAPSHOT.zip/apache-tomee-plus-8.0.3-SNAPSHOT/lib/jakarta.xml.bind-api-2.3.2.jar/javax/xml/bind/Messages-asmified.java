...
classWriter.visit(V1_8, ACC_SUPER, "javax/xml/bind/Messages", null, "java/lang/Object", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/bind/Messages", "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", false);
...
methodVisitor = classWriter.visitMethod(ACC_STATIC, "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Ljavax/xml/bind/Messages;"));
