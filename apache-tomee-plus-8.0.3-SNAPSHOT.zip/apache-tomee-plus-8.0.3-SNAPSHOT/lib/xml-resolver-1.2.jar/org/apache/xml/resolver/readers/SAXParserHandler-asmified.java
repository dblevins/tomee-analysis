...
public class SAXParserHandlerDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/resolver/readers/SAXParserHandler", null, "org/xml/sax/helpers/DefaultHandler", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "er", "Lorg/xml/sax/EntityResolver;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "ch", "Lorg/xml/sax/ContentHandler;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/resolver/readers/SAXParserHandler", "er", "Lorg/xml/sax/EntityResolver;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/resolver/readers/SAXParserHandler", "ch", "Lorg/xml/sax/ContentHandler;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/resolver/readers/SAXParserHandler", "er", "Lorg/xml/sax/EntityResolver;");
...
methodVisitor.visitLdcInsn("resolveEntity threw IOException!");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/resolver/readers/SAXParserHandler", "ch", "Lorg/xml/sax/ContentHandler;");
Label label0 = new Label();
