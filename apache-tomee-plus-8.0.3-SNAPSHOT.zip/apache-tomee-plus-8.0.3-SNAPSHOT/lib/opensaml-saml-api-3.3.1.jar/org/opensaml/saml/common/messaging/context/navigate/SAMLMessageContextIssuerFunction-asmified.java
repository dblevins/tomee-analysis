...
public class SAMLMessageContextIssuerFunctionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/messaging/context/navigate/SAMLMessageContextIssuerFunction", "Ljava/lang/Object;Lcom/google/common/base/Function<Lorg/opensaml/messaging/context/MessageContext;Ljava/lang/String;>;", "java/lang/Object", new String[] { "com/google/common/base/Function" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "apply", "(Lorg/opensaml/messaging/context/MessageContext;)Ljava/lang/String;", null, null);
{
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/messaging/context/navigate/SAMLMessageContextIssuerFunction", "apply", "(Lorg/opensaml/messaging/context/MessageContext;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
