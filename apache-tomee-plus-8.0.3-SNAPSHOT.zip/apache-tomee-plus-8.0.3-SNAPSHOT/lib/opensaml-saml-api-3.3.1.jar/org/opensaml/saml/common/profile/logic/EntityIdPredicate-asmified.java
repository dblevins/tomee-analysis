...
public class EntityIdPredicateDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/profile/logic/EntityIdPredicate", "Ljava/lang/Object;Lcom/google/common/base/Predicate<Lorg/opensaml/saml/saml2/metadata/EntityDescriptor;>;", "java/lang/Object", new String[] { "com/google/common/base/Predicate" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "entityIds", "Ljava/util/Set;", "Ljava/util/Set<Ljava/lang/String;>;", null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/common/profile/logic/EntityIdPredicate;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/profile/logic/EntityIdPredicate", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("EntityID collection cannot be null");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/profile/logic/EntityIdPredicate", "entityIds", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Collection", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/opensaml/saml/common/profile/logic/EntityIdPredicate", "java/util/Collection", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/logic/EntityIdPredicate", "entityIds", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEntityIds", "()Ljava/util/Set;", "()Ljava/util/Set<Ljava/lang/String;>;", null);
{
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/profile/logic/EntityIdPredicate", "apply", "(Lorg/opensaml/saml/saml2/metadata/EntityDescriptor;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
