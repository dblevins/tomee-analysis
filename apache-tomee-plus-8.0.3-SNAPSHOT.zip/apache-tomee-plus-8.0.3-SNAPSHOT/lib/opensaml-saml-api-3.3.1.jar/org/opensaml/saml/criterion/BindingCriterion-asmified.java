...
public class BindingCriterionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/opensaml/saml/criterion/BindingCriterion", null, "java/lang/Object", new String[] { "net/shibboleth/utilities/java/support/resolver/Criterion" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "bindings", "Ljava/util/List;", "Ljava/util/List<Ljava/lang/String;>;", null);
{
...
methodVisitor.visitLdcInsn("Binding list cannot be null");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/criterion/BindingCriterion", "bindings", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/opensaml/saml/criterion/BindingCriterion", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/criterion/BindingCriterion", "bindings", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBindings", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/String;>;", null);
{
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("BindingCriterion [bindings=");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/saml/criterion/BindingCriterion");
Label label2 = new Label();
