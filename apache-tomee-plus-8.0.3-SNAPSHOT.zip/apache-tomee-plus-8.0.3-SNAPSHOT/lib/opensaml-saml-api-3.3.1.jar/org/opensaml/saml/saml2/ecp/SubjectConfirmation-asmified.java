...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/opensaml/saml/saml2/ecp/SubjectConfirmation", null, "java/lang/Object", new String[] { "org/opensaml/saml/common/SAMLObject", "org/opensaml/soap/soap11/MustUnderstandBearing", "org/opensaml/soap/soap11/ActorBearing" });
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/saml2/ecp/SubjectConfirmation", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
methodVisitor.visitTypeInsn(NEW, "javax/xml/namespace/QName");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("urn:oasis:names:tc:SAML:2.0:profiles:SSO:ecp");
...
methodVisitor.visitLdcInsn("ecp");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/namespace/QName", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/saml2/ecp/SubjectConfirmation", "TYPE_NAME", "Ljavax/xml/namespace/QName;");
