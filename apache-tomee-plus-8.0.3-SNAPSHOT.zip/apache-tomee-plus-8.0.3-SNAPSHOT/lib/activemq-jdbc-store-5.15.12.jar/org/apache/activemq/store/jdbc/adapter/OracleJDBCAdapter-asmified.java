...
public class OracleJDBCAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/store/jdbc/adapter/OracleJDBCAdapter", null, "org/apache/activemq/store/jdbc/adapter/DefaultJDBCAdapter", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/jdbc/adapter/OracleJDBCAdapter", "getMaxRows", "()I", false);
