...
public class JDBCPersistenceAdapter$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/jdbc/JDBCPersistenceAdapter$2", null, "java/lang/Object", new String[] { "org/apache/activemq/store/jdbc/JDBCMessageIdScanListener" });

classWriter.visitOuterClass("org/apache/activemq/store/jdbc/JDBCPersistenceAdapter", "initSequenceIdGenerator", "()V");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/jdbc/JDBCPersistenceAdapter$2", "this$0", "Lorg/apache/activemq/store/jdbc/JDBCPersistenceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/jdbc/JDBCPersistenceAdapter$2", "this$0", "Lorg/apache/activemq/store/jdbc/JDBCPersistenceAdapter;");
