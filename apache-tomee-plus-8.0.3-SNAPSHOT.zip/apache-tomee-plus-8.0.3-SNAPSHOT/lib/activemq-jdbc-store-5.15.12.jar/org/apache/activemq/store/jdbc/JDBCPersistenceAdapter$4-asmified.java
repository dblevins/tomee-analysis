...
public class JDBCPersistenceAdapter$4Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/jdbc/JDBCPersistenceAdapter$4", null, "java/lang/Object", new String[] { "java/util/concurrent/ThreadFactory" });

classWriter.visitOuterClass("org/apache/activemq/store/jdbc/JDBCPersistenceAdapter", "getScheduledThreadPoolExecutor", "()Ljava/util/concurrent/ScheduledThreadPoolExecutor;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/jdbc/JDBCPersistenceAdapter$4", "this$0", "Lorg/apache/activemq/store/jdbc/JDBCPersistenceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("ActiveMQ JDBC PA Scheduled Task");
