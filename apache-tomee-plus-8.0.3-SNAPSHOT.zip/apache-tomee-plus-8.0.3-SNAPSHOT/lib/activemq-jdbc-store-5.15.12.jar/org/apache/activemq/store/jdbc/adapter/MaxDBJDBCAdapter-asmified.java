...
public class MaxDBJDBCAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/store/jdbc/adapter/MaxDBJDBCAdapter", null, "org/apache/activemq/store/jdbc/adapter/DefaultJDBCAdapter", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("VARCHAR(250) ASCII");
