...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "definition", "Ljavax/wsdl/Definition;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/cxf/Bus;Ljavax/wsdl/Definition;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "definition", "Ljavax/wsdl/Definition;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/cxf/Bus;Ljavax/wsdl/Definition;Ljavax/xml/namespace/QName;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceFactory", "org/apache/cxf/Bus", "java/lang/String"}, 1, new Object[] {"javax/wsdl/WSDLException"});
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceFactory", "org/apache/cxf/Bus", "java/lang/String", "javax/xml/namespace/QName"}, 1, new Object[] {"javax/wsdl/WSDLException"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "definition", "Ljavax/wsdl/Definition;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "definition", "Ljavax/wsdl/Definition;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildServices", "(Ljavax/wsdl/Definition;)Ljava/util/List;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "serviceName", "Ljavax/xml/namespace/QName;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/wsdl11/PartialWSDLProcessor", "isServiceExisted", "(Ljavax/wsdl/Definition;Ljavax/xml/namespace/QName;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "serviceName", "Ljavax/xml/namespace/QName;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/wsdl11/PartialWSDLProcessor", "isBindingExisted", "(Ljavax/wsdl/Definition;Ljavax/xml/namespace/QName;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label15);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "definition", "Ljavax/wsdl/Definition;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "serviceName", "Ljavax/xml/namespace/QName;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/wsdl11/PartialWSDLProcessor", "isPortTypeExisted", "(Ljavax/wsdl/Definition;Ljavax/xml/namespace/QName;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceFactory", Opcodes.TOP, "javax/wsdl/Service", "java/util/Map", "java/lang/String", "javax/wsdl/PortType", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/wsdl11/PartialWSDLProcessor", "doAppendBinding", "(Ljavax/wsdl/Definition;Ljava/lang/String;Ljavax/wsdl/PortType;Ljavax/wsdl/extensions/ExtensionRegistry;)Ljavax/wsdl/Binding;", false);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/wsdl11/PartialWSDLProcessor", "doAppendService", "(Ljavax/wsdl/Definition;Ljava/lang/String;Ljavax/wsdl/extensions/ExtensionRegistry;Ljavax/wsdl/Binding;)Ljavax/wsdl/Service;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceFactory", "definition", "Ljavax/wsdl/Definition;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceFactory", Opcodes.TOP, "javax/wsdl/Service"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/service/factory/ServiceConstructionException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/i18n/Message");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildServices", "(Ljavax/wsdl/Definition;Ljavax/wsdl/Service;Ljavax/xml/namespace/QName;)Ljava/util/List;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "isEmpty", "()Z", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceFactory", "java/util/List", "javax/wsdl/Service"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label14);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceFactory", Opcodes.TOP, "javax/wsdl/Service"}, 1, new Object[] {"org/apache/ws/commons/schema/XmlSchemaException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/service/factory/ServiceConstructionException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/i18n/Message");
