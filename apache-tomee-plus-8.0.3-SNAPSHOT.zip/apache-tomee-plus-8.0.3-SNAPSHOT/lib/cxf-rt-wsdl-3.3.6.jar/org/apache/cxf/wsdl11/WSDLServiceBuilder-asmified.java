...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/wsdl/extensions/ExtensibilityElement", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "copyExtensionAttributes", "(Lorg/apache/cxf/service/model/AbstractPropertiesHolder;Ljakarta/wsdl/extensions/AttributeExtensible;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "copyDocumentation", "(Lorg/apache/cxf/service/model/AbstractPropertiesHolder;Ljakarta/wsdl/WSDLElement;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/WSDLElement", "getDocumentationElement", "()Lorg/w3c/dom/Element;", true);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/WSDLElement", "getDocumentationElement", "()Lorg/w3c/dom/Element;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildServices", "(Ljakarta/wsdl/Definition;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "copyExtensionAttributes", "(Lorg/apache/cxf/service/model/AbstractPropertiesHolder;Ljakarta/wsdl/extensions/AttributeExtensible;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildServices", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;Lorg/apache/cxf/service/model/DescriptionInfo;)Ljava/util/List;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildServices", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildServices", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "buildServices", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;Lorg/apache/cxf/service/model/DescriptionInfo;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;Lorg/apache/cxf/service/model/DescriptionInfo;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/wsdl/Service"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildServices", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;Ljavax/xml/namespace/QName;Lorg/apache/cxf/service/model/DescriptionInfo;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(8, 7);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildServices", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildServices", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;Ljavax/xml/namespace/QName;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;Ljavax/xml/namespace/QName;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildMockServices", "(Ljakarta/wsdl/Definition;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "parseImports", "(Ljakarta/wsdl/Definition;Ljava/util/List;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
Label label0 = new Label();
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/wsdl/Definition", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label3 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildMockService", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/PortType;)Lorg/apache/cxf/service/model/ServiceInfo;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceBuilder", "jakarta/wsdl/Definition", "java/util/List", "java/util/List", "java/util/Iterator", "jakarta/wsdl/Definition", "java/util/Iterator", "java/util/Map$Entry", "jakarta/wsdl/PortType", "org/apache/cxf/service/model/ServiceInfo", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildBinding", "(Lorg/apache/cxf/service/model/ServiceInfo;Ljakarta/wsdl/Binding;)Lorg/apache/cxf/service/model/BindingInfo;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceBuilder", "jakarta/wsdl/Definition", "java/util/List", "java/util/List", "java/util/Iterator", "jakarta/wsdl/Definition", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "getSchemas", "(Ljakarta/wsdl/Definition;Lorg/apache/cxf/service/model/ServiceInfo;)V", false);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildMockService", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/PortType;)Lorg/apache/cxf/service/model/ServiceInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/service/model/DescriptionInfo");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/service/model/DescriptionInfo", "<init>", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildInterface", "(Lorg/apache/cxf/service/model/ServiceInfo;Ljakarta/wsdl/PortType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "buildServices", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;Ljavax/xml/namespace/QName;Lorg/apache/cxf/service/model/DescriptionInfo;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;Ljakarta/wsdl/Service;Ljavax/xml/namespace/QName;Lorg/apache/cxf/service/model/DescriptionInfo;)Ljava/util/List<Lorg/apache/cxf/service/model/ServiceInfo;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/wsdl/Port"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/wsdl/Binding", "jakarta/wsdl/PortType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/wsdl/PortType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/PortType", "getQName", "()Ljavax/xml/namespace/QName;", true);
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "copyDocumentation", "(Lorg/apache/cxf/service/model/AbstractPropertiesHolder;Ljakarta/wsdl/WSDLElement;)V", false);
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "WSDL_SCHEMA_ELEMENT_LIST", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "schemaList", "Ljava/util/Map;");
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildEndpoint", "(Lorg/apache/cxf/service/model/ServiceInfo;Lorg/apache/cxf/service/model/BindingInfo;Ljakarta/wsdl/Port;)Lorg/apache/cxf/service/model/EndpointInfo;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceBuilder", "jakarta/wsdl/Definition", "jakarta/wsdl/Service", "javax/xml/namespace/QName", "org/apache/cxf/service/model/DescriptionInfo", "java/util/Map", "org/apache/cxf/service/model/DescriptionInfo"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "values", "()Ljava/util/Collection;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getSchemas", "(Ljakarta/wsdl/Definition;Lorg/apache/cxf/service/model/ServiceInfo;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/wsdl/WSDLManager", "getSchemasForDefinition", "(Ljakarta/wsdl/Definition;)Lorg/apache/cxf/service/model/ServiceSchemaInfo;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/SchemaUtil", "getSchemas", "(Ljakarta/wsdl/Definition;Lorg/apache/cxf/service/model/ServiceInfo;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/wsdl/WSDLManager", "putSchemasForDefinition", "(Ljakarta/wsdl/Definition;Lorg/apache/cxf/service/model/ServiceSchemaInfo;)V", true);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseImports", "(Ljakarta/wsdl/Definition;Ljava/util/List;)V", "(Ljakarta/wsdl/Definition;Ljava/util/List<Ljakarta/wsdl/Definition;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildEndpoint", "(Lorg/apache/cxf/service/model/ServiceInfo;Lorg/apache/cxf/service/model/BindingInfo;Ljakarta/wsdl/Port;)Lorg/apache/cxf/service/model/EndpointInfo;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceBuilder", "org/apache/cxf/service/model/ServiceInfo", "org/apache/cxf/service/model/BindingInfo", "jakarta/wsdl/Port", "java/util/List", "java/lang/String", "org/apache/cxf/transport/DestinationFactory", "org/apache/cxf/service/model/EndpointInfo", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label8 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label8);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceBuilder", "org/apache/cxf/service/model/ServiceInfo", "org/apache/cxf/service/model/BindingInfo", "jakarta/wsdl/Port", "java/util/List", "java/lang/String", "org/apache/cxf/transport/DestinationFactory", "org/apache/cxf/service/model/EndpointInfo", "java/util/Iterator", "jakarta/wsdl/extensions/ExtensibilityElement"}, 1, new Object[] {"org/apache/cxf/BusException"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildBinding", "(Lorg/apache/cxf/service/model/ServiceInfo;Ljakarta/wsdl/Binding;)Lorg/apache/cxf/service/model/BindingInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "bus", "Lorg/apache/cxf/Bus;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/wsdl11/WSDLServiceUtils", "getBindingFactory", "(Ljakarta/wsdl/Binding;Lorg/apache/cxf/Bus;Ljava/lang/StringBuilder;)Lorg/apache/cxf/binding/BindingFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/wsdl/binding/WSDLBindingFactory", "createBindingInfo", "(Lorg/apache/cxf/service/model/ServiceInfo;Ljakarta/wsdl/Binding;Ljava/lang/String;)Lorg/apache/cxf/service/model/BindingInfo;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/wsdl/BindingOperation"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 10);
...
methodVisitor.visitJumpInsn(GOTO, label13);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/wsdl11/WSDLServiceBuilder", "org/apache/cxf/service/model/ServiceInfo", "jakarta/wsdl/Binding", "org/apache/cxf/service/model/BindingInfo", "java/lang/StringBuilder", "org/apache/cxf/binding/BindingFactory", Opcodes.INTEGER, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,2, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildInterface", "(Lorg/apache/cxf/service/model/ServiceInfo;Ljakarta/wsdl/PortType;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/PortType", "getQName", "()Ljavax/xml/namespace/QName;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildInterfaceOperation", "(Lorg/apache/cxf/service/model/InterfaceInfo;Ljakarta/wsdl/Operation;)V", false);
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "buildInterfaceOperation", "(Lorg/apache/cxf/service/model/InterfaceInfo;Ljakarta/wsdl/Operation;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(NEW, "javax/xml/namespace/QName");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/List", "jakarta/wsdl/Input"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/Input", "getMessage", "()Ljakarta/wsdl/Message;", true);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/Input", "getMessage", "()Ljakarta/wsdl/Message;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "buildMessage", "(Lorg/apache/cxf/service/model/AbstractMessageContainer;Ljakarta/wsdl/Message;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/wsdl/Output"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/Output", "getMessage", "()Ljakarta/wsdl/Message;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/Message", "getQName", "()Ljavax/xml/namespace/QName;", true);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map$Entry", "getValue", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/wsdl/WSDLElement");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "copyDocumentation", "(Lorg/apache/cxf/service/model/AbstractPropertiesHolder;Ljakarta/wsdl/WSDLElement;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map$Entry", "getValue", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/wsdl/extensions/AttributeExtensible");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLServiceBuilder", "copyExtensionAttributes", "(Lorg/apache/cxf/service/model/AbstractPropertiesHolder;Ljakarta/wsdl/extensions/AttributeExtensible;)V", false);
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "buildMessage", "(Lorg/apache/cxf/service/model/AbstractMessageContainer;Ljakarta/wsdl/Message;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/wsdl/Part", "org/apache/cxf/service/model/MessagePartInfo"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
