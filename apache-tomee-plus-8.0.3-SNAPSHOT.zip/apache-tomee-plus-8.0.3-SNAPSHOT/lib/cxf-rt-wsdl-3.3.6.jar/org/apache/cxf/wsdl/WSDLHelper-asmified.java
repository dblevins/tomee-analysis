...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBindingOperation", "(Ljakarta/wsdl/Definition;Ljava/lang/String;)Ljakarta/wsdl/BindingOperation;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "writeQName", "(Ljakarta/wsdl/Definition;Ljavax/xml/namespace/QName;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBindingOperation", "(Ljakarta/wsdl/Binding;Ljava/lang/String;)Ljakarta/wsdl/BindingOperation;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPortTypes", "(Ljakarta/wsdl/Definition;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;)Ljava/util/List<Ljakarta/wsdl/PortType;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInMessageParts", "(Ljakarta/wsdl/Operation;)Ljava/util/List;", "(Ljakarta/wsdl/Operation;)Ljava/util/List<Ljakarta/wsdl/Part;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/wsdl/WSDLHelper", "jakarta/wsdl/Operation", "jakarta/wsdl/Input", "java/util/List", "java/util/Collection", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOutMessageParts", "(Ljakarta/wsdl/Operation;)Ljava/util/List;", "(Ljakarta/wsdl/Operation;)Ljava/util/List<Ljakarta/wsdl/Part;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/wsdl/WSDLHelper", "jakarta/wsdl/Operation", "jakarta/wsdl/Output", "java/util/List", "java/util/Collection", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBinding", "(Ljakarta/wsdl/BindingOperation;Ljakarta/wsdl/Definition;)Ljakarta/wsdl/Binding;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/Definition", "getBindings", "()Ljava/util/Map;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "values", "()Ljava/util/Collection;", true);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/wsdl/Binding", "java/util/List", "java/util/Iterator"}, 0, null);
