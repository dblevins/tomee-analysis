...
public class DocLiteralInInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", null, "org/apache/cxf/interceptor/AbstractInDatabindingInterceptor", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "KEEP_PARAMETERS_WRAPPER", "Ljava/lang/String;", null, null);
...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "org/apache/cxf/interceptor/Fault");
Label label5 = new Label();
Label label6 = new Label();
methodVisitor.visitTryCatchBlock(label5, label6, label2, "org/apache/cxf/interceptor/Fault");
Label label7 = new Label();
Label label8 = new Label();
methodVisitor.visitTryCatchBlock(label7, label8, label2, "org/apache/cxf/interceptor/Fault");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "isGET", "(Lorg/apache/cxf/message/Message;)Z", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitLdcInsn("DocLiteralInInterceptor skipped in HTTP GET method");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getXMLStreamReader", "(Lorg/apache/cxf/message/Message;)Lorg/apache/cxf/staxutils/DepthXMLStreamReader;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "isRequestor", "(Lorg/apache/cxf/message/Message;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/staxutils/DepthXMLStreamReader", "org/apache/cxf/message/MessageContentsList", "org/apache/cxf/message/Exchange", "org/apache/cxf/service/model/BindingOperationInfo", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/message/Message", "getExchange", "()Lorg/apache/cxf/message/Exchange;", true);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getBindingOperationInfo", "(Lorg/apache/cxf/staxutils/DepthXMLStreamReader;Lorg/apache/cxf/message/Exchange;Lorg/apache/cxf/service/model/BindingOperationInfo;Z)Lorg/apache/cxf/service/model/BindingOperationInfo;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/cxf/service/Service", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getDataReader", "(Lorg/apache/cxf/message/Message;)Lorg/apache/cxf/databinding/DataReader;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "setMessage", "(Lorg/apache/cxf/message/Message;Lorg/apache/cxf/service/model/BindingOperationInfo;ZLorg/apache/cxf/service/model/ServiceInfo;)Lorg/apache/cxf/service/model/MessageInfo;", false);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "setDataReaderValidation", "(Lorg/apache/cxf/service/Service;Lorg/apache/cxf/message/Message;Lorg/apache/cxf/databinding/DataReader;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "shouldWrapParameters", "(Lorg/apache/cxf/service/model/MessageInfo;Lorg/apache/cxf/message/Message;)Z", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("UNEXPECTED_WRAPPER_ELEMENT");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "LOG", "Ljava/util/logging/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/staxutils/DepthXMLStreamReader", "org/apache/cxf/message/MessageContentsList", "org/apache/cxf/message/Exchange", "org/apache/cxf/service/model/BindingOperationInfo", Opcodes.INTEGER, "org/apache/cxf/service/Service", Opcodes.INTEGER, "org/apache/cxf/databinding/DataReader", "org/apache/cxf/service/model/ServiceInfo", "org/apache/cxf/service/model/MessageInfo", "javax/xml/namespace/QName", "org/apache/cxf/service/model/MessagePartInfo"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getPara", "(Lorg/apache/cxf/staxutils/DepthXMLStreamReader;Lorg/apache/cxf/databinding/DataReader;Lorg/apache/cxf/message/MessageContentsList;Ljava/util/Iterator;Lorg/apache/cxf/message/Message;)V", false);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/staxutils/DepthXMLStreamReader", "org/apache/cxf/message/MessageContentsList", "org/apache/cxf/message/Exchange", "org/apache/cxf/service/model/BindingOperationInfo", Opcodes.INTEGER, "org/apache/cxf/service/Service", Opcodes.INTEGER, "org/apache/cxf/databinding/DataReader"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/cxf/service/model/BindingMessageInfo", "org/apache/cxf/endpoint/Endpoint", "org/apache/cxf/service/model/ServiceInfo"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "setMessage", "(Lorg/apache/cxf/message/Message;Lorg/apache/cxf/service/model/BindingOperationInfo;ZLorg/apache/cxf/service/model/ServiceInfo;Lorg/apache/cxf/service/model/MessageInfo;)Lorg/apache/cxf/service/model/MessageInfo;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getBindingOperationForEmptyBody", "(Ljava/util/Collection;Lorg/apache/cxf/endpoint/Endpoint;Lorg/apache/cxf/message/Exchange;)V", false);
...
methodVisitor.visitVarInsn(ILOAD, 14);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "findMessagePart", "(Lorg/apache/cxf/message/Exchange;Ljava/util/Collection;Ljavax/xml/namespace/QName;ZILorg/apache/cxf/message/Message;)Lorg/apache/cxf/service/model/MessagePartInfo;", false);
methodVisitor.visitVarInsn(ASTORE, 17);
...
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "validatePart", "(Lorg/apache/cxf/service/model/MessagePartInfo;Ljavax/xml/namespace/QName;Lorg/apache/cxf/message/Message;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getBindingOperationForEmptyBody", "(Ljava/util/Collection;Lorg/apache/cxf/endpoint/Endpoint;Lorg/apache/cxf/message/Exchange;)V", "(Ljava/util/Collection<Lorg/apache/cxf/service/model/OperationInfo;>;Lorg/apache/cxf/endpoint/Endpoint;Lorg/apache/cxf/message/Exchange;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/cxf/service/model/OperationInfo", "org/apache/cxf/service/model/MessageInfo", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/endpoint/Endpoint", "getEndpointInfo", "()Lorg/apache/cxf/service/model/EndpointInfo;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getBindingOperationInfo", "(Lorg/apache/cxf/staxutils/DepthXMLStreamReader;Lorg/apache/cxf/message/Exchange;Lorg/apache/cxf/service/model/BindingOperationInfo;Z)Lorg/apache/cxf/service/model/BindingOperationInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getBindingOperationInfo", "(Lorg/apache/cxf/message/Exchange;Ljavax/xml/namespace/QName;Z)Lorg/apache/cxf/service/model/BindingOperationInfo;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validatePart", "(Lorg/apache/cxf/service/model/MessagePartInfo;Ljavax/xml/namespace/QName;Lorg/apache/cxf/message/Message;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getPara", "(Lorg/apache/cxf/staxutils/DepthXMLStreamReader;Lorg/apache/cxf/databinding/DataReader;Lorg/apache/cxf/message/MessageContentsList;Ljava/util/Iterator;Lorg/apache/cxf/message/Message;)V", "(Lorg/apache/cxf/staxutils/DepthXMLStreamReader;Lorg/apache/cxf/databinding/DataReader<Ljavax/xml/stream/XMLStreamReader;>;Lorg/apache/cxf/message/MessageContentsList;Ljava/util/Iterator<Lorg/apache/cxf/service/model/MessagePartInfo;>;Lorg/apache/cxf/message/Message;)V", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ISTORE, 6);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "setMessage", "(Lorg/apache/cxf/message/Message;Lorg/apache/cxf/service/model/BindingOperationInfo;ZLorg/apache/cxf/service/model/ServiceInfo;)Lorg/apache/cxf/service/model/MessageInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "getMessageInfo", "(Lorg/apache/cxf/message/Message;Lorg/apache/cxf/service/model/BindingOperationInfo;Z)Lorg/apache/cxf/service/model/MessageInfo;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/interceptor/AbstractInDatabindingInterceptor", "getBindingOperationInfo", "(Lorg/apache/cxf/message/Exchange;Ljavax/xml/namespace/QName;Z)Lorg/apache/cxf/service/model/BindingOperationInfo;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "shouldWrapParameters", "(Lorg/apache/cxf/service/model/MessageInfo;Lorg/apache/cxf/message/Message;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "KEEP_PARAMETERS_WRAPPER", "Ljava/lang/String;");
...
methodVisitor.visitLdcInsn(".DocLiteralInInterceptor.keep-parameters-wrapper");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "KEEP_PARAMETERS_WRAPPER", "Ljava/lang/String;");
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/LogUtils", "getL7dLogger", "(Ljava/lang/Class;)Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/wsdl/interceptors/DocLiteralInInterceptor", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
