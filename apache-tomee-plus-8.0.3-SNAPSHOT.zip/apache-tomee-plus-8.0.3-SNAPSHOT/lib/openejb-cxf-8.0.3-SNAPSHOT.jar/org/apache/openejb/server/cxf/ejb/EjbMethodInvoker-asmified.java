...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/ejb/EjbMethodInvoker", "updateWebServiceContext", "(Lorg/apache/cxf/message/Exchange;Ljavax/xml/ws/handler/MessageContext;)V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/ejb/EjbMessageContext", "<init>", "(Lorg/apache/cxf/message/Message;Ljavax/xml/ws/handler/MessageContext$Scope;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
