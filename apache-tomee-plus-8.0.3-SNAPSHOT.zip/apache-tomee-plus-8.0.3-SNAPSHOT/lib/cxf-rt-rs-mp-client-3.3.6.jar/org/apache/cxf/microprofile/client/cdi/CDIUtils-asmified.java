...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getCurrentBeanManager", "(Lorg/apache/cxf/Bus;)Ljakarta/enterprise/inject/spi/BeanManager;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getCurrentBeanManager", "()Ljakarta/enterprise/inject/spi/BeanManager;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/Class", "org/apache/cxf/Bus", "jakarta/enterprise/inject/spi/BeanManager", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/context/spi/CreationalContext"}, 3, new Object[] {label2, label2, "java/lang/Object"});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("run", "(Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/lang/Runnable;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()V"), new Handle(Opcodes.H_INVOKEINTERFACE, "jakarta/enterprise/context/spi/CreationalContext", "release", "()V", true), Type.getType("()V")});
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/Class", "org/apache/cxf/Bus", "jakarta/enterprise/inject/spi/BeanManager", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/context/spi/CreationalContext"}, 4, new Object[] {label2, label2, "java/lang/Object", "java/lang/Runnable"});
