...
public class EncryptedPartsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/policy/model/EncryptedParts", null, "org/apache/wss4j/policy/model/AbstractSecuredParts", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/EncryptedParts", "getVersion", "()Lorg/apache/wss4j/policy/SPConstants$SPVersion;", false);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/wss4j/policy/model/EncryptedParts", "org/apache/neethi/Policy"}, 4, new Object[] {label0, label0, "org/apache/wss4j/policy/SPConstants$SPVersion", Opcodes.INTEGER});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/EncryptedParts", "getAttachments", "()Lorg/apache/wss4j/policy/model/Attachments;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/wss4j/policy/model/EncryptedParts", "org/apache/neethi/Policy"}, 5, new Object[] {label0, label0, "org/apache/wss4j/policy/SPConstants$SPVersion", Opcodes.INTEGER, "org/apache/wss4j/policy/model/Attachments"});
methodVisitor.visitVarInsn(ALOAD, 0);
