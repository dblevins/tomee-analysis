...
public class BootstrapPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/policy/model/BootstrapPolicy", null, "org/apache/wss4j/policy/model/AbstractSecurityAssertion", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "nestedPolicy", "Lorg/apache/neethi/Policy;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/policy/model/BootstrapPolicy", "nestedPolicy", "Lorg/apache/neethi/Policy;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/policy/model/AbstractSecurityAssertion", "getVersion", "()Lorg/apache/wss4j/policy/SPConstants$SPVersion;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/policy/model/BootstrapPolicy", "nestedPolicy", "Lorg/apache/neethi/Policy;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
