...
public class PasswordStringDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/secext/PasswordString", null, "org/apache/cxf/ws/security/sts/provider/model/secext/AttributedString", null);
...
annotationVisitor0.visit("name", "PasswordString");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/PasswordString", "type", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/PasswordString", "type", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
