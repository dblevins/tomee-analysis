...
public class KeyValueTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/xmldsig/KeyValueType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "KeyValueType");
{
...
annotationVisitor2.visit("name", "DSAKeyValue");
...
{
AnnotationVisitor annotationVisitor2 = annotationVisitor1.visitAnnotation(null, "Ljakarta/xml/bind/annotation/XmlElementRef;");
annotationVisitor2.visit("name", "RSAKeyValue");
annotationVisitor2.visit("namespace", "http://www.w3.org/2000/09/xmldsig#");
annotationVisitor2.visit("type", Type.getType("Ljakarta/xml/bind/JAXBElement;"));
annotationVisitor2.visit("required", Boolean.FALSE);
annotationVisitor2.visitEnd();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/xmldsig/KeyValueType", "content", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/xmldsig/KeyValueType", "content", "Ljava/util/List;");
