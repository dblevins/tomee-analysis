...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/ws/security/wss4j/PolicyBasedWSS4JOutInterceptor$PolicyBasedWSS4JOutInterceptorInternal", "org/apache/cxf/binding/soap/SoapMessage", "org/apache/cxf/ws/policy/AssertionInfoMap", "jakarta/xml/soap/SOAPMessage", Opcodes.INTEGER, "java/lang/String", "org/apache/wss4j/policy/model/AbstractBinding"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/ws/security/wss4j/PolicyBasedWSS4JOutInterceptor$PolicyBasedWSS4JOutInterceptorInternal", "org/apache/cxf/binding/soap/SoapMessage", "org/apache/cxf/ws/policy/AssertionInfoMap", "jakarta/xml/soap/SOAPMessage", Opcodes.INTEGER, "java/lang/String", "org/apache/wss4j/policy/model/AbstractBinding", "org/apache/wss4j/dom/message/WSSecHeader", "org/w3c/dom/Element"}, 1, new Object[] {"org/apache/wss4j/common/ext/WSSecurityException"});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/soap/SOAPHeader", "removeChild", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/binding/soap/saaj/SAAJUtils", "getHeader", "(Ljakarta/xml/soap/SOAPMessage;)Ljakarta/xml/soap/SOAPHeader;", false);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/soap/SOAPHeader", "appendChild", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label4);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/security/wss4j/policyhandlers/SymmetricBindingHandler", "<init>", "(Lorg/apache/wss4j/dom/engine/WSSConfig;Lorg/apache/wss4j/policy/model/SymmetricBinding;Ljakarta/xml/soap/SOAPMessage;Lorg/apache/wss4j/dom/message/WSSecHeader;Lorg/apache/cxf/ws/policy/AssertionInfoMap;Lorg/apache/cxf/binding/soap/SoapMessage;)V", false);
