...
public class InteractiveChallengeTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/InteractiveChallengeType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "InteractiveChallengeType");
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/InteractiveChallengeType", "otherAttributes", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/InteractiveChallengeType", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/InteractiveChallengeType", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/InteractiveChallengeType", "otherAttributes", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
