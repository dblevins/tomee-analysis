...
public class HttpSOAPRequestParametersDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "SOAP_ACTION_HEADER", "Ljava/lang/String;", null, "SOAPAction");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "soapAction", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/soap/client/http/HttpSOAPRequestParameters", "soapAction", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/soap/client/http/HttpSOAPRequestParameters", "soapAction", "Ljava/lang/String;");
