...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/client/cache/CacheControlClientRequestFilter", null, "java/lang/Object", new String[] { "javax/ws/rs/client/ClientRequestFilter" });
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientRequestContext", "getHeaderString", "(Ljava/lang/String;)Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/client/cache/Entry", "getHeaders", "()Ljavax/ws/rs/core/MultivaluedMap;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "javax/ws/rs/core/Response$ResponseBuilder", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientRequestContext", "abortWith", "(Ljavax/ws/rs/core/Response;)V", true);
