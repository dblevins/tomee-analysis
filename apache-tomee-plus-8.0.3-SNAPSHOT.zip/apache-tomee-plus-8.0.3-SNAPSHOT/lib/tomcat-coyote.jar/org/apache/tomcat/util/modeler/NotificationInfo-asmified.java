...
{
fieldVisitor = classWriter.visitField(ACC_TRANSIENT, "info", "Ljavax/management/MBeanNotificationInfo;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/modeler/NotificationInfo", "info", "Ljavax/management/MBeanNotificationInfo;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createNotificationInfo", "()Ljavax/management/MBeanNotificationInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/modeler/NotificationInfo", "info", "Ljavax/management/MBeanNotificationInfo;");
Label label0 = new Label();
