...
public class SecureNio2Channel$5Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/net/SecureNio2Channel$5", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/net/SecureNio2Channel", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$net$TLSClientHelloExtractor$ExtractorResult", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/net/TLSClientHelloExtractor$ExtractorResult", "values", "()[Lorg/apache/tomcat/util/net/TLSClientHelloExtractor$ExtractorResult;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/net/SecureNio2Channel$5", "$SwitchMap$org$apache$tomcat$util$net$TLSClientHelloExtractor$ExtractorResult", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/net/SecureNio2Channel$5", "$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus", "[I");
