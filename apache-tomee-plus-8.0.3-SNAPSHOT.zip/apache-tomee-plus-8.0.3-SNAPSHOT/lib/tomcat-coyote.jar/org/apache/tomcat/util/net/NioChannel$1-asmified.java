...
public class NioChannel$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/tomcat/util/net/NioChannel$1", null, "org/apache/tomcat/util/net/NioChannel", null);

classWriter.visitOuterClass("org/apache/tomcat/util/net/NioChannel", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/NioChannel$1", "checkInterruptStatus", "()V", false);
methodVisitor.visitInsn(ICONST_M1);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 2);
methodVisitor.visitEnd();
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("Closed NioChannel");
