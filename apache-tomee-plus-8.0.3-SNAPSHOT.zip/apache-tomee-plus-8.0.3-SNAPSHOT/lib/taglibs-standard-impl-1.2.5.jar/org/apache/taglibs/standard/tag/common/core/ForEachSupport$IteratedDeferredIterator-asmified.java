...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "itemsValueIteratedExpression", "Ljavax/servlet/jsp/jstl/core/IteratedExpression;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljava/util/Iterator;Ljavax/servlet/jsp/jstl/core/IteratedExpression;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport$IteratedDeferredIterator", "itemsValueIteratedExpression", "Ljavax/servlet/jsp/jstl/core/IteratedExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport$IteratedDeferredIterator", "itemsValueIteratedExpression", "Ljavax/servlet/jsp/jstl/core/IteratedExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljava/util/Iterator;Ljavax/servlet/jsp/jstl/core/IteratedExpression;Lorg/apache/taglibs/standard/tag/common/core/ForEachSupport$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/taglibs/standard/tag/common/core/ForEachSupport$IteratedDeferredIterator", "<init>", "(Ljava/util/Iterator;Ljavax/servlet/jsp/jstl/core/IteratedExpression;)V", false);
methodVisitor.visitInsn(RETURN);
