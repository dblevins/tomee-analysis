...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getDataSource", "(Ljava/lang/Object;Ljavax/servlet/jsp/PageContext;)Ljavax/sql/DataSource;", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getDataSource", "(Ljava/lang/String;)Ljavax/sql/DataSource;", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
