...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tag/common/core/SetSupport", null, "javax/servlet/jsp/tagext/BodyTagSupport", null);
...
{
methodVisitor = classWriter.visitMethod(0, "getResult", "()Ljava/lang/Object;", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/SetSupport", "bodyContent", "Ljavax/servlet/jsp/tagext/BodyContent;");
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "evalTarget", "()Ljava/lang/Object;", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "evalProperty", "()Ljava/lang/String;", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "exportToVariable", "(Ljava/lang/Object;)V", null, new String[] { "javax/servlet/jsp/JspTagException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/SetSupport", "pageContext", "Ljavax/servlet/jsp/PageContext;");
...
{
methodVisitor = classWriter.visitMethod(0, "exportToBeanProperty", "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V", null, new String[] { "javax/servlet/jsp/JspTagException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "convertToExpectedType", "(Ljava/lang/Object;Ljava/lang/reflect/Method;)Ljava/lang/Object;", null, new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/taglibs/standard/tag/common/core/SetSupport", "getExpressionFactory", "()Ljavax/el/ExpressionFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
