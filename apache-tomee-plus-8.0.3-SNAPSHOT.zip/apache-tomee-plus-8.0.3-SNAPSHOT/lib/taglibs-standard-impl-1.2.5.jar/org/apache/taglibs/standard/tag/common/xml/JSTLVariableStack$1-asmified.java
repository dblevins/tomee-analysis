...
public class JSTLVariableStack$1Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER | ACC_SYNTHETIC, "org/apache/taglibs/standard/tag/common/xml/JSTLVariableStack$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/taglibs/standard/tag/common/xml/JSTLVariableStack", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$taglibs$standard$tag$common$xml$JSTLVariableStack$Scope", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/taglibs/standard/tag/common/xml/JSTLVariableStack$Scope", "values", "()[Lorg/apache/taglibs/standard/tag/common/xml/JSTLVariableStack$Scope;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/taglibs/standard/tag/common/xml/JSTLVariableStack$1", "$SwitchMap$org$apache$taglibs$standard$tag$common$xml$JSTLVariableStack$Scope", "[I");
