...
public class AbstractBagDecoratorDump implements Opcodes {
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/collection/AbstractCollectionDecorator", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/commons/collections4/Bag;)V", "(Lorg/apache/commons/collections4/Bag<TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bag/AbstractBagDecorator", "decorated", "()Lorg/apache/commons/collections4/Bag;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
