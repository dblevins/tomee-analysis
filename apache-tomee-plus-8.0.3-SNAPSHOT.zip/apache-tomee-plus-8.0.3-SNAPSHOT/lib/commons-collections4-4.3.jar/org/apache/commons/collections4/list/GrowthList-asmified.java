...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections4/list/GrowthList", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/list/AbstractSerializableListDecorator<TE;>;", "org/apache/commons/collections4/list/AbstractSerializableListDecorator", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "growthList", "(Ljava/util/List;)Lorg/apache/commons/collections4/list/GrowthList;", "<E:Ljava/lang/Object;>(Ljava/util/List<TE;>;)Lorg/apache/commons/collections4/list/GrowthList<TE;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/list/GrowthList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/list/GrowthList", "<init>", "(Ljava/util/List;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/list/GrowthList", "decorated", "()Ljava/util/List;", false);
