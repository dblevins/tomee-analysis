...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections4/bidimap/AbstractDualBidiMap$KeySet", "<K:Ljava/lang/Object;>Lorg/apache/commons/collections4/bidimap/AbstractDualBidiMap$View<TK;Ljava/lang/Object;TK;>;Ljava/util/Set<TK;>;", "org/apache/commons/collections4/bidimap/AbstractDualBidiMap$View", new String[] { "java/util/Set" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-7107935777385040694L));
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/commons/collections4/bidimap/AbstractDualBidiMap;)V", "(Lorg/apache/commons/collections4/bidimap/AbstractDualBidiMap<TK;*>;)V", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/bidimap/AbstractDualBidiMap$KeySet", "parent", "Lorg/apache/commons/collections4/bidimap/AbstractDualBidiMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bidimap/AbstractDualBidiMap", "createKeySetIterator", "(Ljava/util/Iterator;)Ljava/util/Iterator;", false);
