...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/tomcat/dbcp/pool2/impl/GenericObjectPoolMXBean", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "listAllObjects", "()Ljava/util/Set;", "()Ljava/util/Set<Lorg/apache/tomcat/dbcp/pool2/impl/DefaultPooledObjectInfo;>;", null);
methodVisitor.visitEnd();
}
