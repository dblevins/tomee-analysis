...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/valueextraction/FxExtractor$ForMapPropertyKey", "Ljava/lang/Object;Ljakarta/validation/valueextraction/ValueExtractor<Ljavafx/beans/property/ReadOnlyMapProperty<**>;>;", "java/lang/Object", new String[] { "jakarta/validation/valueextraction/ValueExtractor" });
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/FxExtractor$ForMapPropertyKey", "extractValues", "(Ljavafx/beans/property/ReadOnlyMapProperty;Ljakarta/validation/valueextraction/ValueExtractor$ValueReceiver;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljakarta/validation/valueextraction/ValueExtractor$ValueReceiver;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/valueextraction/FxExtractor$ForMapPropertyKey", "lambda$null$0", "(Ljakarta/validation/valueextraction/ValueExtractor$ValueReceiver;Ljava/lang/Object;)V", false), Type.getType("(Ljava/lang/Object;)V")});
