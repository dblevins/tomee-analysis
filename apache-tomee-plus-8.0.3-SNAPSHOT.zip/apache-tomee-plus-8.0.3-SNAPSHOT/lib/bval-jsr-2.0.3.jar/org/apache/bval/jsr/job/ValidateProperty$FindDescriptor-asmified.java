...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/job/ValidateProperty$DescriptorWrapper", "<init>", "(Ljavax/validation/metadata/ElementDescriptor;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/validation/metadata/ElementDescriptor"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/ApacheFactoryContext", "getDescriptorManager", "()Lorg/apache/bval/jsr/descriptor/DescriptorManager;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/metadata/ElementDescriptor", "getElementClass", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/descriptor/DescriptorManager", "getBeanDescriptor", "(Ljava/lang/Class;)Ljavax/validation/metadata/BeanDescriptor;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/bval/jsr/descriptor/BeanD");
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/validation/metadata/PropertyDescriptor"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/bval/jsr/job/ValidateProperty$DescriptorWrapper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/validation/metadata/ContainerElementTypeDescriptor");
methodVisitor.visitVarInsn(ASTORE, 3);
Label label2 = new Label();
...
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("apply", "(Ljava/lang/Class;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false), Type.getType("(Ljavax/validation/metadata/ContainerElementTypeDescriptor;)Lorg/apache/bval/jsr/descriptor/ContainerElementTypeD;")});
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/bval/jsr/job/ValidateProperty$FindDescriptor", "org/apache/bval/jsr/descriptor/CascadableContainerD", "java/util/Set", "javax/validation/metadata/ContainerElementTypeDescriptor"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "org/apache/bval/jsr/job/ValidateProperty$DescriptorWrapper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/job/ValidateProperty$DescriptorWrapper", "<init>", "(Ljavax/validation/metadata/ElementDescriptor;)V", false);
