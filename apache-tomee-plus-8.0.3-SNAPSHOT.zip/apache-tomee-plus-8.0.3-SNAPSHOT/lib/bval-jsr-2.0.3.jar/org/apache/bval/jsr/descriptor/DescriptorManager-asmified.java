...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isConstrained", "(Ljakarta/validation/metadata/ElementDescriptor;)Z", "<D::Ljakarta/validation/metadata/ElementDescriptor;:Ljakarta/validation/metadata/CascadableDescriptor;:Ljakarta/validation/metadata/ContainerDescriptor;>(TD;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/validation/metadata/ElementDescriptor", "hasConstraints", "()Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isCascaded", "(Ljakarta/validation/metadata/ElementDescriptor;)Z", "<D::Ljakarta/validation/metadata/ElementDescriptor;:Ljakarta/validation/metadata/CascadableDescriptor;:Ljakarta/validation/metadata/ContainerDescriptor;>(TD;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitInvokeDynamicInsn("test", "()Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/descriptor/DescriptorManager", "isCascaded", "(Ljakarta/validation/metadata/ElementDescriptor;)Z", false), Type.getType("(Ljakarta/validation/metadata/ContainerElementTypeDescriptor;)Z")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isConstrained", "(Ljakarta/validation/metadata/ExecutableDescriptor;)Z", "<E::Ljakarta/validation/metadata/ExecutableDescriptor;>(TE;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/validation/metadata/ExecutableDescriptor", "hasConstrainedParameters", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/validation/metadata/ExecutableDescriptor", "hasConstrainedReturnValue", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ICONST_1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBeanDescriptor", "(Ljava/lang/Class;)Ljakarta/validation/metadata/BeanDescriptor;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)Ljakarta/validation/metadata/BeanDescriptor;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/descriptor/BeanD", "getConstrainedMethods", "(Ljakarta/validation/metadata/MethodType;[Ljakarta/validation/metadata/MethodType;)Ljava/util/Set;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "isEmpty", "()Z", true);
