...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "unwrap", "(Ljavax/validation/metadata/ValidateUnwrappedValue;)Ljava/util/stream/Stream;", "(Ljavax/validation/metadata/ValidateUnwrappedValue;)Ljava/util/stream/Stream<Lorg/apache/bval/jsr/job/ValidationJob<TT;>.Frame<TD;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/ValueExtractors", "findUnwrappingInfo", "(Ljava/lang/Class;Ljavax/validation/metadata/ValidateUnwrappedValue;)Ljava/util/Optional;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validate", "(Lorg/apache/bval/jsr/descriptor/ConstraintD;Ljava/util/function/Consumer;)Z", "(Lorg/apache/bval/jsr/descriptor/ConstraintD<*>;Ljava/util/function/Consumer<Ljavax/validation/ConstraintViolation<TT;>;>;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/job/ValidationJob$Frame", "lambda$validate$5", "(Ljavax/validation/Path;)Ljava/util/Set;", false), Type.getType("(Ljavax/validation/Path;)Ljava/util/Set;")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/concurrent/ConcurrentMap", "computeIfAbsent", "(Ljava/lang/Object;Ljava/util/function/Function;)Ljava/lang/Object;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/job/ValidationJob$Frame", "getConstraintValidator", "(Lorg/apache/bval/jsr/descriptor/ConstraintD;)Ljavax/validation/ConstraintValidator;", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/validation/ConstraintValidator", "org/apache/bval/jsr/job/ConstraintValidatorContextImpl"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/ConstraintValidator", "initialize", "(Ljava/lang/annotation/Annotation;)V", true);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/job/ValidationJob$Frame", "context", "Lorg/apache/bval/jsr/GraphContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/GraphContext", "getValue", "()Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/ConstraintValidator", "isValid", "(Ljava/lang/Object;Ljavax/validation/ConstraintValidatorContext;)Z", true);
methodVisitor.visitVarInsn(ISTORE, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validateComposed", "(Lorg/apache/bval/jsr/descriptor/ConstraintD;Ljava/util/function/Consumer;)Z", "(Lorg/apache/bval/jsr/descriptor/ConstraintD<*>;Ljava/util/function/Consumer<Ljavax/validation/ConstraintViolation<TT;>;>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitInvokeDynamicInsn("accept", "()Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/job/ValidationJob$Frame", "lambda$validateComposed$6", "(Ljavax/validation/ConstraintViolation;)V", false), Type.getType("(Ljavax/validation/ConstraintViolation;)V")});
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("apply", "(Ljava/lang/Class;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false), Type.getType("(Ljavax/validation/metadata/ConstraintDescriptor;)Lorg/apache/bval/jsr/descriptor/ConstraintD;")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "map", "(Ljava/util/function/Function;)Ljava/util/stream/Stream;", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getConstraintValidator", "(Lorg/apache/bval/jsr/descriptor/ConstraintD;)Ljavax/validation/ConstraintValidator;", "(Lorg/apache/bval/jsr/descriptor/ConstraintD<*>;)Ljavax/validation/ConstraintValidator;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/job/ValidationJob$Frame", "this$0", "Lorg/apache/bval/jsr/job/ValidationJob;");
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/job/ValidationJob", "validatorContext", "Lorg/apache/bval/jsr/ApacheFactoryContext;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/descriptor/ConstraintD", "getValueUnwrapping", "()Ljavax/validation/metadata/ValidateUnwrappedValue;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/ValueExtractors", "findUnwrappingInfo", "(Ljava/lang/Class;Ljavax/validation/metadata/ValidateUnwrappedValue;)Ljava/util/Optional;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/valueextraction/ValueExtractors$UnwrappingInfo", "valueExtractor", "Ljavax/validation/valueextraction/ValueExtractor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/bval/jsr/valueextraction/ValueExtractors", "getExtractedType", "(Ljavax/validation/valueextraction/ValueExtractor;Ljava/lang/reflect/Type;)Ljava/lang/Class;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$getConstraintValidator$8", "(Lorg/apache/bval/jsr/descriptor/ConstraintD;)Ljavax/validation/ConstraintValidator;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/job/ValidationJob$Frame", "getValidationTarget", "()Ljavax/validation/constraintvalidation/ValidationTarget;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/bval/jsr/job/ValidationJob", "access$200", "()Ljavax/validation/ConstraintValidator;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/job/ValidationJob$Frame", "this$0", "Lorg/apache/bval/jsr/job/ValidationJob;");
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/jsr/job/ValidationJob", "validatorContext", "Lorg/apache/bval/jsr/ApacheFactoryContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/ApacheFactoryContext", "getConstraintValidatorFactory", "()Ljavax/validation/ConstraintValidatorFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/ConstraintValidatorFactory", "getInstance", "(Ljava/lang/Class;)Ljavax/validation/ConstraintValidator;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/bval/jsr/job/ValidationJob$Frame", "org/apache/bval/jsr/descriptor/ConstraintD", "java/lang/Class", "javax/validation/ConstraintValidator", "java/lang/Exception"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$validateComposed$6", "(Ljavax/validation/ConstraintViolation;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$validate$5", "(Ljavax/validation/Path;)Ljava/util/Set;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/descriptor/ConstraintD", "getValueUnwrapping", "()Ljavax/validation/metadata/ValidateUnwrappedValue;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/job/ValidationJob$Frame", "unwrap", "(Ljavax/validation/metadata/ValidateUnwrappedValue;)Ljava/util/stream/Stream;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
