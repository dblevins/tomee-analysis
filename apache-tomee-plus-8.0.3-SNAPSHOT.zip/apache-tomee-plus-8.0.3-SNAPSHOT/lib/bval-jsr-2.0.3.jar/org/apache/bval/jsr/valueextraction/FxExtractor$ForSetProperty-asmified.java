...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/valueextraction/FxExtractor$ForSetProperty", "Ljava/lang/Object;Ljavax/validation/valueextraction/ValueExtractor<Ljavafx/beans/property/ReadOnlySetProperty<*>;>;", "java/lang/Object", new String[] { "javax/validation/valueextraction/ValueExtractor" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "extractValues", "(Ljavafx/beans/property/ReadOnlySetProperty;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", "(Ljavafx/beans/property/ReadOnlySetProperty<*>;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/FxExtractor$ForSetProperty", "extractValues", "(Ljavafx/beans/property/ReadOnlySetProperty;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$extractValues$1", "(Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;Ljavafx/collections/ObservableSet;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/valueextraction/FxExtractor$ForSetProperty", "lambda$null$0", "(Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;Ljava/lang/Object;)V", false), Type.getType("(Ljava/lang/Object;)V")});
