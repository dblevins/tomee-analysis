...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "forValueExtractor", "(Ljavax/validation/valueextraction/ValueExtractor;)Lorg/apache/bval/jsr/metadata/ContainerElementKey;", "(Ljavax/validation/valueextraction/ValueExtractor<*>;)Lorg/apache/bval/jsr/metadata/ContainerElementKey;", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInvokeDynamicInsn("get", "(Ljava/lang/Class;)Ljava/util/function/Supplier;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/metadata/ContainerElementKey", "lambda$forValueExtractor$5", "(Ljava/lang/Class;)Ljavax/validation/valueextraction/ValueExtractorDefinitionException;", false), Type.getType("()Ljavax/validation/valueextraction/ValueExtractorDefinitionException;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$forValueExtractor$5", "(Ljava/lang/Class;)Ljavax/validation/valueextraction/ValueExtractorDefinitionException;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "javax/validation/valueextraction/ValueExtractorDefinitionException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/validation/valueextraction/ValueExtractorDefinitionException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/valueextraction/ExtractedValue;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/validation/valueextraction/ExtractedValue");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/valueextraction/ExtractedValue", "type", "()Ljava/lang/Class;", true);
