...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/util/ContainerElementNodeBuilderCustomizableContextImpl", null, "java/lang/Object", new String[] { "javax/validation/ConstraintValidatorContext$ConstraintViolationBuilder$ContainerElementNodeBuilderCustomizableContext" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "inIterable", "()Ljavax/validation/ConstraintValidatorContext$ConstraintViolationBuilder$ContainerElementNodeContextBuilder;", null, null);
methodVisitor.visitCode();
