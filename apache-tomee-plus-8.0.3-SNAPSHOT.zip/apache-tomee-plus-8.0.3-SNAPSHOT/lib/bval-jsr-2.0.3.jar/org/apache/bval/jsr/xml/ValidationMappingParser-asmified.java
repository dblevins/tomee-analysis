...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/spi/ConfigurationState", "isIgnoreXmlConfiguration", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/spi/ConfigurationState", "getMappingStreams", "()Ljava/util/Set;", true);
