...
public class Meta$ForConstructorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/metadata/Meta$ForConstructor", "<T:Ljava/lang/Object;>Lorg/apache/bval/jsr/metadata/Meta$ForExecutable<Ljava/lang/reflect/Constructor<+TT;>;>;", "org/apache/bval/jsr/metadata/Meta$ForExecutable", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "java/lang/annotation/ElementType", "CONSTRUCTOR", "Ljava/lang/annotation/ElementType;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/metadata/Meta$ForConstructor", "getHost", "()Ljava/lang/reflect/AnnotatedElement;", false);
