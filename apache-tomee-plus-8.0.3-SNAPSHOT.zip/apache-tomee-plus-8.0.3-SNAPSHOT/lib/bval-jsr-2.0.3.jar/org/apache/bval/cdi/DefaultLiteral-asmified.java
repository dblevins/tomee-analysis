...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/bval/cdi/DefaultLiteral;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/bval/cdi/DefaultLiteral");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/cdi/DefaultLiteral", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/bval/cdi/DefaultLiteral", "INSTANCE", "Lorg/apache/bval/cdi/DefaultLiteral;");
methodVisitor.visitInsn(RETURN);
