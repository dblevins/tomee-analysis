...
public class DecimalMaxValidator$ForNumberDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/constraints/DecimalMaxValidator$ForNumber", "Lorg/apache/bval/constraints/DecimalMaxValidator<Ljava/lang/Number;>;", "org/apache/bval/constraints/DecimalMaxValidator", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/constraints/DecimalMaxValidator$ForNumber", "isValid", "(Ljava/math/BigDecimal;)Z", false);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/constraints/DecimalMaxValidator$ForNumber", "isValid", "(Ljava/lang/Number;Ljakarta/validation/ConstraintValidatorContext;)Z", false);
methodVisitor.visitInsn(IRETURN);
