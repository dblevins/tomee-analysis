...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE | ACC_DEPRECATED, "org/apache/bval/constraints/Email", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, "{org.apache.bval.constraints.Email.message}");
annotationVisitor0.visitEnd();
}
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljakarta/validation/OverridesAttribute;", true);
