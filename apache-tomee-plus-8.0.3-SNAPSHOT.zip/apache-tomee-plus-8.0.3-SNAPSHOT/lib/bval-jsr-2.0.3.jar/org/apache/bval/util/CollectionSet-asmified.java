...
public class CollectionSetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/util/CollectionSet", "<E:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/Set<TE;>;", "java/lang/Object", new String[] { "java/util/Set" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "wrapped", "Ljava/util/Collection;", "Ljava/util/Collection<TE;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/util/CollectionSet", "wrapped", "Ljava/util/Collection;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/bval/util/CollectionSet", "java/util/Collection"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {Opcodes.INTEGER});
methodVisitor.visitLdcInsn("Collection values are not distinct");
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/util/CollectionSet", "wrapped", "Ljava/util/Collection;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Collection", "size", "()I", true);
