...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", null, "java/lang/Object", new String[] { "java/lang/reflect/ParameterizedType" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "raw", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "useOwner", "Ljava/lang/reflect/Type;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "typeArguments", "[Ljava/lang/reflect/Type;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "raw", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "useOwner", "Ljava/lang/reflect/Type;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "typeArguments", "[Ljava/lang/reflect/Type;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljava/lang/reflect/Type;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljava/lang/reflect/Type;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/bval/util/reflection/TypeUtils", "access$100", "(Ljava/lang/reflect/ParameterizedType;Ljava/lang/reflect/Type;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljava/lang/Class;Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;Lorg/apache/bval/util/reflection/TypeUtils$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/util/reflection/TypeUtils$ParameterizedTypeImpl", "<init>", "(Ljava/lang/Class;Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;)V", false);
methodVisitor.visitInsn(RETURN);
