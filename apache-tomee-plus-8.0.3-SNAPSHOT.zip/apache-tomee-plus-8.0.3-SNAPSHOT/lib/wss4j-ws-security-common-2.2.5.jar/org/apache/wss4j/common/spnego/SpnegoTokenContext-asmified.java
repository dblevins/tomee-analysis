...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/security/auth/Subject", "java/lang/String", "java/util/Set"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label12);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/wss4j/common/spnego/SpnegoTokenContext", "java/lang/String", "javax/security/auth/callback/CallbackHandler", "java/lang/String", Opcodes.INTEGER, "[B", "javax/security/auth/login/LoginContext", "jakarta/security/auth/Subject", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/wss4j/common/spnego/SpnegoTokenContext", "LOG", "Lorg/slf4j/Logger;");
