...
public class CertificateStore$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/wss4j/common/crypto/CertificateStore$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/wss4j/common/crypto/CertificateStore", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$wss4j$common$crypto$CryptoType$TYPE", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/wss4j/common/crypto/CryptoType$TYPE", "values", "()[Lorg/apache/wss4j/common/crypto/CryptoType$TYPE;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/wss4j/common/crypto/CertificateStore$1", "$SwitchMap$org$apache$wss4j$common$crypto$CryptoType$TYPE", "[I");
