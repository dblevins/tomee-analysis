...
public class UsernameTokenUtilDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/wss4j/common/util/UsernameTokenUtil", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "generateDerivedKey", "([B[BI)[B", null, new String[] { "org/apache/wss4j/common/ext/WSSecurityException" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"[B", "[B", Opcodes.INTEGER, "[B", "java/security/MessageDigest"}, 1, new Object[] {"java/security/NoSuchAlgorithmException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/wss4j/common/util/UsernameTokenUtil", "LOG", "Lorg/slf4j/Logger;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "generateDerivedKey", "(Ljava/lang/String;[BI)[B", null, new String[] { "org/apache/wss4j/common/ext/WSSecurityException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "generateSalt", "(Z)[B", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/wss4j/common/util/UsernameTokenUtil", "generateNonce", "(I)[B", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {Opcodes.INTEGER, "[B"}, 1, new Object[] {"org/apache/wss4j/common/ext/WSSecurityException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "generateNonce", "(I)[B", null, new String[] { "org/apache/wss4j/common/ext/WSSecurityException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/wss4j/common/util/UsernameTokenUtil;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/wss4j/common/util/UsernameTokenUtil", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitInsn(RETURN);
