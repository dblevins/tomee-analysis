...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "registerTransactionSynchronization", "(Ljavax/enterprise/event/TransactionPhase;Ljavax/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljavax/enterprise/inject/spi/EventMetadata;)V", "(Ljavax/enterprise/event/TransactionPhase;Ljavax/enterprise/inject/spi/ObserverMethod<-Ljava/lang/Object;>;Ljava/lang/Object;Ljavax/enterprise/inject/spi/EventMetadata;)V", new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/webbeans/spi/TransactionService", "getTransaction", "()Ljavax/transaction/Transaction;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/webbeans/spi/TransactionService", "javax/transaction/Transaction"}, 0, null);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AfterCompletion", "<init>", "(Ljavax/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljavax/enterprise/inject/spi/EventMetadata;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$1;)V", false);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/ee/event/TransactionalEventNotifier", "registerEvent", "(Ljavax/transaction/Transaction;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$AbstractSynchronization;Z)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AfterCompletionSuccess", "<init>", "(Ljavax/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljavax/enterprise/inject/spi/EventMetadata;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$1;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AfterCompletionFailure", "<init>", "(Ljavax/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljavax/enterprise/inject/spi/EventMetadata;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$1;)V", false);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/ee/event/TransactionalEventNotifier", "registerEvent", "(Ljavax/transaction/Transaction;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$AbstractSynchronization;Z)V", false);
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/ee/event/TransactionalEventNotifier$BeforeCompletion", "<init>", "(Ljavax/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljavax/enterprise/inject/spi/EventMetadata;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$1;)V", false);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/ee/event/TransactionalEventNotifier", "registerEvent", "(Ljavax/transaction/Transaction;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$AbstractSynchronization;Z)V", false);
methodVisitor.visitJumpInsn(GOTO, label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "registerEvent", "(Ljavax/transaction/Transaction;Lorg/apache/webbeans/ee/event/TransactionalEventNotifier$AbstractSynchronization;Z)V", null, new String[] { "javax/transaction/SystemException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
