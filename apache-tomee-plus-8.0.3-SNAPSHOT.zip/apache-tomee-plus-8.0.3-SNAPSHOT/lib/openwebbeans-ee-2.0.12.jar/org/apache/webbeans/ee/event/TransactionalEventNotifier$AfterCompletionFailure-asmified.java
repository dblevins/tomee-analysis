...
public class TransactionalEventNotifier$AfterCompletionFailureDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AfterCompletionFailure", null, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AbstractSynchronization", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AfterCompletionFailure", "notifyObserver", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/ee/event/TransactionalEventNotifier$AfterCompletionFailure", "<init>", "(Ljakarta/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/EventMetadata;)V", false);
methodVisitor.visitInsn(RETURN);
