...
public class StreamLexer$2Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/codehaus/swizzle/stream/StreamLexer$2", null, "org/codehaus/swizzle/stream/StringTokenHandler", null);

classWriter.visitOuterClass("org/codehaus/swizzle/stream/StreamLexer", "read", "(Ljava/lang/String;)Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/swizzle/stream/StreamLexer$2", "this$0", "Lorg/codehaus/swizzle/stream/StreamLexer;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/swizzle/stream/StreamLexer$2", "val$token", "[Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/swizzle/stream/StreamLexer$2", "val$token", "[Ljava/lang/String;");
