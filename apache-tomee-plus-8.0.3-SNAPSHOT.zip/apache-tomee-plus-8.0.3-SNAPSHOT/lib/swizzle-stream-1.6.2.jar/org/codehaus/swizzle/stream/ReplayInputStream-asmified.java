...
public class ReplayInputStreamDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/codehaus/swizzle/stream/ReplayInputStream", null, "org/codehaus/swizzle/stream/FilteredInputStream", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "out", "Ljava/io/ByteArrayOutputStream;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/swizzle/stream/ReplayInputStream", "out", "Ljava/io/ByteArrayOutputStream;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/swizzle/stream/ReplayInputStream", "out", "Ljava/io/ByteArrayOutputStream;");
methodVisitor.visitVarInsn(ILOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBytesRead", "()[B", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/swizzle/stream/ReplayInputStream", "out", "Ljava/io/ByteArrayOutputStream;");
