...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/websocket/RemoteEndpoint$Basic", null, "java/lang/Object", new String[] { "javax/websocket/RemoteEndpoint" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "sendObject", "(Ljava/lang/Object;)V", null, new String[] { "java/io/IOException", "javax/websocket/EncodeException" });
methodVisitor.visitEnd();
}
