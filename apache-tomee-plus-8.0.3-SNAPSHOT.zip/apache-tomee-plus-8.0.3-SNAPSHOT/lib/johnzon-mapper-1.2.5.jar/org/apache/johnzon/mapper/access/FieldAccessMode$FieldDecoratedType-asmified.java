...
public class FieldAccessMode$FieldDecoratedTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", null, "java/lang/Object", new String[] { "org/apache/johnzon/mapper/access/AccessMode$DecoratedType" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "field", "Ljava/lang/reflect/Field;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "field", "Ljava/lang/reflect/Field;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Field", "isAccessible", "()Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "field", "Ljava/lang/reflect/Field;");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Field", "setAccessible", "(Z)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "java/lang/reflect/Field", "java/lang/reflect/Type"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "type", "Ljava/lang/reflect/Type;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "field", "Ljava/lang/reflect/Field;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/johnzon/mapper/access/Meta", "getClassOrPackageAnnotation", "(Ljava/lang/reflect/Field;Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getField", "()Ljava/lang/reflect/Field;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "field", "Ljava/lang/reflect/Field;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/access/FieldAccessMode$FieldDecoratedType", "type", "Ljava/lang/reflect/Type;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitLdcInsn("FieldDecoratedType{field=");
