...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/johnzon/mapper/util/ArrayUtil$7", "Ljava/util/AbstractList<Ljava/lang/Double;>;", "java/util/AbstractList", null);

classWriter.visitOuterClass("org/apache/johnzon/mapper/util/ArrayUtil", "asList", "([D)Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/util/ArrayUtil$7", "val$vals", "[D");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/util/ArrayUtil$7", "val$vals", "[D");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/mapper/util/ArrayUtil$7", "get", "(I)Ljava/lang/Double;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
