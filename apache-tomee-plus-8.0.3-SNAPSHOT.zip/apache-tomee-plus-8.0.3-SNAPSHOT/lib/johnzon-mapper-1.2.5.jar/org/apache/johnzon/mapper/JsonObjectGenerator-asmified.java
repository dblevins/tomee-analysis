...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/mapper/JsonObjectGenerator", null, "java/lang/Object", new String[] { "jakarta/json/stream/JsonGenerator" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "factory", "Ljakarta/json/JsonBuilderFactory;", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "objectBuilder", "Ljakarta/json/JsonObjectBuilder;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "arrayBuilder", "Ljakarta/json/JsonArrayBuilder;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/json/JsonBuilderFactory;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "factory", "Ljakarta/json/JsonBuilderFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "factory", "Ljakarta/json/JsonBuilderFactory;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "objectBuilder", "Ljakarta/json/JsonObjectBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "builders", "Ljava/util/LinkedList;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "objectBuilder", "Ljakarta/json/JsonObjectBuilder;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/LinkedList", "add", "(Ljava/lang/Object;)Z", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "arrayBuilder", "Ljakarta/json/JsonArrayBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "builders", "Ljava/util/LinkedList;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "arrayBuilder", "Ljakarta/json/JsonArrayBuilder;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/LinkedList", "add", "(Ljava/lang/Object;)Z", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/json/JsonArrayBuilder;"));
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "isInstance", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/json/JsonObjectBuilder;"));
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "isInstance", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/json/JsonObjectBuilder");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "objectBuilder", "Ljakarta/json/JsonObjectBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/JsonObjectGenerator", "arrayBuilder", "Ljakarta/json/JsonArrayBuilder;");
