...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/geronimo/connector/outbound/SubjectSource", "getSubject", "()Ljakarta/security/auth/Subject;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label1);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/geronimo/connector/outbound/SubjectInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "jakarta/security/auth/Subject"}, 1, new Object[] {"java/lang/SecurityException"});
