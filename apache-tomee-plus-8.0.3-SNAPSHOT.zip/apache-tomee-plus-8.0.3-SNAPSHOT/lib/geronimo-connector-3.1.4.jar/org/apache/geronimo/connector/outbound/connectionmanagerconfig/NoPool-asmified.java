...
public class NoPoolDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/connector/outbound/connectionmanagerconfig/NoPool", null, "java/lang/Object", new String[] { "org/apache/geronimo/connector/outbound/connectionmanagerconfig/PoolingSupport" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-7871656583080873750L));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setPartitionMaxSize", "(I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
