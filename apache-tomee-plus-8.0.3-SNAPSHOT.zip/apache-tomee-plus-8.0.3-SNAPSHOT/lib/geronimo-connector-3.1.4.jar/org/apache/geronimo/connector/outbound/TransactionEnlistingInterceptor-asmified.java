...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/outbound/TransactionEnlistingInterceptor", "transactionManager", "Ljavax/transaction/TransactionManager;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/outbound/TransactionEnlistingInterceptor", "transactionManager", "Ljavax/transaction/TransactionManager;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/geronimo/connector/outbound/ManagedConnectionInfo", "javax/transaction/Transaction", "javax/transaction/xa/XAResource"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
