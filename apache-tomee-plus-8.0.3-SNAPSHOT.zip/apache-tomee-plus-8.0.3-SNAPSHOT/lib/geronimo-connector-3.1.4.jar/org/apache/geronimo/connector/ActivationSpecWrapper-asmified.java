...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "activationSpec", "Ljavax/resource/spi/ActivationSpec;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "validatorFactory", "Ljavax/validation/ValidatorFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "validated", "Z");
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/ActivationSpec");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/resource/spi/ActivationSpec;Lorg/apache/geronimo/connector/ResourceAdapterWrapper;Ljavax/validation/ValidatorFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "activate", "(Ljavax/resource/spi/endpoint/MessageEndpointFactory;)V", null, new String[] { "javax/resource/ResourceException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/connector/ActivationSpecWrapper", "checkConstraints", "(Ljavax/resource/spi/ActivationSpec;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/connector/ResourceAdapterWrapper", "endpointActivation", "(Ljavax/resource/spi/endpoint/MessageEndpointFactory;Ljavax/resource/spi/ActivationSpec;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "resourceAdapterWrapper", "Lorg/apache/geronimo/connector/ResourceAdapterWrapper;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "containerId", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/connector/ResourceAdapterWrapper", "doRecovery", "(Ljavax/resource/spi/ActivationSpec;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "deactivate", "(Ljavax/resource/spi/endpoint/MessageEndpointFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ActivationSpec", "getResourceAdapter", "()Ljavax/resource/spi/ResourceAdapter;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "activationSpec", "Ljavax/resource/spi/ActivationSpec;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/connector/ResourceAdapterWrapper", "endpointDeactivation", "(Ljavax/resource/spi/endpoint/MessageEndpointFactory;Ljavax/resource/spi/ActivationSpec;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "checkConstraints", "(Ljavax/resource/spi/ActivationSpec;)V", null, new String[] { "javax/resource/spi/InvalidPropertyException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ActivationSpec", "validate", "()V", true);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/ActivationSpecWrapper", "validatorFactory", "Ljavax/validation/ValidatorFactory;");
