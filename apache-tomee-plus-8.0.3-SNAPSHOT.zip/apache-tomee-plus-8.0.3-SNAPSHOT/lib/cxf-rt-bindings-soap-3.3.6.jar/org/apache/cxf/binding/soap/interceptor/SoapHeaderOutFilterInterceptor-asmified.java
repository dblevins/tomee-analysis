...
public class SoapHeaderOutFilterInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor", null, "org/apache/cxf/binding/soap/interceptor/AbstractSoapInterceptor", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor;", null, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor", "handleMessage", "(Lorg/apache/cxf/binding/soap/SoapMessage;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor", "INSTANCE", "Lorg/apache/cxf/binding/soap/interceptor/SoapHeaderOutFilterInterceptor;");
methodVisitor.visitInsn(RETURN);
