...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/apache/commons/pool2/ObjectPool<TT;>;", "java/lang/Object", new String[] { "org/apache/commons/pool2/ObjectPool" });
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/commons/pool2/ObjectPool;)V", "(Lorg/apache/commons/pool2/ObjectPool<TT;>;)V", new String[] { "java/lang/IllegalArgumentException" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "readWriteLock", "Ljava/util/concurrent/locks/ReentrantReadWriteLock;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "org/apache/commons/pool2/ObjectPool"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "pool", "Lorg/apache/commons/pool2/ObjectPool;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "readWriteLock", "Ljava/util/concurrent/locks/ReentrantReadWriteLock;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "pool", "Lorg/apache/commons/pool2/ObjectPool;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "java/lang/Object", "java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "java/util/concurrent/locks/ReentrantReadWriteLock$ReadLock"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/locks/ReentrantReadWriteLock$ReadLock", "unlock", "()V", false);
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/commons/pool2/PoolUtils$SynchronizedObjectPool", "java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/locks/ReentrantReadWriteLock$WriteLock", "unlock", "()V", false);
