...
{
annotationVisitor0 = classWriter.visitAnnotation("Ljakarta/cache/annotation/CacheResult;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheResult;"));
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResult", "cacheName", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResult", "cacheResolverFactory", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResult", "cacheKeyGenerator", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResult", "skipGet", "()Z", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/commons/jcs/jcache/cdi/CacheResultInterceptor", "jakarta/interceptor/InvocationContext", "jakarta/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "jakarta/cache/annotation/CacheResult", "java/lang/String", "jakarta/cache/annotation/CacheKeyInvocationContext", "jakarta/cache/annotation/CacheResolverFactory", "jakarta/cache/annotation/CacheResolver", "jakarta/cache/Cache", "jakarta/cache/annotation/GeneratedCacheKey", "jakarta/cache/Cache", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResolverFactory", "getExceptionCacheResolver", "(Ljakarta/cache/annotation/CacheMethodDetails;)Ljakarta/cache/annotation/CacheResolver;", true);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResolver", "resolveCache", "(Ljakarta/cache/annotation/CacheInvocationContext;)Ljakarta/cache/Cache;", true);
methodVisitor.visitVarInsn(ASTORE, 11);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/commons/jcs/jcache/cdi/CacheResultInterceptor", "jakarta/interceptor/InvocationContext", "jakarta/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "jakarta/cache/annotation/CacheResult", "java/lang/String", "jakarta/cache/annotation/CacheKeyInvocationContext", "jakarta/cache/annotation/CacheResolverFactory", "jakarta/cache/annotation/CacheResolver", "jakarta/cache/Cache", "jakarta/cache/annotation/GeneratedCacheKey", "jakarta/cache/Cache"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/jcache/cdi/CacheResultInterceptor", "helper", "Lorg/apache/commons/jcs/jcache/cdi/CDIJCacheHelper;");
methodVisitor.visitVarInsn(ALOAD, 13);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResult", "cachedExceptions", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheResult", "nonCachedExceptions", "()[Ljava/lang/Class;", true);
