...
{
annotationVisitor0 = classWriter.visitAnnotation("Ljavax/cache/annotation/CacheRemove;", true);
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/cache/annotation/CacheRemove");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheRemove", "cacheName", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheRemove", "afterInvocation", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/jcs/jcache/cdi/CacheRemoveInterceptor", "doRemove", "(Ljavax/cache/annotation/CacheKeyInvocationContext;Ljavax/cache/annotation/CacheDefaults;Ljavax/cache/annotation/CacheRemove;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/commons/jcs/jcache/cdi/CacheRemoveInterceptor", "jakarta/interceptor/InvocationContext", "javax/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "javax/cache/annotation/CacheRemove", "java/lang/String", Opcodes.INTEGER, "javax/cache/annotation/CacheKeyInvocationContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheRemove", "evictFor", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheRemove", "noEvictFor", "()[Ljava/lang/Class;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/commons/jcs/jcache/cdi/CacheRemoveInterceptor", "jakarta/interceptor/InvocationContext", "javax/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "javax/cache/annotation/CacheRemove", "java/lang/String", Opcodes.INTEGER, "javax/cache/annotation/CacheKeyInvocationContext", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doRemove", "(Ljavax/cache/annotation/CacheKeyInvocationContext;Ljavax/cache/annotation/CacheDefaults;Ljavax/cache/annotation/CacheRemove;)V", "(Ljavax/cache/annotation/CacheKeyInvocationContext<Ljavax/cache/annotation/CacheRemove;>;Ljavax/cache/annotation/CacheDefaults;Ljavax/cache/annotation/CacheRemove;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/jcache/cdi/CacheRemoveInterceptor", "helper", "Lorg/apache/commons/jcs/jcache/cdi/CDIJCacheHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheRemove", "cacheResolverFactory", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheRemove", "cacheKeyGenerator", "()Ljava/lang/Class;", true);
