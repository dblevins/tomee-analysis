...
{
annotationVisitor0 = classWriter.visitAnnotation("Ljakarta/cache/annotation/CacheRemoveAll;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheRemoveAll;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/cache/annotation/CacheRemoveAll");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheRemoveAll", "cacheName", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheRemoveAll", "afterInvocation", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/jcs/jcache/cdi/CacheRemoveAllInterceptor", "removeAll", "(Ljakarta/cache/annotation/CacheKeyInvocationContext;Ljakarta/cache/annotation/CacheDefaults;Ljakarta/cache/annotation/CacheRemoveAll;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/commons/jcs/jcache/cdi/CacheRemoveAllInterceptor", "jakarta/interceptor/InvocationContext", "jakarta/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "jakarta/cache/annotation/CacheRemoveAll", "java/lang/String", Opcodes.INTEGER, "jakarta/cache/annotation/CacheKeyInvocationContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheRemoveAll", "evictFor", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheRemoveAll", "noEvictFor", "()[Ljava/lang/Class;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "removeAll", "(Ljakarta/cache/annotation/CacheKeyInvocationContext;Ljakarta/cache/annotation/CacheDefaults;Ljakarta/cache/annotation/CacheRemoveAll;)V", "(Ljakarta/cache/annotation/CacheKeyInvocationContext<Ljakarta/cache/annotation/CacheRemoveAll;>;Ljakarta/cache/annotation/CacheDefaults;Ljakarta/cache/annotation/CacheRemoveAll;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/jcache/cdi/CacheRemoveAllInterceptor", "helper", "Lorg/apache/commons/jcs/jcache/cdi/CDIJCacheHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheRemoveAll", "cacheResolverFactory", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/Cache", "removeAll", "()V", true);
methodVisitor.visitInsn(RETURN);
