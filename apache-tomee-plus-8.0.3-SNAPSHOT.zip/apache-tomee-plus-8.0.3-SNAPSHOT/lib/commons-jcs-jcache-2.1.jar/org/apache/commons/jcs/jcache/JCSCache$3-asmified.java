...
public class JCSCache$3Dump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/commons/jcs/jcache/JCSCache;Ljava/lang/Exception;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/jcs/jcache/JCSCache$3", "this$0", "Lorg/apache/commons/jcs/jcache/JCSCache;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/jcs/jcache/JCSCache$3", "val$e", "Ljava/lang/Exception;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/jcs/jcache/JCSCache", "access$100", "(Ljava/lang/Exception;)Ljava/lang/Object;", false);
