...
public class CachePutInterceptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", null, "java/lang/Object", new String[] { "java/io/Serializable" });

{
annotationVisitor0 = classWriter.visitAnnotation("Ljakarta/cache/annotation/CachePut;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "helper", "Lorg/apache/commons/jcs/jcache/cdi/CDIJCacheHelper;");
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CachePut;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/cache/annotation/CachePut");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CachePut", "cacheName", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CachePut", "afterInvocation", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "doCache", "(Ljakarta/cache/annotation/CacheKeyInvocationContext;Ljakarta/cache/annotation/CacheDefaults;Ljakarta/cache/annotation/CachePut;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "jakarta/interceptor/InvocationContext", "jakarta/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "jakarta/cache/annotation/CachePut", "java/lang/String", Opcodes.INTEGER, "jakarta/cache/annotation/CacheKeyInvocationContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CachePut", "cacheFor", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CachePut", "noCacheFor", "()[Ljava/lang/Class;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "jakarta/interceptor/InvocationContext", "jakarta/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "jakarta/cache/annotation/CachePut", "java/lang/String", Opcodes.INTEGER, "jakarta/cache/annotation/CacheKeyInvocationContext", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doCache", "(Ljakarta/cache/annotation/CacheKeyInvocationContext;Ljakarta/cache/annotation/CacheDefaults;Ljakarta/cache/annotation/CachePut;)V", "(Ljakarta/cache/annotation/CacheKeyInvocationContext<Ljakarta/cache/annotation/CachePut;>;Ljakarta/cache/annotation/CacheDefaults;Ljakarta/cache/annotation/CachePut;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "helper", "Lorg/apache/commons/jcs/jcache/cdi/CDIJCacheHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CachePut", "cacheResolverFactory", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CachePut", "cacheKeyGenerator", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheKeyInvocationContext", "getValueParameter", "()Ljakarta/cache/annotation/CacheInvocationParameter;", true);
