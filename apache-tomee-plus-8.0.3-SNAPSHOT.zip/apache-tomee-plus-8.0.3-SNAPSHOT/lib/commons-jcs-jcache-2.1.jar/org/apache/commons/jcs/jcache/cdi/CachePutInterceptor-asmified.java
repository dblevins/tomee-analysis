...
{
annotationVisitor0 = classWriter.visitAnnotation("Ljavax/cache/annotation/CachePut;", true);
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/cache/annotation/CachePut");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CachePut", "cacheName", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CachePut", "afterInvocation", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "doCache", "(Ljavax/cache/annotation/CacheKeyInvocationContext;Ljavax/cache/annotation/CacheDefaults;Ljavax/cache/annotation/CachePut;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "jakarta/interceptor/InvocationContext", "javax/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "javax/cache/annotation/CachePut", "java/lang/String", Opcodes.INTEGER, "javax/cache/annotation/CacheKeyInvocationContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CachePut", "cacheFor", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CachePut", "noCacheFor", "()[Ljava/lang/Class;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "jakarta/interceptor/InvocationContext", "javax/cache/annotation/CacheDefaults", "java/lang/reflect/Method", "javax/cache/annotation/CachePut", "java/lang/String", Opcodes.INTEGER, "javax/cache/annotation/CacheKeyInvocationContext", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doCache", "(Ljavax/cache/annotation/CacheKeyInvocationContext;Ljavax/cache/annotation/CacheDefaults;Ljavax/cache/annotation/CachePut;)V", "(Ljavax/cache/annotation/CacheKeyInvocationContext<Ljavax/cache/annotation/CachePut;>;Ljavax/cache/annotation/CacheDefaults;Ljavax/cache/annotation/CachePut;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/jcache/cdi/CachePutInterceptor", "helper", "Lorg/apache/commons/jcs/jcache/cdi/CDIJCacheHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CachePut", "cacheResolverFactory", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CachePut", "cacheKeyGenerator", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/cache/annotation/CacheKeyInvocationContext", "getValueParameter", "()Ljavax/cache/annotation/CacheInvocationParameter;", true);
