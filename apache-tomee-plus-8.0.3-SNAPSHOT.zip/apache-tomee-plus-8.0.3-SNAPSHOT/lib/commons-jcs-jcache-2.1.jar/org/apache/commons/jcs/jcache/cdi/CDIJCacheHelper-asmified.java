...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "defaultName", "(Ljava/lang/reflect/Method;Ljakarta/cache/annotation/CacheDefaults;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheDefaults", "cacheName", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/commons/jcs/jcache/cdi/CDIJCacheHelper", "java/lang/reflect/Method", "jakarta/cache/annotation/CacheDefaults", "java/lang/String", "java/lang/String", "java/lang/StringBuilder", "[Ljava/lang/Class;", Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "findDefaults", "(Ljakarta/interceptor/InvocationContext;)Ljakarta/cache/annotation/CacheDefaults;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Class", "jakarta/cache/annotation/CacheDefaults"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheDefaults;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/cache/annotation/CacheDefaults");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "cacheKeyGeneratorFor", "(Ljakarta/cache/annotation/CacheDefaults;Ljava/lang/Class;)Ljakarta/cache/annotation/CacheKeyGenerator;", "(Ljakarta/cache/annotation/CacheDefaults;Ljava/lang/Class<+Ljakarta/cache/annotation/CacheKeyGenerator;>;)Ljakarta/cache/annotation/CacheKeyGenerator;", null);
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheKeyGenerator;"));
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/cache/annotation/CacheKeyGenerator");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheDefaults", "cacheKeyGenerator", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheKeyGenerator;"));
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "equals", "(Ljava/lang/Object;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "cacheResolverFactoryFor", "(Ljakarta/cache/annotation/CacheDefaults;Ljava/lang/Class;)Ljakarta/cache/annotation/CacheResolverFactory;", "(Ljakarta/cache/annotation/CacheDefaults;Ljava/lang/Class<+Ljakarta/cache/annotation/CacheResolverFactory;>;)Ljakarta/cache/annotation/CacheResolverFactory;", null);
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheResolverFactory;"));
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "equals", "(Ljava/lang/Object;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/jcs/jcache/cdi/CDIJCacheHelper", "instance", "(Ljava/lang/Class;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/cache/annotation/CacheResolverFactory");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/annotation/CacheDefaults", "cacheResolverFactory", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/cache/annotation/CacheResolverFactory;"));
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "equals", "(Ljava/lang/Object;)Z", false);
