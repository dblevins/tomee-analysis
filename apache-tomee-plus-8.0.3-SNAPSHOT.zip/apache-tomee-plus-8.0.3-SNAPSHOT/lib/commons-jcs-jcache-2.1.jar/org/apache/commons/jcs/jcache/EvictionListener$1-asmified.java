...
public class EvictionListener$1Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER | ACC_SYNTHETIC, "org/apache/commons/jcs/jcache/EvictionListener$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/commons/jcs/jcache/EvictionListener", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$commons$jcs$engine$control$event$behavior$ElementEventType", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/jcs/engine/control/event/behavior/ElementEventType", "values", "()[Lorg/apache/commons/jcs/engine/control/event/behavior/ElementEventType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/jcs/jcache/EvictionListener$1", "$SwitchMap$org$apache$commons$jcs$engine$control$event$behavior$ElementEventType", "[I");
