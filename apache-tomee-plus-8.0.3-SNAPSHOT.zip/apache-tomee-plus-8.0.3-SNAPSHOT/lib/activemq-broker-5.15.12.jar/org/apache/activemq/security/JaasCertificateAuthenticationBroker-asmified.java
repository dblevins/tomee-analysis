...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/activemq/security/JaasCertificateAuthenticationBroker", "java/lang/String", "java/lang/String", "[Ljava/security/cert/X509Certificate;", "javax/security/auth/callback/CallbackHandler", "javax/security/auth/login/LoginContext", "jakarta/security/auth/Subject", "java/lang/String", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/security/JaasCertificateSecurityContext", "<init>", "(Ljava/lang/String;Ljakarta/security/auth/Subject;[Ljava/security/cert/X509Certificate;)V", false);
methodVisitor.visitLabel(label1);
