...
public class MemoryIntPropertyEditorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/util/MemoryIntPropertyEditor", null, "java/beans/PropertyEditorSupport", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/util/MemoryIntPropertyEditor", "setValue", "(Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/util/MemoryIntPropertyEditor", "getValue", "()Ljava/lang/Object;", false);
