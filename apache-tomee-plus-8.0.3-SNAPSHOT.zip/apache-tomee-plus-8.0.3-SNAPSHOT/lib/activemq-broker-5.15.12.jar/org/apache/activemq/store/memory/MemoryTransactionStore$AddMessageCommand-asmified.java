...
public class MemoryTransactionStore$AddMessageCommandDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/activemq/store/memory/MemoryTransactionStore$AddMessageCommand", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setMessageStore", "(Lorg/apache/activemq/store/MessageStore;)V", null, null);
methodVisitor.visitEnd();
}
