...
public class JAXPXPathEvaluatorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/filter/JAXPXPathEvaluator", null, "java/lang/Object", new String[] { "org/apache/activemq/filter/XPathExpression$XPathEvaluator" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/filter/JAXPXPathEvaluator", "FACTORY", "Ljavax/xml/xpath/XPathFactory;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/xpath/XPathFactory", "newXPath", "()Ljavax/xml/xpath/XPath;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/filter/JAXPXPathEvaluator", "xpath", "Ljavax/xml/xpath/XPath;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/filter/JAXPXPathEvaluator", "xpathExpression", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/filter/JAXPXPathEvaluator", "builder", "Ljavax/xml/parsers/DocumentBuilder;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/filter/JAXPXPathEvaluator", "java/lang/String", "javax/xml/parsers/DocumentBuilder"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "evaluate", "(Lorg/apache/activemq/command/Message;)Z", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/filter/JAXPXPathEvaluator", "evaluate", "(Ljava/lang/String;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/filter/JAXPXPathEvaluator", "evaluate", "([B)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/filter/JAXPXPathEvaluator", "builder", "Ljavax/xml/parsers/DocumentBuilder;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/filter/JAXPXPathEvaluator", "xpath", "Ljavax/xml/xpath/XPath;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/filter/JAXPXPathEvaluator", "FACTORY", "Ljavax/xml/xpath/XPathFactory;");
methodVisitor.visitInsn(RETURN);
