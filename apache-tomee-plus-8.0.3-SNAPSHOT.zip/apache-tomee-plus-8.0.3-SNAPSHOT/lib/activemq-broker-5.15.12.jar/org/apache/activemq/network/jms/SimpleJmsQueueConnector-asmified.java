...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "outboundQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "localQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLocalQueueConnectionFactory", "()Ljavax/jms/QueueConnectionFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "localQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setLocalQueueConnectionFactory", "(Ljavax/jms/QueueConnectionFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "localQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOutboundQueueConnectionFactory", "()Ljavax/jms/QueueConnectionFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLocalQueueConnection", "()Ljavax/jms/QueueConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setLocalQueueConnection", "(Ljavax/jms/QueueConnection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "localConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOutboundQueueConnection", "()Ljavax/jms/QueueConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setOutboundQueueConnection", "(Ljavax/jms/QueueConnection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "foreignConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setOutboundQueueConnectionFactory", "(Ljavax/jms/QueueConnectionFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueConnectionFactoryName", "Ljava/lang/String;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/jms/QueueConnectionFactory;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/jms/QueueConnectionFactory");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueConnectionFactory", "createQueueConnection", "(Ljava/lang/String;Ljava/lang/String;)Ljavax/jms/QueueConnection;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
Label label10 = new Label();
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/jms/QueueConnection"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueConnectionFactory", "Ljavax/jms/QueueConnectionFactory;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueConnectionFactory", "createQueueConnection", "()Ljavax/jms/QueueConnection;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitJumpInsn(GOTO, label10);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueConnection", "setExceptionListener", "(Ljavax/jms/ExceptionListener;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueConnection", "setClientID", "(Ljava/lang/String;)V", true);
methodVisitor.visitLabel(label12);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueConnection", "start", "()V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "initializeInboundDestinationBridgesOutboundSide", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "initializeOutboundDestinationBridgesOutboundSide", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "foreignConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/atomic/AtomicReference", "set", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueConnection", "close", "()V", true);
methodVisitor.visitLabel(label4);
methodVisitor.visitJumpInsn(GOTO, label14);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueConnection", "java/lang/Exception"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "embeddedConnectionFactory", "Lorg/apache/activemq/ActiveMQConnectionFactory;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQConnectionFactory", "createQueueConnection", "()Ljavax/jms/QueueConnection;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "initializeInboundDestinationBridgesLocalSide", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "initializeOutboundDestinationBridgesLocalSide", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "localConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/atomic/AtomicReference", "set", "(Ljava/lang/Object;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeInboundDestinationBridgesOutboundSide", "(Ljavax/jms/QueueConnection;)V", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "inboundQueueBridges", "[Lorg/apache/activemq/network/jms/InboundQueueBridge;");
Label label0 = new Label();
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueConnection", "javax/jms/QueueSession", "[Lorg/apache/activemq/network/jms/InboundQueueBridge;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "createForeignQueue", "(Ljavax/jms/QueueSession;Ljava/lang/String;)Ljavax/jms/Queue;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setConsumer", "(Ljavax/jms/MessageConsumer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setConsumerQueue", "(Ljavax/jms/Queue;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setConsumerConnection", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeInboundDestinationBridgesLocalSide", "(Ljavax/jms/QueueConnection;)V", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "inboundQueueBridges", "[Lorg/apache/activemq/network/jms/InboundQueueBridge;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "createActiveMQQueue", "(Ljavax/jms/QueueSession;Ljava/lang/String;)Ljavax/jms/Queue;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setProducerQueue", "(Ljavax/jms/Queue;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setProducerConnection", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/activemq/network/jms/InboundQueueBridge", "java/lang/String", "javax/jms/Queue"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueConnection", "javax/jms/QueueSession"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/QueueSession", "close", "()V", true);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeOutboundDestinationBridgesOutboundSide", "(Ljavax/jms/QueueConnection;)V", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueBridges", "[Lorg/apache/activemq/network/jms/OutboundQueueBridge;");
Label label0 = new Label();
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueConnection", "javax/jms/QueueSession", "[Lorg/apache/activemq/network/jms/OutboundQueueBridge;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 4);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label2);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setProducerQueue", "(Ljavax/jms/Queue;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setProducerConnection", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/activemq/network/jms/OutboundQueueBridge", "java/lang/String", "javax/jms/Queue"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeOutboundDestinationBridgesLocalSide", "(Ljavax/jms/QueueConnection;)V", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "outboundQueueBridges", "[Lorg/apache/activemq/network/jms/OutboundQueueBridge;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setConsumer", "(Ljavax/jms/MessageConsumer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setConsumerQueue", "(Ljavax/jms/Queue;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setConsumerConnection", "(Ljavax/jms/QueueConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setJmsMessageConvertor", "(Lorg/apache/activemq/network/jms/JmsMesageConvertor;)V", false);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/Destination", "javax/jms/Connection", "javax/jms/Connection", "javax/jms/Queue", Opcodes.INTEGER, "org/apache/activemq/network/jms/InboundQueueBridge", "javax/jms/QueueSession", "javax/jms/Queue"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/Destination", "javax/jms/Connection", "javax/jms/Connection", "javax/jms/Queue", Opcodes.INTEGER, "org/apache/activemq/network/jms/InboundQueueBridge"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "LOG", "Lorg/slf4j/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundQueueBridge", "getConsumerQueue", "()Ljavax/jms/Queue;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setJmsMessageConvertor", "(Lorg/apache/activemq/network/jms/JmsMesageConvertor;)V", false);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/activemq/network/jms/OutboundQueueBridge", "javax/jms/QueueSession", "javax/jms/Queue"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/Destination", "javax/jms/Connection", "javax/jms/Connection", "javax/jms/Queue", Opcodes.INTEGER, "org/apache/activemq/network/jms/OutboundQueueBridge"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/network/jms/SimpleJmsQueueConnector", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Failed to create replyTo bridge for queue: {}");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundQueueBridge", "getConsumerQueue", "()Ljavax/jms/Queue;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 9);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createActiveMQQueue", "(Ljavax/jms/QueueSession;Ljava/lang/String;)Ljavax/jms/Queue;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createForeignQueue", "(Ljavax/jms/QueueSession;Ljava/lang/String;)Ljavax/jms/Queue;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueSession", "java/lang/String", "javax/jms/Queue"}, 1, new Object[] {"javax/naming/NamingException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(GOTO, label13);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueSession", "java/lang/String", "javax/jms/Queue", "javax/naming/NamingException"}, 1, new Object[] {"javax/jms/JMSException"});
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/activemq/network/jms/SimpleJmsQueueConnector", "javax/jms/QueueSession", "java/lang/String", "javax/jms/Queue", "javax/jms/JMSException"}, 1, new Object[] {"javax/naming/NamingException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
