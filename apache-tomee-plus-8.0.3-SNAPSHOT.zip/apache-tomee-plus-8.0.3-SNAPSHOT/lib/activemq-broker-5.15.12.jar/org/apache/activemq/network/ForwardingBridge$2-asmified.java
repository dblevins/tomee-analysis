...
public class ForwardingBridge$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/network/ForwardingBridge$2", null, "org/apache/activemq/transport/DefaultTransportListener", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/ForwardingBridge$2", "this$0", "Lorg/apache/activemq/network/ForwardingBridge;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/ForwardingBridge$2", "this$0", "Lorg/apache/activemq/network/ForwardingBridge;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/ForwardingBridge", "serviceRemoteCommand", "(Lorg/apache/activemq/command/Command;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/ForwardingBridge$2", "this$0", "Lorg/apache/activemq/network/ForwardingBridge;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/ForwardingBridge", "serviceRemoteException", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
