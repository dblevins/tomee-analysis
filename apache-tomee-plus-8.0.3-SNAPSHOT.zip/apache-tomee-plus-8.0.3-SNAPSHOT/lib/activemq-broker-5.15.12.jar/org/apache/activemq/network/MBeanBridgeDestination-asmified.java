...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/broker/jmx/BrokerMBeanSupport", "createNetworkOutBoundDestinationObjectName", "(Ljakarta/management/ObjectName;Lorg/apache/activemq/command/ActiveMQDestination;)Ljakarta/management/ObjectName;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/network/MBeanBridgeDestination$NetworkDestinationContainer", "<init>", "(Lorg/apache/activemq/broker/jmx/NetworkDestinationView;Ljakarta/management/ObjectName;Lorg/apache/activemq/network/MBeanBridgeDestination$1;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/MBeanBridgeDestination", "outboundDestinationViewMap", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/broker/jmx/BrokerMBeanSupport", "createNetworkInBoundDestinationObjectName", "(Ljakarta/management/ObjectName;Lorg/apache/activemq/command/ActiveMQDestination;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "org/apache/activemq/broker/jmx/NetworkDestinationView");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/BrokerService", "getManagementContext", "()Lorg/apache/activemq/broker/jmx/ManagementContext;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/network/MBeanBridgeDestination$NetworkDestinationContainer", "access$300", "(Lorg/apache/activemq/network/MBeanBridgeDestination$NetworkDestinationContainer;)Ljakarta/management/ObjectName;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/network/MBeanBridgeDestination", "java/util/Map", Opcodes.LONG, "java/util/Iterator", "java/util/Map$Entry", "jakarta/management/ObjectName"}, 1, new Object[] {"java/lang/Throwable"});
