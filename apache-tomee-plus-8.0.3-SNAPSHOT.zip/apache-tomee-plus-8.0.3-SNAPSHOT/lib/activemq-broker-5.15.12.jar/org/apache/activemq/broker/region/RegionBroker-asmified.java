...
methodVisitor.visitTypeInsn(NEW, "javax/jms/InvalidClientIDException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("No clientID specified for connection request");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/jms/InvalidClientIDException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getRegion", "(Lorg/apache/activemq/command/ActiveMQDestination;)Lorg/apache/activemq/broker/region/Region;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/region/RegionBroker", "createUnknownDestinationTypeException", "(Lorg/apache/activemq/command/ActiveMQDestination;)Ljavax/jms/JMSException;", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createUnknownDestinationTypeException", "(Lorg/apache/activemq/command/ActiveMQDestination;)Ljavax/jms/JMSException;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/broker/region/RegionBroker", "org/apache/activemq/broker/ConsumerBrokerExchange", "org/apache/activemq/command/ConsumerControl", "org/apache/activemq/command/ActiveMQDestination"}, 1, new Object[] {"javax/jms/JMSException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/broker/region/RegionBroker", "LOG", "Lorg/slf4j/Logger;");
