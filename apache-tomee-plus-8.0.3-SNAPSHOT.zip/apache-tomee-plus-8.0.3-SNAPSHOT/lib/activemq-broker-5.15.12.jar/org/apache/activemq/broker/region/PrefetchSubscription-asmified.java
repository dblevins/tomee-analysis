...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "assertAckMatchesDispatched", "(Lorg/apache/activemq/command/MessageAck;)V", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/command/MessageAck", "getFirstMessageId", "()Lorg/apache/activemq/command/MessageId;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
