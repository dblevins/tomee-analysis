...
public class BrokerService$10Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/broker/BrokerService$10", null, "java/lang/Object", new String[] { "java/util/concurrent/ThreadFactory" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/broker/BrokerService$10", "this$0", "Lorg/apache/activemq/broker/BrokerService;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(LCONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/broker/BrokerService$10", "i", "J");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/BrokerService$10", "i", "J");
...
methodVisitor.visitLdcInsn("ActiveMQ BrokerService.worker.");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(NEW, "org/apache/activemq/broker/BrokerService$10$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/BrokerService$10$1", "<init>", "(Lorg/apache/activemq/broker/BrokerService$10;)V", false);
