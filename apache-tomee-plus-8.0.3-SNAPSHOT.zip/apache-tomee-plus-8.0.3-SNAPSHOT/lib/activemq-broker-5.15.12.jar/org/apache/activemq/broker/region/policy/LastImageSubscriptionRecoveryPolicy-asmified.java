...
public class LastImageSubscriptionRecoveryPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/broker/region/policy/LastImageSubscriptionRecoveryPolicy", null, "java/lang/Object", new String[] { "org/apache/activemq/broker/region/policy/SubscriptionRecoveryPolicy" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "lastImage", "Lorg/apache/activemq/broker/region/MessageReference;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/broker/region/policy/LastImageSubscriptionRecoveryPolicy", "lastImage", "Lorg/apache/activemq/broker/region/MessageReference;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/region/policy/LastImageSubscriptionRecoveryPolicy", "lastImage", "Lorg/apache/activemq/broker/region/MessageReference;");
