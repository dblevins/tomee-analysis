...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/view/ConnectionDotFileInterceptor", "printSubscribers", "(Ljava/io/PrintWriter;Ljava/util/Map;Ljava/util/Map;Ljava/lang/String;[Ljakarta/management/ObjectName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintWriter", "println", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "printSubscribers", "(Ljava/io/PrintWriter;Ljava/util/Map;Ljava/util/Map;Ljava/lang/String;[Ljakarta/management/ObjectName;)V", "(Ljava/io/PrintWriter;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljava/lang/String;[Ljakarta/management/ObjectName;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"org/apache/activemq/broker/view/ConnectionDotFileInterceptor", "java/io/PrintWriter", "java/util/Map", "java/util/Map", "java/lang/String", "[Ljakarta/management/ObjectName;", Opcodes.INTEGER, "jakarta/management/ObjectName", "org/apache/activemq/broker/jmx/SubscriptionViewMBean", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintWriter", "print", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/broker/view/ConnectionDotFileInterceptor", "java/io/PrintWriter", "java/util/Map", "java/util/Map", "java/lang/String", "[Ljakarta/management/ObjectName;"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
