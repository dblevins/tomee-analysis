...
public class WSSec$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/wss4j/stax/setup/WSSec$1", null, "java/lang/Object", new String[] { "org/w3c/dom/ls/LSResourceResolver" });

classWriter.visitOuterClass("org/apache/wss4j/stax/setup/WSSec", "loadWSSecuritySchemas", "()Ljavax/xml/validation/Schema;");
...
methodVisitor.visitLdcInsn("schemas/XMLSchema.dtd");
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitLdcInsn("schemas/datatypes.dtd");
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/wss4j/stax/setup/WSSec;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/xml/security/utils/ClassLoaderUtils", "getResourceAsStream", "(Ljava/lang/String;Ljava/lang/Class;)Ljava/io/InputStream;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/stax/impl/util/ConcreteLSInput", "setByteStream", "(Ljava/io/InputStream;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
