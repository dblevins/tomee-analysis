...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverAttachment", null, "java/lang/Object", new String[] { "org/apache/xml/security/stax/ext/ResourceResolver", "org/apache/xml/security/stax/ext/ResourceResolverLookup" });
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverAttachment");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverAttachment", "<init>", "()V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
