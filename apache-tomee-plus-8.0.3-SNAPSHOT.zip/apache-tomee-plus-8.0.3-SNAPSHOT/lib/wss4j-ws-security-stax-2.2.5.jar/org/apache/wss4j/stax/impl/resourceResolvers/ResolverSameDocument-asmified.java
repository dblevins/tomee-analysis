...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverSameDocument", null, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverSameDocument", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverSameDocument", "<init>", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverSameDocument");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverSameDocument", "<init>", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverSameDocument", "matches", "(Lorg/apache/xml/security/stax/ext/stax/XMLSecStartElement;Ljavax/xml/namespace/QName;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/impl/resourceResolvers/ResolverSameDocument", "getId", "()Ljava/lang/String;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverSameDocument", "matches", "(Lorg/apache/xml/security/stax/ext/stax/XMLSecStartElement;Ljavax/xml/namespace/QName;)Z", false);
methodVisitor.visitInsn(IRETURN);
