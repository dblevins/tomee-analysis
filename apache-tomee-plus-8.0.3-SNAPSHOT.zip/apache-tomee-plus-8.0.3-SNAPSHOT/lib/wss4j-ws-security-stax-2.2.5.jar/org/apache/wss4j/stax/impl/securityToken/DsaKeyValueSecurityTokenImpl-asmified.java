...
public class DsaKeyValueSecurityTokenImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", null, "org/apache/xml/security/stax/impl/securityToken/DsaKeyValueSecurityToken", new String[] { "org/apache/wss4j/stax/securityToken/DsaKeyValueSecurityToken" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "crypto", "Lorg/apache/wss4j/common/crypto/Crypto;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "callbackHandler", "Ljavax/security/auth/callback/CallbackHandler;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "securityProperties", "Lorg/apache/wss4j/stax/ext/WSSSecurityProperties;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "crypto", "Lorg/apache/wss4j/common/crypto/Crypto;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "getPublicKey", "()Ljava/security/PublicKey;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "callbackHandler", "Ljavax/security/auth/callback/CallbackHandler;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "java/lang/String", "org/apache/xml/security/stax/ext/XMLSecurityConstants$AlgorithmUsage", "java/lang/String", "java/security/PublicKey"}, 1, new Object[] {"org/apache/wss4j/common/ext/WSSecurityException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "securityProperties", "Lorg/apache/wss4j/stax/ext/WSSSecurityProperties;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "principal", "Ljava/security/Principal;");
Label label3 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/DsaKeyValueSecurityTokenImpl", "principal", "Ljava/security/Principal;");
methodVisitor.visitLabel(label1);
