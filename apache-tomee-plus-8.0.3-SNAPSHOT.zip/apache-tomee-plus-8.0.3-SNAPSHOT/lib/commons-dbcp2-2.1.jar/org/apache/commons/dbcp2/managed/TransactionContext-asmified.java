...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/dbcp2/managed/TransactionRegistry;Ljavax/transaction/Transaction;)V", null, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/dbcp2/managed/TransactionContext", "org/apache/commons/dbcp2/managed/TransactionRegistry", "javax/transaction/Transaction"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/dbcp2/managed/TransactionContext", "getTransaction", "()Ljavax/transaction/Transaction;", false);
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/commons/dbcp2/managed/TransactionContext"}, 1, new Object[] {"javax/transaction/SystemException"});
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitTypeInsn(NEW, "java/sql/SQLException");
methodVisitor.visitInsn(DUP);
