...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", null, "java/lang/Object", new String[] { "java/sql/DatabaseMetaData" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_meta", "Ljava/sql/DatabaseMetaData;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_conn", "Lorg/apache/commons/dbcp2/DelegatingConnection;", "Lorg/apache/commons/dbcp2/DelegatingConnection<*>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/dbcp2/DelegatingConnection;Ljava/sql/DatabaseMetaData;)V", "(Lorg/apache/commons/dbcp2/DelegatingConnection<*>;Ljava/sql/DatabaseMetaData;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", "_conn", "Lorg/apache/commons/dbcp2/DelegatingConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", "_meta", "Ljava/sql/DatabaseMetaData;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", "_meta", "Ljava/sql/DatabaseMetaData;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData");
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", "getDelegate", "()Ljava/sql/DatabaseMetaData;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", "_conn", "Lorg/apache/commons/dbcp2/DelegatingConnection;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/DelegatingDatabaseMetaData", "handleException", "(Ljava/sql/SQLException;)V", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/dbcp2/DelegatingResultSet", "wrapResultSet", "(Ljava/sql/Connection;Ljava/sql/ResultSet;)Ljava/sql/ResultSet;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/sql/SQLException"});
