...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/dbcp2/PoolingDataSource", "<C::Ljava/sql/Connection;>Ljava/lang/Object;Ljavax/sql/DataSource;Ljava/lang/AutoCloseable;", "java/lang/Object", new String[] { "javax/sql/DataSource", "java/lang/AutoCloseable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_logWriter", "Ljava/io/PrintWriter;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_pool", "Lorg/apache/commons/pool2/ObjectPool;", "Lorg/apache/commons/pool2/ObjectPool<TC;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/pool2/ObjectPool;)V", "(Lorg/apache/commons/pool2/ObjectPool<TC;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "accessToUnderlyingConnectionAllowed", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_logWriter", "Ljava/io/PrintWriter;");
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/commons/dbcp2/PoolingDataSource", "org/apache/commons/pool2/ObjectPool"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_pool", "Lorg/apache/commons/pool2/ObjectPool;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_pool", "Lorg/apache/commons/pool2/ObjectPool;");
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/commons/pool2/impl/GenericObjectPool");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_pool", "Lorg/apache/commons/pool2/ObjectPool;");
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/commons/pool2/impl/GenericObjectPool");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/pool2/impl/GenericObjectPool", "getFactory", "()Lorg/apache/commons/pool2/PooledObjectFactory;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/commons/dbcp2/PoolableConnectionFactory");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/PoolableConnectionFactory", "getPool", "()Lorg/apache/commons/pool2/ObjectPool;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_pool", "Lorg/apache/commons/pool2/ObjectPool;");
methodVisitor.visitJumpInsn(IF_ACMPEQ, label1);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/dbcp2/PoolingDataSource", "log", "Lorg/apache/commons/logging/Log;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "accessToUnderlyingConnectionAllowed", "Z");
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/dbcp2/PoolingDataSource$PoolGuardConnectionWrapper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/dbcp2/PoolingDataSource$PoolGuardConnectionWrapper", "<init>", "(Lorg/apache/commons/dbcp2/PoolingDataSource;Ljava/sql/Connection;)V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/commons/dbcp2/PoolingDataSource"}, 1, new Object[] {"java/sql/SQLException"});
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_logWriter", "Ljava/io/PrintWriter;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getPool", "()Lorg/apache/commons/pool2/ObjectPool;", "()Lorg/apache/commons/pool2/ObjectPool<TC;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/PoolingDataSource", "_pool", "Lorg/apache/commons/pool2/ObjectPool;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/commons/dbcp2/PoolingDataSource;"));
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/dbcp2/PoolingDataSource", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitInsn(RETURN);
