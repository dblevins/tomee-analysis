...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/dbcp2/DelegatingCallableStatement", null, "org/apache/commons/dbcp2/DelegatingPreparedStatement", new String[] { "java/sql/CallableStatement" });

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/dbcp2/DelegatingConnection;Ljava/sql/CallableStatement;)V", "(Lorg/apache/commons/dbcp2/DelegatingConnection<*>;Ljava/sql/CallableStatement;)V", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/DelegatingCallableStatement", "checkOpen", "()V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/DelegatingCallableStatement", "getDelegate", "()Ljava/sql/Statement;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/DelegatingCallableStatement", "handleException", "(Ljava/sql/SQLException;)V", false);
