...
public class DigesterRuleParser$BeanPropertySetterRuleFactoryDump implements Opcodes {
...
classWriter.visit(V1_2, ACC_SUPER, "org/apache/commons/digester/xmlrules/DigesterRuleParser$BeanPropertySetterRuleFactory", null, "org/apache/commons/digester/AbstractObjectCreationFactory", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/commons/digester/xmlrules/DigesterRuleParser;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/digester/xmlrules/DigesterRuleParser$BeanPropertySetterRuleFactory", "this$0", "Lorg/apache/commons/digester/xmlrules/DigesterRuleParser;");
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/commons/digester/xmlrules/DigesterRuleParser;Lorg/apache/commons/digester/xmlrules/DigesterRuleParser$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/digester/xmlrules/DigesterRuleParser$BeanPropertySetterRuleFactory", "<init>", "(Lorg/apache/commons/digester/xmlrules/DigesterRuleParser;)V", false);
methodVisitor.visitInsn(RETURN);
