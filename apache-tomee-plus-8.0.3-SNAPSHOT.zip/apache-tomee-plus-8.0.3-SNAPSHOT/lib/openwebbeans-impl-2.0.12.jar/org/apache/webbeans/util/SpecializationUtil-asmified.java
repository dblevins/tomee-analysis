...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/SpecializationUtil", "isEnabled", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/enterprise/inject/spi/AnnotatedType", "java/lang/Class", "java/lang/Class"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label8 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label8);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/webbeans/util/SpecializationUtil$BeanAttributesProvider", "get", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Ljavax/enterprise/inject/spi/BeanAttributes;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/enterprise/inject/spi/BeanAttributes"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/SpecializationUtil", "containsAllSuperclassTypes", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/Class;Ljava/util/Collection;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/SpecializationUtil", "getAnnotatedTypeForClass", "(Ljava/util/Collection;Ljava/lang/Class;)Ljavax/enterprise/inject/spi/AnnotatedType;", false);
methodVisitor.visitVarInsn(ASTORE, 11);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "containsAllSuperclassTypes", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/Class;Ljava/util/Collection;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/lang/Class<*>;Ljava/util/Collection<Ljavax/enterprise/inject/spi/AnnotatedType<*>;>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/util/SpecializationUtil", "javax/enterprise/inject/spi/AnnotatedType", "java/lang/Class", "java/util/Collection", "javax/enterprise/inject/Typed", "java/util/List", "javax/enterprise/inject/spi/AnnotatedType", "javax/enterprise/inject/Typed"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/util/SpecializationUtil", "javax/enterprise/inject/spi/AnnotatedType", "java/lang/Class", "java/util/Collection", "javax/enterprise/inject/Typed"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getAnnotatedTypeForClass", "(Ljava/util/Collection;Ljava/lang/Class;)Ljavax/enterprise/inject/spi/AnnotatedType;", "(Ljava/util/Collection<Ljavax/enterprise/inject/spi/AnnotatedType<*>;>;Ljava/lang/Class<*>;)Ljavax/enterprise/inject/spi/AnnotatedType<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Collection", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isEnabled", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/SpecializationUtil", "getAnnotationClasses", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Ljava/util/Set;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getAnnotationClasses", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Ljava/util/Set;", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;)Ljava/util/Set<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
