...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLifecycleMethods", "(Ljakarta/enterprise/inject/spi/AnnotatedType;Ljava/lang/Class;)Ljava/util/List;", "(Ljakarta/enterprise/inject/spi/AnnotatedType<*>;Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;)Ljava/util/List<Ljakarta/enterprise/inject/spi/AnnotatedMethod<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
