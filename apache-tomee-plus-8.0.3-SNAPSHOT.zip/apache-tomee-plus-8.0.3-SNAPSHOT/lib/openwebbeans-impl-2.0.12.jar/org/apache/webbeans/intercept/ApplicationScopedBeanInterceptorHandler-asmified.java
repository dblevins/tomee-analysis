...
public class ApplicationScopedBeanInterceptorHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/intercept/ApplicationScopedBeanInterceptorHandler", null, "org/apache/webbeans/intercept/NormalScopedBeanInterceptorHandler", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "cachedInstance", "Ljava/lang/Object;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/intercept/ApplicationScopedBeanInterceptorHandler", "cachedInstance", "Ljava/lang/Object;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/intercept/ApplicationScopedBeanInterceptorHandler", "cachedInstance", "Ljava/lang/Object;");
