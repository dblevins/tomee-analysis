...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "owner", "Ljakarta/enterprise/inject/spi/Bean;", "Ljakarta/enterprise/inject/spi/Bean<TP;>;", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "disposalIPs", "Ljava/util/Set;", "Ljava/util/Set<Ljakarta/enterprise/inject/spi/InjectionPoint;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "disposerMethod", "Ljakarta/enterprise/inject/spi/AnnotatedMethod;", "Ljakarta/enterprise/inject/spi/AnnotatedMethod<-TP;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/enterprise/inject/spi/Bean;Ljakarta/enterprise/inject/spi/AnnotatedMethod;Ljava/util/Set;Ljava/util/Set;Lorg/apache/webbeans/config/WebBeansContext;)V", "(Ljakarta/enterprise/inject/spi/Bean<TP;>;Ljakarta/enterprise/inject/spi/AnnotatedMethod<-TP;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/InjectionPoint;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/InjectionPoint;>;Lorg/apache/webbeans/config/WebBeansContext;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/portable/BaseProducerProducer", "owner", "Ljakarta/enterprise/inject/spi/Bean;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/webbeans/portable/BaseProducerProducer", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/inject/spi/AnnotatedMethod", "java/util/Set", "java/util/Set", "org/apache/webbeans/config/WebBeansContext", "org/apache/webbeans/spi/plugins/OpenWebBeansEjbPlugin"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/portable/BaseProducerProducer", "disposerMethod", "Ljakarta/enterprise/inject/spi/AnnotatedMethod;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 9);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDisposerMethod", "()Ljakarta/enterprise/inject/spi/AnnotatedMethod;", "()Ljakarta/enterprise/inject/spi/AnnotatedMethod<-TP;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/BaseProducerProducer", "disposerMethod", "Ljakarta/enterprise/inject/spi/AnnotatedMethod;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/AbstractProducer", "defineInterceptorStack", "(Ljakarta/enterprise/inject/spi/Bean;Ljakarta/enterprise/inject/spi/AnnotatedType;Lorg/apache/webbeans/config/WebBeansContext;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/BaseProducerProducer", "owner", "Ljakarta/enterprise/inject/spi/Bean;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/inject/InjectableMethod", "<init>", "(Ljava/lang/reflect/Method;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/Producer;Lorg/apache/webbeans/context/creational/CreationalContextImpl;Ljava/util/Set;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDisposalIPs", "()Ljava/util/Set;", "()Ljava/util/Set<Ljakarta/enterprise/inject/spi/InjectionPoint;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/BaseProducerProducer", "disposalIPs", "Ljava/util/Set;");
methodVisitor.visitInsn(ARETURN);
