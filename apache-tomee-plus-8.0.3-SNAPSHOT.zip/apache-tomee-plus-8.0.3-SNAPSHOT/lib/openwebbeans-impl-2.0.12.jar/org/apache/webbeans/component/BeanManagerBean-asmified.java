...
public class BeanManagerBeanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/component/BeanManagerBean", "Lorg/apache/webbeans/component/BuiltInOwbBean<Ljakarta/enterprise/inject/spi/BeanManager;>;", "org/apache/webbeans/component/BuiltInOwbBean", null);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/portable/BeanManagerProducer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/BeanManagerProducer", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;)V", false);
