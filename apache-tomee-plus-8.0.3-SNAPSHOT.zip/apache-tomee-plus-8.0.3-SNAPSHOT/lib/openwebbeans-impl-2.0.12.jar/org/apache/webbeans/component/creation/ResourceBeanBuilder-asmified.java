...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/webbeans/component/InjectionTargetBean;Lorg/apache/webbeans/spi/api/ResourceReference;Ljakarta/enterprise/inject/spi/AnnotatedField;Ljakarta/enterprise/inject/spi/BeanAttributes;)V", "(Lorg/apache/webbeans/component/InjectionTargetBean<*>;Lorg/apache/webbeans/spi/api/ResourceReference<TT;TR;>;Ljakarta/enterprise/inject/spi/AnnotatedField<*>;Ljakarta/enterprise/inject/spi/BeanAttributes<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/ProducerFieldBeanBuilder", "<init>", "(Lorg/apache/webbeans/component/InjectionTargetBean;Ljakarta/enterprise/inject/spi/AnnotatedField;Ljakarta/enterprise/inject/spi/BeanAttributes;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/creation/ResourceBeanBuilder", "beanAttributes", "Ljakarta/enterprise/inject/spi/BeanAttributes;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/component/creation/ResourceBeanBuilder", "org/apache/webbeans/component/InjectionTargetBean", "java/lang/Class"}, 8, new Object[] {label0, label0, "org/apache/webbeans/component/InjectionTargetBean", "org/apache/webbeans/spi/api/ResourceReference", "jakarta/enterprise/inject/spi/BeanAttributes", "java/lang/Class", label1, label1});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/component/creation/ResourceBeanBuilder", "org/apache/webbeans/component/InjectionTargetBean", "java/lang/Class"}, 9, new Object[] {label0, label0, "org/apache/webbeans/component/InjectionTargetBean", "org/apache/webbeans/spi/api/ResourceReference", "jakarta/enterprise/inject/spi/BeanAttributes", "java/lang/Class", label1, label1, Opcodes.INTEGER});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/InjectionTargetBean", "getWebBeansContext", "()Lorg/apache/webbeans/config/WebBeansContext;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/creation/ResourceBeanBuilder", "annotatedMember", "Ljakarta/enterprise/inject/spi/AnnotatedMember;");
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/enterprise/inject/spi/AnnotatedField");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/creation/ResourceBeanBuilder", "resourceRef", "Lorg/apache/webbeans/spi/api/ResourceReference;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/ResourceProducerFactory", "<init>", "(ZLjakarta/enterprise/inject/spi/Bean;Lorg/apache/webbeans/component/ResourceProvider;Ljava/lang/Class;Lorg/apache/webbeans/config/WebBeansContext;Ljakarta/enterprise/inject/spi/AnnotatedField;Lorg/apache/webbeans/spi/api/ResourceReference;)V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/ResourceBean", "<init>", "(Lorg/apache/webbeans/component/InjectionTargetBean;Lorg/apache/webbeans/spi/api/ResourceReference;Ljakarta/enterprise/inject/spi/BeanAttributes;Ljava/lang/Class;Ljakarta/enterprise/inject/spi/ProducerFactory;)V", false);
