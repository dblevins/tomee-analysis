...
public class TrustEngineTLSSocketFactoryDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", null, "java/lang/Object", new String[] { "org/apache/http/conn/socket/LayeredConnectionSocketFactory" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "wrappedFactory", "Lorg/apache/http/conn/socket/LayeredConnectionSocketFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "hostnameVerifier", "Lorg/apache/http/conn/ssl/X509HostnameVerifier;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "wrappedFactory", "Lorg/apache/http/conn/socket/LayeredConnectionSocketFactory;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "performTrustEval", "(Ljava/net/Socket;Lorg/apache/http/protocol/HttpContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/http/HttpHost", "getHostName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "performHostnameVerification", "(Ljava/net/Socket;Ljava/lang/String;Lorg/apache/http/protocol/HttpContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "performTrustEval", "(Ljava/net/Socket;Lorg/apache/http/protocol/HttpContext;)V", null, new String[] { "java/io/IOException" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("No criteria set supplied by caller, building new criteria set with signing criteria");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;)V", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "extractCredential", "(Ljavax/net/ssl/SSLSocket;)Lorg/opensaml/security/x509/X509Credential;", false);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "javax/net/ssl/SSLSocket", "javax/net/ssl/SSLSession", "[Ljava/security/cert/Certificate;", "java/util/ArrayList", "[Ljava/security/cert/Certificate;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/security/httpclient/impl/TrustEngineTLSSocketFactory", "hostnameVerifier", "Lorg/apache/http/conn/ssl/X509HostnameVerifier;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/net/ssl/SSLSocket");
