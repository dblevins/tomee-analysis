...
public class DiscoveryRegistry$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/server/DiscoveryRegistry$2", null, "java/lang/Object", new String[] { "java/util/concurrent/RejectedExecutionHandler" });

classWriter.visitOuterClass("org/apache/openejb/server/DiscoveryRegistry", "<init>", "(Lorg/apache/openejb/server/DiscoveryAgent;)V");

classWriter.visitInnerClass("org/apache/openejb/server/DiscoveryRegistry$2", null, null, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/DiscoveryRegistry$2", "this$0", "Lorg/apache/openejb/server/DiscoveryRegistry;");
methodVisitor.visitVarInsn(ALOAD, 0);
