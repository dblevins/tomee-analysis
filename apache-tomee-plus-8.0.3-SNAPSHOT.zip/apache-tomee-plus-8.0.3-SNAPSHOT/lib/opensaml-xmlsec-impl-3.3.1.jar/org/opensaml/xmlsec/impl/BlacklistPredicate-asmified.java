...
public class BlacklistPredicateDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/impl/BlacklistPredicate", "Ljava/lang/Object;Lcom/google/common/base/Predicate<Ljava/lang/String;>;", "java/lang/Object", new String[] { "com/google/common/base/Predicate" });
...
methodVisitor.visitLdcInsn("Blacklist may not be null");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/impl/BlacklistPredicate", "blacklist", "Ljava/util/Collection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/impl/BlacklistPredicate", "blacklist", "Ljava/util/Collection;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Algorithm URI to evaluate may not be null");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/BlacklistPredicate", "apply", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
