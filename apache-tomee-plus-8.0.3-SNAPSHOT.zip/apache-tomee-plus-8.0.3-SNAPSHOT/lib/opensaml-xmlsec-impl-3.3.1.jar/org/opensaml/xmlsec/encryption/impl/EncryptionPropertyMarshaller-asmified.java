...
public class EncryptionPropertyMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/encryption/impl/EncryptionPropertyMarshaller", null, "org/opensaml/xmlsec/encryption/impl/AbstractXMLEncryptionMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xmlsec/encryption/EncryptionProperty", "getID", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xmlsec/encryption/EncryptionProperty"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xmlsec/encryption/EncryptionProperty", "getTarget", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xmlsec/encryption/EncryptionProperty", "getUnknownAttributes", "()Lorg/opensaml/core/xml/util/AttributeMap;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/opensaml/xmlsec/encryption/impl/EncryptionPropertyMarshaller", "org/opensaml/core/xml/XMLObject", "org/w3c/dom/Element", "org/opensaml/xmlsec/encryption/EncryptionProperty", "org/w3c/dom/Attr", "java/util/Iterator", "java/util/Map$Entry"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
