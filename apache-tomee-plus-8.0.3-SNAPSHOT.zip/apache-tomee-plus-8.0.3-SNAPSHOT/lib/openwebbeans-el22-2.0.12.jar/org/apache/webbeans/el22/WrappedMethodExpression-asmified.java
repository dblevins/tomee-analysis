...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/el22/WrappedMethodExpression", null, "jakarta/el/MethodExpression", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/el22/WrappedMethodExpression", "delegate", "Ljakarta/el/MethodExpression;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMethodInfo", "(Ljakarta/el/ELContext;)Ljakarta/el/MethodInfo;", null, new String[] { "java/lang/NullPointerException", "jakarta/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/el22/WrappedMethodExpression", "delegate", "Ljakarta/el/MethodExpression;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invoke", "(Ljakarta/el/ELContext;[Ljava/lang/Object;)Ljava/lang/Object;", null, new String[] { "java/lang/NullPointerException", "jakarta/el/ELException" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/el22/WrappedMethodExpression", "jakarta/el/ELContext", "[Ljava/lang/Object;"}, 1, new Object[] {"java/lang/Throwable"});
