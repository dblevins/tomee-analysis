...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/rest/ThreadLocalHttpServletResponse", "Lorg/apache/openejb/rest/AbstractRestThreadLocalProxy<Ljavax/servlet/http/HttpServletResponse;>;Ljavax/servlet/http/HttpServletResponse;", "org/apache/openejb/rest/AbstractRestThreadLocalProxy", new String[] { "javax/servlet/http/HttpServletResponse" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/rest/ThreadLocalHttpServletResponse", "get", "()Ljava/lang/Object;", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpServletResponse", "setContentLengthLong", "(J)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
