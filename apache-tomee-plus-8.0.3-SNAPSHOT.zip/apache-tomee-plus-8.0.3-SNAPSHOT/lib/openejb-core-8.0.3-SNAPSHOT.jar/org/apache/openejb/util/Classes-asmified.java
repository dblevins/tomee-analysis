...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/util/Classes", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/util/Classes", "primitives", "Ljava/util/HashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/util/Classes", "packageName", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/util/Classes", "primitiveWrappers", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "ancestors", "(Ljava/lang/Class;)Ljava/util/List;", "(Ljava/lang/Class;)Ljava/util/List<Ljava/lang/Class<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/util/Classes", "primitiveWrappers", "Ljava/util/Map;");
methodVisitor.visitTypeInsn(NEW, "java/util/HashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashMap", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/util/Classes", "primitives", "Ljava/util/HashMap;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/util/Classes", "primitives", "Ljava/util/HashMap;");
