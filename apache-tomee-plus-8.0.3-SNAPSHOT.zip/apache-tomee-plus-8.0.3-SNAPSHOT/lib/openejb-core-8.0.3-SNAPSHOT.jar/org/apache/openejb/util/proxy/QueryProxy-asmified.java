...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/proxy/QueryProxy", "em", "Ljakarta/persistence/EntityManager;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/util/proxy/QueryProxy", "em", "Ljakarta/persistence/EntityManager;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(AALOAD);
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/persistence/Query"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/util/proxy/QueryProxy", "getQueryResult", "(Ljava/lang/reflect/Method;Ljakarta/persistence/Query;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getQueryResult", "(Ljava/lang/reflect/Method;Ljakarta/persistence/Query;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/util/proxy/QueryProxy", "createFinderQuery", "(Ljakarta/persistence/EntityManager;Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Object;)Ljakarta/persistence/Query;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/metamodel/EntityType", "hasSingleIdAttribute", "()Z", true);
Label label2 = new Label();
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "java/lang/Class", "jakarta/persistence/metamodel/EntityType"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/metamodel/EntityType", "getSingularAttributes", "()Ljava/util/Set;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/persistence/metamodel/SingularAttribute", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createFinderQuery", "(Ljakarta/persistence/EntityManager;Ljava/lang/String;Ljava/lang/Class;[Ljava/lang/Object;)Ljakarta/persistence/Query;", "<T:Ljava/lang/Object;>(Ljakarta/persistence/EntityManager;Ljava/lang/String;Ljava/lang/Class<TT;>;[Ljava/lang/Object;)Ljakarta/persistence/Query;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/CriteriaBuilder", "createQuery", "()Ljakarta/persistence/criteria/CriteriaQuery;", true);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 3);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openejb/util/proxy/QueryProxy", "jakarta/persistence/EntityManager", "java/lang/String", "java/lang/Class", "[Ljava/lang/Object;", "java/util/List", "jakarta/persistence/metamodel/EntityType", "jakarta/persistence/criteria/CriteriaBuilder", "jakarta/persistence/criteria/CriteriaQuery", "jakarta/persistence/criteria/Root", Opcodes.INTEGER, "jakarta/persistence/criteria/Predicate", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/metamodel/EntityType", "getSingularAttribute", "(Ljava/lang/String;)Ljakarta/persistence/metamodel/SingularAttribute;", true);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/openejb/util/proxy/QueryProxy", "jakarta/persistence/EntityManager", "java/lang/String", "java/lang/Class", "[Ljava/lang/Object;", "java/util/List", "jakarta/persistence/metamodel/EntityType", "jakarta/persistence/criteria/CriteriaBuilder", "jakarta/persistence/criteria/CriteriaQuery", "jakarta/persistence/criteria/Root", Opcodes.INTEGER, "jakarta/persistence/criteria/Predicate", "java/util/Iterator", "java/lang/String", "jakarta/persistence/metamodel/SingularAttribute", "jakarta/persistence/criteria/Path", "java/lang/Class"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/CriteriaBuilder", "and", "(Ljakarta/persistence/criteria/Expression;Ljakarta/persistence/criteria/Expression;)Ljakarta/persistence/criteria/Predicate;", true);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openejb/util/proxy/QueryProxy", "jakarta/persistence/EntityManager", "java/lang/String", "java/lang/Class", "[Ljava/lang/Object;", "java/util/List", "jakarta/persistence/metamodel/EntityType", "jakarta/persistence/criteria/CriteriaBuilder", "jakarta/persistence/criteria/CriteriaQuery", "jakarta/persistence/criteria/Root", Opcodes.INTEGER, "jakarta/persistence/criteria/Predicate", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label0);
