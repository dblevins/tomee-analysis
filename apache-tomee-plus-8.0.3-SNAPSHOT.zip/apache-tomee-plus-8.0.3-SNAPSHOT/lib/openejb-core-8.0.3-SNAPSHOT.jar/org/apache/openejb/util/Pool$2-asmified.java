...
public class Pool$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openejb/util/Pool$2", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openejb/util/Pool", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$util$Pool$Event", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/util/Pool$Event", "values", "()[Lorg/apache/openejb/util/Pool$Event;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/util/Pool$2", "$SwitchMap$org$apache$openejb$util$Pool$Event", "[I");
