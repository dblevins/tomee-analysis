...
public class Index$IndexIteratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/util/Index$IndexIterator", "<E:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/Iterator<TE;>;", "java/lang/Object", new String[] { "java/util/Iterator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/Index$IndexIterator", "this$0", "Lorg/apache/openejb/util/Index;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/util/Index$IndexIterator", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/util/Index$IndexIterator", "this$0", "Lorg/apache/openejb/util/Index;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/Index$IndexIterator", "index", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/util/Index$IndexIterator", "<init>", "(Lorg/apache/openejb/util/Index;)V", false);
methodVisitor.visitInsn(RETURN);
