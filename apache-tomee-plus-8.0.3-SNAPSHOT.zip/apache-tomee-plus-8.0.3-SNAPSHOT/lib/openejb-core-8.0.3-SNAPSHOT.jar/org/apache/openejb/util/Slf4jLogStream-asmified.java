...
public class Slf4jLogStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/util/Slf4jLogStream", null, "java/lang/Object", new String[] { "org/apache/openejb/util/LogStream" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/Slf4jLogStream", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/util/Slf4jLogStream", "log", "Lorg/slf4j/Logger;");
