...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "Ljava/lang/Object;Ljava/util/concurrent/Callable<Ljavax/persistence/EntityManagerFactory;>;", "java/lang/Object", new String[] { "java/util/concurrent/Callable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "potentialValidators", "Ljava/util/Map;", "Ljava/util/Map<Lorg/apache/openejb/assembler/classic/ComparableValidationConfig;Ljavax/validation/ValidatorFactory;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "call", "()Ljavax/persistence/EntityManagerFactory;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/persistence/ValidationMode", "equals", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "ensureSerializable", "(Ljavax/validation/ValidatorFactory;)Ljavax/validation/ValidatorFactory;", false);
Label label10 = new Label();
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "java/lang/ClassLoader", "java/lang/Class", "javax/persistence/spi/PersistenceProvider", "java/util/Map"}, 2, new Object[] {"java/util/Map", "java/lang/String"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "java/lang/ClassLoader", "java/lang/Class", "javax/persistence/spi/PersistenceProvider", "java/util/Map"}, 3, new Object[] {"java/util/Map", "java/lang/String", "java/lang/Object"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "java/lang/ClassLoader", "java/lang/Class", "javax/persistence/spi/PersistenceProvider", "java/util/Map", "javax/transaction/Transaction", "javax/persistence/EntityManagerFactory"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "unitInfo", "Lorg/apache/openejb/persistence/PersistenceUnitInfoImpl;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/persistence/PersistenceUnitInfoImpl", "getProperties", "()Ljava/util/Properties;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "ensureSerializable", "(Ljavax/validation/ValidatorFactory;)Ljavax/validation/ValidatorFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/SingleValidatorFactoryWrapper", "<init>", "(Ljavax/validation/ValidatorFactory;)V", false);
methodVisitor.visitInsn(ARETURN);
