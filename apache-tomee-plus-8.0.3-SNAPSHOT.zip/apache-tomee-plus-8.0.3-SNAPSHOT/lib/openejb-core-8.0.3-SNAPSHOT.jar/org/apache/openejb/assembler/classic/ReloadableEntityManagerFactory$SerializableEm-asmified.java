...
public class ReloadableEntityManagerFactory$SerializableEmDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$SerializableEm", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$SerializableEm", "jndiName", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$SerializableEm", "jndiName", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljava/lang/String;Lorg/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$SerializableEm", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
