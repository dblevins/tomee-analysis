...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "setTransactionType", "(Ljavax/persistence/spi/PersistenceUnitTransactionType;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "setSharedCacheMode", "(Ljavax/persistence/SharedCacheMode;)V", false);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory$JMXReloadableEntityManagerFactory", "reloadableEntityManagerFactory", "Lorg/apache/openejb/assembler/classic/ReloadableEntityManagerFactory;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "setValidationMode", "(Ljavax/persistence/ValidationMode;)V", false);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/persistence/PersistenceUnitInfoImpl", "getTransactionType", "()Ljavax/persistence/spi/PersistenceUnitTransactionType;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/persistence/spi/PersistenceUnitTransactionType", "name", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/persistence/PersistenceUnitInfoImpl", "getSharedCacheMode", "()Ljavax/persistence/SharedCacheMode;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/persistence/PersistenceUnitInfoImpl", "getValidationMode", "()Ljavax/persistence/ValidationMode;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/persistence/ValidationMode", "name", "()Ljava/lang/String;", false);
