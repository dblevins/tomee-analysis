...
public class ManagedThreadFactoryImplFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/resource/thread/ManagedThreadFactoryImplFactory", null, "java/lang/Object", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("openejb-managed-thread-");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/resource/thread/ManagedThreadFactoryImplFactory", "prefix", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/resource/thread/ManagedThreadFactoryImplFactory", "prefix", "Ljava/lang/String;");
