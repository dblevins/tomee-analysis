...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "SYNCHRONIZATION_REGISTRY", "Ljavax/transaction/TransactionSynchronizationRegistry;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/resource/jdbc/router/FailOverRouter$FacadeHandler", "transactionManager", "Ljavax/transaction/TransactionManager;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/resource/jdbc/router/FailOverRouter$FacadeHandler", "transactionManager", "Ljavax/transaction/TransactionManager;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/resource/jdbc/router/FailOverRouter$FacadeHandler", "SYNCHRONIZATION_REGISTRY", "Ljavax/transaction/TransactionSynchronizationRegistry;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/openejb/resource/jdbc/router/FailOverRouter$FacadeHandler", "java/lang/Object", "java/lang/reflect/Method", "[Ljava/lang/Object;", "javax/transaction/Transaction", Opcodes.INTEGER, "java/util/Collection", Opcodes.INTEGER, "java/lang/Object", "java/util/Map", "org/apache/openejb/resource/jdbc/router/FailOverRouter$DataSourceHolder", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/resource/jdbc/router/FailOverRouter$FacadeHandler", "SYNCHRONIZATION_REGISTRY", "Ljavax/transaction/TransactionSynchronizationRegistry;");
methodVisitor.visitInsn(RETURN);
