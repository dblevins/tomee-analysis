...
public class FinderFactory$ModuleLimitedFinder$FieldPredicateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$FieldPredicate", "Lorg/apache/openejb/config/FinderFactory$ModuleLimitedFinder$Predicate<Ljava/lang/reflect/Field;>;", "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$Predicate", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "name", "(Ljava/lang/reflect/Field;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$FieldPredicate", "name", "(Ljava/lang/reflect/Field;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
