...
public class AdditionalDeploymentsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/sys/AdditionalDeployments", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "additional-deployments");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/sys/AdditionalDeployments", "deployments", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/sys/AdditionalDeployments", "deployments", "Ljava/util/List;");
