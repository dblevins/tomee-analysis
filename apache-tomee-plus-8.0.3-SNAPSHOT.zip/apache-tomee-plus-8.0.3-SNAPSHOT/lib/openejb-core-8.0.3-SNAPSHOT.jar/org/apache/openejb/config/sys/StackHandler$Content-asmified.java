...
public class StackHandler$ContentDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/sys/StackHandler$Content", null, "org/xml/sax/helpers/DefaultHandler", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "characters", "Ljava/lang/StringBuilder;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/config/sys/StackHandler;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/sys/StackHandler$Content", "this$0", "Lorg/apache/openejb/config/sys/StackHandler;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/sys/StackHandler$Content", "characters", "Ljava/lang/StringBuilder;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/sys/StackHandler$Content", "characters", "Ljava/lang/StringBuilder;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/config/sys/StackHandler$Content", "setValue", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
