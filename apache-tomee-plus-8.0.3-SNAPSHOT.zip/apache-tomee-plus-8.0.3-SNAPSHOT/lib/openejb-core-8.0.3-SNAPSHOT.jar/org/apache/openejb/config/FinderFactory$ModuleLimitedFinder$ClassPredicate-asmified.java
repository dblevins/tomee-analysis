...
public class FinderFactory$ModuleLimitedFinder$ClassPredicateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$ClassPredicate", "<T:Ljava/lang/Object;>Lorg/apache/openejb/config/FinderFactory$ModuleLimitedFinder$Predicate<Ljava/lang/Class<+TT;>;>;", "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$Predicate", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "name", "(Ljava/lang/Class;)Ljava/lang/String;", "(Ljava/lang/Class<+TT;>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/config/FinderFactory$ModuleLimitedFinder$ClassPredicate", "name", "(Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
