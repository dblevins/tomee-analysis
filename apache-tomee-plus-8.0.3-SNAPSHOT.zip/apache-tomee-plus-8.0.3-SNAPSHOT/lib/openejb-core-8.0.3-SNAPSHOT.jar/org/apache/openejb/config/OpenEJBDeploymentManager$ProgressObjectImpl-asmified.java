...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", null, "java/lang/Object", new String[] { "javax/enterprise/deploy/spi/status/ProgressObject" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/config/OpenEJBDeploymentManager;Ljavax/enterprise/deploy/shared/CommandType;Ljava/util/Set;)V", "(Ljavax/enterprise/deploy/shared/CommandType;Ljava/util/Set<Ljavax/enterprise/deploy/spi/TargetModuleID;>;)V", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/OpenEJBDeploymentManager$DeploymentStatusImpl", "<init>", "(Ljavax/enterprise/deploy/shared/CommandType;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", "deploymentStatus", "Ljavax/enterprise/deploy/spi/status/DeploymentStatus;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", "deploymentStatus", "Ljavax/enterprise/deploy/spi/status/DeploymentStatus;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", "event", "Ljavax/enterprise/deploy/spi/status/ProgressEvent;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(6, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/config/OpenEJBDeploymentManager;Ljavax/enterprise/deploy/shared/CommandType;Ljava/lang/Exception;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", "this$0", "Lorg/apache/openejb/config/OpenEJBDeploymentManager;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/OpenEJBDeploymentManager$DeploymentStatusImpl", "<init>", "(Ljavax/enterprise/deploy/shared/CommandType;Ljava/lang/Exception;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", "deploymentStatus", "Ljavax/enterprise/deploy/spi/status/DeploymentStatus;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "javax/enterprise/deploy/spi/status/ProgressEvent");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/OpenEJBDeploymentManager$ProgressObjectImpl", "event", "Ljavax/enterprise/deploy/spi/status/ProgressEvent;");
