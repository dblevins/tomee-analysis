...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/webservices/ProviderWrapper", null, "jakarta/xml/ws/spi/Provider", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/webservices/ProviderWrapper", "findProvider", "()Ljakarta/xml/ws/spi/Provider;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/webservices/ProviderWrapper", "delegate", "Ljakarta/xml/ws/spi/Provider;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/webservices/ProviderWrapper", "threadPortRefs", "Ljava/lang/ThreadLocal;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/ThreadLocal", "get", "()Ljava/lang/Object;", false);
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/webservices/ProviderWrapper", "delegate", "Ljakarta/xml/ws/spi/Provider;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", "<init>", "(Lorg/apache/openejb/core/webservices/ProviderWrapper;Ljakarta/xml/ws/spi/ServiceDelegate;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/xml/ws/spi/ServiceDelegate"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/webservices/ProviderWrapper", "createProviderInstance", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljakarta/xml/ws/spi/Provider;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"java/lang/ClassLoader", "java/lang/String", "jakarta/xml/ws/spi/Provider", "java/util/Iterator", "java/net/URL", "java/io/BufferedReader", "java/lang/Throwable", "jakarta/xml/ws/spi/Provider"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"java/lang/ClassLoader", "java/lang/String", "jakarta/xml/ws/spi/Provider", "java/util/Iterator", "java/net/URL", "java/io/BufferedReader", "java/lang/Throwable", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/ClassLoader", "java/lang/String", "jakarta/xml/ws/spi/Provider", "java/util/Iterator", "java/net/URL"}, 0, new Object[] {});
