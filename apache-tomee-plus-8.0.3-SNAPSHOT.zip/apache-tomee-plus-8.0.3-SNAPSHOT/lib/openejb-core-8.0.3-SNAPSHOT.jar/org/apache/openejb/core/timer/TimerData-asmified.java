...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "timer", "Ljavax/ejb/Timer;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(JLorg/apache/openejb/core/timer/EjbTimerServiceImpl;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/reflect/Method;Ljavax/ejb/TimerConfig;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/timer/TimerData", Opcodes.LONG, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "java/lang/String", "java/lang/Object", "java/lang/reflect/Method", "javax/ejb/TimerConfig"}, 1, new Object[] {"org/apache/openejb/core/timer/TimerData"});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/ejb/TimerConfig", "getInfo", "()Ljava/io/Serializable;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/timer/TimerData", Opcodes.LONG, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "java/lang/String", "java/lang/Object", "java/lang/reflect/Method", "javax/ejb/TimerConfig"}, 2, new Object[] {"org/apache/openejb/core/timer/TimerData", "java/lang/Object"});
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/ejb/TimerConfig", "isPersistent", "()Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/timer/TimerData", Opcodes.LONG, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "java/lang/String", "java/lang/Object", "java/lang/reflect/Method", "javax/ejb/TimerConfig"}, 2, new Object[] {"org/apache/openejb/core/timer/TimerData", Opcodes.INTEGER});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/timer/TimerData", "timer", "Ljavax/ejb/Timer;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/timer/TimerData", "timer", "Ljavax/ejb/Timer;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getTimer", "()Ljavax/ejb/Timer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/timer/TimerData", "timer", "Ljavax/ejb/Timer;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/timer/TimerData", "timerService", "Lorg/apache/openejb/core/timer/EjbTimerServiceImpl;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/timer/EjbTimerServiceImpl", "getTransactionManager", "()Ljavax/transaction/TransactionManager;", false);
