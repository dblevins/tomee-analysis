...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "setEntityContext", "(Ljakarta/ejb/EntityBean;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine$OpenJPALifecycleListener", "this$0", "Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine", "access$100", "(Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;)Lorg/apache/openejb/core/cmp/CmpCallback;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ejb/EntityBean");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "ejbActivate", "(Ljakarta/ejb/EntityBean;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine$OpenJPALifecycleListener", "this$0", "Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine", "access$100", "(Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;)Lorg/apache/openejb/core/cmp/CmpCallback;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ejb/EntityBean");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "ejbLoad", "(Ljakarta/ejb/EntityBean;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine", "access$100", "(Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;)Lorg/apache/openejb/core/cmp/CmpCallback;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "ejbStore", "(Ljakarta/ejb/EntityBean;)V", true);
...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/ejb/RemoveException");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine$OpenJPALifecycleListener", "eventOccurred", "(Lorg/apache/openjpa/event/LifecycleEvent;)V", false);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ejb/EntityBean");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "ejbRemove", "(Ljakarta/ejb/EntityBean;)V", true);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/ejb/RemoveException"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ejb/EntityBean");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "ejbPassivate", "(Ljakarta/ejb/EntityBean;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine$OpenJPALifecycleListener", "this$0", "Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/cmp/jpa/JpaCmpEngine", "access$100", "(Lorg/apache/openejb/core/cmp/jpa/JpaCmpEngine;)Lorg/apache/openejb/core/cmp/CmpCallback;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ejb/EntityBean");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/core/cmp/CmpCallback", "unsetEntityContext", "(Ljakarta/ejb/EntityBean;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
