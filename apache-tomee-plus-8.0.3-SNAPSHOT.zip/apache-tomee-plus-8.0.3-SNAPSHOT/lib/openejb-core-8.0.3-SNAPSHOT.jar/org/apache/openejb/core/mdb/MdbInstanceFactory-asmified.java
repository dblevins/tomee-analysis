...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createInstance", "(Z)Ljava/lang/Object;", null, new String[] { "javax/resource/spi/UnavailableException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTryCatchBlock(label4, label5, label6, "javax/resource/spi/UnavailableException");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/core/mdb/MdbInstanceFactory", Opcodes.INTEGER, "javax/resource/spi/UnavailableException", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(MONITOREXIT);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/ejb/MessageDrivenBean");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "recreateInstance", "(Ljava/lang/Object;)Ljava/lang/Object;", null, new String[] { "javax/resource/spi/UnavailableException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "constructBean", "()Ljava/lang/Object;", null, new String[] { "javax/resource/spi/UnavailableException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
