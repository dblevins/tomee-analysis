...
public class IntraVmArtifact$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/core/ivm/IntraVmArtifact$2", "Ljava/lang/ThreadLocal<Lorg/apache/openejb/core/ivm/IntraVmArtifact$Handles;>;", "java/lang/ThreadLocal", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initialValue", "()Lorg/apache/openejb/core/ivm/IntraVmArtifact$Handles;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/ivm/IntraVmArtifact$Handles");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/ivm/IntraVmArtifact$2", "initialValue", "()Lorg/apache/openejb/core/ivm/IntraVmArtifact$Handles;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
