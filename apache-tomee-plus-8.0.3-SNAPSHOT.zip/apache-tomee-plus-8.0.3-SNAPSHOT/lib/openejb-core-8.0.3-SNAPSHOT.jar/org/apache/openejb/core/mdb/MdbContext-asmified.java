...
public class MdbContextDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "flushable", "Ljava/io/Flushable;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbContext", "flushable", "Ljava/io/Flushable;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbContext$1", "$SwitchMap$org$apache$openejb$core$BaseContext$Call", "[I");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitTableSwitchInsn(1, 8, label2, new Label[] { label0, label0, label0, label1, label1, label1, label1, label1 });
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/openejb/core/Operation"}, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/mdb/MdbContext$1", "$SwitchMap$org$apache$openejb$core$Operation", "[I");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/Operation", "ordinal", "()I", false);
methodVisitor.visitInsn(IALOAD);
Label label3 = new Label();
Label label4 = new Label();
methodVisitor.visitLookupSwitchInsn(label4, new int[] { 1 }, new Label[] { label3 });
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbContext", "illegal", "(Lorg/apache/openejb/core/BaseContext$Call;Lorg/apache/openejb/core/Operation;)Ljava/lang/IllegalStateException;", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitTableSwitchInsn(1, 4, label6, new Label[] { label5, label5, label5, label5 });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbContext", "flushable", "Ljava/io/Flushable;");
