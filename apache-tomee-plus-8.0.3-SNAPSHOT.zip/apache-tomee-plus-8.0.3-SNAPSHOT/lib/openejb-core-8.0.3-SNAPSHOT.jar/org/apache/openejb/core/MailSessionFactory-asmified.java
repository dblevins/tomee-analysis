...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "create", "()Ljakarta/mail/Session;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/MailSessionFactory", "java/lang/String", "jakarta/mail/Authenticator", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/MailSessionFactory$1", "<init>", "(Lorg/apache/openejb/core/MailSessionFactory;Ljakarta/mail/PasswordAuthentication;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/MailSessionFactory", "properties", "Ljava/util/Properties;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/mail/Session", "getDefaultInstance", "(Ljava/util/Properties;)Ljakarta/mail/Session;", false);
methodVisitor.visitInsn(ARETURN);
