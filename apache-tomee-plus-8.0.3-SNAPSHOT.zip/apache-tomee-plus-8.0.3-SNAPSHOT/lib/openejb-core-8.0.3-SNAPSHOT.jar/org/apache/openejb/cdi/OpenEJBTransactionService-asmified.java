...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/cdi/OpenEJBTransactionService", "getTransactionManager", "()Ljakarta/transaction/TransactionManager;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openejb/cdi/OpenEJBTransactionService", "jakarta/transaction/TransactionManager"}, 1, new Object[] {"jakarta/transaction/SystemException"});
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/transaction/UserTransaction"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "registerTransactionSynchronization", "(Ljakarta/enterprise/event/TransactionPhase;Ljakarta/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;)V", "(Ljakarta/enterprise/event/TransactionPhase;Ljakarta/enterprise/inject/spi/ObserverMethod<-Ljava/lang/Object;>;Ljava/lang/Object;)V", new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/ee/event/TransactionalEventNotifier", "registerTransactionSynchronization", "(Ljakarta/enterprise/event/TransactionPhase;Ljakarta/enterprise/inject/spi/ObserverMethod;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/EventMetadata;)V", false);
methodVisitor.visitInsn(RETURN);
