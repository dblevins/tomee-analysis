...
public class RequiredInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/cdi/transactional/RequiredInterceptor", null, "org/apache/openejb/cdi/transactional/InterceptorBase", null);
...
annotationVisitor0.visitEnum("value", "Ljakarta/transaction/Transactional$TxType;", "REQUIRED");
annotationVisitor0.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getPolicy", "()Lorg/apache/openejb/core/transaction/TransactionPolicy;", null, new String[] { "org/apache/openejb/SystemException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/transaction/TxRequired");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/transactional/RequiredInterceptor", "getTransactionManager", "()Ljakarta/transaction/TransactionManager;", false);
