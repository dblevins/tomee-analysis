...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Class", "org/apache/openejb/cdi/CdiEjbBean", "javax/enterprise/context/spi/CreationalContext"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/openejb/cdi/CdiPlugin", "javax/enterprise/inject/spi/Bean", "java/lang/Class", "javax/enterprise/context/spi/CreationalContext", "java/lang/Object", "java/lang/Object", "java/lang/Class", "org/apache/openejb/cdi/CdiEjbBean", "javax/enterprise/context/spi/CreationalContext", "org/apache/openejb/cdi/CdiPlugin$InstanceBean", "org/apache/openejb/BeanContext", "javax/inject/Provider", "java/util/List", "org/apache/openejb/InterfaceType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/cdi/CdiPlugin$1", "<init>", "(Lorg/apache/openejb/cdi/CdiPlugin;Ljavax/inject/Provider;)V", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/cdi/CdiPlugin", "javax/enterprise/inject/spi/Bean", "java/lang/Class", "javax/enterprise/context/spi/CreationalContext", "java/lang/Object", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/cdi/OpenEJBBeanBuilder", "<init>", "(Lorg/apache/openejb/BeanContext;Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedType;Ljavax/enterprise/inject/spi/BeanAttributes;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/cdi/CdiPlugin", "java/lang/Class", "javax/enterprise/inject/spi/BeanAttributes", "javax/enterprise/inject/spi/AnnotatedType", "org/apache/openejb/BeanContext", "java/lang/Class"}, 2, new Object[] {"org/apache/openejb/cdi/OpenEJBBeanBuilder", "java/lang/Class"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label5);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessSessionBean", "<init>", "(Ljavax/enterprise/inject/spi/Bean;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/String;Ljavax/enterprise/inject/spi/SessionBeanType;)V", false);
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitInsn(ICONST_1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "defineNewSessionBean", "(Ljava/lang/Class;)Ljavax/enterprise/inject/spi/Bean;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)Ljavax/enterprise/inject/spi/Bean<TT;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "validateObserverMethods", "(Lorg/apache/openejb/cdi/CdiEjbBean;Ljava/util/Map;)V", "(Lorg/apache/openejb/cdi/CdiEjbBean<*>;Ljava/util/Map<Ljavax/enterprise/inject/spi/ObserverMethod<*>;Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/cdi/CdiEjbBean", "getBeanContext", "()Lorg/apache/openejb/BeanContext;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/CdiPlugin", "doResolveViewMethod", "(Ljavax/enterprise/inject/spi/Bean;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "doResolveViewMethod", "(Ljavax/enterprise/inject/spi/Bean;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", "(Ljavax/enterprise/inject/spi/Bean<*>;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"javax/enterprise/inject/spi/Bean", "java/lang/reflect/Method", "org/apache/openejb/cdi/CdiEjbBean", "org/apache/openejb/BeanContext", "java/util/Iterator", "java/lang/Class"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_CHOP,2, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "resolveViewMethod", "(Ljavax/enterprise/inject/spi/Bean;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", "(Ljavax/enterprise/inject/spi/Bean<*>;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/CdiPlugin", "doResolveViewMethod", "(Ljavax/enterprise/inject/spi/Bean;Ljava/lang/reflect/Method;)Ljava/lang/reflect/Method;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$validateObserverMethods$0", "(Ljavax/enterprise/inject/spi/AnnotatedParameter;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
