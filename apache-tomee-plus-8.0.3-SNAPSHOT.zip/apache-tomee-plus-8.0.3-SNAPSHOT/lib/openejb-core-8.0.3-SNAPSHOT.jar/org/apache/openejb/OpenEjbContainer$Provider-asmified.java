...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/OpenEjbContainer$Provider", null, "java/lang/Object", new String[] { "javax/ejb/spi/EJBContainerProvider" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createEJBContainer", "(Ljava/util/Map;)Ljavax/ejb/embeddable/EJBContainer;", "(Ljava/util/Map<**>;)Ljavax/ejb/embeddable/EJBContainer;", null);
methodVisitor.visitCode();
...
methodVisitor.visitTryCatchBlock(label3, label4, label6, "javax/validation/ValidationException");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/OpenEjbContainer$Provider", "java/util/Map", "java/util/Properties", "org/apache/openejb/AppContext", "org/apache/openejb/OpenEjbContainer", "javax/ejb/embeddable/EJBContainer"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/OpenEjbContainer$Provider", "java/util/Map", "org/apache/openejb/config/ConfigurationFactory", "org/apache/openejb/config/AppModule", "java/util/Set", "org/apache/openejb/jee/EjbJar", "org/apache/openejb/jee/oejb3/OpenejbJar", "org/apache/openejb/config/EjbModule", "org/apache/openejb/assembler/classic/AppInfo", "org/apache/openejb/assembler/classic/Assembler"}, 1, new Object[] {"javax/validation/ValidationException"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label7);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("javax.ejb.embeddable.appName");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("javax.ejb.embeddable.modules");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Thread", "currentThread", "()Ljava/lang/Thread;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Thread", "getContextClassLoader", "()Ljava/lang/ClassLoader;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/OpenEjbContainer$Provider", "specifiedModulesNotFound", "()Ljavax/ejb/EJBException;", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitJumpInsn(GOTO, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "specifiedModulesNotFound", "()Ljavax/ejb/EJBException;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("javax.ejb.embeddable.provider");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
