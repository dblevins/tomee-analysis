...
public class AttachmentUtil$DHMapDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/attachment/AttachmentUtil$DHMap", "Ljava/util/AbstractMap<Ljava/lang/String;Ljavax/activation/DataHandler;>;", "java/util/AbstractMap", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "list", "Ljava/util/Collection;", "Ljava/util/Collection<Lorg/apache/cxf/message/Attachment;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljava/util/Collection;)V", "(Ljava/util/Collection<Lorg/apache/cxf/message/Attachment;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/AbstractMap", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/attachment/AttachmentUtil$DHMap", "list", "Ljava/util/Collection;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/attachment/AttachmentUtil$DHMap$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/attachment/AttachmentUtil$DHMap$1", "<init>", "(Lorg/apache/cxf/attachment/AttachmentUtil$DHMap;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/Iterator", "javax/activation/DataHandler"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/attachment/AttachmentUtil$DHMap", "put", "(Ljava/lang/String;Ljavax/activation/DataHandler;)Ljavax/activation/DataHandler;", false);
methodVisitor.visitInsn(ARETURN);
