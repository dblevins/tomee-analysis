...
public class LazyAttachmentCollection$LazyAttachmentMap$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap$2", "Ljava/util/AbstractSet<Ljava/lang/String;>;", "java/util/AbstractSet", null);

classWriter.visitOuterClass("org/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap", "keySet", "()Ljava/util/Set;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap$2", "this$0", "Lorg/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap$2$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap$2$1", "<init>", "(Lorg/apache/cxf/attachment/LazyAttachmentCollection$LazyAttachmentMap$2;)V", false);
