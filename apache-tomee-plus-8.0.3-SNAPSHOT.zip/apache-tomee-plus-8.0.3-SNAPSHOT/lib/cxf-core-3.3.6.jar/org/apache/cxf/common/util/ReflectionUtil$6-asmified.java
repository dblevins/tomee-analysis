...
public class ReflectionUtil$6Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/cxf/common/util/ReflectionUtil$6", "Ljava/lang/Object;Ljava/security/PrivilegedAction<[Ljava/lang/reflect/Constructor<TT;>;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });

classWriter.visitOuterClass("org/apache/cxf/common/util/ReflectionUtil", "getDeclaredConstructors", "(Ljava/lang/Class;)[Ljava/lang/reflect/Constructor;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/util/ReflectionUtil$6", "val$cls", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/util/ReflectionUtil$6", "val$cls", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/util/ReflectionUtil$6", "run", "()[Ljava/lang/reflect/Constructor;", false);
methodVisitor.visitInsn(ARETURN);
