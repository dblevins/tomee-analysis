...
public class PerRequestFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/service/invoker/PerRequestFactory", null, "java/lang/Object", new String[] { "org/apache/cxf/service/invoker/Factory" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "svcClass", "Ljava/lang/Class;", "Ljava/lang/Class<*>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/service/invoker/PerRequestFactory", "svcClass", "Ljava/lang/Class;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/service/invoker/PerRequestFactory", "svcClass", "Ljava/lang/Class;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("SVC_CLASS_IS_INTERFACE");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/service/invoker/PerRequestFactory", "BUNDLE", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/i18n/Message");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("SVC_CLASS_IS_ABSTRACT");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/service/invoker/PerRequestFactory", "BUNDLE", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "org/apache/cxf/Bus", "org/apache/cxf/resource/ResourceManager"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/service/invoker/PerRequestFactory", "org/apache/cxf/message/Exchange"}, 1, new Object[] {"java/lang/InstantiationException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/interceptor/Fault");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/i18n/Message");
...
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/i18n/Message");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("ILLEGAL_ACCESS");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/service/invoker/PerRequestFactory", "BUNDLE", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/common/i18n/Message", "<init>", "(Ljava/lang/String;Ljava/util/ResourceBundle;[Ljava/lang/Object;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/service/invoker/PerRequestFactory;"));
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/service/invoker/PerRequestFactory", "BUNDLE", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
