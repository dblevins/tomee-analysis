...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/service/model/ServiceInfo;Lorg/apache/cxf/common/xmlschema/SchemaCollection;Ljakarta/xml/bind/JAXBContext;ZLjava/lang/String;)V", null, null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljava/lang/annotation/Annotation;", "jakarta/xml/bind/annotation/adapters/XmlJavaTypeAdapter", "org/apache/cxf/common/jaxb/JAXBBeanInfo"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxb/JAXBSchemaInitializer", "getBeanInfo", "(Ljava/lang/Class;)Lorg/apache/cxf/common/jaxb/JAXBBeanInfo;", false);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/jaxb/JAXBSchemaInitializer", "org/apache/cxf/service/model/MessagePartInfo", "java/lang/Class", "org/apache/cxf/service/model/SchemaInfo", "jakarta/xml/bind/annotation/XmlAccessorOrder", "jakarta/xml/bind/annotation/XmlType", "[Ljava/lang/String;", Opcodes.INTEGER, "org/apache/ws/commons/schema/XmlSchema"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
Label label4 = new Label();
...
Label label10 = new Label();
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/apache/cxf/jaxb/JAXBSchemaInitializer", "org/apache/cxf/service/model/MessagePartInfo", "java/lang/Class", "org/apache/cxf/service/model/SchemaInfo", "jakarta/xml/bind/annotation/XmlAccessorOrder", "jakarta/xml/bind/annotation/XmlType", "[Ljava/lang/String;", Opcodes.INTEGER, "org/apache/ws/commons/schema/XmlSchema", "org/apache/ws/commons/schema/XmlSchema", "java/lang/String", "org/apache/ws/commons/schema/XmlSchemaType", "org/apache/ws/commons/schema/XmlSchemaElement", "org/apache/ws/commons/schema/XmlSchemaComplexType", "org/apache/ws/commons/schema/XmlSchemaSequence", "java/lang/String", "jakarta/xml/bind/annotation/XmlAccessType", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label11 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxb/JAXBSchemaInitializer", "addElement", "(Lorg/apache/ws/commons/schema/XmlSchema;Lorg/apache/ws/commons/schema/XmlSchemaSequence;Lorg/apache/cxf/common/jaxb/JAXBBeanInfo;Ljavax/xml/namespace/QName;ZLjakarta/xml/bind/annotation/XmlElement;)V", false);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_CHOP,2, null, 0, null);
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label11);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/ws/commons/schema/XmlSchemaSequence", "jakarta/xml/bind/annotation/XmlAccessType", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/cxf/jaxb/JAXBSchemaInitializer", "org/apache/ws/commons/schema/XmlSchema", "org/apache/ws/commons/schema/XmlSchemaComplexType", "java/lang/Class", "org/apache/ws/commons/schema/XmlSchemaSequence", "jakarta/xml/bind/annotation/XmlAccessType", "java/util/Iterator", "java/lang/reflect/Field", "java/lang/String", "org/apache/ws/commons/schema/XmlSchemaElement", "org/apache/cxf/common/jaxb/JAXBBeanInfo", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/namespace/QName");
methodVisitor.visitVarInsn(ASTORE, 12);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxb/JAXBSchemaInitializer", "org/apache/ws/commons/schema/XmlSchema", "org/apache/ws/commons/schema/XmlSchemaComplexType", "java/lang/Class", "org/apache/ws/commons/schema/XmlSchemaSequence", "jakarta/xml/bind/annotation/XmlAccessType", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/cxf/jaxb/JAXBSchemaInitializer", "org/apache/ws/commons/schema/XmlSchema", "org/apache/ws/commons/schema/XmlSchemaComplexType", "java/lang/Class", "org/apache/ws/commons/schema/XmlSchemaSequence", "jakarta/xml/bind/annotation/XmlAccessType", "java/util/Iterator", "java/lang/reflect/Method", Opcodes.INTEGER, "java/lang/String", "org/apache/ws/commons/schema/XmlSchemaElement", "org/apache/cxf/common/jaxb/JAXBBeanInfo", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/namespace/QName");
methodVisitor.visitVarInsn(ASTORE, 13);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "addElement", "(Lorg/apache/ws/commons/schema/XmlSchema;Lorg/apache/ws/commons/schema/XmlSchemaSequence;Lorg/apache/cxf/common/jaxb/JAXBBeanInfo;Ljavax/xml/namespace/QName;ZLjakarta/xml/bind/annotation/XmlElement;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/ws/commons/schema/XmlSchemaElement");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
