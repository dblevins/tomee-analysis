...
public class AbstractCacheEventQueue$DisposeEventDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/jcs/engine/AbstractCacheEventQueue$DisposeEvent", "Lorg/apache/commons/jcs/engine/AbstractCacheEventQueue<TK;TV;>.AbstractCacheEvent;", "org/apache/commons/jcs/engine/AbstractCacheEventQueue$AbstractCacheEvent", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/jcs/engine/AbstractCacheEventQueue$DisposeEvent", "this$0", "Lorg/apache/commons/jcs/engine/AbstractCacheEventQueue;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/engine/AbstractCacheEventQueue$DisposeEvent", "this$0", "Lorg/apache/commons/jcs/engine/AbstractCacheEventQueue;");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/commons/jcs/engine/behavior/ICacheListener", "handleDispose", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("DisposeEvent");
