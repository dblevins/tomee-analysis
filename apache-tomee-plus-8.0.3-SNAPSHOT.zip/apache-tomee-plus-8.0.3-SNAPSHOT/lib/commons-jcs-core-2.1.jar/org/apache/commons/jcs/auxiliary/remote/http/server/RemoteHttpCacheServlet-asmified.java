...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", null, "javax/servlet/http/HttpServlet", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", "readRequest", "(Ljavax/servlet/http/HttpServletRequest;)Lorg/apache/commons/jcs/auxiliary/remote/value/RemoteCacheRequest;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", "writeResponse", "(Ljavax/servlet/http/HttpServletResponse;Lorg/apache/commons/jcs/auxiliary/remote/value/RemoteCacheResponse;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 5);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "readRequest", "(Ljavax/servlet/http/HttpServletRequest;)Lorg/apache/commons/jcs/auxiliary/remote/value/RemoteCacheRequest;", "(Ljavax/servlet/http/HttpServletRequest;)Lorg/apache/commons/jcs/auxiliary/remote/value/RemoteCacheRequest<Ljava/io/Serializable;Ljava/io/Serializable;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", "javax/servlet/http/HttpServletRequest", "org/apache/commons/jcs/auxiliary/remote/value/RemoteCacheRequest"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", "log", "Lorg/apache/commons/logging/Log;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "writeResponse", "(Ljavax/servlet/http/HttpServletResponse;Lorg/apache/commons/jcs/auxiliary/remote/value/RemoteCacheResponse;)V", "(Ljavax/servlet/http/HttpServletResponse;Lorg/apache/commons/jcs/auxiliary/remote/value/RemoteCacheResponse<Ljava/lang/Object;>;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", "javax/servlet/http/HttpServletResponse", "org/apache/commons/jcs/auxiliary/remote/value/RemoteCacheResponse"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/jcs/auxiliary/remote/http/server/RemoteHttpCacheServlet", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
