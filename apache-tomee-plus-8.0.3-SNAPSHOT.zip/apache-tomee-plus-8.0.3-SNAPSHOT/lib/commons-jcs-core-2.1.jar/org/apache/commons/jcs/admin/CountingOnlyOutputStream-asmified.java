...
public class CountingOnlyOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/jcs/admin/CountingOnlyOutputStream", null, "java/io/OutputStream", null);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/jcs/admin/CountingOnlyOutputStream", "count", "I");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitInsn(IADD);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/jcs/admin/CountingOnlyOutputStream", "count", "I");
methodVisitor.visitInsn(RETURN);
