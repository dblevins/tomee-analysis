...
public class IElementEventQueueDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/commons/jcs/engine/control/event/behavior/IElementEventQueue", null, "java/lang/Object", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addElementEvent", "(Lorg/apache/commons/jcs/engine/control/event/behavior/IElementEventHandler;Lorg/apache/commons/jcs/engine/control/event/behavior/IElementEvent;)V", "<T:Ljava/lang/Object;>(Lorg/apache/commons/jcs/engine/control/event/behavior/IElementEventHandler;Lorg/apache/commons/jcs/engine/control/event/behavior/IElementEvent<TT;>;)V", new String[] { "java/io/IOException" });
