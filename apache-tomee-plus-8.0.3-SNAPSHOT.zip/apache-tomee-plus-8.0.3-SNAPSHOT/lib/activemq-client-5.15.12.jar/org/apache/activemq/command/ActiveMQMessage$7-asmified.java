...
public class ActiveMQMessage$7Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/activemq/command/ActiveMQMessage$7", null, "java/lang/Object", new String[] { "org/apache/activemq/command/ActiveMQMessage$PropertySetter" });
...
methodVisitor.visitLdcInsn("Property JMSPriority cannot be set from a ");
