...
public class ActiveMQMessage$9Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/activemq/command/ActiveMQMessage$9", null, "java/lang/Object", new String[] { "org/apache/activemq/command/ActiveMQMessage$PropertySetter" });
...
methodVisitor.visitLdcInsn("Property JMSReplyTo cannot be set from a ");
