...
public class MulticastDiscoveryAgent$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$1", null, "java/lang/Object", new String[] { "java/lang/Runnable" });

classWriter.visitOuterClass("org/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent", "fireServiceRemovedEvent", "(Lorg/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$RemoteBrokerData;)V");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$1", "this$0", "Lorg/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$1", "val$data", "Lorg/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$RemoteBrokerData;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$1", "this$0", "Lorg/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$1", "val$data", "Lorg/apache/activemq/transport/discovery/multicast/MulticastDiscoveryAgent$RemoteBrokerData;");
