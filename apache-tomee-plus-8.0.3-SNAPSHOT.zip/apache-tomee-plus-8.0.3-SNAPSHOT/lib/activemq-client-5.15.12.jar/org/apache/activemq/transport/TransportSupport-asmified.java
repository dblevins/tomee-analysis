...
public class TransportSupportDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/activemq/transport/TransportSupport", null, "org/apache/activemq/util/ServiceSupport", new String[] { "org/apache/activemq/transport/Transport" });
...
{
fieldVisitor = classWriter.visitField(0, "transportListener", "Lorg/apache/activemq/transport/TransportListener;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/transport/TransportSupport", "transportListener", "Lorg/apache/activemq/transport/TransportListener;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/transport/TransportSupport", "transportListener", "Lorg/apache/activemq/transport/TransportListener;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/transport/TransportSupport", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("No transportListener available to process inbound command: ");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkStarted", "()V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/transport/TransportSupport", "isStarted", "()Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitTypeInsn(NEW, "java/io/IOException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("The transport is not running.");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/transport/TransportSupport", "isStopped", "()Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/activemq/transport/TransportSupport;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/transport/TransportSupport", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitInsn(RETURN);
