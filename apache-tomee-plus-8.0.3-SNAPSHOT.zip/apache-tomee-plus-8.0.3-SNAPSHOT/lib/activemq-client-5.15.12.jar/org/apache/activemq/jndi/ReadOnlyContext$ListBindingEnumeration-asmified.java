...
public class ReadOnlyContext$ListBindingEnumerationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/jndi/ReadOnlyContext$ListBindingEnumeration", null, "org/apache/activemq/jndi/ReadOnlyContext$LocalNamingEnumeration", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/jndi/ReadOnlyContext$ListBindingEnumeration", "this$0", "Lorg/apache/activemq/jndi/ReadOnlyContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/jndi/ReadOnlyContext$ListBindingEnumeration", "nextElement", "()Ljava/lang/Object;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/jndi/ReadOnlyContext$ListBindingEnumeration", "getNext", "()Ljava/util/Map$Entry;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitTypeInsn(NEW, "javax/naming/Binding");
