...
public class ActiveMQInitialContextFactory$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/jndi/ActiveMQInitialContextFactory$2", null, "org/apache/activemq/jndi/LazyCreateContext", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(2019166796234979615L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/jndi/ActiveMQInitialContextFactory$2", "this$0", "Lorg/apache/activemq/jndi/ActiveMQInitialContextFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
