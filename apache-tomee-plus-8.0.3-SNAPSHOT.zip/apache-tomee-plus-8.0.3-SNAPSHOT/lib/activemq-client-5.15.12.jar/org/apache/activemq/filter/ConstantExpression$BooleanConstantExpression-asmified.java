...
public class ConstantExpression$BooleanConstantExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/filter/ConstantExpression$BooleanConstantExpression", null, "org/apache/activemq/filter/ConstantExpression", new String[] { "org/apache/activemq/filter/BooleanExpression" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/filter/ConstantExpression$BooleanConstantExpression", "evaluate", "(Lorg/apache/activemq/filter/MessageEvaluationContext;)Ljava/lang/Object;", false);
