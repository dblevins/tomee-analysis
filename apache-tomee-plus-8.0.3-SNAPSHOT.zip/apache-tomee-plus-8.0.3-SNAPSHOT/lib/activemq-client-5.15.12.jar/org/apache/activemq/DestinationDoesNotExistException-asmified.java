...
public class DestinationDoesNotExistExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/DestinationDoesNotExistException", null, "jakarta/jms/JMSException", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/DestinationDoesNotExistException", "getMessage", "()Ljava/lang/String;", false);
