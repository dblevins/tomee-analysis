...
public class JMSConsumerStatsImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/management/JMSConsumerStatsImpl", null, "org/apache/activemq/management/JMSEndpointStatsImpl", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "origin", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/activemq/management/JMSSessionStatsImpl;Ljakarta/jms/Destination;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/management/JMSConsumerStatsImpl", "origin", "Ljava/lang/String;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/management/JMSConsumerStatsImpl", "org/apache/activemq/management/JMSSessionStatsImpl", "jakarta/jms/Destination"}, 0, new Object[] {});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/management/JMSConsumerStatsImpl", "origin", "Ljava/lang/String;");
