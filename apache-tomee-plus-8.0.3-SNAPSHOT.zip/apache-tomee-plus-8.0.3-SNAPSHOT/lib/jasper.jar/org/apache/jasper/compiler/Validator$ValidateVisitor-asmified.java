...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor", "expressionFactory", "Ljakarta/el/ExpressionFactory;");
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/compiler/Validator$ValidateVisitor", "getJspAttribute", "(Ljakarta/servlet/jsp/tagext/TagAttributeInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/apache/jasper/compiler/Node;Lorg/apache/jasper/compiler/ELNode$Nodes;Z)Lorg/apache/jasper/compiler/Node$JspAttribute;", false);
...
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/tagext/TagInfo", "getBodyContent", "()Ljava/lang/String;", false);
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "java/lang/String", "org/xml/sax/Attributes"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/xml/sax/Attributes", "getLength", "()I", true);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {Opcodes.INTEGER});
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "java/lang/String", "org/xml/sax/Attributes", Opcodes.INTEGER, "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/tagext/TagAttributeInfo", "isRequired", "()Z", false);
...
methodVisitor.visitTypeInsn(NEW, "jakarta/servlet/jsp/tagext/TagData");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/jsp/tagext/TagData", "<init>", "(Ljava/util/Hashtable;)V", false);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagData", "jakarta/servlet/jsp/tagext/TagExtraInfo"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/Node$CustomTag", "setTagData", "(Ljakarta/servlet/jsp/tagext/TagData;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/compiler/Node$JspAttribute", "<init>", "(Lorg/apache/jasper/compiler/Node$NamedAttribute;Ljakarta/servlet/jsp/tagext/TagAttributeInfo;Z)V", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitIincInsn(8, 1);
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "[Lorg/apache/jasper/compiler/Node$JspAttribute;", "java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "org/xml/sax/Attributes", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label7);
methodVisitor.visitVarInsn(ILOAD, 7);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/tagext/TagLibraryInfo", "getRequiredVersion", "()Ljava/lang/String;", false);
...
methodVisitor.visitLabel(label12);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "[Lorg/apache/jasper/compiler/Node$JspAttribute;", "java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "org/xml/sax/Attributes", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.DOUBLE}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "[Lorg/apache/jasper/compiler/Node$JspAttribute;", "java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "org/xml/sax/Attributes", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.DOUBLE, Opcodes.INTEGER, "java/lang/String", "org/apache/jasper/compiler/ELNode$Nodes", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 22, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "[Lorg/apache/jasper/compiler/Node$JspAttribute;", "java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "org/xml/sax/Attributes", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.DOUBLE, Opcodes.INTEGER, "java/lang/String", "org/apache/jasper/compiler/ELNode$Nodes", Opcodes.INTEGER, "java/lang/String", Opcodes.INTEGER, "jakarta/servlet/jsp/tagext/TagAttributeInfo", "java/lang/String", "java/lang/Class"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor", "expressionFactory", "Ljakarta/el/ExpressionFactory;");
methodVisitor.visitVarInsn(ALOAD, 18);
methodVisitor.visitVarInsn(ALOAD, 22);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/compiler/Node$JspAttribute", "<init>", "(Ljakarta/servlet/jsp/tagext/TagAttributeInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLorg/apache/jasper/compiler/ELNode$Nodes;Z)V", false);
methodVisitor.visitInsn(AASTORE);
...
methodVisitor.visitVarInsn(ILOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/xml/sax/Attributes", "getQName", "(I)Ljava/lang/String;", true);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/jsp/tagext/TagData", "REQUEST_TIME_VALUE", "Ljava/lang/Object;");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "[Lorg/apache/jasper/compiler/Node$JspAttribute;", Opcodes.INTEGER, "java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "org/apache/jasper/compiler/Node$Nodes", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/Node$Nodes", "size", "()I", false);
Label label1 = new Label();
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/Node$CustomTag", "[Lorg/apache/jasper/compiler/Node$JspAttribute;", Opcodes.INTEGER, "java/util/Hashtable", "jakarta/servlet/jsp/tagext/TagInfo", "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", "org/apache/jasper/compiler/Node$Nodes", Opcodes.INTEGER, "org/apache/jasper/compiler/Node$NamedAttribute", Opcodes.INTEGER, "[Ljakarta/servlet/jsp/tagext/TagAttributeInfo;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getJspAttribute", "(Ljakarta/servlet/jsp/tagext/TagAttributeInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/apache/jasper/compiler/Node;Lorg/apache/jasper/compiler/ELNode$Nodes;Z)Lorg/apache/jasper/compiler/Node$JspAttribute;", null, new String[] { "org/apache/jasper/JasperException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor", "expressionFactory", "Ljakarta/el/ExpressionFactory;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/el/ELContextImpl", "<init>", "(Ljakarta/el/ExpressionFactory;)V", false);
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/compiler/Validator$ValidateVisitor", "getFunctionMapper", "(Lorg/apache/jasper/compiler/ELNode$Nodes;)Ljakarta/el/FunctionMapper;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor", "pageInfo", "Lorg/apache/jasper/compiler/PageInfo;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/PageInfo", "getExpressionFactory", "()Ljakarta/el/ExpressionFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/Node$JspAttribute", "validateEL", "(Ljakarta/el/ExpressionFactory;Ljakarta/el/ELContext;)V", false);
methodVisitor.visitLabel(label1);
Label label14 = new Label();
methodVisitor.visitJumpInsn(GOTO, label14);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "jakarta/servlet/jsp/tagext/TagAttributeInfo", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "org/apache/jasper/compiler/Node", "org/apache/jasper/compiler/ELNode$Nodes", Opcodes.INTEGER, "org/apache/jasper/compiler/Node$JspAttribute", "org/apache/jasper/el/ELContextImpl"}, 1, new Object[] {"jakarta/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor", "err", "Lorg/apache/jasper/compiler/ErrorDispatcher;");
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/ELNode$Nodes", "org/apache/jasper/compiler/Node", "java/lang/String", "org/apache/jasper/el/ELContextImpl", "jakarta/el/ExpressionFactory"}, 1, new Object[] {"jakarta/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/tagext/FunctionInfo", "getFunctionSignature", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/ErrorDispatcher", "jspError", "(Ljava/lang/String;[Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/servlet/jsp/tagext/FunctionInfo", "java/lang/String", "java/util/regex/Matcher"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ICONST_1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/jasper/compiler/Validator$ValidateVisitor", "org/apache/jasper/compiler/ELNode$Function", "jakarta/servlet/jsp/tagext/FunctionInfo", "java/lang/String", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getFunctionMapper", "(Lorg/apache/jasper/compiler/ELNode$Nodes;)Ljakarta/el/FunctionMapper;", null, new String[] { "org/apache/jasper/JasperException" });
methodVisitor.visitCode();
