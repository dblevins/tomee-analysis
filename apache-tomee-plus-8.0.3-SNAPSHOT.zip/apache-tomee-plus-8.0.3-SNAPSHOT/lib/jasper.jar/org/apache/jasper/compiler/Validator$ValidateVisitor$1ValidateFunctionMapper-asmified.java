...
public class Validator$ValidateVisitor$1ValidateFunctionMapperDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "fnmap", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Ljava/lang/reflect/Method;>;", null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/jasper/compiler/Validator$ValidateVisitor;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor$1ValidateFunctionMapper", "fnmap", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Validator$ValidateVisitor$1ValidateFunctionMapper", "fnmap", "Ljava/util/Map;");
