...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", null, "jakarta/servlet/jsp/tagext/TagLibraryValidator", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowDeclarations", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowScriptlets", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowExpressions", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowRTExpressions", "Z");
...
methodVisitor.visitTypeInsn(NEW, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV$MyContentHandler");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV$MyContentHandler", "<init>", "(Ljakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV;Ljakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV$1;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "parser", "Ljakarta/servlet/jsp/jstl/tlv/PageParser;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV$MyContentHandler", "reportResults", "()[Ljakarta/servlet/jsp/tagext/ValidationMessage;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "vmFromString", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "vmFromString", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Ljakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowDeclarations", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$200", "(Ljakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowScriptlets", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$300", "(Ljakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowExpressions", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$400", "(Ljakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "allowRTExpressions", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$500", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "vmFromString", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/servlet/jsp/jstl/tlv/ScriptFreeTLV", "parser", "Ljakarta/servlet/jsp/jstl/tlv/PageParser;");
methodVisitor.visitInsn(RETURN);
