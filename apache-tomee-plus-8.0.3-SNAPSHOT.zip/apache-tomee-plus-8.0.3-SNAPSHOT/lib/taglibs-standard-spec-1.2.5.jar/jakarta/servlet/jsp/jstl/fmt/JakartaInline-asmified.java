...
classWriter.visit(V1_5, ACC_SUPER, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getLocalizationContext", "(Ljakarta/servlet/jsp/PageContext;)Ljakarta/servlet/jsp/jstl/fmt/LocalizationContext;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getLocalizationContext", "(Ljakarta/servlet/jsp/PageContext;Ljava/lang/String;)Ljakarta/servlet/jsp/jstl/fmt/LocalizationContext;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "findMatch", "(Ljava/lang/String;Ljava/util/Locale;)Ljava/util/ResourceBundle;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "findMatch", "(Ljakarta/servlet/jsp/PageContext;Ljava/lang/String;)Ljakarta/servlet/jsp/jstl/fmt/LocalizationContext;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "getClassLoaderCheckingPrivilege", "()Ljava/lang/ClassLoader;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "EMPTY_LOCALE", "Ljava/util/Locale;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/jstl/fmt/LocalizationContext", "getLocale", "()Ljava/util/Locale;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "setResponseLocale", "(Ljakarta/servlet/jsp/PageContext;Ljava/util/Locale;)V", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "getRequestLocales", "(Ljakarta/servlet/http/HttpServletRequest;)Ljava/util/Enumeration;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "jakarta/servlet/jsp/jstl/fmt/JakartaInline$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/jsp/jstl/fmt/JakartaInline$1", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "setResponseLocale", "(Ljakarta/servlet/jsp/PageContext;Ljava/util/Locale;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getLocale", "(Ljakarta/servlet/jsp/PageContext;Ljava/lang/String;)Ljava/util/Locale;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "parseLocale", "(Ljava/lang/String;Ljava/lang/String;)Ljava/util/Locale;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLdcInsn("");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/Locale", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/servlet/jsp/jstl/fmt/JakartaInline", "EMPTY_LOCALE", "Ljava/util/Locale;");
methodVisitor.visitInsn(RETURN);
