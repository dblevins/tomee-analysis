...
public class RuntimeBuiltinLeafInfoImpl$StringImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_ABSTRACT, "com/sun/xml/bind/v2/model/impl/RuntimeBuiltinLeafInfoImpl$StringImpl", "<T:Ljava/lang/Object;>Lcom/sun/xml/bind/v2/model/impl/RuntimeBuiltinLeafInfoImpl<TT;>;", "com/sun/xml/bind/v2/model/impl/RuntimeBuiltinLeafInfoImpl", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "print", "(Ljava/lang/Object;)Ljava/lang/String;", "(TT;)Ljava/lang/String;", new String[] { "com/sun/xml/bind/api/AccessorException" });
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/model/impl/RuntimeBuiltinLeafInfoImpl$StringImpl", "print", "(Ljava/lang/Object;)Ljava/lang/String;", false);
