...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "adapter", "Ljava/lang/Class;", "Ljava/lang/Class<+Ljakarta/xml/bind/annotation/adapters/XmlAdapter<TOnWireValueT;TInMemValueT;>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "staticAdapter", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter;", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter<TOnWireValueT;TInMemValueT;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljava/lang/Class;Lcom/sun/xml/bind/v2/runtime/reflect/Accessor;Ljava/lang/Class;)V", "(Ljava/lang/Class<TOnWireValueT;>;Lcom/sun/xml/bind/v2/runtime/reflect/Accessor<TBeanT;TInMemValueT;>;Ljava/lang/Class<+Ljakarta/xml/bind/annotation/adapters/XmlAdapter<TOnWireValueT;TInMemValueT;>;>;)V", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/xml/bind/v2/runtime/reflect/AdaptedAccessor", "getAdapter", "()Ljakarta/xml/bind/annotation/adapters/XmlAdapter;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/AdaptedAccessor", "java/lang/Object", "java/lang/Object", "jakarta/xml/bind/annotation/adapters/XmlAdapter"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/AdaptedAccessor", "java/lang/Object", "java/lang/Object", "jakarta/xml/bind/annotation/adapters/XmlAdapter"}, 2, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/Accessor", "java/lang/Object"});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/AdaptedAccessor", "java/lang/Object", "java/lang/Object", "jakarta/xml/bind/annotation/adapters/XmlAdapter"}, 3, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/Accessor", "java/lang/Object", "java/lang/Object"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getAdapter", "()Ljakarta/xml/bind/annotation/adapters/XmlAdapter;", "()Ljakarta/xml/bind/annotation/adapters/XmlAdapter<TOnWireValueT;TInMemValueT;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/reflect/AdaptedAccessor", "staticAdapter", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter;");
Label label5 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/v2/runtime/reflect/AdaptedAccessor", "staticAdapter", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter;");
methodVisitor.visitLabel(label5);
