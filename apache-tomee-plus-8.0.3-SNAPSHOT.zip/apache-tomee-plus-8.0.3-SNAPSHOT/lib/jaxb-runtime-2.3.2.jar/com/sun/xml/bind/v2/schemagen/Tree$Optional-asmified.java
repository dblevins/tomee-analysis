...
public class Tree$OptionalDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_FINAL | ACC_SUPER, "com/sun/xml/bind/v2/schemagen/Tree$Optional", null, "com/sun/xml/bind/v2/schemagen/Tree", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/v2/schemagen/Tree$Optional", "body", "Lcom/sun/xml/bind/v2/schemagen/Tree;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/schemagen/Tree$Optional", "body", "Lcom/sun/xml/bind/v2/schemagen/Tree;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/xml/bind/v2/schemagen/Tree$Optional", "<init>", "(Lcom/sun/xml/bind/v2/schemagen/Tree;)V", false);
methodVisitor.visitInsn(RETURN);
