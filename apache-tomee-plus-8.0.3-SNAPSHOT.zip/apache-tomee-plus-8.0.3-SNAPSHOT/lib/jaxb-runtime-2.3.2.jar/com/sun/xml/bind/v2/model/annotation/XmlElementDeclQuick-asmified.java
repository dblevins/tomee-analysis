...
classWriter.visit(V1_7, ACC_FINAL | ACC_SUPER, "com/sun/xml/bind/v2/model/annotation/XmlElementDeclQuick", null, "com/sun/xml/bind/v2/model/annotation/Quick", new String[] { "jakarta/xml/bind/annotation/XmlElementDecl" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "core", "Ljakarta/xml/bind/annotation/XmlElementDecl;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lcom/sun/xml/bind/v2/model/annotation/Locatable;Ljakarta/xml/bind/annotation/XmlElementDecl;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/v2/model/annotation/XmlElementDeclQuick", "core", "Ljakarta/xml/bind/annotation/XmlElementDecl;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/model/annotation/XmlElementDeclQuick", "core", "Ljakarta/xml/bind/annotation/XmlElementDecl;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "annotationType", "()Ljava/lang/Class;", "()Ljava/lang/Class<Ljakarta/xml/bind/annotation/XmlElementDecl;>;", null);
methodVisitor.visitCode();
