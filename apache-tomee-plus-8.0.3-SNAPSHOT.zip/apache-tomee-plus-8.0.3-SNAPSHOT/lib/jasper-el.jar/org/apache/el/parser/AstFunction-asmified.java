...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/el/FunctionMapper"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/parser/AstFunction", "prefix", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/el/parser/AstFunction", "org/apache/el/lang/EvaluationContext", "jakarta/el/FunctionMapper", "java/lang/reflect/Method", "org/apache/el/parser/Node", "[Ljava/lang/Class;", "[Ljava/lang/Object;", "java/lang/Object", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 8);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/el/parser/AstFunction", "coerceToType", "(Ljakarta/el/ELContext;Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(AASTORE);
