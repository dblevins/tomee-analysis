...
classWriter.visitOuterClass("org/apache/el/stream/Stream", "map", "(Ljakarta/el/LambdaExpression;)Lorg/apache/el/stream/Stream;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/stream/Stream$2", "val$le", "Ljakarta/el/LambdaExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/stream/Stream$2", "val$le", "Ljakarta/el/LambdaExpression;");
