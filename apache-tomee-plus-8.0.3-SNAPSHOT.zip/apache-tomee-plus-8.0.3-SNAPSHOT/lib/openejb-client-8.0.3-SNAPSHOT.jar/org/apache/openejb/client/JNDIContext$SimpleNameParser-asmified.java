...
public class JNDIContext$SimpleNameParserDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/client/JNDIContext$SimpleNameParser", null, "java/lang/Object", new String[] { "javax/naming/NameParser" });
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/client/JNDIContext$SimpleNameParser", "PARSER_PROPERTIES", "Ljava/util/Properties;");
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/openejb/client/JNDIContext$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/client/JNDIContext$SimpleNameParser", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/client/JNDIContext$SimpleNameParser", "PARSER_PROPERTIES", "Ljava/util/Properties;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/client/JNDIContext$SimpleNameParser", "PARSER_PROPERTIES", "Ljava/util/Properties;");
