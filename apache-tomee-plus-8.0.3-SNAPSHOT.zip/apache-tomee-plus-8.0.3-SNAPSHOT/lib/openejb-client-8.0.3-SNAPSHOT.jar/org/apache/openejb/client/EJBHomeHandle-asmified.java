...
public class EJBHomeHandleDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-5221661986423761808L));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_TRANSIENT, "ejbHomeProxy", "Lorg/apache/openejb/client/EJBHomeProxy;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_TRANSIENT, "handler", "Lorg/apache/openejb/client/EJBHomeHandler;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/client/EJBHomeProxy;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/EJBHomeHandle", "ejbHomeProxy", "Lorg/apache/openejb/client/EJBHomeProxy;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/client/EJBHomeProxy", "getEJBHomeHandler", "()Lorg/apache/openejb/client/EJBHomeHandler;", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/EJBHomeHandle", "handler", "Lorg/apache/openejb/client/EJBHomeHandler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/EJBHomeHandle", "metaData", "Lorg/apache/openejb/client/ProtocolMetaData;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/EJBHomeHandle", "handler", "Lorg/apache/openejb/client/EJBHomeHandler;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/EJBHomeHandle", "metaData", "Lorg/apache/openejb/client/ProtocolMetaData;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/client/EJBHomeHandle", "getClassName", "(Ljava/lang/Class;)Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/client/EJBHomeHandle", "java/io/ObjectInput", Opcodes.INTEGER, Opcodes.TOP, Opcodes.INTEGER}, 2, new Object[] {label2, label2});
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/client/EJBHomeHandle", "java/io/ObjectInput", Opcodes.INTEGER, Opcodes.TOP, Opcodes.INTEGER}, 3, new Object[] {label2, label2, Opcodes.INTEGER});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/client/EJBHomeHandle", "java/io/ObjectInput", Opcodes.INTEGER, "java/util/concurrent/ThreadPoolExecutor", "org/apache/openejb/client/ClientMetaData", "org/apache/openejb/client/EJBMetaDataImpl", "org/apache/openejb/client/ServerMetaData", "java/lang/ClassLoader"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/io/ObjectInput", "readObject", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/client/EJBHomeHandle", "loadClass", "(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/lang/Class;", false);
