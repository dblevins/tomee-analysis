...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/client/JaxWsProviderWrapper", null, "javax/xml/ws/spi/Provider", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/client/JaxWsProviderWrapper", "findProvider", "()Ljavax/xml/ws/spi/Provider;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/JaxWsProviderWrapper", "delegate", "Ljavax/xml/ws/spi/Provider;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/client/JaxWsProviderWrapper", "threadPortRefs", "Ljava/lang/ThreadLocal;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/ThreadLocal", "get", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/client/JaxWsProviderWrapper$ProviderWrapperData");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/JaxWsProviderWrapper", "delegate", "Ljavax/xml/ws/spi/Provider;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/client/JaxWsProviderWrapper$ServiceDelegateWrapper", "<init>", "(Lorg/apache/openejb/client/JaxWsProviderWrapper;Ljavax/xml/ws/spi/ServiceDelegate;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/client/JaxWsProviderWrapper", "createProviderInstance", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljavax/xml/ws/spi/Provider;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/util/Iterator", "java/net/URL", "java/io/BufferedReader", "javax/xml/ws/spi/Provider"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/util/Iterator", "java/net/URL", "java/io/BufferedReader", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitLdcInsn("No META-INF/services/javax.xml.ws.spi.Provider found");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/lang/String", "java/io/File", "java/io/InputStream", "java/util/Properties", "javax/xml/ws/spi/Provider"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/lang/String", "java/io/File", "java/io/InputStream", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/lang/String", "java/io/File"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/client/JaxWsProviderWrapper", "JAXWSPROVIDER_PROPERTY", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getProperty", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/ws/spi/Provider"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"java/lang/ClassLoader", "java/lang/String", "javax/xml/ws/spi/Provider", "java/lang/String", "java/io/File", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
