...
public class CompositeArchiveDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/finder/archive/CompositeArchive", null, "java/lang/Object", new String[] { "org/apache/xbean/finder/archive/Archive" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "archives", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/xbean/finder/archive/Archive;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "<init>", "([Lorg/apache/xbean/finder/archive/Archive;)V", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Iterable;)V", "(Ljava/lang/Iterable<Lorg/apache/xbean/finder/archive/Archive;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/finder/archive/CompositeArchive", "archives", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/finder/archive/CompositeArchive", "archives", "Ljava/util/List;");
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "org/apache/xbean/finder/archive/CompositeArchive$CompositeIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/finder/archive/CompositeArchive", "archives", "Ljava/util/List;");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xbean/finder/archive/CompositeArchive$CompositeIterator", "<init>", "(Ljava/lang/Iterable;Lorg/apache/xbean/finder/archive/CompositeArchive$1;)V", false);
methodVisitor.visitInsn(ARETURN);
