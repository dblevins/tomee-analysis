...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.TOP, "javax/servlet/ServletContext"}, 0, null);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"java/lang/String", "org/apache/openejb/core/WebContext", "java/lang/String", "org/apache/openejb/server/httpd/HttpListenerRegistry", Opcodes.TOP, "javax/servlet/ServletContext", "java/lang/Class", "javax/servlet/ServletContextListener", "java/lang/Thread", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"java/lang/String", "org/apache/openejb/core/WebContext", "java/lang/String", "org/apache/openejb/server/httpd/HttpListenerRegistry", Opcodes.TOP, "javax/servlet/ServletContext"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/httpd/ServletListener", "<init>", "(Ljavax/servlet/Servlet;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/httpd/ServletListener", "getDelegate", "()Ljavax/servlet/Servlet;", false);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/server/httpd/util/HttpUtil$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/httpd/util/HttpUtil$1", "<init>", "(Ljava/lang/String;Ljavax/servlet/ServletContext;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"java/lang/String", "org/apache/openejb/core/WebContext", "java/lang/String", "org/apache/openejb/server/httpd/HttpListenerRegistry", Opcodes.TOP, "javax/servlet/ServletContext", "java/lang/Thread", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "addFilter", "(Ljava/lang/String;Lorg/apache/openejb/core/WebContext;Ljava/lang/String;Ljavax/servlet/FilterConfig;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/WebContext", "getContextRoot", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/httpd/FilterListener", "<init>", "(Ljavax/servlet/Filter;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/httpd/FilterListener", "getDelegate", "()Ljavax/servlet/Filter;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
