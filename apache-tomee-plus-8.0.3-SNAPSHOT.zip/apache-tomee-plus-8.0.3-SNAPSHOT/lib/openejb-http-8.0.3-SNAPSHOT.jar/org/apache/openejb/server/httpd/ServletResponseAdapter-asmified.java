...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/httpd/ServletResponseAdapter", "response", "Ljavax/servlet/http/HttpServletResponse;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/httpd/ServletResponseAdapter", "response", "Ljavax/servlet/http/HttpServletResponse;");
methodVisitor.visitVarInsn(ALOAD, 1);
