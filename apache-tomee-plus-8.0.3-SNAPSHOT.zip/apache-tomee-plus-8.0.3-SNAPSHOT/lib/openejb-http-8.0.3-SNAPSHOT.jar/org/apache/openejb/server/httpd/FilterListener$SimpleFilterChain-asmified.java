...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/server/httpd/FilterListener$SimpleFilterChain", null, "java/lang/Object", new String[] { "jakarta/servlet/FilterChain" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/server/httpd/FilterListener$SimpleFilterChain", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse", "org/apache/openejb/server/httpd/HttpListenerRegistry"}, 1, new Object[] {"org/apache/openejb/server/httpd/HttpListenerRegistry"});
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/httpd/ServletRequestAdapter", "<init>", "(Ljakarta/servlet/http/HttpServletRequest;)V", false);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/server/httpd/FilterListener$SimpleFilterChain", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse", "org/apache/openejb/server/httpd/HttpListenerRegistry"}, 2, new Object[] {"org/apache/openejb/server/httpd/HttpListenerRegistry", "org/apache/openejb/server/httpd/HttpRequest"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/server/httpd/FilterListener$SimpleFilterChain", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse", "org/apache/openejb/server/httpd/HttpListenerRegistry"}, 3, new Object[] {"org/apache/openejb/server/httpd/HttpListenerRegistry", "org/apache/openejb/server/httpd/HttpRequest", "org/apache/openejb/server/httpd/HttpResponse"});
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/ServletException", "getCause", "()Ljava/lang/Throwable;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/server/httpd/FilterListener$SimpleFilterChain", "jakarta/servlet/ServletRequest", "jakarta/servlet/ServletResponse", "org/apache/openejb/server/httpd/HttpListenerRegistry"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ATHROW);
