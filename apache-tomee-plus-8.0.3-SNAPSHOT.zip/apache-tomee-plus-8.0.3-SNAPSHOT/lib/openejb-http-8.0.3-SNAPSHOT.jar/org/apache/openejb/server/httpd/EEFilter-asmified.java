...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/server/httpd/EEFilter", null, "java/lang/Object", new String[] { "javax/servlet/Filter" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/server/httpd/EEFilter", "javax/servlet/FilterConfig", "org/apache/openejb/loader/SystemInstance", "java/util/Properties"}, 1, new Object[] {"org/apache/openejb/server/httpd/EEFilter"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/server/httpd/EEFilter", "javax/servlet/FilterConfig", "org/apache/openejb/loader/SystemInstance", "java/util/Properties"}, 2, new Object[] {"org/apache/openejb/server/httpd/EEFilter", "org/apache/openejb/spi/SecurityService"});
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/httpd/EEFilter", "javax/servlet/ServletRequest", "javax/servlet/ServletResponse", "javax/servlet/FilterChain", Opcodes.INTEGER}, 1, new Object[] {"javax/servlet/FilterChain"});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/httpd/EEFilter", "javax/servlet/ServletRequest", "javax/servlet/ServletResponse", "javax/servlet/FilterChain", Opcodes.INTEGER}, 2, new Object[] {"javax/servlet/FilterChain", "javax/servlet/ServletRequest"});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/httpd/EEFilter$CdiRequest", "<init>", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/webbeans/config/WebBeansContext;Lorg/apache/openejb/server/httpd/EEFilter;)V", false);
Label label6 = new Label();
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/servlet/FilterChain"});
methodVisitor.visitVarInsn(ILOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "onLogout", "(Ljavax/servlet/http/HttpServletRequest;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/spi/SecurityService", "onLogout", "(Ljavax/servlet/http/HttpServletRequest;)V", true);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/openejb/server/httpd/EEFilter;Ljavax/servlet/http/HttpServletRequest;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/httpd/EEFilter", "onLogout", "(Ljavax/servlet/http/HttpServletRequest;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
