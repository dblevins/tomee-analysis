...
public class AttributeValueTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/ctx/impl/AttributeValueTypeMarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/ctx/impl/AttributeValueTypeMarshaller", "marshallUnknownAttributes", "(Lorg/opensaml/core/xml/AttributeExtensibleXMLObject;Lorg/w3c/dom/Element;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/ctx/AttributeValueType", "getValue", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xacml/ctx/AttributeValueType"}, 0, null);
methodVisitor.visitInsn(RETURN);
