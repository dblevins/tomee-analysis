...
public class StatusMessageTypeImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/ctx/impl/StatusMessageTypeImpl", null, "org/opensaml/xacml/impl/AbstractXACMLObject", new String[] { "org/opensaml/xacml/ctx/StatusMessageType" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/ctx/impl/StatusMessageTypeImpl", "message", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/ctx/impl/StatusMessageTypeImpl", "message", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/ctx/impl/StatusMessageTypeImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/ctx/impl/StatusMessageTypeImpl", "message", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
