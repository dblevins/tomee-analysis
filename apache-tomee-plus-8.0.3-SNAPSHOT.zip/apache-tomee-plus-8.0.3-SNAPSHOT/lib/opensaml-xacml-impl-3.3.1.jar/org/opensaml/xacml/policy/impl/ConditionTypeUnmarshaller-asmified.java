...
public class ConditionTypeUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/policy/impl/ConditionTypeUnmarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/policy/ConditionType", "setExpression", "(Lorg/opensaml/xacml/policy/ExpressionType;)V", true);
