package asm.jakarta.wsdl.extensions.soap;
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/wsdl/extensions/soap/SOAPHeader", null, "java/lang/Object", new String[] { "jakarta/wsdl/extensions/ExtensibilityElement", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addSOAPHeaderFault", "(Ljakarta/wsdl/extensions/soap/SOAPHeaderFault;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removeSOAPHeaderFault", "(Ljakarta/wsdl/extensions/soap/SOAPHeaderFault;)Ljakarta/wsdl/extensions/soap/SOAPHeaderFault;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getSOAPHeaderFaults", "()Ljava/util/List;", null, null);
methodVisitor.visitEnd();
}
