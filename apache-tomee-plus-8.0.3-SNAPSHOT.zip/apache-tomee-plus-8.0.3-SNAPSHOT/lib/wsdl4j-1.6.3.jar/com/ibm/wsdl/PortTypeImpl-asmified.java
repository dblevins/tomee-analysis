...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "com/ibm/wsdl/PortTypeImpl", null, "com/ibm/wsdl/AbstractWSDLElement", new String[] { "javax/wsdl/PortType" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addOperation", "(Ljavax/wsdl/Operation;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOperation", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/wsdl/Operation;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "removeOperation", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/wsdl/Operation;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ibm/wsdl/PortTypeImpl", "getOperation", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljavax/wsdl/Operation;", false);
