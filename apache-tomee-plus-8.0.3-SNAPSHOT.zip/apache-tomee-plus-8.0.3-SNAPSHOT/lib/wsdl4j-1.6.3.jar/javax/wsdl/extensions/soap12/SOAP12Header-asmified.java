...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/wsdl/extensions/soap12/SOAP12Header", null, "java/lang/Object", new String[] { "javax/wsdl/extensions/ExtensibilityElement", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addSOAP12HeaderFault", "(Ljavax/wsdl/extensions/soap12/SOAP12HeaderFault;)V", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removeSOAP12HeaderFault", "(Ljavax/wsdl/extensions/soap12/SOAP12HeaderFault;)Ljavax/wsdl/extensions/soap12/SOAP12HeaderFault;", null, null);
methodVisitor.visitEnd();
}
