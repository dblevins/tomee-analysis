...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wsdlDefinition", "Ljakarta/wsdl/Definition;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "wsdlDefinition", "Ljakarta/wsdl/Definition;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "wsdlDefinition", "Ljakarta/wsdl/Definition;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "findPoliciesByOperation", "(Ljakarta/wsdl/Definition;)Ljava/util/List;", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/wsdl/WSDLException", "getMessage", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/xml/WSDLReader", "readWSDL", "(Ljava/lang/String;Lorg/w3c/dom/Document;)Ljakarta/wsdl/Definition;", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "wsdlDefinition", "Ljakarta/wsdl/Definition;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findPoliciesByOperation", "(Ljakarta/wsdl/Definition;)Ljava/util/List;", "(Ljakarta/wsdl/Definition;)Ljava/util/List<Lorg/apache/wss4j/policy/stax/OperationPolicy;>;", new String[] { "org/apache/wss4j/common/WSSPolicyException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Map$Entry", "jakarta/wsdl/Service", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "jakarta/wsdl/Definition", "java/util/List", "java/util/Iterator", "java/util/Map$Entry", "jakarta/wsdl/Service", "java/util/Iterator", "java/util/Map$Entry", "jakarta/wsdl/Port", "jakarta/wsdl/Binding", "java/util/List", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/BindingOperation", "getOperation", "()Ljakarta/wsdl/Operation;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "jakarta/wsdl/Definition", "java/util/List", "java/util/Iterator", "java/util/Map$Entry", "jakarta/wsdl/Service", "java/util/Iterator", "java/util/Map$Entry", "jakarta/wsdl/Port", "jakarta/wsdl/Binding", "java/util/List", Opcodes.INTEGER, "jakarta/wsdl/BindingOperation", "jakarta/wsdl/Operation", "org/apache/wss4j/policy/stax/OperationPolicy", "java/util/List", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/wsdl/extensions/soap12/SOAP12Operation");
methodVisitor.visitVarInsn(ASTORE, 18);
methodVisitor.visitVarInsn(ALOAD, 18);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/extensions/soap12/SOAP12Operation", "getSoapActionURI", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 19);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitVarInsn(ALOAD, 19);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/stax/OperationPolicy", "setOperationAction", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "getPolicy", "(Ljakarta/wsdl/Service;Ljakarta/wsdl/Port;Ljakarta/wsdl/Binding;Ljakarta/wsdl/BindingOperation;Ljakarta/wsdl/Operation;)Lorg/apache/neethi/Policy;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "jakarta/wsdl/Definition", "java/util/List", "java/util/Iterator", "java/util/Map$Entry", "jakarta/wsdl/Service", "java/util/Iterator"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getPolicy", "(Ljakarta/wsdl/Service;Ljakarta/wsdl/Port;Ljakarta/wsdl/Binding;Ljakarta/wsdl/BindingOperation;Ljakarta/wsdl/Operation;)Lorg/apache/neethi/Policy;", null, new String[] { "org/apache/wss4j/common/WSSPolicyException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "findPolicies", "(Ljakarta/wsdl/WSDLElement;)Lorg/apache/neethi/Policy;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "findPortTypePolicy", "(Ljakarta/wsdl/Binding;Ljakarta/wsdl/Operation;)Lorg/apache/neethi/Policy;", false);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitVarInsn(ALOAD, 12);
Label label5 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findPortTypePolicy", "(Ljakarta/wsdl/Binding;Ljakarta/wsdl/Operation;)Lorg/apache/neethi/Policy;", null, new String[] { "org/apache/wss4j/common/WSSPolicyException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "jakarta/wsdl/PortType", "org/apache/neethi/Policy"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/wsdl/Operation", "org/apache/neethi/Policy"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 8);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findPolicies", "(Ljakarta/wsdl/WSDLElement;)Lorg/apache/neethi/Policy;", null, new String[] { "org/apache/wss4j/common/WSSPolicyException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/WSDLElement", "getExtensibilityElements", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitInsn(ICONST_0);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/wss4j/policy/stax/enforcer/PolicyEnforcerFactory", "jakarta/wsdl/WSDLElement", "java/util/List", "java/util/List", Opcodes.INTEGER, "jakarta/wsdl/extensions/ExtensibilityElement", "jakarta/wsdl/extensions/UnknownExtensibilityElement", "java/lang/String", "org/w3c/dom/NodeList", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
