...
public class ProtectionOrderAssertionState$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/wss4j/policy/stax/assertionStates/ProtectionOrderAssertionState$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/wss4j/policy/stax/assertionStates/ProtectionOrderAssertionState", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$wss4j$policy$model$AbstractSymmetricAsymmetricBinding$ProtectionOrder", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/wss4j/policy/model/AbstractSymmetricAsymmetricBinding$ProtectionOrder", "values", "()[Lorg/apache/wss4j/policy/model/AbstractSymmetricAsymmetricBinding$ProtectionOrder;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/wss4j/policy/stax/assertionStates/ProtectionOrderAssertionState$1", "$SwitchMap$org$apache$wss4j$policy$model$AbstractSymmetricAsymmetricBinding$ProtectionOrder", "[I");
