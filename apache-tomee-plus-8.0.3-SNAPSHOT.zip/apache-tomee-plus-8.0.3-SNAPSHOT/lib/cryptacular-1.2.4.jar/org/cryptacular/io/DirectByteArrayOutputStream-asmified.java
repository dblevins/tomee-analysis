...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/cryptacular/io/DirectByteArrayOutputStream", null, "java/io/ByteArrayOutputStream", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/io/DirectByteArrayOutputStream", "buf", "[B");
