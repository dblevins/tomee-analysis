...
public class DelegateUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2delrestrict/impl/DelegateUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/opensaml/saml/ext/saml2delrestrict/Delegate", "java/lang/String"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2delrestrict/Delegate", "setBaseID", "(Lorg/opensaml/saml/saml2/core/BaseID;)V", true);
Label label1 = new Label();
