...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/saml/ext/saml2alg/DigestMethod" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", "unknownChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", "algorithm", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", "algorithm", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", "algorithm", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2alg/impl/DigestMethodImpl", "unknownChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
