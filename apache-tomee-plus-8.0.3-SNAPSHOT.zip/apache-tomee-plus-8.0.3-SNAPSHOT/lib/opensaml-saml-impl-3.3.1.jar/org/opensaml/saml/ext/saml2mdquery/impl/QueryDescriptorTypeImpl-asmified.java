...
public class QueryDescriptorTypeImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/opensaml/saml/ext/saml2mdquery/impl/QueryDescriptorTypeImpl", null, "org/opensaml/saml/saml2/metadata/impl/RoleDescriptorImpl", new String[] { "org/opensaml/saml/ext/saml2mdquery/QueryDescriptorType" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wantAssertionsSigned", "Lorg/opensaml/core/xml/schema/XSBooleanValue;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "nameIDFormats", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList;", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList<Lorg/opensaml/saml/saml2/metadata/NameIDFormat;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/QueryDescriptorTypeImpl", "nameIDFormats", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/QueryDescriptorTypeImpl", "wantAssertionsSigned", "Lorg/opensaml/core/xml/schema/XSBooleanValue;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/ext/saml2mdquery/impl/QueryDescriptorTypeImpl", "prepareForAssignment", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/core/xml/schema/XSBooleanValue");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/QueryDescriptorTypeImpl", "wantAssertionsSigned", "Lorg/opensaml/core/xml/schema/XSBooleanValue;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getNameIDFormat", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/metadata/NameIDFormat;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/QueryDescriptorTypeImpl", "nameIDFormats", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
