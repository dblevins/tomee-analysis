...
public class AddInResponseToToResponse$DefaultRequestIdLookupStrategyDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "Ljava/lang/Object;Lcom/google/common/base/Function<Lorg/opensaml/profile/context/ProfileRequestContext;Ljava/lang/String;>;", "java/lang/Object", new String[] { "com/google/common/base/Function" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "suppressForBindings", "Ljava/util/Set;", "Ljava/util/Set<Ljava/lang/String;>;", null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljavax/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Collections", "emptySet", "()Ljava/util/Set;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "suppressForBindings", "Ljava/util/Set;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setSuppressForBindings", "(Ljava/util/Collection;)V", "(Ljava/util/Collection<Ljava/lang/String;>;)V", null);
...
methodVisitor.visitLdcInsn("Bindings collection cannot be null");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "suppressForBindings", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Inbound binding {} is suppressed, ignoring request ID");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/messaging/context/SAMLBindingContext", "getBindingUri", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("No inbound SAMLMessageInfoContext available");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/profile/impl/AddInResponseToToResponse$DefaultRequestIdLookupStrategy", "apply", "(Lorg/opensaml/profile/context/ProfileRequestContext;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
