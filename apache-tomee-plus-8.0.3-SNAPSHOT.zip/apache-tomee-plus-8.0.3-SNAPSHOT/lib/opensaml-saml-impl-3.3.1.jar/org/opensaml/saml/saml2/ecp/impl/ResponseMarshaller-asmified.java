...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/ecp/impl/ResponseMarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/ecp/Response", "getAssertionConsumerServiceURL", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/saml2/ecp/Response"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/ecp/Response", "isSOAP11MustUnderstandXSBoolean", "()Lorg/opensaml/core/xml/schema/XSBooleanValue;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/ecp/Response", "getSOAP11Actor", "()Ljava/lang/String;", true);
