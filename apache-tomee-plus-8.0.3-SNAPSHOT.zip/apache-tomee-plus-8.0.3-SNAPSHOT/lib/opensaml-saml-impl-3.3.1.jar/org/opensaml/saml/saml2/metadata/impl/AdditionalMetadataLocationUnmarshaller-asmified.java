...
public class AdditionalMetadataLocationUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/metadata/impl/AdditionalMetadataLocationUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/AdditionalMetadataLocation", "setNamespaceURI", "(Ljava/lang/String;)V", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/AdditionalMetadataLocation", "setLocationURI", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
