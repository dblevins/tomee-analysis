...
public class AddRequestAuthenticatedHeaderHandlerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/binding/impl/AddRequestAuthenticatedHeaderHandler", null, "org/opensaml/messaging/handler/AbstractMessageHandler", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/opensaml/saml/saml2/ecp/RequestAuthenticated", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/opensaml/saml/saml2/binding/impl/AddRequestAuthenticatedHeaderHandler", "org/opensaml/messaging/context/MessageContext", "org/opensaml/saml/common/SAMLObjectBuilder", "org/opensaml/saml/saml2/ecp/RequestAuthenticated"}, 1, new Object[] {"java/lang/Exception"});
