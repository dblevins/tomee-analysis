...
public class IndexedEndpointUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/metadata/impl/IndexedEndpointUnmarshaller", null, "org/opensaml/saml/saml2/metadata/impl/EndpointUnmarshaller", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/saml/saml2/metadata/impl/EndpointUnmarshaller", "<init>", "()V", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/IndexedEndpoint", "setIndex", "(Ljava/lang/Integer;)V", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/IndexedEndpoint", "setIsDefault", "(Lorg/opensaml/core/xml/schema/XSBooleanValue;)V", true);
methodVisitor.visitJumpInsn(GOTO, label2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/saml/saml2/metadata/impl/EndpointUnmarshaller", "processAttribute", "(Lorg/opensaml/core/xml/XMLObject;Lorg/w3c/dom/Attr;)V", false);
methodVisitor.visitJumpInsn(GOTO, label2);
