...
public class AbstractResponseShellActionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "<MessageType::Lorg/opensaml/saml/saml2/core/StatusResponseType;>Lorg/opensaml/profile/action/AbstractProfileAction;", "org/opensaml/profile/action/AbstractProfileAction", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction$1", "<init>", "(Lorg/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "idGeneratorLookupStrategy", "Lcom/google/common/base/Function;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "overwriteExisting", "Z");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "issuerLookupStrategy", "Lcom/google/common/base/Function;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} No outbound message context");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "getLogPrefix", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "overwriteExisting", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "idGeneratorLookupStrategy", "Lcom/google/common/base/Function;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "idGenerator", "Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "idGenerator", "Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "issuerLookupStrategy", "Lcom/google/common/base/Function;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "issuerId", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "getMessageType", "()Ljavax/xml/namespace/QName;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/core/xml/XMLObjectBuilderFactory", "getBuilderOrThrow", "(Ljavax/xml/namespace/QName;)Lorg/opensaml/core/xml/XMLObjectBuilder;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/common/SAMLObjectBuilder");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "issuerId", "Ljava/lang/String;");
Label label0 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "org/opensaml/profile/context/ProfileRequestContext", "org/opensaml/core/xml/XMLObjectBuilderFactory", "org/opensaml/saml/common/SAMLObjectBuilder", "org/opensaml/saml/common/SAMLObjectBuilder", "org/opensaml/saml/common/SAMLObjectBuilder", "org/opensaml/saml/saml2/core/StatusCode", "org/opensaml/saml/saml2/core/Status", "org/opensaml/saml/saml2/core/StatusResponseType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/AbstractResponseShellAction", "log", "Lorg/slf4j/Logger;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "getMessageType", "()Ljavax/xml/namespace/QName;", null, null);
{
