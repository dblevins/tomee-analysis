...
public class NameIDMappingRequestUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/NameIDMappingRequestUnmarshaller", null, "org/opensaml/saml/saml2/core/impl/RequestAbstractTypeUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/NameIDMappingRequest", "setBaseID", "(Lorg/opensaml/saml/saml2/core/BaseID;)V", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/saml2/core/NameIDMappingRequest"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/NameIDMappingRequest", "setNameIDPolicy", "(Lorg/opensaml/saml/saml2/core/NameIDPolicy;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
