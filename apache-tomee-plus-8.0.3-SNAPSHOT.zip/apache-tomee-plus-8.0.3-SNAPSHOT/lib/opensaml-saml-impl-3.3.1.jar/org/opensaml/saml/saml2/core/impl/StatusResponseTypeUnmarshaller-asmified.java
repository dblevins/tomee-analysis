...
public class StatusResponseTypeUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/opensaml/saml/saml2/core/impl/StatusResponseTypeUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/StatusResponseType", "setSignature", "(Lorg/opensaml/xmlsec/signature/Signature;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/StatusResponseType", "setExtensions", "(Lorg/opensaml/saml/saml2/core/Extensions;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/core/impl/StatusResponseTypeUnmarshaller", "parseSAMLVersion", "(Lorg/w3c/dom/Attr;)Lorg/opensaml/saml/common/SAMLVersion;", false);
