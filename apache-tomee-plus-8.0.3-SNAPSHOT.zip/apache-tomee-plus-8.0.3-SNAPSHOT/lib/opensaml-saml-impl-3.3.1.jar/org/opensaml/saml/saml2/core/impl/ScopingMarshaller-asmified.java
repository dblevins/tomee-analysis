...
public class ScopingMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/ScopingMarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/Scoping", "getProxyCount", "()Ljava/lang/Integer;", true);
