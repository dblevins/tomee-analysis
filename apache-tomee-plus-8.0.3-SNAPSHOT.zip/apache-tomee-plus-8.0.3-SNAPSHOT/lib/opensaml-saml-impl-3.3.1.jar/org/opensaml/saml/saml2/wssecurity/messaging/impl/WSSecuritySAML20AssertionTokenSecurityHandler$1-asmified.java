...
public class WSSecuritySAML20AssertionTokenSecurityHandler$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "org/opensaml/saml/saml2/wssecurity/messaging/impl/WSSecuritySAML20AssertionTokenSecurityHandler$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/opensaml/saml/saml2/wssecurity/messaging/impl/WSSecuritySAML20AssertionTokenSecurityHandler", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$opensaml$saml$common$assertion$ValidationResult", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/common/assertion/ValidationResult", "values", "()[Lorg/opensaml/saml/common/assertion/ValidationResult;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/saml2/wssecurity/messaging/impl/WSSecuritySAML20AssertionTokenSecurityHandler$1", "$SwitchMap$org$opensaml$saml$common$assertion$ValidationResult", "[I");
