...
public class ConfirmationMethodImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml1/core/impl/ConfirmationMethodImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/saml/saml1/core/ConfirmationMethod" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/core/impl/ConfirmationMethodImpl", "confirmationMethod", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/core/impl/ConfirmationMethodImpl", "confirmationMethod", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml1/core/impl/ConfirmationMethodImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/core/impl/ConfirmationMethodImpl", "confirmationMethod", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
