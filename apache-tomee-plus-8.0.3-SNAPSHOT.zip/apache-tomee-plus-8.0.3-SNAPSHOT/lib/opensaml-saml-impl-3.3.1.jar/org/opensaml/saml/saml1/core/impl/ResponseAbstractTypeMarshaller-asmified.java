...
public class ResponseAbstractTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/opensaml/saml/saml1/core/impl/ResponseAbstractTypeMarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectMarshaller", null);
...
methodVisitor.visitLdcInsn("ResponseID");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml1/core/ResponseAbstractType", "getID", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/saml1/core/ResponseAbstractType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml1/core/ResponseAbstractType", "getInResponseTo", "()Ljava/lang/String;", true);
