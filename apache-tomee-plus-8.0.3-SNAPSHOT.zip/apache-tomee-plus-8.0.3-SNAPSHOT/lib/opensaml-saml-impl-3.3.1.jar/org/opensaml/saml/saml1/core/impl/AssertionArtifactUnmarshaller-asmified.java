...
public class AssertionArtifactUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml1/core/impl/AssertionArtifactUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml1/core/AssertionArtifact", "setAssertionArtifact", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
