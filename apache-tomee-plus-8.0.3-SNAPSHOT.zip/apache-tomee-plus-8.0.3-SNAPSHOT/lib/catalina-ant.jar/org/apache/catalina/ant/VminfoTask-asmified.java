...
public class VminfoTaskDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/ant/VminfoTask", null, "org/apache/catalina/ant/AbstractCatalinaTask", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/ant/VminfoTask", "execute", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
