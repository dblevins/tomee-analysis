...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "copy", "(Ljakarta/xml/soap/MimeHeaders;)Ljakarta/xml/soap/MimeHeaders;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/xml/soap/MimeHeaders", "java/util/Iterator"}, 0, null);
