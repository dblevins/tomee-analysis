package asm.org.eclipse.microprofile.config.inject;
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "UNCONFIGURED_VALUE", "Ljava/lang/String;", null, "org.eclipse.microprofile.config.configproperty.unconfigureddvalue");
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, "org.eclipse.microprofile.config.configproperty.unconfigureddvalue");
annotationVisitor0.visitEnd();
}
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/enterprise/util/Nonbinding;", true);
