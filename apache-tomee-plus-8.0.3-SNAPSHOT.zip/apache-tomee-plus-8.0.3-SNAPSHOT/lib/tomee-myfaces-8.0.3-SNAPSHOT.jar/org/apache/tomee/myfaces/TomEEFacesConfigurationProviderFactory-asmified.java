...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/myfaces/TomEEFacesConfigurationProviderFactory", "resolveFacesConfigurationProviderFromService", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProvider;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/ExternalContext", "getApplicationMap", "()Ljava/util/Map;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomee/myfaces/TomEEFacesConfigurationProviderFactory", "FACES_CONFIGURATION_PROVIDER_INSTANCE_KEY", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/tomee/myfaces/TomEEFacesConfigurationProviderFactory", "jakarta/faces/context/ExternalContext", "org/apache/myfaces/spi/FacesConfigurationProvider", "jakarta/faces/context/ExternalContext"}, 1, new Object[] {"java/lang/Throwable"});
