...
public class ContextClassPathDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/loader/ContextClassPath", null, "org/apache/openejb/loader/BasicURLClassPath", null);
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/loader/ContextClassPath", "getContextClassLoader", "()Ljava/lang/ClassLoader;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/loader/ContextClassPath", "addJarsToPath", "(Ljava/io/File;Ljava/net/URLClassLoader;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/loader/ContextClassPath", "addJarToPath", "(Ljava/net/URL;Ljava/net/URLClassLoader;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"java/lang/ClassLoader"}, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 4);
