...
public class ConcurrentReferenceHashSetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "<E:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/Set<TE;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "java/util/Set", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_set", "Ljava/util/Set;", "Ljava/util/Set<TE;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "DUMMY_VAL", "Ljava/lang/Object;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "_set", "Ljava/util/Set;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "org/apache/commons/collections4/map/AbstractReferenceMap$ReferenceStrength"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "_set", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet");
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "_set", "Ljava/util/Set;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashSet", "DUMMY_VAL", "Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
