...
public class ListResultObjectProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/lib/rop/ListResultObjectProvider", null, "java/lang/Object", new String[] { "org/apache/openjpa/lib/rop/ResultObjectProvider" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/lib/rop/ListResultObjectProvider", "_idx", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/lib/rop/ListResultObjectProvider", "_list", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/rop/ListResultObjectProvider", "_list", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/rop/ListResultObjectProvider", "_list", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/lib/rop/ListResultObjectProvider", "_idx", "I");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/lib/rop/ListResultObjectProvider", "absolute", "(I)Z", false);
methodVisitor.visitInsn(IRETURN);
