...
public class Trim$TrimExpStateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/jdbc/kernel/exps/Trim$TrimExpState", null, "org/apache/openjpa/jdbc/kernel/exps/ExpState", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL, "charState", "Lorg/apache/openjpa/jdbc/kernel/exps/ExpState;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/kernel/exps/Trim$TrimExpState", "valueState", "Lorg/apache/openjpa/jdbc/kernel/exps/ExpState;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/kernel/exps/Trim$TrimExpState", "charState", "Lorg/apache/openjpa/jdbc/kernel/exps/ExpState;");
