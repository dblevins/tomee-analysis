...
public class ClassMappingInfo$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/jdbc/meta/ClassMappingInfo$1", null, "java/lang/Object", new String[] { "org/apache/openjpa/jdbc/meta/MappingInfo$TableDefaults" });

classWriter.visitOuterClass("org/apache/openjpa/jdbc/meta/ClassMappingInfo", "getTable", "(Lorg/apache/openjpa/jdbc/meta/ClassMapping;Lorg/apache/openjpa/jdbc/identifier/DBIdentifier;Z)Lorg/apache/openjpa/jdbc/schema/Table;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/meta/ClassMappingInfo$1", "this$0", "Lorg/apache/openjpa/jdbc/meta/ClassMappingInfo;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/meta/ClassMappingInfo$1", "val$cls", "Lorg/apache/openjpa/jdbc/meta/ClassMapping;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/meta/ClassMappingInfo$1", "val$cls", "Lorg/apache/openjpa/jdbc/meta/ClassMapping;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/meta/ClassMappingInfo$1", "val$cls", "Lorg/apache/openjpa/jdbc/meta/ClassMapping;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openjpa/jdbc/meta/MappingDefaults", "getTableName", "(Lorg/apache/openjpa/jdbc/meta/ClassMapping;Lorg/apache/openjpa/jdbc/schema/Schema;)Ljava/lang/String;", true);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/meta/ClassMappingInfo$1", "val$cls", "Lorg/apache/openjpa/jdbc/meta/ClassMapping;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openjpa/jdbc/meta/MappingDefaults", "getTableIdentifier", "(Lorg/apache/openjpa/jdbc/meta/ClassMapping;Lorg/apache/openjpa/jdbc/schema/Schema;)Lorg/apache/openjpa/jdbc/identifier/DBIdentifier;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
