...
public class NoneMetaDataFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/meta/NoneMetaDataFactory", null, "java/lang/Object", new String[] { "org/apache/openjpa/meta/MetaDataFactory", "org/apache/openjpa/meta/MetaDataDefaults" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "_instance", "Lorg/apache/openjpa/meta/NoneMetaDataFactory;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "()Lorg/apache/openjpa/meta/NoneMetaDataFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/meta/NoneMetaDataFactory", "_instance", "Lorg/apache/openjpa/meta/NoneMetaDataFactory;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getUnimplementedExceptionType", "()Ljava/lang/Class;", "()Ljava/lang/Class<+Ljava/lang/Exception;>;", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openjpa/meta/NoneMetaDataFactory");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/meta/NoneMetaDataFactory", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/meta/NoneMetaDataFactory", "_instance", "Lorg/apache/openjpa/meta/NoneMetaDataFactory;");
methodVisitor.visitInsn(RETURN);
