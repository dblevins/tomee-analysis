...
public class AbstractLRSProxyMap$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/util/AbstractLRSProxyMap$2", "Ljava/util/AbstractCollection<TV;>;", "java/util/AbstractCollection", null);

classWriter.visitOuterClass("org/apache/openjpa/util/AbstractLRSProxyMap", "values", "()Ljava/util/Collection;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/util/AbstractLRSProxyMap$2", "this$0", "Lorg/apache/openjpa/util/AbstractLRSProxyMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/util/AbstractLRSProxyMap$2", "this$0", "Lorg/apache/openjpa/util/AbstractLRSProxyMap;");
