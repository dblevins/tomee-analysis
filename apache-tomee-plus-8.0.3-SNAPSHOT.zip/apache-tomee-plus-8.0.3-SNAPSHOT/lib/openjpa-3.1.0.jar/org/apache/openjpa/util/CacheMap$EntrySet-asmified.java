...
public class CacheMap$EntrySetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/util/CacheMap$EntrySet", null, "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/util/CacheMap$EntrySet", "this$0", "Lorg/apache/openjpa/util/CacheMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/util/CacheMap$EntrySet", "this$0", "Lorg/apache/openjpa/util/CacheMap;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/util/CacheMap$EntrySet", "<init>", "(Lorg/apache/openjpa/util/CacheMap;)V", false);
methodVisitor.visitInsn(RETURN);
