...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "<Z:Ljava/lang/Object;C:Ljava/lang/Object;E:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/FromImpl<TZ;TE;>;Ljakarta/persistence/criteria/PluralJoin<TZ;TC;TE;>;", "org/apache/openjpa/persistence/criteria/FromImpl", new String[] { "jakarta/persistence/criteria/PluralJoin" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openjpa/persistence/criteria/FromImpl;Lorg/apache/openjpa/persistence/meta/Members$PluralAttributeImpl;Ljakarta/persistence/criteria/JoinType;)V", "(Lorg/apache/openjpa/persistence/criteria/FromImpl<*TZ;>;Lorg/apache/openjpa/persistence/meta/Members$PluralAttributeImpl<-TZ;TC;TE;>;Ljakarta/persistence/criteria/JoinType;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "joinType", "Ljakarta/persistence/criteria/JoinType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "joinType", "Ljakarta/persistence/criteria/JoinType;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "org/apache/openjpa/persistence/criteria/FromImpl", "org/apache/openjpa/persistence/meta/Members$PluralAttributeImpl", "jakarta/persistence/criteria/JoinType"}, 1, new Object[] {"org/apache/openjpa/persistence/criteria/Joins$AbstractCollection"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "org/apache/openjpa/persistence/criteria/FromImpl", "org/apache/openjpa/persistence/meta/Members$PluralAttributeImpl", "jakarta/persistence/criteria/JoinType"}, 2, new Object[] {"org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "allowNull", "Z");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "getJoinType", "()Ljakarta/persistence/criteria/JoinType;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "joinType", "Ljakarta/persistence/criteria/JoinType;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getAttribute", "()Ljakarta/persistence/metamodel/Attribute;", "()Ljakarta/persistence/metamodel/Attribute<-TZ;TE;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getModel", "()Ljakarta/persistence/metamodel/PluralAttribute;", "()Ljakarta/persistence/metamodel/PluralAttribute<-TZ;TC;TE;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "_member", "Lorg/apache/openjpa/persistence/meta/Members$Member;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/Joins$AbstractCollection", "getModel", "()Ljakarta/persistence/metamodel/PluralAttribute;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
