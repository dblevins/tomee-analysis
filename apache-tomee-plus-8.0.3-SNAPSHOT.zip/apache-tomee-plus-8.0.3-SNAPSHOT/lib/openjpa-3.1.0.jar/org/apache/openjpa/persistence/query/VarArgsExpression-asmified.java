...
public class VarArgsExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/query/VarArgsExpression", null, "org/apache/openjpa/persistence/query/ExpressionImpl", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_values", "[Lorg/apache/openjpa/persistence/query/Expression;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/query/VarArgsExpression", "_values", "[Lorg/apache/openjpa/persistence/query/Expression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/VarArgsExpression", "_values", "[Lorg/apache/openjpa/persistence/query/Expression;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openjpa/persistence/query/VarArgsExpression", "org/apache/openjpa/persistence/query/AliasContext", "java/lang/StringBuilder", Opcodes.INTEGER, "org/apache/openjpa/persistence/query/Visitable"}, 1, new Object[] {"java/lang/StringBuilder"});
methodVisitor.visitLdcInsn(", ");
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openjpa/persistence/query/VarArgsExpression", "org/apache/openjpa/persistence/query/AliasContext", "java/lang/StringBuilder", Opcodes.INTEGER, "org/apache/openjpa/persistence/query/Visitable"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/query/VarArgsExpression", "asExpression", "(Lorg/apache/openjpa/persistence/query/AliasContext;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
