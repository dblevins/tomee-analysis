...
public class Expressions$CurrentDateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$CurrentDate", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<Ljava/sql/Date;>;", "org/apache/openjpa/persistence/criteria/ExpressionImpl", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/Expressions$CurrentDate", "getJavaType", "()Ljava/lang/Class;", false);
