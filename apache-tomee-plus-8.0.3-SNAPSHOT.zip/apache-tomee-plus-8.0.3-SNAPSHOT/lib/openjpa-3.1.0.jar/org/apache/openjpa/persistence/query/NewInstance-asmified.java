...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/query/NewInstance", null, "org/apache/openjpa/persistence/query/AbstractVisitable", new String[] { "org/apache/openjpa/persistence/query/SelectItem", "org/apache/openjpa/persistence/query/Visitable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_args", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/openjpa/persistence/query/SelectItem;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_VARARGS, "<init>", "(Ljava/lang/Class;[Lorg/apache/openjpa/persistence/query/SelectItem;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/query/NewInstance", "_cls", "Ljava/lang/Class;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/query/NewInstance", "_args", "Ljava/util/List;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openjpa/persistence/query/NewInstance", "java/lang/Class", "[Lorg/apache/openjpa/persistence/query/SelectItem;"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/NewInstance", "_cls", "Ljava/lang/Class;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/NewInstance", "_args", "Ljava/util/List;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/NewInstance", "_args", "Ljava/util/List;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openjpa/persistence/query/NewInstance", "org/apache/openjpa/persistence/query/AliasContext", "java/lang/StringBuilder", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/Iterator", "org/apache/openjpa/persistence/query/SelectItem"}, 1, new Object[] {"java/lang/StringBuilder"});
methodVisitor.visitLdcInsn(",");
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openjpa/persistence/query/NewInstance", "org/apache/openjpa/persistence/query/AliasContext", "java/lang/StringBuilder", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/Iterator", "org/apache/openjpa/persistence/query/SelectItem"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/query/AbstractVisitable", "asExpression", "(Lorg/apache/openjpa/persistence/query/AliasContext;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
