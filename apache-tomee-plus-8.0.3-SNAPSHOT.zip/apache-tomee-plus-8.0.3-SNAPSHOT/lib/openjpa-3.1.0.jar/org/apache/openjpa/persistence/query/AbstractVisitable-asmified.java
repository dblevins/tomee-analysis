...
public class AbstractVisitableDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/persistence/query/AbstractVisitable", null, "java/lang/Object", new String[] { "org/apache/openjpa/persistence/query/Visitable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "OPEN_BRACE", "Ljava/lang/String;", null, "(");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CLOSE_BRACE", "Ljava/lang/String;", null, ")");
fieldVisitor.visitEnd();
}
{
