...
public class PersistenceMetaDataDefaults$AnnotatedFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/persistence/PersistenceMetaDataDefaults$AnnotatedFilter", "Ljava/lang/Object;Lorg/apache/openjpa/persistence/PersistenceMetaDataDefaults$InclusiveFilter<Ljava/lang/reflect/AnnotatedElement;>;", "java/lang/Object", new String[] { "org/apache/openjpa/persistence/PersistenceMetaDataDefaults$InclusiveFilter" });
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/lib/util/J2DoPrivHelper", "getAnnotationsAction", "(Ljava/lang/reflect/AnnotatedElement;)Ljava/security/PrivilegedAction;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openjpa/persistence/PersistenceMetaDataDefaults$AnnotatedFilter", "java/lang/reflect/AnnotatedElement", "[Ljava/lang/annotation/Annotation;", "[Ljava/lang/annotation/Annotation;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/PersistenceMetaDataDefaults", "access$000", "()Ljava/util/Set;", false);
methodVisitor.visitVarInsn(ALOAD, 7);
