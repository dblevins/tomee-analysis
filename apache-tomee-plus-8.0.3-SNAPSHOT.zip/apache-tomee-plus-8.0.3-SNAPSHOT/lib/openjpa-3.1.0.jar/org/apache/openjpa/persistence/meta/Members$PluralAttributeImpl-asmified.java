...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/persistence/meta/Members$PluralAttributeImpl", "<X:Ljava/lang/Object;C:Ljava/lang/Object;E:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/meta/Members$Member<TX;TC;>;Ljakarta/persistence/metamodel/PluralAttribute<TX;TC;TE;>;", "org/apache/openjpa/persistence/meta/Members$Member", new String[] { "jakarta/persistence/metamodel/PluralAttribute" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "getElementType", "()Ljakarta/persistence/metamodel/Type;", "()Ljakarta/persistence/metamodel/Type<TE;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "getBindableType", "()Ljakarta/persistence/metamodel/Bindable$BindableType;", null, null);
methodVisitor.visitCode();
