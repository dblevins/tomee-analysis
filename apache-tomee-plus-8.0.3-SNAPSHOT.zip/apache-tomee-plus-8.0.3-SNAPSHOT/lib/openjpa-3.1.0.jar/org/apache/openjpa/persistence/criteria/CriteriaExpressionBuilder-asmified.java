...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/persistence/criteria/Root", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openjpa/persistence/criteria/CriteriaExpressionBuilder", "org/apache/openjpa/kernel/exps/QueryExpressions", "org/apache/openjpa/kernel/exps/ExpressionFactory", "org/apache/openjpa/persistence/criteria/CriteriaQueryImpl", "java/util/Set", "org/apache/openjpa/persistence/meta/MetamodelImpl", "java/util/Iterator", "jakarta/persistence/criteria/Root", "java/util/Iterator", "jakarta/persistence/criteria/Join", "java/lang/Class", "org/apache/openjpa/meta/ClassMetaData", "jakarta/persistence/metamodel/Type$PersistenceType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/CriteriaQueryImpl", "registerRoot", "(Ljakarta/persistence/criteria/Root;Lorg/apache/openjpa/kernel/exps/Value;)V", false);
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getProjections", "(Lorg/apache/openjpa/kernel/exps/QueryExpressions;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lorg/apache/openjpa/kernel/exps/ExpressionFactory;Lorg/apache/openjpa/persistence/criteria/CriteriaQueryImpl;Lorg/apache/openjpa/persistence/meta/MetamodelImpl;Ljava/util/Map;)V", "(Lorg/apache/openjpa/kernel/exps/QueryExpressions;Ljava/util/List<Ljakarta/persistence/criteria/Selection<*>;>;Ljava/util/List<Lorg/apache/openjpa/kernel/exps/Value;>;Ljava/util/List<Ljava/lang/String;>;Ljava/util/List<Ljava/lang/String;>;Lorg/apache/openjpa/kernel/exps/ExpressionFactory;Lorg/apache/openjpa/persistence/criteria/CriteriaQueryImpl<*>;Lorg/apache/openjpa/persistence/meta/MetamodelImpl;Ljava/util/Map<Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<*>;Lorg/apache/openjpa/kernel/exps/Value;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "size", "()I", true);
Label label0 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/persistence/criteria/Root", "java/util/Set"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 10);
Label label3 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/Fetch", "getAttribute", "()Ljakarta/persistence/metamodel/Attribute;", true);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/Fetch", "getJoinType", "()Ljakarta/persistence/criteria/JoinType;", true);
...
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/persistence/criteria/CompoundSelection");
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/Selection", "getJavaType", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/criteria/CompoundSelections", "getFillStrategy", "(Ljakarta/persistence/criteria/Selection;)Lorg/apache/openjpa/kernel/FillStrategy;", false);
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/CompoundSelection", "getCompoundSelectionItems", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 8);
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/persistence/criteria/CompoundSelection", "java/util/List", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/CriteriaExpressionBuilder", "getShape", "(Lorg/apache/openjpa/persistence/criteria/CriteriaQueryImpl;Lorg/apache/openjpa/kernel/ResultShape;Ljakarta/persistence/criteria/Selection;)Lorg/apache/openjpa/kernel/ResultShape;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/TupleFactory", "<init>", "([Ljakarta/persistence/criteria/Selection;)V", false);
