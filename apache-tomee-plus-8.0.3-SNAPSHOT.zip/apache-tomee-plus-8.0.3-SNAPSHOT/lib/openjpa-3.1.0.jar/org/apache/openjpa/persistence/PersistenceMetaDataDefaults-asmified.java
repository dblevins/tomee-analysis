...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/PersistenceMetaDataDefaults$AccessFilter", "<init>", "(Ljavax/persistence/AccessType;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/AccessType", "FIELD", "Ljavax/persistence/AccessType;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/PersistenceMetaDataDefaults", "isAnnotatedAccess", "(Ljava/lang/reflect/Member;Ljavax/persistence/AccessType;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label5);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isAnnotatedAccess", "(Ljava/lang/reflect/Member;Ljavax/persistence/AccessType;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
