...
public class AbstractLockManagerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/kernel/AbstractLockManager", null, "java/lang/Object", new String[] { "org/apache/openjpa/kernel/LockManager" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/AbstractLockManager", "ctx", "Lorg/apache/openjpa/kernel/StoreContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/AbstractLockManager", "log", "Lorg/apache/openjpa/lib/log/Log;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/AbstractLockManager", "ctx", "Lorg/apache/openjpa/kernel/StoreContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "lockAll", "(Ljava/util/Collection;IILjava/lang/Object;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/AbstractLockManager", "lock", "(Lorg/apache/openjpa/kernel/OpenJPAStateManager;IILjava/lang/Object;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "endTransaction", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(0, 1);
methodVisitor.visitEnd();
