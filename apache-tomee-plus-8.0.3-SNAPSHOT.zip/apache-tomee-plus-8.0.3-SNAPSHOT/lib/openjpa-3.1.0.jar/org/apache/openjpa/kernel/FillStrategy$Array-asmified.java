...
public class FillStrategy$ArrayDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/kernel/FillStrategy$Array", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/apache/openjpa/kernel/FillStrategy<TT;>;", "java/lang/Object", new String[] { "org/apache/openjpa/kernel/FillStrategy" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openjpa/kernel/FillStrategy$Array", "java/lang/Class"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/kernel/FillStrategy$Array", "_loc", "Lorg/apache/openjpa/lib/util/Localizer;");
methodVisitor.visitLdcInsn("fill-bad-array");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/FillStrategy$Array", "cls", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/FillStrategy$Array", "cls", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 1);
