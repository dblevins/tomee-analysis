...
public class AggregateValDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/kernel/exps/AggregateVal", null, "org/apache/openjpa/kernel/exps/Val", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/AggregateVal", "_val", "Lorg/apache/openjpa/kernel/exps/Val;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/AggregateVal", "_val", "Lorg/apache/openjpa/kernel/exps/Val;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/exps/Val", "getType", "()Ljava/lang/Class;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/exps/AggregateVal", "getType", "(Ljava/lang/Class;)Ljava/lang/Class;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/exps/AggregateVal", "eval", "(Ljava/util/Collection;Ljava/lang/Object;Lorg/apache/openjpa/kernel/StoreContext;[Ljava/lang/Object;)Ljava/util/Collection;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/kernel/exps/AggregateVal", "_loc", "Lorg/apache/openjpa/lib/util/Localizer;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/AggregateVal", "_val", "Lorg/apache/openjpa/kernel/exps/Val;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/exps/Val", "getType", "()Ljava/lang/Class;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/exps/AggregateVal", "operate", "(Ljava/util/Collection;Ljava/lang/Class;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "operate", "(Ljava/util/Collection;Ljava/lang/Class;)Ljava/lang/Object;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/openjpa/kernel/exps/AggregateVal;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/lib/util/Localizer", "forPackage", "(Ljava/lang/Class;)Lorg/apache/openjpa/lib/util/Localizer;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/kernel/exps/AggregateVal", "_loc", "Lorg/apache/openjpa/lib/util/Localizer;");
methodVisitor.visitInsn(RETURN);
