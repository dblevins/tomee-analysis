...
public class UnboundVariableDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/kernel/exps/UnboundVariable", null, "org/apache/openjpa/kernel/exps/Val", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/UnboundVariable", "_type", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/UnboundVariable", "_val", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/UnboundVariable", "_type", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/UnboundVariable", "_val", "Ljava/lang/Object;");
methodVisitor.visitInsn(ARETURN);
