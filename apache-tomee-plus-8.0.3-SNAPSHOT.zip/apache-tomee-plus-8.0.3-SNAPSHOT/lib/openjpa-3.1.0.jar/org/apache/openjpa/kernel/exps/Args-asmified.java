...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/kernel/exps/Args", null, "org/apache/openjpa/kernel/exps/Val", new String[] { "org/apache/openjpa/kernel/exps/Arguments" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_args", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/openjpa/kernel/exps/Value;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openjpa/kernel/exps/Value;Lorg/apache/openjpa/kernel/exps/Value;)V", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "<init>", "([Lorg/apache/openjpa/kernel/exps/Value;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/Args", "_args", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openjpa/kernel/exps/Args", "[Lorg/apache/openjpa/kernel/exps/Value;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Lorg/apache/openjpa/kernel/exps/Value;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/Args", "_args", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 5);
