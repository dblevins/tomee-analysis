...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/kernel/exps/WhenScalar", null, "org/apache/openjpa/kernel/exps/Exp", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/WhenScalar", "_val1", "Lorg/apache/openjpa/kernel/exps/Val;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/WhenScalar", "_val2", "Lorg/apache/openjpa/kernel/exps/Val;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/WhenScalar", "_val1", "Lorg/apache/openjpa/kernel/exps/Val;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/WhenScalar", "_val2", "Lorg/apache/openjpa/kernel/exps/Val;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
