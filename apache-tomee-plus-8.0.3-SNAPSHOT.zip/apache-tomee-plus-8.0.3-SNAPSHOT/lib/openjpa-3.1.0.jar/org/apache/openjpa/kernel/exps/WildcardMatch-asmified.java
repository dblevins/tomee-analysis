...
public class WildcardMatchDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "org/apache/openjpa/kernel/exps/WildcardMatch", null, "java/lang/Object", new String[] { "org/apache/openjpa/kernel/exps/FilterListener" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "TAG", "Ljava/lang/String;", null, "wildcardMatch");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/openjpa/lib/util/SimpleRegex"}, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "java/lang/Boolean", "FALSE", "Ljava/lang/Boolean;");
