...
public class AbstractLifecycleListenerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/event/AbstractLifecycleListener", null, "java/lang/Object", new String[] { "org/apache/openjpa/event/LifecycleListener" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "eventOccurred", "(Lorg/apache/openjpa/event/LifecycleEvent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/event/AbstractLifecycleListener", "eventOccurred", "(Lorg/apache/openjpa/event/LifecycleEvent;)V", false);
methodVisitor.visitInsn(RETURN);
