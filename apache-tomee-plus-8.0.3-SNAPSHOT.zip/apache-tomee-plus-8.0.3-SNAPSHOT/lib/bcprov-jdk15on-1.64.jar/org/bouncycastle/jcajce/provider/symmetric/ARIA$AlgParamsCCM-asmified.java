...
public class ARIA$AlgParamsCCMDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsCCM", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameters", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsCCM", "ccmParams", "Lorg/bouncycastle/asn1/cms/CCMParameters;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsCCM", "isASN1FormatString", "(Ljava/lang/String;)Z", false);
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsCCM", "ccmParams", "Lorg/bouncycastle/asn1/cms/CCMParameters;");
