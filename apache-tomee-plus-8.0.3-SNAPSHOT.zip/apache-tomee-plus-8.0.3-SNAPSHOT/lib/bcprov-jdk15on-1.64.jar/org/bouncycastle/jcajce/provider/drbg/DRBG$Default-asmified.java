...
public class DRBG$DefaultDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/drbg/DRBG$Default", null, "java/security/SecureRandomSpi", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/jcajce/provider/drbg/DRBG$Default", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/jcajce/provider/drbg/DRBG$Default", "random", "Ljava/security/SecureRandom;");
methodVisitor.visitInsn(RETURN);
