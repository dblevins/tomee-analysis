...
public class TLSKDF$TLS11Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/TLSKDF$TLS11", null, "org/bouncycastle/jcajce/provider/symmetric/TLSKDF$TLSKeyMaterialFactory", null);
...
methodVisitor.visitLdcInsn("TLS11KDF");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/TLSKDF$TLS11", "algName", "Ljava/lang/String;");
