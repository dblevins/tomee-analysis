...
public class AES$ECB$1Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/AES$ECB$1", null, "java/lang/Object", new String[] { "org/bouncycastle/jcajce/provider/symmetric/util/BlockCipherProvider" });

classWriter.visitOuterClass("org/bouncycastle/jcajce/provider/symmetric/AES$ECB", "<init>", "()V");
