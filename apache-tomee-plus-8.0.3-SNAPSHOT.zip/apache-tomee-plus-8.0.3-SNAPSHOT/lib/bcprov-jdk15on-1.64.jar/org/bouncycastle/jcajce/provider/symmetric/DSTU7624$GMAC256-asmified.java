...
public class DSTU7624$GMAC256Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/DSTU7624$GMAC256", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseMac", null);
...
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/crypto/macs/KGMac");
...
methodVisitor.visitIntInsn(SIPUSH, 256);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/macs/KGMac", "<init>", "(Lorg/bouncycastle/crypto/modes/KGCMBlockCipher;I)V", false);
