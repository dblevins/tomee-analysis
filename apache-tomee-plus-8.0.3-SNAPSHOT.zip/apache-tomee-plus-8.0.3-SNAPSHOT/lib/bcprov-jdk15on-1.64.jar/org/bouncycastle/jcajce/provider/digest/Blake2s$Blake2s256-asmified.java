...
public class Blake2s$Blake2s256Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/digest/Blake2s$Blake2s256", null, "org/bouncycastle/jcajce/provider/digest/BCMessageDigest", new String[] { "java/lang/Cloneable" });
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/jcajce/provider/digest/Blake2s$Blake2s256");
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/crypto/digests/Blake2sDigest");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/digest/Blake2s$Blake2s256", "digest", "Lorg/bouncycastle/crypto/Digest;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/digest/Blake2s$Blake2s256", "digest", "Lorg/bouncycastle/crypto/Digest;");
methodVisitor.visitVarInsn(ALOAD, 1);
