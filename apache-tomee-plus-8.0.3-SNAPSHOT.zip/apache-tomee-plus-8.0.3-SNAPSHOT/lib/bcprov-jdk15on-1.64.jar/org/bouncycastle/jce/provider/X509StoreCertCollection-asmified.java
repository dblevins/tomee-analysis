...
public class X509StoreCertCollectionDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jce/provider/X509StoreCertCollection", null, "org/bouncycastle/x509/X509StoreSpi", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509StoreCertCollection", "_store", "Lorg/bouncycastle/util/CollectionStore;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509StoreCertCollection", "_store", "Lorg/bouncycastle/util/CollectionStore;");
methodVisitor.visitVarInsn(ALOAD, 1);
