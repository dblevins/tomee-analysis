...
public class DERSetParserDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "org/bouncycastle/asn1/DERSetParser", null, "java/lang/Object", new String[] { "org/bouncycastle/asn1/ASN1SetParser" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/DERSetParser", "_parser", "Lorg/bouncycastle/asn1/ASN1StreamParser;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/DERSetParser", "_parser", "Lorg/bouncycastle/asn1/ASN1StreamParser;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/DERSetParser", "getLoadedObject", "()Lorg/bouncycastle/asn1/ASN1Primitive;", false);
