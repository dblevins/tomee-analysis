...
public class PBEParameterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/asn1/pkcs/PBEParameter", null, "org/bouncycastle/asn1/ASN1Object", null);
...
{
fieldVisitor = classWriter.visitField(0, "salt", "Lorg/bouncycastle/asn1/ASN1OctetString;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("salt length must be 8");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/pkcs/PBEParameter", "salt", "Lorg/bouncycastle/asn1/ASN1OctetString;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/pkcs/PBEParameter", "iterations", "Lorg/bouncycastle/asn1/ASN1Integer;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljava/lang/Object;)Lorg/bouncycastle/asn1/pkcs/PBEParameter;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/bouncycastle/asn1/pkcs/PBEParameter");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/asn1/pkcs/PBEParameter");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/pkcs/PBEParameter", "<init>", "(Lorg/bouncycastle/asn1/ASN1Sequence;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/pkcs/PBEParameter", "iterations", "Lorg/bouncycastle/asn1/ASN1Integer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/pkcs/PBEParameter", "salt", "Lorg/bouncycastle/asn1/ASN1OctetString;");
