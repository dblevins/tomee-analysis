...
public class CAST5CBCParametersDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/asn1/misc/CAST5CBCParameters", null, "org/bouncycastle/asn1/ASN1Object", null);

{
fieldVisitor = classWriter.visitField(0, "keyLength", "Lorg/bouncycastle/asn1/ASN1Integer;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljava/lang/Object;)Lorg/bouncycastle/asn1/misc/CAST5CBCParameters;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/bouncycastle/asn1/misc/CAST5CBCParameters");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/asn1/misc/CAST5CBCParameters");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/misc/CAST5CBCParameters", "<init>", "(Lorg/bouncycastle/asn1/ASN1Sequence;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/misc/CAST5CBCParameters", "iv", "Lorg/bouncycastle/asn1/ASN1OctetString;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/misc/CAST5CBCParameters", "keyLength", "Lorg/bouncycastle/asn1/ASN1Integer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/misc/CAST5CBCParameters", "iv", "Lorg/bouncycastle/asn1/ASN1OctetString;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/misc/CAST5CBCParameters", "keyLength", "Lorg/bouncycastle/asn1/ASN1Integer;");
