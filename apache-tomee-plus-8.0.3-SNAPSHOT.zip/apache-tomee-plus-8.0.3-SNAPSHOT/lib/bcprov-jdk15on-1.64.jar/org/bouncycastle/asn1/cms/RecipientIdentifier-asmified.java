...
public class RecipientIdentifierDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/asn1/cms/RecipientIdentifier", null, "org/bouncycastle/asn1/ASN1Object", new String[] { "org/bouncycastle/asn1/ASN1Choice" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/cms/RecipientIdentifier", "id", "Lorg/bouncycastle/asn1/ASN1Encodable;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljava/lang/Object;)Lorg/bouncycastle/asn1/cms/RecipientIdentifier;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/bouncycastle/asn1/cms/RecipientIdentifier");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/asn1/cms/RecipientIdentifier");
...
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/asn1/cms/RecipientIdentifier");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/asn1/cms/IssuerAndSerialNumber");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/cms/RecipientIdentifier", "<init>", "(Lorg/bouncycastle/asn1/cms/IssuerAndSerialNumber;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/cms/RecipientIdentifier", "<init>", "(Lorg/bouncycastle/asn1/ASN1OctetString;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/cms/RecipientIdentifier", "<init>", "(Lorg/bouncycastle/asn1/ASN1Primitive;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLdcInsn("Illegal object in RecipientIdentifier: ");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/RecipientIdentifier", "id", "Lorg/bouncycastle/asn1/ASN1Encodable;");
