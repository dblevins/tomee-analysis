...
public class ECDHBasicAgreementDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/agreement/ECDHBasicAgreement", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/BasicAgreement" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/agreement/ECDHBasicAgreement", "key", "Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/agreement/ECDHBasicAgreement", "key", "Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;");
...
methodVisitor.visitLdcInsn("ECDH public key has wrong domain parameters");
...
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Infinity is not a valid public key for ECDH");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalStateException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/ECDomainParameters", "getHInv", "()Ljava/math/BigInteger;", false);
...
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Infinity is not a valid agreement value for ECDH");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalStateException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
