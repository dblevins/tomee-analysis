...
public class PublicKeyFactory$GOST3410_2001ConverterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/crypto/util/PublicKeyFactory$GOST3410_2001Converter", null, "org/bouncycastle/crypto/util/PublicKeyFactory$SubjectPublicKeyInfoConverter", null);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("error recovering GOST3410_2001 public key");
...
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("invalid length for GOST3410_2001 public key");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalArgumentException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/util/PublicKeyFactory$GOST3410_2001Converter", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
