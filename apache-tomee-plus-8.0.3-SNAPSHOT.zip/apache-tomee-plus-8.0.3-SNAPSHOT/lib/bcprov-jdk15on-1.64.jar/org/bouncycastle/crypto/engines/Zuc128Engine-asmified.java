...
public class Zuc128EngineDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/bouncycastle/crypto/engines/Zuc128Engine", null, "org/bouncycastle/crypto/engines/Zuc128CoreEngine", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/bouncycastle/crypto/engines/Zuc128Engine;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/engines/Zuc128Engine", "<init>", "(Lorg/bouncycastle/crypto/engines/Zuc128Engine;)V", false);
