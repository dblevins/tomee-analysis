...
public class RSABlindingFactorGeneratorDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "key", "Lorg/bouncycastle/crypto/params/RSAKeyParameters;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "key", "Lorg/bouncycastle/crypto/params/RSAKeyParameters;");
...
methodVisitor.visitLdcInsn("generator requires RSA public key");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generateBlindingFactor", "()Ljava/math/BigInteger;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "key", "Lorg/bouncycastle/crypto/params/RSAKeyParameters;");
Label label0 = new Label();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("generator not initialised");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "ZERO", "Ljava/math/BigInteger;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/math/BigInteger", "equals", "(Ljava/lang/Object;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "ONE", "Ljava/math/BigInteger;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/math/BigInteger", "equals", "(Ljava/lang/Object;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label1);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "ZERO", "Ljava/math/BigInteger;");
methodVisitor.visitInsn(LCONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/math/BigInteger", "valueOf", "(J)Ljava/math/BigInteger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/crypto/generators/RSABlindingFactorGenerator", "ONE", "Ljava/math/BigInteger;");
methodVisitor.visitInsn(RETURN);
