...
public class DHKeyPairGeneratorDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/generators/DHKeyPairGenerator", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/AsymmetricCipherKeyPairGenerator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/generators/DHKeyPairGenerator", "param", "Lorg/bouncycastle/crypto/params/DHKeyGenerationParameters;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/generators/DHKeyPairGenerator", "param", "Lorg/bouncycastle/crypto/params/DHKeyGenerationParameters;");
