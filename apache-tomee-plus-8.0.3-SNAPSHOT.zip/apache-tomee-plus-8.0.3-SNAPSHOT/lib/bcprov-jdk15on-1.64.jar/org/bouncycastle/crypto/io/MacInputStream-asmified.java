...
public class MacInputStreamDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/io/MacInputStream", null, "java/io/FilterInputStream", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/io/InputStream;Lorg/bouncycastle/crypto/Mac;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/io/MacInputStream", "mac", "Lorg/bouncycastle/crypto/Mac;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/io/MacInputStream", "in", "Ljava/io/InputStream;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/io/MacInputStream", "mac", "Lorg/bouncycastle/crypto/Mac;");
methodVisitor.visitVarInsn(ILOAD, 1);
