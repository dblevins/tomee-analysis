...
public class GeneralHashCommitterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/Committer" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "digest", "Lorg/bouncycastle/crypto/Digest;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/bouncycastle/crypto/ExtendedDigest", "getByteLength", "()I", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "byteLength", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "byteLength", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "random", "Ljava/security/SecureRandom;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "calculateCommitment", "([B[B)[B", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/commitments/GeneralHashCommitter", "digest", "Lorg/bouncycastle/crypto/Digest;");
