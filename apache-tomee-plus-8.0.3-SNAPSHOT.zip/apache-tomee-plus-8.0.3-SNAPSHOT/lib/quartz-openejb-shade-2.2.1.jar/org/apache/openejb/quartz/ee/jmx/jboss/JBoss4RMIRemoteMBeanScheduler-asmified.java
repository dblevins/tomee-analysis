...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "server", "Ljakarta/management/MBeanServerConnection;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/ee/jmx/jboss/JBoss4RMIRemoteMBeanScheduler", "server", "Ljakarta/management/MBeanServerConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/management/MBeanServerConnection");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/ee/jmx/jboss/JBoss4RMIRemoteMBeanScheduler", "server", "Ljakarta/management/MBeanServerConnection;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/ee/jmx/jboss/JBoss4RMIRemoteMBeanScheduler", "server", "Ljakarta/management/MBeanServerConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/ee/jmx/jboss/JBoss4RMIRemoteMBeanScheduler", "getSchedulerObjectName", "()Ljakarta/management/ObjectName;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getAttributes", "([Ljava/lang/String;)Ljakarta/management/AttributeList;", null, new String[] { "org/apache/openejb/quartz/SchedulerException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/ee/jmx/jboss/JBoss4RMIRemoteMBeanScheduler", "getSchedulerObjectName", "()Ljakarta/management/ObjectName;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/management/MBeanServerConnection", "getAttributes", "(Ljakarta/management/ObjectName;[Ljava/lang/String;)Ljakarta/management/AttributeList;", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/lang/Exception"});
