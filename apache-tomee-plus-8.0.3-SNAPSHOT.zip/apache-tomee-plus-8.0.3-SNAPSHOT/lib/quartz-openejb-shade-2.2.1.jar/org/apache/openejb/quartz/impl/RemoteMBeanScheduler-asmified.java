...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "schedulerObjectName", "Ljakarta/management/ObjectName;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getSchedulerObjectName", "()Ljakarta/management/ObjectName;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/impl/RemoteMBeanScheduler", "schedulerObjectName", "Ljakarta/management/ObjectName;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/impl/RemoteMBeanScheduler", "schedulerObjectName", "Ljakarta/management/ObjectName;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setSchedulerObjectName", "(Ljakarta/management/ObjectName;)V", null, new String[] { "org/apache/openejb/quartz/SchedulerException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/impl/RemoteMBeanScheduler", "schedulerObjectName", "Ljakarta/management/ObjectName;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "getAttributes", "([Ljava/lang/String;)Ljakarta/management/AttributeList;", null, new String[] { "org/apache/openejb/quartz/SchedulerException" });
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/impl/RemoteMBeanScheduler", "getAttributes", "([Ljava/lang/String;)Ljakarta/management/AttributeList;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/quartz/impl/RemoteMBeanScheduler", "getAttribute", "(Ljakarta/management/AttributeList;I)Ljakarta/management/Attribute;", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openejb/quartz/impl/RemoteMBeanScheduler", "jakarta/management/AttributeList"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/quartz/SchedulerException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getAttribute", "(Ljakarta/management/AttributeList;I)Ljakarta/management/Attribute;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/management/AttributeList", "get", "(I)Ljava/lang/Object;", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/management/openmbean/CompositeData;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
