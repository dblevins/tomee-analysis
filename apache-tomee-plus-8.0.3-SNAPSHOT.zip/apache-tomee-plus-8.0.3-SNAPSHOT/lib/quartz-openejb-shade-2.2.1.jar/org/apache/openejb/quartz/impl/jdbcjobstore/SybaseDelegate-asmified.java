...
public class SybaseDelegateDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/quartz/impl/jdbcjobstore/SybaseDelegate", null, "org/apache/openejb/quartz/impl/jdbcjobstore/StdJDBCDelegate", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/quartz/impl/jdbcjobstore/SybaseDelegate", "java/sql/ResultSet", "java/lang/String", "java/io/InputStream", "java/lang/Object", "java/io/ObjectInputStream"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/impl/jdbcjobstore/SybaseDelegate", "canUseProperties", "()Z", false);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/impl/jdbcjobstore/SybaseDelegate", "getObjectFromBlob", "(Ljava/sql/ResultSet;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/quartz/impl/jdbcjobstore/SybaseDelegate", "java/sql/PreparedStatement", Opcodes.INTEGER, "java/io/ByteArrayOutputStream"}, 2, new Object[] {"java/sql/PreparedStatement", Opcodes.INTEGER});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/ByteArrayOutputStream", "toByteArray", "()[B", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/quartz/impl/jdbcjobstore/SybaseDelegate", "java/sql/PreparedStatement", Opcodes.INTEGER, "java/io/ByteArrayOutputStream"}, 3, new Object[] {"java/sql/PreparedStatement", Opcodes.INTEGER, "[B"});
