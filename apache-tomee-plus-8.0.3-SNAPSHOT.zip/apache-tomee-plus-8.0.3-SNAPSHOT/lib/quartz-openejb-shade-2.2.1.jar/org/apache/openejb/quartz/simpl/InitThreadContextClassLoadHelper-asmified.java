...
public class InitThreadContextClassLoadHelperDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/quartz/simpl/InitThreadContextClassLoadHelper", null, "java/lang/Object", new String[] { "org/apache/openejb/quartz/spi/ClassLoadHelper" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "initClassLoader", "Ljava/lang/ClassLoader;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/simpl/InitThreadContextClassLoadHelper", "initClassLoader", "Ljava/lang/ClassLoader;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/simpl/InitThreadContextClassLoadHelper", "initClassLoader", "Ljava/lang/ClassLoader;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/simpl/InitThreadContextClassLoadHelper", "loadClass", "(Ljava/lang/String;)Ljava/lang/Class;", false);
methodVisitor.visitInsn(ARETURN);
