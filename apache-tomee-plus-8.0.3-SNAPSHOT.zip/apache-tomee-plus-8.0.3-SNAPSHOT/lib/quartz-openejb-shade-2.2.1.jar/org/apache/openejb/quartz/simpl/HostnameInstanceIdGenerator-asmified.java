...
public class HostnameInstanceIdGeneratorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/quartz/simpl/HostnameInstanceIdGenerator", null, "java/lang/Object", new String[] { "org/apache/openejb/quartz/spi/InstanceIdGenerator" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generateInstanceId", "()Ljava/lang/String;", null, new String[] { "org/apache/openejb/quartz/SchedulerException" });
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn("Couldn't get host name!");
