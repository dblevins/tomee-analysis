...
public class AccessTokenClientFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/oauth2/client/AccessTokenClientFilter", null, "org/apache/cxf/rs/security/oauth2/client/AbstractAuthSupplier", new String[] { "jakarta/ws/rs/client/ClientRequestFilter" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/client/AccessTokenClientFilter", "createAuthorizationHeader", "()Ljava/lang/String;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/oauth2/client/AbstractAuthSupplier", "getClientAccessToken", "()Lorg/apache/cxf/rs/security/oauth2/common/ClientAccessToken;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/client/StaticClientTokenContext", "getClientTokenContext", "()Lorg/apache/cxf/rs/security/oauth2/client/ClientTokenContext;", false);
