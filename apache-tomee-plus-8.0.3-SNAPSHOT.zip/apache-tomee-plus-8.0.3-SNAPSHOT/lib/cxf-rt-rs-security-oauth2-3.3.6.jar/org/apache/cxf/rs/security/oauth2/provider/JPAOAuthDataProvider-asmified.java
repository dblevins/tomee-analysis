...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "entityManagerFactory", "Ljakarta/persistence/EntityManagerFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setEntityManagerFactory", "(Ljakarta/persistence/EntityManagerFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "entityManagerFactory", "Ljakarta/persistence/EntityManagerFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "getEntityManager", "()Ljakarta/persistence/EntityManager;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider$EntityManagerOperation", "execute", "(Ljakarta/persistence/EntityManager;)Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "closeIfNeeded", "(Ljakarta/persistence/EntityManager;)V", false);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider$EntityManagerOperation", "jakarta/persistence/EntityManager"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "beginIfNeeded", "(Ljakarta/persistence/EntityManager;)Ljakarta/persistence/EntityTransaction;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider$EntityManagerOperation", "execute", "(Ljakarta/persistence/EntityManager;)Ljava/lang/Object;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "flushIfNeeded", "(Ljakarta/persistence/EntityManager;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "commitIfNeeded", "(Ljakarta/persistence/EntityManager;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "closeIfNeeded", "(Ljakarta/persistence/EntityManager;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider$EntityManagerOperation", "jakarta/persistence/EntityManager", "jakarta/persistence/EntityTransaction"}, 1, new Object[] {"java/lang/RuntimeException"});
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider$EntityManagerOperation", "jakarta/persistence/EntityManager", "jakarta/persistence/EntityTransaction"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getClientsQuery", "(Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;)Ljakarta/persistence/TypedQuery;", "(Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;)Ljakarta/persistence/TypedQuery<Lorg/apache/cxf/rs/security/oauth2/common/Client;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getTokensQuery", "(Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;)Ljakarta/persistence/TypedQuery;", "(Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;)Ljakarta/persistence/TypedQuery<Lorg/apache/cxf/rs/security/oauth2/tokens/bearer/BearerAccessToken;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "getQuery", "(Ljava/lang/String;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;Ljava/lang/Class;)Ljakarta/persistence/TypedQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(5, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getRefreshTokensQuery", "(Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;)Ljakarta/persistence/TypedQuery;", "(Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;)Ljakarta/persistence/TypedQuery<Lorg/apache/cxf/rs/security/oauth2/tokens/refresh/RefreshToken;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getQuery", "(Ljava/lang/String;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;Ljava/lang/Class;)Ljakarta/persistence/TypedQuery;", "<T:Ljava/lang/Object;>(Ljava/lang/String;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;Ljakarta/persistence/EntityManager;Ljava/lang/Class<TT;>;)Ljakarta/persistence/TypedQuery<TT;>;", null);
methodVisitor.visitCode();
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/persistence/TypedQuery", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JPAOAuthDataProvider", "entityManagerFactory", "Ljakarta/persistence/EntityManagerFactory;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "flushIfNeeded", "(Ljakarta/persistence/EntityManager;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
