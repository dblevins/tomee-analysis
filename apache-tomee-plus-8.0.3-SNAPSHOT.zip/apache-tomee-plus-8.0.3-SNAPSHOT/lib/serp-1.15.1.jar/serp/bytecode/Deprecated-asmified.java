...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "serp/bytecode/Deprecated", null, "serp/bytecode/Attribute", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/visitor/BCVisitor", "enterDeprecated", "(Lserp/bytecode/Deprecated;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/visitor/BCVisitor", "exitDeprecated", "(Lserp/bytecode/Deprecated;)V", false);
methodVisitor.visitInsn(RETURN);
