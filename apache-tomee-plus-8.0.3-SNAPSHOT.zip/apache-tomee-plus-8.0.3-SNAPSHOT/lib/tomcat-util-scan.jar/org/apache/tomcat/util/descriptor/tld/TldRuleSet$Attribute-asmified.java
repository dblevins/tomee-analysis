...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "toTagAttributeInfo", "()Ljavax/servlet/jsp/tagext/TagAttributeInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("javax.el.ValueExpression");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/descriptor/tld/TldRuleSet$Attribute", "type", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("javax.el.MethodExpression");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/descriptor/tld/TldRuleSet$Attribute", "type", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
