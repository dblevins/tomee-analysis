...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jaxrs/JweWriterInterceptor", null, "java/lang/Object", new String[] { "jakarta/ws/rs/ext/WriterInterceptor" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JweWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/io/OutputStream", "org/apache/cxf/rs/security/jose/jwe/JweHeaders", "org/apache/cxf/rs/security/jose/jwe/JweEncryptionProvider", "java/lang/String", "jakarta/ws/rs/core/MediaType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JweWriterInterceptor", "protectHttpHeadersIfNeeded", "(Ljakarta/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jwe/JweHeaders;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JweWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/io/OutputStream", "org/apache/cxf/rs/security/jose/jwe/JweHeaders", "org/apache/cxf/rs/security/jose/jwe/JweEncryptionProvider", "java/lang/String", "jakarta/ws/rs/core/MediaType", "org/apache/cxf/rs/security/jose/jwe/JweEncryptionOutput"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jaxrs/JweWriterInterceptor", "setJoseMediaType", "(Ljakarta/ws/rs/ext/WriterInterceptorContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 9);
