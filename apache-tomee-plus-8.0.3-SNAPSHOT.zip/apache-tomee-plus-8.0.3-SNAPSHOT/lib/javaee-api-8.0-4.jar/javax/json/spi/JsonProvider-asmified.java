...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/json/spi/JsonProvider", null, "java/lang/Object", null);

classWriter.visitInnerClass("javax/json/spi/JsonProvider$1", null, null, ACC_STATIC);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "provider", "()Ljavax/json/spi/JsonProvider;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getSecurityManager", "()Ljava/lang/SecurityManager;", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitTypeInsn(NEW, "javax/json/spi/JsonProvider$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/json/spi/JsonProvider$1", "<init>", "()V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/json/spi/JsonProvider");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/json/spi/JsonProvider", "doLoadProvider", "()Ljavax/json/spi/JsonProvider;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 0);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "doLoadProvider", "()Ljavax/json/spi/JsonProvider;", null, new String[] { "javax/json/JsonException" });
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/json/spi/JsonProvider;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createParser", "(Ljava/io/Reader;)Ljavax/json/stream/JsonParser;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createParser", "(Ljava/io/InputStream;)Ljavax/json/stream/JsonParser;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createParserFactory", "(Ljava/util/Map;)Ljavax/json/stream/JsonParserFactory;", "(Ljava/util/Map<Ljava/lang/String;*>;)Ljavax/json/stream/JsonParserFactory;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createGenerator", "(Ljava/io/Writer;)Ljavax/json/stream/JsonGenerator;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createGenerator", "(Ljava/io/OutputStream;)Ljavax/json/stream/JsonGenerator;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createGeneratorFactory", "(Ljava/util/Map;)Ljavax/json/stream/JsonGeneratorFactory;", "(Ljava/util/Map<Ljava/lang/String;*>;)Ljavax/json/stream/JsonGeneratorFactory;", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createWriter", "(Ljava/io/Writer;)Ljavax/json/JsonWriter;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createWriter", "(Ljava/io/OutputStream;)Ljavax/json/JsonWriter;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createWriterFactory", "(Ljava/util/Map;)Ljavax/json/JsonWriterFactory;", "(Ljava/util/Map<Ljava/lang/String;*>;)Ljavax/json/JsonWriterFactory;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createReaderFactory", "(Ljava/util/Map;)Ljavax/json/JsonReaderFactory;", "(Ljava/util/Map<Ljava/lang/String;*>;)Ljavax/json/JsonReaderFactory;", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createBuilderFactory", "(Ljava/util/Map;)Ljavax/json/JsonBuilderFactory;", "(Ljava/util/Map<Ljava/lang/String;*>;)Ljavax/json/JsonBuilderFactory;", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "()Ljavax/json/spi/JsonProvider;", null, new String[] { "javax/json/JsonException" });
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/json/spi/JsonProvider", "doLoadProvider", "()Ljavax/json/spi/JsonProvider;", false);
methodVisitor.visitInsn(ARETURN);
