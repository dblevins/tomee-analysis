package asm.javax.json.bind.annotation;
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/json/bind/annotation/JsonbDateFormat", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });

{
annotationVisitor0 = classWriter.visitAnnotation("Ljavax/json/bind/annotation/JsonbAnnotation;", true);
