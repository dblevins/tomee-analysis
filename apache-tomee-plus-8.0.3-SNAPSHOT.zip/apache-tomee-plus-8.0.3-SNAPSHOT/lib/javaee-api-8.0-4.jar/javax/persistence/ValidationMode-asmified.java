...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljavax/persistence/ValidationMode;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "values", "()[Ljavax/persistence/ValidationMode;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/ValidationMode", "$VALUES", "[Ljavax/persistence/ValidationMode;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljavax/persistence/ValidationMode;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/persistence/ValidationMode;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/ValidationMode", "$VALUES", "[Ljavax/persistence/ValidationMode;");
methodVisitor.visitInsn(RETURN);
