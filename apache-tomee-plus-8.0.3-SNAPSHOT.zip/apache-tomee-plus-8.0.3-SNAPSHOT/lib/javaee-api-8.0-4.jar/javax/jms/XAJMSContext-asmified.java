...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/jms/XAJMSContext", null, "java/lang/Object", new String[] { "javax/jms/JMSContext" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getContext", "()Ljavax/jms/JMSContext;", null, null);
methodVisitor.visitEnd();
}
{
