...
public class StreamMessageDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/jms/StreamMessage", null, "java/lang/Object", new String[] { "javax/jms/Message" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "readString", "()Ljava/lang/String;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "readObject", "()Ljava/lang/Object;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "writeString", "(Ljava/lang/String;)V", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitEnd();
}
{
