...
public class StartElementDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/stream/events/StartElement", null, "java/lang/Object", new String[] { "javax/xml/stream/events/XMLEvent" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getAttributes", "()Ljava/util/Iterator;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getNamespaces", "()Ljava/util/Iterator;", null, null);
methodVisitor.visitEnd();
}
{
