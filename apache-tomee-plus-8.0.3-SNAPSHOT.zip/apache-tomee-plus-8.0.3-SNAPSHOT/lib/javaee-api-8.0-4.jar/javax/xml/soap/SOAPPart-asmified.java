...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/xml/soap/SOAPPart", null, "java/lang/Object", new String[] { "javax/xml/soap/Node", "org/w3c/dom/Document" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getEnvelope", "()Ljavax/xml/soap/SOAPEnvelope;", null, new String[] { "javax/xml/soap/SOAPException" });
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/soap/SOAPPart", "getMimeHeader", "(Ljava/lang/String;)[Ljava/lang/String;", false);
...
methodVisitor.visitLdcInsn("Content-Id");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/soap/SOAPPart", "setMimeHeader", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setContent", "(Ljavax/xml/transform/Source;)V", null, new String[] { "javax/xml/soap/SOAPException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getContent", "()Ljavax/xml/transform/Source;", null, new String[] { "javax/xml/soap/SOAPException" });
methodVisitor.visitEnd();
}
