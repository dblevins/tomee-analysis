...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/ws/soap/SOAPBinding", null, "java/lang/Object", new String[] { "javax/xml/ws/Binding" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getSOAPFactory", "()Ljavax/xml/soap/SOAPFactory;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getMessageFactory", "()Ljavax/xml/soap/MessageFactory;", null, null);
methodVisitor.visitEnd();
}
