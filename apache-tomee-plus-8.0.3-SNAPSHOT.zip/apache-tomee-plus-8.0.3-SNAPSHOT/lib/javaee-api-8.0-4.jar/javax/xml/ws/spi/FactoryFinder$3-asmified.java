...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "javax/xml/ws/spi/FactoryFinder$3", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/ws/spi/FactoryFinder$3", "val$iFactoryId", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/ws/spi/FactoryFinder$3", "val$iFallbackClassName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/ws/spi/FactoryFinder", "access$100", "()Ljava/lang/ClassLoader;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/ws/spi/FactoryFinder$3", "val$iFactoryId", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/ws/spi/FactoryFinder", "access$200", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/ws/spi/FactoryFinder$3", "val$iFallbackClassName", "Ljava/lang/String;");
