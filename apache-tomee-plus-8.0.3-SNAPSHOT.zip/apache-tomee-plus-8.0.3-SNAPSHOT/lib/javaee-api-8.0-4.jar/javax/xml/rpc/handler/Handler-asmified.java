...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/rpc/handler/Handler", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "init", "(Ljavax/xml/rpc/handler/HandlerInfo;)V", null, null);
methodVisitor.visitEnd();
}
{
