...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/transaction/TransactionSynchronizationRegistry", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "registerInterposedSynchronization", "(Ljavax/transaction/Synchronization;)V", null, null);
methodVisitor.visitEnd();
}
{
