package asm.javax.ejb.embeddable;
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/ejb/embeddable/EJBContainer", null, "java/lang/Object", new String[] { "java/lang/AutoCloseable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createEJBContainer", "()Ljavax/ejb/embeddable/EJBContainer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/Collections", "EMPTY_MAP", "Ljava/util/Map;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/ejb/embeddable/EJBContainer", "createEJBContainer", "(Ljava/util/Map;)Ljavax/ejb/embeddable/EJBContainer;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 0);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createEJBContainer", "(Ljava/util/Map;)Ljavax/ejb/embeddable/EJBContainer;", "(Ljava/util/Map<**>;)Ljavax/ejb/embeddable/EJBContainer;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "javax/ejb/EJBException");
Label label3 = new Label();
methodVisitor.visitTryCatchBlock(label3, label2, label2, "javax/ejb/EJBException");
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/spi/EJBContainerProvider;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/ejb/spi/EJBContainerProvider");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/spi/EJBContainerProvider", "createEJBContainer", "(Ljava/util/Map;)Ljavax/ejb/embeddable/EJBContainer;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"java/util/Map"}, 1, new Object[] {"javax/ejb/EJBException"});
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ATHROW);
