...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/Min", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/validation/constraints/Min$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{javax.validation.constraints.Min.message}");
annotationVisitor0.visitEnd();
}
