...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/Size", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/validation/constraints/Size$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{javax.validation.constraints.Size.message}");
annotationVisitor0.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "min", "()I", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "max", "()I", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
