...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/NotEmpty", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/validation/constraints/NotEmpty$List;"));
annotationVisitor0.visitEnd();
}
classWriter.visitInnerClass("javax/validation/constraints/NotEmpty$List", "javax/validation/constraints/NotEmpty", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);
