...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/ws/rs/core/MultivaluedMap", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/Map<TK;Ljava/util/List<TV;>;>;", "java/lang/Object", new String[] { "java/util/Map" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "equalsIgnoreValueOrder", "(Ljavax/ws/rs/core/MultivaluedMap;)Z", "(Ljavax/ws/rs/core/MultivaluedMap<TK;TV;>;)Z", null);
methodVisitor.visitEnd();
}
