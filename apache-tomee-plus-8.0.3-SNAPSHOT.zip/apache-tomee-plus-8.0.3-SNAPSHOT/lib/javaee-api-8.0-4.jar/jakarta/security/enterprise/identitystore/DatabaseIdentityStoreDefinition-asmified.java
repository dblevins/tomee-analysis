...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/security/enterprise/identitystore/DatabaseIdentityStoreDefinition", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "hashAlgorithm", "()Ljava/lang/Class;", "()Ljava/lang/Class<+Ljakarta/security/enterprise/identitystore/PasswordHash;>;", null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Ljakarta/security/enterprise/identitystore/Pbkdf2PasswordHash;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
