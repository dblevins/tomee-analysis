...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/Constraint", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "validatedBy", "()[Ljava/lang/Class;", "()[Ljava/lang/Class<+Ljakarta/validation/ConstraintValidator<**>;>;", null);
