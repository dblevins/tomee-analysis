...
public class NotBlankDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/NotBlank", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/validation/constraints/NotBlank$List;"));
annotationVisitor0.visitEnd();
}
classWriter.visitInnerClass("jakarta/validation/constraints/NotBlank$List", "jakarta/validation/constraints/NotBlank", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "message", "()Ljava/lang/String;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, "{jakarta.validation.constraints.NotBlank.message}");
annotationVisitor0.visitEnd();
}
