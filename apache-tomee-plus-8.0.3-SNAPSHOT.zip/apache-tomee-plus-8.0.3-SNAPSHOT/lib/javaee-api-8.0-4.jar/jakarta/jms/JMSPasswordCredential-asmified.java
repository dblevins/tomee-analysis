...
public class JMSPasswordCredentialDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/jms/JMSPasswordCredential", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "userName", "()Ljava/lang/String;", null, null);
