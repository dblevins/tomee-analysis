...
public class XAJMSContextDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/jms/XAJMSContext", null, "java/lang/Object", new String[] { "jakarta/jms/JMSContext" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getContext", "()Ljakarta/jms/JMSContext;", null, null);
methodVisitor.visitEnd();
}
{
