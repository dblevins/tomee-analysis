...
public class JsonProvider$1Dump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "run", "()Ljakarta/json/spi/JsonProvider;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/json/spi/JsonProvider", "access$000", "()Ljakarta/json/spi/JsonProvider;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/spi/JsonProvider$1", "run", "()Ljakarta/json/spi/JsonProvider;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
