package asm.jakarta.json.bind.annotation;
...
public class JsonbDateFormatDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/json/bind/annotation/JsonbDateFormat", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });

{
annotationVisitor0 = classWriter.visitAnnotation("Ljakarta/json/bind/annotation/JsonbAnnotation;", true);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "DEFAULT_FORMAT", "Ljava/lang/String;", null, "##default");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "TIME_IN_MILLIS", "Ljava/lang/String;", null, "##time-in-millis");
fieldVisitor.visitEnd();
}
{
