...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/json/JsonReaderFactory", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createReader", "(Ljava/io/InputStream;Ljava/nio/charset/Charset;)Ljakarta/json/JsonReader;", null, null);
methodVisitor.visitEnd();
}
{
