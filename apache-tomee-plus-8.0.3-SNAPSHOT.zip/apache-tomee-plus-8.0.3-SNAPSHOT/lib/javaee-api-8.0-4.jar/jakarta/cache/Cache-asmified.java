...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/cache/Cache", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Ljava/lang/Iterable<Ljakarta/cache/Cache$Entry<TK;TV;>;>;Ljava/io/Closeable;", "java/lang/Object", new String[] { "java/lang/Iterable", "java/io/Closeable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "loadAll", "(Ljava/util/Set;ZLjakarta/cache/integration/CompletionListener;)V", "(Ljava/util/Set<+TK;>;ZLjakarta/cache/integration/CompletionListener;)V", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getConfiguration", "(Ljava/lang/Class;)Ljakarta/cache/configuration/Configuration;", "<C::Ljakarta/cache/configuration/Configuration<TK;TV;>;>(Ljava/lang/Class<TC;>;)TC;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS | ACC_ABSTRACT, "invoke", "(Ljava/lang/Object;Ljakarta/cache/processor/EntryProcessor;[Ljava/lang/Object;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(TK;Ljakarta/cache/processor/EntryProcessor<TK;TV;TT;>;[Ljava/lang/Object;)TT;", new String[] { "jakarta/cache/processor/EntryProcessorException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS | ACC_ABSTRACT, "invokeAll", "(Ljava/util/Set;Ljakarta/cache/processor/EntryProcessor;[Ljava/lang/Object;)Ljava/util/Map;", "<T:Ljava/lang/Object;>(Ljava/util/Set<+TK;>;Ljakarta/cache/processor/EntryProcessor<TK;TV;TT;>;[Ljava/lang/Object;)Ljava/util/Map<TK;Ljakarta/cache/processor/EntryProcessorResult<TT;>;>;", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getCacheManager", "()Ljakarta/cache/CacheManager;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "registerCacheEntryListener", "(Ljakarta/cache/configuration/CacheEntryListenerConfiguration;)V", "(Ljakarta/cache/configuration/CacheEntryListenerConfiguration<TK;TV;>;)V", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "deregisterCacheEntryListener", "(Ljakarta/cache/configuration/CacheEntryListenerConfiguration;)V", "(Ljakarta/cache/configuration/CacheEntryListenerConfiguration<TK;TV;>;)V", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Ljakarta/cache/Cache$Entry<TK;TV;>;>;", null);
methodVisitor.visitEnd();
}
