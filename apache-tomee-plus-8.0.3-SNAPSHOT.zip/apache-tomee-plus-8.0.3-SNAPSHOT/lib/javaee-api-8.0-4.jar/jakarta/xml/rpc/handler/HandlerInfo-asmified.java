package asm.jakarta.xml.rpc.handler;
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/xml/rpc/handler/HandlerInfo", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/xml/rpc/handler/HandlerInfo", "handlerClass", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/util/HashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashMap", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/xml/rpc/handler/HandlerInfo", "config", "Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/xml/rpc/handler/HandlerInfo", "headers", "[Ljavax/xml/namespace/QName;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/rpc/handler/HandlerInfo", "handlerClass", "Ljava/lang/Class;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/rpc/handler/HandlerInfo", "config", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/rpc/handler/HandlerInfo", "headers", "[Ljavax/xml/namespace/QName;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
