...
classWriter.visit(V1_5, ACC_SUPER, "jakarta/xml/rpc/FactoryFinder", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "findClassLoader", "()Ljava/lang/ClassLoader;", null, new String[] { "jakarta/xml/rpc/FactoryFinder$ConfigurationError" });
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/rpc/FactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/xml/rpc/FactoryFinder;"));
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitTypeInsn(NEW, "jakarta/xml/rpc/FactoryFinder$ConfigurationError");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Unexpected IllegalAccessException");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/xml/rpc/FactoryFinder$ConfigurationError", "<init>", "(Ljava/lang/String;Ljava/lang/Exception;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "newInstance", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Object;", null, new String[] { "jakarta/xml/rpc/FactoryFinder$ConfigurationError" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "find", "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", "(Ljava/lang/Class<*>;Ljava/lang/String;)Ljava/lang/Object;", new String[] { "jakarta/xml/rpc/FactoryFinder$ConfigurationError" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/rpc/FactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/rpc/FactoryFinder", "findClassLoader", "()Ljava/lang/ClassLoader;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/rpc/FactoryFinder", "newInstance", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/Object;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
