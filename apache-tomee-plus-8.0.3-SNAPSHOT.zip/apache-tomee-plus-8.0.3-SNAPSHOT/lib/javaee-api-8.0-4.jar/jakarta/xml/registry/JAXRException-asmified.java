...
classWriter.visit(V1_4, ACC_PUBLIC | ACC_SUPER, "jakarta/xml/registry/JAXRException", null, "java/lang/Exception", new String[] { "jakarta/xml/registry/JAXRResponse" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/xml/registry/JAXRException", "cause", "Ljava/lang/Throwable;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/registry/JAXRException", "cause", "Ljava/lang/Throwable;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isAvailable", "()Z", null, new String[] { "jakarta/xml/registry/JAXRException" });
methodVisitor.visitCode();
