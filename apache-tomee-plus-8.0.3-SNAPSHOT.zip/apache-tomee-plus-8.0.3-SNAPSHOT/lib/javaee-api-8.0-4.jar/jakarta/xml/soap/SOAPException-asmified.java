...
public class SOAPExceptionDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/xml/soap/SOAPException", null, "java/lang/Exception", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(5083961510786058130L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/xml/soap/SOAPException", "cause", "Ljava/lang/Throwable;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/soap/SOAPException", "initCause", "(Ljava/lang/Throwable;)Ljava/lang/Throwable;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/xml/soap/SOAPException", "cause", "Ljava/lang/Throwable;");
