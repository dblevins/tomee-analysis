...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/batch/api/partition/PartitionReducer", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "afterPartitionedStepCompletion", "(Ljakarta/batch/api/partition/PartitionReducer$PartitionStatus;)V", null, new String[] { "java/lang/Exception" });
methodVisitor.visitEnd();
}
