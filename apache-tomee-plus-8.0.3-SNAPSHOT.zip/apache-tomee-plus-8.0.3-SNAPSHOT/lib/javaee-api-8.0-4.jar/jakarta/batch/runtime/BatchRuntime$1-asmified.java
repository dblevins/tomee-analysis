...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "run", "()Ljakarta/batch/operations/JobOperator;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/batch/runtime/BatchRuntime", "access$000", "()Ljakarta/batch/operations/JobOperator;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/batch/runtime/BatchRuntime$1", "run", "()Ljakarta/batch/operations/JobOperator;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
