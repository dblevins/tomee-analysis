...
public class AbstractEncryptOutputProcessor$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/xml/security/stax/impl/processor/output/AbstractEncryptOutputProcessor$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/xml/security/stax/impl/processor/output/AbstractEncryptOutputProcessor", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$xml$security$stax$ext$SecurePart$Modifier", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/xml/security/stax/ext/SecurePart$Modifier", "values", "()[Lorg/apache/xml/security/stax/ext/SecurePart$Modifier;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/xml/security/stax/impl/processor/output/AbstractEncryptOutputProcessor$1", "$SwitchMap$org$apache$xml$security$stax$ext$SecurePart$Modifier", "[I");
