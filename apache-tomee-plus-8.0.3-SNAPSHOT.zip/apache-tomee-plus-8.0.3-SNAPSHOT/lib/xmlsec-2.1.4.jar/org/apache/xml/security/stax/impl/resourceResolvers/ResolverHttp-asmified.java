...
public class ResolverHttpDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", null, "java/lang/Object", new String[] { "org/apache/xml/security/stax/ext/ResourceResolver", "org/apache/xml/security/stax/ext/ResourceResolverLookup" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "proxy", "Ljava/net/Proxy;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "pattern", "Ljava/util/regex/Pattern;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "uri", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "baseURI", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "setProxy", "(Ljava/net/Proxy;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "proxy", "Ljava/net/Proxy;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "pattern", "Ljava/util/regex/Pattern;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "baseURI", "Ljava/lang/String;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "uri", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp", "proxy", "Ljava/net/Proxy;");
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/xml/security/stax/impl/resourceResolvers/ResolverHttp"}, 1, new Object[] {"java/net/MalformedURLException"});
methodVisitor.visitVarInsn(ASTORE, 1);
