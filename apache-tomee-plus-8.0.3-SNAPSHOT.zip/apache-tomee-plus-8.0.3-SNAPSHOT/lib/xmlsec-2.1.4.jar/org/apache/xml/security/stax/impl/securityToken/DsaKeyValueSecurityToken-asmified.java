...
public class DsaKeyValueSecurityTokenDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/stax/impl/securityToken/DsaKeyValueSecurityToken", null, "org/apache/xml/security/stax/impl/securityToken/AbstractInboundSecurityToken", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "dsaKeyValueType", "Lorg/apache/xml/security/binding/xmldsig/DSAKeyValueType;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/xml/security/binding/xmldsig/DSAKeyValueType;Lorg/apache/xml/security/stax/ext/InboundSecurityContext;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/securityToken/DsaKeyValueSecurityToken", "dsaKeyValueType", "Lorg/apache/xml/security/binding/xmldsig/DSAKeyValueType;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(5, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "buildPublicKey", "(Lorg/apache/xml/security/binding/xmldsig/DSAKeyValueType;)Ljava/security/PublicKey;", null, new String[] { "java/security/spec/InvalidKeySpecException", "java/security/NoSuchAlgorithmException" });
methodVisitor.visitCode();
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/DSAKeyValueType", "getY", "()[B", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/math/BigInteger", "<init>", "(I[B)V", false);
methodVisitor.visitTypeInsn(NEW, "java/math/BigInteger");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/DSAKeyValueType", "getP", "()[B", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/math/BigInteger", "<init>", "(I[B)V", false);
methodVisitor.visitTypeInsn(NEW, "java/math/BigInteger");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/DSAKeyValueType", "getQ", "()[B", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/math/BigInteger", "<init>", "(I[B)V", false);
methodVisitor.visitTypeInsn(NEW, "java/math/BigInteger");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/DSAKeyValueType", "getG", "()[B", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/math/BigInteger", "<init>", "(I[B)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/securityToken/DsaKeyValueSecurityToken", "dsaKeyValueType", "Lorg/apache/xml/security/binding/xmldsig/DSAKeyValueType;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/stax/impl/securityToken/DsaKeyValueSecurityToken", "buildPublicKey", "(Lorg/apache/xml/security/binding/xmldsig/DSAKeyValueType;)Ljava/security/PublicKey;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/stax/impl/securityToken/DsaKeyValueSecurityToken", "setPublicKey", "(Ljava/security/PublicKey;)V", false);
