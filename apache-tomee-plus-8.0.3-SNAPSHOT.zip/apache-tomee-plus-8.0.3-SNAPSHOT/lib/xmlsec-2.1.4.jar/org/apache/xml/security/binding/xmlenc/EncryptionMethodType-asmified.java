...
public class EncryptionMethodTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/binding/xmlenc/EncryptionMethodType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "EncryptionMethodType");
...
annotationVisitor2.visit("name", "KeySize");
...
{
AnnotationVisitor annotationVisitor2 = annotationVisitor1.visitAnnotation(null, "Ljavax/xml/bind/annotation/XmlElementRef;");
annotationVisitor2.visit("name", "OAEPparams");
annotationVisitor2.visit("namespace", "http://www.w3.org/2001/04/xmlenc#");
annotationVisitor2.visit("type", Type.getType("Ljavax/xml/bind/JAXBElement;"));
annotationVisitor2.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmlenc/EncryptionMethodType", "content", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmlenc/EncryptionMethodType", "content", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmlenc/EncryptionMethodType", "algorithm", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmlenc/EncryptionMethodType", "algorithm", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
