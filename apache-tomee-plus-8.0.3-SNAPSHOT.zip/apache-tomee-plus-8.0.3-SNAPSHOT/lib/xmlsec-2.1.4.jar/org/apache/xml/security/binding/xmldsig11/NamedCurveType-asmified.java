...
public class NamedCurveTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/binding/xmldsig11/NamedCurveType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "NamedCurveType");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmldsig11/NamedCurveType", "uri", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmldsig11/NamedCurveType", "uri", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
