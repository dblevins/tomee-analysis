...
public class SignatureElementProxyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/xml/security/utils/SignatureElementProxy", null, "org/apache/xml/security/utils/ElementProxy", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/xml/security/utils/SignatureElementProxy", "org/w3c/dom/Document"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/utils/SignatureElementProxy", "setDocument", "(Lorg/w3c/dom/Document;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/utils/SignatureElementProxy", "getBaseLocalName", "()Ljava/lang/String;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/utils/SignatureElementProxy", "setElement", "(Lorg/w3c/dom/Element;)V", false);
methodVisitor.visitInsn(RETURN);
