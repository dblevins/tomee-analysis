...
public class TransformerAlgorithmMapper$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/xml/security/stax/config/TransformerAlgorithmMapper$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/xml/security/stax/config/TransformerAlgorithmMapper", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$xml$security$stax$ext$XMLSecurityConstants$DIRECTION", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/xml/security/stax/ext/XMLSecurityConstants$DIRECTION", "values", "()[Lorg/apache/xml/security/stax/ext/XMLSecurityConstants$DIRECTION;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/xml/security/stax/config/TransformerAlgorithmMapper$1", "$SwitchMap$org$apache$xml$security$stax$ext$XMLSecurityConstants$DIRECTION", "[I");
