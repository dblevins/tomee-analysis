...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", null, "org/apache/xml/security/c14n/implementations/CanonicalizerBase", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "firstCall", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "xmlattrStack", "Lorg/apache/xml/security/c14n/implementations/XmlAttrStack;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "c14n11", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "firstCall", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/xml/security/c14n/implementations/XmlAttrStack");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/c14n/implementations/XmlAttrStack", "<init>", "(Z)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "xmlattrStack", "Lorg/apache/xml/security/c14n/implementations/XmlAttrStack;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "c14n11", "Z");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "firstCall", "Z");
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "COMPARE", "Lorg/apache/xml/security/c14n/helper/AttrCompare;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "org/w3c/dom/Element", "org/apache/xml/security/c14n/implementations/NameSpaceSymbTable", "java/util/Map", "java/util/SortedSet", "org/w3c/dom/NamedNodeMap", Opcodes.INTEGER, Opcodes.INTEGER, "org/w3c/dom/Attr", "java/lang/String", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/NameSpaceSymbTable", "getUnrenderedNodes", "(Ljava/util/Collection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "xmlattrStack", "Lorg/apache/xml/security/c14n/implementations/XmlAttrStack;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/XmlAttrStack", "getXmlnsAttr", "(Ljava/util/Collection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "firstCall", "Z");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "getWriter", "()Ljava/io/OutputStream;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "outputAttrToWriter", "(Ljava/lang/String;Ljava/lang/String;Ljava/io/OutputStream;Ljava/util/Map;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/XmlAttrStack", "push", "(I)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/NameSpaceSymbTable", "getLevel", "()I", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "isVisibleDO", "(Lorg/w3c/dom/Node;I)I", false);
methodVisitor.visitInsn(ICONST_1);
Label label0 = new Label();
...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "org/w3c/dom/Element", "org/apache/xml/security/c14n/implementations/NameSpaceSymbTable", "java/util/Map", Opcodes.INTEGER, "java/util/SortedSet", "org/w3c/dom/NamedNodeMap", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(IFEQ, label5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "c14n11", "Z");
Label label6 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label6);
...
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "org/w3c/dom/Element", "org/apache/xml/security/c14n/implementations/NameSpaceSymbTable", "java/util/Map", Opcodes.INTEGER, "java/util/SortedSet", "org/w3c/dom/NamedNodeMap", Opcodes.INTEGER, Opcodes.INTEGER, "org/w3c/dom/Attr", "java/lang/String", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "xmlattrStack", "Lorg/apache/xml/security/c14n/implementations/XmlAttrStack;");
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/XmlAttrStack", "addXmlnsAttr", "(Lorg/w3c/dom/Attr;)V", false);
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ILOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "isVisible", "(Lorg/w3c/dom/Node;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/w3c/dom/Attr", "org/w3c/dom/Node"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "isVisible", "(Lorg/w3c/dom/Node;)Z", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/Canonicalizer20010315", "getNullNode", "(Lorg/w3c/dom/Document;)Lorg/w3c/dom/Attr;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/c14n/implementations/NameSpaceSymbTable", "addMappingAndRender", "(Ljava/lang/String;Ljava/lang/String;Lorg/w3c/dom/Attr;)Lorg/w3c/dom/Node;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
