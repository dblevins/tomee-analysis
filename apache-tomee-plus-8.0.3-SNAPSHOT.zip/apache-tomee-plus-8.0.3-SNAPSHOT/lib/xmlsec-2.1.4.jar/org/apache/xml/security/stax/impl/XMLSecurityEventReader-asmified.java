...
public class XMLSecurityEventReaderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/stax/impl/XMLSecurityEventReader", null, "java/lang/Object", new String[] { "javax/xml/stream/XMLEventReader" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "xmlSecEventIterator", "Ljava/util/Iterator;", "Ljava/util/Iterator<Lorg/apache/xml/security/stax/ext/stax/XMLSecEvent;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "xmlSecEvent", "Ljavax/xml/stream/events/XMLEvent;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/Deque;I)V", "(Ljava/util/Deque<Lorg/apache/xml/security/stax/ext/stax/XMLSecEvent;>;I)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/XMLSecurityEventReader", "xmlSecEventIterator", "Ljava/util/Iterator;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 3);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/xml/security/stax/impl/XMLSecurityEventReader", "java/util/Deque", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/XMLSecurityEventReader", "xmlSecEventIterator", "Ljava/util/Iterator;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/XMLSecurityEventReader", "xmlSecEvent", "Ljavax/xml/stream/events/XMLEvent;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/XMLSecurityEventReader", "xmlSecEvent", "Ljavax/xml/stream/events/XMLEvent;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/stax/impl/XMLSecurityEventReader", "nextEvent", "()Ljavax/xml/stream/events/XMLEvent;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
