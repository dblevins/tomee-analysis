...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jcp/xml/dsig/internal/SignerOutputStream", null, "java/io/ByteArrayOutputStream", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "sig", "Ljava/security/Signature;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jcp/xml/dsig/internal/SignerOutputStream", "sig", "Ljava/security/Signature;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jcp/xml/dsig/internal/SignerOutputStream", "sig", "Ljava/security/Signature;");
methodVisitor.visitVarInsn(ILOAD, 1);
