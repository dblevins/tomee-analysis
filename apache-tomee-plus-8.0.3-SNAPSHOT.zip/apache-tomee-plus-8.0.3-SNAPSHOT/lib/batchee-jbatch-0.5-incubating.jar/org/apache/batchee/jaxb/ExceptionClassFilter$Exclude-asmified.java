...
public class ExceptionClassFilter$ExcludeDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/batchee/jaxb/ExceptionClassFilter$Exclude", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/jaxb/ExceptionClassFilter$Exclude", "clazz", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/jaxb/ExceptionClassFilter$Exclude", "clazz", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
