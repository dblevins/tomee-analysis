...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "jobInstance", "Ljavax/batch/runtime/JobInstance;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "jobInstance", "Ljavax/batch/runtime/JobInstance;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "invokeCoreStep", "()V", null, new String[] { "javax/batch/operations/JobRestartException", "javax/batch/operations/JobStartException", "javax/batch/operations/JobExecutionAlreadyCompleteException", "javax/batch/operations/JobExecutionNotMostRecentException" });
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/batch/runtime/BatchStatus", "FAILED", "Ljavax/batch/runtime/BatchStatus;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/impl/controller/BaseStepController", "updateBatchStatus", "(Ljavax/batch/runtime/BatchStatus;)V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "updateBatchStatus", "(Ljavax/batch/runtime/BatchStatus;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "stepStatus", "Lorg/apache/batchee/container/status/StepStatus;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "statusManagerService", "Lorg/apache/batchee/container/services/JobStatusManagerService;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "jobInstance", "Ljavax/batch/runtime/JobInstance;");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/batchee/container/impl/controller/BaseStepController", "javax/batch/runtime/BatchStatus", Opcodes.INTEGER, "java/lang/String"}, 1, new Object[] {"java/lang/NumberFormatException"});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/impl/StepContextImpl", "addMetric", "(Ljavax/batch/runtime/Metric$MetricType;J)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "stepContext", "Lorg/apache/batchee/container/impl/StepContextImpl;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "stepContext", "Lorg/apache/batchee/container/impl/StepContextImpl;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/batchee/spi/TransactionManagementService", "getTransactionManager", "(Ljavax/batch/runtime/context/StepContext;)Lorg/apache/batchee/spi/TransactionManagerAdapter;", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/BaseStepController", "transactionManager", "Lorg/apache/batchee/spi/TransactionManagerAdapter;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 5);
methodVisitor.visitEnd();
