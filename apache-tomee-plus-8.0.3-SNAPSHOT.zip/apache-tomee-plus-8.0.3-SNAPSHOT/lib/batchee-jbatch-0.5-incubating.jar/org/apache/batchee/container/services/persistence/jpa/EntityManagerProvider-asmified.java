...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "newEntityManager", "()Ljakarta/persistence/EntityManager;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "release", "(Ljakarta/persistence/EntityManager;)V", null, null);
methodVisitor.visitEnd();
}
{
