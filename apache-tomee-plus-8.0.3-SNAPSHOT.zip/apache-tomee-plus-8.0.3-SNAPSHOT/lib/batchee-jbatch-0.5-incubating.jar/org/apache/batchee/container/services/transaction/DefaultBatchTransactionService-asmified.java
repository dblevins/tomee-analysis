...
public class DefaultBatchTransactionServiceDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/batchee/container/services/transaction/DefaultBatchTransactionService", null, "java/lang/Object", new String[] { "org/apache/batchee/spi/TransactionManagementService" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "batchConfig", "Ljava/util/Properties;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/services/transaction/DefaultBatchTransactionService", "batchConfig", "Ljava/util/Properties;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getTransactionManager", "()Lorg/apache/batchee/spi/TransactionManagerAdapter;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitTypeInsn(NEW, "org/apache/batchee/container/services/transaction/DefaultNonTransactionalManager");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/batchee/container/services/transaction/DefaultNonTransactionalManager", "<init>", "()V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
