...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "batchletProxy", "Ljavax/batch/api/Batchlet;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/batchlet/BatchletStepController", "batchletProxy", "Ljavax/batch/api/Batchlet;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/batch/api/Batchlet", "process", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/batchlet/BatchletStepController", "batchletProxy", "Ljavax/batch/api/Batchlet;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/batch/api/Batchlet", "stop", "()V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
