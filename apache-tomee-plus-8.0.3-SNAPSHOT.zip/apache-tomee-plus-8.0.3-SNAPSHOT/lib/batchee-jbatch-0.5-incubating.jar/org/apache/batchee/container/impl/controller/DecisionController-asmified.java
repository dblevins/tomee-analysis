...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "previousStepExecutions", "[Ljakarta/batch/runtime/StepExecution;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/DecisionController", "previousStepExecutions", "[Ljakarta/batch/runtime/StepExecution;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/DecisionController", "previousStepExecutions", "[Ljakarta/batch/runtime/StepExecution;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/Decider", "decide", "([Ljakarta/batch/runtime/StepExecution;)Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label1);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/batchee/container/impl/controller/DecisionController", "java/lang/String", "java/util/List", "org/apache/batchee/container/proxy/InjectionReferences", "jakarta/batch/api/Decider", "java/lang/String"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/batch/runtime/StepExecution");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 5);
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "[Ljakarta/batch/runtime/StepExecution;", Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/batchee/spi/PersistenceManagerService", "getStepExecutionByStepExecutionId", "(J)Ljakarta/batch/runtime/StepExecution;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 6);
