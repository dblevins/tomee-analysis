...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "JOB_CONTEXT", "Ljakarta/xml/bind/JAXBContext;", null, null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/batchee/container/jsl/JobModelResolver", "JOB_CONTEXT", "Ljakarta/xml/bind/JAXBContext;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/batchee/container/jsl/JobModelResolver", "java/lang/String", Opcodes.TOP, "org/apache/batchee/container/jsl/JSLValidationEventHandler"}, 1, new Object[] {"jakarta/xml/bind/JAXBException"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/batchee/container/jsl/JobModelResolver", "JOB_CONTEXT", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/batch/operations/BatchRuntimeException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
