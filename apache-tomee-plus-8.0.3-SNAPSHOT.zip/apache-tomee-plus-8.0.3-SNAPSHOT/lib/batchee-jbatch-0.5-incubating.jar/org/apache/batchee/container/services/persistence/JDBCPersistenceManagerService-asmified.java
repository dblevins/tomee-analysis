...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/batchee/container/services/persistence/JDBCPersistenceManagerService", "createRuntimeJobExecutionEntry", "(Ljavax/batch/runtime/JobInstance;Ljava/util/Properties;Ljavax/batch/runtime/BatchStatus;Ljava/sql/Timestamp;)J", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createRuntimeJobExecutionEntry", "(Ljavax/batch/runtime/JobInstance;Ljava/util/Properties;Ljavax/batch/runtime/BatchStatus;Ljava/sql/Timestamp;)J", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/batchee/container/services/persistence/JDBCPersistenceManagerService", "javax/batch/runtime/JobInstance", "java/util/Properties", "javax/batch/runtime/BatchStatus", "java/sql/Timestamp", "java/sql/Connection", "java/sql/PreparedStatement", "java/sql/ResultSet", "java/lang/String"}, 2, new Object[] {"java/sql/PreparedStatement", Opcodes.INTEGER});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label8);
...
methodVisitor.visitInsn(LRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/batchee/container/services/persistence/JDBCPersistenceManagerService", "javax/batch/runtime/JobInstance", "java/util/Properties", "javax/batch/runtime/BatchStatus", "java/sql/Timestamp", "java/sql/Connection", "java/sql/PreparedStatement", "java/sql/ResultSet"}, 1, new Object[] {"java/sql/SQLException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitTypeInsn(NEW, "org/apache/batchee/container/exception/PersistenceException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/batch/runtime/Metric"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 29);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/batch/runtime/Metric", "getType", "()Ljavax/batch/runtime/Metric$MetricType;", true);
