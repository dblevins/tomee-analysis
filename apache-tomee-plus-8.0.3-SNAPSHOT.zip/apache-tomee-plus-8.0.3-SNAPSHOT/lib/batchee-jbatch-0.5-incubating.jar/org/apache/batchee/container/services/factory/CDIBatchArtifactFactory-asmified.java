...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/services/factory/CDIBatchArtifactFactory", "getBeanManager", "()Ljakarta/enterprise/inject/spi/BeanManager;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Class", "jakarta/enterprise/context/spi/CreationalContext", "java/lang/Object"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/batchee/container/services/factory/CDIBatchArtifactFactory$1", "<init>", "(Lorg/apache/batchee/container/services/factory/CDIBatchArtifactFactory;Ljakarta/enterprise/context/spi/CreationalContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/cdi/BatchCDIInjectionExtension", "getBeanManager", "()Ljakarta/enterprise/inject/spi/BeanManager;", false);
methodVisitor.visitInsn(ARETURN);
