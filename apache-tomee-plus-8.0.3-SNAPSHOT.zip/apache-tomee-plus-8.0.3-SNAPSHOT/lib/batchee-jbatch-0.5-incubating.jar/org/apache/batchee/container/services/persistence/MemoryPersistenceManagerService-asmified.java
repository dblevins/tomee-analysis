...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "RUNNING_STATUSES", "Ljava/util/Collection;", "Ljava/util/Collection<Ljavax/batch/runtime/BatchStatus;>;", null);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/services/persistence/MemoryPersistenceManagerService$Structures$ExecutionInstanceData", "execution", "Lorg/apache/batchee/container/impl/JobExecutionImpl;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/impl/JobExecutionImpl", "getBatchStatus", "()Ljavax/batch/runtime/BatchStatus;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createRuntimeJobExecutionEntry", "(Ljavax/batch/runtime/JobInstance;Ljava/util/Properties;Ljavax/batch/runtime/BatchStatus;Ljava/sql/Timestamp;)Lorg/apache/batchee/container/services/persistence/MemoryPersistenceManagerService$Structures$ExecutionInstanceData;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/services/persistence/MemoryPersistenceManagerService", "createJobInstance", "(Ljava/lang/String;Ljava/lang/String;)Ljavax/batch/runtime/JobInstance;", false);
methodVisitor.visitInsn(ARETURN);
