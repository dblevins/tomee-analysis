...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "mgr", "Ljavax/transaction/TransactionManager;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/services/transaction/JTAUserTransactionAdapter", "mgr", "Ljavax/transaction/TransactionManager;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/services/transaction/JTAUserTransactionAdapter", "mgr", "Ljavax/transaction/TransactionManager;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "beginSuspending", "()Ljavax/transaction/Transaction;", null, new String[] { "org/apache/batchee/container/exception/TransactionManagementException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "resume", "(Ljavax/transaction/Transaction;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label5, "javax/transaction/HeuristicMixedException");
Label label6 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label6, "javax/transaction/HeuristicRollbackException");
Label label7 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label7, "javax/transaction/SystemException");
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/services/transaction/JTAUserTransactionAdapter", "mgr", "Ljavax/transaction/TransactionManager;");
...
methodVisitor.visitLdcInsn("aries:services/javax.transaction.TransactionManager");
methodVisitor.visitInsn(AASTORE);
