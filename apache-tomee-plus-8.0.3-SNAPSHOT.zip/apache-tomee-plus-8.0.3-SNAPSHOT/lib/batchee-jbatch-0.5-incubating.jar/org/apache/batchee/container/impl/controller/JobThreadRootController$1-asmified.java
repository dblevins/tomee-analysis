...
public class JobThreadRootController$1Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER | ACC_SYNTHETIC, "org/apache/batchee/container/impl/controller/JobThreadRootController$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/batchee/container/impl/controller/JobThreadRootController", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$batchee$container$status$ExtendedBatchStatus", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/batchee/container/status/ExtendedBatchStatus", "values", "()[Lorg/apache/batchee/container/status/ExtendedBatchStatus;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/batchee/container/impl/controller/JobThreadRootController$1", "$SwitchMap$org$apache$batchee$container$status$ExtendedBatchStatus", "[I");
