...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "collectorProxy", "Ljakarta/batch/api/partition/PartitionCollector;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "stepListeners", "Ljava/util/List;", "Ljava/util/List<Ljakarta/batch/api/listener/StepListener;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/SingleThreadedStepController", "collectorProxy", "Ljakarta/batch/api/partition/PartitionCollector;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/batchee/container/impl/controller/SingleThreadedStepController", "java/util/Iterator", "jakarta/batch/api/listener/StepListener"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "java/lang/Exception");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/SingleThreadedStepController", "collectorProxy", "Ljakarta/batch/api/partition/PartitionCollector;");
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label3);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/SingleThreadedStepController", "collectorProxy", "Ljakarta/batch/api/partition/PartitionCollector;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionCollector", "collectPartitionData", "()Ljava/io/Serializable;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/util/PartitionDataWrapper", "setBatchStatus", "(Ljakarta/batch/runtime/BatchStatus;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/SingleThreadedStepController", "stepStatus", "Lorg/apache/batchee/container/status/StepStatus;");
