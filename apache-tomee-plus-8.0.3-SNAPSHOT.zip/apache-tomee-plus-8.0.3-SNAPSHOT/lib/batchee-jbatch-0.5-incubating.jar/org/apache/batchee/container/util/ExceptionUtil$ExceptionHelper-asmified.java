...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/batchee/container/util/ExceptionUtil$ExceptionHelper", "<T:Ljava/lang/Throwable;>Ljava/lang/Object;", "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/batchee/container/util/ExceptionUtil$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/batchee/container/util/ExceptionUtil$ExceptionHelper", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Lorg/apache/batchee/container/util/ExceptionUtil$ExceptionHelper;Ljava/lang/Throwable;)V", null, new String[] { "java/lang/Throwable" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/batchee/container/util/ExceptionUtil$ExceptionHelper", "throwException", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(RETURN);
