...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "plan", "Ljakarta/batch/api/partition/PartitionPlan;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "partitionReducerProxy", "Ljakarta/batch/api/partition/PartitionReducer;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "analyzerProxy", "Ljakarta/batch/api/partition/PartitionAnalyzer;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "stepListeners", "Ljava/util/List;", "Ljava/util/List<Ljakarta/batch/api/listener/StepListener;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "plan", "Ljakarta/batch/api/partition/PartitionPlan;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "partitionReducerProxy", "Ljakarta/batch/api/partition/PartitionReducer;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "analyzerProxy", "Ljakarta/batch/api/partition/PartitionAnalyzer;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/impl/controller/PartitionedStepController", "updateBatchStatus", "(Ljakarta/batch/runtime/BatchStatus;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/impl/jobinstance/RuntimeJobExecution", "getBatchStatus", "()Ljakarta/batch/runtime/BatchStatus;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "generatePartitionPlan", "()Ljakarta/batch/api/partition/PartitionPlan;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/batch/api/partition/PartitionPlan", "java/lang/Integer", "org/apache/batchee/jaxb/PartitionMapper"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "jobExecutionImpl", "Lorg/apache/batchee/container/impl/jobinstance/RuntimeJobExecution;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/batchee/container/proxy/ProxyFactory", "createPartitionMapperProxy", "(Lorg/apache/batchee/spi/BatchArtifactFactory;Ljava/lang/String;Lorg/apache/batchee/container/proxy/InjectionReferences;Lorg/apache/batchee/container/impl/jobinstance/RuntimeJobExecution;)Ljakarta/batch/api/partition/PartitionMapper;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionMapper", "mapPartitions", "()Ljakarta/batch/api/partition/PartitionPlan;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label1);
Label label16 = new Label();
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/batchee/container/impl/controller/PartitionedStepController", "jakarta/batch/api/partition/PartitionPlan", "java/lang/Integer", "org/apache/batchee/jaxb/PartitionMapper", "java/util/List", "org/apache/batchee/container/proxy/InjectionReferences", "jakarta/batch/api/partition/PartitionMapper", "jakarta/batch/api/partition/PartitionPlan"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getPartitionsOverride", "()Z", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "setPartitionsOverride", "(Z)V", true);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getPartitionsOverride", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getPartitions", "()I", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "setPartitions", "(I)V", true);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getThreads", "()I", true);
Label label20 = new Label();
methodVisitor.visitJumpInsn(IFNE, label20);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getPartitions", "()I", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "setThreads", "(I)V", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getPartitionProperties", "()[Ljava/util/Properties;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "setPartitionProperties", "([Ljava/util/Properties;)V", true);
Label label22 = new Label();
methodVisitor.visitJumpInsn(GOTO, label22);
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/batchee/container/impl/controller/PartitionedStepController", "jakarta/batch/api/partition/PartitionPlan", "java/lang/Integer", "org/apache/batchee/jaxb/PartitionMapper"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "step", "Lorg/apache/batchee/jaxb/Step;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/jaxb/Step", "getPartition", "()Lorg/apache/batchee/jaxb/Partition;", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "plan", "Ljakarta/batch/api/partition/PartitionPlan;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionPlan", "getPartitionsOverride", "()Z", true);
Label label3 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "invokeCoreStep", "()V", null, new String[] { "jakarta/batch/operations/JobRestartException", "jakarta/batch/operations/JobStartException", "jakarta/batch/operations/JobExecutionAlreadyCompleteException", "jakarta/batch/operations/JobExecutionNotMostRecentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/batchee/container/impl/controller/PartitionedStepController", "generatePartitionPlan", "()Ljakarta/batch/api/partition/PartitionPlan;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "plan", "Ljakarta/batch/api/partition/PartitionPlan;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "stepStatus", "Lorg/apache/batchee/container/status/StepStatus;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "partitionReducerProxy", "Ljakarta/batch/api/partition/PartitionReducer;");
methodVisitor.visitJumpInsn(IFNULL, label3);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "partitionReducerProxy", "Ljakarta/batch/api/partition/PartitionReducer;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionReducer", "rollbackPartitionedStep", "()V", true);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "analyzerProxy", "Ljakarta/batch/api/partition/PartitionAnalyzer;");
Label label4 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "buildSubJobBatchWorkUnits", "()V", null, new String[] { "jakarta/batch/operations/JobRestartException", "jakarta/batch/operations/JobStartException", "jakarta/batch/operations/JobExecutionAlreadyCompleteException", "jakarta/batch/operations/JobExecutionNotMostRecentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "step", "Lorg/apache/batchee/jaxb/Step;");
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/batchee/container/impl/controller/PartitionedStepBuilder", "buildPartitionSubJob", "(Ljava/lang/Long;Ljakarta/batch/runtime/context/JobContext;Lorg/apache/batchee/jaxb/Step;I)Lorg/apache/batchee/jaxb/JSLJob;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "executeAndWaitForCompletion", "()V", null, new String[] { "jakarta/batch/operations/JobRestartException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionAnalyzer", "analyzeCollectorData", "(Ljava/io/Serializable;)V", true);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "analyzerProxy", "Ljakarta/batch/api/partition/PartitionAnalyzer;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/batchee/container/util/PartitionDataWrapper", "getBatchstatus", "()Ljakarta/batch/runtime/BatchStatus;", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionAnalyzer", "analyzeStatus", "(Ljakarta/batch/runtime/BatchStatus;Ljava/lang/String;)V", true);
methodVisitor.visitLabel(label4);
Label label18 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/runtime/StepExecution", "getMetrics", "()[Ljakarta/batch/runtime/Metric;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
...
Label label9 = new Label();
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/batchee/container/impl/controller/PartitionedStepController", Opcodes.INTEGER, "java/util/Iterator", "org/apache/batchee/container/util/BatchWorkUnit", "java/util/List", "[Ljakarta/batch/runtime/Metric;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 7);
methodVisitor.visitVarInsn(ILOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "partitionReducerProxy", "Ljakarta/batch/api/partition/PartitionReducer;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionReducer", "beforePartitionedStepCompletion", "()V", true);
methodVisitor.visitLabel(label4);
methodVisitor.visitJumpInsn(GOTO, label13);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/batch/api/listener/StepListener;"));
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "step", "Lorg/apache/batchee/jaxb/Step;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/batch/api/listener/StepListener");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/listener/StepListener", "beforeStep", "()V", true);
methodVisitor.visitLabel(label1);
Label label8 = new Label();
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/batchee/container/impl/controller/PartitionedStepController", "java/util/Iterator", "jakarta/batch/api/listener/StepListener"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/batchee/container/impl/controller/chunk/ExceptionConfig", "wrapBatchException", "(Ljava/lang/Exception;)V", false);
methodVisitor.visitLabel(label8);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/batchee/container/impl/controller/PartitionedStepController", "partitionReducerProxy", "Ljakarta/batch/api/partition/PartitionReducer;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionReducer", "beginPartitionedStep", "()V", true);
methodVisitor.visitLabel(label4);
methodVisitor.visitJumpInsn(GOTO, label9);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/partition/PartitionReducer", "afterPartitionedStepCompletion", "(Ljakarta/batch/api/partition/PartitionReducer$PartitionStatus;)V", true);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/batch/api/listener/StepListener", "afterStep", "()V", true);
methodVisitor.visitLabel(label4);
Label label10 = new Label();
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label5);
