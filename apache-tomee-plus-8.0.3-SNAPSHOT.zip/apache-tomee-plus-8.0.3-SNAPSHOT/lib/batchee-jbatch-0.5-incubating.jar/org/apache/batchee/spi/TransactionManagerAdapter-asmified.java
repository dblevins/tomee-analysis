...
public class TransactionManagerAdapterDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/batchee/spi/TransactionManagerAdapter", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setTransactionTimeout", "(I)V", null, null);
methodVisitor.visitEnd();
}
