...
public class Util$MethodWrapperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "javax/el/Util$MethodWrapper", "Ljavax/el/Util$Wrapper<Ljava/lang/reflect/Method;>;", "javax/el/Util$Wrapper", null);

classWriter.visitInnerClass("javax/el/Util$MethodWrapper", "javax/el/Util", "MethodWrapper", ACC_PRIVATE | ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/el/Util$MethodWrapper", "m", "Ljava/lang/reflect/Method;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unWrap", "()Ljava/lang/reflect/Method;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/el/Util$MethodWrapper", "m", "Ljava/lang/reflect/Method;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/el/Util$MethodWrapper", "unWrap", "()Ljava/lang/reflect/Method;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
