...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/el/Util$MethodWrapper", "Ljakarta/el/Util$Wrapper<Ljava/lang/reflect/Method;>;", "jakarta/el/Util$Wrapper", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/Util$MethodWrapper", "m", "Ljava/lang/reflect/Method;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/Util$MethodWrapper", "m", "Ljava/lang/reflect/Method;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/el/Util$MethodWrapper", "unWrap", "()Ljava/lang/reflect/Method;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
