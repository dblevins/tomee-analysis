...
public class JsonManagedReferenceDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "com/fasterxml/jackson/annotation/JsonManagedReference", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit(null, "defaultReference");
annotationVisitor0.visitEnd();
}
