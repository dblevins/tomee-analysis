...
public class ModuleReferenceImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/jdt/internal/compiler/env/ModuleReferenceImpl", null, "java/lang/Object", new String[] { "org/eclipse/jdt/internal/compiler/env/IModule$IModuleReference" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/env/ModuleReferenceImpl", "name", "[C");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/env/ModuleReferenceImpl", "modifiers", "I");
