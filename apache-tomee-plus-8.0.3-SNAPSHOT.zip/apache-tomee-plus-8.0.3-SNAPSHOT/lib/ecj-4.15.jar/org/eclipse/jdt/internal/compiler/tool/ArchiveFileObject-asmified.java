...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", null, "java/lang/Object", new String[] { "javax/tools/JavaFileObject" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "zipFile", "Ljava/util/zip/ZipFile;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "entryName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "file", "Ljava/io/File;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "charset", "Ljava/nio/charset/Charset;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "zipFile", "Ljava/util/zip/ZipFile;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "getKind", "()Ljavax/tools/JavaFileObject$Kind;", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "getClassReader", "()Lorg/eclipse/jdt/internal/compiler/classfmt/ClassFileReader;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "org/eclipse/jdt/internal/compiler/classfmt/ClassFileReader", "java/lang/Throwable", "java/lang/Throwable", "java/util/zip/ZipFile"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "org/eclipse/jdt/internal/compiler/classfmt/ClassFileReader"}, 1, new Object[] {"org/eclipse/jdt/internal/compiler/classfmt/ClassFormatException"});
methodVisitor.visitInsn(POP);
methodVisitor.visitJumpInsn(GOTO, label8);
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "$SWITCH_TABLE$javax$tools$JavaFileObject$Kind", "()[I", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "getKind", "()Ljavax/tools/JavaFileObject$Kind;", false);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "toUri", "()Ljava/net/URI;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "toUri", "()Ljava/net/URI;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "charset", "Ljava/nio/charset/Charset;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/zip/ZipFile", "close", "()V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", Opcodes.INTEGER, "java/lang/Throwable", "java/lang/Throwable", "java/util/zip/ZipFile", "java/util/zip/ZipEntry"}, 1, new Object[] {"java/lang/CharSequence"});
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", Opcodes.INTEGER, "java/lang/Throwable", "java/lang/Throwable", "java/util/zip/ZipFile"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label7 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/zip/ZipFile", "close", "()V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "java/lang/Throwable", "java/lang/Throwable", "java/util/zip/ZipFile", "java/util/zip/ZipEntry"}, 1, new Object[] {Opcodes.LONG});
methodVisitor.visitInsn(LRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "java/lang/Throwable", "java/lang/Throwable", "java/util/zip/ZipFile"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label8 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label8);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "file", "Ljava/io/File;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/zip/ZipFile", "<init>", "(Ljava/io/File;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "zipFile", "Ljava/util/zip/ZipFile;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "zipFile", "Ljava/util/zip/ZipFile;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "$SWITCH_TABLE$javax$tools$JavaFileObject$Kind", "[I");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/jdt/internal/compiler/tool/ArchiveFileObject", "$SWITCH_TABLE$javax$tools$JavaFileObject$Kind", "[I");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
