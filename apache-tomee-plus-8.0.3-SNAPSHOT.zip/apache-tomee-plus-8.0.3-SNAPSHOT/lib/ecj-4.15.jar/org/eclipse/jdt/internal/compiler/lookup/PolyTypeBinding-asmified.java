...
public class PolyTypeBindingDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", null, "org/eclipse/jdt/internal/compiler/lookup/TypeBinding", null);

{
fieldVisitor = classWriter.visitField(0, "expression", "Lorg/eclipse/jdt/internal/compiler/ast/Expression;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "vanillaCompatibilty", "Z", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/jdt/internal/compiler/ast/Expression;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "vanillaCompatibilty", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "expression", "Lorg/eclipse/jdt/internal/compiler/ast/Expression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "vanillaCompatibilty", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "readableName", "()[C", false);
...
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuffer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("PolyTypeBinding for: ");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "computeBoxingType", "()Lorg/eclipse/jdt/internal/compiler/lookup/TypeBinding;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding"}, 1, new Object[] {"org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding"});
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding"}, 2, new Object[] {"org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/lookup/PolyTypeBinding", "vanillaCompatibilty", "Z");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
