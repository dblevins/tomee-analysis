...
public class JrtFileSystemWithOlderRelease$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "Lorg/eclipse/jdt/internal/compiler/util/JRTUtil$AbstractFileVisitor<Ljava/nio/file/Path;>;", "org/eclipse/jdt/internal/compiler/util/JRTUtil$AbstractFileVisitor", null);

classWriter.visitOuterClass("org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease", "walkModuleImage", "(Lorg/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor;I)V");
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease;", null, null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease;ILorg/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "this$0", "Lorg/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "val$notify", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "val$visitor", "Lorg/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "val$notify", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "val$visitor", "Lorg/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitJumpInsn(IF_ICMPNE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "this$0", "Lorg/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease;");
methodVisitor.visitLdcInsn("");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/nio/file/Path", "getName", "(I)Ljava/nio/file/Path;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/nio/file/Path", "toString", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease", "cachePackage", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "val$visitor", "Lorg/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "preVisitDirectory", "(Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/nio/file/Path");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/util/JrtFileSystemWithOlderRelease$1", "visitFile", "(Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
