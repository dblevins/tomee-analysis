package asm.org.eclipse.jdt.internal.antadapter;
...
public class AntAdapterMessagesDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/jdt/internal/antadapter/AntAdapterMessages", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "BUNDLE_NAME", "Ljava/lang/String;", null, "org.eclipse.jdt.internal.antadapter.messages");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "RESOURCE_BUNDLE", "Ljava/util/ResourceBundle;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("org.eclipse.jdt.internal.antadapter.messages");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/jdt/internal/antadapter/AntAdapterMessages", "RESOURCE_BUNDLE", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "java/util/MissingResourceException");
methodVisitor.visitLabel(label0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/antadapter/AntAdapterMessages", "RESOURCE_BUNDLE", "Ljava/util/ResourceBundle;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getString", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
