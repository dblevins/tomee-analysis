...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", null, "java/lang/Object", new String[] { "jakarta/json/bind/serializer/DeserializationContext" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "jsonp", "Ljakarta/json/spi/JsonProvider;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/johnzon/mapper/MappingParser;Ljakarta/json/JsonBuilderFactory;Ljakarta/json/spi/JsonProvider;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "builderFactory", "Ljakarta/json/JsonBuilderFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "jsonp", "Ljakarta/json/spi/JsonProvider;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "deserialize", "(Ljava/lang/Class;Ljakarta/json/stream/JsonParser;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljakarta/json/stream/JsonParser;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "read", "(Ljakarta/json/stream/JsonParser;)Ljakarta/json/JsonValue;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/mapper/MappingParser", "readObject", "(Ljakarta/json/JsonValue;Ljava/lang/reflect/Type;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "deserialize", "(Ljava/lang/reflect/Type;Ljakarta/json/stream/JsonParser;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/reflect/Type;Ljakarta/json/stream/JsonParser;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "runtime", "Lorg/apache/johnzon/mapper/MappingParser;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "read", "(Ljakarta/json/stream/JsonParser;)Ljakarta/json/JsonValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "builderFactory", "Ljakarta/json/JsonBuilderFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "parseObject", "(Ljava/lang/String;Ljakarta/json/stream/JsonParser;Ljakarta/json/JsonObjectBuilder;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "parseArray", "(Ljakarta/json/stream/JsonParser;Ljakarta/json/JsonArrayBuilder;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/serializer/JohnzonDeserializationContext", "jsonp", "Ljakarta/json/spi/JsonProvider;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/json/stream/JsonParser", "getString", "()Ljava/lang/String;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseObject", "(Ljava/lang/String;Ljakarta/json/stream/JsonParser;Ljakarta/json/JsonObjectBuilder;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ASTORE, 4);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseArray", "(Ljakarta/json/stream/JsonParser;Ljakarta/json/JsonArrayBuilder;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
