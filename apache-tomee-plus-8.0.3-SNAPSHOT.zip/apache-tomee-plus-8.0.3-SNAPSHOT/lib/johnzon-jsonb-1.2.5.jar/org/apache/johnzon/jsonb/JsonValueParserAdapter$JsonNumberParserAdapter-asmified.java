...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/jsonb/JsonValueParserAdapter$JsonNumberParserAdapter", "Lorg/apache/johnzon/jsonb/JsonValueParserAdapter<Ljakarta/json/JsonNumber;>;", "org/apache/johnzon/jsonb/JsonValueParserAdapter", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/json/JsonNumber;)V", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jsonb/JsonValueParserAdapter$JsonNumberParserAdapter", "getValue", "()Ljakarta/json/JsonValue;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jsonb/JsonValueParserAdapter$JsonNumberParserAdapter", "getValue", "()Ljakarta/json/JsonValue;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/json/JsonNumber");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/json/JsonNumber", "intValueExact", "()I", true);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
