...
public class Inet6AddressEditorDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/propertyeditor/Inet6AddressEditor", null, "org/apache/xbean/propertyeditor/AbstractConverter", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/net/Inet6Address", "getByName", "(Ljava/lang/String;)Ljava/net/InetAddress;", false);
