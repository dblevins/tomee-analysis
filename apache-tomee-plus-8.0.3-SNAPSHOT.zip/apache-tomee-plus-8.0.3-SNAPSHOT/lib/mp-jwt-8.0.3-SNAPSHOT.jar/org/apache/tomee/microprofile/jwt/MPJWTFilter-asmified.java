...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/microprofile/jwt/MPJWTFilter", null, "java/lang/Object", new String[] { "javax/servlet/Filter" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "authContextInfo", "Ljavax/enterprise/inject/Instance;", "Ljavax/enterprise/inject/Instance<Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;>;", null);
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/MPJWTFilter$MPJWTServletRequestWrapper", "<init>", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/jwt/MPJWTFilter", "authContextInfo", "Ljavax/enterprise/inject/Instance;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "token", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;)Ljava/util/function/Function;", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;)Ljava/util/function/Function<Ljavax/servlet/http/HttpServletRequest;Lorg/eclipse/microprofile/jwt/JsonWebToken;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/tomee/microprofile/jwt/MPJWTFilter$ValidateJSonWebToken");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/MPJWTFilter$ValidateJSonWebToken", "<init>", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;)V", false);
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("apply", "(Lorg/apache/tomee/microprofile/jwt/MPJWTFilter$ValidateJSonWebToken;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEVIRTUAL, "org/apache/tomee/microprofile/jwt/MPJWTFilter$ValidateJSonWebToken", "validate", "(Ljavax/servlet/http/HttpServletRequest;)Lorg/eclipse/microprofile/jwt/JsonWebToken;", false), Type.getType("(Ljavax/servlet/http/HttpServletRequest;)Lorg/eclipse/microprofile/jwt/JsonWebToken;")});
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;)Ljava/util/function/Function;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomee/microprofile/jwt/MPJWTFilter", "token", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/tomee/microprofile/jwt/config/JWTAuthConfiguration;)Ljava/util/function/Function;", false);
methodVisitor.visitInsn(ARETURN);
