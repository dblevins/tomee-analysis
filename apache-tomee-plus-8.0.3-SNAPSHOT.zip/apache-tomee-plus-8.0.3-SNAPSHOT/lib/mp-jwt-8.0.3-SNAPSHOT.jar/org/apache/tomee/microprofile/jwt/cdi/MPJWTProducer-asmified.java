...
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljakarta/enterprise/context/RequestScoped;", true);
annotationVisitor0.visitEnd();
}
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/jwt/cdi/MPJWTProducer", "httpServletRequest", "Ljakarta/servlet/http/HttpServletRequest;");
