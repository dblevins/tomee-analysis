...
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/ietf/jgss/GSSCredential", "javax/security/auth/Subject", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/cxf/transport/http/auth/AbstractSpnegoAuthSupplier", "org/apache/cxf/configuration/security/AuthorizationPolicy", "java/lang/String", "org/ietf/jgss/Oid", "org/apache/cxf/message/Message", "org/ietf/jgss/GSSCredential", "javax/security/auth/Subject", "org/ietf/jgss/GSSManager", "org/ietf/jgss/GSSName", "org/ietf/jgss/GSSContext", "[B"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/transport/http/auth/AbstractSpnegoAuthSupplier", "decorateSubject", "(Ljavax/security/auth/Subject;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "decorateSubject", "(Ljavax/security/auth/Subject;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
