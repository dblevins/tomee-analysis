...
public class WildcardJohnzonProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/jaxrs/WildcardJohnzonProvider", "<T:Ljava/lang/Object;>Lorg/apache/johnzon/jaxrs/DelegateProvider<TT;>;", "org/apache/johnzon/jaxrs/DelegateProvider", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jaxrs/WildcardJohnzonProvider", "<init>", "(Lorg/apache/johnzon/mapper/Mapper;Ljava/util/Collection;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("johnzon.jaxrs.johnzon.wildcard.throwNoContentExceptionOnEmptyStreams");
