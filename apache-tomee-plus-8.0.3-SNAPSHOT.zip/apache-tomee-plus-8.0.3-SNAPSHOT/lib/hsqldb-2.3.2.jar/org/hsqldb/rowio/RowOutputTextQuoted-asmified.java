...
public class RowOutputTextQuotedDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/hsqldb/rowio/RowOutputTextQuoted", null, "org/hsqldb/rowio/RowOutputText", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/rowio/RowOutputTextQuoted", "allQuoted", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/hsqldb/rowio/RowOutputTextQuoted", "hasUnprintable", "(Ljava/lang/String;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "hasUnprintable", "(Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
