...
public class IntKeyHashMapDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/hsqldb/lib/IntKeyHashMap", null, "org/hsqldb/map/BaseHashMap", null);

classWriter.visitInnerClass("org/hsqldb/lib/IntKeyHashMap$Values", "org/hsqldb/lib/IntKeyHashMap", "Values", 0);

classWriter.visitInnerClass("org/hsqldb/lib/IntKeyHashMap$KeySet", "org/hsqldb/lib/IntKeyHashMap", "KeySet", 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/IntKeyHashMap", "getLookup", "(I)I", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/IntKeyHashMap", "objectValueTable", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ILOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "valuesToArray", "([Ljava/lang/Object;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/IntKeyHashMap", "keySet", "Lorg/hsqldb/lib/Set;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/hsqldb/lib/IntKeyHashMap$KeySet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/hsqldb/lib/IntKeyHashMap$KeySet", "<init>", "(Lorg/hsqldb/lib/IntKeyHashMap;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/IntKeyHashMap", "keySet", "Lorg/hsqldb/lib/Set;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/IntKeyHashMap", "keySet", "Lorg/hsqldb/lib/Set;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/IntKeyHashMap", "values", "Lorg/hsqldb/lib/Collection;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/hsqldb/lib/IntKeyHashMap$Values");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/hsqldb/lib/IntKeyHashMap$Values", "<init>", "(Lorg/hsqldb/lib/IntKeyHashMap;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/IntKeyHashMap", "values", "Lorg/hsqldb/lib/Collection;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/IntKeyHashMap", "values", "Lorg/hsqldb/lib/Collection;");
