...
public class OrderedIntKeyHashMap$ValuesDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER, "org/hsqldb/lib/OrderedIntKeyHashMap$Values", null, "java/lang/Object", new String[] { "org/hsqldb/lib/Collection" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/OrderedIntKeyHashMap$Values", "this$0", "Lorg/hsqldb/lib/OrderedIntKeyHashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/OrderedIntKeyHashMap$Values", "this$0", "Lorg/hsqldb/lib/OrderedIntKeyHashMap;");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/OrderedIntKeyHashMap$Values", "size", "()I", false);
