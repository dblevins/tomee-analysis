...
public class AppendableExceptionDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/hsqldb/lib/AppendableException", null, "java/lang/Exception", null);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-1002629580611098803L));
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "appendages", "Ljava/util/List;", "Ljava/util/List<Ljava/lang/String;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/AppendableException", "appendages", "Ljava/util/List;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/hsqldb/lib/AppendableException", "LS", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitInsn(POP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "appendMessage", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/AppendableException", "appendages", "Ljava/util/List;");
Label label0 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/AppendableException", "appendages", "Ljava/util/List;");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/hsqldb/lib/AppendableException", "LS", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
