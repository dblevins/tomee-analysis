...
public class SecretKeyCallback$AliasRequestDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/security/auth/message/callback/SecretKeyCallback$AliasRequest", null, "java/lang/Object", new String[] { "javax/security/auth/message/callback/SecretKeyCallback$Request" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/security/auth/message/callback/SecretKeyCallback$AliasRequest", "alias", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/security/auth/message/callback/SecretKeyCallback$AliasRequest", "alias", "Ljava/lang/String;");
