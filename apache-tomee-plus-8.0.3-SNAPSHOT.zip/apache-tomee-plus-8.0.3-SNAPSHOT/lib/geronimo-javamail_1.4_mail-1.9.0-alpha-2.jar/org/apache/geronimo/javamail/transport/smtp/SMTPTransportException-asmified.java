...
public class SMTPTransportExceptionDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/apache/geronimo/javamail/transport/smtp/SMTPTransportException", null, "java/lang/Exception", null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljava/lang/Exception;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("SMTP Transport error");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Exception", "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(RETURN);
