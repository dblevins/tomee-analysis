...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/mail/event/MessageChangedEvent", null, "jakarta/mail/event/MailEvent", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Object;ILjakarta/mail/Message;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/mail/event/MessageChangedEvent", "msg", "Ljakarta/mail/Message;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/mail/event/MessageChangedEvent", "type", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/mail/event/MessageChangedListener");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/mail/event/MessageChangedListener", "messageChanged", "(Ljakarta/mail/event/MessageChangedEvent;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/event/MessageChangedEvent", "msg", "Ljakarta/mail/Message;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/event/MessageChangedEvent", "type", "I");
