...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "jakarta/mail/search/FromTerm", null, "jakarta/mail/search/AddressTerm", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/mail/Address;)V", null, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/mail/search/FromTerm", "match", "(Ljakarta/mail/Address;)Z", false);
