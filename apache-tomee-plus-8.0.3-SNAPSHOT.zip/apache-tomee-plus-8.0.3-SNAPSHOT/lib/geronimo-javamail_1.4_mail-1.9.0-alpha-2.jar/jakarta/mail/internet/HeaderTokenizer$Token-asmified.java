...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/mail/internet/HeaderTokenizer$Token", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/mail/internet/HeaderTokenizer$Token", "_type", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/mail/internet/HeaderTokenizer$Token", "_value", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/internet/HeaderTokenizer$Token", "_type", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/internet/HeaderTokenizer$Token", "_value", "Ljava/lang/String;");
