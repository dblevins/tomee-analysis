...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/mail/internet/MailDateFormat", null, "java/text/SimpleDateFormat", null);

classWriter.visitInnerClass("jakarta/mail/internet/MailDateFormat$MailDateParser", "jakarta/mail/internet/MailDateFormat", "MailDateParser", 0);
...
methodVisitor.visitTypeInsn(NEW, "jakarta/mail/internet/MailDateFormat$MailDateParser");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/mail/internet/MailDateFormat$MailDateParser", "<init>", "(Ljakarta/mail/internet/MailDateFormat;Ljava/lang/String;Ljava/text/ParsePosition;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/mail/internet/MailDateFormat", "isLenient", "()Z", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/mail/internet/MailDateFormat$MailDateParser", "parse", "(Z)Ljava/util/Date;", false);
