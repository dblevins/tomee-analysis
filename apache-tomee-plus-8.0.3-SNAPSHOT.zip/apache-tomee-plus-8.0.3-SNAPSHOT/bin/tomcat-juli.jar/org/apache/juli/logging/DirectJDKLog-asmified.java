...
public class DirectJDKLogDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/juli/logging/DirectJDKLog", null, "java/lang/Object", new String[] { "org/apache/juli/logging/Log" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL, "logger", "Ljava/util/logging/Logger;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "SIMPLE_FMT", "Ljava/lang/String;", null, "java.util.logging.SimpleFormatter");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FORMATTER", "Ljava/lang/String;", null, "org.apache.juli.formatter");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/juli/logging/DirectJDKLog", "logger", "Ljava/util/logging/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/juli/logging/DirectJDKLog", "logger", "Ljava/util/logging/Logger;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/juli/logging/DirectJDKLog", "log", "(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/juli/logging/DirectJDKLog", "java/util/logging/Level", "java/lang/String", "java/lang/Throwable", "java/lang/Throwable", "[Ljava/lang/StackTraceElement;", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/juli/logging/DirectJDKLog", "java/util/logging/Level", "java/lang/String", "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(6, 9);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getInstance", "(Ljava/lang/String;)Lorg/apache/juli/logging/Log;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/juli/logging/DirectJDKLog");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/juli/logging/DirectJDKLog", "<init>", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitLdcInsn("java.util.logging.config.class");
...
methodVisitor.visitJumpInsn(IFNONNULL, label3);
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn("org.apache.juli.formatter");
methodVisitor.visitLdcInsn("java.util.logging.SimpleFormatter");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/util/logging/Formatter", "java/util/logging/Logger", "[Ljava/util/logging/Handler;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitTypeInsn(INSTANCEOF, "java/util/logging/ConsoleHandler");
Label label5 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Handler", "setFormatter", "(Ljava/util/logging/Formatter;)V", false);
