...
public class UnmodifiableBagDump implements Opcodes {
...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections/bag/UnmodifiableBag", null, "org/apache/commons/collections/bag/AbstractBagDecorator", new String[] { "org/apache/commons/collections/Unmodifiable", "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-1873799975157099624L));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/bag/UnmodifiableBag");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bag/UnmodifiableBag", "<init>", "(Lorg/apache/commons/collections/Bag;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/commons/collections/Bag;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bag/AbstractBagDecorator", "<init>", "(Lorg/apache/commons/collections/Bag;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bag/UnmodifiableBag", "collection", "Ljava/util/Collection;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bag/UnmodifiableBag", "collection", "Ljava/util/Collection;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/UnmodifiableBag", "getCollection", "()Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/UnmodifiableBag", "getBag", "()Lorg/apache/commons/collections/Bag;", false);
