...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/map/LinkedMap$LinkedMapList", null, "java/util/AbstractList", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "parent", "Lorg/apache/commons/collections/map/LinkedMap;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/commons/collections/map/LinkedMap;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/AbstractList", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/map/LinkedMap$LinkedMapList", "parent", "Lorg/apache/commons/collections/map/LinkedMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/map/LinkedMap$LinkedMapList", "parent", "Lorg/apache/commons/collections/map/LinkedMap;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/LinkedMap", "size", "()I", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/map/LinkedMap$LinkedMapList", "parent", "Lorg/apache/commons/collections/map/LinkedMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/LinkedMap", "containsKey", "(Ljava/lang/Object;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/map/LinkedMap$LinkedMapList", "parent", "Lorg/apache/commons/collections/map/LinkedMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/LinkedMap", "indexOf", "(Ljava/lang/Object;)I", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/map/LinkedMap$LinkedMapList", "parent", "Lorg/apache/commons/collections/map/LinkedMap;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/map/LinkedMap", "keySet", "()Ljava/util/Set;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
