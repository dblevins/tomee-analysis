...
public class ReferenceMap$ValueIteratorDump implements Opcodes {
...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/ReferenceMap$ValueIterator", null, "org/apache/commons/collections/ReferenceMap$EntryIterator", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/ReferenceMap$ValueIterator", "this$0", "Lorg/apache/commons/collections/ReferenceMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/ReferenceMap$ValueIterator", "nextEntry", "()Lorg/apache/commons/collections/ReferenceMap$Entry;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/ReferenceMap$ValueIterator", "<init>", "(Lorg/apache/commons/collections/ReferenceMap;)V", false);
methodVisitor.visitInsn(RETURN);
