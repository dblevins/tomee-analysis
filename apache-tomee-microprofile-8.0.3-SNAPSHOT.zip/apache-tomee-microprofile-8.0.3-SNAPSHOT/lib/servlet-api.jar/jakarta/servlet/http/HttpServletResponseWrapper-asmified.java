...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/servlet/http/HttpServletResponseWrapper", null, "jakarta/servlet/ServletResponseWrapper", new String[] { "jakarta/servlet/http/HttpServletResponse" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_getHttpServletResponse", "()Ljakarta/servlet/http/HttpServletResponse;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/ServletResponseWrapper", "getResponse", "()Ljakarta/servlet/ServletResponse;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/http/HttpServletResponseWrapper", "_getHttpServletResponse", "()Ljakarta/servlet/http/HttpServletResponse;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/http/HttpServletResponseWrapper", "_getHttpServletResponse", "()Ljakarta/servlet/http/HttpServletResponse;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/http/HttpServletResponse", "setTrailerFields", "(Ljava/util/function/Supplier;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/http/HttpServletResponseWrapper", "_getHttpServletResponse", "()Ljakarta/servlet/http/HttpServletResponse;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/http/HttpServletResponse", "getTrailerFields", "()Ljava/util/function/Supplier;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
