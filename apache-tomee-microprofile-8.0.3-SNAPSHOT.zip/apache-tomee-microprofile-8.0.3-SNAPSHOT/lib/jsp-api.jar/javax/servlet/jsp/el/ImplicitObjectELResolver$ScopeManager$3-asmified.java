...
classWriter.visit(V1_8, ACC_SUPER, "javax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$3", "Ljavax/servlet/jsp/el/ImplicitObjectELResolver$ScopeMap<Ljava/lang/String;>;", "javax/servlet/jsp/el/ImplicitObjectELResolver$ScopeMap", null);

classWriter.visitOuterClass("javax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager", "getHeader", "()Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$3", "this$0", "Ljavax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$3", "this$0", "Ljavax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$3", "getAttribute", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
