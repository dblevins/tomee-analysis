...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "javax/servlet/jsp/el/ELException", null, "java/lang/Exception", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/jsp/el/ELException", "getCause", "()Ljava/lang/Throwable;", false);
