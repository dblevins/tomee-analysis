...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/enterprise/inject/spi/Producer;Ljakarta/enterprise/inject/spi/AnnotatedMember;)V", "(Ljakarta/enterprise/inject/spi/Producer<*>;Ljakarta/enterprise/inject/spi/AnnotatedMember<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/ProcessProducerImpl", "<init>", "(Ljakarta/enterprise/inject/spi/Producer;Ljakarta/enterprise/inject/spi/AnnotatedMember;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/events/generics/GProcessProducer", "getAnnotatedMember", "()Ljakarta/enterprise/inject/spi/AnnotatedMember;", false);
