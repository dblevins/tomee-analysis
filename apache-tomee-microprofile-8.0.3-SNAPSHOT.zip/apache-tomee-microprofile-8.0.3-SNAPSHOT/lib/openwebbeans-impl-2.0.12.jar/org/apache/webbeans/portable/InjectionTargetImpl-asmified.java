...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_VOLATILE, "constructor", "Ljakarta/enterprise/inject/spi/AnnotatedConstructor;", "Ljakarta/enterprise/inject/spi/AnnotatedConstructor<TT;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "postConstructMethods", "Ljava/util/List;", "Ljava/util/List<Ljakarta/enterprise/inject/spi/AnnotatedMethod<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "postConstructInterceptors", "Ljava/util/List;", "Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "preDestroyMethods", "Ljava/util/List;", "Ljava/util/List<Ljakarta/enterprise/inject/spi/AnnotatedMethod<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "preDestroyInterceptors", "Ljava/util/List;", "Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "aroundConstructInterceptors", "Ljava/util/List;", "Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/portable/InjectionTargetImpl", "annotatedType", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "getLifecycleInterceptors", "(Ljava/util/Collection;Ljava/util/List;Ljakarta/enterprise/inject/spi/InterceptionType;)Ljava/util/List;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/InjectionTargetImpl", "getConstructor", "()Ljakarta/enterprise/inject/spi/AnnotatedConstructor;", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"[Ljakarta/enterprise/inject/spi/Interceptor;"});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"[Ljakarta/enterprise/inject/spi/Interceptor;"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljava/lang/Object;", "(Ljava/util/Map<Ljakarta/enterprise/inject/spi/Interceptor<*>;*>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<TT;>;)TT;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/ConstructorInterceptorInvocationContext", "<init>", "(Ljakarta/inject/Provider;Ljava/util/List;Ljava/util/Map;Ljava/lang/reflect/Constructor;[Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/inject/InjectableField", "<init>", "(Ljava/lang/reflect/Field;Ljava/lang/Object;Ljakarta/enterprise/inject/spi/InjectionTarget;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "isProducerMethod", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "isDisposalMethod", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "isObserverMethod", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/InjectionTargetImpl", "annotatedType", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/InjectionTargetImpl", "postConstructMethods", "Ljava/util/List;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/LifecycleInterceptorInvocationContext", "<init>", "(Ljava/lang/Object;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/portable/InjectionTargetImpl", "java/lang/Object", "java/util/Map", "java/lang/Object", "jakarta/interceptor/InvocationContext"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/util/ExceptionUtil", "throwAsRuntimeException", "(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getConstructor", "()Ljakarta/enterprise/inject/spi/AnnotatedConstructor;", "()Ljakarta/enterprise/inject/spi/AnnotatedConstructor<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/InjectionTargetImpl", "constructor", "Ljakarta/enterprise/inject/spi/AnnotatedConstructor;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/InjectionTargetImpl", "createConstructor", "()Ljakarta/enterprise/inject/spi/AnnotatedConstructor;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/portable/InjectionTargetImpl", "constructor", "Ljakarta/enterprise/inject/spi/AnnotatedConstructor;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/InjectionTargetImpl", "constructor", "Ljakarta/enterprise/inject/spi/AnnotatedConstructor;");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/enterprise/inject/spi/AnnotatedConstructor", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isProducerMethod", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/InjectionPoint", "getMember", "()Ljava/lang/reflect/Member;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isObserverMethod", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/InjectionPoint", "getMember", "()Ljava/lang/reflect/Member;", true);
methodVisitor.visitTypeInsn(INSTANCEOF, "java/lang/reflect/Method");
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/webbeans/portable/InjectionTargetImpl", "jakarta/enterprise/inject/spi/InjectionPoint", "java/lang/reflect/Method", "[[Ljava/lang/annotation/Annotation;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/webbeans/portable/InjectionTargetImpl", "jakarta/enterprise/inject/spi/InjectionPoint", "java/lang/reflect/Method", "[[Ljava/lang/annotation/Annotation;", Opcodes.INTEGER, Opcodes.INTEGER, "[Ljava/lang/annotation/Annotation;", "[Ljava/lang/annotation/Annotation;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isDisposalMethod", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/InjectionPoint", "getMember", "()Ljava/lang/reflect/Member;", true);
methodVisitor.visitTypeInsn(INSTANCEOF, "java/lang/reflect/Method");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getLifecycleInterceptors", "(Ljava/util/Collection;Ljava/util/List;Ljakarta/enterprise/inject/spi/InterceptionType;)Ljava/util/List;", "(Ljava/util/Collection<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljakarta/enterprise/inject/spi/InterceptionType;)Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;", null);
methodVisitor.visitCode();
