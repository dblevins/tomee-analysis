...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/portable/EventProducer", "<T:Ljava/lang/Object;>Lorg/apache/webbeans/portable/AbstractProducer<Ljavax/enterprise/event/Event<TT;>;>;", "org/apache/webbeans/portable/AbstractProducer", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "filterDecorators", "(Ljavax/enterprise/event/Event;Ljava/util/List;)Ljava/util/List;", "(Ljavax/enterprise/event/Event<TT;>;Ljava/util/List<Ljavax/enterprise/inject/spi/Decorator<*>;>;)Ljava/util/List<Ljavax/enterprise/inject/spi/Decorator<*>;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljavax/enterprise/event/Event;", "(Ljava/util/Map<Ljavax/enterprise/inject/spi/Interceptor<*>;*>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<Ljavax/enterprise/event/Event<TT;>;>;)Ljavax/enterprise/event/Event<TT;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/webbeans/portable/EventProducer", "java/util/Map", "org/apache/webbeans/context/creational/CreationalContextImpl", "javax/enterprise/event/Event", "java/lang/reflect/Type", "javax/enterprise/inject/spi/InjectionPoint", "[Ljava/lang/reflect/Type;", "java/lang/reflect/Type", "java/lang/reflect/ParameterizedType", "[Ljava/lang/annotation/Annotation;"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/webbeans/portable/EventProducer", "java/util/Map", "org/apache/webbeans/context/creational/CreationalContextImpl", "javax/enterprise/event/Event", Opcodes.TOP, "javax/enterprise/inject/spi/InjectionPoint"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/EventProducer", "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljavax/enterprise/event/Event;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/enterprise/event/Event");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/EventProducer", "filterDecorators", "(Ljavax/enterprise/event/Event;Ljava/util/List;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
