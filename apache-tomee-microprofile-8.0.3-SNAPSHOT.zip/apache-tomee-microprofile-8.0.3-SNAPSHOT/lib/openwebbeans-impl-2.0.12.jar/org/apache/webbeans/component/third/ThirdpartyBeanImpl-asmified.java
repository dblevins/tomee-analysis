...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "bean", "Ljavax/enterprise/inject/spi/Bean;", "Ljavax/enterprise/inject/spi/Bean<TT;>;", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/third/ThirdpartyBeanAttributesImpl", "<init>", "(Ljavax/enterprise/inject/spi/BeanAttributes;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/Bean", "getBeanClass", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/Bean", "isNullable", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/component/third/ThirdpartyBeanImpl", "bean", "Ljavax/enterprise/inject/spi/Bean;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/third/ThirdpartyBeanImpl", "bean", "Ljavax/enterprise/inject/spi/Bean;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/component/third/ThirdpartyBeanImpl", "javax/enterprise/context/spi/CreationalContext", "org/apache/webbeans/context/creational/CreationalContextImpl", Opcodes.TOP, "javax/enterprise/inject/spi/Bean"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/component/third/ThirdpartyBeanImpl", "javax/enterprise/context/spi/CreationalContext", "org/apache/webbeans/context/creational/CreationalContextImpl", "java/lang/Object", "javax/enterprise/inject/spi/Bean"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/context/creational/CreationalContextImpl", "addDependent", "(Ljavax/enterprise/context/spi/Contextual;Ljava/lang/Object;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/webbeans/component/third/ThirdpartyBeanImpl;)Ljavax/enterprise/inject/spi/Bean;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/third/ThirdpartyBeanImpl", "bean", "Ljavax/enterprise/inject/spi/Bean;");
methodVisitor.visitInsn(ARETURN);
