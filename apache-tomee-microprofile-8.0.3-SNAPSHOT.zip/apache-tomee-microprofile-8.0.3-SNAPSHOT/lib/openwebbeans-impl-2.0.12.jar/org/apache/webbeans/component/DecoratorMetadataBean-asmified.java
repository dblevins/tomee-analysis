...
public class DecoratorMetadataBeanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/component/DecoratorMetadataBean", "<T:Ljava/lang/Object;>Lorg/apache/webbeans/component/BuiltInOwbBean<Ljavax/enterprise/inject/spi/Decorator<TT;>;>;", "org/apache/webbeans/component/BuiltInOwbBean", null);

classWriter.visitInnerClass("org/apache/webbeans/component/DecoratorMetadataBean$1", null, null, 0);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/Decorator;"));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/component/DecoratorMetadataBean$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/DecoratorMetadataBean$1", "<init>", "()V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/DecoratorMetadataBean$1", "getRawType", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(ICONST_0);
