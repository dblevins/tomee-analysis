...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/exception/WebBeansDeploymentException", null, "jakarta/enterprise/inject/spi/DeploymentException", new String[] { "org/apache/webbeans/exception/helper/DescriptiveException" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/enterprise/inject/spi/DeploymentException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/exception/WebBeansDeploymentException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/enterprise/inject/spi/DeploymentException", "getMessage", "()Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/exception/WebBeansDeploymentException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/enterprise/inject/spi/DeploymentException", "getLocalizedMessage", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/exception/helper/ExceptionMessageBuilder", "getAdditionalInformation", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
