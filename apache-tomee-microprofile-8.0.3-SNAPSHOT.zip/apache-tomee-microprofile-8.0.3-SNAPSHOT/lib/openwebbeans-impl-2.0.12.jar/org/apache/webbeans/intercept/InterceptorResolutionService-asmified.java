...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "calculateInterceptorInfo", "(Ljava/util/Set;Ljava/util/Set;Ljakarta/enterprise/inject/spi/AnnotatedType;Z)Lorg/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo;", "<T:Ljava/lang/Object;>(Ljava/util/Set<Ljava/lang/reflect/Type;>;Ljava/util/Set<Ljava/lang/annotation/Annotation;>;Ljakarta/enterprise/inject/spi/AnnotatedType<TT;>;Z)Lorg/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "getInterceptableBusinessMethods", "(Ljakarta/enterprise/inject/spi/AnnotatedType;)Ljava/util/List;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "collectEjbInterceptors", "(Ljava/util/List;Ljakarta/enterprise/inject/spi/Annotated;ZLjava/util/Set;)V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "addCdiClassLifecycleInterceptors", "(Ljakarta/enterprise/inject/spi/AnnotatedType;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "resolveSelfInterceptorBean", "(Ljakarta/enterprise/inject/spi/AnnotatedType;)Lorg/apache/webbeans/component/SelfInterceptorBean;", false);
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "calculateCdiMethodInterceptors", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/util/Set;Ljakarta/enterprise/inject/spi/AnnotatedCallable;Ljava/util/Set;Ljava/util/List;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 21);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "calculateCdiMethodDecorators", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljava/util/List;Ljakarta/enterprise/inject/spi/AnnotatedMethod;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 21);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/enterprise/inject/spi/AnnotatedMethod", "org/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/enterprise/inject/spi/AnnotatedConstructor", "org/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "addLifecycleMethods", "(Ljava/util/Map;Ljakarta/enterprise/inject/spi/AnnotatedType;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/lang/Class;Ljava/util/Set;Ljava/util/Set;Ljava/util/List;Ljava/util/Set;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 19);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 25);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "isUnproxyable", "(Ljakarta/enterprise/inject/spi/AnnotatedCallable;Z)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addCdiClassLifecycleInterceptors", "(Ljakarta/enterprise/inject/spi/AnnotatedType;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V", "<T:Ljava/lang/Object;>(Ljakarta/enterprise/inject/spi/AnnotatedType<TT;>;Ljava/util/Set<Ljava/lang/annotation/Annotation;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/intercept/InterceptorResolutionService", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveSelfInterceptorBean", "(Ljakarta/enterprise/inject/spi/AnnotatedType;)Lorg/apache/webbeans/component/SelfInterceptorBean;", "<T:Ljava/lang/Object;>(Ljakarta/enterprise/inject/spi/AnnotatedType<TT;>;)Lorg/apache/webbeans/component/SelfInterceptorBean<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/intercept/InterceptorResolutionService", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/SelfInterceptorBeanBuilder", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljakarta/enterprise/inject/spi/AnnotatedType;Lorg/apache/webbeans/component/BeanAttributesImpl;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addLifecycleMethods", "(Ljava/util/Map;Ljakarta/enterprise/inject/spi/AnnotatedType;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/lang/Class;Ljava/util/Set;Ljava/util/Set;Ljava/util/List;Ljava/util/Set;Z)V", "(Ljava/util/Map<Ljakarta/enterprise/inject/spi/InterceptionType;Lorg/apache/webbeans/intercept/InterceptorResolutionService$LifecycleMethodInfo;>;Ljakarta/enterprise/inject/spi/AnnotatedType<*>;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/Set<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/Set<Ljava/lang/annotation/Annotation;>;Z)V", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/webbeans/intercept/InterceptorResolutionService", "java/util/Map", "jakarta/enterprise/inject/spi/AnnotatedType", "jakarta/enterprise/inject/spi/InterceptionType", "java/lang/Class", "java/util/Set", "java/util/Set", "java/util/List", "java/util/Set", Opcodes.INTEGER, "java/util/List", "org/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "verifyLifecycleMethod", "(Ljava/lang/Class;Ljakarta/enterprise/inject/spi/AnnotatedMethod;)V", false);
methodVisitor.visitVarInsn(ALOAD, 14);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "collectEjbInterceptors", "(Ljava/util/List;Ljakarta/enterprise/inject/spi/Annotated;ZLjava/util/Set;)V", "(Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljakarta/enterprise/inject/spi/Annotated;ZLjava/util/Set<Ljava/lang/reflect/Type;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/interceptor/Interceptors"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/intercept/InterceptorsManager", "getEjbInterceptorForClass", "(Ljava/lang/Class;)Ljakarta/enterprise/inject/spi/Interceptor;", false);
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateEjbMethodInterceptors", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljava/util/Set;Ljava/util/List;Ljakarta/enterprise/inject/spi/AnnotatedCallable;Z)V", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljava/util/Set<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljakarta/enterprise/inject/spi/AnnotatedCallable;Z)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/interceptor/ExcludeClassInterceptors");
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isUnproxyable", "(Ljakarta/enterprise/inject/spi/AnnotatedCallable;Z)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedCallable", "getJavaMember", "()Ljava/lang/reflect/Member;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateCdiMethodDecorators", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljava/util/List;Ljakarta/enterprise/inject/spi/AnnotatedMethod;Z)V", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljava/util/List<Ljakarta/enterprise/inject/spi/Decorator<*>;>;Ljakarta/enterprise/inject/spi/AnnotatedMethod;Z)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/enterprise/inject/spi/Decorator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/intercept/InterceptorResolutionService", "getDecoratingMethod", "(Ljakarta/enterprise/inject/spi/Decorator;Ljakarta/enterprise/inject/spi/AnnotatedMethod;)Ljava/lang/reflect/Method;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
Label label5 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getDecoratingMethod", "(Ljakarta/enterprise/inject/spi/Decorator;Ljakarta/enterprise/inject/spi/AnnotatedMethod;)Ljava/lang/reflect/Method;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label9 = new Label();
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/webbeans/intercept/InterceptorResolutionService", "jakarta/enterprise/inject/spi/Decorator", "jakarta/enterprise/inject/spi/AnnotatedMethod", "java/util/Set", "java/util/Iterator", "java/lang/reflect/Type", "java/lang/Class", "[Ljava/lang/reflect/Method;", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/webbeans/intercept/InterceptorResolutionService", "jakarta/enterprise/inject/spi/Decorator", "jakarta/enterprise/inject/spi/AnnotatedMethod", "java/util/Set", "java/util/Iterator", "java/lang/reflect/Type", "java/lang/Class", "[Ljava/lang/reflect/Method;", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/reflect/Method", Opcodes.INTEGER, "java/lang/Class"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitVarInsn(ALOAD, 13);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/intercept/InterceptorResolutionService", "jakarta/enterprise/inject/spi/Decorator", "jakarta/enterprise/inject/spi/AnnotatedMethod", "java/util/Set", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateCdiMethodInterceptors", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/util/Set;Ljakarta/enterprise/inject/spi/AnnotatedCallable;Ljava/util/Set;Ljava/util/List;Z)V", "(Lorg/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/util/Set<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljakarta/enterprise/inject/spi/AnnotatedCallable;Ljava/util/Set<Ljava/lang/annotation/Annotation;>;Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Z)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/intercept/InterceptorResolutionService", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getAnnotationManager", "()Lorg/apache/webbeans/annotation/AnnotationManager;", false);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedCallable", "getAnnotations", "()Ljava/util/Set;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/annotation/AnnotationManager", "getInterceptorAnnotations", "(Ljava/util/Set;)Ljava/util/Set;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 12);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/webbeans/intercept/InterceptorResolutionService", "org/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo", "jakarta/enterprise/inject/spi/InterceptionType", "java/util/Set", "jakarta/enterprise/inject/spi/AnnotatedCallable", "java/util/Set", "java/util/List", Opcodes.INTEGER, "org/apache/webbeans/annotation/AnnotationManager", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/Map", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "verifyLifecycleMethod", "(Ljava/lang/Class;Ljakarta/enterprise/inject/spi/AnnotatedMethod;)V", "<T:Ljava/lang/Object;>(Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;Ljakarta/enterprise/inject/spi/AnnotatedMethod<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedMethod", "getParameters", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getInterceptableBusinessMethods", "(Ljakarta/enterprise/inject/spi/AnnotatedType;)Ljava/util/List;", "(Ljakarta/enterprise/inject/spi/AnnotatedType;)Ljava/util/List<Ljakarta/enterprise/inject/spi/AnnotatedMethod;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedType", "getJavaClass", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Class", "jakarta/enterprise/inject/spi/AnnotatedType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 11);
Label label4 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo", "getCdiInterceptors", "()[Ljakarta/enterprise/inject/spi/Interceptor;", false);
Label label3 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createProxiedInstance", "(Ljava/lang/Object;Lorg/apache/webbeans/context/creational/CreationalContextImpl;Ljakarta/enterprise/context/spi/CreationalContext;Lorg/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo;Ljava/lang/Class;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/function/Function;Ljava/util/function/BiFunction;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(TT;Lorg/apache/webbeans/context/creational/CreationalContextImpl<TT;>;Ljakarta/enterprise/context/spi/CreationalContext<TT;>;Lorg/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo;Ljava/lang/Class<+TT;>;Ljava/util/Map<Ljava/lang/reflect/Method;Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;>;Ljava/lang/String;Ljava/util/Map<Ljakarta/enterprise/inject/spi/Interceptor<*>;Ljava/lang/Object;>;Ljava/util/function/Function<Lorg/apache/webbeans/context/creational/CreationalContextImpl<*>;Ljava/lang/Boolean;>;Ljava/util/function/BiFunction<TT;Ljava/util/List<Ljakarta/enterprise/inject/spi/Decorator<*>;>;Ljava/util/List<Ljakarta/enterprise/inject/spi/Decorator<*>;>;>;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo", "getSelfInterceptorBean", "()Lorg/apache/webbeans/component/SelfInterceptorBean;", false);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/Decorator", "create", "(Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitVarInsn(ALOAD, 16);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$addCdiClassLifecycleInterceptors$0", "(Ljakarta/enterprise/inject/spi/AnnotatedConstructor;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedConstructor", "getParameters", "()Ljava/util/List;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "isEmpty", "()Z", true);
