...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/util/UrlSet", "Ljava/lang/Object;Ljava/util/Set<Ljava/net/URL;>;", "java/lang/Object", new String[] { "java/util/Set" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "urlMap", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Ljava/net/URL;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/util/UrlSet", "urlMap", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/UrlSet", "urlMap", "Ljava/util/Map;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addAll", "(Ljava/util/Collection;)Z", "(Ljava/util/Collection<+Ljava/net/URL;>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 2);
