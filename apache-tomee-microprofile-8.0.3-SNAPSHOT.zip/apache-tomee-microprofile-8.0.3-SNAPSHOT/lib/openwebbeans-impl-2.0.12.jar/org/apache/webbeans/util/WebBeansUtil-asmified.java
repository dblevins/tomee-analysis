...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "checkProducerGenericType", "(Ljavax/enterprise/inject/spi/Bean;Ljava/lang/reflect/Member;)V", "(Ljavax/enterprise/inject/spi/Bean<*>;Ljava/lang/reflect/Member;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isConstructorOk", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;)Z", new String[] { "org/apache/webbeans/exception/WebBeansConfigurationException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInjectedConstructor", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Ljavax/enterprise/inject/spi/AnnotatedConstructor;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/AnnotatedType<TT;>;)Ljavax/enterprise/inject/spi/AnnotatedConstructor<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitInvokeDynamicInsn("test", "(Lorg/apache/webbeans/spi/InjectionPointService;)Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKEINTERFACE, "org/apache/webbeans/spi/InjectionPointService", "hasInjection", "(Ljavax/enterprise/inject/spi/Annotated;)Z", true), Type.getType("(Ljavax/enterprise/inject/spi/AnnotatedParameter;)Z")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createNewComponent", "(Ljava/lang/Class;)Ljavax/enterprise/inject/spi/Bean;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;)Ljavax/enterprise/inject/spi/Bean<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/webbeans/spi/plugins/OpenWebBeansEjbPlugin", "defineNewSessionBean", "(Ljava/lang/Class;)Ljavax/enterprise/inject/spi/Bean;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/ManagedBeanBuilder", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedType;Ljavax/enterprise/inject/spi/BeanAttributes;Z)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/NewManagedBean", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Lorg/apache/webbeans/component/WebBeansType;Ljavax/enterprise/inject/spi/AnnotatedType;Lorg/apache/webbeans/component/BeanAttributesImpl;Ljava/lang/Class;Ljava/util/Set;)V", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/creation/ExtensionBeanBuilder", "getAnnotatedType", "()Ljavax/enterprise/inject/spi/AnnotatedType;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/ObserverMethodsBuilder", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "checkObtainsInjectionPointConditions", "(Ljavax/enterprise/inject/spi/InjectionPoint;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitLdcInsn(" must have type javax.inject.Instance");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/exception/WebBeansConfigurationException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getMostSpecializedBean", "(Ljavax/enterprise/inject/spi/BeanManager;Ljavax/enterprise/inject/spi/Bean;)Ljavax/enterprise/inject/spi/Bean;", "(Ljavax/enterprise/inject/spi/BeanManager;Ljavax/enterprise/inject/spi/Bean<*>;)Ljavax/enterprise/inject/spi/Bean<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/util/WebBeansUtil", "getMostSpecializedBean", "(Ljavax/enterprise/inject/spi/BeanManager;Ljavax/enterprise/inject/spi/Bean;)Ljavax/enterprise/inject/spi/Bean;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitJumpInsn(GOTO, label5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessAnnotatedTypeEvent", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Lorg/apache/webbeans/portable/events/generics/GProcessAnnotatedType;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/AnnotatedType<TT;>;)Lorg/apache/webbeans/portable/events/generics/GProcessAnnotatedType;", null);
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessAnnotatedType", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/AnnotatedElementFactory", "setAnnotatedType", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Ljavax/enterprise/inject/spi/AnnotatedType;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessSyntheticAnnotatedTypeEvent", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Lorg/apache/webbeans/portable/events/generics/GProcessSyntheticAnnotatedType;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/AnnotatedType<TT;>;)Lorg/apache/webbeans/portable/events/generics/GProcessSyntheticAnnotatedType;", null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/container/AnnotatedTypeWrapper", "getSource", "()Ljavax/enterprise/inject/spi/Extension;", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/enterprise/inject/spi/Extension"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessSyntheticAnnotatedType", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/Extension;Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/enterprise/inject/spi/Extension", "org/apache/webbeans/portable/events/generics/GProcessSyntheticAnnotatedType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessInjectionPointEvent", "(Ljavax/enterprise/inject/spi/InjectionPoint;)Lorg/apache/webbeans/portable/events/generics/GProcessInjectionPoint;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/portable/events/generics/GProcessInjectionPoint");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessInjectionPoint", "<init>", "(Ljavax/enterprise/inject/spi/InjectionPoint;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessInjectionTargetEvent", "(Lorg/apache/webbeans/portable/InjectionTargetImpl;Ljavax/enterprise/inject/spi/AnnotatedType;)Lorg/apache/webbeans/portable/events/generics/GProcessInjectionTarget;", "<T:Ljava/lang/Object;>(Lorg/apache/webbeans/portable/InjectionTargetImpl<TT;>;Ljavax/enterprise/inject/spi/AnnotatedType<TT;>;)Lorg/apache/webbeans/portable/events/generics/GProcessInjectionTarget;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/portable/events/generics/GProcessInjectionTarget");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessInjectionTarget", "<init>", "(Lorg/apache/webbeans/portable/InjectionTargetImpl;Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessProducerEvent", "(Ljavax/enterprise/inject/spi/Producer;Ljavax/enterprise/inject/spi/AnnotatedMember;)Ljavax/enterprise/inject/spi/Producer;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/Producer<TT;>;Ljavax/enterprise/inject/spi/AnnotatedMember<*>;)Ljavax/enterprise/inject/spi/Producer<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/portable/events/generics/GProcessProducer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessProducer", "<init>", "(Ljavax/enterprise/inject/spi/Producer;Ljavax/enterprise/inject/spi/AnnotatedMember;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/events/generics/GProcessProducer", "getProducer", "()Ljavax/enterprise/inject/spi/Producer;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessProducerMethodBeanEvent", "(Ljava/util/Map;Ljavax/enterprise/inject/spi/AnnotatedType;)V", "(Ljava/util/Map<Lorg/apache/webbeans/component/ProducerMethodBean<*>;Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;Ljavax/enterprise/inject/spi/AnnotatedType<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/annotation/AnnotationManager", "getDisposalWithGivenAnnotatedMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Ljava/lang/reflect/Method;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessProducerMethod", "<init>", "(Lorg/apache/webbeans/component/ProducerMethodBean;Ljavax/enterprise/inject/spi/AnnotatedMethod;Ljavax/enterprise/inject/spi/AnnotatedParameter;)V", false);
methodVisitor.visitVarInsn(ASTORE, 12);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "java/util/Map", "javax/enterprise/inject/spi/AnnotatedType", "org/apache/webbeans/config/WebBeansContext", "org/apache/webbeans/annotation/AnnotationManager", "java/util/Iterator", "java/util/Map$Entry", "org/apache/webbeans/component/ProducerMethodBean", "javax/enterprise/inject/spi/AnnotatedMethod", "[Ljava/lang/annotation/Annotation;", "java/lang/reflect/Method"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/portable/events/generics/GProcessProducerMethod");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "java/util/Map", "javax/enterprise/inject/spi/AnnotatedType", "org/apache/webbeans/config/WebBeansContext", "org/apache/webbeans/annotation/AnnotationManager"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(6, 13);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessProducerFieldBeanEvent", "(Ljava/util/Map;)V", "(Ljava/util/Map<Lorg/apache/webbeans/component/ProducerFieldBean<*>;Ljavax/enterprise/inject/spi/AnnotatedField<*>;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "entrySet", "()Ljava/util/Set;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/ProducerFieldBean", "getProducer", "()Ljavax/enterprise/inject/spi/Producer;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/ProducerFieldProducer", "getDisposerMethod", "()Ljavax/enterprise/inject/spi/AnnotatedMethod;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitJumpInsn(IFNULL, label2);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "java/util/Map", "java/util/Iterator", "java/util/Map$Entry", "org/apache/webbeans/component/ProducerFieldBean", "javax/enterprise/inject/spi/AnnotatedField", "javax/enterprise/inject/spi/Producer", "javax/enterprise/inject/spi/AnnotatedParameter"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/portable/events/generics/GProcessProducerField");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessProducerField", "<init>", "(Lorg/apache/webbeans/component/ProducerFieldBean;Ljavax/enterprise/inject/spi/AnnotatedField;Ljavax/enterprise/inject/spi/AnnotatedParameter;)V", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "checkInjectionPointNamedQualifier", "(Ljavax/enterprise/inject/spi/InjectionPoint;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Set", "javax/inject/Named", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isBeanEnabled", "(Ljavax/enterprise/inject/spi/BeanAttributes;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/util/Set;)Z", "(Ljavax/enterprise/inject/spi/BeanAttributes<*>;Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/util/Set<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isBeanEnabled", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/util/Set;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/util/Set<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isAlternative", "(Ljavax/enterprise/inject/spi/Annotated;Ljava/util/Set;)Z", "(Ljavax/enterprise/inject/spi/Annotated;Ljava/util/Set<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isDependent", "(Ljavax/enterprise/inject/spi/Bean;)Z", "(Ljavax/enterprise/inject/spi/Bean<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getPassivationId", "(Ljavax/enterprise/context/spi/Contextual;)Ljava/lang/String;", "(Ljavax/enterprise/context/spi/Contextual<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "defineManagedBeanWithoutFireEvents", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Lorg/apache/webbeans/component/ManagedBean;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/AnnotatedType<TT;>;)Lorg/apache/webbeans/component/ManagedBean<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/component/creation/BeanAttributesBuilder", "forContext", "(Lorg/apache/webbeans/config/WebBeansContext;)Lorg/apache/webbeans/component/creation/BeanAttributesBuilder$BeanAttributesBuilderFactory;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/ManagedBean", "getAnnotatedType", "()Ljavax/enterprise/inject/spi/AnnotatedType;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/ProducerMethodBeansBuilder", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/ManagedBean", "getAnnotatedType", "()Ljavax/enterprise/inject/spi/AnnotatedType;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/ProducerFieldBeansBuilder", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/ManagedBean", "getProducer", "()Ljavax/enterprise/inject/spi/InjectionTarget;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isPassivationCapableDependency", "(Ljavax/enterprise/inject/spi/InjectionPoint;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/webbeans/container/InjectionResolver", "javax/enterprise/inject/spi/Bean"}, 0, null);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isDecorator", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/decorator/Decorator;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isAnnotatedTypeDecoratorOrInterceptor", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isCdiInterceptor", "(Ljavax/enterprise/inject/spi/AnnotatedType;)Z", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/interceptor/Interceptor;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedType", "isAnnotationPresent", "(Ljava/lang/Class;)Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "checkManagedBeanCondition", "(Ljavax/enterprise/inject/spi/AnnotatedType;)V", "<X:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/AnnotatedType<TX;>;)V", new String[] { "org/apache/webbeans/exception/WebBeansConfigurationException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedType", "getJavaClass", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getModifiers", "()I", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/WebBeansUtil", "checkManagedWebBeansInterceptorConditions", "(Ljavax/enterprise/inject/spi/AnnotatedType;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ILOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "checkManagedWebBeansInterceptorConditions", "(Ljavax/enterprise/inject/spi/AnnotatedType;)V", "<X:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/AnnotatedType<TX;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "javax/enterprise/inject/spi/AnnotatedType", "[Ljava/lang/annotation/Annotation;", "java/lang/Class", Opcodes.INTEGER, "org/apache/webbeans/annotation/AnnotationManager"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/enterprise/inject/spi/AnnotatedMethod", "java/lang/reflect/Method", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 8);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "validate", "(Ljava/util/Set;Ljavax/enterprise/inject/spi/Bean;)V", "(Ljava/util/Set<Ljavax/enterprise/inject/spi/InjectionPoint;>;Ljavax/enterprise/inject/spi/Bean<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/Decorated;"));
...
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/WebBeansUtil", "validateDecorated", "(Ljavax/enterprise/inject/spi/Bean;ZLjavax/enterprise/inject/spi/InjectionPoint;)V", false);
Label label6 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/InjectionPoint", "getAnnotated", "()Ljavax/enterprise/inject/spi/Annotated;", true);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/Intercepted;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/Annotated", "isAnnotationPresent", "(Ljava/lang/Class;)Z", true);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/util/WebBeansUtil", "validateIntercepted", "(Ljavax/enterprise/inject/spi/Bean;ZLjavax/enterprise/inject/spi/InjectionPoint;)V", false);
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "java/util/Set", "javax/enterprise/inject/spi/Bean", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, "java/util/Iterator", "javax/enterprise/inject/spi/InjectionPoint"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/InjectionPoint", "isDelegate", "()Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "checkTypeVariables", "(Ljavax/enterprise/util/TypeLiteral;)V", "(Ljavax/enterprise/util/TypeLiteral<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "fireProcessBeanAttributes", "(Ljavax/enterprise/inject/spi/Annotated;Ljava/lang/Class;Ljavax/enterprise/inject/spi/BeanAttributes;)Lorg/apache/webbeans/portable/events/ProcessBeanAttributesImpl;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/Annotated;Ljava/lang/Class<*>;Ljavax/enterprise/inject/spi/BeanAttributes<TT;>;)Lorg/apache/webbeans/portable/events/ProcessBeanAttributesImpl<TT;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/events/generics/GProcessBeanAttributes", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;Ljava/lang/Class;Ljavax/enterprise/inject/spi/Annotated;Ljavax/enterprise/inject/spi/BeanAttributes;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/util/WebBeansUtil", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "javax/enterprise/inject/spi/Annotated", "java/lang/Class", "javax/enterprise/inject/spi/BeanAttributes", "org/apache/webbeans/portable/events/ProcessBeanAttributesImpl"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/exception/WebBeansConfigurationException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "validateBeanInjection", "(Ljavax/enterprise/inject/spi/Bean;)V", "(Ljavax/enterprise/inject/spi/Bean<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "javax/enterprise/inject/spi/Bean", "java/util/Iterator", "javax/enterprise/inject/spi/InjectionPoint", "java/lang/reflect/Type", "javax/enterprise/inject/spi/Bean", "java/lang/reflect/ParameterizedType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/Bean", "getBeanClass", "()Ljava/lang/Class;", true);
methodVisitor.visitLabel(label4);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/util/WebBeansUtil", "javax/enterprise/inject/spi/Bean", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validateDecorated", "(Ljavax/enterprise/inject/spi/Bean;ZLjavax/enterprise/inject/spi/InjectionPoint;)V", "(Ljavax/enterprise/inject/spi/Bean<*>;ZLjavax/enterprise/inject/spi/InjectionPoint;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ILOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validateIntercepted", "(Ljavax/enterprise/inject/spi/Bean;ZLjavax/enterprise/inject/spi/InjectionPoint;)V", "(Ljavax/enterprise/inject/spi/Bean<*>;ZLjavax/enterprise/inject/spi/InjectionPoint;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ILOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessSyntheticAnnotatedType;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessInjectionPoint;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessInjectionTarget;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessBeanAttributes;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_5);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessManagedBean;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitIntInsn(BIPUSH, 6);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessBean;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitIntInsn(BIPUSH, 7);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitIntInsn(BIPUSH, 8);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessSyntheticBean;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "(Ljava/util/Collection;)V", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessProducerField;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessProducerMethod;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessObserverMethod;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessSyntheticObserverMethod;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "(Ljava/util/Collection;)V", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/AfterBeanDiscovery;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/AfterDeploymentValidation;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/AfterTypeDiscovery;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/BeforeBeanDiscovery;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/BeforeShutdown;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_5);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/inject/spi/ProcessAnnotatedType;"));
