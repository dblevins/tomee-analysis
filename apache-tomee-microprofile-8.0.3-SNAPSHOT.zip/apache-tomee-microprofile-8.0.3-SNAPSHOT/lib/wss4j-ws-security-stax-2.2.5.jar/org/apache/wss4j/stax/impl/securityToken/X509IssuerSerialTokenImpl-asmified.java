...
public class X509IssuerSerialTokenImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", null, "org/apache/wss4j/stax/impl/securityToken/X509SecurityTokenImpl", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "x509IssuerSerialType", "Lorg/apache/xml/security/binding/xmldsig/X509IssuerSerialType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "org/apache/wss4j/stax/ext/WSInboundSecurityContext", "org/apache/wss4j/common/crypto/Crypto", "javax/security/auth/callback/CallbackHandler", "org/apache/xml/security/binding/xmldsig/X509IssuerSerialType", "java/lang/String", "org/apache/wss4j/stax/ext/WSSSecurityProperties"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "x509IssuerSerialType", "Lorg/apache/xml/security/binding/xmldsig/X509IssuerSerialType;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "alias", "Ljava/lang/String;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "x509IssuerSerialType", "Lorg/apache/xml/security/binding/xmldsig/X509IssuerSerialType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/X509IssuerSerialType", "getX509IssuerName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "x509IssuerSerialType", "Lorg/apache/xml/security/binding/xmldsig/X509IssuerSerialType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/X509IssuerSerialType", "getX509SerialNumber", "()Ljava/math/BigInteger;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "getCrypto", "()Lorg/apache/wss4j/common/crypto/Crypto;", false);
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "setX509Certificates", "([Ljava/security/cert/X509Certificate;)V", false);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/X509IssuerSerialTokenImpl", "alias", "Ljava/lang/String;");
