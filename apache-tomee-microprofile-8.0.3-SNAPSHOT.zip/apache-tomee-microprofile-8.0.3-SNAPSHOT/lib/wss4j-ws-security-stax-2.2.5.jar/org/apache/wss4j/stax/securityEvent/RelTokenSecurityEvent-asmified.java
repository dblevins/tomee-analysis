...
public class RelTokenSecurityEventDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/stax/securityEvent/RelTokenSecurityEvent", "Lorg/apache/wss4j/stax/securityEvent/IssuedTokenSecurityEvent<Lorg/apache/xml/security/stax/securityToken/SecurityToken;>;", "org/apache/wss4j/stax/securityEvent/IssuedTokenSecurityEvent", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/securityEvent/RelTokenSecurityEvent", "issuerName", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/securityEvent/RelTokenSecurityEvent", "issuerName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
