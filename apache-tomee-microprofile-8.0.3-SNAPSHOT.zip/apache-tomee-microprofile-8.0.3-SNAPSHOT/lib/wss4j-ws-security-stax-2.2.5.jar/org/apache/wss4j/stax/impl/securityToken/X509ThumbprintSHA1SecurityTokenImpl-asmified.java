...
public class X509ThumbprintSHA1SecurityTokenImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/stax/impl/securityToken/X509ThumbprintSHA1SecurityTokenImpl", null, "org/apache/wss4j/stax/impl/securityToken/X509SecurityTokenImpl", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/X509ThumbprintSHA1SecurityTokenImpl", "binaryContent", "[B");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/X509ThumbprintSHA1SecurityTokenImpl", "alias", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/impl/securityToken/X509ThumbprintSHA1SecurityTokenImpl", "binaryContent", "[B");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/common/crypto/CryptoType", "setBytes", "([B)V", false);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/impl/securityToken/X509ThumbprintSHA1SecurityTokenImpl", "getCrypto", "()Lorg/apache/wss4j/common/crypto/Crypto;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/impl/securityToken/X509ThumbprintSHA1SecurityTokenImpl", "alias", "Ljava/lang/String;");
