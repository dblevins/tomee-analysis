...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/security/auth/login/LoginContext", "javax/security/auth/Subject", "java/util/Set"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/stax/impl/securityToken/KerberosClientSecurityToken", "getKerberosTicket", "(Ljavax/security/auth/Subject;Ljavax/security/auth/kerberos/KerberosTicket;)Ljavax/security/auth/kerberos/KerberosTicket;", false);
