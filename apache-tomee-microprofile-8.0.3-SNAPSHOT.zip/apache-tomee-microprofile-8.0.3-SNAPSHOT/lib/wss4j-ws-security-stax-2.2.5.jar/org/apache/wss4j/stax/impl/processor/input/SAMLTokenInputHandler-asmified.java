...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/wss4j/stax/ext/WSSConstants", "getJaxbUnmarshaller", "(Z)Ljakarta/xml/bind/Unmarshaller;", false);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
...
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/wss4j/stax/impl/processor/input/SAMLTokenInputHandler", "org/apache/xml/security/stax/ext/InputProcessorChain", "org/apache/xml/security/stax/ext/XMLSecurityProperties", "java/util/Deque", Opcodes.INTEGER, "org/apache/xml/security/stax/ext/stax/XMLSecEvent", Opcodes.INTEGER, "java/util/Iterator", "org/apache/xml/security/stax/ext/stax/XMLSecStartElement", "javax/xml/namespace/QName", "java/lang/Object"}, 1, new Object[] {"jakarta/xml/bind/JAXBException"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitTypeInsn(NEW, "org/apache/wss4j/common/ext/WSSecurityException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/ObjectFactory", "createX509Data", "(Lorg/apache/xml/security/binding/xmldsig/X509DataType;)Ljakarta/xml/bind/JAXBElement;", false);
methodVisitor.visitVarInsn(ASTORE, 12);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/binding/xmldsig/ObjectFactory", "createKeyValue", "(Lorg/apache/xml/security/binding/xmldsig/KeyValueType;)Ljakarta/xml/bind/JAXBElement;", false);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitTypeInsn(NEW, "org/apache/xml/security/binding/xmldsig/KeyInfoType");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/binding/xmldsig/KeyInfoType", "<init>", "()V", false);
