...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/microprofile/impl/health/cdi/GeronimoHealthExtension", null, "java/lang/Object", new String[] { "jakarta/enterprise/inject/spi/Extension", "org/apache/geronimo/microprofile/common/registry/HealthChecksRegistry" });

classWriter.visitInnerClass("java/lang/invoke/MethodHandles$Lookup", "java/lang/invoke/MethodHandles", "Lookup", ACC_PUBLIC | ACC_FINAL | ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "beans", "Ljava/util/Collection;", "Ljava/util/Collection<Ljakarta/enterprise/inject/spi/Bean<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "contexts", "Ljava/util/Collection;", "Ljava/util/Collection<Ljakarta/enterprise/context/spi/CreationalContext<*>;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(0, "findChecks", "(Ljakarta/enterprise/inject/spi/ProcessBean;)V", "(Ljakarta/enterprise/inject/spi/ProcessBean<*>;)V", null);
...
{
methodVisitor = classWriter.visitMethod(0, "start", "(Ljakarta/enterprise/inject/spi/AfterDeploymentValidation;Ljakarta/enterprise/inject/spi/BeanManager;)V", null, null);
...
methodVisitor.visitInvokeDynamicInsn("apply", "(Lorg/apache/geronimo/microprofile/impl/health/cdi/GeronimoHealthExtension;Ljakarta/enterprise/inject/spi/BeanManager;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/geronimo/microprofile/impl/health/cdi/GeronimoHealthExtension", "lambda$start$0", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/inject/spi/Bean;)Lorg/eclipse/microprofile/health/HealthCheck;", false), Type.getType("(Ljakarta/enterprise/inject/spi/Bean;)Lorg/eclipse/microprofile/health/HealthCheck;")});
...
{
methodVisitor = classWriter.visitMethod(0, "stop", "(Ljakarta/enterprise/inject/spi/BeforeShutdown;)V", null, null);
methodVisitor.visitAnnotableParameterCount(1, true);
{
annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljakarta/enterprise/event/Observes;", true);
annotationVisitor0.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "lookup", "(Ljakarta/enterprise/inject/spi/Bean;Ljakarta/enterprise/inject/spi/BeanManager;)Lorg/eclipse/microprofile/health/HealthCheck;", "(Ljakarta/enterprise/inject/spi/Bean<*>;Ljakarta/enterprise/inject/spi/BeanManager;)Lorg/eclipse/microprofile/health/HealthCheck;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/geronimo/microprofile/impl/health/cdi/GeronimoHealthExtension", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/inject/spi/BeanManager", "java/lang/Class", "java/util/Set", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/context/spi/CreationalContext"}, 0, new Object[] {});
methodVisitor.visitLdcInsn(Type.getType("Lorg/eclipse/microprofile/health/HealthCheck;"));
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitLdcInsn(Type.getType("Lorg/eclipse/microprofile/health/HealthCheck;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$stop$1", "(Ljava/lang/IllegalStateException;Ljakarta/enterprise/context/spi/CreationalContext;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$start$0", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/inject/spi/Bean;)Lorg/eclipse/microprofile/health/HealthCheck;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/microprofile/impl/health/cdi/GeronimoHealthExtension", "lookup", "(Ljakarta/enterprise/inject/spi/Bean;Ljakarta/enterprise/inject/spi/BeanManager;)Lorg/eclipse/microprofile/health/HealthCheck;", false);
methodVisitor.visitInsn(ARETURN);
