...
public class ImplicitObjects$5Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/apache/taglibs/standard/lang/jstl/ImplicitObjects$5", null, "org/apache/taglibs/standard/lang/jstl/EnumeratedMap", null);

classWriter.visitOuterClass("org/apache/taglibs/standard/lang/jstl/ImplicitObjects", "createParamMap", "(Ljakarta/servlet/jsp/PageContext;)Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/lang/jstl/ImplicitObjects$5", "val$request", "Ljakarta/servlet/http/HttpServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/lang/jstl/ImplicitObjects$5", "val$request", "Ljakarta/servlet/http/HttpServletRequest;");
