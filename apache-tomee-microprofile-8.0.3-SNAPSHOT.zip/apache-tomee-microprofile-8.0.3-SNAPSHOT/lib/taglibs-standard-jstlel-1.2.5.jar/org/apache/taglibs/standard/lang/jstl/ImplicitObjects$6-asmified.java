...
public class ImplicitObjects$6Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/apache/taglibs/standard/lang/jstl/ImplicitObjects$6", null, "org/apache/taglibs/standard/lang/jstl/EnumeratedMap", null);

classWriter.visitOuterClass("org/apache/taglibs/standard/lang/jstl/ImplicitObjects", "createParamsMap", "(Ljakarta/servlet/jsp/PageContext;)Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/lang/jstl/ImplicitObjects$6", "val$request", "Ljakarta/servlet/http/HttpServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/lang/jstl/ImplicitObjects$6", "val$request", "Ljakarta/servlet/http/HttpServletRequest;");
