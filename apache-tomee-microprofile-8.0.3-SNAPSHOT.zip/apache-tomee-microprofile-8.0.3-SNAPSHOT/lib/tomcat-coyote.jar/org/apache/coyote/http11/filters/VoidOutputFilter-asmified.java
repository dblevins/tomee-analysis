...
public class VoidOutputFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/coyote/http11/filters/VoidOutputFilter", null, "java/lang/Object", new String[] { "org/apache/coyote/http11/OutputFilter" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "buffer", "Lorg/apache/coyote/http11/HttpOutputBuffer;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/coyote/http11/filters/VoidOutputFilter", "buffer", "Lorg/apache/coyote/http11/HttpOutputBuffer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/coyote/http11/filters/VoidOutputFilter", "buffer", "Lorg/apache/coyote/http11/HttpOutputBuffer;");
