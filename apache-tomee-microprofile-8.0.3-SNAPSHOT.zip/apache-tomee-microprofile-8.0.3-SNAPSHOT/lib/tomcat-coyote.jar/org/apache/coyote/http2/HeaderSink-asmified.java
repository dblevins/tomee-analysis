...
public class HeaderSinkDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/coyote/http2/HeaderSink", null, "java/lang/Object", new String[] { "org/apache/coyote/http2/HpackDecoder$HeaderEmitter" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "emitHeader", "(Ljava/lang/String;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
