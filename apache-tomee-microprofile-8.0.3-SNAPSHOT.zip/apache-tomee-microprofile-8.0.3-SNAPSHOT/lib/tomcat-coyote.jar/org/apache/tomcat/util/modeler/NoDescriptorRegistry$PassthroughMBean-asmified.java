...
public class NoDescriptorRegistry$PassthroughMBeanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomcat/util/modeler/NoDescriptorRegistry$PassthroughMBean", null, "org/apache/tomcat/util/modeler/ManagedBean", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/util/modeler/NoDescriptorRegistry$PassthroughMBean", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
