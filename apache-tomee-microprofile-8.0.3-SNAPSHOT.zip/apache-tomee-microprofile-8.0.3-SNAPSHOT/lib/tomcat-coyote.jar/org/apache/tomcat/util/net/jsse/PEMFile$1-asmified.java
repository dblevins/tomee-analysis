...
public class PEMFile$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/net/jsse/PEMFile$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/net/jsse/PEMFile", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$net$jsse$PEMFile$Format", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/net/jsse/PEMFile$Format", "values", "()[Lorg/apache/tomcat/util/net/jsse/PEMFile$Format;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/net/jsse/PEMFile$1", "$SwitchMap$org$apache$tomcat$util$net$jsse$PEMFile$Format", "[I");
