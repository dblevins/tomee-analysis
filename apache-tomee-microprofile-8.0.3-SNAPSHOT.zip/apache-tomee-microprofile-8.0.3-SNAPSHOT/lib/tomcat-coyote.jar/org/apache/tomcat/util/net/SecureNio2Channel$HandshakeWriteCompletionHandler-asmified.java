...
public class SecureNio2Channel$HandshakeWriteCompletionHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler", "Ljava/lang/Object;Ljava/nio/channels/CompletionHandler<Ljava/lang/Integer;Lorg/apache/tomcat/util/net/SocketWrapperBase<Lorg/apache/tomcat/util/net/Nio2Channel;>;>;", "java/lang/Object", new String[] { "java/nio/channels/CompletionHandler" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler", "this$0", "Lorg/apache/tomcat/util/net/SecureNio2Channel;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler", "failed", "(Ljava/lang/Throwable;Lorg/apache/tomcat/util/net/SocketWrapperBase;)V", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler", "this$0", "Lorg/apache/tomcat/util/net/SecureNio2Channel;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/tomcat/util/net/SocketWrapperBase");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler", "completed", "(Ljava/lang/Integer;Lorg/apache/tomcat/util/net/SocketWrapperBase;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/util/net/SecureNio2Channel$HandshakeWriteCompletionHandler", "<init>", "(Lorg/apache/tomcat/util/net/SecureNio2Channel;)V", false);
methodVisitor.visitInsn(RETURN);
