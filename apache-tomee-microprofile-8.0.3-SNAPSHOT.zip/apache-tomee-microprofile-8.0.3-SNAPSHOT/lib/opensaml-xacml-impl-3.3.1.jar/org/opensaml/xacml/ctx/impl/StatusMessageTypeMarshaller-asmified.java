...
public class StatusMessageTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/ctx/impl/StatusMessageTypeMarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectMarshaller", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xacml/ctx/StatusMessageType"}, 0, null);
methodVisitor.visitInsn(RETURN);
