...
public class DecisionTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/ctx/impl/DecisionTypeMarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/ctx/DecisionType$DECISION", "toString", "()Ljava/lang/String;", false);
