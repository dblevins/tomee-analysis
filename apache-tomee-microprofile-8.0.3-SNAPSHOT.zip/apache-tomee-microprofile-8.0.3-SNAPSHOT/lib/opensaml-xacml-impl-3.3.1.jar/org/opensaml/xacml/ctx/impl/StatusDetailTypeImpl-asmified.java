...
public class StatusDetailTypeImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/ctx/impl/StatusDetailTypeImpl", null, "org/opensaml/xacml/impl/AbstractXACMLObject", new String[] { "org/opensaml/xacml/ctx/StatusDetailType" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "unknownChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList<Lorg/opensaml/core/xml/XMLObject;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/ctx/impl/StatusDetailTypeImpl", "unknownChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/ctx/impl/StatusDetailTypeImpl", "unknownChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
