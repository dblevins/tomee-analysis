...
public class EnvironmentsTypeUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/policy/impl/EnvironmentsTypeUnmarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectUnmarshaller", null);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/xacml/policy/EnvironmentType");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/policy/EnvironmentsType", "getEnvironments", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xacml/policy/EnvironmentsType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
