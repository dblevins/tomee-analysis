...
public class AttributeSelectorTypeImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", null, "org/opensaml/xacml/impl/AbstractXACMLObject", new String[] { "org/opensaml/xacml/policy/AttributeSelectorType" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "requestContextPath", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "mustBePresentXS", "Lorg/opensaml/core/xml/schema/XSBooleanValue;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "dataType", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "mustBePresentXS", "Lorg/opensaml/core/xml/schema/XSBooleanValue;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "requestContextPath", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "dataType", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "dataType", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "mustBePresentXS", "Lorg/opensaml/core/xml/schema/XSBooleanValue;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "prepareForAssignment", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setRequestContextPath", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/policy/impl/AttributeSelectorTypeImpl", "requestContextPath", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
