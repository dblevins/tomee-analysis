...
public class X509StoreLDAPAttrCertsDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jce/provider/X509StoreLDAPAttrCerts", null, "org/bouncycastle/x509/X509StoreSpi", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509StoreLDAPAttrCerts", "helper", "Lorg/bouncycastle/x509/util/LDAPStoreHelper;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509StoreLDAPAttrCerts", "helper", "Lorg/bouncycastle/x509/util/LDAPStoreHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/x509/util/LDAPStoreHelper", "getAACertificates", "(Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Collection;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509StoreLDAPAttrCerts", "helper", "Lorg/bouncycastle/x509/util/LDAPStoreHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/x509/util/LDAPStoreHelper", "getAttributeCertificateAttributes", "(Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Collection;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "addAll", "(Ljava/util/Collection;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509StoreLDAPAttrCerts", "helper", "Lorg/bouncycastle/x509/util/LDAPStoreHelper;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/x509/util/LDAPStoreHelper", "getAttributeDescriptorCertificates", "(Lorg/bouncycastle/x509/X509AttributeCertStoreSelector;)Ljava/util/Collection;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "addAll", "(Ljava/util/Collection;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
