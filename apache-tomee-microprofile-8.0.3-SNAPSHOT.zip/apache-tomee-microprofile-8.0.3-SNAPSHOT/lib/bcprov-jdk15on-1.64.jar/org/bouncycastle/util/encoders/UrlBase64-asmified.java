...
public class UrlBase64Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/util/encoders/UrlBase64", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/util/encoders/UrlBase64", "encoder", "Lorg/bouncycastle/util/encoders/Encoder;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn("exception encoding URL safe base64 data: ");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("exception decoding URL safe base64 string: ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Exception", "getMessage", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/util/encoders/UrlBase64Encoder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/util/encoders/UrlBase64Encoder", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/util/encoders/UrlBase64", "encoder", "Lorg/bouncycastle/util/encoders/Encoder;");
methodVisitor.visitInsn(RETURN);
