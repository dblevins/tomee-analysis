...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/x509/CertPathValidatorUtilities", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL | ACC_STATIC, "CRL_UTIL", "Lorg/bouncycastle/x509/PKIXCRLUtil;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getEncodedIssuerPrincipal", "(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getValidDate", "(Ljava/security/cert/PKIXParameters;)Ljava/util/Date;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getSubjectPrincipal", "(Ljava/security/cert/X509Certificate;)Ljavax/security/auth/x500/X500Principal;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "getObject", "(Ljava/lang/String;[B)Lorg/bouncycastle/asn1/ASN1Primitive;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getIssuerPrincipal", "(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "removePolicyNodeRecurse", "([Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jce/provider/PKIXPolicyNode", "setExpectedPolicies", "(Ljava/util/Set;)V", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "CERTIFICATE_POLICIES", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "getExtensionValue", "(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/bouncycastle/asn1/ASN1Primitive;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "getQualifierSet", "(Lorg/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "removePolicyNode", "(Lorg/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lorg/bouncycastle/jce/provider/PKIXPolicyNode;)Lorg/bouncycastle/jce/provider/PKIXPolicyNode;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "findCertificates", "(Lorg/bouncycastle/x509/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;", null, new String[] { "org/bouncycastle/jce/provider/AnnotatedException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label4 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label4, "java/security/cert/CertificateException");
Label label5 = new Label();
Label label6 = new Label();
Label label7 = new Label();
methodVisitor.visitTryCatchBlock(label5, label6, label7, "java/security/cert/CertStoreException");
methodVisitor.visitTypeInsn(NEW, "java/util/HashSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/bouncycastle/util/Encodable");
Label label12 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label12);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/util/Encodable");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/bouncycastle/util/Encodable", "getEncoded", "()[B", true);
...
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/jce/provider/AnnotatedException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Unknown object found in certificate store.");
...
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/jce/provider/AnnotatedException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Problem while extracting certificates from X.509 store.");
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jce/provider/AnnotatedException", "<init>", "(Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getCertStatus", "(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/x509/CertStatus;)V", null, new String[] { "org/bouncycastle/jce/provider/AnnotatedException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "isIndirectCRL", "(Ljava/security/cert/X509CRL;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 5);
methodVisitor.visitLabel(label1);
Label label6 = new Label();
methodVisitor.visitJumpInsn(GOTO, label6);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "getSerialNumber", "(Ljava/lang/Object;)Ljava/math/BigInteger;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "getIssuerPrincipal", "(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label9);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "getEncodedIssuerPrincipal", "(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ILOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/x509/CertStatus", "setCertStatus", "(I)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/security/cert/X509CRLEntry", "getRevocationDate", "()Ljava/util/Date;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/x509/CertStatus", "setRevocationDate", "(Ljava/util/Date;)V", false);
methodVisitor.visitLabel(label17);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getNextWorkingKey", "(Ljava/util/List;I)Ljava/security/PublicKey;", null, new String[] { "java/security/cert/CertPathValidatorException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "isIndirectCRL", "(Ljava/security/cert/X509CRL;)Z", null, new String[] { "java/security/cert/CRLException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/x509/PKIXCRLUtil");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/x509/PKIXCRLUtil", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "CRL_UTIL", "Lorg/bouncycastle/x509/PKIXCRLUtil;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "CERTIFICATE_POLICIES", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "BASIC_CONSTRAINTS", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "POLICY_MAPPINGS", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "SUBJECT_ALTERNATIVE_NAME", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "NAME_CONSTRAINTS", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "KEY_USAGE", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "INHIBIT_ANY_POLICY", "Ljava/lang/String;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/asn1/x509/Extension", "issuingDistributionPoint", "Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "ISSUING_DISTRIBUTION_POINT", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "DELTA_CRL_INDICATOR", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "POLICY_CONSTRAINTS", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "FRESHEST_CRL", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "CRL_DISTRIBUTION_POINTS", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "AUTHORITY_KEY_IDENTIFIER", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1ObjectIdentifier", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "CRL_NUMBER", "Ljava/lang/String;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/x509/CertPathValidatorUtilities", "crlReasons", "[Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
