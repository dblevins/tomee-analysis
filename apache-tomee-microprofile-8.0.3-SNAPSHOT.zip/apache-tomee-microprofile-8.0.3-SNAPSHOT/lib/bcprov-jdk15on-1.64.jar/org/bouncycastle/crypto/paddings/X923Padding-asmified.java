...
public class X923PaddingDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/paddings/X923Padding", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/paddings/BlockCipherPadding" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/paddings/X923Padding", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("X9.23");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/paddings/X923Padding", "random", "Ljava/security/SecureRandom;");
