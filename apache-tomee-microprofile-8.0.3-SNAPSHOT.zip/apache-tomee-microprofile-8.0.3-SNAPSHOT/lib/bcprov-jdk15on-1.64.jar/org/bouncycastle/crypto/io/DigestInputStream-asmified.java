...
public class DigestInputStreamDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/io/DigestInputStream", null, "java/io/FilterInputStream", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/io/InputStream;Lorg/bouncycastle/crypto/Digest;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/io/DigestInputStream", "digest", "Lorg/bouncycastle/crypto/Digest;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/io/DigestInputStream", "in", "Ljava/io/InputStream;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/io/DigestInputStream", "digest", "Lorg/bouncycastle/crypto/Digest;");
methodVisitor.visitVarInsn(ILOAD, 1);
