...
public class X25519PrivateKeyParametersDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/bouncycastle/crypto/params/X25519PrivateKeyParameters", null, "org/bouncycastle/crypto/params/AsymmetricKeyParameter", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "SECRET_SIZE", "I", null, new Integer(32));
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/params/X25519PrivateKeyParameters", "data", "[B");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/params/X25519PrivateKeyParameters", "data", "[B");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/math/ec/rfc7748/X25519", "generatePrivateKey", "(Ljava/security/SecureRandom;[B)V", false);
...
methodVisitor.visitLdcInsn("EOF encountered in middle of X25519 private key");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generatePublicKey", "()Lorg/bouncycastle/crypto/params/X25519PublicKeyParameters;", null, null);
methodVisitor.visitCode();
methodVisitor.visitIntInsn(BIPUSH, 32);
methodVisitor.visitIntInsn(NEWARRAY, T_BYTE);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/math/ec/rfc7748/X25519", "generatePublicKey", "([BI[BI)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generateSecret", "(Lorg/bouncycastle/crypto/params/X25519PublicKeyParameters;[BI)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitIntInsn(BIPUSH, 32);
methodVisitor.visitIntInsn(NEWARRAY, T_BYTE);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/math/ec/rfc7748/X25519", "calculateAgreement", "([BI[BI[BI)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("X25519 agreement failed");
