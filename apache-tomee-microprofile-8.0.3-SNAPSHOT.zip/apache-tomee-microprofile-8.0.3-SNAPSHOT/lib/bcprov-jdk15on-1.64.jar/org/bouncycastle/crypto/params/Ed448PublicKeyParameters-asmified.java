...
public class Ed448PublicKeyParametersDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/bouncycastle/crypto/params/Ed448PublicKeyParameters", null, "org/bouncycastle/crypto/params/AsymmetricKeyParameter", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/params/Ed448PublicKeyParameters", "data", "[B");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/params/Ed448PublicKeyParameters", "data", "[B");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitIntInsn(BIPUSH, 57);
...
methodVisitor.visitLdcInsn("EOF encountered in middle of Ed448 public key");
