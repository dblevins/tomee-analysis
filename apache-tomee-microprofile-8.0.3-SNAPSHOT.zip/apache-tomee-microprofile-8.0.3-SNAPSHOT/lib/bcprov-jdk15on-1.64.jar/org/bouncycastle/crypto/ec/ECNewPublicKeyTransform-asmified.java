...
public class ECNewPublicKeyTransformDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/ec/ECNewPublicKeyTransform", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/ec/ECPairTransform" });
...
methodVisitor.visitLdcInsn("ECPublicKeyParameters are required for new public key transform.");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/ec/ECNewPublicKeyTransform", "key", "Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/ec/ECNewPublicKeyTransform", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/ec/ECNewPublicKeyTransform", "key", "Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("ECNewPublicKeyTransform not initialised");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/ec/ECNewPublicKeyTransform", "createBasePointMultiplier", "()Lorg/bouncycastle/math/ec/ECMultiplier;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/ec/ECNewPublicKeyTransform", "random", "Ljava/security/SecureRandom;");
