...
public class PBKDF1KeyDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/PBKDF1Key", null, "java/lang/Object", new String[] { "org/bouncycastle/jcajce/PBKDFKey" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/PBKDF1Key", "password", "[C");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/PBKDF1Key", "converter", "Lorg/bouncycastle/crypto/CharToByteConverter;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/PBKDF1Key", "password", "[C");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARRAYLENGTH);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("PBKDF1");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/PBKDF1Key", "converter", "Lorg/bouncycastle/crypto/CharToByteConverter;");
