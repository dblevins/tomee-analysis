...
public class GMCipherSpi$ErasableOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/bouncycastle/jcajce/provider/asymmetric/ec/GMCipherSpi$ErasableOutputStream", null, "java/io/ByteArrayOutputStream", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/asymmetric/ec/GMCipherSpi$ErasableOutputStream", "buf", "[B");
