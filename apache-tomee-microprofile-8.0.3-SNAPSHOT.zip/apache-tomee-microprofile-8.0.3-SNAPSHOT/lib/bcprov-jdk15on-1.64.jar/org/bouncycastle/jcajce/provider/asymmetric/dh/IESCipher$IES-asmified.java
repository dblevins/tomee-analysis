...
public class IESCipher$IESDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/asymmetric/dh/IESCipher$IES", null, "org/bouncycastle/jcajce/provider/asymmetric/dh/IESCipher", null);

classWriter.visitInnerClass("org/bouncycastle/jcajce/provider/asymmetric/dh/IESCipher$IES", "org/bouncycastle/jcajce/provider/asymmetric/dh/IESCipher", "IES", ACC_PUBLIC | ACC_STATIC);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/engines/IESEngine", "<init>", "(Lorg/bouncycastle/crypto/BasicAgreement;Lorg/bouncycastle/crypto/DerivationFunction;Lorg/bouncycastle/crypto/Mac;)V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jcajce/provider/asymmetric/dh/IESCipher", "<init>", "(Lorg/bouncycastle/crypto/engines/IESEngine;)V", false);
