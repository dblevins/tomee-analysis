...
public class BaseAlgorithmParameterGeneratorDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", null, "java/security/AlgorithmParameterGeneratorSpi", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", "helper", "Lorg/bouncycastle/jcajce/util/JcaJceHelper;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitIntInsn(SIPUSH, 1024);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", "strength", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", "helper", "Lorg/bouncycastle/jcajce/util/JcaJceHelper;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", "random", "Ljava/security/SecureRandom;");
methodVisitor.visitInsn(RETURN);
