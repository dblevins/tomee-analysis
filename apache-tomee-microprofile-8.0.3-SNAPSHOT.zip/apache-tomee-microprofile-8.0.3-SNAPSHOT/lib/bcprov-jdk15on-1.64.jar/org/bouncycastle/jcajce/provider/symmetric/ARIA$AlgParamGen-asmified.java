...
public class ARIA$AlgParamGenDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamGen", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", null);
...
methodVisitor.visitLdcInsn("No supported AlgorithmParameterSpec for ARIA parameter generation.");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamGen", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamGen", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamGen", "createParametersInstance", "(Ljava/lang/String;)Ljava/security/AlgorithmParameters;", false);
