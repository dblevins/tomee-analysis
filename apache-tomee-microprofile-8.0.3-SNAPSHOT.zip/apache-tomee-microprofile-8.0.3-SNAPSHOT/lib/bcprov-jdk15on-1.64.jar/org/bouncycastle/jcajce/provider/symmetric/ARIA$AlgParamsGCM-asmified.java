...
public class ARIA$AlgParamsGCMDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsGCM", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameters", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "gcmParams", "Lorg/bouncycastle/asn1/cms/GCMParameters;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsGCM", "gcmParams", "Lorg/bouncycastle/asn1/cms/GCMParameters;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsGCM", "isASN1FormatString", "(Ljava/lang/String;)Z", false);
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsGCM", "gcmParams", "Lorg/bouncycastle/asn1/cms/GCMParameters;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/ARIA$AlgParamsGCM", "gcmParams", "Lorg/bouncycastle/asn1/cms/GCMParameters;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/cms/GCMParameters", "toASN1Primitive", "()Lorg/bouncycastle/asn1/ASN1Primitive;", false);
