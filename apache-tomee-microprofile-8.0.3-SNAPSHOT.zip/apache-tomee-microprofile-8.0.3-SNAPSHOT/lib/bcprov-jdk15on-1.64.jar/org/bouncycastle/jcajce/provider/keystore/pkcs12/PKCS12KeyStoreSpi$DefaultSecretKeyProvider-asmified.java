...
public class PKCS12KeyStoreSpi$DefaultSecretKeyProviderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "KEY_SIZES", "Ljava/util/Map;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider", "KEY_SIZES", "Ljava/util/Map;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getKeySize", "(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/keystore/pkcs12/PKCS12KeyStoreSpi$DefaultSecretKeyProvider", "KEY_SIZES", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
