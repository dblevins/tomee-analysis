...
public class PBEPKCS12$AlgParamsDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameters", null);

classWriter.visitInnerClass("org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12", "AlgParams", ACC_PUBLIC | ACC_STATIC);

{
fieldVisitor = classWriter.visitField(0, "params", "Lorg/bouncycastle/asn1/pkcs/PKCS12PBEParams;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", "params", "Lorg/bouncycastle/asn1/pkcs/PKCS12PBEParams;");
methodVisitor.visitLdcInsn("DER");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/pkcs/PKCS12PBEParams", "getEncoded", "(Ljava/lang/String;)[B", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", "isASN1FormatString", "(Ljava/lang/String;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", "engineGetEncoded", "()[B", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("unknown parameter spec passed to PKCS12 PBE parameters object.");
...
methodVisitor.visitTypeInsn(NEW, "java/security/spec/InvalidParameterSpecException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("PBEParameterSpec required to initialise a PKCS12 PBE parameters algorithm parameters object");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/security/spec/InvalidParameterSpecException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", "params", "Lorg/bouncycastle/asn1/pkcs/PKCS12PBEParams;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/PBEPKCS12$AlgParams", "engineInit", "([B)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "java/io/IOException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Unknown parameters format in PKCS12 PBE parameters object");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("PKCS12 PBE Parameters");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
