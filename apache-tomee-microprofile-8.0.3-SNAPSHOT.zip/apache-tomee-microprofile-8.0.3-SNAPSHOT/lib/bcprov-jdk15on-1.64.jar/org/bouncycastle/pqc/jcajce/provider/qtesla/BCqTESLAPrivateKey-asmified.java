...
public class BCqTESLAPrivateKeyDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", null, "java/lang/Object", new String[] { "java/security/PrivateKey", "org/bouncycastle/pqc/jcajce/interfaces/QTESLAKey" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "keyParams", "Lorg/bouncycastle/pqc/crypto/qtesla/QTESLAPrivateKeyParameters;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/bouncycastle/pqc/crypto/qtesla/QTESLAPrivateKeyParameters;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "keyParams", "Lorg/bouncycastle/pqc/crypto/qtesla/QTESLAPrivateKeyParameters;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "init", "(Lorg/bouncycastle/asn1/pkcs/PrivateKeyInfo;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "attributes", "Lorg/bouncycastle/asn1/ASN1Set;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "keyParams", "Lorg/bouncycastle/pqc/crypto/qtesla/QTESLAPrivateKeyParameters;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getParams", "()Lorg/bouncycastle/pqc/jcajce/spec/QTESLAParameterSpec;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/pqc/jcajce/spec/QTESLAParameterSpec");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "getAlgorithm", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/pqc/jcajce/spec/QTESLAParameterSpec", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "keyParams", "Lorg/bouncycastle/pqc/crypto/qtesla/QTESLAPrivateKeyParameters;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "attributes", "Lorg/bouncycastle/asn1/ASN1Set;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/pqc/jcajce/provider/qtesla/BCqTESLAPrivateKey", "getEncoded", "()[B", false);
