...
public class McElieceKeyGenParameterSpecDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", null, "java/lang/Object", new String[] { "java/security/spec/AlgorithmParameterSpec" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "<init>", "(II)V", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "m", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "n", "I");
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "n", "I");
methodVisitor.visitVarInsn(ILOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "m", "I");
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "t", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "t", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "m", "I");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "fieldPoly", "I");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(II)V", null, new String[] { "java/security/InvalidParameterException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ILOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/pqc/jcajce/spec/McElieceKeyGenParameterSpec", "fieldPoly", "I");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
