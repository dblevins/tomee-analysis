...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/pqc/crypto/qtesla/HashUtils", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "SECURE_HASH_ALGORITHM_KECCAK_128_RATE", "I", null, new Integer(168));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "SECURE_HASH_ALGORITHM_KECCAK_256_RATE", "I", null, new Integer(136));
fieldVisitor.visitEnd();
}
{
