...
public class ASN1NullDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/bouncycastle/asn1/ASN1Null", null, "org/bouncycastle/asn1/ASN1Primitive", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Null;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/asn1/ASN1Null", "getInstance", "(Ljava/lang/Object;)Lorg/bouncycastle/asn1/ASN1Null;", false);
...
methodVisitor.visitLdcInsn("failed to construct NULL from byte[]: ");
