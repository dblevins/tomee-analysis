...
public class BEROctetStringParserDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/asn1/BEROctetStringParser", null, "java/lang/Object", new String[] { "org/bouncycastle/asn1/ASN1OctetStringParser" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/BEROctetStringParser", "_parser", "Lorg/bouncycastle/asn1/ASN1StreamParser;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/asn1/ConstructedOctetStream");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/BEROctetStringParser", "_parser", "Lorg/bouncycastle/asn1/ASN1StreamParser;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/ConstructedOctetStream", "<init>", "(Lorg/bouncycastle/asn1/ASN1StreamParser;)V", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/BEROctetStringParser", "getOctetStream", "()Ljava/io/InputStream;", false);
