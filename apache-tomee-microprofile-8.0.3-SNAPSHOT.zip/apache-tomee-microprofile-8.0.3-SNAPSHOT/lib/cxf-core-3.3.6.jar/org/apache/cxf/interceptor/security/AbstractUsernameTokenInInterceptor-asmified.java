...
public class AbstractUsernameTokenInInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/cxf/interceptor/security/AbstractUsernameTokenInInterceptor", null, "org/apache/cxf/interceptor/security/AbstractSecurityContextInInterceptor", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/interceptor/security/AbstractSecurityContextInInterceptor", "<init>", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/common/security/SecurityToken", "getTokenType", "()Lorg/apache/cxf/common/security/TokenType;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/security/TokenType", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/interceptor/security/AbstractUsernameTokenInInterceptor", "reportSecurityException", "(Ljava/lang/String;)V", false);
