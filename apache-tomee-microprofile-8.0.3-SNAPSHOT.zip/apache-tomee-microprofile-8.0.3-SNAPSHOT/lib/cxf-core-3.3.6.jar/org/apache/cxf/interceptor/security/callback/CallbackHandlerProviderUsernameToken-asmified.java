...
public class CallbackHandlerProviderUsernameTokenDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/interceptor/security/callback/CallbackHandlerProviderUsernameToken", null, "java/lang/Object", new String[] { "org/apache/cxf/interceptor/security/callback/CallbackHandlerProvider" });
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/cxf/common/security/UsernameToken");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/security/UsernameToken", "getPasswordType", "()Ljava/lang/String;", false);
methodVisitor.visitLdcInsn("PasswordDigest");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "endsWith", "(Ljava/lang/String;)Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/interceptor/security/NameDigestPasswordCallbackHandler");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/interceptor/security/NameDigestPasswordCallbackHandler", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/cxf/common/security/UsernameToken"}, 0, null);
