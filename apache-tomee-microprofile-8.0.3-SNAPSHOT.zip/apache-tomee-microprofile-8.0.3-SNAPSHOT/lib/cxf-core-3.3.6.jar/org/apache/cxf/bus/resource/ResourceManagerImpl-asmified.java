package asm.org.apache.cxf.bus.resource;
...
public class ResourceManagerImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/bus/resource/ResourceManagerImpl", null, "org/apache/cxf/resource/DefaultResourceManager", new String[] { "org/apache/cxf/extension/BusExtension" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/bus/resource/ResourceManagerImpl", "setBus", "(Lorg/apache/cxf/Bus;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "onFirstResolve", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/resource/DefaultResourceManager", "onFirstResolve", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/resource/ResourceManagerImpl", "bus", "Lorg/apache/cxf/Bus;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/bus/resource/ResourceManagerImpl", "addResourceResolvers", "(Ljava/util/Collection;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "setResolvers", "(Ljava/util/List;)V", "(Ljava/util/List<+Lorg/apache/cxf/resource/ResourceResolver;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/resource/ResourceManagerImpl", "registeredResolvers", "Ljava/util/List;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/bus/resource/ResourceManagerImpl", "bus", "Lorg/apache/cxf/Bus;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/bus/resource/ResourceManagerImpl", "firstCalled", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/resource/DefaultResourceManager", "addResourceResolver", "(Lorg/apache/cxf/resource/ResourceResolver;)V", false);
