...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/management/JMException", "getMessage", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/managers/WorkQueueManagerImpl", "imanager", "Lorg/apache/cxf/management/InstrumentationManager;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/management/InstrumentationManager", "getMBeanServer", "()Ljakarta/management/MBeanServer;", true);
methodVisitor.visitJumpInsn(IFNULL, label15);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/managers/WorkQueueManagerImpl", "imanager", "Lorg/apache/cxf/management/InstrumentationManager;");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/bus/managers/WorkQueueManagerImpl", Opcodes.INTEGER, "java/util/Iterator", "org/apache/cxf/workqueue/AutomaticWorkQueue", "org/apache/cxf/workqueue/AutomaticWorkQueueImpl", "java/lang/Object"}, 1, new Object[] {"jakarta/management/JMException"});
...
Label label8 = new Label();
Label label9 = new Label();
methodVisitor.visitTryCatchBlock(label7, label8, label9, "jakarta/management/JMException");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/managers/WorkQueueManagerImpl", "namedQueues", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/bus/managers/WorkQueueManagerImpl", "java/lang/String", "org/apache/cxf/workqueue/AutomaticWorkQueue", "org/apache/cxf/workqueue/AutomaticWorkQueueImpl", "java/lang/Object"}, 1, new Object[] {"jakarta/management/JMException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/bus/managers/WorkQueueManagerImpl", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "WARNING", "Ljava/util/logging/Level;");
methodVisitor.visitVarInsn(ALOAD, 5);
