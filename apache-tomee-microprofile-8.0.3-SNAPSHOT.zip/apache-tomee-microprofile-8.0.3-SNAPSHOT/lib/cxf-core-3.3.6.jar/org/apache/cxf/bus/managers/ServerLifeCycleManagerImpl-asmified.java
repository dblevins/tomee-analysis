...
public class ServerLifeCycleManagerImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/bus/managers/ServerLifeCycleManagerImpl", null, "java/lang/Object", new String[] { "org/apache/cxf/endpoint/ServerLifeCycleManager", "org/apache/cxf/extension/BusExtension" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "listeners", "Ljava/util/concurrent/CopyOnWriteArrayList;", "Ljava/util/concurrent/CopyOnWriteArrayList<Lorg/apache/cxf/endpoint/ServerLifeCycleListener;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/bus/managers/ServerLifeCycleManagerImpl", "listeners", "Ljava/util/concurrent/CopyOnWriteArrayList;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/managers/ServerLifeCycleManagerImpl", "listeners", "Ljava/util/concurrent/CopyOnWriteArrayList;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/bus/managers/ServerLifeCycleManagerImpl", "org/apache/cxf/Bus", "java/util/Collection"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "registerListener", "(Lorg/apache/cxf/endpoint/ServerLifeCycleListener;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/managers/ServerLifeCycleManagerImpl", "listeners", "Ljava/util/concurrent/CopyOnWriteArrayList;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/endpoint/ServerLifeCycleListener", "startServer", "(Lorg/apache/cxf/endpoint/Server;)V", true);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/cxf/endpoint/ServerLifeCycleListener");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/cxf/endpoint/ServerLifeCycleListener", "stopServer", "(Lorg/apache/cxf/endpoint/Server;)V", true);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "unRegisterListener", "(Lorg/apache/cxf/endpoint/ServerLifeCycleListener;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/bus/managers/ServerLifeCycleManagerImpl", "listeners", "Ljava/util/concurrent/CopyOnWriteArrayList;");
methodVisitor.visitVarInsn(ALOAD, 1);
