...
public class StaxSchemaValidationOutInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/staxutils/validation/StaxSchemaValidationOutInterceptor", "Lorg/apache/cxf/phase/AbstractPhaseInterceptor<Lorg/apache/cxf/message/Message;>;", "org/apache/cxf/phase/AbstractPhaseInterceptor", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/staxutils/validation/StaxSchemaValidationOutInterceptor", "setSchemaInMessage", "(Lorg/apache/cxf/message/Message;Ljavax/xml/stream/XMLStreamWriter;)V", false);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/staxutils/validation/StaxSchemaValidationOutInterceptor", "org/apache/cxf/message/Message", "javax/xml/stream/XMLStreamWriter"}, 1, new Object[] {"javax/xml/stream/XMLStreamException"});
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/staxutils/validation/StaxSchemaValidationOutInterceptor", "LOG", "Ljava/util/logging/Logger;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "setSchemaInMessage", "(Lorg/apache/cxf/message/Message;Ljavax/xml/stream/XMLStreamWriter;)V", null, new String[] { "javax/xml/stream/XMLStreamException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/staxutils/validation/StaxSchemaValidationOutInterceptor;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/LogUtils", "getL7dLogger", "(Ljava/lang/Class;)Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/staxutils/validation/StaxSchemaValidationOutInterceptor", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
