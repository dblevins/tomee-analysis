...
public class DepthXMLStreamReaderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/staxutils/DepthXMLStreamReader", null, "java/lang/Object", new String[] { "javax/xml/stream/XMLStreamReader" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/staxutils/DepthXMLStreamReader", "reader", "Ljavax/xml/stream/XMLStreamReader;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/staxutils/DepthXMLStreamReader", "reader", "Ljavax/xml/stream/XMLStreamReader;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/staxutils/DepthXMLStreamReader", "depth", "I");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/staxutils/DepthXMLStreamReader", "depth", "I");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitJumpInsn(IF_ICMPNE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/staxutils/DepthXMLStreamReader", "isWhiteSpace", "()Z", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("expected start or end tag");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/staxutils/DepthXMLStreamReader", "getLocation", "()Ljavax/xml/stream/Location;", false);
