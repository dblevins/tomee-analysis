...
public class ClientBeanValidationFeatureDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/validation/ClientBeanValidationFeature", "Lorg/apache/cxf/feature/DelegatingFeature<Lorg/apache/cxf/validation/ClientBeanValidationFeature$Portable;>;", "org/apache/cxf/feature/DelegatingFeature", null);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/validation/ClientBeanValidationFeature$Portable");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/cxf/validation/ClientBeanValidationFeature$Portable;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addInterceptor", "(Lorg/apache/cxf/interceptor/InterceptorProvider;Lorg/apache/cxf/validation/ClientBeanValidationOutInterceptor;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/validation/ClientBeanValidationFeature", "delegate", "Lorg/apache/cxf/feature/AbstractPortableFeature;");
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/cxf/validation/ClientBeanValidationFeature$Portable");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/cxf/validation/ClientBeanValidationFeature$Portable");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/validation/ClientBeanValidationFeature$Portable", "setProvider", "(Lorg/apache/cxf/validation/BeanValidationProvider;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
