...
public class WrappedFeatureDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/feature/WrappedFeature", null, "org/apache/cxf/feature/AbstractFeature", null);

{
fieldVisitor = classWriter.visitField(ACC_FINAL, "wrapped", "Lorg/apache/cxf/feature/Feature;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/cxf/feature/Feature;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/feature/AbstractFeature", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/feature/WrappedFeature", "wrapped", "Lorg/apache/cxf/feature/Feature;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/feature/WrappedFeature", "wrapped", "Lorg/apache/cxf/feature/Feature;");
methodVisitor.visitVarInsn(ALOAD, 1);
