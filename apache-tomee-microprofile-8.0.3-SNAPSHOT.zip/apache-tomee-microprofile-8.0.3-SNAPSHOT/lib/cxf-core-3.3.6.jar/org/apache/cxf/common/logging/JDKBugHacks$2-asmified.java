...
public class JDKBugHacks$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/cxf/common/logging/JDKBugHacks$2", null, "java/net/URLConnection", null);

classWriter.visitOuterClass("org/apache/cxf/common/logging/JDKBugHacks", "doHacks", "()V");
