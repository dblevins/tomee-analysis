...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", null, "org/apache/log4j/AppenderSkeleton", null);

classWriter.visitInnerClass("org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "org/apache/cxf/common/logging/Log4jLogger", "HandlerWrapper", ACC_PRIVATE);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/apache/cxf/common/logging/Log4jLogger;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/common/logging/Log4jLogger;Ljava/util/logging/Handler;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "this$0", "Lorg/apache/cxf/common/logging/Log4jLogger;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/log4j/AppenderSkeleton", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "handler", "Ljava/util/logging/Handler;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "handler", "Ljava/util/logging/Handler;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "this$0", "Lorg/apache/cxf/common/logging/Log4jLogger;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/log4j/spi/LoggingEvent", "getLevel", "()Lorg/apache/log4j/Level;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/Log4jLogger", "access$000", "(Lorg/apache/cxf/common/logging/Log4jLogger;Lorg/apache/log4j/Level;)Ljava/util/logging/Level;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "this$0", "Lorg/apache/cxf/common/logging/Log4jLogger;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/logging/Log4jLogger", "getResourceBundleName", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "this$0", "Lorg/apache/cxf/common/logging/Log4jLogger;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/logging/Log4jLogger", "getResourceBundle", "()Ljava/util/ResourceBundle;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/log4j/spi/LoggingEvent", "fqnOfCategoryClass", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/Log4jLogger", "access$100", "(Ljava/util/logging/LogRecord;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "handler", "Ljava/util/logging/Handler;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "closed", "Z");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/Log4jLogger", "access$200", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "handler", "Ljava/util/logging/Handler;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "getThreshold", "()Lorg/apache/log4j/Priority;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
