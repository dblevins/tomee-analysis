...
public class JAXBUtils$JPackageDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/cxf/common/jaxb/JAXBUtils$JPackage", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "classes", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Lorg/apache/cxf/common/jaxb/JAXBUtils$JDefinedClass;>;", null);
{
annotationVisitor0 = methodVisitor.visitAnnotation("Lorg/apache/cxf/common/util/ReflectionInvokationHandler$WrapReturn;", true);
annotationVisitor0.visit("value", Type.getType("Lorg/apache/cxf/common/jaxb/JAXBUtils$JDefinedClass;"));
