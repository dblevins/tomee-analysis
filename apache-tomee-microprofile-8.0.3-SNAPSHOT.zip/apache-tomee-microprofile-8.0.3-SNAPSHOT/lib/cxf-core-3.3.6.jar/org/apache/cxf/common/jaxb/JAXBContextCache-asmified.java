...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC | ACC_VARARGS, "getCachedContextAndSchemas", "([Ljava/lang/Class;)Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas;", "([Ljava/lang/Class<*>;)Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas;", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getCachedContextAndSchemas", "(Ljava/lang/String;Ljava/util/Map;Ljava/lang/ClassLoader;)Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas;", "(Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/lang/ClassLoader;)Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas;", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/HashSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getCachedContextAndSchemas", "(Ljava/util/Set;Ljava/lang/String;Ljava/util/Map;Ljava/util/Collection;Z)Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas;", "(Ljava/util/Set<Ljava/lang/Class<*>;>;Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/util/Collection<Ljava/lang/Object;>;Z)Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas;", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemasInternal", "javax/xml/bind/JAXBContext", "java/util/Map"}, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/jaxb/JAXBContextCache", "JAXBCONTEXT_CACHE", "Ljava/util/Map;");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemasInternal", "getContext", "()Ljavax/xml/bind/JAXBContext;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemas", "<init>", "(Ljavax/xml/bind/JAXBContext;Ljava/util/Set;Lorg/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemasInternal;Lorg/apache/cxf/common/jaxb/JAXBContextCache$1;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/jaxb/JAXBContextCache", "createContext", "(Ljava/util/Set;Ljava/util/Map;Ljava/util/Collection;)Ljavax/xml/bind/JAXBContext;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label7);
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/jaxb/JAXBContextCache", "addJaxbObjectFactory", "(Ljavax/xml/bind/JAXBException;Ljava/util/Set;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"java/util/Set", "java/lang/String", "java/util/Map", "java/util/Collection", Opcodes.INTEGER, "java/util/Map", "org/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemasInternal", "javax/xml/bind/JAXBContext", "java/util/Map", "javax/xml/bind/JAXBException", Opcodes.INTEGER}, 1, new Object[] {"java/security/PrivilegedActionException"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemasInternal", "<init>", "(Ljavax/xml/bind/JAXBContext;Ljava/util/Set;)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/jaxb/JAXBContextCache", "JAXBCONTEXT_CACHE", "Ljava/util/Map;");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ASTORE, 9);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"java/util/Set", "java/lang/String", "java/util/Map", "java/util/Collection", Opcodes.INTEGER, "java/util/Map", "org/apache/cxf/common/jaxb/JAXBContextCache$CachedContextAndSchemasInternal", "javax/xml/bind/JAXBContext", "java/util/Map", "java/lang/Object"}, 2, new Object[] {"java/util/Map", "java/lang/String"});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/jaxb/JAXBContextCache", "JAXBCONTEXT_CACHE", "Ljava/util/Map;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createContext", "(Ljava/util/Set;Ljava/util/Map;Ljava/util/Collection;)Ljavax/xml/bind/JAXBContext;", "(Ljava/util/Set<Ljava/lang/Class<*>;>;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/util/Collection<Ljava/lang/Object;>;)Ljavax/xml/bind/JAXBContext;", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label25);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {Opcodes.TOP, "java/security/PrivilegedActionException", "javax/xml/bind/JAXBException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label26);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/util/Set", "java/util/Map", "java/util/Collection", "javax/xml/bind/JAXBContext", "java/security/PrivilegedActionException"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label23);
methodVisitor.visitLabel(label24);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label23);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"java/util/Set", "java/util/Map", "java/util/Collection", "javax/xml/bind/JAXBContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "addJaxbObjectFactory", "(Ljavax/xml/bind/JAXBException;Ljava/util/Set;)Z", "(Ljavax/xml/bind/JAXBException;Ljava/util/Set<Ljava/lang/Class<*>;>;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/bind/JAXBException", "printStackTrace", "(Ljava/io/PrintStream;)V", false);
...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"javax/xml/bind/JAXBException", "java/util/Set", Opcodes.INTEGER, "java/io/ByteArrayOutputStream", "java/io/PrintStream", "java/lang/String", "java/util/regex/Pattern", "java/util/regex/Matcher"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
