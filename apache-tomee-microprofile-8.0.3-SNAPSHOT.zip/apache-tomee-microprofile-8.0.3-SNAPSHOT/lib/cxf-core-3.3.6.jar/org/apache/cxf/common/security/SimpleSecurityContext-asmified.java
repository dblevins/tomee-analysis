...
public class SimpleSecurityContextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/common/security/SimpleSecurityContext", null, "java/lang/Object", new String[] { "org/apache/cxf/security/SecurityContext" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/security/SimpleSecurityContext", "principal", "Ljava/security/Principal;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/security/SimpleSecurityContext", "principal", "Ljava/security/Principal;");
