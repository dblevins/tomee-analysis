...
public class ManagedNotificationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/cxf/management/annotation/ManagedNotification", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "notificationTypes", "()[Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
