...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNCHRONIZED, "getContext", "(Ljava/lang/Class;)Ljakarta/xml/bind/JAXBContext;", "(Ljava/lang/Class<*>;)Ljakarta/xml/bind/JAXBContext;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", "context", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", "context", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", "java/lang/Class"}, 1, new Object[] {"jakarta/xml/bind/JAXBException"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", "getContext", "(Ljava/lang/Class;)Ljakarta/xml/bind/JAXBContext;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", "org/w3c/dom/Element", "org/springframework/beans/factory/support/BeanDefinitionBuilder", "java/lang/String", "java/lang/Class", "javax/xml/stream/XMLStreamWriter", "jakarta/xml/bind/Unmarshaller"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/configuration/spring/AbstractBeanDefinitionParser", "getContext", "(Ljava/lang/Class;)Ljakarta/xml/bind/JAXBContext;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "unmarshalFactoryString", "(Ljava/lang/String;Ljakarta/xml/bind/JAXBContext;Ljava/lang/Class;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/String;Ljakarta/xml/bind/JAXBContext;Ljava/lang/Class<TT;>;)TT;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"java/lang/String", "jakarta/xml/bind/JAXBContext", "java/lang/Class", "java/io/StringReader", "javax/xml/stream/XMLStreamReader", "jakarta/xml/bind/Unmarshaller", "jakarta/xml/bind/JAXBElement", "java/lang/Object"}, 1, new Object[] {"javax/xml/stream/XMLStreamException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitTypeInsn(NEW, "java/lang/RuntimeException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"java/lang/String", "jakarta/xml/bind/JAXBContext", "java/lang/Class", "java/io/StringReader", "javax/xml/stream/XMLStreamReader", "jakarta/xml/bind/Unmarshaller"}, 1, new Object[] {"java/lang/RuntimeException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label5);
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"java/lang/String", "jakarta/xml/bind/JAXBContext", "java/lang/Class", "java/io/StringReader", "javax/xml/stream/XMLStreamReader", "jakarta/xml/bind/Unmarshaller", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"javax/xml/stream/XMLStreamException"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitTypeInsn(NEW, "java/lang/RuntimeException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 10);
