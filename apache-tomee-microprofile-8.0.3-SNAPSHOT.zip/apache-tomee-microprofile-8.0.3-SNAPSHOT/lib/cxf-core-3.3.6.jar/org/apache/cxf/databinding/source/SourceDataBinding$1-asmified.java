...
public class SourceDataBinding$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/databinding/source/SourceDataBinding$1", null, "org/apache/cxf/service/ServiceModelVisitor", null);

classWriter.visitOuterClass("org/apache/cxf/databinding/source/SourceDataBinding", "initialize", "(Lorg/apache/cxf/service/Service;)V");

classWriter.visitInnerClass("org/apache/cxf/databinding/source/SourceDataBinding$1", null, null, 0);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/apache/cxf/databinding/source/SourceDataBinding;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/databinding/source/SourceDataBinding;Lorg/apache/cxf/service/model/ServiceInfo;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/databinding/source/SourceDataBinding$1", "this$0", "Lorg/apache/cxf/databinding/source/SourceDataBinding;");
methodVisitor.visitVarInsn(ALOAD, 0);
