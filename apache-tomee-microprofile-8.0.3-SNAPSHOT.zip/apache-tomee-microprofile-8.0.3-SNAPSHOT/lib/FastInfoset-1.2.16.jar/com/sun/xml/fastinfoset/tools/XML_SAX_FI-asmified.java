...
public class XML_SAX_FIDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/fastinfoset/tools/XML_SAX_FI", null, "com/sun/xml/fastinfoset/tools/TransformInputOutput", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/xml/fastinfoset/tools/XML_SAX_FI", "getParser", "()Ljavax/xml/parsers/SAXParser;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/xml/fastinfoset/tools/XML_SAX_FI", "getSerializer", "(Ljava/io/OutputStream;)Lcom/sun/xml/fastinfoset/sax/SAXDocumentSerializer;", false);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/xml/fastinfoset/tools/XML_SAX_FI", "createRelativePathResolver", "(Ljava/lang/String;)Lorg/xml/sax/EntityResolver;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/xml/parsers/SAXParser", "com/sun/xml/fastinfoset/sax/SAXDocumentSerializer", "org/xml/sax/XMLReader"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/fastinfoset/tools/XML_SAX_FI", "parse", "(Ljava/io/InputStream;Ljava/io/OutputStream;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "convert", "(Ljava/io/Reader;Ljava/io/OutputStream;)V", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/xml/sax/InputSource");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/xml/fastinfoset/tools/XML_SAX_FI", "javax/xml/parsers/SAXParserFactory"}, 1, new Object[] {"java/lang/Exception"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getSerializer", "(Ljava/io/OutputStream;)Lcom/sun/xml/fastinfoset/sax/SAXDocumentSerializer;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/fastinfoset/tools/XML_SAX_FI", "parse", "([Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
