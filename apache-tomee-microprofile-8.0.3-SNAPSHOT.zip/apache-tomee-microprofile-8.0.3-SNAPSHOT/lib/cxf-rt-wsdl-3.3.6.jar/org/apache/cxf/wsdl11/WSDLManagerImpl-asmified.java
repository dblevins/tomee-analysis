...
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "registry", "Ljakarta/wsdl/extensions/ExtensionRegistry;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "factory", "Ljakarta/wsdl/factory/WSDLFactory;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "definitionsMap", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/Object;Ljakarta/wsdl/Definition;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitTryCatchBlock(label3, label4, label5, "jakarta/wsdl/WSDLException");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "factory", "Ljakarta/wsdl/factory/WSDLFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInvokeDynamicInsn("run", "()Ljava/security/PrivilegedExceptionAction;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "jakarta/wsdl/factory/WSDLFactory", "newInstance", "()Ljakarta/wsdl/factory/WSDLFactory;", false), Type.getType("()Ljakarta/wsdl/factory/WSDLFactory;")});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "factory", "Ljakarta/wsdl/factory/WSDLFactory;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "registry", "Ljakarta/wsdl/extensions/ExtensionRegistry;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "registry", "Ljakarta/wsdl/extensions/ExtensionRegistry;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "registry", "Ljakarta/wsdl/extensions/ExtensionRegistry;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/WSDLManagerImpl", "addExtensionAttributeTypes", "(Ljakarta/wsdl/extensions/ExtensionRegistry;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getWSDLFactory", "()Ljakarta/wsdl/factory/WSDLFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "factory", "Ljakarta/wsdl/factory/WSDLFactory;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDefinitions", "()Ljava/util/Map;", "()Ljava/util/Map<Ljava/lang/Object;Ljakarta/wsdl/Definition;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDefinition", "(Ljava/lang/String;)Ljakarta/wsdl/Definition;", null, new String[] { "jakarta/wsdl/WSDLException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/wsdl11/WSDLManagerImpl", "loadDefinition", "(Ljava/lang/String;)Ljakarta/wsdl/Definition;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "definitionsMap", "Ljava/util/Map;");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/String", "jakarta/wsdl/Definition", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDefinition", "(Lorg/w3c/dom/Element;)Ljakarta/wsdl/Definition;", null, new String[] { "jakarta/wsdl/WSDLException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "registry", "Ljakarta/wsdl/extensions/ExtensionRegistry;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/xml/WSDLReader", "setExtensionRegistry", "(Ljakarta/wsdl/extensions/ExtensionRegistry;)V", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getSecurityManager", "()Ljava/lang/SecurityManager;", false);
methodVisitor.visitJumpInsn(IFNONNULL, label6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn("");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/xml/WSDLReader", "readWSDL", "(Ljava/lang/String;Lorg/w3c/dom/Element;)Ljakarta/wsdl/Definition;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
Label label14 = new Label();
methodVisitor.visitJumpInsn(GOTO, label14);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/wsdl/xml/WSDLReader"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInvokeDynamicInsn("run", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/w3c/dom/Element;)Ljava/security/PrivilegedExceptionAction;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/cxf/wsdl11/WSDLManagerImpl", "lambda$getDefinition$0", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/w3c/dom/Element;)Ljakarta/wsdl/Definition;", false), Type.getType("()Ljakarta/wsdl/Definition;")});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/wsdl/Definition");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label7);
...
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "org/w3c/dom/Element", "jakarta/wsdl/xml/WSDLReader", "jakarta/wsdl/Definition", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addDefinition", "(Ljava/lang/Object;Ljakarta/wsdl/Definition;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/Object", "jakarta/wsdl/Definition", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(MONITOREXIT);
methodVisitor.visitLabel(label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "loadDefinition", "(Ljava/lang/String;)Ljakarta/wsdl/Definition;", null, new String[] { "jakarta/wsdl/WSDLException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl11/WSDLManagerImpl", "bus", "Lorg/apache/cxf/Bus;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/wsdl11/ResourceManagerWSDLLocator", "<init>", "(Ljava/lang/String;Ljakarta/wsdl/xml/WSDLLocator;Lorg/apache/cxf/Bus;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/String", "jakarta/wsdl/xml/WSDLReader", "org/apache/cxf/wsdl11/CatalogWSDLLocator", "org/apache/cxf/wsdl11/ResourceManagerWSDLLocator", "org/xml/sax/InputSource", "jakarta/wsdl/Definition"}, 0, new Object[] {});
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/String", "jakarta/wsdl/xml/WSDLReader", "org/apache/cxf/wsdl11/CatalogWSDLLocator", "org/apache/cxf/wsdl11/ResourceManagerWSDLLocator", "org/xml/sax/InputSource", "jakarta/wsdl/Definition", "org/w3c/dom/Document", "javax/xml/stream/XMLStreamReader"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/String", "jakarta/wsdl/xml/WSDLReader", "org/apache/cxf/wsdl11/CatalogWSDLLocator", "org/apache/cxf/wsdl11/ResourceManagerWSDLLocator", "org/xml/sax/InputSource", "jakarta/wsdl/Definition", Opcodes.TOP, "javax/xml/stream/XMLStreamReader"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitTypeInsn(NEW, "jakarta/wsdl/WSDLException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("PARSER_ERROR");
...
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/String", "jakarta/wsdl/xml/WSDLReader", "org/apache/cxf/wsdl11/CatalogWSDLLocator", "org/apache/cxf/wsdl11/ResourceManagerWSDLLocator", "org/xml/sax/InputSource", "jakarta/wsdl/Definition", Opcodes.TOP, "javax/xml/stream/XMLStreamReader", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"javax/xml/stream/XMLStreamException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/wsdl11/WSDLManagerImpl", "java/lang/String", "jakarta/wsdl/xml/WSDLReader", "org/apache/cxf/wsdl11/CatalogWSDLLocator", "org/apache/cxf/wsdl11/ResourceManagerWSDLLocator", "org/xml/sax/InputSource", "jakarta/wsdl/Definition", "org/w3c/dom/Document", "javax/xml/stream/XMLStreamReader"}, 0, new Object[] {});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/System", "getSecurityManager", "()Ljava/lang/SecurityManager;", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/xml/WSDLReader", "readWSDL", "(Ljakarta/wsdl/xml/WSDLLocator;Lorg/w3c/dom/Element;)Ljakarta/wsdl/Definition;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitInvokeDynamicInsn("run", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/apache/cxf/wsdl11/ResourceManagerWSDLLocator;Lorg/w3c/dom/Document;)Ljava/security/PrivilegedExceptionAction;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/cxf/wsdl11/WSDLManagerImpl", "lambda$loadDefinition$1", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/apache/cxf/wsdl11/ResourceManagerWSDLLocator;Lorg/w3c/dom/Document;)Ljakarta/wsdl/Definition;", false), Type.getType("()Ljakarta/wsdl/Definition;")});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/wsdl/Definition");
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label13);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/xml/WSDLReader", "readWSDL", "(Ljakarta/wsdl/xml/WSDLLocator;)Ljakarta/wsdl/Definition;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitJumpInsn(GOTO, label24);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInvokeDynamicInsn("run", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/apache/cxf/wsdl11/ResourceManagerWSDLLocator;)Ljava/security/PrivilegedExceptionAction;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/cxf/wsdl11/WSDLManagerImpl", "lambda$loadDefinition$2", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/apache/cxf/wsdl11/ResourceManagerWSDLLocator;)Ljakarta/wsdl/Definition;", false), Type.getType("()Ljakarta/wsdl/Definition;")});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/wsdl/Definition");
methodVisitor.visitVarInsn(ASTORE, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addExtensionAttributeTypes", "(Ljakarta/wsdl/extensions/ExtensionRegistry;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "javax/xml/namespace/QName");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/wsdl/extensions/ExtensionRegistry", "registerExtensionAttributeType", "(Ljava/lang/Class;Ljavax/xml/namespace/QName;I)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSchemasForDefinition", "(Ljakarta/wsdl/Definition;)Lorg/apache/cxf/service/model/ServiceSchemaInfo;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "putSchemasForDefinition", "(Ljakarta/wsdl/Definition;Lorg/apache/cxf/service/model/ServiceSchemaInfo;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "removeDefinition", "(Ljakarta/wsdl/Definition;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$loadDefinition$2", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/apache/cxf/wsdl11/ResourceManagerWSDLLocator;)Ljakarta/wsdl/Definition;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/xml/WSDLReader", "readWSDL", "(Ljakarta/wsdl/xml/WSDLLocator;)Ljakarta/wsdl/Definition;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$loadDefinition$1", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/apache/cxf/wsdl11/ResourceManagerWSDLLocator;Lorg/w3c/dom/Document;)Ljakarta/wsdl/Definition;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getDefinition$0", "(Ljakarta/wsdl/xml/WSDLReader;Lorg/w3c/dom/Element;)Ljakarta/wsdl/Definition;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("");
methodVisitor.visitVarInsn(ALOAD, 1);
