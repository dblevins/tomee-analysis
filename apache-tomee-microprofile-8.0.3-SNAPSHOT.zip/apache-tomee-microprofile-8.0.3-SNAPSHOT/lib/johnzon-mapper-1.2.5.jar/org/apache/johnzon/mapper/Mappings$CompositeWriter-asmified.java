...
public class Mappings$CompositeWriterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/mapper/Mappings$CompositeWriter", null, "java/lang/Object", new String[] { "org/apache/johnzon/mapper/access/AccessMode$Writer" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "delegates", "[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "<init>", "([Lorg/apache/johnzon/mapper/access/AccessMode$Writer;)V", null, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/johnzon/mapper/Mappings$CompositeWriter", "[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;", "java/util/Collection", "[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/johnzon/mapper/Mappings$CompositeWriter;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/johnzon/mapper/Mappings$CompositeWriter");
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/Mappings$CompositeWriter", "delegates", "[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;");
...
methodVisitor.visitTypeInsn(CHECKCAST, "[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/Mappings$CompositeWriter", "delegates", "[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Lorg/apache/johnzon/mapper/access/AccessMode$Writer;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 4);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label1);
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/mapper/access/AccessMode$Writer", "findConverter", "()Lorg/apache/johnzon/mapper/Adapter;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label2);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/mapper/access/AccessMode$Writer", "isNillable", "(Z)Z", true);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
