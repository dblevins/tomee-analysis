...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", null, "java/lang/Object", new String[] { "javax/json/stream/JsonGenerator" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "delegate", "Ljavax/json/stream/JsonGenerator;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljavax/json/stream/JsonGenerator;Ljava/lang/Runnable;Ljava/lang/String;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "delegate", "Ljavax/json/stream/JsonGenerator;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "nested", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "delegate", "Ljavax/json/stream/JsonGenerator;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "delegate", "Ljavax/json/stream/JsonGenerator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/json/stream/JsonGenerator", "writeKey", "(Ljava/lang/String;)Ljavax/json/stream/JsonGenerator;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "delegate", "Ljavax/json/stream/JsonGenerator;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/json/stream/JsonGenerator", "flush", "()V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljavax/json/stream/JsonGenerator;Ljava/lang/Runnable;Ljava/lang/String;Lorg/apache/johnzon/mapper/DynamicMappingGenerator$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "<init>", "(Ljavax/json/stream/JsonGenerator;Ljava/lang/Runnable;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 5);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Lorg/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator;)Ljavax/json/stream/JsonGenerator;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/mapper/DynamicMappingGenerator$InObjectOrPrimitiveJsonGenerator", "delegate", "Ljavax/json/stream/JsonGenerator;");
methodVisitor.visitInsn(ARETURN);
