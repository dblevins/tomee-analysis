...
public class BaseAccessMode$SingleEntryFieldFilteringStrategyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/mapper/access/BaseAccessMode$SingleEntryFieldFilteringStrategy", null, "org/apache/johnzon/mapper/access/BaseAccessMode$ConfiguredFieldFilteringStrategy", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/mapper/access/BaseAccessMode$SingleEntryFieldFilteringStrategy", "getFieldsToRemove", "()Ljava/util/Map;", false);
