...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tag/common/sql/TransactionTagSupport", null, "jakarta/servlet/jsp/tagext/TagSupport", new String[] { "jakarta/servlet/jsp/tagext/TryCatchFinally" });
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/sql/TransactionTagSupport", "rawDataSource", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/sql/TransactionTagSupport", "pageContext", "Ljakarta/servlet/jsp/PageContext;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setIsolation", "(Ljava/lang/String;)V", null, new String[] { "jakarta/servlet/jsp/JspTagException" });
methodVisitor.visitCode();
