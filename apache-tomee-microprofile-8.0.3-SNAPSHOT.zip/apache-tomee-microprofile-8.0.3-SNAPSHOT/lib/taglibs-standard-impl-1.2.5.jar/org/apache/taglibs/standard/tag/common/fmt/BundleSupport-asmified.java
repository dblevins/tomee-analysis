...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", null, "javax/servlet/jsp/tagext/BodyTagSupport", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "locCtxt", "Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "locCtxt", "Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLocalizationContext", "()Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "locCtxt", "Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "pageContext", "Ljavax/servlet/jsp/PageContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "getLocalizationContext", "(Ljavax/servlet/jsp/PageContext;Ljava/lang/String;)Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "locCtxt", "Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/jsp/tagext/BodyTagSupport", "release", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "init", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getLocalizationContext", "(Ljavax/servlet/jsp/PageContext;)Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getLocalizationContext", "(Ljavax/servlet/jsp/PageContext;Ljava/lang/String;)Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/taglibs/standard/tag/common/fmt/BundleSupport", "findMatch", "(Ljavax/servlet/jsp/PageContext;Ljava/lang/String;)Ljavax/servlet/jsp/jstl/fmt/LocalizationContext;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
