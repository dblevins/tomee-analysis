...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/taglibs/standard/tag/rt/core/ForTokensTag", null, "org/apache/taglibs/standard/tag/common/core/ForTokensSupport", new String[] { "javax/servlet/jsp/jstl/core/LoopTag", "javax/servlet/jsp/tagext/IterationTag" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setItems", "(Ljava/lang/Object;)V", null, new String[] { "javax/servlet/jsp/JspTagException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setDelims", "(Ljava/lang/String;)V", null, new String[] { "javax/servlet/jsp/JspTagException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
