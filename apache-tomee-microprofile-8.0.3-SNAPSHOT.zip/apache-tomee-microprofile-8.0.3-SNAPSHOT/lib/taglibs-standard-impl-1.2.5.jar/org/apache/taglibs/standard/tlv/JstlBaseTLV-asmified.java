...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tlv/JstlBaseTLV", null, "jakarta/servlet/jsp/tagext/TagLibraryValidator", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/jsp/tagext/TagLibraryValidator", "release", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/taglibs/standard/tlv/JstlBaseTLV", "init", "()V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "validate", "(ILjava/lang/String;Ljava/lang/String;Ljakarta/servlet/jsp/tagext/PageData;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/taglibs/standard/tlv/JstlBaseTLV", "vmFromString", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tlv/JstlBaseTLV", "messageVector", "Ljava/util/Vector;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/taglibs/standard/tlv/JstlBaseTLV", "vmFromVector", "(Ljava/util/Vector;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "isSpecified", "(Ljakarta/servlet/jsp/tagext/TagData;Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/tagext/TagData", "getAttribute", "(Ljava/lang/String;)Ljava/lang/Object;", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitInsn(ICONST_1);
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "vmFromString", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "vmFromVector", "(Ljava/util/Vector;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Vector", "size", "()I", false);
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/servlet/jsp/tagext/ValidationMessage");
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/servlet/jsp/tagext/ValidationMessage");
methodVisitor.visitInsn(AASTORE);
