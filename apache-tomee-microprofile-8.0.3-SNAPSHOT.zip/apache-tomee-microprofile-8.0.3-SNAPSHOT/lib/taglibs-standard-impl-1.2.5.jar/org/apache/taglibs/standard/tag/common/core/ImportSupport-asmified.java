...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tag/common/core/ImportSupport", null, "javax/servlet/jsp/tagext/BodyTagSupport", new String[] { "javax/servlet/jsp/tagext/TryCatchFinally", "org/apache/taglibs/standard/tag/common/core/ParamParent" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/ImportSupport", "pageContext", "Ljavax/servlet/jsp/PageContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/ImportSupport", "varReader", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "acquireString", "()Ljava/lang/String;", null, new String[] { "java/io/IOException", "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label4 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label4, "javax/servlet/ServletException");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/taglibs/standard/tag/common/core/ImportSupport$ImportResponseWrapper", "<init>", "(Lorg/apache/taglibs/standard/tag/common/core/ImportSupport;Ljavax/servlet/http/HttpServletResponse;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "acquireReader", "()Ljava/io/Reader;", null, new String[] { "java/io/IOException", "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
