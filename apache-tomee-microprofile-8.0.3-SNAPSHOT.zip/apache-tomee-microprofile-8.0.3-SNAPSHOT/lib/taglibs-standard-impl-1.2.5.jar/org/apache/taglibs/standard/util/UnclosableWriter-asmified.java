...
public class UnclosableWriterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/taglibs/standard/util/UnclosableWriter", null, "java/io/Writer", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/util/UnclosableWriter", "w", "Ljava/io/Writer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/util/UnclosableWriter", "w", "Ljava/io/Writer;");
methodVisitor.visitVarInsn(ALOAD, 1);
