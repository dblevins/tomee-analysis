...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tag/common/sql/QueryTagSupport", null, "jakarta/servlet/jsp/tagext/BodyTagSupport", new String[] { "jakarta/servlet/jsp/tagext/TryCatchFinally", "jakarta/servlet/jsp/jstl/sql/SQLExecutionTag" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/sql/QueryTagSupport", "bodyContent", "Ljakarta/servlet/jsp/tagext/BodyContent;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getConnection", "()Ljava/sql/Connection;", null, new String[] { "jakarta/servlet/jsp/JspException", "java/sql/SQLException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/taglibs/standard/tag/common/sql/QueryTagSupport", "findAncestorWithClass", "(Ljakarta/servlet/jsp/tagext/Tag;Ljava/lang/Class;)Ljakarta/servlet/jsp/tagext/Tag;", false);
