...
classWriter.visit(V1_8, ACC_SUPER, "javax/el/StandardELContext$StandardVariableMapper", null, "javax/el/VariableMapper", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/el/StandardELContext$StandardVariableMapper", "vars", "Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/el/StandardELContext$StandardVariableMapper", "vars", "Ljava/util/Map;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljavax/el/StandardELContext$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/el/StandardELContext$StandardVariableMapper", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
