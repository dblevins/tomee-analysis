...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/el/ValueExpression", null, "javax/el/Expression", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/el/Expression", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setValue", "(Ljavax/el/ELContext;Ljava/lang/Object;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "isReadOnly", "(Ljavax/el/ELContext;)Z", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getType", "(Ljavax/el/ELContext;)Ljava/lang/Class;", "(Ljavax/el/ELContext;)Ljava/lang/Class<*>;", null);
methodVisitor.visitEnd();
}
{
