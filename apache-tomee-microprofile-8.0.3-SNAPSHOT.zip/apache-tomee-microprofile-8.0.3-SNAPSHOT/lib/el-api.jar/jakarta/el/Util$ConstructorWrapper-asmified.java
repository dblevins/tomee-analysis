...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/el/Util$ConstructorWrapper", "Ljakarta/el/Util$Wrapper<Ljava/lang/reflect/Constructor<*>;>;", "jakarta/el/Util$Wrapper", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/el/Util$Wrapper", "<init>", "(Ljakarta/el/Util$1;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/el/Util$ConstructorWrapper", "c", "Ljava/lang/reflect/Constructor;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/el/Util$ConstructorWrapper", "c", "Ljava/lang/reflect/Constructor;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/el/Util$ConstructorWrapper", "unWrap", "()Ljava/lang/reflect/Constructor;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
