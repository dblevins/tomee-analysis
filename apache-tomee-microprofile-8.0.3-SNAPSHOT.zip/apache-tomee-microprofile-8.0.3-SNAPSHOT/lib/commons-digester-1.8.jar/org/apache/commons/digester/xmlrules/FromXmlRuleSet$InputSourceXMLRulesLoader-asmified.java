...
public class FromXmlRuleSet$InputSourceXMLRulesLoaderDump implements Opcodes {
...
classWriter.visit(V1_2, ACC_SUPER, "org/apache/commons/digester/xmlrules/FromXmlRuleSet$InputSourceXMLRulesLoader", null, "org/apache/commons/digester/xmlrules/FromXmlRuleSet$XMLRulesLoader", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/digester/xmlrules/FromXmlRuleSet;Lorg/xml/sax/InputSource;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/digester/xmlrules/FromXmlRuleSet$InputSourceXMLRulesLoader", "this$0", "Lorg/apache/commons/digester/xmlrules/FromXmlRuleSet;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/digester/xmlrules/FromXmlRuleSet$InputSourceXMLRulesLoader", "inputSource", "Lorg/xml/sax/InputSource;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/digester/xmlrules/FromXmlRuleSet$InputSourceXMLRulesLoader", "this$0", "Lorg/apache/commons/digester/xmlrules/FromXmlRuleSet;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/digester/xmlrules/FromXmlRuleSet$InputSourceXMLRulesLoader", "inputSource", "Lorg/xml/sax/InputSource;");
