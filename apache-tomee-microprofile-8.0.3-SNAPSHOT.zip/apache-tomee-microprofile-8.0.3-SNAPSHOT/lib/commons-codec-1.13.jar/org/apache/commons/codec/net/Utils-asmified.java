...
classWriter.visit(V1_7, ACC_SUPER, "org/apache/commons/codec/net/Utils", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "digit16", "(B)I", null, new String[] { "org/apache/commons/codec/DecoderException" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "hexDigit", "(I)C", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ILOAD, 0);
