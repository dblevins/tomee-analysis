...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/tomcat/dbcp/pool2/PooledObject", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljava/lang/Comparable<Lorg/apache/tomcat/dbcp/pool2/PooledObject<TT;>;>;", "java/lang/Object", new String[] { "java/lang/Comparable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "compareTo", "(Lorg/apache/tomcat/dbcp/pool2/PooledObject;)I", "(Lorg/apache/tomcat/dbcp/pool2/PooledObject<TT;>;)I", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "endEvictionTest", "(Ljava/util/Deque;)Z", "(Ljava/util/Deque<Lorg/apache/tomcat/dbcp/pool2/PooledObject<TT;>;>;)Z", null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getState", "()Lorg/apache/tomcat/dbcp/pool2/PooledObjectState;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/tomcat/dbcp/pool2/PooledObject", "compareTo", "(Lorg/apache/tomcat/dbcp/pool2/PooledObject;)I", true);
