...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingPerKeyKeyedObjectPool", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Lorg/apache/tomcat/dbcp/pool2/PoolUtils$ErodingKeyedObjectPool<TK;TV;>;", "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingKeyedObjectPool", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "factors", "Ljava/util/Map;", "Ljava/util/Map<TK;Lorg/apache/tomcat/dbcp/pool2/PoolUtils$ErodingFactor;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingPerKeyKeyedObjectPool", "factors", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(FLOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingPerKeyKeyedObjectPool", "factor", "F");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingPerKeyKeyedObjectPool", "factors", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingFactor");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingPerKeyKeyedObjectPool", "factor", "F");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingFactor"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/dbcp/pool2/PoolUtils$ErodingPerKeyKeyedObjectPool", "getKeyedPool", "()Lorg/apache/tomcat/dbcp/pool2/KeyedObjectPool;", false);
