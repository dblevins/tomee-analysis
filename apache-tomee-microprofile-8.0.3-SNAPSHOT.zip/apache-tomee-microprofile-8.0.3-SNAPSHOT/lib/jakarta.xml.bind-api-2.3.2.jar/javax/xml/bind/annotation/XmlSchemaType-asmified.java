...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/bind/annotation/XmlSchemaType", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
classWriter.visitInnerClass("javax/xml/bind/annotation/XmlSchemaType$DEFAULT", "javax/xml/bind/annotation/XmlSchemaType", "DEFAULT", ACC_PUBLIC | ACC_FINAL | ACC_STATIC);
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Ljavax/xml/bind/annotation/XmlSchemaType$DEFAULT;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
