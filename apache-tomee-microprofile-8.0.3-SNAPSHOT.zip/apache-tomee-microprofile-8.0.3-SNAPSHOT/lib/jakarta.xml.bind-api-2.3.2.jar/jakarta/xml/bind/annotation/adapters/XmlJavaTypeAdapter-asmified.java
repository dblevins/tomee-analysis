...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/xml/bind/annotation/adapters/XmlJavaTypeAdapter", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "value", "()Ljava/lang/Class;", "()Ljava/lang/Class<+Ljakarta/xml/bind/annotation/adapters/XmlAdapter;>;", null);
...
annotationVisitor0.visit(null, Type.getType("Ljakarta/xml/bind/annotation/adapters/XmlJavaTypeAdapter$DEFAULT;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
