package asm.org.opensaml.xmlsec.criterion;
...
public class EncryptionConfigurationCriterionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/criterion/EncryptionConfigurationCriterion", null, "java/lang/Object", new String[] { "net/shibboleth/utilities/java/support/resolver/Criterion" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "configs", "Ljava/util/List;", "Ljava/util/List<Lorg/opensaml/xmlsec/EncryptionConfiguration;>;", null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/List;)V", "(Ljava/util/List<Lorg/opensaml/xmlsec/EncryptionConfiguration;>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/criterion/EncryptionConfigurationCriterion", "configs", "Ljava/util/List;");
methodVisitor.visitInsn(LCONST_1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/criterion/EncryptionConfigurationCriterion", "configs", "Ljava/util/List;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "<init>", "([Lorg/opensaml/xmlsec/EncryptionConfiguration;)V", null, null);
methodVisitor.visitAnnotableParameterCount(1, true);
{
annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConfigurations", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/xmlsec/EncryptionConfiguration;>;", null);
{
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("EncryptionConfigurationCriterion [configs=");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/xmlsec/criterion/EncryptionConfigurationCriterion");
