...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/opensaml/xmlsec/signature/DEREncodedKeyValue", null, "java/lang/Object", new String[] { "org/opensaml/core/xml/schema/XSBase64Binary" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "DEFAULT_ELEMENT_LOCAL_NAME", "Ljava/lang/String;", null, "DEREncodedKeyValue");
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "TYPE_LOCAL_NAME", "Ljava/lang/String;", null, "DEREncodedKeyValueType");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/xmlsec/signature/DEREncodedKeyValue", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
methodVisitor.visitTypeInsn(NEW, "javax/xml/namespace/QName");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("http://www.w3.org/2009/xmldsig11#");
methodVisitor.visitLdcInsn("DEREncodedKeyValueType");
methodVisitor.visitLdcInsn("ds11");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/namespace/QName", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/xmlsec/signature/DEREncodedKeyValue", "TYPE_NAME", "Ljavax/xml/namespace/QName;");
