package asm.org.eclipse.microprofile.openapi.annotations.servers;
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/microprofile/openapi/annotations/servers/Server", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Lorg/eclipse/microprofile/openapi/annotations/servers/Servers;"));
annotationVisitor0.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "variables", "()[Lorg/eclipse/microprofile/openapi/annotations/servers/ServerVariable;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
