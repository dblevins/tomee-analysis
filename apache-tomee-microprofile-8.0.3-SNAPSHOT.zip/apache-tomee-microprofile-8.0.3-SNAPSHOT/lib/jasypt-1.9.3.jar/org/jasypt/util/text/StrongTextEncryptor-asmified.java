...
public class StrongTextEncryptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/util/text/StrongTextEncryptor", null, "java/lang/Object", new String[] { "org/jasypt/util/text/TextEncryptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/util/text/StrongTextEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEStringEncryptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/util/text/StrongTextEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEStringEncryptor;");
