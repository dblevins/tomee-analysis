...
public class StrongDecimalNumberEncryptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/util/numeric/StrongDecimalNumberEncryptor", null, "java/lang/Object", new String[] { "org/jasypt/util/numeric/DecimalNumberEncryptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/util/numeric/StrongDecimalNumberEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEBigDecimalEncryptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/util/numeric/StrongDecimalNumberEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEBigDecimalEncryptor;");
