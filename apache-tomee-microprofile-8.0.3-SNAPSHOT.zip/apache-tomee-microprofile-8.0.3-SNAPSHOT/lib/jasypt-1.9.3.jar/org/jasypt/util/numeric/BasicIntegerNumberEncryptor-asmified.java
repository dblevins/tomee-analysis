...
public class BasicIntegerNumberEncryptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/util/numeric/BasicIntegerNumberEncryptor", null, "java/lang/Object", new String[] { "org/jasypt/util/numeric/IntegerNumberEncryptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/util/numeric/BasicIntegerNumberEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/util/numeric/BasicIntegerNumberEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor;");
