...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", null, "org/apache/wss4j/binding/wssc/AbstractSecurityContextTokenType", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", "otherAttributes", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/binding/wssc13/SecurityContextTokenType", "otherAttributes", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
