...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/tomcat/util/scan/StandardJarScanner", "org/apache/tomcat/JarScanType", "javax/servlet/ServletContext", "org/apache/tomcat/JarScannerCallback", "java/util/Set", "java/util/Set", "java/util/Iterator", "java/lang/String", "java/net/URL"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/tomcat/util/scan/StandardJarScanner", "org/apache/tomcat/JarScanType", "javax/servlet/ServletContext", "org/apache/tomcat/JarScannerCallback", "java/util/Set", "java/util/Set", "java/net/URL", "java/net/URL"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/scan/StandardJarScanner", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomcat/util/scan/StandardJarScanner", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/scan/StandardJarScanner", "doScanClassPath", "(Lorg/apache/tomcat/JarScanType;Ljavax/servlet/ServletContext;Lorg/apache/tomcat/JarScannerCallback;Ljava/util/Set;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doScanClassPath", "(Lorg/apache/tomcat/JarScanType;Ljavax/servlet/ServletContext;Lorg/apache/tomcat/JarScannerCallback;Ljava/util/Set;)V", "(Lorg/apache/tomcat/JarScanType;Ljavax/servlet/ServletContext;Lorg/apache/tomcat/JarScannerCallback;Ljava/util/Set<Ljava/net/URL;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/scan/StandardJarScanner", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/juli/logging/Log", "isTraceEnabled", "()Z", true);
