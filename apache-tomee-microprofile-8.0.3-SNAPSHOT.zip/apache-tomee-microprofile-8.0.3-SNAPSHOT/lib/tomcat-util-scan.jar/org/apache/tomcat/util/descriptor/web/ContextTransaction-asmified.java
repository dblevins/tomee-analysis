...
public class ContextTransactionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/util/descriptor/web/ContextTransaction", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/descriptor/web/ContextTransaction", "properties", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/descriptor/web/ContextTransaction", "properties", "Ljava/util/Map;");
