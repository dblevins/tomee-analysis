...
methodVisitor.visitTryCatchBlock(label6, label7, label5, "jakarta/xml/soap/SOAPException");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/xml/soap/SOAPPart", "org/w3c/dom/Document"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/soap/SOAPMessage", "getSOAPPart", "()Ljakarta/xml/soap/SOAPPart;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/binding/soap/SoapMessage", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/binding/soap/saaj/SAAJInInterceptor", "adjustPrefixes", "(Ljakarta/xml/soap/SOAPEnvelope;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/xml/soap/SOAPEnvelope"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/binding/soap/saaj/SAAJInInterceptor", "applyEvents", "(Ljava/util/List;Ljakarta/xml/soap/SOAPElement;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/binding/soap/saaj/SAAJInInterceptor", "org/apache/cxf/binding/soap/SoapMessage", "java/lang/Boolean", "jakarta/xml/soap/SOAPMessage", "javax/xml/stream/XMLStreamReader", "jakarta/xml/soap/SOAPPart", "org/w3c/dom/Document", "java/util/Collection", "java/util/Iterator", "org/apache/cxf/message/Attachment"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/xml/soap/AttachmentPart", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/soap/AttachmentPart", "addMimeHeader", "(Ljava/lang/String;Ljava/lang/String;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/binding/soap/saaj/SAAJInInterceptor", "org/apache/cxf/binding/soap/SoapMessage", "java/lang/Boolean", "jakarta/xml/soap/SOAPMessage", "javax/xml/stream/XMLStreamReader", "jakarta/xml/soap/SOAPPart", "org/w3c/dom/Document", "java/util/Collection"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/binding/soap/saaj/SAAJStreamWriter", "<init>", "(Ljakarta/xml/soap/SOAPPart;Lorg/w3c/dom/Element;)V", false);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/binding/soap/saaj/SAAJInInterceptor", "org/apache/cxf/binding/soap/SoapMessage", "java/lang/Boolean", "jakarta/xml/soap/SOAPMessage", "javax/xml/stream/XMLStreamReader", "jakarta/xml/soap/SOAPPart", "org/w3c/dom/Document", "java/util/Collection", Opcodes.INTEGER}, 3, new Object[] {"javax/xml/stream/XMLStreamReader", "org/apache/cxf/binding/soap/saaj/SAAJStreamWriter", Opcodes.INTEGER});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/binding/soap/saaj/SAAJInInterceptor", "org/apache/cxf/binding/soap/SoapMessage", "java/lang/Boolean"}, 1, new Object[] {"jakarta/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "adjustPrefixes", "(Ljakarta/xml/soap/SOAPEnvelope;Ljava/lang/String;Ljava/lang/String;)V", null, new String[] { "jakarta/xml/soap/SOAPException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "applyEvents", "(Ljava/util/List;Ljakarta/xml/soap/SOAPElement;)V", "(Ljava/util/List<Ljavax/xml/stream/events/XMLEvent;>;Ljakarta/xml/soap/SOAPElement;)V", new String[] { "jakarta/xml/soap/SOAPException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "replaceHeaders", "(Ljakarta/xml/soap/SOAPMessage;Lorg/apache/cxf/binding/soap/SoapMessage;)V", null, new String[] { "jakarta/xml/soap/SOAPException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/xml/soap/SOAPHeader"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"jakarta/xml/soap/SOAPMessage", "org/apache/cxf/binding/soap/SoapMessage", "jakarta/xml/soap/SOAPHeader", "org/w3c/dom/Element", "org/apache/cxf/Bus", "org/apache/cxf/headers/HeaderProcessor", "java/lang/Object", "org/apache/cxf/databinding/DataBinding"}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"jakarta/xml/soap/SOAPMessage", "org/apache/cxf/binding/soap/SoapMessage", "jakarta/xml/soap/SOAPHeader", "org/w3c/dom/Element"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
