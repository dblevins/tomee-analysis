...
public class JsonbZonedDateTimeConverterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/jsonb/converter/JsonbZonedDateTimeConverter", "Lorg/apache/johnzon/jsonb/converter/JsonbDateConverterBase<Ljava/time/ZonedDateTime;>;", "org/apache/johnzon/jsonb/converter/JsonbDateConverterBase", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/converter/JsonbZonedDateTimeConverter", "formatter", "Ljava/time/format/DateTimeFormatter;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/johnzon/jsonb/converter/JsonbZonedDateTimeConverter", "UTC", "Ljava/time/ZoneId;");
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/time/ZonedDateTime"});
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jsonb/converter/JsonbZonedDateTimeConverter", "fromString", "(Ljava/lang/String;)Ljava/time/ZonedDateTime;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jsonb/converter/JsonbZonedDateTimeConverter", "toString", "(Ljava/time/ZonedDateTime;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/johnzon/jsonb/converter/JsonbZonedDateTimeConverter", "UTC", "Ljava/time/ZoneId;");
methodVisitor.visitInsn(RETURN);
