...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljakarta/ws/rs/ext/MessageBodyWriter<TT;>;Ljakarta/ws/rs/ext/MessageBodyReader<TT;>;Ljava/lang/AutoCloseable;", "java/lang/Object", new String[] { "jakarta/ws/rs/ext/MessageBodyWriter", "jakarta/ws/rs/ext/MessageBodyReader", "java/lang/AutoCloseable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "config", "Ljakarta/json/bind/JsonbConfig;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_VOLATILE, "delegate", "Ljava/util/function/Function;", "Ljava/util/function/Function<Ljava/lang/Class<*>;Ljakarta/json/bind/Jsonb;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "config", "Ljakarta/json/bind/JsonbConfig;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "config", "Ljakarta/json/bind/JsonbConfig;");
...
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/bind/JsonbConfig", "withStrictIJSON", "(Ljava/lang/Boolean;)Ljakarta/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "customized", "Z");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "config", "Ljakarta/json/bind/JsonbConfig;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/bind/JsonbConfig", "withEncoding", "(Ljava/lang/String;)Ljakarta/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "customized", "Z");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "config", "Ljakarta/json/bind/JsonbConfig;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/bind/JsonbConfig", "withPropertyNamingStrategy", "(Ljava/lang/String;)Ljakarta/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "customized", "Z");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "config", "Ljakarta/json/bind/JsonbConfig;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/bind/JsonbConfig", "withPropertyOrderStrategy", "(Ljava/lang/String;)Ljakarta/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "customized", "Z");
...
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/bind/JsonbConfig", "withNullValues", "(Ljava/lang/Boolean;)Ljakarta/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "customized", "Z");
...
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/json/bind/JsonbConfig", "withFormatting", "(Ljava/lang/Boolean;)Ljakarta/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "customized", "Z");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "readFrom", "(Ljava/lang/Class;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljakarta/ws/rs/core/MediaType;Ljakarta/ws/rs/core/MultivaluedMap;Ljava/io/InputStream;)Ljava/lang/Object;", "(Ljava/lang/Class<TT;>;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljakarta/ws/rs/core/MediaType;Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;Ljava/io/InputStream;)TT;", new String[] { "jakarta/ws/rs/WebApplicationException", "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "getJsonb", "(Ljava/lang/Class;)Ljakarta/json/bind/Jsonb;", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$ReadImpl", "doRead", "(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 8);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "writeTo", "(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljakarta/ws/rs/core/MediaType;Ljakarta/ws/rs/core/MultivaluedMap;Ljava/io/OutputStream;)V", "(TT;Ljava/lang/Class<*>;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;Ljakarta/ws/rs/core/MediaType;Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/Object;>;Ljava/io/OutputStream;)V", new String[] { "jakarta/ws/rs/WebApplicationException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "getJsonb", "(Ljava/lang/Class;)Ljakarta/json/bind/Jsonb;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/json/bind/Jsonb", "toJson", "(Ljava/lang/Object;Ljava/io/OutputStream;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 8);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createJsonb", "()Ljakarta/json/bind/Jsonb;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "config", "Ljakarta/json/bind/JsonbConfig;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/json/bind/JsonbBuilder", "create", "(Ljakarta/json/bind/JsonbConfig;)Ljakarta/json/bind/Jsonb;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getJsonb", "(Ljava/lang/Class;)Ljakarta/json/bind/Jsonb;", "(Ljava/lang/Class<*>;)Ljakarta/json/bind/Jsonb;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "providers", "Ljakarta/ws/rs/ext/Providers;");
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/json/bind/Jsonb;"));
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/ws/rs/ext/ContextResolver"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "throwNoContentExceptionOnEmptyStreams", "Ljava/lang/Boolean;");
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$DynamicInstance", "<init>", "(Ljakarta/ws/rs/ext/ContextResolver;Lorg/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "delegate", "Ljava/util/function/Function;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "createJsonb", "()Ljakarta/json/bind/Jsonb;", false);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$ProvidedInstance", "<init>", "(Ljakarta/json/bind/Jsonb;Lorg/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "delegate", "Ljava/util/function/Function;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInvokeDynamicInsn("doRead", "(Lorg/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider;)Lorg/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$ReadImpl;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "doReadWithNoContentException", "(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;", false), Type.getType("(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;")});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInvokeDynamicInsn("doRead", "(Lorg/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider;)Lorg/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider$ReadImpl;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "doRead", "(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;", false), Type.getType("(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doRead", "(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/json/bind/Jsonb", "fromJson", "(Ljava/io/InputStream;Ljava/lang/reflect/Type;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doReadWithNoContentException", "(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;", null, new String[] { "jakarta/ws/rs/core/NoContentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jaxrs/jsonb/jaxrs/JsonbJaxrsProvider", "doRead", "(Ljakarta/json/bind/Jsonb;Ljava/lang/reflect/Type;Ljava/io/InputStream;)Ljava/lang/Object;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/ws/rs/core/NoContentException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
