...
public class DateTimeZone$LazyInit$1Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/joda/time/DateTimeZone$LazyInit$1", null, "org/joda/time/chrono/BaseChronology", null);

classWriter.visitOuterClass("org/joda/time/DateTimeZone$LazyInit", "buildFormatter", "()Lorg/joda/time/format/DateTimeFormatter;");
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-3128740902654445468L));
