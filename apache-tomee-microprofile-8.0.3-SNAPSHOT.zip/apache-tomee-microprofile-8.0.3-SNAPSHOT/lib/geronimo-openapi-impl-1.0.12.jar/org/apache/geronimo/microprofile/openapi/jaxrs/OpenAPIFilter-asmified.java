...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", null, "java/lang/Object", new String[] { "jakarta/ws/rs/container/ContainerRequestFilter" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "defaultMediaType", "Ljakarta/ws/rs/core/MediaType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "defaultMediaType", "Ljakarta/ws/rs/core/MediaType;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/microprofile/openapi/cdi/GeronimoOpenAPIExtension", "getDefaultMediaType", "()Ljakarta/ws/rs/core/MediaType;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter"}, 2, new Object[] {"org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "jakarta/ws/rs/core/MediaType"});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "defaultMediaType", "Ljakarta/ws/rs/core/MediaType;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/container/ContainerRequestContext", "getRequest", "()Ljakarta/ws/rs/core/Request;", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/container/ContainerRequestContext", "getAcceptableMediaTypes", "()Ljava/util/List;", true);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "selectType", "(Ljava/util/List;)Ljakarta/ws/rs/core/MediaType;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "selectType", "(Ljava/util/List;)Ljakarta/ws/rs/core/MediaType;", "(Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;)Ljakarta/ws/rs/core/MediaType;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/ws/rs/core/MediaType", "APPLICATION_JSON_TYPE", "Ljakarta/ws/rs/core/MediaType;");
...
methodVisitor.visitInvokeDynamicInsn("test", "()Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "lambda$selectType$0", "(Ljakarta/ws/rs/core/MediaType;)Z", false), Type.getType("(Ljakarta/ws/rs/core/MediaType;)Z")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setApplication", "(Ljakarta/ws/rs/core/Application;)V", null, null);
{
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "extension", "Lorg/apache/geronimo/microprofile/openapi/cdi/GeronimoOpenAPIExtension;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/microprofile/openapi/cdi/GeronimoOpenAPIExtension", "getOrCreateOpenAPI", "(Ljakarta/ws/rs/core/Application;)Lorg/eclipse/microprofile/openapi/models/OpenAPI;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setDefaultMediaType", "(Ljakarta/ws/rs/core/MediaType;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "defaultMediaType", "Ljakarta/ws/rs/core/MediaType;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$selectType$1", "(Ljakarta/ws/rs/core/MediaType;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/microprofile/openapi/jaxrs/OpenAPIFilter", "providers", "Ljakarta/ws/rs/ext/Providers;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$selectType$0", "(Ljakarta/ws/rs/core/MediaType;)Z", null, null);
methodVisitor.visitCode();
