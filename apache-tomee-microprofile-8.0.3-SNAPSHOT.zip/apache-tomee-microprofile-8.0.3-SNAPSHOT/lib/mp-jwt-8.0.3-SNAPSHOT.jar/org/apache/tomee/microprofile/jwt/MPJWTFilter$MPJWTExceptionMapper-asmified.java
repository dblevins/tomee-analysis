...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/microprofile/jwt/MPJWTFilter$MPJWTExceptionMapper", "Ljava/lang/Object;Ljakarta/ws/rs/ext/ExceptionMapper<Lorg/apache/tomee/microprofile/jwt/MPJWTFilter$MPJWTException;>;", "java/lang/Object", new String[] { "jakarta/ws/rs/ext/ExceptionMapper" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "toResponse", "(Lorg/apache/tomee/microprofile/jwt/MPJWTFilter$MPJWTException;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomee/microprofile/jwt/MPJWTFilter$MPJWTExceptionMapper", "toResponse", "(Lorg/apache/tomee/microprofile/jwt/MPJWTFilter$MPJWTException;)Ljakarta/ws/rs/core/Response;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
