...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljavax/enterprise/inject/spi/Bean<TT;>;Ljavax/enterprise/inject/spi/PassivationCapable;", "java/lang/Object", new String[] { "javax/enterprise/inject/spi/Bean", "javax/enterprise/inject/spi/PassivationCapable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "bm", "Ljavax/enterprise/inject/spi/BeanManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "finest", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "bm", "Ljavax/enterprise/inject/spi/BeanManager;");
methodVisitor.visitTypeInsn(NEW, "org/apache/tomee/microprofile/jwt/cdi/ClaimInjectionPoint");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/cdi/ClaimInjectionPoint", "<init>", "(Ljavax/enterprise/inject/spi/Bean;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "javax/enterprise/context/spi/CreationalContext", "javax/enterprise/inject/spi/InjectionPoint", "javax/enterprise/inject/spi/Annotated", "org/eclipse/microprofile/jwt/Claim", "java/lang/String", "java/lang/reflect/ParameterizedType", "java/lang/reflect/Type", "java/lang/Class", "java/lang/reflect/Type"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "getClaimValue", "(Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLdcInsn("javax.json.Json");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "startsWith", "(Ljava/lang/String;)Z", false);
Label label21 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label21);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "toJson", "(Ljava/lang/String;)Ljavax/json/JsonValue;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "javax/enterprise/context/spi/CreationalContext", "javax/enterprise/inject/spi/InjectionPoint", "javax/enterprise/inject/spi/Annotated", "org/eclipse/microprofile/jwt/Claim", "java/lang/String", "java/lang/Class"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "logger", "Ljava/util/logging/Logger;");
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/enterprise/inject/spi/Bean", "java/security/Principal"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "toJson", "(Ljava/lang/String;)Ljavax/json/JsonValue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "getClaimValue", "(Ljava/lang/String;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "wrapValue", "(Ljava/lang/Object;)Ljavax/json/JsonValue;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLdcInsn("tmp");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/json/JsonObject", "getJsonString", "(Ljava/lang/String;)Ljavax/json/JsonString;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
Label label11 = new Label();
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/json/JsonArrayBuilder", "java/util/Collection", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "jsonb", "Ljavax/json/bind/Jsonb;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/jwt/cdi/ClaimBean", "jsonb", "Ljavax/json/bind/Jsonb;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/json/bind/Jsonb", "fromJson", "(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/json/JsonValue");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
