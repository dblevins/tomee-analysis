...
public class ValueEncoderFactory$IntArrayEncoderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntArrayEncoder", null, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$ArrayEncoder", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "_values", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntArrayEncoder", "_values", "[I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntArrayEncoder", "_ptr", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntArrayEncoder", "_end", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntArrayEncoder", "_values", "[I");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntArrayEncoder", "_ptr", "I");
