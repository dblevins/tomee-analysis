...
public class PolicyEngineBPDefinitionParser$PolicyEngineConfigDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/policy/blueprint/PolicyEngineBPDefinitionParser$PolicyEngineConfig", null, "org/apache/cxf/feature/AbstractFeature", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/policy/blueprint/PolicyEngineBPDefinitionParser$PolicyEngineConfig", "engine", "Lorg/apache/cxf/ws/policy/PolicyEngineImpl;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/policy/blueprint/PolicyEngineBPDefinitionParser$PolicyEngineConfig", "engine", "Lorg/apache/cxf/ws/policy/PolicyEngineImpl;");
