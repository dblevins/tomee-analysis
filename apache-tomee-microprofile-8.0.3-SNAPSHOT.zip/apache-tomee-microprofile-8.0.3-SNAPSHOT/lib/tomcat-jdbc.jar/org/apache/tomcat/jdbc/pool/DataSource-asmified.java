...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/jdbc/pool/DataSource", null, "org/apache/tomcat/jdbc/pool/DataSourceProxy", new String[] { "javax/sql/DataSource", "jakarta/management/MBeanRegistration", "org/apache/tomcat/jdbc/pool/jmx/ConnectionPoolMBean", "javax/sql/ConnectionPoolDataSource" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_VOLATILE, "oname", "Ljakarta/management/ObjectName;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/jdbc/pool/DataSourceProxy", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljakarta/management/ObjectName;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljakarta/management/ObjectName;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/DataSource", "unregisterJmx", "()V", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/DataSource", "isJmxEnabled", "()Z", false);
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/DataSource", "createObjectName", "(Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljakarta/management/ObjectName;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljakarta/management/ObjectName;");
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/DataSource", "registerJmx", "()V", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomcat/jdbc/pool/DataSource", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitLdcInsn("Unable to create object name for JDBC pool.");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createObjectName", "(Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", null, new String[] { "jakarta/management/MalformedObjectNameException" });
methodVisitor.visitCode();
...
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/String", "java/util/Hashtable", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "pool", "Lorg/apache/tomcat/jdbc/pool/ConnectionPool;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/jdbc/pool/DataSource", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitInsn(RETURN);
