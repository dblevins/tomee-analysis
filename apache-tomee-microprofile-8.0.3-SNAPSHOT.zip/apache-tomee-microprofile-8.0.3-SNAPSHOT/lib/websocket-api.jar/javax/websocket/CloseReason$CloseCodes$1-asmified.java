...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "javax/websocket/CloseReason$CloseCodes$1", null, "java/lang/Object", new String[] { "javax/websocket/CloseReason$CloseCode" });

classWriter.visitOuterClass("javax/websocket/CloseReason$CloseCodes", "getCloseCode", "(I)Ljavax/websocket/CloseReason$CloseCode;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/websocket/CloseReason$CloseCodes$1", "val$code", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/websocket/CloseReason$CloseCodes$1", "val$code", "I");
