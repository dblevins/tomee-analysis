...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/messaging/saaj/soap/SOAPDocumentImpl", null, "java/lang/Object", new String[] { "com/sun/xml/messaging/saaj/soap/SOAPDocument", "javax/xml/soap/Node", "org/w3c/dom/Document" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "SAAJ_NODE", "Ljava/lang/String;", null, "javax.xml.soap.Node");
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/xml/soap/Node");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn("javax.xml.soap.Node");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/xml/messaging/saaj/soap/impl/ElementFactory", "createElement", "(Lcom/sun/xml/messaging/saaj/soap/SOAPDocumentImpl;Lorg/w3c/dom/Element;)Ljavax/xml/soap/SOAPElement;", false);
methodVisitor.visitInsn(POP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "register", "(Ljavax/xml/soap/Node;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/messaging/saaj/soap/SOAPDocumentImpl", "getDomNode", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "find", "(Lorg/w3c/dom/Node;)Ljavax/xml/soap/Node;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/xml/messaging/saaj/soap/SOAPDocumentImpl", "find", "(Lorg/w3c/dom/Node;Z)Ljavax/xml/soap/Node;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "find", "(Lorg/w3c/dom/Node;Z)Ljavax/xml/soap/Node;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
