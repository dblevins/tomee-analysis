...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/messaging/saaj/soap/StringDataContentHandler", null, "java/lang/Object", new String[] { "javax/activation/DataContentHandler" });
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "myDF", "Ljavax/activation/ActivationDataFlavor;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "getDF", "()Ljavax/activation/ActivationDataFlavor;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "getContent", "(Ljavax/activation/DataSource;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "javax/activation/DataSource", "java/lang/String", "java/io/InputStreamReader"}, 1, new Object[] {"java/lang/IllegalArgumentException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "javax/activation/DataSource", "java/lang/String", "java/io/InputStreamReader", Opcodes.INTEGER, Opcodes.INTEGER, "[C", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 7);
methodVisitor.visitLdcInsn(new Integer(262144));
methodVisitor.visitInsn(IADD);
methodVisitor.visitVarInsn(ISTORE, 7);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "javax/activation/DataSource", "java/lang/String", "java/io/InputStreamReader", Opcodes.INTEGER, Opcodes.INTEGER, "[C", "java/lang/Object"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "javax/activation/DataSource", "java/lang/String", "java/io/InputStreamReader"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "javax/activation/DataSource", "java/lang/String", "java/io/InputStreamReader", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/xml/messaging/saaj/soap/StringDataContentHandler", "myDF", "Ljavax/activation/ActivationDataFlavor;");
methodVisitor.visitInsn(RETURN);
