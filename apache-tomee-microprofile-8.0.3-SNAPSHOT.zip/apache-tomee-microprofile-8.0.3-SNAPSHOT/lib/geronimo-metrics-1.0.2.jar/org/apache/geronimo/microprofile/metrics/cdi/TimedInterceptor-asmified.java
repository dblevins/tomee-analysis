...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/microprofile/metrics/cdi/TimedInterceptor", "beanManager", "Ljavax/enterprise/inject/spi/BeanManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/microprofile/metrics/cdi/TimedInterceptor", "bean", "Ljavax/enterprise/inject/spi/Bean;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/eclipse/microprofile/metrics/Timer", "javax/enterprise/inject/spi/AnnotatedType", "org/eclipse/microprofile/metrics/annotation/Timed"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Executable", "getDeclaringClass", "()Ljava/lang/Class;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$findTimer$1", "(Ljavax/enterprise/inject/spi/AnnotatedCallable;)Lorg/eclipse/microprofile/metrics/annotation/Timed;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/eclipse/microprofile/metrics/annotation/Timed;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$findTimer$0", "(Ljava/lang/reflect/Executable;Ljavax/enterprise/inject/spi/AnnotatedCallable;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
