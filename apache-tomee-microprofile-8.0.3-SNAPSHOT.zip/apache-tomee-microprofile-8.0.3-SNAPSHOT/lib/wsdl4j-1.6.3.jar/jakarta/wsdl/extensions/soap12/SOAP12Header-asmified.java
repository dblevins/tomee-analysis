...
public class SOAP12HeaderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/wsdl/extensions/soap12/SOAP12Header", null, "java/lang/Object", new String[] { "jakarta/wsdl/extensions/ExtensibilityElement", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setEncodingStyle", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addSOAP12HeaderFault", "(Ljakarta/wsdl/extensions/soap12/SOAP12HeaderFault;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getSOAP12HeaderFaults", "()Ljava/util/List;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removeSOAP12HeaderFault", "(Ljakarta/wsdl/extensions/soap12/SOAP12HeaderFault;)Ljakarta/wsdl/extensions/soap12/SOAP12HeaderFault;", null, null);
methodVisitor.visitEnd();
}
