...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/wsdl/Message", null, "java/lang/Object", new String[] { "javax/wsdl/WSDLElement" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addPart", "(Ljavax/wsdl/Part;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getPart", "(Ljava/lang/String;)Ljavax/wsdl/Part;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removePart", "(Ljava/lang/String;)Ljavax/wsdl/Part;", null, null);
methodVisitor.visitEnd();
}
{
