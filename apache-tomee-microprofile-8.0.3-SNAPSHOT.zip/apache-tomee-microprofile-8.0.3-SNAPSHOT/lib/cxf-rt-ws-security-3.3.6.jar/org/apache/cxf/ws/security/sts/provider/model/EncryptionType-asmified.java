...
public class EncryptionTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/EncryptionType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "EncryptionType");
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/EncryptionType", "any", "Ljava/lang/Object;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/EncryptionType", "any", "Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
