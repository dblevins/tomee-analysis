...
public class SecurityHeaderTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/secext/SecurityHeaderType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "SecurityHeaderType");
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/SecurityHeaderType", "otherAttributes", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/SecurityHeaderType", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/SecurityHeaderType", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/SecurityHeaderType", "otherAttributes", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
