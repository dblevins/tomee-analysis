...
public class RequestSecurityTokenTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "RequestSecurityTokenType");
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", "otherAttributes", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", "context", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", "context", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenType", "otherAttributes", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
