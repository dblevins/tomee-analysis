...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/SecurityTokenServiceProvider", "Ljava/lang/Object;Ljakarta/xml/ws/Provider<Ljavax/xml/transform/Source;>;", "java/lang/Object", new String[] { "jakarta/xml/ws/Provider" });

{
annotationVisitor0 = classWriter.visitAnnotation("Ljakarta/xml/ws/ServiceMode;", true);
annotationVisitor0.visitEnum("value", "Ljakarta/xml/ws/Service$Mode;", "PAYLOAD");
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "jaxbContext", "Ljakarta/xml/bind/JAXBContext;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/SecurityTokenServiceProvider", "jaxbContext", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/SecurityTokenServiceProvider", "context", "Ljakarta/xml/ws/WebServiceContext;");
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitTypeInsn(NEW, "jakarta/xml/bind/util/JAXBSource");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/SecurityTokenServiceProvider", "jaxbContext", "Ljakarta/xml/bind/JAXBContext;");
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/security/sts/provider/model/ObjectFactory", "createRequestSecurityTokenResponseCollection", "(Lorg/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenResponseCollectionType;)Ljakarta/xml/bind/JAXBElement;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/xml/bind/util/JAXBSource", "<init>", "(Ljakarta/xml/bind/JAXBContext;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/security/sts/provider/model/ObjectFactory", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/security/sts/provider/model/ObjectFactory", "createRequestSecurityTokenResponse", "(Lorg/apache/cxf/ws/security/sts/provider/model/RequestSecurityTokenResponseType;)Ljakarta/xml/bind/JAXBElement;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/xml/bind/util/JAXBSource", "<init>", "(Ljakarta/xml/bind/JAXBContext;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,3, null, 0, null);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/xml/ws/handler/MessageContext", "org/apache/cxf/binding/soap/SoapVersion"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/binding/soap/SoapFault");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/SecurityTokenServiceProvider", "jaxbContext", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/JAXBContext", "createBinder", "()Ljakarta/xml/bind/Binder;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/Binder", "unmarshal", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/bind/JAXBElement");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/ws/security/sts/provider/SecurityTokenServiceProvider", "walkDom", "(Ljava/lang/String;Lorg/w3c/dom/Element;Ljakarta/xml/bind/Binder;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/JAXBElement", "getValue", "()Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "walkDom", "(Ljava/lang/String;Lorg/w3c/dom/Element;Ljakarta/xml/bind/Binder;Ljava/lang/Object;)V", "(Ljava/lang/String;Lorg/w3c/dom/Element;Ljakarta/xml/bind/Binder<Lorg/w3c/dom/Node;>;Ljava/lang/Object;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/Binder", "getJAXBNode", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/xml/bind/JAXBElement");
Label label5 = new Label();
