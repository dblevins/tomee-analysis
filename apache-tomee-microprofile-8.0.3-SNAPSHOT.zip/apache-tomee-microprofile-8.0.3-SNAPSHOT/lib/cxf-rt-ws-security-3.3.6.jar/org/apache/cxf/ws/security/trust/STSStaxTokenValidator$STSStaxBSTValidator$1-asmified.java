...
public class STSStaxTokenValidator$STSStaxBSTValidator$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", null, "org/apache/wss4j/stax/impl/securityToken/X509V3SecurityTokenImpl", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "this$0", "Lorg/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 8);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$stsValidated", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$binarySecurityTokenType", "Lorg/apache/wss4j/binding/wss10/BinarySecurityTokenType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$bytes", "[B");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$message", "Lorg/apache/cxf/binding/soap/SoapMessage;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$stsValidated", "Z");
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/stax/impl/securityToken/X509V3SecurityTokenImpl", "verify", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "this$0", "Lorg/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$binarySecurityTokenType", "Lorg/apache/wss4j/binding/wss10/BinarySecurityTokenType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$bytes", "[B");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$1", "val$message", "Lorg/apache/cxf/binding/soap/SoapMessage;");
