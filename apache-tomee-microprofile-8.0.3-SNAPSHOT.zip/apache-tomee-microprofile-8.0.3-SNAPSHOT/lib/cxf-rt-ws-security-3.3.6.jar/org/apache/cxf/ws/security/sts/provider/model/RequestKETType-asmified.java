...
public class RequestKETTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/RequestKETType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "RequestKETType");
annotationVisitor0.visitEnd();
}
{
