...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/secext/BinarySecurityTokenType", null, "org/apache/cxf/ws/security/sts/provider/model/secext/EncodedString", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/BinarySecurityTokenType", "valueType", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/secext/BinarySecurityTokenType", "valueType", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
