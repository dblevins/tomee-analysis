...
public class UnsetPropertiesRecipeDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/recipe/UnsetPropertiesRecipe", null, "org/apache/xbean/recipe/AbstractRecipe", null);
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/xbean/recipe/RecipeHelper", "getCaller", "()Lorg/apache/xbean/recipe/Recipe;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/xbean/recipe/ObjectRecipe");
...
methodVisitor.visitLdcInsn("UnsetPropertiesRecipe can only be nested in an ObjectRecipe: outerRecipe=");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xbean/recipe/UnsetPropertiesRecipe", "getName", "()Ljava/lang/String;", false);
