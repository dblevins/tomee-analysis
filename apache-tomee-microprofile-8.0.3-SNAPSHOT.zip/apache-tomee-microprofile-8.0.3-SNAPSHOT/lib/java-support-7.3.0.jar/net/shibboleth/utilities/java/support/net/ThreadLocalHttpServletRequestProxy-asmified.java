...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "net/shibboleth/utilities/java/support/net/ThreadLocalHttpServletRequestProxy", null, "java/lang/Object", new String[] { "javax/servlet/http/HttpServletRequest" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "net/shibboleth/utilities/java/support/net/ThreadLocalHttpServletRequestProxy", "getCurrent", "()Ljavax/servlet/http/HttpServletRequest;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getCurrent", "()Ljavax/servlet/http/HttpServletRequest;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/net/HttpServletRequestResponseContext", "getRequest", "()Ljavax/servlet/http/HttpServletRequest;", false);
