...
public class KeyNotFoundExceptionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "net/shibboleth/utilities/java/support/security/KeyNotFoundException", null, "java/security/KeyException", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(310860860022348748L));
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/security/KeyException", "<init>", "()V", false);
