...
public class CookieBufferingFilter$CookieBufferingHttpServletResponseProxyDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lnet/shibboleth/utilities/java/support/net/CookieBufferingFilter;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "net/shibboleth/utilities/java/support/net/CookieBufferingFilter$CookieBufferingHttpServletResponseProxy", "cookieMap", "Ljava/util/Map;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "dumpCookies", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "net/shibboleth/utilities/java/support/net/CookieBufferingFilter$CookieBufferingHttpServletResponseProxy", "cookieMap", "Ljava/util/Map;");
