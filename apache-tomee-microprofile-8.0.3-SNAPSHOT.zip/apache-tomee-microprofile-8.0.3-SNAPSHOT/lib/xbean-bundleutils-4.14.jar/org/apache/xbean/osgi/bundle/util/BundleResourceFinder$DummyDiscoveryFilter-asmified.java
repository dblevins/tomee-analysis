...
public class BundleResourceFinder$DummyDiscoveryFilterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/osgi/bundle/util/BundleResourceFinder$DummyDiscoveryFilter", null, "java/lang/Object", new String[] { "org/apache/xbean/osgi/bundle/util/ResourceDiscoveryFilter" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "zipFileDiscoveryRequired", "(Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 2);
