...
public class ObserverManager$AfterInvocationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/observer/ObserverManager$AfterInvocation", null, "org/apache/openejb/observer/ObserverManager$MethodInvocation", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/observer/ObserverManager$AfterInvocation", "this$0", "Lorg/apache/openejb/observer/ObserverManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/observer/ObserverManager$AfterInvocation$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/observer/ObserverManager$AfterInvocation$1", "<init>", "(Lorg/apache/openejb/observer/ObserverManager$AfterInvocation;Ljava/lang/Object;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/observer/ObserverManager$AfterInvocation", "<init>", "(Lorg/apache/openejb/observer/ObserverManager;Ljava/lang/reflect/Method;Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
