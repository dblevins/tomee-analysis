...
public class FastDatePrinter$TwelveHourFieldDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/apache/commons/lang3/time/FastDatePrinter$TwelveHourField", null, "java/lang/Object", new String[] { "org/apache/commons/lang3/time/FastDatePrinter$NumberRule" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/lang3/time/FastDatePrinter$TwelveHourField", "mRule", "Lorg/apache/commons/lang3/time/FastDatePrinter$NumberRule;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/time/FastDatePrinter$TwelveHourField", "mRule", "Lorg/apache/commons/lang3/time/FastDatePrinter$NumberRule;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitIntInsn(BIPUSH, 10);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Calendar", "getLeastMaximum", "(I)I", false);
