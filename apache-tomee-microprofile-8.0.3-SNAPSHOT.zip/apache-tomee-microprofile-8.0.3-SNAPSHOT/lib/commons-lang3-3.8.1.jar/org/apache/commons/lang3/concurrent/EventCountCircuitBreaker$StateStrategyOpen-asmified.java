...
public class EventCountCircuitBreaker$StateStrategyOpenDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/apache/commons/lang3/concurrent/EventCountCircuitBreaker$StateStrategyOpen", null, "org/apache/commons/lang3/concurrent/EventCountCircuitBreaker$StateStrategy", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/lang3/concurrent/EventCountCircuitBreaker", "getClosingThreshold", "()I", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/lang3/concurrent/EventCountCircuitBreaker", "getClosingInterval", "()J", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/lang3/concurrent/EventCountCircuitBreaker$StateStrategyOpen", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
