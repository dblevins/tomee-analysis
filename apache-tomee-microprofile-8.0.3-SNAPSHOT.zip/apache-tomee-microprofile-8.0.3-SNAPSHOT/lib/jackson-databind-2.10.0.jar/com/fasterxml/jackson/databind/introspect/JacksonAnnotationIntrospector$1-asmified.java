...
public class JacksonAnnotationIntrospector$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "com/fasterxml/jackson/databind/introspect/JacksonAnnotationIntrospector$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/fasterxml/jackson/databind/introspect/JacksonAnnotationIntrospector", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/fasterxml/jackson/databind/annotation/JsonSerialize$Inclusion", "values", "()[Lcom/fasterxml/jackson/databind/annotation/JsonSerialize$Inclusion;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/introspect/JacksonAnnotationIntrospector$1", "$SwitchMap$com$fasterxml$jackson$databind$annotation$JsonSerialize$Inclusion", "[I");
