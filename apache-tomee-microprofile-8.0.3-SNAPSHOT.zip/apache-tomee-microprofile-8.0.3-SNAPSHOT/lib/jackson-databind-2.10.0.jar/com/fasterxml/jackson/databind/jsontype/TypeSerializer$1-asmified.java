...
public class TypeSerializer$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "com/fasterxml/jackson/databind/jsontype/TypeSerializer$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/fasterxml/jackson/databind/jsontype/TypeSerializer", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/fasterxml/jackson/annotation/JsonTypeInfo$As", "values", "()[Lcom/fasterxml/jackson/annotation/JsonTypeInfo$As;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/jsontype/TypeSerializer$1", "$SwitchMap$com$fasterxml$jackson$annotation$JsonTypeInfo$As", "[I");
