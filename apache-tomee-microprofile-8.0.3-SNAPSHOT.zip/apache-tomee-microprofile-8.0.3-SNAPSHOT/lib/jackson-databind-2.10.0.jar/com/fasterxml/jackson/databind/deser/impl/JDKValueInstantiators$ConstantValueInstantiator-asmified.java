...
public class JDKValueInstantiators$ConstantValueInstantiatorDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$ConstantValueInstantiator", null, "com/fasterxml/jackson/databind/deser/ValueInstantiator$Base", new String[] { "java/io/Serializable" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$ConstantValueInstantiator", "_value", "Ljava/lang/Object;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$ConstantValueInstantiator", "_value", "Ljava/lang/Object;");
