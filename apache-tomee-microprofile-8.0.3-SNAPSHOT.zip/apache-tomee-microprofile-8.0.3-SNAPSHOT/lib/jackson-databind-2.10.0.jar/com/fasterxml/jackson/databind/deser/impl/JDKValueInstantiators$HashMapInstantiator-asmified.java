...
public class JDKValueInstantiators$HashMapInstantiatorDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$HashMapInstantiator", null, "com/fasterxml/jackson/databind/deser/ValueInstantiator$Base", new String[] { "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "INSTANCE", "Lcom/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$HashMapInstantiator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$HashMapInstantiator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$HashMapInstantiator", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$HashMapInstantiator", "INSTANCE", "Lcom/fasterxml/jackson/databind/deser/impl/JDKValueInstantiators$HashMapInstantiator;");
methodVisitor.visitInsn(RETURN);
