...
public class NumberSerializers$IntLikeSerializerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer", "Lcom/fasterxml/jackson/databind/ser/std/NumberSerializers$Base<Ljava/lang/Object;>;", "com/fasterxml/jackson/databind/ser/std/NumberSerializers$Base", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "instance", "Lcom/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer", "instance", "Lcom/fasterxml/jackson/databind/ser/std/NumberSerializers$IntLikeSerializer;");
methodVisitor.visitInsn(RETURN);
