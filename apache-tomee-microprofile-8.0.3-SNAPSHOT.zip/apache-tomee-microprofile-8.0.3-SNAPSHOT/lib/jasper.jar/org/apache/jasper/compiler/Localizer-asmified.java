...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/compiler/Localizer", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "bundle", "Ljava/util/ResourceBundle;", null, null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/jasper/compiler/Localizer", "bundle", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn("org.apache.jasper.resources.LocalStrings");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/jasper/compiler/Localizer", "bundle", "Ljava/util/ResourceBundle;");
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
