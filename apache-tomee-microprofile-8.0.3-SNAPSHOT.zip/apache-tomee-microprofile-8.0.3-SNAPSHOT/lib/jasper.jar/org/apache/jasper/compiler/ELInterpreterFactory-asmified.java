...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getELInterpreter", "(Ljavax/servlet/ServletContext;)Lorg/apache/jasper/compiler/ELInterpreter;", null, new String[] { "java/lang/Exception" });
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/jasper/compiler/ELInterpreterFactory", "createInstance", "(Ljavax/servlet/ServletContext;Ljava/lang/String;)Lorg/apache/jasper/compiler/ELInterpreter;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createInstance", "(Ljavax/servlet/ServletContext;Ljava/lang/String;)Lorg/apache/jasper/compiler/ELInterpreter;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
