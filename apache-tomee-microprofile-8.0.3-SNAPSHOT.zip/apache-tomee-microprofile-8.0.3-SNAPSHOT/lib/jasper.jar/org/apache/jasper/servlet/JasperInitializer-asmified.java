...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/servlet/JasperInitializer", null, "java/lang/Object", new String[] { "javax/servlet/ServletContainerInitializer" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/servlet/JasperInitializer", "newTldScanner", "(Ljavax/servlet/ServletContext;ZZZ)Lorg/apache/jasper/servlet/TldScanner;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/jasper/servlet/JasperInitializer", "java/util/Set", "javax/servlet/ServletContext", Opcodes.INTEGER, "java/lang/String", Opcodes.INTEGER, "org/apache/jasper/servlet/TldScanner"}, 1, new Object[] {"java/lang/Exception"});
