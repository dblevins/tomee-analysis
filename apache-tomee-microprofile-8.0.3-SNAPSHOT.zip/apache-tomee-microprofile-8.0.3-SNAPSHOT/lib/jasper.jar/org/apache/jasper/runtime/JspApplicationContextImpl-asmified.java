...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/runtime/JspApplicationContextImpl", null, "java/lang/Object", new String[] { "jakarta/servlet/jsp/JspApplicationContext" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "contextListeners", "Ljava/util/List;", "Ljava/util/List<Ljakarta/el/ELContextListener;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "resolvers", "Ljava/util/List;", "Ljava/util/List<Ljakarta/el/ELResolver;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "resolver", "Ljakarta/el/ELResolver;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspApplicationContextImpl", "expressionFactory", "Ljakarta/el/ExpressionFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljakarta/servlet/ServletContext;)Lorg/apache/jasper/runtime/JspApplicationContextImpl;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createELContext", "(Ljakarta/servlet/jsp/JspContext;)Lorg/apache/jasper/el/ELContextImpl;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/runtime/JspApplicationContextImpl", "createELResolver", "()Ljakarta/el/ELResolver;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/runtime/JspApplicationContextImpl$1", "<init>", "(Lorg/apache/jasper/runtime/JspApplicationContextImpl;Ljakarta/el/ELResolver;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/runtime/JspApplicationContextImpl", "fireListeners", "(Ljakarta/el/ELContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "fireListeners", "(Ljakarta/el/ELContext;)V", null, null);
methodVisitor.visitCode();
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/el/ELContextEvent", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/el/ELContextListener");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createELResolver", "()Ljakarta/el/ELResolver;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspApplicationContextImpl", "instantiated", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspApplicationContextImpl", "resolver", "Ljakarta/el/ELResolver;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspApplicationContextImpl", "expressionFactory", "Ljakarta/el/ExpressionFactory;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jasper/el/JasperELResolver", "<init>", "(Ljava/util/List;Ljakarta/el/ELResolver;)V", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/runtime/JspApplicationContextImpl", "resolver", "Ljakarta/el/ELResolver;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/runtime/JspApplicationContextImpl", "resolver", "Ljakarta/el/ELResolver;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addELResolver", "(Ljakarta/el/ELResolver;)V", null, new String[] { "java/lang/IllegalStateException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
