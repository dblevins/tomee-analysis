package asm.org.apache.jasper.security;
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/jasper/security/SecurityUtil", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/jasper/security/SecurityUtil", "packageDefinitionEnabled", "Z");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/jasper/security/SecurityUtil", "packageDefinitionEnabled", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 0);
methodVisitor.visitEnd();
}
