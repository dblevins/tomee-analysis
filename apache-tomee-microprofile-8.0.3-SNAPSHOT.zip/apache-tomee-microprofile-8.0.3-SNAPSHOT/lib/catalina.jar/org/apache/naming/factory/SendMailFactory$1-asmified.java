...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/naming/factory/SendMailFactory$1", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljakarta/mail/internet/MimePartDataSource;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "run", "()Ljakarta/mail/internet/MimePartDataSource;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/mail/Session", "getInstance", "(Ljava/util/Properties;)Ljakarta/mail/Session;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/naming/factory/SendMailFactory$1", "java/util/Properties", "java/util/Enumeration", Opcodes.TOP, "jakarta/mail/internet/MimeMessage", "javax/naming/RefAddr", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/mail/internet/InternetAddress", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/mail/internet/MimeMessage", "setFrom", "(Ljakarta/mail/internet/InternetAddress;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/naming/factory/SendMailFactory$1", "java/util/Properties", "java/util/Enumeration", Opcodes.TOP, "jakarta/mail/internet/MimeMessage"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/naming/factory/SendMailFactory$1", "run", "()Ljakarta/mail/internet/MimePartDataSource;", false);
methodVisitor.visitInsn(ARETURN);
