...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/servlets/DefaultServlet", null, "javax/servlet/http/HttpServlet", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "getServletConfig", "()Ljavax/servlet/ServletConfig;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "getServletContext", "()Ljavax/servlet/ServletContext;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getRelativePath", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "getRelativePath", "(Ljavax/servlet/http/HttpServletRequest;Z)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getRelativePath", "(Ljavax/servlet/http/HttpServletRequest;Z)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getPathPrefix", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "doGet", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doGet", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/servlets/DefaultServlet", "fileEncoding", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "serveResource", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;ZLjava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(5, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doHead", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "determineMethodsAllowed", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "determineMethodsAllowed", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "sendNotAllowed", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn("Allow");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doPost", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "sendNotAllowed", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "getRelativePath", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/servlets/DefaultServlet", "resources", "Lorg/apache/catalina/WebResourceRoot;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "parseContentRange", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)Lorg/apache/catalina/servlets/DefaultServlet$Range;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
Label label11 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "executePartialPut", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/catalina/servlets/DefaultServlet$Range;Ljava/lang/String;)Ljava/io/File;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/String", "org/apache/catalina/WebResource", "org/apache/catalina/servlets/DefaultServlet$Range", "java/io/InputStream", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitLabel(label17);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "executePartialPut", "(Ljavax/servlet/http/HttpServletRequest;Lorg/apache/catalina/servlets/DefaultServlet$Range;Ljava/lang/String;)Ljava/io/File;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource", "java/io/BufferedInputStream", "java/lang/Throwable", Opcodes.TOP, "[B"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource", "java/io/BufferedInputStream", "java/lang/Throwable", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource", Opcodes.TOP, "[B", "java/io/BufferedInputStream", "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/BufferedInputStream", "read", "([B)I", false);
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource", Opcodes.INTEGER, "[B", "java/io/BufferedInputStream", "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
...
methodVisitor.visitJumpInsn(GOTO, label26);
methodVisitor.visitLabel(label16);
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource", Opcodes.TOP, "[B", "java/io/BufferedInputStream", "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 14);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", "org/apache/catalina/WebResource", Opcodes.TOP, "[B", "java/io/BufferedInputStream", "java/lang/Throwable", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 19, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File", "java/io/RandomAccessFile", "java/lang/Throwable", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/servlets/DefaultServlet$Range", "java/lang/String", "java/io/File", "java/lang/String", "java/io/File"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkIfHeaders", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "checkIfMatch", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "checkIfModifiedSince", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "checkIfNoneMatch", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "checkIfUnmodifiedSince", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitInsn(ICONST_1);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "serveResource", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;ZLjava/lang/String;)V", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/servlets/DefaultServlet", "doDirectoryRedirect", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "checkIfHeaders", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label27);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label27);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/servlets/DefaultServlet", "getBestPrecompressedResource", "(Ljavax/servlet/http/HttpServletRequest;Ljava/util/List;)Lorg/apache/catalina/servlets/DefaultServlet$PrecompressedResource;", false);
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitVarInsn(ALOAD, 15);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "parseRange", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Ljava/util/ArrayList;", false);
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitVarInsn(ALOAD, 14);
Label label39 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label40);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", Opcodes.INTEGER, "java/lang/String", Opcodes.INTEGER, "java/lang/String", "org/apache/catalina/WebResource", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/String", "java/lang/String", "java/lang/String", Opcodes.INTEGER, "java/util/ArrayList", Opcodes.LONG, "javax/servlet/ServletOutputStream", "java/io/PrintWriter"}, 1, new Object[] {"java/lang/IllegalStateException"});
methodVisitor.visitVarInsn(ASTORE, 19);
...
Label label42 = new Label();
methodVisitor.visitLabel(label42);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/servlet/ServletResponse", Opcodes.LONG}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 19);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 24, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", Opcodes.INTEGER, "java/lang/String", Opcodes.INTEGER, "java/lang/String", "org/apache/catalina/WebResource", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/String", "java/lang/String", "java/lang/String", Opcodes.INTEGER, "java/util/ArrayList", Opcodes.LONG, "javax/servlet/ServletOutputStream", "java/io/PrintWriter", "javax/servlet/ServletResponse", Opcodes.LONG, "java/lang/String", "java/nio/charset/Charset", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/WebResource", "isDirectory", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "getPathPrefix", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "render", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljava/lang/String;)Ljava/io/InputStream;", false);
methodVisitor.visitVarInsn(ASTORE, 26);
...
methodVisitor.visitVarInsn(LLOAD, 15);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "checkSendfile", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;JLorg/apache/catalina/servlets/DefaultServlet$Range;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 26);
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "copy", "(Ljava/io/InputStream;Ljavax/servlet/ServletOutputStream;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitVarInsn(ALOAD, 26);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "copy", "(Lorg/apache/catalina/WebResource;Ljavax/servlet/ServletOutputStream;Lorg/apache/catalina/servlets/DefaultServlet$Range;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "copy", "(Lorg/apache/catalina/WebResource;Ljavax/servlet/ServletOutputStream;Ljava/util/Iterator;Ljava/lang/String;)V", false);
methodVisitor.visitJumpInsn(GOTO, label57);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getBestPrecompressedResource", "(Ljavax/servlet/http/HttpServletRequest;Ljava/util/List;)Lorg/apache/catalina/servlets/DefaultServlet$PrecompressedResource;", "(Ljavax/servlet/http/HttpServletRequest;Ljava/util/List<Lorg/apache/catalina/servlets/DefaultServlet$PrecompressedResource;>;)Lorg/apache/catalina/servlets/DefaultServlet$PrecompressedResource;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("Accept-Encoding");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/util/List", "java/util/Enumeration", "org/apache/catalina/servlets/DefaultServlet$PrecompressedResource", Opcodes.DOUBLE, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/util/List", "java/util/Enumeration", "org/apache/catalina/servlets/DefaultServlet$PrecompressedResource", Opcodes.DOUBLE, Opcodes.INTEGER, "java/lang/String", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/util/List", "java/util/Enumeration", "org/apache/catalina/servlets/DefaultServlet$PrecompressedResource", Opcodes.DOUBLE, Opcodes.INTEGER, "java/lang/String", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/String", Opcodes.DOUBLE, Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ILOAD, 16);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IADD);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doDirectoryRedirect", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "parseContentRange", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)Lorg/apache/catalina/servlets/DefaultServlet$Range;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("Content-Range");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "parseRange", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Ljava/util/ArrayList;", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Ljava/util/ArrayList<Lorg/apache/catalina/servlets/DefaultServlet$Range;>;", new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "org/apache/catalina/WebResource", "java/lang/String", Opcodes.LONG}, 1, new Object[] {"java/lang/IllegalArgumentException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_DEPRECATED, "render", "(Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljava/lang/String;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "render", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljava/lang/String;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "renderHtml", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljava/lang/String;)Ljava/io/InputStream;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "renderXml", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljavax/xml/transform/Source;Ljava/lang/String;)Ljava/io/InputStream;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(6, 6);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_DEPRECATED, "renderXml", "(Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljavax/xml/transform/Source;Ljava/lang/String;)Ljava/io/InputStream;", null, new String[] { "javax/servlet/ServletException", "java/io/IOException" });
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
annotationVisitor0.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "renderXml", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljavax/xml/transform/Source;Ljava/lang/String;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException", "javax/servlet/ServletException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder"}, 1, new Object[] {"java/lang/StringBuilder"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder"}, 2, new Object[] {"java/lang/StringBuilder", Opcodes.INTEGER});
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder", "[Ljava/lang/String;", "java/lang/String", "java/lang/String", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 12);
methodVisitor.visitVarInsn(ILOAD, 11);
Label label8 = new Label();
...
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder", "[Ljava/lang/String;", "java/lang/String", "java/lang/String", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/String", "org/apache/catalina/WebResource"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitLdcInsn("'");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitJumpInsn(GOTO, label24);
methodVisitor.visitLabel(label23);
methodVisitor.visitFrame(Opcodes.F_FULL, 19, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder", "[Ljava/lang/String;", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/ClassLoader", "javax/xml/transform/TransformerFactory", "javax/xml/transform/Source", "javax/xml/transform/Transformer", "java/io/ByteArrayOutputStream", "java/io/OutputStreamWriter", "javax/xml/transform/stream/StreamResult", "java/io/InputStream"}, 0, new Object[] {});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Thread", "currentThread", "()Ljava/lang/Thread;", false);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Thread", "setContextClassLoader", "(Ljava/lang/ClassLoader;)V", false);
methodVisitor.visitLabel(label24);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder", "[Ljava/lang/String;", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/ClassLoader"}, 1, new Object[] {"javax/xml/transform/TransformerException"});
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitTypeInsn(NEW, "javax/servlet/ServletException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/servlets/DefaultServlet", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
methodVisitor.visitJumpInsn(GOTO, label26);
methodVisitor.visitLabel(label25);
methodVisitor.visitFrame(Opcodes.F_FULL, 21, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "javax/xml/transform/Source", "java/lang/String", "java/lang/StringBuilder", "[Ljava/lang/String;", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/ClassLoader", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Thread", "currentThread", "()Ljava/lang/Thread;", false);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Thread", "setContextClassLoader", "(Ljava/lang/ClassLoader;)V", false);
methodVisitor.visitLabel(label26);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "renderHtml", "(Ljavax/servlet/http/HttpServletRequest;Ljava/lang/String;Lorg/apache/catalina/WebResource;Ljava/lang/String;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/io/ByteArrayOutputStream");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/io/ByteArrayOutputStream", "<init>", "()V", false);
...
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "java/lang/String", "java/io/ByteArrayOutputStream", "java/io/OutputStreamWriter", "java/io/PrintWriter", "java/lang/StringBuilder", "java/lang/String", "[Lorg/apache/catalina/WebResource;", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitIntInsn(BIPUSH, 47);
...
Label label13 = new Label();
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 19, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "java/lang/String", "org/apache/catalina/WebResource", "java/lang/String", "java/io/ByteArrayOutputStream", "java/io/OutputStreamWriter", "java/io/PrintWriter", "java/lang/StringBuilder", "java/lang/String", "[Lorg/apache/catalina/WebResource;", "java/lang/String", "java/lang/String", Opcodes.INTEGER, "org/apache/catalina/servlets/DefaultServlet$SortManager$Order", Opcodes.INTEGER, "[Lorg/apache/catalina/WebResource;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkSendfile", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;JLorg/apache/catalina/servlets/DefaultServlet$Range;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkIfMatch", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/WebResource", "getETag", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkIfModifiedSince", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkIfNoneMatch", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/catalina/WebResource", "getETag", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "org/apache/catalina/WebResource", "java/lang/String", "java/lang/String", Opcodes.INTEGER, "java/util/StringTokenizer"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 6);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNE, label3);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "checkIfUnmodifiedSince", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/apache/catalina/WebResource;)Z", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "copy", "(Ljava/io/InputStream;Ljavax/servlet/ServletOutputStream;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "java/io/BufferedInputStream");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "copyRange", "(Ljava/io/InputStream;Ljavax/servlet/ServletOutputStream;)Ljava/io/IOException;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/InputStream", "close", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "copy", "(Lorg/apache/catalina/WebResource;Ljavax/servlet/ServletOutputStream;Lorg/apache/catalina/servlets/DefaultServlet$Range;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/servlets/DefaultServlet$Range", "end", "J");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet", "copyRange", "(Ljava/io/InputStream;Ljavax/servlet/ServletOutputStream;JJ)Ljava/io/IOException;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/InputStream", "close", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "copy", "(Lorg/apache/catalina/WebResource;Ljavax/servlet/ServletOutputStream;Ljava/util/Iterator;Ljava/lang/String;)V", "(Lorg/apache/catalina/WebResource;Ljavax/servlet/ServletOutputStream;Ljava/util/Iterator<Lorg/apache/catalina/servlets/DefaultServlet$Range;>;Ljava/lang/String;)V", new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/ServletOutputStream", "println", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "org/apache/catalina/WebResource", "javax/servlet/ServletOutputStream", "java/util/Iterator", "java/lang/String", "java/io/IOException", "java/io/InputStream", "java/io/InputStream", "java/lang/Throwable", "org/apache/catalina/servlets/DefaultServlet$Range"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
...
methodVisitor.visitJumpInsn(GOTO, label14);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "org/apache/catalina/WebResource", "javax/servlet/ServletOutputStream", "java/util/Iterator", "java/lang/String", "java/io/IOException", "java/io/InputStream", "java/io/InputStream", "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Throwable", "addSuppressed", "(Ljava/lang/Throwable;)V", false);
...
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "org/apache/catalina/WebResource", "javax/servlet/ServletOutputStream", "java/util/Iterator", "java/lang/String", "java/io/IOException", "java/io/InputStream", "java/io/InputStream", "java/lang/Throwable", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Throwable", "addSuppressed", "(Ljava/lang/Throwable;)V", false);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "org/apache/catalina/WebResource", "javax/servlet/ServletOutputStream", "java/util/Iterator", "java/lang/String", "java/io/IOException"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label12);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "copyRange", "(Ljava/io/InputStream;Ljavax/servlet/ServletOutputStream;)Ljava/io/IOException;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "copyRange", "(Ljava/io/InputStream;Ljavax/servlet/ServletOutputStream;JJ)Ljava/io/IOException;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "java/io/InputStream", "javax/servlet/ServletOutputStream", Opcodes.LONG, Opcodes.LONG, Opcodes.LONG}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label7);
...
Label label9 = new Label();
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/catalina/servlets/DefaultServlet", "java/io/InputStream", "javax/servlet/ServletOutputStream", Opcodes.LONG, Opcodes.LONG, Opcodes.LONG, "java/io/IOException", Opcodes.LONG, "[B", Opcodes.INTEGER}, 0, new Object[] {});
