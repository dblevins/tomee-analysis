...
public class BaseCatalinaMBeanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/catalina/mbeans/BaseCatalinaMBean", "<T:Ljava/lang/Object;>Lorg/apache/tomcat/util/modeler/BaseModelMBean;", "org/apache/tomcat/util/modeler/BaseModelMBean", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doGetManagedResource", "()Ljava/lang/Object;", "()TT;", new String[] { "javax/management/MBeanException" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/mbeans/BaseCatalinaMBean", "getManagedResource", "()Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "newInstance", "(Ljava/lang/String;)Ljava/lang/Object;", null, new String[] { "javax/management/MBeanException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
