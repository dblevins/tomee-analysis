...
public class CoyoteInputStream$PrivilegedAvailableDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/connector/CoyoteInputStream$PrivilegedAvailable", "Ljava/lang/Object;Ljava/security/PrivilegedExceptionAction<Ljava/lang/Integer;>;", "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/CoyoteInputStream$PrivilegedAvailable", "inputBuffer", "Lorg/apache/catalina/connector/InputBuffer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/connector/CoyoteInputStream$PrivilegedAvailable", "inputBuffer", "Lorg/apache/catalina/connector/InputBuffer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/connector/CoyoteInputStream$PrivilegedAvailable", "run", "()Ljava/lang/Integer;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
