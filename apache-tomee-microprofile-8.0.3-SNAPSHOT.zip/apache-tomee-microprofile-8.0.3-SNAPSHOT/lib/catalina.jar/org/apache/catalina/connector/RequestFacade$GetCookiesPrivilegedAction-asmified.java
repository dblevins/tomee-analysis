...
public class RequestFacade$GetCookiesPrivilegedActionDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/connector/RequestFacade$GetCookiesPrivilegedAction", "this$0", "Lorg/apache/catalina/connector/RequestFacade;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/connector/RequestFacade$GetCookiesPrivilegedAction", "<init>", "(Lorg/apache/catalina/connector/RequestFacade;)V", false);
methodVisitor.visitInsn(RETURN);
