...
public class DumpSerializerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/txw2/output/DumpSerializer", null, "java/lang/Object", new String[] { "com/sun/xml/txw2/output/XmlSerializer" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/txw2/output/DumpSerializer", "out", "Ljava/io/PrintStream;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/txw2/output/DumpSerializer", "out", "Ljava/io/PrintStream;");
