...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FACTORY_ATOMIC_REFERENCE", "Ljava/util/concurrent/atomic/AtomicReference;", "Ljava/util/concurrent/atomic/AtomicReference<Ljavax/json/JsonReaderFactory;>;", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/johnzon/core/SerializableValue", "factory", "()Ljavax/json/JsonReaderFactory;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/johnzon/core/SerializableValue", "javax/json/JsonReader"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "factory", "()Ljavax/json/JsonReaderFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/json/JsonReaderFactory");
...
methodVisitor.visitVarInsn(ASTORE, 0);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/json/JsonReaderFactory"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ARETURN);
