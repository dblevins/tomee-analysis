...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "source", "Ljakarta/json/JsonValue;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "target", "Ljakarta/json/JsonValue;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/json/JsonValue;Ljakarta/json/JsonValue;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider;)V", "(Ljakarta/json/JsonValue;Ljakarta/json/JsonValue;Lorg/apache/johnzon/core/BufferStrategy$BufferProvider<[C>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonMergePatchDiff", "source", "Ljakarta/json/JsonValue;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JsonMergePatchDiff", "target", "Ljakarta/json/JsonValue;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "calculateDiff", "()Ljakarta/json/JsonMergePatch;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/johnzon/core/JsonMergePatchImpl");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonMergePatchDiff", "source", "Ljakarta/json/JsonValue;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/core/JsonMergePatchDiff", "target", "Ljakarta/json/JsonValue;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/core/JsonMergePatchDiff", "diff", "(Ljakarta/json/JsonValue;Ljakarta/json/JsonValue;)Ljakarta/json/JsonValue;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "diff", "(Ljakarta/json/JsonValue;Ljakarta/json/JsonValue;)Ljakarta/json/JsonValue;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonMergePatchDiff", "isJsonObject", "(Ljakarta/json/JsonValue;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/johnzon/core/JsonMergePatchDiff", "jakarta/json/JsonValue", "jakarta/json/JsonValue", "jakarta/json/JsonObjectBuilder", "jakarta/json/JsonObject", "jakarta/json/JsonObject", "java/util/Iterator"}, 0, new Object[] {});
