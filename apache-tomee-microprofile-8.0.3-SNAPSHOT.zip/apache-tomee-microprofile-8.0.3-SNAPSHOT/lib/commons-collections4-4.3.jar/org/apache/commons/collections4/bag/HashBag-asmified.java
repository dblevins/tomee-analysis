...
public class HashBagDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections4/bag/HashBag", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/bag/AbstractMapBag<TE;>;Ljava/io/Serializable;", "org/apache/commons/collections4/bag/AbstractMapBag", new String[] { "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-6561115435802554013L));
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/bag/HashBag", "addAll", "(Ljava/util/Collection;)Z", false);
