...
public class SetUtils$SetViewDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections4/SetUtils$SetView", "<E:Ljava/lang/Object;>Ljava/util/AbstractSet<TE;>;", "java/util/AbstractSet", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "copyInto", "(Ljava/util/Set;)V", "<S::Ljava/util/Set<TE;>;>(TS;)V", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "createIterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<TE;>;", null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/SetUtils$SetView", "createIterator", "()Ljava/util/Iterator;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/SetUtils$SetView", "copyInto", "(Ljava/util/Set;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
