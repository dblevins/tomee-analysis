...
public class Flat3Map$EntrySetIteratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/commons/collections4/map/Flat3Map$EntrySetIterator", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Lorg/apache/commons/collections4/map/Flat3Map$EntryIterator<TK;TV;>;Ljava/util/Iterator<Ljava/util/Map$Entry<TK;TV;>;>;", "org/apache/commons/collections4/map/Flat3Map$EntryIterator", new String[] { "java/util/Iterator" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/map/Flat3Map$EntrySetIterator", "nextEntry", "()Ljava/util/Map$Entry;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/map/Flat3Map$EntrySetIterator", "next", "()Ljava/util/Map$Entry;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
