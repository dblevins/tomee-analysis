...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/commons/collections4/map/Flat3Map$KeySet", "<K:Ljava/lang/Object;>Ljava/util/AbstractSet<TK;>;", "java/util/AbstractSet", null);

classWriter.visitInnerClass("org/apache/commons/collections4/map/Flat3Map$KeySet", "org/apache/commons/collections4/map/Flat3Map", "KeySet", ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "parent", "Lorg/apache/commons/collections4/map/Flat3Map;", "Lorg/apache/commons/collections4/map/Flat3Map<TK;*>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/map/Flat3Map$KeySet", "parent", "Lorg/apache/commons/collections4/map/Flat3Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/map/Flat3Map$KeySet", "parent", "Lorg/apache/commons/collections4/map/Flat3Map;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/map/Flat3Map$KeySet", "parent", "Lorg/apache/commons/collections4/map/Flat3Map;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/collections4/map/Flat3Map", "access$700", "(Lorg/apache/commons/collections4/map/Flat3Map;)Lorg/apache/commons/collections4/map/AbstractHashedMap;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/map/AbstractHashedMap", "keySet", "()Ljava/util/Set;", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/map/Flat3Map$KeySetIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/map/Flat3Map$KeySet", "parent", "Lorg/apache/commons/collections4/map/Flat3Map;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/map/Flat3Map$KeySetIterator", "<init>", "(Lorg/apache/commons/collections4/map/Flat3Map;)V", false);
methodVisitor.visitInsn(ARETURN);
