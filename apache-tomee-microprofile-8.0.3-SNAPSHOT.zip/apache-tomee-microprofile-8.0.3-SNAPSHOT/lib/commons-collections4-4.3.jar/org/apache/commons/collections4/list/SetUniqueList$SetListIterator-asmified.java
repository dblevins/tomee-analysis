...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/iterators/AbstractIteratorDecorator<TE;>;", "org/apache/commons/collections4/iterators/AbstractIteratorDecorator", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Ljava/util/Iterator;Ljava/util/Set;)V", "(Ljava/util/Iterator<TE;>;Ljava/util/Set<TE;>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "last", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "set", "Ljava/util/Set;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "last", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "last", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "set", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/list/SetUniqueList$SetListIterator", "last", "Ljava/lang/Object;");
