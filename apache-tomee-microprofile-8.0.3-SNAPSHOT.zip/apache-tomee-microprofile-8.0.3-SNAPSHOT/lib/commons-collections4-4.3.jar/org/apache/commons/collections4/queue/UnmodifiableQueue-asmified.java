...
public class UnmodifiableQueueDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/queue/UnmodifiableQueue", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/queue/AbstractQueueDecorator<TE;>;Lorg/apache/commons/collections4/Unmodifiable;", "org/apache/commons/collections4/queue/AbstractQueueDecorator", new String[] { "org/apache/commons/collections4/Unmodifiable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(1832948656215393357L));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/queue/UnmodifiableQueue");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/queue/UnmodifiableQueue", "<init>", "(Ljava/util/Queue;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljava/util/Queue;)V", "(Ljava/util/Queue<+TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/queue/AbstractQueueDecorator", "<init>", "(Ljava/util/Queue;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/queue/UnmodifiableQueue", "decorated", "()Ljava/util/Queue;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/queue/UnmodifiableQueue", "setCollection", "(Ljava/util/Collection;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
