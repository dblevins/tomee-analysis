...
public class ArrayListIteratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections4/iterators/ArrayListIterator", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/iterators/ArrayIterator<TE;>;Lorg/apache/commons/collections4/ResettableListIterator<TE;>;", "org/apache/commons/collections4/iterators/ArrayIterator", new String[] { "org/apache/commons/collections4/ResettableListIterator" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "lastItemIndex", "I", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "lastItemIndex", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "startIndex", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/iterators/ArrayListIterator", "hasPrevious", "()Z", false);
Label label0 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "index", "I");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "lastItemIndex", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "array", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "index", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/iterators/ArrayListIterator", "hasNext", "()Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitTypeInsn(NEW, "java/util/NoSuchElementException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "lastItemIndex", "I");
methodVisitor.visitInsn(ICONST_M1);
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/iterators/ArrayIterator", "reset", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_M1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/iterators/ArrayListIterator", "lastItemIndex", "I");
methodVisitor.visitInsn(RETURN);
