...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/commons/collections4/map/StaticBucketMap$KeyIterator", "Lorg/apache/commons/collections4/map/StaticBucketMap<TK;TV;>.BaseIterator;Ljava/util/Iterator<TK;>;", "org/apache/commons/collections4/map/StaticBucketMap$BaseIterator", new String[] { "java/util/Iterator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/map/StaticBucketMap$KeyIterator", "this$0", "Lorg/apache/commons/collections4/map/StaticBucketMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/map/StaticBucketMap$KeyIterator", "nextEntry", "()Ljava/util/Map$Entry;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/map/StaticBucketMap$KeyIterator", "<init>", "(Lorg/apache/commons/collections4/map/StaticBucketMap;)V", false);
methodVisitor.visitInsn(RETURN);
