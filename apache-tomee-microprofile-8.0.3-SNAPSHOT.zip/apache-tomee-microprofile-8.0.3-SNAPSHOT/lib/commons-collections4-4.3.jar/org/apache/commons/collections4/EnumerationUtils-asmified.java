...
public class EnumerationUtilsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections4/EnumerationUtils", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "get", "(Ljava/util/Enumeration;I)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/util/Enumeration<TT;>;I)TT;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "toList", "(Ljava/util/Enumeration;)Ljava/util/List;", "<E:Ljava/lang/Object;>(Ljava/util/Enumeration<+TE;>;)Ljava/util/List<TE;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "toList", "(Ljava/util/StringTokenizer;)Ljava/util/List;", "(Ljava/util/StringTokenizer;)Ljava/util/List<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
