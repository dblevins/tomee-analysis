...
public class ELFacade$BValFunctionMapperDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/bval/el/ELFacade$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/el/ELFacade$BValFunctionMapper", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
