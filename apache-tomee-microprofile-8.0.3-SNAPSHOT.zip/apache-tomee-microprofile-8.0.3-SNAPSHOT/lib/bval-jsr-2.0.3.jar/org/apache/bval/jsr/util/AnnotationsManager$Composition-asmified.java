...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/OverridesAttribute;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/validation/OverridesAttribute;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/bval/jsr/util/AnnotationsManager$Composition", "org/apache/bval/jsr/util/AnnotationsManager", "java/lang/Class", "java/util/Map", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/reflect/Method", "java/lang/String", "[Ljavax/validation/OverridesAttribute;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/OverridesAttribute", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Optional", "of", "(Ljava/lang/Object;)Ljava/util/Optional;", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/util/AnnotationsManager$OverriddenAnnotationSpecifier", "<init>", "(Ljavax/validation/OverridesAttribute;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"org/apache/bval/jsr/util/AnnotationsManager$Composition", "org/apache/bval/jsr/util/AnnotationsManager", "java/lang/Class", "java/util/Map", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/reflect/Method", "java/lang/String", "[Ljavax/validation/OverridesAttribute;", Opcodes.INTEGER, Opcodes.INTEGER, "javax/validation/OverridesAttribute", "java/lang/String", "org/apache/bval/jsr/util/AnnotationsManager$OverriddenAnnotationSpecifier", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getComponents$2", "(Ljava/lang/annotation/Annotation;Lorg/apache/bval/jsr/ConstraintAnnotationAttributes$Worker;)Ljavax/validation/ConstraintTarget;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/ConstraintAnnotationAttributes$Worker", "read", "(Ljava/lang/annotation/Annotation;)Ljava/lang/Object;", false);
