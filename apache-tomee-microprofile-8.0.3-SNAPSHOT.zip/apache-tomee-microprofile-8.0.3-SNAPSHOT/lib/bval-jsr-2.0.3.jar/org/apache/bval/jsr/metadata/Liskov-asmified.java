...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "validateContainerHierarchy", "(Ljava/util/Collection;Ljakarta/validation/ElementKind;)V", "(Ljava/util/Collection<+Lorg/apache/bval/jsr/metadata/HierarchyBuilder$ContainerDelegate<*>;>;Ljakarta/validation/ElementKind;)V", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/bval/jsr/metadata/Liskov", "getContainer", "(Lorg/apache/bval/jsr/metadata/Meta;)Ljakarta/validation/ElementKind;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getContainer", "(Lorg/apache/bval/jsr/metadata/Meta;)Ljakarta/validation/ElementKind;", "(Lorg/apache/bval/jsr/metadata/Meta<*>;)Ljakarta/validation/ElementKind;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ASTORE, 1);
Label label0 = new Label();
