...
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/jsr/metadata/ReflectionBuilder$ForContainer", "lambda$getGroupConversions$0", "(Ljavax/validation/groups/ConvertGroup;)Lorg/apache/bval/jsr/groups/GroupConversion;", false), Type.getType("(Ljavax/validation/groups/ConvertGroup;)Lorg/apache/bval/jsr/groups/GroupConversion;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getGroupConversions$0", "(Ljavax/validation/groups/ConvertGroup;)Lorg/apache/bval/jsr/groups/GroupConversion;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/groups/ConvertGroup", "from", "()Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/groups/ConvertGroup", "to", "()Ljava/lang/Class;", true);
