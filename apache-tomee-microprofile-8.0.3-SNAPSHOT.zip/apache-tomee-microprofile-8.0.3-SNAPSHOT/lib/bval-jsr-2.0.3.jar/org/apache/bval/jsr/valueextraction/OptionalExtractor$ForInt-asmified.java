...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/valueextraction/OptionalExtractor$ForInt", "Ljava/lang/Object;Ljavax/validation/valueextraction/ValueExtractor<Ljava/util/OptionalInt;>;", "java/lang/Object", new String[] { "javax/validation/valueextraction/ValueExtractor" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "extractValues", "(Ljava/util/OptionalInt;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/bval/jsr/valueextraction/OptionalExtractor$ForInt", "java/util/OptionalInt", "javax/validation/valueextraction/ValueExtractor$ValueReceiver"}, 2, new Object[] {"javax/validation/valueextraction/ValueExtractor$ValueReceiver", Opcodes.NULL});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/bval/jsr/valueextraction/OptionalExtractor$ForInt", "java/util/OptionalInt", "javax/validation/valueextraction/ValueExtractor$ValueReceiver"}, 3, new Object[] {"javax/validation/valueextraction/ValueExtractor$ValueReceiver", Opcodes.NULL, "java/lang/Integer"});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/OptionalExtractor$ForInt", "extractValues", "(Ljava/util/OptionalInt;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
