...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jaxrs/JwsWriterInterceptor", null, "org/apache/cxf/rs/security/jose/jaxrs/AbstractJwsWriterProvider", new String[] { "javax/ws/rs/ext/WriterInterceptor" });
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsWriterInterceptor", "setContentTypeIfNeeded", "(Lorg/apache/cxf/rs/security/jose/common/JoseHeaders;Ljavax/ws/rs/ext/WriterInterceptorContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsWriterInterceptor", "protectHttpHeadersIfNeeded", "(Ljavax/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jws/JwsHeaders;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsWriterInterceptor", "setJoseMediaType", "(Ljavax/ws/rs/ext/WriterInterceptorContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsWriterInterceptor", "javax/ws/rs/ext/WriterInterceptorContext", "org/apache/cxf/rs/security/jose/jws/JwsHeaders", "org/apache/cxf/rs/security/jose/jws/JwsSignatureProvider", "java/io/OutputStream"}, 0, new Object[] {});
