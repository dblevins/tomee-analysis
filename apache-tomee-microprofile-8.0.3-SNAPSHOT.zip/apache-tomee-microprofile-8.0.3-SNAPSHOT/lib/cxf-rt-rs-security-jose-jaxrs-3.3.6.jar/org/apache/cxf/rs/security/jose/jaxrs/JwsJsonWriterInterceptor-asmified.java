...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", null, "org/apache/cxf/rs/security/jose/jaxrs/AbstractJwsJsonWriterProvider", new String[] { "jakarta/ws/rs/ext/WriterInterceptor" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/util/List", "java/util/List", "java/util/List", "java/io/OutputStream", "java/util/List", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/util/List", "java/util/List", "java/util/List", "java/io/OutputStream", "java/util/List", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/cxf/rs/security/jose/jws/JwsSignatureProvider", "org/apache/cxf/rs/security/jose/jws/JwsHeaders"}, 4, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "org/apache/cxf/rs/security/jose/jws/JwsHeaders", "jakarta/ws/rs/ext/WriterInterceptorContext", "org/apache/cxf/rs/security/jose/jws/JwsSignatureProvider"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/util/List", "java/util/List", "java/util/List", "java/io/OutputStream", "java/util/List", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/cxf/rs/security/jose/jws/JwsSignatureProvider", "org/apache/cxf/rs/security/jose/jws/JwsHeaders"}, 5, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "org/apache/cxf/rs/security/jose/jws/JwsHeaders", "jakarta/ws/rs/ext/WriterInterceptorContext", "org/apache/cxf/rs/security/jose/jws/JwsSignatureProvider", Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "prepareProtectedHeader", "(Lorg/apache/cxf/rs/security/jose/jws/JwsHeaders;Ljakarta/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jws/JwsSignatureProvider;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "jakarta/ws/rs/ext/WriterInterceptorContext", "java/util/List", "java/util/List", "java/util/List", "java/io/OutputStream"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "prepareProtectedHeader", "(Lorg/apache/cxf/rs/security/jose/jws/JwsHeaders;Ljakarta/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jws/JwsSignatureProvider;Z)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "setContentTypeIfNeeded", "(Lorg/apache/cxf/rs/security/jose/common/JoseHeaders;Ljakarta/ws/rs/ext/WriterInterceptorContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "encodePayload", "Z");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonWriterInterceptor", "protectHttpHeadersIfNeeded", "(Ljakarta/ws/rs/ext/WriterInterceptorContext;Lorg/apache/cxf/rs/security/jose/jws/JwsHeaders;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
