...
public class AlgoFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/wss4j/common/derivedKey/AlgoFactory", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljava/lang/String;)Lorg/apache/wss4j/common/derivedKey/DerivationAlgorithm;", null, new String[] { "org/apache/wss4j/common/ext/WSSecurityException" });
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("http://docs.oasis-open.org/ws-sx/ws-secureconversation/200512/dk/p_sha1");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn("unknownAlgorithm");
