...
public class AllDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/neethi/All", null, "org/apache/neethi/AbstractPolicyOperator", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addAssertion", "(Lorg/apache/neethi/Assertion;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getAssertions", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/neethi/PolicyComponent;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/neethi/All", "policyComponents", "Ljava/util/List;");
