...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/eclipse/jdt/internal/compiler/apt/util/Options", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "ZERO_ARGUMENT_OPTIONS", "Ljava/util/Set;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "ZERO_ARGUMENT_OPTIONS", "Ljava/util/Set;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "FILE_MANAGER_OPTIONS", "Ljava/util/Set;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "FILE_MANAGER_OPTIONS", "Ljava/util/Set;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "ONE_ARGUMENT_OPTIONS", "Ljava/util/Set;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "ONE_ARGUMENT_OPTIONS", "Ljava/util/Set;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/apt/util/Options", "FILE_MANAGER_OPTIONS", "Ljava/util/Set;");
