...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", null, "org/eclipse/jdt/internal/compiler/apt/util/ArchiveFileObject", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem;Ljava/io/File;Ljava/nio/file/Path;Ljava/lang/String;Ljava/nio/charset/Charset;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "this$0", "Lorg/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "path", "Ljava/nio/file/Path;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "file", "Ljava/io/File;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "entryName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "module", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "org/eclipse/jdt/internal/compiler/classfmt/ClassFileReader"}, 1, new Object[] {"org/eclipse/jdt/internal/compiler/classfmt/ClassFormatException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/jdt/internal/compiler/util/JRTUtil", "getClassfileContent", "(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)[B", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "charset", "Ljava/nio/charset/Charset;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "path", "Ljava/nio/file/Path;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/nio/file/Path", "toString", "()Ljava/lang/String;", true);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem;Ljava/io/File;Ljava/nio/file/Path;Ljava/lang/String;Ljava/nio/charset/Charset;Lorg/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem$JrtFileObject", "<init>", "(Lorg/eclipse/jdt/internal/compiler/apt/util/JrtFileSystem;Ljava/io/File;Ljava/nio/file/Path;Ljava/lang/String;Ljava/nio/charset/Charset;)V", false);
methodVisitor.visitInsn(RETURN);
