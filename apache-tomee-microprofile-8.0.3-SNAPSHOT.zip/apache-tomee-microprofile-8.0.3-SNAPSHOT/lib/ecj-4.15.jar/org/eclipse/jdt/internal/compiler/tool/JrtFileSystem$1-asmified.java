...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/jdt/internal/compiler/tool/JrtFileSystem$1", "Ljava/lang/Object;Lorg/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor<Ljava/nio/file/Path;>;", "java/lang/Object", new String[] { "org/eclipse/jdt/internal/compiler/util/JRTUtil$JrtFileVisitor" });

classWriter.visitOuterClass("org/eclipse/jdt/internal/compiler/tool/JrtFileSystem", "initialize", "()V");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/eclipse/jdt/internal/compiler/tool/JrtFileSystem;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/jdt/internal/compiler/tool/JrtFileSystem$1", "this$0", "Lorg/eclipse/jdt/internal/compiler/tool/JrtFileSystem;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/jdt/internal/compiler/tool/JrtFileSystem$1", "this$0", "Lorg/eclipse/jdt/internal/compiler/tool/JrtFileSystem;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/JrtFileSystem$1", "visitFile", "(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/nio/file/Path");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/JrtFileSystem$1", "visitModule", "(Ljava/nio/file/Path;Ljava/lang/String;)Ljava/nio/file/FileVisitResult;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/nio/file/Path");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/jdt/internal/compiler/tool/JrtFileSystem$1", "visitPackage", "(Ljava/nio/file/Path;Ljava/nio/file/Path;Ljava/nio/file/attribute/BasicFileAttributes;)Ljava/nio/file/FileVisitResult;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
