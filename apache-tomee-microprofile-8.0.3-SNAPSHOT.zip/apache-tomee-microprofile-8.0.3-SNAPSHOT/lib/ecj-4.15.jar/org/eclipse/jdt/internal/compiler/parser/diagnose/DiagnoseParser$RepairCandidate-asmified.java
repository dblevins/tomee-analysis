...
public class DiagnoseParser$RepairCandidateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/jdt/internal/compiler/parser/diagnose/DiagnoseParser$RepairCandidate", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "location", "I", null, null);
fieldVisitor.visitEnd();
}
{
