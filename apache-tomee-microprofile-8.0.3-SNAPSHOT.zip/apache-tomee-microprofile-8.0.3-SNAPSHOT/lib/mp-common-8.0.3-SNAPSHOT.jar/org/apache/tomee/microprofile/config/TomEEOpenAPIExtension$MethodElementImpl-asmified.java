...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$MethodElementImpl", "delegate", "Ljavax/enterprise/inject/spi/AnnotatedMethod;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$MethodElementImpl", "delegate", "Ljavax/enterprise/inject/spi/AnnotatedMethod;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getParameters$0", "(Ljavax/enterprise/inject/spi/AnnotatedParameter;)Lorg/apache/tomee/microprofile/config/TomEEOpenAPIExtension$TypeElementImpl;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$TypeElementImpl", "<init>", "(Ljava/lang/reflect/Type;Ljavax/enterprise/inject/spi/Annotated;Lorg/apache/tomee/microprofile/config/TomEEOpenAPIExtension$1;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(5, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljavax/enterprise/inject/spi/AnnotatedMethod;Lorg/apache/tomee/microprofile/config/TomEEOpenAPIExtension$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$MethodElementImpl", "<init>", "(Ljavax/enterprise/inject/spi/AnnotatedMethod;)V", false);
methodVisitor.visitInsn(RETURN);
