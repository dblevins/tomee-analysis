...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljava/lang/reflect/Type;Ljakarta/enterprise/inject/spi/Annotated;Lorg/apache/tomee/microprofile/config/TomEEOpenAPIExtension$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$TypeElementImpl", "<init>", "(Ljava/lang/reflect/Type;Ljakarta/enterprise/inject/spi/Annotated;)V", false);
methodVisitor.visitInsn(RETURN);
