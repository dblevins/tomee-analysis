...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/webapp/UIComponentTag$UIComponentTagWrapper", null, "javax/faces/webapp/UIComponentTag", null);

classWriter.visitInnerClass("javax/faces/webapp/UIComponentTag$UIComponentTagWrapper", "javax/faces/webapp/UIComponentTag", "UIComponentTagWrapper", ACC_PRIVATE | ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "target", "Ljavax/faces/webapp/UIComponentClassicTagBase;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/webapp/UIComponentTag$UIComponentTagWrapper", "target", "Ljavax/faces/webapp/UIComponentClassicTagBase;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/UIComponentTag$UIComponentTagWrapper", "target", "Ljavax/faces/webapp/UIComponentClassicTagBase;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/UIComponentTag$UIComponentTagWrapper", "target", "Ljavax/faces/webapp/UIComponentClassicTagBase;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/webapp/UIComponentClassicTagBase", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "findComponent", "(Ljavax/faces/context/FacesContext;)Ljavax/faces/component/UIComponent;", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/lang/UnsupportedOperationException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/UnsupportedOperationException", "<init>", "()V", false);
