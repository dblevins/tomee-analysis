...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "javax/faces/webapp/ValidatorTag", null, "javax/servlet/jsp/tagext/TagSupport", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/webapp/ValidatorTag", "_validatorId", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/ValidatorTag", "pageContext", "Ljavax/servlet/jsp/PageContext;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/webapp/UIComponentTag", "getCreated", "()Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/webapp/ValidatorTag", "createValidator", "()Ljavax/faces/validator/Validator;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/validator/Validator", "javax/faces/component/UIComponent"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/webapp/ValidatorTag", "_binding", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/ValidatorTag", "_binding", "Ljava/lang/String;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/webapp/ValidatorTag", "_validatorId", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setBinding", "(Ljava/lang/String;)V", null, new String[] { "javax/servlet/jsp/JspException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
