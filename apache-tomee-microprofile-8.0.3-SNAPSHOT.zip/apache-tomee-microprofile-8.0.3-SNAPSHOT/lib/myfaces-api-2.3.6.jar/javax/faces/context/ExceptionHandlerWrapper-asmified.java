...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/context/ExceptionHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/ExceptionHandlerWrapper", "delegate", "Ljavax/faces/context/ExceptionHandler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/ExceptionHandlerWrapper", "delegate", "Ljavax/faces/context/ExceptionHandler;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
