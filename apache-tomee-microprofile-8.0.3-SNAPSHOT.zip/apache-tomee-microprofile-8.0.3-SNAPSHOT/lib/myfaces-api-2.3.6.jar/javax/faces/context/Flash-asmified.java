...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/faces/context/Flash", "Ljava/lang/Object;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/util/Map" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "NULL_VALUE", "Ljava/lang/String;", null, "javax.faces.context.Flash.NULL_VALUE");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "doPrePhaseActions", "(Ljavax/faces/context/FacesContext;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "doPostPhaseActions", "(Ljavax/faces/context/FacesContext;)V", null, null);
methodVisitor.visitEnd();
}
