...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionActionListener", "_createZeroArgsMethodExpression", "(Ljavax/el/MethodExpression;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/event/MethodExpressionActionListener", "javax/el/MethodExpression", "javax/el/MethodExpression"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionActionListener", "_createZeroArgsMethodExpression", "(Ljavax/el/MethodExpression;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionActionListener", "getElContext", "()Ljavax/el/ELContext;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionActionListener", "getElContext", "()Ljavax/el/ELContext;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/event/MethodExpressionActionListener", "EMPTY_PARAMS", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/el/MethodExpression", "invoke", "(Ljavax/el/ELContext;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/MethodExpressionActionListener", "getFacesContext", "()Ljavax/faces/context/FacesContext;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/event/MethodExpressionActionListener", "EMPTY_CLASS_ARRAY", "[Ljava/lang/Class;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/event/MethodExpressionActionListener", "EMPTY_CLASS_ARRAY", "[Ljava/lang/Class;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/event/MethodExpressionActionListener", "EMPTY_PARAMS", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
