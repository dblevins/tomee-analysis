...
public class VisitContext$AllIdsCollectionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/visit/VisitContext$AllIdsCollection", "Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "java/util/Collection", "java/io/Serializable" });

classWriter.visitInnerClass("javax/faces/component/visit/VisitContext$AllIdsCollection", "javax/faces/component/visit/VisitContext", "AllIdsCollection", ACC_PRIVATE | ACC_STATIC);

classWriter.visitInnerClass("javax/faces/component/visit/VisitContext$1", null, null, ACC_STATIC | ACC_SYNTHETIC);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/visit/VisitContext$AllIdsCollection", "add", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljavax/faces/component/visit/VisitContext$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/visit/VisitContext$AllIdsCollection", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
