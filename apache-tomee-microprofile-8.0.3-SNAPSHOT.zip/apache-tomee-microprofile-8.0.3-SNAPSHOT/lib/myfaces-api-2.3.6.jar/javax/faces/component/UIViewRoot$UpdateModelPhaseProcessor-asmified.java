...
public class UIViewRoot$UpdateModelPhaseProcessorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/component/UIViewRoot$UpdateModelPhaseProcessor", null, "java/lang/Object", new String[] { "javax/faces/component/UIViewRoot$PhaseProcessor" });
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/faces/component/UIViewRoot", "access$700", "(Ljavax/faces/component/UIViewRoot;Ljavax/faces/context/FacesContext;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewRoot$UpdateModelPhaseProcessor", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
