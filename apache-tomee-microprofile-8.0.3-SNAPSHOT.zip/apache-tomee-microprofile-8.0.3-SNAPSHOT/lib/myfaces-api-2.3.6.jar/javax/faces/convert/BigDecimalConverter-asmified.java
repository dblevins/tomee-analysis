...
public class BigDecimalConverterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/faces/convert/BigDecimalConverter", null, "java/lang/Object", new String[] { "javax/faces/convert/Converter" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CONVERTER_ID", "Ljava/lang/String;", null, "javax.faces.BigDecimal");
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "DECIMAL_ID", "Ljava/lang/String;", null, "javax.faces.converter.BigDecimalConverter.DECIMAL");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("javax.faces.converter.BigDecimalConverter.DECIMAL");
...
methodVisitor.visitTypeInsn(NEW, "java/math/BigDecimal");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn(new Double("4815.16"));
