...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/convert/DoubleConverter", "fixLocale", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/convert/DoubleConverter", "stringToDouble", "(Ljava/lang/String;)Ljava/lang/Double;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "fixLocale", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"javax/faces/convert/DoubleConverter", "javax/faces/context/FacesContext", "java/lang/String", "java/util/Locale", "java/text/DecimalFormatSymbols", Opcodes.INTEGER, "java/lang/StringBuffer", Opcodes.INTEGER}, 0, new Object[] {});
