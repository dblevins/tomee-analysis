...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_type", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_groupingUsed", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_integerOnly", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_initialStateMarked", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/convert/NumberConverter", "getNumberFormat", "(Ljavax/faces/context/FacesContext;)Ljava/text/NumberFormat;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_integerOnly", "Z");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "javax/faces/component/UIComponent", "java/lang/String", "java/text/NumberFormat", "java/text/DecimalFormat", "javax/el/ValueExpression", "java/lang/Class"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/convert/NumberConverter", "formatCurrency", "(Ljava/text/NumberFormat;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/convert/NumberConverter", "parse", "(Ljava/lang/String;Ljava/text/NumberFormat;Ljava/lang/Class;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/convert/NumberConverter", "getPattern", "()Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"java/text/ParseException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/convert/NumberConverter", "getType", "()Ljava/lang/String;", false);
methodVisitor.visitLdcInsn("number");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "javax/faces/component/UIComponent", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_groupingUsed", "Z");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/text/NumberFormat", "setGroupingUsed", "(Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_maxFractionDigitsSet", "Z");
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_maxFractionDigits", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_maxIntegerDigitsSet", "Z");
Label label8 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label8);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_maxIntegerDigits", "I");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/text/NumberFormat", "setMaximumIntegerDigits", "(I)V", false);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_minFractionDigitsSet", "Z");
Label label9 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label9);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_minFractionDigits", "I");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/text/NumberFormat", "setMinimumFractionDigits", "(I)V", false);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_minIntegerDigitsSet", "Z");
Label label10 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label10);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_minIntegerDigits", "I");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getNumberFormat", "(Ljavax/faces/context/FacesContext;)Ljava/text/NumberFormat;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_locale", "Ljava/util/Locale;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_pattern", "Ljava/lang/String;");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_type", "Ljava/lang/String;");
methodVisitor.visitJumpInsn(IFNONNULL, label2);
methodVisitor.visitTypeInsn(NEW, "javax/faces/convert/ConverterException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "java/lang/Exception");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_currencyCode", "Ljava/lang/String;");
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_currencySymbol", "Ljava/lang/String;");
methodVisitor.visitJumpInsn(IFNONNULL, label3);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/convert/NumberConverter", "java/text/NumberFormat", Opcodes.INTEGER}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "javax/faces/convert/ConverterException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_currencyCode", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(AALOAD);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_currencySymbol", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitInsn(AALOAD);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Locale");
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_locale", "Ljava/util/Locale;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitInsn(AALOAD);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/lang/Object;", "java/lang/Integer"}, 1, new Object[] {"javax/faces/convert/NumberConverter"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/lang/Object;", "java/lang/Integer"}, 2, new Object[] {"javax/faces/convert/NumberConverter", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_maxFractionDigits", "I");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/faces/convert/NumberConverter"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/lang/Object;", "java/lang/Integer"}, 2, new Object[] {"javax/faces/convert/NumberConverter", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_maxIntegerDigits", "I");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/lang/Object;", "java/lang/Integer"}, 2, new Object[] {"javax/faces/convert/NumberConverter", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_minFractionDigits", "I");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/lang/Object;", "java/lang/Integer"}, 2, new Object[] {"javax/faces/convert/NumberConverter", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_minIntegerDigits", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitIntInsn(BIPUSH, 7);
methodVisitor.visitInsn(AALOAD);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_pattern", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Boolean");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Boolean", "booleanValue", "()Z", false);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_maxFractionDigitsSet", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Boolean");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Boolean", "booleanValue", "()Z", false);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_maxIntegerDigitsSet", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Boolean");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Boolean", "booleanValue", "()Z", false);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_minFractionDigitsSet", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Boolean");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Boolean", "booleanValue", "()Z", false);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_minIntegerDigitsSet", "Z");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "[Ljava/lang/Object;"}, 2, new Object[] {"[Ljava/lang/Object;", Opcodes.INTEGER});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "[Ljava/lang/Object;"}, 3, new Object[] {"[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Integer"});
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_4);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/convert/NumberConverter", "javax/faces/context/FacesContext", "[Ljava/lang/Object;"}, 3, new Object[] {"[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Boolean"});
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitIntInsn(BIPUSH, 10);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/convert/NumberConverter", "getDecimalFormatSymbols", "()Ljava/text/DecimalFormatSymbols;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_transient", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/NumberConverter", "_transient", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/convert/NumberConverter", "getLocale", "()Ljava/util/Locale;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/text/DecimalFormatSymbols", "<init>", "(Ljava/util/Locale;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/NumberConverter", "_initialStateMarked", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
