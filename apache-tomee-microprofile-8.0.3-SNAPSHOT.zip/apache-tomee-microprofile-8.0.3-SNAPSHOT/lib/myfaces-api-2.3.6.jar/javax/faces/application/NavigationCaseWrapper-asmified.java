...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljavax/faces/application/NavigationCase;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/NavigationCaseWrapper", "delegate", "Ljavax/faces/application/NavigationCase;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/NavigationCaseWrapper", "delegate", "Ljavax/faces/application/NavigationCase;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
