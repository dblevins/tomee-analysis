...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/application/StateManager;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/application/StateManagerWrapper", "delegate", "Ljakarta/faces/application/StateManager;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/application/StateManagerWrapper", "delegate", "Ljakarta/faces/application/StateManager;");
