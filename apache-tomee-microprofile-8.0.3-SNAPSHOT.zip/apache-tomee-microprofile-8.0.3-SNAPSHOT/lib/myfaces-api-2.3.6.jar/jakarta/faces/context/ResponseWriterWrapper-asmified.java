...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/context/ResponseWriter;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/context/ResponseWriterWrapper", "delegate", "Ljakarta/faces/context/ResponseWriter;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/context/ResponseWriterWrapper", "delegate", "Ljakarta/faces/context/ResponseWriter;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
