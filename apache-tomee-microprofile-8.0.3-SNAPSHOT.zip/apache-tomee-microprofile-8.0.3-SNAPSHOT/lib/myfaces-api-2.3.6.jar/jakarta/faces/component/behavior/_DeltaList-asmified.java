...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/component/behavior/_DeltaList", "<T:Ljava/lang/Object;>Ljava/util/ArrayList<TT;>;Ljava/util/List<TT;>;Ljakarta/faces/component/PartialStateHolder;Ljava/util/RandomAccess;", "java/util/ArrayList", new String[] { "java/util/List", "jakarta/faces/component/PartialStateHolder", "java/util/RandomAccess" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/behavior/_DeltaList", "initialStateMarked", "()Z", false);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"jakarta/faces/component/behavior/_DeltaList", "jakarta/faces/context/FacesContext", Opcodes.INTEGER, "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 2);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label3);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/faces/component/PartialStateHolder", "isTransient", "()Z", true);
Label label5 = new Label();
...
methodVisitor.visitVarInsn(ISTORE, 4);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Object", "jakarta/faces/component/PartialStateHolder", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ILOAD, 5);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/behavior/_DeltaList", "emptyObjectArray", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ILOAD, 4);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/behavior/_DeltaList", "_initialStateMarked", "Z");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/behavior/_DeltaList", "_initialStateMarked", "Z");
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/behavior/_DeltaList", "emptyObjectArray", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
