...
public class AbstractTokenWrapperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/wss4j/policy/model/AbstractTokenWrapper", null, "org/apache/wss4j/policy/model/AbstractSecurityAssertion", new String[] { "org/apache/neethi/PolicyContainingAssertion" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "token", "Lorg/apache/wss4j/policy/model/AbstractToken;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "nestedPolicy", "Lorg/apache/neethi/Policy;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "parseNestedPolicy", "(Lorg/apache/neethi/Policy;Lorg/apache/wss4j/policy/model/AbstractTokenWrapper;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "nestedPolicy", "Lorg/apache/neethi/Policy;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/wss4j/policy/model/AbstractTokenWrapper");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/wss4j/policy/model/AbstractTokenWrapper");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "token", "Lorg/apache/wss4j/policy/model/AbstractToken;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "token", "Lorg/apache/wss4j/policy/model/AbstractToken;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/AbstractToken", "hashCode", "()I", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "getPolicy", "()Lorg/apache/neethi/Policy;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "parseNestedPolicy", "(Lorg/apache/neethi/Policy;Lorg/apache/wss4j/policy/model/AbstractTokenWrapper;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "setToken", "(Lorg/apache/wss4j/policy/model/AbstractToken;)V", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setToken", "(Lorg/apache/wss4j/policy/model/AbstractToken;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "token", "Lorg/apache/wss4j/policy/model/AbstractToken;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "parentAssertion", "Lorg/apache/wss4j/policy/model/AbstractSecurityAssertion;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/policy/model/AbstractTokenWrapper", "parentAssertion", "Lorg/apache/wss4j/policy/model/AbstractSecurityAssertion;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
