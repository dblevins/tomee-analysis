...
public class RecipientSignatureTokenBuilderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/policy/builders/RecipientSignatureTokenBuilder", "Ljava/lang/Object;Lorg/apache/neethi/builders/AssertionBuilder<Lorg/w3c/dom/Element;>;", "java/lang/Object", new String[] { "org/apache/neethi/builders/AssertionBuilder" });
...
methodVisitor.visitTypeInsn(NEW, "org/apache/wss4j/policy/model/RecipientSignatureToken");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/policy/model/RecipientSignatureToken", "<init>", "(Lorg/apache/wss4j/policy/SPConstants$SPVersion;Lorg/apache/neethi/Policy;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/RecipientSignatureToken", "setOptional", "(Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/wss4j/policy/SPUtils", "isIgnorable", "(Lorg/w3c/dom/Element;)Z", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/RecipientSignatureToken", "setIgnorable", "(Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/wss4j/policy/SP13Constants", "RECIPIENT_SIGNATURE_TOKEN", "Ljavax/xml/namespace/QName;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/builders/RecipientSignatureTokenBuilder", "build", "(Lorg/w3c/dom/Element;Lorg/apache/neethi/AssertionBuilderFactory;)Lorg/apache/neethi/Assertion;", false);
methodVisitor.visitInsn(ARETURN);
