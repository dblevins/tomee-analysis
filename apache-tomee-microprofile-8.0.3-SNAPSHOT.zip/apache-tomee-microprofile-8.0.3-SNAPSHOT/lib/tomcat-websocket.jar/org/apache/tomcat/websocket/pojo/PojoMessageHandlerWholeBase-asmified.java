...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/tomcat/websocket/pojo/PojoMessageHandlerWholeBase", "<T:Ljava/lang/Object;>Lorg/apache/tomcat/websocket/pojo/PojoMessageHandlerBase<TT;>;Ljakarta/websocket/MessageHandler$Whole<TT;>;", "org/apache/tomcat/websocket/pojo/PojoMessageHandlerBase", new String[] { "jakarta/websocket/MessageHandler$Whole" });
...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/websocket/DecodeException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/websocket/pojo/PojoMessageHandlerWholeBase", "session", "Ljakarta/websocket/Session;");
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/websocket/DecodeException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "decode", "(Ljava/lang/Object;)Ljava/lang/Object;", "(TT;)Ljava/lang/Object;", new String[] { "jakarta/websocket/DecodeException" });
methodVisitor.visitEnd();
}
{
