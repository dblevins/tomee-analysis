...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/tomcat/websocket/pojo/PojoEndpointBase", null, "javax/websocket/Endpoint", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_FINAL, "doOnOpen", "(Ljavax/websocket/Session;Ljavax/websocket/EndpointConfig;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "getMessageHandlers", "(Ljava/lang/Object;Ljava/util/Map;Ljavax/websocket/Session;Ljavax/websocket/EndpointConfig;)Ljava/util/Set;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/tomcat/websocket/pojo/PojoEndpointBase", "javax/websocket/Session", "javax/websocket/EndpointConfig", "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "java/lang/Object", "java/util/Map", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/Session", "addMessageHandler", "(Ljavax/websocket/MessageHandler;)V", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "getOnOpenArgs", "(Ljava/util/Map;Ljavax/websocket/Session;Ljavax/websocket/EndpointConfig;)[Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/pojo/PojoEndpointBase", "handleOnOpenOrCloseError", "(Ljavax/websocket/Session;Ljava/lang/Throwable;)V", false);
methodVisitor.visitJumpInsn(GOTO, label7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "handleOnOpenOrCloseError", "(Ljavax/websocket/Session;Ljava/lang/Throwable;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/pojo/PojoEndpointBase", "onError", "(Ljavax/websocket/Session;Ljava/lang/Throwable;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/Session", "close", "()V", true);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "onClose", "(Ljavax/websocket/Session;Ljavax/websocket/CloseReason;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "getOnCloseArgs", "(Ljava/util/Map;Ljavax/websocket/Session;Ljavax/websocket/CloseReason;)[Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Method", "invoke", "(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/Session", "getMessageHandlers", "()Ljava/util/Set;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "onError", "(Ljavax/websocket/Session;Ljava/lang/Throwable;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "getOnErrorArgs", "(Ljava/util/Map;Ljavax/websocket/Session;Ljava/lang/Throwable;)[Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Method", "invoke", "(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label3);
