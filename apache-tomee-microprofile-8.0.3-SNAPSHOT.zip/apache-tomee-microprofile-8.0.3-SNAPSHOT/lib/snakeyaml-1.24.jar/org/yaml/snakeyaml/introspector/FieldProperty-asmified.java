...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/yaml/snakeyaml/introspector/FieldProperty", null, "org/yaml/snakeyaml/introspector/GenericProperty", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/yaml/snakeyaml/introspector/FieldProperty", "field", "Ljava/lang/reflect/Field;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/yaml/snakeyaml/introspector/FieldProperty", "field", "Ljava/lang/reflect/Field;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLdcInsn("Unable to access field ");
