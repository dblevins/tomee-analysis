...
public class SafeConstructor$ConstructYamlMapDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/yaml/snakeyaml/constructor/SafeConstructor$ConstructYamlMap", null, "java/lang/Object", new String[] { "org/yaml/snakeyaml/constructor/Construct" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/yaml/snakeyaml/constructor/SafeConstructor$ConstructYamlMap", "this$0", "Lorg/yaml/snakeyaml/constructor/SafeConstructor;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/yaml/snakeyaml/constructor/SafeConstructor$ConstructYamlMap", "this$0", "Lorg/yaml/snakeyaml/constructor/SafeConstructor;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/yaml/snakeyaml/constructor/SafeConstructor", "createDefaultMap", "(I)Ljava/util/Map;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/yaml/snakeyaml/constructor/SafeConstructor$ConstructYamlMap", "this$0", "Lorg/yaml/snakeyaml/constructor/SafeConstructor;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/yaml/snakeyaml/constructor/SafeConstructor", "constructMapping", "(Lorg/yaml/snakeyaml/nodes/MappingNode;)Ljava/util/Map;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/yaml/snakeyaml/constructor/SafeConstructor", "constructMapping2ndStep", "(Lorg/yaml/snakeyaml/nodes/MappingNode;Ljava/util/Map;)V", false);
...
methodVisitor.visitLdcInsn("Unexpected recursive mapping structure. Node: ");
