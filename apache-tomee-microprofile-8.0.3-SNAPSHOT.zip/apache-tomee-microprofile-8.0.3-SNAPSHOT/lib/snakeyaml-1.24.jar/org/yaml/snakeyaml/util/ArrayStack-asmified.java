...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/yaml/snakeyaml/util/ArrayStack", "<T:Ljava/lang/Object;>Ljava/lang/Object;", "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "stack", "Ljava/util/ArrayList;", "Ljava/util/ArrayList<TT;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/yaml/snakeyaml/util/ArrayStack", "stack", "Ljava/util/ArrayList;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/yaml/snakeyaml/util/ArrayStack", "stack", "Ljava/util/ArrayList;");
