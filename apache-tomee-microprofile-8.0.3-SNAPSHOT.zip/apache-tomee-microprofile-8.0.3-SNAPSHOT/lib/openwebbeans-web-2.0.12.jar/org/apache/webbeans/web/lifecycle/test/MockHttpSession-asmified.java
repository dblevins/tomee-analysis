...
public class MockHttpSessionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/web/lifecycle/test/MockHttpSession", null, "java/lang/Object", new String[] { "javax/servlet/http/HttpSession" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/webbeans/web/lifecycle/test/MockHttpSession", "ID", "Ljava/util/concurrent/atomic/AtomicInteger;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/web/lifecycle/test/MockHttpSession", "id", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/web/lifecycle/test/MockHttpSession", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/webbeans/web/lifecycle/test/MockHttpSession", "ID", "Ljava/util/concurrent/atomic/AtomicInteger;");
methodVisitor.visitInsn(RETURN);
