...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingServerResponseFilter", null, "java/lang/Object", new String[] { "jakarta/ws/rs/container/ContainerResponseFilter" });
...
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljakarta/ws/rs/container/ContainerResponseContext;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingServerResponseFilter", "lambda$filter$0", "(Ljakarta/ws/rs/container/ContainerResponseContext;Lio/opentracing/Scope;)V", false), Type.getType("(Lio/opentracing/Scope;)V")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$filter$0", "(Ljakarta/ws/rs/container/ContainerResponseContext;Lio/opentracing/Scope;)V", null, null);
methodVisitor.visitCode();
