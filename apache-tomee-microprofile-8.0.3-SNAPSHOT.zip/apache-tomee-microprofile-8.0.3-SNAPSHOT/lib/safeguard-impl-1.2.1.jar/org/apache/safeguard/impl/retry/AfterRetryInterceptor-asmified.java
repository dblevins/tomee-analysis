...
public class AfterRetryInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/safeguard/impl/retry/AfterRetryInterceptor", null, "org/apache/safeguard/impl/retry/BaseRetryInterceptor", null);
...
annotationVisitor0.visit("value", new Integer(4010));
annotationVisitor0.visitEnd();
}
