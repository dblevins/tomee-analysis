...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "findAnnotation", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;)Ljava/lang/annotation/Annotation;", "<T::Ljava/lang/annotation/Annotation;>(Ljava/lang/Class<TT;>;Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/lang/reflect/Method;)TT;", null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "getDirectMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljava/util/Set;)Ljava/util/Optional;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "getParentMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljava/util/Set;)Ljava/util/Optional;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "getFromDirectClass", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "getFromParentClass", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "getByReflection", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 8);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getFromDirectClass", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;)Ljava/lang/annotation/Annotation;", "<T::Ljava/lang/annotation/Annotation;>(Ljava/lang/Class<TT;>;Ljavax/enterprise/inject/spi/AnnotatedType<*>;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getParentMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljava/util/Set;)Ljava/util/Optional;", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/lang/reflect/Method;Ljava/util/Set<Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;)Ljava/util/Optional<Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getMethodAnnotation", "(Ljava/lang/Class;Ljava/util/Optional;)Ljava/lang/annotation/Annotation;", "<T::Ljava/lang/annotation/Annotation;>(Ljava/lang/Class<TT;>;Ljava/util/Optional<Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "isPresent", "()Z", false);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getDirectMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljava/util/Set;)Ljava/util/Optional;", "(Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/lang/reflect/Method;Ljava/util/Set<Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;)Ljava/util/Optional<Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "stream", "()Ljava/util/stream/Stream;", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInvokeDynamicInsn("test", "(Lorg/apache/safeguard/impl/annotation/AnnotationFinder;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;)Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "lambda$getDirectMethod$1", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljavax/enterprise/inject/spi/AnnotatedMethod;)Z", false), Type.getType("(Ljavax/enterprise/inject/spi/AnnotatedMethod;)Z")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "filter", "(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "findFirst", "()Ljava/util/Optional;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getFromParentClass", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;)Ljava/lang/annotation/Annotation;", "<T::Ljava/lang/annotation/Annotation;>(Ljava/lang/Class<TT;>;Ljavax/enterprise/inject/spi/AnnotatedType<*>;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/safeguard/impl/annotation/AnnotationFinder", "manager", "Ljavax/enterprise/inject/spi/BeanManager;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "matches", "(Ljava/lang/reflect/Method;Ljavax/enterprise/inject/spi/AnnotatedMethod;)Z", "(Ljava/lang/reflect/Method;Ljavax/enterprise/inject/spi/AnnotatedMethod<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getByReflection", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;)Ljava/lang/annotation/Annotation;", "<T::Ljava/lang/annotation/Annotation;>(Ljava/lang/Class<TT;>;Ljavax/enterprise/inject/spi/AnnotatedType<*>;Ljava/lang/reflect/Method;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "findAnnotation", "(Ljava/lang/Class;Ljavax/interceptor/InvocationContext;)Ljava/lang/annotation/Annotation;", "<T::Ljava/lang/annotation/Annotation;>(Ljava/lang/Class<TT;>;Ljavax/interceptor/InvocationContext;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInvokeDynamicInsn("get", "(Ljavax/interceptor/InvocationContext;)Ljava/util/function/Supplier;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/safeguard/impl/annotation/AnnotationFinder", "lambda$findAnnotation$4", "(Ljavax/interceptor/InvocationContext;)Ljava/lang/Class;", false), Type.getType("()Ljava/lang/Class;")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "orElseGet", "(Ljava/util/function/Supplier;)Ljava/lang/Object;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "findAnnotation", "(Ljava/lang/Class;Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$findAnnotation$4", "(Ljavax/interceptor/InvocationContext;)Ljava/lang/Class;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getByReflection$2", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedType", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$getDirectMethod$1", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljavax/enterprise/inject/spi/AnnotatedMethod;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedType", "getJavaClass", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/safeguard/impl/annotation/AnnotationFinder", "matches", "(Ljava/lang/reflect/Method;Ljavax/enterprise/inject/spi/AnnotatedMethod;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitInsn(ICONST_1);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$getParentMethod$0", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljava/lang/reflect/Method;Ljavax/enterprise/inject/spi/AnnotatedMethod;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedType", "getJavaClass", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ALOAD, 3);
