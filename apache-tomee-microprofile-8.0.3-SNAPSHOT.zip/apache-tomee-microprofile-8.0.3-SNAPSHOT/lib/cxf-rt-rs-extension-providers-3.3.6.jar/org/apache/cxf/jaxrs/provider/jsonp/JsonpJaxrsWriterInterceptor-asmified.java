...
public class JsonpJaxrsWriterInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", null, "java/lang/Object", new String[] { "jakarta/ws/rs/ext/WriterInterceptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "mediaType", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("(");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "paddingEnd", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "getCallbackValue", "(Lorg/apache/cxf/message/Message;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "getMediaType", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "getPaddingEnd", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "mediaType", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/provider/jsonp/JsonpJaxrsWriterInterceptor", "paddingEnd", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
