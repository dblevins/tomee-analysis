...
public class EmptyVisitor$2Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/apache/xbean/asm7/shade/commons/EmptyVisitor$2", null, "org/apache/xbean/asm7/FieldVisitor", null);

classWriter.visitOuterClass("org/apache/xbean/asm7/shade/commons/EmptyVisitor", null, null);

classWriter.visitInnerClass("org/apache/xbean/asm7/shade/commons/EmptyVisitor$2", null, null, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/asm7/shade/commons/EmptyVisitor$2", "this$0", "Lorg/apache/xbean/asm7/shade/commons/EmptyVisitor;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/asm7/shade/commons/EmptyVisitor$2", "this$0", "Lorg/apache/xbean/asm7/shade/commons/EmptyVisitor;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 2);
