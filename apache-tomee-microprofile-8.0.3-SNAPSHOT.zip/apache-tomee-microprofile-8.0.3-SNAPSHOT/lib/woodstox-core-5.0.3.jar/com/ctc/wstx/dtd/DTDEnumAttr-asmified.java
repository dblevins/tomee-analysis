...
public class DTDEnumAttrDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/ctc/wstx/dtd/DTDEnumAttr", null, "com/ctc/wstx/dtd/DTDAttribute", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mEnumValues", "Lcom/ctc/wstx/util/WordResolver;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mName", "Lcom/ctc/wstx/util/PrefixedName;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mDefValue", "Lcom/ctc/wstx/dtd/DefaultAttrValue;");
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mCfgNsAware", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mCfgXml11", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mEnumValues", "Lcom/ctc/wstx/util/WordResolver;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/dtd/DTDEnumAttr", "mEnumValues", "Lcom/ctc/wstx/util/WordResolver;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/dtd/DTDEnumAttr", "validateEnumValue", "([CIIZLcom/ctc/wstx/util/WordResolver;)Ljava/lang/String;", false);
...
methodVisitor.visitLdcInsn("Invalid enumerated value '");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/dtd/DTDEnumAttr", "reportValidationProblem", "(Lcom/ctc/wstx/dtd/DTDValidatorBase;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/dtd/DTDEnumAttr", "validateDefaultNmToken", "(Lcom/ctc/wstx/sr/InputProblemReporter;Z)Ljava/lang/String;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/dtd/DTDEnumAttr", "reportValidationProblem", "(Lcom/ctc/wstx/sr/InputProblemReporter;Ljava/lang/String;)Ljava/lang/String;", false);
