...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/xml/bind/v2/model/runtime/RuntimePropertyInfo", "getExpectedMimeType", "()Ljakarta/activation/MimeType;", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/xml/bind/v2/runtime/MimeTypedTransducer", "<init>", "(Lcom/sun/xml/bind/v2/runtime/Transducer;Ljakarta/activation/MimeType;)V", false);
methodVisitor.visitVarInsn(ASTORE, 1);
