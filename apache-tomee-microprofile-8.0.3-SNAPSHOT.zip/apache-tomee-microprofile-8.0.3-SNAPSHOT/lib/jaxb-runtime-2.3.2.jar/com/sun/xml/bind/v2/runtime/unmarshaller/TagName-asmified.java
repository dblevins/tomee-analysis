...
public class TagNameDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "com/sun/xml/bind/v2/runtime/unmarshaller/TagName", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "uri", "Ljava/lang/String;", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "atts", "Lorg/xml/sax/Attributes;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "matches", "(Lcom/sun/xml/bind/v2/runtime/Name;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/unmarshaller/TagName", "local", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
