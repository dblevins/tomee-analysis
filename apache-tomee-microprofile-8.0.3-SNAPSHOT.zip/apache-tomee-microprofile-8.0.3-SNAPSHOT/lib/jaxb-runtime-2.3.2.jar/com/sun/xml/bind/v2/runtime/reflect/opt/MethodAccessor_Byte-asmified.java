...
public class MethodAccessor_ByteDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/bind/v2/runtime/reflect/opt/MethodAccessor_Byte", null, "com/sun/xml/bind/v2/runtime/reflect/Accessor", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/reflect/opt/Bean", "get_byte", "()B", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/opt/MethodAccessor_Byte", "java/lang/Object", "java/lang/Object"}, 2, new Object[] {"com/sun/xml/bind/v2/runtime/reflect/opt/Bean", Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/reflect/opt/Bean", "set_byte", "(B)V", false);
methodVisitor.visitInsn(RETURN);
