...
public class ClassInfoImpl$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "com/sun/xml/bind/v2/model/impl/ClassInfoImpl$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/sun/xml/bind/v2/model/impl/ClassInfoImpl", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$sun$xml$bind$v2$model$impl$ClassInfoImpl$PropertyGroup", "[I", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/xml/bind/v2/model/impl/ClassInfoImpl$PropertyGroup", "values", "()[Lcom/sun/xml/bind/v2/model/impl/ClassInfoImpl$PropertyGroup;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/xml/bind/v2/model/impl/ClassInfoImpl$1", "$SwitchMap$com$sun$xml$bind$v2$model$impl$ClassInfoImpl$PropertyGroup", "[I");
...
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/xml/bind/v2/model/impl/ClassInfoImpl$1", "$SwitchMap$com$sun$xml$bind$v2$model$core$PropertyKind", "[I");
