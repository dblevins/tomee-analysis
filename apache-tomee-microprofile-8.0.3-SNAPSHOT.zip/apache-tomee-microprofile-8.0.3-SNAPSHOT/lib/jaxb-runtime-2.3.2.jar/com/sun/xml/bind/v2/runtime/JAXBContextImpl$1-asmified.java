...
classWriter.visit(V1_7, ACC_SUPER, "com/sun/xml/bind/v2/runtime/JAXBContextImpl$1", "Lcom/sun/istack/Pool$Impl<Ljavax/xml/bind/Marshaller;>;", "com/sun/istack/Pool$Impl", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "create", "()Ljavax/xml/bind/Marshaller;", null, null);
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/JAXBContextImpl$1", "create", "()Ljavax/xml/bind/Marshaller;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
