...
public class JAXBContextImpl$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "com/sun/xml/bind/v2/runtime/JAXBContextImpl$1", "Lcom/sun/istack/Pool$Impl<Ljakarta/xml/bind/Marshaller;>;", "com/sun/istack/Pool$Impl", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/v2/runtime/JAXBContextImpl$1", "this$0", "Lcom/sun/xml/bind/v2/runtime/JAXBContextImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "create", "()Ljakarta/xml/bind/Marshaller;", null, null);
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/JAXBContextImpl$1", "this$0", "Lcom/sun/xml/bind/v2/runtime/JAXBContextImpl;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/JAXBContextImpl$1", "create", "()Ljakarta/xml/bind/Marshaller;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
