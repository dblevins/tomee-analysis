...
public class LoadingLoaderClassLoadHelperDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/quartz/simpl/LoadingLoaderClassLoadHelper", null, "java/lang/Object", new String[] { "org/apache/openejb/quartz/spi/ClassLoadHelper" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/simpl/LoadingLoaderClassLoadHelper", "getClassLoader", "()Ljava/lang/ClassLoader;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/simpl/LoadingLoaderClassLoadHelper", "loadClass", "(Ljava/lang/String;)Ljava/lang/Class;", false);
methodVisitor.visitInsn(ARETURN);
