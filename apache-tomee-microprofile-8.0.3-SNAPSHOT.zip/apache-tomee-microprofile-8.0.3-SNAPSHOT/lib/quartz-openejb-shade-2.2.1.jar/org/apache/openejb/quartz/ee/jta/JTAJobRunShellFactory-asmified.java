...
public class JTAJobRunShellFactoryDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/quartz/ee/jta/JTAJobRunShellFactory", null, "java/lang/Object", new String[] { "org/apache/openejb/quartz/core/JobRunShellFactory" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/ee/jta/JTAJobRunShellFactory", "scheduler", "Lorg/apache/openejb/quartz/Scheduler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/ee/jta/JTAJobRunShellFactory", "scheduler", "Lorg/apache/openejb/quartz/Scheduler;");
methodVisitor.visitVarInsn(ALOAD, 1);
