...
public class SampledStatisticsDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/openejb/quartz/core/SampledStatistics", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getJobsExecutingMostRecentSample", "()J", null, null);
methodVisitor.visitEnd();
}
{
