...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/rs/security/oauth2/grants/code/AuthorizationCodeGrant", "toMap", "()Ljakarta/ws/rs/core/MultivaluedMap;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/ws/rs/core/MultivaluedMap", "org/apache/cxf/rs/security/jose/jwt/JwtClaims"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
