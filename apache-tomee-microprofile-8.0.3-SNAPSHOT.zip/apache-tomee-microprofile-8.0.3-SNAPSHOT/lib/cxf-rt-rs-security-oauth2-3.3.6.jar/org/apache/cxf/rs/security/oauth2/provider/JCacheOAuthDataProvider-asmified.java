...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "cacheManager", "Ljakarta/cache/CacheManager;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "clientCache", "Ljakarta/cache/Cache;", "Ljakarta/cache/Cache<Ljava/lang/String;Lorg/apache/cxf/rs/security/oauth2/common/Client;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "accessTokenCache", "Ljakarta/cache/Cache;", "Ljakarta/cache/Cache<Ljava/lang/String;Lorg/apache/cxf/rs/security/oauth2/common/ServerAccessToken;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "jwtAccessTokenCache", "Ljakarta/cache/Cache;", "Ljakarta/cache/Cache<Ljava/lang/String;Ljava/lang/String;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "refreshTokenCache", "Ljakarta/cache/Cache;", "Ljakarta/cache/Cache<Ljava/lang/String;Lorg/apache/cxf/rs/security/oauth2/tokens/refresh/RefreshToken;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "createCacheManager", "(Ljava/lang/String;Lorg/apache/cxf/Bus;)Ljakarta/cache/CacheManager;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "cacheManager", "Ljakarta/cache/CacheManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "cacheManager", "Ljakarta/cache/CacheManager;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLdcInsn(Type.getType("Ljava/lang/String;"));
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/rs/security/oauth2/common/Client;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "createCache", "(Ljakarta/cache/CacheManager;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Ljakarta/cache/Cache;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "clientCache", "Ljakarta/cache/Cache;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn(Type.getType("Ljava/lang/String;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "createCache", "(Ljakarta/cache/CacheManager;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Ljakarta/cache/Cache;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "jwtAccessTokenCache", "Ljakarta/cache/Cache;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "createCache", "(Ljakarta/cache/CacheManager;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Ljakarta/cache/Cache;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "accessTokenCache", "Ljakarta/cache/Cache;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "createCache", "(Ljakarta/cache/CacheManager;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Ljakarta/cache/Cache;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "refreshTokenCache", "Ljakarta/cache/Cache;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "clientCache", "Ljakarta/cache/Cache;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "accessTokenCache", "Ljakarta/cache/Cache;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "getTokens", "(Ljakarta/cache/Cache;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "refreshTokenCache", "Ljakarta/cache/Cache;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "getTokens", "(Ljakarta/cache/Cache;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "accessTokenCache", "Ljakarta/cache/Cache;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "getToken", "(Ljakarta/cache/Cache;Ljava/lang/String;)Lorg/apache/cxf/rs/security/oauth2/common/ServerAccessToken;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "jwtAccessTokenCache", "Ljakarta/cache/Cache;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/oauth2/common/ServerAccessToken", "getTokenKey", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/Cache", "replace", "(Ljava/lang/Object;Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getToken", "(Ljakarta/cache/Cache;Ljava/lang/String;)Lorg/apache/cxf/rs/security/oauth2/common/ServerAccessToken;", "<V:Lorg/apache/cxf/rs/security/oauth2/common/ServerAccessToken;>(Ljakarta/cache/Cache<Ljava/lang/String;TV;>;Ljava/lang/String;)TV;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/cache/Cache", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getTokens", "(Ljakarta/cache/Cache;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;)Ljava/util/List;", "<K:Ljava/lang/Object;V:Lorg/apache/cxf/rs/security/oauth2/common/ServerAccessToken;>(Ljakarta/cache/Cache<TK;TV;>;Lorg/apache/cxf/rs/security/oauth2/common/Client;Lorg/apache/cxf/rs/security/oauth2/common/UserSubject;)Ljava/util/List<TV;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/cache/Cache$Entry", "org/apache/cxf/rs/security/oauth2/common/ServerAccessToken"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/cache/Cache$Entry", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/rs/security/oauth2/provider/JCacheOAuthDataProvider", "jwtTokenConsumer", "Lorg/apache/cxf/rs/security/jose/jwt/JoseJwtConsumer;");
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"org/apache/cxf/rs/security/jose/jwt/JoseJwtConsumer"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "createCacheManager", "(Ljava/lang/String;Lorg/apache/cxf/Bus;)Ljakarta/cache/CacheManager;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"java/lang/String", "org/apache/cxf/Bus", "jakarta/cache/spi/CachingProvider"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "createCache", "(Ljakarta/cache/CacheManager;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Ljakarta/cache/Cache;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljakarta/cache/CacheManager;Ljava/lang/String;Ljava/lang/Class<TK;>;Ljava/lang/Class<TV;>;)Ljakarta/cache/Cache<TK;TV;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/cache/configuration/MutableConfiguration", "setTypes", "(Ljava/lang/Class;Ljava/lang/Class;)Ljakarta/cache/configuration/MutableConfiguration;", false);
methodVisitor.visitInsn(ICONST_1);
