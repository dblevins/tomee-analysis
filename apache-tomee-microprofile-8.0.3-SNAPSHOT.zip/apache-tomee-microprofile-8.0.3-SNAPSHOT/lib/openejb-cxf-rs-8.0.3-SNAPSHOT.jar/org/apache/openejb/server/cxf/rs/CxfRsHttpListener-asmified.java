...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "toRelease", "Ljava/util/Collection;", "Ljava/util/Collection<Ljavax/enterprise/context/spi/CreationalContext<*>;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/servlet/http/HttpServletRequestWrapper;"));
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "isInstance", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "org/apache/openejb/server/httpd/HttpRequest", "org/apache/openejb/server/httpd/HttpResponse", "javax/servlet/ServletRequest", "org/apache/openejb/server/httpd/HttpRequestImpl"}, 2, new Object[] {"org/apache/openejb/server/httpd/HttpRequestImpl", "java/lang/StringBuilder"});
methodVisitor.visitLdcInsn("");
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "org/apache/openejb/server/httpd/HttpRequest", "org/apache/openejb/server/httpd/HttpResponse", "javax/servlet/ServletRequest", "org/apache/openejb/server/httpd/HttpRequestImpl"}, 3, new Object[] {"org/apache/openejb/server/httpd/HttpRequestImpl", "java/lang/StringBuilder", "java/lang/String"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "matchPath", "(Ljavax/servlet/http/HttpServletRequest;)Z", false);
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ISTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "serveStaticContent", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljava/lang/String;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label7);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener$1", "<init>", "(Lorg/apache/openejb/server/cxf/rs/CxfRsHttpListener;Ljavax/servlet/http/HttpServletRequest;)V", false);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/transport/HttpDestination", "invoke", "(Ljavax/servlet/ServletConfig;Ljavax/servlet/ServletContext;Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "matchPath", "(Ljavax/servlet/http/HttpServletRequest;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "findStaticContent", "(Ljavax/servlet/http/HttpServletRequest;[Ljava/lang/String;)Ljava/io/InputStream;", null, new String[] { "javax/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpServletRequest", "getRequestURI", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/servlet/http/HttpServletRequest", "[Ljava/lang/String;", "java/lang/String", "[C", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "serveStaticContent", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljava/lang/String;)Z", null, new String[] { "javax/servlet/ServletException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "findStaticContent", "(Ljavax/servlet/http/HttpServletRequest;[Ljava/lang/String;)Ljava/io/InputStream;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/String", "java/io/InputStream"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label4);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/String", "java/io/InputStream", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 8);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findApplication", "()Ljavax/ws/rs/core/Application;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "applicationProvidesResources", "(Ljavax/ws/rs/core/Application;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isCXFResource", "(Ljavax/servlet/http/HttpServletRequest;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "findApplication", "()Ljavax/ws/rs/core/Application;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "applicationProvidesResources", "(Ljavax/ws/rs/core/Application;)Z", false);
Label label7 = new Label();
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/ws/rs/core/Application", "org/apache/cxf/jaxrs/JAXRSServiceImpl"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/servlet/http/HttpServletRequest", "javax/ws/rs/core/Application"}, 0, new Object[] {});
Label label11 = new Label();
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "deploySingleton", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljavax/ws/rs/core/Application;Ljava/util/Collection;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;)V", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljavax/ws/rs/core/Application;Ljava/util/Collection<Ljava/lang/Object;>;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;)V", null);
{
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "deploy", "(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/String;Lorg/apache/cxf/jaxrs/lifecycle/ResourceProvider;Ljava/lang/Object;Ljavax/ws/rs/core/Application;Lorg/apache/cxf/service/invoker/Invoker;Ljava/util/Collection;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;Lorg/apache/webbeans/config/WebBeansContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(11, 7);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "deployPojo", "(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;Ljavax/ws/rs/core/Application;Ljava/util/Collection;Ljavax/naming/Context;Lorg/apache/webbeans/config/WebBeansContext;Ljava/util/Collection;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;)V", "(Ljava/lang/ClassLoader;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class<*>;Ljavax/ws/rs/core/Application;Ljava/util/Collection<Lorg/apache/openejb/Injection;>;Ljavax/naming/Context;Lorg/apache/webbeans/config/WebBeansContext;Ljava/util/Collection<Ljava/lang/Object;>;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;)V", null);
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljava/lang/Deprecated;", true);
annotationVisitor0.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "deploy", "(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/String;Lorg/apache/cxf/jaxrs/lifecycle/ResourceProvider;Ljava/lang/Object;Ljavax/ws/rs/core/Application;Lorg/apache/cxf/service/invoker/Invoker;Ljava/util/Collection;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;Lorg/apache/webbeans/config/WebBeansContext;)V", "(Ljava/lang/String;Ljava/lang/Class<*>;Ljava/lang/String;Lorg/apache/cxf/jaxrs/lifecycle/ResourceProvider;Ljava/lang/Object;Ljavax/ws/rs/core/Application;Lorg/apache/cxf/service/invoker/Invoker;Ljava/util/Collection<Ljava/lang/Object;>;Lorg/apache/openejb/assembler/classic/util/ServiceConfiguration;Lorg/apache/webbeans/config/WebBeansContext;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "createEndpointName", "(Ljavax/ws/rs/core/Application;)Ljava/lang/String;", false);
...
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "java/lang/String", "java/lang/Class", "java/lang/String", "org/apache/cxf/jaxrs/lifecycle/ResourceProvider", "java/lang/Object", "javax/ws/rs/core/Application", "org/apache/cxf/service/invoker/Invoker", "java/util/Collection", "org/apache/openejb/assembler/classic/util/ServiceConfiguration", "org/apache/webbeans/config/WebBeansContext", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ws/rs/ConstrainedTo;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/ws/rs/ConstrainedTo");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/ConstrainedTo", "value", "()Ljavax/ws/rs/RuntimeType;", true);
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/ws/rs/ConstrainedTo"}, 0, null);
...
methodVisitor.visitJumpInsn(GOTO, label16);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "java/util/Iterator", "javax/enterprise/context/spi/CreationalContext"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "LOGGER", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
Label label15 = new Label();
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/lang/String", "java/util/Collection", "java/util/Map", "java/lang/ClassLoader", "java/util/Collection", "javax/naming/Context", "org/apache/webbeans/config/WebBeansContext", "org/apache/openejb/assembler/classic/util/ServiceConfiguration", "java/lang/ClassLoader", "org/apache/cxf/jaxrs/JAXRSServerFactoryBean", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 20, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/lang/String", "java/util/Collection", "java/util/Map", "java/lang/ClassLoader", "java/util/Collection", "javax/naming/Context", "org/apache/webbeans/config/WebBeansContext", "org/apache/openejb/assembler/classic/util/ServiceConfiguration", "java/lang/ClassLoader", "org/apache/cxf/jaxrs/JAXRSServerFactoryBean", "java/util/List", "java/util/logging/Level", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/UnsupportedOperationException"});
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "logEndpoints", "(Ljavax/ws/rs/core/Application;Ljava/lang/String;Ljava/util/Map;Lorg/apache/cxf/jaxrs/JAXRSServerFactoryBean;Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label12);
methodVisitor.visitVarInsn(ALOAD, 11);
...
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/lang/String", "java/util/Collection", "java/util/Map", "java/lang/ClassLoader", "java/util/Collection", "javax/naming/Context", "org/apache/webbeans/config/WebBeansContext", "org/apache/openejb/assembler/classic/util/ServiceConfiguration", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 22, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/lang/String", "java/util/Collection", "java/util/Map", "java/lang/ClassLoader", "java/util/Collection", "javax/naming/Context", "org/apache/webbeans/config/WebBeansContext", "org/apache/openejb/assembler/classic/util/ServiceConfiguration", "java/lang/ClassLoader", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 21);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label36);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/lang/String", "java/util/Collection", "java/util/Map", "java/lang/ClassLoader", "java/util/Collection", "javax/naming/Context", "org/apache/webbeans/config/WebBeansContext", "org/apache/openejb/assembler/classic/util/ServiceConfiguration", "java/lang/ClassLoader"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createEndpointName", "(Ljavax/ws/rs/core/Application;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "logEndpoints", "(Ljavax/ws/rs/core/Application;Ljava/lang/String;Ljava/util/Map;Lorg/apache/cxf/jaxrs/JAXRSServerFactoryBean;Ljava/lang/String;)V", "(Ljavax/ws/rs/core/Application;Ljava/lang/String;Ljava/util/Map<Ljava/lang/String;Lorg/apache/openejb/server/rest/EJBRestServiceInfo;>;Lorg/apache/cxf/jaxrs/JAXRSServerFactoryBean;Ljava/lang/String;)V", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/util/Map", "org/apache/cxf/jaxrs/JAXRSServerFactoryBean", "java/lang/String", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/cxf/jaxrs/JAXRSServiceImpl", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/util/Map", "org/apache/cxf/jaxrs/JAXRSServerFactoryBean", "java/lang/String", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/cxf/jaxrs/JAXRSServiceImpl", "java/util/List"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "LOGGER", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "javax/ws/rs/core/Application", "java/lang/String", "java/util/Map", "org/apache/cxf/jaxrs/JAXRSServerFactoryBean", "java/lang/String", "java/util/List", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/cxf/jaxrs/JAXRSServiceImpl", "java/util/List"}, 3, new Object[] {"org/apache/openejb/util/Logger", "java/lang/StringBuilder", "javax/ws/rs/core/Application"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/Object;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/util/Logger", "info", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener$5", "<init>", "(Lorg/apache/openejb/server/cxf/rs/CxfRsHttpListener;Ljavax/validation/Validator;)V", false);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitInsn(ICONST_1);
