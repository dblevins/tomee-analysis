...
public class SAXException2Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/istack/SAXException2", null, "org/xml/sax/SAXException", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/istack/SAXException2", "getException", "()Ljava/lang/Exception;", false);
