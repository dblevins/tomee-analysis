...
public class DOMHMACSignatureMethod$RIPEMD160Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/jcp/xml/dsig/internal/dom/DOMHMACSignatureMethod$RIPEMD160", null, "org/apache/jcp/xml/dsig/internal/dom/DOMHMACSignatureMethod", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jcp/xml/dsig/internal/dom/DOMHMACSignatureMethod", "<init>", "(Ljava/security/spec/AlgorithmParameterSpec;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/jcp/xml/dsig/internal/dom/DOMHMACSignatureMethod", "<init>", "(Lorg/w3c/dom/Element;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
