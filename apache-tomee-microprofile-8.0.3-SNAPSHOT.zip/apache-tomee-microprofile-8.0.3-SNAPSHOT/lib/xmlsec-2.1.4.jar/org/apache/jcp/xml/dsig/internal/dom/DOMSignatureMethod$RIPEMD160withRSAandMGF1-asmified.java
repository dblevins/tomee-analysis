...
public class DOMSignatureMethod$RIPEMD160withRSAandMGF1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/jcp/xml/dsig/internal/dom/DOMSignatureMethod$RIPEMD160withRSAandMGF1", null, "org/apache/jcp/xml/dsig/internal/dom/DOMSignatureMethod", null);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("RIPEMD160withRSAandMGF1");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
