...
public class XMLCipher$Factory$ReferenceListImpl$KeyReferenceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/xml/security/encryption/XMLCipher$Factory$ReferenceListImpl$KeyReference", null, "org/apache/xml/security/encryption/XMLCipher$Factory$ReferenceListImpl$ReferenceImpl", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/encryption/XMLCipher$Factory$ReferenceListImpl$KeyReference", "this$2", "Lorg/apache/xml/security/encryption/XMLCipher$Factory$ReferenceListImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
