...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/binding/xmldsig/SignaturePropertiesType", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "signatureProperty", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/xml/security/binding/xmldsig/SignaturePropertyType;>;", null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSignatureProperty", "()Ljava/util/List;", "()Ljava/util/List<Lorg/apache/xml/security/binding/xmldsig/SignaturePropertyType;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmldsig/SignaturePropertiesType", "signatureProperty", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmldsig/SignaturePropertiesType", "signatureProperty", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmldsig/SignaturePropertiesType", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmldsig/SignaturePropertiesType", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
