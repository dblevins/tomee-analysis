...
public class XMLSecEndDocumentImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/stax/impl/stax/XMLSecEndDocumentImpl", null, "org/apache/xml/security/stax/impl/stax/XMLSecEventBaseImpl", new String[] { "org/apache/xml/security/stax/ext/stax/XMLSecEndDocument" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "asEndEndDocument", "()Lorg/apache/xml/security/stax/ext/stax/XMLSecEndDocument;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
