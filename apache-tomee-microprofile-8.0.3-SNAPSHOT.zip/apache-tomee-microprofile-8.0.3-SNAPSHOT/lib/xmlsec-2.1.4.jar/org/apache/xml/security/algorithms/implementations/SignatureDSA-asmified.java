...
public class SignatureDSADump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/algorithms/implementations/SignatureDSA", null, "org/apache/xml/security/algorithms/SignatureAlgorithmSpi", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "URI", "Ljava/lang/String;", null, "http://www.w3.org/2000/09/xmldsig#dsa-sha1");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "engineGetURI", "()Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Created SignatureDSA using {}");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "signatureAlgorithm", "Ljava/security/Signature;");
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/xml/security/algorithms/implementations/SignatureDSA", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "signatureAlgorithm", "Ljava/security/Signature;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLdcInsn("Called DSA.verify() on ");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "size", "I");
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/xml/security/algorithms/implementations/SignatureDSA", "java/security/Key", "java/security/InvalidKeyException", "java/security/Signature"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "LOG", "Lorg/slf4j/Logger;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "size", "I");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 5);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "engineInitSign", "(Ljava/security/Key;Ljava/security/SecureRandom;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitTypeInsn(NEW, "org/apache/xml/security/signature/XMLSignatureException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("algorithms.CannotUseAlgorithmParameterSpecOnDSA");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/xml/security/signature/XMLSignatureException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/xml/security/algorithms/implementations/SignatureDSA", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitInsn(RETURN);
