...
public class TransformBase64Decode$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", null, "java/lang/Object", new String[] { "org/apache/xml/security/stax/impl/transformer/TransformIdentity$ChildOutputMethod" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "this$0", "Lorg/apache/xml/security/stax/impl/transformer/TransformBase64Decode;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "base64OutputStream", "Lorg/apache/commons/codec/binary/Base64OutputStream;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "byteArrayOutputStream", "Lorg/apache/xml/security/utils/UnsyncByteArrayOutputStream;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/codec/binary/Base64OutputStream");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "byteArrayOutputStream", "Lorg/apache/xml/security/utils/UnsyncByteArrayOutputStream;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "base64OutputStream", "Lorg/apache/commons/codec/binary/Base64OutputStream;");
...
methodVisitor.visitTryCatchBlock(label14, label15, label16, "org/apache/xml/security/exceptions/XMLSecurityException");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/io/InputStream", "java/lang/Throwable", "org/apache/xml/security/stax/impl/processor/input/XMLEventReaderInputProcessor"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "this$0", "Lorg/apache/xml/security/stax/impl/transformer/TransformBase64Decode;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "java/io/InputStream", "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2", "java/io/InputStream", "java/lang/Throwable", Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/xml/security/stax/impl/transformer/TransformBase64Decode$2"}, 0, new Object[] {});
