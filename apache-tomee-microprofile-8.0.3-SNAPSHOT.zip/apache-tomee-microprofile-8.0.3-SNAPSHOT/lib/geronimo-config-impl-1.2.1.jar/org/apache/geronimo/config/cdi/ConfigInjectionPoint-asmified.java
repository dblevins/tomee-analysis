...
public class ConfigInjectionPointDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/geronimo/config/cdi/ConfigInjectionPoint", null, "java/lang/Object", new String[] { "javax/enterprise/inject/spi/InjectionPoint" });
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljavax/enterprise/inject/spi/Bean;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/config/cdi/ConfigInjectionPoint", "bean", "Ljavax/enterprise/inject/spi/Bean;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/geronimo/config/cdi/DefaultLiteral", "INSTANCE", "Ljavax/enterprise/inject/Default;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/config/cdi/ConfigInjectionPoint", "bean", "Ljavax/enterprise/inject/spi/Bean;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
