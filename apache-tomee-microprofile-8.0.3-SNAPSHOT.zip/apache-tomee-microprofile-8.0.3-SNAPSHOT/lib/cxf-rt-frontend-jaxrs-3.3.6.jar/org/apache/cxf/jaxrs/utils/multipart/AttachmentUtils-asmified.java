...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getMultipart", "(Lorg/apache/cxf/jaxrs/ext/multipart/Multipart;Ljakarta/ws/rs/core/MediaType;Ljava/util/List;)Lorg/apache/cxf/jaxrs/ext/multipart/Attachment;", "(Lorg/apache/cxf/jaxrs/ext/multipart/Multipart;Ljakarta/ws/rs/core/MediaType;Ljava/util/List<Lorg/apache/cxf/jaxrs/ext/multipart/Attachment;>;)Lorg/apache/cxf/jaxrs/ext/multipart/Attachment;", new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/utils/multipart/AttachmentUtils", "checkMediaTypes", "(Ljakarta/ws/rs/core/MediaType;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "populateFormMap", "(Lorg/apache/cxf/jaxrs/ext/MessageContext;Z)Ljakarta/ws/rs/core/MultivaluedMap;", "(Lorg/apache/cxf/jaxrs/ext/MessageContext;Z)Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "populateFormMap", "(Lorg/apache/cxf/jaxrs/ext/MessageContext;)Ljakarta/ws/rs/core/MultivaluedMap;", "(Lorg/apache/cxf/jaxrs/ext/MessageContext;)Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxrs/utils/multipart/AttachmentUtils", "populateFormMap", "(Lorg/apache/cxf/jaxrs/ext/MessageContext;Z)Ljakarta/ws/rs/core/MultivaluedMap;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "checkMediaTypes", "(Ljakarta/ws/rs/core/MediaType;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
