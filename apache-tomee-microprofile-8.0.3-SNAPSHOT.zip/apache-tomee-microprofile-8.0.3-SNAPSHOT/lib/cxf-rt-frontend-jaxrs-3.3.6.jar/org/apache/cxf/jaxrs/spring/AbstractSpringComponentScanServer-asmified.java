...
annotationVisitor3.visit(null, Type.getType("Ljakarta/ws/rs/ApplicationPath;"));
annotationVisitor3.visit(null, Type.getType("Ljakarta/ws/rs/Path;"));
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/spring/AbstractSpringComponentScanServer", "createFactoryBeanFromApplication", "(Ljakarta/ws/rs/core/Application;)Lorg/apache/cxf/jaxrs/JAXRSServerFactoryBean;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/spring/AbstractSpringComponentScanServer", "applicationContext", "Lorg/springframework/context/ApplicationContext;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/cxf/jaxrs/spring/AbstractSpringComponentScanServer", "org/apache/cxf/jaxrs/JAXRSServerFactoryBean", "[Ljava/lang/String;", "java/util/Set", "java/util/Set", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/String", "jakarta/ws/rs/core/Application", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createFactoryBeanFromApplication", "(Ljakarta/ws/rs/core/Application;)Lorg/apache/cxf/jaxrs/JAXRSServerFactoryBean;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(ICONST_1);
