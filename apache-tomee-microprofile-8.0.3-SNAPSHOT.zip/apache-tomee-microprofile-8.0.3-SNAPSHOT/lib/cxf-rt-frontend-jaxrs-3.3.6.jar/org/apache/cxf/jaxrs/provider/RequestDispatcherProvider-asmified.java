...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider", "getServletContext", "()Ljakarta/servlet/ServletContext;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/servlet/ServletContext", "jakarta/servlet/http/HttpServletRequest", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider", "getRequestDispatcher", "(Ljakarta/servlet/ServletContext;Ljava/lang/Class;Ljava/lang/String;)Ljakarta/servlet/RequestDispatcher;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider$HttpServletRequestFilter", "<init>", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;Ljava/lang/String;Z)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider$HttpServletRequestFilter", "getSession", "(Z)Ljakarta/servlet/http/HttpSession;", false);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getServletContext", "()Ljakarta/servlet/ServletContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider", "getMessageContext", "()Lorg/apache/cxf/jaxrs/ext/MessageContext;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getRequestDispatcher", "(Ljakarta/servlet/ServletContext;Ljava/lang/Class;Ljava/lang/String;)Ljakarta/servlet/RequestDispatcher;", "(Ljakarta/servlet/ServletContext;Ljava/lang/Class<*>;Ljava/lang/String;)Ljakarta/servlet/RequestDispatcher;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/ws/rs/core/UriInfo", "jakarta/ws/rs/core/MultivaluedMap", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/jaxrs/provider/RequestDispatcherProvider", "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider$HttpServletRequestFilter", "jakarta/ws/rs/core/UriInfo", "jakarta/ws/rs/core/MultivaluedMap"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/provider/RequestDispatcherProvider", "doSetRequestParameters", "(Lorg/apache/cxf/jaxrs/provider/RequestDispatcherProvider$HttpServletRequestFilter;Ljakarta/ws/rs/core/MultivaluedMap;)V", false);
methodVisitor.visitLabel(label4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doSetRequestParameters", "(Lorg/apache/cxf/jaxrs/provider/RequestDispatcherProvider$HttpServletRequestFilter;Ljakarta/ws/rs/core/MultivaluedMap;)V", "(Lorg/apache/cxf/jaxrs/provider/RequestDispatcherProvider$HttpServletRequestFilter;Ljakarta/ws/rs/core/MultivaluedMap<Ljava/lang/String;Ljava/lang/String;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/ws/rs/core/MultivaluedMap", "entrySet", "()Ljava/util/Set;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
