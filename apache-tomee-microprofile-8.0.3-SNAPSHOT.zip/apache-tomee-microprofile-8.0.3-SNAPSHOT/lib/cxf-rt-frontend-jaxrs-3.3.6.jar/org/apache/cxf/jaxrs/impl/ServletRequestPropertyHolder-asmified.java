...
public class ServletRequestPropertyHolderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/impl/ServletRequestPropertyHolder", null, "java/lang/Object", new String[] { "org/apache/cxf/jaxrs/impl/PropertyHolderFactory$PropertyHolder" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/impl/ServletRequestPropertyHolder", "request", "Ljakarta/servlet/http/HttpServletRequest;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/impl/ServletRequestPropertyHolder", "request", "Ljakarta/servlet/http/HttpServletRequest;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/impl/ServletRequestPropertyHolder", "removeProperty", "(Ljava/lang/String;)V", false);
