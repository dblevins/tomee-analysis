...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxb/io/DataReaderImpl", "getValidationEventHandler", "(Lorg/apache/cxf/message/Message;Ljava/lang/String;)Ljavax/xml/bind/ValidationEventHandler;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxb/io/DataReaderImpl", "veventHandler", "Ljavax/xml/bind/ValidationEventHandler;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxb/io/DataReaderImpl", "veventHandler", "Ljavax/xml/bind/ValidationEventHandler;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createUnmarshaller", "()Ljavax/xml/bind/Unmarshaller;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTryCatchBlock(label3, label4, label5, "javax/xml/bind/UnmarshalException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxb/io/DataReaderImpl", "context", "Ljavax/xml/bind/JAXBContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxb/io/DataReaderImpl", "databinding", "Lorg/apache/cxf/jaxb/JAXBDataBinding;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxb/JAXBDataBinding", "getUnmarshallerListener", "()Ljavax/xml/bind/Unmarshaller$Listener;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxb/io/DataReaderImpl", "veventHandler", "Ljavax/xml/bind/ValidationEventHandler;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxb/io/DataReaderImpl$WSUIDValidationHandler", "<init>", "(Ljavax/xml/bind/ValidationEventHandler;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/jaxb/io/DataReaderImpl", "javax/xml/bind/Unmarshaller", "java/util/Iterator", "java/util/Map$Entry"}, 1, new Object[] {"javax/xml/bind/PropertyException"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxb/io/DataReaderImpl", "getAttachmentUnmarshaller", "()Ljavax/xml/bind/attachment/AttachmentUnmarshaller;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/cxf/jaxb/io/DataReaderImpl"}, 1, new Object[] {"javax/xml/bind/UnmarshalException"});
methodVisitor.visitVarInsn(ASTORE, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxb/io/DataReaderImpl", "getAttachmentUnmarshaller", "()Ljavax/xml/bind/attachment/AttachmentUnmarshaller;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxb/JAXBEncoderDecoder", "unmarshalWithBridge", "(Ljavax/xml/namespace/QName;Ljava/lang/Class;[Ljava/lang/annotation/Annotation;Ljava/util/Set;Ljava/lang/Object;Ljavax/xml/bind/attachment/AttachmentUnmarshaller;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxb/io/DataReaderImpl", "createUnmarshaller", "()Ljavax/xml/bind/Unmarshaller;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxb/JAXBEncoderDecoder", "unmarshall", "(Ljavax/xml/bind/Unmarshaller;Ljava/lang/Object;Lorg/apache/cxf/service/model/MessagePartInfo;Z)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxb/io/DataReaderImpl", "onCompleteUnmarshalling", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/jaxb/io/DataReaderImpl", "org/apache/cxf/service/model/MessagePartInfo", "java/lang/Object", Opcodes.INTEGER, "[Ljava/lang/annotation/Annotation;", "javax/xml/bind/Unmarshaller"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxb/io/DataReaderImpl", "javax/xml/namespace/QName", "java/lang/Object", "java/lang/Class", "javax/xml/bind/Unmarshaller"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/jaxb/JAXBUtils", "closeUnmarshaller", "(Ljavax/xml/bind/Unmarshaller;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/xml/bind/UnmarshalException"});
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/bind/UnmarshalException", "getLinkedException", "()Ljava/lang/Throwable;", false);
Label label4 = new Label();
