...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/log/logger/Slf4jLogger", null, "org/apache/openejb/log/logger/AbstractDelegatingLogger", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/log/logger/Slf4jLogger", "logger", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/log/logger/Slf4jLogger", "logger", "Lorg/slf4j/Logger;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/log/logger/Slf4jLogger", "locationAwareLogger", "Lorg/slf4j/spi/LocationAwareLogger;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/log/logger/Slf4jLogger", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/log/logger/Slf4jLogger", "getHandlers", "()[Ljava/util/logging/Handler;", false);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/openejb/log/logger/Slf4jLogger", "java/lang/String", "java/util/logging/LogRecord", "java/util/logging/Level", "java/lang/Throwable", "[Ljava/util/logging/Handler;", "[Ljava/util/logging/Handler;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/log/logger/Slf4jLogger", "getUseParentHandlers", "()Z", false);
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/log/logger/Slf4jLogger", "locationAwareLogger", "Lorg/slf4j/spi/LocationAwareLogger;");
Label label4 = new Label();
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/log/logger/Slf4jLogger", "FQCN", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/log/logger/Slf4jLogger", "FQCN", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
