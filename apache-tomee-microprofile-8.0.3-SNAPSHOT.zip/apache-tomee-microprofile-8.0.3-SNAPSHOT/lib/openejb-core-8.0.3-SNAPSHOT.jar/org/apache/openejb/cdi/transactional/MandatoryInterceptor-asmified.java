...
public class MandatoryInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/cdi/transactional/MandatoryInterceptor", null, "org/apache/openejb/cdi/transactional/InterceptorBase", null);
...
annotationVisitor0.visitEnum("value", "Ljakarta/transaction/Transactional$TxType;", "MANDATORY");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/transactional/MandatoryInterceptor", "getTransactionManager", "()Ljakarta/transaction/TransactionManager;", false);
