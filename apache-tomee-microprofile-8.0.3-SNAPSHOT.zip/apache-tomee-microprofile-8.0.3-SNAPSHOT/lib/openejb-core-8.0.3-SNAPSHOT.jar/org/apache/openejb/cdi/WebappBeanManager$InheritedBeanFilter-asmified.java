...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/cdi/WebappBeanManager$InheritedBeanFilter", "Ljava/lang/Object;Lorg/apache/openejb/cdi/WebappBeanManager$Filter<Ljakarta/enterprise/inject/spi/Bean<*>;>;", "java/lang/Object", new String[] { "org/apache/openejb/cdi/WebappBeanManager$Filter" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "accept", "(Ljakarta/enterprise/inject/spi/Bean;)Z", "(Ljakarta/enterprise/inject/spi/Bean<*>;)Z", null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/enterprise/inject/spi/PassivationCapable;"));
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "isInstance", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/cdi/WebappBeanManager$InheritedBeanFilter", "jakarta/enterprise/inject/spi/Bean", "java/util/Set"}, 2, new Object[] {"org/apache/openejb/cdi/WebappBeanManager", "java/lang/Class"});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/cdi/WebappBeanManager$InheritedBeanFilter", "jakarta/enterprise/inject/spi/Bean", "java/util/Set"}, 3, new Object[] {"org/apache/openejb/cdi/WebappBeanManager", "java/lang/Class", "[Ljava/lang/annotation/Annotation;"});
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/cdi/WebappBeanManager$InheritedBeanFilter", "beanManager", "Lorg/apache/openejb/cdi/WebappBeanManager;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/cdi/WebappBeanManager", "getPassivationCapableBean", "(Ljava/lang/String;)Ljakarta/enterprise/inject/spi/Bean;", false);
Label label0 = new Label();
