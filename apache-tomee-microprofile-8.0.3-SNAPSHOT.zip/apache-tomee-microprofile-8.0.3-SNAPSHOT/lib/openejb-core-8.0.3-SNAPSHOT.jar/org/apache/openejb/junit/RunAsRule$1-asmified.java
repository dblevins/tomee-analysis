...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/annotation/security/RunAs;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/annotation/security/RunAs");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/annotation/security/RunAs", "org/apache/openejb/junit/RunAsRule$As", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/junit/RunAsRule$1", "this$0", "Lorg/apache/openejb/junit/RunAsRule;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/annotation/security/RunAs", "value", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
