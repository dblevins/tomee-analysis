...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/openejb/core/mdb/AbstractEndpointHandler", null, "java/lang/Object", new String[] { "java/lang/reflect/InvocationHandler", "javax/resource/spi/endpoint/MessageEndpoint" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "beforeDelivery", "(Ljava/lang/reflect/Method;)V", null, new String[] { "javax/resource/spi/ApplicationServerInternalException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "recreateInstance", "(Z)V", null, new String[] { "javax/resource/spi/UnavailableException" });
methodVisitor.visitEnd();
}
{
...
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "javax/resource/spi/ApplicationServerInternalException");
Label label3 = new Label();
Label label4 = new Label();
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label5, "javax/resource/spi/ApplicationServerInternalException");
Label label6 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label6, "javax/resource/spi/UnavailableException");
...
methodVisitor.visitTryCatchBlock(label10, label11, label12, "javax/resource/spi/ApplicationServerInternalException");
Label label13 = new Label();
methodVisitor.visitTryCatchBlock(label10, label11, label13, "javax/resource/spi/UnavailableException");
Label label14 = new Label();
methodVisitor.visitTryCatchBlock(label7, label8, label14, "org/apache/openejb/ApplicationException");
Label label15 = new Label();
Label label16 = new Label();
Label label17 = new Label();
methodVisitor.visitTryCatchBlock(label15, label16, label17, "javax/resource/spi/ApplicationServerInternalException");
Label label18 = new Label();
methodVisitor.visitTryCatchBlock(label15, label16, label18, "javax/resource/spi/UnavailableException");
...
methodVisitor.visitTryCatchBlock(label22, label23, label24, "javax/resource/spi/ApplicationServerInternalException");
Label label25 = new Label();
methodVisitor.visitTryCatchBlock(label22, label23, label25, "javax/resource/spi/UnavailableException");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/resource/spi/ApplicationServerInternalException"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/resource/spi/ApplicationServerInternalException", "getCause", "()Ljava/lang/Throwable;", false);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/mdb/AbstractEndpointHandler", "java/lang/reflect/Method", "[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Throwable", "java/lang/Object"}, 1, new Object[] {"javax/resource/spi/ApplicationServerInternalException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/resource/spi/ApplicationServerInternalException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitJumpInsn(GOTO, label32);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/mdb/AbstractEndpointHandler", "java/lang/reflect/Method", "[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Throwable", "java/lang/Object"}, 1, new Object[] {"javax/resource/spi/UnavailableException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/resource/spi/UnavailableException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/mdb/AbstractEndpointHandler", "java/lang/reflect/Method", "[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Throwable", "java/lang/Object", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"javax/resource/spi/ApplicationServerInternalException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/mdb/AbstractEndpointHandler", "java/lang/reflect/Method", "[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Throwable", "java/lang/Object", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"javax/resource/spi/UnavailableException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/jms/Message");
