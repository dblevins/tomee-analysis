...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "work", "Ljakarta/resource/spi/work/Work;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "workListener", "Ljakarta/resource/spi/work/WorkListener;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "workException", "Ljakarta/resource/spi/work/WorkException;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/core/transaction/SimpleWorkManager;Ljakarta/resource/spi/work/Work;Ljakarta/resource/spi/work/WorkListener;J)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "work", "Ljakarta/resource/spi/work/Work;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workListener", "Ljakarta/resource/spi/work/WorkListener;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "org/apache/openejb/core/transaction/SimpleWorkManager", "jakarta/resource/spi/work/Work", "jakarta/resource/spi/work/WorkListener", Opcodes.LONG}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(LLOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "startTimeout", "J");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "jakarta/resource/spi/work/WorkRejectedException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/resource/spi/work/WorkRejectedException", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workException", "Ljakarta/resource/spi/work/WorkException;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workListener", "Ljakarta/resource/spi/work/WorkListener;");
methodVisitor.visitTypeInsn(NEW, "jakarta/resource/spi/work/WorkEvent");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "work", "Ljakarta/resource/spi/work/Work;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workException", "Ljakarta/resource/spi/work/WorkException;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "startTimeout", "J");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/resource/spi/work/WorkEvent", "<init>", "(Ljava/lang/Object;ILjakarta/resource/spi/work/Work;Ljakarta/resource/spi/work/WorkException;J)V", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/resource/spi/work/WorkListener", "workRejected", "(Ljakarta/resource/spi/work/WorkEvent;)V", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/resource/spi/work/WorkListener", "workStarted", "(Ljakarta/resource/spi/work/WorkEvent;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "started", "Ljava/util/concurrent/CountDownLatch;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/CountDownLatch", "countDown", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "work", "Ljakarta/resource/spi/work/Work;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/resource/spi/work/Work", "run", "()V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workListener", "Ljakarta/resource/spi/work/WorkListener;");
methodVisitor.visitTypeInsn(NEW, "jakarta/resource/spi/work/WorkEvent");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workException", "Ljakarta/resource/spi/work/WorkException;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/resource/spi/work/WorkEvent", "<init>", "(Ljava/lang/Object;ILjakarta/resource/spi/work/Work;Ljakarta/resource/spi/work/WorkException;)V", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/resource/spi/work/WorkListener", "workCompleted", "(Ljakarta/resource/spi/work/WorkEvent;)V", true);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/resource/spi/work/WorkCompletedException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workException", "Ljakarta/resource/spi/work/WorkException;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getWorkException", "()Ljakarta/resource/spi/work/WorkException;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/SimpleWorkManager$Worker", "workException", "Ljakarta/resource/spi/work/WorkException;");
