...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/core/stateful/SimpleCache$1", null, "java/lang/Object", new String[] { "java/util/concurrent/ThreadFactory" });

classWriter.visitOuterClass("org/apache/openejb/core/stateful/SimpleCache", "initScheduledExecutorService", "()V");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/openejb/core/stateful/SimpleCache;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/stateful/SimpleCache$1", "this$0", "Lorg/apache/openejb/core/stateful/SimpleCache;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("Stateful cache");
