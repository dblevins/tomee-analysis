...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Object;Lorg/apache/openejb/spi/SecurityService;Ljakarta/resource/spi/ResourceAdapter;Ljava/lang/Class;Ljava/lang/Class;ZLorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Pool$Builder;IZI)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "resourceAdapter", "Ljakarta/resource/spi/ResourceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "org/apache/openejb/spi/SecurityService", "jakarta/resource/spi/ResourceAdapter", "java/lang/Class", "java/lang/Class", Opcodes.INTEGER, "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER}, 11, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", label0, label0, "org/apache/openejb/spi/SecurityService", "jakarta/resource/spi/ResourceAdapter", "org/apache/openejb/core/mdb/InboundRecovery", "java/lang/Object", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "java/lang/Object", "org/apache/openejb/spi/SecurityService", "jakarta/resource/spi/ResourceAdapter", "java/lang/Class", "java/lang/Class", Opcodes.INTEGER, "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER}, 12, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", label0, label0, "org/apache/openejb/spi/SecurityService", "jakarta/resource/spi/ResourceAdapter", "org/apache/openejb/core/mdb/InboundRecovery", "java/lang/Object", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Pool$Builder", Opcodes.INTEGER, "java/util/concurrent/ScheduledExecutorService"});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbInstanceManager", "<init>", "(Lorg/apache/openejb/spi/SecurityService;Ljakarta/resource/spi/ResourceAdapter;Lorg/apache/openejb/core/mdb/InboundRecovery;Ljava/lang/Object;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Duration;Lorg/apache/openejb/util/Pool$Builder;ILjava/util/concurrent/ScheduledExecutorService;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbPoolContainer", "resourceAdapter", "Ljakarta/resource/spi/ResourceAdapter;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbPoolContainer", "createActivationSpec", "(Lorg/apache/openejb/BeanContext;)Ljakarta/resource/spi/ActivationSpec;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/mdb/MdbInstanceManager", "deploy", "(Lorg/apache/openejb/BeanContext;Ljakarta/resource/spi/ActivationSpec;Lorg/apache/openejb/core/mdb/EndpointFactory;)V", false);
methodVisitor.visitLabel(label1);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/mdb/MdbPoolContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "jakarta/resource/spi/ActivationSpec", "org/apache/openejb/core/mdb/EndpointFactory"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
