...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "defaultSubject", "Ljakarta/security/auth/Subject;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/security/AbstractSecurityService", "defaultUser", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/security/AbstractSecurityService", "createSubject", "(Ljava/lang/String;Ljava/lang/String;)Ljakarta/security/auth/Subject;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/security/AbstractSecurityService", "defaultSubject", "Ljakarta/security/auth/Subject;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/security/AbstractSecurityService$SecurityContext");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/security/AbstractSecurityService", "defaultSubject", "Ljakarta/security/auth/Subject;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/security/AbstractSecurityService$Identity", "access$000", "(Lorg/apache/openejb/core/security/AbstractSecurityService$Identity;)Ljakarta/security/auth/Subject;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/security/AbstractSecurityService$SecurityContext", "<init>", "(Ljakarta/security/auth/Subject;)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/security/AbstractSecurityService", "createRunAsSubject", "(Ljava/lang/String;Ljava/lang/String;)Ljakarta/security/auth/Subject;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createRunAsSubject", "(Ljava/lang/String;Ljava/lang/String;)Ljakarta/security/auth/Subject;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "registerSubject", "(Ljakarta/security/auth/Subject;)Ljava/util/UUID;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/security/AbstractSecurityService$Identity");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/security/AbstractSecurityService$Identity", "<init>", "(Ljakarta/security/auth/Subject;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/security/AbstractSecurityService$SecurityContext", "subject", "Ljakarta/security/auth/Subject;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createSubject", "(Ljava/lang/String;Ljava/lang/String;)Ljakarta/security/auth/Subject;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
