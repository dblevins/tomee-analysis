...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/TxBeanManaged", "suspendTransaction", "()Ljakarta/transaction/Transaction;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/transaction/TxBeanManaged", "clientTx", "Ljakarta/transaction/Transaction;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/TxBeanManaged", "getTransaction", "()Ljakarta/transaction/Transaction;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getUserTransaction", "()Ljakarta/transaction/UserTransaction;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/core/CoreUserTransaction");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/TxBeanManaged", "transactionManager", "Ljakarta/transaction/TransactionManager;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/transaction/TxBeanManaged$JtaSuspendedTransaction", "<init>", "(Ljakarta/transaction/Transaction;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/transaction/TxBeanManaged$JtaSuspendedTransaction", "access$000", "(Lorg/apache/openejb/core/transaction/TxBeanManaged$JtaSuspendedTransaction;)Ljakarta/transaction/Transaction;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/TxBeanManaged", "resumeTransaction", "(Ljakarta/transaction/Transaction;)V", false);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/TxBeanManaged", "rollbackTransaction", "(Ljakarta/transaction/Transaction;)V", false);
methodVisitor.visitLabel(label1);
Label label8 = new Label();
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openejb/core/transaction/TxBeanManaged", "jakarta/transaction/Transaction", "java/lang/String"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/transaction/TxBeanManaged", "clientTx", "Ljakarta/transaction/Transaction;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/transaction/TxBeanManaged", "resumeTransaction", "(Ljakarta/transaction/Transaction;)V", false);
