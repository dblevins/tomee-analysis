package asm.org.apache.openejb.core.ivm.naming.openejb;
...
public class openejbURLContextFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/ivm/naming/openejb/openejbURLContextFactory", null, "java/lang/Object", new String[] { "javax/naming/spi/ObjectFactory" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getContext", "()Ljavax/naming/Context;", null, new String[] { "javax/naming/NamingException" });
methodVisitor.visitCode();
