...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", null, "javax/xml/ws/spi/ServiceDelegate", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/core/webservices/ProviderWrapper;Ljavax/xml/ws/spi/ServiceDelegate;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", "serviceDelegate", "Ljavax/xml/ws/spi/ServiceDelegate;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", "org/apache/openejb/core/webservices/ProviderWrapper", "javax/xml/ws/spi/ServiceDelegate", "org/apache/openejb/core/webservices/ProviderWrapper$ProviderWrapperData"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", "serviceDelegate", "Ljavax/xml/ws/spi/ServiceDelegate;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", "setProperties", "(Ljavax/xml/ws/BindingProvider;Ljavax/xml/namespace/QName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/webservices/ProviderWrapper$ServiceDelegateWrapper", "javax/xml/ws/BindingProvider", "javax/xml/namespace/QName", "java/util/Iterator", "org/apache/openejb/core/webservices/PortRefData", "java/lang/Class"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
