...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Object;Lorg/apache/openejb/spi/SecurityService;Ljavax/resource/spi/ResourceAdapter;Ljava/lang/Class;Ljava/lang/Class;IZ)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/MdbContainer", "resourceAdapter", "Ljavax/resource/spi/ResourceAdapter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/MdbContainer", "resourceAdapter", "Ljavax/resource/spi/ResourceAdapter;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbContainer", "createActivationSpec", "(Lorg/apache/openejb/BeanContext;)Ljavax/resource/spi/ActivationSpec;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/resource/spi/ActivationSpec"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/mdb/MdbContainer$MdbActivationContext", "<init>", "(Ljava/lang/ClassLoader;Lorg/apache/openejb/BeanContext;Ljavax/resource/spi/ResourceAdapter;Lorg/apache/openejb/core/mdb/EndpointFactory;Ljavax/resource/spi/ActivationSpec;)V", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/mdb/MdbContainer", "org/apache/openejb/BeanContext", "java/lang/Object", "javax/resource/spi/ActivationSpec", "org/apache/openejb/loader/Options", Opcodes.INTEGER, "org/apache/openejb/core/mdb/MdbInstanceFactory", "org/apache/openejb/core/mdb/EndpointFactory"}, 1, new Object[] {"javax/resource/ResourceException"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/BeanContext", "setContainer", "(Lorg/apache/openejb/Container;)V", false);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/core/mdb/MdbContainer", "java/lang/Object", "org/apache/openejb/InterfaceType", "java/lang/Class", "java/lang/reflect/Method", "[Ljava/lang/Object;", "java/lang/Object", "org/apache/openejb/BeanContext", "org/apache/openejb/core/mdb/EndpointFactory", "org/apache/openejb/core/mdb/MdbInstanceFactory"}, 1, new Object[] {"javax/resource/spi/UnavailableException"});
methodVisitor.visitVarInsn(ASTORE, 11);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addJMxControl", "(Lorg/apache/openejb/BeanContext;Ljava/lang/String;Lorg/apache/openejb/core/mdb/MdbContainer$MdbActivationContext;)V", null, new String[] { "javax/resource/ResourceException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
