...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/security/SecurityContextHandler", "Ljava/lang/Object;Lorg/apache/geronimo/connector/work/WorkContextHandler<Ljakarta/resource/spi/work/SecurityContext;>;", "java/lang/Object", new String[] { "org/apache/geronimo/connector/work/WorkContextHandler" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "before", "(Ljakarta/resource/spi/work/SecurityContext;)V", null, new String[] { "jakarta/resource/spi/work/WorkCompletedException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/resource/spi/work/SecurityContext", "setupSecurityContext", "(Ljavax/security/auth/callback/CallbackHandler;Ljakarta/security/auth/Subject;Ljakarta/security/auth/Subject;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "after", "(Ljakarta/resource/spi/work/SecurityContext;)V", null, new String[] { "jakarta/resource/spi/work/WorkCompletedException" });
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/core/security/SecurityContextHandler", "jakarta/resource/spi/work/SecurityContext", "org/apache/openejb/spi/SecurityService", "java/lang/Object"}, 1, new Object[] {"javax/security/auth/login/LoginException"});
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/resource/spi/work/SecurityContext;"));
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/resource/spi/work/SecurityContext");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/security/SecurityContextHandler", "after", "(Ljakarta/resource/spi/work/SecurityContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/resource/spi/work/SecurityContext");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/security/SecurityContextHandler", "before", "(Ljakarta/resource/spi/work/SecurityContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
