...
public class FailOverRouter$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/resource/jdbc/router/FailOverRouter$2", null, "java/lang/Object", new String[] { "org/apache/openejb/resource/jdbc/router/FailOverRouter$Strategy" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/resource/jdbc/router/FailOverRouter$2", "this$0", "Lorg/apache/openejb/resource/jdbc/router/FailOverRouter;");
methodVisitor.visitVarInsn(ALOAD, 0);
