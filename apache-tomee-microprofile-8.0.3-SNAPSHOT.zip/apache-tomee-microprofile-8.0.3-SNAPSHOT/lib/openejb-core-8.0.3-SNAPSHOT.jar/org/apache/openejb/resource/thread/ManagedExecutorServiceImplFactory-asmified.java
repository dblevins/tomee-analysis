...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/resource/thread/ManagedExecutorServiceImplFactory", "threadFactory", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/resource/thread/ThreadFactories", "findThreadFactory", "(Ljava/lang/String;)Ljavax/enterprise/concurrent/ManagedThreadFactory;", false);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/enterprise/concurrent/ManagedThreadFactory"});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/enterprise/concurrent/ManagedThreadFactory"}, 0, null);
