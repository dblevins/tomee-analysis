...
public class ReadDescriptors$UrlSourceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/ReadDescriptors$UrlSource", null, "java/lang/Object", new String[] { "org/apache/openejb/config/ReadDescriptors$Source" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/ReadDescriptors$UrlSource", "url", "Ljava/net/URL;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/ReadDescriptors$UrlSource", "url", "Ljava/net/URL;");
...
methodVisitor.visitLdcInsn("UrlSource{url=");
