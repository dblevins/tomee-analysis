...
public class JndiEncInfoBuilder$SimpleRefDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/config/JndiEncInfoBuilder$SimpleRef", null, "java/lang/Object", new String[] { "org/apache/openejb/assembler/classic/EjbResolver$Reference" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/JndiEncInfoBuilder$SimpleRef", "name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/JndiEncInfoBuilder$SimpleRef", "name", "Ljava/lang/String;");
