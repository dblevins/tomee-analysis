...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/WsDeployer", "getWsdl", "(Lorg/apache/openejb/config/DeploymentModule;Ljava/lang/String;)Ljakarta/wsdl/Definition;", false);
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/config/WsDeployer", "org/apache/openejb/config/DeploymentModule", "org/apache/openejb/jee/JndiConsumer", "java/util/Iterator", "org/apache/openejb/jee/ServiceRef", "java/lang/String", "jakarta/wsdl/Definition", "java/util/Set"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/PortComponent", "setEnableMtom", "(Ljava/lang/Boolean;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/xml/ws/soap/MTOM"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/WsDeployer", "getLocationFromWsdl", "(Ljakarta/wsdl/Definition;Lorg/apache/openejb/jee/PortComponent;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 15);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getWsdl", "(Lorg/apache/openejb/config/DeploymentModule;Ljava/lang/String;)Ljakarta/wsdl/Definition;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/wsdl/Definition");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/WsDeployer", "readWsdl", "(Ljava/net/URL;)Ljakarta/wsdl/Definition;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/config/DeploymentModule", "getAltDDs", "()Ljava/util/Map;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "readWsdl", "(Ljava/net/URL;)Ljakarta/wsdl/Definition;", null, new String[] { "org/apache/openejb/OpenEJBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getLocationFromWsdl", "(Ljakarta/wsdl/Definition;Lorg/apache/openejb/jee/PortComponent;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"java/lang/Class", "java/lang/String", "java/lang/ClassLoader", "jakarta/jws/HandlerChain"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/Class", "java/lang/String", "java/lang/ClassLoader", "jakarta/jws/HandlerChain", "org/apache/openejb/jee/HandlerChains"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/OpenEJBException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
