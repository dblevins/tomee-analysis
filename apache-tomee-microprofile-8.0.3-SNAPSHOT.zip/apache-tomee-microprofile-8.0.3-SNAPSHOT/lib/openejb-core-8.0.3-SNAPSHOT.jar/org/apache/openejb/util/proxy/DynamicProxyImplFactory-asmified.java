...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/persistence/EntityManager", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/BeanContext", "java/lang/reflect/InvocationHandler", "jakarta/persistence/EntityManager", "java/util/Iterator", "org/apache/openejb/Injection"}, 1, new Object[] {"javax/naming/NamingException"});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/util/proxy/QueryProxy", "setEntityManager", "(Ljakarta/persistence/EntityManager;)V", false);
