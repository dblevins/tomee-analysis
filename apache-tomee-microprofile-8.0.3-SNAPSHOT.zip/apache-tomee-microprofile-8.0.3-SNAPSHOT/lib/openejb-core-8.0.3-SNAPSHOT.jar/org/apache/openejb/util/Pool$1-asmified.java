...
public class Pool$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/util/Pool$1", null, "java/lang/Object", new String[] { "java/util/concurrent/RejectedExecutionHandler" });

classWriter.visitOuterClass("org/apache/openejb/util/Pool", "createExecutor", "()Ljava/util/concurrent/Executor;");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/openejb/util/Pool;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/Pool$1", "this$0", "Lorg/apache/openejb/util/Pool;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn("Default pool executor failed to run asynchronous process: ");
