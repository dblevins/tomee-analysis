...
public class Pool$NoSupplierDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/util/Pool$NoSupplier", null, "java/lang/Object", new String[] { "org/apache/openejb/util/Pool$Supplier" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "discard", "(Ljava/lang/Object;Lorg/apache/openejb/util/Pool$Event;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/openejb/util/Pool$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/util/Pool$NoSupplier", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
