...
public class OpenEJB$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openejb/OpenEJB$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openejb/OpenEJB", null, null);

classWriter.visitInnerClass("org/apache/openejb/OpenEJB$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$ContainerType", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/OpenEJB$1", "$SwitchMap$org$apache$openejb$BeanType", "[I");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/ContainerType", "values", "()[Lorg/apache/openejb/ContainerType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/OpenEJB$1", "$SwitchMap$org$apache$openejb$ContainerType", "[I");
