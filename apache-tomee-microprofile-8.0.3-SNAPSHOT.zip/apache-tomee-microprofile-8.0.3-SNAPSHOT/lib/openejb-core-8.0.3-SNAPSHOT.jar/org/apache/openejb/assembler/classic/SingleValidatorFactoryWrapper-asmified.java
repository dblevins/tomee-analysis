...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/assembler/classic/SingleValidatorFactoryWrapper", null, "java/lang/Object", new String[] { "javax/validation/ValidatorFactory", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE | ACC_TRANSIENT, "factory", "Ljavax/validation/ValidatorFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/assembler/classic/SingleValidatorFactoryWrapper", "factory", "Ljavax/validation/ValidatorFactory;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/SingleValidatorFactoryWrapper", "factory", "()Ljavax/validation/ValidatorFactory;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "factory", "()Ljavax/validation/ValidatorFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/SingleValidatorFactoryWrapper", "factory", "Ljavax/validation/ValidatorFactory;");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/validation/ValidatorFactory"}, 0, null);
methodVisitor.visitInsn(RETURN);
