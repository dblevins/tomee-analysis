...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/assembler/classic/MethodScheduleBuilder", "org/apache/openejb/MethodContext", "org/apache/openejb/assembler/classic/MethodScheduleInfo", "java/util/Iterator", "org/apache/openejb/assembler/classic/ScheduleInfo", "jakarta/ejb/ScheduleExpression"}, 1, new Object[] {"jakarta/ejb/ScheduleExpression"});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ScheduleInfo", "second", "Ljava/lang/String;");
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/assembler/classic/MethodScheduleBuilder", "org/apache/openejb/MethodContext", "org/apache/openejb/assembler/classic/MethodScheduleInfo", "java/util/Iterator", "org/apache/openejb/assembler/classic/ScheduleInfo", "jakarta/ejb/ScheduleExpression"}, 2, new Object[] {"jakarta/ejb/ScheduleExpression", "java/lang/String"});
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/ejb/ScheduleExpression"});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ScheduleInfo", "minute", "Ljava/lang/String;");
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/assembler/classic/MethodScheduleBuilder", "org/apache/openejb/MethodContext", "org/apache/openejb/assembler/classic/MethodScheduleInfo", "java/util/Iterator", "org/apache/openejb/assembler/classic/ScheduleInfo", "jakarta/ejb/ScheduleExpression"}, 2, new Object[] {"jakarta/ejb/ScheduleExpression", "java/lang/String"});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/ejb/TimerConfig", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ScheduleInfo", "info", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ejb/TimerConfig", "setInfo", "(Ljava/io/Serializable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ScheduleInfo", "persistent", "Z");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ejb/TimerConfig", "setPersistent", "(Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/timer/ScheduleData", "<init>", "(Ljakarta/ejb/TimerConfig;Ljakarta/ejb/ScheduleExpression;)V", false);
