...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", null, "java/lang/Object", new String[] { "javax/persistence/EntityManagerFactory", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "delegate", "Ljavax/persistence/EntityManagerFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "delegate", "()Ljavax/persistence/EntityManagerFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "Ljavax/persistence/EntityManagerFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "entityManagerFactoryCallable", "Lorg/apache/openejb/assembler/classic/EntityManagerFactoryCallable;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "call", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "Ljavax/persistence/EntityManagerFactory;");
methodVisitor.visitLabel(label1);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/persistence/QueryLogEntityManager", "<init>", "(Ljavax/persistence/EntityManager;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "unwrap", "(Ljava/lang/Class;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "addNamedQuery", "(Ljava/lang/String;Ljavax/persistence/Query;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "addNamedEntityGraph", "(Ljava/lang/String;Ljavax/persistence/EntityGraph;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "getCriteriaBuilder", "()Ljavax/persistence/criteria/CriteriaBuilder;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "getMetamodel", "()Ljavax/persistence/metamodel/Metamodel;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "getCache", "()Ljavax/persistence/Cache;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManagerFactory", "getPersistenceUnitUtil", "()Ljavax/persistence/PersistenceUnitUtil;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDelegate", "()Ljavax/persistence/EntityManagerFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "delegate", "()Ljavax/persistence/EntityManagerFactory;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "setSharedCacheMode", "(Ljavax/persistence/SharedCacheMode;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "entityManagerFactoryCallable", "Lorg/apache/openejb/assembler/classic/EntityManagerFactoryCallable;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "getUnitInfo", "()Lorg/apache/openejb/persistence/PersistenceUnitInfoImpl;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "setValidationMode", "(Ljavax/persistence/ValidationMode;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "entityManagerFactoryCallable", "Lorg/apache/openejb/assembler/classic/EntityManagerFactoryCallable;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "getUnitInfo", "()Lorg/apache/openejb/persistence/PersistenceUnitInfoImpl;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "setTransactionType", "(Ljavax/persistence/spi/PersistenceUnitTransactionType;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "entityManagerFactoryCallable", "Lorg/apache/openejb/assembler/classic/EntityManagerFactoryCallable;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "getUnitInfo", "()Lorg/apache/openejb/persistence/PersistenceUnitInfoImpl;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "info", "()Ljavax/persistence/spi/PersistenceUnitInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ReloadableEntityManagerFactory", "entityManagerFactoryCallable", "Lorg/apache/openejb/assembler/classic/EntityManagerFactoryCallable;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable", "getUnitInfo", "()Lorg/apache/openejb/persistence/PersistenceUnitInfoImpl;", false);
