...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "entityManagersByDeploymentId", "Ljava/util/Map;", "Ljava/util/Map<Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId;Ljava/util/Map<Ljavax/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addEntityManagers", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId;Ljava/util/Map;)V", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId;Ljava/util/Map<Ljavax/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;)V", new String[] { "org/apache/openejb/persistence/EntityManagerAlreadyRegisteredException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry", "this$0", "Lorg/apache/openejb/persistence/JtaEntityManagerRegistry;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/persistence/JtaEntityManagerRegistry", "access$600", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry;)Ljavax/transaction/TransactionSynchronizationRegistry;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry", "org/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId", "java/util/Map", "java/util/Iterator", "java/util/Map$Entry", "javax/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "javax/persistence/EntityManager", "org/apache/openejb/persistence/EntityManagerTxKey", "javax/persistence/EntityManager"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "removeEntityManagers", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId;)Ljava/util/Map;", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId;)Ljava/util/Map<Ljavax/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getInheritedEntityManager", "(Ljavax/persistence/EntityManagerFactory;)Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/persistence/TransactionRequiredException", "<init>", "()V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/EntityManager", "joinTransaction", "()V", true);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry", "org/apache/openejb/persistence/JtaEntityManagerRegistry$InstanceId", "java/util/Map", "java/util/Iterator", "java/util/Map$Entry", "javax/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "javax/persistence/EntityManager"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/persistence/EntityManagerTxKey");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/persistence/EntityManagerTxKey", "<init>", "(Ljavax/persistence/EntityManagerFactory;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$400", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry;Ljavax/persistence/EntityManagerFactory;)Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry", "getInheritedEntityManager", "(Ljavax/persistence/EntityManagerFactory;)Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
