...
classWriter.visitOuterClass("org/apache/openejb/persistence/JtaQuery", "setParameter", "(ILjava/util/Calendar;Ljavax/persistence/TemporalType;)Ljavax/persistence/Query;");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/openejb/persistence/JtaQuery;ILjava/util/Calendar;Ljavax/persistence/TemporalType;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/persistence/JtaQuery$10", "val$temporalType", "Ljavax/persistence/TemporalType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/persistence/JtaQuery$10", "val$temporalType", "Ljavax/persistence/TemporalType;");
