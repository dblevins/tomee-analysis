...
public class ConfigFilesXmlValidationUtils$VersionCheckHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/config/ConfigFilesXmlValidationUtils$VersionCheckHandler", null, "org/xml/sax/helpers/DefaultHandler", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "version20OrLater", "Z", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isVersion20OrLater", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/config/ConfigFilesXmlValidationUtils$VersionCheckHandler", "version20OrLater", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/config/ConfigFilesXmlValidationUtils$VersionCheckHandler", "version20OrLater", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/ConfigFilesXmlValidationUtils$VersionCheckHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
