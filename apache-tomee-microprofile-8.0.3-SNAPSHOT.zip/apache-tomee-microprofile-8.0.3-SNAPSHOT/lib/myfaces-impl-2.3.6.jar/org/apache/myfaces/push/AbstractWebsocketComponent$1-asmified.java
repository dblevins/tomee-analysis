...
public class AbstractWebsocketComponent$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/push/AbstractWebsocketComponent$1", "Ljava/lang/Object;Ljava/util/Collection<Ljava/lang/String;>;", "java/lang/Object", new String[] { "java/util/Collection" });

classWriter.visitOuterClass("org/apache/myfaces/push/AbstractWebsocketComponent", "getEventNames", "()Ljava/util/Collection;");

classWriter.visitInnerClass("org/apache/myfaces/push/AbstractWebsocketComponent$1", null, null, 0);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/apache/myfaces/push/AbstractWebsocketComponent;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/myfaces/push/AbstractWebsocketComponent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/push/AbstractWebsocketComponent$1", "this$0", "Lorg/apache/myfaces/push/AbstractWebsocketComponent;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/push/AbstractWebsocketComponent$1", "add", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
