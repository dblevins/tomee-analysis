...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/application/_LocaleUtils$SyncAvoid", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/application/_LocaleUtils$SyncAvoid", "AVAILABLE_LOCALE_LIST", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/application/_LocaleUtils$SyncAvoid", "AVAILABLE_LOCALE_SET", "Ljava/util/Set;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 0);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/application/_LocaleUtils$SyncAvoid", "AVAILABLE_LOCALE_LIST", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/application/_LocaleUtils$SyncAvoid", "AVAILABLE_LOCALE_SET", "Ljava/util/Set;");
methodVisitor.visitInsn(RETURN);
