...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", null, "javax/faces/view/facelets/TagHandler", new String[] { "javax/faces/view/EditableValueHolderAttachedObjectHandler" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", "getAttribute", "(Ljava/lang/String;)Ljavax/faces/view/facelets/TagAttribute;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", "binding", "Ljavax/faces/view/facelets/TagAttribute;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", "javax/faces/view/facelets/TagConfig", "javax/faces/view/facelets/TagAttribute"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", "applyAttachedObject", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/UIComponent;)V", false);
Label label2 = new Label();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", "tag", "Ljavax/faces/view/facelets/Tag;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler", "binding", "Ljavax/faces/view/facelets/TagAttribute;");
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/jsf/core/ValueChangeListenerHandler$LazyValueChangeListener", "<init>", "(Ljava/lang/String;Ljavax/el/ValueExpression;)V", false);
