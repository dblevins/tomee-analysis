...
public class SelectItemsHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/core/SelectItemsHandler", null, "jakarta/faces/view/facelets/ComponentHandler", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getNoSelectionValue", "()Z", null, null);
methodVisitor.visitCode();
