...
public class _CommonPropertyConstantsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/view/facelets/component/_CommonPropertyConstants", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "markProperty", "(Ljavax/faces/component/UIComponent;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/view/facelets/component/_CommonPropertyConstants", "COMMON_PROPERTIES_KEY_BY_NAME", "Ljava/util/Map;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "markProperty", "(Ljavax/faces/component/UIComponent;J)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIComponent", "getAttributes", "()Ljava/util/Map;", false);
methodVisitor.visitLdcInsn("oam.COMMON_PROPERTIES_MARKED");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/view/facelets/component/_CommonPropertyConstants", "COMMON_PROPERTIES_KEY_BY_NAME", "Ljava/util/Map;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/view/facelets/component/_CommonPropertyConstants", "COMMON_PROPERTIES_KEY_BY_NAME", "Ljava/util/Map;");
