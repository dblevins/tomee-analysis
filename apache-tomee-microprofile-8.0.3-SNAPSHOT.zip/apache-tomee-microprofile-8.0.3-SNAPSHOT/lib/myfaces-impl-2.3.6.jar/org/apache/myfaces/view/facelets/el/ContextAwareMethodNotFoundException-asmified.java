...
public class ContextAwareMethodNotFoundExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/el/ContextAwareMethodNotFoundException", null, "jakarta/el/MethodNotFoundException", new String[] { "org/apache/myfaces/view/facelets/el/ContextAwareExceptionWrapper" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-8172862923048615707L));
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/el/MethodNotFoundException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/el/ContextAwareMethodNotFoundException", "_delegate", "Lorg/apache/myfaces/view/facelets/el/ContextAwareExceptionWrapper;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/el/ContextAwareMethodNotFoundException", "_delegate", "Lorg/apache/myfaces/view/facelets/el/ContextAwareExceptionWrapper;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/el/ContextAwareMethodNotFoundException", "getWrapped", "()Ljava/lang/Throwable;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
