...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/core/PhaseListenerHandler$LazyPhaseListener", null, "java/lang/Object", new String[] { "javax/faces/event/PhaseListener", "java/io/Serializable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/PhaseListenerHandler$LazyPhaseListener", "binding", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/PhaseListenerHandler$LazyPhaseListener", "binding", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/tag/jsf/core/PhaseListenerHandler$LazyPhaseListener", "getInstance", "()Ljavax/faces/event/PhaseListener;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
