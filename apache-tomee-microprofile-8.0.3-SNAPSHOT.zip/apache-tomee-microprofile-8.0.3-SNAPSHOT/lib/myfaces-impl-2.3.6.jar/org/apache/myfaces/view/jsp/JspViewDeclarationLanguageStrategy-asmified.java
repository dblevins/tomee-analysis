...
public class JspViewDeclarationLanguageStrategyDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "JSP_SUFFIX_PARAM_NAME", "Ljava/lang/String;", null, "org.apache.myfaces.JSP_SUFFIX");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "JSP_SUFFIX_DEFAULT", "Ljava/lang/String;", null, ".jsp");
fieldVisitor.visitEnd();
}
{
