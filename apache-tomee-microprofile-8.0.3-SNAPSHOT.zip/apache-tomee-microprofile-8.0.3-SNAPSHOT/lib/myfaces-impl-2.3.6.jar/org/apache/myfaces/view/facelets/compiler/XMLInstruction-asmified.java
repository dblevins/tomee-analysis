...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/compiler/XMLInstruction", null, "java/lang/Object", new String[] { "org/apache/myfaces/view/facelets/compiler/Instruction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/compiler/XMLInstruction", "_text", "Lorg/apache/myfaces/view/facelets/el/ELText;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/view/facelets/compiler/XMLInstruction", "STOP", "[C");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ResponseWriter", "writeText", "([CII)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/compiler/XMLInstruction", "_text", "Lorg/apache/myfaces/view/facelets/el/ELText;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/view/facelets/compiler/XMLInstruction", "STOP", "[C");
methodVisitor.visitInsn(RETURN);
