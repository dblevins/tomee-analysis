...
public class FaceletViewDeclarationLanguageStrategyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/FaceletViewDeclarationLanguageStrategy", null, "java/lang/Object", new String[] { "org/apache/myfaces/view/ViewDeclarationLanguageStrategy" });
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/FaceletViewDeclarationLanguageStrategy", "_extension", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/FaceletViewDeclarationLanguageStrategy", "_acceptPatterns", "Ljava/util/regex/Pattern;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/view/facelets/FaceletViewDeclarationLanguageStrategy", "toRegex", "(Ljava/lang/String;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMinimalImplicitOutcome", "(Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/myfaces/view/facelets/FaceletViewDeclarationLanguageStrategy;"));
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/view/facelets/FaceletViewDeclarationLanguageStrategy", "$assertionsDisabled", "Z");
methodVisitor.visitInsn(RETURN);
