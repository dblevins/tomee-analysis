...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/component/JsfElement", null, "javax/faces/component/UIPanel", new String[] { "javax/faces/component/behavior/ClientBehaviorHolder" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/view/facelets/component/_CommonEventConstants", "markEvent", "(Ljavax/faces/component/UIComponent;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/component/JsfElement", "getStateHelper", "()Ljavax/faces/component/StateHelper;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/view/facelets/component/_CommonPropertyConstants", "markProperty", "(Ljavax/faces/component/UIComponent;J)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
