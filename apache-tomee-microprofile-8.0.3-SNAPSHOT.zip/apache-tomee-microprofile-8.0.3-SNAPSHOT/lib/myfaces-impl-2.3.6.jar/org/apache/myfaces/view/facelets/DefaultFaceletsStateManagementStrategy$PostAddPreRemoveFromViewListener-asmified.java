...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/view/facelets/DefaultFaceletsStateManagementStrategy$PostAddPreRemoveFromViewListener", null, "java/lang/Object", new String[] { "javax/faces/event/SystemEventListener" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/DefaultFaceletsStateManagementStrategy$PostAddPreRemoveFromViewListener", "_facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/DefaultFaceletsStateManagementStrategy$PostAddPreRemoveFromViewListener", "_facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/DefaultFaceletsStateManagementStrategy$PostAddPreRemoveFromViewListener", "_facesContext", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/view/facelets/FaceletViewDeclarationLanguage", "isRemovingComponentBuild", "(Ljavax/faces/context/FacesContext;)Z", false);
