...
public class ResetValuesActionListenerHandler$LiteralResetValuesActionListenerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/tag/jsf/core/ResetValuesActionListenerHandler$LiteralResetValuesActionListener", null, "java/lang/Object", new String[] { "jakarta/faces/event/ActionListener", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/Collection;Ljakarta/faces/view/Location;)V", "(Ljava/util/Collection<Ljava/lang/String;>;Ljakarta/faces/view/Location;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ResetValuesActionListenerHandler$LiteralResetValuesActionListener", "clientIds", "Ljava/util/Collection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ResetValuesActionListenerHandler$LiteralResetValuesActionListener", "topCompositeComponentReference", "Ljakarta/faces/view/Location;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ResetValuesActionListenerHandler$LiteralResetValuesActionListener", "topCompositeComponentReference", "Ljakarta/faces/view/Location;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/tag/jsf/core/ResetValuesActionListenerHandler$LiteralResetValuesActionListener", "clientIds", "Ljava/util/Collection;");
