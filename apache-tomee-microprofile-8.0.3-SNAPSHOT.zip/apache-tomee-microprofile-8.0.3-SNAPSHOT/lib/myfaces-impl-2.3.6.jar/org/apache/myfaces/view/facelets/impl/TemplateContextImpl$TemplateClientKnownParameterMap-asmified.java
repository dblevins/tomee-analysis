...
public class TemplateContextImpl$TemplateClientKnownParameterMapDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "Lorg/apache/myfaces/util/AbstractAttributeMap<Ljava/lang/Boolean;>;", "org/apache/myfaces/util/AbstractAttributeMap", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "this$0", "Lorg/apache/myfaces/view/facelets/impl/TemplateContextImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getAttribute", "(Ljava/lang/String;)Ljava/lang/Boolean;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "this$0", "Lorg/apache/myfaces/view/facelets/impl/TemplateContextImpl;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "java/lang/String", "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateManagerImpl", Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setAttribute", "(Ljava/lang/String;Ljava/lang/Boolean;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "java/util/Set", "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateManagerImpl", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitIincInsn(3, 1);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,2, null, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "setAttribute", "(Ljava/lang/String;Ljava/lang/Boolean;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/view/facelets/impl/TemplateContextImpl$TemplateClientKnownParameterMap", "getAttribute", "(Ljava/lang/String;)Ljava/lang/Boolean;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
