...
public class AbstractAttributeMap$ValuesIteratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/myfaces/util/AbstractAttributeMap$ValuesIterator", "Lorg/apache/myfaces/util/AbstractAttributeMap<TV;>.AbstractAttributeIterator<TV;>;", "org/apache/myfaces/util/AbstractAttributeMap$AbstractAttributeIterator", null);

classWriter.visitInnerClass("org/apache/myfaces/util/AbstractAttributeMap$ValuesIterator", "org/apache/myfaces/util/AbstractAttributeMap", "ValuesIterator", ACC_PRIVATE);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/util/AbstractAttributeMap$ValuesIterator", "this$0", "Lorg/apache/myfaces/util/AbstractAttributeMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/util/AbstractAttributeMap$ValuesIterator", "this$0", "Lorg/apache/myfaces/util/AbstractAttributeMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/util/AbstractAttributeMap$ValuesIterator", "<init>", "(Lorg/apache/myfaces/util/AbstractAttributeMap;)V", false);
methodVisitor.visitInsn(RETURN);
