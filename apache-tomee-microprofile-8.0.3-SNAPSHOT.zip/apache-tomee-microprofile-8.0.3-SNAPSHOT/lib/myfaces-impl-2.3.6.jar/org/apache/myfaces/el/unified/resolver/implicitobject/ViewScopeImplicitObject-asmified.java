...
public class ViewScopeImplicitObjectDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/el/unified/resolver/implicitobject/ViewScopeImplicitObject", null, "org/apache/myfaces/el/unified/resolver/implicitobject/ImplicitObject", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "NAME", "Ljava/lang/String;", null, "viewScope");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("viewScope");
methodVisitor.visitLdcInsn("View scope attributes");
methodVisitor.visitLdcInsn(Type.getType("Ljava/util/Map;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/resolver/implicitobject/ViewScopeImplicitObject", "makeDescriptor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Class;)Ljava/beans/FeatureDescriptor;", false);
methodVisitor.visitInsn(ARETURN);
