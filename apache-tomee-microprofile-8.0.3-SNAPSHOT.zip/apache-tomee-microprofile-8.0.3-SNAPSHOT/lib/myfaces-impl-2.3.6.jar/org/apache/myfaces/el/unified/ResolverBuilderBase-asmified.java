...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "addFromRuntimeConfig", "(Ljava/util/List;)V", "(Ljava/util/List<Ljavax/el/ELResolver;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/unified/ResolverBuilderBase", "_config", "Lorg/apache/myfaces/config/RuntimeConfig;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/RuntimeConfig", "getVariableResolver", "()Ljavax/faces/el/VariableResolver;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/unified/ResolverBuilderBase", "_config", "Lorg/apache/myfaces/config/RuntimeConfig;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/RuntimeConfig", "getVariableResolver", "()Ljavax/faces/el/VariableResolver;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/ResolverBuilderBase", "createELResolver", "(Ljavax/faces/el/VariableResolver;)Ljavax/el/ELResolver;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/unified/ResolverBuilderBase", "_config", "Lorg/apache/myfaces/config/RuntimeConfig;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/RuntimeConfig", "getVariableResolverChainHead", "()Ljavax/faces/el/VariableResolver;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/unified/ResolverBuilderBase", "_config", "Lorg/apache/myfaces/config/RuntimeConfig;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/RuntimeConfig", "getPropertyResolver", "()Ljavax/faces/el/PropertyResolver;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/unified/ResolverBuilderBase", "_config", "Lorg/apache/myfaces/config/RuntimeConfig;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/RuntimeConfig", "getPropertyResolver", "()Ljavax/faces/el/PropertyResolver;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/el/unified/ResolverBuilderBase", "createELResolver", "(Ljavax/faces/el/PropertyResolver;)Ljavax/el/ELResolver;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/el/unified/ResolverBuilderBase", "_config", "Lorg/apache/myfaces/config/RuntimeConfig;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/config/RuntimeConfig", "getPropertyResolverChainHead", "()Ljavax/faces/el/PropertyResolver;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "sortELResolvers", "(Ljava/util/List;Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;)V", "(Ljava/util/List<Ljavax/el/ELResolver;>;Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "filterELResolvers", "(Ljava/util/List;Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;)Ljava/lang/Iterable;", "(Ljava/util/List<Ljavax/el/ELResolver;>;Lorg/apache/myfaces/el/unified/resolver/FacesCompositeELResolver$Scope;)Ljava/lang/Iterable<Ljavax/el/ELResolver;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInvokeDynamicInsn("test", "(Ljava/util/function/Predicate;)Ljava/util/function/Predicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Z"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/myfaces/el/unified/ResolverBuilderBase", "lambda$filterELResolvers$0", "(Ljava/util/function/Predicate;Ljavax/el/ELResolver;)Z", false), Type.getType("(Ljavax/el/ELResolver;)Z")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createELResolver", "(Ljavax/faces/el/VariableResolver;)Ljavax/el/ELResolver;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/el/convert/VariableResolverToELResolver");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/el/convert/VariableResolverToELResolver", "<init>", "(Ljavax/faces/el/VariableResolver;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createELResolver", "(Ljavax/faces/el/PropertyResolver;)Ljavax/el/ELResolver;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/el/convert/PropertyResolverToELResolver");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/el/convert/PropertyResolverToELResolver", "<init>", "(Ljavax/faces/el/PropertyResolver;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "isReplaceImplicitObjectResolverWithCDIResolver", "(Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getExternalContext", "()Ljavax/faces/context/ExternalContext;", false);
...
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/cdi/config/FacesConfigBeanHolder", "getFacesConfigVersion", "()Ljavax/faces/annotation/FacesConfig$Version;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label2 = new Label();
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/enterprise/inject/spi/BeanManager", "org/apache/myfaces/cdi/config/FacesConfigBeanHolder", "javax/faces/annotation/FacesConfig$Version"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$filterELResolvers$0", "(Ljava/util/function/Predicate;Ljavax/el/ELResolver;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
