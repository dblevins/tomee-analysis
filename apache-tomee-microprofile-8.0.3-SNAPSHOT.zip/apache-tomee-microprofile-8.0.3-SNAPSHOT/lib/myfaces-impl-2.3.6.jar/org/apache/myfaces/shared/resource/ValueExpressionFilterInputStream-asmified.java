...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/io/InputStream;Ljakarta/faces/application/Resource;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/io/InputStream", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "java/io/InputStream", "jakarta/faces/application/Resource"}, 1, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "java/io/InputStream", "jakarta/faces/application/Resource"}, 2, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "java/lang/String"});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "contractName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "libraryName", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/resource/ResourceELUtils", "saveResourceLibraryForResolver", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "contractName", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/resource/ResourceELUtils", "saveResourceContractForResolver", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/el/ValueExpression", "java/lang/String", Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/resource/ResourceELUtils", "removeResourceLibraryForResolver", "(Ljakarta/faces/context/FacesContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared/resource/ResourceELUtils", "removeResourceContractForResolver", "(Ljakarta/faces/context/FacesContext;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", Opcodes.INTEGER, "jakarta/faces/context/FacesContext", "jakarta/el/ELContext", "jakarta/el/ELException", "jakarta/faces/event/ExceptionQueuedEventContext", "java/util/logging/Logger"}, 2, new Object[] {"java/util/logging/Logger", "java/lang/StringBuilder"});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "libraryName", "Ljava/lang/String;");
methodVisitor.visitLabel(label22);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", Opcodes.INTEGER, "jakarta/faces/context/FacesContext", "jakarta/el/ELContext", "jakarta/el/ELException", "jakarta/faces/event/ExceptionQueuedEventContext", "java/util/logging/Logger"}, 3, new Object[] {"java/util/logging/Logger", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitLdcInsn(":");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", Opcodes.INTEGER, "jakarta/faces/context/FacesContext", "jakarta/el/ELContext"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", Opcodes.INTEGER, "jakarta/faces/context/FacesContext", "jakarta/el/ELContext", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "contractName", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", Opcodes.INTEGER, Opcodes.INTEGER, "java/util/List", Opcodes.INTEGER, "jakarta/faces/context/FacesContext", "jakarta/el/ELContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/resource/ValueExpressionFilterInputStream", "delegate", "Ljava/io/PushbackInputStream;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/PushbackInputStream", "read", "()I", false);
methodVisitor.visitInsn(IRETURN);
