...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/shared/context/ExceptionHandlerImpl", null, "jakarta/faces/context/ExceptionHandler", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/ExceptionHandlerImpl", "handledAndThrown", "Ljakarta/faces/event/ExceptionQueuedEvent;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/context/ExceptionHandlerImpl", "handledAndThrown", "Ljakarta/faces/event/ExceptionQueuedEvent;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/shared/context/ExceptionHandlerImpl", "wrap", "(Ljava/lang/Throwable;)Ljakarta/faces/FacesException;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/context/ExceptionHandlerImpl", "handled", "Ljava/util/Queue;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/event/ExceptionQueuedEvent", "jakarta/faces/event/ExceptionQueuedEventContext", "java/lang/Throwable"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/shared/context/ExceptionHandlerImpl", "jakarta/faces/FacesException", "jakarta/faces/event/ExceptionQueuedEvent", "jakarta/faces/event/ExceptionQueuedEventContext", "java/lang/Throwable"}, 3, new Object[] {"java/util/logging/Logger", "java/util/logging/Level", "java/lang/StringBuilder"});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/shared/context/ExceptionHandlerImpl", "jakarta/faces/FacesException", "jakarta/faces/event/ExceptionQueuedEvent", "jakarta/faces/event/ExceptionQueuedEventContext", "java/lang/Throwable"}, 4, new Object[] {"java/util/logging/Logger", "java/util/logging/Level", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/shared/context/ExceptionHandlerImpl", "jakarta/faces/FacesException", "jakarta/faces/event/ExceptionQueuedEvent"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 3);
