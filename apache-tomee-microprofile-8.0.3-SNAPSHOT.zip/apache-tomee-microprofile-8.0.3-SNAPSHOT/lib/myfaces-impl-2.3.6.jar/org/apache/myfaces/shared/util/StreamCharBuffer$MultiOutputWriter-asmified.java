...
public class StreamCharBuffer$MultiOutputWriterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/myfaces/shared/util/StreamCharBuffer$MultiOutputWriter", null, "java/io/Writer", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "writers", "Ljava/util/List;", "Ljava/util/List<Lorg/apache/myfaces/shared/util/StreamCharBuffer$ConnectedWriter;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/List;)V", "(Ljava/util/List<Lorg/apache/myfaces/shared/util/StreamCharBuffer$ConnectedWriter;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/io/Writer", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/shared/util/StreamCharBuffer$MultiOutputWriter", "writers", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/shared/util/StreamCharBuffer$MultiOutputWriter", "writers", "Ljava/util/List;");
...
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/shared/util/StreamCharBuffer$MultiOutputWriter", "append", "(Ljava/lang/CharSequence;II)Ljava/io/Writer;", false);
methodVisitor.visitInsn(ARETURN);
