...
public class FacesScopeBeanHolderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/cdi/scope/FacesScopeBeanHolder", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "FACES_SCOPE_MAP", "Ljava/lang/String;", null, "oam.FACES_SCOPE_MAP");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "FACES_SCOPE_MAP_INFO", "Ljava/lang/String;", null, "oam.FACES_SCOPE_MAP_INFO");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("oam.FACES_SCOPE_MAP_INFO");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/cdi/scope/FacesScopedContextImpl", "destroyAllActive", "(Lorg/apache/myfaces/cdi/util/ContextualStorage;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/myfaces/cdi/util/ContextualStorage"}, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
