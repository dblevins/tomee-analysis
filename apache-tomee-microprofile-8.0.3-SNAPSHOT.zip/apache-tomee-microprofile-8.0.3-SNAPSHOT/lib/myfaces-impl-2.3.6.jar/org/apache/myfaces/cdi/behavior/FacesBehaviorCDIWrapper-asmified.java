...
public class FacesBehaviorCDIWrapperDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/cdi/behavior/FacesBehaviorCDIWrapper", "_initialStateMarked", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/cdi/behavior/FacesBehaviorCDIWrapper", "behaviorId", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/cdi/behavior/FacesBehaviorCDIWrapper", "behaviorId", "Ljava/lang/String;");
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/cdi/behavior/FacesBehaviorCDIWrapper", "_transient", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/cdi/behavior/FacesBehaviorCDIWrapper", "_transient", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/cdi/behavior/FacesBehaviorCDIWrapper", "_initialStateMarked", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
