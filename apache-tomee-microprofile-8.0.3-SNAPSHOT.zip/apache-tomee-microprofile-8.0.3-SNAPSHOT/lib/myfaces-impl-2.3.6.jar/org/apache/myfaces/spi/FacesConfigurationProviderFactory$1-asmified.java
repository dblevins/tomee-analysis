...
classWriter.visitOuterClass("org/apache/myfaces/spi/FacesConfigurationProviderFactory", "getFacesConfigurationProviderFactory", "(Ljakarta/faces/context/ExternalContext;)Lorg/apache/myfaces/spi/FacesConfigurationProviderFactory;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/spi/FacesConfigurationProviderFactory$1", "val$ectx", "Ljakarta/faces/context/ExternalContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/spi/FacesConfigurationProviderFactory$1", "val$ectx", "Ljakarta/faces/context/ExternalContext;");
