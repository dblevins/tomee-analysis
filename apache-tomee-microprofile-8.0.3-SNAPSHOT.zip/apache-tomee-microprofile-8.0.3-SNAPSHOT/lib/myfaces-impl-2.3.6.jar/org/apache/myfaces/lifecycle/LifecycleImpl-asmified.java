...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/lifecycle/LifecycleImpl", null, "jakarta/faces/lifecycle/Lifecycle", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_phaseListenerList", "Ljava/util/List;", "Ljava/util/List<Ljakarta/faces/event/PhaseListener;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "clientWindowFactory", "Ljakarta/faces/lifecycle/ClientWindowFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/lifecycle/LifecycleImpl", "clientWindowFactory", "Ljakarta/faces/lifecycle/ClientWindowFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "getClientWindowFactory", "()Ljakarta/faces/lifecycle/ClientWindowFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getClientWindowFactory", "()Ljakarta/faces/lifecycle/ClientWindowFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/lifecycle/LifecycleImpl", "clientWindowFactory", "Ljakarta/faces/lifecycle/ClientWindowFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getExternalContext", "()Ljakarta/faces/context/ExternalContext;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/shared_impl/webapp/webxml/WebXml", "update", "(Ljakarta/faces/context/ExternalContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "getPhaseListeners", "()[Ljakarta/faces/event/PhaseListener;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/PhaseListenerManager", "<init>", "(Ljakarta/faces/lifecycle/Lifecycle;Ljakarta/faces/context/FacesContext;[Ljakarta/faces/event/PhaseListener;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/myfaces/lifecycle/LifecycleImpl", "jakarta/faces/context/FacesContext", "org/apache/myfaces/lifecycle/PhaseListenerManager", "[Lorg/apache/myfaces/lifecycle/PhaseExecutor;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "executePhase", "(Ljakarta/faces/context/FacesContext;Lorg/apache/myfaces/lifecycle/PhaseExecutor;Lorg/apache/myfaces/lifecycle/PhaseListenerManager;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "executePhase", "(Ljakarta/faces/context/FacesContext;Lorg/apache/myfaces/lifecycle/PhaseExecutor;Lorg/apache/myfaces/lifecycle/PhaseListenerManager;)Z", null, new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/PhaseExecutor", "getPhase", "()Ljakarta/faces/event/PhaseId;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/PhaseExecutor", "doPrePhaseActions", "(Ljakarta/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/PhaseListenerManager", "informPhaseListenersBefore", "(Ljakarta/faces/event/PhaseId;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "isResponseComplete", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;Z)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/PhaseListenerManager", "informPhaseListenersAfter", "(Ljakarta/faces/event/PhaseId;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/event/PhaseId", "jakarta/faces/context/Flash"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "shouldRenderResponse", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;Z)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/PhaseExecutor", "execute", "(Ljakarta/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "publishException", "(Ljava/lang/Throwable;Ljakarta/faces/event/PhaseId;Ljakarta/faces/context/FacesContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/lifecycle/LifecycleImpl", "requestProcessed", "(Ljakarta/faces/context/FacesContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/myfaces/lifecycle/PhaseListenerManager", "jakarta/faces/context/Flash"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/lifecycle/LifecycleImpl", "renderExecutor", "Lorg/apache/myfaces/lifecycle/PhaseExecutor;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/lifecycle/PhaseExecutor", "execute", "(Ljakarta/faces/context/FacesContext;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isResponseComplete", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;Z)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/lifecycle/LifecycleImpl", "jakarta/faces/context/FacesContext", "jakarta/faces/event/PhaseId", Opcodes.INTEGER, Opcodes.INTEGER}, 2, new Object[] {"java/util/logging/Logger", "java/lang/StringBuilder"});
methodVisitor.visitLdcInsn("after");
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/lifecycle/LifecycleImpl", "jakarta/faces/context/FacesContext", "jakarta/faces/event/PhaseId", Opcodes.INTEGER, Opcodes.INTEGER}, 3, new Object[] {"java/util/logging/Logger", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "shouldRenderResponse", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;Z)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "publishException", "(Ljava/lang/Throwable;Ljakarta/faces/event/PhaseId;Ljakarta/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "requestProcessed", "(Ljakarta/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
