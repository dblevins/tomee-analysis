...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/taglib/core/ValidateRequiredTag", null, "javax/faces/webapp/ValidatorELTag", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/myfaces/taglib/core/ValidateRequiredTag", "_binding", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/myfaces/taglib/core/ValidateRequiredTag", "_binding", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/myfaces/taglib/core/ValidateRequiredTag", "javax/faces/context/FacesContext", "javax/el/ELContext"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/faces/validator/RequiredValidator");
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/faces/validator/RequiredValidator");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label4);
Label label8 = new Label();
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/myfaces/taglib/core/ValidateRequiredTag", "javax/faces/context/FacesContext", "javax/el/ELContext", "javax/faces/application/Application", "javax/faces/validator/RequiredValidator"}, 1, new Object[] {"java/lang/Exception"});
