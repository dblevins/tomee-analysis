...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getName", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/shared/renderkit/html/HtmlRendererUtils$ScriptContext", "prettyLine", "()V", false);
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/component/behavior/AjaxBehavior");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/behavior/AjaxBehavior", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getResetValues", "()Ljava/lang/Boolean;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/component/behavior/AjaxBehavior", "java/lang/Boolean"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getOnerror", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getOnevent", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getClientId", "(Ljakarta/faces/context/FacesContext;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlCommandScriptRenderer", "makeAjax", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/behavior/ClientBehaviorContext;Ljakarta/faces/component/behavior/AjaxBehavior;Ljakarta/faces/component/html/HtmlCommandScript;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/shared/renderkit/html/HtmlRendererUtils$ScriptContext", "append", "(Ljava/lang/String;)Lorg/apache/myfaces/shared/renderkit/html/JavascriptContext;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "isAutorun", "()Z", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/Collection", "jakarta/faces/component/behavior/ClientBehaviorContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "isRendered", "()Z", false);
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/myfaces/renderkit/html/HtmlCommandScriptRenderer", "jakarta/faces/context/FacesContext", "jakarta/faces/component/UIComponent", "jakarta/faces/component/html/HtmlCommandScript", "java/util/Map", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIComponent", "getClientId", "(Ljakarta/faces/context/FacesContext;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/myfaces/renderkit/html/HtmlCommandScriptRenderer", "jakarta/faces/context/FacesContext", "jakarta/faces/component/UIComponent", "jakarta/faces/component/html/HtmlCommandScript", "java/util/Map", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "makeAjax", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/behavior/ClientBehaviorContext;Ljakarta/faces/component/behavior/AjaxBehavior;Ljakarta/faces/component/html/HtmlCommandScript;)Ljava/lang/StringBuilder;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getExecute", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlCommandScriptRenderer", "resolveExpressionsAsParameter", "(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljakarta/faces/component/search/SearchExpressionContext;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitLdcInsn("render");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getRender", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/renderkit/html/HtmlCommandScriptRenderer", "resolveExpressionsAsParameter", "(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljakarta/faces/component/search/SearchExpressionContext;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/myfaces/renderkit/html/HtmlCommandScriptRenderer", "jakarta/faces/context/FacesContext", "jakarta/faces/component/behavior/ClientBehaviorContext", "jakarta/faces/component/behavior/AjaxBehavior", "jakarta/faces/component/html/HtmlCommandScript", "java/lang/StringBuilder", "java/lang/StringBuilder", "jakarta/faces/component/search/SearchExpressionContext", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "jakarta/faces/component/UIComponent", "jakarta/faces/component/UIComponent"}, 1, new Object[] {"java/lang/IllegalArgumentException"});
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/html/HtmlCommandScript", "getChildren", "()Ljava/util/List;", false);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveExpressionsAsParameter", "(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljakarta/faces/component/search/SearchExpressionContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/component/search/SearchExpressionHandler", "java/util/List", Opcodes.INTEGER}, 0, null);
