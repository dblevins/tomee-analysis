package asm.org.apache.myfaces.flow.util;
...
public class FlowUtilsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/flow/util/FlowUtils", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getFlowMapKey", "(Ljavax/faces/context/FacesContext;Lorg/apache/myfaces/flow/FlowReference;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getFlowMapKey", "(Ljavax/faces/context/FacesContext;Ljavax/faces/flow/Flow;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/flow/util/FlowUtils", "getFlowIndex", "(Ljavax/faces/context/FacesContext;Ljavax/faces/flow/Flow;)I", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getFlowIndex", "(Ljavax/faces/context/FacesContext;Ljavax/faces/flow/Flow;)I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getApplication", "()Ljavax/faces/application/Application;", false);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"javax/faces/context/FacesContext", "javax/faces/flow/Flow", "java/util/List", "org/apache/myfaces/flow/FlowReference", Opcodes.INTEGER, "java/util/Iterator"}, 0, new Object[] {});
