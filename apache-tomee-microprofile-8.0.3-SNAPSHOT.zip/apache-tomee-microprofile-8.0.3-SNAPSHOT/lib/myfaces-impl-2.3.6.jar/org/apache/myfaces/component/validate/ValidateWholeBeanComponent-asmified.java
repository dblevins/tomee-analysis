...
public class ValidateWholeBeanComponentDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/component/validate/ValidateWholeBeanComponent", null, "jakarta/faces/component/UIInput", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "COMPONENT_TYPE", "Ljava/lang/String;", null, "org.apache.myfaces.component.validate.ValidateWholeBean");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/component/validate/ValidateWholeBeanComponent", "setRendererType", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("WholeBeanValidator");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/component/validate/ValidateWholeBeanComponent", "isDisabled", "()Z", false);
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/component/validate/ValidateWholeBeanComponent", "getValidators", "()[Ljakarta/faces/validator/Validator;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Boolean", "[Ljakarta/faces/validator/Validator;"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/component/validate/WholeBeanValidator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/component/validate/WholeBeanValidator", "<init>", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/myfaces/component/validate/ValidateWholeBeanComponent", "getStateHelper", "()Ljakarta/faces/component/StateHelper;", false);
