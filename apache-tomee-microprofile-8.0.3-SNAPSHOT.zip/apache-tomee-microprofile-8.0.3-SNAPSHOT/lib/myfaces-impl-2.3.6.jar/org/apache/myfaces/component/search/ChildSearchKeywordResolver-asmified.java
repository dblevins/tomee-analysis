...
public class ChildSearchKeywordResolverDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/component/search/ChildSearchKeywordResolver", null, "jakarta/faces/component/search/SearchKeywordResolver", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CHILD_KEYWORD", "Ljava/lang/String;", null, "child");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/myfaces/component/search/ChildSearchKeywordResolver", "PATTERN", "Ljava/util/regex/Pattern;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/myfaces/component/search/ChildSearchKeywordResolver", "PATTERN", "Ljava/util/regex/Pattern;");
methodVisitor.visitInsn(RETURN);
