...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/myfaces/component/search/IdSearchKeywordResolver", null, "jakarta/faces/component/search/SearchKeywordResolver", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/search/SearchKeywordContext", "getSearchExpressionContext", "()Ljakarta/faces/component/search/SearchExpressionContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/search/SearchExpressionContext", "getExpressionHints", "()Ljava/util/Set;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/myfaces/component/search/IdSearchKeywordResolver", "withId", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/ContextCallback;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/component/search/IdSearchKeywordResolver$1", "<init>", "(Lorg/apache/myfaces/component/search/IdSearchKeywordResolver;Ljava/lang/String;Ljakarta/faces/component/search/SearchKeywordContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "withId", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/ContextCallback;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
