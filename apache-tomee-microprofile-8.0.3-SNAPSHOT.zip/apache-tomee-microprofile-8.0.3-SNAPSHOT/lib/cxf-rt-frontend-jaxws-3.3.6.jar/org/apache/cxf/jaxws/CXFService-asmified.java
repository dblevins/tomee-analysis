...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/cxf/jaxws/CXFService", null, "jakarta/xml/ws/Service", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/ServiceImpl", "initialize", "(Lorg/apache/cxf/Bus;Ljava/net/URL;[Ljakarta/xml/ws/WebServiceFeature;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_VARARGS, "<init>", "(Lorg/apache/cxf/Bus;Ljava/net/URL;Ljavax/xml/namespace/QName;[Ljakarta/xml/ws/WebServiceFeature;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/ws/spi/ServiceDelegate");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/reflect/Field", "jakarta/xml/ws/spi/ServiceDelegate"}, 0, null);
