...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxws/spi/ProviderImpl", null, "jakarta/xml/ws/spi/Provider", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/ServiceImpl", "<init>", "(Lorg/apache/cxf/Bus;Ljava/net/URL;Ljavax/xml/namespace/QName;Ljava/lang/Class;[Ljakarta/xml/ws/WebServiceFeature;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(7, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "createServiceDelegate", "(Ljava/net/URL;Ljavax/xml/namespace/QName;Ljava/lang/Class;[Ljakarta/xml/ws/WebServiceFeature;)Ljakarta/xml/ws/spi/ServiceDelegate;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljakarta/xml/ws/WebServiceFeature;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_VARARGS, "createEndpointImpl", "(Lorg/apache/cxf/Bus;Ljava/lang/String;Ljava/lang/Object;[Ljakarta/xml/ws/WebServiceFeature;)Lorg/apache/cxf/jaxws/EndpointImpl;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/xml/ws/WebServiceFeature");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl", "createEndpointImpl", "(Lorg/apache/cxf/Bus;Ljava/lang/String;Ljava/lang/Object;[Ljakarta/xml/ws/WebServiceFeature;)Lorg/apache/cxf/jaxws/EndpointImpl;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/xml/ws/Endpoint"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "jakarta/xml/ws/WebServiceException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl", "createEndpoint", "(Ljava/lang/String;Ljava/lang/Object;)Ljakarta/xml/ws/Endpoint;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/Endpoint", "publish", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl", "createEndpoint", "(Ljava/lang/String;Ljava/lang/Object;[Ljakarta/xml/ws/WebServiceFeature;)Ljakarta/xml/ws/Endpoint;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/Endpoint", "publish", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/Invoker", "inject", "(Ljakarta/xml/ws/WebServiceContext;)V", false);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl", "createW3CEndpointReference", "(Ljava/lang/String;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;Ljavax/xml/namespace/QName;Ljava/util/List;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/Map;)Ljakarta/xml/ws/wsaddressing/W3CEndpointReference;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(10, 7);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "convertToInternal", "(Ljakarta/xml/ws/EndpointReference;)Lorg/apache/cxf/ws/addressing/EndpointReferenceType;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/xml/ws/wsaddressing/W3CEndpointReference");
Label label5 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/xml/ws/EndpointReference", "jakarta/xml/bind/Unmarshaller"}, 1, new Object[] {"jakarta/xml/bind/JAXBException"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl", "createServiceDelegate", "(Ljava/net/URL;Ljavax/xml/namespace/QName;Ljava/lang/Class;)Ljakarta/xml/ws/spi/ServiceDelegate;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getJAXBContext", "()Ljakarta/xml/bind/JAXBContext;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/xml/bind/JAXBException");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/jaxws/spi/ProviderImpl", "jaxbContext", "Ljakarta/xml/bind/JAXBContext;");
Label label3 = new Label();
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/bind/JAXBContext", "newInstance", "([Ljava/lang/Class;)Ljakarta/xml/bind/JAXBContext;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/jaxws/spi/ProviderImpl", "jaxbContext", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitLabel(label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "()Ljakarta/xml/bind/JAXBContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxws/spi/ProviderImpl", "getJAXBContext", "()Ljakarta/xml/bind/JAXBContext;", false);
methodVisitor.visitInsn(ARETURN);
