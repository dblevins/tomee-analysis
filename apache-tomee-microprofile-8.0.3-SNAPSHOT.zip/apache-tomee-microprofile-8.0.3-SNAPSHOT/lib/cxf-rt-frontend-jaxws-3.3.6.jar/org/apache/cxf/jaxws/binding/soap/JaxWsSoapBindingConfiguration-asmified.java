...
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jws/soap/SOAPBinding", "use", "()Ljakarta/jws/soap/SOAPBinding$Use;", true);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/jws/soap/SOAPBinding$Use", "LITERAL", "Ljakarta/jws/soap/SOAPBinding$Use;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/jws/soap/SOAPBinding$Use", "equals", "(Ljava/lang/Object;)Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
