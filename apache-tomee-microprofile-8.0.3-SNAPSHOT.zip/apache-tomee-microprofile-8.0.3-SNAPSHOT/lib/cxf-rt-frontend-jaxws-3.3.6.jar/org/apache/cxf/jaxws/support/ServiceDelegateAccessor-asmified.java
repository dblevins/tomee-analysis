...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "get", "(Ljakarta/xml/ws/Service;)Lorg/apache/cxf/jaxws/ServiceImpl;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/xml/ws/Service", "org/apache/cxf/jaxws/ServiceImpl"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/xml/ws/Service", "org/apache/cxf/jaxws/ServiceImpl", "java/lang/Exception"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
