...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxws/interceptors/MessageModeOutInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/service/model/BindingOperationInfo", "org/apache/cxf/message/MessageContentsList", "javax/activation/DataSource", "java/lang/String", "org/apache/cxf/message/Message"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxws/interceptors/MessageModeOutInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/service/model/BindingOperationInfo", "org/apache/cxf/message/MessageContentsList", "javax/activation/DataSource", "java/lang/String", "java/io/OutputStream"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/interceptor/Fault");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validateFault", "(Lorg/apache/cxf/binding/soap/SoapMessage;Ljavax/xml/soap/SOAPFault;Lorg/apache/cxf/service/model/BindingOperationInfo;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/jaxws/interceptors/MessageModeOutInterceptor", "org/apache/cxf/binding/soap/SoapMessage", "javax/xml/soap/SOAPFault", "org/apache/cxf/service/model/BindingOperationInfo", "javax/xml/validation/Schema", "javax/xml/soap/Detail"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Object", "javax/xml/soap/SOAPMessage"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label12);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/cxf/binding/soap/SoapMessage", "java/lang/String", "javax/xml/soap/SOAPHeader"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPHeader", "getNamespaceURI", "()Ljava/lang/String;", true);
methodVisitor.visitLabel(label13);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/soap/SOAPMessage", "getProperty", "(Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/cxf/jaxws/interceptors/MessageModeOutInterceptor;Lorg/apache/cxf/binding/soap/SoapMessage;Ljavax/xml/soap/SOAPFault;Lorg/apache/cxf/service/model/BindingOperationInfo;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/interceptors/MessageModeOutInterceptor", "validateFault", "(Lorg/apache/cxf/binding/soap/SoapMessage;Ljavax/xml/soap/SOAPFault;Lorg/apache/cxf/service/model/BindingOperationInfo;)V", false);
methodVisitor.visitInsn(RETURN);
