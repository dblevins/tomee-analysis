package asm.org.apache.cxf.jaxws.binding.http;
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/binding/AbstractBindingImpl", "setHandlerChain", "(Ljava/util/List;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/binding/http/HTTPBindingImpl", "validate", "()V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/binding/http/HTTPBindingImpl", "getHandlerChain", "()Ljava/util/List;", false);
...
methodVisitor.visitLdcInsn("Adding an incompatible handler in HTTPBinding: ");
