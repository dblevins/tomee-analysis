...
public class ELArithmetic$DoubleDelegateDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/el/lang/ELArithmetic$DoubleDelegate", null, "org/apache/el/lang/ELArithmetic", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/el/lang/ELSupport", "isStringFloat", "(Ljava/lang/String;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
