...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;Ljavax/el/ELContext;)V", null, new String[] { "javax/el/ELException" });
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/el/lang/FunctionMapperFactory", "<init>", "(Ljavax/el/FunctionMapper;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/lang/ExpressionBuilder", "fnMapper", "Ljavax/el/FunctionMapper;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/el/lang/ExpressionBuilder", "java/lang/String", "javax/el/ELContext", "javax/el/FunctionMapper", "javax/el/VariableMapper"}, 0, new Object[] {});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/el/lang/VariableMapperFactory", "<init>", "(Ljavax/el/VariableMapper;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/lang/ExpressionBuilder", "varMapper", "Ljavax/el/VariableMapper;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "createNode", "(Ljava/lang/String;)Lorg/apache/el/parser/Node;", null, new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "createNodeInternal", "(Ljava/lang/String;)Lorg/apache/el/parser/Node;", null, new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "prepare", "(Lorg/apache/el/parser/Node;)V", null, new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/lang/ExpressionBuilder", "fnMapper", "Ljavax/el/FunctionMapper;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/el/lang/FunctionMapperFactory", "create", "()Ljavax/el/FunctionMapper;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/lang/ExpressionBuilder", "fnMapper", "Ljavax/el/FunctionMapper;");
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/lang/ExpressionBuilder", "varMapper", "Ljavax/el/VariableMapper;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/el/lang/VariableMapperFactory", "create", "()Ljavax/el/VariableMapper;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/lang/ExpressionBuilder", "varMapper", "Ljavax/el/VariableMapper;");
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "build", "()Lorg/apache/el/parser/Node;", null, new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "visit", "(Lorg/apache/el/parser/Node;)V", null, new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createValueExpression", "(Ljava/lang/Class;)Ljavax/el/ValueExpression;", "(Ljava/lang/Class<*>;)Ljavax/el/ValueExpression;", new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/lang/ExpressionBuilder", "varMapper", "Ljavax/el/VariableMapper;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/el/ValueExpressionImpl", "<init>", "(Ljava/lang/String;Lorg/apache/el/parser/Node;Ljavax/el/FunctionMapper;Ljavax/el/VariableMapper;Ljava/lang/Class;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(7, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createMethodExpression", "(Ljava/lang/Class;[Ljava/lang/Class;)Ljavax/el/MethodExpression;", "(Ljava/lang/Class<*>;[Ljava/lang/Class<*>;)Ljavax/el/MethodExpression;", new String[] { "javax/el/ELException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/el/lang/ExpressionBuilder", "build", "()Lorg/apache/el/parser/Node;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/el/MethodExpressionImpl", "<init>", "(Ljava/lang/String;Lorg/apache/el/parser/Node;Ljavax/el/FunctionMapper;Ljavax/el/VariableMapper;Ljava/lang/Class;[Ljava/lang/Class;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
