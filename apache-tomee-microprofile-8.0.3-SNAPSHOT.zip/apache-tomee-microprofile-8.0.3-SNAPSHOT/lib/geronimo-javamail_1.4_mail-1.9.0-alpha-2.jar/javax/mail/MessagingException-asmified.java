...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "javax/mail/MessagingException", null, "java/lang/Exception", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-7569192289819959253L));
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/MessagingException", "next", "Ljava/lang/Exception;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/MessagingException", "next", "Ljava/lang/Exception;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/MessagingException", "next", "Ljava/lang/Exception;");
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/mail/MessagingException");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/MessagingException", "next", "Ljava/lang/Exception;");
methodVisitor.visitTypeInsn(CHECKCAST, "javax/mail/MessagingException");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/mail/MessagingException", "setNextException", "(Ljava/lang/Exception;)Z", false);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/mail/MessagingException", "getNextException", "()Ljava/lang/Exception;", false);
