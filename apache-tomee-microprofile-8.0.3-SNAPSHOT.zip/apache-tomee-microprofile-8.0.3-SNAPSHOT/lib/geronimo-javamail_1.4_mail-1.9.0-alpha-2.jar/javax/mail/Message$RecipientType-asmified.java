...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "javax/mail/Message$RecipientType", null, "java/lang/Object", new String[] { "java/io/Serializable" });

classWriter.visitInnerClass("javax/mail/Message$RecipientType", "javax/mail/Message", "RecipientType", ACC_PUBLIC | ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "TO", "Ljavax/mail/Message$RecipientType;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CC", "Ljavax/mail/Message$RecipientType;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "BCC", "Ljavax/mail/Message$RecipientType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/Message$RecipientType", "type", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/Message$RecipientType", "type", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "javax/mail/Message$RecipientType");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("To");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/mail/Message$RecipientType", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/mail/Message$RecipientType", "TO", "Ljavax/mail/Message$RecipientType;");
methodVisitor.visitTypeInsn(NEW, "javax/mail/Message$RecipientType");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Cc");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/mail/Message$RecipientType", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/mail/Message$RecipientType", "CC", "Ljavax/mail/Message$RecipientType;");
methodVisitor.visitTypeInsn(NEW, "javax/mail/Message$RecipientType");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Bcc");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/mail/Message$RecipientType", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/mail/Message$RecipientType", "BCC", "Ljavax/mail/Message$RecipientType;");
methodVisitor.visitInsn(RETURN);
