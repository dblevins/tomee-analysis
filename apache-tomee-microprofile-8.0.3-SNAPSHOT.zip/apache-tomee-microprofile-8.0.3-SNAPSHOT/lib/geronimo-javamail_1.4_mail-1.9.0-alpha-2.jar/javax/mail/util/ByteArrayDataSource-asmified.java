...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "javax/mail/util/ByteArrayDataSource", null, "java/lang/Object", new String[] { "javax/activation/DataSource" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/ByteArrayDataSource", "name", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/ByteArrayDataSource", "source", "[B");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/mail/util/ByteArrayDataSource", "contentType", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/mail/internet/MimeUtility", "getDefaultJavaCharset", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/util/ByteArrayDataSource", "source", "[B");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Writing to a ByteArrayDataSource is not supported");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/util/ByteArrayDataSource", "contentType", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/mail/util/ByteArrayDataSource", "name", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
