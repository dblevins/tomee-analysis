...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "inbox", "Ljakarta/mail/Folder;", null, null);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/javamail/store/pop3/POP3RootFolder", "getInbox", "()Ljakarta/mail/Folder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "open", "(Z)V", null, new String[] { "jakarta/mail/MessagingException" });
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/mail/MessagingException");
methodVisitor.visitInsn(DUP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getInbox", "()Ljakarta/mail/Folder;", null, new String[] { "jakarta/mail/MessagingException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/javamail/store/pop3/POP3RootFolder", "inbox", "Ljakarta/mail/Folder;");
Label label0 = new Label();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/javamail/store/pop3/POP3RootFolder", "store", "Ljakarta/mail/Store;");
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/geronimo/javamail/store/pop3/POP3Store");
methodVisitor.visitLdcInsn("INBOX");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/javamail/store/pop3/POP3Folder", "<init>", "(Lorg/apache/geronimo/javamail/store/pop3/POP3Store;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/javamail/store/pop3/POP3RootFolder", "inbox", "Ljakarta/mail/Folder;");
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/javamail/store/pop3/POP3RootFolder", "inbox", "Ljakarta/mail/Folder;");
methodVisitor.visitInsn(ARETURN);
