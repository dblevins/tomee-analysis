...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "parseNameValuePair", "()Lorg/apache/geronimo/javamail/authentication/DigestMD5Authenticator$NameValuePair;", null, new String[] { "javax/mail/MessagingException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
