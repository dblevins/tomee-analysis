...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/javamail/handlers/RFC822MessageHandler", null, "java/lang/Object", new String[] { "jakarta/activation/DataContentHandler" });
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/mail/Message;"));
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/javamail/handlers/RFC822MessageHandler", "getContent", "(Ljakarta/activation/DataSource;)Ljava/lang/Object;", false);
