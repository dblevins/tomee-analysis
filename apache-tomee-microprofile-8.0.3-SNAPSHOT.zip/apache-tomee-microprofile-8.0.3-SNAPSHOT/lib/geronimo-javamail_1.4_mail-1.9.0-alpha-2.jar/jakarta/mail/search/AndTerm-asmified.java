...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "jakarta/mail/search/AndTerm", null, "jakarta/mail/search/SearchTerm", null);
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/mail/search/AndTerm", "terms", "[Ljakarta/mail/search/SearchTerm;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/search/AndTerm", "terms", "[Ljakarta/mail/search/SearchTerm;");
