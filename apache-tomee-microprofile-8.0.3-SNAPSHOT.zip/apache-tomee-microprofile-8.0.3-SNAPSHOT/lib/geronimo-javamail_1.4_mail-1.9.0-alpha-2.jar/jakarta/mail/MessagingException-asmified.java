...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/mail/MessagingException", null, "java/lang/Exception", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/mail/MessagingException", "next", "Ljava/lang/Exception;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/MessagingException", "next", "Ljava/lang/Exception;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/MessagingException", "next", "Ljava/lang/Exception;");
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/mail/MessagingException");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/mail/MessagingException", "next", "Ljava/lang/Exception;");
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/mail/MessagingException");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/mail/MessagingException", "getNextException", "()Ljava/lang/Exception;", false);
