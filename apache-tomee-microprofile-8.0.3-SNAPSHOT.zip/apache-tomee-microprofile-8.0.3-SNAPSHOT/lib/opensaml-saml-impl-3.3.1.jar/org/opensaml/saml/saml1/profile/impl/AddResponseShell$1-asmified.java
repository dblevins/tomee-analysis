...
public class AddResponseShell$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/opensaml/saml/saml1/profile/impl/AddResponseShell$1", "Ljava/lang/Object;Lcom/google/common/base/Function<Lorg/opensaml/profile/context/ProfileRequestContext;Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;>;", "java/lang/Object", new String[] { "com/google/common/base/Function" });

classWriter.visitOuterClass("org/opensaml/saml/saml1/profile/impl/AddResponseShell", "<init>", "()V");

classWriter.visitInnerClass("org/opensaml/saml/saml1/profile/impl/AddResponseShell$1", null, null, 0);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/opensaml/saml/saml1/profile/impl/AddResponseShell;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/opensaml/saml/saml1/profile/impl/AddResponseShell;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddResponseShell$1", "this$0", "Lorg/opensaml/saml/saml1/profile/impl/AddResponseShell;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml1/profile/impl/AddResponseShell$1", "apply", "(Lorg/opensaml/profile/context/ProfileRequestContext;)Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
