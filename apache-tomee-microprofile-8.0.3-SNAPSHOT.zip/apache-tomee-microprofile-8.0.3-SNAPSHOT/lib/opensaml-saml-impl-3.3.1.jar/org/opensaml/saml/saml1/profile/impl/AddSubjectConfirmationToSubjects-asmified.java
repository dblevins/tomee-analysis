...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", null, "org/opensaml/profile/action/AbstractProfileAction", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "confirmationBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;", "Lorg/opensaml/saml/common/SAMLObjectBuilder<Lorg/opensaml/saml/saml1/core/SubjectConfirmation;>;", null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "confirmationMethodBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;", "Lorg/opensaml/saml/common/SAMLObjectBuilder<Lorg/opensaml/saml/saml1/core/ConfirmationMethod;>;", null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "confirmationMethods", "Ljava/util/Collection;", "Ljava/util/Collection<Ljava/lang/String;>;", null);
{
annotationVisitor0 = fieldVisitor.visitAnnotation("Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "artifactProfile", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "subjectBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/core/xml/config/XMLObjectProviderRegistrySupport", "getBuilderFactory", "()Lorg/opensaml/core/xml/XMLObjectBuilderFactory;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/core/xml/XMLObjectBuilderFactory", "getBuilderOrThrow", "(Ljavax/xml/namespace/QName;)Lorg/opensaml/core/xml/XMLObjectBuilder;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/common/SAMLObjectBuilder");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "confirmationBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/core/xml/config/XMLObjectProviderRegistrySupport", "getBuilderFactory", "()Lorg/opensaml/core/xml/XMLObjectBuilderFactory;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/core/xml/XMLObjectBuilderFactory", "getBuilderOrThrow", "(Ljavax/xml/namespace/QName;)Lorg/opensaml/core/xml/XMLObjectBuilder;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/common/SAMLObjectBuilder");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "confirmationMethodBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "overwriteExisting", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "responseLookupStrategy", "Lcom/google/common/base/Function;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Collections", "emptyList", "()Ljava/util/List;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "confirmationMethods", "Ljava/util/Collection;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setMethods", "(Ljava/util/Collection;)V", "(Ljava/util/Collection<Ljava/lang/String;>;)V", null);
methodVisitor.visitAnnotableParameterCount(1, true);
{
annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/component/ComponentSupport", "ifInitializedThrowUnmodifiabledComponentException", "(Lnet/shibboleth/utilities/java/support/component/InitializableComponent;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("Confirmation method collection cannot be null or empty");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "confirmationMethods", "Ljava/util/Collection;");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Confirmation method list cannot be empty");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} Attempting to add SubjectConfirmation to assertions in outgoing Response");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "getLogPrefix", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;Ljava/lang/Object;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "responseLookupStrategy", "Lcom/google/common/base/Function;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "response", "Lorg/opensaml/saml/saml1/core/Response;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "response", "Lorg/opensaml/saml/saml1/core/Response;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/messaging/context/SAMLBindingContext", "getBindingUri", "()Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "org/opensaml/profile/context/ProfileRequestContext", "org/opensaml/saml/common/messaging/context/SAMLBindingContext"}, 1, new Object[] {"org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "org/opensaml/profile/context/ProfileRequestContext", "org/opensaml/saml/common/messaging/context/SAMLBindingContext"}, 2, new Object[] {"org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "artifactProfile", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "confirmationBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/opensaml/saml/saml1/core/SubjectConfirmation", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "artifactProfile", "Z");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
...
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitLdcInsn("urn:oasis:names:tc:SAML:1.0:cm:artifact");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "confirmationMethodBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/common/SAMLObjectBuilder", "buildObject", "()Lorg/opensaml/saml/common/SAMLObject;", true);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "getStatementSubject", "(Lorg/opensaml/saml/saml1/core/SubjectStatement;)Lorg/opensaml/saml/saml1/core/Subject;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "overwriteExisting", "Z");
Label label9 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label9);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/opensaml/saml/saml1/core/Statement", "org/opensaml/saml/saml1/core/Subject", "org/opensaml/saml/saml1/core/SubjectConfirmation"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "cloneConfirmation", "(Lorg/opensaml/saml/saml1/core/SubjectConfirmation;)Lorg/opensaml/saml/saml1/core/SubjectConfirmation;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "org/opensaml/profile/context/ProfileRequestContext", "org/opensaml/saml/saml1/core/SubjectConfirmation", Opcodes.INTEGER, "java/util/Iterator", "org/opensaml/saml/saml1/core/Assertion", "java/util/Iterator", "org/opensaml/saml/saml1/core/Statement", "org/opensaml/saml/saml1/core/Subject", "org/opensaml/saml/saml1/core/SubjectConfirmation"}, 2, new Object[] {"org/opensaml/saml/saml1/core/Subject", "org/opensaml/saml/saml1/core/SubjectConfirmation"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} Added SubjectConfirmation with methods {} to {} statement subject(s)");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml1/profile/impl/AddSubjectConfirmationToSubjects", "subjectBuilder", "Lorg/opensaml/saml/common/SAMLObjectBuilder;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/common/SAMLObjectBuilder", "buildObject", "()Lorg/opensaml/saml/common/SAMLObject;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "cloneConfirmation", "(Lorg/opensaml/saml/saml1/core/SubjectConfirmation;)Lorg/opensaml/saml/saml1/core/SubjectConfirmation;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
