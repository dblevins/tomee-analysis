...
public class ActionNamespaceMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2mdquery/impl/ActionNamespaceMarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdquery/ActionNamespace", "getValue", "()Ljava/lang/String;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/ext/saml2mdquery/ActionNamespace"}, 0, null);
methodVisitor.visitInsn(RETURN);
