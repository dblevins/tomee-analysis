...
public class PublicationUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2mdrpi/impl/PublicationUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/ext/saml2mdrpi/Publication");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdrpi/Publication", "setPublisher", "(Ljava/lang/String;)V", true);
Label label2 = new Label();
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/ext/saml2mdrpi/Publication"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdrpi/Publication", "setCreationInstant", "(Lorg/joda/time/DateTime;)V", true);
methodVisitor.visitJumpInsn(GOTO, label2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/w3c/dom/Attr", "getValue", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdrpi/Publication", "setPublicationId", "(Ljava/lang/String;)V", true);
methodVisitor.visitJumpInsn(GOTO, label2);
