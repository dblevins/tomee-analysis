...
public class GeneratedKeyUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/samlec/impl/GeneratedKeyUnmarshaller", null, "org/opensaml/core/xml/schema/impl/XSBase64BinaryUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/samlec/GeneratedKey", "setSOAP11MustUnderstand", "(Lorg/opensaml/core/xml/schema/XSBooleanValue;)V", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/opensaml/saml/ext/samlec/GeneratedKey", "javax/xml/namespace/QName"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/w3c/dom/Attr", "getValue", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/samlec/GeneratedKey", "setSOAP11Actor", "(Ljava/lang/String;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
