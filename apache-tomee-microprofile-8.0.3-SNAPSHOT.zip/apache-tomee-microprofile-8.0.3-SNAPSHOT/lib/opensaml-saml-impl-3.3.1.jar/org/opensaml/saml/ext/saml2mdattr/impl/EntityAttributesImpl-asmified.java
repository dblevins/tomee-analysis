...
public class EntityAttributesImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2mdattr/impl/EntityAttributesImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/saml/ext/saml2mdattr/EntityAttributes" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "attributeInfo", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList<+Lorg/opensaml/saml/common/SAMLObject;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/ext/saml2mdattr/impl/EntityAttributesImpl", "attributeInfo", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2mdattr/impl/EntityAttributesImpl", "attributeInfo", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
