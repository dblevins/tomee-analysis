...
public class SigningMethodUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2alg/impl/SigningMethodUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2alg/SigningMethod", "getUnknownXMLObjects", "()Ljava/util/List;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2alg/SigningMethod", "setAlgorithm", "(Ljava/lang/String;)V", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2alg/SigningMethod", "setMinKeySize", "(Ljava/lang/Integer;)V", true);
methodVisitor.visitJumpInsn(GOTO, label2);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/w3c/dom/Attr", "getValue", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(Ljava/lang/String;)Ljava/lang/Integer;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2alg/SigningMethod", "setMaxKeySize", "(Ljava/lang/Integer;)V", true);
methodVisitor.visitJumpInsn(GOTO, label2);
