...
public class MetadataQueryProtocolSHA1TransformerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/metadata/resolver/impl/MetadataQueryProtocolSHA1Transformer", "Ljava/lang/Object;Lcom/google/common/base/Function<Ljava/lang/String;Ljava/lang/String;>;", "java/lang/Object", new String[] { "com/google/common/base/Function" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/metadata/resolver/impl/MetadataQueryProtocolSHA1Transformer", "digester", "Lnet/shibboleth/utilities/java/support/codec/StringDigester;");
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/opensaml/saml/metadata/resolver/impl/MetadataQueryProtocolSHA1Transformer"}, 1, new Object[] {"java/security/NoSuchAlgorithmException"});
...
methodVisitor.visitLdcInsn("Entity ID was null or empty");
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/logic/Constraint", "isNotNull", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/metadata/resolver/impl/MetadataQueryProtocolSHA1Transformer", "digester", "Lnet/shibboleth/utilities/java/support/codec/StringDigester;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/metadata/resolver/impl/MetadataQueryProtocolSHA1Transformer", "apply", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
