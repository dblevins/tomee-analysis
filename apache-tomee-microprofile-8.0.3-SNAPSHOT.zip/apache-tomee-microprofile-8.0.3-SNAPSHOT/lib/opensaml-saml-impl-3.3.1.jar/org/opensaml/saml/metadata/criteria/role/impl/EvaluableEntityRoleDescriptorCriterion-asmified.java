...
public class EvaluableEntityRoleDescriptorCriterionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", null, "java/lang/Object", new String[] { "org/opensaml/saml/metadata/criteria/role/EvaluableRoleDescriptorCriterion" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "role", "Ljavax/xml/namespace/QName;", null, null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/opensaml/saml/criterion/EntityRoleCriterion;)V", null, null);
...
methodVisitor.visitLdcInsn("EntityRoleCriterion was null");
...
methodVisitor.visitLdcInsn("Criterion entity role was null");
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/logic/Constraint", "isNotNull", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/namespace/QName");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", "role", "Ljavax/xml/namespace/QName;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("Entity role QName was null");
methodVisitor.visitMethodInsn(INVOKESTATIC, "net/shibboleth/utilities/java/support/logic/Constraint", "isNotNull", "(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/namespace/QName");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", "role", "Ljavax/xml/namespace/QName;");
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "apply", "(Lorg/opensaml/saml/saml2/metadata/RoleDescriptor;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", "role", "Ljavax/xml/namespace/QName;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", "role", "Ljavax/xml/namespace/QName;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion");
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", "role", "Ljavax/xml/namespace/QName;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Objects", "equals", "(Ljava/lang/Object;Ljava/lang/Object;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/metadata/criteria/role/impl/EvaluableEntityRoleDescriptorCriterion", "apply", "(Lorg/opensaml/saml/saml2/metadata/RoleDescriptor;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
