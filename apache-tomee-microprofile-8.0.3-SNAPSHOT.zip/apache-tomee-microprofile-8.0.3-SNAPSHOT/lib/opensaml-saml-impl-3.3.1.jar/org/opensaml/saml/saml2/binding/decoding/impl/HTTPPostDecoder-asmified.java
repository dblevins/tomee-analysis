...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/binding/decoding/impl/HTTPPostDecoder", "getHttpServletRequest", "()Ljavax/servlet/http/HttpServletRequest;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/binding/decoding/impl/HTTPPostDecoder", "getBase64DecodedMessage", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/io/InputStream;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getBase64DecodedMessage", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/io/InputStream;", null, new String[] { "org/opensaml/messaging/decoder/MessageDecodingException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/binding/decoding/impl/HTTPPostDecoder", "log", "Lorg/slf4j/Logger;");
