...
public class EncryptAttributesDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", null, "org/opensaml/saml/saml2/profile/impl/AbstractEncryptAction", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/saml2/profile/impl/EncryptAttributes;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "responseLookupStrategy", "Lcom/google/common/base/Function;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/context/EncryptionContext", "getAttributeEncryptionParameters", "()Lorg/opensaml/xmlsec/EncryptionParameters;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "responseLookupStrategy", "Lcom/google/common/base/Function;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "response", "Lorg/opensaml/saml/saml2/core/Response;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "response", "Lorg/opensaml/saml/saml2/core/Response;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} Response was not present or contained no assertions, nothing to do");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "getLogPrefix", "()Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/opensaml/saml/saml2/core/Assertion", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} Attribute before encryption:\n{}");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "getLogPrefix", "()Ljava/lang/String;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "org/opensaml/profile/context/ProfileRequestContext", "java/util/Iterator", "org/opensaml/saml/saml2/core/Assertion", "java/util/Iterator", "org/opensaml/saml/saml2/core/AttributeStatement", "java/util/List", "java/util/Iterator", "org/opensaml/saml/saml2/core/Attribute"}, 1, new Object[] {"org/opensaml/core/xml/io/MarshallingException"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} Unable to marshall Attribute for logging purposes");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "getLogPrefix", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "getEncrypter", "()Lorg/opensaml/saml/saml2/encryption/Encrypter;", false);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/encryption/Encrypter", "encrypt", "(Lorg/opensaml/saml/saml2/core/Attribute;)Lorg/opensaml/saml/saml2/core/EncryptedAttribute;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} Error encrypting attribute");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "getLogPrefix", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/opensaml/saml/saml2/profile/impl/EncryptAttributes", "org/opensaml/profile/context/ProfileRequestContext", "java/util/Iterator"}, 0, new Object[] {});
