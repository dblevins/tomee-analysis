...
public class NameIDMappingResponseImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", null, "org/opensaml/saml/saml2/core/impl/StatusResponseTypeImpl", new String[] { "org/opensaml/saml/saml2/core/NameIDMappingResponse" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", "nameID", "Lorg/opensaml/saml/saml2/core/NameID;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", "nameID", "Lorg/opensaml/saml/saml2/core/NameID;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", "prepareForAssignment", "(Lorg/opensaml/core/xml/XMLObject;Lorg/opensaml/core/xml/XMLObject;)Lorg/opensaml/core/xml/XMLObject;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/saml2/core/NameID");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", "nameID", "Lorg/opensaml/saml/saml2/core/NameID;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", "encryptedID", "Lorg/opensaml/saml/saml2/core/EncryptedID;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/core/impl/NameIDMappingResponseImpl", "encryptedID", "Lorg/opensaml/saml/saml2/core/EncryptedID;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
