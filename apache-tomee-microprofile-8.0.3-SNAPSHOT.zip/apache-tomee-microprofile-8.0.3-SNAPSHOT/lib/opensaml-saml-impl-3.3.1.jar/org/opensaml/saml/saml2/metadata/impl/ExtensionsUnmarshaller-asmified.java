...
public class ExtensionsUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/metadata/impl/ExtensionsUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/common/AbstractSAMLObjectUnmarshaller;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/metadata/impl/ExtensionsUnmarshaller", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/Extensions", "getUnknownXMLObjects", "()Ljava/util/List;", true);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/metadata/impl/ExtensionsUnmarshaller", "log", "Lorg/slf4j/Logger;");
