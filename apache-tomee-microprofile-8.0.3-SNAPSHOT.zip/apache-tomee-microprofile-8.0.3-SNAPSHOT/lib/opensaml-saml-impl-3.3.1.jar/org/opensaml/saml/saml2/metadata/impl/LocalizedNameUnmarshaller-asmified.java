...
public class LocalizedNameUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/metadata/impl/LocalizedNameUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/LocalizedName", "setValue", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/LocalizedName", "setXMLLang", "(Ljava/lang/String;)V", true);
