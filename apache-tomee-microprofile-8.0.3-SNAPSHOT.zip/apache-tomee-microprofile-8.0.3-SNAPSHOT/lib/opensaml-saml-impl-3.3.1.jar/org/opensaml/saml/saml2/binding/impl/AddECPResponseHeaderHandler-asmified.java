...
public class AddECPResponseHeaderHandlerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", null, "org/opensaml/messaging/handler/AbstractMessageHandler", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "assertionConsumerURL", "Ljava/net/URI;", null, null);
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", "assertionConsumerURL", "Ljava/net/URI;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("{} No ACS location available in message context");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", "getLogPrefix", "()Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/opensaml/saml/saml2/ecp/Response", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", "assertionConsumerURL", "Ljava/net/URI;");
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/opensaml/saml/saml2/binding/impl/AddECPResponseHeaderHandler", "org/opensaml/messaging/context/MessageContext", "org/opensaml/saml/common/SAMLObjectBuilder", "org/opensaml/saml/saml2/ecp/Response"}, 1, new Object[] {"java/lang/Exception"});
