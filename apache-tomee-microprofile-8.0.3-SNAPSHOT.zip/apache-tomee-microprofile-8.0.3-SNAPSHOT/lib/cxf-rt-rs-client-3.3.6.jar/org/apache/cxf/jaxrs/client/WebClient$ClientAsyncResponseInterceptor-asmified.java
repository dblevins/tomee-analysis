...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/client/WebClient", "handleResponse", "(Lorg/apache/cxf/message/Message;Ljava/lang/Class;Ljava/lang/reflect/Type;)Ljavax/ws/rs/core/Response;", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/client/WebClient$ClientAsyncResponseInterceptor", "this$0", "Lorg/apache/cxf/jaxrs/client/WebClient;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/client/WebClient", "convertToWebApplicationException", "(Ljavax/ws/rs/core/Response;)Ljavax/ws/rs/WebApplicationException;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/client/JaxrsClientCallback", "handleException", "(Ljava/util/Map;Ljava/lang/Throwable;)V", false);
methodVisitor.visitJumpInsn(GOTO, label9);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/client/WebClient$ClientAsyncResponseInterceptor", "closeAsyncResponseIfPossible", "(Ljavax/ws/rs/core/Response;Lorg/apache/cxf/message/Message;Lorg/apache/cxf/jaxrs/client/JaxrsClientCallback;)V", false);
