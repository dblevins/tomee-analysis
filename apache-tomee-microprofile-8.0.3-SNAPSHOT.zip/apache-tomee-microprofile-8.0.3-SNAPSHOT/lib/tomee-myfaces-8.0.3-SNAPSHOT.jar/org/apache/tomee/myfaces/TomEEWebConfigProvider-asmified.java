...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/spi/impl/DefaultWebConfigProvider", "getFacesServletMappings", "(Ljakarta/faces/context/ExternalContext;)Ljava/util/List;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/List", "jakarta/servlet/ServletContext", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Map$Entry", "jakarta/servlet/ServletRegistration", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/ServletRegistration", "getName", "()Ljava/lang/String;", true);
