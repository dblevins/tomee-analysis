...
public class TomEEFacesConfigurationProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/myfaces/TomEEFacesConfigurationProvider", null, "org/apache/myfaces/config/DefaultFacesConfigurationProvider", null);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomee/myfaces/TomEEFacesConfigurationProvider", "isEmpty", "(Ljava/io/InputStream;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitTypeInsn(NEW, "org/apache/myfaces/config/impl/digester/elements/FacesConfig");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/myfaces/config/impl/digester/elements/FacesConfig", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isEmpty", "(Ljava/io/InputStream;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
