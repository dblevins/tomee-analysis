...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/jose4j/jwe/CipherUtil", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getCipher", "(Ljava/lang/String;Ljava/lang/String;)Ljavax/crypto/Cipher;", null, new String[] { "org/jose4j/lang/JoseException" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/crypto/Cipher"});
...
methodVisitor.visitLdcInsn("Unable to get a Cipher implementation of ");
