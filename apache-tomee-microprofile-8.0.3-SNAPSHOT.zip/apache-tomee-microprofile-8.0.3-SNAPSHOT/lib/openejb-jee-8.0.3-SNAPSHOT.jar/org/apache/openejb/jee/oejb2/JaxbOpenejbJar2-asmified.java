...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "contexts", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/Class<*>;Ljavax/xml/bind/JAXBContext;>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getContext", "(Ljava/lang/Class;)Ljavax/xml/bind/JAXBContext;", "(Ljava/lang/Class<*>;)Ljavax/xml/bind/JAXBContext;", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/jee/oejb2/JaxbOpenejbJar2", "getContext", "(Ljava/lang/Class;)Ljavax/xml/bind/JAXBContext;", false);
