...
public class NamedModuleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/openejb/jee/NamedModule", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setModuleName", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitEnd();
}
{
