...
public class FacesManagedBeanExtensionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/FacesManagedBeanExtension", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "faces-config-managed-bean-extensionType");
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/FacesManagedBeanExtension", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/FacesManagedBeanExtension", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/FacesManagedBeanExtension", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/FacesManagedBeanExtension", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
