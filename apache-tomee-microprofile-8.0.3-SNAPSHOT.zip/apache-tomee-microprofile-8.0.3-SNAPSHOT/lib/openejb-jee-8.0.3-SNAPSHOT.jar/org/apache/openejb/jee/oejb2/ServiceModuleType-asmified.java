...
public class ServiceModuleTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/oejb2/ServiceModuleType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "serviceModuleType");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/oejb2/ServiceModuleType", "environment", "Lorg/apache/openejb/jee/oejb2/EnvironmentType;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/oejb2/ServiceModuleType", "environment", "Lorg/apache/openejb/jee/oejb2/EnvironmentType;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/oejb2/ServiceModuleType", "service", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/oejb2/ServiceModuleType", "service", "Ljava/util/List;");
