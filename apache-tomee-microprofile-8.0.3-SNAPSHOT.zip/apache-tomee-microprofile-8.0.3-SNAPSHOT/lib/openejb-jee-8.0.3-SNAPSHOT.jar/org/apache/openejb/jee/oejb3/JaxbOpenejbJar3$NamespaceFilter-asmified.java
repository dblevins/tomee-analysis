...
public class JaxbOpenejbJar3$NamespaceFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/oejb3/JaxbOpenejbJar3$NamespaceFilter", null, "org/xml/sax/helpers/XMLFilterImpl", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/jee/oejb3/JaxbOpenejbJar3$NamespaceFilter", "EMPTY_INPUT_SOURCE", "Lorg/xml/sax/InputSource;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/jee/oejb3/JaxbOpenejbJar3$NamespaceFilter", "EMPTY_INPUT_SOURCE", "Lorg/xml/sax/InputSource;");
methodVisitor.visitInsn(RETURN);
