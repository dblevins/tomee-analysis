...
public class Adapter1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/bval/Adapter1", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter<Ljava/lang/String;Ljakarta/validation/executable/ExecutableType;>;", "jakarta/xml/bind/annotation/adapters/XmlAdapter", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/bval/Adapter1", "marshal", "(Ljakarta/validation/executable/ExecutableType;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/bval/Adapter1", "unmarshal", "(Ljava/lang/String;)Ljakarta/validation/executable/ExecutableType;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
