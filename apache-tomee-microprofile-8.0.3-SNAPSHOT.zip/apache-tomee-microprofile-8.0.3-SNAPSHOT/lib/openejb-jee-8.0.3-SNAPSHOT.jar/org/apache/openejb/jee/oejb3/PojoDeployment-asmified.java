...
public class PojoDeploymentDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/oejb3/PojoDeployment", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/oejb3/PojoDeployment", "className", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/oejb3/PojoDeployment", "className", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/oejb3/PojoDeployment", "properties", "Ljava/util/Properties;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/oejb3/PojoDeployment", "properties", "Ljava/util/Properties;");
