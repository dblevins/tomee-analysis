...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/hsqldb/server/Servlet", null, "javax/servlet/http/HttpServlet", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/ServletException", "toString", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/server/Servlet", "getServletContext", "()Ljavax/servlet/ServletContext;", false);
methodVisitor.visitLdcInsn("/");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/hsqldb/server/Servlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/Object", "java/io/DataInputStream", "org/hsqldb/lib/DataOutputStream", Opcodes.INTEGER, Opcodes.LONG, Opcodes.INTEGER, "org/hsqldb/Session", "org/hsqldb/result/Result", Opcodes.TOP, Opcodes.INTEGER}, 1, new Object[] {"org/hsqldb/HsqlException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/hsqldb/server/Servlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/Object", "java/io/DataInputStream", "org/hsqldb/lib/DataOutputStream"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/hsqldb/server/Servlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/Object", "java/io/DataInputStream", "org/hsqldb/lib/DataOutputStream", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/hsqldb/server/Servlet", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletResponse", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(MONITOREXIT);
