...
public class RowAVLDiskLargeDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/hsqldb/RowAVLDiskLarge", null, "org/hsqldb/RowAVLDisk", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/hsqldb/RowAVLDisk", "<init>", "(Lorg/hsqldb/TableBase;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/hsqldb/rowio/RowInputInterface", "getPos", "()J", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/RowAVLDiskLarge", "position", "J");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/hsqldb/rowio/RowInputInterface", "getSize", "()I", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/RowAVLDiskLarge", "storageSize", "I");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/TableBase", "getIndexCount", "()I", false);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/hsqldb/index/NodeAVLDiskLarge");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/hsqldb/index/NodeAVLDiskLarge", "<init>", "(Lorg/hsqldb/RowAVLDisk;Lorg/hsqldb/rowio/RowInputInterface;I)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/RowAVLDiskLarge", "nPrimaryNode", "Lorg/hsqldb/index/NodeAVL;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/RowAVLDiskLarge", "nPrimaryNode", "Lorg/hsqldb/index/NodeAVL;");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ISTORE, 5);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/hsqldb/RowAVLDiskLarge", "org/hsqldb/TableBase", "org/hsqldb/rowio/RowInputInterface", Opcodes.INTEGER, "org/hsqldb/index/NodeAVL", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/RowAVLDiskLarge", "table", "Lorg/hsqldb/TableBase;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/RowAVLDiskLarge", "rowData", "[Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/hsqldb/index/NodeAVLDiskLarge", "<init>", "(Lorg/hsqldb/RowAVLDisk;I)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/RowAVLDiskLarge", "nPrimaryNode", "Lorg/hsqldb/index/NodeAVL;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/RowAVLDiskLarge", "nPrimaryNode", "Lorg/hsqldb/index/NodeAVL;");
