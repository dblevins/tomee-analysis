...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/security/auth/Subject", "getPublicCredentials", "()Ljava/util/Set;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "(Ljava/util/Collection;)V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "iterator", "()Ljava/util/Iterator;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
Label label15 = new Label();
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/hsqldb/auth/JaasAuthBean", "java/lang/String", "java/lang/String", "javax/security/auth/login/LoginContext", Opcodes.INTEGER, "java/util/regex/Matcher", "java/util/List", "java/util/List", "jakarta/security/auth/Subject", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/hsqldb/auth/JaasAuthBean", "java/lang/String", "java/lang/String", "javax/security/auth/login/LoginContext", Opcodes.INTEGER, "java/util/regex/Matcher", "java/util/List", "java/util/List", "jakarta/security/auth/Subject"}, 2, new Object[] {"org/hsqldb/lib/FrameworkLogger", "java/lang/StringBuilder"});
methodVisitor.visitLdcInsn("Principals");
methodVisitor.visitLabel(label20);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/hsqldb/auth/JaasAuthBean", "java/lang/String", "java/lang/String", "javax/security/auth/login/LoginContext", Opcodes.INTEGER, "java/util/regex/Matcher", "java/util/List", "java/util/List", "jakarta/security/auth/Subject"}, 3, new Object[] {"org/hsqldb/lib/FrameworkLogger", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/FrameworkLogger", "finer", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/hsqldb/auth/JaasAuthBean", "java/lang/String", "java/lang/String", "javax/security/auth/login/LoginContext", Opcodes.INTEGER, "java/util/regex/Matcher", "java/util/List", "java/util/List", "jakarta/security/auth/Subject", "java/util/Iterator", "java/lang/String"}, 2, new Object[] {"org/hsqldb/lib/FrameworkLogger", "java/lang/StringBuilder"});
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitLabel(label25);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/hsqldb/auth/JaasAuthBean", "java/lang/String", "java/lang/String", "javax/security/auth/login/LoginContext", Opcodes.INTEGER, "java/util/regex/Matcher", "java/util/List", "java/util/List", "jakarta/security/auth/Subject", "java/util/Iterator", "java/lang/String"}, 3, new Object[] {"org/hsqldb/lib/FrameworkLogger", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/FrameworkLogger", "finer", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/hsqldb/auth/JaasAuthBean", "java/lang/String", "java/lang/String", "javax/security/auth/login/LoginContext", Opcodes.INTEGER, "java/util/regex/Matcher", "java/util/List", "java/util/List", "jakarta/security/auth/Subject", "java/util/Iterator", "java/lang/String"}, 2, new Object[] {"java/util/List", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
