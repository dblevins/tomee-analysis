...
public class IntKeyIntValueHashMap$ValuesDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER, "org/hsqldb/lib/IntKeyIntValueHashMap$Values", null, "java/lang/Object", new String[] { "org/hsqldb/lib/Collection" });
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/hsqldb/lib/IntKeyIntValueHashMap;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/hsqldb/lib/IntKeyIntValueHashMap;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/lib/IntKeyIntValueHashMap$Values", "this$0", "Lorg/hsqldb/lib/IntKeyIntValueHashMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/lib/IntKeyIntValueHashMap$Values", "this$0", "Lorg/hsqldb/lib/IntKeyIntValueHashMap;");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/IntKeyIntValueHashMap$Values", "size", "()I", false);
