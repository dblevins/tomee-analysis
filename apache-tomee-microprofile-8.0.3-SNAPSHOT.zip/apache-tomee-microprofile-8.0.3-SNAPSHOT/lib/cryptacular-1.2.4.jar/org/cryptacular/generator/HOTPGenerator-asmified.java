...
public class HOTPGeneratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/cryptacular/generator/HOTPGenerator", null, "org/cryptacular/generator/AbstractOTPGenerator", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generate", "([BJ)I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(LLOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/cryptacular/generator/HOTPGenerator", "generateInternal", "([BJ)I", false);
