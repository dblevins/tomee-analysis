...
public class Base64CodecDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/cryptacular/codec/Base64Codec", null, "java/lang/Object", new String[] { "org/cryptacular/codec/Codec" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/codec/Base64Codec", "encoder", "Lorg/cryptacular/codec/Encoder;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/codec/Base64Codec", "decoder", "Lorg/cryptacular/codec/Decoder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/codec/Base64Codec", "customAlphabet", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/codec/Base64Codec", "padding", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/cryptacular/codec/Base64Codec", "newEncoder", "()Lorg/cryptacular/codec/Encoder;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/codec/Base64Codec", "encoder", "Lorg/cryptacular/codec/Encoder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/cryptacular/codec/Base64Codec", "newDecoder", "()Lorg/cryptacular/codec/Decoder;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/codec/Base64Codec", "decoder", "Lorg/cryptacular/codec/Decoder;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/codec/Base64Codec", "encoder", "Lorg/cryptacular/codec/Encoder;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/codec/Base64Codec", "decoder", "Lorg/cryptacular/codec/Decoder;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/codec/Base64Codec", "customAlphabet", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/codec/Base64Codec", "customAlphabet", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/cryptacular/codec/Base64Encoder", "<init>", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/codec/Base64Codec", "padding", "Z");
