...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/wss4j/policy/stax/PolicyUtils", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getElementPath", "(Lorg/apache/wss4j/policy/model/XPath;)Ljava/util/List;", "(Lorg/apache/wss4j/policy/model/XPath;)Ljava/util/List<Ljavax/xml/namespace/QName;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Namespace not declared");
