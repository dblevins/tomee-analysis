...
public class DecimalLocaleConverterDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", null, "org/apache/commons/beanutils/locale/BaseLocaleConverter", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "<init>", "(Z)V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "<init>", "(Ljava/util/Locale;Z)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/commons/beanutils/locale/converters/DecimalLocaleConverter;"));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "<init>", "(Ljava/lang/Object;Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Locale", "getDefault", "()Ljava/util/Locale;", false);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "<init>", "(Ljava/lang/Object;Ljava/util/Locale;Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "locale", "Ljava/util/Locale;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/text/DecimalFormat", "getInstance", "(Ljava/util/Locale;)Ljava/text/NumberFormat;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "locPattern", "Z");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/locale/converters/DecimalLocaleConverter", "log", "Lorg/apache/commons/logging/Log;");
