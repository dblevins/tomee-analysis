...
public class DisabledCounterDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/metrics/impl/DisabledCounter", null, "com/codahale/metrics/Counter", new String[] { "org/opensaml/core/metrics/impl/DisabledMetric" });

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/codahale/metrics/Counter", "<init>", "()V", false);
