...
public class DisabledTimerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/metrics/impl/DisabledTimer", null, "com/codahale/metrics/Timer", new String[] { "org/opensaml/core/metrics/impl/DisabledMetric" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/codahale/metrics/Timer", "<init>", "(Lcom/codahale/metrics/Reservoir;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "time", "()Lcom/codahale/metrics/Timer$Context;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSnapshot", "()Lcom/codahale/metrics/Snapshot;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
