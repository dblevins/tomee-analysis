...
public class XSBase64BinaryImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/xml/schema/impl/XSBase64BinaryImpl", null, "org/opensaml/core/xml/AbstractXMLObject", new String[] { "org/opensaml/core/xml/schema/XSBase64Binary" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/core/xml/schema/impl/XSBase64BinaryImpl", "value", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/core/xml/schema/impl/XSBase64BinaryImpl", "value", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/core/xml/schema/impl/XSBase64BinaryImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/core/xml/schema/impl/XSBase64BinaryImpl", "value", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
