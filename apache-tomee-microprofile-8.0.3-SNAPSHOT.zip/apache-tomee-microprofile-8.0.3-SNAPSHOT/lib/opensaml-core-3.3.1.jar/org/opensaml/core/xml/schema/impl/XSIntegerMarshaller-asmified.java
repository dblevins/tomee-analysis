...
public class XSIntegerMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/xml/schema/impl/XSIntegerMarshaller", null, "org/opensaml/core/xml/io/AbstractXMLObjectMarshaller", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/core/xml/schema/XSInteger"}, 0, null);
methodVisitor.visitInsn(RETURN);
