...
public class UnknownAttributeDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "serp/bytecode/UnknownAttribute", null, "serp/bytecode/Attribute", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_value", "[B", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "serp/bytecode/UnknownAttribute", "_value", "[B");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "serp/bytecode/UnknownAttribute", "_value", "[B");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/visitor/BCVisitor", "enterUnknownAttribute", "(Lserp/bytecode/UnknownAttribute;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/visitor/BCVisitor", "exitUnknownAttribute", "(Lserp/bytecode/UnknownAttribute;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "serp/bytecode/UnknownAttribute");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/UnknownAttribute", "getValue", "()[B", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/UnknownAttribute", "setValue", "([B)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
