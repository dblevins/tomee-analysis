...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/webservices/WsServlet$InstanceContext", "servletContext", "Ljavax/servlet/ServletContext;");
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/server/webservices/WsServlet", "access$100", "()Ljavax/xml/rpc/server/ServletEndpointContext;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/rpc/server/ServletEndpointContext", "getHttpSession", "()Ljavax/servlet/http/HttpSession;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/webservices/WsServlet$InstanceContext", "servletContext", "Ljavax/servlet/ServletContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
