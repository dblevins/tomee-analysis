...
methodVisitor.visitJumpInsn(IFEQ, label15);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Map$Entry", "jakarta/servlet/ServletContainerInitializer", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/startup/OpenEJBContextConfig", "addClassesWithRightLoader", "(Ljava/lang/ClassLoader;Ljakarta/servlet/ServletContainerInitializer;Ljava/util/List;)V", false);
methodVisitor.visitLabel(label4);
Label label26 = new Label();
methodVisitor.visitJumpInsn(GOTO, label26);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/catalina/startup/OpenEJBContextConfig", "java/util/Iterator", "java/lang/ClassLoader", "java/util/Iterator", "java/util/Map$Entry", "java/lang/Class", "java/util/Iterator", "jakarta/servlet/ServletContainerInitializer"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitJumpInsn(GOTO, label26);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addClassesWithRightLoader", "(Ljava/lang/ClassLoader;Ljakarta/servlet/ServletContainerInitializer;Ljava/util/List;)V", "(Ljava/lang/ClassLoader;Ljakarta/servlet/ServletContainerInitializer;Ljava/util/List<Ljava/lang/Class<*>;>;)V", new String[] { "java/lang/ClassNotFoundException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/startup/OpenEJBContextConfig", "initializerClassMap", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 2);
