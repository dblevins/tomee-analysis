...
public class ResponseTimeCounter$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/cxf/management/counters/ResponseTimeCounter$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/cxf/management/counters/ResponseTimeCounter", null, null);

classWriter.visitInnerClass("org/apache/cxf/management/counters/ResponseTimeCounter$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$cxf$message$FaultMode", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/message/FaultMode", "values", "()[Lorg/apache/cxf/message/FaultMode;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/management/counters/ResponseTimeCounter$1", "$SwitchMap$org$apache$cxf$message$FaultMode", "[I");
