...
public class SimpleLog$1Dump implements Opcodes {
...
classWriter.visit(V1_2, ACC_FINAL | ACC_SUPER, "org/apache/commons/logging/impl/SimpleLog$1", null, "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/impl/SimpleLog$1", "val$name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/logging/impl/SimpleLog", "access$000", "()Ljava/lang/ClassLoader;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/impl/SimpleLog$1", "val$name", "Ljava/lang/String;");
