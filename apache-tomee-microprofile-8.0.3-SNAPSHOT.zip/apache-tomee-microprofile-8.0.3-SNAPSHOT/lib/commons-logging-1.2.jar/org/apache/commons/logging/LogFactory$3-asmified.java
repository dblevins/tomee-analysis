...
public class LogFactory$3Dump implements Opcodes {
...
classWriter.visit(V1_2, ACC_FINAL | ACC_SUPER, "org/apache/commons/logging/LogFactory$3", null, "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/LogFactory$3", "val$loader", "Ljava/lang/ClassLoader;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/LogFactory$3", "val$name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/LogFactory$3", "val$loader", "Ljava/lang/ClassLoader;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/LogFactory$3", "val$loader", "Ljava/lang/ClassLoader;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/LogFactory$3", "val$name", "Ljava/lang/String;");
