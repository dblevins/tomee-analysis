...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "javax/servlet/jsp/jstl/fmt/LocalizationContext", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/servlet/jsp/jstl/fmt/LocalizationContext", "bundle", "Ljava/util/ResourceBundle;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/servlet/jsp/jstl/fmt/LocalizationContext", "locale", "Ljava/util/Locale;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/jsp/jstl/fmt/LocalizationContext", "bundle", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/jsp/jstl/fmt/LocalizationContext", "locale", "Ljava/util/Locale;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
