...
public class XACMLAuthzDecisionQueryTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/profile/saml/impl/XACMLAuthzDecisionQueryTypeMarshaller", null, "org/opensaml/saml/saml2/core/impl/RequestAbstractTypeMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/profile/saml/XACMLAuthzDecisionQueryType", "getInputContextOnlyXSBooleanValue", "()Lorg/opensaml/core/xml/schema/XSBooleanValue;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/profile/saml/XACMLAuthzDecisionQueryType", "getReturnContextXSBooleanValue", "()Lorg/opensaml/core/xml/schema/XSBooleanValue;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/profile/saml/XACMLAuthzDecisionQueryType", "getCombinePoliciesXSBooleanValue", "()Lorg/opensaml/core/xml/schema/XSBooleanValue;", true);
