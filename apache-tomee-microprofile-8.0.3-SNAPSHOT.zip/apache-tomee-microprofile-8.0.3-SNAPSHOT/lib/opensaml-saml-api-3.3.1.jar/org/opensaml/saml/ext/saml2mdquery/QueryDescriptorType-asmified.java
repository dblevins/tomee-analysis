...
public class QueryDescriptorTypeDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/opensaml/saml/ext/saml2mdquery/QueryDescriptorType", null, "java/lang/Object", new String[] { "org/opensaml/saml/saml2/metadata/RoleDescriptor" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "TYPE_LOCAL_NAME", "Ljava/lang/String;", null, "QueryDescriptorType");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getNameIDFormat", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/metadata/NameIDFormat;>;", null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("QueryDescriptorType");
methodVisitor.visitLdcInsn("query");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/namespace/QName", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/ext/saml2mdquery/QueryDescriptorType", "TYPE_NAME", "Ljavax/xml/namespace/QName;");
