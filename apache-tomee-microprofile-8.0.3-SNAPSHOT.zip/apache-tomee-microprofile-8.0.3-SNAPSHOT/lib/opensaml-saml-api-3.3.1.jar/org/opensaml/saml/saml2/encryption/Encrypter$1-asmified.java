...
public class Encrypter$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "org/opensaml/saml/saml2/encryption/Encrypter$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/opensaml/saml/saml2/encryption/Encrypter", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$opensaml$saml$saml2$encryption$Encrypter$KeyPlacement", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/saml2/encryption/Encrypter$KeyPlacement", "values", "()[Lorg/opensaml/saml/saml2/encryption/Encrypter$KeyPlacement;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/saml2/encryption/Encrypter$1", "$SwitchMap$org$opensaml$saml$saml2$encryption$Encrypter$KeyPlacement", "[I");
