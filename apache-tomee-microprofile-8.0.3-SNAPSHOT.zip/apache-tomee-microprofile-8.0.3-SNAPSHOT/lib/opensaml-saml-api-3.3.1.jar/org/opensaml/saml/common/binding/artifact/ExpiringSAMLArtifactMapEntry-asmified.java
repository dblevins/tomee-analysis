...
public class ExpiringSAMLArtifactMapEntryDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/binding/artifact/ExpiringSAMLArtifactMapEntry", null, "org/opensaml/saml/common/binding/artifact/BasicSAMLArtifactMapEntry", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/binding/artifact/ExpiringSAMLArtifactMapEntry", "expiration", "J");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/binding/artifact/ExpiringSAMLArtifactMapEntry", "expiration", "J");
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isValid", "(J)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(LLOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/binding/artifact/ExpiringSAMLArtifactMapEntry", "expiration", "J");
