...
public class ChannelBindingsContextDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/messaging/context/ChannelBindingsContext", null, "org/opensaml/messaging/context/BaseContext", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/messaging/context/ChannelBindingsContext", "channelBindings", "Ljava/util/Collection;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/messaging/context/ChannelBindingsContext", "channelBindings", "Ljava/util/Collection;");
