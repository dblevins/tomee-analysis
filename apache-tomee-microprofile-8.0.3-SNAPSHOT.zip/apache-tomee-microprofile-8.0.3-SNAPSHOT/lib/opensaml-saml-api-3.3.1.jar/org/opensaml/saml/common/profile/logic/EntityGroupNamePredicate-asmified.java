...
public class EntityGroupNamePredicateDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/profile/logic/EntityGroupNamePredicate", "Ljava/lang/Object;Lcom/google/common/base/Predicate<Lorg/opensaml/saml/saml2/metadata/EntityDescriptor;>;", "java/lang/Object", new String[] { "com/google/common/base/Predicate" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "groupNames", "Ljava/util/Set;", "Ljava/util/Set<Ljava/lang/String;>;", null);
{
...
methodVisitor.visitLdcInsn("Group name collection cannot be null");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/profile/logic/EntityGroupNamePredicate", "groupNames", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Collection", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/opensaml/saml/common/profile/logic/EntityGroupNamePredicate", "java/util/Collection", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/logic/EntityGroupNamePredicate", "groupNames", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/metadata/EntityDescriptor", "getObjectMetadata", "()Lnet/shibboleth/utilities/java/support/collection/LockableClassToInstanceMultiMap;", true);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/metadata/EntityGroupName;"));
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/metadata/EntityGroupName");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/profile/logic/EntityGroupNamePredicate", "groupNames", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/metadata/EntityGroupName", "getName", "()Ljava/lang/String;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/profile/logic/EntityGroupNamePredicate", "apply", "(Lorg/opensaml/saml/saml2/metadata/EntityDescriptor;)Z", false);
methodVisitor.visitInsn(IRETURN);
