...
public class AbstractSignableSAMLObjectDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/opensaml/saml/common/AbstractSignableSAMLObject", null, "org/opensaml/xmlsec/signature/AbstractSignableXMLObject", new String[] { "org/opensaml/saml/common/SignableSAMLObject" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/xmlsec/signature/AbstractSignableXMLObject", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xmlsec/signature/Signature", "getContentReferences", "()Ljava/util/List;", true);
methodVisitor.visitTypeInsn(NEW, "org/opensaml/saml/common/SAMLObjectContentReference");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/saml/common/SAMLObjectContentReference", "<init>", "(Lorg/opensaml/saml/common/SignableSAMLObject;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/xmlsec/signature/AbstractSignableXMLObject", "setSignature", "(Lorg/opensaml/xmlsec/signature/Signature;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/xmlsec/signature/AbstractSignableXMLObject", "prepareForAssignment", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", false);
