...
public class SAMLProtocolContextDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/messaging/context/SAMLProtocolContext", null, "org/opensaml/messaging/context/BaseContext", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/messaging/context/SAMLProtocolContext", "protocol", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/messaging/context/SAMLProtocolContext", "protocol", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
