...
public class AbstractSAMLObjectMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/opensaml/saml/common/AbstractSAMLObjectMarshaller", null, "org/opensaml/core/xml/io/AbstractXMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/common/SAMLObjectSupport", "declareNonVisibleNamespaces", "(Lorg/opensaml/saml/common/SignableSAMLObject;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/core/xml/io/AbstractXMLObjectMarshaller", "marshall", "(Lorg/opensaml/core/xml/XMLObject;Lorg/w3c/dom/Document;)Lorg/w3c/dom/Element;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/opensaml/core/xml/io/AbstractXMLObjectMarshaller", "marshall", "(Lorg/opensaml/core/xml/XMLObject;Lorg/w3c/dom/Element;)Lorg/w3c/dom/Element;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
