...
public class SAMLMessageContextAuthenticationFunctionDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/common/messaging/context/navigate/SAMLMessageContextAuthenticationFunction", "Ljava/lang/Object;Lcom/google/common/base/Function<Lorg/opensaml/messaging/context/MessageContext;Ljava/lang/Boolean;>;", "java/lang/Object", new String[] { "com/google/common/base/Function" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/common/messaging/context/navigate/SAMLMessageContextAuthenticationFunction", "entityContextClass", "Ljava/lang/Class;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "apply", "(Lorg/opensaml/messaging/context/MessageContext;)Ljava/lang/Boolean;", null, null);
{
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/common/messaging/context/navigate/SAMLMessageContextAuthenticationFunction", "entityContextClass", "Ljava/lang/Class;");
...
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/messaging/context/AbstractAuthenticatableSAMLEntityContext", "isAuthenticated", "()Z", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/common/messaging/context/navigate/SAMLMessageContextAuthenticationFunction", "apply", "(Lorg/opensaml/messaging/context/MessageContext;)Ljava/lang/Boolean;", false);
methodVisitor.visitInsn(ARETURN);
