...
public class DerivedKeyTokenSTRParserDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/dom/str/DerivedKeyTokenSTRParser", null, "java/lang/Object", new String[] { "org/apache/wss4j/dom/str/STRParser" });
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/dom/str/DerivedKeyTokenSTRParser", "processPreviousResult", "(Lorg/apache/wss4j/dom/engine/WSSecurityEngineResult;Lorg/apache/wss4j/common/token/SecurityTokenReference;Lorg/apache/wss4j/dom/str/STRParserParameters;)Lorg/apache/wss4j/dom/str/STRParserResult;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/dom/str/DerivedKeyTokenSTRParser", "processSTR", "(Lorg/apache/wss4j/common/token/SecurityTokenReference;Ljava/lang/String;Lorg/apache/wss4j/dom/str/STRParserParameters;)Lorg/apache/wss4j/dom/str/STRParserResult;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/wss4j/dom/str/STRParserResult", "org/apache/wss4j/dom/handler/RequestData", "[B"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/dom/str/STRParserResult", "setSecretKey", "([B)V", false);
Label label2 = new Label();
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/wss4j/dom/str/DerivedKeyTokenSTRParser", "org/apache/wss4j/common/token/SecurityTokenReference", "java/lang/String", "org/apache/wss4j/dom/str/STRParserParameters", "org/apache/wss4j/dom/str/STRParserResult", "org/apache/wss4j/dom/handler/RequestData", "java/lang/String", "[B", "[B", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/wss4j/common/crypto/Crypto", "[Ljava/security/cert/X509Certificate;"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/common/token/SecurityTokenReference", "getKeyIdentifierValue", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitIntInsn(BIPUSH, 9);
