...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/meta/SourceAnnotationHandler$AccessFilter", "<init>", "(Ljakarta/persistence/AccessType;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/meta/SourceAnnotationHandler", "getExplicitAccessType", "(Ljavax/lang/model/element/TypeElement;)Ljakarta/persistence/AccessType;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/persistence/AccessType"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(0, "getExplicitAccessType", "(Ljavax/lang/model/element/TypeElement;)Ljakarta/persistence/AccessType;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
