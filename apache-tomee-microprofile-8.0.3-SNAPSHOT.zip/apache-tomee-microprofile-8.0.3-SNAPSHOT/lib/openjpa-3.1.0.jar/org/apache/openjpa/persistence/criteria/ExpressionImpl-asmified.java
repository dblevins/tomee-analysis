...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/persistence/criteria/ExpressionImpl", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/SelectionImpl<TX;>;Ljavax/persistence/criteria/Expression<TX;>;", "org/apache/openjpa/persistence/criteria/SelectionImpl", new String[] { "javax/persistence/criteria/Expression" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "as", "(Ljava/lang/Class;)Ljavax/persistence/criteria/Expression;", "<Y:Ljava/lang/Object;>(Ljava/lang/Class<TY;>;)Ljavax/persistence/criteria/Expression<TY;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/persistence/criteria/Expression"});
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openjpa/persistence/criteria/ExpressionImpl", "[Ljava/lang/Object;", "javax/persistence/criteria/CriteriaBuilder$In", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/criteria/CriteriaBuilder$In", "value", "(Ljava/lang/Object;)Ljavax/persistence/criteria/CriteriaBuilder$In;", true);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openjpa/persistence/criteria/ExpressionImpl", "[Ljavax/persistence/criteria/Expression;", "javax/persistence/criteria/CriteriaBuilder$In", "[Ljavax/persistence/criteria/Expression;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 4);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/persistence/criteria/CriteriaBuilder$In", "value", "(Ljavax/persistence/criteria/Expression;)Ljavax/persistence/criteria/CriteriaBuilder$In;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitIincInsn(5, 1);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/persistence/criteria/CriteriaBuilder$In", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
