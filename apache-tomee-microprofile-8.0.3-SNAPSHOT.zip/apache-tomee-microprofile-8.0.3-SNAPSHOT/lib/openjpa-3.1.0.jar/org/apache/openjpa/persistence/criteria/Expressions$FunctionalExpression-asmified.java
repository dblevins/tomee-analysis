...
public class Expressions$FunctionalExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openjpa/persistence/criteria/Expressions$FunctionalExpression", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<TX;>;", "org/apache/openjpa/persistence/criteria/ExpressionImpl", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "args", "[Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;", "[Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<*>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "<init>", "(Ljava/lang/Class;[Ljakarta/persistence/criteria/Expression;)V", "(Ljava/lang/Class<TX;>;[Ljakarta/persistence/criteria/Expression<*>;)V", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openjpa/persistence/criteria/Expressions$FunctionalExpression", "java/lang/Class", "[Ljakarta/persistence/criteria/Expression;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/criteria/Expressions$FunctionalExpression", "args", "[Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;");
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$FunctionalExpression", "args", "[Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;");
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 4);
