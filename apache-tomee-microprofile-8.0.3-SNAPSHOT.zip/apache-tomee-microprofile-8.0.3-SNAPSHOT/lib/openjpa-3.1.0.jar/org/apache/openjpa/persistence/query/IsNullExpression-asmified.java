...
public class IsNullExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/query/IsNullExpression", null, "org/apache/openjpa/persistence/query/UnaryExpressionPredicate", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/IsNullExpression", "_e", "Lorg/apache/openjpa/persistence/query/Expression;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/query/IsNullExpression", "_op", "Lorg/apache/openjpa/persistence/query/UnaryConditionalOperator;");
