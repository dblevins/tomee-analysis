...
public class Expressions$AnyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$Any", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression<TX;>;", "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", "<init>", "(Ljavax/persistence/criteria/Subquery;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$Any", "e", "Lorg/apache/openjpa/persistence/criteria/SubqueryImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
