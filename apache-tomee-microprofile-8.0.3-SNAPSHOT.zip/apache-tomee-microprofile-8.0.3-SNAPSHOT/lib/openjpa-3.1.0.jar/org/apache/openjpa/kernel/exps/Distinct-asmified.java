...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/kernel/exps/Distinct", null, "org/apache/openjpa/kernel/exps/Val", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/exps/Distinct", "_val", "Lorg/apache/openjpa/kernel/exps/Val;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/exps/Distinct", "eval", "(Ljava/util/Collection;Ljava/lang/Object;Lorg/apache/openjpa/kernel/StoreContext;[Ljava/lang/Object;)Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/exps/Distinct", "_val", "Lorg/apache/openjpa/kernel/exps/Val;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
