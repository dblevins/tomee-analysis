...
public class DistinctResultListDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/kernel/DistinctResultList", "<E:Ljava/lang/Object;>Ljava/lang/Object;Ljava/util/List<TE;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "java/util/List", "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-6140119764940777922L));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "_del", "Ljava/util/ArrayList;", "Ljava/util/ArrayList<TE;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openjpa/lib/rop/ResultList;Lorg/apache/openjpa/util/RuntimeExceptionTranslator;)V", "(Lorg/apache/openjpa/lib/rop/ResultList<TE;>;Lorg/apache/openjpa/util/RuntimeExceptionTranslator;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/DistinctResultList", "_del", "Ljava/util/ArrayList;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/kernel/DistinctResultList", "_trans", "Lorg/apache/openjpa/util/RuntimeExceptionTranslator;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openjpa/kernel/DistinctResultList", "org/apache/openjpa/lib/rop/ResultList", "org/apache/openjpa/util/RuntimeExceptionTranslator", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/DistinctResultList", "_del", "Ljava/util/ArrayList;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/kernel/DistinctResultList", "translate", "(Ljava/lang/RuntimeException;)Ljava/lang/RuntimeException;", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/kernel/DistinctResultList", "_trans", "Lorg/apache/openjpa/util/RuntimeExceptionTranslator;");
Label label0 = new Label();
