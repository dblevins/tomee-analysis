...
public class LRSProxyMap$EntryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/jdbc/meta/strats/LRSProxyMap$Entry", null, "java/lang/Object", new String[] { "java/util/Map$Entry" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "key", "Ljava/lang/Object;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "val", "Ljava/lang/Object;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/openjpa/jdbc/meta/strats/LRSProxyMap$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/jdbc/meta/strats/LRSProxyMap$Entry", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
