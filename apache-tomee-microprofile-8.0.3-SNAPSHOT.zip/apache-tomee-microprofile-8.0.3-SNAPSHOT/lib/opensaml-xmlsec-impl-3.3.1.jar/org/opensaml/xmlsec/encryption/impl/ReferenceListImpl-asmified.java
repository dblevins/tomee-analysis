...
public class ReferenceListImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/encryption/impl/ReferenceListImpl", null, "org/opensaml/core/xml/AbstractXMLObject", new String[] { "org/opensaml/xmlsec/encryption/ReferenceList" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/encryption/impl/ReferenceListImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getReferences", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/xmlsec/encryption/ReferenceType;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/encryption/impl/ReferenceListImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getDataReferences", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/xmlsec/encryption/DataReference;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/encryption/impl/ReferenceListImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getKeyReferences", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/xmlsec/encryption/KeyReference;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/encryption/impl/ReferenceListImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/opensaml/xmlsec/encryption/KeyReference", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/core/xml/util/IndexedXMLObjectChildrenList", "subList", "(Ljavax/xml/namespace/QName;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
