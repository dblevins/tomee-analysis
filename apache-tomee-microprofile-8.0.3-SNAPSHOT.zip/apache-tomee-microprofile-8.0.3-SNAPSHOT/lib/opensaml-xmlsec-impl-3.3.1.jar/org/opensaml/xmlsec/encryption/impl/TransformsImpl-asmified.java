...
public class TransformsImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/encryption/impl/TransformsImpl", null, "org/opensaml/core/xml/AbstractXMLObject", new String[] { "org/opensaml/xmlsec/encryption/Transforms" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "transforms", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/encryption/impl/TransformsImpl", "transforms", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getTransforms", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/xmlsec/signature/Transform;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/encryption/impl/TransformsImpl", "transforms", "Lorg/opensaml/core/xml/util/XMLObjectChildrenList;");
