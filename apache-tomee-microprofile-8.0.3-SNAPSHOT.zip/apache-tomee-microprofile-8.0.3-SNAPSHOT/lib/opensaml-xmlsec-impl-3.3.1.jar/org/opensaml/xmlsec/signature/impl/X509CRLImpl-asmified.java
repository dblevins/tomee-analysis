...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/signature/impl/X509CRLImpl", null, "org/opensaml/core/xml/AbstractXMLObject", new String[] { "org/opensaml/xmlsec/signature/X509CRL" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "B64_CRL_STORE", "Lnet/shibboleth/utilities/java/support/collection/IndexingObjectStore;", "Lnet/shibboleth/utilities/java/support/collection/IndexingObjectStore<Ljava/lang/String;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "b64CRLIndex", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/opensaml/xmlsec/signature/impl/X509CRLImpl", "B64_CRL_STORE", "Lnet/shibboleth/utilities/java/support/collection/IndexingObjectStore;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/signature/impl/X509CRLImpl", "b64CRLIndex", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/signature/impl/X509CRLImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/signature/impl/X509CRLImpl", "b64CRLIndex", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/xmlsec/signature/impl/X509CRLImpl", "B64_CRL_STORE", "Lnet/shibboleth/utilities/java/support/collection/IndexingObjectStore;");
methodVisitor.visitInsn(RETURN);
