...
public class WhitelistPredicateDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/impl/WhitelistPredicate", "Ljava/lang/Object;Lcom/google/common/base/Predicate<Ljava/lang/String;>;", "java/lang/Object", new String[] { "com/google/common/base/Predicate" });
...
methodVisitor.visitLdcInsn("Whitelist may not be null");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/impl/WhitelistPredicate", "whitelist", "Ljava/util/Collection;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/impl/WhitelistPredicate", "whitelist", "Ljava/util/Collection;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/WhitelistPredicate", "apply", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
