...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/enterprise/inject/New", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
classWriter.visitInnerClass("javax/enterprise/inject/New$Literal", "javax/enterprise/inject/New", "Literal", ACC_PUBLIC | ACC_FINAL | ACC_STATIC);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "value", "()Ljava/lang/Class;", "()Ljava/lang/Class<*>;", null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Ljavax/enterprise/inject/New;"));
annotationVisitor0.visitEnd();
}
