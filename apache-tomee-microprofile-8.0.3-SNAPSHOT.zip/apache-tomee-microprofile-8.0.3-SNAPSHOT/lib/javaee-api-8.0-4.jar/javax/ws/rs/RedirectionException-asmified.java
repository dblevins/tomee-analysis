...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/ws/rs/RedirectionException", null, "javax/ws/rs/WebApplicationException", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/ws/rs/core/Response$Status;Ljava/net/URI;)V", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/ws/rs/RedirectionException", "validate", "(Ljavax/ws/rs/core/Response;Ljavax/ws/rs/core/Response$Status$Family;)Ljavax/ws/rs/core/Response;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;Ljavax/ws/rs/core/Response$Status;Ljava/net/URI;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/ws/rs/RedirectionException", "getResponse", "()Ljavax/ws/rs/core/Response;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/ws/rs/core/Response", "getLocation", "()Ljava/net/URI;", false);
