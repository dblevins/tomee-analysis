...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljavax/persistence/PessimisticLockScope;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "values", "()[Ljavax/persistence/PessimisticLockScope;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/PessimisticLockScope", "$VALUES", "[Ljavax/persistence/PessimisticLockScope;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljavax/persistence/PessimisticLockScope;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/persistence/PessimisticLockScope;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/PessimisticLockScope", "$VALUES", "[Ljavax/persistence/PessimisticLockScope;");
methodVisitor.visitInsn(RETURN);
