...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/cache/CacheManager", null, "java/lang/Object", new String[] { "java/io/Closeable" });

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getCachingProvider", "()Ljavax/cache/spi/CachingProvider;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createCache", "(Ljava/lang/String;Ljavax/cache/configuration/Configuration;)Ljavax/cache/Cache;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;C::Ljavax/cache/configuration/Configuration<TK;TV;>;>(Ljava/lang/String;TC;)Ljavax/cache/Cache<TK;TV;>;", new String[] { "java/lang/IllegalArgumentException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getCache", "(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;)Ljavax/cache/Cache;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/lang/String;Ljava/lang/Class<TK;>;Ljava/lang/Class<TV;>;)Ljavax/cache/Cache<TK;TV;>;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getCache", "(Ljava/lang/String;)Ljavax/cache/Cache;", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>(Ljava/lang/String;)Ljavax/cache/Cache<TK;TV;>;", null);
methodVisitor.visitEnd();
}
{
