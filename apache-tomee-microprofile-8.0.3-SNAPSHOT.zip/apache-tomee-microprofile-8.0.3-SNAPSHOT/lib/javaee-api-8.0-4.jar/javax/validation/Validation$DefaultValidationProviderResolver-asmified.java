...
classWriter.visit(V1_8, ACC_SUPER, "javax/validation/Validation$DefaultValidationProviderResolver", null, "java/lang/Object", new String[] { "javax/validation/ValidationProviderResolver" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "providerCache", "Ljava/util/WeakHashMap;", "Ljava/util/WeakHashMap<Ljava/lang/ClassLoader;Ljava/util/List<Ljavax/validation/spi/ValidationProvider<*>;>;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/validation/Validation$DefaultValidationProviderResolver", "providerCache", "Ljava/util/WeakHashMap;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/validation/Validation$DefaultValidationProviderResolver$PrivClassLoader", "get", "(Ljava/lang/Class;)Ljava/lang/ClassLoader;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label6 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label6);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/Validation$DefaultValidationProviderResolver;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/validation/Validation$DefaultValidationProviderResolver$PrivClassLoader", "get", "(Ljava/lang/Class;)Ljava/lang/ClassLoader;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.TOP, "java/lang/ClassLoader"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/validation/Validation$DefaultValidationProviderResolver", "providerCache", "Ljava/util/WeakHashMap;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/validation/Validation$DefaultValidationProviderResolver", "java/util/List", "java/lang/ClassLoader", "java/lang/ClassLoader", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/validation/Validation$DefaultValidationProviderResolver", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
