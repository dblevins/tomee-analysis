...
public class JsonValue$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "javax/json/JsonValue$1", null, "java/lang/Object", new String[] { "javax/json/JsonValue" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/JsonValue$1", "getValueType", "()Ljavax/json/JsonValue$ValueType;", false);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/json/JsonValue$ValueType", "NULL", "Ljavax/json/JsonValue$ValueType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/JsonValue$ValueType", "hashCode", "()I", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
