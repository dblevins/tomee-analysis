...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/security/enterprise/identitystore/IdentityStore", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "DEFAULT_VALIDATION_TYPES", "Ljava/util/Set;", "Ljava/util/Set<Ljavax/security/enterprise/identitystore/IdentityStore$ValidationType;>;", null);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/security/enterprise/identitystore/CredentialValidationResult;"));
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/invoke/MethodHandle", "invoke", "(Ljavax/security/enterprise/credential/Credential;)Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/security/enterprise/identitystore/CredentialValidationResult");
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/security/enterprise/identitystore/CredentialValidationResult", "NOT_VALIDATED_RESULT", "Ljavax/security/enterprise/identitystore/CredentialValidationResult;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/security/enterprise/identitystore/IdentityStore", "DEFAULT_VALIDATION_TYPES", "Ljava/util/Set;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/security/enterprise/identitystore/IdentityStore", "DEFAULT_VALIDATION_TYPES", "Ljava/util/Set;");
