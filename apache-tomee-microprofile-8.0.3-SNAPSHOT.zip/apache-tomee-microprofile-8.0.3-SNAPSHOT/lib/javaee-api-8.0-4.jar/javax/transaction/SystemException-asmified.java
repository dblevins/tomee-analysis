...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "javax/transaction/SystemException", null, "java/lang/Exception", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/transaction/SystemException", "errorCode", "I");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
