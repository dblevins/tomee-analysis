...
public class MTOMDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/ws/soap/MTOM", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("id", "http://www.w3.org/2004/08/soap/features/http-optimization");
annotationVisitor0.visit("bean", Type.getType("Ljavax/xml/ws/soap/MTOMFeature;"));
annotationVisitor0.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "threshold", "()I", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
