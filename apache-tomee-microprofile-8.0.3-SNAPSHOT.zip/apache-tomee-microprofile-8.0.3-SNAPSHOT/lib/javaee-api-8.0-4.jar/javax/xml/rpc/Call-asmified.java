...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addParameter", "(Ljava/lang/String;Ljavax/xml/namespace/QName;Ljavax/xml/rpc/ParameterMode;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addParameter", "(Ljava/lang/String;Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljavax/xml/rpc/ParameterMode;)V", null, null);
methodVisitor.visitEnd();
}
{
