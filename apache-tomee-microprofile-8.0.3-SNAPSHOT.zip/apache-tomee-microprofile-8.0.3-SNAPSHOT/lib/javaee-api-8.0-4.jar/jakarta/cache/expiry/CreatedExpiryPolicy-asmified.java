...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "jakarta/cache/expiry/CreatedExpiryPolicy", null, "java/lang/Object", new String[] { "jakarta/cache/expiry/ExpiryPolicy", "java/io/Serializable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/cache/expiry/CreatedExpiryPolicy", "expiryDuration", "Ljakarta/cache/expiry/Duration;");
...
methodVisitor.visitTypeInsn(NEW, "jakarta/cache/expiry/CreatedExpiryPolicy");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/cache/expiry/CreatedExpiryPolicy", "<init>", "(Ljakarta/cache/expiry/Duration;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/cache/expiry/CreatedExpiryPolicy", "expiryDuration", "Ljakarta/cache/expiry/Duration;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/cache/expiry/CreatedExpiryPolicy", Opcodes.INTEGER, Opcodes.INTEGER}, 1, new Object[] {Opcodes.INTEGER});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/cache/expiry/CreatedExpiryPolicy", "expiryDuration", "Ljakarta/cache/expiry/Duration;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/cache/expiry/Duration", "hashCode", "()I", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/cache/expiry/CreatedExpiryPolicy", Opcodes.INTEGER, Opcodes.INTEGER}, 2, new Object[] {Opcodes.INTEGER, Opcodes.INTEGER});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/cache/expiry/CreatedExpiryPolicy");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/cache/expiry/CreatedExpiryPolicy");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/cache/expiry/CreatedExpiryPolicy"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/cache/expiry/CreatedExpiryPolicy", "expiryDuration", "Ljakarta/cache/expiry/Duration;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/cache/expiry/CreatedExpiryPolicy", "expiryDuration", "Ljakarta/cache/expiry/Duration;");
