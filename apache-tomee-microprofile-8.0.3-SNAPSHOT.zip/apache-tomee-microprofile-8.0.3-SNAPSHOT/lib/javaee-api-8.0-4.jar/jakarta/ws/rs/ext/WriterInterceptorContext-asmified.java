...
public class WriterInterceptorContextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/ws/rs/ext/WriterInterceptorContext", null, "java/lang/Object", new String[] { "jakarta/ws/rs/ext/InterceptorContext" });

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "proceed", "()V", null, new String[] { "java/io/IOException", "jakarta/ws/rs/WebApplicationException" });
