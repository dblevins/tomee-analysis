...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/json/JsonWriterFactory", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createWriter", "(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)Ljakarta/json/JsonWriter;", null, null);
methodVisitor.visitEnd();
}
{
