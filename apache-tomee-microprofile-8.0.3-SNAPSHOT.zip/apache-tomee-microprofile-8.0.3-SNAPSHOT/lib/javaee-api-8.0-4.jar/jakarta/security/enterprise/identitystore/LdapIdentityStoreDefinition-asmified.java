...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/security/enterprise/identitystore/LdapIdentityStoreDefinition", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "callerSearchScope", "()Ljakarta/security/enterprise/identitystore/LdapIdentityStoreDefinition$LdapSearchScope;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljakarta/security/enterprise/identitystore/LdapIdentityStoreDefinition$LdapSearchScope;", "SUBTREE");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "groupSearchScope", "()Ljakarta/security/enterprise/identitystore/LdapIdentityStoreDefinition$LdapSearchScope;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljakarta/security/enterprise/identitystore/LdapIdentityStoreDefinition$LdapSearchScope;", "SUBTREE");
annotationVisitor0.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "useFor", "()[Ljakarta/security/enterprise/identitystore/IdentityStore$ValidationType;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
AnnotationVisitor annotationVisitor1 = annotationVisitor0.visitArray(null);
annotationVisitor1.visitEnum(null, "Ljakarta/security/enterprise/identitystore/IdentityStore$ValidationType;", "VALIDATE");
annotationVisitor1.visitEnum(null, "Ljakarta/security/enterprise/identitystore/IdentityStore$ValidationType;", "PROVIDE_GROUPS");
annotationVisitor1.visitEnd();
}
annotationVisitor0.visitEnd();
}
