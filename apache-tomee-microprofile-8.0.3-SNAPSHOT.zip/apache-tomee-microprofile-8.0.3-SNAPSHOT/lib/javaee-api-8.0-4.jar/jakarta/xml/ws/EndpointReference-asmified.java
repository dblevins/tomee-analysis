...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "jakarta/xml/ws/EndpointReference", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "readFrom", "(Ljavax/xml/transform/Source;)Ljakarta/xml/ws/EndpointReference;", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/xml/ws/spi/Provider", "provider", "()Ljakarta/xml/ws/spi/Provider;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/Provider", "readEndpointReference", "(Ljavax/xml/transform/Source;)Ljakarta/xml/ws/EndpointReference;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/Provider", "getPort", "(Ljakarta/xml/ws/EndpointReference;Ljava/lang/Class;[Ljakarta/xml/ws/WebServiceFeature;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/EndpointReference", "writeTo", "(Ljavax/xml/transform/Result;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
