...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/xml/ws/soap/MTOM", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("bean", Type.getType("Ljakarta/xml/ws/soap/MTOMFeature;"));
annotationVisitor0.visitEnd();
}
{
