...
public class Path$BeanNodeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/Path$BeanNode", null, "java/lang/Object", new String[] { "jakarta/validation/Path$Node" });
