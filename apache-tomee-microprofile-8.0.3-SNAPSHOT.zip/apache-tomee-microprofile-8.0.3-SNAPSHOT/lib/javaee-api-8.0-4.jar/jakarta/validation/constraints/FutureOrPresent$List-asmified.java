...
public class FutureOrPresent$ListDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/FutureOrPresent$List", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "value", "()[Ljakarta/validation/constraints/FutureOrPresent;", null, null);
