...
public class NegativeOrZeroDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/NegativeOrZero", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/validation/constraints/NegativeOrZero$List;"));
annotationVisitor0.visitEnd();
}
classWriter.visitInnerClass("jakarta/validation/constraints/NegativeOrZero$List", "jakarta/validation/constraints/NegativeOrZero", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "message", "()Ljava/lang/String;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, "{jakarta.validation.constraints.NegativeOrZero.message}");
annotationVisitor0.visitEnd();
}
