...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/AssertTrue", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/validation/constraints/AssertTrue$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{jakarta.validation.constraints.AssertTrue.message}");
annotationVisitor0.visitEnd();
}
