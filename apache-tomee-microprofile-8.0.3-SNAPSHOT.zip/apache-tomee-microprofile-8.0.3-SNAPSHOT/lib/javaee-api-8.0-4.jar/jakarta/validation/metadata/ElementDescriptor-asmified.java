...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/metadata/ElementDescriptor", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "findConstraints", "()Ljakarta/validation/metadata/ElementDescriptor$ConstraintFinder;", null, null);
methodVisitor.visitEnd();
}
