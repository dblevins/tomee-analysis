...
public class StatefulTimeoutDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/ejb/StatefulTimeout", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visitEnum(null, "Ljava/util/concurrent/TimeUnit;", "MINUTES");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
