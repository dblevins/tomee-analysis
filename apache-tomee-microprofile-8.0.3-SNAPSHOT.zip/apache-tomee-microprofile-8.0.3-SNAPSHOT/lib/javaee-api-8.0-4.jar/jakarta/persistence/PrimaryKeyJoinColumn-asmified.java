...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/persistence/PrimaryKeyJoinColumn", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/persistence/PrimaryKeyJoinColumns;"));
annotationVisitor0.visitEnd();
}
{
