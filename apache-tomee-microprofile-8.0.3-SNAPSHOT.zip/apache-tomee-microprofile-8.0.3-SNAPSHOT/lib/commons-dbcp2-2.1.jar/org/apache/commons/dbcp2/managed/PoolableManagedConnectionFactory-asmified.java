...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/commons/dbcp2/managed/XAConnectionFactory;Ljavax/management/ObjectName;)V", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/dbcp2/managed/PoolableManagedConnectionFactory", "getDataSourceJmxName", "()Ljavax/management/ObjectName;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/commons/pool2/impl/GenericKeyedObjectPoolConfig", "javax/management/ObjectName", Opcodes.LONG}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
