...
public class JsonPropertyOrderDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "com/fasterxml/jackson/annotation/JsonPropertyOrder", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "alphabetic", "()Z", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
