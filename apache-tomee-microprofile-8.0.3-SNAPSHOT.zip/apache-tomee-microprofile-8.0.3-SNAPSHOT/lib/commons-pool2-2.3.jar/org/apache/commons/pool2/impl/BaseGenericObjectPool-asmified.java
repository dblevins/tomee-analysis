...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "oname", "Ljavax/management/ObjectName;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/pool2/impl/BaseGenericObjectPool", "jmxRegister", "(Lorg/apache/commons/pool2/impl/BaseObjectPoolConfig;Ljava/lang/String;Ljava/lang/String;)Ljavax/management/ObjectName;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool", "oname", "Ljavax/management/ObjectName;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool", "oname", "Ljavax/management/ObjectName;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
Label label3 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label3, "javax/management/InstanceNotFoundException");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/impl/BaseGenericObjectPool", "oname", "Ljavax/management/ObjectName;");
Label label4 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "jmxRegister", "(Lorg/apache/commons/pool2/impl/BaseObjectPoolConfig;Ljava/lang/String;Ljava/lang/String;)Ljavax/management/ObjectName;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label5, "javax/management/NotCompliantMBeanException");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/management/ManagementFactory", "getPlatformMBeanServer", "()Ljavax/management/MBeanServer;", false);
