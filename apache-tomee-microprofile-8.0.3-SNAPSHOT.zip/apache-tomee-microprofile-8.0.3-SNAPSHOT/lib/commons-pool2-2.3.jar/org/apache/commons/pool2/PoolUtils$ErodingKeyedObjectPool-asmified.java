...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "<K:Ljava/lang/Object;V:Ljava/lang/Object;>Ljava/lang/Object;Lorg/apache/commons/pool2/KeyedObjectPool<TK;TV;>;", "java/lang/Object", new String[] { "org/apache/commons/pool2/KeyedObjectPool" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "keyedPool", "Lorg/apache/commons/pool2/KeyedObjectPool;", "Lorg/apache/commons/pool2/KeyedObjectPool<TK;TV;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "erodingFactor", "Lorg/apache/commons/pool2/PoolUtils$ErodingFactor;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/commons/pool2/KeyedObjectPool;Lorg/apache/commons/pool2/PoolUtils$ErodingFactor;)V", "(Lorg/apache/commons/pool2/KeyedObjectPool<TK;TV;>;Lorg/apache/commons/pool2/PoolUtils$ErodingFactor;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "org/apache/commons/pool2/KeyedObjectPool", "org/apache/commons/pool2/PoolUtils$ErodingFactor"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "keyedPool", "Lorg/apache/commons/pool2/KeyedObjectPool;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "erodingFactor", "Lorg/apache/commons/pool2/PoolUtils$ErodingFactor;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "keyedPool", "Lorg/apache/commons/pool2/KeyedObjectPool;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "getErodingFactor", "(Ljava/lang/Object;)Lorg/apache/commons/pool2/PoolUtils$ErodingFactor;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "getNumIdle", "(Ljava/lang/Object;)I", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "java/lang/Object", "java/lang/Object", Opcodes.INTEGER, Opcodes.LONG, "org/apache/commons/pool2/PoolUtils$ErodingFactor", "java/lang/Object", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(LLOAD, 4);
methodVisitor.visitVarInsn(ILOAD, 8);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "erodingFactor", "Lorg/apache/commons/pool2/PoolUtils$ErodingFactor;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getKeyedPool", "()Lorg/apache/commons/pool2/KeyedObjectPool;", "()Lorg/apache/commons/pool2/KeyedObjectPool<TK;TV;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/pool2/PoolUtils$ErodingKeyedObjectPool", "keyedPool", "Lorg/apache/commons/pool2/KeyedObjectPool;");
methodVisitor.visitInsn(ARETURN);
