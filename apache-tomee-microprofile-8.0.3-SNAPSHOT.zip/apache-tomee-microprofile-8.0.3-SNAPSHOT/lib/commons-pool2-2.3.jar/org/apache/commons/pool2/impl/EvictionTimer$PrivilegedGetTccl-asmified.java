...
public class EvictionTimer$PrivilegedGetTcclDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_SUPER, "org/apache/commons/pool2/impl/EvictionTimer$PrivilegedGetTccl", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/lang/ClassLoader;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/pool2/impl/EvictionTimer$PrivilegedGetTccl", "run", "()Ljava/lang/ClassLoader;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/pool2/impl/EvictionTimer$PrivilegedGetTccl", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
