...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/transport/http/HttpServletRequestSnapshot", null, "jakarta/servlet/http/HttpServletRequestWrapper", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "cookies", "[Ljakarta/servlet/http/Cookie;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/transport/http/HttpServletRequestSnapshot", "cookies", "[Ljakarta/servlet/http/Cookie;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/transport/http/HttpServletRequestSnapshot", "jakarta/servlet/http/HttpServletRequest", "java/util/Enumeration"}, 0, new Object[] {});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/transport/http/HttpServletRequestSnapshot", "session", "Ljakarta/servlet/http/HttpSession;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/http/HttpServletRequestSnapshot", "cookies", "[Ljakarta/servlet/http/Cookie;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/http/HttpServletRequestSnapshot", "session", "Ljakarta/servlet/http/HttpSession;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
