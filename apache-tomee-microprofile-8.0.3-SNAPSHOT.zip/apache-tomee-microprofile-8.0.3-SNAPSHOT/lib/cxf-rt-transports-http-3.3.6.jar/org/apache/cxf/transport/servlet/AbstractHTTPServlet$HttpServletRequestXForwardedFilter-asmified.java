...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/transport/servlet/AbstractHTTPServlet$HttpServletRequestXForwardedFilter", null, "jakarta/servlet/http/HttpServletRequestWrapper", null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", null, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/transport/servlet/AbstractHTTPServlet$HttpServletRequestXForwardedFilter", "jakarta/servlet/http/HttpServletRequest", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/transport/servlet/AbstractHTTPServlet$HttpServletRequestXForwardedFilter", "calculateNewRequestUri", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/transport/servlet/AbstractHTTPServlet$HttpServletRequestXForwardedFilter", "calculateNewRequestUrl", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/transport/servlet/AbstractHTTPServlet$HttpServletRequestXForwardedFilter", "calculateNewContextPath", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/transport/servlet/AbstractHTTPServlet$HttpServletRequestXForwardedFilter", "calculateNewServletPath", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "calculateNewContextPath", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "calculateNewServletPath", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "calculateNewRequestUri", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "calculateNewRequestUrl", "(Ljakarta/servlet/http/HttpServletRequest;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuffer;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"jakarta/servlet/http/HttpServletRequest", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/net/URI", "java/lang/StringBuffer"}, 1, new Object[] {"java/lang/StringBuffer"});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/net/URI", "getScheme", "()Ljava/lang/String;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"jakarta/servlet/http/HttpServletRequest", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/net/URI", "java/lang/StringBuffer"}, 2, new Object[] {"java/lang/StringBuffer", "java/lang/String"});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/http/HttpServletRequestWrapper", "isSecure", "()Z", false);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/http/HttpServletRequestWrapper", "getRemoteAddr", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
