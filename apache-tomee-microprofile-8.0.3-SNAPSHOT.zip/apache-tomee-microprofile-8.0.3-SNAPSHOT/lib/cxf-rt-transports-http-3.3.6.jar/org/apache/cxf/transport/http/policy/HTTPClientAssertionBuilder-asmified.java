...
public class HTTPClientAssertionBuilderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/transport/http/policy/HTTPClientAssertionBuilder", "Lorg/apache/cxf/ws/policy/builder/jaxb/JaxbAssertionBuilder<Lorg/apache/cxf/transports/http/configuration/HTTPClientPolicy;>;", "org/apache/cxf/ws/policy/builder/jaxb/JaxbAssertionBuilder", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, new String[] { "javax/xml/bind/JAXBException" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildAssertion", "()Lorg/apache/cxf/ws/policy/builder/jaxb/JaxbAssertion;", "()Lorg/apache/cxf/ws/policy/builder/jaxb/JaxbAssertion<Lorg/apache/cxf/transports/http/configuration/HTTPClientPolicy;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/transport/http/policy/HTTPClientAssertionBuilder", "KNOWN_ELEMENTS", "Ljava/util/List;");
methodVisitor.visitInsn(RETURN);
