...
public class DOMImplementationRegistry$4Dump implements Opcodes {
...
classWriter.visit(V1_1, ACC_SUPER, "org/w3c/dom/bootstrap/DOMImplementationRegistry$4", null, "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/w3c/dom/bootstrap/DOMImplementationRegistry$4", "val$classLoader", "Ljava/lang/ClassLoader;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/w3c/dom/bootstrap/DOMImplementationRegistry$4", "val$name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/w3c/dom/bootstrap/DOMImplementationRegistry$4", "val$classLoader", "Ljava/lang/ClassLoader;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/w3c/dom/bootstrap/DOMImplementationRegistry$4", "val$name", "Ljava/lang/String;");
