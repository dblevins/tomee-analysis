...
public class HTMLHRElementDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/w3c/dom/html/HTMLHRElement", null, "java/lang/Object", new String[] { "org/w3c/dom/html/HTMLElement" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getNoShade", "()Z", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setNoShade", "(Z)V", null, null);
methodVisitor.visitEnd();
}
{
