...
public class SAXExceptionDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_SUPER, "org/xml/sax/SAXException", null, "java/lang/Exception", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(583241635256073760L));
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/xml/sax/SAXException", "exception", "Ljava/lang/Exception;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/xml/sax/SAXException", "exception", "Ljava/lang/Exception;");
