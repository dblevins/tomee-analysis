...
public class EventReaderDelegateDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_SUPER, "javax/xml/stream/util/EventReaderDelegate", null, "java/lang/Object", new String[] { "javax/xml/stream/XMLEventReader" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "reader", "Ljavax/xml/stream/XMLEventReader;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/stream/util/EventReaderDelegate", "reader", "Ljavax/xml/stream/XMLEventReader;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setParent", "(Ljavax/xml/stream/XMLEventReader;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/stream/util/EventReaderDelegate", "reader", "Ljavax/xml/stream/XMLEventReader;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getParent", "()Ljavax/xml/stream/XMLEventReader;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/stream/util/EventReaderDelegate", "reader", "Ljavax/xml/stream/XMLEventReader;");
