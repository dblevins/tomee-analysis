...
public class StreamReaderDelegateDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_SUPER, "javax/xml/stream/util/StreamReaderDelegate", null, "java/lang/Object", new String[] { "javax/xml/stream/XMLStreamReader" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/stream/util/StreamReaderDelegate", "reader", "Ljavax/xml/stream/XMLStreamReader;");
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getParent", "()Ljavax/xml/stream/XMLStreamReader;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/stream/util/StreamReaderDelegate", "reader", "Ljavax/xml/stream/XMLStreamReader;");
