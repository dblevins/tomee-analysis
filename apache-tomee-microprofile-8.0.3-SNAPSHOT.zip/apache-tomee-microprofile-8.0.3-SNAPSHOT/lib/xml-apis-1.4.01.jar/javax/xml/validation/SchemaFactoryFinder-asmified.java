...
public class SchemaFactoryFinderDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_FINAL | ACC_SUPER, "javax/xml/validation/SchemaFactoryFinder", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "W3C_XML_SCHEMA10_NS_URI", "Ljava/lang/String;", null, "http://www.w3.org/XML/XMLSchema/v1.0");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "W3C_XML_SCHEMA11_NS_URI", "Ljava/lang/String;", null, "http://www.w3.org/XML/XMLSchema/v1.1");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/validation/SchemaFactoryFinder", "classLoader", "Ljava/lang/ClassLoader;");
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/validation/SchemaFactoryFinder", "debugDisplayClassLoader", "()V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/validation/SchemaFactoryFinder", "classLoader", "Ljava/lang/ClassLoader;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "newFactory", "(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/validation/SchemaFactoryFinder", "_newFactory", "(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "_newFactory", "(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuffer", "<init>", "()V", false);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "SERVICE_CLASS", "Ljava/lang/Class;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SecuritySupport", "getSystemProperty", "(Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "firstTime", "Z");
Label label17 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label17);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "cacheProps", "Ljava/util/Properties;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "firstTime", "Z");
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SecuritySupport", "doesFileExist", "(Ljava/io/File;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label18);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "cacheProps", "Ljava/util/Properties;");
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SecuritySupport", "getFileInputStream", "(Ljava/io/File;)Ljava/io/FileInputStream;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/validation/SchemaFactoryFinder", "createServiceFileIterator", "()Ljava/util/Iterator;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SecuritySupport", "getURLInputStream", "(Ljava/net/URL;)Ljava/io/InputStream;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/validation/SchemaFactoryFinder", "loadFromServicesFile", "(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Ljavax/xml/validation/SchemaFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("http://www.w3.org/XML/XMLSchema/v1.0");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitLdcInsn("attempting to use the platform default XML Schema 1.0 validator");
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label26);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("org.apache.xerces.jaxp.validation.XMLSchemaFactory");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/validation/SchemaFactoryFinder", "createInstance", "(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label25);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("http://www.w3.org/XML/XMLSchema/v1.1");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitLdcInsn("attempting to use the platform default XML Schema 1.1 validator");
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label28);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("org.apache.xerces.jaxp.validation.XMLSchema11Factory");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/validation/SchemaFactoryFinder", "createInstance", "(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(0, "createInstance", "(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "which", "(Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label8);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/xml/validation/SchemaFactory");
Label label9 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label9);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/validation/SchemaFactory");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label9);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
methodVisitor.visitJumpInsn(IFEQ, label1);
...
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/validation/SchemaFactoryFinder", "classLoader", "Ljava/lang/ClassLoader;");
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitTypeInsn(NEW, "javax/xml/validation/SchemaFactoryFinder$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/validation/SchemaFactoryFinder$1", "<init>", "(Ljavax/xml/validation/SchemaFactoryFinder;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/validation/SchemaFactoryFinder", "classLoader", "Ljava/lang/ClassLoader;");
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "SERVICE_ID", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SecuritySupport", "getResources", "(Ljava/lang/ClassLoader;Ljava/lang/String;)Ljava/util/Enumeration;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "debugPrintln", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label2);
methodVisitor.visitTypeInsn(NEW, "javax/xml/validation/SchemaFactoryFinder$2");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/validation/SchemaFactoryFinder$2", "<init>", "(Ljavax/xml/validation/SchemaFactoryFinder;Ljava/util/Enumeration;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "loadFromServicesFile", "(Ljava/lang/String;Ljava/lang/String;Ljava/io/InputStream;)Ljavax/xml/validation/SchemaFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "which", "(Ljava/lang/String;Ljava/lang/ClassLoader;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
methodVisitor.visitTypeInsn(NEW, "java/util/Properties");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/Properties", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "cacheProps", "Ljava/util/Properties;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "debug", "Z");
methodVisitor.visitLabel(label5);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "class$javax$xml$validation$SchemaFactory", "Ljava/lang/Class;");
Label label6 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label6);
methodVisitor.visitLdcInsn("javax.xml.validation.SchemaFactory");
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/validation/SchemaFactoryFinder", "class$", "(Ljava/lang/String;)Ljava/lang/Class;", false);
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "class$javax$xml$validation$SchemaFactory", "Ljava/lang/Class;");
Label label7 = new Label();
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label6);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/xml/validation/SchemaFactoryFinder", "class$javax$xml$validation$SchemaFactory", "Ljava/lang/Class;");
methodVisitor.visitLabel(label7);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "SERVICE_CLASS", "Ljava/lang/Class;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuffer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuffer", "<init>", "()V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/xml/validation/SchemaFactoryFinder", "SERVICE_ID", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
