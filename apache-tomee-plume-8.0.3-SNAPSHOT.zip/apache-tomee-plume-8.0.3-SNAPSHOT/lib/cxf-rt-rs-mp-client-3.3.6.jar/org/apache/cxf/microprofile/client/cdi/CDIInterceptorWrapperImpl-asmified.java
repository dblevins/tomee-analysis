...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "creationalContext", "Ljakarta/enterprise/context/spi/CreationalContext;", "Ljakarta/enterprise/context/spi/CreationalContext<*>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "java/lang/Class", "java/lang/Object", "jakarta/enterprise/inject/spi/BeanManager"}, 1, new Object[] {"org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "java/lang/Class", "java/lang/Object", "jakarta/enterprise/inject/spi/BeanManager"}, 2, new Object[] {"org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "jakarta/enterprise/context/spi/CreationalContext"});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "creationalContext", "Ljakarta/enterprise/context/spi/CreationalContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "creationalContext", "Ljakarta/enterprise/context/spi/CreationalContext;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "initInterceptorInvokers", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/context/spi/CreationalContext;Ljava/lang/Class;)Ljava/util/Map;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "initInterceptorInvokers", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/context/spi/CreationalContext;Ljava/lang/Class;)Ljava/util/Map;", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/context/spi/CreationalContext<*>;Ljava/lang/Class<*>;)Ljava/util/Map<Ljava/lang/reflect/Method;Ljava/util/List<Lorg/apache/cxf/microprofile/client/cdi/InterceptorInvoker;>;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/microprofile/client/cdi/CDIInterceptorWrapperImpl", "getBindings", "(Ljava/util/Set;Ljakarta/enterprise/inject/spi/BeanManager;)Ljava/util/List;", false);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"jakarta/enterprise/inject/spi/BeanManager", "jakarta/enterprise/context/spi/CreationalContext", "java/lang/Class", "java/util/Map", "java/util/Map", "jakarta/enterprise/inject/spi/AnnotatedType", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/BeanManager", "resolveInterceptors", "(Ljakarta/enterprise/inject/spi/InterceptionType;[Ljava/lang/annotation/Annotation;)Ljava/util/List;", true);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/microprofile/client/cdi/InterceptorInvoker", "<init>", "(Ljakarta/enterprise/inject/spi/Interceptor;Ljava/lang/Object;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getBindings", "(Ljava/util/Set;Ljakarta/enterprise/inject/spi/BeanManager;)Ljava/util/List;", "(Ljava/util/Set<Ljava/lang/annotation/Annotation;>;Ljakarta/enterprise/inject/spi/BeanManager;)Ljava/util/List<Ljava/lang/annotation/Annotation;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/lang/annotation/Annotation", "annotationType", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/BeanManager", "isInterceptorBinding", "(Ljava/lang/Class;)Z", true);
Label label4 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$initInterceptorInvokers$0", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/context/spi/CreationalContext;Ljakarta/enterprise/inject/spi/Interceptor;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
