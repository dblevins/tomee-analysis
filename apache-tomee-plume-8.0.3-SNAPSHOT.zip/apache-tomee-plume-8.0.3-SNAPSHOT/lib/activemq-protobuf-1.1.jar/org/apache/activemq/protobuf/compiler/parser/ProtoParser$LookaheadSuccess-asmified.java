...
public class ProtoParser$LookaheadSuccessDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/apache/activemq/protobuf/compiler/parser/ProtoParser$LookaheadSuccess", null, "java/lang/Error", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/activemq/protobuf/compiler/parser/ProtoParser$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/protobuf/compiler/parser/ProtoParser$LookaheadSuccess", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
