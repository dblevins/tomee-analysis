...
public class ObligationsTypeUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/policy/impl/ObligationsTypeUnmarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectUnmarshaller", null);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/xacml/policy/ObligationType");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xacml/policy/ObligationsType"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
