...
public class ResourceMatchTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/policy/impl/ResourceMatchTypeMarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/policy/ResourceMatchType", "getMatchId", "()Ljava/lang/String;", true);
