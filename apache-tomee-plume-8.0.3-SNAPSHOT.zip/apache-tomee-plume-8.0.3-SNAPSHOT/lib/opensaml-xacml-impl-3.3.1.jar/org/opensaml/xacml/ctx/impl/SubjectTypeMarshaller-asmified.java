...
public class SubjectTypeMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/ctx/impl/SubjectTypeMarshaller", null, "org/opensaml/xacml/impl/AbstractXACMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/xacml/ctx/SubjectType", "getSubjectCategory", "()Ljava/lang/String;", true);
