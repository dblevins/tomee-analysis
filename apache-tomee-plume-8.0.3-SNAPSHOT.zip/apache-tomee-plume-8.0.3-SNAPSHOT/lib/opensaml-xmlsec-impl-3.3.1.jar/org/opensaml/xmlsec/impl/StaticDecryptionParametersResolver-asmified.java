...
public class StaticDecryptionParametersResolverDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/impl/StaticDecryptionParametersResolver", null, "java/lang/Object", new String[] { "org/opensaml/xmlsec/DecryptionParametersResolver" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "params", "Lorg/opensaml/xmlsec/DecryptionParameters;", null, null);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/xmlsec/DecryptionParameters");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/impl/StaticDecryptionParametersResolver", "params", "Lorg/opensaml/xmlsec/DecryptionParameters;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/impl/StaticDecryptionParametersResolver", "params", "Lorg/opensaml/xmlsec/DecryptionParameters;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/StaticDecryptionParametersResolver", "resolveSingle", "(Lnet/shibboleth/utilities/java/support/resolver/CriteriaSet;)Lorg/opensaml/xmlsec/DecryptionParameters;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "net/shibboleth/utilities/java/support/resolver/CriteriaSet");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/StaticDecryptionParametersResolver", "resolve", "(Lnet/shibboleth/utilities/java/support/resolver/CriteriaSet;)Ljava/lang/Iterable;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
