...
public class StaticSignatureValidationParametersResolverDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/impl/StaticSignatureValidationParametersResolver", null, "java/lang/Object", new String[] { "org/opensaml/xmlsec/SignatureValidationParametersResolver" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "params", "Lorg/opensaml/xmlsec/SignatureValidationParameters;", null, null);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/xmlsec/SignatureValidationParameters");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/impl/StaticSignatureValidationParametersResolver", "params", "Lorg/opensaml/xmlsec/SignatureValidationParameters;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/impl/StaticSignatureValidationParametersResolver", "params", "Lorg/opensaml/xmlsec/SignatureValidationParameters;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/StaticSignatureValidationParametersResolver", "resolveSingle", "(Lnet/shibboleth/utilities/java/support/resolver/CriteriaSet;)Lorg/opensaml/xmlsec/SignatureValidationParameters;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "net/shibboleth/utilities/java/support/resolver/CriteriaSet");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/StaticSignatureValidationParametersResolver", "resolve", "(Lnet/shibboleth/utilities/java/support/resolver/CriteriaSet;)Ljava/lang/Iterable;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
