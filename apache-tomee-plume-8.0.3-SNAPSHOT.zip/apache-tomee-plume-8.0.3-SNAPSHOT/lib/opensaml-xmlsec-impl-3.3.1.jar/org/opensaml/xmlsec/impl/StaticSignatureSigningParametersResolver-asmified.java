...
public class StaticSignatureSigningParametersResolverDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/impl/StaticSignatureSigningParametersResolver", null, "java/lang/Object", new String[] { "org/opensaml/xmlsec/SignatureSigningParametersResolver" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "params", "Lorg/opensaml/xmlsec/SignatureSigningParameters;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/opensaml/xmlsec/SignatureSigningParameters;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/impl/StaticSignatureSigningParametersResolver", "params", "Lorg/opensaml/xmlsec/SignatureSigningParameters;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/impl/StaticSignatureSigningParametersResolver", "params", "Lorg/opensaml/xmlsec/SignatureSigningParameters;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/StaticSignatureSigningParametersResolver", "resolveSingle", "(Lnet/shibboleth/utilities/java/support/resolver/CriteriaSet;)Lorg/opensaml/xmlsec/SignatureSigningParameters;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "net/shibboleth/utilities/java/support/resolver/CriteriaSet");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/impl/StaticSignatureSigningParametersResolver", "resolve", "(Lnet/shibboleth/utilities/java/support/resolver/CriteriaSet;)Ljava/lang/Iterable;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
