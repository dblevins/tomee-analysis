...
public class AbstractSecurityParametersResolver$1Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER | ACC_SYNTHETIC, "org/opensaml/xmlsec/impl/AbstractSecurityParametersResolver$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/opensaml/xmlsec/impl/AbstractSecurityParametersResolver", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$opensaml$xmlsec$WhitelistBlacklistConfiguration$Precedence", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/xmlsec/WhitelistBlacklistConfiguration$Precedence", "values", "()[Lorg/opensaml/xmlsec/WhitelistBlacklistConfiguration$Precedence;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/xmlsec/impl/AbstractSecurityParametersResolver$1", "$SwitchMap$org$opensaml$xmlsec$WhitelistBlacklistConfiguration$Precedence", "[I");
