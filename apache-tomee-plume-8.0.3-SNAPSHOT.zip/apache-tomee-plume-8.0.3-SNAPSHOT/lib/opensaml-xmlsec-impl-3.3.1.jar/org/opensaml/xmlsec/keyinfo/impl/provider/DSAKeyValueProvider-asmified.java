...
public class DSAKeyValueProviderDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", null, "org/opensaml/xmlsec/keyinfo/impl/provider/AbstractKeyInfoProvider", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "getDSAKeyValue", "(Lorg/opensaml/core/xml/XMLObject;)Lorg/opensaml/xmlsec/signature/DSAKeyValue;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xmlsec/signature/DSAKeyValue"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Criterion specified non-DSA key algorithm, skipping");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Attempting to extract credential from a DSAKeyValue");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "org/opensaml/xmlsec/keyinfo/KeyInfoCredentialResolver", "org/opensaml/core/xml/XMLObject", "net/shibboleth/utilities/java/support/resolver/CriteriaSet", "org/opensaml/xmlsec/keyinfo/impl/KeyInfoResolutionContext", "org/opensaml/xmlsec/signature/DSAKeyValue", "java/security/PublicKey"}, 1, new Object[] {"java/security/KeyException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Error extracting DSA key value");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "buildCredentialContext", "(Lorg/opensaml/xmlsec/keyinfo/impl/KeyInfoResolutionContext;)Lorg/opensaml/xmlsec/keyinfo/impl/KeyInfoCredentialContext;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/DSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Credential successfully extracted from DSAKeyValue");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;)V", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getDSAKeyValue", "(Lorg/opensaml/core/xml/XMLObject;)Lorg/opensaml/xmlsec/signature/DSAKeyValue;", null, null);
methodVisitor.visitAnnotableParameterCount(1, true);
{
annotationVisitor0 = methodVisitor.visitParameterAnnotation(0, "Ljakarta/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/xmlsec/signature/DSAKeyValue");
Label label0 = new Label();
