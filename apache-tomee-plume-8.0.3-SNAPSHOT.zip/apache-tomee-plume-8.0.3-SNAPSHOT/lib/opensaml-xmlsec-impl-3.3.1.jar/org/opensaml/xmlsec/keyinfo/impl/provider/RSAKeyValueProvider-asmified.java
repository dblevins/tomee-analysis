...
public class RSAKeyValueProviderDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", null, "org/opensaml/xmlsec/keyinfo/impl/provider/AbstractKeyInfoProvider", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/slf4j/LoggerFactory", "getLogger", "(Ljava/lang/Class;)Lorg/slf4j/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "getRSAKeyValue", "(Lorg/opensaml/core/xml/XMLObject;)Lorg/opensaml/xmlsec/signature/RSAKeyValue;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xmlsec/signature/RSAKeyValue"}, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Criterion specified non-RSA key algorithm, skipping");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Attempting to extract credential from an RSAKeyValue");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "org/opensaml/xmlsec/keyinfo/KeyInfoCredentialResolver", "org/opensaml/core/xml/XMLObject", "net/shibboleth/utilities/java/support/resolver/CriteriaSet", "org/opensaml/xmlsec/keyinfo/impl/KeyInfoResolutionContext", "org/opensaml/xmlsec/signature/RSAKeyValue", "java/security/PublicKey"}, 1, new Object[] {"java/security/KeyException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Error extracting RSA key value");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "buildCredentialContext", "(Lorg/opensaml/xmlsec/keyinfo/impl/KeyInfoResolutionContext;)Lorg/opensaml/xmlsec/keyinfo/impl/KeyInfoCredentialContext;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/opensaml/security/credential/BasicCredential", "org/opensaml/security/credential/CredentialContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xmlsec/keyinfo/impl/provider/RSAKeyValueProvider", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Credential successfully extracted from RSAKeyValue");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "debug", "(Ljava/lang/String;)V", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getRSAKeyValue", "(Lorg/opensaml/core/xml/XMLObject;)Lorg/opensaml/xmlsec/signature/RSAKeyValue;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nullable;", true);
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/xmlsec/signature/RSAKeyValue");
Label label0 = new Label();
