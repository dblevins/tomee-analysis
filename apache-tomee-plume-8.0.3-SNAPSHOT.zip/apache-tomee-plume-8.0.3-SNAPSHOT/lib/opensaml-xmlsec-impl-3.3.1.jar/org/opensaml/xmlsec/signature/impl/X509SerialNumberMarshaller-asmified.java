...
public class X509SerialNumberMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xmlsec/signature/impl/X509SerialNumberMarshaller", null, "org/opensaml/core/xml/io/AbstractXMLObjectMarshaller", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/xmlsec/signature/X509SerialNumber"}, 0, null);
methodVisitor.visitInsn(RETURN);
