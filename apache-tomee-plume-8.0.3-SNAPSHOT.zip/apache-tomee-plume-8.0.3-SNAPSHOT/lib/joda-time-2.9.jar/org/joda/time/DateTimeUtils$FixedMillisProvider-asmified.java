...
public class DateTimeUtils$FixedMillisProviderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/joda/time/DateTimeUtils$FixedMillisProvider", null, "java/lang/Object", new String[] { "org/joda/time/DateTimeUtils$MillisProvider" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/joda/time/DateTimeUtils$FixedMillisProvider", "iMillis", "J");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/joda/time/DateTimeUtils$FixedMillisProvider", "iMillis", "J");
