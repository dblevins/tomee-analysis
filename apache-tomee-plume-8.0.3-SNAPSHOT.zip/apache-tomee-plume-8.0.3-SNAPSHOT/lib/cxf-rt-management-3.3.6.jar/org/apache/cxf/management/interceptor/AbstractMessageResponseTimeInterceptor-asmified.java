...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", "getServiceCounterName", "(Lorg/apache/cxf/message/Exchange;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/counters/CounterRepository", "increaseCounter", "(Ljakarta/management/ObjectName;Lorg/apache/cxf/management/counters/MessageHandlingTimeRecorder;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", "getOperationCounterName", "(Lorg/apache/cxf/message/Exchange;Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getServiceCounterName", "(Lorg/apache/cxf/message/Exchange;)Ljakarta/management/ObjectName;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", "org/apache/cxf/message/Exchange", "org/apache/cxf/Bus", "java/lang/StringBuilder", "jakarta/management/ObjectName"}, 1, new Object[] {"jakarta/management/MalformedObjectNameException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "WARNING", "Ljava/util/logging/Level;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", "org/apache/cxf/message/Exchange", "org/apache/cxf/Bus", "java/lang/StringBuilder", "jakarta/management/ObjectName", "org/apache/cxf/service/Service", "org/apache/cxf/endpoint/Endpoint", "java/lang/String", "java/lang/String", "org/apache/cxf/message/Message"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLdcInsn("type");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitIntInsn(BIPUSH, 61);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", "org/apache/cxf/message/Exchange", "org/apache/cxf/Bus", "java/lang/StringBuilder", "jakarta/management/ObjectName"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/management/ObjectName", "org/apache/cxf/management/counters/Counter"}, 0, null);
methodVisitor.visitInsn(ICONST_1);
Label label3 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getOperationCounterName", "(Lorg/apache/cxf/message/Exchange;Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
