...
public class ResponseTimeMessageInInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/management/interceptor/ResponseTimeMessageInInterceptor", null, "org/apache/cxf/management/interceptor/AbstractMessageResponseTimeInterceptor", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/ResponseTimeMessageInInterceptor", "addBefore", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/ResponseTimeMessageInInterceptor", "isServiceCounterEnabled", "(Lorg/apache/cxf/message/Exchange;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/ResponseTimeMessageInInterceptor", "isClient", "(Lorg/apache/cxf/message/Message;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/ResponseTimeMessageInInterceptor", "endHandlingMessage", "(Lorg/apache/cxf/message/Exchange;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/management/interceptor/ResponseTimeMessageInInterceptor", "beginHandlingMessage", "(Lorg/apache/cxf/message/Exchange;)V", false);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/cxf/message/Exchange", "org/apache/cxf/message/FaultMode"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/message/FaultMode;"));
methodVisitor.visitVarInsn(ALOAD, 3);
