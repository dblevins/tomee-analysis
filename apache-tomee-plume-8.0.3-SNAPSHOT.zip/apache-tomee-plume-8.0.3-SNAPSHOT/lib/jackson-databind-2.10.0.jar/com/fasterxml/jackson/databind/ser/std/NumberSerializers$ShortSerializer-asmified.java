...
public class NumberSerializers$ShortSerializerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer", "Lcom/fasterxml/jackson/databind/ser/std/NumberSerializers$Base<Ljava/lang/Object;>;", "com/fasterxml/jackson/databind/ser/std/NumberSerializers$Base", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "instance", "Lcom/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer", "instance", "Lcom/fasterxml/jackson/databind/ser/std/NumberSerializers$ShortSerializer;");
methodVisitor.visitInsn(RETURN);
