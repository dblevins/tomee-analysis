...
public class POJOPropertyBuilder$8Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "com/fasterxml/jackson/databind/introspect/POJOPropertyBuilder$8", "Ljava/lang/Object;Lcom/fasterxml/jackson/databind/introspect/POJOPropertyBuilder$WithMember<Lcom/fasterxml/jackson/databind/introspect/ObjectIdInfo;>;", "java/lang/Object", new String[] { "com/fasterxml/jackson/databind/introspect/POJOPropertyBuilder$WithMember" });

classWriter.visitOuterClass("com/fasterxml/jackson/databind/introspect/POJOPropertyBuilder", "findObjectIdInfo", "()Lcom/fasterxml/jackson/databind/introspect/ObjectIdInfo;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/fasterxml/jackson/databind/introspect/POJOPropertyBuilder$8", "this$0", "Lcom/fasterxml/jackson/databind/introspect/POJOPropertyBuilder;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "withMember", "(Lcom/fasterxml/jackson/databind/introspect/AnnotatedMember;)Lcom/fasterxml/jackson/databind/introspect/ObjectIdInfo;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/fasterxml/jackson/databind/introspect/POJOPropertyBuilder$8", "this$0", "Lcom/fasterxml/jackson/databind/introspect/POJOPropertyBuilder;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/fasterxml/jackson/databind/introspect/POJOPropertyBuilder$8", "withMember", "(Lcom/fasterxml/jackson/databind/introspect/AnnotatedMember;)Lcom/fasterxml/jackson/databind/introspect/ObjectIdInfo;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
