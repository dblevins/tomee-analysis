...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/opensaml/saml/saml2/core/Conditions", null, "java/lang/Object", new String[] { "org/opensaml/saml/common/SAMLObject" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getConditions", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/core/Condition;>;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getAudienceRestrictions", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/core/AudienceRestriction;>;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getOneTimeUse", "()Lorg/opensaml/saml/saml2/core/OneTimeUse;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getProxyRestriction", "()Lorg/opensaml/saml/saml2/core/ProxyRestriction;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/saml2/core/Conditions", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
methodVisitor.visitTypeInsn(NEW, "javax/xml/namespace/QName");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("urn:oasis:names:tc:SAML:2.0:assertion");
...
methodVisitor.visitLdcInsn("saml2");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/namespace/QName", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/saml/saml2/core/Conditions", "TYPE_NAME", "Ljavax/xml/namespace/QName;");
