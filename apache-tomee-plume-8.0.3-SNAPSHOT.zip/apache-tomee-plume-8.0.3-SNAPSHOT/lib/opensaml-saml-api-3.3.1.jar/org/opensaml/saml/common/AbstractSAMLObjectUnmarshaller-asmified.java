...
public class AbstractSAMLObjectUnmarshallerDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "parseSAMLVersion", "(Lorg/w3c/dom/Attr;)Lorg/opensaml/saml/common/SAMLVersion;", null, new String[] { "org/opensaml/core/xml/io/UnmarshallingException" });
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/common/SAMLVersion", "valueOf", "(Ljava/lang/String;)Lorg/opensaml/saml/common/SAMLVersion;", false);
...
methodVisitor.visitLdcInsn("Could not parse SAMLVersion from DOM attribute value '%s'");
