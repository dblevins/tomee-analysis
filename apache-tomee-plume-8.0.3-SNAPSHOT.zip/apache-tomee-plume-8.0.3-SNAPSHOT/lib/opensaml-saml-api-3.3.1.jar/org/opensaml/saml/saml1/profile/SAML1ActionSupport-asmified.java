...
public class SAML1ActionSupportDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/opensaml/saml/saml1/profile/SAML1ActionSupport", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "buildAssertion", "(Lorg/opensaml/profile/action/AbstractProfileAction;Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;Ljava/lang/String;)Lorg/opensaml/saml/saml1/core/Assertion;", null, null);
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/saml1/profile/SAML1ActionSupport", "getLogger", "()Lorg/slf4j/Logger;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "addAssertionToResponse", "(Lorg/opensaml/profile/action/AbstractProfileAction;Lorg/opensaml/saml/saml1/core/Response;Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;Ljava/lang/String;)Lorg/opensaml/saml/saml1/core/Assertion;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/saml1/profile/SAML1ActionSupport", "buildAssertion", "(Lorg/opensaml/profile/action/AbstractProfileAction;Lnet/shibboleth/utilities/java/support/security/IdentifierGenerationStrategy;Ljava/lang/String;)Lorg/opensaml/saml/saml1/core/Assertion;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml1/core/Response", "getIssueInstant", "()Lorg/joda/time/DateTime;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml1/core/Assertion", "setIssueInstant", "(Lorg/joda/time/DateTime;)V", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/saml1/profile/SAML1ActionSupport", "getLogger", "()Lorg/slf4j/Logger;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "addConditionsToAssertion", "(Lorg/opensaml/profile/action/AbstractProfileAction;Lorg/opensaml/saml/saml1/core/Assertion;)Lorg/opensaml/saml/saml1/core/Conditions;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotation("Ljavax/annotation/Nonnull;", true);
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/saml1/profile/SAML1ActionSupport", "getLogger", "()Lorg/slf4j/Logger;", false);
methodVisitor.visitLdcInsn("Profile Action {}: Assertion {} did not already contain Conditions, added");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getSimpleName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/opensaml/saml/saml1/profile/SAML1ActionSupport", "getLogger", "()Lorg/slf4j/Logger;", false);
methodVisitor.visitLdcInsn("Profile Action {}: Assertion {} already contains Conditions, nothing was done");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getSimpleName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/opensaml/saml/saml1/profile/SAML1ActionSupport;"));
