...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/opensaml/saml/saml1/core/RequestAbstractType", null, "java/lang/Object", new String[] { "org/opensaml/saml/common/SignableSAMLObject" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "ID_ATTRIB_NAME", "Ljava/lang/String;", null, "RequestID");
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getRespondWiths", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml1/core/RespondWith;>;", null);
methodVisitor.visitEnd();
}
