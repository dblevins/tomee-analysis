...
public class AES256BinaryEncryptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/util/binary/AES256BinaryEncryptor", null, "java/lang/Object", new String[] { "org/jasypt/util/binary/BinaryEncryptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/util/binary/AES256BinaryEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/util/binary/AES256BinaryEncryptor", "encryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
