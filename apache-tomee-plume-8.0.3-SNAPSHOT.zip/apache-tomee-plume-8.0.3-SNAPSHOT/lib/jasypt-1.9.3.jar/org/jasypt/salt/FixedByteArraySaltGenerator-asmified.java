...
public class FixedByteArraySaltGeneratorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "org/jasypt/salt/FixedByteArraySaltGenerator", null, "java/lang/Object", new String[] { "org/jasypt/salt/SaltGenerator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/salt/FixedByteArraySaltGenerator", "salt", "[B");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "setSalt", "([B)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/salt/FixedByteArraySaltGenerator", "salt", "[B");
