...
public class ByteArrayFixedSaltGeneratorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/jasypt/salt/ByteArrayFixedSaltGenerator", null, "java/lang/Object", new String[] { "org/jasypt/salt/FixedSaltGenerator" });
...
methodVisitor.visitTypeInsn(CHECKCAST, "[B");
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/salt/ByteArrayFixedSaltGenerator", "salt", "[B");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/salt/ByteArrayFixedSaltGenerator", "salt", "[B");
