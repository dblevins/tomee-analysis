...
public class StandardPBEBigIntegerEncryptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor", null, "java/lang/Object", new String[] { "org/jasypt/encryption/pbe/PBEBigIntegerCleanablePasswordEncryptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor", "byteEncryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor", "byteEncryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNCHRONIZED, "cloneAndInitializeEncryptor", "(I)[Lorg/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor", "byteEncryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
methodVisitor.visitVarInsn(ILOAD, 1);
...
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitTypeInsn(ANEWARRAY, "org/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;", "[Lorg/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor;", Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/jasypt/encryption/pbe/StandardPBEBigIntegerEncryptor", "<init>", "(Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;)V", false);
methodVisitor.visitInsn(AASTORE);
