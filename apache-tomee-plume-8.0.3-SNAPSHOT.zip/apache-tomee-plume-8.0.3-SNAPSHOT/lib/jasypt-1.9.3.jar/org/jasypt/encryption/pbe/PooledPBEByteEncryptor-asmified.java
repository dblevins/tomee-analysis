...
public class PooledPBEByteEncryptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", null, "java/lang/Object", new String[] { "org/jasypt/encryption/pbe/PBEByteCleanablePasswordEncryptor" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "firstEncryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "pool", "[Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "config", "Lorg/jasypt/encryption/pbe/config/PBEConfig;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "poolSize", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "poolSizeSet", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "roundRobin", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "initialized", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "firstEncryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "firstEncryptor", "Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "isInitialized", "()Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "initialized", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "config", "Lorg/jasypt/encryption/pbe/config/PBEConfig;");
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "poolSizeSet", "Z");
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "java/lang/Integer"}, 1, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor"});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "poolSize", "I");
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor"});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Integer", "intValue", "()I", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "java/lang/Integer"}, 2, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "poolSize", "I");
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "pool", "[Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "initialized", "Z");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "initialize", "()V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "roundRobin", "I");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "[B", Opcodes.TOP, "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "[B", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/jasypt/encryption/pbe/PooledPBEByteEncryptor", "pool", "[Lorg/jasypt/encryption/pbe/StandardPBEByteEncryptor;");
