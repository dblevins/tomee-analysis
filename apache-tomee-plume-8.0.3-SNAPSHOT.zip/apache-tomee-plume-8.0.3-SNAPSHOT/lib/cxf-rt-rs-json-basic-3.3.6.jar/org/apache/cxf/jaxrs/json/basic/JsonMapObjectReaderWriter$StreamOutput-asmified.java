...
public class JsonMapObjectReaderWriter$StreamOutputDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter$StreamOutput", null, "java/lang/Object", new String[] { "org/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter$Output" });
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter;Ljava/io/OutputStream;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter$StreamOutput", "this$0", "Lorg/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter$StreamOutput", "os", "Ljava/io/OutputStream;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/json/basic/JsonMapObjectReaderWriter$StreamOutput", "os", "Ljava/io/OutputStream;");
methodVisitor.visitVarInsn(ALOAD, 1);
