...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/ra/ActiveMQManagedConnection$3", null, "java/lang/Object", new String[] { "javax/resource/spi/ManagedConnectionMetaData" });

classWriter.visitOuterClass("org/apache/activemq/ra/ActiveMQManagedConnection", "getMetaData", "()Ljavax/resource/spi/ManagedConnectionMetaData;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEISProductName", "()Ljava/lang/String;", null, new String[] { "javax/resource/ResourceException" });
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ra/ActiveMQManagedConnection$3", "this$0", "Lorg/apache/activemq/ra/ActiveMQManagedConnection;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/ra/ActiveMQManagedConnection", "access$400", "(Lorg/apache/activemq/ra/ActiveMQManagedConnection;)Lorg/apache/activemq/ActiveMQConnection;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQConnection", "getMetaData", "()Ljavax/jms/ConnectionMetaData;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/ConnectionMetaData", "getJMSProviderName", "()Ljava/lang/String;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEISProductVersion", "()Ljava/lang/String;", null, new String[] { "javax/resource/ResourceException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/ra/ActiveMQManagedConnection", "access$400", "(Lorg/apache/activemq/ra/ActiveMQManagedConnection;)Lorg/apache/activemq/ActiveMQConnection;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQConnection", "getMetaData", "()Ljavax/jms/ConnectionMetaData;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/ConnectionMetaData", "getProviderVersion", "()Ljava/lang/String;", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/jms/JMSException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMaxConnections", "()I", null, new String[] { "javax/resource/ResourceException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ra/ActiveMQManagedConnection$3", "this$0", "Lorg/apache/activemq/ra/ActiveMQManagedConnection;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/ra/ActiveMQManagedConnection", "access$400", "(Lorg/apache/activemq/ra/ActiveMQManagedConnection;)Lorg/apache/activemq/ActiveMQConnection;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getUserName", "()Ljava/lang/String;", null, new String[] { "javax/resource/ResourceException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
