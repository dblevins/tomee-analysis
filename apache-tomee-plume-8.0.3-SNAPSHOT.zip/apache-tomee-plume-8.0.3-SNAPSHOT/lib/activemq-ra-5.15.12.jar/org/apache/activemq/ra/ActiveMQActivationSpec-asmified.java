...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/resource/spi/InvalidPropertyException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "size", "()I", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/resource/spi/InvalidPropertyException", "setInvalidPropertyDescriptors", "([Ljava/beans/PropertyDescriptor;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
