...
public class JuliLogStreamFactory$OpenEJBSimpleLayoutHandler$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler$1", null, "java/io/FilterOutputStream", null);

classWriter.visitOuterClass("org/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler", "setOutputStream", "(Ljava/io/OutputStream;)V");
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler;Ljava/io/OutputStream;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler$1", "this$0", "Lorg/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/util/JuliLogStreamFactory$OpenEJBSimpleLayoutHandler$1", "flush", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
