...
public class LocalBeanProxyFactory$Unsafe$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/util/proxy/LocalBeanProxyFactory$Unsafe$2", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/util/proxy/LocalBeanProxyFactory$Unsafe$2", "val$unsafeClass", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/util/proxy/LocalBeanProxyFactory$Unsafe$2", "val$unsafeClass", "Ljava/lang/Class;");
