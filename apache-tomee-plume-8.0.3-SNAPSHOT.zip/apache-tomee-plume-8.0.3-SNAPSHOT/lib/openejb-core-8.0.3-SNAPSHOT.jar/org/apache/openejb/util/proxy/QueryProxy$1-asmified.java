...
public class QueryProxy$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openejb/util/proxy/QueryProxy$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openejb/util/proxy/QueryProxy", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openejb$util$proxy$QueryProxy$QueryType", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/util/proxy/QueryProxy$QueryType", "values", "()[Lorg/apache/openejb/util/proxy/QueryProxy$QueryType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/util/proxy/QueryProxy$1", "$SwitchMap$org$apache$openejb$util$proxy$QueryProxy$QueryType", "[I");
