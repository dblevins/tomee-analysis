...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/interceptor/InterceptorData", "getInterceptionMethodAsListOrEmpty", "(Lorg/apache/webbeans/component/CdiInterceptorBean;Ljavax/enterprise/inject/spi/InterceptionType;)Ljava/util/List;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getInterceptionMethodAsListOrEmpty", "(Lorg/apache/webbeans/component/CdiInterceptorBean;Ljavax/enterprise/inject/spi/InterceptionType;)Ljava/util/List;", "(Lorg/apache/webbeans/component/CdiInterceptorBean;Ljavax/enterprise/inject/spi/InterceptionType;)Ljava/util/List<Ljava/lang/reflect/Method;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/CdiInterceptorBean", "getInterceptorMethods", "(Ljavax/enterprise/inject/spi/InterceptionType;)[Ljava/lang/reflect/Method;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/interceptor/InterceptorData", "aroundTimeout", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/interceptor/AroundTimeout;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/core/interceptor/InterceptorData", "add", "(Lorg/apache/xbean/finder/ClassFinder;Ljava/util/Set;Ljava/lang/Class;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
