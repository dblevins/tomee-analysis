...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "conMngr", "Ljakarta/resource/spi/ConnectionManager;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "mngedConFactory", "Ljakarta/resource/spi/ManagedConnectionFactory;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/resource/spi/ConnectionManager;Ljakarta/resource/spi/ManagedConnectionFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/ivm/naming/Reference", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/ConnectorReference", "conMngr", "Ljakarta/resource/spi/ConnectionManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/ConnectorReference", "mngedConFactory", "Ljakarta/resource/spi/ManagedConnectionFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/ConnectorReference", "mngedConFactory", "Ljakarta/resource/spi/ManagedConnectionFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/ConnectorReference", "conMngr", "Ljakarta/resource/spi/ConnectionManager;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConnectionManager", "()Ljakarta/resource/spi/ConnectionManager;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/ConnectorReference", "conMngr", "Ljakarta/resource/spi/ConnectionManager;");
methodVisitor.visitInsn(ARETURN);
