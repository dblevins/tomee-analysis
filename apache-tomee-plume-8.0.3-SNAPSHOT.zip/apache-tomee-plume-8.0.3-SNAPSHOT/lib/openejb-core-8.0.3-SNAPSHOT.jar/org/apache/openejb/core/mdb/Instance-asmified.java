...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/mdb/Instance", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "poolEntry", "Lorg/apache/openejb/util/Pool$Entry;", "Lorg/apache/openejb/util/Pool<Lorg/apache/openejb/core/mdb/Instance;>.Entry;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/Instance", "bean", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPoolEntry", "()Lorg/apache/openejb/util/Pool$Entry;", "()Lorg/apache/openejb/util/Pool<Lorg/apache/openejb/core/mdb/Instance;>.Entry;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/mdb/Instance", "poolEntry", "Lorg/apache/openejb/util/Pool$Entry;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setPoolEntry", "(Lorg/apache/openejb/util/Pool$Entry;)V", "(Lorg/apache/openejb/util/Pool<Lorg/apache/openejb/core/mdb/Instance;>.Entry;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/mdb/Instance", "poolEntry", "Lorg/apache/openejb/util/Pool$Entry;");
methodVisitor.visitInsn(RETURN);
