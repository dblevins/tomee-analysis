...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/BeanContext", "getConcurrencyAttribute", "(Ljava/lang/reflect/Method;)Ljakarta/ejb/LockType;", false);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ejb/ConcurrentAccessTimeoutException", "initCause", "(Ljava/lang/Throwable;)Ljava/lang/Throwable;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/ejb/ConcurrentAccessTimeoutException");
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label7);
...
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/xml/rpc/handler/MessageContext");
Label label4 = new Label();
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/rpc/handler/MessageContext");
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/interceptor/InterceptorStack", "invoke", "(Ljakarta/xml/rpc/handler/MessageContext;[Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label4);
