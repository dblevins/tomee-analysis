...
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/monitoring/ObjectNameBuilder", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/StatsInterceptor", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "add", "(Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label4);
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/monitoring/ObjectNameBuilder", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/StatsInterceptor"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 17);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 14, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/loader/Options", "org/apache/openejb/util/Duration", "org/apache/openejb/util/Duration", "org/apache/xbean/recipe/ObjectRecipe", "org/apache/openejb/util/Pool$Builder", "org/apache/openejb/core/stateless/StatelessInstanceManager$StatelessSupplier", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", Opcodes.INTEGER, Opcodes.LONG, Opcodes.DOUBLE, "org/apache/openejb/monitoring/ObjectNameBuilder", "jakarta/management/MBeanServer"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitLdcInsn("Unable to register MBean ");
methodVisitor.visitVarInsn(ALOAD, 16);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/stateless/StatelessInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/core/stateless/StatelessInstanceManager$Data", "jakarta/management/MBeanServer", "java/util/Iterator", "jakarta/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/stateless/StatelessInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
