...
public class IvmContext$MyBindingEnumerationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/ivm/naming/IvmContext$MyBindingEnumeration", null, "org/apache/openejb/core/ivm/naming/IvmContext$MyNamingEnumeration", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/ivm/naming/IvmContext$MyBindingEnumeration", "this$0", "Lorg/apache/openejb/core/ivm/naming/IvmContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/ivm/naming/NameNode", "getBinding", "()Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/naming/Binding", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ILOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/ivm/naming/IvmContext$MyBindingEnumeration", "myEnum", "Ljava/util/Enumeration;");
methodVisitor.visitInsn(RETURN);
