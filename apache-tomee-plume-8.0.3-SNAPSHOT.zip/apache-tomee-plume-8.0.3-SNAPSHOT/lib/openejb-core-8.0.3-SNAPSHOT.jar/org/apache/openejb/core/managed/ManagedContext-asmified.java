...
public class ManagedContextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/core/managed/ManagedContext", null, "org/apache/openejb/core/BaseSessionContext", null);

classWriter.visitInnerClass("org/apache/openejb/core/managed/ManagedContext$1", null, null, ACC_STATIC | ACC_SYNTHETIC);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/managed/ManagedContext$1", "$SwitchMap$org$apache$openejb$core$BaseContext$Call", "[I");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/managed/ManagedContext$1", "$SwitchMap$org$apache$openejb$core$Operation", "[I");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/managed/ManagedContext", "illegal", "(Lorg/apache/openejb/core/BaseContext$Call;Lorg/apache/openejb/core/Operation;)Ljava/lang/IllegalStateException;", false);
...
methodVisitor.visitLdcInsn("@ManagedBeans do not support Web Service interfaces");
