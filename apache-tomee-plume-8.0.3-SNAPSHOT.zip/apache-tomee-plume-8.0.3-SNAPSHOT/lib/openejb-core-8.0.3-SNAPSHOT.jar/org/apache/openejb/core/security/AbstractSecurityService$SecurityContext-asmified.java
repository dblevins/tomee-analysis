...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL, "subject", "Ljakarta/security/auth/Subject;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/security/AbstractSecurityService$SecurityContext", "subject", "Ljakarta/security/auth/Subject;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/security/auth/Subject", "doAsPrivileged", "(Ljakarta/security/auth/Subject;Ljava/security/PrivilegedAction;Ljava/security/AccessControlContext;)Ljava/lang/Object;", false);
