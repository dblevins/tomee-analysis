...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/singleton/SingletonInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/core/singleton/SingletonInstanceManager$Data", "org/apache/openejb/monitoring/StatsInterceptor", "org/apache/openejb/monitoring/ObjectNameBuilder", "jakarta/management/MBeanServer", "jakarta/management/ObjectName"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/singleton/SingletonInstanceManager$Data", "add", "(Ljakarta/management/ObjectName;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/singleton/SingletonInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/core/singleton/SingletonInstanceManager$Data", "org/apache/openejb/monitoring/StatsInterceptor", "org/apache/openejb/monitoring/ObjectNameBuilder", "jakarta/management/MBeanServer"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/singleton/SingletonInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/singleton/SingletonInstanceManager", "org/apache/openejb/BeanContext", "org/apache/openejb/core/singleton/SingletonInstanceManager$Data", "jakarta/management/MBeanServer", "java/util/Iterator", "jakarta/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/singleton/SingletonInstanceManager", "logger", "Lorg/apache/openejb/util/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
