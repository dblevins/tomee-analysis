...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "webServiceContext", "Ljavax/xml/ws/WebServiceContext;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/singleton/EjbWsContext", "<init>", "(Ljavax/ejb/SessionContext;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/singleton/SingletonInstanceManager", "webServiceContext", "Ljavax/xml/ws/WebServiceContext;");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/singleton/Instance", "<init>", "(Ljava/lang/Object;Ljava/util/Map;Ljavax/enterprise/context/spi/CreationalContext;Ljava/util/concurrent/locks/ReadWriteLock;)V", false);
methodVisitor.visitLabel(label5);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label6);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/singleton/SingletonInstanceManager", "webServiceContext", "Ljavax/xml/ws/WebServiceContext;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/naming/Context", "bind", "(Ljava/lang/String;Ljava/lang/Object;)V", true);
methodVisitor.visitVarInsn(ALOAD, 3);
