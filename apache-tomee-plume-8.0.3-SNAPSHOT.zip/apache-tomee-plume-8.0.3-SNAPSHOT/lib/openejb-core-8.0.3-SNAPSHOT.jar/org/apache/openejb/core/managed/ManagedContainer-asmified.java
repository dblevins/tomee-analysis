...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/managed/ManagedUserTransaction", "<init>", "(Ljakarta/transaction/UserTransaction;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry;)V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/managed/ManagedContext", "<init>", "(Lorg/apache/openejb/spi/SecurityService;Ljakarta/transaction/UserTransaction;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/core/managed/ManagedContainer", "sessionContext", "Ljakarta/ejb/SessionContext;");
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/openejb/core/managed/ManagedContainer$Data", "jakarta/management/MBeanServer", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/core/managed/ManagedContainer$Data", "jakarta/management/MBeanServer", "java/util/Iterator", "jakarta/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/management/MBeanServer", "unregisterMBean", "(Ljakarta/management/ObjectName;)V", true);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "java/util/Map", "org/apache/openejb/core/managed/ManagedContainer$Data", "org/apache/openejb/monitoring/StatsInterceptor", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder", "jakarta/management/ObjectName"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "java/util/Map", "org/apache/openejb/core/managed/ManagedContainer$Data", "org/apache/openejb/monitoring/StatsInterceptor", "jakarta/management/MBeanServer", "org/apache/openejb/monitoring/ObjectNameBuilder"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/core/managed/ManagedContainer", "logger", "Lorg/apache/openejb/util/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/managed/ManagedContainer", "sessionContext", "Ljakarta/ejb/SessionContext;");
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/managed/Instance", "<init>", "(Lorg/apache/openejb/BeanContext;Ljava/lang/Object;Ljava/lang/Object;Ljava/util/Map;Ljakarta/enterprise/context/spi/CreationalContext;Ljava/util/Map;)V", false);
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitLabel(label4);
Label label16 = new Label();
methodVisitor.visitJumpInsn(GOTO, label16);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/core/managed/ManagedContainer", "getTransaction", "(Lorg/apache/openejb/core/ThreadContext;)Ljakarta/transaction/Transaction;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/core/managed/ManagedContainer", "checkedOutInstances", "Ljava/util/concurrent/ConcurrentHashMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "java/lang/Object", "org/apache/openejb/core/ThreadContext", "jakarta/transaction/Transaction", "org/apache/openejb/core/managed/Instance"}, 1, new Object[] {"org/apache/openejb/OpenEJBException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/managed/Instance", "getTransaction", "()Ljakarta/transaction/Transaction;", false);
Label label13 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/managed/Instance", "setTransaction", "(Ljakarta/transaction/Transaction;)V", false);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "jakarta/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", Opcodes.TOP, "jakarta/persistence/SynchronizationType", "java/util/Map"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "jakarta/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "jakarta/persistence/EntityManager", "jakarta/persistence/SynchronizationType", "java/util/Map"}, 0, new Object[] {});
...
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "jakarta/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "jakarta/persistence/EntityManager", "jakarta/persistence/SynchronizationType", "java/util/Map"}, 3, new Object[] {label5, label5, "jakarta/persistence/EntityManager"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/core/managed/ManagedContainer", "org/apache/openejb/BeanContext", "org/apache/openejb/util/Index", "org/apache/openejb/util/Index", "java/util/Iterator", "java/util/Map$Entry", "jakarta/persistence/EntityManagerFactory", "org/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker", "jakarta/persistence/EntityManager", "jakarta/persistence/SynchronizationType", "java/util/Map"}, 4, new Object[] {label5, label5, "jakarta/persistence/EntityManager", Opcodes.INTEGER});
