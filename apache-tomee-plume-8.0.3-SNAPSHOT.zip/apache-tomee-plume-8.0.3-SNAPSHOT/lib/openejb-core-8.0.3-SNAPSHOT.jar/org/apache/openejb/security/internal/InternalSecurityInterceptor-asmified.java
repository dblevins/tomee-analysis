package asm.org.apache.openejb.security.internal;
...
public class InternalSecurityInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/security/internal/InternalSecurityInterceptor", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "OPENEJB_INTERNAL_BEANS_SECURITY_ENABLED", "Ljava/lang/String;", null, "openejb.internal.beans.security.enabled");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "ROLES", "[Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("openejb.internal.beans.security.enabled");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/security/internal/InternalSecurityInterceptor", "ROLES", "[Ljava/lang/String;");
...
methodVisitor.visitLdcInsn("to invoke this EJB you need to get the right permission");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLdcInsn("openejb-admin");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn("tomee-admin");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/security/internal/InternalSecurityInterceptor", "ROLES", "[Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
