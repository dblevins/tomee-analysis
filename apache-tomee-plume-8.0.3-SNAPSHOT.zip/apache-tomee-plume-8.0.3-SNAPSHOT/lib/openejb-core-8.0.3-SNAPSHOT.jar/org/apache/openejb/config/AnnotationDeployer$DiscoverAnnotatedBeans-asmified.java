...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/Connector;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/Connector");
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "displayName", "()[Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "description", "()[Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getTexts", "([Lorg/apache/openejb/jee/Text;[Ljava/lang/String;)[Lorg/apache/openejb/jee/Text;", false);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "eisType", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "vendorName", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getString", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "version", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getString", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "smallIcon", "()[Ljava/lang/String;", true);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitVarInsn(ISTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "largeIcon", "()[Ljava/lang/String;", true);
methodVisitor.visitInsn(ARRAYLENGTH);
...
Label label23 = new Label();
methodVisitor.visitLabel(label23);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "org/apache/openejb/config/ConnectorModule", "org/apache/openejb/jee/Connector", Opcodes.FLOAT, "org/apache/xbean/finder/IAnnotationFinder", "java/util/List", "java/lang/Class", "javax/resource/spi/Connector", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label23);
methodVisitor.visitLabel(label22);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "org/apache/openejb/config/ConnectorModule", "org/apache/openejb/jee/Connector", Opcodes.FLOAT, "org/apache/xbean/finder/IAnnotationFinder", "java/util/List", "java/lang/Class", "javax/resource/spi/Connector"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "licenseRequired", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "licenseDescription", "()[Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getTexts", "([Lorg/apache/openejb/jee/Text;[Ljava/lang/String;)[Lorg/apache/openejb/jee/Text;", false);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "securityPermissions", "()[Ljavax/resource/spi/SecurityPermission;", true);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/Connector", "getResourceAdapter", "()Lorg/apache/openejb/jee/ResourceAdapter;", false);
...
methodVisitor.visitLabel(label27);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"[Ljavax/resource/spi/SecurityPermission;", "java/util/List"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
Label label29 = new Label();
methodVisitor.visitLabel(label29);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljavax/resource/spi/SecurityPermission;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/SecurityPermission", "permissionSpec", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/SecurityPermission", "description", "()[Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "requiredWorkContexts", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 2);
...
Label label31 = new Label();
methodVisitor.visitLabel(label31);
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "org/apache/openejb/config/ConnectorModule", "org/apache/openejb/jee/Connector", Opcodes.FLOAT, "org/apache/xbean/finder/IAnnotationFinder", "java/util/List", "java/lang/Class", "javax/resource/spi/Connector", "[Ljavax/resource/spi/SecurityPermission;", "java/util/List", "[Ljava/lang/Class;", "java/util/List", "[Ljava/lang/Class;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "authMechanisms", "()[Ljavax/resource/spi/AuthenticationMechanism;", true);
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "size", "()I", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "org/apache/openejb/config/ConnectorModule", "org/apache/openejb/jee/Connector", Opcodes.FLOAT, "org/apache/xbean/finder/IAnnotationFinder", "java/util/List", "java/lang/Class", "javax/resource/spi/Connector", "[Ljavax/resource/spi/SecurityPermission;", "java/util/List", "[Ljava/lang/Class;", "java/util/List", "org/apache/openejb/jee/OutboundResourceAdapter", "java/util/List", "[Ljavax/resource/spi/AuthenticationMechanism;", "[Ljavax/resource/spi/AuthenticationMechanism;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/AuthenticationMechanism", "authMechanism", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 19);
methodVisitor.visitVarInsn(ALOAD, 18);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/AuthenticationMechanism", "credentialInterface", "()Ljavax/resource/spi/AuthenticationMechanism$CredentialInterface;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/resource/spi/AuthenticationMechanism$CredentialInterface", "toString", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 18);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/AuthenticationMechanism", "description", "()[Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "stringsToTexts", "([Ljava/lang/String;)[Lorg/apache/openejb/jee/Text;", false);
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "transactionSupport", "()Ljavax/resource/spi/TransactionSupport$TransactionSupportLevel;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/resource/spi/TransactionSupport$TransactionSupportLevel", "toString", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Connector", "reauthenticationSupport", "()Z", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/ConnectionDefinitions;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/IAnnotationFinder", "findAnnotatedClasses", "(Ljava/lang/Class;)Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/ConnectionDefinitions;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/ConnectionDefinitions");
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConnectionDefinitions", "value", "()[Ljavax/resource/spi/ConnectionDefinition;", true);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitVarInsn(ALOAD, 12);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "org/apache/openejb/config/ConnectorModule", "org/apache/openejb/jee/Connector", Opcodes.FLOAT, "org/apache/xbean/finder/IAnnotationFinder", "java/util/List", "java/lang/Class", "java/util/List", "java/util/Iterator", "java/lang/Class", "javax/resource/spi/ConnectionDefinitions", "[Ljavax/resource/spi/ConnectionDefinition;", "[Ljavax/resource/spi/ConnectionDefinition;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 14);
methodVisitor.visitVarInsn(ILOAD, 13);
...
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "processConnectionDescription", "(Lorg/apache/openejb/jee/ResourceAdapter;Ljavax/resource/spi/ConnectionDefinition;Ljava/lang/Class;)V", false);
methodVisitor.visitIincInsn(14, 1);
...
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/ConnectionDefinition;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/IAnnotationFinder", "findAnnotatedClasses", "(Ljava/lang/Class;)Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/ConnectionDefinition;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/ConnectionDefinition");
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/Connector", "getResourceAdapter", "()Lorg/apache/openejb/jee/ResourceAdapter;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/Activation;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/IAnnotationFinder", "findAnnotatedClasses", "(Ljava/lang/Class;)Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/Activation;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/Activation");
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/Activation", "messageListeners", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitVarInsn(ALOAD, 16);
...
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/AdministeredObject;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/IAnnotationFinder", "findAnnotatedClasses", "(Ljava/lang/Class;)Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/Connector", "getResourceAdapter", "()Lorg/apache/openejb/jee/ResourceAdapter;", false);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/AdministeredObject;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/AdministeredObject");
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/AdministeredObject", "adminObjectInterfaces", "()[Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 15);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitVarInsn(ALOAD, 19);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/resource/spi/ConfigProperty;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/resource/spi/ConfigProperty");
methodVisitor.visitVarInsn(ASTORE, 20);
methodVisitor.visitVarInsn(ALOAD, 20);
...
methodVisitor.visitJumpInsn(GOTO, label25);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 21, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "java/lang/ClassLoader", "java/lang/String", "java/lang/Object", "java/util/List", "java/lang/ClassLoader", "java/util/List", "java/lang/Class", "java/lang/Object", "java/beans/BeanInfo", "[Ljava/beans/PropertyDescriptor;", "[Ljava/beans/PropertyDescriptor;", Opcodes.INTEGER, Opcodes.INTEGER, "java/beans/PropertyDescriptor", "java/lang/String", "java/lang/Class", "org/apache/openejb/jee/ConfigProperty", "java/lang/Object", "java/lang/reflect/Method", "javax/resource/spi/ConfigProperty"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getConfigPropertyType", "(Ljavax/resource/spi/ConfigProperty;Ljava/lang/Class;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "defaultValue", "()Ljava/lang/String;", true);
Label label27 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label27);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "defaultValue", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "confidential", "()Z", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
...
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "ignore", "()Z", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
...
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "supportsDynamicUpdates", "()Z", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 20);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "description", "()[Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "stringsToTexts", "([Ljava/lang/String;)[Lorg/apache/openejb/jee/Text;", false);
...
methodVisitor.visitJumpInsn(GOTO, label29);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 19, new Object[] {"org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "java/lang/ClassLoader", "java/lang/String", "java/lang/Object", "java/util/List", "java/lang/ClassLoader", "java/util/List", "java/lang/Class", "java/lang/Object", "java/beans/BeanInfo", "[Ljava/beans/PropertyDescriptor;", "[Ljava/lang/reflect/Field;", "[Ljava/lang/reflect/Field;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/reflect/Field", "javax/resource/spi/ConfigProperty", "java/lang/String", "java/lang/Object"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 19);
methodVisitor.visitLabel(label29);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getConfigPropertyType", "(Ljavax/resource/spi/ConfigProperty;Ljava/lang/Class;)Ljava/lang/String;", "(Ljavax/resource/spi/ConfigProperty;Ljava/lang/Class<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConfigProperty", "type", "()Ljava/lang/Class;", true);
methodVisitor.visitLabel(label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "processConnectionDescription", "(Lorg/apache/openejb/jee/ResourceAdapter;Ljavax/resource/spi/ConnectionDefinition;Ljava/lang/Class;)V", "(Lorg/apache/openejb/jee/ResourceAdapter;Ljavax/resource/spi/ConnectionDefinition;Ljava/lang/Class<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/ResourceAdapter", "getOutboundResourceAdapter", "()Lorg/apache/openejb/jee/OutboundResourceAdapter;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConnectionDefinition", "connection", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConnectionDefinition", "connectionImpl", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConnectionDefinition", "connectionFactory", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/resource/spi/ConnectionDefinition", "connectionFactoryImpl", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "addRestApplicationIfPossible", "(Lorg/apache/openejb/config/WebModule;Ljava/lang/Class;)V", "(Lorg/apache/openejb/config/WebModule;Ljava/lang/Class<+Ljavax/ws/rs/core/Application;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/ejb/Singleton");
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "get", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Class");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getEjbName", "(Ljavax/ejb/Singleton;Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/Singleton;"));
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitJumpInsn(GOTO, label24);
methodVisitor.visitLabel(label26);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/xbean/finder/Annotated", "javax/ejb/Singleton", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/SessionBean", "setSessionType", "(Lorg/apache/openejb/jee/SessionType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Singleton", "mappedName", "()Ljava/lang/String;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/Stateless;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/ejb/Stateless");
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "get", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Class");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getEjbName", "(Ljavax/ejb/Stateless;Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/Stateless;"));
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitLabel(label32);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/xbean/finder/Annotated", "javax/ejb/Stateless", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/EjbJar", "getEnterpriseBean", "(Ljava/lang/String;)Lorg/apache/openejb/jee/EnterpriseBean;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/SessionBean", "setSessionType", "(Lorg/apache/openejb/jee/SessionType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateless", "mappedName", "()Ljava/lang/String;", true);
methodVisitor.visitJumpInsn(IFNULL, label35);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateless", "mappedName", "()Ljava/lang/String;", true);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/Stateful;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/ejb/Stateful");
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "get", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Class");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getEjbName", "(Ljavax/ejb/Stateful;Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/Stateful;"));
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitJumpInsn(GOTO, label36);
methodVisitor.visitLabel(label38);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/xbean/finder/Annotated", "javax/ejb/Stateful", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/EjbJar", "getEnterpriseBean", "(Ljava/lang/String;)Lorg/apache/openejb/jee/EnterpriseBean;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/SessionBean", "setSessionType", "(Lorg/apache/openejb/jee/SessionType;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateful", "mappedName", "()Ljava/lang/String;", true);
Label label42 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateful", "passivationCapable", "()Z", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "get", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Class");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getEjbName", "(Ljavax/annotation/ManagedBean;Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/annotation/ManagedBean;"));
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitLabel(label45);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/xbean/finder/Annotated", "javax/annotation/ManagedBean", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/EjbJar", "getEnterpriseBean", "(Ljava/lang/String;)Lorg/apache/openejb/jee/EnterpriseBean;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/xbean/finder/Annotated", "get", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Class");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "getEjbName", "(Ljavax/ejb/MessageDriven;Ljava/lang/Class;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/ejb/MessageDriven;"));
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitLabel(label51);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/xbean/finder/Annotated", "javax/ejb/MessageDriven", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/EjbJar", "getEnterpriseBean", "(Ljava/lang/String;)Lorg/apache/openejb/jee/EnterpriseBean;", false);
...
methodVisitor.visitJumpInsn(IFNULL, label2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateful", "name", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateless", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "specified", "(Ljava/lang/String;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateless", "name", "()Ljava/lang/String;", true);
...
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Singleton", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "specified", "(Ljava/lang/String;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Singleton", "name", "()Ljava/lang/String;", true);
...
methodVisitor.visitJumpInsn(IFNULL, label4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/MessageDriven", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/AnnotationDeployer$DiscoverAnnotatedBeans", "specified", "(Ljava/lang/String;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/MessageDriven", "name", "()Ljava/lang/String;", true);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLdcInsn("javax.faces.flow.FlowScoped");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn("javax.faces.view.ViewScoped");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getEjbName", "(Ljavax/ejb/MessageDriven;Ljava/lang/Class;)Ljava/lang/String;", "(Ljavax/ejb/MessageDriven;Ljava/lang/Class<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/MessageDriven", "name", "()Ljava/lang/String;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getEjbName", "(Ljavax/ejb/Stateful;Ljava/lang/Class;)Ljava/lang/String;", "(Ljavax/ejb/Stateful;Ljava/lang/Class<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateful", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "isEmpty", "()Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getEjbName", "(Ljavax/ejb/Stateless;Ljava/lang/Class;)Ljava/lang/String;", "(Ljavax/ejb/Stateless;Ljava/lang/Class<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Stateless", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "isEmpty", "()Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getEjbName", "(Ljavax/ejb/Singleton;Ljava/lang/Class;)Ljava/lang/String;", "(Ljavax/ejb/Singleton;Ljava/lang/Class<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ejb/Singleton", "name", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "isEmpty", "()Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getEjbName", "(Ljavax/annotation/ManagedBean;Ljava/lang/Class;)Ljava/lang/String;", "(Ljavax/annotation/ManagedBean;Ljava/lang/Class<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/ejb/Stateful");
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/ejb/Stateless");
Label label5 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/ejb/Singleton");
Label label6 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/ejb/MessageDriven");
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/ejb/MessageDriven");
