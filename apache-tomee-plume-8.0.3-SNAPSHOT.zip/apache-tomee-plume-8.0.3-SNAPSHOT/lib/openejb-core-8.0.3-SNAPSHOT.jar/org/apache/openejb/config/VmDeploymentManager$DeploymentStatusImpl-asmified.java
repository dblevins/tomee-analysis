...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", null, "java/lang/Object", new String[] { "javax/enterprise/deploy/spi/status/DeploymentStatus" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "command", "Ljavax/enterprise/deploy/shared/CommandType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "state", "Ljavax/enterprise/deploy/shared/StateType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "command", "Ljavax/enterprise/deploy/shared/CommandType;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/config/VmDeploymentManager$DeploymentStatusImpl", "state", "Ljavax/enterprise/deploy/shared/StateType;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
