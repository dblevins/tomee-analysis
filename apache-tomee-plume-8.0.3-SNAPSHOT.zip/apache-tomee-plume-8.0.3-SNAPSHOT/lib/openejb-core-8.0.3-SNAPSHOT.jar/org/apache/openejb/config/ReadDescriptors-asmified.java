...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "org/xml/sax/SAXException");
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label5, "jakarta/xml/bind/JAXBException");
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/JAXBException", "printStackTrace", "()V", false);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/OpenEJBException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"java/net/URL", Opcodes.TOP, "jakarta/xml/bind/JAXBException"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/OpenEJBException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
...
Label label7 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label7, "jakarta/xml/bind/JAXBException");
methodVisitor.visitTryCatchBlock(label3, label4, label7, "jakarta/xml/bind/JAXBException");
methodVisitor.visitTryCatchBlock(label5, label6, label7, "jakarta/xml/bind/JAXBException");
Label label8 = new Label();
