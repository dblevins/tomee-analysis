...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/config/VmDeploymentManager", null, "java/lang/Object", new String[] { "jakarta/enterprise/deploy/spi/DeploymentManager" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "DEFAULT_TARGET", "Ljakarta/enterprise/deploy/spi/Target;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "DCONFIG_BEAN_VERSION", "Ljakarta/enterprise/deploy/shared/DConfigBeanVersionType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/config/VmDeploymentManager", "DEFAULT_TARGET", "Ljakarta/enterprise/deploy/spi/Target;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/VmDeploymentManager", "containsDefaultTarget", "([Ljakarta/enterprise/deploy/spi/Target;)Z", false);
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/VmDeploymentManager", "toTargetModuleIds", "(Ljava/util/Collection;Ljakarta/enterprise/deploy/shared/ModuleType;)Ljava/util/Set;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "toTargetModuleIds", "(Ljava/util/Collection;Ljakarta/enterprise/deploy/shared/ModuleType;)Ljava/util/Set;", "(Ljava/util/Collection<Lorg/apache/openejb/assembler/classic/AppInfo;>;Ljakarta/enterprise/deploy/shared/ModuleType;)Ljava/util/Set<Ljakarta/enterprise/deploy/spi/TargetModuleID;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/config/VmDeploymentManager", "toTargetModuleId", "(Lorg/apache/openejb/assembler/classic/AppInfo;Ljakarta/enterprise/deploy/shared/ModuleType;)Ljakarta/enterprise/deploy/spi/TargetModuleID;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "toTargetModuleId", "(Lorg/apache/openejb/assembler/classic/AppInfo;Ljakarta/enterprise/deploy/shared/ModuleType;)Ljakarta/enterprise/deploy/spi/TargetModuleID;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/assembler/classic/ClientInfo", "moduleId", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/VmDeploymentManager$TargetModuleIDImpl", "<init>", "(Ljakarta/enterprise/deploy/spi/Target;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/config/VmDeploymentManager", "[Ljakarta/enterprise/deploy/spi/Target;", "java/io/File", "java/io/File", "java/util/Properties"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/VmDeploymentManager", "deploy", "([Ljakarta/enterprise/deploy/spi/Target;Ljava/util/Properties;)Ljakarta/enterprise/deploy/spi/status/ProgressObject;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 6);
methodVisitor.visitEnd();
}
...
methodVisitor.visitJumpInsn(GOTO, label9);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/config/VmDeploymentManager", "[Ljakarta/enterprise/deploy/spi/Target;", "java/io/InputStream", "java/io/InputStream", "java/util/Properties"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/loader/IO", "close", "(Ljava/io/Closeable;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "deploy", "([Ljakarta/enterprise/deploy/spi/Target;Ljava/util/Properties;)Ljakarta/enterprise/deploy/spi/status/ProgressObject;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/VmDeploymentManager$ProgressObjectImpl", "<init>", "(Lorg/apache/openejb/config/VmDeploymentManager;Ljakarta/enterprise/deploy/shared/CommandType;Ljava/lang/Exception;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/config/VmDeploymentManager$ProgressObjectImpl", "<init>", "(Lorg/apache/openejb/config/VmDeploymentManager;Ljakarta/enterprise/deploy/shared/CommandType;Ljava/util/Set;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "containsDefaultTarget", "([Ljakarta/enterprise/deploy/spi/Target;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljakarta/enterprise/deploy/spi/Target;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, null);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/config/VmDeploymentManager", "[Ljakarta/enterprise/deploy/spi/TargetModuleID;", "org/apache/openejb/UndeployException", "java/util/Set", "[Ljakarta/enterprise/deploy/spi/TargetModuleID;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 6);
methodVisitor.visitVarInsn(ILOAD, 5);
Label label6 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/openejb/config/VmDeploymentManager", "[Ljakarta/enterprise/deploy/spi/TargetModuleID;", "org/apache/openejb/UndeployException", "java/util/Set", "[Ljakarta/enterprise/deploy/spi/TargetModuleID;", Opcodes.INTEGER, Opcodes.INTEGER, "jakarta/enterprise/deploy/spi/TargetModuleID"}, 1, new Object[] {"org/apache/openejb/UndeployException"});
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/config/VmDeploymentManager", "DCONFIG_BEAN_VERSION", "Ljakarta/enterprise/deploy/shared/DConfigBeanVersionType;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/config/VmDeploymentManager", "isDConfigBeanVersionSupported", "(Ljakarta/enterprise/deploy/shared/DConfigBeanVersionType;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/config/VmDeploymentManager", "DEFAULT_TARGET", "Ljakarta/enterprise/deploy/spi/Target;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/config/VmDeploymentManager", "DCONFIG_BEAN_VERSION", "Ljakarta/enterprise/deploy/shared/DConfigBeanVersionType;");
