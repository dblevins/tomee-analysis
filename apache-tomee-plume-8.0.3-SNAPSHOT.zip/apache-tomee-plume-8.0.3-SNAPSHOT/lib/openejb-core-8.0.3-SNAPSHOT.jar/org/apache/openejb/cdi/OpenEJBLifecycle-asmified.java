...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/cdi/OpenEJBLifecycle", "beanManager", "Lorg/apache/webbeans/container/BeanManagerImpl;");
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/cdi/OpenEJBLifecycle", "starts", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class;)V", false);
methodVisitor.visitJumpInsn(GOTO, label22);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "starts", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class;)V", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "startServletContext", "(Ljakarta/servlet/ServletContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/cdi/OpenEJBLifecycle", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "initializeServletContext", "(Ljakarta/servlet/ServletContext;Lorg/apache/webbeans/config/WebBeansContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/OpenEJBLifecycle", "setJspELFactory", "(Ljakarta/servlet/ServletContext;Ljakarta/el/ELResolver;)V", false);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/webbeans/spi/adaptor/ELAdaptor", "jakarta/el/ELResolver"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "setJspELFactory", "(Ljakarta/servlet/ServletContext;Ljakarta/el/ELResolver;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/servlet/ServletContext", "jakarta/el/ELResolver", "jakarta/servlet/jsp/JspFactory"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 3);
