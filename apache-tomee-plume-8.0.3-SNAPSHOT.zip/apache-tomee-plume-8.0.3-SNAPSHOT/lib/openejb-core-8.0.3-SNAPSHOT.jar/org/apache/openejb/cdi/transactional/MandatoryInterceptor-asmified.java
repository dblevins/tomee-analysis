...
annotationVisitor0.visitEnum("value", "Ljavax/transaction/Transactional$TxType;", "MANDATORY");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/transactional/MandatoryInterceptor", "getTransactionManager", "()Ljavax/transaction/TransactionManager;", false);
