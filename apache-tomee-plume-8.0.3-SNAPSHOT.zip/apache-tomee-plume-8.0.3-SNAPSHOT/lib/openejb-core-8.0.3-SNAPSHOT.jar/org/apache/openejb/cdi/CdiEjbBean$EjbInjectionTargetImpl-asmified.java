...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/enterprise/inject/spi/InjectionTarget;", "Ljakarta/enterprise/inject/spi/InjectionTarget<TT;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl;Ljakarta/enterprise/inject/spi/InjectionTarget;)V", "(Lorg/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl<TT;>;Ljakarta/enterprise/inject/spi/InjectionTarget<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "annotatedType", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "delegate", "Ljakarta/enterprise/inject/spi/InjectionTarget;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "isDynamicBean", "(Ljakarta/enterprise/inject/spi/Bean;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "defineLifecycleInterceptors", "(Ljakarta/enterprise/inject/spi/Bean;Ljakarta/enterprise/inject/spi/AnnotatedType;Lorg/apache/webbeans/config/WebBeansContext;)V", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/inject/spi/AnnotatedType", "org/apache/webbeans/config/WebBeansContext"}, 2, new Object[] {"org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "jakarta/enterprise/inject/spi/Bean"});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/inject/spi/AnnotatedType", "org/apache/webbeans/config/WebBeansContext"}, 3, new Object[] {"org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/inject/spi/AnnotatedType"});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "defineInterceptorStack", "(Ljakarta/enterprise/inject/spi/Bean;Ljakarta/enterprise/inject/spi/AnnotatedType;Lorg/apache/webbeans/config/WebBeansContext;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "delegate", "Ljakarta/enterprise/inject/spi/InjectionTarget;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "inject", "(Ljava/lang/Object;Ljakarta/enterprise/context/spi/CreationalContext;)V", "(TT;Ljakarta/enterprise/context/spi/CreationalContext<TT;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "delegate", "Ljakarta/enterprise/inject/spi/InjectionTarget;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionTargetImpl", "inject", "(Ljava/lang/Object;Ljakarta/enterprise/context/spi/CreationalContext;)V", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createNewPojo", "(Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/lang/Object;", "(Ljakarta/enterprise/context/spi/CreationalContext<TT;>;)TT;", null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/intercept/InterceptorResolutionService$BusinessMethodInterceptorInfo", "getEjbInterceptors", "()[Ljakarta/enterprise/inject/spi/Interceptor;", false);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "jakarta/enterprise/context/spi/CreationalContext", "org/apache/webbeans/context/creational/CreationalContextImpl", "java/util/Map", "org/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo", "java/util/Map", "[Ljakarta/enterprise/inject/spi/Interceptor;", "[Ljakarta/enterprise/inject/spi/Interceptor;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/Interceptor", "create", "(Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/lang/Object;", true);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/cdi/CdiEjbBean$EjbInjectionTargetImpl", "jakarta/enterprise/context/spi/CreationalContext", "org/apache/webbeans/context/creational/CreationalContextImpl", "java/util/Map", "org/apache/webbeans/intercept/InterceptorResolutionService$BeanInterceptorInfo"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isDynamicBean", "(Ljakarta/enterprise/inject/spi/Bean;)Z", "(Ljakarta/enterprise/inject/spi/Bean<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/openejb/cdi/CdiEjbBean;"));
methodVisitor.visitVarInsn(ALOAD, 0);
