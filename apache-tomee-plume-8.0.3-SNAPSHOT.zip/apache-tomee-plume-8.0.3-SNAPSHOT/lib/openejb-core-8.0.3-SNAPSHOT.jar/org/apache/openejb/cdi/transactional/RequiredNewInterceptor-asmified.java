...
annotationVisitor0.visitEnum("value", "Ljavax/transaction/Transactional$TxType;", "REQUIRES_NEW");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/cdi/transactional/RequiredNewInterceptor", "getTransactionManager", "()Ljavax/transaction/TransactionManager;", false);
