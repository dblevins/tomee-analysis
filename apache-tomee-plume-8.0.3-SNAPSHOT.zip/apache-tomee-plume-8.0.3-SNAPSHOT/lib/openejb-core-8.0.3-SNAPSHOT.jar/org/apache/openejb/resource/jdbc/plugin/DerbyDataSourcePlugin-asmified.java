...
public class DerbyDataSourcePluginDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/resource/jdbc/plugin/DerbyDataSourcePlugin", null, "org/apache/openejb/resource/jdbc/plugin/AbstractDataSourcePlugin", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/resource/jdbc/plugin/DerbyDataSourcePlugin", "isActive", "(Lorg/apache/openejb/resource/jdbc/plugin/DataSourcePlugin;)Z", false);
