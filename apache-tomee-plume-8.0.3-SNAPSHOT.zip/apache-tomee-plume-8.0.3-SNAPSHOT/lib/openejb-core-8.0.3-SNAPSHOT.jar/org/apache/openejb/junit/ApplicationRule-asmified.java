...
public class ApplicationRuleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/junit/ApplicationRule", null, "java/lang/Object", new String[] { "org/junit/rules/TestRule" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/junit/ApplicationRule", "instance", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/junit/ApplicationRule", "instance", "Ljava/lang/Object;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/junit/ApplicationRule$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/junit/ApplicationRule$1", "<init>", "(Lorg/apache/openejb/junit/ApplicationRule;Lorg/junit/runners/model/Statement;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/openejb/junit/ApplicationRule;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/junit/ApplicationRule", "instance", "Ljava/lang/Object;");
methodVisitor.visitInsn(ARETURN);
