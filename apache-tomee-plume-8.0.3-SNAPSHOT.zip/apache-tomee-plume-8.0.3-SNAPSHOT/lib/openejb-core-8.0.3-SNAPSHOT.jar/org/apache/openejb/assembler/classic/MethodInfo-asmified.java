...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/assembler/classic/MethodInfo", null, "org/apache/openejb/assembler/classic/InfoObject", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "methodIntf", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "methodParams", "Ljava/util/List;", "Ljava/util/List<Ljava/lang/String;>;", null);
fieldVisitor.visitEnd();
}
{
