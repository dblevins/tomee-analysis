...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/assembler/classic/ValidatorFactoryWrapper", null, "java/lang/Object", new String[] { "javax/validation/ValidatorFactory", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "fallbackValidators", "Ljava/util/Map;", "Ljava/util/Map<Lorg/apache/openejb/assembler/classic/ComparableValidationConfig;Ljavax/validation/ValidatorFactory;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/Map;)V", "(Ljava/util/Map<Lorg/apache/openejb/assembler/classic/ComparableValidationConfig;Ljavax/validation/ValidatorFactory;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/ValidatorFactoryWrapper", "factory", "()Ljavax/validation/ValidatorFactory;", false);
