...
public class EntityManagerFactoryCallable$BmHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable$BmHandler", null, "java/lang/Object", new String[] { "java/lang/reflect/InvocationHandler", "java/io/Serializable" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable$BmHandler", "findBm", "()Ljava/lang/Object;", false);
...
methodVisitor.visitLdcInsn("Exception calling CDI, if a lifecycle issue you should maybe set tomee.jpa.factory.lazy=true");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findBm", "()Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/openejb/assembler/classic/EntityManagerFactoryCallable$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/assembler/classic/EntityManagerFactoryCallable$BmHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
