...
public class EjbResolver$ReferenceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/openejb/assembler/classic/EjbResolver$Reference", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getRefType", "()Lorg/apache/openejb/assembler/classic/EjbResolver$Type;", null, null);
methodVisitor.visitEnd();
}
{
