...
public class MathRuntimeException$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/openejb/math/MathRuntimeException$3", null, "java/io/EOFException", null);

classWriter.visitOuterClass("org/apache/openejb/math/MathRuntimeException", "createEOFException", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/EOFException;");

classWriter.visitInnerClass("org/apache/openejb/math/MathRuntimeException$3", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(279461544586092584L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/math/MathRuntimeException$3", "val$pattern", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/math/MathRuntimeException$3", "val$arguments", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/math/MathRuntimeException$3", "val$pattern", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/math/MathRuntimeException$3", "val$arguments", "[Ljava/lang/Object;");
