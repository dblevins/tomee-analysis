...
public class PersistenceBootstrap$NullDataSourceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openejb/persistence/PersistenceBootstrap$NullDataSource", null, "java/lang/Object", new String[] { "javax/sql/DataSource" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/persistence/PersistenceBootstrap$NullDataSource", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 2);
methodVisitor.visitEnd();
}
