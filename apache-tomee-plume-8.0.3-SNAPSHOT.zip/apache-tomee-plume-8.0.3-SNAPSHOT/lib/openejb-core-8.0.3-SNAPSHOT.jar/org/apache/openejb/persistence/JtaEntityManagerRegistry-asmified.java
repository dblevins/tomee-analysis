...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/persistence/JtaEntityManagerRegistry", "transactionRegistry", "Ljakarta/transaction/TransactionSynchronizationRegistry;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEntityManager", "(Ljakarta/persistence/EntityManagerFactory;Ljava/util/Map;ZLjava/lang/String;Ljakarta/persistence/SynchronizationType;)Ljakarta/persistence/EntityManager;", null, new String[] { "java/lang/IllegalStateException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/persistence/JtaEntityManagerRegistry", "transactionRegistry", "Ljakarta/transaction/TransactionSynchronizationRegistry;");
...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/persistence/JtaEntityManagerRegistry$CloseEntityManager", "<init>", "(Ljakarta/persistence/EntityManager;Ljava/lang/String;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addEntityManagers", "(Ljava/lang/String;Ljava/lang/Object;Ljava/util/Map;)V", "(Ljava/lang/String;Ljava/lang/Object;Ljava/util/Map<Ljakarta/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;)V", new String[] { "org/apache/openejb/persistence/EntityManagerAlreadyRegisteredException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "removeEntityManagers", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Map;", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Map<Ljakarta/persistence/EntityManagerFactory;Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/persistence/JtaEntityManagerRegistry", "extendedRegistry", "Ljava/lang/ThreadLocal;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/ThreadLocal", "get", "()Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInheritedEntityManager", "(Ljakarta/persistence/EntityManagerFactory;)Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/persistence/JtaEntityManagerRegistry", "extendedRegistry", "Ljava/lang/ThreadLocal;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/ThreadLocal", "get", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry", "access$400", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$ExtendedRegistry;Ljakarta/persistence/EntityManagerFactory;)Lorg/apache/openejb/persistence/JtaEntityManagerRegistry$EntityManagerTracker;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$600", "(Lorg/apache/openejb/persistence/JtaEntityManagerRegistry;)Ljakarta/transaction/TransactionSynchronizationRegistry;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/persistence/JtaEntityManagerRegistry", "transactionRegistry", "Ljakarta/transaction/TransactionSynchronizationRegistry;");
methodVisitor.visitInsn(ARETURN);
