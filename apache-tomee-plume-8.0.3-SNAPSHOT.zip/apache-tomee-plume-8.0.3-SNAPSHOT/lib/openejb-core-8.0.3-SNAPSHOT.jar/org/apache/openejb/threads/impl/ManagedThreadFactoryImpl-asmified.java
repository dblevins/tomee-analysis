...
public class ManagedThreadFactoryImplDump implements Opcodes {
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("managed-thread-");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/threads/impl/ManagedThreadFactoryImpl", "prefix", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/threads/impl/ManagedThreadFactoryImpl$ManagedThread");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/threads/impl/ManagedThreadFactoryImpl$ManagedThread", "<init>", "(Ljava/lang/Runnable;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/threads/impl/ManagedThreadFactoryImpl", "prefix", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/threads/impl/ManagedThreadFactoryImpl", "ID", "Ljava/util/concurrent/atomic/AtomicInteger;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/threads/impl/ManagedThreadFactoryImpl", "ID", "Ljava/util/concurrent/atomic/AtomicInteger;");
methodVisitor.visitInsn(RETURN);
