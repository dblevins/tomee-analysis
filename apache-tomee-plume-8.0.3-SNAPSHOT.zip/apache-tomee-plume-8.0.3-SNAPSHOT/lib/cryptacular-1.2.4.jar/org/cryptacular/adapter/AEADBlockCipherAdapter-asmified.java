...
public class AEADBlockCipherAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/cryptacular/adapter/AEADBlockCipherAdapter", null, "java/lang/Object", new String[] { "org/cryptacular/adapter/BlockCipherAdapter" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "cipherDelegate", "Lorg/bouncycastle/crypto/modes/AEADBlockCipher;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/bouncycastle/crypto/modes/AEADBlockCipher;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/adapter/AEADBlockCipherAdapter", "cipherDelegate", "Lorg/bouncycastle/crypto/modes/AEADBlockCipher;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/adapter/AEADBlockCipherAdapter", "cipherDelegate", "Lorg/bouncycastle/crypto/modes/AEADBlockCipher;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/adapter/AEADBlockCipherAdapter", "cipherDelegate", "Lorg/bouncycastle/crypto/modes/AEADBlockCipher;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/bouncycastle/crypto/modes/AEADBlockCipher", "reset", "()V", true);
methodVisitor.visitInsn(RETURN);
