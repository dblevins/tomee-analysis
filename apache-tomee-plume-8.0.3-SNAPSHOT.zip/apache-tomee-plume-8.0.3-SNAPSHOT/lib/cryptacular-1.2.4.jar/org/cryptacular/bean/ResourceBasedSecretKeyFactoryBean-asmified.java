...
public class ResourceBasedSecretKeyFactoryBeanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "Ljava/lang/Object;Lorg/cryptacular/bean/FactoryBean<Ljavax/crypto/SecretKey;>;", "java/lang/Object", new String[] { "org/cryptacular/bean/FactoryBean" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "setResource", "(Lorg/cryptacular/io/Resource;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "setAlgorithm", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "algorithm", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "algorithm", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "resource", "Lorg/cryptacular/io/Resource;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "resource", "Lorg/cryptacular/io/Resource;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "newInstance", "()Ljavax/crypto/SecretKey;", null, new String[] { "org/cryptacular/StreamException" });
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/cryptacular/bean/ResourceBasedSecretKeyFactoryBean", "newInstance", "()Ljavax/crypto/SecretKey;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
