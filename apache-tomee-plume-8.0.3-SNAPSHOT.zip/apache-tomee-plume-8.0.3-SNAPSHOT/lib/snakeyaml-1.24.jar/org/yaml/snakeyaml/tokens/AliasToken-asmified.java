...
public class AliasTokenDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/yaml/snakeyaml/tokens/AliasToken", null, "org/yaml/snakeyaml/tokens/Token", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/yaml/snakeyaml/tokens/AliasToken", "value", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/yaml/snakeyaml/tokens/AliasToken", "value", "Ljava/lang/String;");
