...
public class AuthnContextDeclMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/AuthnContextDeclMarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/AuthnContextDecl", "getUnknownAttributes", "()Lorg/opensaml/core/xml/util/AttributeMap;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/opensaml/saml/saml2/core/AuthnContextDecl", Opcodes.TOP, "java/util/Iterator"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/opensaml/saml/saml2/core/impl/AuthnContextDeclMarshaller", "org/opensaml/core/xml/XMLObject", "org/w3c/dom/Element", "org/opensaml/saml/saml2/core/AuthnContextDecl", "org/w3c/dom/Attr", "java/util/Iterator", "java/util/Map$Entry"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/AuthnContextDecl", "getTextContent", "()Ljava/lang/String;", true);
Label label0 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/saml2/core/AuthnContextDecl"}, 0, null);
methodVisitor.visitInsn(RETURN);
