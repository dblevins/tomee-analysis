...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/AttributeStatementImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/saml/saml2/core/AttributeStatement" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/core/impl/AttributeStatementImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/AttributeStatementImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEncryptedAttributes", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/core/EncryptedAttribute;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/AttributeStatementImpl", "indexedChildren", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
