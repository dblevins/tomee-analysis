...
public class EvidenceImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/EvidenceImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/saml/saml2/core/Evidence" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "evidence", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList<Lorg/opensaml/saml/saml2/core/Evidentiary;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/saml2/core/impl/EvidenceImpl", "evidence", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEvidence", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/core/Evidentiary;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/EvidenceImpl", "evidence", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getAssertionIDReferences", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/core/AssertionIDRef;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/EvidenceImpl", "evidence", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getAssertionURIReferences", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/saml2/core/AssertionURIRef;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/saml2/core/impl/EvidenceImpl", "evidence", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
