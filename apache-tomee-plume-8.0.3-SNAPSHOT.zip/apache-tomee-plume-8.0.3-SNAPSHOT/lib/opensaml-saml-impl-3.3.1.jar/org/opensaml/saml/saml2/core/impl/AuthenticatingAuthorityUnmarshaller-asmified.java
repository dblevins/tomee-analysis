...
public class AuthenticatingAuthorityUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/AuthenticatingAuthorityUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/AuthenticatingAuthority", "setURI", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
