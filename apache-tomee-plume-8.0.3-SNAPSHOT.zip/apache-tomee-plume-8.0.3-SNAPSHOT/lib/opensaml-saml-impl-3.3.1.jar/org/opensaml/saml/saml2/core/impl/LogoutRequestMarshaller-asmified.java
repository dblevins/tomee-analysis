...
public class LogoutRequestMarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml2/core/impl/LogoutRequestMarshaller", null, "org/opensaml/saml/saml2/core/impl/RequestAbstractTypeMarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/LogoutRequest", "getReason", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml2/core/LogoutRequest", "getNotOnOrAfter", "()Lorg/joda/time/DateTime;", true);
