...
public class LogoUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2mdui/impl/LogoUnmarshaller", null, "org/opensaml/saml/common/AbstractSAMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdui/Logo", "setURL", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdui/Logo", "setXMLLang", "(Ljava/lang/String;)V", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdui/Logo", "setHeight", "(Ljava/lang/Integer;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/w3c/dom/Attr", "getValue", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(Ljava/lang/String;)Ljava/lang/Integer;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/ext/saml2mdui/Logo", "setWidth", "(Ljava/lang/Integer;)V", true);
methodVisitor.visitJumpInsn(GOTO, label1);
