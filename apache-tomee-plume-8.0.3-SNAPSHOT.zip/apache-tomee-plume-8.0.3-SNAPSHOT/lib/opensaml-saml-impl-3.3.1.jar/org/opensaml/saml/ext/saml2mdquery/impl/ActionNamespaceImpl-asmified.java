...
public class ActionNamespaceImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/ext/saml2mdquery/impl/ActionNamespaceImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/saml/ext/saml2mdquery/ActionNamespace" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/ActionNamespaceImpl", "value", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/ActionNamespaceImpl", "value", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/ext/saml2mdquery/impl/ActionNamespaceImpl", "prepareForAssignment", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/ext/saml2mdquery/impl/ActionNamespaceImpl", "value", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
