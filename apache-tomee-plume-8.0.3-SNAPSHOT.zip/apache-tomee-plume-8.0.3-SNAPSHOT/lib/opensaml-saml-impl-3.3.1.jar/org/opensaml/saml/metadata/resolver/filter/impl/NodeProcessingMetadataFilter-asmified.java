...
public class NodeProcessingMetadataFilterDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/metadata/resolver/filter/impl/NodeProcessingMetadataFilter", null, "net/shibboleth/utilities/java/support/component/AbstractInitializableComponent", new String[] { "org/opensaml/saml/metadata/resolver/filter/MetadataFilter" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "processors", "Ljava/util/List;", "Ljava/util/List<Lorg/opensaml/saml/metadata/resolver/filter/MetadataNodeProcessor;>;", null);
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/saml/metadata/resolver/filter/impl/NodeProcessingMetadataFilter", "processors", "Ljava/util/List;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getNodeProcessors", "()Ljava/util/List;", "()Ljava/util/List<Lorg/opensaml/saml/metadata/resolver/filter/MetadataNodeProcessor;>;", null);
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/saml/metadata/resolver/filter/impl/NodeProcessingMetadataFilter", "processors", "Ljava/util/List;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setNodeProcessors", "(Ljava/util/List;)V", "(Ljava/util/List<Lorg/opensaml/saml/metadata/resolver/filter/MetadataNodeProcessor;>;)V", null);
...
methodVisitor.visitLdcInsn("MetadataNodeProcessor list cannot be null");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/metadata/resolver/filter/impl/NodeProcessingMetadataFilter", "processNode", "(Lorg/opensaml/core/xml/XMLObject;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "processNode", "(Lorg/opensaml/core/xml/XMLObject;)V", null, new String[] { "org/opensaml/saml/metadata/resolver/filter/FilterException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/saml/metadata/resolver/filter/impl/NodeProcessingMetadataFilter", "getNodeProcessors", "()Ljava/util/List;", false);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/metadata/resolver/filter/MetadataNodeProcessor");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/metadata/resolver/filter/MetadataNodeProcessor", "process", "(Lorg/opensaml/core/xml/XMLObject;)V", true);
