...
public class AuthenticationStatementUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/saml/saml1/core/impl/AuthenticationStatementUnmarshaller", null, "org/opensaml/saml/saml1/core/impl/SubjectStatementUnmarshaller", null);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/saml/saml1/core/SubjectLocality");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/saml1/core/AuthenticationStatement"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/opensaml/saml/saml1/core/AuthorityBinding");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/saml/saml1/core/AuthenticationStatement", "getAuthorityBindings", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/saml/saml1/core/AuthorityBinding");
...
methodVisitor.visitLdcInsn("AuthenticationInstant");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/opensaml/saml/saml1/core/AuthenticationStatement"}, 0, null);
methodVisitor.visitLdcInsn("AuthenticationMethod");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/w3c/dom/Attr", "getLocalName", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
