...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/opensaml/xacml/ctx/ActionType", null, "java/lang/Object", new String[] { "org/opensaml/xacml/XACMLObject" });
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/xacml/ctx/ActionType", "DEFAULT_ELEMENT_NAME", "Ljavax/xml/namespace/QName;");
methodVisitor.visitTypeInsn(NEW, "javax/xml/namespace/QName");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("urn:oasis:names:tc:xacml:2.0:context:schema:os");
...
methodVisitor.visitLdcInsn("xacml-context");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/xml/namespace/QName", "<init>", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/opensaml/xacml/ctx/ActionType", "TYPE_NAME", "Ljavax/xml/namespace/QName;");
