...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "jakarta/security/auth/message/config/AuthConfigFactory", null, "java/lang/Object", null);
...
classWriter.visitInnerClass("jakarta/security/auth/message/config/AuthConfigFactory$1", null, null, ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC | ACC_VOLATILE, "factory", "Ljakarta/security/auth/message/config/AuthConfigFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getFactory", "()Ljakarta/security/auth/message/config/AuthConfigFactory;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "getFactorySecurityPermission", "Ljava/security/SecurityPermission;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "checkPermission", "(Ljava/security/Permission;)V", false);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "factory", "Ljakarta/security/auth/message/config/AuthConfigFactory;");
...
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/security/auth/message/config/AuthConfigFactory;"));
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "getFactoryClassName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "jakarta/security/auth/message/config/AuthConfigFactory$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/security/auth/message/config/AuthConfigFactory$1", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/security/auth/message/config/AuthConfigFactory");
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "factory", "Ljakarta/security/auth/message/config/AuthConfigFactory;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC | ACC_SYNCHRONIZED, "setFactory", "(Ljakarta/security/auth/message/config/AuthConfigFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "setFactorySecurityPermission", "Ljava/security/SecurityPermission;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "checkPermission", "(Ljava/security/Permission;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "factory", "Ljakarta/security/auth/message/config/AuthConfigFactory;");
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getConfigProvider", "(Ljava/lang/String;Ljava/lang/String;Ljakarta/security/auth/message/config/RegistrationListener;)Ljakarta/security/auth/message/config/AuthConfigProvider;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "registerConfigProvider", "(Ljakarta/security/auth/message/config/AuthConfigProvider;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "detachListener", "(Ljakarta/security/auth/message/config/RegistrationListener;Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getRegistrationIDs", "(Ljakarta/security/auth/message/config/AuthConfigProvider;)[Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getRegistrationContext", "(Ljava/lang/String;)Ljakarta/security/auth/message/config/AuthConfigFactory$RegistrationContext;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/security/auth/message/config/AuthConfigFactory$2");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/security/auth/message/config/AuthConfigFactory$2", "<init>", "()V", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "getFactorySecurityPermission", "Ljava/security/SecurityPermission;");
methodVisitor.visitTypeInsn(NEW, "java/security/SecurityPermission");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("setProperty.authconfigprovider.factory");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/security/SecurityPermission", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "setFactorySecurityPermission", "Ljava/security/SecurityPermission;");
methodVisitor.visitTypeInsn(NEW, "java/security/SecurityPermission");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("setProperty.authconfigfactory.provider");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/security/SecurityPermission", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/security/auth/message/config/AuthConfigFactory", "providerRegistrationSecurityPermission", "Ljava/security/SecurityPermission;");
methodVisitor.visitInsn(RETURN);
