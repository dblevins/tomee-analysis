...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", null, "java/lang/Object", new String[] { "javax/servlet/Filter" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "buildServletOperationName", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInvokeDynamicInsn("get", "(Lorg/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter;Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/ServletResponse;)Ljava/util/function/Supplier;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "lambda$doFilter$10", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/ServletResponse;)Lio/opentracing/SpanContext;", false), Type.getType("()Lio/opentracing/SpanContext;")});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "javax/servlet/ServletRequest", "javax/servlet/ServletResponse", "javax/servlet/FilterChain", "javax/servlet/http/HttpServletRequest", "java/lang/String", "io/opentracing/Tracer$SpanBuilder", "io/opentracing/Scope", "io/opentracing/Span"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "javax/servlet/ServletRequest", "javax/servlet/ServletResponse", "javax/servlet/FilterChain"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "getCurrentScope", "(Ljavax/servlet/ServletRequest;)Ljava/util/Optional;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInvokeDynamicInsn("accept", "(Lorg/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter;Ljavax/servlet/ServletRequest;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "lambda$doFilter$13", "(Ljavax/servlet/ServletRequest;Lio/opentracing/Scope;)V", false), Type.getType("(Lio/opentracing/Scope;)V")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "ifPresent", "(Ljava/util/function/Consumer;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInvokeDynamicInsn("accept", "(Lorg/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter;Ljavax/servlet/ServletResponse;Ljava/lang/Exception;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "lambda$doFilter$12", "(Ljavax/servlet/ServletResponse;Ljava/lang/Exception;Lio/opentracing/Scope;)V", false), Type.getType("(Lio/opentracing/Scope;)V")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "ifPresent", "(Ljava/util/function/Consumer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getCurrentScope", "(Ljavax/servlet/ServletRequest;)Ljava/util/Optional;", "(Ljavax/servlet/ServletRequest;)Ljava/util/Optional<Lio/opentracing/Scope;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildServletOperationName", "(Ljavax/servlet/http/HttpServletRequest;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$doFilter$13", "(Ljavax/servlet/ServletRequest;Lio/opentracing/Scope;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$doFilter$12", "(Ljavax/servlet/ServletResponse;Ljava/lang/Exception;Lio/opentracing/Scope;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "javax/servlet/ServletResponse", "java/lang/Exception", "io/opentracing/Scope", Opcodes.INTEGER, "io/opentracing/Span"}, 2, new Object[] {"io/opentracing/tag/IntTag", "io/opentracing/Span"});
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "javax/servlet/ServletResponse", "java/lang/Exception", "io/opentracing/Scope", Opcodes.INTEGER, "io/opentracing/Span"}, 3, new Object[] {"io/opentracing/tag/IntTag", "io/opentracing/Span", Opcodes.INTEGER});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$doFilter$10", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/ServletResponse;)Lio/opentracing/SpanContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/microprofile/opentracing/microprofile/server/OpenTracingFilter", "tracer", "Lio/opentracing/Tracer;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/servlet/http/HttpServletResponse");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/microprofile/opentracing/impl/ServletHeaderTextMap", "<init>", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V", false);
