...
public class OpenTracingClientResponseFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/microprofile/opentracing/microprofile/client/OpenTracingClientResponseFilter", null, "java/lang/Object", new String[] { "jakarta/ws/rs/client/ClientResponseFilter" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "filter", "(Ljakarta/ws/rs/client/ClientRequestContext;Ljakarta/ws/rs/client/ClientResponseContext;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljakarta/ws/rs/client/ClientResponseContext;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/geronimo/microprofile/opentracing/microprofile/client/OpenTracingClientResponseFilter", "lambda$filter$0", "(Ljakarta/ws/rs/client/ClientResponseContext;Lio/opentracing/Scope;)V", false), Type.getType("(Lio/opentracing/Scope;)V")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$filter$0", "(Ljakarta/ws/rs/client/ClientResponseContext;Lio/opentracing/Scope;)V", null, null);
methodVisitor.visitCode();
