...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "configure", "(Ljakarta/ws/rs/client/ClientBuilder;)Ljakarta/ws/rs/client/ClientBuilder;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/microprofile/opentracing/microprofile/client/GeronimoClientTracingRegistrarProvider", "configure", "(Ljakarta/ws/rs/client/ClientBuilder;Ljava/util/concurrent/ExecutorService;)Ljakarta/ws/rs/client/ClientBuilder;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "configure", "(Ljakarta/ws/rs/client/ClientBuilder;Ljava/util/concurrent/ExecutorService;)Ljakarta/ws/rs/client/ClientBuilder;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ws/rs/client/ClientBuilder", "getConfiguration", "()Ljakarta/ws/rs/core/Configuration;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ws/rs/client/ClientBuilder", "register", "(Ljava/lang/Object;)Ljakarta/ws/rs/core/Configurable;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ws/rs/client/ClientBuilder", "executorService", "(Ljava/util/concurrent/ExecutorService;)Ljakarta/ws/rs/client/ClientBuilder;", false);
methodVisitor.visitInsn(ARETURN);
