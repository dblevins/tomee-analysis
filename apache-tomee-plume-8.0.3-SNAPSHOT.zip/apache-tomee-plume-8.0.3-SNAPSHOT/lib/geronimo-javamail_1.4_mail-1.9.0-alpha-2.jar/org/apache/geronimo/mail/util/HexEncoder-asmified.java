...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/mail/util/HexEncoder", null, "java/lang/Object", new String[] { "org/apache/geronimo/mail/util/Encoder" });
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/mail/util/HexEncoder", "encodingTable", "[B");
methodVisitor.visitInsn(ARRAYLENGTH);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/mail/util/HexEncoder", "decodingTable", "[B");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/mail/util/HexEncoder", "encodingTable", "[B");
methodVisitor.visitVarInsn(ILOAD, 1);
...
methodVisitor.visitIntInsn(BIPUSH, 102);
methodVisitor.visitInsn(BASTORE);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/mail/util/HexEncoder", "encodingTable", "[B");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitIntInsn(SIPUSH, 128);
methodVisitor.visitIntInsn(NEWARRAY, T_BYTE);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/mail/util/HexEncoder", "decodingTable", "[B");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/mail/util/HexEncoder", "initialiseDecodingTable", "()V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/mail/util/HexEncoder", "ignore", "(C)Z", false);
Label label2 = new Label();
