...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/javamail/handlers/AbstractImageHandler", null, "java/lang/Object", new String[] { "javax/activation/DataContentHandler" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "flavour", "Ljavax/activation/ActivationDataFlavor;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/javamail/handlers/AbstractImageHandler", "flavour", "Ljavax/activation/ActivationDataFlavor;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/javamail/handlers/AbstractImageHandler", "flavour", "Ljavax/activation/ActivationDataFlavor;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/geronimo/javamail/handlers/AbstractImageHandler", "getContent", "(Ljavax/activation/DataSource;)Ljava/lang/Object;", false);
