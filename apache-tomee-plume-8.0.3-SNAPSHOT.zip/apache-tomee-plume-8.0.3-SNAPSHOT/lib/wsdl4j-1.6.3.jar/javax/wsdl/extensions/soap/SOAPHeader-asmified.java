...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/wsdl/extensions/soap/SOAPHeader", null, "java/lang/Object", new String[] { "javax/wsdl/extensions/ExtensibilityElement", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addSOAPHeaderFault", "(Ljavax/wsdl/extensions/soap/SOAPHeaderFault;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removeSOAPHeaderFault", "(Ljavax/wsdl/extensions/soap/SOAPHeaderFault;)Ljavax/wsdl/extensions/soap/SOAPHeaderFault;", null, null);
methodVisitor.visitEnd();
}
{
