...
public class BindingFaultImplDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ibm/wsdl/BindingFaultImpl", "name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "com/ibm/wsdl/Constants", "BINDING_FAULT_ATTR_NAMES", "[Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/ibm/wsdl/BindingFaultImpl", "nativeAttributeNames", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ibm/wsdl/BindingFaultImpl", "name", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("BindingFault: name=");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ibm/wsdl/BindingFaultImpl", "nativeAttributeNames", "Ljava/util/List;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
