...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "com/ibm/wsdl/extensions/schema/SchemaDeserializer", null, "java/lang/Object", new String[] { "jakarta/wsdl/extensions/ExtensionDeserializer", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "setLocator", "(Ljakarta/wsdl/xml/WSDLLocator;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn("id");
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/ibm/wsdl/util/xml/DOMUtils", "getAttribute", "(Lorg/w3c/dom/Element;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/wsdl/extensions/schema/SchemaReference", "setId", "(Ljava/lang/String;)V", true);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitLdcInsn("schemaLocation");
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/ibm/wsdl/util/xml/DOMUtils", "getAttribute", "(Lorg/w3c/dom/Element;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 10);
