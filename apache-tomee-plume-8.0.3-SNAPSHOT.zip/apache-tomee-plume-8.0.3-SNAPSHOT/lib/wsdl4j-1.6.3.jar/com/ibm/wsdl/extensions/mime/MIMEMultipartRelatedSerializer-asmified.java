...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "com/ibm/wsdl/extensions/mime/MIMEMultipartRelatedSerializer", null, "java/lang/Object", new String[] { "javax/wsdl/extensions/ExtensionSerializer", "javax/wsdl/extensions/ExtensionDeserializer", "java/io/Serializable" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintWriter", "print", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/wsdl/extensions/mime/MIMEMultipartRelated", "getRequired", "()Ljava/lang/Boolean;", true);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/ibm/wsdl/extensions/mime/MIMEMultipartRelatedSerializer", "printMIMEParts", "(Ljava/util/List;Ljava/io/PrintWriter;Ljavax/wsdl/Definition;Ljavax/wsdl/extensions/ExtensionRegistry;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "printMIMEParts", "(Ljava/util/List;Ljava/io/PrintWriter;Ljavax/wsdl/Definition;Ljavax/wsdl/extensions/ExtensionRegistry;)V", null, new String[] { "javax/wsdl/WSDLException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/PrintWriter", "print", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/wsdl/extensions/mime/MIMEPart", "getRequired", "()Ljava/lang/Boolean;", true);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label3);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/ibm/wsdl/extensions/mime/MIMEMultipartRelatedSerializer", "parseMIMEPart", "(Ljava/lang/Class;Ljavax/xml/namespace/QName;Lorg/w3c/dom/Element;Ljavax/wsdl/Definition;Ljavax/wsdl/extensions/ExtensionRegistry;)Ljavax/wsdl/extensions/mime/MIMEPart;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/wsdl/extensions/mime/MIMEMultipartRelated", "addMIMEPart", "(Ljavax/wsdl/extensions/mime/MIMEPart;)V", true);
Label label3 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/wsdl/extensions/mime/MIMEMultipartRelated", "setRequired", "(Ljava/lang/Boolean;)V", true);
methodVisitor.visitLabel(label4);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseMIMEPart", "(Ljava/lang/Class;Ljavax/xml/namespace/QName;Lorg/w3c/dom/Element;Ljavax/wsdl/Definition;Ljavax/wsdl/extensions/ExtensionRegistry;)Ljavax/wsdl/extensions/mime/MIMEPart;", null, new String[] { "javax/wsdl/WSDLException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Boolean", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/wsdl/extensions/mime/MIMEPart", "setRequired", "(Ljava/lang/Boolean;)V", true);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/ibm/wsdl/util/xml/DOMUtils", "getFirstChildElement", "(Lorg/w3c/dom/Element;)Lorg/w3c/dom/Element;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/wsdl/extensions/mime/MIMEPart", "addExtensibilityElement", "(Ljavax/wsdl/extensions/ExtensibilityElement;)V", true);
methodVisitor.visitLabel(label1);
