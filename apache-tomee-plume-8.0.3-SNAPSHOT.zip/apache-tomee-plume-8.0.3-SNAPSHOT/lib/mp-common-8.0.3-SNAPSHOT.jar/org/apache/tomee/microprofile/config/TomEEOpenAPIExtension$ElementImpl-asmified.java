...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$ElementImpl", "delegate", "Ljakarta/enterprise/inject/spi/Annotated;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$ElementImpl", "delegate", "Ljakarta/enterprise/inject/spi/Annotated;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljakarta/enterprise/inject/spi/Annotated;Lorg/apache/tomee/microprofile/config/TomEEOpenAPIExtension$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/microprofile/config/TomEEOpenAPIExtension$ElementImpl", "<init>", "(Ljakarta/enterprise/inject/spi/Annotated;)V", false);
methodVisitor.visitInsn(RETURN);
