...
public class EncryptedElementsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/policy/model/EncryptedElements", null, "org/apache/wss4j/policy/model/RequiredElements", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/EncryptedElements", "getVersion", "()Lorg/apache/wss4j/policy/SPConstants$SPVersion;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/EncryptedElements", "getVersion", "()Lorg/apache/wss4j/policy/SPConstants$SPVersion;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/policy/model/EncryptedElements", "getXPathVersion", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
