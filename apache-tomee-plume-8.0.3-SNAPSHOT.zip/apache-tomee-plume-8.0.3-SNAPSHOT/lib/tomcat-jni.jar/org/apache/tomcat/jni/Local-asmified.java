...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/jni/Local", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC | ACC_NATIVE, "create", "(Ljava/lang/String;J)J", null, new String[] { "java/lang/Exception" });
methodVisitor.visitEnd();
}
{
