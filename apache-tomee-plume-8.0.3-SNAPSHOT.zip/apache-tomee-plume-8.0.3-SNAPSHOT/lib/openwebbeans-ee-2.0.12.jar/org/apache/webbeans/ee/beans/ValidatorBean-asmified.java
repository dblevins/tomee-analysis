...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/ee/beans/ValidatorBean", "Lorg/apache/webbeans/component/BuiltInOwbBean<Ljakarta/validation/Validator;>;", "org/apache/webbeans/component/BuiltInOwbBean", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/validation/Validator;"));
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/ee/beans/ValidatorProvider");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/ee/beans/ValidatorProvider", "<init>", "(Lorg/apache/webbeans/config/WebBeansContext;)V", false);
