...
public class InstanceManagerFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/runtime/InstanceManagerFactory", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstanceManager", "(Ljakarta/servlet/ServletConfig;)Lorg/apache/tomcat/InstanceManager;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn("jsp.error.noInstanceManager");
