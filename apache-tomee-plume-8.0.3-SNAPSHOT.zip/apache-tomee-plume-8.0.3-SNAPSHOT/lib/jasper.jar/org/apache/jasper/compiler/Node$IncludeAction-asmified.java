...
public class Node$IncludeActionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/compiler/Node$IncludeAction", null, "org/apache/jasper/compiler/Node", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "page", "Lorg/apache/jasper/compiler/Node$JspAttribute;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/Node$Visitor", "visit", "(Lorg/apache/jasper/compiler/Node$IncludeAction;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setPage", "(Lorg/apache/jasper/compiler/Node$JspAttribute;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/Node$IncludeAction", "page", "Lorg/apache/jasper/compiler/Node$JspAttribute;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPage", "()Lorg/apache/jasper/compiler/Node$JspAttribute;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Node$IncludeAction", "page", "Lorg/apache/jasper/compiler/Node$JspAttribute;");
