...
public class ELNode$TextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/compiler/ELNode$Text", null, "org/apache/jasper/compiler/ELNode", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/ELNode$Text", "text", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/ELNode$Visitor", "visit", "(Lorg/apache/jasper/compiler/ELNode$Text;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/ELNode$Text", "text", "Ljava/lang/String;");
