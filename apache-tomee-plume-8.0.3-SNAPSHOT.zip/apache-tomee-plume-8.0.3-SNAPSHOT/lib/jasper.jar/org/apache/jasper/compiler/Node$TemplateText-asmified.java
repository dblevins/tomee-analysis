...
public class Node$TemplateTextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/compiler/Node$TemplateText", null, "org/apache/jasper/compiler/Node", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "extraSmap", "Ljava/util/ArrayList;", "Ljava/util/ArrayList<Ljava/lang/Integer;>;", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/Node$TemplateText", "extraSmap", "Ljava/util/ArrayList;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/Node$Visitor", "visit", "(Lorg/apache/jasper/compiler/Node$TemplateText;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "ltrim", "()V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Node$TemplateText", "text", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jasper/compiler/Node$TemplateText", "text", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "rtrim", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Node$TemplateText", "text", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "length", "()I", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isAllSpace", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ISTORE, 1);
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addSmap", "(I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Node$TemplateText", "extraSmap", "Ljava/util/ArrayList;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getExtraSmap", "()Ljava/util/ArrayList;", "()Ljava/util/ArrayList<Ljava/lang/Integer;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jasper/compiler/Node$TemplateText", "extraSmap", "Ljava/util/ArrayList;");
