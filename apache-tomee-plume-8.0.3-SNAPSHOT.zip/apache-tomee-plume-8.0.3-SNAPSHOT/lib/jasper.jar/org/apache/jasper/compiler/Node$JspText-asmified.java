...
public class Node$JspTextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/jasper/compiler/Node$JspText", null, "org/apache/jasper/compiler/Node", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jasper/compiler/Node$Visitor", "visit", "(Lorg/apache/jasper/compiler/Node$JspText;)V", false);
methodVisitor.visitInsn(RETURN);
