...
public class ClusterMessageDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/catalina/ha/ClusterMessage", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getUniqueId", "()Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
{
