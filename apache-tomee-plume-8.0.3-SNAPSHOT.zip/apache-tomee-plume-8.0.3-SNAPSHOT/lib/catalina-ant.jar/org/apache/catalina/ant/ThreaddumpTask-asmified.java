...
public class ThreaddumpTaskDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/ant/ThreaddumpTask", null, "org/apache/catalina/ant/AbstractCatalinaTask", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/ant/ThreaddumpTask", "execute", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
