...
public class WrapperListenerSFDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/storeconfig/WrapperListenerSF", null, "org/apache/catalina/storeconfig/StoreFactoryBase", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/storeconfig/WrapperListenerSF", "getRegistry", "()Lorg/apache/catalina/storeconfig/StoreRegistry;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/storeconfig/WrapperListenerSF", "log", "Lorg/apache/juli/logging/Log;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/storeconfig/WrapperListenerSF", "getStoreAppender", "()Lorg/apache/catalina/storeconfig/StoreAppender;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/storeconfig/WrapperListenerSF", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/storeconfig/WrapperListenerSF", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/catalina/storeconfig/WrapperListenerSF;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/juli/logging/LogFactory", "getLog", "(Ljava/lang/Class;)Lorg/apache/juli/logging/Log;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/catalina/storeconfig/WrapperListenerSF", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitInsn(RETURN);
