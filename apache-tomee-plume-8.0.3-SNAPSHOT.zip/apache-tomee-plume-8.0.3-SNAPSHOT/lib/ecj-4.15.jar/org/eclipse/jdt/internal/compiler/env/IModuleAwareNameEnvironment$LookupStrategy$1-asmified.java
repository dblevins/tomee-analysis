...
public class IModuleAwareNameEnvironment$LookupStrategy$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ENUM, "org/eclipse/jdt/internal/compiler/env/IModuleAwareNameEnvironment$LookupStrategy$1", null, "org/eclipse/jdt/internal/compiler/env/IModuleAwareNameEnvironment$LookupStrategy", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/env/IModuleAwareNameEnvironment$LookupStrategy", "$assertionsDisabled", "Z");
...
methodVisitor.visitLdcInsn("name match needs a nameMatcher");
