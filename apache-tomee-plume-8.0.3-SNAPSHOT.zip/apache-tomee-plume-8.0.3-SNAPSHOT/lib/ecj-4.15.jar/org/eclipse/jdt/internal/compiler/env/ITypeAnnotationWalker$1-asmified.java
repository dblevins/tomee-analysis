...
public class ITypeAnnotationWalker$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/jdt/internal/compiler/env/ITypeAnnotationWalker$1", null, "java/lang/Object", new String[] { "org/eclipse/jdt/internal/compiler/env/ITypeAnnotationWalker" });

classWriter.visitOuterClass("org/eclipse/jdt/internal/compiler/env/ITypeAnnotationWalker", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/jdt/internal/compiler/env/ITypeAnnotationWalker$1", "NO_ANNOTATIONS", "[Lorg/eclipse/jdt/internal/compiler/env/IBinaryAnnotation;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 3);
methodVisitor.visitEnd();
}
