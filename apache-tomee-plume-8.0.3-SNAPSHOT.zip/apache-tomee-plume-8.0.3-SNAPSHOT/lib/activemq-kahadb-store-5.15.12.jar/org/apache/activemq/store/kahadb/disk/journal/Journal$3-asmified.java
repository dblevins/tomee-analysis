...
public class Journal$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/kahadb/disk/journal/Journal$3", null, "java/lang/Object", new String[] { "java/lang/Runnable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/disk/journal/Journal$3", "this$0", "Lorg/apache/activemq/store/kahadb/disk/journal/Journal;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/disk/journal/Journal$3", "this$0", "Lorg/apache/activemq/store/kahadb/disk/journal/Journal;");
