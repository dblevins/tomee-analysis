...
public class BTreeVisitor$LTVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$LTVisitor", "<Key::Ljava/lang/Comparable<TKey;>;Value:Ljava/lang/Object;>Lorg/apache/activemq/store/kahadb/disk/index/BTreeVisitor$PredicateVisitor<TKey;TValue;>;", "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$PredicateVisitor", null);

classWriter.visitInnerClass("org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$LTVisitor", "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor", "LTVisitor", ACC_PUBLIC | ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$LTVisitor", "value", "Ljava/lang/Comparable;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$LTVisitor", "value", "Ljava/lang/Comparable;");
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Comparable");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$LTVisitor", "isInterestedInKeysBetween", "(Ljava/lang/Comparable;Ljava/lang/Comparable;)Z", false);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Comparable");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/disk/index/BTreeVisitor$LTVisitor", "isInterestedInKey", "(Ljava/lang/Comparable;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
