...
public class PListStoreImpl$MetaDataDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(0, "page", "Lorg/apache/activemq/store/kahadb/disk/page/Page;", "Lorg/apache/activemq/store/kahadb/disk/page/Page<Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "lists", "Lorg/apache/activemq/store/kahadb/disk/index/BTreeIndex;", "Lorg/apache/activemq/store/kahadb/disk/index/BTreeIndex<Ljava/lang/String;Lorg/apache/activemq/store/kahadb/plist/PListImpl;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "this$0", "Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "store", "Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "this$0", "Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "lists", "Lorg/apache/activemq/store/kahadb/disk/index/BTreeIndex;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "lists", "Lorg/apache/activemq/store/kahadb/disk/index/BTreeIndex;");
methodVisitor.visitTypeInsn(NEW, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$PListMarshaller");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "this$0", "Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "store", "Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$PListMarshaller", "<init>", "(Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;Lorg/apache/activemq/store/kahadb/plist/PListStoreImpl;)V", false);
...
{
methodVisitor = classWriter.visitMethod(0, "loadLists", "(Lorg/apache/activemq/store/kahadb/disk/page/Transaction;Ljava/util/Map;)V", "(Lorg/apache/activemq/store/kahadb/disk/page/Transaction;Ljava/util/Map<Ljava/lang/String;Lorg/apache/activemq/store/kahadb/plist/PListImpl;>;)V", new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/plist/PListStoreImpl$MetaData", "lists", "Lorg/apache/activemq/store/kahadb/disk/index/BTreeIndex;");
methodVisitor.visitVarInsn(ALOAD, 1);
