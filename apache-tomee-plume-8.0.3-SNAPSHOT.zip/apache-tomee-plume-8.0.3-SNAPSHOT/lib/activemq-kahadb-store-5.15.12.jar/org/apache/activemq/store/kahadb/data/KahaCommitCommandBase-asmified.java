...
public class KahaCommitCommandBaseDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/activemq/store/kahadb/data/KahaCommitCommandBase", "<T:Ljava/lang/Object;>Lorg/apache/activemq/protobuf/BaseMessage<TT;>;", "org/apache/activemq/protobuf/BaseMessage", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/data/KahaCommitCommandBase", "f_transactionInfo", "Lorg/apache/activemq/store/kahadb/data/KahaTransactionInfo;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/data/KahaCommitCommandBase", "f_transactionInfo", "Lorg/apache/activemq/store/kahadb/data/KahaTransactionInfo;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/data/KahaCommitCommandBase", "loadAndClear", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
