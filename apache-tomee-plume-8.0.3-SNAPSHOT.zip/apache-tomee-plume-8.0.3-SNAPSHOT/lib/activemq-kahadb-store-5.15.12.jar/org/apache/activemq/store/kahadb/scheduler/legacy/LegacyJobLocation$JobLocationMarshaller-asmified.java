...
public class LegacyJobLocation$JobLocationMarshallerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller", "Lorg/apache/activemq/store/kahadb/disk/util/VariableMarshaller<Ljava/util/List<Lorg/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation;>;>;", "org/apache/activemq/store/kahadb/disk/util/VariableMarshaller", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "INSTANCE", "Lorg/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller", "readPayload", "(Ljava/io/DataInput;)Ljava/util/List;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller", "writePayload", "(Ljava/util/List;Ljava/io/DataOutput;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller", "INSTANCE", "Lorg/apache/activemq/store/kahadb/scheduler/legacy/LegacyJobLocation$JobLocationMarshaller;");
methodVisitor.visitInsn(RETURN);
