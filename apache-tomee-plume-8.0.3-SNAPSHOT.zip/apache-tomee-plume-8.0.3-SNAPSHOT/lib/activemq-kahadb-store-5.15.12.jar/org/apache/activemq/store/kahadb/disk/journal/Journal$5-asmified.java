...
public class Journal$5Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/activemq/store/kahadb/disk/journal/Journal$5", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$activemq$store$kahadb$disk$journal$Journal$PreallocationStrategy", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/store/kahadb/disk/journal/Journal$PreallocationStrategy", "values", "()[Lorg/apache/activemq/store/kahadb/disk/journal/Journal$PreallocationStrategy;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/activemq/store/kahadb/disk/journal/Journal$5", "$SwitchMap$org$apache$activemq$store$kahadb$disk$journal$Journal$PreallocationStrategy", "[I");
