...
public class KahaPrepareCommandBaseDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/activemq/store/kahadb/data/KahaPrepareCommandBase", "<T:Ljava/lang/Object;>Lorg/apache/activemq/protobuf/BaseMessage<TT;>;", "org/apache/activemq/protobuf/BaseMessage", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/kahadb/data/KahaPrepareCommandBase", "f_transactionInfo", "Lorg/apache/activemq/store/kahadb/data/KahaTransactionInfo;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/kahadb/data/KahaPrepareCommandBase", "f_transactionInfo", "Lorg/apache/activemq/store/kahadb/data/KahaTransactionInfo;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/store/kahadb/data/KahaPrepareCommandBase", "loadAndClear", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
