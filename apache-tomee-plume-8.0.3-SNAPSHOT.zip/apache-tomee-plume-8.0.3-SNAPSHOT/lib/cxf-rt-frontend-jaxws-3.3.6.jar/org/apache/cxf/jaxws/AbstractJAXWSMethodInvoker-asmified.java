...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "findSoapFaultException", "(Ljava/lang/Throwable;)Ljavax/xml/ws/soap/SOAPFaultException;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Throwable", "getCause", "()Ljava/lang/Throwable;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/AbstractJAXWSMethodInvoker", "findSoapFaultException", "(Ljava/lang/Throwable;)Ljavax/xml/ws/soap/SOAPFaultException;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/xml/ws/soap/SOAPFaultException", "org/apache/cxf/binding/soap/SoapFault"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "updateWebServiceContext", "(Lorg/apache/cxf/message/Exchange;Ljavax/xml/ws/handler/MessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/headers/Header", "HEADER_LIST", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/MessageContext", "containsKey", "(Ljava/lang/Object;)Z", true);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/headers/Header", "HEADER_LIST", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "updateHeader", "(Lorg/apache/cxf/message/Exchange;Ljavax/xml/ws/handler/MessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/headers/Header", "HEADER_LIST", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/MessageContext", "containsKey", "(Ljava/lang/Object;)Z", true);
