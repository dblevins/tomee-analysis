...
public class JAXWSBPNamespaceHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxws/blueprint/JAXWSBPNamespaceHandler", null, "org/apache/cxf/helpers/BaseNamespaceHandler", null);

{
annotationVisitor0 = classWriter.visitAnnotation("Lorg/apache/aries/blueprint/Namespaces;", true);
{
AnnotationVisitor annotationVisitor1 = annotationVisitor0.visitArray("value");
annotationVisitor1.visit(null, "http://cxf.apache.org/blueprint/jaxws");
annotationVisitor1.visitEnd();
}
annotationVisitor0.visitEnd();
}
classWriter.visitInnerClass("org/apache/cxf/jaxws/blueprint/JAXWSBPNamespaceHandler$BPJaxWsServerFactoryBean", "org/apache/cxf/jaxws/blueprint/JAXWSBPNamespaceHandler", "BPJaxWsServerFactoryBean", ACC_PUBLIC | ACC_STATIC);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("http://cxf.apache.org/blueprint/jaxws");
...
methodVisitor.visitLdcInsn("schemas/blueprint/jaxws.xsd");
...
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/jaxws/blueprint/EndpointDefinitionParser");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/blueprint/EndpointDefinitionParser", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/blueprint/EndpointDefinitionParser", "parse", "(Lorg/w3c/dom/Element;Lorg/apache/aries/blueprint/ParserContext;)Lorg/osgi/service/blueprint/reflect/Metadata;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/jaxws/blueprint/JAXWSBPNamespaceHandler$BPJaxWsServerFactoryBean;"));
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/blueprint/JAXWSBPNamespaceHandler", "blueprintContainer", "Lorg/osgi/service/blueprint/container/BlueprintContainer;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/blueprint/JAXWSBPNamespaceHandler", "blueprintContainer", "Lorg/osgi/service/blueprint/container/BlueprintContainer;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
