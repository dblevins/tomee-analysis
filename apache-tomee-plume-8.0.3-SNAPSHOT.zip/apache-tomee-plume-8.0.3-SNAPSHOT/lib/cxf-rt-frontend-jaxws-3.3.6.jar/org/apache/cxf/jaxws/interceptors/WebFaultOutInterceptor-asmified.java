...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getFaultName", "(Ljakarta/xml/ws/WebFault;Ljava/lang/Class;Lorg/apache/cxf/service/model/OperationInfo;)Ljavax/xml/namespace/QName;", "(Ljakarta/xml/ws/WebFault;Ljava/lang/Class<*>;Lorg/apache/cxf/service/model/OperationInfo;)Ljavax/xml/namespace/QName;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getWebFaultAnnotation", "(Ljava/lang/Class;)Ljakarta/xml/ws/WebFault;", "(Ljava/lang/Class<*>;)Ljakarta/xml/ws/WebFault;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getSuperclass", "()Ljava/lang/Class;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "getWebFaultAnnotation", "(Ljava/lang/Class;)Ljakarta/xml/ws/WebFault;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Throwable", "jakarta/xml/ws/soap/SOAPFaultException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/soap/SOAPFault", "getFaultSubcodes", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/soap/SOAPFaultException", "getFault", "()Ljakarta/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/soap/SOAPFault", "getFaultReasonLocales", "()Ljava/util/Iterator;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label14);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/soap/SOAPFaultException", "getFault", "()Ljakarta/xml/soap/SOAPFault;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Throwable", "jakarta/xml/ws/WebFault"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Throwable", "getCause", "()Ljava/lang/Throwable;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/interceptor/Fault", "java/lang/Throwable", "jakarta/xml/ws/WebFault", "java/lang/Exception", "java/lang/Object"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "createFaultInfoBean", "(Ljakarta/xml/ws/WebFault;Ljava/lang/Throwable;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitJumpInsn(GOTO, label22);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "getFaultName", "(Ljakarta/xml/ws/WebFault;Ljava/lang/Class;Lorg/apache/cxf/service/model/OperationInfo;)Ljavax/xml/namespace/QName;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "org/apache/cxf/message/Message", "org/apache/cxf/interceptor/Fault", "java/lang/Throwable", "jakarta/xml/ws/WebFault", "java/lang/Exception", "java/lang/Object", "org/apache/cxf/service/Service"}, 1, new Object[] {"org/apache/cxf/interceptor/Fault"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljava/lang/Exception;"));
methodVisitor.visitVarInsn(ALOAD, 8);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createFaultInfoBean", "(Ljakarta/xml/ws/WebFault;Ljava/lang/Throwable;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/ws/WebFault", "faultBean", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/util/StringUtils", "isEmpty", "(Ljava/lang/String;)Z", false);
Label label6 = new Label();
...
Label label8 = new Label();
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "jakarta/xml/ws/WebFault", "java/lang/Throwable", "java/lang/Class", "java/lang/Object", "[Ljava/lang/reflect/Method;", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/jaxws/interceptors/WebFaultOutInterceptor", "jakarta/xml/ws/WebFault", "java/lang/Throwable", "java/lang/Class", "java/lang/Object", "[Ljava/lang/reflect/Method;", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/reflect/Method"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
