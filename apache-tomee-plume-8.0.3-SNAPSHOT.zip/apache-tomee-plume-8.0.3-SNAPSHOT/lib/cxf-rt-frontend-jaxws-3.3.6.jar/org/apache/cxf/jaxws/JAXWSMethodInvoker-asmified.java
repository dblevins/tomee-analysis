...
{
fieldVisitor = classWriter.visitField(0, "invoker", "Ljakarta/xml/ws/spi/Invoker;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/JAXWSMethodInvoker", "invoker", "Ljakarta/xml/ws/spi/Invoker;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/JAXWSMethodInvoker", "invoker", "Ljakarta/xml/ws/spi/Invoker;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/ws/spi/Invoker", "invoke", "(Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/jaxws/JAXWSMethodInvoker", "org/apache/cxf/message/Exchange", "java/lang/Object", "java/lang/reflect/Method", "java/util/List", "org/apache/cxf/jaxws/context/WrappedMessageContext", "java/util/Map", "jakarta/xml/ws/handler/MessageContext", "java/util/List"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/xml/ws/Provider");
methodVisitor.visitJumpInsn(IFEQ, label6);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/JAXWSMethodInvoker", "updateWebServiceContext", "(Lorg/apache/cxf/message/Exchange;Ljakarta/xml/ws/handler/MessageContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/JAXWSMethodInvoker", "updateHeader", "(Lorg/apache/cxf/message/Exchange;Ljakarta/xml/ws/handler/MessageContext;)V", false);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/apache/cxf/interceptor/Fault"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/jaxws/JAXWSMethodInvoker", "org/apache/cxf/message/Exchange", "java/lang/Object", "java/lang/reflect/Method", "java/util/List", "org/apache/cxf/jaxws/context/WrappedMessageContext", "java/util/Map", "jakarta/xml/ws/handler/MessageContext", "java/util/List"}, 1, new Object[] {"java/lang/Throwable"});
