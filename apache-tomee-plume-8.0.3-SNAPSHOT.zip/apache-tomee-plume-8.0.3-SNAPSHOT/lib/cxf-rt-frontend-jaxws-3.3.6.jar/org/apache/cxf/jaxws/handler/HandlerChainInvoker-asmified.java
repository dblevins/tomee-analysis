...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "protocolHandlers", "Ljava/util/List;", "Ljava/util/List<Ljavax/xml/ws/handler/Handler<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "logicalHandlers", "Ljava/util/List;", "Ljava/util/List<Ljavax/xml/ws/handler/LogicalHandler<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "invokedHandlers", "Ljava/util/List;", "Ljava/util/List<Ljavax/xml/ws/handler/Handler<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "closeHandlers", "Ljava/util/List;", "Ljava/util/List<Ljavax/xml/ws/handler/Handler<*>;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "logicalMessageContext", "Ljavax/xml/ws/handler/LogicalMessageContext;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "protocolMessageContext", "Ljavax/xml/ws/handler/MessageContext;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/List;)V", "(Ljava/util/List<Ljavax/xml/ws/handler/Handler;>;)V", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/List;Z)V", "(Ljava/util/List<Ljavax/xml/ws/handler/Handler;>;Z)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLogicalHandlers", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/xml/ws/handler/LogicalHandler<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalHandlers", "Ljava/util/List;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProtocolHandlers", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/xml/ws/handler/Handler<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "protocolHandlers", "Ljava/util/List;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLogicalMessageContext", "()Ljavax/xml/ws/handler/LogicalMessageContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalMessageContext", "Ljavax/xml/ws/handler/LogicalMessageContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setLogicalMessageContext", "(Ljavax/xml/ws/handler/LogicalMessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalMessageContext", "Ljavax/xml/ws/handler/LogicalMessageContext;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProtocolMessageContext", "()Ljavax/xml/ws/handler/MessageContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "protocolMessageContext", "Ljavax/xml/ws/handler/MessageContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setProtocolMessageContext", "(Ljavax/xml/ws/handler/MessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "protocolMessageContext", "Ljavax/xml/ws/handler/MessageContext;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invokeLogicalHandlers", "(ZLjavax/xml/ws/handler/LogicalMessageContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalHandlers", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeHandlerChain", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invokeLogicalHandlersHandleFault", "(ZLjavax/xml/ws/handler/LogicalMessageContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalHandlers", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeHandlerChainHandleFault", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invokeProtocolHandlers", "(ZLjavax/xml/ws/handler/MessageContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "protocolHandlers", "Ljava/util/List;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invokeProtocolHandlersHandleFault", "(ZLjavax/xml/ws/handler/MessageContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "protocolHandlers", "Ljava/util/List;");
...
{
methodVisitor = classWriter.visitMethod(0, "getInvokedHandlers", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/xml/ws/handler/Handler<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokedHandlers", "Ljava/util/List;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "invokeHandlerChain", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", "(Ljava/util/List<+Ljavax/xml/ws/handler/Handler<*>;>;Ljavax/xml/ws/handler/MessageContext;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxws/handler/HandlerChainInvoker", "java/util/List", "javax/xml/ws/handler/MessageContext"}, 3, new Object[] {"java/util/logging/Logger", "java/util/logging/Level", "java/lang/StringBuilder"});
methodVisitor.visitLdcInsn("inbound");
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxws/handler/HandlerChainInvoker", "java/util/List", "javax/xml/ws/handler/MessageContext"}, 4, new Object[] {"java/util/logging/Logger", "java/util/logging/Level", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "log", "(Ljava/util/logging/Level;Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label6);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeHandleMessage", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {Opcodes.INTEGER, "javax/xml/ws/handler/MessageContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/jaxws/context/WebServiceContextImpl", "setMessageContext", "(Ljavax/xml/ws/handler/MessageContext;)Ljavax/xml/ws/handler/MessageContext;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitJumpInsn(GOTO, label11);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "invokeHandlerChainHandleFault", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", "(Ljava/util/List<+Ljavax/xml/ws/handler/Handler<*>;>;Ljavax/xml/ws/handler/MessageContext;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "fault", "Ljava/lang/Exception;");
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/xml/ws/ProtocolException");
Label label7 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "setMessageOutboundProperty", "(Ljavax/xml/ws/handler/MessageContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "outbound", "Z");
Label label11 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeHandleFault", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label12 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "invokeHandleFault", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", "(Ljava/util/List<+Ljavax/xml/ws/handler/Handler<*>;>;Ljavax/xml/ws/handler/MessageContext;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeThisHandler", "(Ljavax/xml/ws/handler/Handler;)Z", false);
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "markHandlerInvoked", "(Ljavax/xml/ws/handler/Handler;)V", false);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/Handler", "handleFault", "(Ljavax/xml/ws/handler/MessageContext;)Z", true);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/ws/handler/Handler"}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "invokeHandleMessage", "(Ljava/util/List;Ljavax/xml/ws/handler/MessageContext;)Z", "(Ljava/util/List<+Ljavax/xml/ws/handler/Handler<*>;>;Ljavax/xml/ws/handler/MessageContext;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "javax/xml/ws/ProtocolException");
Label label3 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/Handler", "handleMessage", "(Ljavax/xml/ws/handler/MessageContext;)Z", true);
methodVisitor.visitVarInsn(ISTORE, 3);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/ws/handler/Handler"}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "changeMessageDirection", "(Ljavax/xml/ws/handler/MessageContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/xml/ws/ProtocolException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "LOG", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "messageDirectionReversed", "Z");
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/ws/ProtocolException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "setFaultMessage", "(Ljavax/xml/ws/handler/MessageContext;Ljava/lang/Exception;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeReversedHandleFault", "(Ljavax/xml/ws/handler/MessageContext;)Z", false);
methodVisitor.visitInsn(POP);
Label label12 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "mapSoapFault", "(Ljavax/xml/ws/soap/SOAPFaultException;)Lorg/apache/cxf/binding/soap/SoapFault;", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "mapSoapFault", "(Ljavax/xml/ws/soap/SOAPFaultException;)Lorg/apache/cxf/binding/soap/SoapFault;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/soap/SOAPFaultException", "getFault", "()Ljavax/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getFaultCodeAsQName", "()Ljavax/xml/namespace/QName;", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/soap/SOAPFaultException", "getFault", "()Ljavax/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getFaultActor", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/soap/SOAPFaultException", "getFault", "()Ljavax/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getDetail", "()Ljavax/xml/soap/Detail;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "setFaultMessage", "(Ljavax/xml/ws/handler/MessageContext;Ljava/lang/Exception;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/cxf/message/Message", "javax/xml/soap/SOAPMessage", "org/apache/cxf/binding/soap/SoapVersion"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPBody", "addFault", "()Ljavax/xml/soap/SOAPFault;", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/soap/SOAPFaultException", "getFault", "()Ljavax/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getFaultCodeAsQName", "()Ljavax/xml/namespace/QName;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/binding/soap/saaj/SAAJUtils", "setFaultCode", "(Ljavax/xml/soap/SOAPFault;Ljavax/xml/namespace/QName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/soap/SOAPFaultException", "getFault", "()Ljavax/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getFaultActor", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "setFaultActor", "(Ljava/lang/String;)V", true);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/ws/soap/SOAPFaultException", "getFault", "()Ljavax/xml/soap/SOAPFault;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "hasDetail", "()Z", true);
Label label5 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getDetail", "()Ljavax/xml/soap/Detail;", true);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/soap/SOAPPart", "importNode", "(Lorg/w3c/dom/Node;Z)Lorg/w3c/dom/Node;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/w3c/dom/Node", "getFirstChild", "()Lorg/w3c/dom/Node;", true);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "addDetail", "()Ljavax/xml/soap/Detail;", true);
methodVisitor.visitInsn(POP);
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/cxf/jaxws/handler/HandlerChainInvoker", "javax/xml/ws/handler/MessageContext", "java/lang/Exception", "org/apache/cxf/message/Message", "javax/xml/soap/SOAPMessage", "org/apache/cxf/binding/soap/SoapVersion", "javax/xml/soap/SOAPBody", "javax/xml/soap/SOAPFault", "javax/xml/ws/soap/SOAPFaultException", "org/w3c/dom/Node"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitJumpInsn(IFNULL, label5);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "getDetail", "()Ljavax/xml/soap/Detail;", true);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/Detail", "appendChild", "(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPFault", "setFaultString", "(Ljava/lang/String;)V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/cxf/jaxws/handler/HandlerChainInvoker", "javax/xml/ws/handler/MessageContext", "java/lang/Exception", "org/apache/cxf/message/Message"}, 0, new Object[] {});
Label label10 = new Label();
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "invokeReversedHandleFault", "(Ljavax/xml/ws/handler/MessageContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalMessageContext", "Ljavax/xml/ws/handler/LogicalMessageContext;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/LogicalHandler", "handleFault", "(Ljavax/xml/ws/handler/MessageContext;)Z", true);
methodVisitor.visitVarInsn(ISTORE, 2);
Label label5 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalMessageContext", "Ljavax/xml/ws/handler/LogicalMessageContext;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/Handler", "close", "(Ljavax/xml/ws/handler/MessageContext;)V", true);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/ws/handler/Handler"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "invokeThisHandler", "(Ljavax/xml/ws/handler/Handler;)Z", "(Ljavax/xml/ws/handler/Handler<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ISTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "isTheLastInvokedHandler", "(Ljavax/xml/ws/handler/Handler;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isTheLastInvokedHandler", "(Ljavax/xml/ws/handler/Handler;)Z", "(Ljavax/xml/ws/handler/Handler<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokedHandlers", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "markHandlerInvoked", "(Ljavax/xml/ws/handler/Handler;)V", "(Ljavax/xml/ws/handler/Handler<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokedHandlers", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "changeMessageDirection", "(Ljavax/xml/ws/handler/MessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "outbound", "Z");
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/jaxws/handler/HandlerChainInvoker", "javax/xml/ws/handler/MessageContext"}, 2, new Object[] {"org/apache/cxf/jaxws/handler/HandlerChainInvoker", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "outbound", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "setMessageOutboundProperty", "(Ljavax/xml/ws/handler/MessageContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "setMessageOutboundProperty", "(Ljavax/xml/ws/handler/MessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/MessageContext", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "logicalMessageContext", "Ljavax/xml/ws/handler/LogicalMessageContext;");
Label label0 = new Label();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "outbound", "Z");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/ws/handler/LogicalMessageContext", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "reverseHandlerChain", "(Ljava/util/List;)Ljava/util/List;", "<T::Ljavax/xml/ws/handler/Handler<*>;>(Ljava/util/List<TT;>;)Ljava/util/List<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
