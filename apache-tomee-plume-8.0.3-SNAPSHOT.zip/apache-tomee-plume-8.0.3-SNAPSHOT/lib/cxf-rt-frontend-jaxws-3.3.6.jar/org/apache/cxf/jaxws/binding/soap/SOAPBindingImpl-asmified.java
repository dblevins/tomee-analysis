...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxws/binding/soap/SOAPBindingImpl", null, "org/apache/cxf/jaxws/binding/AbstractBindingImpl", new String[] { "javax/xml/ws/soap/SOAPBinding" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMessageFactory", "()Ljavax/xml/soap/MessageFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/jaxws/binding/soap/SOAPBindingImpl", "org/apache/cxf/binding/soap/model/SoapBindingInfo"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSOAPFactory", "()Ljavax/xml/soap/SOAPFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
