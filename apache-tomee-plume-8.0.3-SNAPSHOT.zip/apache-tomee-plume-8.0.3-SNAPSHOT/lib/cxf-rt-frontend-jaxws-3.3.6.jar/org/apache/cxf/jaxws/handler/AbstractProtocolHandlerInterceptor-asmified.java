...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Ljakarta/xml/ws/Binding;)V", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxws/handler/AbstractProtocolHandlerInterceptor", "binding", "Ljakarta/xml/ws/Binding;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/handler/AbstractProtocolHandlerInterceptor", "createProtocolMessageContext", "(Lorg/apache/cxf/message/Message;)Ljakarta/xml/ws/handler/MessageContext;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/handler/HandlerChainInvoker", "invokeProtocolHandlers", "(ZLjakarta/xml/ws/handler/MessageContext;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createProtocolMessageContext", "(Lorg/apache/cxf/message/Message;)Ljakarta/xml/ws/handler/MessageContext;", "(TT;)Ljakarta/xml/ws/handler/MessageContext;", null);
methodVisitor.visitCode();
