...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxws/spi/ProviderImpl$1", "Ljava/lang/Object;Ljava/security/PrivilegedExceptionAction<Ljavax/xml/ws/wsaddressing/W3CEndpointReference;>;", "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "run", "()Ljavax/xml/ws/wsaddressing/W3CEndpointReference;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/jaxws/spi/ProviderImpl$1", "javax/xml/bind/Unmarshaller"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxws/spi/ProviderImpl$1", "run", "()Ljavax/xml/ws/wsaddressing/W3CEndpointReference;", false);
methodVisitor.visitInsn(ARETURN);
