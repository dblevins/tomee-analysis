...
classWriter.visit(V1_3, ACC_SUPER, "org/apache/commons/collections/StaticBucketMap$EntrySet", null, "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/StaticBucketMap$EntrySet", "this$0", "Lorg/apache/commons/collections/StaticBucketMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/StaticBucketMap$EntrySet", "this$0", "Lorg/apache/commons/collections/StaticBucketMap;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections/StaticBucketMap$EntryIterator");
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/StaticBucketMap$Node", "equals", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/StaticBucketMap$EntrySet", "<init>", "(Lorg/apache/commons/collections/StaticBucketMap;)V", false);
methodVisitor.visitInsn(RETURN);
