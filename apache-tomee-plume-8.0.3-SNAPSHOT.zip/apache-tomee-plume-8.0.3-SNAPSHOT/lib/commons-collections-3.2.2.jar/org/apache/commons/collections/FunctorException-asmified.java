...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections/FunctorException", null, "java/lang/RuntimeException", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "JDK_SUPPORTS_NESTED", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "rootCause", "Ljava/lang/Throwable;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/FunctorException", "rootCause", "Ljava/lang/Throwable;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/FunctorException", "rootCause", "Ljava/lang/Throwable;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/FunctorException", "printStackTrace", "(Ljava/io/PrintStream;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/FunctorException", "printStackTrace", "(Ljava/io/PrintWriter;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/collections/FunctorException", "JDK_SUPPORTS_NESTED", "Z");
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/collections/FunctorException", "class$java$lang$Throwable", "Ljava/lang/Class;");
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label3);
methodVisitor.visitLdcInsn("java.lang.Throwable");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/collections/FunctorException", "class$", "(Ljava/lang/String;)Ljava/lang/Class;", false);
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/collections/FunctorException", "class$java$lang$Throwable", "Ljava/lang/Class;");
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/commons/collections/FunctorException", "class$java$lang$Throwable", "Ljava/lang/Class;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/collections/FunctorException", "JDK_SUPPORTS_NESTED", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
