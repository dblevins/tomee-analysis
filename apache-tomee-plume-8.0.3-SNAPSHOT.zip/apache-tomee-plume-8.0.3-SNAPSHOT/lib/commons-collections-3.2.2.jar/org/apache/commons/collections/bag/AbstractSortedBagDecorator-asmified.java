...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections/bag/AbstractSortedBagDecorator", null, "org/apache/commons/collections/bag/AbstractBagDecorator", new String[] { "org/apache/commons/collections/SortedBag" });

{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections/bag/AbstractBagDecorator", "<init>", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/AbstractSortedBagDecorator", "getCollection", "()Ljava/util/Collection;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bag/AbstractSortedBagDecorator", "getSortedBag", "()Lorg/apache/commons/collections/SortedBag;", false);
