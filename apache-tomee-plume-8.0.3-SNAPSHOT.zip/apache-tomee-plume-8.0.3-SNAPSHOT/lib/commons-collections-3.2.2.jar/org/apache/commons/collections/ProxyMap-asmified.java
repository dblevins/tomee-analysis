...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT | ACC_DEPRECATED, "org/apache/commons/collections/ProxyMap", null, "java/lang/Object", new String[] { "java/util/Map" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "map", "Ljava/util/Map;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/ProxyMap", "map", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/ProxyMap", "map", "Ljava/util/Map;");
