...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", null, "java/lang/Object", new String[] { "org/apache/commons/collections/OrderedMapIterator", "org/apache/commons/collections/ResettableIterator" });

classWriter.visitInnerClass("java/util/Map$Entry", "java/util/Map", "Entry", ACC_PUBLIC | ACC_STATIC | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "org/apache/commons/collections/bidimap/DualTreeBidiMap", "BidiOrderedMapIterator", ACC_PROTECTED | ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "iterator", "Ljava/util/ListIterator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "last", "Ljava/util/Map$Entry;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "parent", "Lorg/apache/commons/collections/bidimap/AbstractDualBidiMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/AbstractDualBidiMap", "entrySet", "()Ljava/util/Set;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "iterator", "Ljava/util/ListIterator;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "iterator", "Ljava/util/ListIterator;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "last", "Ljava/util/Map$Entry;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "last", "Ljava/util/Map$Entry;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "parent", "Lorg/apache/commons/collections/bidimap/AbstractDualBidiMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "last", "Ljava/util/Map$Entry;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map$Entry", "getKey", "()Ljava/lang/Object;", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/AbstractDualBidiMap", "remove", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "getKey", "()Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/Object;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitLdcInsn("=");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections/bidimap/DualTreeBidiMap$BidiOrderedMapIterator", "getValue", "()Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/Object;)Ljava/lang/StringBuffer;", false);
methodVisitor.visitLdcInsn("]");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuffer", "append", "(Ljava/lang/String;)Ljava/lang/StringBuffer;", false);
