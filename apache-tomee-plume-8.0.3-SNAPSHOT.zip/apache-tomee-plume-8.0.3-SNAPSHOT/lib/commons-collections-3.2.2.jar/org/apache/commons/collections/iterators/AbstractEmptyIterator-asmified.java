...
public class AbstractEmptyIteratorDump implements Opcodes {
...
classWriter.visit(V1_3, ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections/iterators/AbstractEmptyIterator", null, "java/lang/Object", null);
...
methodVisitor.visitLdcInsn("Iterator contains no elements");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("add() not supported for empty Iterator");
