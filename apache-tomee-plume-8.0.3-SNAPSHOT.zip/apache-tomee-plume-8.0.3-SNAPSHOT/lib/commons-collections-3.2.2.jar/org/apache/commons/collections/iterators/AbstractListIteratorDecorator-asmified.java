...
classWriter.visit(V1_3, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/collections/iterators/AbstractListIteratorDecorator", null, "java/lang/Object", new String[] { "java/util/ListIterator" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "iterator", "Ljava/util/ListIterator;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections/iterators/AbstractListIteratorDecorator", "iterator", "Ljava/util/ListIterator;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getListIterator", "()Ljava/util/ListIterator;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections/iterators/AbstractListIteratorDecorator", "iterator", "Ljava/util/ListIterator;");
