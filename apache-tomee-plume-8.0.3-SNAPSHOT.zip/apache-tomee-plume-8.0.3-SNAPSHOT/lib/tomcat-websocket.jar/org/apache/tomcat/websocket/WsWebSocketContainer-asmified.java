...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/websocket/WsWebSocketContainer", null, "java/lang/Object", new String[] { "javax/websocket/WebSocketContainer", "org/apache/tomcat/websocket/BackgroundProcess" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "connectToServer", "(Ljava/lang/Object;Ljava/net/URI;)Ljavax/websocket/Session;", null, new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/websocket/ClientEndpoint;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/websocket/ClientEndpoint");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/websocket/ClientEndpoint"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "org/apache/tomcat/websocket/pojo/PojoEndpointClient");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpoint", "decoders", "()[Ljava/lang/Class;", true);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpoint", "configurator", "()Ljava/lang/Class;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/websocket/ClientEndpointConfig$Configurator;"));
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/websocket/ClientEndpointConfig$Configurator");
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label1);
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/tomcat/websocket/WsWebSocketContainer", "java/lang/Object", "java/net/URI", "javax/websocket/ClientEndpoint", "javax/websocket/Endpoint", "java/lang/Class", "javax/websocket/ClientEndpointConfig$Configurator"}, 1, new Object[] {"java/lang/ReflectiveOperationException"});
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/websocket/ClientEndpointConfig$Builder", "create", "()Ljavax/websocket/ClientEndpointConfig$Builder;", false);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Builder", "configurator", "(Ljavax/websocket/ClientEndpointConfig$Configurator;)Ljavax/websocket/ClientEndpointConfig$Builder;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/websocket/ClientEndpointConfig$Builder"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpoint", "decoders", "()[Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Builder", "decoders", "(Ljava/util/List;)Ljavax/websocket/ClientEndpointConfig$Builder;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpoint", "encoders", "()[Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Builder", "encoders", "(Ljava/util/List;)Ljavax/websocket/ClientEndpointConfig$Builder;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpoint", "subprotocols", "()[Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Builder", "preferredSubprotocols", "(Ljava/util/List;)Ljavax/websocket/ClientEndpointConfig$Builder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Builder", "build", "()Ljavax/websocket/ClientEndpointConfig;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/WsWebSocketContainer", "connectToServer", "(Ljavax/websocket/Endpoint;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;)Ljavax/websocket/Session;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(8, 9);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "connectToServer", "(Ljava/lang/Class;Ljava/net/URI;)Ljavax/websocket/Session;", "(Ljava/lang/Class<*>;Ljava/net/URI;)Ljavax/websocket/Session;", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/WsWebSocketContainer", "connectToServer", "(Ljava/lang/Object;Ljava/net/URI;)Ljavax/websocket/Session;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(8, 5);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "connectToServer", "(Ljava/lang/Class;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;)Ljavax/websocket/Session;", "(Ljava/lang/Class<+Ljavax/websocket/Endpoint;>;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;)Ljavax/websocket/Session;", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Constructor", "newInstance", "([Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/websocket/Endpoint");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/websocket/Endpoint"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "connectToServer", "(Ljavax/websocket/Endpoint;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;)Ljavax/websocket/Session;", null, new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/WsWebSocketContainer", "connectToServerRecursive", "(Ljavax/websocket/Endpoint;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;Ljava/util/Set;)Ljavax/websocket/Session;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(6, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "connectToServerRecursive", "(Ljavax/websocket/Endpoint;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;Ljava/util/Set;)Ljavax/websocket/Session;", "(Ljavax/websocket/Endpoint;Ljavax/websocket/ClientEndpointConfig;Ljava/net/URI;Ljava/util/Set<Ljava/net/URI;>;)Ljavax/websocket/Session;", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/tomcat/websocket/WsWebSocketContainer", "javax/websocket/Endpoint", "javax/websocket/ClientEndpointConfig", "java/net/URI", "java/util/Set", Opcodes.INTEGER, "java/nio/ByteBuffer", Opcodes.TOP, "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/tomcat/websocket/WsWebSocketContainer", "javax/websocket/Endpoint", "javax/websocket/ClientEndpointConfig", "java/net/URI", "java/util/Set", Opcodes.INTEGER, "java/nio/ByteBuffer", "java/net/URI", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/apache/tomcat/websocket/WsWebSocketContainer", "javax/websocket/Endpoint", "javax/websocket/ClientEndpointConfig", "java/net/URI", "java/util/Set", Opcodes.INTEGER, "java/nio/ByteBuffer", "java/net/URI", "java/lang/String", "java/lang/String", Opcodes.INTEGER, "java/net/SocketAddress", "java/util/List", "java/net/Proxy", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/websocket/WsWebSocketContainer", "createRequestHeaders", "(Ljava/lang/String;IZLjavax/websocket/ClientEndpointConfig;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpointConfig", "getConfigurator", "()Ljavax/websocket/ClientEndpointConfig$Configurator;", true);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Configurator", "beforeRequest", "(Ljava/util/Map;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpointConfig", "getUserProperties", "()Ljava/util/Map;", true);
methodVisitor.visitVarInsn(ASTORE, 17);
...
methodVisitor.visitVarInsn(ALOAD, 29);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/WsWebSocketContainer$HttpResponse", "getHandshakeResponse", "()Ljavax/websocket/HandshakeResponse;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/HandshakeResponse", "getHeaders", "()Ljava/util/Map;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/websocket/Session"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpointConfig", "getConfigurator", "()Ljavax/websocket/ClientEndpointConfig$Configurator;", true);
methodVisitor.visitVarInsn(ALOAD, 32);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/websocket/ClientEndpointConfig$Configurator", "afterResponse", "(Ljavax/websocket/HandshakeResponse;)V", false);
methodVisitor.visitVarInsn(ALOAD, 32);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/HandshakeResponse", "getHeaders", "()Ljava/util/Map;", true);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/websocket/HandshakeResponse", "java/util/List"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/websocket/Extension", "java/util/List", "org/apache/tomcat/websocket/Transformation"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(0, "getOpenSessions", "(Ljava/lang/Object;)Ljava/util/Set;", "(Ljava/lang/Object;)Ljava/util/Set<Ljavax/websocket/Session;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createRequestHeaders", "(Ljava/lang/String;IZLjavax/websocket/ClientEndpointConfig;)Ljava/util/Map;", "(Ljava/lang/String;IZLjavax/websocket/ClientEndpointConfig;)Ljava/util/Map<Ljava/lang/String;Ljava/util/List<Ljava/lang/String;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/HashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashMap", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpointConfig", "getExtensions", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpointConfig", "getPreferredSubprotocols", "()Ljava/util/List;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/websocket/ClientEndpointConfig", "getUserProperties", "()Ljava/util/Map;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"java/lang/String", Opcodes.INTEGER, Opcodes.INTEGER, "javax/websocket/ClientEndpointConfig", "java/util/Map", "java/util/List", "java/util/List", "java/util/Map"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "(I)V", false);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"java/lang/String", Opcodes.INTEGER, Opcodes.INTEGER, "javax/websocket/ClientEndpointConfig", "java/util/Map", "java/util/List", "java/util/List", "java/util/Map", "java/util/List", "java/util/List", "java/util/List", "java/util/List", "java/util/List"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
Label label6 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "generateExtensionHeaders", "(Ljava/util/List;)Ljava/util/List;", "(Ljava/util/List<Ljavax/websocket/Extension;>;)Ljava/util/List<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/websocket/Extension", "java/lang/StringBuilder", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/WsWebSocketContainer$HttpResponse", "<init>", "(ILjavax/websocket/HandshakeResponse;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(6, 12);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseStatus", "(Ljava/lang/String;)I", null, new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createSSLEngine", "(Ljava/util/Map;Ljava/lang/String;I)Ljavax/net/ssl/SSLEngine;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Ljava/lang/String;I)Ljavax/net/ssl/SSLEngine;", new String[] { "javax/websocket/DeploymentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInstalledExtensions", "()Ljava/util/Set;", "()Ljava/util/Set<Ljavax/websocket/Extension;>;", null);
methodVisitor.visitCode();
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/websocket/CloseReason", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label8 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label8);
...
methodVisitor.visitJumpInsn(GOTO, label9);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/tomcat/websocket/WsWebSocketContainer", "javax/websocket/CloseReason", "java/util/Iterator", "org/apache/tomcat/websocket/WsSession"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/websocket/WsWebSocketContainer", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomcat/websocket/WsWebSocketContainer", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
