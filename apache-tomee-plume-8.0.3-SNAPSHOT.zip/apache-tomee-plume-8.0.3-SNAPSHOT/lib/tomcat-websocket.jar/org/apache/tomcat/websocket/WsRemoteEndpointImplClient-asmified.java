...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/tomcat/websocket/WsRemoteEndpointImplClient", "jakarta/websocket/SendHandler", Opcodes.LONG, "[Ljava/nio/ByteBuffer;", Opcodes.TOP, Opcodes.TOP, "[Ljava/nio/ByteBuffer;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/tomcat/websocket/WsRemoteEndpointImplClient", "jakarta/websocket/SendHandler", Opcodes.LONG, "[Ljava/nio/ByteBuffer;", Opcodes.LONG, "[Ljava/nio/ByteBuffer;", Opcodes.INTEGER, Opcodes.INTEGER, "java/nio/ByteBuffer"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/tomcat/websocket/WsRemoteEndpointImplClient", "jakarta/websocket/SendHandler", Opcodes.LONG, "[Ljava/nio/ByteBuffer;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomcat/websocket/WsRemoteEndpointImplClient", "SENDRESULT_OK", "Ljakarta/websocket/SendResult;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/websocket/SendHandler", "onResult", "(Ljakarta/websocket/SendResult;)V", true);
methodVisitor.visitInsn(RETURN);
