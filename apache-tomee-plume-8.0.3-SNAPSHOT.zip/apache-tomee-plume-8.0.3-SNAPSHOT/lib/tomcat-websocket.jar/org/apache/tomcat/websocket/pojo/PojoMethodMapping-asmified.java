...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Class;Ljava/util/List;Ljava/lang/String;)V", "(Ljava/lang/Class<*>;Ljava/util/List<Ljava/lang/Class<+Ljakarta/websocket/Decoder;>;>;Ljava/lang/String;)V", new String[] { "jakarta/websocket/DeploymentException" });
...
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/websocket/OnOpen;"));
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/websocket/OnClose;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Method", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 14);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/websocket/OnError;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/reflect/Method", "getAnnotation", "(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "checkPublic", "(Ljava/lang/reflect/Method;)V", null, new String[] { "jakarta/websocket/DeploymentException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOnOpenArgs", "(Ljava/util/Map;Ljakarta/websocket/Session;Ljakarta/websocket/EndpointConfig;)[Ljava/lang/Object;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljakarta/websocket/Session;Ljakarta/websocket/EndpointConfig;)[Ljava/lang/Object;", new String[] { "jakarta/websocket/DecodeException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/websocket/pojo/PojoMethodMapping", "buildArgs", "([Lorg/apache/tomcat/websocket/pojo/PojoPathParam;Ljava/util/Map;Ljakarta/websocket/Session;Ljakarta/websocket/EndpointConfig;Ljava/lang/Throwable;Ljakarta/websocket/CloseReason;)[Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOnCloseArgs", "(Ljava/util/Map;Ljakarta/websocket/Session;Ljakarta/websocket/CloseReason;)[Ljava/lang/Object;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljakarta/websocket/Session;Ljakarta/websocket/CloseReason;)[Ljava/lang/Object;", new String[] { "jakarta/websocket/DecodeException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOnErrorArgs", "(Ljava/util/Map;Ljakarta/websocket/Session;Ljava/lang/Throwable;)[Ljava/lang/Object;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljakarta/websocket/Session;Ljava/lang/Throwable;)[Ljava/lang/Object;", new String[] { "jakarta/websocket/DecodeException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/websocket/pojo/PojoMethodMapping$MessageHandlerInfo", "getMessageHandlers", "(Ljava/lang/Object;Ljava/util/Map;Ljakarta/websocket/Session;Ljakarta/websocket/EndpointConfig;)Ljava/util/Set;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getPathParams", "(Ljava/lang/reflect/Method;Lorg/apache/tomcat/websocket/pojo/PojoMethodMapping$MethodType;)[Lorg/apache/tomcat/websocket/pojo/PojoPathParam;", null, new String[] { "jakarta/websocket/DeploymentException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/websocket/EndpointConfig;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "equals", "(Ljava/lang/Object;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 6);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/websocket/CloseReason;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "equals", "(Ljava/lang/Object;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "buildArgs", "([Lorg/apache/tomcat/websocket/pojo/PojoPathParam;Ljava/util/Map;Ljakarta/websocket/Session;Ljakarta/websocket/EndpointConfig;Ljava/lang/Throwable;Ljakarta/websocket/CloseReason;)[Ljava/lang/Object;", "([Lorg/apache/tomcat/websocket/pojo/PojoPathParam;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljakarta/websocket/Session;Ljakarta/websocket/EndpointConfig;Ljava/lang/Throwable;Ljakarta/websocket/CloseReason;)[Ljava/lang/Object;", new String[] { "jakarta/websocket/DecodeException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"[Lorg/apache/tomcat/websocket/pojo/PojoPathParam;", "java/util/Map", "jakarta/websocket/Session", "jakarta/websocket/EndpointConfig", "java/lang/Throwable", "jakarta/websocket/CloseReason", "[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Class", "java/lang/String", "java/lang/String"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 11);
