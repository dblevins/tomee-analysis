...
public class WsExtensionDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/websocket/WsExtension", "parameters", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/websocket/WsExtension", "name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/websocket/WsExtension", "name", "Ljava/lang/String;");
