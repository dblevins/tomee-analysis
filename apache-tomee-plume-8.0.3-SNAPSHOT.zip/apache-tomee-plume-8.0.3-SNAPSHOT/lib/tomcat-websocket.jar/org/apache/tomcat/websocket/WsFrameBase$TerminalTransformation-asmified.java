...
public class WsFrameBase$TerminalTransformationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "org/apache/tomcat/websocket/WsFrameBase$TerminalTransformation", null, "java/lang/Object", new String[] { "org/apache/tomcat/websocket/Transformation" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/websocket/WsFrameBase$TerminalTransformation", "this$0", "Lorg/apache/tomcat/websocket/WsFrameBase;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/websocket/WsFrameBase$TerminalTransformation", "<init>", "(Lorg/apache/tomcat/websocket/WsFrameBase;)V", false);
methodVisitor.visitInsn(RETURN);
