...
public class WsSession$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/websocket/WsSession$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/websocket/WsSession", null, null);

classWriter.visitInnerClass("org/apache/tomcat/websocket/WsSession$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$websocket$MessageHandlerResultType", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/websocket/MessageHandlerResultType", "values", "()[Lorg/apache/tomcat/websocket/MessageHandlerResultType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/websocket/WsSession$1", "$SwitchMap$org$apache$tomcat$websocket$MessageHandlerResultType", "[I");
