...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/servlet/ServletRegistration$Dynamic", null, "java/lang/Object", new String[] { "javax/servlet/ServletRegistration", "javax/servlet/Registration$Dynamic" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setServletSecurity", "(Ljavax/servlet/ServletSecurityElement;)Ljava/util/Set;", "(Ljavax/servlet/ServletSecurityElement;)Ljava/util/Set<Ljava/lang/String;>;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "setMultipartConfig", "(Ljavax/servlet/MultipartConfigElement;)V", null, null);
methodVisitor.visitEnd();
}
{
