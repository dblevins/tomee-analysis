...
classWriter.visit(V1_8, ACC_SUPER, "javax/servlet/http/CookieNameValidator", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/servlet/http/CookieNameValidator", "allowed", "Ljava/util/BitSet;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/http/CookieNameValidator", "allowed", "Ljava/util/BitSet;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/servlet/http/CookieNameValidator", "java/lang/String", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/servlet/http/CookieNameValidator", "lStrings", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/http/CookieNameValidator", "isToken", "(Ljava/lang/String;)Z", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/servlet/http/CookieNameValidator", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
