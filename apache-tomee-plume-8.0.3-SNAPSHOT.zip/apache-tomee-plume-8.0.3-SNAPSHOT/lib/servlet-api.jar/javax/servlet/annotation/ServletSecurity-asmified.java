...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/servlet/annotation/ServletSecurity", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "value", "()Ljavax/servlet/annotation/HttpConstraint;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
AnnotationVisitor annotationVisitor1 = annotationVisitor0.visitAnnotation(null, "Ljavax/servlet/annotation/HttpConstraint;");
annotationVisitor1.visitEnd();
}
annotationVisitor0.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "httpMethodConstraints", "()[Ljavax/servlet/annotation/HttpMethodConstraint;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
{
