...
public class NoBodyOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/servlet/http/NoBodyOutputStream", null, "jakarta/servlet/ServletOutputStream", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/http/NoBodyOutputStream", "flushed", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/http/NoBodyOutputStream", "contentLength", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/http/NoBodyOutputStream", "response", "Ljakarta/servlet/http/HttpServletResponse;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "getContentLength", "()I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/http/NoBodyOutputStream", "contentLength", "I");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/http/NoBodyOutputStream", "contentLength", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/servlet/http/NoBodyOutputStream", "checkCommit", "()V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/http/NoBodyOutputStream", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitLdcInsn("err.io.nullArray");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/http/NoBodyOutputStream", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitLdcInsn("err.io.indexOutOfBounds");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ResourceBundle", "getString", "(Ljava/lang/String;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "checkCommit", "()V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/http/NoBodyOutputStream", "flushed", "Z");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/http/NoBodyOutputStream", "contentLength", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/http/NoBodyOutputStream", "response", "Ljakarta/servlet/http/HttpServletResponse;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/servlet/http/NoBodyOutputStream", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
