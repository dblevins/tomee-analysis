...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/servlet/HttpMethodConstraintElement", null, "jakarta/servlet/HttpConstraintElement", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/servlet/HttpMethodConstraintElement", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/HttpMethodConstraintElement", "lStrings", "Ljava/util/ResourceBundle;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/HttpMethodConstraintElement", "methodName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;Ljakarta/servlet/HttpConstraintElement;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/servlet/HttpMethodConstraintElement", "java/lang/String", "jakarta/servlet/HttpConstraintElement"}, 0, new Object[] {});
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalArgumentException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/servlet/HttpMethodConstraintElement", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitLdcInsn("httpMethodConstraintElement.invalidMethod");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/HttpMethodConstraintElement", "methodName", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/servlet/HttpMethodConstraintElement", "lStrings", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
