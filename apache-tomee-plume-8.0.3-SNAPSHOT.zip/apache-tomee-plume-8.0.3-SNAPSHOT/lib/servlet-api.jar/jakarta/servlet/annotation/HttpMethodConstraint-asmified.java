...
public class HttpMethodConstraintDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/servlet/annotation/HttpMethodConstraint", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "emptyRoleSemantic", "()Ljakarta/servlet/annotation/ServletSecurity$EmptyRoleSemantic;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljakarta/servlet/annotation/ServletSecurity$EmptyRoleSemantic;", "PERMIT");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "transportGuarantee", "()Ljakarta/servlet/annotation/ServletSecurity$TransportGuarantee;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljakarta/servlet/annotation/ServletSecurity$TransportGuarantee;", "NONE");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
