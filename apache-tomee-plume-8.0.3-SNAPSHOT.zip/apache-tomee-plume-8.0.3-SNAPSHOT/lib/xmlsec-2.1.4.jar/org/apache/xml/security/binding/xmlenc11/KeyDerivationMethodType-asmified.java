...
public class KeyDerivationMethodTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/binding/xmlenc11/KeyDerivationMethodType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "KeyDerivationMethodType");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmlenc11/KeyDerivationMethodType", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmlenc11/KeyDerivationMethodType", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/binding/xmlenc11/KeyDerivationMethodType", "algorithm", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/binding/xmlenc11/KeyDerivationMethodType", "algorithm", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
