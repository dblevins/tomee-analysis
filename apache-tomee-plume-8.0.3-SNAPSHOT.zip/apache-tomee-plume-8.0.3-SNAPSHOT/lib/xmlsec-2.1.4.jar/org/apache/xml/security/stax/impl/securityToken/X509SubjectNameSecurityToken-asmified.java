...
public class X509SubjectNameSecurityTokenDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/xml/security/stax/impl/securityToken/X509SubjectNameSecurityToken", null, "org/apache/xml/security/stax/impl/securityToken/X509SecurityToken", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "subjectName", "Ljava/lang/String;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xml/security/stax/impl/securityToken/X509SubjectNameSecurityToken", "subjectName", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xml/security/stax/impl/securityToken/X509SubjectNameSecurityToken", "subjectName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
