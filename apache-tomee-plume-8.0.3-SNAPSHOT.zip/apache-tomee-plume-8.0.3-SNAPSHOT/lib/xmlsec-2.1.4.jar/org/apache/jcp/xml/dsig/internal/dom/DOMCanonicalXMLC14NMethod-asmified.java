...
public class DOMCanonicalXMLC14NMethodDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/jcp/xml/dsig/internal/dom/DOMCanonicalXMLC14NMethod", null, "org/apache/jcp/xml/dsig/internal/dom/ApacheCanonicalizer", null);
...
methodVisitor.visitLdcInsn("no parameters should be specified for Canonical XML C14N algorithm");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/jcp/xml/dsig/internal/dom/DOMCanonicalXMLC14NMethod", "apacheCanonicalizer", "Lorg/apache/xml/security/c14n/Canonicalizer;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/jcp/xml/dsig/internal/dom/DOMCanonicalXMLC14NMethod", "apacheCanonicalizer", "Lorg/apache/xml/security/c14n/Canonicalizer;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/jcp/xml/dsig/internal/dom/DOMCanonicalXMLC14NMethod", "javax/xml/crypto/Data", "javax/xml/crypto/XMLCryptoContext", "org/apache/jcp/xml/dsig/internal/dom/DOMSubTreeData"}, 1, new Object[] {"org/apache/xml/security/c14n/InvalidCanonicalizerException"});
...
methodVisitor.visitLdcInsn("Couldn't find Canonicalizer for: http://www.w3.org/TR/2001/REC-xml-c14n-20010315: ");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/jcp/xml/dsig/internal/dom/DOMCanonicalXMLC14NMethod", "canonicalize", "(Ljavax/xml/crypto/Data;Ljavax/xml/crypto/XMLCryptoContext;)Ljavax/xml/crypto/Data;", false);
