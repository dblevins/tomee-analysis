...
public class BindingTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/wsdl/http/BindingType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "bindingType");
...
annotationVisitor0.visit("name", "verb");
...
annotationVisitor0.visit("name", "NMTOKEN");
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/wsdl/http/BindingType", "otherAttributes", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl/http/BindingType", "verb", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/wsdl/http/BindingType", "verb", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/wsdl/http/BindingType", "otherAttributes", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
