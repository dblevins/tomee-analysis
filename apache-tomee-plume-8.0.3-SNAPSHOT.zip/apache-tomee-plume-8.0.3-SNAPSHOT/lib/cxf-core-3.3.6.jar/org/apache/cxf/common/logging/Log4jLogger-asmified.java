...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/common/logging/Log4jLogger", null, "org/apache/cxf/common/logging/AbstractDelegatingLogger", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/logging/Log4jLogger", "log", "Lorg/apache/log4j/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger", "log", "Lorg/apache/log4j/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/common/logging/Log4jLogger", "fromL4J", "(Lorg/apache/log4j/Level;)Ljava/util/logging/Level;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger", "log", "Lorg/apache/log4j/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/logging/Log4jLogger", "TO_LOG4J", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/common/logging/Log4jLogger", "log", "Lorg/apache/log4j/Logger;");
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "<init>", "(Lorg/apache/cxf/common/logging/Log4jLogger;Ljava/util/logging/Handler;)V", false);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/common/logging/Log4jLogger$HandlerWrapper", "getHandler", "()Ljava/util/logging/Handler;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/log4j/Level", "toInt", "()I", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/logging/Log4jLogger", "TRACE", "Lorg/apache/log4j/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/log4j/Level", "toInt", "()I", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getFullInfoForLogUtils", "(Ljava/util/logging/LogRecord;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/cxf/common/logging/Log4jLogger;Lorg/apache/log4j/Level;)Ljava/util/logging/Level;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/common/logging/Log4jLogger", "fromL4J", "(Lorg/apache/log4j/Level;)Ljava/util/logging/Level;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Ljava/util/logging/LogRecord;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/cxf/common/logging/Log4jLogger", "getFullInfoForLogUtils", "(Ljava/util/logging/LogRecord;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$200", "()Ljava/util/Map;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/logging/Log4jLogger", "TO_LOG4J", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/common/logging/Log4jLogger", "TO_LOG4J", "Ljava/util/Map;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/common/logging/Log4jLogger", "TRACE", "Lorg/apache/log4j/Level;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/cxf/common/logging/Log4jLogger", "TO_LOG4J", "Ljava/util/Map;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "ALL", "Ljava/util/logging/Level;");
