...
public class Compiler$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/cxf/common/util/Compiler$2", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/cxf/common/util/Compiler", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$javax$tools$Diagnostic$Kind", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/cxf/common/util/Compiler$2", "$SwitchMap$javax$tools$Diagnostic$Kind", "[I");
