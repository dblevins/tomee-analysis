...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/xml/bind/JAXBContext;Lorg/apache/cxf/common/xmlschema/SchemaCollection;Ljava/lang/String;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/common/jaxb/SchemaCollectionContextProxy", "context", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
