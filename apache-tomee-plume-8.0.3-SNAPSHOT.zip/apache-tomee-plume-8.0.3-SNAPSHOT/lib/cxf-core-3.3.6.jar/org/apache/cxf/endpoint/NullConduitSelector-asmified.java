...
public class NullConduitSelectorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/endpoint/NullConduitSelector", null, "java/lang/Object", new String[] { "org/apache/cxf/endpoint/ConduitSelector" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/endpoint/NullConduitSelector", "endpoint", "Lorg/apache/cxf/endpoint/Endpoint;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/endpoint/NullConduitSelector", "endpoint", "Lorg/apache/cxf/endpoint/Endpoint;");
methodVisitor.visitInsn(RETURN);
