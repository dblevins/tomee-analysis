...
public class ClassLoaderResolverDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/resource/ClassLoaderResolver", null, "java/lang/Object", new String[] { "org/apache/cxf/resource/ResourceResolver" });
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/cxf/resource/ClassLoaderResolver;"));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/resource/ClassLoaderResolver", "loader", "Ljava/lang/ClassLoader;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/resource/ClassLoaderResolver", "loader", "Ljava/lang/ClassLoader;");
methodVisitor.visitVarInsn(ALOAD, 1);
