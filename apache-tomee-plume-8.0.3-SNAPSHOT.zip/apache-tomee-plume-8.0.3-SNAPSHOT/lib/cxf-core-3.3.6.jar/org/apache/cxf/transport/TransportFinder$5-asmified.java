...
public class TransportFinder$5Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/transport/TransportFinder$5", "Ljava/lang/Object;Lorg/apache/cxf/configuration/ConfiguredBeanLocator$BeanLoaderListener<TT;>;", "java/lang/Object", new String[] { "org/apache/cxf/configuration/ConfiguredBeanLocator$BeanLoaderListener" });

classWriter.visitOuterClass("org/apache/cxf/transport/TransportFinder", "loadNoDefaultNamespace", "(Ljava/lang/String;)Ljava/lang/Object;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/transport/TransportFinder$5", "this$0", "Lorg/apache/cxf/transport/TransportFinder;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/transport/TransportFinder$5", "val$namespace", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/TransportFinder$5", "this$0", "Lorg/apache/cxf/transport/TransportFinder;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/transport/TransportFinder$5", "val$namespace", "Ljava/lang/String;");
