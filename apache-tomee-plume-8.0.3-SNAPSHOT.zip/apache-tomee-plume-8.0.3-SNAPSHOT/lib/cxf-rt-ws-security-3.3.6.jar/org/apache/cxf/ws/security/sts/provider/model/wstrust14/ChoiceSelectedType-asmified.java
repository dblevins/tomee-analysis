...
public class ChoiceSelectedTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/ChoiceSelectedType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "ChoiceSelectedType");
annotationVisitor0.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/ChoiceSelectedType", "refId", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/ChoiceSelectedType", "refId", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
