...
public class ActAsTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/ActAsType", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "ActAsType");
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/ActAsType", "any", "Ljava/lang/Object;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/sts/provider/model/wstrust14/ActAsType", "any", "Ljava/lang/Object;");
methodVisitor.visitInsn(RETURN);
