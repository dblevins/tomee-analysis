...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/cxf/ws/security/wss4j/policyhandlers/StaxAsymmetricBindingHandler", "org/apache/wss4j/policy/model/AbstractTokenWrapper", "org/apache/wss4j/policy/model/AbstractToken", "org/apache/wss4j/policy/model/AbstractTokenWrapper", "java/util/List", "java/util/List"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/interceptor/Fault");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
