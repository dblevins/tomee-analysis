...
public class STSStaxTokenValidator$STSStaxBSTValidator$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", null, "org/apache/wss4j/stax/impl/securityToken/X509PKIPathv1SecurityTokenImpl", null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator;Lorg/apache/wss4j/stax/ext/WSInboundSecurityContext;Lorg/apache/wss4j/common/crypto/Crypto;Ljavax/security/auth/callback/CallbackHandler;[BLjava/lang/String;Lorg/apache/xml/security/stax/securityToken/SecurityTokenConstants$KeyIdentifier;Lorg/apache/wss4j/stax/ext/WSSSecurityProperties;ZLorg/apache/wss4j/binding/wss10/BinarySecurityTokenType;[BLorg/apache/cxf/binding/soap/SoapMessage;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "this$0", "Lorg/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 9);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$stsValidated", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$binarySecurityTokenType", "Lorg/apache/wss4j/binding/wss10/BinarySecurityTokenType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$bytes", "[B");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$message", "Lorg/apache/cxf/binding/soap/SoapMessage;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$stsValidated", "Z");
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/wss4j/stax/impl/securityToken/X509PKIPathv1SecurityTokenImpl", "verify", "()V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "this$0", "Lorg/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$binarySecurityTokenType", "Lorg/apache/wss4j/binding/wss10/BinarySecurityTokenType;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$bytes", "[B");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/security/trust/STSStaxTokenValidator$STSStaxBSTValidator$2", "val$message", "Lorg/apache/cxf/binding/soap/SoapMessage;");
