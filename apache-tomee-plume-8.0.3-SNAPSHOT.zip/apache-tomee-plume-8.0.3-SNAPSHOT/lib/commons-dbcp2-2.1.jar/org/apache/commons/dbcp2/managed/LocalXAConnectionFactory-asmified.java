...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory", null, "java/lang/Object", new String[] { "org/apache/commons/dbcp2/managed/XAConnectionFactory" });

classWriter.visitInnerClass("org/apache/commons/dbcp2/managed/LocalXAConnectionFactory$LocalXAResource", "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory", "LocalXAResource", ACC_PROTECTED | ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "connectionFactory", "Lorg/apache/commons/dbcp2/ConnectionFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory", "connectionFactory", "Lorg/apache/commons/dbcp2/ConnectionFactory;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory", "transactionRegistry", "Lorg/apache/commons/dbcp2/managed/TransactionRegistry;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory", "connectionFactory", "Lorg/apache/commons/dbcp2/ConnectionFactory;");
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory$LocalXAResource");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/dbcp2/managed/LocalXAConnectionFactory$LocalXAResource", "<init>", "(Ljava/sql/Connection;)V", false);
