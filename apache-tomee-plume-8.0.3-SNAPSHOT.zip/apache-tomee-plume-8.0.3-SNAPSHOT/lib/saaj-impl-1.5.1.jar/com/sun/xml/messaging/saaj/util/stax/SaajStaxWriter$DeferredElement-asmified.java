...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "flushTo", "(Ljakarta/xml/soap/SOAPElement;)Ljakarta/xml/soap/SOAPElement;", null, new String[] { "javax/xml/stream/XMLStreamException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/messaging/saaj/util/stax/SaajStaxWriter$DeferredElement", "localName", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/soap/SOAPElement", "addChildElement", "(Ljava/lang/String;)Ljakarta/xml/soap/SOAPElement;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/soap/SOAPElement", "addChildElement", "(Ljavax/xml/namespace/QName;)Ljakarta/xml/soap/SOAPElement;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitJumpInsn(GOTO, label6);
