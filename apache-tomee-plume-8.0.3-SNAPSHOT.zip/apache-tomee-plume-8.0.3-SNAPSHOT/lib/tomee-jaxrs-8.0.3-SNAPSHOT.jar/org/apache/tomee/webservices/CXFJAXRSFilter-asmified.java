...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/webservices/CXFJAXRSFilter", null, "java/lang/Object", new String[] { "javax/servlet/Filter" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/rs/CxfRsHttpListener", "isCXFResource", "(Ljavax/servlet/http/HttpServletRequest;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/webservices/CXFJAXRSFilter", "servletMappingIsUnderRestPath", "(Ljavax/servlet/http/HttpServletRequest;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "servletMappingIsUnderRestPath", "(Ljavax/servlet/http/HttpServletRequest;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomee/webservices/CXFJAXRSFilter", "unwrap", "(Ljavax/servlet/http/HttpServletRequest;)Ljavax/servlet/http/HttpServletRequest;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/tomee/webservices/CXFJAXRSFilter", "javax/servlet/http/HttpServletRequest", "javax/servlet/http/HttpServletRequest", "org/apache/catalina/connector/Request", "org/apache/catalina/Wrapper", "java/lang/Boolean", "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "unwrap", "(Ljavax/servlet/http/HttpServletRequest;)Ljavax/servlet/http/HttpServletRequest;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label0 = new Label();
