...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/wss4j/binding/wss10/SecurityHeaderType", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/binding/wss10/SecurityHeaderType", "otherAttributes", "Ljava/util/Map;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/binding/wss10/SecurityHeaderType", "any", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/binding/wss10/SecurityHeaderType", "any", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/binding/wss10/SecurityHeaderType", "otherAttributes", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
