...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/persistence/Tuple", null, "java/lang/Object", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "get", "(Ljakarta/persistence/TupleElement;)Ljava/lang/Object;", "<X:Ljava/lang/Object;>(Ljakarta/persistence/TupleElement<TX;>;)TX;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getElements", "()Ljava/util/List;", "()Ljava/util/List<Ljakarta/persistence/TupleElement<*>;>;", null);
methodVisitor.visitEnd();
}
