...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/persistence/NamedQuery", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });

{
annotationVisitor0 = classWriter.visitAnnotation("Ljava/lang/annotation/Repeatable;", true);
annotationVisitor0.visit("value", Type.getType("Ljakarta/persistence/NamedQueries;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "lockMode", "()Ljakarta/persistence/LockModeType;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljakarta/persistence/LockModeType;", "NONE");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
