...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/criteria/CriteriaBuilder$Trimspec;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/criteria/CriteriaBuilder$Trimspec", "ENUM$VALUES", "[Ljakarta/persistence/criteria/CriteriaBuilder$Trimspec;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/criteria/CriteriaBuilder$Trimspec", "ENUM$VALUES", "[Ljakarta/persistence/criteria/CriteriaBuilder$Trimspec;");
methodVisitor.visitInsn(DUP);
