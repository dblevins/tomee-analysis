...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/criteria/Predicate$BooleanOperator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/criteria/Predicate$BooleanOperator", "ENUM$VALUES", "[Ljakarta/persistence/criteria/Predicate$BooleanOperator;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/criteria/Predicate$BooleanOperator", "ENUM$VALUES", "[Ljakarta/persistence/criteria/Predicate$BooleanOperator;");
methodVisitor.visitInsn(DUP);
