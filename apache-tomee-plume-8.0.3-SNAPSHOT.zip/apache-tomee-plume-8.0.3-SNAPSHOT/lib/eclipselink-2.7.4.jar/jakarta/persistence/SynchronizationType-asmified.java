...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/SynchronizationType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/SynchronizationType", "ENUM$VALUES", "[Ljakarta/persistence/SynchronizationType;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/SynchronizationType", "ENUM$VALUES", "[Ljakarta/persistence/SynchronizationType;");
methodVisitor.visitInsn(DUP);
