...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/LockModeType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/LockModeType", "ENUM$VALUES", "[Ljakarta/persistence/LockModeType;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/LockModeType", "ENUM$VALUES", "[Ljakarta/persistence/LockModeType;");
methodVisitor.visitInsn(DUP);
