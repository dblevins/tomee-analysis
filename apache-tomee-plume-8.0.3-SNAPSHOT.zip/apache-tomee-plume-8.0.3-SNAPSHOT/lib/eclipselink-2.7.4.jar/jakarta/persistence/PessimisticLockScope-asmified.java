...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/PessimisticLockScope;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/PessimisticLockScope", "ENUM$VALUES", "[Ljakarta/persistence/PessimisticLockScope;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/PessimisticLockScope", "ENUM$VALUES", "[Ljakarta/persistence/PessimisticLockScope;");
methodVisitor.visitInsn(DUP);
