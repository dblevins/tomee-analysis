...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/SharedCacheMode;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/SharedCacheMode", "ENUM$VALUES", "[Ljakarta/persistence/SharedCacheMode;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/SharedCacheMode", "ENUM$VALUES", "[Ljakarta/persistence/SharedCacheMode;");
methodVisitor.visitInsn(DUP);
