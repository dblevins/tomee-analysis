...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/spi/LoadState;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/spi/LoadState", "ENUM$VALUES", "[Ljakarta/persistence/spi/LoadState;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/spi/LoadState", "ENUM$VALUES", "[Ljakarta/persistence/spi/LoadState;");
methodVisitor.visitInsn(DUP);
