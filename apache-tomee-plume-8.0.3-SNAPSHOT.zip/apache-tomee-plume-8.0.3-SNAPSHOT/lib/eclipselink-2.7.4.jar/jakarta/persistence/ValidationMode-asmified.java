...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljakarta/persistence/ValidationMode;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/persistence/ValidationMode", "ENUM$VALUES", "[Ljakarta/persistence/ValidationMode;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/persistence/ValidationMode", "ENUM$VALUES", "[Ljakarta/persistence/ValidationMode;");
methodVisitor.visitInsn(DUP);
