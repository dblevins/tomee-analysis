...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/criteria/Predicate$BooleanOperator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/criteria/Predicate$BooleanOperator", "ENUM$VALUES", "[Ljavax/persistence/criteria/Predicate$BooleanOperator;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/criteria/Predicate$BooleanOperator", "ENUM$VALUES", "[Ljavax/persistence/criteria/Predicate$BooleanOperator;");
methodVisitor.visitInsn(DUP);
