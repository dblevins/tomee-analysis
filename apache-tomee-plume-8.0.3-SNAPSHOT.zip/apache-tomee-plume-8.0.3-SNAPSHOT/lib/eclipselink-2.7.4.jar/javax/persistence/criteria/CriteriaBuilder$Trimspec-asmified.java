...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/criteria/CriteriaBuilder$Trimspec;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/criteria/CriteriaBuilder$Trimspec", "ENUM$VALUES", "[Ljavax/persistence/criteria/CriteriaBuilder$Trimspec;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/criteria/CriteriaBuilder$Trimspec", "ENUM$VALUES", "[Ljavax/persistence/criteria/CriteriaBuilder$Trimspec;");
methodVisitor.visitInsn(DUP);
