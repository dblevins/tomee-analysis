...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/metamodel/Attribute$PersistentAttributeType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/metamodel/Attribute$PersistentAttributeType", "ENUM$VALUES", "[Ljavax/persistence/metamodel/Attribute$PersistentAttributeType;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/metamodel/Attribute$PersistentAttributeType", "ENUM$VALUES", "[Ljavax/persistence/metamodel/Attribute$PersistentAttributeType;");
methodVisitor.visitInsn(DUP);
