...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/metamodel/PluralAttribute$CollectionType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/metamodel/PluralAttribute$CollectionType", "ENUM$VALUES", "[Ljavax/persistence/metamodel/PluralAttribute$CollectionType;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/metamodel/PluralAttribute$CollectionType", "ENUM$VALUES", "[Ljavax/persistence/metamodel/PluralAttribute$CollectionType;");
methodVisitor.visitInsn(DUP);
