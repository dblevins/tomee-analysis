...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/metamodel/Type$PersistenceType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/metamodel/Type$PersistenceType", "ENUM$VALUES", "[Ljavax/persistence/metamodel/Type$PersistenceType;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/metamodel/Type$PersistenceType", "ENUM$VALUES", "[Ljavax/persistence/metamodel/Type$PersistenceType;");
methodVisitor.visitInsn(DUP);
