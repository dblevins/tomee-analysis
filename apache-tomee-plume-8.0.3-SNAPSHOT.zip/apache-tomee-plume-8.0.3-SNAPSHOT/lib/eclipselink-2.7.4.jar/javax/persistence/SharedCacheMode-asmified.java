...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/SharedCacheMode;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/SharedCacheMode", "ENUM$VALUES", "[Ljavax/persistence/SharedCacheMode;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/SharedCacheMode", "ENUM$VALUES", "[Ljavax/persistence/SharedCacheMode;");
methodVisitor.visitInsn(DUP);
