...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "ENUM$VALUES", "[Ljavax/persistence/LockModeType;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/LockModeType", "ENUM$VALUES", "[Ljavax/persistence/LockModeType;");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/LockModeType", "ENUM$VALUES", "[Ljavax/persistence/LockModeType;");
methodVisitor.visitInsn(DUP);
