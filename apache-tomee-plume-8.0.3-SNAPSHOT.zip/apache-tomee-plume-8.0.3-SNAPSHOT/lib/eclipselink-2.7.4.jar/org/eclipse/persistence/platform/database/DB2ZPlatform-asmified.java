...
public class DB2ZPlatformDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/platform/database/DB2ZPlatform", null, "org/eclipse/persistence/platform/database/DB2Platform", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/platform/database/DB2ZPlatform", "getUseNationalCharacterVaryingTypeForString", "()Z", false);
...
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitLdcInsn(" CCSID UNICODE");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
