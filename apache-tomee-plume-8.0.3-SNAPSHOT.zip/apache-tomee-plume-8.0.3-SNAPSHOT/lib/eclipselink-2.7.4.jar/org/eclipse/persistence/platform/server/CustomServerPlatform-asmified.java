...
public class CustomServerPlatformDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/platform/server/CustomServerPlatform", null, "org/eclipse/persistence/platform/server/ServerPlatformBase", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/platform/server/CustomServerPlatform", "disableRuntimeServices", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/platform/server/CustomServerPlatform", "externalTransactionControllerClass", "Ljava/lang/Class;");
