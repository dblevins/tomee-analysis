...
public class WebLogic_12_Platform$ContextHelper$4Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper$4", "Ljava/lang/Object;Ljava/security/PrivilegedAction<Ljava/lang/Boolean;>;", "java/lang/Object", new String[] { "java/security/PrivilegedAction" });

classWriter.visitOuterClass("org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper", "isGlobalRuntime", "()Z");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper$4", "this$1", "Lorg/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper$4", "this$1", "Lorg/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper$4", "this$1", "Lorg/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper", "access$4", "(Lorg/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper;)Ljava/lang/reflect/Method;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/internal/security/PrivilegedAccessHelper", "invokeMethod", "(Ljava/lang/reflect/Method;Ljava/lang/Object;)Ljava/lang/Object;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/platform/server/wls/WebLogic_12_Platform$ContextHelper$4", "run", "()Ljava/lang/Boolean;", false);
methodVisitor.visitInsn(ARETURN);
