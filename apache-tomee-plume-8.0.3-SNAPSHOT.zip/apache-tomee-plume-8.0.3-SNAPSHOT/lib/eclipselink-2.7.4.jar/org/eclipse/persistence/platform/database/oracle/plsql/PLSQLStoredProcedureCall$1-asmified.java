...
public class PLSQLStoredProcedureCall$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/persistence/platform/database/oracle/plsql/PLSQLStoredProcedureCall$1", "Ljava/lang/Object;Ljava/util/Comparator<Lorg/eclipse/persistence/platform/database/oracle/plsql/PLSQLargument;>;", "java/lang/Object", new String[] { "java/util/Comparator" });

classWriter.visitOuterClass("org/eclipse/persistence/platform/database/oracle/plsql/PLSQLStoredProcedureCall", "buildOutputRow", "(Ljava/sql/CallableStatement;Lorg/eclipse/persistence/internal/databaseaccess/DatabaseAccessor;Lorg/eclipse/persistence/internal/sessions/AbstractSession;)Lorg/eclipse/persistence/internal/sessions/AbstractRecord;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/platform/database/oracle/plsql/PLSQLStoredProcedureCall$1", "this$0", "Lorg/eclipse/persistence/platform/database/oracle/plsql/PLSQLStoredProcedureCall;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "org/eclipse/persistence/platform/database/oracle/plsql/PLSQLargument");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/platform/database/oracle/plsql/PLSQLStoredProcedureCall$1", "compare", "(Lorg/eclipse/persistence/platform/database/oracle/plsql/PLSQLargument;Lorg/eclipse/persistence/platform/database/oracle/plsql/PLSQLargument;)I", false);
methodVisitor.visitInsn(IRETURN);
