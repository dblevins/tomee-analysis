...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wlsThreadPoolRuntime", "Ljavax/management/ObjectName;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_10_Platform", "wlsThreadPoolRuntime", "Ljavax/management/ObjectName;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_10_Platform", "mBeanServer", "Ljavax/management/MBeanServer;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_10_Platform", "mBeanServer", "Ljavax/management/MBeanServer;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_10_Platform", "mBeanServer", "Ljavax/management/MBeanServer;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/platform/server/wls/WebLogic_10_Platform", "getMBeanServer", "()Ljavax/management/MBeanServer;", false);
Label label6 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/platform/server/wls/WebLogic_10_Platform", "wlsThreadPoolRuntime", "Ljavax/management/ObjectName;");
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label7);
methodVisitor.visitLabel(label0);
