...
public class EISObjectPersistenceXMLProject$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/persistence/eis/EISObjectPersistenceXMLProject$3", null, "org/eclipse/persistence/mappings/AttributeAccessor", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/eis/EISObjectPersistenceXMLProject$3", "this$0", "Lorg/eclipse/persistence/eis/EISObjectPersistenceXMLProject;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/eclipse/persistence/eis/mappings/EISOneToOneMapping", "java/util/List", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
