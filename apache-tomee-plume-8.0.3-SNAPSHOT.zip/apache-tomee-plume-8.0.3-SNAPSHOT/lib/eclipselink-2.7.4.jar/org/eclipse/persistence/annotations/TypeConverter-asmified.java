...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/persistence/annotations/TypeConverter", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Lorg/eclipse/persistence/annotations/TypeConverters;"));
annotationVisitor0.visitEnd();
}
{
