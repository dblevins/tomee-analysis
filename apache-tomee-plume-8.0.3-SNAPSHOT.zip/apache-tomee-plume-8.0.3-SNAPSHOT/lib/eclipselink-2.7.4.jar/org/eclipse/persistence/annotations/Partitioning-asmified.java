...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/persistence/annotations/Partitioning", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "partitioningClass", "()Ljava/lang/Class;", "()Ljava/lang/Class<+Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;>;", null);
methodVisitor.visitEnd();
}
