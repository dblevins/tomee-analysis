...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/persistence/annotations/TenantDiscriminatorColumn", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Lorg/eclipse/persistence/annotations/TenantDiscriminatorColumns;"));
annotationVisitor0.visitEnd();
}
{
...
annotationVisitor0.visit(null, "TENANT_ID");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "contextProperty", "()Ljava/lang/String;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, "eclipselink.tenant-id");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, new Integer(31));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "primaryKey", "()Z", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
