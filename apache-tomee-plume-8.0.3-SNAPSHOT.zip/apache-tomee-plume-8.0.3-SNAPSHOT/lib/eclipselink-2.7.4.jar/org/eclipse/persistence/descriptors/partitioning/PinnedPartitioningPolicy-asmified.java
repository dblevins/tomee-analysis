...
public class PinnedPartitioningPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/descriptors/partitioning/PinnedPartitioningPolicy", null, "org/eclipse/persistence/descriptors/partitioning/PartitioningPolicy", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/descriptors/partitioning/PinnedPartitioningPolicy", "connectionPool", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/descriptors/partitioning/PinnedPartitioningPolicy", "connectionPool", "Ljava/lang/String;");
