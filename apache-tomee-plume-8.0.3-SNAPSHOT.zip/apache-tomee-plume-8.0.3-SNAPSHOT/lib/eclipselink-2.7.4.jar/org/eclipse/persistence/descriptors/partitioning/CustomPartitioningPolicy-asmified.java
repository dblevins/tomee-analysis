...
public class CustomPartitioningPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", null, "org/eclipse/persistence/descriptors/partitioning/PartitioningPolicy", null);

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "partitioningClasName", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "policy", "Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "getPartitioningClasName", "()Ljava/lang/String;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "policy", "Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "policy", "Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPartitioningClasName", "()Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "partitioningClasName", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setPartitioningClasName", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "partitioningClasName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getPolicy", "()Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "policy", "Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setPolicy", "(Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/descriptors/partitioning/CustomPartitioningPolicy", "policy", "Lorg/eclipse/persistence/descriptors/partitioning/PartitioningPolicy;");
