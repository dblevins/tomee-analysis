...
public class XmlSchema$XmlNsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jaxb/xmlmodel/XmlSchema$XmlNs", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "namespace-uri");
annotationVisitor0.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlSchema$XmlNs", "namespaceUri", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlSchema$XmlNs", "namespaceUri", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlSchema$XmlNs", "prefix", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlSchema$XmlNs", "prefix", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
