...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/eclipse/persistence/jaxb/IDResolver", null, "org/eclipse/persistence/oxm/IDResolver", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/oxm/IDResolver", "<init>", "()V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "startDocument", "(Lorg/xml/sax/ErrorHandler;)V", null, new String[] { "org/xml/sax/SAXException" });
methodVisitor.visitCode();
