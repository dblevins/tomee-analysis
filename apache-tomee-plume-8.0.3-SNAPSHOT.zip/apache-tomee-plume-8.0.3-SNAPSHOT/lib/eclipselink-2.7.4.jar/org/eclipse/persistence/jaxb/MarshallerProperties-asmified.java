...
public class MarshallerPropertiesDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jaxb/MarshallerProperties", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CHARACTER_ESCAPE_HANDLER", "Ljava/lang/String;", null, "eclipselink.character-escape-handler");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "INDENT_STRING", "Ljava/lang/String;", null, "eclipselink.indent-string");
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "JSON_MARSHAL_EMPTY_COLLECTIONS", "Ljava/lang/String;", null, "eclipselink.json.marshal-empty-collections");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "JSON_REDUCE_ANY_ARRAYS", "Ljava/lang/String;", null, "eclipselink.json.reduce-any-arrays");
fieldVisitor.visitEnd();
}
{
