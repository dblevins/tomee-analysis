...
public class BeanValidationCheckerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jaxb/BeanValidationChecker", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "isBeanValidationPresent", "()Z", null, null);
methodVisitor.visitCode();
