...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "constraintViolations", "Ljava/util/Set;", "Ljava/util/Set<Ljavax/validation/ConstraintViolation<Ljava/lang/Object;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "validatorFactory", "Ljavax/validation/ValidatorFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "validatorFactory", "Ljavax/validation/ValidatorFactory;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "validatorFactory", "Ljavax/validation/ValidatorFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "validator", "Ljavax/validation/Validator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jaxb/ConstraintViolationWrapper", "<init>", "(Ljavax/validation/ConstraintViolation;)V", false);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "getValidatorFactory", "()Ljavax/validation/ValidatorFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "validator", "Ljavax/validation/Validator;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/validation/ValidationException"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "stopSearchingForValidator", "Z");
methodVisitor.visitLabel(label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getValidatorFactory", "()Ljavax/validation/ValidatorFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/validation/ConstraintViolation", "java/util/Collection", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jaxb/JAXBBeanValidator$ConstraintViolationInfo", "<init>", "(Ljava/lang/String;Ljavax/validation/Path;Lorg/eclipse/persistence/jaxb/JAXBBeanValidator$ConstraintViolationInfo;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$1", "(Lorg/eclipse/persistence/jaxb/JAXBBeanValidator;)Ljavax/validation/Validator;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/JAXBBeanValidator", "validator", "Ljavax/validation/Validator;");
methodVisitor.visitInsn(ARETURN);
