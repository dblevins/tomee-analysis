...
public class XmlMap$KeyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jaxb/xmlmodel/XmlMap$Key", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlMap$Key", "type", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlMap$Key", "type", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
