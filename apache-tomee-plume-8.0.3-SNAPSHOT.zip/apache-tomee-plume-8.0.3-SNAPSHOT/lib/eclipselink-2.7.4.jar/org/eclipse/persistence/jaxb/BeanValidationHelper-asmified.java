...
classWriter.visitInnerClass("javax/validation/constraints/AssertFalse$List", "javax/validation/constraints/AssertFalse", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/AssertTrue$List", "javax/validation/constraints/AssertTrue", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/DecimalMax$List", "javax/validation/constraints/DecimalMax", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/DecimalMin$List", "javax/validation/constraints/DecimalMin", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Digits$List", "javax/validation/constraints/Digits", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Future$List", "javax/validation/constraints/Future", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Max$List", "javax/validation/constraints/Max", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Min$List", "javax/validation/constraints/Min", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/NotNull$List", "javax/validation/constraints/NotNull", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Past$List", "javax/validation/constraints/Past", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Pattern$List", "javax/validation/constraints/Pattern", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

classWriter.visitInnerClass("javax/validation/constraints/Size$List", "javax/validation/constraints/Size", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Max;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Min;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/DecimalMax;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/DecimalMin;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Digits;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/NotNull;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Pattern;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Size;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/AssertTrue;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/AssertFalse;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Future;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Past;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Max$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Min$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/DecimalMax$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/DecimalMin$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Digits$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/NotNull$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Pattern$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Size$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/AssertTrue$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/AssertFalse$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Future$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/BeanValidationHelper", "knownConstraints", "Ljava/util/Set;");
methodVisitor.visitLdcInsn(Type.getType("Ljavax/validation/constraints/Past$List;"));
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "add", "(Ljava/lang/Object;)Z", true);
methodVisitor.visitInsn(POP);
