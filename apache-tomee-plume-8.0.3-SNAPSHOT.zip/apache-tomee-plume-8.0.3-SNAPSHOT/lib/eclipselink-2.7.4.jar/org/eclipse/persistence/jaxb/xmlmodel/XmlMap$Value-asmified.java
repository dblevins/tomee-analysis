...
public class XmlMap$ValueDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jaxb/xmlmodel/XmlMap$Value", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlMap$Value", "type", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jaxb/xmlmodel/XmlMap$Value", "type", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
