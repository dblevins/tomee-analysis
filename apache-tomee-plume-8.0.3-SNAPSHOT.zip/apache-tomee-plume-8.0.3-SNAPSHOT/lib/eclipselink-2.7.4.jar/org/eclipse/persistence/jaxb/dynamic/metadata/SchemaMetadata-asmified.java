...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/persistence/dynamic/DynamicClassLoader;Ljava/util/Map;)V", "(Lorg/eclipse/persistence/dynamic/DynamicClassLoader;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)V", new String[] { "javax/xml/bind/JAXBException" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/persistence/dynamic/DynamicClassLoader;Ljava/util/Map;Lorg/w3c/dom/Node;Lorg/xml/sax/EntityResolver;)V", "(Lorg/eclipse/persistence/dynamic/DynamicClassLoader;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;Lorg/w3c/dom/Node;Lorg/xml/sax/EntityResolver;)V", new String[] { "javax/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
