...
public class JoinFieldMetadataDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/metadata/columns/JoinFieldMetadata", null, "org/eclipse/persistence/internal/jpa/metadata/columns/JoinColumnMetadata", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("<join-field>");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/columns/JoinColumnMetadata", "<init>", "(Ljava/lang/String;)V", false);
