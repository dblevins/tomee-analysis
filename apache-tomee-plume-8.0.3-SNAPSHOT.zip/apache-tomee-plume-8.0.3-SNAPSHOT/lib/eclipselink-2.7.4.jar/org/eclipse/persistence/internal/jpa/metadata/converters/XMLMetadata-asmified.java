...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/metadata/converters/XMLMetadata", null, "org/eclipse/persistence/internal/jpa/metadata/converters/MetadataConverter", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/eclipse/persistence/internal/jpa/metadata/converters/XMLMetadata");
methodVisitor.visitJumpInsn(IFEQ, label0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(NEW, "org/eclipse/persistence/sessions/serializers/XMLSerializer");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/sessions/serializers/XMLSerializer", "<init>", "()V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/mappings/converters/SerializedObjectConverter", "<init>", "(Lorg/eclipse/persistence/mappings/DatabaseMapping;Lorg/eclipse/persistence/sessions/serializers/Serializer;)V", false);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/metadata/converters/XMLMetadata", "setConverter", "(Lorg/eclipse/persistence/mappings/DatabaseMapping;Lorg/eclipse/persistence/mappings/converters/Converter;Z)V", false);
methodVisitor.visitInsn(RETURN);
