...
public class PropertiesHandler$CommitOrderPropDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/sessions/PropertiesHandler$CommitOrderProp", null, "org/eclipse/persistence/internal/sessions/PropertiesHandler$Prop", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/sessions/PropertiesHandler$CommitOrderProp", "valueArray", "[Ljava/lang/Object;");
