...
public class JPQLQueryHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/xr/JPQLQueryHandler", null, "org/eclipse/persistence/internal/xr/QueryHandler", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/xr/JPQLQueryHandler", "jpqlString", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/xr/JPQLQueryHandler", "jpqlString", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
