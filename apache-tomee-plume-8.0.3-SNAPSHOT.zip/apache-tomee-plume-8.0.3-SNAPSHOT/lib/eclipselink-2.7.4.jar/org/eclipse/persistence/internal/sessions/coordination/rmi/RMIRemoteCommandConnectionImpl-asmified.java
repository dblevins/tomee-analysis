...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/sessions/coordination/rmi/RMIRemoteCommandConnectionImpl", null, "java/rmi/server/UnicastRemoteObject", new String[] { "org/eclipse/persistence/internal/sessions/coordination/rmi/RMIRemoteCommandConnection" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/sessions/coordination/rmi/RMIRemoteCommandConnectionImpl", "rcm", "Lorg/eclipse/persistence/sessions/coordination/RemoteCommandManager;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/sessions/coordination/rmi/RMIRemoteCommandConnectionImpl", "rcm", "Lorg/eclipse/persistence/sessions/coordination/RemoteCommandManager;");
methodVisitor.visitVarInsn(ALOAD, 1);
