...
public class MultitenantPrimaryKeyAccessorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/descriptors/MultitenantPrimaryKeyAccessor", null, "org/eclipse/persistence/mappings/AttributeAccessor", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getValue", "(Lorg/eclipse/persistence/sessions/Session;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/descriptors/MultitenantPrimaryKeyAccessor", "getAttributeName", "()Ljava/lang/String;", false);
