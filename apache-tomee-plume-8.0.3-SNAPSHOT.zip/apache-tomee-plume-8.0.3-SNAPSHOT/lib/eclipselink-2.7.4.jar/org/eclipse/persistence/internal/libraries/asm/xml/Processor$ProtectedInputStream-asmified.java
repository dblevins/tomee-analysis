...
public class Processor$ProtectedInputStreamDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/internal/libraries/asm/xml/Processor$ProtectedInputStream", null, "java/io/InputStream", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/libraries/asm/xml/Processor$ProtectedInputStream", "is", "Ljava/io/InputStream;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/libraries/asm/xml/Processor$ProtectedInputStream", "is", "Ljava/io/InputStream;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "available", "()I", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/libraries/asm/xml/Processor$ProtectedInputStream", "is", "Ljava/io/InputStream;");
