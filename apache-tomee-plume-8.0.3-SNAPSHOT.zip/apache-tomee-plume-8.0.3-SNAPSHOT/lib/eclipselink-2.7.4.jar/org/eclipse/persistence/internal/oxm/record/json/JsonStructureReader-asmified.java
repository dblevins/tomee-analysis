...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setJsonStructure", "(Ljavax/json/JsonStructure;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "jsonStructure", "Ljavax/json/JsonStructure;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "parse", "(Lorg/xml/sax/InputSource;)V", null, new String[] { "java/io/IOException", "org/xml/sax/SAXException", "javax/json/JsonException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "jsonStructure", "Ljavax/json/JsonStructure;");
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/json/Json", "createReader", "(Ljava/io/InputStream;)Ljavax/json/JsonReader;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/json/JsonReader"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "org/xml/sax/InputSource"}, 1, new Object[] {"javax/json/JsonException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "parseRoot", "(Ljavax/json/JsonValue;)V", null, new String[] { "org/xml/sax/SAXException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "javax/json/JsonValue", "java/util/Map", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "javax/json/JsonValue"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/json/JsonObject", "java/util/Set"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "parsePair", "(Ljava/lang/String;Ljavax/json/JsonValue;)V", false);
...
Label label13 = new Label();
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "javax/json/JsonValue", "org/eclipse/persistence/internal/oxm/record/SAXUnmarshallerHandler", "javax/json/JsonArray", "java/util/List", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "javax/json/JsonValue", "org/eclipse/persistence/internal/oxm/record/SAXUnmarshallerHandler", "javax/json/JsonArray", "java/util/List", "javax/json/JsonValue", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "getContentHandler", "()Lorg/eclipse/persistence/internal/oxm/record/ExtendedContentHandler;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "javax/json/JsonValue", "org/eclipse/persistence/internal/oxm/record/SAXUnmarshallerHandler", "javax/json/JsonArray", "java/util/List"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "getContentHandler", "()Lorg/eclipse/persistence/internal/oxm/record/ExtendedContentHandler;", false);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/eclipse/persistence/internal/oxm/record/UnmarshalRecord");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "parseValue", "(Ljavax/json/JsonValue;)V", false);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseValue", "(Ljavax/json/JsonValue;)V", null, new String[] { "org/xml/sax/SAXException" });
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "contentHandler", "Lorg/eclipse/persistence/internal/oxm/record/ExtendedContentHandler;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/json/JsonNumber", "toString", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/ExtendedContentHandler", "characters", "(Ljava/lang/CharSequence;)V", true);
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
Label label10 = new Label();
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "javax/json/JsonValue", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Map$Entry");
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parsePair", "(Ljava/lang/String;Ljavax/json/JsonValue;)V", null, new String[] { "org/xml/sax/SAXException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/json/JsonValue$ValueType", "javax/json/JsonArray", "java/lang/String"}, 0, null);
methodVisitor.visitLdcInsn("");
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "isNamespaceAware", "()Z", false);
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "java/lang/String", "javax/json/JsonValue", "javax/json/JsonValue$ValueType", "javax/json/JsonArray", "java/lang/String", "java/lang/String", Opcodes.TOP, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "contentHandler", "Lorg/eclipse/persistence/internal/oxm/record/ExtendedContentHandler;");
methodVisitor.visitTypeInsn(INSTANCEOF, "org/eclipse/persistence/internal/oxm/record/UnmarshalRecord");
Label label10 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "java/lang/String", "javax/json/JsonValue", "javax/json/JsonValue$ValueType", "javax/json/JsonArray", "java/lang/String", "java/lang/String", Opcodes.INTEGER, Opcodes.INTEGER, "org/eclipse/persistence/internal/oxm/XPathFragment", "org/eclipse/persistence/internal/oxm/XPathFragment", "org/eclipse/persistence/internal/oxm/record/UnmarshalRecord", "org/eclipse/persistence/internal/oxm/record/UnmarshalRecord", "javax/json/JsonValue", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 7);
...
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "java/lang/String", "javax/json/JsonValue", "javax/json/JsonValue$ValueType", "javax/json/JsonArray", "java/lang/String", "java/lang/String", Opcodes.TOP, Opcodes.INTEGER, "org/eclipse/persistence/internal/oxm/XPathFragment", "org/eclipse/persistence/internal/oxm/XPathFragment"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "java/lang/String", "javax/json/JsonValue", "javax/json/JsonValue$ValueType"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "attributePrefix", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "java/lang/String", "javax/json/JsonValue", "javax/json/JsonValue$ValueType", "java/lang/String", "java/lang/String", Opcodes.INTEGER, "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonStructureReader", "namespaces", "Lorg/eclipse/persistence/internal/oxm/NamespaceResolver;");
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/NamespaceResolver", "resolveNamespacePrefix", "(Ljava/lang/String;)Ljava/lang/String;", false);
