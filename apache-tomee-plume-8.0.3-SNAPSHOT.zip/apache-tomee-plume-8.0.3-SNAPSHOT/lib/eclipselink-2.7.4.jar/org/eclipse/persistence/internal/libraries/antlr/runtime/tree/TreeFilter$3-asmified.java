...
public class TreeFilter$3Dump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter$3", null, "java/lang/Object", new String[] { "org/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter$fptr" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter$3", "this$0", "Lorg/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter$3", "this$0", "Lorg/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/libraries/antlr/runtime/tree/TreeFilter", "bottomup", "()V", false);
methodVisitor.visitInsn(RETURN);
