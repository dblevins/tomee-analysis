...
public class QueryHintsHandler$FlushHintDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/QueryHintsHandler$FlushHint", null, "org/eclipse/persistence/internal/jpa/QueryHintsHandler$Hint", null);
...
methodVisitor.visitLdcInsn("eclipselink.flush");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/QueryHintsHandler$FlushHint", "valueArray", "[Ljava/lang/Object;");
