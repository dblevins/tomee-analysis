...
public class CommandDataHolderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/CommandDataHolder", null, "java/lang/Object", new String[] { "org/omg/CORBA/portable/Streamable" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/CommandDataHolder", "value", "[B");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/CommandDataHolder", "value", "[B");
