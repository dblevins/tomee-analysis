...
public class DecoratedDatabaseTableDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/history/DecoratedDatabaseTable", null, "org/eclipse/persistence/internal/helper/DatabaseTable", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "asOfClause", "Lorg/eclipse/persistence/history/AsOfClause;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;Lorg/eclipse/persistence/history/AsOfClause;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/history/DecoratedDatabaseTable", "asOfClause", "Lorg/eclipse/persistence/history/AsOfClause;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/history/DecoratedDatabaseTable", "asOfClause", "Lorg/eclipse/persistence/history/AsOfClause;");
