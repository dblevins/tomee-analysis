...
public class DateConstantExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/expressions/DateConstantExpression", null, "org/eclipse/persistence/internal/expressions/ConstantExpression", null);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("DateConstant");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/expressions/DateConstantExpression", "value", "Ljava/lang/Object;");
