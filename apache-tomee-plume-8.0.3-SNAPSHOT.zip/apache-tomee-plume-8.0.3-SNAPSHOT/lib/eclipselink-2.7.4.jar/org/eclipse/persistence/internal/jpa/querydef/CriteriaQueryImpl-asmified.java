...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "<T:Ljava/lang/Object;>Lorg/eclipse/persistence/internal/jpa/querydef/AbstractQueryImpl<TT;>;Ljakarta/persistence/criteria/CriteriaQuery<TT;>;", "org/eclipse/persistence/internal/jpa/querydef/AbstractQueryImpl", new String[] { "jakarta/persistence/criteria/CriteriaQuery" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "orderBy", "Ljava/util/List;", "Ljava/util/List<Ljakarta/persistence/criteria/Order;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "findRootAndParameters", "(Ljakarta/persistence/criteria/Selection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "populateAndSetConstructorSelection", "(Lorg/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl;Ljava/lang/Class;[Ljakarta/persistence/criteria/Selection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/criteria/Selection", "getJavaType", "()Ljava/lang/Class;", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "queryType", "Ljava/lang/Class;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "metamodel", "Ljakarta/persistence/metamodel/Metamodel;");
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "[Ljakarta/persistence/criteria/Selection;", Opcodes.TOP, Opcodes.INTEGER, Opcodes.INTEGER, "[Ljakarta/persistence/criteria/Selection;"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "[Ljakarta/persistence/criteria/Selection;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "queryResult", "Lorg/eclipse/persistence/internal/jpa/querydef/AbstractQueryImpl$ResultType;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/internal/jpa/querydef/AbstractQueryImpl$ResultType", "ENTITY", "Lorg/eclipse/persistence/internal/jpa/querydef/AbstractQueryImpl$ResultType;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "queryType", "Ljava/lang/Class;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/querydef/CompoundSelectionImpl", "<init>", "(Ljava/lang/Class;[Ljakarta/persistence/criteria/Selection;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "selection", "Lorg/eclipse/persistence/internal/jpa/querydef/SelectionImpl;");
methodVisitor.visitJumpInsn(GOTO, label8);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/persistence/criteria/Selection;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "multiselect", "([Ljakarta/persistence/criteria/Selection;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/persistence/criteria/CriteriaQuery");
methodVisitor.visitInsn(ARETURN);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "[Ljakarta/persistence/criteria/Order;", Opcodes.TOP, Opcodes.INTEGER, Opcodes.INTEGER, "[Ljakarta/persistence/criteria/Order;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitInsn(AALOAD);
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "populateAndSetConstructorSelection", "(Lorg/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl;Ljava/lang/Class;[Ljakarta/persistence/criteria/Selection;)V", "(Lorg/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl;Ljava/lang/Class<*>;[Ljakarta/persistence/criteria/Selection<*>;)V", new String[] { "java/lang/IllegalArgumentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "org/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl", "java/lang/Class", "[Ljakarta/persistence/criteria/Selection;", "[Ljava/lang/Class;", Opcodes.INTEGER, Opcodes.TOP, Opcodes.INTEGER, Opcodes.INTEGER, "[Ljakarta/persistence/criteria/Selection;"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "populateAndSetConstructorSelection", "(Lorg/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl;Ljava/lang/Class;[Ljakarta/persistence/criteria/Selection;)V", false);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "org/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl", "java/lang/Class", "[Ljakarta/persistence/criteria/Selection;", "[Ljava/lang/Class;", Opcodes.INTEGER, "jakarta/persistence/criteria/Selection", Opcodes.INTEGER, Opcodes.INTEGER, "[Ljakarta/persistence/criteria/Selection;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "org/eclipse/persistence/internal/jpa/querydef/ConstructorSelectionImpl", "java/lang/Class", "[Ljakarta/persistence/criteria/Selection;", "[Ljava/lang/Class;", Opcodes.INTEGER, "java/lang/reflect/Constructor"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "org/eclipse/persistence/queries/ObjectLevelReadQuery", "org/eclipse/persistence/queries/ReportQuery", "jakarta/persistence/criteria/Selection", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(CHECKCAST, "org/eclipse/persistence/internal/jpa/querydef/SelectionImpl");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/SelectionImpl", "isCompoundSelection", "()Z", false);
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/PathImpl", "getParentPath", "()Ljakarta/persistence/criteria/Path;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "where", "Ljakarta/persistence/criteria/Expression;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "org/eclipse/persistence/queries/ObjectLevelReadQuery", "org/eclipse/persistence/queries/ReportQuery"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "havingClause", "Ljakarta/persistence/criteria/Predicate;");
methodVisitor.visitJumpInsn(IFNULL, label6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "havingClause", "Ljakarta/persistence/criteria/Predicate;");
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/OrderImpl", "getExpression", "()Ljakarta/persistence/criteria/Expression;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/eclipse/persistence/internal/jpa/querydef/ExpressionImpl");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/ExpressionImpl", "getCurrentNode", "()Lorg/eclipse/persistence/expressions/Expression;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "org/eclipse/persistence/queries/ObjectLevelReadQuery", "jakarta/persistence/criteria/Order", "java/util/Iterator", "org/eclipse/persistence/internal/jpa/querydef/OrderImpl", "org/eclipse/persistence/expressions/Expression"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "groupBy", "(Ljava/util/List;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "groupBy", "([Ljakarta/persistence/criteria/Expression;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "distinct", "(Z)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "where", "([Ljakarta/persistence/criteria/Predicate;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "where", "(Ljakarta/persistence/criteria/Expression;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "having", "([Ljakarta/persistence/criteria/Predicate;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/querydef/CriteriaQueryImpl", "having", "(Ljakarta/persistence/criteria/Expression;)Ljakarta/persistence/criteria/CriteriaQuery;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
