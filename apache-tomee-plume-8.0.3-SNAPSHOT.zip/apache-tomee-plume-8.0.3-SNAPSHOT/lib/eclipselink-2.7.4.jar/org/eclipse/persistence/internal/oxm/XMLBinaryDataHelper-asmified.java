...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "convertObjectToDataHandler", "(Ljava/lang/Object;Lorg/eclipse/persistence/internal/core/sessions/CoreAbstractSession;)Ljakarta/activation/DataHandler;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBytesFromDataHandler", "(Ljakarta/activation/DataHandler;)Lorg/eclipse/persistence/internal/oxm/XMLBinaryDataHelper$EncodedData;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "jakarta/activation/DataHandler", "java/io/ByteArrayOutputStream"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "getBytesFromDataHandler", "(Ljakarta/activation/DataHandler;)Lorg/eclipse/persistence/internal/oxm/XMLBinaryDataHelper$EncodedData;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "getBytesFromMultipart", "(Ljakarta/mail/internet/MimeMultipart;Lorg/eclipse/persistence/internal/oxm/Marshaller;)Lorg/eclipse/persistence/internal/oxm/XMLBinaryDataHelper$EncodedData;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBytesFromMultipart", "(Ljakarta/mail/internet/MimeMultipart;Lorg/eclipse/persistence/internal/oxm/Marshaller;)Lorg/eclipse/persistence/internal/oxm/XMLBinaryDataHelper$EncodedData;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/mail/internet/MimeMultipart", "getContentType", "()Ljava/lang/String;", false);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "jakarta/mail/internet/MimeMultipart", "org/eclipse/persistence/internal/oxm/Marshaller", "java/io/ByteArrayOutputStream"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("[B"));
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "stringFromDataHandler", "(Ljakarta/activation/DataHandler;Ljavax/xml/namespace/QName;Lorg/eclipse/persistence/internal/core/sessions/CoreAbstractSession;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "jakarta/activation/DataHandler", "javax/xml/namespace/QName", "org/eclipse/persistence/internal/core/sessions/CoreAbstractSession", "java/io/ByteArrayOutputStream"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/XMLBinaryDataHelper", "stringFromDataHandler", "(Ljakarta/activation/DataHandler;Ljavax/xml/namespace/QName;Lorg/eclipse/persistence/internal/core/sessions/CoreAbstractSession;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "stringFromMultipart", "(Ljakarta/mail/internet/MimeMultipart;Ljavax/xml/namespace/QName;Lorg/eclipse/persistence/internal/core/sessions/CoreAbstractSession;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/activation/DataHandler");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "convertObjectToDataHandler", "(Ljava/lang/Object;Lorg/eclipse/persistence/internal/core/sessions/CoreAbstractSession;)Ljakarta/activation/DataHandler;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
