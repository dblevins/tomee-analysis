...
public class IndirectListContainerPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/queries/IndirectListContainerPolicy", null, "org/eclipse/persistence/internal/queries/ListContainerPolicy", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/indirection/IndirectCollectionsFactory", "createIndirectList", "(Ljava/util/Collection;)Lorg/eclipse/persistence/indirection/IndirectList;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
