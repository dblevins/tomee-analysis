...
public class PropertiesHandler$BatchWritingPropDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/sessions/PropertiesHandler$BatchWritingProp", null, "org/eclipse/persistence/internal/sessions/PropertiesHandler$Prop", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/sessions/PropertiesHandler$BatchWritingProp", "shouldReturnOriginalValueIfValueToApplyNotFound", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/sessions/PropertiesHandler$BatchWritingProp", "valueArray", "[Ljava/lang/Object;");
