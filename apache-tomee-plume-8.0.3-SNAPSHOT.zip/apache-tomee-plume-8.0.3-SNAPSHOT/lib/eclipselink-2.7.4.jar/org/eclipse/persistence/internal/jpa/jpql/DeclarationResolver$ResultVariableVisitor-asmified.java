...
public class DeclarationResolver$ResultVariableVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/persistence/internal/jpa/jpql/DeclarationResolver$ResultVariableVisitor", null, "org/eclipse/persistence/jpa/jpql/parser/AbstractEclipseLinkExpressionVisitor", null);
...
{
fieldVisitor = classWriter.visitField(0, "resultVariables", "Ljava/util/Set;", "Ljava/util/Set<Lorg/eclipse/persistence/jpa/jpql/parser/IdentificationVariable;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/jpql/DeclarationResolver$ResultVariableVisitor", "resultVariables", "Ljava/util/Set;");
