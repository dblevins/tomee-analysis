...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "validatorMap", "Ljava/util/Map;", "Ljava/util/Map<Lorg/eclipse/persistence/descriptors/ClassDescriptor;Ljavax/validation/Validator;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/validation/ValidatorFactory;[Ljava/lang/Class;[Ljava/lang/Class;[Ljava/lang/Class;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "validatorFactory", "Ljavax/validation/ValidatorFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "javax/validation/ValidatorFactory", "[Ljava/lang/Class;", "[Ljava/lang/Class;", "[Ljava/lang/Class;"}, 1, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "javax/validation/ValidatorFactory", "[Ljava/lang/Class;", "[Ljava/lang/Class;", "[Ljava/lang/Class;"}, 2, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "[Ljava/lang/Class;"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "getValidator", "(Lorg/eclipse/persistence/descriptors/DescriptorEvent;)Ljavax/validation/Validator;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "isBeanConstrained", "(Ljava/lang/Object;Ljavax/validation/Validator;)Z", false);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "org/eclipse/persistence/descriptors/DescriptorEvent", "java/lang/String", "[Ljava/lang/Class;", "java/lang/Object", "javax/validation/Validator", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLabel(label1);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "validate", "(Ljava/lang/Object;[Ljava/lang/Class;Ljavax/validation/Validator;)Ljava/util/Set;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getValidator", "(Lorg/eclipse/persistence/descriptors/DescriptorEvent;)Ljavax/validation/Validator;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener", "validatorFactory", "Ljavax/validation/ValidatorFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/ValidatorContext", "traversableResolver", "(Ljavax/validation/TraversableResolver;)Ljavax/validation/ValidatorContext;", true);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/eclipse/persistence/descriptors/ClassDescriptor", "javax/validation/Validator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isBeanConstrained", "(Ljava/lang/Object;Ljavax/validation/Validator;)Z", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener$1", "<init>", "(Lorg/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener;Ljavax/validation/Validator;Ljava/lang/Object;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validate", "(Ljava/lang/Object;[Ljava/lang/Class;Ljavax/validation/Validator;)Ljava/util/Set;", "(Ljava/lang/Object;[Ljava/lang/Class;Ljavax/validation/Validator;)Ljava/util/Set<Ljavax/validation/ConstraintViolation<Ljava/lang/Object;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/internal/security/PrivilegedAccessHelper", "shouldUsePrivilegedAccess", "()Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener$2", "<init>", "(Lorg/eclipse/persistence/internal/jpa/metadata/listeners/BeanValidationListener;Ljavax/validation/Validator;Ljava/lang/Object;[Ljava/lang/Class;)V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Set");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
