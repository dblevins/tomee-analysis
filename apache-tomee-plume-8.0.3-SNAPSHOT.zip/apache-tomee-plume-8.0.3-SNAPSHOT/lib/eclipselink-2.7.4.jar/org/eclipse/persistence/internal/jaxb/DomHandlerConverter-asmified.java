...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "domHandler", "Ljakarta/xml/bind/annotation/DomHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jaxb/DomHandlerConverter", "domHandler", "Ljakarta/xml/bind/annotation/DomHandler;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jaxb/DomHandlerConverter", "domHandler", "Ljakarta/xml/bind/annotation/DomHandler;");
methodVisitor.visitVarInsn(ALOAD, 4);
