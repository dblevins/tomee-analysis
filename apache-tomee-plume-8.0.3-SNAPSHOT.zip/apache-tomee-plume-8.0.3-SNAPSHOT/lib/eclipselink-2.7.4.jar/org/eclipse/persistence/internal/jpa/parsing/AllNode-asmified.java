...
public class AllNodeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/parsing/AllNode", null, "org/eclipse/persistence/internal/jpa/parsing/Node", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/parsing/AllNode", "left", "Lorg/eclipse/persistence/internal/jpa/parsing/Node;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/parsing/AllNode", "setType", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/parsing/AllNode", "getLeft", "()Lorg/eclipse/persistence/internal/jpa/parsing/Node;", false);
