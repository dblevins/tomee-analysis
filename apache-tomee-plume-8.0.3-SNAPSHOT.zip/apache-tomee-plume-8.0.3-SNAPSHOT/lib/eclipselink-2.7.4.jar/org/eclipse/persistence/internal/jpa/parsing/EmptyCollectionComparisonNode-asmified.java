...
public class EmptyCollectionComparisonNodeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/parsing/EmptyCollectionComparisonNode", null, "org/eclipse/persistence/internal/jpa/parsing/SimpleConditionalExpressionNode", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "notIndicated", "Z", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/parsing/EmptyCollectionComparisonNode", "notIndicated", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/parsing/EmptyCollectionComparisonNode", "left", "Lorg/eclipse/persistence/internal/jpa/parsing/Node;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/parsing/EmptyCollectionComparisonNode", "setType", "(Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/parsing/EmptyCollectionComparisonNode", "getLeft", "()Lorg/eclipse/persistence/internal/jpa/parsing/Node;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/parsing/EmptyCollectionComparisonNode", "notIndicated", "Z");
Label label0 = new Label();
