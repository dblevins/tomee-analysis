...
public class MarshalRecordContentHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", null, "java/lang/Object", new String[] { "org/eclipse/persistence/internal/oxm/record/ExtendedContentHandler" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "marshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "resolver", "Lorg/eclipse/persistence/internal/oxm/NamespaceResolver;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;Lorg/eclipse/persistence/internal/oxm/NamespaceResolver;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "marshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "resolver", "Lorg/eclipse/persistence/internal/oxm/NamespaceResolver;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setMarshalRecord", "(Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "marshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMarshalRecord", "()Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "marshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "resolver", "Lorg/eclipse/persistence/internal/oxm/NamespaceResolver;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/eclipse/persistence/internal/oxm/XPathFragment", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "marshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/MarshalRecord", "startPrefixMapping", "(Ljava/lang/String;Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "marshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/MarshalRecord;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/MarshalRecord", "endPrefixMapping", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/MarshalRecordContentHandler", "characters", "(Ljava/lang/CharSequence;)V", false);
methodVisitor.visitInsn(RETURN);
