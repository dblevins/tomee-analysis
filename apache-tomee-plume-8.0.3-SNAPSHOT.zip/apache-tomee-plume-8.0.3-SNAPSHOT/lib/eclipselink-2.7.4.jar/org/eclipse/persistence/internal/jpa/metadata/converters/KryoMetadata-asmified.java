...
public class KryoMetadataDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/metadata/converters/KryoMetadata", null, "org/eclipse/persistence/internal/jpa/metadata/converters/MetadataConverter", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/eclipse/persistence/internal/jpa/metadata/converters/KryoMetadata");
methodVisitor.visitJumpInsn(IFEQ, label0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("org.eclipse.persistence.sessions.serializers.kryo.KryoSerializer");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/metadata/converters/KryoMetadata", "setConverter", "(Lorg/eclipse/persistence/mappings/DatabaseMapping;Lorg/eclipse/persistence/mappings/converters/Converter;Z)V", false);
methodVisitor.visitInsn(RETURN);
