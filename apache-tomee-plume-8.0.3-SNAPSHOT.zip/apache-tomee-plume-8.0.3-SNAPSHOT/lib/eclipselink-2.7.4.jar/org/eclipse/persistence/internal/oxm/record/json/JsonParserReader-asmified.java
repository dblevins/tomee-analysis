...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonParserReaderBuilder", "access$0", "(Lorg/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonParserReaderBuilder;)Ljakarta/json/stream/JsonParser;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "parser", "Ljakarta/json/stream/JsonParser;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTryCatchBlock(label0, label9, label8, "jakarta/json/JsonException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "parser", "Ljakarta/json/stream/JsonParser;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "doParsing", "(Ljakarta/json/stream/JsonParser;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/xml/sax/InputSource", "getCharacterStream", "()Ljava/io/Reader;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/json/Json", "createParser", "(Ljava/io/Reader;)Ljakarta/json/stream/JsonParser;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "doParsing", "(Ljakarta/json/stream/JsonParser;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/json/Json", "createParser", "(Ljava/io/InputStream;)Ljakarta/json/stream/JsonParser;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "doParsing", "(Ljakarta/json/stream/JsonParser;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doParsing", "(Ljakarta/json/stream/JsonParser;)V", null, new String[] { "org/xml/sax/SAXException", "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "parseEvent", "(Ljakarta/json/stream/JsonParser;)Lorg/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder", "build", "()Ljakarta/json/JsonStructure;", true);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "parseEvent", "(Ljakarta/json/stream/JsonParser;)Lorg/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder;", null, new String[] { "org/xml/sax/SAXException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/json/stream/JsonParser$Event", "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$ArrayBuilder", "<init>", "(Ljakarta/json/JsonArrayBuilder;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "stack", "Ljava/util/Deque;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$ObjectBuilder", "<init>", "(Ljakarta/json/JsonObjectBuilder;)V", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader", "stack", "Ljava/util/Deque;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder", "build", "()Ljakarta/json/JsonStructure;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder", "add", "(Ljakarta/json/JsonValue;)V", true);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"org/eclipse/persistence/internal/oxm/record/json/JsonParserReader$JsonStructureBuilder"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
