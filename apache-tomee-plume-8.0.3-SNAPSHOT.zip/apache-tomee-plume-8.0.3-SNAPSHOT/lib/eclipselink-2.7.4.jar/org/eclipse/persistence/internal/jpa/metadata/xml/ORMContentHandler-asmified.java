...
public class ORMContentHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", null, "java/lang/Object", new String[] { "org/xml/sax/ContentHandler" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "ENTITY_MAPPINGS", "Ljava/lang/String;", null, "entity-mappings");
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "ECLIPSELINK", "Ljava/lang/String;", null, "eclipselink");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "isEclipseLink", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", "version", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", "java/lang/String", "java/lang/String", "java/lang/String", "org/xml/sax/Attributes"}, 2, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", "isEclipseLink", "Z");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isEclipseLink", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", "isEclipseLink", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/metadata/xml/ORMContentHandler", "version", "Ljava/lang/String;");
