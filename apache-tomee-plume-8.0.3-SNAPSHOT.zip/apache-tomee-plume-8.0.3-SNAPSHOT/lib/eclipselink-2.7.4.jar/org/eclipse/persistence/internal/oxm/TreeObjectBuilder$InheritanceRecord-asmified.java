...
public class TreeObjectBuilder$InheritanceRecordDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/eclipse/persistence/internal/oxm/TreeObjectBuilder$InheritanceRecord", null, "org/eclipse/persistence/oxm/record/XMLRecord", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "abstractMarshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/TreeObjectBuilder$InheritanceRecord", "abstractMarshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/TreeObjectBuilder$InheritanceRecord", "abstractMarshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/TreeObjectBuilder$InheritanceRecord", "abstractMarshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord", "hasCustomNamespaceMapper", "()Z", true);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/TreeObjectBuilder$InheritanceRecord", "abstractMarshalRecord", "Lorg/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/AbstractMarshalRecord", "getNamespaceSeparator", "()C", true);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/TreeObjectBuilder$InheritanceRecord", "put", "(Lorg/eclipse/persistence/internal/helper/DatabaseField;Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
