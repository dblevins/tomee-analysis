...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jaxb/JAXBElementRootConverter", "createJAXBElement", "(Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljava/lang/Object;)Ljavax/xml/bind/JAXBElement;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createJAXBElement", "(Ljavax/xml/namespace/QName;Ljava/lang/Class;Ljava/lang/Object;)Ljavax/xml/bind/JAXBElement;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
