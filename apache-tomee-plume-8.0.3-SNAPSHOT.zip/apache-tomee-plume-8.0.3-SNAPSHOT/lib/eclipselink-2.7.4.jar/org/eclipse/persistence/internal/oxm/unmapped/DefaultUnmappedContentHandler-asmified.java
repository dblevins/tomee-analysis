...
public class DefaultUnmappedContentHandlerDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setUnmarshalRecord", "(Lorg/eclipse/persistence/internal/oxm/record/UnmarshalRecord;)V", "(TUNMARSHAL_RECORD;)V", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
