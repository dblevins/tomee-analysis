...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "mc", "Ljavax/xml/ws/handler/MessageContext;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setMessageContext", "(Ljavax/xml/ws/handler/MessageContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/dbws/ProviderHelper", "mc", "Ljavax/xml/ws/handler/MessageContext;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initXRServiceStream", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;)Ljava/io/InputStream;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "java/lang/ClassLoader", "javax/servlet/ServletContext", "java/io/InputStream", Opcodes.TOP, Opcodes.INTEGER, Opcodes.INTEGER, "[Ljava/lang/String;"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "java/lang/ClassLoader", "javax/servlet/ServletContext", "java/io/InputStream"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initXRSchemaStream", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;)Ljava/io/InputStream;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initWSDLInputStream", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;)Ljava/io/InputStream;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "init", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;Z)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/dbws/ProviderHelper", "initXRServiceStream", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;)Ljava/io/InputStream;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/dbws/ProviderHelper", "initXRSchemaStream", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;)Ljava/io/InputStream;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/dbws/ProviderHelper", "initWSDLInputStream", "(Ljava/lang/ClassLoader;Ljavax/servlet/ServletContext;)Ljava/io/InputStream;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "invoke", "(Ljavax/xml/soap/SOAPMessage;)Ljavax/xml/soap/SOAPMessage;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
Label label13 = new Label();
Label label14 = new Label();
methodVisitor.visitTryCatchBlock(label12, label13, label14, "javax/xml/soap/SOAPException");
Label label15 = new Label();
Label label16 = new Label();
Label label17 = new Label();
methodVisitor.visitTryCatchBlock(label15, label16, label17, "javax/xml/soap/SOAPException");
Label label18 = new Label();
methodVisitor.visitTryCatchBlock(label15, label16, label18, "java/lang/Exception");
Label label19 = new Label();
Label label20 = new Label();
Label label21 = new Label();
methodVisitor.visitTryCatchBlock(label19, label20, label21, "javax/xml/soap/SOAPException");
Label label22 = new Label();
Label label23 = new Label();
Label label24 = new Label();
methodVisitor.visitTryCatchBlock(label22, label23, label24, "javax/xml/soap/SOAPException");
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/dbws/ProviderHelper", "mc", "Ljavax/xml/ws/handler/MessageContext;");
...
methodVisitor.visitJumpInsn(GOTO, label26);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitTypeInsn(NEW, "javax/xml/ws/WebServiceException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPEnvelope", "getNamespaceURI", "()Ljava/lang/String;", true);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitLdcInsn("http://www.w3.org/2003/05/soap-envelope");
...
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/internal/dbws/ProviderHelper", "getSOAPBodyElement", "(Ljavax/xml/soap/SOAPEnvelope;)Ljavax/xml/soap/SOAPElement;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label4);
Label label27 = new Label();
methodVisitor.visitJumpInsn(GOTO, label27);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope", "java/lang/String"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitTypeInsn(NEW, "javax/xml/ws/WebServiceException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 9);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/xml/soap/SOAPFault", "javax/xml/soap/SOAPFactory"}, 0, null);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope", "java/lang/String", "javax/xml/soap/SOAPElement", "javax/xml/soap/SOAPFault"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitTypeInsn(NEW, "javax/xml/ws/WebServiceException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope", "java/lang/String", "javax/xml/soap/SOAPElement", "org/eclipse/persistence/oxm/XMLRoot"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitLabel(label12);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/Exception", "javax/xml/soap/SOAPFault", "javax/xml/soap/SOAPFactory"}, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/soap/SOAPFactory", "newInstance", "()Ljavax/xml/soap/SOAPFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 12);
...
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope", "java/lang/String", "javax/xml/soap/SOAPElement", "org/eclipse/persistence/oxm/XMLRoot", "java/lang/Exception", "javax/xml/soap/SOAPFault"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitTypeInsn(NEW, "javax/xml/ws/WebServiceException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 12);
...
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/dbws/SOAPResponseWriter", "generateResponse", "(Lorg/eclipse/persistence/internal/xr/Operation;ZLjava/lang/Object;)Ljavax/xml/soap/SOAPMessage;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label16);
...
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 17);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/dbws/SOAPResponseWriter", "generateResponse", "(Lorg/eclipse/persistence/internal/xr/Operation;ZLjava/lang/Exception;)Ljavax/xml/soap/SOAPMessage;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label20);
methodVisitor.visitJumpInsn(GOTO, label50);
methodVisitor.visitLabel(label21);
methodVisitor.visitFrame(Opcodes.F_FULL, 18, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope", "java/lang/String", "javax/xml/soap/SOAPElement", "org/eclipse/persistence/oxm/XMLRoot", "org/eclipse/persistence/internal/xr/Invocation", "org/eclipse/persistence/internal/xr/Operation", "org/eclipse/persistence/internal/oxm/schema/model/Element", "java/lang/String", Opcodes.INTEGER, "org/eclipse/persistence/internal/oxm/schema/model/ComplexType", "java/lang/Object", "java/lang/Exception"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 18);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 19);
methodVisitor.visitLabel(label22);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/xml/soap/SOAPException", "javax/xml/soap/SOAPFault", "javax/xml/soap/SOAPFactory"}, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/xml/soap/SOAPFactory", "newInstance", "()Ljavax/xml/soap/SOAPFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 20);
...
methodVisitor.visitLabel(label24);
methodVisitor.visitFrame(Opcodes.F_FULL, 20, new Object[] {"org/eclipse/persistence/internal/dbws/ProviderHelper", "javax/xml/soap/SOAPMessage", "java/util/Map", "javax/xml/soap/SOAPMessage", Opcodes.INTEGER, "org/eclipse/persistence/internal/dbws/DBWSAdapter", "javax/xml/soap/SOAPEnvelope", "java/lang/String", "javax/xml/soap/SOAPElement", "org/eclipse/persistence/oxm/XMLRoot", "org/eclipse/persistence/internal/xr/Invocation", "org/eclipse/persistence/internal/xr/Operation", "org/eclipse/persistence/internal/oxm/schema/model/Element", "java/lang/String", Opcodes.INTEGER, "org/eclipse/persistence/internal/oxm/schema/model/ComplexType", "java/lang/Object", "java/lang/Exception", "javax/xml/soap/SOAPException", "javax/xml/soap/SOAPFault"}, 1, new Object[] {"javax/xml/soap/SOAPException"});
methodVisitor.visitVarInsn(ASTORE, 20);
methodVisitor.visitTypeInsn(NEW, "javax/xml/ws/WebServiceException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 20);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getSOAPBodyElement", "(Ljavax/xml/soap/SOAPEnvelope;)Ljavax/xml/soap/SOAPElement;", null, new String[] { "javax/xml/soap/SOAPException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPEnvelope", "getBody", "()Ljavax/xml/soap/SOAPBody;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/soap/SOAPBody", "getChildElements", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(GOTO, label0);
Label label1 = new Label();
