...
classWriter.visitOuterClass("org/eclipse/persistence/internal/jpa/deployment/JavaSECMPInitializer", "registerTransformer", "(Ljavax/persistence/spi/ClassTransformer;Ljavax/persistence/spi/PersistenceUnitInfo;Ljava/util/Map;)V");
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_SYNTHETIC, "val$transformer", "Ljavax/persistence/spi/ClassTransformer;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/eclipse/persistence/internal/jpa/deployment/JavaSECMPInitializer;Ljavax/persistence/spi/ClassTransformer;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jpa/deployment/JavaSECMPInitializer$1", "val$transformer", "Ljavax/persistence/spi/ClassTransformer;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/deployment/JavaSECMPInitializer$1", "val$transformer", "Ljavax/persistence/spi/ClassTransformer;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
