...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "registerTransformer", "(Ljakarta/persistence/spi/ClassTransformer;Ljakarta/persistence/spi/PersistenceUnitInfo;Ljava/util/Map;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/deployment/JavaSECMPInitializer$1", "<init>", "(Lorg/eclipse/persistence/internal/jpa/deployment/JavaSECMPInitializer;Ljakarta/persistence/spi/ClassTransformer;)V", false);
