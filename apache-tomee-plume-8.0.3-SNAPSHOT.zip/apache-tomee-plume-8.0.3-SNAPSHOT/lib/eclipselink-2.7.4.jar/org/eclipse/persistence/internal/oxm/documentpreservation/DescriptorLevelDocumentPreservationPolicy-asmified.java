...
public class DescriptorLevelDocumentPreservationPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/oxm/documentpreservation/DescriptorLevelDocumentPreservationPolicy", null, "org/eclipse/persistence/internal/oxm/documentpreservation/AbstractDocumentPreservationPolicy", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/documentpreservation/DescriptorLevelDocumentPreservationPolicy", "nodesToObjects", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/util/WeakHashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/WeakHashMap", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/documentpreservation/DescriptorLevelDocumentPreservationPolicy", "objectsToNodes", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/oxm/documentpreservation/DescriptorLevelDocumentPreservationPolicy", "setNodeOrderingPolicy", "(Lorg/eclipse/persistence/oxm/documentpreservation/NodeOrderingPolicy;)V", false);
