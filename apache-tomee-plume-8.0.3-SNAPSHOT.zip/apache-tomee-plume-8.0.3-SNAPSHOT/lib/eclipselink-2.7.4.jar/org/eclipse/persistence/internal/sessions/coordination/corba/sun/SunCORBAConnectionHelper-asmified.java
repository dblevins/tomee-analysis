...
public class SunCORBAConnectionHelperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnectionHelper", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnectionHelper", "_id", "Ljava/lang/String;");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnectionHelper", "__typeCode", "Lorg/omg/CORBA/TypeCode;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "insert", "(Lorg/omg/CORBA/Any;Lorg/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "extract", "(Lorg/omg/CORBA/Any;)Lorg/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnectionHelper", "__typeCode", "Lorg/omg/CORBA/TypeCode;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/omg/CORBA/ORB", "init", "()Lorg/omg/CORBA/ORB;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnectionHelper", "id", "()Ljava/lang/String;", false);
methodVisitor.visitLdcInsn("SunCORBAConnection");
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnectionHelper", "_id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 0);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "read", "(Lorg/omg/CORBA/portable/InputStream;)Lorg/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/eclipse/persistence/internal/sessions/coordination/corba/sun/_SunCORBAConnectionStub;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "write", "(Lorg/omg/CORBA/portable/OutputStream;Lorg/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "narrow", "(Lorg/omg/CORBA/Object;)Lorg/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(CHECKCAST, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/SunCORBAConnection");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitTypeInsn(NEW, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/_SunCORBAConnectionStub");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/sessions/coordination/corba/sun/_SunCORBAConnectionStub", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
