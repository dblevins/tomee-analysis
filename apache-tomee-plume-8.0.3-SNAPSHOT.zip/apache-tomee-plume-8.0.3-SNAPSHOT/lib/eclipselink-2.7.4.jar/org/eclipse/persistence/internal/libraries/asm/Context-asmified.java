...
classWriter.visit(V1_7, ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/internal/libraries/asm/Context", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(0, "attributePrototypes", "[Lorg/eclipse/persistence/internal/libraries/asm/Attribute;", null, null);
...
{
fieldVisitor = classWriter.visitField(0, "currentMethodLabels", "[Lorg/eclipse/persistence/internal/libraries/asm/Label;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(0, "currentTypeAnnotationTargetPath", "Lorg/eclipse/persistence/internal/libraries/asm/TypePath;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "currentLocalVariableAnnotationRangeStarts", "[Lorg/eclipse/persistence/internal/libraries/asm/Label;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "currentLocalVariableAnnotationRangeEnds", "[Lorg/eclipse/persistence/internal/libraries/asm/Label;", null, null);
fieldVisitor.visitEnd();
}
{
