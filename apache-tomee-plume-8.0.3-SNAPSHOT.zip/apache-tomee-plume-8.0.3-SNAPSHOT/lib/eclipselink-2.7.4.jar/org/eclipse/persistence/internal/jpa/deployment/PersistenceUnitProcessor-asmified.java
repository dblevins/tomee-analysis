...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "buildClassSet", "(Ljakarta/persistence/spi/PersistenceUnitInfo;Ljava/util/Map;)Ljava/util/Set;", "(Ljakarta/persistence/spi/PersistenceUnitInfo;Ljava/util/Map;)Ljava/util/Set<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("jakarta.persistence.Converter");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("jakarta.persistence.metamodel.StaticMetamodel");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jpa/metadata/accessors/objects/MetadataClass", "getAnnotation", "(Ljava/lang/String;)Lorg/eclipse/persistence/internal/jpa/metadata/accessors/objects/MetadataAnnotation;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
