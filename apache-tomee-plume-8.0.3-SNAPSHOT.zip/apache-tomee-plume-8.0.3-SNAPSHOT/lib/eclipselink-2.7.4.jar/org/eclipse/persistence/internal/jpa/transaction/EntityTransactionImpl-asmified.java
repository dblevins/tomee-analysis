...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/jpa/transaction/EntityTransactionImpl", null, "java/lang/Object", new String[] { "jakarta/persistence/EntityTransaction" });
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "jakarta/persistence/RollbackException");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/persistence/RollbackException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
