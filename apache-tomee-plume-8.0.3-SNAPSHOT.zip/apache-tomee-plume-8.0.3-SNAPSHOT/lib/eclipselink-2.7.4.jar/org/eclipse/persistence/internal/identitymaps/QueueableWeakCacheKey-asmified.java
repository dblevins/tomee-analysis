...
public class QueueableWeakCacheKeyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey", null, "org/eclipse/persistence/internal/identitymaps/WeakCacheKey", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;JLjava/lang/ref/ReferenceQueue;Z)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey", "referenceQueue", "Ljava/lang/ref/ReferenceQueue;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "org/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey$CacheKeyReference");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey", "referenceQueue", "Ljava/lang/ref/ReferenceQueue;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey$CacheKeyReference", "<init>", "(Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;Lorg/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/identitymaps/QueueableWeakCacheKey", "reference", "Ljava/lang/ref/Reference;");
methodVisitor.visitInsn(RETURN);
