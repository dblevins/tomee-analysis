...
public class NodeValueDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/eclipse/persistence/internal/oxm/NodeValue", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "xPathNode", "Lorg/eclipse/persistence/internal/oxm/XPathNode;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/NodeValue", "xPathNode", "Lorg/eclipse/persistence/internal/oxm/XPathNode;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/NodeValue", "xPathNode", "Lorg/eclipse/persistence/internal/oxm/XPathNode;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isMarshalOnlyNodeValue", "()Z", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/internal/oxm/record/MarshalRecord", "setMarshaller", "(Lorg/eclipse/persistence/internal/oxm/Marshaller;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
