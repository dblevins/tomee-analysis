...
public class XMLReaderAdapter$ExtendedContentHandlerAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/internal/oxm/record/XMLReaderAdapter$ExtendedContentHandlerAdapter", null, "java/lang/Object", new String[] { "org/eclipse/persistence/internal/oxm/record/ExtendedContentHandler" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/oxm/record/XMLReaderAdapter$ExtendedContentHandlerAdapter", "contentHandler", "Lorg/xml/sax/ContentHandler;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/oxm/record/XMLReaderAdapter$ExtendedContentHandlerAdapter", "contentHandler", "Lorg/xml/sax/ContentHandler;");
