...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "isAscending", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jpa/querydef/OrderImpl", "isAscending", "Z");
