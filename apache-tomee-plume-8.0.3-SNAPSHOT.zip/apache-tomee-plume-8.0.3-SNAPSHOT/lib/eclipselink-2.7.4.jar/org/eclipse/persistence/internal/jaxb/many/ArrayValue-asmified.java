...
public class ArrayValueDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/eclipse/persistence/internal/jaxb/many/ArrayValue", "<T:Ljava/lang/Object;>Lorg/eclipse/persistence/internal/jaxb/many/ManyValue<TT;Ljava/lang/Object;>;", "org/eclipse/persistence/internal/jaxb/many/ManyValue", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/internal/jaxb/many/ArrayValue", "adaptedValue", "Ljava/util/Collection;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/internal/jaxb/many/ArrayValue", "containerClass", "()Ljava/lang/Class;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/internal/jaxb/many/ArrayValue", "adaptedValue", "Ljava/util/Collection;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 3);
Label label0 = new Label();
