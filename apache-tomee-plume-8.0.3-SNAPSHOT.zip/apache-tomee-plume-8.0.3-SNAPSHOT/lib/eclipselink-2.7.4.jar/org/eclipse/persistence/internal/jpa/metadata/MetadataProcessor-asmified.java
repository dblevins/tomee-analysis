...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/persistence/spi/PersistenceUnitInfo;Lorg/eclipse/persistence/internal/sessions/AbstractSession;Ljava/lang/ClassLoader;ZZZZZLjava/util/Map;Lorg/eclipse/persistence/internal/jpa/metadata/MetadataProcessor;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/internal/jpa/metadata/MetadataProject", "<init>", "(Ljavax/persistence/spi/PersistenceUnitInfo;Lorg/eclipse/persistence/internal/sessions/AbstractSession;ZZZZZ)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", "java/util/HashMap", "java/util/HashMap", "javax/persistence/spi/PersistenceUnitInfo", "java/util/List", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", "java/util/HashMap", "java/util/HashMap", "javax/persistence/spi/PersistenceUnitInfo", "java/util/List", "java/util/Set"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitInsn(ICONST_0);
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", Opcodes.INTEGER, "javax/persistence/spi/PersistenceUnitInfo", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", Opcodes.INTEGER, "javax/persistence/spi/PersistenceUnitInfo", "java/lang/String", "java/util/Iterator", "java/util/Enumeration"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Enumeration", "hasMoreElements", "()Z", true);
Label label6 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", Opcodes.INTEGER, "javax/persistence/spi/PersistenceUnitInfo", "java/lang/String", "java/util/Iterator"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", "java/lang/String", "javax/persistence/spi/PersistenceUnitInfo", "java/util/Collection", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/net/URL");
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", "java/lang/String", "javax/persistence/spi/PersistenceUnitInfo", "java/util/Collection", "java/net/URL", "java/util/Iterator", "java/net/URL", "org/eclipse/persistence/jpa/Archive"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/internal/jpa/metadata/MetadataProcessor", "java/lang/String", "javax/persistence/spi/PersistenceUnitInfo", "java/util/Collection", "java/net/URL", "java/util/Iterator", "java/net/URL", "org/eclipse/persistence/jpa/Archive"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
