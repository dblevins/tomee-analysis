...
public class CORBARemoteSessionControllerDispatcherDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/sessions/remote/corba/sun/CORBARemoteSessionControllerDispatcher", null, "org/eclipse/persistence/sessions/remote/corba/sun/_CORBARemoteSessionControllerImplBase", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/sessions/remote/corba/sun/_CORBARemoteSessionControllerImplBase", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/remote/corba/sun/CORBARemoteSessionControllerDispatcher", "controller", "Lorg/eclipse/persistence/internal/sessions/remote/RemoteSessionController;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/sessions/remote/corba/sun/CORBARemoteSessionControllerDispatcher", "<init>", "(Lorg/eclipse/persistence/internal/sessions/AbstractSession;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/remote/corba/sun/CORBARemoteSessionControllerDispatcher", "getController", "()Lorg/eclipse/persistence/internal/sessions/remote/RemoteSessionController;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/remote/corba/sun/CORBARemoteSessionControllerDispatcher", "controller", "Lorg/eclipse/persistence/internal/sessions/remote/RemoteSessionController;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
