...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/sessions/remote/rmi/RMIRemoteSessionControllerDispatcher", null, "java/rmi/server/UnicastRemoteObject", new String[] { "org/eclipse/persistence/sessions/remote/rmi/RMIRemoteSessionController" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/remote/rmi/RMIRemoteSessionControllerDispatcher", "controller", "Lorg/eclipse/persistence/internal/sessions/remote/RemoteSessionController;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/remote/rmi/RMIRemoteSessionControllerDispatcher", "getController", "()Lorg/eclipse/persistence/internal/sessions/remote/RemoteSessionController;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/remote/rmi/RMIRemoteSessionControllerDispatcher", "controller", "Lorg/eclipse/persistence/internal/sessions/remote/RemoteSessionController;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
