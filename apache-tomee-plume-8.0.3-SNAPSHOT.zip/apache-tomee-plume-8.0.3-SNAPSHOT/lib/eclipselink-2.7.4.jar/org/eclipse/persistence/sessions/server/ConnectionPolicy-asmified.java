...
public class ConnectionPolicyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/sessions/server/ConnectionPolicy", null, "java/lang/Object", new String[] { "java/lang/Cloneable", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "isLazy", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "isLazy", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "poolName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode", "Transactional", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "login", "Lorg/eclipse/persistence/sessions/Login;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode", "Transactional", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "hasLogin", "()Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/eclipse/persistence/sessions/server/ConnectionPolicy"}, 1, new Object[] {"java/lang/CloneNotSupportedException"});
methodVisitor.visitVarInsn(ASTORE, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "dontUseLazyConnection", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "login", "Lorg/eclipse/persistence/sessions/Login;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "poolName", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "properties", "Ljava/util/Map;");
Label label0 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "properties", "Ljava/util/Map;");
methodVisitor.visitLabel(label0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "hasProperties", "()Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "getProperties", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "hasLogin", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "login", "Lorg/eclipse/persistence/sessions/Login;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isExclusiveIsolated", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isExclusiveAlways", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isPooled", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "poolName", "Ljava/lang/String;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "isUserDefinedConnection", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "poolName", "Ljava/lang/String;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "removeProperty", "(Ljava/lang/Object;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "hasProperties", "()Z", false);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getExclusiveMode", "()Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "exclusiveMode", "Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setExclusiveMode", "(Lorg/eclipse/persistence/sessions/server/ConnectionPolicy$ExclusiveMode;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "setShouldUseExclusiveConnection", "(Z)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ILOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_DEPRECATED, "shouldUseExclusiveConnection", "()Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "isExclusiveIsolated", "()Z", false);
methodVisitor.visitInsn(IRETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "useLazyConnection", "()V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sessions/server/ConnectionPolicy", "setIsLazy", "(Z)V", false);
