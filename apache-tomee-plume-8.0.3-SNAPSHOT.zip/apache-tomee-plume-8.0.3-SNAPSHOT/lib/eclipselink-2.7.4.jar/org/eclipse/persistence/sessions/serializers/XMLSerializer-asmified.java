...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/sessions/serializers/XMLSerializer", null, "org/eclipse/persistence/sessions/serializers/AbstractSerializer", null);

{
fieldVisitor = classWriter.visitField(0, "context", "Ljakarta/xml/bind/JAXBContext;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/sessions/serializers/XMLSerializer", "context", "Ljakarta/xml/bind/JAXBContext;");
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/persistence/sessions/serializers/XMLSerializer", "java/lang/String"}, 1, new Object[] {"jakarta/xml/bind/JAXBException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "initialize", "(Ljava/lang/Class;Ljava/lang/String;Lorg/eclipse/persistence/sessions/Session;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/xml/bind/JAXBException");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/sessions/serializers/XMLSerializer", "context", "Ljakarta/xml/bind/JAXBContext;");
Label label3 = new Label();
