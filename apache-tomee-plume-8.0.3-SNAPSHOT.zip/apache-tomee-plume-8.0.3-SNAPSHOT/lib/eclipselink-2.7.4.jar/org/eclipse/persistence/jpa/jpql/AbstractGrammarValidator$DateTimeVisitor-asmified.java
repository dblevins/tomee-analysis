...
public class AbstractGrammarValidator$DateTimeVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/jpa/jpql/AbstractGrammarValidator$DateTimeVisitor", null, "org/eclipse/persistence/jpa/jpql/parser/AbstractExpressionVisitor", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "dateTime", "Z", null, null);
