...
public class DefaultEclipseLinkJPQLGrammarDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/jpa/jpql/parser/DefaultEclipseLinkJPQLGrammar", null, "java/lang/Object", new String[] { "org/eclipse/persistence/jpa/jpql/parser/JPQLGrammar" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "PROVIDER_NAME", "Ljava/lang/String;", null, "EclipseLink");
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/jpql/parser/EclipseLinkJPQLGrammar2_6", "instance", "()Lorg/eclipse/persistence/jpa/jpql/parser/JPQLGrammar;", false);
