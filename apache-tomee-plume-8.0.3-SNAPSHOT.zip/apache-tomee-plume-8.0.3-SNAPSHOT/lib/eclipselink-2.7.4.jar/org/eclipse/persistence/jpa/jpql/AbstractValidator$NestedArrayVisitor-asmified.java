...
public class AbstractValidator$NestedArrayVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jpa/jpql/AbstractValidator$NestedArrayVisitor", null, "org/eclipse/persistence/jpa/jpql/parser/AbstractExpressionVisitor", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "nestedArraySize", "I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "subExpression", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/jpql/AbstractValidator$NestedArrayVisitor", "subExpression", "Z");
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"org/eclipse/persistence/jpa/jpql/AbstractValidator$NestedArrayVisitor"});
methodVisitor.visitInsn(ICONST_M1);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/eclipse/persistence/jpa/jpql/AbstractValidator$NestedArrayVisitor", "org/eclipse/persistence/jpa/jpql/parser/CollectionExpression"}, 2, new Object[] {"org/eclipse/persistence/jpa/jpql/AbstractValidator$NestedArrayVisitor", Opcodes.INTEGER});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/jpql/AbstractValidator$NestedArrayVisitor", "subExpression", "Z");
methodVisitor.visitVarInsn(ALOAD, 1);
