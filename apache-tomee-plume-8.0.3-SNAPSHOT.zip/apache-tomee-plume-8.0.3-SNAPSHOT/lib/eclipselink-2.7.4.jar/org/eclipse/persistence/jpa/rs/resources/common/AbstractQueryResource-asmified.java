...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "namedQueryUpdateInternal", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "getMatrixParameters", "(Ljakarta/ws/rs/core/UriInfo;Ljava/lang/String;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "getMatrixParameters", "(Ljakarta/ws/rs/core/UriInfo;Ljava/lang/String;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "getQueryParameters", "(Ljakarta/ws/rs/core/UriInfo;)Ljava/util/Map;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "namedQueryInternal", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "getQueryParameters", "(Ljakarta/ws/rs/core/UriInfo;)Ljava/util/Map;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "buildQuery", "(Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Ljakarta/persistence/Query;", false);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "processPageableQuery", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/String;Lorg/eclipse/persistence/queries/DatabaseQuery;Ljakarta/persistence/Query;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;)Ljakarta/ws/rs/core/Response;", false);
methodVisitor.visitVarInsn(ASTORE, 10);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "java/lang/String", "java/lang/String", "java/lang/String", "jakarta/ws/rs/core/HttpHeaders", "jakarta/ws/rs/core/UriInfo", "org/eclipse/persistence/jpa/rs/PersistenceContext", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery", "org/eclipse/persistence/jpa/rs/features/FeatureSet"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "namedQueryResponse", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/String;Lorg/eclipse/persistence/queries/DatabaseQuery;Ljakarta/persistence/Query;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;Lorg/eclipse/persistence/jpa/rs/features/FeatureResponseBuilder;)Ljakarta/ws/rs/core/Response;", false);
methodVisitor.visitVarInsn(ASTORE, 10);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "java/lang/String", "java/lang/String", "java/lang/String", "jakarta/ws/rs/core/HttpHeaders", "jakarta/ws/rs/core/UriInfo"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/exceptions/JPARSException", "exceptionOccurred", "(Ljava/lang/Exception;)Lorg/eclipse/persistence/jpa/rs/exceptions/JPARSException;", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildQueryOptionsResponse", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractQueryResource", "CLASS_NAME", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "processPageableQuery", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/String;Lorg/eclipse/persistence/queries/DatabaseQuery;Ljakarta/persistence/Query;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jpa/rs/features/paging/PageableQueryValidator", "<init>", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/String;Ljakarta/ws/rs/core/UriInfo;)V", false);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/jpa/rs/features/FeatureResponseBuilder", "buildReportQueryResponse", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/util/Map;Ljava/util/List;Ljava/util/List;Ljakarta/ws/rs/core/UriInfo;)Ljava/lang/Object;", true);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/jpa/rs/features/FeatureResponseBuilder", "buildReadAllQueryResponse", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/util/Map;Ljava/util/List;Ljakarta/ws/rs/core/UriInfo;)Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitTypeInsn(NEW, "org/eclipse/persistence/jpa/rs/util/StreamingOutputMarshaller");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
