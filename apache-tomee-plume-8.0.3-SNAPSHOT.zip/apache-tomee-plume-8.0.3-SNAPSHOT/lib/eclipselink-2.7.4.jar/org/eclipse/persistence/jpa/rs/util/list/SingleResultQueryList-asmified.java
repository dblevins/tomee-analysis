...
public class SingleResultQueryListDump implements Opcodes {
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/util/list/SingleResultQueryList", "fields", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/rs/util/list/SingleResultQueryList", "fields", "Ljava/util/List;");
methodVisitor.visitInsn(RETURN);
