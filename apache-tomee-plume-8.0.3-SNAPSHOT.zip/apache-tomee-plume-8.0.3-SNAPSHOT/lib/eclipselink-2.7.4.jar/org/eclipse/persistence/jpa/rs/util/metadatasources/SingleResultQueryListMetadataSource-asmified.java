...
public class SingleResultQueryListMetadataSourceDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jpa/rs/util/metadatasources/SingleResultQueryListMetadataSource", null, "java/lang/Object", new String[] { "org/eclipse/persistence/jaxb/metadata/MetadataSource" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/rs/util/metadatasources/SingleResultQueryListMetadataSource", "xmlBindings", "Lorg/eclipse/persistence/jaxb/xmlmodel/XmlBindings;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/util/metadatasources/SingleResultQueryListMetadataSource", "xmlBindings", "Lorg/eclipse/persistence/jaxb/xmlmodel/XmlBindings;");
methodVisitor.visitLdcInsn(Type.getType("Lorg/eclipse/persistence/jpa/rs/util/list/SingleResultQueryList;"));
