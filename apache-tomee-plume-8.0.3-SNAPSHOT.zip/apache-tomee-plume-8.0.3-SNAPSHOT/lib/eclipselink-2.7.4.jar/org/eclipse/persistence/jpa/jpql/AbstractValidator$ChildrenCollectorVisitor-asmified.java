...
public class AbstractValidator$ChildrenCollectorVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jpa/jpql/AbstractValidator$ChildrenCollectorVisitor", null, "org/eclipse/persistence/jpa/jpql/parser/AnonymousExpressionVisitor", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "expressions", "Ljava/util/List;", "Ljava/util/List<Lorg/eclipse/persistence/jpa/jpql/parser/Expression;>;", null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/jpql/utility/CollectionTools", "addAll", "(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/Collection;", false);
