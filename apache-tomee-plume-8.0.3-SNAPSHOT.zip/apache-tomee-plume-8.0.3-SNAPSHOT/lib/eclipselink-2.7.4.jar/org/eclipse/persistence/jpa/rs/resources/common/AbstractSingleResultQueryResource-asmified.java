...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "namedQuerySingleResultInternal", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljakarta/ws/rs/core/HttpHeaders;Ljakarta/ws/rs/core/UriInfo;)Ljakarta/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractSingleResultQueryResource", "getMatrixParameters", "(Ljakarta/ws/rs/core/UriInfo;Ljava/lang/String;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractSingleResultQueryResource", "getMatrixParameters", "(Ljakarta/ws/rs/core/UriInfo;Ljava/lang/String;)Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/resources/common/AbstractSingleResultQueryResource", "getQueryParameters", "(Ljakarta/ws/rs/core/UriInfo;)Ljava/util/Map;", false);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/eclipse/persistence/jpa/rs/features/FeatureResponseBuilder", "buildSingleResultQueryResponse", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/util/Map;Ljava/lang/Object;Ljava/util/List;Ljakarta/ws/rs/core/UriInfo;)Ljava/lang/Object;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/resources/common/AbstractSingleResultQueryResource", "java/lang/String", "java/lang/String", "java/lang/String", "jakarta/ws/rs/core/HttpHeaders", "jakarta/ws/rs/core/UriInfo"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
