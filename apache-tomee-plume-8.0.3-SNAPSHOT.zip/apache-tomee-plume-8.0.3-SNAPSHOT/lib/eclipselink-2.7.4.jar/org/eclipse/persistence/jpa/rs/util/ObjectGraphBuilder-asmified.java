...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "processFieldsList", "(Lorg/eclipse/persistence/jpa/rs/util/ObjectGraphBuilder$Node;Ljava/util/List;)V", "(Lorg/eclipse/persistence/jpa/rs/util/ObjectGraphBuilder$Node;Ljava/util/List<Ljavax/xml/bind/JAXBElement;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/jpa/rs/util/ObjectGraphBuilder", "org/eclipse/persistence/jpa/rs/util/ObjectGraphBuilder$Node", "java/util/List", "javax/xml/bind/JAXBElement", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/bind/JAXBElement", "getName", "()Ljavax/xml/namespace/QName;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/xml/namespace/QName", "toString", "()Ljava/lang/String;", false);
