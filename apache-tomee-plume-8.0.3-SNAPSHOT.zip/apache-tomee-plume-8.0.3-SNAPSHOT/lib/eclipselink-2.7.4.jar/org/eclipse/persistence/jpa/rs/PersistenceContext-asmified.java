...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "adapters", "Ljava/util/List;", "Ljava/util/List<Ljakarta/xml/bind/annotation/adapters/XmlAdapter;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "emf", "Ljakarta/persistence/EntityManagerFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "emf", "Ljakarta/persistence/EntityManagerFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/persistence/RollbackException");
Label label3 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/util/TransactionWrapper", "beginTransaction", "(Ljakarta/persistence/EntityManager;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "transaction", "Lorg/eclipse/persistence/jpa/rs/util/TransactionWrapper;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/util/TransactionWrapper", "commitTransaction", "(Ljakarta/persistence/EntityManager;)V", false);
methodVisitor.visitLabel(label1);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/Object", "jakarta/persistence/EntityManager"}, 1, new Object[] {"jakarta/persistence/RollbackException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "transaction", "Lorg/eclipse/persistence/jpa/rs/util/TransactionWrapper;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/util/TransactionWrapper", "rollbackTransaction", "(Ljakarta/persistence/EntityManager;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createDynamicJAXBContext", "(Lorg/eclipse/persistence/internal/sessions/AbstractSession;)Lorg/eclipse/persistence/jaxb/JAXBContext;", null, new String[] { "jakarta/xml/bind/JAXBException", "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createEntityManagerFactory", "(Ljakarta/persistence/spi/PersistenceUnitInfo;Ljava/util/Map;)Lorg/eclipse/persistence/internal/jpa/EntityManagerFactoryImpl;", "(Ljakarta/persistence/spi/PersistenceUnitInfo;Ljava/util/Map<Ljava/lang/String;*>;)Lorg/eclipse/persistence/internal/jpa/EntityManagerFactoryImpl;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createEntityManager", "(Ljava/lang/String;)Ljakarta/persistence/EntityManager;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getEmf", "()Ljakarta/persistence/EntityManagerFactory;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "emf", "Ljakarta/persistence/EntityManagerFactory;");
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/persistence/EntityManager", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "transaction", "Lorg/eclipse/persistence/jpa/rs/util/TransactionWrapper;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/util/TransactionWrapper", "commitTransaction", "(Ljakarta/persistence/EntityManager;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "jakarta/persistence/EntityManager"}, 1, new Object[] {"jakarta/persistence/RollbackException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "java/util/Map", "jakarta/persistence/EntityManager"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/EntityManager", "close", "()V", true);
methodVisitor.visitVarInsn(ALOAD, 6);
...
Label label3 = new Label();
Label label4 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label2, "jakarta/persistence/RollbackException");
Label label5 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/persistence/EntityManager", "org/eclipse/persistence/descriptors/ClassDescriptor", "org/eclipse/persistence/mappings/DatabaseMapping"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "java/util/Map", "java/lang/String", "java/lang/Object", "java/lang/String", "jakarta/persistence/EntityManager", "org/eclipse/persistence/descriptors/ClassDescriptor", "org/eclipse/persistence/mappings/DatabaseMapping", Opcodes.TOP, "org/eclipse/persistence/mappings/DatabaseMapping"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "transaction", "Lorg/eclipse/persistence/jpa/rs/util/TransactionWrapper;");
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/util/TransactionWrapper", "beginTransaction", "(Ljakarta/persistence/EntityManager;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "java/util/Map", "java/lang/String", "java/lang/Object", "java/lang/String", "jakarta/persistence/EntityManager", "org/eclipse/persistence/descriptors/ClassDescriptor", "org/eclipse/persistence/mappings/DatabaseMapping", Opcodes.TOP, "org/eclipse/persistence/mappings/DatabaseMapping"}, 1, new Object[] {"jakarta/persistence/RollbackException"});
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "java/util/Map", "java/lang/String", "java/lang/Object", "java/lang/String", "jakarta/persistence/EntityManager"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "java/lang/String", "java/lang/String", "java/lang/Object", "java/lang/String", "jakarta/persistence/EntityManager", "java/lang/String", "java/lang/Class", "org/eclipse/persistence/descriptors/ClassDescriptor", "org/eclipse/persistence/mappings/DatabaseMapping"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 12);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/mappings/DatabaseMapping", "isObjectReferenceMapping", "()Z", false);
Label label14 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/lang/Object", "java/lang/String", "java/lang/String", "java/lang/Object", "java/lang/String", "jakarta/persistence/EntityManager", "java/lang/String"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getClientSession", "(Ljakarta/persistence/EntityManager;)Lorg/eclipse/persistence/internal/sessions/AbstractSession;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEmf", "()Ljakarta/persistence/EntityManagerFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "emf", "Ljakarta/persistence/EntityManagerFactory;");
methodVisitor.visitInsn(ARETURN);
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/Object", "jakarta/persistence/EntityManager", Opcodes.TOP, "java/util/List", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitJumpInsn(GOTO, label8);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/Object", "jakarta/persistence/EntityManager"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/EntityManager", "merge", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getEmf", "()Ljakarta/persistence/EntityManagerFactory;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jpa/dynamic/JPADynamicHelper", "<init>", "(Ljakarta/persistence/EntityManagerFactory;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "constructQuery", "(Ljakarta/persistence/EntityManager;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Ljakarta/persistence/Query;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/PersistenceContext", "transaction", "Lorg/eclipse/persistence/jpa/rs/util/TransactionWrapper;");
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/EntityManager"}, 1, new Object[] {"jakarta/persistence/RollbackException"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/exceptions/JPARSException", "exceptionOccurred", "(Ljava/lang/Exception;)Lorg/eclipse/persistence/jpa/rs/exceptions/JPARSException;", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/EntityManager"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/persistence/EntityManager", "close", "()V", true);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "constructQuery", "(Ljakarta/persistence/EntityManager;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Ljakarta/persistence/Query;", "(Ljakarta/persistence/EntityManager;Ljava/lang/String;Ljava/util/Map<**>;Ljava/util/Map<Ljava/lang/String;*>;)Ljakarta/persistence/Query;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "jakarta/persistence/EntityManager", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFNE, label2);
methodVisitor.visitLabel(label0);
...
Label label7 = new Label();
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "jakarta/persistence/EntityManager", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Map$Entry");
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitJumpInsn(IFNE, label7);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "jakarta/persistence/EntityManager", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "buildQuery", "(Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Ljakarta/persistence/Query;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;Ljava/lang/String;Ljava/util/Map<**>;Ljava/util/Map<Ljava/lang/String;*>;)Ljakarta/persistence/Query;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getEmf", "()Ljakarta/persistence/EntityManagerFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/EntityManager", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Map$Entry");
methodVisitor.visitVarInsn(ASTORE, 9);
...
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/EntityManager", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery", "java/util/Iterator", "java/util/Map$Entry", "java/lang/String", "java/lang/Class", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map$Entry", "getValue", "()Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 13);
methodVisitor.visitVarInsn(ALOAD, 11);
...
methodVisitor.visitJumpInsn(IFNE, label7);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/util/Map", "java/lang/String", "java/util/Map", "java/util/Map", "jakarta/persistence/EntityManager", "jakarta/persistence/Query", "org/eclipse/persistence/queries/DatabaseQuery"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unmarshalEntity", "(Ljava/lang/String;Ljakarta/ws/rs/core/MediaType;Ljava/io/InputStream;)Ljava/lang/Object;", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "unmarshal", "(Ljava/lang/Class;Ljakarta/ws/rs/core/MediaType;Ljava/io/InputStream;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/jpa/rs/PersistenceContext", "CLASS_NAME", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unmarshal", "(Ljava/lang/Class;Ljakarta/ws/rs/core/MediaType;Ljava/io/InputStream;)Ljava/lang/Object;", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getJAXBContext", "()Lorg/eclipse/persistence/jaxb/JAXBContext;", false);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Class", "jakarta/ws/rs/core/MediaType", "java/io/InputStream", "jakarta/xml/bind/Unmarshaller", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Class", "jakarta/ws/rs/core/MediaType", "java/io/InputStream", "jakarta/xml/bind/Unmarshaller", "jakarta/xml/bind/JAXBElement", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Class", "jakarta/ws/rs/core/MediaType", "java/io/InputStream", "jakarta/xml/bind/Unmarshaller", "jakarta/xml/bind/JAXBElement"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/bind/JAXBElement", "getValue", "()Ljava/lang/Object;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "wrap", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
...
Label label8 = new Label();
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Class", "jakarta/ws/rs/core/MediaType", "java/io/InputStream", "jakarta/xml/bind/Unmarshaller", "java/lang/Object", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Class", "jakarta/ws/rs/core/MediaType", "java/io/InputStream", "jakarta/xml/bind/Unmarshaller", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "wrap", "(Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "marshallEntity", "(Ljava/lang/Object;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;)V", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/jpa/rs/PersistenceContext", "CLASS_NAME", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "marshallEntity", "(Ljava/lang/Object;Lorg/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;)V", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/jpa/rs/PersistenceContext", "CLASS_NAME", "Ljava/lang/String;");
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "marshall", "(Ljava/lang/Object;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;ZLorg/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getSessionLog", "()Lorg/eclipse/persistence/logging/SessionLog;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/jpa/rs/PersistenceContext", "CLASS_NAME", "Ljava/lang/String;");
methodVisitor.visitLdcInsn("marshallEntity");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "marshall", "(Ljava/lang/Object;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;Z)V", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "marshall", "(Ljava/lang/Object;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;ZLorg/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter;)V", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jpa/rs/util/xmladapters/LinkAdapter", "<init>", "(Ljava/lang/String;Lorg/eclipse/persistence/jpa/rs/PersistenceContext;)V", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/bind/Marshaller", "setAdapter", "(Ljakarta/xml/bind/annotation/adapters/XmlAdapter;)V", true);
methodVisitor.visitVarInsn(ALOAD, 6);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Object", "jakarta/ws/rs/core/MediaType", "java/io/OutputStream", Opcodes.INTEGER, "org/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter", "jakarta/xml/bind/Marshaller", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/bind/annotation/adapters/XmlAdapter");
methodVisitor.visitVarInsn(ASTORE, 7);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/xml/bind/Marshaller", "setProperty", "(Ljava/lang/String;Ljava/lang/Object;)V", true);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Object", "jakarta/ws/rs/core/MediaType", "java/io/OutputStream", Opcodes.INTEGER, "org/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter", "jakarta/xml/bind/Marshaller"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
...
Label label9 = new Label();
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Object", "jakarta/ws/rs/core/MediaType", "java/io/OutputStream", Opcodes.INTEGER, "org/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter", "jakarta/xml/bind/Marshaller", "javax/xml/stream/XMLOutputFactory", "javax/xml/stream/XMLStreamWriter", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "next", "()Ljava/lang/Object;", true);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/eclipse/persistence/jpa/rs/PersistenceContext", "java/lang/Object", "jakarta/ws/rs/core/MediaType", "java/io/OutputStream", Opcodes.INTEGER, "org/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter", "jakarta/xml/bind/Marshaller", "javax/xml/stream/XMLOutputFactory"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/jpa/rs/exceptions/JPARSException", "exceptionOccurred", "(Ljava/lang/Exception;)Lorg/eclipse/persistence/jpa/rs/exceptions/JPARSException;", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getAdapters", "()Ljava/util/List;", "()Ljava/util/List<Ljakarta/xml/bind/annotation/adapters/XmlAdapter;>;", new String[] { "org/eclipse/persistence/jpa/rs/exceptions/JPARSException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
