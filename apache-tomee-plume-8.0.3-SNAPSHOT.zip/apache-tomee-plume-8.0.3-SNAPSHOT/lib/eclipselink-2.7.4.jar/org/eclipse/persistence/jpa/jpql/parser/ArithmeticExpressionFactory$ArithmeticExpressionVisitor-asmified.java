...
public class ArithmeticExpressionFactory$ArithmeticExpressionVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/jpa/jpql/parser/ArithmeticExpressionFactory$ArithmeticExpressionVisitor", null, "org/eclipse/persistence/jpa/jpql/parser/AbstractExpressionVisitor", null);
...
{
fieldVisitor = classWriter.visitField(0, "found", "Z", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/eclipse/persistence/jpa/jpql/parser/ArithmeticExpressionFactory$ArithmeticExpressionVisitor;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/jpa/jpql/parser/ArithmeticExpressionFactory$ArithmeticExpressionVisitor", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
