...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "httpStatusCode", "Ljavax/ws/rs/core/Response$Status;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getHttpStatusCode", "()Ljavax/ws/rs/core/Response$Status;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/exceptions/JPARSException", "httpStatusCode", "Ljavax/ws/rs/core/Response$Status;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setHttpStatusCode", "(Ljavax/ws/rs/core/Response$Status;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/rs/exceptions/JPARSException", "httpStatusCode", "Ljavax/ws/rs/core/Response$Status;");
methodVisitor.visitInsn(RETURN);
