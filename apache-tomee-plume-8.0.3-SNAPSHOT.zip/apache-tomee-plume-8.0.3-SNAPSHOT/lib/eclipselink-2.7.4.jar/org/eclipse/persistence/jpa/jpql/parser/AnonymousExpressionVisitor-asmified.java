...
public class AnonymousExpressionVisitorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/eclipse/persistence/jpa/jpql/parser/AnonymousExpressionVisitor", null, "java/lang/Object", new String[] { "org/eclipse/persistence/jpa/jpql/parser/ExpressionVisitor" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/jpql/parser/AnonymousExpressionVisitor", "visit", "(Lorg/eclipse/persistence/jpa/jpql/parser/Expression;)V", false);
methodVisitor.visitInsn(RETURN);
