...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/jpa/rs/util/StreamingOutputMarshaller", null, "java/lang/Object", new String[] { "jakarta/ws/rs/core/StreamingOutput" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "mediaType", "Ljakarta/ws/rs/core/MediaType;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/Object;Ljakarta/ws/rs/core/MediaType;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/jpa/rs/util/StreamingOutputMarshaller", "mediaType", "Ljakarta/ws/rs/core/MediaType;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/Object;Ljava/util/List;Lorg/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter;)V", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/Object;Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;Lorg/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/Object;Ljava/util/List;)V", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljava/lang/Object;Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "write", "(Ljava/io/OutputStream;)V", null, new String[] { "java/io/IOException", "jakarta/ws/rs/WebApplicationException" });
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/util/StreamingOutputMarshaller", "mediaType", "Ljakarta/ws/rs/core/MediaType;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/util/StreamingOutputMarshaller", "mediaType", "Ljakarta/ws/rs/core/MediaType;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "marshallEntity", "(Ljava/lang/Object;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;)V", false);
...
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/jpa/rs/util/StreamingOutputMarshaller", "mediaType", "Ljakarta/ws/rs/core/MediaType;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "marshallEntity", "(Ljava/lang/Object;Lorg/eclipse/persistence/jpa/rs/features/fieldsfiltering/FieldsFilter;Ljakarta/ws/rs/core/MediaType;Ljava/io/OutputStream;)V", false);
methodVisitor.visitJumpInsn(GOTO, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "mediaType", "(Ljava/util/List;)Ljakarta/ws/rs/core/MediaType;", "(Ljava/util/List<Ljakarta/ws/rs/core/MediaType;>;)Ljakarta/ws/rs/core/MediaType;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"java/util/List", "jakarta/ws/rs/core/MediaType", "jakarta/ws/rs/core/MediaType", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/ws/rs/core/MediaType", "APPLICATION_XML_TYPE", "Ljakarta/ws/rs/core/MediaType;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/ws/rs/core/MediaType", "isCompatible", "(Ljakarta/ws/rs/core/MediaType;)Z", false);
Label label4 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createMarshaller", "(Lorg/eclipse/persistence/jpa/rs/PersistenceContext;Ljakarta/ws/rs/core/MediaType;)Ljakarta/xml/bind/Marshaller;", null, new String[] { "jakarta/xml/bind/JAXBException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/rs/PersistenceContext", "getJAXBContext", "()Lorg/eclipse/persistence/jaxb/JAXBContext;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getResponseMediaType", "(Ljakarta/ws/rs/core/HttpHeaders;)Ljakarta/ws/rs/core/MediaType;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/ws/rs/core/HttpHeaders", "jakarta/ws/rs/core/MediaType", "java/util/List"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
