...
public class StartWithClauseDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/eclipse/persistence/jpa/jpql/parser/StartWithClause", null, "org/eclipse/persistence/jpa/jpql/parser/AbstractConditionalClause", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/jpql/parser/StartWithClause", "acceptUnknownVisitor", "(Lorg/eclipse/persistence/jpa/jpql/parser/ExpressionVisitor;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("START WITH");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/jpa/jpql/parser/StartWithClause", "getQueryBNF", "(Ljava/lang/String;)Lorg/eclipse/persistence/jpa/jpql/parser/JPQLQueryBNF;", false);
