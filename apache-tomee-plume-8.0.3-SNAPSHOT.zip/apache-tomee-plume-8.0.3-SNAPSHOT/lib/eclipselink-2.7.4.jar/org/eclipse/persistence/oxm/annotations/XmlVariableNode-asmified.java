...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/persistence/oxm/annotations/XmlVariableNode", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Lorg/eclipse/persistence/oxm/annotations/XmlVariableNode$DEFAULT;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "attribute", "()Z", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
