...
public class JSONWriterRecord$JSONWriterRecordContentHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", null, "java/lang/Object", new String[] { "org/eclipse/persistence/internal/oxm/record/ExtendedContentHandler", "org/xml/sax/ext/LexicalHandler" });
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/eclipse/persistence/oxm/record/JSONWriterRecord;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/eclipse/persistence/oxm/record/JSONWriterRecord;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", "this$0", "Lorg/eclipse/persistence/oxm/record/JSONWriterRecord;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", "this$0", "Lorg/eclipse/persistence/oxm/record/JSONWriterRecord;");
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", "this$0", "Lorg/eclipse/persistence/oxm/record/JSONWriterRecord;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/oxm/record/JSONWriterRecord", "access$1", "(Lorg/eclipse/persistence/oxm/record/JSONWriterRecord;)Lorg/eclipse/persistence/internal/oxm/NamespaceResolver;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", "handleAttributes", "(Lorg/xml/sax/Attributes;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", "characters", "(Ljava/lang/CharSequence;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/oxm/record/JSONWriterRecord$JSONWriterRecordContentHandler", "characters", "([CII)V", false);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
