...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/persistence/oxm/annotations/XmlNullPolicy", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "isSetPerformedForAbsentNode", "()Z", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
