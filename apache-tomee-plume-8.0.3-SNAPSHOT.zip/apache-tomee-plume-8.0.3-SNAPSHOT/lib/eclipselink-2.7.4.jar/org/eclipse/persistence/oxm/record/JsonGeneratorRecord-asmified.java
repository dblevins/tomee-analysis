...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "jsonGenerator", "Ljavax/json/stream/JsonGenerator;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/oxm/record/JsonGeneratorRecord", "jsonGenerator", "Ljavax/json/stream/JsonGenerator;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/oxm/record/JsonGeneratorRecord", "jsonGenerator", "Ljavax/json/stream/JsonGenerator;");
