...
public class XMLAttachmentMarshallerDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addSwaRefAttachment", "([BII)Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
{
