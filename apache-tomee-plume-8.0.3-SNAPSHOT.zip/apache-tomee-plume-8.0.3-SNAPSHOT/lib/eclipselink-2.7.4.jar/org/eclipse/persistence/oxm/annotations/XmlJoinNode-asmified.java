...
public class XmlJoinNodeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/persistence/oxm/annotations/XmlJoinNode", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "referencedXmlPath", "()Ljava/lang/String;", null, null);
methodVisitor.visitEnd();
}
