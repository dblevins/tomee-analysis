...
public class JAXBXMLHelperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/sdo/helper/jaxb/JAXBXMLHelper", null, "org/eclipse/persistence/sdo/helper/delegates/SDOXMLHelperDelegate", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/sdo/helper/delegates/SDOXMLHelperDelegate", "<init>", "(Lcommonj/sdo/helper/HelperContext;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/sdo/helper/delegates/SDOXMLHelperDelegate", "getHelperContext", "()Lcommonj/sdo/helper/HelperContext;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/sdo/helper/jaxb/JAXBXMLHelper", "getHelperContext", "()Lorg/eclipse/persistence/sdo/helper/jaxb/JAXBHelperContext;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
