...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "wlsMBeanServer", "Ljavax/management/MBeanServer;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "wlsThreadPoolRuntime", "Ljavax/management/ObjectName;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "jbossMBeanServer", "Ljavax/management/MBeanServer;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "wlsMBeanServer", "Ljavax/management/MBeanServer;");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "wlsThreadPoolRuntime", "Ljavax/management/ObjectName;");
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "jbossMBeanServer", "Ljavax/management/MBeanServer;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getWLSMBeanServer", "()Ljavax/management/MBeanServer;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "wlsMBeanServer", "Ljavax/management/MBeanServer;");
Label label8 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "getWLSMBeanServer", "()Ljavax/management/MBeanServer;", false);
Label label12 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label12);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "wlsThreadPoolRuntime", "Ljavax/management/ObjectName;");
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"javax/management/ObjectName", "javax/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitJumpInsn(GOTO, label7);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/String", "javax/management/ObjectName", "javax/management/ObjectName", "[Ljavax/management/ObjectName;", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"java/lang/String", "javax/management/ObjectName", "javax/management/ObjectName", "[Ljavax/management/ObjectName;", Opcodes.INTEGER, "javax/management/ObjectName", "java/lang/Object", "java/lang/Object", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label10);
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"java/lang/String", "javax/management/ObjectName", "javax/management/ObjectName", "[Ljavax/management/ObjectName;", Opcodes.INTEGER}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "LOGGER", "Ljava/util/logging/Logger;");
...
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "java/lang/Exception");
methodVisitor.visitFieldInsn(GETSTATIC, "org/eclipse/persistence/sdo/helper/SDOHelperContext", "jbossMBeanServer", "Ljavax/management/MBeanServer;");
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label3);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"java/util/List", "javax/management/MBeanServer", "java/util/Iterator"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"java/util/List", Opcodes.TOP, "java/util/Iterator"}, 0, new Object[] {});
