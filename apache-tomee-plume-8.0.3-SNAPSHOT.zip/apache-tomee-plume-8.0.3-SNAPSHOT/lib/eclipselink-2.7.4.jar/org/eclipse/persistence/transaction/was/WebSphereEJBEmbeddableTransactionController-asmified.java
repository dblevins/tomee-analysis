...
public class WebSphereEJBEmbeddableTransactionControllerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/transaction/was/WebSphereEJBEmbeddableTransactionController", null, "org/eclipse/persistence/transaction/was/WebSphereTransactionController", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "TX_MANAGER_FACTORY_CLASS", "Ljava/lang/String;", null, "com.ibm.tx.jta.embeddable.EmbeddableTransactionManagerFactory");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("com.ibm.tx.jta.embeddable.EmbeddableTransactionManagerFactory");
