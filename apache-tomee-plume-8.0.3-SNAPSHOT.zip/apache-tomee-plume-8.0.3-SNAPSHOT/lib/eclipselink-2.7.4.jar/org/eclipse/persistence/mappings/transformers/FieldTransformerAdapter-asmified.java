...
public class FieldTransformerAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/mappings/transformers/FieldTransformerAdapter", null, "java/lang/Object", new String[] { "org/eclipse/persistence/mappings/transformers/FieldTransformer" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/mappings/transformers/FieldTransformerAdapter", "buildFieldValue", "(Ljava/lang/Object;Ljava/lang/String;Lorg/eclipse/persistence/sessions/Session;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
