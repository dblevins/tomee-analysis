...
public class DirectToFieldMappingDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/mappings/DirectToFieldMapping", null, "org/eclipse/persistence/mappings/foundation/AbstractDirectMapping", new String[] { "org/eclipse/persistence/mappings/RelationalMapping" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/mappings/DirectToFieldMapping", "setField", "(Lorg/eclipse/persistence/internal/helper/DatabaseField;)V", false);
methodVisitor.visitInsn(RETURN);
