...
public class DirectQueryKeyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/mappings/querykeys/DirectQueryKey", null, "org/eclipse/persistence/mappings/querykeys/QueryKey", null);

{
fieldVisitor = classWriter.visitField(0, "field", "Lorg/eclipse/persistence/internal/helper/DatabaseField;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/mappings/querykeys/DirectQueryKey", "field", "Lorg/eclipse/persistence/internal/helper/DatabaseField;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getQualifiedFieldName", "()Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/mappings/querykeys/DirectQueryKey", "getField", "()Lorg/eclipse/persistence/internal/helper/DatabaseField;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/eclipse/persistence/mappings/querykeys/QueryKey", "initialize", "(Lorg/eclipse/persistence/descriptors/ClassDescriptor;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/mappings/querykeys/DirectQueryKey", "getField", "()Lorg/eclipse/persistence/internal/helper/DatabaseField;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/mappings/querykeys/DirectQueryKey", "field", "Lorg/eclipse/persistence/internal/helper/DatabaseField;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
