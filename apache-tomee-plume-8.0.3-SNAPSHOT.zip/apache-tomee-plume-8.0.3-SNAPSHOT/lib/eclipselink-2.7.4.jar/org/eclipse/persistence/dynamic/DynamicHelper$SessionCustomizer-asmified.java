...
public class DynamicHelper$SessionCustomizerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/dynamic/DynamicHelper$SessionCustomizer", null, "java/lang/Object", new String[] { "org/eclipse/persistence/config/SessionCustomizer" });
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/eclipse/persistence/dynamic/DynamicClassLoader", "java/util/Iterator"}, 0, null);
