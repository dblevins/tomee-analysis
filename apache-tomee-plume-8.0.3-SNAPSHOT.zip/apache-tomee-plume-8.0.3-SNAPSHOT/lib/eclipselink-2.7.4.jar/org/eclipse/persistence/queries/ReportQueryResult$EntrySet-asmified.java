...
public class ReportQueryResult$EntrySetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/queries/ReportQueryResult$EntrySet", null, "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/queries/ReportQueryResult$EntrySet", "this$0", "Lorg/eclipse/persistence/queries/ReportQueryResult;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/eclipse/persistence/queries/ReportQueryResult$EntryIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/queries/ReportQueryResult$EntrySet", "this$0", "Lorg/eclipse/persistence/queries/ReportQueryResult;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/queries/ReportQueryResult$EntrySet", "this$0", "Lorg/eclipse/persistence/queries/ReportQueryResult;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/eclipse/persistence/queries/ReportQueryResult", "clear", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
