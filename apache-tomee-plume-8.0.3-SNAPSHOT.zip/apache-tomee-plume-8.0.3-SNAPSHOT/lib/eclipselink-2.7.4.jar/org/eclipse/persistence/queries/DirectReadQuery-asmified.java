...
public class DirectReadQueryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/eclipse/persistence/queries/DirectReadQuery", null, "org/eclipse/persistence/queries/DataReadQuery", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/queries/DirectReadQuery", "resultType", "I");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/eclipse/persistence/queries/DirectReadQuery", "valueConverter", "Lorg/eclipse/persistence/mappings/converters/Converter;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/eclipse/persistence/queries/DirectReadQuery", "valueConverter", "Lorg/eclipse/persistence/mappings/converters/Converter;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
