...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/outbound/LocalXAResource", "localTransaction", "Ljakarta/resource/spi/LocalTransaction;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/outbound/LocalXAResource", "localTransaction", "Ljakarta/resource/spi/LocalTransaction;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/resource/spi/LocalTransaction", "commit", "()V", true);
