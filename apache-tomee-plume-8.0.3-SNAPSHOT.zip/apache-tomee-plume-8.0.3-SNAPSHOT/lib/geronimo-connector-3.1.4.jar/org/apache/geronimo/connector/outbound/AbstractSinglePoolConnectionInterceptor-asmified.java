...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "internalGetConnection", "(Lorg/apache/geronimo/connector/outbound/ConnectionInfo;)V", null, new String[] { "jakarta/resource/ResourceException" });
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/geronimo/connector/outbound/AbstractSinglePoolConnectionInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "org/apache/geronimo/connector/outbound/ConnectionReturnAction", "org/apache/geronimo/connector/outbound/ManagedConnectionInfo", "jakarta/resource/spi/ManagedConnection"}, 1, new Object[] {"jakarta/resource/ResourceException"});
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/geronimo/connector/outbound/AbstractSinglePoolConnectionInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "org/apache/geronimo/connector/outbound/ConnectionReturnAction", "org/apache/geronimo/connector/outbound/ManagedConnectionInfo", "jakarta/resource/spi/ManagedConnection", Opcodes.TOP, "java/lang/Object"}, 1, new Object[] {"jakarta/resource/ResourceException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/geronimo/connector/outbound/AbstractSinglePoolConnectionInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "org/apache/geronimo/connector/outbound/ConnectionReturnAction", "org/apache/geronimo/connector/outbound/ManagedConnectionInfo", "jakarta/resource/spi/ManagedConnection", Opcodes.INTEGER, "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(MONITOREXIT);
methodVisitor.visitLabel(label12);
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/geronimo/connector/outbound/AbstractSinglePoolConnectionInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "org/apache/geronimo/connector/outbound/ConnectionReturnAction", "org/apache/geronimo/connector/outbound/ManagedConnectionInfo", "jakarta/resource/spi/ManagedConnection", Opcodes.TOP, "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/geronimo/connector/outbound/AbstractSinglePoolConnectionInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "org/apache/geronimo/connector/outbound/ConnectionReturnAction", "org/apache/geronimo/connector/outbound/ManagedConnectionInfo", "jakarta/resource/spi/ManagedConnection", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/geronimo/connector/outbound/AbstractSinglePoolConnectionInterceptor", "log", "Lorg/slf4j/Logger;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/slf4j/Logger", "isTraceEnabled", "()Z", true);
