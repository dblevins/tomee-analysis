...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/outbound/TransactionCachingInterceptor", "transactionManager", "Ljakarta/transaction/TransactionManager;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/outbound/TransactionCachingInterceptor", "transactionManager", "Ljakarta/transaction/TransactionManager;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/geronimo/connector/ConnectorTransactionContext", "get", "(Ljakarta/transaction/Transaction;Lorg/apache/geronimo/connector/ConnectionReleaser;)Lorg/apache/geronimo/connector/outbound/TransactionCachingInterceptor$ManagedConnectionInfos;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/transaction/Transaction", "org/apache/geronimo/connector/outbound/TransactionCachingInterceptor$ManagedConnectionInfos"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitJumpInsn(IFNULL, label4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/geronimo/connector/outbound/TxUtil", "isActive", "(Ljakarta/transaction/Transaction;)Z", false);
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/geronimo/connector/outbound/TransactionCachingInterceptor", "org/apache/geronimo/connector/outbound/ConnectionInfo", "org/apache/geronimo/connector/outbound/ConnectionReturnAction"}, 1, new Object[] {"jakarta/transaction/SystemException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/geronimo/connector/outbound/TransactionCachingInterceptor", "log", "Lorg/slf4j/Logger;");
