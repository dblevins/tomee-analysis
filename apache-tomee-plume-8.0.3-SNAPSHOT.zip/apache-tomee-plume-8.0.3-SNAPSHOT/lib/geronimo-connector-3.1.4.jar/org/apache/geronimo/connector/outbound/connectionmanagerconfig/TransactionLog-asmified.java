...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/connector/outbound/connectionmanagerconfig/TransactionLog", null, "org/apache/geronimo/connector/outbound/connectionmanagerconfig/TransactionSupport", null);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor", "<init>", "(Lorg/apache/geronimo/connector/outbound/ConnectionInterceptor;Ljava/lang/String;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/geronimo/connector/outbound/connectionmanagerconfig/TransactionLog");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/connector/outbound/connectionmanagerconfig/TransactionLog", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/geronimo/connector/outbound/connectionmanagerconfig/TransactionLog", "INSTANCE", "Lorg/apache/geronimo/connector/outbound/connectionmanagerconfig/TransactionSupport;");
methodVisitor.visitInsn(RETURN);
