package asm.org.apache.geronimo.connector.outbound.transactionlog;
...
public class LogXAResourceInsertionInterceptorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor", null, "java/lang/Object", new String[] { "org/apache/geronimo/connector/outbound/ConnectionInterceptor" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor", "next", "Lorg/apache/geronimo/connector/outbound/ConnectionInterceptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor", "name", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor", "next", "Lorg/apache/geronimo/connector/outbound/ConnectionInterceptor;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(NEW, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResource");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResourceInsertionInterceptor", "name", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/connector/outbound/transactionlog/LogXAResource", "<init>", "(Ljakarta/resource/spi/LocalTransaction;Ljava/lang/String;)V", false);
