...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", null, "jakarta/servlet/jsp/jstl/core/LoopTagSupport", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", "deferredExpression", "Ljakarta/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", "deferredExpression", "Ljakarta/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", "pageContext", "Ljakarta/servlet/jsp/PageContext;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", "deferredExpression", "Ljakarta/el/ValueExpression;");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/taglibs/standard/tag/common/core/ForEachSupport$IndexedDeferredIterator", "<init>", "(Ljava/util/Iterator;Ljakarta/el/ValueExpression;Lorg/apache/taglibs/standard/tag/common/core/ForEachSupport$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", "items", "Ljava/util/Iterator;");
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/taglibs/standard/tag/common/core/ForEachSupport$IteratedDeferredIterator", "<init>", "(Ljava/util/Iterator;Ljakarta/servlet/jsp/jstl/core/IteratedExpression;Lorg/apache/taglibs/standard/tag/common/core/ForEachSupport$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/taglibs/standard/tag/common/core/ForEachSupport", "items", "Ljava/util/Iterator;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "toIterator", "(Ljava/lang/Object;)Ljava/util/Iterator;", null, new String[] { "jakarta/servlet/jsp/JspTagException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
