...
public class ProvisioningResolver$LocalInputStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", null, "java/io/InputStream", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "stream", "Ljava/io/FileInputStream;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "path", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "stream", "()Ljava/io/FileInputStream;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "stream", "Ljava/io/FileInputStream;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "path", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/io/FileInputStream", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "stream", "Ljava/io/FileInputStream;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "stream", "()Ljava/io/FileInputStream;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/FileInputStream", "mark", "(I)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "stream", "()Ljava/io/FileInputStream;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/FileInputStream", "reset", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "stream", "()Ljava/io/FileInputStream;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/io/FileInputStream", "markSupported", "()Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "path", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljava/lang/String;Lorg/apache/openejb/loader/provisining/ProvisioningResolver$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openejb/loader/provisining/ProvisioningResolver$LocalInputStream", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
