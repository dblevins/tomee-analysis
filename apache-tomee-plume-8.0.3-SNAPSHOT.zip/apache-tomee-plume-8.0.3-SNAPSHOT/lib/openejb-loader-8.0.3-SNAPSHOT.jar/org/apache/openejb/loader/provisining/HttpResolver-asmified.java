...
public class HttpResolverDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/loader/provisining/HttpResolver", null, "java/lang/Object", new String[] { "org/apache/openejb/loader/provisining/ArchiveResolver" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "CONNECT_TIMEOUT", "I", null, new Integer(10000));
...
methodVisitor.visitTryCatchBlock(label3, label1, label4, "java/net/URISyntaxException");
Label label5 = new Label();
methodVisitor.visitTryCatchBlock(label2, label5, label4, "java/net/MalformedURLException");
methodVisitor.visitTryCatchBlock(label2, label5, label4, "java/net/URISyntaxException");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/loader/provisining/HttpResolver", "java/lang/String", "java/net/URL", "java/util/Iterator", "java/net/Proxy"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openejb/loader/provisining/HttpResolver", "lastPart", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "lastPart", "(Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitIntInsn(BIPUSH, 47);
