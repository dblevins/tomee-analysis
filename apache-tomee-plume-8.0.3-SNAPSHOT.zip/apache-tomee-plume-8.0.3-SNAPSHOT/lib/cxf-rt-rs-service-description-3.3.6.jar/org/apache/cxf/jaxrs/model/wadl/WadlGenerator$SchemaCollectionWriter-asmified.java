...
public class WadlGenerator$SchemaCollectionWriterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaCollectionWriter", null, "java/lang/Object", new String[] { "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaWriter" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "coll", "Lorg/apache/cxf/common/xmlschema/SchemaCollection;", null, null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/cxf/jaxrs/model/wadl/WadlGenerator;Lorg/apache/cxf/common/xmlschema/SchemaCollection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaCollectionWriter", "this$0", "Lorg/apache/cxf/jaxrs/model/wadl/WadlGenerator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaCollectionWriter", "coll", "Lorg/apache/cxf/common/xmlschema/SchemaCollection;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaCollectionWriter", "coll", "Lorg/apache/cxf/common/xmlschema/SchemaCollection;");
