...
public class WadlGenerator$SchemaConverterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaConverter", null, "org/apache/cxf/staxutils/DelegatingXMLStreamWriter", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "locsMap", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljavax/xml/stream/XMLStreamWriter;Ljava/util/Map;)V", "(Ljavax/xml/stream/XMLStreamWriter;Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaConverter", "locsMap", "Ljava/util/Map;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/jaxrs/model/wadl/WadlGenerator$SchemaConverter", "locsMap", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 2);
