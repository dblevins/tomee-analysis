...
public class ConfigInjectionBean$ConfigPropertyLiteralDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lorg/apache/geronimo/config/cdi/ConfigInjectionBean$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/geronimo/config/cdi/ConfigInjectionBean$ConfigPropertyLiteral", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
