...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljavax/faces/application/ResourceHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/ResourceHandlerWrapper", "wrapped", "Ljavax/faces/application/ResourceHandler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/ResourceHandlerWrapper", "wrapped", "Ljavax/faces/application/ResourceHandler;");
