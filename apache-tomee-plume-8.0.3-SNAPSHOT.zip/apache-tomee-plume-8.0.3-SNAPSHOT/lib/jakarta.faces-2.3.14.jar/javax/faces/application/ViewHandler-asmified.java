...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/application/ViewHandler", "log", "Ljava/util/logging/Logger;");
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"javax/faces/application/ViewHandler", "javax/faces/context/FacesContext", "javax/faces/context/ExternalContext", "java/util/Map", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("javax.faces.application");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/logging/Logger", "getLogger", "(Ljava/lang/String;)Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/application/ViewHandler", "log", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
