...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljavax/faces/application/ViewHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/ViewHandlerWrapper", "wrapped", "Ljavax/faces/application/ViewHandler;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/ViewHandlerWrapper", "wrapped", "Ljavax/faces/application/ViewHandler;");
