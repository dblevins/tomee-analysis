...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljavax/faces/application/StateManager;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/StateManagerWrapper", "wrapped", "Ljavax/faces/application/StateManager;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/StateManagerWrapper", "wrapped", "Ljavax/faces/application/StateManager;");
