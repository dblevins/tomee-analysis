...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "values", "[Ljavax/faces/application/FacesMessage$Severity;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "_MODIFIABLE_MAP", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Ljavax/faces/application/FacesMessage$Severity;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "severity", "Ljavax/faces/application/FacesMessage$Severity;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/FacesMessage", "severity", "Ljavax/faces/application/FacesMessage$Severity;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/FacesMessage", "summary", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/FacesMessage", "detail", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/application/FacesMessage", "setSummary", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/FacesMessage", "detail", "Ljava/lang/String;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/FacesMessage", "summary", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/FacesMessage", "severity", "Ljavax/faces/application/FacesMessage$Severity;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/application/FacesMessage", "rendered", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/application/FacesMessage", "rendered", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/application/FacesMessage$Severity", "<init>", "(Ljava/lang/String;Ljavax/faces/application/FacesMessage$1;)V", false);
...
methodVisitor.visitTypeInsn(ANEWARRAY, "javax/faces/application/FacesMessage$Severity");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/application/FacesMessage", "SEVERITY_FATAL", "Ljavax/faces/application/FacesMessage$Severity;");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/application/FacesMessage", "values", "[Ljavax/faces/application/FacesMessage$Severity;");
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/application/FacesMessage", "values", "[Ljavax/faces/application/FacesMessage$Severity;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/application/FacesMessage", "_MODIFIABLE_MAP", "Ljava/util/Map;");
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/application/FacesMessage", "_MODIFIABLE_MAP", "Ljava/util/Map;");
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/application/FacesMessage", "values", "[Ljavax/faces/application/FacesMessage$Severity;");
methodVisitor.visitVarInsn(ILOAD, 0);
