...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/model/ResultSetDataModel$ResultSetValues", "Ljava/util/AbstractCollection<Ljava/lang/Object;>;", "java/util/AbstractCollection", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/model/ResultSetDataModel$ResultSetValues", "map", "Ljavax/faces/model/ResultSetDataModel$ResultSetMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ResultSetDataModel$ResultSetValues", "map", "Ljavax/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/model/ResultSetDataModel$ResultSetMap", "containsValue", "(Ljava/lang/Object;)Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "javax/faces/model/ResultSetDataModel$ResultSetValuesIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ResultSetDataModel$ResultSetValues", "map", "Ljavax/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/model/ResultSetDataModel$ResultSetValuesIterator", "<init>", "(Ljavax/faces/model/ResultSetDataModel$ResultSetMap;)V", false);
