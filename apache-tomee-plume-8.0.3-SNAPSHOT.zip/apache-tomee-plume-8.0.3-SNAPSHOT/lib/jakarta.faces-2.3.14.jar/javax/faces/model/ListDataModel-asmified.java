...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/model/ListDataModel", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ListDataModel", "list", "Ljava/util/List;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ListDataModel", "index", "I");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/model/ListDataModel", Opcodes.INTEGER, Opcodes.INTEGER, "[Ljavax/faces/model/DataModelListener;"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/model/ListDataModel", "list", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_M1);
