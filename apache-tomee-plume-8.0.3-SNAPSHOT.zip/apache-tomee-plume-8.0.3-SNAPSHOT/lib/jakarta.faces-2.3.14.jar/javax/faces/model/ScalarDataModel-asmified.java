...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "scalar", "Ljava/lang/Object;", "TE;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ScalarDataModel", "scalar", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ScalarDataModel", "index", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/model/ScalarDataModel", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/model/ScalarDataModel", "scalar", "Ljava/lang/Object;");
Label label1 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/model/ScalarDataModel", Opcodes.INTEGER, Opcodes.INTEGER, "[Ljavax/faces/model/DataModelListener;"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/model/ScalarDataModel", "scalar", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_M1);
