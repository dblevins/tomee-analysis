...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/faces/convert/EnumConverter", null, "java/lang/Object", new String[] { "javax/faces/convert/Converter", "javax/faces/component/PartialStateHolder" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CONVERTER_ID", "Ljava/lang/String;", null, "javax.faces.Enum");
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/EnumConverter", "targetClass", "Ljava/lang/Class;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/EnumConverter", "targetClass", "Ljava/lang/Class;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/convert/EnumConverter", "initialStateMarked", "()Z", false);
Label label1 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/EnumConverter", "isTransient", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/EnumConverter", "isTransient", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/convert/EnumConverter", "initialState", "Z");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/convert/EnumConverter", "initialState", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
