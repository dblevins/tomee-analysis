...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/faces/lifecycle/ClientWindow", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "CLIENT_WINDOW_MODE_PARAM_NAME", "Ljava/lang/String;", null, "javax.faces.CLIENT_WINDOW_MODE");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "PER_USE_CLIENT_WINDOW_URL_QUERY_PARAMETER_DISABLED_KEY", "Ljava/lang/String;", null, "javax.faces.lifecycle.ClientWindowRenderModeEnablement");
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getQueryURLParameters", "(Ljavax/faces/context/FacesContext;)Ljava/util/Map;", "(Ljavax/faces/context/FacesContext;)Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;", null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("javax.faces.lifecycle.ClientWindowRenderModeEnablement");
