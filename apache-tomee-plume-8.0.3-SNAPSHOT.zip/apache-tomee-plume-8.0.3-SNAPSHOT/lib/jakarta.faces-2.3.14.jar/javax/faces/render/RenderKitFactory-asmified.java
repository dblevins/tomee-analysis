...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljavax/faces/render/RenderKitFactory;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/render/RenderKitFactory", "wrapped", "Ljavax/faces/render/RenderKitFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/render/RenderKitFactory", "wrapped", "Ljavax/faces/render/RenderKitFactory;");
