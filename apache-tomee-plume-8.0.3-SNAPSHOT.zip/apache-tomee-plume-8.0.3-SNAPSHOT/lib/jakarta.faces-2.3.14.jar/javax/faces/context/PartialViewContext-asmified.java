...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/faces/context/PartialViewContext", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getPartialResponseWriter", "()Ljavax/faces/context/PartialResponseWriter;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "processPartial", "(Ljavax/faces/event/PhaseId;)V", null, null);
methodVisitor.visitEnd();
}
