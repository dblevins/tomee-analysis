...
classWriter.visitInnerClass("javax/faces/context/FacesContext$1", null, null, ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "defaultFacesContext", "Ljavax/faces/context/FacesContext;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "processingEvents", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "isCreatedFromValidFactory", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "threadInitContext", "Ljava/util/concurrent/ConcurrentHashMap;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "initContextServletContext", "Ljava/util/concurrent/ConcurrentHashMap;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "attributesForInvalidFactoryConstruction", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/Object;Ljava/lang/Object;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "partialViewContextForInvalidFactoryConstruction", "Ljavax/faces/context/PartialViewContext;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "currentPhaseIdForInvalidFactoryConstruction", "Ljavax/faces/event/PhaseId;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "instance", "Ljava/lang/ThreadLocal;", "Ljava/lang/ThreadLocal<Ljavax/faces/context/FacesContext;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/FacesContext", "processingEvents", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/FacesContext", "isCreatedFromValidFactory", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/FacesContext", "partialViewContextForInvalidFactoryConstruction", "Ljavax/faces/context/PartialViewContext;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"javax/faces/context/FacesContext", "java/lang/Thread", "[Ljava/lang/StackTraceElement;", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "defaultFacesContext", "Ljavax/faces/context/FacesContext;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "isCreatedFromValidFactory", "Z");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "attributesForInvalidFactoryConstruction", "Ljava/util/Map;");
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/FacesContext", "attributesForInvalidFactoryConstruction", "Ljava/util/Map;");
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "attributesForInvalidFactoryConstruction", "Ljava/util/Map;");
...
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "partialViewContextForInvalidFactoryConstruction", "Ljavax/faces/context/PartialViewContext;");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label2);
...
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "currentPhaseIdForInvalidFactoryConstruction", "Ljavax/faces/event/PhaseId;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "java/lang/UnsupportedOperationException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/context/FacesContext", "currentPhaseIdForInvalidFactoryConstruction", "Ljavax/faces/event/PhaseId;");
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "java/lang/UnsupportedOperationException");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/context/FacesContext", "processingEvents", "Z");
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/context/FacesContext", "instance", "Ljava/lang/ThreadLocal;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/context/FacesContext", "threadInitContext", "Ljava/util/concurrent/ConcurrentHashMap;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Thread", "currentThread", "()Ljava/lang/Thread;", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/context/FacesContext", "threadInitContext", "Ljava/util/concurrent/ConcurrentHashMap;");
methodVisitor.visitTypeInsn(NEW, "java/util/concurrent/ConcurrentHashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/concurrent/ConcurrentHashMap", "<init>", "(I)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/context/FacesContext", "initContextServletContext", "Ljava/util/concurrent/ConcurrentHashMap;");
methodVisitor.visitTypeInsn(NEW, "javax/faces/context/FacesContext$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/context/FacesContext$1", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/context/FacesContext", "instance", "Ljava/lang/ThreadLocal;");
methodVisitor.visitInsn(RETURN);
