...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/faces/event/ComponentSystemEvent", null, "javax/faces/event/SystemEvent", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/SystemEvent", "<init>", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/SystemEvent", "<init>", "(Ljavax/faces/context/FacesContext;Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/faces/event/ComponentSystemEventListener");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/SystemEvent", "isAppropriateListener", "(Ljavax/faces/event/FacesListener;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 2);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"javax/faces/event/ComponentSystemEvent", "javax/faces/event/FacesListener", "javax/faces/component/UIComponent", "javax/faces/component/UIComponent", Opcodes.INTEGER, "javax/faces/context/FacesContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/SystemEvent", "processListener", "(Ljavax/faces/event/FacesListener;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/event/ComponentSystemEvent", "getSource", "()Ljava/lang/Object;", false);
