...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/faces/component/UIMessages", null, "javax/faces/component/UIComponentBase", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "COMPONENT_TYPE", "Ljava/lang/String;", null, "javax.faces.Messages");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIMessages", "setRendererType", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIMessages", "getStateHelper", "()Ljavax/faces/component/StateHelper;", false);
