...
classWriter.visitInnerClass("javax/faces/component/UIViewAction$InstrumentedFacesContext", "javax/faces/component/UIViewAction", "InstrumentedFacesContext", ACC_PRIVATE);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "UIVIEWACTION_BROADCAST", "Ljava/lang/String;", null, "javax.faces.ViewAction.broadcast");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "UIVIEWACTION_EVENT_COUNT", "Ljava/lang/String;", null, "javax.faces.ViewAction.eventCount");
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "incrementEventCount", "(Ljavax/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitLdcInsn("javax.faces.ViewAction.eventCount");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/Map", "java/lang/Integer"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn("javax.faces.ViewAction.eventCount");
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "decrementEventCountAndReturnTrueIfZero", "(Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewAction", "getPhaseId", "()Ljavax/faces/event/PhaseId;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/event/PhaseId", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLdcInsn("View actions cannot be executed in specified phase: [");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "setIsProcessingUIViewActionBroadcast", "(Ljavax/faces/context/FacesContext;Z)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getAttributes", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLdcInsn("javax.faces.ViewAction.broadcast");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getPhaseId", "()Ljavax/faces/event/PhaseId;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewAction", "getViewRootOf", "(Ljavax/faces/event/FacesEvent;)Ljavax/faces/component/UIViewRoot;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/faces/component/UIViewAction", "$assertionsDisabled", "Z");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/faces/event/ActionListener", Opcodes.INTEGER, "javax/faces/component/UIViewRoot"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "javax/faces/component/UIViewAction$InstrumentedFacesContext");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewAction$InstrumentedFacesContext", "<init>", "(Ljavax/faces/component/UIViewAction;Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewAction", "setIsProcessingUIViewActionBroadcast", "(Ljavax/faces/context/FacesContext;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIViewAction$InstrumentedFacesContext", "disableRenderResponseControl", "()Ljavax/faces/component/UIViewAction$InstrumentedFacesContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIViewAction$InstrumentedFacesContext", "set", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewAction", "decrementEventCountAndReturnTrueIfZero", "(Ljavax/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/faces/component/UIViewAction$InstrumentedFacesContext"}, 0, null);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/UIViewAction$InstrumentedFacesContext", "restore", "()V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/faces/component/UIViewAction", "javax/faces/event/FacesEvent", "javax/faces/context/FacesContext"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/event/ActionEvent", "javax/faces/event/PhaseId"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIViewAction", "incrementEventCount", "(Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getViewRootOf", "(Ljavax/faces/event/FacesEvent;)Ljavax/faces/component/UIViewRoot;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Ljavax/faces/component/UIViewAction;"));
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/faces/component/UIViewAction", "$assertionsDisabled", "Z");
methodVisitor.visitInsn(RETURN);
