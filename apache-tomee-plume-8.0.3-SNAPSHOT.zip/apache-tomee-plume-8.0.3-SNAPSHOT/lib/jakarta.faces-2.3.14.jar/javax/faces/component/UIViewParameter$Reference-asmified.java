...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "saver", "Ljavax/faces/component/StateHolderSaver;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIViewParameter$Reference", "saver", "Ljavax/faces/component/StateHolderSaver;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIViewParameter$Reference", "indexInParent", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/component/UIViewParameter$Reference", "viewIdAtTimeOfConstruction", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIViewParameter$Reference", "viewIdAtTimeOfConstruction", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIViewParameter$Reference", "indexInParent", "I");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/component/UIViewParameter", "javax/faces/component/UIViewRoot"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/component/UIViewParameter$Reference", "saver", "Ljavax/faces/component/StateHolderSaver;");
methodVisitor.visitVarInsn(ALOAD, 1);
