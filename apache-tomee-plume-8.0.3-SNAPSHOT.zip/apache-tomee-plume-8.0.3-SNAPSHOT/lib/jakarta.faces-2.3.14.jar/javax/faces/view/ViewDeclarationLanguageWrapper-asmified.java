...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljavax/faces/view/ViewDeclarationLanguage;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/view/ViewDeclarationLanguageWrapper", "wrapped", "Ljavax/faces/view/ViewDeclarationLanguage;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/view/ViewDeclarationLanguageWrapper", "wrapped", "Ljavax/faces/view/ViewDeclarationLanguage;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/view/ViewDeclarationLanguage", "getId", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
