...
classWriter.visit(V1_8, ACC_SUPER, "javax/faces/validator/MessageFactory$BindingFacesMessage", null, "javax/faces/application/FacesMessage", null);

classWriter.visitInnerClass("javax/faces/validator/MessageFactory$BindingFacesMessage", "javax/faces/validator/MessageFactory", "BindingFacesMessage", ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/validator/MessageFactory$BindingFacesMessage", "locale", "Ljava/util/Locale;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/validator/MessageFactory$BindingFacesMessage", "parameters", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/faces/validator/MessageFactory$BindingFacesMessage", "resolvedParameters", "[Ljava/lang/Object;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"javax/faces/validator/MessageFactory$BindingFacesMessage", "java/util/Locale", "java/lang/String", "java/lang/String", "[Ljava/lang/Object;"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/validator/MessageFactory$BindingFacesMessage", "resolveBindings", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/validator/MessageFactory$BindingFacesMessage", "resolvedParameters", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/validator/MessageFactory$BindingFacesMessage", "getFormattedString", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/validator/MessageFactory$BindingFacesMessage", "parameters", "[Ljava/lang/Object;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/faces/validator/MessageFactory$BindingFacesMessage", "locale", "Ljava/util/Locale;");
Label label2 = new Label();
