...
public class FindConfigResourceURIsTaskDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/config/manager/tasks/FindConfigResourceURIsTask", "Ljava/lang/Object;Ljava/util/concurrent/Callable<Ljava/util/Collection<Ljava/net/URI;>;>;", "java/lang/Object", new String[] { "java/util/concurrent/Callable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "provider", "Lcom/sun/faces/spi/ConfigurationResourceProvider;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "call", "()Ljava/util/Collection;", "()Ljava/util/Collection<Ljava/net/URI;>;", new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/config/manager/tasks/FindConfigResourceURIsTask", "java/util/Collection", "java/util/Iterator", "java/util/Collection", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/manager/tasks/FindConfigResourceURIsTask", "call", "()Ljava/util/Collection;", false);
methodVisitor.visitInsn(ARETURN);
