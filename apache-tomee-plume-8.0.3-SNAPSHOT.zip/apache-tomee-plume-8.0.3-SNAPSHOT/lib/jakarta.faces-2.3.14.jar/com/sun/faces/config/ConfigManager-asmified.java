...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "initializedContexts", "Ljava/util/List;", "Ljava/util/List<Ljavax/servlet/ServletContext;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/ConfigManager;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/ConfigManager;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("com.sun.faces.CONFIG_MANAGER_KEY");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getAnnotatedClasses", "(Ljavax/faces/context/FacesContext;)Ljava/util/Map;", "(Ljavax/faces/context/FacesContext;)Ljava/util/Map<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;Ljava/util/Set<Ljava/lang/Class<*>;>;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "removeInstance", "(Ljavax/servlet/ServletContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("com.sun.faces.CONFIG_MANAGER_KEY");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "initialize", "(Ljavax/servlet/ServletContext;Lcom/sun/faces/config/InitFacesContext;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigManager", "initializeConfigProcessers", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigManager", "useThreads", "(Ljavax/servlet/ServletContext;)Z", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/manager/Documents", "getXMLDocuments", "(Ljavax/servlet/ServletContext;Ljava/util/List;Ljava/util/concurrent/ExecutorService;Z)[Lcom/sun/faces/config/manager/documents/DocumentInfo;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/InitFacesContext", "getExternalContext", "()Ljavax/faces/context/ExternalContext;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/spi/InjectionProviderFactory", "createInstance", "(Ljavax/faces/context/ExternalContext;)Lcom/sun/faces/spi/InjectionProvider;", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigManager", "findAnnotations", "([Lcom/sun/faces/config/manager/documents/DocumentInfo;Lcom/sun/faces/spi/InjectionProvider;Ljavax/servlet/ServletContext;Lcom/sun/faces/config/InitFacesContext;Ljava/util/concurrent/ExecutorService;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/spi/HighAvailabilityEnabler", "enableHighAvailability", "(Ljavax/servlet/ServletContext;)V", true);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitInvokeDynamicInsn("accept", "(JLjava/lang/ClassLoader;Ljavax/servlet/ServletContext;Ljava/lang/Object;Lcom/sun/faces/spi/ThreadContext;Lcom/sun/faces/config/InitFacesContext;[Lcom/sun/faces/config/manager/documents/DocumentInfo;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "com/sun/faces/config/ConfigManager", "lambda$initialize$1", "(JLjava/lang/ClassLoader;Ljavax/servlet/ServletContext;Ljava/lang/Object;Lcom/sun/faces/spi/ThreadContext;Lcom/sun/faces/config/InitFacesContext;[Lcom/sun/faces/config/manager/documents/DocumentInfo;Lcom/sun/faces/config/processor/ConfigProcessor;)V", false), Type.getType("(Lcom/sun/faces/config/processor/ConfigProcessor;)V")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "forEach", "(Ljava/util/function/Consumer;)V", true);
...
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/manager/Documents", "getXMLDocuments", "(Ljavax/servlet/ServletContext;Ljava/util/List;Ljava/util/concurrent/ExecutorService;Z)[Lcom/sun/faces/config/manager/documents/DocumentInfo;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/config/processor/ConfigProcessor", "process", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;[Lcom/sun/faces/config/manager/documents/DocumentInfo;)V", true);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/config/ConfigManager", "javax/servlet/ServletContext", "com/sun/faces/config/InitFacesContext", "java/util/concurrent/ExecutorService"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/config/ConfigManager", "javax/servlet/ServletContext", "com/sun/faces/config/InitFacesContext", "java/util/concurrent/ExecutorService"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/config/ConfigManager", "javax/servlet/ServletContext", "com/sun/faces/config/InitFacesContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/manager/DbfFactory", "removeSchemaMap", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(9, 17);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "hasBeenInitialized", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigManager", "initializedContexts", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "findAnnotations", "([Lcom/sun/faces/config/manager/documents/DocumentInfo;Lcom/sun/faces/spi/InjectionProvider;Ljavax/servlet/ServletContext;Lcom/sun/faces/config/InitFacesContext;Ljava/util/concurrent/ExecutorService;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/manager/tasks/FindAnnotatedConfigClasses", "<init>", "(Ljavax/servlet/ServletContext;Lcom/sun/faces/config/InitFacesContext;Lcom/sun/faces/config/manager/tasks/ProvideMetadataToAnnotationScanTask;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigManager", "pushTaskToContext", "(Ljavax/servlet/ServletContext;Ljava/util/concurrent/Future;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(7, 8);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "pushTaskToContext", "(Ljavax/servlet/ServletContext;Ljava/util/concurrent/Future;)V", "(Ljavax/servlet/ServletContext;Ljava/util/concurrent/Future<Ljava/util/Map<Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;Ljava/util/Set<Ljava/lang/Class<*>;>;>;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/ConfigManager", "ANNOTATIONS_SCAN_TASK_KEY", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "useThreads", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/WebConfiguration", "getInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/WebConfiguration;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "initializeConfigProcessers", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigManager", "configProcessors", "Ljava/util/List;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "stream", "()Ljava/util/stream/Stream;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getConfigPopulators", "()Ljava/util/List;", "()Ljava/util/List<Ljavax/faces/application/ApplicationConfigurationPopulator;>;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/InitFacesContext", "getELContext", "()Ljavax/el/ELContext;", false);
Label label0 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/el/ELContext", "putContext", "(Ljava/lang/Class;Ljava/lang/Object;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/config/ConfigManager", "javax/faces/context/FacesContext", "javax/faces/application/Application", "javax/el/ELContext", "javax/el/ExpressionFactory"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/config/ConfigManager", "javax/faces/context/FacesContext", "javax/faces/application/Application", "javax/el/ELContext", "javax/el/ExpressionFactory", "javax/faces/component/UIViewRoot", "[Ljavax/el/ELContextListener;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "com/sun/faces/config/InitFacesContext");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/config/ConfigManager", "javax/faces/context/FacesContext", "javax/faces/application/Application"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "com/sun/faces/config/ConfigManager", "lambda$destroy$4", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Lcom/sun/faces/config/processor/ConfigProcessor;)V", false), Type.getType("(Lcom/sun/faces/config/processor/ConfigProcessor;)V")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "forEach", "(Ljava/util/function/Consumer;)V", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigManager", "initializedContexts", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$destroy$4", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Lcom/sun/faces/config/processor/ConfigProcessor;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/config/processor/ConfigProcessor", "destroy", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$getConfigPopulators$3", "(Ljava/util/List;Ljavax/faces/application/ApplicationConfigurationPopulator;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "add", "(Ljava/lang/Object;)Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$initializeConfigProcessers$2", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Lcom/sun/faces/config/processor/ConfigProcessor;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/config/processor/ConfigProcessor", "initializeClassMetadataMap", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/InitFacesContext", "getInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/InitFacesContext;", false);
methodVisitor.visitVarInsn(ASTORE, 11);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$initialize$0", "(Ljavax/servlet/ServletContext;Lcom/sun/faces/config/InitFacesContext;[Lcom/sun/faces/config/manager/documents/DocumentInfo;Lcom/sun/faces/config/processor/ConfigProcessor;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
