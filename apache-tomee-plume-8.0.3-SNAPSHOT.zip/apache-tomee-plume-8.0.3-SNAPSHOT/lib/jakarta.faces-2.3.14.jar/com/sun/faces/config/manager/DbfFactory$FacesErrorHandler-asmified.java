...
public class DbfFactory$FacesErrorHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/config/manager/DbfFactory$FacesErrorHandler", null, "java/lang/Object", new String[] { "org/xml/sax/ErrorHandler" });
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lcom/sun/faces/config/manager/DbfFactory$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/manager/DbfFactory$FacesErrorHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 2);
methodVisitor.visitEnd();
}
