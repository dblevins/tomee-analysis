...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getClassMetadataMap", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/application/ApplicationInstanceFactoryMetadataMap;", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/application/ApplicationInstanceFactoryMetadataMap<Ljava/lang/String;Ljava/lang/Object;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "initializeClassMetadataMap", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/processor/AbstractConfigProcessor", "getClassMetadataMap", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/application/ApplicationInstanceFactoryMetadataMap;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "findRootType", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Lorg/w3c/dom/Node;[Ljava/lang/Class;)Ljava/lang/Class;", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Lorg/w3c/dom/Node;[Ljava/lang/Class<*>;)Ljava/lang/Class<*>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/processor/AbstractConfigProcessor", "loadClass", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
...
Label label5 = new Label();
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/config/processor/AbstractConfigProcessor", "javax/servlet/ServletContext", "javax/faces/context/FacesContext", "java/lang/String", "org/w3c/dom/Node", "[Ljava/lang/Class;", "java/lang/Class", "[Ljava/lang/Class;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/config/processor/AbstractConfigProcessor", "javax/servlet/ServletContext", "javax/faces/context/FacesContext", "java/lang/String", "org/w3c/dom/Node", "[Ljava/lang/Class;"}, 0, new Object[] {});
Label label6 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createInstance", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Lorg/w3c/dom/Node;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/processor/AbstractConfigProcessor", "createInstance", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;Lorg/w3c/dom/Node;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(7, 5);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createInstance", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;Lorg/w3c/dom/Node;)Ljava/lang/Object;", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Class<*>;Ljava/lang/Object;Lorg/w3c/dom/Node;)Ljava/lang/Object;", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/processor/AbstractConfigProcessor", "createInstance", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;Lorg/w3c/dom/Node;Z[Z)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createInstance", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Object;Lorg/w3c/dom/Node;Z[Z)Ljava/lang/Object;", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Class<*>;Ljava/lang/Object;Lorg/w3c/dom/Node;Z[Z)Ljava/lang/Object;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitTryCatchBlock(label6, label7, label11, "javax/faces/FacesException");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "destroyInstance", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Object;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/config/processor/AbstractConfigProcessor", "javax/servlet/ServletContext", "javax/faces/context/FacesContext", "java/lang/String", "java/lang/Object", "com/sun/faces/application/ApplicationInstanceFactoryMetadataMap", "com/sun/faces/spi/InjectionProvider"}, 1, new Object[] {"com/sun/faces/spi/InjectionProviderException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/processor/AbstractConfigProcessor", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "loadClass", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Class;)Ljava/lang/Class;", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Class<*>;)Ljava/lang/Class<*>;", new String[] { "java/lang/ClassNotFoundException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/processor/AbstractConfigProcessor", "isDevModeEnabled", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)Z", false);
Label label4 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "processAnnotations", "(Ljavax/faces/context/FacesContext;Ljava/lang/Class;)V", "(Ljavax/faces/context/FacesContext;Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/annotation/AnnotationManager", "applyConfigAnnotations", "(Ljavax/faces/context/FacesContext;Ljava/lang/Class;Ljava/util/Set;)V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "isDevModeEnabled", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/processor/AbstractConfigProcessor", "getProjectStage", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)Ljavax/faces/application/ProjectStage;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getProjectStage", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)Ljavax/faces/application/ProjectStage;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/config/processor/AbstractConfigProcessor", "javax/servlet/ServletContext", "javax/faces/context/FacesContext", "java/lang/String", "javax/faces/application/ProjectStage", "com/sun/faces/config/WebConfiguration", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
