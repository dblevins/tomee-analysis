...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/config/ConfigureListener", null, "java/lang/Object", new String[] { "javax/servlet/ServletRequestListener", "javax/servlet/http/HttpSessionListener", "javax/servlet/ServletRequestAttributeListener", "javax/servlet/http/HttpSessionAttributeListener", "javax/servlet/ServletContextAttributeListener", "javax/servlet/ServletContextListener" });
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/servlet/ServletContext", "com/sun/faces/util/Timer"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigManager", "getInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/ConfigManager;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label7);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigManager", "createInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/ConfigManager;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"com/sun/faces/config/ConfigManager"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/ConfigManager", "hasBeenInitialized", "(Ljavax/servlet/ServletContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigureListener", "getServletContextIdentifier", "(Ljavax/servlet/ServletContext;)Ljava/lang/String;", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigureListener$WebXmlProcessor", "<init>", "(Ljavax/servlet/ServletContext;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "log", "(Ljava/util/logging/Level;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/WebConfiguration", "clear", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/ConfigManager", "destroy", "(Ljavax/servlet/ServletContext;Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigManager", "removeInstance", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/WebappLifecycleListener", "<init>", "(Ljavax/servlet/ServletContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "contextInitialized", "(Ljavax/servlet/ServletContextEvent;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/ConfigManager", "initialize", "(Ljavax/servlet/ServletContext;Lcom/sun/faces/config/InitFacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigureListener", "initConfigMonitoring", "(Ljavax/servlet/ServletContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/ConfigureListener", "registerELResolverAndListenerWithJsp", "(Ljavax/servlet/ServletContext;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/el/ELUtils", "getDefaultExpressionFactory", "(Lcom/sun/faces/application/ApplicationAssociate;Ljavax/faces/context/FacesContext;)Ljavax/el/ExpressionFactory;", false);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitVarInsn(ALOAD, 12);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"com/sun/faces/application/ApplicationAssociate", "javax/el/ELContext", "javax/el/ExpressionFactory"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/InitFacesContext", "setELContext", "(Ljavax/el/ELContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/mgbean/BeanManager", "create", "(Ljava/lang/String;Ljavax/faces/context/FacesContext;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/websocket/server/ServerContainer"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 13);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContextEvent", "javax/servlet/ServletContext", "com/sun/faces/util/Timer", "com/sun/faces/config/ConfigManager", "com/sun/faces/config/InitFacesContext", "java/lang/Object", "com/sun/faces/config/ConfigureListener$WebXmlProcessor", "java/lang/Throwable"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/WebConfiguration", "getInstanceWithoutCreating", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/WebConfiguration;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "log", "(Ljava/util/logging/Level;Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/servlet/ServletContext", "com/sun/faces/config/ConfigManager"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigureListener", "getInitFacesContext", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/InitFacesContext;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label9 = new Label();
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "contextDestroyed", "(Ljavax/servlet/ServletContextEvent;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitLabel(label11);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/ApplicationAssociate", "clearInstance", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitJumpInsn(GOTO, label23);
methodVisitor.visitLabel(label22);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContextEvent", "javax/servlet/ServletContext", "com/sun/faces/config/ConfigManager", "com/sun/faces/config/InitFacesContext", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/ConfigureListener", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "WARNING", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label19);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContextEvent", "javax/servlet/ServletContext", "com/sun/faces/config/ConfigManager", "com/sun/faces/config/InitFacesContext"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "requestDestroyed", "(Ljavax/servlet/ServletRequestEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "requestInitialized", "(Ljavax/servlet/ServletRequestEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "sessionCreated", "(Ljavax/servlet/http/HttpSessionEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "sessionDestroyed", "(Ljavax/servlet/http/HttpSessionEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "attributeRemoved", "(Ljavax/servlet/ServletRequestAttributeEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "attributeReplaced", "(Ljavax/servlet/ServletRequestAttributeEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "attributeRemoved", "(Ljavax/servlet/http/HttpSessionBindingEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "attributeReplaced", "(Ljavax/servlet/http/HttpSessionBindingEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "attributeRemoved", "(Ljavax/servlet/ServletContextAttributeEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/ConfigureListener", "webAppListener", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebappLifecycleListener", "attributeReplaced", "(Ljavax/servlet/ServletContextAttributeEvent;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "initConfigMonitoring", "(Ljavax/servlet/ServletContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigureListener$WebConfigResourceMonitor", "<init>", "(Lcom/sun/faces/config/ConfigureListener;Ljavax/servlet/ServletContext;Ljava/util/Collection;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "reload", "(Ljavax/servlet/ServletContext;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/ApplicationAssociate", "clearInstance", "(Ljavax/faces/context/ExternalContext;)V", false);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/ApplicationAssociate", "setCurrentInstance", "(Lcom/sun/faces/application/ApplicationAssociate;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigManager", "getInstance", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/ConfigManager;", false);
...
methodVisitor.visitLabel(label19);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext", "javax/faces/context/FacesContext", "com/sun/faces/config/ConfigManager"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/ConfigureListener", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitJumpInsn(GOTO, label21);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(GOTO, label23);
methodVisitor.visitLabel(label22);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/context/FacesContext", "com/sun/faces/config/ConfigManager"}, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/ConfigureListener", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label23);
...
methodVisitor.visitJumpInsn(GOTO, label21);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label5);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/config/InitFacesContext");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitLabel(label24);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable", "javax/faces/context/FacesContext", "com/sun/faces/config/ConfigManager"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/ConfigureListener", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label21);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/application/WebappLifecycleListener");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isJspTwoOne", "(Ljavax/servlet/ServletContext;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/servlet/jsp/JspFactory;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "registerELResolverAndListenerWithJsp", "(Ljavax/servlet/ServletContext;Z)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(IFNE, label3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigureListener", "isJspTwoOne", "(Ljavax/servlet/ServletContext;)Z", false);
Label label4 = new Label();
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/WebConfiguration$WebContextInitParameter", "ExpressionFactory", "Lcom/sun/faces/config/WebConfiguration$WebContextInitParameter;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/WebConfiguration", "getOptionValue", "(Lcom/sun/faces/config/WebConfiguration$WebContextInitParameter;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigureListener", "installExpressionFactory", "(Ljavax/servlet/ServletContext;Ljava/lang/String;)Z", false);
Label label5 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/ApplicationAssociate", "setExpressionFactory", "(Ljavax/el/ExpressionFactory;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/servlet/jsp/JspApplicationContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "installExpressionFactory", "(Ljavax/servlet/ServletContext;Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/ApplicationAssociate", "setExpressionFactory", "(Ljavax/el/ExpressionFactory;)V", false);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/el/ExpressionFactory", "com/sun/faces/application/ApplicationAssociate"}, 0, null);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext", "java/lang/String"}, 1, new Object[] {"java/lang/ReflectiveOperationException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/ConfigureListener", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getInitFacesContext", "(Ljavax/servlet/ServletContext;)Lcom/sun/faces/config/InitFacesContext;", null, null);
methodVisitor.visitCode();
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/config/ConfigureListener", "javax/servlet/ServletContext", "java/util/Map", "java/util/Set", "com/sun/faces/config/InitFacesContext", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$200", "(Ljavax/servlet/ServletContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/ConfigureListener", "getServletContextIdentifier", "(Ljavax/servlet/ServletContext;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$700", "(Lcom/sun/faces/config/ConfigureListener;Ljavax/servlet/ServletContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/ConfigureListener", "reload", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
