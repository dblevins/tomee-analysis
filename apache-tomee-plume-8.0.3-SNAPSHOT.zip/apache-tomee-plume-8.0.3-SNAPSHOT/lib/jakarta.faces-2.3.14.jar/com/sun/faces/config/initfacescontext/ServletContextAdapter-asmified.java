...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/config/initfacescontext/ServletContextAdapter", null, "jakarta/faces/context/ExternalContext", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/config/initfacescontext/ServletContextAdapter", "servletContext", "Ljakarta/servlet/ServletContext;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/config/WebConfiguration$BooleanWebContextInitParameter", "EnableTransitionTimeNoOpFlash", "Lcom/sun/faces/config/WebConfiguration$BooleanWebContextInitParameter;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/config/initfacescontext/ServletContextAdapter", "jakarta/servlet/ServletContext", "java/lang/String"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/initfacescontext/ServletContextAdapter", "servletContext", "Ljakarta/servlet/ServletContext;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/context/ExternalContext", "getFlash", "()Ljakarta/faces/context/Flash;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
