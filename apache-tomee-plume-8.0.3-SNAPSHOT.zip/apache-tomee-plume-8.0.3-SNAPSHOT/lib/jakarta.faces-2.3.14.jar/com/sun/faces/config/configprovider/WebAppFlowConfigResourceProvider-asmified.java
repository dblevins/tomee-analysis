...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/configprovider/WebAppFlowConfigResourceProvider", "inspectDirectory", "(Ljakarta/servlet/ServletContext;Ljava/lang/String;Ljava/util/List;)Ljava/util/List;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "inspectDirectory", "(Ljakarta/servlet/ServletContext;Ljava/lang/String;Ljava/util/List;)Ljava/util/List;", "(Ljakarta/servlet/ServletContext;Ljava/lang/String;Ljava/util/List<Ljava/net/URI;>;)Ljava/util/List<Ljava/net/URI;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "log", "(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/config/configprovider/WebAppFlowConfigResourceProvider", "jakarta/servlet/ServletContext", "java/lang/String", "java/util/List", "java/net/URL", "java/util/Set", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
