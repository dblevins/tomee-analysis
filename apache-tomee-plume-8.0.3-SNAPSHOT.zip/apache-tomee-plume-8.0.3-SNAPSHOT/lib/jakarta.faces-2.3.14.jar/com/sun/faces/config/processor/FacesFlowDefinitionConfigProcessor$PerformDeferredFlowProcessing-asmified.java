...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor$PerformDeferredFlowProcessing", null, "java/lang/Object", new String[] { "jakarta/faces/event/SystemEventListener" });
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/event/SystemEvent", "getFacesContext", "()Ljakarta/faces/context/FacesContext;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor", "access$100", "(Lcom/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor;Ljakarta/faces/context/FacesContext;)Ljava/util/List;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor", "access$200", "(Lcom/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor;Ljakarta/faces/context/FacesContext;Ljava/net/URI;Lorg/w3c/dom/Document;)V", false);
methodVisitor.visitLabel(label1);
Label label5 = new Label();
methodVisitor.visitJumpInsn(GOTO, label5);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor$PerformDeferredFlowProcessing", "jakarta/faces/event/SystemEvent", "jakarta/faces/context/FacesContext", "java/util/Iterator", "com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor$FlowDefinitionDocument"}, 1, new Object[] {"javax/xml/xpath/XPathExpressionException"});
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor$PerformDeferredFlowProcessing", "this$0", "Lcom/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor", "access$300", "(Lcom/sun/faces/config/processor/FacesFlowDefinitionConfigProcessor;Ljakarta/faces/context/FacesContext;)V", false);
methodVisitor.visitInsn(RETURN);
