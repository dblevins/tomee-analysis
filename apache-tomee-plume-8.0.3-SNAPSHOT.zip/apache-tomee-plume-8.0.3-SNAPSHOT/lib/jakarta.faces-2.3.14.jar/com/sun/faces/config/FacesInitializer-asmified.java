...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/config/FacesInitializer", null, "java/lang/Object", new String[] { "jakarta/servlet/ServletContainerInitializer" });
...
annotationVisitor1.visit(null, Type.getType("Ljakarta/faces/view/facelets/FaceletsResourceResolver;"));
...
annotationVisitor1.visit(null, Type.getType("Ljakarta/faces/annotation/FacesConfig;"));
...
annotationVisitor1.visit(null, Type.getType("Ljakarta/faces/event/PhaseListener;"));
annotationVisitor1.visit(null, Type.getType("Ljakarta/faces/render/Renderer;"));
annotationVisitor1.visit(null, Type.getType("Ljakarta/annotation/Resource;"));
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/FacesInitializer", "appMayHaveSomeJsfContent", "(Ljava/util/Set;Ljakarta/servlet/ServletContext;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/FacesInitializer", "getExistingFacesServletRegistration", "(Ljakarta/servlet/ServletContext;)Ljakarta/servlet/ServletRegistration;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/FacesInitializer", "handleMappingConcerns", "(Ljakarta/servlet/ServletContext;)V", false);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"com/sun/faces/config/InitFacesContext"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/FacesInitializer", "handleWebSocketConcerns", "(Ljakarta/servlet/ServletContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "appMayHaveSomeJsfContent", "(Ljava/util/Set;Ljakarta/servlet/ServletContext;)Z", "(Ljava/util/Set<Ljava/lang/Class<*>;>;Ljakarta/servlet/ServletContext;)Z", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "handleMappingConcerns", "(Ljakarta/servlet/ServletContext;)V", null, new String[] { "jakarta/servlet/ServletException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/config/FacesInitializer", "getExistingFacesServletRegistration", "(Ljakarta/servlet/ServletContext;)Ljakarta/servlet/ServletRegistration;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getExistingFacesServletRegistration", "(Ljakarta/servlet/ServletContext;)Ljakarta/servlet/ServletRegistration;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "handleWebSocketConcerns", "(Ljakarta/servlet/ServletContext;)V", null, new String[] { "jakarta/servlet/ServletException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/config/FacesInitializer", "jakarta/servlet/ServletContext", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label3);
