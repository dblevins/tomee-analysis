...
public class DbfFactory$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "com/sun/faces/config/manager/DbfFactory$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("com/sun/faces/config/manager/DbfFactory", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$com$sun$faces$config$manager$DbfFactory$FacesSchema", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/config/manager/DbfFactory$FacesSchema", "values", "()[Lcom/sun/faces/config/manager/DbfFactory$FacesSchema;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/config/manager/DbfFactory$1", "$SwitchMap$com$sun$faces$config$manager$DbfFactory$FacesSchema", "[I");
