...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/el/PropertyResolverImpl", null, "jakarta/faces/el/PropertyResolver", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/faces/el/PropertyResolver;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/el/PropertyResolverImpl", "delegate", "Ljakarta/faces/el/PropertyResolver;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/el/PropertyNotFoundException", "<init>", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/el/PropertyResolverImpl", "java/lang/Object", Opcodes.INTEGER, "java/lang/Object", "jakarta/faces/context/FacesContext", "java/lang/Class"}, 1, new Object[] {"java/lang/ArrayIndexOutOfBoundsException"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setDelegate", "(Ljakarta/faces/el/PropertyResolver;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/el/PropertyResolverImpl", "delegate", "Ljakarta/faces/el/PropertyResolver;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "assertInput", "(Ljava/lang/Object;Ljava/lang/Object;)V", null, new String[] { "jakarta/faces/el/PropertyNotFoundException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "assertInput", "(Ljava/lang/Object;I)V", null, new String[] { "jakarta/faces/el/PropertyNotFoundException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
