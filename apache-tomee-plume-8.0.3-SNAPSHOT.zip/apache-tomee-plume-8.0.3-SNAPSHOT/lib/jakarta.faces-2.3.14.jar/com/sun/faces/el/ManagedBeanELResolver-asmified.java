...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/el/ManagedBeanELResolver", null, "jakarta/el/ELResolver", null);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/el/ManagedBeanELResolver", "resolveBean", "(Ljakarta/el/ELContext;Ljava/lang/Object;Z)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/context/FacesContext", "com/sun/faces/mgbean/BeanManager"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/el/ManagedBeanELResolver", "jakarta/el/ELContext", "java/lang/Object", "jakarta/faces/context/FacesContext", "com/sun/faces/mgbean/BeanManager", "java/util/Map", "java/util/List"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveBean", "(Ljakarta/el/ELContext;Ljava/lang/Object;Z)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/el/ManagedBeanELResolver", "getBeanManager", "()Lcom/sun/faces/mgbean/BeanManager;", false);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/el/ManagedBeanELResolver", "jakarta/el/ELContext", "java/lang/Object", Opcodes.INTEGER, "java/lang/Object", "com/sun/faces/mgbean/BeanManager", "java/lang/String", "com/sun/faces/mgbean/BeanBuilder", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext"}, 0, new Object[] {});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/mgbean/BeanManager", "getBeanFromScope", "(Ljava/lang/String;Lcom/sun/faces/mgbean/BeanBuilder;Ljakarta/faces/context/FacesContext;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label4 = new Label();
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/el/ManagedBeanELResolver", "jakarta/el/ELContext", "java/lang/Object", Opcodes.INTEGER, "java/lang/Object", "com/sun/faces/mgbean/BeanManager", "java/lang/String", "com/sun/faces/mgbean/BeanBuilder", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext"}, 2, new Object[] {"jakarta/el/ELContext", Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/el/ELContext", "setPropertyResolved", "(Z)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/el/ManagedBeanELResolver", "jakarta/el/ELContext", "java/lang/Object", Opcodes.INTEGER, "java/lang/Object", "com/sun/faces/mgbean/BeanManager"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
