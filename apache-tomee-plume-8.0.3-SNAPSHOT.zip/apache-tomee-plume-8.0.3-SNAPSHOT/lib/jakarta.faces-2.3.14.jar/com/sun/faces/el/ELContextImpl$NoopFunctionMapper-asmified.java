...
public class ELContextImpl$NoopFunctionMapperDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lcom/sun/faces/el/ELContextImpl$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/el/ELContextImpl$NoopFunctionMapper", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
