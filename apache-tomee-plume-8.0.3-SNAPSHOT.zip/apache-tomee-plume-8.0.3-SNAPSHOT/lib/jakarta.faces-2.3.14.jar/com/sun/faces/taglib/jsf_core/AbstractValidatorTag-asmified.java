...
public class AbstractValidatorTagDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", null, "jakarta/faces/webapp/ValidatorELTag", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(8941293586160549920L));
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "validatorId", "Ljakarta/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", "binding", "Ljakarta/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", "validatorId", "Ljakarta/el/ValueExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", "validatorId", "Ljakarta/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", "binding", "Ljakarta/el/ValueExpression;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "createValidator", "(Ljakarta/el/ValueExpression;Ljakarta/el/ValueExpression;Ljakarta/faces/context/FacesContext;)Ljakarta/faces/validator/Validator;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/el/ELContext", "jakarta/faces/validator/Validator"}, 0, null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", "LOGGER", "Ljava/util/logging/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"jakarta/el/ValueExpression", "jakarta/el/ValueExpression", "jakarta/faces/context/FacesContext", "jakarta/el/ELContext", "jakarta/faces/validator/Validator"}, 6, new Object[] {"java/util/logging/Logger", "java/util/logging/Level", "java/lang/String", "[Ljava/lang/Object;", "[Ljava/lang/Object;", Opcodes.INTEGER});
methodVisitor.visitLdcInsn("");
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"jakarta/el/ValueExpression", "jakarta/el/ValueExpression", "jakarta/faces/context/FacesContext", "jakarta/el/ELContext", "jakarta/faces/validator/Validator"}, 7, new Object[] {"java/util/logging/Logger", "java/util/logging/Level", "java/lang/String", "[Ljava/lang/Object;", "[Ljava/lang/Object;", Opcodes.INTEGER, "java/lang/Object"});
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/taglib/jsf_core/AbstractValidatorTag", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
