...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/taglib/jsf_core/AbstractConverterTag", null, "javax/faces/webapp/ConverterELTag", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "binding", "Ljavax/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "converterId", "Ljavax/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/AbstractConverterTag", "binding", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/AbstractConverterTag", "converterId", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/AbstractConverterTag", "converterId", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/AbstractConverterTag", "binding", "Ljavax/el/ValueExpression;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "createConverter", "(Ljavax/el/ValueExpression;Ljavax/el/ValueExpression;Ljavax/faces/context/FacesContext;)Ljavax/faces/convert/Converter;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/el/ELContext", "javax/faces/convert/Converter"}, 0, null);
