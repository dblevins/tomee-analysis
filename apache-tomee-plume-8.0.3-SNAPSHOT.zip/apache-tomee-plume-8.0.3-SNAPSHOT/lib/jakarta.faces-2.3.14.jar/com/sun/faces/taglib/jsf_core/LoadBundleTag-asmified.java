...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/taglib/jsf_core/LoadBundleTag", null, "jakarta/servlet/jsp/tagext/TagSupport", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "basenameExpression", "Ljakarta/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setBasename", "(Ljakarta/el/ValueExpression;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag", "basenameExpression", "Ljakarta/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag", "basenameExpression", "Ljakarta/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag", "var", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/taglib/jsf_core/LoadBundleTag", "createNewLoadBundleComponent", "(Ljava/lang/String;Ljava/util/Map;)Ljakarta/faces/component/UIComponent;", false);
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/taglib/jsf_core/LoadBundleTag", "getParentUIComponentTag", "()Ljakarta/faces/webapp/UIComponentClassicTagBase;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/taglib/jsf_core/LoadBundleTag", "jakarta/faces/context/FacesContext", "java/lang/String", "java/util/ResourceBundle", "java/util/Map", "jakarta/faces/context/ExternalContext", "jakarta/faces/component/UIComponent", "jakarta/faces/webapp/UIComponentClassicTagBase"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 7);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "addChildToParentTagAndParentComponent", "(Ljakarta/faces/component/UIComponent;Ljakarta/faces/webapp/UIComponentClassicTagBase;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"jakarta/faces/component/UIComponent", "jakarta/faces/webapp/UIComponentClassicTagBase", "java/lang/reflect/Method"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getPreViewLoadBundleComponentList", "()Ljava/util/List;", "()Ljava/util/List<Ljakarta/faces/component/UIComponent;>;", null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/context/FacesContext", "getCurrentInstance", "()Ljakarta/faces/context/FacesContext;", false);
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/context/FacesContext", "java/util/Map", "java/util/List"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createNewLoadBundleComponent", "(Ljava/lang/String;Ljava/util/Map;)Ljakarta/faces/component/UIComponent;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getParentUIComponentTag", "()Ljakarta/faces/webapp/UIComponentClassicTagBase;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/taglib/jsf_core/LoadBundleTag", "getParent", "()Ljakarta/servlet/jsp/tagext/Tag;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
Label label0 = new Label();
methodVisitor.visitLabel(label0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/faces/webapp/UIComponentClassicTagBase");
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/webapp/UIComponentClassicTagBase", "java/util/Stack"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
