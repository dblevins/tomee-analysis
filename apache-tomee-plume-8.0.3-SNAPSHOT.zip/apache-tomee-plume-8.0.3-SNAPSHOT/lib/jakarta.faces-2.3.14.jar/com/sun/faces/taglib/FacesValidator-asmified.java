...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "com/sun/faces/taglib/FacesValidator", null, "jakarta/servlet/jsp/tagext/TagLibraryValidator", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "validate", "(Ljava/lang/String;Ljava/lang/String;Ljakarta/servlet/jsp/tagext/PageData;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"[Ljakarta/servlet/jsp/tagext/ValidationMessage;", "org/xml/sax/helpers/DefaultHandler"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/taglib/FacesValidator", "vmFromString", "(Ljava/lang/String;)[Ljakarta/servlet/jsp/tagext/ValidationMessage;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
