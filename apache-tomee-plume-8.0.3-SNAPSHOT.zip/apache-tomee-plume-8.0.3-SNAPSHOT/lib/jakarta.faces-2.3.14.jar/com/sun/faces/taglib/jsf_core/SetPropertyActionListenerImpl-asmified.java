...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", null, "java/lang/Object", new String[] { "javax/faces/event/ActionListener", "javax/faces/component/StateHolder" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "source", "Ljavax/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", "target", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", "source", "Ljavax/el/ValueExpression;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", "source", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", "target", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/faces/context/FacesContext", "javax/el/ELContext", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", "target", "Ljavax/el/ValueExpression;");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/taglib/jsf_core/SetPropertyActionListenerImpl", "javax/faces/event/ActionEvent", "javax/faces/context/FacesContext", "javax/el/ELContext"}, 1, new Object[] {"javax/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitTypeInsn(NEW, "javax/faces/event/AbortProcessingException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/event/AbortProcessingException", "<init>", "(Ljava/lang/Throwable;)V", false);
