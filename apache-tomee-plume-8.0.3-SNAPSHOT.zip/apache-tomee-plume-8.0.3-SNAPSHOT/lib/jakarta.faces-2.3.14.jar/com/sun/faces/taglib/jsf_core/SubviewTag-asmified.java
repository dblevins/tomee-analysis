...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/taglib/jsf_core/SubviewTag", null, "javax/faces/webapp/UIComponentELTag", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/taglib/jsf_core/SubviewTag", "getFacesContext", "()Ljavax/faces/context/FacesContext;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getViewTagStack", "()Ljava/util/Stack;", "()Ljava/util/Stack<Ljavax/faces/webapp/UIComponentClassicTagBase;>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/faces/context/FacesContext", "java/util/Map", "java/util/Stack"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
