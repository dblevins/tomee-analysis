...
public class LoadBundleTag$LoadBundleComponentDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/taglib/jsf_core/LoadBundleTag$LoadBundleComponent", null, "javax/faces/component/UIComponentBase", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "toStore", "Ljava/util/Map;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;Ljava/util/Map;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIComponentBase", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag$LoadBundleComponent", "var", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag$LoadBundleComponent", "toStore", "Ljava/util/Map;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag$LoadBundleComponent", "var", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/taglib/jsf_core/LoadBundleTag$LoadBundleComponent", "toStore", "Ljava/util/Map;");
...
methodVisitor.visitLdcInsn("LoadBundleComponent: var: ");
