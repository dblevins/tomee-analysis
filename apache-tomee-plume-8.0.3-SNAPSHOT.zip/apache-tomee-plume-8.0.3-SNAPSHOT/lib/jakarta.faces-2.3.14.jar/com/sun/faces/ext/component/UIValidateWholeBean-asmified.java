...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/ext/component/UIValidateWholeBean", null, "javax/faces/component/UIInput", new String[] { "javax/faces/component/PartialStateHolder" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "addValidator", "(Ljavax/faces/validator/Validator;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIInput", "addValidator", "(Ljavax/faces/validator/Validator;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/ext/component/UIValidateWholeBean", "wholeBeanValidationEnabled", "(Ljavax/faces/context/FacesContext;)Z", false);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/ext/component/UIValidateWholeBean", "addValidator", "(Ljavax/faces/validator/Validator;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIInput", "validate", "(Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/faces/component/UIForm;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/ext/component/UIValidateWholeBean", "getClosestParent", "(Ljavax/faces/component/UIComponent;Ljava/lang/Class;)Ljavax/faces/component/UIComponent;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/ext/component/UIValidateWholeBean", "misplacedComponentCheck", "(Ljavax/faces/component/UIComponent;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "misplacedComponentCheck", "(Ljavax/faces/component/UIComponent;Ljava/lang/String;)V", null, new String[] { "java/lang/IllegalArgumentException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljava/lang/String;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "com/sun/faces/ext/component/UIValidateWholeBean", "lambda$misplacedComponentCheck$0", "(Ljava/lang/String;Ljavax/faces/component/UIComponent;)V", false), Type.getType("(Ljavax/faces/component/UIComponent;)V")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getClosestParent", "(Ljavax/faces/component/UIComponent;Ljava/lang/Class;)Ljavax/faces/component/UIComponent;", "<C:Ljavax/faces/component/UIComponent;>(Ljavax/faces/component/UIComponent;Ljava/lang/Class<TC;>;)TC;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/ext/component/UIValidateWholeBean", "getStateHelper", "()Ljavax/faces/component/StateHelper;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "wholeBeanValidationEnabled", "(Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIInput", "restoreState", "(Ljavax/faces/context/FacesContext;Ljava/lang/Object;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$misplacedComponentCheck$0", "(Ljava/lang/String;Ljavax/faces/component/UIComponent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
