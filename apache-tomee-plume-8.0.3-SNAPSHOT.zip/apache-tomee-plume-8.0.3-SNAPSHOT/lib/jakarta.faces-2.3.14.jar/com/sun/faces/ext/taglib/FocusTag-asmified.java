...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/ext/taglib/FocusTag", null, "jakarta/faces/webapp/UIComponentELTag", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "forID", "Ljakarta/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/ext/taglib/FocusTag", "forID", "Ljakarta/el/ValueExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/ext/taglib/FocusTag", "forID", "Ljakarta/el/ValueExpression;");
