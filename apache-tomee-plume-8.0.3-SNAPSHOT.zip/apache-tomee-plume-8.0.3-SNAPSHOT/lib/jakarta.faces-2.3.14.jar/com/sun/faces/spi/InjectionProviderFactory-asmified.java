...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createInstance", "(Ljakarta/faces/context/ExternalContext;)Lcom/sun/faces/spi/InjectionProvider;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/spi/InjectionProviderFactory", "findProviderClass", "(Ljakarta/faces/context/ExternalContext;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/spi/InjectionProviderFactory", "getProviderInstance", "(Ljava/lang/String;Ljakarta/faces/context/ExternalContext;)Lcom/sun/faces/spi/InjectionProvider;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getProviderInstance", "(Ljava/lang/String;Ljakarta/faces/context/ExternalContext;)Lcom/sun/faces/spi/InjectionProvider;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"java/lang/String", "jakarta/faces/context/ExternalContext", "com/sun/faces/spi/InjectionProvider", "java/lang/Class"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
