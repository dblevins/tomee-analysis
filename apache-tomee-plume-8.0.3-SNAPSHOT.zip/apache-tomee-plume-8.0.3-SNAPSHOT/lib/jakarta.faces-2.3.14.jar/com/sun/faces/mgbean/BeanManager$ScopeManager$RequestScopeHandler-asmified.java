...
public class BeanManager$ScopeManager$RequestScopeHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/mgbean/BeanManager$ScopeManager$RequestScopeHandler", null, "java/lang/Object", new String[] { "com/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/mgbean/BeanManager$ScopeManager$RequestScopeHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
