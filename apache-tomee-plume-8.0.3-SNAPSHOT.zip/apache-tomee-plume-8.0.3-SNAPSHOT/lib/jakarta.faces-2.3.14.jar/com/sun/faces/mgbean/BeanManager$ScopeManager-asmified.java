...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "pushToScope", "(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljakarta/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/mgbean/BeanManager$ScopeManager", "getScopeHandler", "(Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Lcom/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler", "handle", "(Ljava/lang/String;Ljava/lang/Object;Ljakarta/faces/context/FacesContext;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 5);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "isInScope", "(Ljava/lang/String;Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/mgbean/BeanManager$ScopeManager", "getScopeHandler", "(Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Lcom/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler", "isInScope", "(Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Z", true);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(3, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getFromScope", "(Ljava/lang/String;Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/mgbean/BeanManager$ScopeManager", "getScopeHandler", "(Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Lcom/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler", "getFromScope", "(Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getScopeHandler", "(Ljava/lang/String;Ljakarta/faces/context/FacesContext;)Lcom/sun/faces/mgbean/BeanManager$ScopeManager$ScopeHandler;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/mgbean/BeanManager$ScopeManager$CustomScopeHandler", "<init>", "(Ljakarta/el/ValueExpression;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/mgbean/BeanManager$ScopeManager", "handlerMap", "Ljava/util/concurrent/ConcurrentMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
