...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "EMPTY_EL_CTX_LIST_ARRAY", "[Ljavax/el/ELContextListener;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "elContextListeners", "Ljava/util/List;", "Ljava/util/List<Ljavax/el/ELContextListener;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "elResolvers", "Ljavax/el/CompositeELResolver;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "elResolvers", "Ljavax/el/CompositeELResolver;");
...
methodVisitor.visitTypeInsn(ANEWARRAY, "javax/el/ELContextListener");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/el/ELContextListener;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "EMPTY_EL_CTX_LIST_ARRAY", "[Ljavax/el/ELContextListener;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "elResolvers", "Ljavax/el/CompositeELResolver;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "associate", "Lcom/sun/faces/application/ApplicationAssociate;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/ApplicationAssociate", "getExpressionFactory", "()Ljavax/el/ExpressionFactory;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "associate", "Lcom/sun/faces/application/ApplicationAssociate;");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/el/ELUtils", "getDelegatePR", "(Lcom/sun/faces/application/ApplicationAssociate;Z)Ljavax/faces/el/PropertyResolver;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/el/PropertyResolverImpl", "setDelegate", "(Ljavax/faces/el/PropertyResolver;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "associate", "Lcom/sun/faces/application/ApplicationAssociate;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/ApplicationAssociate", "setLegacyPropertyResolver", "(Ljavax/faces/el/PropertyResolver;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/el/PropertyResolverImpl");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/el/PropertyResolverImpl", "<init>", "()V", false);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "javax/faces/el/ReferenceSyntaxException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/el/ReferenceSyntaxException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/faces/context/FacesContext", "getCurrentInstance", "()Ljavax/faces/context/FacesContext;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/el/ReferenceSyntaxException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/application/applicationimpl/ExpressionLanguage", "java/lang/String", Opcodes.TOP, "javax/faces/context/FacesContext"}, 1, new Object[] {"javax/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitTypeInsn(NEW, "javax/faces/el/ReferenceSyntaxException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/application/applicationimpl/ExpressionLanguage", "java/lang/String", "javax/el/ValueExpression", "javax/faces/context/FacesContext"}, 0, new Object[] {});
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "associate", "Lcom/sun/faces/application/ApplicationAssociate;");
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/el/ELUtils", "getDelegateVR", "(Lcom/sun/faces/application/ApplicationAssociate;Z)Ljavax/faces/el/VariableResolver;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/el/VariableResolverImpl", "setDelegate", "(Ljavax/faces/el/VariableResolver;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "associate", "Lcom/sun/faces/application/ApplicationAssociate;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/ApplicationAssociate", "setLegacyVariableResolver", "(Ljavax/faces/el/VariableResolver;)V", false);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
Label label0 = new Label();
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "javax/el/ELContextListener");
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/application/applicationimpl/ExpressionLanguage", "EMPTY_EL_CTX_LIST_ARRAY", "[Ljavax/el/ELContextListener;");
methodVisitor.visitInsn(RETURN);
