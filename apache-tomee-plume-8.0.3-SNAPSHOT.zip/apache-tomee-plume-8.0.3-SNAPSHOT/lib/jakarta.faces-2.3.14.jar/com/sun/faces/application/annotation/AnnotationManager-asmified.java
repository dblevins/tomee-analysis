...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyConfigAnnotations", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Class;Ljava/util/Set;)V", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Class<+Ljava/lang/annotation/Annotation;>;Ljava/util/Set<+Ljava/lang/Class;>;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/application/annotation/ConfigAnnotationHandler", "push", "(Ljakarta/faces/context/FacesContext;)V", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyBehaviorAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/behavior/Behavior;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/AnnotationManager", "applyAnnotations", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Class;Lcom/sun/faces/application/annotation/AnnotationManager$ProcessingTarget;[Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/annotation/AnnotationManager", "applyClientBehaviorRendererAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/render/ClientBehaviorRenderer;)V", false);
methodVisitor.visitLabel(label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyClientBehaviorRendererAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/render/ClientBehaviorRenderer;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyComponentAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyValidatorAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/validator/Validator;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyConverterAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/convert/Converter;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applyRendererAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/render/Renderer;Ljakarta/faces/component/UIComponent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "applySystemEventAnnotations", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/SystemEvent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/application/annotation/RuntimeAnnotationHandler", "apply", "(Ljakarta/faces/context/FacesContext;[Ljava/lang/Object;)V", true);
