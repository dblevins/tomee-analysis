...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/application/InjectionApplicationFactory", null, "javax/faces/application/ApplicationFactory", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_VOLATILE, "application", "Ljavax/faces/application/Application;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/InjectionApplicationFactory", "application", "Ljavax/faces/application/Application;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/InjectionApplicationFactory", "getWrapped", "()Ljavax/faces/application/ApplicationFactory;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/InjectionApplicationFactory", "application", "Ljavax/faces/application/Application;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/InjectionApplicationFactory", "application", "Ljavax/faces/application/Application;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "setApplication", "(Ljavax/faces/application/Application;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/InjectionApplicationFactory", "application", "Ljavax/faces/application/Application;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/InjectionApplicationFactory", "defaultApplication", "Ljavax/faces/application/Application;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/InjectionApplicationFactory", "removeApplicationInstance", "(Ljava/util/Map;)Ljavax/faces/application/Application;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/InjectionApplicationFactory", "defaultApplication", "Ljavax/faces/application/Application;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/application/InjectionApplicationFactory", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
methodVisitor.visitLdcInsn("Unable to find private field named 'defaultApplication' in javax.faces.application.Application.");
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "setApplicationInstance", "(Ljavax/faces/application/Application;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/faces/context/FacesContext", "getCurrentInstance", "()Ljavax/faces/context/FacesContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getExternalContext", "()Ljavax/faces/context/ExternalContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ExternalContext", "getApplicationMap", "()Ljava/util/Map;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "removeApplicationInstance", "(Ljava/util/Map;)Ljavax/faces/application/Application;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)Ljavax/faces/application/Application;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lcom/sun/faces/application/InjectionApplicationFactory;"));
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Class", "getName", "()Ljava/lang/String;", false);
