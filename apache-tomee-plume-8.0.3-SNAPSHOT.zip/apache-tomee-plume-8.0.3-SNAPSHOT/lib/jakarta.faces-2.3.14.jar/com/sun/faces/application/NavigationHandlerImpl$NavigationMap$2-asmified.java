...
public class NavigationHandlerImpl$NavigationMap$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/NavigationHandlerImpl$NavigationMap$2", "Ljava/util/AbstractSet<Ljava/lang/String;>;", "java/util/AbstractSet", null);

classWriter.visitOuterClass("com/sun/faces/application/NavigationHandlerImpl$NavigationMap", "keySet", "()Ljava/util/Set;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/NavigationHandlerImpl$NavigationMap$2", "this$0", "Lcom/sun/faces/application/NavigationHandlerImpl$NavigationMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/application/NavigationHandlerImpl$NavigationMap$2$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/NavigationHandlerImpl$NavigationMap$2$1", "<init>", "(Lcom/sun/faces/application/NavigationHandlerImpl$NavigationMap$2;)V", false);
