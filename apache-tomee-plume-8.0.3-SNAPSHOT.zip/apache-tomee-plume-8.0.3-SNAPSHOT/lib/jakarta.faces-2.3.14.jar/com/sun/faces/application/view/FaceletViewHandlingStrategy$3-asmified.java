...
public class FaceletViewHandlingStrategy$3Dump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lcom/sun/faces/application/view/FaceletViewHandlingStrategy;Ljava/util/List;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/FaceletViewHandlingStrategy$3", "this$0", "Lcom/sun/faces/application/view/FaceletViewHandlingStrategy;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/FaceletViewHandlingStrategy$3", "val$found", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 0);
