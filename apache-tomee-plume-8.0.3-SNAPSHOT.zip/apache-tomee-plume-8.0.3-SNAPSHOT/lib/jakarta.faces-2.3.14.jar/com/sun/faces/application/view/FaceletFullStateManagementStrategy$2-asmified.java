...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/view/FaceletFullStateManagementStrategy$2", null, "java/lang/Object", new String[] { "javax/faces/component/visit/VisitCallback" });

classWriter.visitOuterClass("com/sun/faces/application/view/FaceletFullStateManagementStrategy", "restoreComponentState", "(Ljavax/faces/context/FacesContext;Ljava/util/HashMap;)V");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lcom/sun/faces/application/view/FaceletFullStateManagementStrategy;Ljavax/faces/context/FacesContext;Ljava/util/HashMap;Lcom/sun/faces/context/StateContext;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/FaceletFullStateManagementStrategy$2", "val$context", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/FaceletFullStateManagementStrategy$2", "val$context", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/application/view/FaceletFullStateManagementStrategy$2", "javax/faces/component/visit/VisitContext", "javax/faces/component/UIComponent", "javax/faces/component/visit/VisitResult", "java/lang/String", "java/lang/Object", Opcodes.INTEGER}, 0, new Object[] {});
