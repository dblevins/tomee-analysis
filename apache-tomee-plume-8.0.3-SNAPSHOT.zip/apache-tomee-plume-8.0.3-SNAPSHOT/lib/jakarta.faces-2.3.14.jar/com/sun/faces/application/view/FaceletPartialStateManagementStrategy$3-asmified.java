...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy$3", null, "java/lang/Object", new String[] { "javax/faces/component/visit/VisitCallback" });

classWriter.visitOuterClass("com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "saveView", "(Ljavax/faces/context/FacesContext;)Ljava/lang/Object;");
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lcom/sun/faces/application/view/FaceletPartialStateManagementStrategy;Lcom/sun/faces/context/StateContext;Ljavax/faces/context/FacesContext;Ljava/util/Map;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy$3", "val$finalContext", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy$3", "val$finalContext", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 2);
