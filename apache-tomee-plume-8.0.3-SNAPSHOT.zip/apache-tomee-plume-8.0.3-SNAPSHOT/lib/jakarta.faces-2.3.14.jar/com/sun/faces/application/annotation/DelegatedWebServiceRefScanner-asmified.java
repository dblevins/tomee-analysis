...
public class DelegatedWebServiceRefScannerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/annotation/DelegatedWebServiceRefScanner", null, "java/lang/Object", new String[] { "com/sun/faces/application/annotation/Scanner" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/application/annotation/WebServiceRefScanner");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/WebServiceRefScanner", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/annotation/DelegatedWebServiceRefScanner", "delegate", "Lcom/sun/faces/application/annotation/Scanner;");
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"com/sun/faces/application/annotation/DelegatedWebServiceRefScanner"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/DelegatedWebServiceRefScanner", "delegate", "Lcom/sun/faces/application/annotation/Scanner;");
Label label0 = new Label();
