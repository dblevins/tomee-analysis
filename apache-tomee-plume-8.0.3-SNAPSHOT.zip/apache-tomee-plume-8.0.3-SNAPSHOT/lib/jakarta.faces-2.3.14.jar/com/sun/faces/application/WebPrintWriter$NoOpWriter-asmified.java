...
public class WebPrintWriter$NoOpWriterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/WebPrintWriter$NoOpWriter", null, "java/io/Writer", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebPrintWriter$NoOpWriter", "append", "(C)Ljava/io/Writer;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebPrintWriter$NoOpWriter", "append", "(Ljava/lang/CharSequence;II)Ljava/io/Writer;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/WebPrintWriter$NoOpWriter", "append", "(Ljava/lang/CharSequence;)Ljava/io/Writer;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
