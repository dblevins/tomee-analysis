...
public class WebappLifecycleListener$ActiveSessionsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/WebappLifecycleListener$ActiveSessions", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lcom/sun/faces/application/WebappLifecycleListener;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lcom/sun/faces/application/WebappLifecycleListener;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/WebappLifecycleListener$ActiveSessions", "this$0", "Lcom/sun/faces/application/WebappLifecycleListener;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/WebappLifecycleListener$ActiveSessions", "activeSessions", "Ljava/util/List;");
