...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", null, "jakarta/faces/view/StateManagementStrategy", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "jakarta/faces/context/FacesContext", "jakarta/faces/component/UIComponent", "java/lang/String", "java/util/List", "jakarta/faces/component/UIComponent"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "restoreDynamicActions", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/StateContext;Ljava/util/Map;)V", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/StateContext;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINEST", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "restoreDynamicAdd", "(Ljakarta/faces/context/FacesContext;Ljava/util/Map;Lcom/sun/faces/util/ComponentStruct;)V", false);
methodVisitor.visitLabel(label3);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "restoreDynamicRemove", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/util/ComponentStruct;)V", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "locateComponentByClientId", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljava/lang/String;)Ljakarta/faces/component/UIComponent;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "restoreDynamicActions", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/StateContext;Ljava/util/Map;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/context/StateContext", "setTrackViewModifications", "(Z)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "saveDynamicActions", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/StateContext;Ljava/util/Map;)V", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/StateContext;Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINEST", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "jakarta/faces/context/FacesContext", "com/sun/faces/context/StateContext", "java/util/Map", "java/util/List", "java/util/HashMap", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy$3", "<init>", "(Lcom/sun/faces/application/view/FaceletPartialStateManagementStrategy;Lcom/sun/faces/context/StateContext;Ljakarta/faces/context/FacesContext;Ljava/util/Map;)V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIViewRoot", "visitTree", "(Ljakarta/faces/component/visit/VisitContext;Ljakarta/faces/component/visit/VisitCallback;)Z", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/FaceletPartialStateManagementStrategy", "saveDynamicActions", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/StateContext;Ljava/util/Map;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
