...
public class ByteArrayWebOutputStream$DirectByteArrayOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/ByteArrayWebOutputStream$DirectByteArrayOutputStream", null, "java/io/ByteArrayOutputStream", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/ByteArrayWebOutputStream$DirectByteArrayOutputStream", "buf", "[B");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/ByteArrayWebOutputStream$DirectByteArrayOutputStream", "count", "I");
