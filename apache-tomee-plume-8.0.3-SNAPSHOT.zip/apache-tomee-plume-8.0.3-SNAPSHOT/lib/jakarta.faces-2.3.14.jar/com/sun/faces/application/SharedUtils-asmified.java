...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/SharedUtils", null, "java/lang/Object", null);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/SharedUtils", "isExpression", "(Ljava/lang/String;)Z", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/SharedUtils", "evaluateExpressions", "(Ljakarta/faces/context/FacesContext;Ljava/util/List;)Ljava/util/List;", false);
