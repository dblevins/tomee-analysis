...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInputStream", "(Lcom/sun/faces/application/resource/ResourceInfo;Ljavax/faces/context/FacesContext;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/resource/ResourceHelper", "getInputStreamFromClientInfo", "(Lcom/sun/faces/application/resource/ClientResourceInfo;Ljavax/faces/context/FacesContext;)Ljava/io/InputStream;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getInputStreamFromClientInfo", "(Lcom/sun/faces/application/resource/ClientResourceInfo;Ljavax/faces/context/FacesContext;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/resource/ResourceHelper", "clientAcceptsCompression", "(Ljavax/faces/context/FacesContext;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label39);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/application/resource/ResourceHelper", "com/sun/faces/application/resource/ClientResourceInfo", "javax/faces/context/FacesContext", "java/io/InputStream"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/resource/ResourceHelper", "getNonCompressedInputStream", "(Lcom/sun/faces/application/resource/ResourceInfo;Ljavax/faces/context/FacesContext;)Ljava/io/InputStream;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/resource/ResourceHelper$ELEvaluatingInputStream", "<init>", "(Ljavax/faces/context/FacesContext;Lcom/sun/faces/application/resource/ClientResourceInfo;Ljava/io/InputStream;)V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/io/BufferedInputStream", "<init>", "(Ljava/io/InputStream;)V", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/application/resource/ResourceHelper", "com/sun/faces/application/resource/ClientResourceInfo", "javax/faces/context/FacesContext", "java/io/InputStream", "[B", "java/io/InputStream", "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/application/resource/ResourceHelper", "com/sun/faces/application/resource/ClientResourceInfo", "javax/faces/context/FacesContext", "java/io/InputStream", "[B"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label39);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getURL", "(Lcom/sun/faces/application/resource/ResourceInfo;Ljavax/faces/context/FacesContext;)Ljava/net/URL;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "findLibrary", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljavax/faces/context/FacesContext;)Lcom/sun/faces/application/resource/LibraryInfo;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "findResource", "(Lcom/sun/faces/application/resource/LibraryInfo;Ljava/lang/String;Ljava/lang/String;ZLjavax/faces/context/FacesContext;)Lcom/sun/faces/application/resource/ResourceInfo;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLastModified", "(Lcom/sun/faces/application/resource/ResourceInfo;Ljavax/faces/context/FacesContext;)J", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "getNonCompressedInputStream", "(Lcom/sun/faces/application/resource/ResourceInfo;Ljavax/faces/context/FacesContext;)Ljava/io/InputStream;", null, new String[] { "java/io/IOException" });
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "clientAcceptsCompression", "(Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"com/sun/faces/application/resource/ResourceHelper", "javax/faces/context/FacesContext", "javax/faces/context/ExternalContext", "java/lang/Object", "[Ljava/lang/String;", Opcodes.INTEGER, "[Ljava/lang/String;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 8);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "resourceSupportsEL", "(Ljava/lang/String;Ljava/lang/String;Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getExternalContext", "()Ljavax/faces/context/ExternalContext;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
