...
public class WebServiceRefScannerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/annotation/WebServiceRefScanner", null, "java/lang/Object", new String[] { "com/sun/faces/application/annotation/Scanner" });
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"com/sun/faces/application/annotation/WebServiceRefHandler", "java/util/ArrayList", "jakarta/xml/ws/WebServiceRef"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "java/util/ArrayList");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/ArrayList", "<init>", "()V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/application/annotation/WebServiceRefScanner", "java/lang/Class", "com/sun/faces/application/annotation/WebServiceRefHandler", "java/util/ArrayList", "jakarta/xml/ws/WebServiceRef", "java/util/ArrayList", "java/util/ArrayList", "[Ljava/lang/reflect/Field;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"com/sun/faces/application/annotation/WebServiceRefScanner", "java/lang/Class", "com/sun/faces/application/annotation/WebServiceRefHandler", "java/util/ArrayList", "jakarta/xml/ws/WebServiceRef", "java/util/ArrayList", "java/util/ArrayList", "java/util/ArrayList", "java/util/ArrayList", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/application/annotation/WebServiceRefHandler");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/xml/ws/WebServiceRef");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/xml/ws/WebServiceRef;");
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/xml/ws/WebServiceRef;");
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/xml/ws/WebServiceRef;");
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/xml/ws/WebServiceRef;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/WebServiceRefHandler", "<init>", "([Ljava/lang/reflect/Field;[Ljakarta/xml/ws/WebServiceRef;[Ljava/lang/reflect/Method;[Ljakarta/xml/ws/WebServiceRef;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
