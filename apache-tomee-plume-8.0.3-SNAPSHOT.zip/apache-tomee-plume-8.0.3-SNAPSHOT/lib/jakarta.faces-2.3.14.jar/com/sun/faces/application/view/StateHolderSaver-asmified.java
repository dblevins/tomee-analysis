...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/view/StateHolderSaver", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(4866548262845392093L));
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/StateHolderSaver", "className", "Ljava/lang/String;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IF_ACMPNE, label0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/StateHolderSaver", "savedState", "Ljava/io/Serializable;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/application/view/StateHolderSaver$StateHolderTupleIndices", "ordinal", "()I", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/StateHolderSaver", "className", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/StateHolderSaver", "savedState", "Ljava/io/Serializable;");
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/application/view/StateHolderSaver", "javax/faces/context/FacesContext", "java/lang/Object"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/application/view/StateHolderSaver", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/io/Serializable;"}, 2, new Object[] {"[Ljava/io/Serializable;", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(GETSTATIC, "java/lang/Boolean", "FALSE", "Ljava/lang/Boolean;");
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/application/view/StateHolderSaver", "javax/faces/context/FacesContext", "java/lang/Object", "[Ljava/io/Serializable;"}, 3, new Object[] {"[Ljava/io/Serializable;", Opcodes.INTEGER, "java/lang/Boolean"});
methodVisitor.visitInsn(AASTORE);
...
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/StateHolderSaver", "className", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/view/StateHolderSaver", "loadClass", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
