...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/ViewHandlerImpl$WriteBehindStateWriter", "context", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/ViewHandlerImpl$WriteBehindStateWriter", "context", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/application/ViewHandlerImpl$WriteBehindStateWriter", "javax/faces/application/StateManager", "javax/faces/context/ResponseWriter"}, 2, new Object[] {label0, label0});
methodVisitor.visitIntInsn(SIPUSH, 128);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/application/ViewHandlerImpl$WriteBehindStateWriter", "javax/faces/application/StateManager", "javax/faces/context/ResponseWriter"}, 3, new Object[] {label0, label0, Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/io/FastStringWriter", "<init>", "(I)V", false);
