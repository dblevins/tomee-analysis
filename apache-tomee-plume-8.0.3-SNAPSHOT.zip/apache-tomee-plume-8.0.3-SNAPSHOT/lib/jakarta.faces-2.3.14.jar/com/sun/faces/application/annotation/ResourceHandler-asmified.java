...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/annotation/ResourceHandler", null, "com/sun/faces/application/annotation/JndiHandler", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/ResourceHandler", "fields", "[Ljava/lang/reflect/Field;");
...
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/ResourceHandler", "methods", "[Ljava/lang/reflect/Method;");
methodVisitor.visitInsn(ARRAYLENGTH);
