...
public class PersistenceContextScannerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/annotation/PersistenceContextScanner", null, "java/lang/Object", new String[] { "com/sun/faces/application/annotation/Scanner" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/application/annotation/PersistenceContextScanner", "java/lang/Class", "com/sun/faces/application/annotation/PersistenceContextHandler", "java/util/ArrayList", "java/util/ArrayList", "[Ljava/lang/reflect/Field;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/application/annotation/PersistenceContextScanner", "java/lang/Class", "com/sun/faces/application/annotation/PersistenceContextHandler", "java/util/ArrayList", "java/util/ArrayList", "java/util/ArrayList", "java/util/ArrayList", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/application/annotation/PersistenceContextHandler");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/persistence/PersistenceContext");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/persistence/PersistenceContext;");
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/persistence/PersistenceContext;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/PersistenceContextHandler", "<init>", "([Ljava/lang/reflect/Method;[Ljakarta/persistence/PersistenceContext;[Ljava/lang/reflect/Field;[Ljakarta/persistence/PersistenceContext;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
