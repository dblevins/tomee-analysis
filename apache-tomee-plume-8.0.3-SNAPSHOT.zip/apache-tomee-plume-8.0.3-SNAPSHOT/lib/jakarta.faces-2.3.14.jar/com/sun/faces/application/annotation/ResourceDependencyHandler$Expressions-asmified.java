...
{
fieldVisitor = classWriter.visitField(0, "nameExpression", "Ljavax/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "libraryExpression", "Ljavax/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "targetExpression", "Ljavax/el/ValueExpression;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(0, "getName", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "nameExpression", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "nameExpression", "Ljavax/el/ValueExpression;");
...
{
methodVisitor = classWriter.visitMethod(0, "getLibrary", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "libraryExpression", "Ljavax/el/ValueExpression;");
...
methodVisitor.visitLdcInsn(Type.getType("Ljava/lang/String;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/el/ELUtils", "createValueExpression", "(Ljava/lang/String;Ljava/lang/Class;)Ljavax/el/ValueExpression;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "libraryExpression", "Ljavax/el/ValueExpression;");
...
{
methodVisitor = classWriter.visitMethod(0, "getTarget", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "targetExpression", "Ljavax/el/ValueExpression;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn(Type.getType("Ljava/lang/String;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/el/ELUtils", "createValueExpression", "(Ljava/lang/String;Ljava/lang/Class;)Ljavax/el/ValueExpression;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "targetExpression", "Ljavax/el/ValueExpression;");
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/annotation/ResourceDependencyHandler$Expressions", "targetExpression", "Ljavax/el/ValueExpression;");
