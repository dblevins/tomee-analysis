...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/application/view/WriteBehindStateWriter", "context", "Ljakarta/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/WriteBehindStateWriter", "context", "Ljakarta/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/view/WriteBehindStateWriter", "getState", "(Ljakarta/faces/application/StateManager;Ljakarta/faces/context/ResponseWriter;)Ljava/lang/StringBuilder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getState", "(Ljakarta/faces/application/StateManager;Ljakarta/faces/context/ResponseWriter;)Ljava/lang/StringBuilder;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/io/FastStringWriter");
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/application/view/WriteBehindStateWriter", "jakarta/faces/application/StateManager", "jakarta/faces/context/ResponseWriter"}, 2, new Object[] {label0, label0});
methodVisitor.visitIntInsn(SIPUSH, 128);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/application/view/WriteBehindStateWriter", "jakarta/faces/application/StateManager", "jakarta/faces/context/ResponseWriter"}, 3, new Object[] {label0, label0, Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/io/FastStringWriter", "<init>", "(I)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/application/view/WriteBehindStateWriter", "context", "Ljakarta/faces/context/FacesContext;");
