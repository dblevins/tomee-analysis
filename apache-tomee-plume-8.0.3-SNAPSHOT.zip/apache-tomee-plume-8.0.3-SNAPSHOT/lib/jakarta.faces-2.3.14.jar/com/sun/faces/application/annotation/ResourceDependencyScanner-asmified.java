...
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/faces/application/ResourceDependency");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/ResourceDependencyHandler", "<init>", "([Ljakarta/faces/application/ResourceDependency;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"com/sun/faces/application/annotation/ResourceDependencyHandler", "jakarta/faces/application/ResourceDependency"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
