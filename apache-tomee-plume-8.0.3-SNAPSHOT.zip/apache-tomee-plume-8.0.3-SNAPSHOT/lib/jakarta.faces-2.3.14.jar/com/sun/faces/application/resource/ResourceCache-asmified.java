...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/config/WebConfiguration", "getServletContext", "()Ljavax/servlet/ServletContext;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/resource/ResourceCache", "getServletContextIdentifier", "(Ljavax/servlet/ServletContext;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getServletContextIdentifier", "(Ljavax/servlet/ServletContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
