...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "javax/ejb/EJB");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/ejb/EJB;");
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/ejb/EJB;");
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/ejb/EJB;");
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/ejb/EJB;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/EJBHandler", "<init>", "([Ljava/lang/reflect/Field;[Ljavax/ejb/EJB;[Ljava/lang/reflect/Method;[Ljavax/ejb/EJB;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
