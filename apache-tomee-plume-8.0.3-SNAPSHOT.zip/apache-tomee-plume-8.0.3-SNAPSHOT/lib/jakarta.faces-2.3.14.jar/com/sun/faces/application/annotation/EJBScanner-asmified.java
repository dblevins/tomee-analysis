...
public class EJBScannerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/application/annotation/EJBScanner", null, "java/lang/Object", new String[] { "com/sun/faces/application/annotation/Scanner" });
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/application/annotation/EJBScanner", "java/lang/Class", "com/sun/faces/application/annotation/EJBHandler", "java/util/ArrayList", "java/util/ArrayList", "[Ljava/lang/reflect/Field;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/application/annotation/EJBScanner", "java/lang/Class", "com/sun/faces/application/annotation/EJBHandler", "java/util/ArrayList", "java/util/ArrayList", "java/util/ArrayList", "java/util/ArrayList", "[Ljava/lang/reflect/Method;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/application/annotation/EJBHandler");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/ejb/EJB");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "toArray", "([Ljava/lang/Object;)[Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/ejb/EJB;");
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/ejb/EJB;");
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/ejb/EJB;");
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljakarta/ejb/EJB;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/application/annotation/EJBHandler", "<init>", "([Ljava/lang/reflect/Field;[Ljakarta/ejb/EJB;[Ljava/lang/reflect/Method;[Ljakarta/ejb/EJB;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
