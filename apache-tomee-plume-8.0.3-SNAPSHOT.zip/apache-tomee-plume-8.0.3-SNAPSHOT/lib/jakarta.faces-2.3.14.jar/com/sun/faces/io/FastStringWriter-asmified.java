...
public class FastStringWriterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/io/FastStringWriter", null, "java/io/Writer", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/io/FastStringWriter", "builder", "Ljava/lang/StringBuilder;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/io/FastStringWriter", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ILOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/io/FastStringWriter", "builder", "Ljava/lang/StringBuilder;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitVarInsn(ILOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBuffer", "()Ljava/lang/StringBuilder;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/io/FastStringWriter", "builder", "Ljava/lang/StringBuilder;");
