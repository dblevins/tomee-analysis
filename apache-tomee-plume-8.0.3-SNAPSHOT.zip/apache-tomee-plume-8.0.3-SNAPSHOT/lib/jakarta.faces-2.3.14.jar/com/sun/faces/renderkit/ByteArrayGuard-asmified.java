...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "encrypt", "(Ljavax/faces/context/FacesContext;[B)[B", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/ByteArrayGuard", "getSecretKey", "(Ljavax/faces/context/FacesContext;)Ljavax/crypto/SecretKey;", false);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/renderkit/ByteArrayGuard", "javax/faces/context/FacesContext", "[B", "[B"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/ByteArrayGuard", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "decrypt", "(Ljavax/faces/context/FacesContext;[B)[B", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"com/sun/faces/renderkit/ByteArrayGuard", "javax/faces/context/FacesContext", "[B", "[B", "[B", "[B", "javax/crypto/spec/IvParameterSpec", "javax/crypto/SecretKey", "javax/crypto/Cipher", "javax/crypto/Mac", "[B"}, 0, new Object[] {});
methodVisitor.visitFieldInsn(GETSTATIC, "java/lang/System", "err", "Ljava/io/PrintStream;");
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/renderkit/ByteArrayGuard", "javax/faces/context/FacesContext", "[B"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "java/lang/System", "err", "Ljava/io/PrintStream;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getSecretKey", "(Ljavax/faces/context/FacesContext;)Ljavax/crypto/SecretKey;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/ByteArrayGuard", "sk", "Ljavax/crypto/SecretKey;");
methodVisitor.visitVarInsn(ASTORE, 2);
