...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", null, "jakarta/faces/component/UISelectItem", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UISelectItem", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getSelectItem", "()Ljakarta/faces/model/SelectItem;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", "selectItem", "Ljakarta/faces/model/SelectItem;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", "getFacesContext", "()Ljakarta/faces/context/FacesContext;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", "getParent", "()Ljakarta/faces/component/UIComponent;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", "jakarta/faces/context/FacesContext", "jakarta/faces/component/UISelectOne", "java/util/List", "jakarta/faces/component/UIComponent", "com/sun/faces/renderkit/SelectItemsIterator", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/SelectItemsIterator", "next", "()Ljakarta/faces/model/SelectItem;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", "selectItem", "Ljakarta/faces/model/SelectItem;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/html_basic/RadioRenderer$GroupSelectItem", "getSelectItem", "()Ljakarta/faces/model/SelectItem;", false);
