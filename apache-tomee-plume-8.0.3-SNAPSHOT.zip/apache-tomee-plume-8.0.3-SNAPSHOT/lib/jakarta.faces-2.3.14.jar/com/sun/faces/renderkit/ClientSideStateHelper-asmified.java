...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ClientSideStateHelper", "doWriteState", "(Ljavax/faces/context/FacesContext;Ljava/lang/Object;Ljava/io/Writer;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ClientSideStateHelper", "writeClientWindowField", "(Ljavax/faces/context/FacesContext;Ljavax/faces/context/ResponseWriter;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ClientSideStateHelper", "writeRenderKitIdField", "(Ljavax/faces/context/FacesContext;Ljavax/faces/context/ResponseWriter;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getState", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/Object;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/ClientSideStateHelper", "getStateParamValue", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ClientSideStateHelper", "doGetState", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doGetState", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ByteArrayGuard", "decrypt", "(Ljavax/faces/context/FacesContext;[B)[B", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream", "[B", "[B", "java/lang/Object"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream", Opcodes.LONG}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/ClientSideStateHelper", "LOGGER", "Ljava/util/logging/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream", Opcodes.LONG, "java/io/IOException", "java/lang/Object"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream", Opcodes.LONG, "java/lang/Object", "java/lang/Object", "java/lang/Object"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream"}, 1, new Object[] {"java/io/OptionalDataException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/ClientSideStateHelper", "LOGGER", "Ljava/util/logging/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream"}, 1, new Object[] {"java/lang/ClassNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/ClientSideStateHelper", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream"}, 1, new Object[] {"java/io/InvalidClassException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 6);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream", "java/io/InvalidClassException", "java/lang/Object"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/ClientSideStateHelper", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINEST", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/ClientSideStateHelper", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/String", "java/io/ObjectInputStream", "java/io/InputStream"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "doWriteState", "(Ljavax/faces/context/FacesContext;Ljava/lang/Object;Ljava/io/Writer;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ByteArrayGuard", "encrypt", "(Ljavax/faces/context/FacesContext;[B)[B", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label22);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label23);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/renderkit/ClientSideStateHelper", "javax/faces/context/FacesContext", "java/lang/Object", "java/io/Writer", "java/io/ByteArrayOutputStream", "java/io/OutputStream", "java/io/ObjectOutputStream"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 13);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/renderkit/ClientSideStateHelper", "getState", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label1);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
