...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/renderkit/html_basic/AjaxBehaviorRenderer", null, "jakarta/faces/render/ClientBehaviorRenderer", null);
...
methodVisitor.visitLdcInsn("Instance of jakarta.faces.component.behavior.AjaxBehavior required: ");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/faces/component/behavior/AjaxBehavior");
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/html_basic/AjaxBehaviorRenderer", "buildAjaxCommand", "(Ljakarta/faces/component/behavior/ClientBehaviorContext;Ljakarta/faces/component/behavior/AjaxBehavior;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/html_basic/AjaxBehaviorRenderer", "createEvent", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/behavior/AjaxBehavior;)Ljakarta/faces/event/AjaxBehaviorEvent;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createEvent", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/behavior/AjaxBehavior;)Ljakarta/faces/event/AjaxBehaviorEvent;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/event/AjaxBehaviorEvent", "<init>", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/behavior/Behavior;)V", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/html_basic/AjaxBehaviorRenderer", "isImmediate", "(Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/behavior/AjaxBehavior;)Z", false);
Label label0 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/faces/event/AjaxBehaviorEvent"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isImmediate", "(Ljakarta/faces/component/UIComponent;Ljakarta/faces/component/behavior/AjaxBehavior;)Z", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "buildAjaxCommand", "(Ljakarta/faces/component/behavior/ClientBehaviorContext;Ljakarta/faces/component/behavior/AjaxBehavior;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/behavior/AjaxBehavior", "isResetValuesSet", "()Z", false);
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Collection", "jakarta/faces/component/behavior/ClientBehaviorContext$Parameter", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/faces/component/html/HtmlCommandScript"});
methodVisitor.visitVarInsn(ASTORE, 14);
methodVisitor.visitVarInsn(ALOAD, 14);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/component/html/HtmlCommandScript", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 15);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/component/behavior/ClientBehaviorContext$Parameter", "java/lang/Object"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 18);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 15, new Object[] {"jakarta/faces/component/behavior/ClientBehaviorContext", "jakarta/faces/component/behavior/AjaxBehavior", "jakarta/faces/component/UIComponent", "java/lang/String", "java/lang/StringBuilder", "java/util/Collection", "java/util/Collection", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/Boolean", "java/util/Collection", "jakarta/faces/component/behavior/ClientBehaviorContext$Parameter", "jakarta/faces/component/html/HtmlCommandScript"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(",'");
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/html_basic/AjaxBehaviorRenderer", "appendIds", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljava/lang/StringBuilder;Ljava/util/Collection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitLdcInsn(",");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitInsn(POP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "appendIds", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljava/lang/StringBuilder;Ljava/util/Collection;)V", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;Ljava/lang/StringBuilder;Ljava/util/Collection<Ljava/lang/String;>;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "jakarta/faces/component/search/ComponentNotFoundException");
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label3 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"jakarta/faces/context/FacesContext", "jakarta/faces/component/UIComponent", "java/lang/StringBuilder", "java/util/Collection", "jakarta/faces/component/search/SearchExpressionHandler", "jakarta/faces/component/search/SearchExpressionContext", Opcodes.INTEGER, "java/util/Iterator", "java/lang/String", "java/lang/String"}, 1, new Object[] {"jakarta/faces/component/search/ComponentNotFoundException"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/html_basic/AjaxBehaviorRenderer", "getResolvedId", "(Ljakarta/faces/component/UIComponent;Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "getResolvedId", "(Ljakarta/faces/component/UIComponent;Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
