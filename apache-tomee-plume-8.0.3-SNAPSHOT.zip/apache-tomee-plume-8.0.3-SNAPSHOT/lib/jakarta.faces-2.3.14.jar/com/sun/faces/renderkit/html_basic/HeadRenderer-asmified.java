...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/renderkit/html_basic/HeadRenderer", null, "javax/faces/render/Renderer", null);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/faces/context/ResponseWriter", "com/sun/faces/config/WebConfiguration", "com/sun/faces/config/FaceletsConfiguration"}, 0, null);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/html_basic/HeadRenderer", "encodeHeadResources", "(Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLdcInsn("head");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "encodeHeadResources", "(Ljavax/faces/context/FacesContext;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getViewRoot", "()Ljavax/faces/component/UIViewRoot;", false);
