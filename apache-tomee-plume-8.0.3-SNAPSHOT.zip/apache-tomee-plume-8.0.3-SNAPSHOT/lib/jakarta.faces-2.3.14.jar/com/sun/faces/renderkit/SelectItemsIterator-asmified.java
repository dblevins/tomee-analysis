...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/sun/faces/renderkit/SelectItemsIterator", "<T:Ljakarta/faces/model/SelectItem;>Ljava/lang/Object;Ljava/util/Iterator<Ljakarta/faces/model/SelectItem;>;", "java/lang/Object", new String[] { "java/util/Iterator" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "items", "Lcom/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator;", "Lcom/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator<Ljakarta/faces/model/SelectItem;>;", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "ctx", "Ljakarta/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "items", "Lcom/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "com/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator", "currentSelectComponent", "()Ljakarta/faces/component/UIComponent;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/SelectItemsIterator", "updateSingeItemIterator", "(Ljakarta/faces/component/UIComponent;Ljakarta/faces/model/SelectItem;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "ctx", "Ljakarta/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/faces/component/UISelectItems");
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/SelectItemsIterator$ArrayIterator", "<init>", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UISelectItems;Ljava/lang/Object;Lcom/sun/faces/renderkit/SelectItemsIterator$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "items", "Lcom/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator;");
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/SelectItemsIterator$IterableItemIterator", "<init>", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UISelectItems;Ljava/lang/Iterable;Lcom/sun/faces/renderkit/SelectItemsIterator$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "items", "Lcom/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator;");
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UISelectItems", "getParent", "()Ljakarta/faces/component/UIComponent;", false);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/renderkit/SelectItemsIterator$MapIterator", "<init>", "(Ljava/util/Map;Ljakarta/faces/component/UIComponent;Lcom/sun/faces/renderkit/SelectItemsIterator$1;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "items", "Lcom/sun/faces/renderkit/SelectItemsIterator$ComponentAwareSelectItemIterator;");
methodVisitor.visitJumpInsn(GOTO, label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "updateSingeItemIterator", "(Ljakarta/faces/component/UIComponent;Ljakarta/faces/model/SelectItem;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/SelectItemsIterator", "singleItemIterator", "Lcom/sun/faces/renderkit/SelectItemsIterator$SingleElementIterator;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/renderkit/SelectItemsIterator$SingleElementIterator", "access$400", "(Lcom/sun/faces/renderkit/SelectItemsIterator$SingleElementIterator;Ljakarta/faces/component/UIComponent;Ljakarta/faces/model/SelectItem;)V", false);
methodVisitor.visitInsn(RETURN);
