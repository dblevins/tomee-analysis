...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "com/sun/faces/renderkit/StateHelper", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "serialProvider", "Lcom/sun/faces/spi/SerializationProvider;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "compressViewState", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "stateFieldStart", "[C", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "fieldMiddle", "[C", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "fieldEnd", "[C", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "TOKEN_NAME", "Ljava/lang/String;", null, "com.sun.faces.TOKEN");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/spi/SerializationProviderFactory", "createInstance", "(Ljakarta/faces/context/ExternalContext;)Lcom/sun/faces/spi/SerializationProvider;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/StateHelper", "serialProvider", "Lcom/sun/faces/spi/SerializationProvider;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getExternalContext", "()Ljakarta/faces/context/ExternalContext;", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/StateHelper", "webConfig", "Lcom/sun/faces/config/WebConfiguration;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/StateHelper", "webConfig", "Lcom/sun/faces/config/WebConfiguration;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/renderkit/StateHelper", "compressViewState", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/renderkit/StateHelper", "serialProvider", "Lcom/sun/faces/spi/SerializationProvider;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/renderkit/StateHelper", "jakarta/faces/context/FacesContext"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createAndStoreCryptographicallyStrongTokenInSession", "(Ljakarta/servlet/http/HttpSession;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"jakarta/servlet/http/HttpSession", "com/sun/faces/util/ByteArrayGuardAESCTR", "java/lang/String", "java/lang/String"}, 1, new Object[] {"java/io/UnsupportedEncodingException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/StateHelper", "LOGGER", "Ljava/util/logging/Logger;");
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/renderkit/StateHelper", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitLdcInsn("Unable to URL encode cryptographically strong token, storing clear text in session instead.");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("com.sun.faces.TOKEN");
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "writeState", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Object;Ljava/lang/StringBuilder;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getState", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)Ljava/lang/Object;", null, new String[] { "java/io/IOException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "isStateless", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)Z", null, new String[] { "java/lang/IllegalStateException" });
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_STATIC, "getStateParamValue", "(Ljakarta/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "writeRenderKitIdField", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/context/ResponseWriter;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "writeClientWindowField", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/context/ResponseWriter;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getExternalContext", "()Ljakarta/faces/context/ExternalContext;", false);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/renderkit/StateHelper", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
