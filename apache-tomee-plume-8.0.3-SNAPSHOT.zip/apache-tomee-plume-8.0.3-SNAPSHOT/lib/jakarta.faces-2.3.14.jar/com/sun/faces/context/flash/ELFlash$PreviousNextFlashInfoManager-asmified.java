...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/context/flash/ELFlash", "access$300", "(Ljakarta/faces/context/FacesContext;)Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(0, "decode", "(Ljakarta/faces/context/FacesContext;Lcom/sun/faces/context/flash/ELFlash;Ljakarta/servlet/http/Cookie;)V", null, new String[] { "java/security/InvalidKeyException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/context/flash/ELFlash$PreviousNextFlashInfoManager", "jakarta/faces/context/FacesContext", "com/sun/faces/context/flash/ELFlash", "jakarta/servlet/http/Cookie", Opcodes.TOP, Opcodes.TOP, "java/lang/String"}, 1, new Object[] {"java/io/UnsupportedEncodingException"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/context/flash/ELFlash$PreviousNextFlashInfoManager", "jakarta/faces/context/FacesContext", "com/sun/faces/context/flash/ELFlash", "jakarta/servlet/http/Cookie", "java/lang/String", "java/lang/String", "java/lang/String", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/context/flash/ELFlash$FlashInfo");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/context/flash/ELFlash$PreviousNextFlashInfoManager", "jakarta/faces/context/FacesContext", "com/sun/faces/context/flash/ELFlash", "jakarta/servlet/http/Cookie", Opcodes.TOP, "java/lang/String", "java/lang/String"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(0, "encode", "()Ljakarta/servlet/http/Cookie;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/context/flash/ELFlash$PreviousNextFlashInfoManager", "jakarta/servlet/http/Cookie"}, 1, new Object[] {"java/lang/StringBuilder"});
methodVisitor.visitLdcInsn("");
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/context/flash/ELFlash$PreviousNextFlashInfoManager", "jakarta/servlet/http/Cookie"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitLdcInsn("_");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/context/flash/ELFlash$PreviousNextFlashInfoManager", "jakarta/servlet/http/Cookie", "java/lang/String", "java/lang/String"}, 1, new Object[] {"java/io/UnsupportedEncodingException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitTypeInsn(NEW, "jakarta/servlet/http/Cookie");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("csfcfc");
