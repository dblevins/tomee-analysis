...
public class SessionHelperDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "FLASH_SESSIONACTIVATIONLISTENER_ATTRIBUTE_NAME", "Ljava/lang/String;", null, "csfcffFSAL");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FLASH_INNER_MAP_KEY", "Ljava/lang/String;", null, "csfcffFIM");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "didPassivate", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitLdcInsn("csfcffFIM");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Map");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/context/flash/ELFlash", "setFlashInnerMap", "(Ljava/util/Map;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/context/flash/SessionHelper", "didPassivate", "Z");
...
methodVisitor.visitLdcInsn("csfcffFIM");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/context/flash/ELFlash", "getFlashInnerMap", "()Ljava/util/Map;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitInsn(POP);
