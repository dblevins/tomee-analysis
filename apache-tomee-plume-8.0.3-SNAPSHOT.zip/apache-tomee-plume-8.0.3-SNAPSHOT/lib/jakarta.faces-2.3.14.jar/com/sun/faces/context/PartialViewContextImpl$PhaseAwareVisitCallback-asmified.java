...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/context/PartialViewContextImpl$PhaseAwareVisitCallback", null, "java/lang/Object", new String[] { "javax/faces/component/visit/VisitCallback" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "curPhase", "Ljavax/faces/event/PhaseId;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljavax/faces/context/FacesContext;Ljavax/faces/event/PhaseId;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/context/PartialViewContextImpl$PhaseAwareVisitCallback", "ctx", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/context/PartialViewContextImpl$PhaseAwareVisitCallback", "curPhase", "Ljavax/faces/event/PhaseId;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/context/PartialViewContextImpl$PhaseAwareVisitCallback", "curPhase", "Ljavax/faces/event/PhaseId;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/context/PartialViewContextImpl$PhaseAwareVisitCallback", "ctx", "Ljavax/faces/context/FacesContext;");
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Ljavax/faces/context/FacesContext;Ljavax/faces/event/PhaseId;Lcom/sun/faces/context/PartialViewContextImpl$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/context/PartialViewContextImpl$PhaseAwareVisitCallback", "<init>", "(Ljavax/faces/context/FacesContext;Ljavax/faces/event/PhaseId;)V", false);
methodVisitor.visitInsn(RETURN);
