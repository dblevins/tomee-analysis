...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/context/InjectionFacesContextFactory", null, "jakarta/faces/context/FacesContextFactory", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/context/InjectionFacesContextFactory", "jakarta/faces/context/FacesContextFactory"}, 1, new Object[] {"java/lang/NoSuchFieldException"});
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/context/InjectionFacesContextFactory", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
methodVisitor.visitLdcInsn("Unable to find private field named 'defaultFacesContext' in jakarta.faces.context.FacesContext.");
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/context/InjectionFacesContextFactory", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
methodVisitor.visitLdcInsn("Unable to find private field named 'defaultExternalContext' in jakarta.faces.context.ExternalContext.");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "log", "(Ljava/util/logging/Level;Ljava/lang/String;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/context/InjectionFacesContextFactory", "getWrapped", "()Ljakarta/faces/context/FacesContextFactory;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/context/InjectionFacesContextFactory", "injectDefaults", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ALOAD, 5);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "injectDefaults", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Object;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/context/FacesContextImpl", "getDefaultFacesContext", "()Ljakarta/faces/context/FacesContext;", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/context/InjectionFacesContextFactory", "jakarta/faces/context/FacesContext", "java/lang/Object", "jakarta/faces/context/FacesContext"}, 1, new Object[] {"java/lang/IllegalAccessException"});
