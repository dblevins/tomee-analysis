...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/util/MessageFactory$BindingFacesMessage", null, "jakarta/faces/application/FacesMessage", null);

classWriter.visitInnerClass("com/sun/faces/util/MessageFactory$BindingFacesMessage", "com/sun/faces/util/MessageFactory", "BindingFacesMessage", ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "locale", "Ljava/util/Locale;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "parameters", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "resolvedParameters", "[Ljava/lang/Object;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/util/MessageFactory$BindingFacesMessage", "java/util/Locale", "java/lang/String", "java/lang/String", "[Ljava/lang/Object;"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "resolveBindings", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "resolvedParameters", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "getFormattedString", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "parameters", "[Ljava/lang/Object;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/util/MessageFactory$BindingFacesMessage", "locale", "Ljava/util/Locale;");
Label label2 = new Label();
