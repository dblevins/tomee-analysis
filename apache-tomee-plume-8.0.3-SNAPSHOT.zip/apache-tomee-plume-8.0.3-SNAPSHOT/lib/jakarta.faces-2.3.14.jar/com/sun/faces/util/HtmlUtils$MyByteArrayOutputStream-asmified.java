...
public class HtmlUtils$MyByteArrayOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/util/HtmlUtils$MyByteArrayOutputStream", null, "java/io/ByteArrayOutputStream", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/util/HtmlUtils$MyByteArrayOutputStream", "buf", "[B");
