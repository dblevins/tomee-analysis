...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/util/BeanValidation$JsfAwareMessageInterpolator", null, "java/lang/Object", new String[] { "javax/validation/MessageInterpolator" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "delegate", "Ljavax/validation/MessageInterpolator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/util/BeanValidation$JsfAwareMessageInterpolator", "context", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/util/BeanValidation$JsfAwareMessageInterpolator", "delegate", "Ljavax/validation/MessageInterpolator;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/util/BeanValidation$JsfAwareMessageInterpolator", "context", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/util/BeanValidation$JsfAwareMessageInterpolator", "delegate", "Ljavax/validation/MessageInterpolator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
