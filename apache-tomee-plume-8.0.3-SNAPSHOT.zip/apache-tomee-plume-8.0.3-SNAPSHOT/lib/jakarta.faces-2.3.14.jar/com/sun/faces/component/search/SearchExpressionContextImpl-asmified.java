...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/component/search/SearchExpressionContextImpl", null, "javax/faces/component/search/SearchExpressionContext", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/component/search/SearchExpressionContextImpl", "facesContext", "Ljavax/faces/context/FacesContext;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/component/search/SearchExpressionContextImpl", "source", "Ljavax/faces/component/UIComponent;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/component/search/SearchExpressionContextImpl", "source", "Ljavax/faces/component/UIComponent;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/component/search/SearchExpressionContextImpl", "facesContext", "Ljavax/faces/context/FacesContext;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
