...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "COMPONENT_VALIDATORS", "Ljava/lang/String;", null, "jakarta.faces.component.ComponentValidators");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getValidators", "(Ljakarta/faces/context/FacesContext;Z)Lcom/sun/faces/component/validator/ComponentValidators;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn("jakarta.faces.component.ComponentValidators");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "addDefaultValidatorsToComponent", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/EditableValueHolder;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"jakarta/faces/context/FacesContext", "jakarta/faces/component/EditableValueHolder", "java/util/Set", "java/util/List", "java/util/Set", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/component/validator/ComponentValidators", "addValidatorsToComponent", "(Ljakarta/faces/context/FacesContext;Ljava/util/Collection;Ljakarta/faces/component/EditableValueHolder;Ljava/util/LinkedList;)V", false);
methodVisitor.visitLabel(label0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addValidators", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/EditableValueHolder;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/component/validator/ComponentValidators", "jakarta/faces/context/FacesContext", "jakarta/faces/component/EditableValueHolder", "jakarta/faces/application/Application", "java/util/Map", "java/util/Set", "java/util/List", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"com/sun/faces/component/validator/ComponentValidators", "jakarta/faces/context/FacesContext", "jakarta/faces/component/EditableValueHolder", "jakarta/faces/application/Application", "java/util/Map", "java/util/Set", "java/util/List", "java/util/Set", Opcodes.INTEGER}, 3, new Object[] {"jakarta/faces/context/FacesContext", "java/util/List", "jakarta/faces/component/EditableValueHolder"});
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"com/sun/faces/component/validator/ComponentValidators", "jakarta/faces/context/FacesContext", "jakarta/faces/component/EditableValueHolder", "jakarta/faces/application/Application", "java/util/Map", "java/util/Set", "java/util/List", "java/util/Set", Opcodes.INTEGER}, 4, new Object[] {"jakarta/faces/context/FacesContext", "java/util/List", "jakarta/faces/component/EditableValueHolder", "java/util/LinkedList"});
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/component/validator/ComponentValidators", "addValidatorsToComponent", "(Ljakarta/faces/context/FacesContext;Ljava/util/Collection;Ljakarta/faces/component/EditableValueHolder;Ljava/util/LinkedList;)V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "addValidatorsToComponent", "(Ljakarta/faces/context/FacesContext;Ljava/util/Collection;Ljakarta/faces/component/EditableValueHolder;Ljava/util/LinkedList;)V", "(Ljakarta/faces/context/FacesContext;Ljava/util/Collection<Ljava/lang/String;>;Ljakarta/faces/component/EditableValueHolder;Ljava/util/LinkedList<Lcom/sun/faces/component/validator/ComponentValidators$ValidatorInfo;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"jakarta/faces/context/FacesContext", "java/util/Collection", "jakarta/faces/component/EditableValueHolder", "java/util/LinkedList", "jakarta/faces/application/Application", "java/util/Map", "[Ljakarta/faces/validator/Validator;", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"jakarta/faces/context/FacesContext", "java/util/Collection", "jakarta/faces/component/EditableValueHolder", "java/util/LinkedList", "jakarta/faces/application/Application", "java/util/Map", "[Ljakarta/faces/validator/Validator;", "java/util/Iterator", "java/util/Map$Entry", "[Ljakarta/faces/validator/Validator;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
Label label10 = new Label();
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/String", "jakarta/faces/validator/Validator", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 10);
...
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/component/validator/ComponentValidators$ValidatorInfo", "applyAttributes", "(Ljakarta/faces/validator/Validator;)V", false);
