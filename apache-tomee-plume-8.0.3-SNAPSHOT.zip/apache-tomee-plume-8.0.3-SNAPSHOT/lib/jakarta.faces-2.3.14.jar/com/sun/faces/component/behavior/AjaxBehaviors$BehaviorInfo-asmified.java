...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/behavior/AjaxBehavior;Ljava/lang/String;)V", null, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/behavior/AjaxBehavior", "saveState", "(Ljavax/faces/context/FacesContext;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "addBehavior", "(Ljavax/faces/context/FacesContext;Ljavax/faces/component/behavior/ClientBehaviorHolder;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/component/behavior/AjaxBehaviors$BehaviorInfo", "shouldAddBehavior", "(Ljavax/faces/component/behavior/ClientBehaviorHolder;Ljava/lang/String;)Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/component/behavior/AjaxBehaviors$BehaviorInfo", "createBehavior", "(Ljavax/faces/context/FacesContext;)Ljavax/faces/component/behavior/ClientBehavior;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "shouldAddBehavior", "(Ljavax/faces/component/behavior/ClientBehaviorHolder;Ljava/lang/String;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createBehavior", "(Ljavax/faces/context/FacesContext;)Ljavax/faces/component/behavior/ClientBehavior;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/component/behavior/AjaxBehavior", "restoreState", "(Ljavax/faces/context/FacesContext;Ljava/lang/Object;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
