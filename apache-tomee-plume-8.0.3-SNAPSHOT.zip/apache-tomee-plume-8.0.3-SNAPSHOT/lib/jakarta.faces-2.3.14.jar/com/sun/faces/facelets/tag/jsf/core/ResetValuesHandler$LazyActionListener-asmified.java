...
public class ResetValuesHandler$LazyActionListenerDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(0, "render", "Ljava/util/Collection;", "Ljava/util/Collection<Ljava/lang/String;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-5676209243297546166L));
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/jsf/core/ResetValuesHandler$LazyActionListener", "render", "Ljava/util/Collection;");
