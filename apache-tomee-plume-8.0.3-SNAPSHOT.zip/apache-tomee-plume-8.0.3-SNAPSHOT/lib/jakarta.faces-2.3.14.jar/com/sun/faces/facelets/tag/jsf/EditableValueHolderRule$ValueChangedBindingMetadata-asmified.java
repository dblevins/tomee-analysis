...
public class EditableValueHolderRule$ValueChangedBindingMetadataDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/tag/jsf/EditableValueHolderRule$ValueChangedBindingMetadata", null, "jakarta/faces/view/facelets/Metadata", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/jsf/EditableValueHolderRule$ValueChangedBindingMetadata", "attr", "Ljakarta/faces/view/facelets/TagAttribute;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/jsf/EditableValueHolderRule$ValueChangedBindingMetadata", "attr", "Ljakarta/faces/view/facelets/TagAttribute;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/faces/component/EditableValueHolder", "setValueChangeListener", "(Ljakarta/faces/el/MethodBinding;)V", true);
methodVisitor.visitInsn(RETURN);
