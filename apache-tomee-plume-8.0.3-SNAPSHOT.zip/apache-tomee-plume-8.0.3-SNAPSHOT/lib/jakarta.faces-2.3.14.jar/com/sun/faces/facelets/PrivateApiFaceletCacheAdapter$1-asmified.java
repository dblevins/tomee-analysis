...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$faceletFactory", "Ljakarta/faces/view/facelets/FaceletCache$MemberFactory;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/PrivateApiFaceletCacheAdapter$1", "val$faceletFactory", "Ljakarta/faces/view/facelets/FaceletCache$MemberFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/PrivateApiFaceletCacheAdapter$1", "val$faceletFactory", "Ljakarta/faces/view/facelets/FaceletCache$MemberFactory;");
methodVisitor.visitVarInsn(ALOAD, 1);
