...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/facelets/compiler/UILeaf", null, "javax/faces/component/UIComponentBase", new String[] { "javax/faces/component/search/UntargetableComponent" });

classWriter.visitInnerClass("com/sun/faces/facelets/compiler/UILeaf$1", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "facets", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/String;Ljavax/faces/component/UIComponent;>;", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "returnLocalTransient", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/UILeaf", "returnLocalTransient", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/UILeaf", "parent", "Ljavax/faces/component/UIComponent;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/UILeaf", "parent", "Ljavax/faces/component/UIComponent;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/facelets/compiler/UILeaf", "facets", "Ljava/util/Map;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/compiler/UILeaf", "encodeBegin", "(Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/UILeaf", "returnLocalTransient", "Z");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIComponentBase", "isTransient", "()Z", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/component/UIComponentBase", "setTransient", "(Z)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/facelets/compiler/UILeaf$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(FCONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/compiler/UILeaf$1", "<init>", "(IF)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/facelets/compiler/UILeaf", "facets", "Ljava/util/Map;");
methodVisitor.visitInsn(RETURN);
