...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/facelets/impl/DefaultFaceletFactory$2", "Ljava/lang/Object;Ljakarta/faces/view/facelets/FaceletCache$MemberFactory<Lcom/sun/faces/facelets/impl/DefaultFacelet;>;", "java/lang/Object", new String[] { "jakarta/faces/view/facelets/FaceletCache$MemberFactory" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/impl/DefaultFaceletFactory$2", "this$0", "Lcom/sun/faces/facelets/impl/DefaultFaceletFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/impl/DefaultFaceletFactory$2", "this$0", "Lcom/sun/faces/facelets/impl/DefaultFaceletFactory;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/facelets/impl/DefaultFaceletFactory", "access$200", "(Lcom/sun/faces/facelets/impl/DefaultFaceletFactory;Ljava/net/URL;)Lcom/sun/faces/facelets/impl/DefaultFacelet;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/impl/DefaultFaceletFactory$2", "newInstance", "(Ljava/net/URL;)Lcom/sun/faces/facelets/impl/DefaultFacelet;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
