...
public class PropertyHandlerManager$StringFeatureDescriptorPropertyHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$StringFeatureDescriptorPropertyHandler", null, "java/lang/Object", new String[] { "com/sun/faces/facelets/tag/composite/TypedPropertyHandler" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$StringFeatureDescriptorPropertyHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
