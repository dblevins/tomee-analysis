...
public class DefaultFaceletCache$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/facelets/impl/DefaultFaceletCache$1", "Ljava/lang/Object;Lcom/sun/faces/util/ConcurrentCache$Factory<Ljava/net/URL;Lcom/sun/faces/facelets/impl/DefaultFaceletCache$Record;>;", "java/lang/Object", new String[] { "com/sun/faces/util/ConcurrentCache$Factory" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/impl/DefaultFaceletCache$1", "this$0", "Lcom/sun/faces/facelets/impl/DefaultFaceletCache;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/impl/DefaultFaceletCache$1", "val$checkExpiry", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(LLOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/impl/DefaultFaceletCache$1", "val$refreshPeriod", "J");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/impl/DefaultFaceletCache$1", "val$checkExpiry", "Z");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/impl/DefaultFaceletCache$1", "newInstance", "(Ljava/net/URL;)Lcom/sun/faces/facelets/impl/DefaultFaceletCache$Record;", false);
methodVisitor.visitInsn(ARETURN);
