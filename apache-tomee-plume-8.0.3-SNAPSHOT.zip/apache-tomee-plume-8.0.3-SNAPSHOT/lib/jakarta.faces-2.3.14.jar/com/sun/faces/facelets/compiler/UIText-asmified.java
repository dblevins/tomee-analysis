...
public class UITextDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/compiler/UIText", null, "com/sun/faces/facelets/compiler/UILeaf", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/UIText", "txt", "Lcom/sun/faces/facelets/el/ELText;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/UIText", "alias", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/compiler/UIText", "isRendered", "()Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/UIText", "txt", "Lcom/sun/faces/facelets/el/ELText;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/facelets/compiler/UIText", "javax/faces/context/FacesContext", "javax/faces/context/ResponseWriter"}, 1, new Object[] {"javax/el/ELException"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/UIText", "alias", "Ljava/lang/String;");
