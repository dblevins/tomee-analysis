...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/compiler/NamespaceHandler", null, "jakarta/el/FunctionMapper", new String[] { "jakarta/faces/view/facelets/FaceletHandler" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/faces/view/facelets/FaceletHandler;Lcom/sun/faces/facelets/tag/TagLibrary;Ljava/util/Map;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/NamespaceHandler", "next", "Ljakarta/faces/view/facelets/FaceletHandler;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/compiler/NamespaceHandler", "pushMapper", "(Ljakarta/faces/context/FacesContext;Ljakarta/el/FunctionMapper;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/facelets/el/CompositeFunctionMapper");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/el/CompositeFunctionMapper", "<init>", "(Ljakarta/el/FunctionMapper;Ljakarta/el/FunctionMapper;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/NamespaceHandler", "next", "Ljakarta/faces/view/facelets/FaceletHandler;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/facelets/compiler/NamespaceHandler", "jakarta/faces/view/facelets/FaceletContext", "jakarta/faces/component/UIComponent", "jakarta/el/FunctionMapper"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "pushMapper", "(Ljakarta/faces/context/FacesContext;Ljakarta/el/FunctionMapper;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/el/ELContextImpl", "setFunctionMapper", "(Ljakarta/el/FunctionMapper;)V", false);
methodVisitor.visitLabel(label0);
