...
public class AttachedBehaviorsDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/jsf/AttachedBehaviors", "behaviors", "Ljava/util/Map;");
...
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/facelets/tag/jsf/AttachedBehaviors");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/Map", "com/sun/faces/facelets/tag/jsf/AttachedBehaviors"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
