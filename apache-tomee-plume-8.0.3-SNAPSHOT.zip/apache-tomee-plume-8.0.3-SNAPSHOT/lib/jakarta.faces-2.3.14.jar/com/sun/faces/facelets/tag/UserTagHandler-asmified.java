...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "vars", "[Ljakarta/faces/view/facelets/TagAttribute;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/UserTagHandler", "tag", "Ljakarta/faces/view/facelets/Tag;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/UserTagHandler", "vars", "[Ljakarta/faces/view/facelets/TagAttribute;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/facelets/tag/UserTagHandler", "jakarta/faces/view/facelets/TagConfig", "java/net/URL", "java/util/Iterator", "com/sun/faces/facelets/tag/ui/DefineHandler"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/UserTagHandler", "vars", "[Ljakarta/faces/view/facelets/TagAttribute;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/facelets/tag/UserTagHandler", "jakarta/faces/view/facelets/FaceletContext", "jakarta/faces/component/UIComponent", "com/sun/faces/facelets/FaceletContextImplBase", "jakarta/el/VariableMapper", "jakarta/el/VariableMapper", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/FaceletContextImplBase", "includeFacelet", "(Ljakarta/faces/component/UIComponent;Ljava/net/URL;)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/UserTagHandler", "nextHandler", "Ljakarta/faces/view/facelets/FaceletHandler;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
