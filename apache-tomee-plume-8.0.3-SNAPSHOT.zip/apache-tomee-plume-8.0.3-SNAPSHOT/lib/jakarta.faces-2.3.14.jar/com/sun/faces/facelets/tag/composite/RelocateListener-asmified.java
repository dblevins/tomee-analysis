...
public class RelocateListenerDump implements Opcodes {
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Backing resource information not found in composite component attribute map");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lcom/sun/faces/facelets/tag/composite/RelocateListener;"));
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/facelets/tag/composite/RelocateListener", "$assertionsDisabled", "Z");
methodVisitor.visitInsn(RETURN);
