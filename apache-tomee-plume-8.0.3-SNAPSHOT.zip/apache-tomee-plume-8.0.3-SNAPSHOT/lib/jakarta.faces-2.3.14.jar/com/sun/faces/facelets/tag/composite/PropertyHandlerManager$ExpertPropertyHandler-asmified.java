...
public class PropertyHandlerManager$ExpertPropertyHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$ExpertPropertyHandler", null, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$BooleanFeatureDescriptorPropertyHandler", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$ExpertPropertyHandler", "getEvalType", "()Ljava/lang/Class;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$ExpertPropertyHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
