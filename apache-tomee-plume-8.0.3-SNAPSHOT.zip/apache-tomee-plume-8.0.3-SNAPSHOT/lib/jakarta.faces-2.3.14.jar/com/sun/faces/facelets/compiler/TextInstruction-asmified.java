...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/compiler/TextInstruction", null, "java/lang/Object", new String[] { "com/sun/faces/facelets/compiler/Instruction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/TextInstruction", "alias", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/TextInstruction", "txt", "Lcom/sun/faces/facelets/el/ELText;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/TextInstruction", "txt", "Lcom/sun/faces/facelets/el/ELText;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/el/ELText", "writeText", "(Ljavax/faces/context/ResponseWriter;Ljavax/el/ELContext;)V", false);
methodVisitor.visitLabel(label1);
Label label4 = new Label();
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/facelets/compiler/TextInstruction", "javax/faces/context/FacesContext", "javax/faces/context/ResponseWriter"}, 1, new Object[] {"javax/el/ELException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/TextInstruction", "alias", "Ljava/lang/String;");
