...
public class PropertyHandlerManager$PreferredPropertyHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$PreferredPropertyHandler", null, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$BooleanFeatureDescriptorPropertyHandler", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$PreferredPropertyHandler", "getEvalType", "()Ljava/lang/Class;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$PreferredPropertyHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
