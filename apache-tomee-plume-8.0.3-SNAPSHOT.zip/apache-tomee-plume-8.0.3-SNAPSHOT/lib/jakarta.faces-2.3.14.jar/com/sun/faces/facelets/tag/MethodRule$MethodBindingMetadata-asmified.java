...
public class MethodRule$MethodBindingMetadataDump implements Opcodes {
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/MethodRule$MethodBindingMetadata", "_returnType", "Ljava/lang/Class;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/MethodRule$MethodBindingMetadata", "_method", "Ljava/lang/reflect/Method;");
methodVisitor.visitVarInsn(ALOAD, 2);
