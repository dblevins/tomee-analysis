...
public class PropertyHandlerManager$BooleanFeatureDescriptorPropertyHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_ABSTRACT, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$BooleanFeatureDescriptorPropertyHandler", null, "java/lang/Object", new String[] { "com/sun/faces/facelets/tag/composite/TypedPropertyHandler" });
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/tag/composite/PropertyHandlerManager$BooleanFeatureDescriptorPropertyHandler", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
