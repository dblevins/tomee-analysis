...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/facelets/tag/composite/BehaviorHolderWrapper", null, "jakarta/faces/component/UIComponent", new String[] { "jakarta/faces/component/behavior/ClientBehaviorHolder" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "parent", "Ljakarta/faces/component/UIComponent;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/composite/BehaviorHolderWrapper", "parent", "Ljakarta/faces/component/UIComponent;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/composite/BehaviorHolderWrapper", "parent", "Ljakarta/faces/component/UIComponent;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTypeInsn(ANEWARRAY, "jakarta/faces/event/FacesListener");
methodVisitor.visitInsn(ARETURN);
