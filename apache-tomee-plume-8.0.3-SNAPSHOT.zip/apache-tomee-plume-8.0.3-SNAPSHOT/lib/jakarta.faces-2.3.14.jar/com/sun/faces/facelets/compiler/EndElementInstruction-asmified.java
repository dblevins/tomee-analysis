...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("head");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/compiler/EndElementInstruction", "warnUnhandledResources", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "warnUnhandledResources", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
