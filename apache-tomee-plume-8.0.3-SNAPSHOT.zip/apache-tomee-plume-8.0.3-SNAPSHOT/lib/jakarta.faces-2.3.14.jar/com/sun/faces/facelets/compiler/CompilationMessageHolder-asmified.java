...
public class CompilationMessageHolderDump implements Opcodes {
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removeNamespacePrefixMessages", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitEnd();
}
{
