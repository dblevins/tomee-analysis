...
public class CompilationMessageHolderImplDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "compilationManager", "Lcom/sun/faces/facelets/compiler/CompilationManager;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/CompilationMessageHolderImpl", "messageListMap", "Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/CompilationMessageHolderImpl", "messageListMap", "Ljava/util/Map;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "removeNamespacePrefixMessages", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/compiler/CompilationMessageHolderImpl", "getMessageListMap", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getCurrentCompositeComponentCompilationManager", "()Lcom/sun/faces/facelets/compiler/CompilationManager;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/compiler/CompilationMessageHolderImpl", "compilationManager", "Lcom/sun/faces/facelets/compiler/CompilationManager;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setCurrentCompositeComponentCompilationManager", "(Lcom/sun/faces/facelets/compiler/CompilationManager;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/compiler/CompilationMessageHolderImpl", "compilationManager", "Lcom/sun/faces/facelets/compiler/CompilationManager;");
methodVisitor.visitInsn(RETURN);
