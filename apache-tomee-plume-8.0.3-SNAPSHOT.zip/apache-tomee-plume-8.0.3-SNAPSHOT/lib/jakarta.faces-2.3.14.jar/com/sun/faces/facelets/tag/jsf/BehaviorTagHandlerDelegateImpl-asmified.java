...
classWriter.visit(V1_8, ACC_SUPER, "com/sun/faces/facelets/tag/jsf/BehaviorTagHandlerDelegateImpl", null, "jakarta/faces/view/facelets/TagHandlerDelegate", new String[] { "jakarta/faces/view/AttachedObjectHandler" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "owner", "Ljakarta/faces/view/facelets/BehaviorHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/jsf/BehaviorTagHandlerDelegateImpl", "owner", "Ljakarta/faces/view/facelets/BehaviorHandler;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/jsf/BehaviorTagHandlerDelegateImpl", "owner", "Ljakarta/faces/view/facelets/BehaviorHandler;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/facelets/tag/jsf/BehaviorTagHandlerDelegateImpl", "jakarta/faces/view/facelets/FaceletContext", "jakarta/faces/component/UIComponent"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/view/facelets/BehaviorHandler", "applyAttachedObject", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/component/UIComponent;)V", false);
methodVisitor.visitJumpInsn(GOTO, label13);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/tag/jsf/BehaviorTagHandlerDelegateImpl", "getEventName", "(Ljakarta/faces/component/behavior/ClientBehaviorHolder;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getEventName", "(Ljakarta/faces/component/behavior/ClientBehaviorHolder;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/jsf/BehaviorTagHandlerDelegateImpl", "owner", "Ljakarta/faces/view/facelets/BehaviorHandler;");
