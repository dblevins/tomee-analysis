...
public class LegacyELContext$EmptyFunctionMapperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/el/LegacyELContext$EmptyFunctionMapper", null, "javax/el/FunctionMapper", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_SYNTHETIC, "<init>", "(Lcom/sun/faces/facelets/el/LegacyELContext$1;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/facelets/el/LegacyELContext$EmptyFunctionMapper", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
