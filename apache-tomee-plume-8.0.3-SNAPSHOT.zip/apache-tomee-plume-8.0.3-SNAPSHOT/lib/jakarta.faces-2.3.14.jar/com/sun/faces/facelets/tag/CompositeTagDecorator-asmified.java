...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/sun/faces/facelets/tag/CompositeTagDecorator", null, "java/lang/Object", new String[] { "javax/faces/view/facelets/TagDecorator" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "decorators", "[Ljavax/faces/view/facelets/TagDecorator;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "([Ljavax/faces/view/facelets/TagDecorator;)V", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/facelets/tag/CompositeTagDecorator", "decorators", "[Ljavax/faces/view/facelets/TagDecorator;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/facelets/tag/DefaultTagDecorator", "decorate", "(Ljavax/faces/view/facelets/Tag;)Ljavax/faces/view/facelets/Tag;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/faces/view/facelets/Tag", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/facelets/tag/CompositeTagDecorator", "decorators", "[Ljavax/faces/view/facelets/TagDecorator;");
