...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createConverter", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/String;)Ljakarta/faces/convert/Converter;", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/String;)Ljakarta/faces/convert/Converter<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/cdi/CdiUtils", "createConverter", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/annotation/Annotation;)Ljakarta/faces/convert/Converter;", false);
...
methodVisitor.visitLdcInsn(Type.getType("Ljava/lang/Object;"));
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/cdi/CdiConverter", "<init>", "(Ljava/lang/String;Ljava/lang/Class;Ljakarta/faces/convert/Converter;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createConverter", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class;)Ljakarta/faces/convert/Converter;", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class<*>;)Ljakarta/faces/convert/Converter<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/convert/Converter", "java/lang/Class"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createConverter", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/annotation/Annotation;)Ljakarta/faces/convert/Converter;", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/annotation/Annotation;)Ljakarta/faces/convert/Converter<*>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/cdi/CdiUtils", "getBeanReferenceByType", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Ljava/lang/Object;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createBehavior", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/String;)Ljakarta/faces/component/behavior/Behavior;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/cdi/CdiBehavior", "<init>", "(Ljava/lang/String;Ljakarta/faces/component/behavior/Behavior;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/component/behavior/Behavior", "jakarta/faces/component/behavior/Behavior"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createValidator", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/String;)Ljakarta/faces/validator/Validator;", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/String;)Ljakarta/faces/validator/Validator<*>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/annotation/Annotation", "jakarta/faces/validator/Validator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/cdi/CdiValidator", "<init>", "(Ljava/lang/String;Ljakarta/faces/validator/Validator;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC | ACC_VARARGS, "getBeanReference", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class;[Ljava/lang/annotation/Annotation;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/Class<TT;>;[Ljava/lang/annotation/Annotation;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC | ACC_VARARGS, "getBeanReferenceByType", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/enterprise/inject/spi/BeanManager", "jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/context/spi/Context"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getAnnotation", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/inject/spi/Annotated;Ljava/lang/Class;)Ljava/util/Optional;", "<A::Ljava/lang/annotation/Annotation;>(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/inject/spi/Annotated;Ljava/lang/Class<TA;>;)Ljava/util/Optional<TA;>;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/lang/annotation/Annotation", "annotationType", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/BeanManager", "isStereotype", "(Ljava/lang/Class;)Z", true);
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/lang/annotation/Annotation", "annotationType", "()Ljava/lang/Class;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/BeanManager", "getStereotypeDefinition", "(Ljava/lang/Class;)Ljava/util/Set;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "createDataModel", "(Ljava/lang/Class;)Ljakarta/faces/model/DataModel;", "(Ljava/lang/Class<*>;)Ljakarta/faces/model/DataModel<*>;", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/cdi/CdiUtils", "getDataModelClassesMap", "(Ljakarta/enterprise/inject/spi/CDI;)Ljava/util/Map;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInvokeDynamicInsn("accept", "(Ljava/util/List;Ljakarta/enterprise/inject/spi/CDI;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESTATIC, "com/sun/faces/cdi/CdiUtils", "lambda$createDataModel$1", "(Ljava/util/List;Ljakarta/enterprise/inject/spi/CDI;Ljava/util/Map$Entry;)V", false), Type.getType("(Ljava/util/Map$Entry;)V")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getDataModelClassesMap", "(Ljakarta/enterprise/inject/spi/CDI;)Ljava/util/Map;", "(Ljakarta/enterprise/inject/spi/CDI<Ljava/lang/Object;>;)Ljava/util/Map<Ljava/lang/Class<*>;Ljava/lang/Class<+Ljakarta/faces/model/DataModel<*>;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getCurrentInjectionPoint", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/context/spi/CreationalContext;)Ljakarta/enterprise/inject/spi/InjectionPoint;", "(Ljakarta/enterprise/inject/spi/BeanManager;Ljakarta/enterprise/context/spi/CreationalContext<*>;)Ljakarta/enterprise/inject/spi/InjectionPoint;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/enterprise/inject/spi/Bean", "jakarta/enterprise/inject/spi/InjectionPoint"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getQualifier", "(Ljakarta/enterprise/inject/spi/InjectionPoint;Ljava/lang/Class;)Ljava/lang/annotation/Annotation;", "<A::Ljava/lang/annotation/Annotation;>(Ljakarta/enterprise/inject/spi/InjectionPoint;Ljava/lang/Class<TA;>;)TA;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"java/lang/Class", "jakarta/enterprise/inject/spi/BeanManager"}, 1, new Object[] {"jakarta/enterprise/context/ContextNotActiveException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(IRETURN);
