...
public class ExternalContextProducerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/cdi/ExternalContextProducer", "Lcom/sun/faces/cdi/CdiProducer<Ljavax/faces/context/ExternalContext;>;", "com/sun/faces/cdi/CdiProducer", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("externalContext");
...
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "com/sun/faces/cdi/ExternalContextProducer", "lambda$new$0", "(Ljavax/enterprise/context/spi/CreationalContext;)Ljavax/faces/context/ExternalContext;", false), Type.getType("(Ljavax/enterprise/context/spi/CreationalContext;)Ljavax/faces/context/ExternalContext;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$new$0", "(Ljavax/enterprise/context/spi/CreationalContext;)Ljavax/faces/context/ExternalContext;", null, null);
methodVisitor.visitCode();
