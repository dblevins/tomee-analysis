...
public class RequestCookieMapProducerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/cdi/RequestCookieMapProducer", "Lcom/sun/faces/cdi/CdiProducer<Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;>;", "com/sun/faces/cdi/CdiProducer", null);
...
methodVisitor.visitTypeInsn(NEW, "com/sun/faces/cdi/RequestCookieMapAnnotationLiteral");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/cdi/RequestCookieMapAnnotationLiteral", "<init>", "()V", false);
...
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESTATIC, "com/sun/faces/cdi/RequestCookieMapProducer", "lambda$new$0", "(Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/util/Map;", false), Type.getType("(Ljakarta/enterprise/context/spi/CreationalContext;)Ljava/util/Map;")});
