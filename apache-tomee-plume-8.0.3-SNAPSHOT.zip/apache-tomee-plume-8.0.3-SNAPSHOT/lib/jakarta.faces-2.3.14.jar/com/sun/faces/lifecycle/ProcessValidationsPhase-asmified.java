...
public class ProcessValidationsPhaseDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/lifecycle/ProcessValidationsPhase", null, "com/sun/faces/lifecycle/Phase", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/ProcessValidationsPhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/ProcessValidationsPhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitLdcInsn("Entering ProcessValidationsPhase");
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/ProcessValidationsPhase", "$assertionsDisabled", "Z");
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/ProcessValidationsPhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitLdcInsn("Exiting ProcessValidationsPhase");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "fine", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lcom/sun/faces/lifecycle/ProcessValidationsPhase;"));
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/lifecycle/ProcessValidationsPhase", "$assertionsDisabled", "Z");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "com/sun/faces/lifecycle/ProcessValidationsPhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitInsn(RETURN);
