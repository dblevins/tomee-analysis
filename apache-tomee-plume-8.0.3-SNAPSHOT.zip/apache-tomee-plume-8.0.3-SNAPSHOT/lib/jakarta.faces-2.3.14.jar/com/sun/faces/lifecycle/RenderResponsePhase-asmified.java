...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/application/ViewHandler", "jakarta/faces/view/ViewDeclarationLanguage"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getApplication", "()Ljakarta/faces/application/Application;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/faces/lifecycle/RenderResponsePhase", "jakarta/faces/context/FacesContext", "jakarta/faces/application/ViewHandler", "jakarta/faces/view/ViewDeclarationLanguage", "jakarta/faces/application/Application", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"com/sun/faces/lifecycle/RenderResponsePhase", "jakarta/faces/context/FacesContext"}, 1, new Object[] {"java/io/IOException"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/RenderResponsePhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINEST", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/util/DebugUtil", "printTree", "(Ljakarta/faces/component/UIComponent;Ljava/util/logging/Logger;Ljava/util/logging/Level;)V", false);
