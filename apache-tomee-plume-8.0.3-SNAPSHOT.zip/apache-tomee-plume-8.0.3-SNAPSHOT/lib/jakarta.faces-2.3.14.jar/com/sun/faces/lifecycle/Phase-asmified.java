...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/Phase", "getId", "()Ljakarta/faces/event/PhaseId;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/Phase", "handleBeforePhase", "(Ljakarta/faces/context/FacesContext;Ljava/util/ListIterator;Ljakarta/faces/event/PhaseEvent;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/Phase", "shouldSkip", "(Ljakarta/faces/context/FacesContext;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/Phase", "execute", "(Ljakarta/faces/context/FacesContext;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/Phase", "handleAfterPhase", "(Ljakarta/faces/context/FacesContext;Ljava/util/ListIterator;Ljakarta/faces/event/PhaseEvent;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/Phase", "queueException", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Throwable;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"com/sun/faces/lifecycle/Phase", "jakarta/faces/context/FacesContext", "jakarta/faces/lifecycle/Lifecycle", "java/util/ListIterator", "jakarta/faces/event/PhaseEvent", "com/sun/faces/util/Timer", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getId", "()Ljakarta/faces/event/PhaseId;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "queueException", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Throwable;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/Phase", "queueException", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Throwable;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "queueException", "(Ljakarta/faces/context/FacesContext;Ljava/lang/Throwable;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "handleAfterPhase", "(Ljakarta/faces/context/FacesContext;Ljava/util/ListIterator;Ljakarta/faces/event/PhaseEvent;)V", "(Ljakarta/faces/context/FacesContext;Ljava/util/ListIterator<Ljakarta/faces/event/PhaseListener;>;Ljakarta/faces/event/PhaseEvent;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "handleBeforePhase", "(Ljakarta/faces/context/FacesContext;Ljava/util/ListIterator;Ljakarta/faces/event/PhaseEvent;)V", "(Ljakarta/faces/context/FacesContext;Ljava/util/ListIterator<Ljakarta/faces/event/PhaseListener;>;Ljakarta/faces/event/PhaseEvent;)V", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "shouldSkip", "(Ljakarta/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
