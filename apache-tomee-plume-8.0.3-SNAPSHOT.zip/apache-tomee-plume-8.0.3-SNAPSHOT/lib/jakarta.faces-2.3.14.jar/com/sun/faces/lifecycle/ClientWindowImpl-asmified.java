...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/lifecycle/ClientWindowImpl", null, "jakarta/faces/lifecycle/ClientWindow", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/ClientWindowImpl", "isClientWindowRenderModeEnabled", "(Ljakarta/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/ClientWindowImpl", "calculateClientWindow", "(Ljakarta/faces/context/FacesContext;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/lifecycle/ClientWindowImpl", "id", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateClientWindow", "(Ljakarta/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/lifecycle/ClientWindowImpl", "jakarta/faces/context/FacesContext", "java/lang/Object", "java/lang/String", "jakarta/faces/context/ExternalContext", "java/util/Map", "java/lang/Integer"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/lifecycle/ClientWindowImpl", "jakarta/faces/context/FacesContext", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
