...
public class ClientWindowImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/lifecycle/ClientWindowImpl", null, "javax/faces/lifecycle/ClientWindow", null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/lifecycle/ClientWindowImpl", "isClientWindowRenderModeEnabled", "(Ljavax/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/lifecycle/ClientWindowImpl", "id", "Ljava/lang/String;");
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/faces/lifecycle/ClientWindowImpl", "id", "Ljava/lang/String;");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IF_ACMPNE, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/ClientWindowImpl", "calculateClientWindow", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/lifecycle/ClientWindowImpl", "id", "Ljava/lang/String;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateClientWindow", "(Ljavax/faces/context/FacesContext;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label0);
methodVisitor.visitLdcInsn("com.sun.faces.lifecycle.ClientWindowCounterKey");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getExternalContext", "()Ljavax/faces/context/ExternalContext;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/lifecycle/ClientWindowImpl", "javax/faces/context/FacesContext", "java/lang/Object", "java/lang/String", "javax/faces/context/ExternalContext", "java/util/Map", "java/lang/Integer"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"com/sun/faces/lifecycle/ClientWindowImpl", "javax/faces/context/FacesContext", "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
