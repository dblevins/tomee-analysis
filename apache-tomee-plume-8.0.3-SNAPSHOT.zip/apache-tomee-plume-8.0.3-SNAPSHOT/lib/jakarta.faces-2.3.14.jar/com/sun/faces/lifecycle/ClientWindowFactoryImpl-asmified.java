...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/lifecycle/ClientWindowFactoryImpl", null, "jakarta/faces/lifecycle/ClientWindowFactory", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/lifecycle/ClientWindowFactory", "<init>", "(Ljakarta/faces/lifecycle/ClientWindowFactory;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/lifecycle/ClientWindowFactoryImpl", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext", "java/lang/String"}, 1, new Object[] {"com/sun/faces/lifecycle/ClientWindowFactoryImpl"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/lifecycle/ClientWindowFactoryImpl", "jakarta/faces/context/FacesContext", "jakarta/faces/context/ExternalContext", "java/lang/String"}, 2, new Object[] {"com/sun/faces/lifecycle/ClientWindowFactoryImpl", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/faces/lifecycle/ClientWindowFactoryImpl", "isClientWindowEnabled", "Z");
methodVisitor.visitInsn(RETURN);
