...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/Phase", "doPhase", "(Ljavax/faces/context/FacesContext;Ljavax/faces/lifecycle/Lifecycle;Ljava/util/ListIterator;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "notifyAfter", "(Ljavax/faces/context/FacesContext;Ljavax/faces/lifecycle/Lifecycle;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "deliverPostRestoreStateEvent", "(Ljavax/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/faces/FacesException", "java/util/Map", "java/lang/String"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/lifecycle/RestoreViewPhase", "isErrorPage", "(Ljavax/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "is11CompatEnabled", "(Ljavax/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/util/MessageUtils", "getExceptionMessageString", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/application/ViewExpiredException", "<init>", "(Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "maybeTakeProtectedViewAction", "(Ljavax/faces/context/FacesContext;Ljavax/faces/application/ViewHandler;Ljavax/faces/view/ViewDeclarationLanguage;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/faces/view/ViewMetadata", "hasMetadata", "(Ljavax/faces/component/UIViewRoot;)Z", false);
methodVisitor.visitJumpInsn(IFNE, label20);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "renderResponse", "()V", false);
methodVisitor.visitLabel(label20);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/String", "javax/faces/view/ViewDeclarationLanguage", "javax/faces/view/ViewMetadata"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/component/UIViewRoot", "javax/faces/FacesException"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/flow/FlowHandler", "clientWindowTransition", "(Ljavax/faces/context/FacesContext;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/component/UIViewRoot", "javax/faces/FacesException", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable", "javax/faces/flow/FlowHandler"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "deliverPostRestoreStateEvent", "(Ljavax/faces/context/FacesContext;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "maybeTakeProtectedViewAction", "(Ljavax/faces/context/FacesContext;Ljavax/faces/application/ViewHandler;Ljavax/faces/view/ViewDeclarationLanguage;Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/application/ViewHandler", "javax/faces/view/ViewDeclarationLanguage", "java/lang/String", "java/util/Set", Opcodes.INTEGER, "javax/faces/context/ExternalContext", "java/util/Map", "java/lang/String", "javax/faces/render/ResponseStateManager", "java/lang/String"}, 1, new Object[] {"java/io/UnsupportedEncodingException"});
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("Unable to re-encode value of request parameter javax.faces.Token:");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
...
methodVisitor.visitTypeInsn(NEW, "javax/faces/application/ProtectedViewException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/application/ProtectedViewException", "<init>", "()V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "originatesInWebapp", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljavax/faces/view/ViewDeclarationLanguage;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 15);
methodVisitor.visitLabel(label4);
Label label15 = new Label();
methodVisitor.visitJumpInsn(GOTO, label15);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/application/ViewHandler", "javax/faces/view/ViewDeclarationLanguage", "java/lang/String", "java/util/Set", Opcodes.INTEGER, "javax/faces/context/ExternalContext", "java/util/Map", "java/lang/String", "javax/faces/render/ResponseStateManager", "java/lang/String", "java/lang/String", "java/lang/String", Opcodes.INTEGER, Opcodes.INTEGER}, 1, new Object[] {"java/net/URISyntaxException"});
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitTypeInsn(NEW, "javax/faces/application/ProtectedViewException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/application/ProtectedViewException", "<init>", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/faces/util/FacesLogger", "interpolateMessage", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 16);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/RestoreViewPhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 16);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/faces/application/ProtectedViewException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label14);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/application/ViewHandler", "javax/faces/view/ViewDeclarationLanguage", "java/lang/String", "java/util/Set", Opcodes.INTEGER, "javax/faces/context/ExternalContext", "java/util/Map", "java/lang/String", "javax/faces/render/ResponseStateManager", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 8);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/application/ViewHandler", "javax/faces/view/ViewDeclarationLanguage", "java/lang/String", "java/util/Set", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "originatesInWebapp", "(Ljavax/faces/context/FacesContext;Ljava/lang/String;Ljavax/faces/view/ViewDeclarationLanguage;)Z", null, new String[] { "java/net/URISyntaxException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "java/lang/String", "javax/faces/view/ViewDeclarationLanguage", Opcodes.INTEGER, "javax/faces/context/ExternalContext", "java/lang/String", "java/net/URI", "java/lang/String", Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "deliverPostRestoreStateEvent", "(Ljavax/faces/context/FacesContext;)V", null, new String[] { "javax/faces/FacesException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase$1", "<init>", "(Lcom/sun/faces/lifecycle/RestoreViewPhase;Ljavax/faces/event/PostRestoreStateEvent;)V", false);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/component/UIViewRoot", "javax/faces/event/PostRestoreStateEvent"}, 1, new Object[] {"javax/faces/event/AbortProcessingException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getApplication", "()Ljavax/faces/application/Application;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "notifyAfter", "(Ljavax/faces/context/FacesContext;Ljavax/faces/lifecycle/Lifecycle;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/faces/lifecycle/RestoreViewPhase", "javax/faces/context/FacesContext", "javax/faces/lifecycle/Lifecycle", "javax/faces/component/UIViewRoot", "javax/el/MethodExpression"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitFieldInsn(GETSTATIC, "com/sun/faces/lifecycle/RestoreViewPhase", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "SEVERE", "Ljava/util/logging/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/logging/Logger", "isLoggable", "(Ljava/util/logging/Level;)Z", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isErrorPage", "(Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/FacesContext", "getExternalContext", "()Ljavax/faces/context/ExternalContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/faces/context/ExternalContext", "getRequestMap", "()Ljava/util/Map;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getWebConfig", "(Ljavax/faces/context/FacesContext;)Lcom/sun/faces/config/WebConfiguration;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "is11CompatEnabled", "(Ljavax/faces/context/FacesContext;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/sun/faces/lifecycle/RestoreViewPhase", "getWebConfig", "(Ljavax/faces/context/FacesContext;)Lcom/sun/faces/config/WebConfiguration;", false);
