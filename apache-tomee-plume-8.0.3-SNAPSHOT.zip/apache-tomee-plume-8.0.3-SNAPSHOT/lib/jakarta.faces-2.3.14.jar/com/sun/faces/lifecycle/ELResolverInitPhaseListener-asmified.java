...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "com/sun/faces/lifecycle/ELResolverInitPhaseListener", null, "java/lang/Object", new String[] { "jakarta/faces/event/PhaseListener" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "afterPhase", "(Ljakarta/faces/event/PhaseEvent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"com/sun/faces/application/ApplicationAssociate", "jakarta/faces/lifecycle/LifecycleFactory", "java/util/Iterator"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "beforePhase", "(Ljakarta/faces/event/PhaseEvent;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "populateFacesELResolverForJsp", "(Ljakarta/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getExternalContext", "()Ljakarta/faces/context/ExternalContext;", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/faces/application/ApplicationAssociate", "getInstance", "(Ljakarta/faces/context/ExternalContext;)Lcom/sun/faces/application/ApplicationAssociate;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "populateFacesELResolverForJsp", "(Ljakarta/faces/application/Application;Lcom/sun/faces/application/ApplicationAssociate;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"jakarta/faces/lifecycle/LifecycleFactory", "java/util/Iterator", "jakarta/faces/lifecycle/Lifecycle", "[Ljakarta/faces/event/PhaseListener;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/faces/lifecycle/LifecycleFactory", "java/util/Iterator"}, 0, new Object[] {});
