...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/lifecycle/Lifecycle;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/lifecycle/LifecycleWrapper", "wrapped", "Ljakarta/faces/lifecycle/Lifecycle;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/lifecycle/LifecycleWrapper", "wrapped", "Ljakarta/faces/lifecycle/Lifecycle;");
