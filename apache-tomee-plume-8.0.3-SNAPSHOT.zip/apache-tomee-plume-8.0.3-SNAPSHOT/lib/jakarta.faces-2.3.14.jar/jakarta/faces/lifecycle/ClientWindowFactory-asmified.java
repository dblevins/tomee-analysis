...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/lifecycle/ClientWindowFactory;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/lifecycle/ClientWindowFactory", "wrapped", "Ljakarta/faces/lifecycle/ClientWindowFactory;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/lifecycle/ClientWindowFactory", "wrapped", "Ljakarta/faces/lifecycle/ClientWindowFactory;");
