...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/lifecycle/ClientWindow;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/lifecycle/ClientWindowWrapper", "wrapped", "Ljakarta/faces/lifecycle/ClientWindow;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/lifecycle/ClientWindowWrapper", "wrapped", "Ljakarta/faces/lifecycle/ClientWindow;");
