...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/faces/push/PushContext", null, "java/lang/Object", new String[] { "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "ENABLE_WEBSOCKET_ENDPOINT_PARAM_NAME", "Ljava/lang/String;", null, "jakarta.faces.ENABLE_WEBSOCKET_ENDPOINT");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "WEBSOCKET_ENDPOINT_PORT_PARAM_NAME", "Ljava/lang/String;", null, "jakarta.faces.WEBSOCKET_ENDPOINT_PORT");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "URI_PREFIX", "Ljava/lang/String;", null, "/jakarta.faces.push");
fieldVisitor.visitEnd();
}
{
