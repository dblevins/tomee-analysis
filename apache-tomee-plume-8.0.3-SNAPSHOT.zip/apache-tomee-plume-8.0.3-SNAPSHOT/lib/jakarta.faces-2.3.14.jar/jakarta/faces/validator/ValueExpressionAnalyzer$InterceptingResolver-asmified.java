...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/validator/ValueExpressionAnalyzer$InterceptingResolver", null, "jakarta/el/ELResolver", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "valueReference", "Ljakarta/faces/validator/ValueReference;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/ValueExpressionAnalyzer$InterceptingResolver", "delegate", "Ljakarta/el/ELResolver;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getValueReference", "()Ljakarta/faces/validator/ValueReference;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/ValueExpressionAnalyzer$InterceptingResolver", "valueReference", "Ljakarta/faces/validator/ValueReference;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/validator/ValueReference");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/validator/ValueReference", "<init>", "(Ljava/lang/Object;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/ValueExpressionAnalyzer$InterceptingResolver", "valueReference", "Ljakarta/faces/validator/ValueReference;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/ValueExpressionAnalyzer$InterceptingResolver", "delegate", "Ljakarta/el/ELResolver;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
