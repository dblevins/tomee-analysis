...
public class MethodExpressionValidatorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/faces/validator/MethodExpressionValidator", null, "java/lang/Object", new String[] { "jakarta/faces/validator/Validator", "jakarta/faces/component/StateHolder" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "VALIDATE_EMPTY_FIELDS_PARAM_NAME", "Ljava/lang/String;", null, "jakarta.faces.VALIDATE_EMPTY_FIELDS");
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "validateEmptyFields", "Ljava/lang/Boolean;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/MethodExpressionValidator", "methodExpression", "Ljakarta/el/MethodExpression;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/validator/MethodExpressionValidator", "validateEmptyFields", "(Ljakarta/faces/context/FacesContext;)Z", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/MethodExpressionValidator", "methodExpression", "Ljakarta/el/MethodExpression;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/el/ELException", "java/lang/Throwable"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/MethodExpressionValidator", "transientValue", "Z");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/MethodExpressionValidator", "transientValue", "Z");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/MethodExpressionValidator", "validateEmptyFields", "Ljava/lang/Boolean;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/validator/MethodExpressionValidator", "isBeansValidationAvailable", "(Ljakarta/faces/context/FacesContext;)Z", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Boolean", "valueOf", "(Z)Ljava/lang/Boolean;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/MethodExpressionValidator", "validateEmptyFields", "Ljava/lang/Boolean;");
