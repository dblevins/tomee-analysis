...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/validator/BeanValidator$JsfAwareMessageInterpolator", null, "java/lang/Object", new String[] { "jakarta/validation/MessageInterpolator" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "delegate", "Ljakarta/validation/MessageInterpolator;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/BeanValidator$JsfAwareMessageInterpolator", "context", "Ljakarta/faces/context/FacesContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/validator/BeanValidator$JsfAwareMessageInterpolator", "delegate", "Ljakarta/validation/MessageInterpolator;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/BeanValidator$JsfAwareMessageInterpolator", "context", "Ljakarta/faces/context/FacesContext;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/validator/BeanValidator$JsfAwareMessageInterpolator", "delegate", "Ljakarta/validation/MessageInterpolator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 3);
