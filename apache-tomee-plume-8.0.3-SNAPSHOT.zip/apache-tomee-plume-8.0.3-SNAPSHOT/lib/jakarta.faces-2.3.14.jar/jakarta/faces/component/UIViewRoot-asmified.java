...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "lifecycle", "Ljakarta/faces/lifecycle/Lifecycle;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "phaseListenerIterator", "Ljava/util/ListIterator;", "Ljava/util/ListIterator<Ljakarta/faces/event/PhaseListener;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "events", "Ljava/util/List;", "Ljava/util/List<Ljava/util/List<Ljakarta/faces/event/FacesEvent;>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(0, "viewListeners", "Ljava/util/Map;", "Ljava/util/Map<Ljava/lang/Class<+Ljakarta/faces/event/SystemEvent;>;Ljava/util/List<Ljakarta/faces/event/SystemEventListener;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "events", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "getComponentResources", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Z)Ljava/util/List;", false);
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UIViewRoot", "LOCATION_IDENTIFIER_MAP", "Ljava/util/Map;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "events", "Ljava/util/List;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label1);
...
methodVisitor.visitTryCatchBlock(label6, label7, label8, "jakarta/faces/event/AbortProcessingException");
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UIViewRoot", "getCompositeComponentParent", "(Ljakarta/faces/component/UIComponent;)Ljakarta/faces/component/UIComponent;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"jakarta/faces/component/UIViewRoot", "jakarta/faces/context/FacesContext", "jakarta/faces/event/PhaseId", Opcodes.INTEGER, Opcodes.TOP, "java/util/List"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "skipPhase", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "beforeMethodException", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIViewRoot", "getStateHelper", "()Ljakarta/faces/component/StateHelper;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UIViewRoot$PropertyKeys", "phaseListeners", "Ljakarta/faces/component/UIViewRoot$PropertyKeys;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/faces/component/StateHelper", "get", "(Ljava/io/Serializable;)Ljava/lang/Object;", true);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/faces/component/UIViewRoot", "java/util/List"}, 1, new Object[] {"jakarta/faces/component/UIViewRoot"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"jakarta/faces/component/UIViewRoot", "java/util/List"}, 2, new Object[] {"jakarta/faces/component/UIViewRoot", "java/util/ListIterator"});
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "phaseListenerIterator", "Ljava/util/ListIterator;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "notifyBefore", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "phaseListenerIterator", "Ljava/util/ListIterator;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "notifyPhaseListeners", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;Z)V", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "notifyAfter", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/context/FacesContext", "jakarta/faces/application/ResourceHandler", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIComponentBase", "processEvent", "(Ljakarta/faces/event/ComponentSystemEvent;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "initState", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/event/PhaseId", "APPLY_REQUEST_VALUES", "Ljakarta/faces/event/PhaseId;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "notifyBefore", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)V", false);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "skipPhase", "Z");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "clearFacesEvents", "(Ljakarta/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/event/PhaseId", "APPLY_REQUEST_VALUES", "Ljakarta/faces/event/PhaseId;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "notifyAfter", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)V", false);
Label label5 = new Label();
...
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/component/UIViewRoot$DoResetValues");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot$DoResetValues", "<init>", "(Ljakarta/faces/component/UIViewRoot$1;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "encodeViewParameters", "(Ljakarta/faces/context/FacesContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/event/PhaseId", "RENDER_RESPONSE", "Ljakarta/faces/event/PhaseId;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot", "notifyAfter", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "notifyPhaseListeners", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;Z)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UIViewRoot", "createPhaseEvent", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)Ljakarta/faces/event/PhaseEvent;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIViewRoot", "getBeforePhaseListener", "()Ljakarta/el/MethodExpression;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"jakarta/faces/event/PhaseEvent", "jakarta/el/MethodExpression", "jakarta/el/MethodExpression"}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 3);
Label label8 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "beforeMethodException", "Z");
methodVisitor.visitJumpInsn(IFNE, label8);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitInsn(ICONST_1);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/el/MethodExpression"});
methodVisitor.visitVarInsn(ASTORE, 8);
...
methodVisitor.visitLabel(label13);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"jakarta/faces/component/UIViewRoot", "jakarta/faces/context/FacesContext", "jakarta/faces/event/PhaseId", Opcodes.INTEGER, "jakarta/faces/event/PhaseEvent", "jakarta/el/MethodExpression", "jakarta/el/MethodExpression", Opcodes.INTEGER, "jakarta/el/MethodExpression"}, 1, new Object[] {"jakarta/faces/component/UIViewRoot"});
methodVisitor.visitInsn(ICONST_1);
Label label15 = new Label();
methodVisitor.visitJumpInsn(GOTO, label15);
methodVisitor.visitLabel(label14);
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label15);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"jakarta/faces/component/UIViewRoot", "jakarta/faces/context/FacesContext", "jakarta/faces/event/PhaseId", Opcodes.INTEGER, "jakarta/faces/event/PhaseEvent", "jakarta/el/MethodExpression", "jakarta/el/MethodExpression", Opcodes.INTEGER, "jakarta/el/MethodExpression"}, 2, new Object[] {"jakarta/faces/component/UIViewRoot", Opcodes.INTEGER});
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "skipPhase", "Z");
methodVisitor.visitLabel(label1);
...
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UIViewRoot", "LOGGER", "Ljava/util/logging/Logger;");
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/faces/event/PhaseListener");
methodVisitor.visitLabel(label28);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"jakarta/faces/event/PhaseListener"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 9);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "createPhaseEvent", "(Ljakarta/faces/context/FacesContext;Ljakarta/faces/event/PhaseId;)Ljakarta/faces/event/PhaseEvent;", null, new String[] { "jakarta/faces/FacesException" });
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UIViewRoot", "lifecycle", "Ljakarta/faces/lifecycle/Lifecycle;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/UIViewRoot", "lifecycle", "Ljakarta/faces/lifecycle/Lifecycle;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_CHOP,2, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "clearFacesEvents", "(Ljakarta/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getRenderResponse", "()Z", false);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/String");
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UIViewRoot", "getLocaleFromString", "(Ljava/lang/String;)Ljava/util/Locale;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UIViewRoot", "indexOfSet", "(Ljava/lang/String;[CI)I", false);
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ISTORE, 7);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/component/UIViewRoot$ViewMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIViewRoot", "getFacesContext", "()Ljakarta/faces/context/FacesContext;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/context/FacesContext", "getApplication", "()Ljakarta/faces/application/Application;", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/component/UIViewRoot$ViewMap", "<init>", "(Ljakarta/faces/application/ProjectStage;)V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIViewRoot", "getTransientStateHelper", "()Ljakarta/faces/component/TransientStateHelper;", false);
methodVisitor.visitLdcInsn("com.sun.faces.application.view.viewMap");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "viewListeners", "Ljava/util/Map;");
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "viewListeners", "Ljava/util/Map;");
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "viewListeners", "Ljava/util/Map;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "encodeViewParameters", "(Ljakarta/faces/context/FacesContext;)V", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"jakarta/faces/view/ViewMetadata", "java/util/Collection"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljava/lang/Object;");
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot", "values", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot", "values", "[Ljava/lang/Object;");
methodVisitor.visitInsn(ICONST_0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getComponentResources", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Z)Ljava/util/List;", "(Ljakarta/faces/context/FacesContext;Ljava/lang/String;Z)Ljava/util/List<Ljakarta/faces/component/UIComponent;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UIViewRoot", "getIdentifier", "(Ljava/lang/String;)Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/UIViewRoot", "LOGGER", "Ljava/util/logging/Logger;");
methodVisitor.visitTypeInsn(NEW, "java/util/LinkedHashMap");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_3);
methodVisitor.visitInsn(FCONST_1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/LinkedHashMap", "<init>", "(IF)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "jakarta/faces/component/UIViewRoot", "LOCATION_IDENTIFIER_MAP", "Ljava/util/Map;");
methodVisitor.visitFieldInsn(GETSTATIC, "jakarta/faces/component/UIViewRoot", "LOCATION_IDENTIFIER_MAP", "Ljava/util/Map;");
methodVisitor.visitLdcInsn("head");
