...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "jakarta/faces/component/UIViewRoot$ViewMap", "Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Object;>;", "java/util/HashMap", null);

classWriter.visitInnerClass("jakarta/faces/component/UIViewRoot$ViewMap", "jakarta/faces/component/UIViewRoot", "ViewMap", ACC_PRIVATE | ACC_FINAL | ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "stage", "Ljakarta/faces/application/ProjectStage;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljakarta/faces/application/ProjectStage;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashMap", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/component/UIViewRoot$ViewMap", "stage", "Ljakarta/faces/application/ProjectStage;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/component/UIViewRoot$ViewMap", "stage", "Ljakarta/faces/application/ProjectStage;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "jakarta/faces/component/UIViewRoot", "access$100", "()Ljava/util/logging/Logger;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIViewRoot$ViewMap", "put", "(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;", false);
