...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/faces/component/UIColumn", null, "jakarta/faces/component/UIComponentBase", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "COMPONENT_TYPE", "Ljava/lang/String;", null, "jakarta.faces.Column");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIColumn", "setRendererType", "(Ljava/lang/String;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/component/UIColumn", "getFacet", "(Ljava/lang/String;)Ljakarta/faces/component/UIComponent;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
