...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", null, "jakarta/faces/application/FacesMessage", null);

classWriter.visitInnerClass("jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "jakarta/faces/webapp/MessageFactory", "BindingFacesMessage", ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "locale", "Ljava/util/Locale;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "parameters", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "resolvedParameters", "[Ljava/lang/Object;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "java/util/Locale", "java/lang/String", "java/lang/String", "[Ljava/lang/Object;"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "resolveBindings", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "resolvedParameters", "[Ljava/lang/Object;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "getFormattedString", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", false);
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "parameters", "[Ljava/lang/Object;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/webapp/MessageFactory$BindingFacesMessage", "locale", "Ljava/util/Locale;");
Label label2 = new Label();
