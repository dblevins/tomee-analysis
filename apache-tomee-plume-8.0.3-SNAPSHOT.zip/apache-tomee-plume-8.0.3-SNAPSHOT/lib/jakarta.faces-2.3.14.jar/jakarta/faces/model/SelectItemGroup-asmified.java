...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "selectItems", "[Ljakarta/faces/model/SelectItem;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/SelectItemGroup", "selectItems", "[Ljakarta/faces/model/SelectItem;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/SelectItemGroup", "setSelectItems", "([Ljakarta/faces/model/SelectItem;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/SelectItemGroup", "selectItems", "[Ljakarta/faces/model/SelectItem;");
