...
public class NoRowAvailableExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/model/NoRowAvailableException", null, "java/lang/IllegalArgumentException", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(3794135774633215459L));
