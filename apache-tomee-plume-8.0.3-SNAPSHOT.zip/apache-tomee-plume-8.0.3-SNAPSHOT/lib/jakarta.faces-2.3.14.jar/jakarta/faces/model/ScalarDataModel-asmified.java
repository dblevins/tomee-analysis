...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/faces/model/ScalarDataModel", "<E:Ljava/lang/Object;>Ljakarta/faces/model/DataModel<TE;>;", "jakarta/faces/model/DataModel", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ScalarDataModel", "setWrappedData", "(Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ScalarDataModel", "scalar", "Ljava/lang/Object;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ScalarDataModel", "index", "I");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ScalarDataModel", "isRowAvailable", "()Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNE, label1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ScalarDataModel", "index", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ScalarDataModel", "scalar", "Ljava/lang/Object;");
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ScalarDataModel", "getDataModelListeners", "()[Ljakarta/faces/model/DataModelListener;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ScalarDataModel", "getRowData", "()Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"jakarta/faces/model/ScalarDataModel", Opcodes.INTEGER, Opcodes.INTEGER, "[Ljakarta/faces/model/DataModelListener;"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ScalarDataModel", "scalar", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_M1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ScalarDataModel", "setRowIndex", "(I)V", false);
Label label1 = new Label();
