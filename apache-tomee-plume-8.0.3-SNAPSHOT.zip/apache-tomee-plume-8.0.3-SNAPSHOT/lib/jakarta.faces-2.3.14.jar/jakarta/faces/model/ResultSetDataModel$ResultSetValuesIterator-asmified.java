...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/model/ResultSetDataModel$ResultSetValuesIterator", "Ljava/lang/Object;Ljava/util/Iterator<Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/util/Iterator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetValuesIterator", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetValuesIterator", "keys", "Ljava/util/Iterator;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetValuesIterator", "keys", "Ljava/util/Iterator;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetValuesIterator", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetValuesIterator", "keys", "Ljava/util/Iterator;");
