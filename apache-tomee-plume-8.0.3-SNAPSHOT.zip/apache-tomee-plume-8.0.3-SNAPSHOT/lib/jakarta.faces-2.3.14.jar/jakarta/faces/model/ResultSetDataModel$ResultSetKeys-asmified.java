...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/model/ResultSetDataModel$ResultSetKeys", "Ljava/util/AbstractSet<Ljava/lang/String;>;", "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetKeys", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetKeys", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/model/ResultSetDataModel$ResultSetKeysIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetKeys", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/model/ResultSetDataModel$ResultSetKeysIterator", "<init>", "(Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ResultSetDataModel$ResultSetKeys", "add", "(Ljava/lang/String;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
