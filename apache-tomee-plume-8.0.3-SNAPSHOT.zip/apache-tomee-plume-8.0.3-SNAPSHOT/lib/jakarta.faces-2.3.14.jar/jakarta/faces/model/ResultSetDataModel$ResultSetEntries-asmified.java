...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/faces/model/ResultSetDataModel$ResultSetEntries", "Ljava/util/AbstractSet<Ljava/util/Map$Entry<Ljava/lang/String;Ljava/lang/Object;>;>;", "java/util/AbstractSet", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetEntries", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetEntries", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetEntries", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ResultSetDataModel$ResultSetMap", "isEmpty", "()Z", false);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "jakarta/faces/model/ResultSetDataModel$ResultSetEntriesIterator");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/model/ResultSetDataModel$ResultSetEntries", "map", "Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/model/ResultSetDataModel$ResultSetEntriesIterator", "<init>", "(Ljakarta/faces/model/ResultSetDataModel$ResultSetMap;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/Map$Entry");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/faces/model/ResultSetDataModel$ResultSetEntries", "add", "(Ljava/util/Map$Entry;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
