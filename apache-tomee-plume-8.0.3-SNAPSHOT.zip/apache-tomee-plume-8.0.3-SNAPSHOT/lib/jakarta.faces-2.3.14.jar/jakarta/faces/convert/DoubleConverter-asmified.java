...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "DOUBLE_ID", "Ljava/lang/String;", null, "jakarta.faces.converter.DoubleConverter.DOUBLE");
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("jakarta.faces.converter.DoubleConverter.DOUBLE");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLdcInsn("1999999");
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
