...
public class PostAddToViewEventDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "jakarta/faces/event/PostAddToViewEvent", null, "jakarta/faces/event/ComponentSystemEvent", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-1113592223476173895L));
