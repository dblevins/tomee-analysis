...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "behavior", "Ljakarta/faces/component/behavior/Behavior;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/event/BehaviorEvent", "behavior", "Ljakarta/faces/component/behavior/Behavior;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/event/BehaviorEvent", "behavior", "Ljakarta/faces/component/behavior/Behavior;");
