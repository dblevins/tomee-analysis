...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/context/PartialViewContext;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/context/PartialViewContextWrapper", "wrapped", "Ljakarta/faces/context/PartialViewContext;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/context/PartialViewContextWrapper", "wrapped", "Ljakarta/faces/context/PartialViewContext;");
