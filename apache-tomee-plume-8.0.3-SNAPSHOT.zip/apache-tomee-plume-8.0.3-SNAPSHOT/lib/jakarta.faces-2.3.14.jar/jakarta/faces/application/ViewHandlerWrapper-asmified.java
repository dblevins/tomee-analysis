...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/application/ViewHandler;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/application/ViewHandlerWrapper", "wrapped", "Ljakarta/faces/application/ViewHandler;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/application/ViewHandlerWrapper", "wrapped", "Ljakarta/faces/application/ViewHandler;");
