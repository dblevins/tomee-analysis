...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/application/Application;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/application/ApplicationWrapper", "wrapped", "Ljakarta/faces/application/Application;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/application/ApplicationWrapper", "wrapped", "Ljakarta/faces/application/Application;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/faces/application/Application", "setFlowHandler", "(Ljakarta/faces/flow/FlowHandler;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
