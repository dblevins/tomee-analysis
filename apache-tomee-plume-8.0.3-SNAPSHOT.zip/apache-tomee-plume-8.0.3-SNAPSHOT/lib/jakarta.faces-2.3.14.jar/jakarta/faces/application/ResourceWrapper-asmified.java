...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "wrapped", "Ljakarta/faces/application/Resource;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/faces/application/ResourceWrapper", "wrapped", "Ljakarta/faces/application/Resource;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/faces/application/ResourceWrapper", "wrapped", "Ljakarta/faces/application/Resource;");
