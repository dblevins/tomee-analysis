...
public class JDBCMessageStore$4Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/store/jdbc/JDBCMessageStore$4", null, "java/lang/Object", new String[] { "org/apache/activemq/store/jdbc/JDBCMessageRecoveryListener" });

classWriter.visitOuterClass("org/apache/activemq/store/jdbc/JDBCMessageStore", "recoverNextMessages", "(ILorg/apache/activemq/store/MessageRecoveryListener;)V");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/jdbc/JDBCMessageStore$4", "this$0", "Lorg/apache/activemq/store/jdbc/JDBCMessageStore;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/store/jdbc/JDBCMessageStore$4", "val$listener", "Lorg/apache/activemq/store/MessageRecoveryListener;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/jdbc/JDBCMessageStore$4", "val$listener", "Lorg/apache/activemq/store/MessageRecoveryListener;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/store/jdbc/JDBCMessageStore$4", "this$0", "Lorg/apache/activemq/store/jdbc/JDBCMessageStore;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/store/jdbc/JDBCMessageStore", "access$100", "(Lorg/apache/activemq/store/jdbc/JDBCMessageStore;JI)V", false);
