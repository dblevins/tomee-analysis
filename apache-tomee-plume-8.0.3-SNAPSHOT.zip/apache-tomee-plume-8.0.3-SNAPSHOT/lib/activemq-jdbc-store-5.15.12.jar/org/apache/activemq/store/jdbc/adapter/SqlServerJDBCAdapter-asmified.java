...
public class SqlServerJDBCAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/store/jdbc/adapter/SqlServerJDBCAdapter", null, "org/apache/activemq/store/jdbc/adapter/DefaultJDBCAdapter", null);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("SELECT * FROM ACTIVEMQ_LOCK WITH (UPDLOCK, ROWLOCK) WHERE ID=1");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("VARBINARY(MAX)");
