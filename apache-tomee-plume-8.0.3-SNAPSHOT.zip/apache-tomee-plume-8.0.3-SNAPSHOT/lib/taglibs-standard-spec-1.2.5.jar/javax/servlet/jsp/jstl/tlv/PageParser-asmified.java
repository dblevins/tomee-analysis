...
classWriter.visit(V1_5, ACC_SUPER, "javax/servlet/jsp/jstl/tlv/PageParser", null, "java/lang/Object", null);

classWriter.visitInnerClass("javax/servlet/jsp/jstl/tlv/PageParser$1", null, null, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "javax/servlet/jsp/jstl/tlv/PageParser$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/servlet/jsp/jstl/tlv/PageParser$1", "<init>", "(Ljavax/servlet/jsp/jstl/tlv/PageParser;)V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/xml/parsers/SAXParserFactory");
methodVisitor.visitFieldInsn(PUTFIELD, "javax/servlet/jsp/jstl/tlv/PageParser", "parserFactory", "Ljavax/xml/parsers/SAXParserFactory;");
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/servlet/jsp/jstl/tlv/PageParser", "parserFactory", "Ljavax/xml/parsers/SAXParserFactory;");
...
{
methodVisitor = classWriter.visitMethod(0, "parse", "(Ljavax/servlet/jsp/tagext/PageData;Lorg/xml/sax/helpers/DefaultHandler;)V", null, new String[] { "javax/xml/parsers/ParserConfigurationException", "org/xml/sax/SAXException", "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
