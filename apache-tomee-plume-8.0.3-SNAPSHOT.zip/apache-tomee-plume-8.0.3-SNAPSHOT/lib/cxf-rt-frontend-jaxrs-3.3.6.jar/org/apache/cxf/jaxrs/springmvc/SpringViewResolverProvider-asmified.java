...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/springframework/web/servlet/LocaleResolver", "resolveLocale", "(Ljakarta/servlet/http/HttpServletRequest;)Ljava/util/Locale;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/springframework/web/servlet/View", "render", "(Ljava/util/Map;Ljakarta/servlet/http/HttpServletRequest;Ljakarta/servlet/http/HttpServletResponse;)V", true);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/cxf/jaxrs/springmvc/SpringViewResolverProvider", "java/lang/Object", "java/lang/Class", "java/lang/reflect/Type", "[Ljava/lang/annotation/Annotation;", "jakarta/ws/rs/core/MediaType", "jakarta/ws/rs/core/MultivaluedMap", "java/io/OutputStream", "org/springframework/web/servlet/View", "java/lang/String", "java/util/Map"}, 1, new Object[] {"java/lang/Throwable"});
