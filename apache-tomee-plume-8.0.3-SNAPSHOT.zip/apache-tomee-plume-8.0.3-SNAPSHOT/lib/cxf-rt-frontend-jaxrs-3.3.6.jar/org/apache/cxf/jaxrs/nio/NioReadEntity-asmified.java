...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/http/HttpServletRequest", "getInputStream", "()Ljavax/servlet/ServletInputStream;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/cxf/jaxrs/nio/NioReadListenerImpl", "<init>", "(Lorg/apache/cxf/jaxrs/nio/NioReadEntity;Ljavax/servlet/ServletInputStream;)V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/servlet/ServletInputStream", "setReadListener", "(Ljavax/servlet/ReadListener;)V", false);
