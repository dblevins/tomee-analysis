...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "Ljava/lang/Object;Ljavax/ws/rs/ext/ExceptionMapper<Ljavax/validation/ValidationException;>;", "java/lang/Object", new String[] { "javax/ws/rs/ext/ExceptionMapper" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "toResponse", "(Ljavax/validation/ValidationException;)Ljavax/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/validation/ConstraintViolationException");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/validation/ConstraintViolationException");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/validation/ConstraintViolationException", "getConstraintViolations", "()Ljava/util/Set;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
Label label3 = new Label();
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/lang/StringBuilder", "javax/validation/ConstraintViolationException", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "buildErrorMessage", "(Ljavax/validation/ConstraintViolation;)Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/validation/ConstraintViolation", "java/lang/String"}, 0, null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/validation/ValidationException", "javax/ws/rs/core/Response$Status", "java/lang/StringBuilder", "javax/validation/ConstraintViolationException"}, 2, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/ws/rs/core/Response$Status"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/validation/ValidationException", "javax/ws/rs/core/Response$Status", "java/lang/StringBuilder", "javax/validation/ConstraintViolationException"}, 3, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/ws/rs/core/Response$Status", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "buildResponse", "(Ljavax/ws/rs/core/Response$Status;Ljava/lang/String;)Ljavax/ws/rs/core/Response;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/validation/ValidationException", "javax/ws/rs/core/Response$Status"}, 2, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/ws/rs/core/Response$Status"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/validation/ValidationException", "javax/ws/rs/core/Response$Status"}, 3, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/ws/rs/core/Response$Status", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "buildResponse", "(Ljavax/ws/rs/core/Response$Status;Ljava/lang/String;)Ljavax/ws/rs/core/Response;", false);
methodVisitor.visitInsn(ARETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildErrorMessage", "(Ljavax/validation/ConstraintViolation;)Ljava/lang/String;", "(Ljavax/validation/ConstraintViolation<*>;)Ljava/lang/String;", null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "javax/validation/ConstraintViolation"}, 2, new Object[] {"java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "buildResponse", "(Ljavax/ws/rs/core/Response$Status;Ljava/lang/String;)Ljavax/ws/rs/core/Response;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/jaxrs/validation/ValidationExceptionMapper", "toResponse", "(Ljavax/validation/ValidationException;)Ljavax/ws/rs/core/Response;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
