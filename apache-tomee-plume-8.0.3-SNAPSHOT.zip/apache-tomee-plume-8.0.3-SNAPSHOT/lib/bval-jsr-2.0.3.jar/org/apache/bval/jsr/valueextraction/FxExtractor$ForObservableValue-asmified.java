...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/valueextraction/FxExtractor$ForObservableValue", "Ljava/lang/Object;Ljavax/validation/valueextraction/ValueExtractor<Ljavafx/beans/value/ObservableValue<*>;>;", "java/lang/Object", new String[] { "javax/validation/valueextraction/ValueExtractor" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "extractValues", "(Ljavafx/beans/value/ObservableValue;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", "(Ljavafx/beans/value/ObservableValue<*>;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/FxExtractor$ForObservableValue", "extractValues", "(Ljavafx/beans/value/ObservableValue;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
