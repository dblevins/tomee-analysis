...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/validation/metadata/ConstraintDescriptor");
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/descriptor/ReturnValueD", "hasValidatorForType", "(Ljava/lang/Class;Ljavax/validation/metadata/ConstraintDescriptor;)Z", false);
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFNE, label4);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/metadata/ConstraintDescriptor", "getConstraintValidatorClasses", "()Ljava/util/List;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "isEmpty", "()Z", true);
Label label5 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/metadata/ConstraintDescriptor", "getComposingConstraints", "()Ljava/util/Set;", true);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "isEmpty", "()Z", true);
methodVisitor.visitJumpInsn(IFNE, label4);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/validation/metadata/ConstraintDescriptor"}, 0, null);
...
methodVisitor.visitTypeInsn(NEW, "javax/validation/UnexpectedTypeException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/validation/UnexpectedTypeException", "<init>", "(Ljava/lang/String;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "hasValidatorForType", "(Ljava/lang/Class;Ljavax/validation/metadata/ConstraintDescriptor;)Z", "(Ljava/lang/Class<*>;Ljavax/validation/metadata/ConstraintDescriptor<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/metadata/ConstraintDescriptor", "getConstraintValidatorClasses", "()Ljava/util/List;", true);
