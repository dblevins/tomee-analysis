...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/validation/Constraint");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/Constraint", "validatedBy", "()[Ljava/lang/Class;", true);
