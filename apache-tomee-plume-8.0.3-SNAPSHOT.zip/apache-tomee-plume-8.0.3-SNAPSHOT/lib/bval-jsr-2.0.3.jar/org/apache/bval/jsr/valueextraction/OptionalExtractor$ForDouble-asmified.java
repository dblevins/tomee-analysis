...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/valueextraction/OptionalExtractor$ForDouble", "Ljava/lang/Object;Ljakarta/validation/valueextraction/ValueExtractor<Ljava/util/OptionalDouble;>;", "java/lang/Object", new String[] { "jakarta/validation/valueextraction/ValueExtractor" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "extractValues", "(Ljava/util/OptionalDouble;Ljakarta/validation/valueextraction/ValueExtractor$ValueReceiver;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/bval/jsr/valueextraction/OptionalExtractor$ForDouble", "java/util/OptionalDouble", "jakarta/validation/valueextraction/ValueExtractor$ValueReceiver"}, 2, new Object[] {"jakarta/validation/valueextraction/ValueExtractor$ValueReceiver", Opcodes.NULL});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/bval/jsr/valueextraction/OptionalExtractor$ForDouble", "java/util/OptionalDouble", "jakarta/validation/valueextraction/ValueExtractor$ValueReceiver"}, 3, new Object[] {"jakarta/validation/valueextraction/ValueExtractor$ValueReceiver", Opcodes.NULL, "java/lang/Double"});
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/OptionalExtractor$ForDouble", "extractValues", "(Ljava/util/OptionalDouble;Ljakarta/validation/valueextraction/ValueExtractor$ValueReceiver;)V", false);
methodVisitor.visitInsn(RETURN);
