...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL | ACC_DEPRECATED, "computeCascadingGroups", "(Ljava/util/Set;Ljava/lang/Class;)Lorg/apache/bval/jsr/groups/Groups;", "(Ljava/util/Set<Ljakarta/validation/metadata/GroupConversionDescriptor;>;Ljava/lang/Class<*>;)Lorg/apache/bval/jsr/groups/Groups;", null);
{
...
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEINTERFACE, "jakarta/validation/metadata/GroupConversionDescriptor", "getFrom", "()Ljava/lang/Class;", true), Type.getType("(Ljakarta/validation/metadata/GroupConversionDescriptor;)Ljava/lang/Class;")});
methodVisitor.visitInvokeDynamicInsn("apply", "()Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEINTERFACE, "jakarta/validation/metadata/GroupConversionDescriptor", "getTo", "()Ljava/lang/Class;", true), Type.getType("(Ljakarta/validation/metadata/GroupConversionDescriptor;)Ljava/lang/Class;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveSequence", "(Ljava/lang/Class;Ljakarta/validation/GroupSequence;Ljava/util/Set;)Ljava/util/List;", "(Ljava/lang/Class<*>;Ljakarta/validation/GroupSequence;Ljava/util/Set<Ljava/lang/Class<*>;>;)Ljava/util/List<Lorg/apache/bval/jsr/groups/Group;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/bval/jsr/groups/GroupsComputer", "java/lang/Class", "jakarta/validation/GroupSequence", "java/util/Set", "java/util/List", "[Ljava/lang/Class;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/lang/Class", "jakarta/validation/GroupSequence"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/jsr/groups/GroupsComputer", "resolveSequence", "(Ljava/lang/Class;Ljakarta/validation/GroupSequence;Ljava/util/Set;)Ljava/util/List;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInvokeDynamicInsn("apply", "(Lorg/apache/bval/jsr/groups/GroupsComputer;Ljakarta/validation/GroupSequence;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/bval/jsr/groups/GroupsComputer", "lambda$null$1", "(Ljakarta/validation/GroupSequence;Ljava/lang/Class;)Ljava/util/List;", false), Type.getType("(Ljava/lang/Class;)Ljava/util/List;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$null$1", "(Ljakarta/validation/GroupSequence;Ljava/lang/Class;)Ljava/util/List;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
