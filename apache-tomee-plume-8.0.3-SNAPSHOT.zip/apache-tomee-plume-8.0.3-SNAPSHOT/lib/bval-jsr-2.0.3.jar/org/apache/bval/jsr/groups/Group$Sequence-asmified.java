...
methodVisitor.visitTryCatchBlock(label0, label1, label2, "javax/validation/GroupDefinitionException");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/bval/jsr/groups/Group$Sequence", "java/util/Map", "java/util/Set"}, 1, new Object[] {"javax/validation/GroupDefinitionException"});
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/validation/GroupDefinitionException");
