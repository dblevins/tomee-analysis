...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/jsr/valueextraction/FxExtractor$ForListProperty", "Ljava/lang/Object;Ljavax/validation/valueextraction/ValueExtractor<Ljavafx/beans/property/ReadOnlyListProperty<*>;>;", "java/lang/Object", new String[] { "javax/validation/valueextraction/ValueExtractor" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "extractValues", "(Ljavafx/beans/property/ReadOnlyListProperty;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", "(Ljavafx/beans/property/ReadOnlyListProperty<*>;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", null);
methodVisitor.visitCode();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/jsr/valueextraction/FxExtractor$ForListProperty", "extractValues", "(Ljavafx/beans/property/ReadOnlyListProperty;Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$extractValues$0", "(Ljavax/validation/valueextraction/ValueExtractor$ValueReceiver;Ljavafx/collections/ObservableList;)V", null, null);
methodVisitor.visitCode();
