...
classWriter.visitOuterClass("org/apache/bval/constraints/EmailValidator", "lambda$new$0", "(Ljakarta/validation/constraints/Email;)Lorg/apache/bval/constraints/AbstractPatternValidator$PatternDescriptor;");
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$email", "Ljakarta/validation/constraints/Email;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljakarta/validation/constraints/Email;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/constraints/EmailValidator$1", "val$email", "Ljakarta/validation/constraints/Email;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/constraints/EmailValidator$1", "val$email", "Ljakarta/validation/constraints/Email;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/validation/constraints/Email", "regexp", "()Ljava/lang/String;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/constraints/EmailValidator$1", "val$email", "Ljakarta/validation/constraints/Email;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/validation/constraints/Email", "flags", "()[Ljakarta/validation/constraints/Pattern$Flag;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
