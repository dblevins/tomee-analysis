...
public class NumberSignValidator$ForNegativeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/constraints/NumberSignValidator$ForNegative", "Lorg/apache/bval/constraints/NumberSignValidator<Ljakarta/validation/constraints/Negative;>;", "org/apache/bval/constraints/NumberSignValidator", null);
...
methodVisitor.visitInvokeDynamicInsn("test", "()Ljava/util/function/IntPredicate;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(I)Z"), new Handle(Opcodes.H_INVOKESTATIC, "org/apache/bval/constraints/NumberSignValidator$ForNegative", "lambda$new$0", "(I)Z", false), Type.getType("(I)Z")});
