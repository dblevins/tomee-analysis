...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/constraints/DigitsValidatorForString", "Ljava/lang/Object;Ljakarta/validation/ConstraintValidator<Ljakarta/validation/constraints/Digits;Ljava/lang/String;>;", "java/lang/Object", new String[] { "jakarta/validation/ConstraintValidator" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/constraints/DigitsValidatorForString", "isValid", "(Ljava/lang/String;Ljakarta/validation/ConstraintValidatorContext;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/constraints/DigitsValidatorForString", "initialize", "(Ljakarta/validation/constraints/Digits;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
