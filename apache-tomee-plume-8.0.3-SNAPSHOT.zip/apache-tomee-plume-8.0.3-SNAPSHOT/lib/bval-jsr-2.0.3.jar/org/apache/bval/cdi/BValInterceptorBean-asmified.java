...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/bval/cdi/BValInterceptorBean", "Ljava/lang/Object;Ljavax/enterprise/inject/spi/Bean<Lorg/apache/bval/cdi/BValInterceptor;>;Ljavax/enterprise/inject/spi/PassivationCapable;", "java/lang/Object", new String[] { "javax/enterprise/inject/spi/Bean", "javax/enterprise/inject/spi/PassivationCapable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "injectionPoints", "Ljava/util/Set;", "Ljava/util/Set<Ljavax/enterprise/inject/spi/InjectionPoint;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "injectionTarget", "Ljavax/enterprise/inject/spi/InjectionTarget;", "Ljavax/enterprise/inject/spi/InjectionTarget<Lorg/apache/bval/cdi/BValInterceptor;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/bval/cdi/BValInterceptorBean", "injectionTarget", "Ljavax/enterprise/inject/spi/InjectionTarget;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/cdi/BValInterceptorBean", "injectionTarget", "Ljavax/enterprise/inject/spi/InjectionTarget;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/bval/cdi/BValInterceptorBean$BValInterceptorInjectionPoint", "<init>", "(Ljavax/enterprise/inject/spi/Bean;Ljavax/enterprise/inject/spi/InjectionPoint;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "create", "(Ljavax/enterprise/context/spi/CreationalContext;)Lorg/apache/bval/cdi/BValInterceptor;", "(Ljavax/enterprise/context/spi/CreationalContext<Lorg/apache/bval/cdi/BValInterceptor;>;)Lorg/apache/bval/cdi/BValInterceptor;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/cdi/BValInterceptorBean", "injectionTarget", "Ljavax/enterprise/inject/spi/InjectionTarget;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "destroy", "(Lorg/apache/bval/cdi/BValInterceptor;Ljavax/enterprise/context/spi/CreationalContext;)V", "(Lorg/apache/bval/cdi/BValInterceptor;Ljavax/enterprise/context/spi/CreationalContext<Lorg/apache/bval/cdi/BValInterceptor;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/bval/cdi/BValInterceptorBean", "injectionTarget", "Ljavax/enterprise/inject/spi/InjectionTarget;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/bval/cdi/BValInterceptor");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/cdi/BValInterceptorBean", "destroy", "(Lorg/apache/bval/cdi/BValInterceptor;Ljavax/enterprise/context/spi/CreationalContext;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/bval/cdi/BValInterceptorBean", "create", "(Ljavax/enterprise/context/spi/CreationalContext;)Lorg/apache/bval/cdi/BValInterceptor;", false);
methodVisitor.visitInsn(ARETURN);
