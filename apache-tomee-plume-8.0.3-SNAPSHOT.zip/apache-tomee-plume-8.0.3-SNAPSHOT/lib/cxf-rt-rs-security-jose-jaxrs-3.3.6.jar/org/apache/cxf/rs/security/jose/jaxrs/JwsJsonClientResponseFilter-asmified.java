...
public class JwsJsonClientResponseFilterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", null, "org/apache/cxf/rs/security/jose/jaxrs/AbstractJwsJsonReaderProvider", new String[] { "javax/ws/rs/client/ClientResponseFilter" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "filter", "(Ljavax/ws/rs/client/ClientRequestContext;Ljavax/ws/rs/client/ClientResponseContext;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "isMethodWithNoContent", "(Ljava/lang/String;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientResponseContext", "getStatus", "()I", true);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "isStatusCodeWithNoContent", "(I)Z", false);
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "isCheckEmptyStream", "()Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientResponseContext", "hasEntity", "()Z", true);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientResponseContext", "getEntityStream", "()Ljava/io/InputStream;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "getInitializedSigVerifier", "()Lorg/apache/cxf/rs/security/jose/jws/JwsSignatureVerifier;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "validate", "(Lorg/apache/cxf/rs/security/jose/jws/JwsJsonConsumer;Lorg/apache/cxf/rs/security/jose/jws/JwsSignatureVerifier;)V", false);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientResponseContext", "setEntityStream", "(Ljava/io/InputStream;)V", true);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/ws/rs/client/ClientResponseContext", "getHeaders", "()Ljavax/ws/rs/core/MultivaluedMap;", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "getDefaultMediaType", "()Ljava/lang/String;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/cxf/rs/security/jose/jaxrs/JwsJsonClientResponseFilter", "javax/ws/rs/client/ClientRequestContext", "javax/ws/rs/client/ClientResponseContext", "java/lang/String", "org/apache/cxf/rs/security/jose/jws/JwsSignatureVerifier", "org/apache/cxf/rs/security/jose/jws/JwsJsonConsumer", "[B", "org/apache/cxf/rs/security/jose/jws/JwsJsonSignatureEntry", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
