...
public class SecurityContextTokenValidatorImpl$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", null, "org/apache/xml/security/stax/impl/securityToken/AbstractInboundSecurityToken", null);

classWriter.visitOuterClass("org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl", "validate", "(Lorg/apache/wss4j/binding/wssc/AbstractSecurityContextTokenType;Ljava/lang/String;Lorg/apache/wss4j/stax/validate/TokenContext;)Lorg/apache/xml/security/stax/securityToken/InboundSecurityToken;");
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$identifier", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "val$tokenContext", "Lorg/apache/wss4j/stax/validate/TokenContext;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_SYNTHETIC, "this$0", "Lorg/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl;Lorg/apache/xml/security/stax/ext/InboundSecurityContext;Ljava/lang/String;Lorg/apache/xml/security/stax/securityToken/SecurityTokenConstants$KeyIdentifier;ZLjava/lang/String;Lorg/apache/wss4j/stax/validate/TokenContext;Lorg/apache/wss4j/binding/wssc/AbstractSecurityContextTokenType;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "this$0", "Lorg/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "val$identifier", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "val$tokenContext", "Lorg/apache/wss4j/stax/validate/TokenContext;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "val$securityContextTokenType", "Lorg/apache/wss4j/binding/wssc/AbstractSecurityContextTokenType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "getSecretKey", "()Ljava/util/Map;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "val$identifier", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "val$tokenContext", "Lorg/apache/wss4j/stax/validate/TokenContext;");
...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "val$securityContextTokenType", "Lorg/apache/wss4j/binding/wssc/AbstractSecurityContextTokenType;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/wss4j/stax/validate/SecurityContextTokenValidatorImpl$1", "setSecretKey", "(Ljava/lang/String;Ljava/security/Key;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitInsn(ARETURN);
