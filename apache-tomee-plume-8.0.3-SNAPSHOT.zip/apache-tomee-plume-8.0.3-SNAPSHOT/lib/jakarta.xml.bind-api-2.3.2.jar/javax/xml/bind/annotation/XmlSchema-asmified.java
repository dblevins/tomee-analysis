...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/bind/annotation/XmlSchema", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "xmlns", "()[Ljavax/xml/bind/annotation/XmlNs;", null, null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "elementFormDefault", "()Ljavax/xml/bind/annotation/XmlNsForm;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljavax/xml/bind/annotation/XmlNsForm;", "UNSET");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "attributeFormDefault", "()Ljavax/xml/bind/annotation/XmlNsForm;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljavax/xml/bind/annotation/XmlNsForm;", "UNSET");
annotationVisitor0.visitEnd();
