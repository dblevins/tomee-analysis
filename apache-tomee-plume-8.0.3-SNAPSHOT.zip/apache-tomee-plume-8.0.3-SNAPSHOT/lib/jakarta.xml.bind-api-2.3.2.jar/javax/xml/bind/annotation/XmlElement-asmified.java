...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/bind/annotation/XmlElement", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
classWriter.visitInnerClass("javax/xml/bind/annotation/XmlElement$DEFAULT", "javax/xml/bind/annotation/XmlElement", "DEFAULT", ACC_PUBLIC | ACC_FINAL | ACC_STATIC);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "nillable", "()Z", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
...
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visit(null, Type.getType("Ljavax/xml/bind/annotation/XmlElement$DEFAULT;"));
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
