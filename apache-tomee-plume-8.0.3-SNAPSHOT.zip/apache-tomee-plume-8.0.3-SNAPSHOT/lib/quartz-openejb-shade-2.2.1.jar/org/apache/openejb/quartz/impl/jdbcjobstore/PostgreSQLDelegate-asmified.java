...
public class PostgreSQLDelegateDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/quartz/impl/jdbcjobstore/PostgreSQLDelegate", null, "org/apache/openejb/quartz/impl/jdbcjobstore/StdJDBCDelegate", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/openejb/quartz/impl/jdbcjobstore/PostgreSQLDelegate", "java/sql/ResultSet", "java/lang/String", "java/io/InputStream", "[B", "java/lang/Object", "java/io/ObjectInputStream"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/impl/jdbcjobstore/PostgreSQLDelegate", "canUseProperties", "()Z", false);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/quartz/impl/jdbcjobstore/PostgreSQLDelegate", "getObjectFromBlob", "(Ljava/sql/ResultSet;Ljava/lang/String;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
