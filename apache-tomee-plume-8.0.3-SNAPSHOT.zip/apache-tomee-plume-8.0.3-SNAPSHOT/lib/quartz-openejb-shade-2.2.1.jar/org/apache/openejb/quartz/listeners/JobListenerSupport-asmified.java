...
public class JobListenerSupportDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openejb/quartz/listeners/JobListenerSupport", null, "java/lang/Object", new String[] { "org/apache/openejb/quartz/JobListener" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/listeners/JobListenerSupport", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/listeners/JobListenerSupport", "log", "Lorg/slf4j/Logger;");
