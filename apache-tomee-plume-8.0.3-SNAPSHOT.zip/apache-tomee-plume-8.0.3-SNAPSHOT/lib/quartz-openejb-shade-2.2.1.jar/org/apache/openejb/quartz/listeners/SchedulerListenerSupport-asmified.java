...
public class SchedulerListenerSupportDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/openejb/quartz/listeners/SchedulerListenerSupport", null, "java/lang/Object", new String[] { "org/apache/openejb/quartz/SchedulerListener" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/quartz/listeners/SchedulerListenerSupport", "log", "Lorg/slf4j/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/quartz/listeners/SchedulerListenerSupport", "log", "Lorg/slf4j/Logger;");
