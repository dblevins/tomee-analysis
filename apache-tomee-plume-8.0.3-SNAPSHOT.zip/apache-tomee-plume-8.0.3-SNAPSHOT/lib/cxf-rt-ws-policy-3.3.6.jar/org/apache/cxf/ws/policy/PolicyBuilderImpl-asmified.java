...
public class PolicyBuilderImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/ws/policy/PolicyBuilderImpl", null, "org/apache/neethi/PolicyBuilder", new String[] { "org/apache/cxf/ws/policy/PolicyBuilder", "org/apache/cxf/extension/BusExtension" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/neethi/PolicyBuilder", "<init>", "(Lorg/apache/neethi/AssertionBuilderFactory;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/policy/PolicyBuilderImpl", "setBus", "(Lorg/apache/cxf/Bus;)V", false);
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setAssertionBuilderRegistry", "(Lorg/apache/cxf/ws/policy/AssertionBuilderRegistry;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/policy/PolicyBuilderImpl", "factory", "Lorg/apache/neethi/AssertionBuilderFactory;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/ws/policy/PolicyBuilderImpl", "bus", "Lorg/apache/cxf/Bus;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/ws/policy/PolicyBuilderImpl", "bus", "Lorg/apache/cxf/Bus;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/ws/policy/PolicyBuilderImpl", "setPolicyRegistry", "(Lorg/apache/neethi/PolicyRegistry;)V", false);
