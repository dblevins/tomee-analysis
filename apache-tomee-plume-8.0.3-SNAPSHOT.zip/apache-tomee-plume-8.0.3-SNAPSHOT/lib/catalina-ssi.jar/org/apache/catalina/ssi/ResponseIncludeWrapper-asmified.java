...
public class ResponseIncludeWrapperDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "lastModified", "J", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "printWriter", "Ljava/io/PrintWriter;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/ssi/ResponseIncludeWrapper", "setCharacterEncoding", "(Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/ssi/ResponseIncludeWrapper", "printWriter", "Ljava/io/PrintWriter;");
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/ssi/ResponseIncludeWrapper", "printWriter", "Ljava/io/PrintWriter;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/ssi/ResponseIncludeWrapper", "lastModified", "J");
