...
public class Nio2Channel$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/tomcat/util/net/Nio2Channel$2", "Ljava/lang/Object;Ljava/util/concurrent/Future<Ljava/lang/Integer;>;", "java/lang/Object", new String[] { "java/util/concurrent/Future" });
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/Nio2Channel$2", "get", "(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Integer;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/Nio2Channel$2", "get", "()Ljava/lang/Integer;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
