...
public class Authorization$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/http/parser/Authorization$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/http/parser/Authorization", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$http$parser$Authorization$FieldType", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/http/parser/Authorization$FieldType", "values", "()[Lorg/apache/tomcat/util/http/parser/Authorization$FieldType;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/http/parser/Authorization$1", "$SwitchMap$org$apache$tomcat$util$http$parser$Authorization$FieldType", "[I");
