...
public class AbstractJsseEndpoint$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/net/AbstractJsseEndpoint$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/net/AbstractJsseEndpoint", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$net$SSLHostConfig$CertificateVerification", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/net/SSLHostConfig$CertificateVerification", "values", "()[Lorg/apache/tomcat/util/net/SSLHostConfig$CertificateVerification;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/net/AbstractJsseEndpoint$1", "$SwitchMap$org$apache$tomcat$util$net$SSLHostConfig$CertificateVerification", "[I");
