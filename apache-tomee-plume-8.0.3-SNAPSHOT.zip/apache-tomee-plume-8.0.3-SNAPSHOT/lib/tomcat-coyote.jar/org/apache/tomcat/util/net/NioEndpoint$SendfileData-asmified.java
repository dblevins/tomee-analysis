...
public class NioEndpoint$SendfileDataDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/util/net/NioEndpoint$SendfileData", null, "org/apache/tomcat/util/net/SendfileDataBase", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_VOLATILE, "fchannel", "Ljava/nio/channels/FileChannel;", null, null);
