...
public class Nio2Endpoint$Nio2SocketWrapper$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "Ljava/lang/Object;Ljava/nio/channels/CompletionHandler<Ljava/lang/Integer;Ljava/nio/ByteBuffer;>;", "java/lang/Object", new String[] { "java/nio/channels/CompletionHandler" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "this$0", "Lorg/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "val$endpoint", "Lorg/apache/tomcat/util/net/Nio2Endpoint;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "this$0", "Lorg/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "failed", "(Ljava/lang/Throwable;Ljava/nio/ByteBuffer;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "val$endpoint", "Lorg/apache/tomcat/util/net/Nio2Endpoint;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "this$0", "Lorg/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "java/nio/ByteBuffer");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/util/net/Nio2Endpoint$Nio2SocketWrapper$3", "completed", "(Ljava/lang/Integer;Ljava/nio/ByteBuffer;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
