...
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/servlet/http/WebConnection");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/http/HttpUpgradeHandler", "init", "(Ljakarta/servlet/http/WebConnection;)V", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/coyote/AbstractProtocol$ConnectionHandler", "org/apache/tomcat/util/net/SocketWrapperBase", "org/apache/tomcat/util/net/SocketEvent", "java/lang/Object", "org/apache/coyote/Processor", "org/apache/tomcat/util/net/AbstractEndpoint$Handler$SocketState", "org/apache/coyote/UpgradeToken", "java/nio/ByteBuffer", "jakarta/servlet/http/HttpUpgradeHandler", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/http/HttpUpgradeHandler", "destroy", "()V", true);
methodVisitor.visitJumpInsn(GOTO, label58);
methodVisitor.visitLabel(label59);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/coyote/UpgradeToken", "jakarta/servlet/http/HttpUpgradeHandler", "org/apache/tomcat/InstanceManager"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/UpgradeToken", "getContextBind", "()Lorg/apache/tomcat/ContextBind;", false);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/coyote/AbstractProtocol$ConnectionHandler", "org/apache/tomcat/util/net/SocketWrapperBase", "org/apache/tomcat/util/net/SocketEvent", "java/lang/Object", "org/apache/coyote/Processor", "org/apache/tomcat/util/net/AbstractEndpoint$Handler$SocketState", "org/apache/coyote/UpgradeToken", "jakarta/servlet/http/HttpUpgradeHandler", "org/apache/tomcat/InstanceManager", "java/lang/ClassLoader"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 10);
methodVisitor.visitVarInsn(ALOAD, 10);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/coyote/AbstractProtocol$ConnectionHandler", "org/apache/tomcat/util/net/SocketWrapperBase", "org/apache/tomcat/util/net/SocketEvent", "java/lang/Object", "org/apache/coyote/Processor", "org/apache/tomcat/util/net/AbstractEndpoint$Handler$SocketState", "org/apache/coyote/UpgradeToken", "jakarta/servlet/http/HttpUpgradeHandler", "org/apache/tomcat/InstanceManager", "java/lang/ClassLoader", Opcodes.TOP, "java/lang/Throwable"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/juli/logging/Log", "debug", "(Ljava/lang/Object;)V", true);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/coyote/AbstractProtocol$ConnectionHandler", "org/apache/coyote/Processor", "java/lang/Object", Opcodes.LONG, "org/apache/coyote/RequestInfo", "jakarta/management/ObjectName"}, 0, new Object[] {});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/RequestInfo", "setRpName", "(Ljakarta/management/ObjectName;)V", false);
methodVisitor.visitLabel(label1);
Label label8 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/RequestInfo", "setGlobalProcessor", "(Lorg/apache/coyote/RequestGroupInfo;)V", false);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/RequestInfo", "getRpName", "()Ljakarta/management/ObjectName;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/AbstractProtocol$ConnectionHandler", "getLog", "()Lorg/apache/juli/logging/Log;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/juli/logging/Log", "isDebugEnabled", "()Z", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/juli/logging/Log", "debug", "(Ljava/lang/Object;)V", true);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"org/apache/coyote/RequestInfo", "jakarta/management/ObjectName"}, 0, null);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/modeler/Registry", "getRegistry", "(Ljava/lang/Object;Ljava/lang/Object;)Lorg/apache/tomcat/util/modeler/Registry;", false);
methodVisitor.visitVarInsn(ALOAD, 5);
