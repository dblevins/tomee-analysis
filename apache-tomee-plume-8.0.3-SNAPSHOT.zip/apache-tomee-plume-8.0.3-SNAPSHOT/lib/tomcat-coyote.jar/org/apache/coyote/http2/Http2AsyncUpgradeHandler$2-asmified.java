...
public class Http2AsyncUpgradeHandler$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/coyote/http2/Http2AsyncUpgradeHandler$2", "Ljava/lang/Object;Ljava/nio/channels/CompletionHandler<Ljava/lang/Long;Ljava/lang/Void;>;", "java/lang/Object", new String[] { "java/nio/channels/CompletionHandler" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/coyote/http2/Http2AsyncUpgradeHandler$2", "this$0", "Lorg/apache/coyote/http2/Http2AsyncUpgradeHandler;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/coyote/http2/Http2AsyncUpgradeHandler$2", "this$0", "Lorg/apache/coyote/http2/Http2AsyncUpgradeHandler;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/io/IOException");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/coyote/http2/Http2AsyncUpgradeHandler", "access$102", "(Lorg/apache/coyote/http2/Http2AsyncUpgradeHandler;Ljava/io/IOException;)Ljava/io/IOException;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/http2/Http2AsyncUpgradeHandler$2", "failed", "(Ljava/lang/Throwable;Ljava/lang/Void;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Void");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/http2/Http2AsyncUpgradeHandler$2", "completed", "(Ljava/lang/Long;Ljava/lang/Void;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
}
