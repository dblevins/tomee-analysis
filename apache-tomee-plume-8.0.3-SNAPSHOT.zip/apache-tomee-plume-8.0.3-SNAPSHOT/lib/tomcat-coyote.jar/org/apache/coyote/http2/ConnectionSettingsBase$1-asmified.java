...
public class ConnectionSettingsBase$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/coyote/http2/ConnectionSettingsBase$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/coyote/http2/ConnectionSettingsBase", null, null);

classWriter.visitInnerClass("org/apache/coyote/http2/ConnectionSettingsBase$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$coyote$http2$Setting", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/coyote/http2/Setting", "values", "()[Lorg/apache/coyote/http2/Setting;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/coyote/http2/ConnectionSettingsBase$1", "$SwitchMap$org$apache$coyote$http2$Setting", "[I");
