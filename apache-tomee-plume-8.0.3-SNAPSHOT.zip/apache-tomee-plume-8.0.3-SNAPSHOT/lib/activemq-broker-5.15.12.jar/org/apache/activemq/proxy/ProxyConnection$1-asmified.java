...
public class ProxyConnection$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/proxy/ProxyConnection$1", null, "org/apache/activemq/transport/DefaultTransportListener", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/proxy/ProxyConnection$1", "this$0", "Lorg/apache/activemq/proxy/ProxyConnection;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/activemq/command/ShutdownInfo;"));
Label label4 = new Label();
methodVisitor.visitJumpInsn(IF_ACMPNE, label4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/proxy/ProxyConnection$1", "this$0", "Lorg/apache/activemq/proxy/ProxyConnection;");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/proxy/ProxyConnection", "access$000", "(Lorg/apache/activemq/proxy/ProxyConnection;)Ljava/util/concurrent/atomic/AtomicBoolean;", false);
