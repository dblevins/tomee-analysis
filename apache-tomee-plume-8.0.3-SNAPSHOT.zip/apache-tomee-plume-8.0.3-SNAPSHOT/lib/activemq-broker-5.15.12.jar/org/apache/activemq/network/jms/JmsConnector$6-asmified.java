...
public class JmsConnector$6Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/network/jms/JmsConnector$6", null, "java/lang/Object", new String[] { "java/util/concurrent/ThreadFactory" });

classWriter.visitOuterClass("org/apache/activemq/network/jms/JmsConnector", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/JmsConnector$6", "this$0", "Lorg/apache/activemq/network/jms/JmsConnector;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn("JmsConnector Async Connection Task: ");
