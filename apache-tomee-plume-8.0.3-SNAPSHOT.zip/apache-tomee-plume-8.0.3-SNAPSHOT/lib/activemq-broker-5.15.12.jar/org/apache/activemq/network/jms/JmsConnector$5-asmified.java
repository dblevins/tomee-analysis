...
public class JmsConnector$5Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/network/jms/JmsConnector$5", null, "java/lang/Object", new String[] { "java/lang/Runnable" });

classWriter.visitOuterClass("org/apache/activemq/network/jms/JmsConnector", "scheduleAsyncForeignConnectionReconnect", "()V");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/JmsConnector$5", "this$0", "Lorg/apache/activemq/network/jms/JmsConnector;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/JmsConnector$5", "this$0", "Lorg/apache/activemq/network/jms/JmsConnector;");
