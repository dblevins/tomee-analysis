...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "outboundTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "localTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLocalTopicConnectionFactory", "()Ljakarta/jms/TopicConnectionFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "localTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setLocalTopicConnectionFactory", "(Ljakarta/jms/TopicConnectionFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "localTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOutboundTopicConnectionFactory", "()Ljakarta/jms/TopicConnectionFactory;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "outboundTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getLocalTopicConnection", "()Ljakarta/jms/TopicConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setLocalTopicConnection", "(Ljakarta/jms/TopicConnection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "localConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getOutboundTopicConnection", "()Ljakarta/jms/TopicConnection;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setOutboundTopicConnection", "(Ljakarta/jms/TopicConnection;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "foreignConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setOutboundTopicConnectionFactory", "(Ljakarta/jms/TopicConnectionFactory;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "outboundTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "outboundTopicConnectionFactoryName", "Ljava/lang/String;");
methodVisitor.visitLdcInsn(Type.getType("Ljakarta/jms/TopicConnectionFactory;"));
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicConnectionFactory", "createTopicConnection", "(Ljava/lang/String;Ljava/lang/String;)Ljakarta/jms/TopicConnection;", true);
methodVisitor.visitVarInsn(ASTORE, 1);
Label label10 = new Label();
methodVisitor.visitJumpInsn(GOTO, label10);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/jms/TopicConnection"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "outboundTopicConnectionFactory", "Ljakarta/jms/TopicConnectionFactory;");
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicConnection", "setClientID", "(Ljava/lang/String;)V", true);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "initializeInboundDestinationBridgesOutboundSide", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "initializeOutboundDestinationBridgesOutboundSide", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "foreignConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/atomic/AtomicReference", "set", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicConnection", "java/lang/Exception"}, 1, new Object[] {"java/lang/Exception"});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "embeddedConnectionFactory", "Lorg/apache/activemq/ActiveMQConnectionFactory;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQConnectionFactory", "createTopicConnection", "()Ljakarta/jms/TopicConnection;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label7);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "initializeInboundDestinationBridgesLocalSide", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "initializeOutboundDestinationBridgesLocalSide", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "localConnection", "Ljava/util/concurrent/atomic/AtomicReference;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/atomic/AtomicReference", "set", "(Ljava/lang/Object;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeInboundDestinationBridgesOutboundSide", "(Ljakarta/jms/TopicConnection;)V", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "inboundTopicBridges", "[Lorg/apache/activemq/network/jms/InboundTopicBridge;");
Label label0 = new Label();
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicConnection", "jakarta/jms/TopicSession", "[Lorg/apache/activemq/network/jms/InboundTopicBridge;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "createForeignTopic", "(Ljakarta/jms/TopicSession;Ljava/lang/String;)Ljakarta/jms/Topic;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setConsumer", "(Ljakarta/jms/MessageConsumer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setConsumerTopic", "(Ljakarta/jms/Topic;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setConsumerConnection", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeInboundDestinationBridgesLocalSide", "(Ljakarta/jms/TopicConnection;)V", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "inboundTopicBridges", "[Lorg/apache/activemq/network/jms/InboundTopicBridge;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "createActiveMQTopic", "(Ljakarta/jms/TopicSession;Ljava/lang/String;)Ljakarta/jms/Topic;", false);
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setProducerTopic", "(Ljakarta/jms/Topic;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setProducerConnection", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/activemq/network/jms/InboundTopicBridge", "java/lang/String", "jakarta/jms/Topic"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicConnection", "jakarta/jms/TopicSession"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/jms/TopicSession", "close", "()V", true);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeOutboundDestinationBridgesOutboundSide", "(Ljakarta/jms/TopicConnection;)V", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "outboundTopicBridges", "[Lorg/apache/activemq/network/jms/OutboundTopicBridge;");
Label label0 = new Label();
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicConnection", "jakarta/jms/TopicSession", "[Lorg/apache/activemq/network/jms/OutboundTopicBridge;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitVarInsn(ILOAD, 4);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label2);
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setProducerTopic", "(Ljakarta/jms/Topic;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setProducerConnection", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/activemq/network/jms/OutboundTopicBridge", "java/lang/String", "jakarta/jms/Topic"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "initializeOutboundDestinationBridgesLocalSide", "(Ljakarta/jms/TopicConnection;)V", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "outboundTopicBridges", "[Lorg/apache/activemq/network/jms/OutboundTopicBridge;");
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setConsumer", "(Ljakarta/jms/MessageConsumer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setConsumerTopic", "(Ljakarta/jms/Topic;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setConsumerConnection", "(Ljakarta/jms/TopicConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setJmsMessageConvertor", "(Lorg/apache/activemq/network/jms/JmsMesageConvertor;)V", false);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/Destination", "jakarta/jms/Connection", "jakarta/jms/Connection", "jakarta/jms/Topic", Opcodes.INTEGER, "org/apache/activemq/network/jms/InboundTopicBridge", "jakarta/jms/TopicSession", "jakarta/jms/Topic"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/Destination", "jakarta/jms/Connection", "jakarta/jms/Connection", "jakarta/jms/Topic", Opcodes.INTEGER, "org/apache/activemq/network/jms/InboundTopicBridge"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "LOG", "Lorg/slf4j/Logger;");
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/InboundTopicBridge", "getConsumerTopic", "()Ljakarta/jms/Topic;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setJmsMessageConvertor", "(Lorg/apache/activemq/network/jms/JmsMesageConvertor;)V", false);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"org/apache/activemq/network/jms/OutboundTopicBridge", "jakarta/jms/TopicSession", "jakarta/jms/Topic"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "setJmsConnector", "(Lorg/apache/activemq/network/jms/JmsConnector;)V", false);
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/Destination", "jakarta/jms/Connection", "jakarta/jms/Connection", "jakarta/jms/Topic", Opcodes.INTEGER, "org/apache/activemq/network/jms/OutboundTopicBridge"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/network/jms/SimpleJmsTopicConnector", "LOG", "Lorg/slf4j/Logger;");
methodVisitor.visitLdcInsn("Failed to create replyTo bridge for topic: {}");
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/network/jms/OutboundTopicBridge", "getConsumerTopic", "()Ljakarta/jms/Topic;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 9);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createActiveMQTopic", "(Ljakarta/jms/TopicSession;Ljava/lang/String;)Ljakarta/jms/Topic;", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createForeignTopic", "(Ljakarta/jms/TopicSession;Ljava/lang/String;)Ljakarta/jms/Topic;", null, new String[] { "jakarta/jms/JMSException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicSession", "java/lang/String", "jakarta/jms/Topic"}, 1, new Object[] {"javax/naming/NamingException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(GOTO, label13);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicSession", "java/lang/String", "jakarta/jms/Topic", "javax/naming/NamingException"}, 1, new Object[] {"jakarta/jms/JMSException"});
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/activemq/network/jms/SimpleJmsTopicConnector", "jakarta/jms/TopicSession", "java/lang/String", "jakarta/jms/Topic", "jakarta/jms/JMSException"}, 1, new Object[] {"javax/naming/NamingException"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
