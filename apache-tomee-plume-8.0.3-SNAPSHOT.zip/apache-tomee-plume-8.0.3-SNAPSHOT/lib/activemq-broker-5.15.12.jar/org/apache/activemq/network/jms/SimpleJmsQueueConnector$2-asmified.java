...
public class SimpleJmsQueueConnector$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/network/jms/SimpleJmsQueueConnector$2", null, "java/lang/Object", new String[] { "jakarta/jms/ExceptionListener" });

classWriter.visitOuterClass("org/apache/activemq/network/jms/SimpleJmsQueueConnector", "initializeLocalConnection", "()V");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector$2", "this$0", "Lorg/apache/activemq/network/jms/SimpleJmsQueueConnector;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector$2", "this$0", "Lorg/apache/activemq/network/jms/SimpleJmsQueueConnector;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/network/jms/SimpleJmsQueueConnector$2", "this$0", "Lorg/apache/activemq/network/jms/SimpleJmsQueueConnector;");
