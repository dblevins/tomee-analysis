...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/jms/InvalidSelectorException"});
methodVisitor.visitVarInsn(ASTORE, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "browse", "(Ljava/lang/String;)[Ljavax/management/openmbean/CompositeData;", null, new String[] { "javax/management/openmbean/OpenDataException", "javax/jms/InvalidSelectorException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "browseMessages", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/Object;>;", new String[] { "javax/jms/InvalidSelectorException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "browseMessages", "(Ljava/lang/String;)Ljava/util/List;", "(Ljava/lang/String;)Ljava/util/List<Ljava/lang/Object;>;", new String[] { "javax/jms/InvalidSelectorException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "browseAsTable", "(Ljava/lang/String;)Ljavax/management/openmbean/TabularData;", null, new String[] { "javax/management/openmbean/OpenDataException", "javax/jms/InvalidSelectorException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/activemq/broker/jmx/DestinationView", "java/lang/String", "org/apache/activemq/broker/jmx/OpenTypeSupport$OpenTypeFactory", "[Lorg/apache/activemq/command/Message;", "javax/management/openmbean/CompositeType", "javax/management/openmbean/TabularType", "javax/management/openmbean/TabularDataSupport", "org/apache/activemq/filter/NonCachedMessageEvaluationContext"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/selector/SelectorParser", "parse", "(Ljava/lang/String;)Lorg/apache/activemq/filter/BooleanExpression;", false);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"org/apache/activemq/filter/BooleanExpression"});
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/activemq/broker/jmx/DestinationView", "java/util/Map", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "org/apache/activemq/command/ActiveMQDestination", "org/apache/activemq/ActiveMQConnectionFactory", "javax/jms/Connection", "javax/jms/Session", "javax/jms/MessageProducer", "org/apache/activemq/command/ActiveMQTextMessage", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"javax/jms/MessageProducer"});
methodVisitor.visitInsn(LCONST_0);
methodVisitor.visitLabel(label9);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/activemq/broker/jmx/DestinationView", "java/util/Map", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "org/apache/activemq/command/ActiveMQDestination", "org/apache/activemq/ActiveMQConnectionFactory", "javax/jms/Connection", "javax/jms/Session", "javax/jms/MessageProducer", "org/apache/activemq/command/ActiveMQTextMessage", Opcodes.LONG}, 2, new Object[] {"javax/jms/MessageProducer", Opcodes.LONG});
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/activemq/broker/jmx/DestinationView", "java/util/Map", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "org/apache/activemq/command/ActiveMQDestination", "org/apache/activemq/ActiveMQConnectionFactory", "javax/jms/Connection"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 16, new Object[] {"org/apache/activemq/broker/jmx/DestinationView", "java/util/Map", "java/lang/String", "java/lang/String", "java/lang/String", "java/lang/String", "org/apache/activemq/command/ActiveMQDestination", "org/apache/activemq/ActiveMQConnectionFactory", "javax/jms/Connection", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSubscriptions", "()[Ljavax/management/ObjectName;", null, new String[] { "java/io/IOException", "javax/management/MalformedObjectNameException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/jmx/DestinationView", "destination", "Lorg/apache/activemq/broker/region/Destination;");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/activemq/broker/jmx/DestinationView", "java/util/List", "[Ljavax/management/ObjectName;", "javax/management/ObjectName", Opcodes.INTEGER, "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/broker/jmx/BrokerMBeanSupport", "createSubscriptionName", "(Ljavax/management/ObjectName;Ljava/lang/String;Lorg/apache/activemq/command/ConsumerInfo;)Ljavax/management/ObjectName;", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSlowConsumerStrategy", "()Ljavax/management/ObjectName;", null, new String[] { "java/io/IOException", "javax/management/MalformedObjectNameException" });
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/ManagedRegionBroker", "registerSlowConsumerStrategy", "(Lorg/apache/activemq/broker/region/policy/AbortSlowConsumerStrategy;)Ljavax/management/ObjectName;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/management/ObjectName", "org/apache/activemq/broker/region/policy/SlowConsumerStrategy"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 3);
methodVisitor.visitEnd();
