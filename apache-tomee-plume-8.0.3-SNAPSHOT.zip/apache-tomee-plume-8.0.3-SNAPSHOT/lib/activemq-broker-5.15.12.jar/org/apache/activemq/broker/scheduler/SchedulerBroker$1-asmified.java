...
public class SchedulerBroker$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/broker/scheduler/SchedulerBroker$1", null, "java/lang/Object", new String[] { "org/apache/activemq/broker/Connection" });

classWriter.visitOuterClass("org/apache/activemq/broker/scheduler/SchedulerBroker", "<init>", "(Lorg/apache/activemq/broker/BrokerService;Lorg/apache/activemq/broker/Broker;Lorg/apache/activemq/broker/scheduler/JobSchedulerStore;)V");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/broker/scheduler/SchedulerBroker$1", "this$0", "Lorg/apache/activemq/broker/scheduler/SchedulerBroker;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/broker/scheduler/SchedulerBroker", "access$000", "()Lorg/slf4j/Logger;", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("Unexpected async ioexception: ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/Object;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
