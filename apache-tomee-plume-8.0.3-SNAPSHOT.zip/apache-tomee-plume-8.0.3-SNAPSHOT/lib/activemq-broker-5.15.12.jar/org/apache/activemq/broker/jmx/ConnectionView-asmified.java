...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConsumers", "()[Ljavax/management/ObjectName;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/jmx/ConnectionView", "connection", "Lorg/apache/activemq/broker/Connection;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/activemq/broker/Connection", "getConnectionId", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/jmx/ConnectionView", "createConsumerQueury", "(Ljava/lang/String;)Ljavax/management/ObjectName;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/activemq/broker/jmx/ConnectionView", "[Ljavax/management/ObjectName;"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getProducers", "()[Ljavax/management/ObjectName;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/jmx/ConnectionView", "connection", "Lorg/apache/activemq/broker/Connection;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/activemq/broker/Connection", "getConnectionId", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/jmx/ConnectionView", "createProducerQueury", "(Ljava/lang/String;)Ljavax/management/ObjectName;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/jmx/ConnectionView", "managementContext", "Lorg/apache/activemq/broker/jmx/ManagementContext;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createConsumerQueury", "(Ljava/lang/String;)Ljavax/management/ObjectName;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/broker/jmx/BrokerMBeanSupport", "createConsumerQueury", "(Ljava/lang/String;Ljava/lang/String;)Ljavax/management/ObjectName;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createProducerQueury", "(Ljava/lang/String;)Ljavax/management/ObjectName;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/ManagementContext", "getJmxDomainName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/broker/jmx/BrokerMBeanSupport", "createProducerQueury", "(Ljava/lang/String;Ljava/lang/String;)Ljavax/management/ObjectName;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/lang/Throwable"});
