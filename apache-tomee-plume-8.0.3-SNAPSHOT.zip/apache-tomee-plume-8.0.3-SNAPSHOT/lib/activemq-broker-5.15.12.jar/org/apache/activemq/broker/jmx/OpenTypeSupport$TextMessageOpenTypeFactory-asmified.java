...
public class OpenTypeSupport$TextMessageOpenTypeFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/broker/jmx/OpenTypeSupport$TextMessageOpenTypeFactory", null, "org/apache/activemq/broker/jmx/OpenTypeSupport$MessageOpenTypeFactory", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/OpenTypeSupport$TextMessageOpenTypeFactory", "addItem", "(Ljava/lang/String;Ljava/lang/String;Ljavax/management/openmbean/OpenType;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/command/ActiveMQTextMessage", "getText", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/broker/jmx/OpenTypeSupport$TextMessageOpenTypeFactory", "java/lang/Object", "org/apache/activemq/command/ActiveMQTextMessage", "java/util/Map"}, 1, new Object[] {"jakarta/jms/JMSException"});
