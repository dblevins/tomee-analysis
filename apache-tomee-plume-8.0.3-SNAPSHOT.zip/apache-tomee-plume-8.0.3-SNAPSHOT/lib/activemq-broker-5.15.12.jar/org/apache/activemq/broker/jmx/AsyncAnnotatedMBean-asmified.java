...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/concurrent/ExecutorService;JLjava/lang/Object;Ljava/lang/Class;Ljakarta/management/ObjectName;)V", "<T:Ljava/lang/Object;>(Ljava/util/concurrent/ExecutorService;JTT;Ljava/lang/Class<TT;>;Ljakarta/management/ObjectName;)V", new String[] { "jakarta/management/NotCompliantMBeanException" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/jmx/AnnotatedMBean", "<init>", "(Ljava/lang/Class;Ljakarta/management/ObjectName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(LCONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/broker/jmx/AsyncAnnotatedMBean", "timeout", "J");
methodVisitor.visitInsn(RETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "asyncInvole", "(Ljava/lang/String;[Ljava/lang/Object;[Ljava/lang/String;)Ljava/lang/Object;", null, new String[] { "jakarta/management/MBeanException", "jakarta/management/ReflectionException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "registerMBean", "(Ljava/util/concurrent/ExecutorService;JLorg/apache/activemq/broker/jmx/ManagementContext;Ljava/lang/Object;Ljakarta/management/ObjectName;)Ljakarta/management/ObjectInstance;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"java/util/concurrent/ExecutorService", Opcodes.LONG, "org/apache/activemq/broker/jmx/ManagementContext", "java/lang/Object", "jakarta/management/ObjectName", "java/lang/String", "[Ljava/lang/Class;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 10);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/jmx/AsyncAnnotatedMBean", "<init>", "(Ljava/util/concurrent/ExecutorService;JLjava/lang/Object;Ljava/lang/Class;Ljakarta/management/ObjectName;)V", false);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/ManagementContext", "registerMBean", "(Ljava/lang/Object;Ljakarta/management/ObjectName;)Ljakarta/management/ObjectInstance;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/management/MBeanException");
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
methodVisitor.visitVarInsn(ALOAD, 8);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/ExecutionException", "getCause", "()Ljava/lang/Throwable;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/management/MBeanException");
methodVisitor.visitInsn(ATHROW);
