...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "org/apache/activemq/broker/jmx/OpenTypeSupport$OpenTypeFactory", "jakarta/management/openmbean/CompositeType", "jakarta/management/openmbean/TabularType", "jakarta/management/openmbean/TabularDataSupport", Opcodes.INTEGER, "java/util/Map", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/ManagedRegionBroker", "getSubscriberObjectName", "(Lorg/apache/activemq/broker/region/Subscription;)Ljakarta/management/ObjectName;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "abortConsumer", "(Ljakarta/management/ObjectName;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "broker", "Lorg/apache/activemq/broker/jmx/ManagedRegionBroker;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/ManagedRegionBroker", "getSubscriber", "(Ljakarta/management/ObjectName;)Lorg/apache/activemq/broker/region/Subscription;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "abortConnection", "(Ljakarta/management/ObjectName;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "broker", "Lorg/apache/activemq/broker/jmx/ManagedRegionBroker;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "toObjectName", "(Ljava/lang/String;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "abortConsumer", "(Ljakarta/management/ObjectName;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "toObjectName", "(Ljava/lang/String;)Ljakarta/management/ObjectName;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "abortConnection", "(Ljakarta/management/ObjectName;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "toObjectName", "(Ljava/lang/String;)Ljakarta/management/ObjectName;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "java/lang/String", "jakarta/management/ObjectName"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/activemq/broker/jmx/AbortSlowConsumerStrategyView", "LOG", "Lorg/slf4j/Logger;");
