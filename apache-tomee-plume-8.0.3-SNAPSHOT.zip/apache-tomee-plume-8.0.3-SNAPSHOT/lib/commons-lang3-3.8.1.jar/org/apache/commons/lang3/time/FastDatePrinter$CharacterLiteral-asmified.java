...
public class FastDatePrinter$CharacterLiteralDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/apache/commons/lang3/time/FastDatePrinter$CharacterLiteral", null, "java/lang/Object", new String[] { "org/apache/commons/lang3/time/FastDatePrinter$Rule" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "mValue", "C", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/lang3/time/FastDatePrinter$CharacterLiteral", "mValue", "C");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/time/FastDatePrinter$CharacterLiteral", "mValue", "C");
