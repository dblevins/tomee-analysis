...
public class FastDatePrinter$UnpaddedNumberFieldDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_SUPER, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedNumberField", null, "java/lang/Object", new String[] { "org/apache/commons/lang3/time/FastDatePrinter$NumberRule" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedNumberField", "mField", "I");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedNumberField", "mField", "I");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Calendar", "get", "(I)I", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/lang3/time/FastDatePrinter$UnpaddedNumberField", "appendTo", "(Ljava/lang/Appendable;I)V", false);
methodVisitor.visitInsn(RETURN);
