...
public class AtomicInitializerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/lang3/concurrent/AtomicInitializer", "<T:Ljava/lang/Object;>Ljava/lang/Object;Lorg/apache/commons/lang3/concurrent/ConcurrentInitializer<TT;>;", "java/lang/Object", new String[] { "org/apache/commons/lang3/concurrent/ConcurrentInitializer" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/lang3/concurrent/AtomicInitializer", "reference", "Ljava/util/concurrent/atomic/AtomicReference;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/concurrent/AtomicInitializer", "reference", "Ljava/util/concurrent/atomic/AtomicReference;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/lang3/concurrent/AtomicInitializer", "initialize", "()Ljava/lang/Object;", false);
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/lang3/concurrent/AtomicInitializer", "reference", "Ljava/util/concurrent/atomic/AtomicReference;");
