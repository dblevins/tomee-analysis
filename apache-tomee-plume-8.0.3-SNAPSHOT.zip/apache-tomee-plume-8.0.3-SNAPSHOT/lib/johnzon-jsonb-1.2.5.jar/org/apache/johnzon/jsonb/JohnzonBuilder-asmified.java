...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/johnzon/jsonb/JohnzonBuilder", null, "java/lang/Object", new String[] { "javax/json/bind/JsonbBuilder" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "jsonp", "Ljavax/json/spi/JsonProvider;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "config", "Ljavax/json/bind/JsonbConfig;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "withConfig", "(Ljavax/json/bind/JsonbConfig;)Ljavax/json/bind/JsonbBuilder;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "config", "Ljavax/json/bind/JsonbConfig;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "withProvider", "(Ljavax/json/spi/JsonProvider;)Ljavax/json/bind/JsonbBuilder;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "jsonp", "Ljavax/json/spi/JsonProvider;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "build", "()Ljavax/json/bind/Jsonb;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "jsonp", "Ljavax/json/spi/JsonProvider;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "config", "Ljavax/json/bind/JsonbConfig;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/jsonb/PropertyNamingStrategyFactory", "create", "()Ljavax/json/bind/config/PropertyNamingStrategy;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/bind/JsonbConfig", "getProperty", "(Ljava/lang/String;)Ljava/util/Optional;", false);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/json/bind/config/PropertyVisibilityStrategy;"));
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("apply", "(Ljava/lang/Class;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false), Type.getType("(Ljava/lang/Object;)Ljavax/json/bind/config/PropertyVisibilityStrategy;")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "map", "(Ljava/util/function/Function;)Ljava/util/Optional;", false);
...
methodVisitor.visitInvokeDynamicInsn("get", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;Ljavax/json/bind/config/PropertyNamingStrategy;Ljava/lang/String;Ljavax/json/bind/config/PropertyVisibilityStrategy;Ljava/util/Optional;Ljava/util/Map;Lorg/apache/johnzon/jsonb/spi/JohnzonAdapterFactory;Ljava/util/function/Supplier;Ljava/util/function/Supplier;Z)Ljava/util/function/Supplier;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("()Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "lambda$build$10", "(Ljavax/json/bind/config/PropertyNamingStrategy;Ljava/lang/String;Ljavax/json/bind/config/PropertyVisibilityStrategy;Ljava/util/Optional;Ljava/util/Map;Lorg/apache/johnzon/jsonb/spi/JohnzonAdapterFactory;Ljava/util/function/Supplier;Ljava/util/function/Supplier;Z)Lorg/apache/johnzon/mapper/access/AccessMode;", false), Type.getType("()Lorg/apache/johnzon/mapper/access/AccessMode;")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "orElseGet", "(Ljava/util/function/Supplier;)Ljava/lang/Object;", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/johnzon/jsonb/JohnzonBuilder", "java/util/function/Supplier", "java/util/function/Supplier", Opcodes.INTEGER, Opcodes.INTEGER, Opcodes.INTEGER, "java/util/Optional", "javax/json/bind/config/PropertyNamingStrategy", "java/lang/String", "javax/json/bind/config/PropertyVisibilityStrategy", "java/util/Map", "org/apache/johnzon/jsonb/spi/JohnzonAdapterFactory", "org/apache/johnzon/mapper/access/AccessMode"}, 0, new Object[] {});
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("apply", "(Ljava/lang/Class;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false), Type.getType("(Ljava/lang/Object;)[Ljavax/json/bind/serializer/JsonbSerializer;")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "map", "(Ljava/util/function/Function;)Ljava/util/Optional;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitInvokeDynamicInsn("accept", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;Lorg/apache/johnzon/core/Types;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "lambda$build$21", "(Lorg/apache/johnzon/core/Types;[Ljavax/json/bind/serializer/JsonbSerializer;)V", false), Type.getType("([Ljavax/json/bind/serializer/JsonbSerializer;)V")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "ifPresent", "(Ljava/util/function/Consumer;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "config", "Ljavax/json/bind/JsonbConfig;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitInvokeDynamicInsn("apply", "(Ljava/lang/Class;)Ljava/util/function/Function;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKEVIRTUAL, "java/lang/Class", "cast", "(Ljava/lang/Object;)Ljava/lang/Object;", false), Type.getType("(Ljava/lang/Object;)[Ljavax/json/bind/serializer/JsonbDeserializer;")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "map", "(Ljava/util/function/Function;)Ljava/util/Optional;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInvokeDynamicInsn("accept", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;Lorg/apache/johnzon/core/Types;Ljava/util/function/Supplier;Ljava/util/function/Supplier;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "lambda$build$24", "(Lorg/apache/johnzon/core/Types;Ljava/util/function/Supplier;Ljava/util/function/Supplier;[Ljavax/json/bind/serializer/JsonbDeserializer;)V", false), Type.getType("([Ljavax/json/bind/serializer/JsonbDeserializer;)V")});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/Optional", "ifPresent", "(Ljava/util/function/Consumer;)V", false);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "doCreateJsonb", "(ZZLorg/apache/johnzon/mapper/Mapper;)Ljavax/json/bind/Jsonb;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(11, 14);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "doCreateJsonb", "(ZZLorg/apache/johnzon/mapper/Mapper;)Ljavax/json/bind/Jsonb;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createJsonParserFactory", "()Ljava/util/function/Supplier;", "()Ljava/util/function/Supplier<Ljavax/json/stream/JsonParserFactory;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createJsonBuilderFactory", "()Ljava/util/function/Supplier;", "()Ljava/util/function/Supplier<Ljavax/json/JsonBuilderFactory;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$build$24", "(Lorg/apache/johnzon/core/Types;Ljava/util/function/Supplier;Ljava/util/function/Supplier;[Ljavax/json/bind/serializer/JsonbDeserializer;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$null$23", "(Lorg/apache/johnzon/core/Types;Ljava/util/function/Supplier;Ljava/util/function/Supplier;Ljavax/json/bind/serializer/JsonbDeserializer;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitInvokeDynamicInsn("fromJson", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;Ljavax/json/bind/serializer/JsonbDeserializer;Ljava/util/function/Supplier;Ljavax/json/JsonBuilderFactory;)Lorg/apache/johnzon/mapper/ObjectConverter$Reader;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljavax/json/JsonValue;Ljava/lang/reflect/Type;Lorg/apache/johnzon/mapper/MappingParser;)Ljava/lang/Object;"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "lambda$null$22", "(Ljavax/json/bind/serializer/JsonbDeserializer;Ljava/util/function/Supplier;Ljavax/json/JsonBuilderFactory;Ljavax/json/JsonValue;Ljava/lang/reflect/Type;Lorg/apache/johnzon/mapper/MappingParser;)Ljava/lang/Object;", false), Type.getType("(Ljavax/json/JsonValue;Ljava/lang/reflect/Type;Lorg/apache/johnzon/mapper/MappingParser;)Ljava/lang/Object;")});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$null$22", "(Ljavax/json/bind/serializer/JsonbDeserializer;Ljava/util/function/Supplier;Ljavax/json/JsonBuilderFactory;Ljavax/json/JsonValue;Ljava/lang/reflect/Type;Lorg/apache/johnzon/mapper/MappingParser;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$build$21", "(Lorg/apache/johnzon/core/Types;[Ljavax/json/bind/serializer/JsonbSerializer;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/stream/Stream", "of", "([Ljava/lang/Object;)Ljava/util/stream/Stream;", true);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInvokeDynamicInsn("accept", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;Lorg/apache/johnzon/core/Types;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "lambda$null$20", "(Lorg/apache/johnzon/core/Types;Ljavax/json/bind/serializer/JsonbSerializer;)V", false), Type.getType("(Ljavax/json/bind/serializer/JsonbSerializer;)V")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "forEach", "(Ljava/util/function/Consumer;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$null$20", "(Lorg/apache/johnzon/core/Types;Ljavax/json/bind/serializer/JsonbSerializer;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC | ACC_SYNTHETIC, "lambda$null$19", "(Ljavax/json/bind/serializer/JsonbSerializer;Ljava/lang/Object;Lorg/apache/johnzon/mapper/MappingGenerator;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInvokeDynamicInsn("accept", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;Ljava/util/Map;)Ljava/util/function/Consumer;", new Handle(Opcodes.H_INVOKESTATIC, "java/lang/invoke/LambdaMetafactory", "metafactory", "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite;", false), new Object[]{Type.getType("(Ljava/lang/Object;)V"), new Handle(Opcodes.H_INVOKESPECIAL, "org/apache/johnzon/jsonb/JohnzonBuilder", "lambda$null$12", "(Ljava/util/Map;Ljavax/json/bind/adapter/JsonbAdapter;)V", false), Type.getType("(Ljavax/json/bind/adapter/JsonbAdapter;)V")});
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/stream/Stream", "forEach", "(Ljava/util/function/Consumer;)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 3);
methodVisitor.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$null$12", "(Ljava/util/Map;Ljavax/json/bind/adapter/JsonbAdapter;)V", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_SYNTHETIC, "lambda$build$10", "(Ljavax/json/bind/config/PropertyNamingStrategy;Ljava/lang/String;Ljavax/json/bind/config/PropertyVisibilityStrategy;Ljava/util/Optional;Ljava/util/Map;Lorg/apache/johnzon/jsonb/spi/JohnzonAdapterFactory;Ljava/util/function/Supplier;Ljava/util/function/Supplier;Z)Lorg/apache/johnzon/mapper/access/AccessMode;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
methodVisitor.visitLabel(label0);
...
methodVisitor.visitJumpInsn(GOTO, label2);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/johnzon/jsonb/JohnzonBuilder", "javax/json/bind/config/PropertyNamingStrategy", "java/lang/String", "javax/json/bind/config/PropertyVisibilityStrategy", "java/util/Optional", "java/util/Map", "org/apache/johnzon/jsonb/spi/JohnzonAdapterFactory", "java/util/function/Supplier", "java/util/function/Supplier", Opcodes.INTEGER}, 5, new Object[] {label0, label0, "javax/json/bind/config/PropertyNamingStrategy", "java/lang/String", "javax/json/bind/config/PropertyVisibilityStrategy"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/johnzon/jsonb/JohnzonBuilder", "javax/json/bind/config/PropertyNamingStrategy", "java/lang/String", "javax/json/bind/config/PropertyVisibilityStrategy", "java/util/Optional", "java/util/Map", "org/apache/johnzon/jsonb/spi/JohnzonAdapterFactory", "java/util/function/Supplier", "java/util/function/Supplier", Opcodes.INTEGER}, 6, new Object[] {label0, label0, "javax/json/bind/config/PropertyNamingStrategy", "java/lang/String", "javax/json/bind/config/PropertyVisibilityStrategy", Opcodes.INTEGER});
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "jsonp", "Ljavax/json/spi/JsonProvider;");
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/Boolean");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Boolean", "booleanValue", "()Z", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jsonb/JsonbAccessMode", "<init>", "(Ljavax/json/bind/config/PropertyNamingStrategy;Ljava/lang/String;Ljavax/json/bind/config/PropertyVisibilityStrategy;ZLjava/util/Map;Lorg/apache/johnzon/jsonb/spi/JohnzonAdapterFactory;Ljavax/json/spi/JsonProvider;Ljava/util/function/Supplier;Ljava/util/function/Supplier;Lorg/apache/johnzon/mapper/access/AccessMode;ZZZ)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/bind/JsonbConfig", "withDateFormat", "(Ljava/lang/String;Ljava/util/Locale;)Ljavax/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$100", "(Lorg/apache/johnzon/jsonb/JohnzonBuilder;)Ljavax/json/spi/JsonProvider;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jsonb/JohnzonBuilder", "jsonp", "Ljavax/json/spi/JsonProvider;");
methodVisitor.visitInsn(ARETURN);
