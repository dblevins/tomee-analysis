...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "jakarta/xml/soap/SAAJResult", null, "javax/xml/transform/dom/DOMResult", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "()V", null, new String[] { "jakarta/xml/soap/SOAPException" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "jakarta/xml/soap/SAAJResult", "<init>", "(Ljakarta/xml/soap/SOAPMessage;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/soap/SAAJResult", "getNode", "()Lorg/w3c/dom/Node;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/xml/soap/SAAJResult", "setNode", "(Lorg/w3c/dom/Node;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 5);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/String;)V", null, new String[] { "jakarta/xml/soap/SOAPException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getResult", "()Ljakarta/xml/soap/Node;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "jakarta/xml/soap/SOAPPart");
Label label4 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label4);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/xml/soap/SOAPPart");
