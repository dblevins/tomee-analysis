...
public class FaultActionDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/xml/ws/FaultAction", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "className", "()Ljava/lang/Class;", "()Ljava/lang/Class<+Ljava/lang/Exception;>;", null);
