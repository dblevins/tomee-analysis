...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/persistence/metamodel/Attribute", "<X:Ljava/lang/Object;Y:Ljava/lang/Object;>Ljava/lang/Object;", "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getPersistentAttributeType", "()Ljakarta/persistence/metamodel/Attribute$PersistentAttributeType;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getDeclaringType", "()Ljakarta/persistence/metamodel/ManagedType;", "()Ljakarta/persistence/metamodel/ManagedType<TX;>;", null);
methodVisitor.visitEnd();
}
{
