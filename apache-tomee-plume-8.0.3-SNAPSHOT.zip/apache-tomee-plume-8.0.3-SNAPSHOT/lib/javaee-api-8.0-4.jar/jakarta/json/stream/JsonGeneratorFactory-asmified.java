...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/json/stream/JsonGeneratorFactory", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "createGenerator", "(Ljava/io/OutputStream;Ljava/nio/charset/Charset;)Ljakarta/json/stream/JsonGenerator;", null, null);
methodVisitor.visitEnd();
}
{
