...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/groups/ConvertGroup", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/validation/groups/ConvertGroup$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, Type.getType("Ljakarta/validation/groups/Default;"));
annotationVisitor0.visitEnd();
}
