...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/Future", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/validation/constraints/Future$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{jakarta.validation.constraints.Future.message}");
annotationVisitor0.visitEnd();
}
