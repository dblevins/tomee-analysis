...
public class Negative$ListDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/Negative$List", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
classWriter.visitInnerClass("jakarta/validation/constraints/Negative$List", "jakarta/validation/constraints/Negative", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "value", "()[Ljakarta/validation/constraints/Negative;", null, null);
