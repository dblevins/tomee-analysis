...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/validation/constraints/DecimalMin", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljakarta/validation/constraints/DecimalMin$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{jakarta.validation.constraints.DecimalMin.message}");
annotationVisitor0.visitEnd();
}
