...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "jakarta/jms/JMSRuntimeException", null, "java/lang/RuntimeException", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/jms/JMSRuntimeException", "errorCode", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/jms/JMSRuntimeException", "errorCode", "Ljava/lang/String;");
