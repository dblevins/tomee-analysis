...
classWriter.visit(V1_4, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/enterprise/deploy/model/DDBean", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getRoot", "()Ljakarta/enterprise/deploy/model/DDBeanRoot;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "addXpathListener", "(Ljava/lang/String;Ljakarta/enterprise/deploy/model/XpathListener;)V", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "removeXpathListener", "(Ljava/lang/String;Ljakarta/enterprise/deploy/model/XpathListener;)V", null, null);
methodVisitor.visitEnd();
}
{
