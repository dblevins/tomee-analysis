...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/enterprise/inject/spi/AnnotatedParameter", "<X:Ljava/lang/Object;>Ljava/lang/Object;Ljakarta/enterprise/inject/spi/Annotated;", "java/lang/Object", new String[] { "jakarta/enterprise/inject/spi/Annotated" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getDeclaringCallable", "()Ljakarta/enterprise/inject/spi/AnnotatedCallable;", "()Ljakarta/enterprise/inject/spi/AnnotatedCallable<TX;>;", null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedParameter", "getJavaParameter", "()Ljava/lang/reflect/Parameter;", true);
methodVisitor.visitVarInsn(ALOAD, 1);
