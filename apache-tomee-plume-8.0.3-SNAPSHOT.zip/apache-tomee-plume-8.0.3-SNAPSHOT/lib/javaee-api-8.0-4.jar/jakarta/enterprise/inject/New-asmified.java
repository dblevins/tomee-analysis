...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "jakarta/enterprise/inject/New", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit(null, Type.getType("Ljakarta/enterprise/inject/New;"));
annotationVisitor0.visitEnd();
}
