...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/security/jacc/PolicyConfigurationFactory", null, "java/lang/Object", null);

classWriter.visitInnerClass("javax/security/jacc/PolicyConfigurationFactory$1", null, null, ACC_STATIC);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FACTORY_NAME", "Ljava/lang/String;", null, "javax.security.jacc.PolicyConfigurationFactory.provider");
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_STATIC, "policyConfigurationFactory", "Ljavax/security/jacc/PolicyConfigurationFactory;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getPolicyConfigurationFactory", "()Ljavax/security/jacc/PolicyConfigurationFactory;", null, new String[] { "java/lang/ClassNotFoundException", "javax/security/jacc/PolicyContextException" });
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETSTATIC, "javax/security/jacc/PolicyConfigurationFactory", "policyConfigurationFactory", "Ljavax/security/jacc/PolicyConfigurationFactory;");
...
methodVisitor.visitTypeInsn(NEW, "javax/security/jacc/PolicyConfigurationFactory$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/security/jacc/PolicyConfigurationFactory$1", "<init>", "([Ljava/lang/String;)V", false);
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/security/jacc/PolicyConfigurationFactory");
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/security/jacc/PolicyConfigurationFactory", "policyConfigurationFactory", "Ljavax/security/jacc/PolicyConfigurationFactory;");
