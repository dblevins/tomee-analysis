...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "javax/security/jacc/WebUserDataPermission", null, "java/security/Permission", new String[] { "java/io/Serializable" });

classWriter.visitInnerClass("javax/security/jacc/WebUserDataPermission$1", "javax/security/jacc/WebUserDataPermission", null, ACC_STATIC | ACC_SYNTHETIC);

classWriter.visitInnerClass("javax/security/jacc/WebUserDataPermission$WebUserDataPermissionCollection", "javax/security/jacc/WebUserDataPermission", "WebUserDataPermissionCollection", ACC_PRIVATE | ACC_FINAL | ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/security/jacc/WebUserDataPermission", "cachedHashCode", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "javax/security/jacc/URLPatternSpec");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/security/jacc/WebUserDataPermission", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/security/jacc/URLPatternSpec", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/security/jacc/WebUserDataPermission", "urlPatternSpec", "Ljavax/security/jacc/URLPatternSpec;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/security/jacc/WebUserDataPermission", "httpMethodSpec", "Ljavax/security/jacc/HTTPMethodSpec;");
...
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitLabel(label1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/security/jacc/HTTPMethodSpec", "<init>", "([Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "javax/security/jacc/WebUserDataPermission", "httpMethodSpec", "Ljavax/security/jacc/HTTPMethodSpec;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/security/jacc/WebUserDataPermission");
Label label1 = new Label();
...
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/security/jacc/WebUserDataPermission");
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/security/jacc/WebUserDataPermission", "urlPatternSpec", "Ljavax/security/jacc/URLPatternSpec;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETFIELD, "javax/security/jacc/WebUserDataPermission", "urlPatternSpec", "Ljavax/security/jacc/URLPatternSpec;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/security/jacc/WebUserDataPermission", "httpMethodSpec", "Ljavax/security/jacc/HTTPMethodSpec;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(GETFIELD, "javax/security/jacc/WebUserDataPermission", "httpMethodSpec", "Ljavax/security/jacc/HTTPMethodSpec;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/security/jacc/WebUserDataPermission", "cachedHashCode", "I");
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "javax/security/jacc/WebUserDataPermission$WebUserDataPermissionCollection");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/security/jacc/WebUserDataPermission$WebUserDataPermissionCollection", "<init>", "(Ljavax/security/jacc/WebUserDataPermission$1;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
