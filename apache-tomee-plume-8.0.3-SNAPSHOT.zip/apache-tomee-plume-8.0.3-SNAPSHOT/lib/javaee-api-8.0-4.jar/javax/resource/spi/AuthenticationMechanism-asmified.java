...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/resource/spi/AuthenticationMechanism", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "credentialInterface", "()Ljavax/resource/spi/AuthenticationMechanism$CredentialInterface;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Ljavax/resource/spi/AuthenticationMechanism$CredentialInterface;", "PasswordCredential");
annotationVisitor0.visitEnd();
}
methodVisitor.visitEnd();
}
