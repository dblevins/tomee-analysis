...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljavax/persistence/CacheStoreMode;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "values", "()[Ljavax/persistence/CacheStoreMode;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/CacheStoreMode", "$VALUES", "[Ljavax/persistence/CacheStoreMode;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljavax/persistence/CacheStoreMode;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/persistence/CacheStoreMode;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/CacheStoreMode", "$VALUES", "[Ljavax/persistence/CacheStoreMode;");
methodVisitor.visitInsn(RETURN);
