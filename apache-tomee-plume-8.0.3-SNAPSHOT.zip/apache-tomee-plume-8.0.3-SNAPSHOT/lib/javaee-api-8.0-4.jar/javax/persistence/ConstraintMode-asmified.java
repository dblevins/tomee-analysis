...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$VALUES", "[Ljavax/persistence/ConstraintMode;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "values", "()[Ljavax/persistence/ConstraintMode;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/ConstraintMode", "$VALUES", "[Ljavax/persistence/ConstraintMode;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "[Ljavax/persistence/ConstraintMode;", "clone", "()Ljava/lang/Object;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "[Ljavax/persistence/ConstraintMode;");
...
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTSTATIC, "javax/persistence/ConstraintMode", "$VALUES", "[Ljavax/persistence/ConstraintMode;");
methodVisitor.visitInsn(RETURN);
