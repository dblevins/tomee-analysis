...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/xml/ws/RespectBinding", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("bean", Type.getType("Ljavax/xml/ws/RespectBindingFeature;"));
annotationVisitor0.visitEnd();
}
{
