...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/PastOrPresent", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/validation/constraints/PastOrPresent$List;"));
annotationVisitor0.visitEnd();
}
classWriter.visitInnerClass("javax/validation/constraints/PastOrPresent$List", "javax/validation/constraints/PastOrPresent", "List", ACC_PUBLIC | ACC_STATIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE);
