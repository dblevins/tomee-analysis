...
public class FutureDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "javax/validation/constraints/Future", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Ljavax/validation/constraints/Future$List;"));
annotationVisitor0.visitEnd();
}
...
annotationVisitor0.visit(null, "{javax.validation.constraints.Future.message}");
annotationVisitor0.visitEnd();
}
