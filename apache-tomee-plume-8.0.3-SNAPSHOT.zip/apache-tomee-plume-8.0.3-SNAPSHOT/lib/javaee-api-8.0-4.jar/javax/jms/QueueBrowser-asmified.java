...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/jms/QueueBrowser", null, "java/lang/Object", new String[] { "java/lang/AutoCloseable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getEnumeration", "()Ljava/util/Enumeration;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitEnd();
}
{
