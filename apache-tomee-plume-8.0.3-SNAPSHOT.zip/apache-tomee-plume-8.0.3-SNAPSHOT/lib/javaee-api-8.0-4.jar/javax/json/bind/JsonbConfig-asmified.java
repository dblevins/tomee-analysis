...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "javax/json/bind/JsonbConfig", null, "java/lang/Object", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/json/bind/JsonbConfig", "configuration", "Ljava/util/Map;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withDateFormat", "(Ljava/lang/String;Ljava/util/Locale;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/json/bind/JsonbConfig", "java/lang/String", "java/util/Locale"}, 2, new Object[] {"javax/json/bind/JsonbConfig", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/util/Locale", "getDefault", "()Ljava/util/Locale;", false);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"javax/json/bind/JsonbConfig", "java/lang/String", "java/util/Locale"}, 3, new Object[] {"javax/json/bind/JsonbConfig", "java/lang/String", "java/lang/Object"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/json/bind/JsonbConfig", "setProperty", "(Ljava/lang/String;Ljava/lang/Object;)Ljavax/json/bind/JsonbConfig;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withLocale", "(Ljava/util/Locale;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("jsonb.locale");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "setProperty", "(Ljava/lang/String;Ljava/lang/Object;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/json/bind/JsonbConfig", "configuration", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withFormatting", "(Ljava/lang/Boolean;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withNullValues", "(Ljava/lang/Boolean;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withEncoding", "(Ljava/lang/String;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withStrictIJSON", "(Ljava/lang/Boolean;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withPropertyNamingStrategy", "(Ljavax/json/bind/config/PropertyNamingStrategy;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withPropertyNamingStrategy", "(Ljava/lang/String;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("jsonb.property-naming-strategy");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withPropertyOrderStrategy", "(Ljava/lang/String;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withPropertyVisibilityStrategy", "(Ljavax/json/bind/config/PropertyVisibilityStrategy;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL | ACC_VARARGS, "withAdapters", "([Ljavax/json/bind/adapter/JsonbAdapter;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("jsonb.adapters");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/json/bind/adapter/JsonbAdapter;"));
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/json/bind/JsonbConfig", "accumulate", "(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Class;)Ljavax/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL, "withBinaryDataStrategy", "(Ljava/lang/String;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL | ACC_VARARGS, "withSerializers", "([Ljavax/json/bind/serializer/JsonbSerializer;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("jsonb.serializers");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitLdcInsn(Type.getType("Ljavax/json/bind/serializer/JsonbSerializer;"));
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/json/bind/JsonbConfig", "accumulate", "(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Class;)Ljavax/json/bind/JsonbConfig;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(4, 2);
methodVisitor.visitEnd();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_FINAL | ACC_VARARGS, "withDeserializers", "([Ljavax/json/bind/serializer/JsonbDeserializer;)Ljavax/json/bind/JsonbConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "accumulate", "(Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Class;)Ljavax/json/bind/JsonbConfig;", "<T:Ljava/lang/Object;>(Ljava/lang/String;[TT;Ljava/lang/Class<TT;>;)Ljavax/json/bind/JsonbConfig;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
