...
public class EmptyJsonObjectDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "javax/json/EmptyJsonObject", "Ljava/util/AbstractMap<Ljava/lang/String;Ljavax/json/JsonValue;>;Ljavax/json/JsonObject;Ljava/io/Serializable;", "java/util/AbstractMap", new String[] { "javax/json/JsonObject", "java/io/Serializable" });
...
methodVisitor.visitLdcInsn("Calling getInt on EmptyJsonObject");
