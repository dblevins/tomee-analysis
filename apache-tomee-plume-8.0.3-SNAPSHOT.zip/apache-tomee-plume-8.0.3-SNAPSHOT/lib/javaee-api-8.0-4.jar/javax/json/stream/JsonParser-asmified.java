...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/json/stream/JsonParser", null, "java/lang/Object", new String[] { "java/io/Closeable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "next", "()Ljavax/json/stream/JsonParser$Event;", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getLocation", "()Ljavax/json/stream/JsonLocation;", null, null);
methodVisitor.visitEnd();
}
{
