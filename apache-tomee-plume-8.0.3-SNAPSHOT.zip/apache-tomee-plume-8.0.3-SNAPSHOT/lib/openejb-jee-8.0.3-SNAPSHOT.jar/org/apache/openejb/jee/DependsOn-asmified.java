...
public class DependsOnDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/DependsOn", null, "java/lang/Object", null);
...
annotationVisitor0.visit("name", "depends-onType");
{
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "ejbName", "Ljava/util/List;", "Ljava/util/List<Ljava/lang/String;>;", null);
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEjbName", "()Ljava/util/List;", "()Ljava/util/List<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/DependsOn", "ejbName", "Ljava/util/List;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/DependsOn", "ejbName", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/DependsOn", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/DependsOn", "id", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
