...
public class EClassifierDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/was/v6/ecore/EClassifier", null, "org/apache/openejb/jee/was/v6/ecore/ENamedElement", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "instanceClassName", "Ljava/lang/String;", null, null);
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/jee/was/v6/ecore/EClassifier", "instanceClassName", "Ljava/lang/String;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/jee/was/v6/ecore/EClassifier", "instanceClassName", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
