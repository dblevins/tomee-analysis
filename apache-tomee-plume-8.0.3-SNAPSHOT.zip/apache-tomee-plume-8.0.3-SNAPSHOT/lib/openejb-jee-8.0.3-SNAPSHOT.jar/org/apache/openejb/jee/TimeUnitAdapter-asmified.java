...
public class TimeUnitAdapterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/jee/TimeUnitAdapter", "Ljakarta/xml/bind/annotation/adapters/XmlAdapter<Ljava/lang/String;Ljava/util/concurrent/TimeUnit;>;", "jakarta/xml/bind/annotation/adapters/XmlAdapter", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "unmarshal", "(Ljava/lang/String;)Ljava/util/concurrent/TimeUnit;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "marshal", "(Ljava/util/concurrent/TimeUnit;)Ljava/lang/String;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "java/util/concurrent/TimeUnit");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/TimeUnitAdapter", "marshal", "(Ljava/util/concurrent/TimeUnit;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/jee/TimeUnitAdapter", "unmarshal", "(Ljava/lang/String;)Ljava/util/concurrent/TimeUnit;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
