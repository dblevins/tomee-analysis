...
public class UDecoder$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/tomcat/util/buf/UDecoder$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/tomcat/util/buf/UDecoder", null, null);

classWriter.visitInnerClass("org/apache/tomcat/util/buf/UDecoder$1", null, null, ACC_STATIC | ACC_SYNTHETIC);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$tomcat$util$buf$EncodedSolidusHandling", "[I", null, null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomcat/util/buf/UDecoder$1", "$SwitchMap$org$apache$tomcat$util$buf$EncodedSolidusHandling", "[I");
