...
public class ValueEncoderFactory$IntEncoderDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntEncoder", null, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$TypedScalarEncoder", null);
...
{
fieldVisitor = classWriter.visitField(0, "_value", "I", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "reset", "(I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntEncoder", "_value", "I");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/codehaus/stax2/ri/typed/ValueEncoderFactory$IntEncoder", "_value", "I");
