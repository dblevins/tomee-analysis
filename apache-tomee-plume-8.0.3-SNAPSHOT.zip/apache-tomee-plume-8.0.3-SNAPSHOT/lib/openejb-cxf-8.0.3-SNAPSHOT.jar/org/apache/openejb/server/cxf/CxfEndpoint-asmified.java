...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/CxfEndpoint", "getBinding", "()Ljavax/xml/ws/Binding;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/core/webservices/HandlerResolverImpl", "getHandlerChain", "(Ljavax/xml/ws/handler/PortInfo;)Ljava/util/List;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/CxfEndpoint", "getBinding", "()Ljavax/xml/ws/Binding;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
