...
public class WSSPassThroughInterceptorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/server/cxf/WSSPassThroughInterceptor", null, "org/apache/cxf/binding/soap/interceptor/AbstractSoapInterceptor", null);
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/server/cxf/WSSPassThroughInterceptor", "HEADERS", "Ljava/util/Set;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openejb/server/cxf/WSSPassThroughInterceptor", "handleMessage", "(Lorg/apache/cxf/binding/soap/SoapMessage;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/server/cxf/WSSPassThroughInterceptor", "HEADERS", "Ljava/util/Set;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openejb/server/cxf/WSSPassThroughInterceptor", "HEADERS", "Ljava/util/Set;");
