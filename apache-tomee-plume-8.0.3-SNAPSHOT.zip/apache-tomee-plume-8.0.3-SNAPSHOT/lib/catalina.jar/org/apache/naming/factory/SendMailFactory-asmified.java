...
public class SendMailFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/naming/factory/SendMailFactory", null, "java/lang/Object", new String[] { "javax/naming/spi/ObjectFactory" });

classWriter.visitInnerClass("org/apache/naming/factory/SendMailFactory$1", null, null, 0);

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL | ACC_STATIC, "DataSourceClassName", "Ljava/lang/String;", null, "javax.mail.internet.MimePartDataSource");
...
methodVisitor.visitLdcInsn("javax.mail.internet.MimePartDataSource");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/String", "equals", "(Ljava/lang/Object;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitTypeInsn(NEW, "org/apache/naming/factory/SendMailFactory$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/naming/factory/SendMailFactory$1", "<init>", "(Lorg/apache/naming/factory/SendMailFactory;Ljavax/naming/Reference;)V", false);
