...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/core/StandardContext", null, "org/apache/catalina/core/ContainerBase", new String[] { "org/apache/catalina/Context", "javax/management/NotificationEmitter" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "initializers", "Ljava/util/Map;", "Ljava/util/Map<Ljavax/servlet/ServletContainerInitializer;Ljava/util/Set<Ljava/lang/Class<*>;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "broadcaster", "Ljavax/management/NotificationBroadcasterSupport;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "createdServlets", "Ljava/util/Set;", "Ljava/util/Set<Ljavax/servlet/Servlet;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "notificationInfo", "[Ljavax/management/MBeanNotificationInfo;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/StandardContext", "broadcaster", "Ljavax/management/NotificationBroadcasterSupport;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/StandardContext", "jspConfigDescriptor", "Ljavax/servlet/descriptor/JspConfigDescriptor;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(NEW, "java/util/HashSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/util/HashSet", "<init>", "()V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/StandardContext", "jspConfigDescriptor", "Ljavax/servlet/descriptor/JspConfigDescriptor;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "dynamicServletCreated", "(Ljavax/servlet/Servlet;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "wasCreatedDynamicServlet", "(Ljavax/servlet/Servlet;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/StandardContext", "createdServlets", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "findFilterConfig", "(Ljava/lang/String;)Ljavax/servlet/FilterConfig;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/StandardContext", "filterConfigs", "Ljava/util/Map;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", true);
methodVisitor.visitTypeInsn(CHECKCAST, "javax/servlet/FilterConfig");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/StandardContext", "getServletContext", "()Ljavax/servlet/ServletContext;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/core/StandardContext$NoPluggabilityServletContext", "<init>", "(Ljavax/servlet/ServletContext;)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/StandardContext", "noPluggabilityServletContext", "Lorg/apache/catalina/core/StandardContext$NoPluggabilityServletContext;");
methodVisitor.visitTypeInsn(NEW, "javax/servlet/ServletContextEvent");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ASTORE, 8);
methodVisitor.visitLabel(label23);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/servlet/ServletContextEvent", "javax/servlet/ServletContextEvent"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 6);
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitInsn(ARRAYLENGTH);
...
methodVisitor.visitLabel(label28);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/servlet/ServletContextListener"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 13);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/ServletContextListener", "contextInitialized", "(Ljavax/servlet/ServletContextEvent;)V", true);
...
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/catalina/core/StandardContext", Opcodes.INTEGER, "[Ljava/lang/Object;", "javax/servlet/ServletContextEvent", "javax/servlet/ServletContextEvent"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ISTORE, 5);
Label label12 = new Label();
methodVisitor.visitLabel(label12);
...
methodVisitor.visitJumpInsn(GOTO, label12);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/core/StandardContext", "[Lorg/apache/catalina/Container;", "java/util/TreeMap", "java/util/Iterator", "java/util/ArrayList", "java/util/Iterator", "org/apache/catalina/Wrapper"}, 1, new Object[] {"javax/servlet/ServletException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/StandardContext", "getLogger", "()Lorg/apache/juli/logging/Log;", false);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/core/StandardContext", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
Label label10 = new Label();
Label label11 = new Label();
methodVisitor.visitTryCatchBlock(label9, label10, label11, "javax/servlet/ServletException");
Label label12 = new Label();
Label label13 = new Label();
Label label14 = new Label();
...
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/StandardContext", "broadcaster", "Ljavax/management/NotificationBroadcasterSupport;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/core/StandardContext", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/String", "java/lang/ClassLoader", "java/util/Iterator", "java/util/Map$Entry"}, 1, new Object[] {"javax/servlet/ServletException"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/core/StandardContext", "log", "Lorg/apache/juli/logging/Log;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/core/StandardContext", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
...
Label label6 = new Label();
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/servlet/ServletContext", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
...
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/servlet/ServletRegistration$Dynamic", "getMappings", "()Ljava/util/Collection;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Collection", "iterator", "()Ljava/util/Iterator;", true);
methodVisitor.visitVarInsn(ASTORE, 5);
...
Label label2 = new Label();
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 12, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRegistration$Dynamic", "javax/servlet/ServletSecurityElement", "java/util/Set", "java/util/Collection", "java/util/Iterator", "java/lang/String", Opcodes.INTEGER, "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 11);
methodVisitor.visitVarInsn(ILOAD, 10);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IF_ICMPGE, label3);
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 17, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRegistration$Dynamic", "javax/servlet/ServletSecurityElement", "java/util/Set", "java/util/Collection", "java/util/Iterator", "java/lang/String", Opcodes.INTEGER, "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", Opcodes.INTEGER, Opcodes.INTEGER, "org/apache/tomcat/util/descriptor/web/SecurityConstraint", "[Lorg/apache/tomcat/util/descriptor/web/SecurityCollection;", "[Lorg/apache/tomcat/util/descriptor/web/SecurityCollection;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
Label label11 = new Label();
methodVisitor.visitLabel(label11);
methodVisitor.visitFrame(Opcodes.F_FULL, 13, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRegistration$Dynamic", "javax/servlet/ServletSecurityElement", "java/util/Set", "java/util/Collection", "java/util/Iterator", "java/lang/String", Opcodes.INTEGER, "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", "[Lorg/apache/tomcat/util/descriptor/web/SecurityConstraint;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitJumpInsn(GOTO, label11);
methodVisitor.visitLabel(label10);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRegistration$Dynamic", "javax/servlet/ServletSecurityElement", "java/util/Set", "java/util/Collection", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 3);
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRequest", "[Ljava/lang/Object;", "javax/servlet/ServletRequestEvent", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
methodVisitor.visitVarInsn(ILOAD, 6);
methodVisitor.visitVarInsn(ILOAD, 5);
methodVisitor.visitJumpInsn(IF_ICMPGE, label3);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRequest", "[Ljava/lang/Object;", "javax/servlet/ServletRequestEvent", "[Ljava/lang/Object;", Opcodes.INTEGER, Opcodes.INTEGER, "java/lang/Object", "javax/servlet/ServletRequestListener"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 9);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/ExceptionUtils", "handleThrowable", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRequest", "[Ljava/lang/Object;"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IRETURN);
...
Label label4 = new Label();
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"[Ljava/lang/Object;", "javax/servlet/ServletRequestEvent", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitJumpInsn(IF_ICMPGE, label3);
...
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/core/StandardContext", "javax/servlet/ServletRequest", "[Ljava/lang/Object;", "javax/servlet/ServletRequestEvent", Opcodes.INTEGER, Opcodes.INTEGER, "javax/servlet/ServletRequestListener"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 7);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/tomcat/util/ExceptionUtils", "handleThrowable", "(Ljava/lang/Throwable;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/StandardContext", "notificationInfo", "[Ljavax/management/MBeanNotificationInfo;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "javax/management/MBeanNotificationInfo", "<init>", "([Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/StandardContext", "notificationInfo", "[Ljavax/management/MBeanNotificationInfo;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/core/StandardContext", "notificationInfo", "[Ljavax/management/MBeanNotificationInfo;");
