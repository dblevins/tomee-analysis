...
public class ApplicationDispatcher$PrivilegedForwardDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedForward", "Ljava/lang/Object;Ljava/security/PrivilegedExceptionAction<Ljava/lang/Void;>;", "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedForward", "this$0", "Lorg/apache/catalina/core/ApplicationDispatcher;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/ApplicationDispatcher$PrivilegedForward", "run", "()Ljava/lang/Void;", false);
methodVisitor.visitInsn(ARETURN);
