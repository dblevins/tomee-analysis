...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/core/ApplicationHttpResponse", null, "javax/servlet/http/HttpServletResponseWrapper", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/servlet/http/HttpServletResponse;Z)V", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/core/ApplicationHttpResponse", "getResponse", "()Ljavax/servlet/ServletResponse;", false);
...
{
methodVisitor = classWriter.visitMethod(0, "setResponse", "(Ljavax/servlet/http/HttpServletResponse;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
