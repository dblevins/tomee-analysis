...
public class DefaultServlet$SecureEntityResolverDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/servlets/DefaultServlet$SecureEntityResolver", null, "java/lang/Object", new String[] { "org/xml/sax/ext/EntityResolver2" });
...
methodVisitor.visitLdcInsn("defaultServlet.blockExternalEntity");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/servlets/DefaultServlet", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
methodVisitor.visitLdcInsn("defaultServlet.blockExternalSubset");
methodVisitor.visitInsn(ICONST_2);
methodVisitor.visitTypeInsn(ANEWARRAY, "java/lang/Object");
methodVisitor.visitInsn(DUP);
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/servlets/DefaultServlet", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
methodVisitor.visitLdcInsn("defaultServlet.blockExternalEntity2");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/servlets/DefaultServlet$SecureEntityResolver", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
