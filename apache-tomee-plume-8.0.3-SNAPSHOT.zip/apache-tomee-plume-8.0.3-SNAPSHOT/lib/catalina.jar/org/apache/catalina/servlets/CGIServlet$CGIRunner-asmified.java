...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/servlets/CGIServlet$CGIRunner", "response", "Ljakarta/servlet/http/HttpServletResponse;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/servlets/CGIServlet$CGIRunner", "response", "Ljakarta/servlet/http/HttpServletResponse;");
methodVisitor.visitJumpInsn(IFNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setResponse", "(Ljakarta/servlet/http/HttpServletResponse;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/servlets/CGIServlet$CGIRunner", "response", "Ljakarta/servlet/http/HttpServletResponse;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/catalina/servlets/CGIServlet", "access$1300", "(Lorg/apache/catalina/servlets/CGIServlet;Ljakarta/servlet/http/HttpServletResponse;I)Z", false);
methodVisitor.visitVarInsn(ISTORE, 14);
