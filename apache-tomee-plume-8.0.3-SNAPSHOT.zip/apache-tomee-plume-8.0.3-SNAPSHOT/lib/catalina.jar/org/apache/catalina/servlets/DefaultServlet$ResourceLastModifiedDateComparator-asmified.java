...
public class DefaultServlet$ResourceLastModifiedDateComparatorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/servlets/DefaultServlet$ResourceLastModifiedDateComparator", "Ljava/lang/Object;Ljava/util/Comparator<Lorg/apache/catalina/WebResource;>;", "java/lang/Object", new String[] { "java/util/Comparator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/servlets/DefaultServlet$ResourceLastModifiedDateComparator", "base", "Ljava/util/Comparator;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/servlets/DefaultServlet$ResourceLastModifiedDateComparator", "base", "Ljava/util/Comparator;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/catalina/WebResource");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/servlets/DefaultServlet$ResourceLastModifiedDateComparator", "compare", "(Lorg/apache/catalina/WebResource;Lorg/apache/catalina/WebResource;)I", false);
methodVisitor.visitInsn(IRETURN);
