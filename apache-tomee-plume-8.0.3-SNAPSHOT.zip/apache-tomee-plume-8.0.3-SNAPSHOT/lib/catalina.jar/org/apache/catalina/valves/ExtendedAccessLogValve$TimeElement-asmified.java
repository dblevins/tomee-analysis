...
public class ExtendedAccessLogValve$TimeElementDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement", null, "java/lang/Object", new String[] { "org/apache/catalina/valves/AbstractAccessLogValve$AccessLogElement" });
...
classWriter.visitInnerClass("org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement$1", null, null, ACC_STATIC);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "INTERVAL", "J", null, new Long(1000L));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "currentTime", "Ljava/lang/ThreadLocal;", "Ljava/lang/ThreadLocal<Lorg/apache/catalina/valves/ExtendedAccessLogValve$ElementTimestampStruct;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement", "currentTime", "Ljava/lang/ThreadLocal;");
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement$1", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/catalina/valves/ExtendedAccessLogValve$TimeElement", "currentTime", "Ljava/lang/ThreadLocal;");
methodVisitor.visitInsn(RETURN);
