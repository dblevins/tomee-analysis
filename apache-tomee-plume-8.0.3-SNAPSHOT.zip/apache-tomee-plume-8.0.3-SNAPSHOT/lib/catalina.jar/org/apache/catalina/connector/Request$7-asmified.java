...
public class Request$7Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/catalina/connector/Request$7", null, "java/lang/Object", new String[] { "org/apache/catalina/connector/Request$SpecialAttributeAdapter" });
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/coyote/ProtocolHandler", "isSendfileSupported", "()Z", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/coyote/Request", "getSendfile", "()Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
