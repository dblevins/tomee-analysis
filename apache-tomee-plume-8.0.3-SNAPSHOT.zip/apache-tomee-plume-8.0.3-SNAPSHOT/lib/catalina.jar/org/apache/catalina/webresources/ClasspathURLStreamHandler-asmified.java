...
public class ClasspathURLStreamHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/catalina/webresources/ClasspathURLStreamHandler", null, "java/net/URLStreamHandler", null);
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/catalina/webresources/ClasspathURLStreamHandler;"));
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/catalina/webresources/ClasspathURLStreamHandler", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
methodVisitor.visitLdcInsn("classpathUrlStreamHandler.notFound");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/catalina/webresources/ClasspathURLStreamHandler", "sm", "Lorg/apache/tomcat/util/res/StringManager;");
methodVisitor.visitInsn(RETURN);
