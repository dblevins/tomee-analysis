...
public class CachedResource$CachedResourceJarURLConnectionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", null, "java/net/JarURLConnection", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Ljava/net/URL;Lorg/apache/catalina/webresources/StandardRoot;Ljava/lang/String;Z)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/net/JarURLConnection", "<init>", "(Ljava/net/URL;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "root", "Lorg/apache/catalina/webresources/StandardRoot;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "webAppPath", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "usesClassLoaderResources", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "resourceURL", "Ljava/net/URL;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "getResource", "()Lorg/apache/catalina/WebResource;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "webAppPath", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "resourceURL", "Ljava/net/URL;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "root", "Lorg/apache/catalina/webresources/StandardRoot;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "webAppPath", "Ljava/lang/String;");
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "usesClassLoaderResources", "Z");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getJarFile", "()Ljava/util/jar/JarFile;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "resourceURL", "Ljava/net/URL;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/net/URL", "openConnection", "()Ljava/net/URLConnection;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getJarEntry", "()Ljava/util/jar/JarEntry;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/webresources/CachedResource$CachedResourceJarURLConnection", "getEntryName", "()Ljava/lang/String;", false);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/net/JarURLConnection", "getJarEntry", "()Ljava/util/jar/JarEntry;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
