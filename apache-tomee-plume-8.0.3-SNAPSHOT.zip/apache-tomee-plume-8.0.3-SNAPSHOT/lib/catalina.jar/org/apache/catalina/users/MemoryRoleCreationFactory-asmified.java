...
public class MemoryRoleCreationFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/catalina/users/MemoryRoleCreationFactory", null, "org/apache/tomcat/util/digester/AbstractObjectCreationFactory", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/catalina/users/MemoryRoleCreationFactory", "database", "Lorg/apache/catalina/users/MemoryUserDatabase;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/users/MemoryRoleCreationFactory", "database", "Lorg/apache/catalina/users/MemoryUserDatabase;");
methodVisitor.visitVarInsn(ALOAD, 2);
