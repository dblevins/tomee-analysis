...
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/authenticator/DigestAuthenticator", "checkForCachedAuthentication", "(Lorg/apache/catalina/connector/Request;Ljavax/servlet/http/HttpServletResponse;Z)Z", false);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/authenticator/DigestAuthenticator", "register", "(Lorg/apache/catalina/connector/Request;Ljavax/servlet/http/HttpServletResponse;Ljava/security/Principal;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/authenticator/DigestAuthenticator", "org/apache/catalina/connector/Request", "javax/servlet/http/HttpServletResponse", "java/security/Principal", "java/lang/String", "org/apache/catalina/authenticator/DigestAuthenticator$DigestInfo", "java/lang/String"}, 4, new Object[] {"org/apache/catalina/authenticator/DigestAuthenticator", "org/apache/catalina/connector/Request", "javax/servlet/http/HttpServletResponse", "java/lang/String"});
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/catalina/authenticator/DigestAuthenticator", "org/apache/catalina/connector/Request", "javax/servlet/http/HttpServletResponse", "java/security/Principal", "java/lang/String", "org/apache/catalina/authenticator/DigestAuthenticator$DigestInfo", "java/lang/String"}, 5, new Object[] {"org/apache/catalina/authenticator/DigestAuthenticator", "org/apache/catalina/connector/Request", "javax/servlet/http/HttpServletResponse", "java/lang/String", Opcodes.INTEGER});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/catalina/authenticator/DigestAuthenticator", "setAuthenticateHeader", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljava/lang/String;Z)V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "setAuthenticateHeader", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Ljava/lang/String;Z)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/catalina/authenticator/DigestAuthenticator", "context", "Lorg/apache/catalina/Context;");
