...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/frontend/spring/NamespaceHandler", null, "org/springframework/beans/factory/xml/NamespaceHandlerSupport", null);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/cxf/frontend/spring/ClientProxyFactoryBeanDefinitionParser");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/cxf/frontend/spring/NamespaceHandler", "registerBeanDefinitionParser", "(Ljava/lang/String;Lorg/springframework/beans/factory/xml/BeanDefinitionParser;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
