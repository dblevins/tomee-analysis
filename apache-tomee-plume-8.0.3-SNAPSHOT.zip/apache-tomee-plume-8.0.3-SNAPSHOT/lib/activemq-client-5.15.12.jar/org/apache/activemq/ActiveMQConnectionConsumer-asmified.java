...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/ActiveMQConnectionConsumer", null, "java/lang/Object", new String[] { "javax/jms/ConnectionConsumer", "org/apache/activemq/ActiveMQDispatcher" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "sessionPool", "Ljavax/jms/ServerSessionPool;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "<init>", "(Lorg/apache/activemq/ActiveMQConnection;Ljavax/jms/ServerSessionPool;Lorg/apache/activemq/command/ConsumerInfo;)V", null, new String[] { "javax/jms/JMSException" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/ActiveMQConnectionConsumer", "sessionPool", "Ljavax/jms/ServerSessionPool;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getServerSessionPool", "()Ljavax/jms/ServerSessionPool;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ActiveMQConnectionConsumer", "sessionPool", "Ljavax/jms/ServerSessionPool;");
...
methodVisitor.visitTryCatchBlock(label3, label4, label2, "javax/jms/JMSException");
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ActiveMQConnectionConsumer", "sessionPool", "Ljavax/jms/ServerSessionPool;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/ServerSessionPool", "getServerSession", "()Ljavax/jms/ServerSession;", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQTopicSession", "getNext", "()Ljavax/jms/TopicSession;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/activemq/ActiveMQSession");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQQueueSession", "getNext", "()Ljavax/jms/QueueSession;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/activemq/ActiveMQSession");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitJumpInsn(GOTO, label3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/activemq/ActiveMQConnectionConsumer", "org/apache/activemq/command/MessageDispatch"}, 1, new Object[] {"javax/jms/JMSException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ActiveMQConnectionConsumer", "connection", "Lorg/apache/activemq/ActiveMQConnection;");
methodVisitor.visitVarInsn(ALOAD, 2);
