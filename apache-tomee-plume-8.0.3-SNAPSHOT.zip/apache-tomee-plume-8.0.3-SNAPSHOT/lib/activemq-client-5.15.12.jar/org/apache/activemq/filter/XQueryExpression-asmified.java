...
public class XQueryExpressionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/activemq/filter/XQueryExpression", null, "java/lang/Object", new String[] { "org/apache/activemq/filter/BooleanExpression" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/filter/XQueryExpression", "xpath", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/filter/XQueryExpression", "xpath", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/filter/XQueryExpression", "evaluate", "(Lorg/apache/activemq/filter/MessageEvaluationContext;)Ljava/lang/Object;", false);
