...
public class UnaryExpression$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/activemq/filter/UnaryExpression$1", null, "org/apache/activemq/filter/UnaryExpression", null);

classWriter.visitOuterClass("org/apache/activemq/filter/UnaryExpression", "createNegate", "(Lorg/apache/activemq/filter/Expression;)Lorg/apache/activemq/filter/Expression;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/filter/UnaryExpression$1", "right", "Lorg/apache/activemq/filter/Expression;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/activemq/filter/UnaryExpression", "access$000", "(Ljava/lang/Number;)Ljava/lang/Number;", false);
methodVisitor.visitInsn(ARETURN);
