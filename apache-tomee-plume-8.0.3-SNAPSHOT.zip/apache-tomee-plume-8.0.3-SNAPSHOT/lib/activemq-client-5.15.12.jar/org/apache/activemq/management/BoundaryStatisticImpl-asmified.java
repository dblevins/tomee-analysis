...
public class BoundaryStatisticImplDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/management/BoundaryStatisticImpl", null, "org/apache/activemq/management/StatisticImpl", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/management/BoundaryStatisticImpl", "lowerBound", "J");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(LLOAD, 6);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/management/BoundaryStatisticImpl", "upperBound", "J");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/management/BoundaryStatisticImpl", "lowerBound", "J");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/management/BoundaryStatisticImpl", "upperBound", "J");
methodVisitor.visitInsn(LRETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
