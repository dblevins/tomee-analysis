...
public class StatsImplDump implements Opcodes {
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/management/StatsImpl", "<init>", "(Ljava/util/Set;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/util/Set;)V", "(Ljava/util/Set<Lorg/apache/activemq/management/StatisticImpl;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn("stats");
methodVisitor.visitLdcInsn("many");
methodVisitor.visitLdcInsn("Used only as container, not Statistic");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/management/StatsImpl", "set", "Ljava/util/Set;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/activemq/management/Resettable");
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label2);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/activemq/management/Resettable");
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/activemq/management/Resettable", "reset", "()V", true);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/activemq/management/StatisticImpl");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/management/StatisticImpl", "getName", "()Ljava/lang/String;", false);
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getStatisticNames", "()[Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "addStatistic", "(Ljava/lang/String;Lorg/apache/activemq/management/StatisticImpl;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/management/StatsImpl", "set", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 2);
