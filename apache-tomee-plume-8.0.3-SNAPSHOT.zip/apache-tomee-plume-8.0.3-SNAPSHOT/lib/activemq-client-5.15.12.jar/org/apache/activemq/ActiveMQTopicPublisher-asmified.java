...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/ActiveMQTopicPublisher", null, "org/apache/activemq/ActiveMQMessageProducer", new String[] { "javax/jms/TopicPublisher" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ActiveMQMessageProducer", "send", "(Ljavax/jms/Message;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ActiveMQMessageProducer", "send", "(Ljavax/jms/Message;IIJ)V", false);
methodVisitor.visitInsn(RETURN);
