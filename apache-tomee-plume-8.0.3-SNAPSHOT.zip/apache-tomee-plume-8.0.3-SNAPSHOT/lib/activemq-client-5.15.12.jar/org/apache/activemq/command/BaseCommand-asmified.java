...
public class BaseCommandDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/activemq/command/BaseCommand", null, "java/lang/Object", new String[] { "org/apache/activemq/command/Command" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "commandId", "I", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "responseRequired", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "copy", "(Lorg/apache/activemq/command/BaseCommand;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/command/BaseCommand", "commandId", "I");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/command/BaseCommand", "commandId", "I");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/command/BaseCommand", "responseRequired", "Z");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/command/BaseCommand", "responseRequired", "Z");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/command/BaseCommand", "toString", "(Ljava/util/Map;)Ljava/lang/String;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/activemq/command/BaseCommand;"));
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/command/BaseCommand", "from", "Lorg/apache/activemq/command/Endpoint;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/command/BaseCommand", "from", "Lorg/apache/activemq/command/Endpoint;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/command/BaseCommand", "to", "Lorg/apache/activemq/command/Endpoint;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/command/BaseCommand", "to", "Lorg/apache/activemq/command/Endpoint;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
