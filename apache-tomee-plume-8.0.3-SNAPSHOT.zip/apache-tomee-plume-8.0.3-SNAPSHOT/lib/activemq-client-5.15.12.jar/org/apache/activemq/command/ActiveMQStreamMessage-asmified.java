...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/command/ActiveMQStreamMessage", null, "org/apache/activemq/command/ActiveMQMessage", new String[] { "jakarta/jms/StreamMessage" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "initializeReading", "()V", null, new String[] { "jakarta/jms/MessageNotReadableException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
