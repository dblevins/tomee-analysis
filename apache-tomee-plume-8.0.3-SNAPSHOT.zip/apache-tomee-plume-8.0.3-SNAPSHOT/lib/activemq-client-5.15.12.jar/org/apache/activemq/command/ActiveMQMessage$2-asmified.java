...
public class ActiveMQMessage$2Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/activemq/command/ActiveMQMessage$2", null, "java/lang/Object", new String[] { "org/apache/activemq/command/ActiveMQMessage$PropertySetter" });
...
methodVisitor.visitLdcInsn("Property JMSXGroupID cannot be set from a ");
