...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/activemq/command/ActiveMQDestination", "Lorg/apache/activemq/jndi/JNDIBaseStorable;Lorg/apache/activemq/command/DataStructure;Ljavax/jms/Destination;Ljava/io/Externalizable;Ljava/lang/Comparable<Ljava/lang/Object;>;", "org/apache/activemq/jndi/JNDIBaseStorable", new String[] { "org/apache/activemq/command/DataStructure", "javax/jms/Destination", "java/io/Externalizable", "java/lang/Comparable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "transform", "(Ljavax/jms/Destination;)Lorg/apache/activemq/command/ActiveMQDestination;", null, new String[] { "javax/jms/JMSException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/activemq/command/UnresolvedDestinationTransformer", "transform", "(Ljavax/jms/Destination;)Lorg/apache/activemq/command/ActiveMQDestination;", true);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_CHOP,2, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/jms/TemporaryQueue");
Label label5 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/TemporaryQueue", "getQueueName", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/command/ActiveMQTempQueue", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label5);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/jms/TemporaryTopic");
Label label6 = new Label();
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/TemporaryTopic", "getTopicName", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/command/ActiveMQTempTopic", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
