...
public class ActiveMQMessage$6Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/activemq/command/ActiveMQMessage$6", null, "java/lang/Object", new String[] { "org/apache/activemq/command/ActiveMQMessage$PropertySetter" });
...
methodVisitor.visitLdcInsn("Property JMSExpiration cannot be set from a ");
