...
public class ActiveMQMessage$3Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/activemq/command/ActiveMQMessage$3", null, "java/lang/Object", new String[] { "org/apache/activemq/command/ActiveMQMessage$PropertySetter" });
...
methodVisitor.visitLdcInsn("Property JMSXGroupSeq cannot be set from a ");
