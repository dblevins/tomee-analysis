...
public class ConnectionIdDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/command/ConnectionId", "Ljava/lang/Object;Lorg/apache/activemq/command/DataStructure;Ljava/lang/Comparable<Lorg/apache/activemq/command/ConnectionId;>;", "java/lang/Object", new String[] { "org/apache/activemq/command/DataStructure", "java/lang/Comparable" });

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "DATA_STRUCTURE_TYPE", "B", null, new Integer(120));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/command/ConnectionId", "value", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/command/ConnectionId", "value", "Ljava/lang/String;");
...
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/activemq/command/ConnectionId;"));
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "compareTo", "(Lorg/apache/activemq/command/ConnectionId;)I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/command/ConnectionId", "value", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 1);
