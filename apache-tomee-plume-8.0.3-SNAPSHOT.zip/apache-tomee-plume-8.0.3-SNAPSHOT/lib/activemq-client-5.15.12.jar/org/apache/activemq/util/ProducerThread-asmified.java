...
{
fieldVisitor = classWriter.visitField(0, "destination", "Ljavax/jms/Destination;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "session", "Ljavax/jms/Session;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/jms/Session;Ljavax/jms/Destination;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/util/ProducerThread", "destination", "Ljavax/jms/Destination;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/util/ProducerThread", "session", "Ljavax/jms/Session;");
...
methodVisitor.visitTryCatchBlock(label8, label9, label10, "javax/jms/JMSException");
...
methodVisitor.visitTryCatchBlock(label14, label15, label16, "javax/jms/JMSException");
...
methodVisitor.visitTryCatchBlock(label19, label20, label21, "javax/jms/JMSException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/util/ProducerThread", "session", "Ljavax/jms/Session;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/util/ProducerThread", "destination", "Ljavax/jms/Destination;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String"}, 1, new Object[] {"javax/jms/MessageProducer"});
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLabel(label24);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String"}, 2, new Object[] {"javax/jms/MessageProducer", Opcodes.INTEGER});
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String", Opcodes.LONG, "java/lang/Object"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/util/ProducerThread", "sendMessage", "(Ljavax/jms/MessageProducer;Ljava/lang/String;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/MessageProducer", "close", "()V", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/jms/JMSException", "printStackTrace", "()V", false);
methodVisitor.visitJumpInsn(GOTO, label32);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 10, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String", Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, Opcodes.TOP, "java/lang/Throwable"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(6, 11);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "sendMessage", "(Ljavax/jms/MessageProducer;Ljava/lang/String;)V", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/util/ProducerThread", "sentCount", "Ljava/util/concurrent/atomic/AtomicInteger;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/concurrent/atomic/AtomicInteger", "get", "()I", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/util/ProducerThread", "createMessage", "(I)Ljavax/jms/Message;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(INSTANCEOF, "javax/jms/TextMessage");
Label label1 = new Label();
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String", "javax/jms/Message"}, 2, new Object[] {"org/slf4j/Logger", "java/lang/StringBuilder"});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/jms/Message", "getJMSMessageID", "()Ljava/lang/String;", true);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/util/ProducerThread", "javax/jms/MessageProducer", "java/lang/String", "javax/jms/Message"}, 3, new Object[] {"org/slf4j/Logger", "java/lang/StringBuilder", "java/lang/String"});
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "createMessage", "(I)Ljavax/jms/Message;", null, new String[] { "java/lang/Exception" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/util/ProducerThread", "payload", "[B");
Label label0 = new Label();
