...
public class ActiveMQXASslConnectionFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/ActiveMQXASslConnectionFactory", null, "org/apache/activemq/ActiveMQSslConnectionFactory", new String[] { "jakarta/jms/XAConnectionFactory", "jakarta/jms/XAQueueConnectionFactory", "jakarta/jms/XATopicConnectionFactory" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ActiveMQSslConnectionFactory", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ActiveMQSslConnectionFactory", "<init>", "(Ljava/net/URI;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQXASslConnectionFactory", "createActiveMQConnection", "()Lorg/apache/activemq/ActiveMQConnection;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQXASslConnectionFactory", "createActiveMQConnection", "(Ljava/lang/String;Ljava/lang/String;)Lorg/apache/activemq/ActiveMQConnection;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/jms/XAConnection");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQXASslConnectionFactory", "getClientIdGenerator", "()Lorg/apache/activemq/util/IdGenerator;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/ActiveMQXASslConnectionFactory", "getConnectionIdGenerator", "()Lorg/apache/activemq/util/IdGenerator;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ActiveMQXASslConnectionFactory", "configureXAConnection", "(Lorg/apache/activemq/ActiveMQXAConnection;)V", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/ActiveMQXASslConnectionFactory", "xaAckMode", "I");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/ActiveMQXASslConnectionFactory", "xaAckMode", "I");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/ActiveMQSslConnectionFactory", "populateProperties", "(Ljava/util/Properties;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
