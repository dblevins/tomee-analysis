...
public class FanoutTransport$RequestCounterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/activemq/transport/fanout/FanoutTransport$RequestCounter", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "command", "Lorg/apache/activemq/command/Command;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_FINAL, "ackCount", "Ljava/util/concurrent/atomic/AtomicInteger;", null, null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Lorg/apache/activemq/command/Command;I)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/transport/fanout/FanoutTransport$RequestCounter", "command", "Lorg/apache/activemq/command/Command;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/transport/fanout/FanoutTransport$RequestCounter", "ackCount", "Ljava/util/concurrent/atomic/AtomicInteger;");
