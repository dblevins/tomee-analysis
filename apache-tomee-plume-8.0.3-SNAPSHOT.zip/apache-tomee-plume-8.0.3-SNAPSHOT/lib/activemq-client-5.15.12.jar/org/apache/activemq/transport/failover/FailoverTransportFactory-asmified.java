...
public class FailoverTransportFactoryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/transport/failover/FailoverTransportFactory", null, "org/apache/activemq/transport/TransportFactory", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/transport/failover/FailoverTransportFactory", "createTransport", "(Lorg/apache/activemq/util/URISupport$CompositeData;)Lorg/apache/activemq/transport/Transport;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/transport/failover/FailoverTransportFactory", "createTransport", "(Ljava/util/Map;)Lorg/apache/activemq/transport/failover/FailoverTransport;", false);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"java/util/Map", "org/apache/activemq/transport/failover/FailoverTransport"}, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createTransport", "(Ljava/util/Map;)Lorg/apache/activemq/transport/failover/FailoverTransport;", "(Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;)Lorg/apache/activemq/transport/failover/FailoverTransport;", new String[] { "java/io/IOException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "java/net/URISyntaxException");
methodVisitor.visitTypeInsn(NEW, "org/apache/activemq/transport/failover/FailoverTransport");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/activemq/transport/failover/FailoverTransport", "<init>", "()V", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/transport/failover/FailoverTransport", "setNestedExtraQueryOptions", "(Ljava/lang/String;)V", false);
methodVisitor.visitLabel(label1);
Label label3 = new Label();
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/transport/failover/FailoverTransportFactory", "java/util/Map", "org/apache/activemq/transport/failover/FailoverTransport", "java/util/Map"}, 1, new Object[] {"java/net/URISyntaxException"});
