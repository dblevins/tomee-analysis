...
public class DefaultBlobDownloadStrategyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/activemq/blob/DefaultBlobDownloadStrategy", null, "org/apache/activemq/blob/DefaultStrategy", new String[] { "org/apache/activemq/blob/BlobDownloadStrategy" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/blob/DefaultBlobDownloadStrategy", "createMessageURL", "(Lorg/apache/activemq/command/ActiveMQBlobMessage;)Ljava/net/URL;", false);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/activemq/blob/DefaultBlobDownloadStrategy", "org/apache/activemq/command/ActiveMQBlobMessage", "java/net/URL", "java/net/HttpURLConnection"}, 1, new Object[] {"java/io/IOException"});
...
methodVisitor.visitLdcInsn("DELETE failed on: ");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/activemq/blob/DefaultBlobDownloadStrategy", "isSuccessfulCode", "(I)Z", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("DELETE was not successful: ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/net/HttpURLConnection", "getResponseCode", "()I", false);
