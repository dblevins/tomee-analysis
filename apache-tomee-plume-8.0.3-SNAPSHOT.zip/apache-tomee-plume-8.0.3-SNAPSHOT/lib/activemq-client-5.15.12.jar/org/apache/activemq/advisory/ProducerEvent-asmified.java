...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/activemq/advisory/ProducerEventSource;Ljakarta/jms/Destination;Lorg/apache/activemq/command/ProducerId;I)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/activemq/advisory/ProducerEvent", "destination", "Ljakarta/jms/Destination;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/activemq/advisory/ProducerEvent", "destination", "Ljakarta/jms/Destination;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
