...
public class UnmodifiableNavigableSetDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/set/UnmodifiableNavigableSet", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/set/AbstractNavigableSetDecorator<TE;>;Lorg/apache/commons/collections4/Unmodifiable;", "org/apache/commons/collections4/set/AbstractNavigableSetDecorator", new String[] { "org/apache/commons/collections4/Unmodifiable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "unmodifiableNavigableSet", "(Ljava/util/NavigableSet;)Ljava/util/NavigableSet;", "<E:Ljava/lang/Object;>(Ljava/util/NavigableSet<TE;>;)Ljava/util/NavigableSet<TE;>;", null);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/set/UnmodifiableNavigableSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/set/UnmodifiableNavigableSet", "<init>", "(Ljava/util/NavigableSet;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljava/util/NavigableSet;)V", "(Ljava/util/NavigableSet<TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/set/AbstractNavigableSetDecorator", "<init>", "(Ljava/util/NavigableSet;)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableNavigableSet", "decorated", "()Ljava/util/NavigableSet;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/NavigableSet", "iterator", "()Ljava/util/Iterator;", true);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/NavigableSet", "subSet", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/SortedSet;", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableNavigableSet", "decorated", "()Ljava/util/NavigableSet;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/NavigableSet", "headSet", "(Ljava/lang/Object;)Ljava/util/SortedSet;", true);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableNavigableSet", "decorated", "()Ljava/util/NavigableSet;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/NavigableSet", "tailSet", "(Ljava/lang/Object;)Ljava/util/SortedSet;", true);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/collections4/set/UnmodifiableSortedSet", "unmodifiableSortedSet", "(Ljava/util/SortedSet;)Ljava/util/SortedSet;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableNavigableSet", "setCollection", "(Ljava/util/Collection;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
