...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/functors/OnePredicate", "<T:Ljava/lang/Object;>Lorg/apache/commons/collections4/functors/AbstractQuantifierPredicate<TT;>;", "org/apache/commons/collections4/functors/AbstractQuantifierPredicate", null);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/functors/OnePredicate");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/functors/OnePredicate", "<init>", "([Lorg/apache/commons/collections4/Predicate;)V", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/functors/OnePredicate", "iPredicates", "[Lorg/apache/commons/collections4/Predicate;");
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"org/apache/commons/collections4/functors/OnePredicate", "java/lang/Object", Opcodes.INTEGER, "[Lorg/apache/commons/collections4/Predicate;", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
