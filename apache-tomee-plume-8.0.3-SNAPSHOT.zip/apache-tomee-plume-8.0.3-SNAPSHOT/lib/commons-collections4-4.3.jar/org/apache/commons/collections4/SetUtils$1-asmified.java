...
public class SetUtils$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/SetUtils$1", "Ljava/lang/Object;Lorg/apache/commons/collections4/Predicate<TE;>;", "java/lang/Object", new String[] { "org/apache/commons/collections4/Predicate" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/collections4/SetUtils$1", "val$b", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/collections4/SetUtils$1", "val$b", "Ljava/util/Set;");
methodVisitor.visitVarInsn(ALOAD, 1);
