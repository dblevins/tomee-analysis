...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/commons/collections4/set/UnmodifiableSet", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/set/AbstractSerializableSetDecorator<TE;>;Lorg/apache/commons/collections4/Unmodifiable;", "org/apache/commons/collections4/set/AbstractSerializableSetDecorator", new String[] { "org/apache/commons/collections4/Unmodifiable" });
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/set/UnmodifiableSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/set/UnmodifiableSet", "<init>", "(Ljava/util/Set;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Ljava/util/Set;)V", "(Ljava/util/Set<+TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/UnmodifiableSet", "decorated", "()Ljava/util/Set;", false);
