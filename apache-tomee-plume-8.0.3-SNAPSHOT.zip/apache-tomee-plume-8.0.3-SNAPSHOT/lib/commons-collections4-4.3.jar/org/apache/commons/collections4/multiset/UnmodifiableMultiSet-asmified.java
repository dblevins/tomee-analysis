...
public class UnmodifiableMultiSetDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(20150611L));
...
methodVisitor.visitTypeInsn(NEW, "org/apache/commons/collections4/multiset/UnmodifiableMultiSet");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/multiset/UnmodifiableMultiSet", "<init>", "(Lorg/apache/commons/collections4/MultiSet;)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 2);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "<init>", "(Lorg/apache/commons/collections4/MultiSet;)V", "(Lorg/apache/commons/collections4/MultiSet<+TE;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/collections4/multiset/AbstractMultiSetDecorator", "<init>", "(Lorg/apache/commons/collections4/MultiSet;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/multiset/UnmodifiableMultiSet", "decorated", "()Lorg/apache/commons/collections4/MultiSet;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/multiset/UnmodifiableMultiSet", "setCollection", "(Ljava/util/Collection;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/multiset/UnmodifiableMultiSet", "decorated", "()Lorg/apache/commons/collections4/MultiSet;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/commons/collections4/MultiSet", "iterator", "()Ljava/util/Iterator;", true);
