...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections4/set/AbstractSetDecorator", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/collection/AbstractCollectionDecorator<TE;>;Ljava/util/Set<TE;>;", "org/apache/commons/collections4/collection/AbstractCollectionDecorator", new String[] { "java/util/Set" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-4678668309576958546L));
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/set/AbstractSetDecorator", "decorated", "()Ljava/util/Set;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
