...
public class AbstractQueueDecoratorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/commons/collections4/queue/AbstractQueueDecorator", "<E:Ljava/lang/Object;>Lorg/apache/commons/collections4/collection/AbstractCollectionDecorator<TE;>;Ljava/util/Queue<TE;>;", "org/apache/commons/collections4/collection/AbstractCollectionDecorator", new String[] { "java/util/Queue" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-2629815475789577029L));
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/collections4/queue/AbstractQueueDecorator", "decorated", "()Ljava/util/Queue;", false);
methodVisitor.visitVarInsn(ALOAD, 1);
