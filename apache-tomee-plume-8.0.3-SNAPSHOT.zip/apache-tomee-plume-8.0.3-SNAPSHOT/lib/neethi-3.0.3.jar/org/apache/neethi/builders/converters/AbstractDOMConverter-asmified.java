...
public class AbstractDOMConverterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/neethi/builders/converters/AbstractDOMConverter", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getQName", "(Lorg/w3c/dom/Element;)Ljavax/xml/namespace/QName;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getAttributes", "(Lorg/w3c/dom/Element;)Ljava/util/Map;", "(Lorg/w3c/dom/Element;)Ljava/util/Map<Ljavax/xml/namespace/QName;Ljava/lang/String;>;", null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getChildren", "(Lorg/w3c/dom/Element;)Ljava/util/Iterator;", "(Lorg/w3c/dom/Element;)Ljava/util/Iterator<Lorg/w3c/dom/Element;>;", null);
methodVisitor.visitCode();
