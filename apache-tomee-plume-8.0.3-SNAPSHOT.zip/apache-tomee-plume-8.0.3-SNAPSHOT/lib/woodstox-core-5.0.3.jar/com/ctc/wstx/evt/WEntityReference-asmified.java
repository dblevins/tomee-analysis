...
public class WEntityReferenceDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "com/ctc/wstx/evt/WEntityReference", null, "org/codehaus/stax2/ri/evt/EntityReferenceEventImpl", new String[] { "javax/xml/stream/events/EntityReference" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/ctc/wstx/evt/WEntityReference", "mName", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/ctc/wstx/evt/WEntityReference", "mName", "Ljava/lang/String;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/codehaus/stax2/ri/evt/EntityReferenceEventImpl", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
