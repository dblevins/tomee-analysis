...
public class WEntityDeclarationDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "com/ctc/wstx/evt/WEntityDeclaration", null, "org/codehaus/stax2/ri/evt/BaseEventImpl", new String[] { "javax/xml/stream/events/EntityDeclaration" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "writeEnc", "(Ljava/io/Writer;)V", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Can not write entity declarations using an XMLStreamWriter");
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "getName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/xml/stream/events/EntityDeclaration", "getName", "()Ljava/lang/String;", true);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/ctc/wstx/evt/WEntityDeclaration", "stringsWithNullsEqual", "(Ljava/lang/String;Ljava/lang/String;)Z", false);
Label label3 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "getBaseURI", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "getNotationName", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "getPublicId", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "getReplacementText", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitJumpInsn(IFEQ, label3);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/ctc/wstx/evt/WEntityDeclaration", "getSystemId", "()Ljava/lang/String;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/xml/stream/events/EntityDeclaration"}, 0, null);
methodVisitor.visitInsn(ICONST_0);
