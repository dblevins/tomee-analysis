...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "conversationStorageBean", "Ljavax/enterprise/inject/spi/Bean;", "Ljavax/enterprise/inject/spi/Bean<Ljava/util/Set<Lorg/apache/webbeans/context/ConversationContext;>;>;", null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/conversation/ConversationManager", "conversationStorageBean", "Ljavax/enterprise/inject/spi/Bean;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConversationContext", "(Ljavax/enterprise/context/spi/Context;)Lorg/apache/webbeans/context/ConversationContext;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/webbeans/conversation/ConversationManager", "javax/enterprise/context/spi/Context", "org/apache/webbeans/spi/ConversationService", "java/util/Set", "java/lang/RuntimeException", "java/lang/String", "java/util/Iterator"}, 0, new Object[] {});
...
Label label0 = new Label();
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/enterprise/context/spi/Context", "java/util/Set", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 5);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConversationBeanReference", "()Ljavax/enterprise/context/Conversation;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/conversation/ConversationManager", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/config/WebBeansContext", "getBeanManagerImpl", "()Lorg/apache/webbeans/container/BeanManagerImpl;", false);
...
methodVisitor.visitTypeInsn(CHECKCAST, "javax/enterprise/context/Conversation");
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitInsn(ARETURN);
...
Label label1 = new Label();
Label label2 = new Label();
methodVisitor.visitTryCatchBlock(label0, label1, label2, "javax/enterprise/context/BusyConversationException");
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/conversation/ConversationManager", "org/apache/webbeans/conversation/ConversationImpl", Opcodes.LONG}, 1, new Object[] {"javax/enterprise/context/BusyConversationException"});
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getSessionConversations", "(Ljavax/enterprise/context/spi/Context;Z)Ljava/util/Set;", "(Ljavax/enterprise/context/spi/Context;Z)Ljava/util/Set<Lorg/apache/webbeans/context/ConversationContext;>;", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/conversation/ConversationManager", "conversationStorageBean", "Ljavax/enterprise/inject/spi/Bean;");
