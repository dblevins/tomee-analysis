...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/portable/InjectionPointProducer", "Lorg/apache/webbeans/portable/AbstractProducer<Ljakarta/enterprise/inject/spi/InjectionPoint;>;", "org/apache/webbeans/portable/AbstractProducer", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljakarta/enterprise/inject/spi/InjectionPoint;", "(Ljava/util/Map<Ljakarta/enterprise/inject/spi/Interceptor<*>;*>;Lorg/apache/webbeans/context/creational/CreationalContextImpl<Ljakarta/enterprise/inject/spi/InjectionPoint;>;)Ljakarta/enterprise/inject/spi/InjectionPoint;", null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/portable/InjectionPointProducer", "java/util/Map", "org/apache/webbeans/context/creational/CreationalContextImpl", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/InjectionPoint", "java/lang/reflect/Type", "java/lang/reflect/ParameterizedType", "jakarta/enterprise/inject/spi/Bean"}, 3, new Object[] {label10, label10, "jakarta/enterprise/inject/spi/InjectionPoint"});
methodVisitor.visitVarInsn(ALOAD, 6);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/portable/InjectionPointProducer", "java/util/Map", "org/apache/webbeans/context/creational/CreationalContextImpl", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/InjectionPoint", "java/lang/reflect/Type", "java/lang/reflect/ParameterizedType", "jakarta/enterprise/inject/spi/Bean"}, 4, new Object[] {label10, label10, "jakarta/enterprise/inject/spi/InjectionPoint", "java/lang/reflect/Type"});
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/portable/InjectionPointProducer$InjectionPointDelegate", "<init>", "(Ljakarta/enterprise/inject/spi/InjectionPoint;Ljava/lang/reflect/Type;)V", false);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/portable/InjectionPointProducer", "java/util/Map", "org/apache/webbeans/context/creational/CreationalContextImpl", "jakarta/enterprise/inject/spi/InjectionPoint", "jakarta/enterprise/inject/spi/InjectionPoint"}, 1, new Object[] {"java/lang/Throwable"});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "dispose", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/InjectionPointProducer", "produce", "(Ljava/util/Map;Lorg/apache/webbeans/context/creational/CreationalContextImpl;)Ljakarta/enterprise/inject/spi/InjectionPoint;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/InjectionPointProducer", "dispose", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)V", false);
methodVisitor.visitInsn(RETURN);
