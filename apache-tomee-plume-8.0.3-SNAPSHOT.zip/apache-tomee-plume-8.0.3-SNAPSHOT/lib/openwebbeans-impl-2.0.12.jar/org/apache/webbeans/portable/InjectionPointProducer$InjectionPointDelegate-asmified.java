...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/webbeans/portable/InjectionPointProducer$InjectionPointDelegate", null, "java/lang/Object", new String[] { "jakarta/enterprise/inject/spi/InjectionPoint", "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "ip", "Ljakarta/enterprise/inject/spi/InjectionPoint;", null, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/enterprise/inject/spi/InjectionPoint;Ljava/lang/reflect/Type;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/portable/InjectionPointProducer$InjectionPointDelegate", "ip", "Ljakarta/enterprise/inject/spi/InjectionPoint;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/portable/InjectionPointProducer$InjectionPointDelegate", "ip", "Ljakarta/enterprise/inject/spi/InjectionPoint;");
