...
public class RequestScopedBeanInterceptorHandlerDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/intercept/RequestScopedBeanInterceptorHandler", null, "org/apache/webbeans/intercept/NormalScopedBeanInterceptorHandler", null);
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/webbeans/intercept/RequestScopedBeanInterceptorHandler", "cachedInstances", "Ljava/lang/ThreadLocal;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/intercept/RequestScopedBeanInterceptorHandler", "bean", "Ljakarta/enterprise/inject/spi/Bean;");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/webbeans/intercept/RequestScopedBeanInterceptorHandler", "cachedInstances", "Ljava/lang/ThreadLocal;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 0);
methodVisitor.visitEnd();
}
