...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "type", "Ljakarta/enterprise/inject/spi/InterceptionType;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "interceptors", "Ljava/util/List;", "Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "instances", "Ljava/util/Map;", "Ljava/util/Map<Ljakarta/enterprise/inject/spi/Interceptor<*>;*>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/inject/Provider;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/util/List;Ljava/util/Map;Ljava/lang/reflect/AccessibleObject;[Ljava/lang/Object;)V", "(Ljakarta/inject/Provider<TT;>;Ljakarta/enterprise/inject/spi/InterceptionType;Ljava/util/List<Ljakarta/enterprise/inject/spi/Interceptor<*>;>;Ljava/util/Map<Ljakarta/enterprise/inject/spi/Interceptor<*>;*>;Ljava/lang/reflect/AccessibleObject;[Ljava/lang/Object;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/intercept/InterceptorInvocationContext", "type", "Ljakarta/enterprise/inject/spi/InterceptionType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/intercept/InterceptorInvocationContext", "type", "Ljakarta/enterprise/inject/spi/InterceptionType;");
