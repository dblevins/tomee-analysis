...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/container/AnnotatedTypeWrapper", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljakarta/enterprise/inject/spi/AnnotatedType<TT;>;", "java/lang/Object", new String[] { "jakarta/enterprise/inject/spi/AnnotatedType" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "original", "Ljakarta/enterprise/inject/spi/AnnotatedType;", "Ljakarta/enterprise/inject/spi/AnnotatedType<TT;>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/enterprise/inject/spi/Extension;Ljakarta/enterprise/inject/spi/AnnotatedType;Ljava/lang/String;)V", "(Ljakarta/enterprise/inject/spi/Extension;Ljakarta/enterprise/inject/spi/AnnotatedType<TT;>;Ljava/lang/String;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "source", "Ljakarta/enterprise/inject/spi/Extension;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "original", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "original", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getConstructors", "()Ljava/util/Set;", "()Ljava/util/Set<Ljakarta/enterprise/inject/spi/AnnotatedConstructor<TT;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "original", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getMethods", "()Ljava/util/Set;", "()Ljava/util/Set<Ljakarta/enterprise/inject/spi/AnnotatedMethod<-TT;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "original", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getFields", "()Ljava/util/Set;", "()Ljava/util/Set<Ljakarta/enterprise/inject/spi/AnnotatedField<-TT;>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "original", "Ljakarta/enterprise/inject/spi/AnnotatedType;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/container/AnnotatedTypeWrapper", "source", "Ljakarta/enterprise/inject/spi/Extension;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
