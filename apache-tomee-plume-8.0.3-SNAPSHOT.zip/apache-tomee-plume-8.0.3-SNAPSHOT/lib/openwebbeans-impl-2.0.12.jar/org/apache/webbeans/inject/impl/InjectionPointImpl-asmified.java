...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/inject/impl/InjectionPointImpl", null, "java/lang/Object", new String[] { "jakarta/enterprise/inject/spi/InjectionPoint", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljakarta/enterprise/inject/spi/Bean;Ljava/util/Collection;Ljakarta/enterprise/inject/spi/AnnotatedField;)V", "(Ljakarta/enterprise/inject/spi/Bean<*>;Ljava/util/Collection<Ljava/lang/annotation/Annotation;>;Ljakarta/enterprise/inject/spi/AnnotatedField<*>;)V", null);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {Opcodes.UNINITIALIZED_THIS, "jakarta/enterprise/inject/spi/Bean", "java/util/Collection", "jakarta/enterprise/inject/spi/AnnotatedField"}, 7, new Object[] {Opcodes.UNINITIALIZED_THIS, "jakarta/enterprise/inject/spi/Bean", "java/lang/reflect/Type", "java/util/Collection", "jakarta/enterprise/inject/spi/AnnotatedField", "java/lang/reflect/Field", Opcodes.INTEGER});
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/enterprise/inject/spi/AnnotatedField", "getJavaMember", "()Ljava/lang/reflect/Field;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {Opcodes.UNINITIALIZED_THIS, "jakarta/enterprise/inject/spi/Bean", "java/util/Collection", "jakarta/enterprise/inject/spi/AnnotatedField"}, 8, new Object[] {Opcodes.UNINITIALIZED_THIS, "jakarta/enterprise/inject/spi/Bean", "java/lang/reflect/Type", "java/util/Collection", "jakarta/enterprise/inject/spi/AnnotatedField", "java/lang/reflect/Field", Opcodes.INTEGER, Opcodes.INTEGER});
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljakarta/enterprise/inject/spi/Bean;Ljava/util/Collection;Ljakarta/enterprise/inject/spi/AnnotatedParameter;)V", "(Ljakarta/enterprise/inject/spi/Bean<*>;Ljava/util/Collection<Ljava/lang/annotation/Annotation;>;Ljakarta/enterprise/inject/spi/AnnotatedParameter<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljakarta/enterprise/inject/spi/Bean;)V", "(Ljakarta/enterprise/inject/spi/Bean<*>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "ownerBean", "Ljakarta/enterprise/inject/spi/Bean;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/webbeans/inject/impl/InjectionPointImpl", "jakarta/enterprise/inject/spi/Bean"}, 1, new Object[] {"org/apache/webbeans/inject/impl/InjectionPointImpl"});
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/webbeans/inject/impl/InjectionPointImpl", "jakarta/enterprise/inject/spi/Bean"}, 2, new Object[] {"org/apache/webbeans/inject/impl/InjectionPointImpl", "java/util/Set"});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "annotated", "Ljakarta/enterprise/inject/spi/Annotated;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljakarta/enterprise/inject/spi/Bean;Ljava/lang/reflect/Type;Ljava/util/Collection;Ljakarta/enterprise/inject/spi/Annotated;Ljava/lang/reflect/Member;ZZ)V", "(Ljakarta/enterprise/inject/spi/Bean<*>;Ljava/lang/reflect/Type;Ljava/util/Collection<Ljava/lang/annotation/Annotation;>;Ljakarta/enterprise/inject/spi/Annotated;Ljava/lang/reflect/Member;ZZ)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/inject/impl/InjectionPointImpl", "jakarta/enterprise/inject/spi/Bean", "java/lang/reflect/Type", "java/util/Collection", "jakarta/enterprise/inject/spi/Annotated", "java/lang/reflect/Member", Opcodes.INTEGER, Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "transientt", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/util/WebBeansUtil", "checkObtainsInjectionPointConditions", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", false);
Label label2 = new Label();
methodVisitor.visitJumpInsn(IFNE, label2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/webbeans/event/EventUtil", "checkObservableInjectionPointConditions", "(Ljakarta/enterprise/inject/spi/InjectionPoint;)Z", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "ownerBean", "Ljakarta/enterprise/inject/spi/Bean;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "annotated", "Ljakarta/enterprise/inject/spi/Annotated;");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/enterprise/inject/spi/Annotated");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "annotated", "Ljakarta/enterprise/inject/spi/Annotated;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/impl/InjectionPointImpl", "annotated", "Ljakarta/enterprise/inject/spi/Annotated;");
...
methodVisitor.visitTypeInsn(CHECKCAST, "java/lang/reflect/Constructor");
methodVisitor.visitVarInsn(ALOAD, 11);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/portable/AnnotatedElementFactory", "newAnnotatedConstructor", "(Ljava/lang/reflect/Constructor;Ljakarta/enterprise/inject/spi/AnnotatedType;)Ljakarta/enterprise/inject/spi/AnnotatedConstructor;", false);
methodVisitor.visitVarInsn(ASTORE, 12);
methodVisitor.visitVarInsn(ALOAD, 12);
