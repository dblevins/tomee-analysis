...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/inject/instance/InstanceImpl", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljavax/enterprise/inject/Instance<TT;>;Ljava/io/Serializable;", "java/lang/Object", new String[] { "javax/enterprise/inject/Instance", "java/io/Serializable" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "<init>", "(Ljava/lang/reflect/Type;Ljavax/enterprise/inject/spi/InjectionPoint;Lorg/apache/webbeans/config/WebBeansContext;[Ljava/lang/annotation/Annotation;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "injectionPoint", "Ljavax/enterprise/inject/spi/InjectionPoint;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/webbeans/inject/instance/InstanceImpl", "java/lang/reflect/Type", "javax/enterprise/inject/spi/InjectionPoint", "org/apache/webbeans/config/WebBeansContext", "[Ljava/lang/annotation/Annotation;"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "injectionPoint", "Ljavax/enterprise/inject/spi/InjectionPoint;");
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/inject/instance/InstanceImpl", "create", "(Ljavax/enterprise/inject/spi/Bean;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(3, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "resolveBeans", "()Ljava/util/Set;", "()Ljava/util/Set<Ljavax/enterprise/inject/spi/Bean<*>;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "qualifierAnnotations", "Ljava/util/Set;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Set", "size", "()I", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "select", "([Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance;", "([Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "strictValidation", "Z");
Label label0 = new Label();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "injectionPoint", "Ljavax/enterprise/inject/spi/InjectionPoint;");
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/inject/instance/InstanceImpl$InstanceInjectionPoint", "<init>", "(Ljavax/enterprise/inject/spi/InjectionPoint;[Ljava/lang/annotation/Annotation;)V", false);
methodVisitor.visitLabel(label3);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/webbeans/inject/instance/InstanceImpl", "[Ljava/lang/annotation/Annotation;", "[Ljava/lang/annotation/Annotation;"}, 4, new Object[] {label1, label1, "java/lang/reflect/Type", "javax/enterprise/inject/spi/InjectionPoint"});
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "webBeansContext", "Lorg/apache/webbeans/config/WebBeansContext;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "select", "(Ljava/lang/Class;[Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance;", "<U:TT;>(Ljava/lang/Class<TU;>;[Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance<TU;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/inject/instance/InstanceImpl", "strictValidation", "Z");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_VARARGS, "select", "(Ljavax/enterprise/util/TypeLiteral;[Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance;", "<U:TT;>(Ljavax/enterprise/util/TypeLiteral<TU;>;[Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance<TU;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "javax/enterprise/util/TypeLiteral", "getRawType", "()Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/inject/instance/InstanceImpl", "select", "(Ljava/lang/Class;[Ljava/lang/annotation/Annotation;)Ljavax/enterprise/inject/Instance;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/proxy/NormalScopeProxyFactory", "getInstanceProvider", "(Lorg/apache/webbeans/proxy/OwbNormalScopeProxy;)Ljavax/inject/Provider;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/webbeans/intercept/NormalScopedBeanInterceptorHandler");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/intercept/NormalScopedBeanInterceptorHandler", "getBean", "()Ljavax/enterprise/inject/spi/Bean;", false);
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitVarInsn(ALOAD, 5);
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 8, new Object[] {"org/apache/webbeans/inject/instance/InstanceImpl", "java/lang/Object", "org/apache/webbeans/proxy/OwbNormalScopeProxy", "javax/inject/Provider", "org/apache/webbeans/intercept/NormalScopedBeanInterceptorHandler", "javax/enterprise/inject/spi/Bean", "java/lang/Class", "javax/enterprise/context/spi/Context"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "create", "(Ljavax/enterprise/inject/spi/Bean;)Ljava/lang/Object;", "(Ljavax/enterprise/inject/spi/Bean<*>;)TT;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/webbeans/inject/instance/InstanceImpl", "javax/enterprise/inject/spi/Bean", "org/apache/webbeans/container/BeanManagerImpl", "org/apache/webbeans/context/creational/CreationalContextImpl"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 6);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/context/creational/CreationalContextImpl", "removeInjectionPoint", "()Ljavax/enterprise/inject/spi/InjectionPoint;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/webbeans/inject/instance/InstanceImpl;Ljavax/enterprise/inject/spi/Bean;)Ljava/lang/Object;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/inject/instance/InstanceImpl", "create", "(Ljavax/enterprise/inject/spi/Bean;)Ljava/lang/Object;", false);
