...
methodVisitor.visitTypeInsn(CHECKCAST, "jakarta/inject/Provider");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInstanceProvider", "(Lorg/apache/webbeans/proxy/OwbNormalScopeProxy;)Ljakarta/inject/Provider;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createNormalScopeProxy", "(Ljakarta/enterprise/inject/spi/Bean;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljakarta/enterprise/inject/spi/Bean<TT;>;)TT;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/proxy/NormalScopeProxyFactory", "createProxyClass", "(Ljakarta/enterprise/inject/spi/Bean;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ASTORE, 4);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getInstanceProvider", "(Ljava/lang/ClassLoader;Ljakarta/enterprise/inject/spi/Bean;)Ljakarta/inject/Provider;", "(Ljava/lang/ClassLoader;Ljakarta/enterprise/inject/spi/Bean<*>;)Ljakarta/inject/Provider;", null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"org/apache/webbeans/proxy/NormalScopeProxyFactory", "java/lang/ClassLoader", "jakarta/enterprise/inject/spi/Bean", "java/lang/String", "java/lang/Class", "java/lang/String", "java/lang/String"}, 0, new Object[] {});
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_SYNCHRONIZED, "createProxyClass", "(Ljakarta/enterprise/inject/spi/Bean;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Class;", "<T:Ljava/lang/Object;>(Ljakarta/enterprise/inject/spi/Bean<TT;>;Ljava/lang/ClassLoader;Ljava/lang/Class<TT;>;)Ljava/lang/Class<TT;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/proxy/NormalScopeProxyFactory", "cachedProxyClasses", "Ljava/util/concurrent/ConcurrentMap;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createProxyInstance", "(Ljava/lang/Class;Ljakarta/inject/Provider;)Ljava/lang/Object;", "<T:Ljava/lang/Object;>(Ljava/lang/Class<TT;>;Ljakarta/inject/Provider;)TT;", new String[] { "org/apache/webbeans/exception/ProxyGenerationException" });
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
