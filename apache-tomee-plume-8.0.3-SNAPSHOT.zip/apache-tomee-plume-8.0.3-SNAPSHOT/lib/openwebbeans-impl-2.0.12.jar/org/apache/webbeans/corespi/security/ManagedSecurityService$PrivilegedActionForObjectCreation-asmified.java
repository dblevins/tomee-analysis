...
public class ManagedSecurityService$PrivilegedActionForObjectCreationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/corespi/security/ManagedSecurityService$PrivilegedActionForObjectCreation", "Ljava/lang/Object;Ljava/security/PrivilegedExceptionAction<Ljava/lang/Object;>;", "java/lang/Object", new String[] { "java/security/PrivilegedExceptionAction" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/corespi/security/ManagedSecurityService$PrivilegedActionForObjectCreation", "clazz", "Ljava/lang/Class;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/corespi/security/ManagedSecurityService$PrivilegedActionForObjectCreation", "clazz", "Ljava/lang/Class;");
