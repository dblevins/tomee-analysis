...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "org/apache/webbeans/component/creation/BaseProducerFactory", "<P:Ljava/lang/Object;>Ljava/lang/Object;Ljavax/enterprise/inject/spi/ProducerFactory<TP;>;", "java/lang/Object", new String[] { "javax/enterprise/inject/spi/ProducerFactory" });

{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "disposalMethod", "Ljavax/enterprise/inject/spi/AnnotatedMethod;", "Ljavax/enterprise/inject/spi/AnnotatedMethod<-TP;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED, "parent", "Ljavax/enterprise/inject/spi/Bean;", "Ljavax/enterprise/inject/spi/Bean<TP;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/enterprise/inject/spi/Bean;Lorg/apache/webbeans/config/WebBeansContext;)V", "(Ljavax/enterprise/inject/spi/Bean<TP;>;Lorg/apache/webbeans/config/WebBeansContext;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/component/creation/BaseProducerFactory", "parent", "Ljavax/enterprise/inject/spi/Bean;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "getInjectionPoints", "(Ljavax/enterprise/inject/spi/Bean;)Ljava/util/Set;", "<T:Ljava/lang/Object;>(Ljavax/enterprise/inject/spi/Bean<TT;>;)Ljava/util/Set<Ljavax/enterprise/inject/spi/InjectionPoint;>;", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/creation/BaseProducerFactory", "disposalMethod", "Ljavax/enterprise/inject/spi/AnnotatedMethod;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/creation/BaseProducerFactory", "producerType", "()Ljavax/enterprise/inject/spi/AnnotatedMember;", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedMember", "getAnnotations", "()Ljava/util/Set;", true);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/enterprise/inject/spi/AnnotatedMember", "java/util/Set"}, 0, null);
methodVisitor.visitTypeInsn(NEW, "java/util/HashSet");
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 9, new Object[] {"org/apache/webbeans/component/creation/BaseProducerFactory", "javax/enterprise/inject/spi/AnnotatedMember", "java/util/Set", "java/util/Set", "javax/enterprise/inject/spi/AnnotatedType", "java/lang/reflect/Type", "java/util/Set", "javax/enterprise/inject/spi/AnnotatedMethod", "java/util/Iterator"}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/BaseProducerFactory", "validateDisposalMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljavax/enterprise/inject/spi/AnnotatedMethod;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 9);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/component/creation/BaseProducerFactory", "disposalMethod", "Ljavax/enterprise/inject/spi/AnnotatedMethod;");
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_FULL, 11, new Object[] {"org/apache/webbeans/component/creation/BaseProducerFactory", "javax/enterprise/inject/spi/AnnotatedMember", "java/util/Set", "java/util/Set", "javax/enterprise/inject/spi/AnnotatedType", "java/lang/reflect/Type", "java/util/Set", "javax/enterprise/inject/spi/AnnotatedMethod", "java/util/Iterator", "javax/enterprise/inject/spi/AnnotatedMethod", "java/util/Iterator"}, 0, new Object[] {});
methodVisitor.visitJumpInsn(GOTO, label7);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "validateDisposalMethod", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljavax/enterprise/inject/spi/AnnotatedMethod;)V", "(Ljavax/enterprise/inject/spi/AnnotatedType;Ljavax/enterprise/inject/spi/AnnotatedMethod<-TP;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/enterprise/inject/spi/AnnotatedMethod", "getDeclaringType", "()Ljavax/enterprise/inject/spi/AnnotatedType;", true);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/BaseProducerFactory", "checkDisposalMethod", "(Ljavax/enterprise/inject/spi/AnnotatedMethod;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "producerType", "()Ljavax/enterprise/inject/spi/AnnotatedMember;", "()Ljavax/enterprise/inject/spi/AnnotatedMember<-TP;>;", null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "checkDisposalMethod", "(Ljavax/enterprise/inject/spi/AnnotatedMethod;)V", "(Ljavax/enterprise/inject/spi/AnnotatedMethod<-TP;>;)V", null);
methodVisitor.visitCode();
methodVisitor.visitInsn(ICONST_0);
...
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label8);
methodVisitor.visitFrame(Opcodes.F_APPEND,2, new Object[] {"javax/enterprise/inject/spi/AnnotatedParameter", "java/lang/reflect/Type"}, 0, null);
