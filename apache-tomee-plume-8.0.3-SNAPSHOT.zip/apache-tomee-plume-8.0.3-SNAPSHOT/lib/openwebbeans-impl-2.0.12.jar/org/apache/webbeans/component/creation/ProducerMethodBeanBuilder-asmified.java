...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/component/creation/ProducerMethodBeanBuilder", "<T:Ljava/lang/Object;>Lorg/apache/webbeans/component/creation/AbstractProducerBeanBuilder<TT;Ljakarta/enterprise/inject/spi/AnnotatedMethod<*>;Lorg/apache/webbeans/component/ProducerMethodBean<TT;>;>;", "org/apache/webbeans/component/creation/AbstractProducerBeanBuilder", null);

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/webbeans/component/InjectionTargetBean;Ljakarta/enterprise/inject/spi/AnnotatedMethod;Ljakarta/enterprise/inject/spi/BeanAttributes;)V", "(Lorg/apache/webbeans/component/InjectionTargetBean<TT;>;Ljakarta/enterprise/inject/spi/AnnotatedMethod<*>;Ljakarta/enterprise/inject/spi/BeanAttributes<TT;>;)V", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/creation/ProducerMethodBeanBuilder", "annotatedMember", "Ljakarta/enterprise/inject/spi/AnnotatedMember;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/component/creation/ProducerMethodBeanBuilder", "beanAttributes", "Ljakarta/enterprise/inject/spi/BeanAttributes;");
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/creation/MethodProducerFactory", "<init>", "(Ljakarta/enterprise/inject/spi/AnnotatedMethod;Ljakarta/enterprise/inject/spi/Bean;Lorg/apache/webbeans/config/WebBeansContext;)V", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/ProducerMethodBean", "<init>", "(Lorg/apache/webbeans/component/InjectionTargetBean;Ljakarta/enterprise/inject/spi/BeanAttributes;Ljava/lang/Class;Lorg/apache/webbeans/component/creation/MethodProducerFactory;)V", false);
