...
public class BeanMetadataBeanDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/component/BeanMetadataBean", "<T:Ljava/lang/Object;>Lorg/apache/webbeans/component/BuiltInOwbBean<Ljavax/enterprise/inject/spi/Bean<TT;>;>;", "org/apache/webbeans/component/BuiltInOwbBean", null);

classWriter.visitInnerClass("org/apache/webbeans/component/BeanMetadataBean$1", null, null, 0);
...
methodVisitor.visitLdcInsn(Type.getType("Ljavax/enterprise/context/spi/Contextual;"));
methodVisitor.visitInsn(AASTORE);
methodVisitor.visitInsn(DUP);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/webbeans/component/BeanMetadataBean$1");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/webbeans/component/BeanMetadataBean$1", "<init>", "()V", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/webbeans/component/BeanMetadataBean$1", "getRawType", "()Ljava/lang/Class;", false);
methodVisitor.visitInsn(ICONST_0);
