...
public class ProxyGenerationExceptionDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/webbeans/exception/ProxyGenerationException", null, "java/lang/RuntimeException", new String[] { "org/apache/webbeans/exception/helper/DescriptiveException" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/webbeans/exception/ProxyGenerationException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/webbeans/exception/ProxyGenerationException", "msg", "Lorg/apache/webbeans/exception/helper/ExceptionMessageBuilder;");
methodVisitor.visitVarInsn(ALOAD, 1);
