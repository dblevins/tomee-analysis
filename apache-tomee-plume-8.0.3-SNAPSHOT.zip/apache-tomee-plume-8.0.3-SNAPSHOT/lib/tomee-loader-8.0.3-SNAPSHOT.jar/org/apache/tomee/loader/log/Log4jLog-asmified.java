package asm.org.apache.tomee.loader.log;
...
public class Log4jLogDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/loader/log/Log4jLog", null, "java/lang/Object", new String[] { "org/apache/juli/logging/Log" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomee/loader/log/Log4jLog", "log", "Lorg/apache/log4j/Logger;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/loader/log/Log4jLog", "log", "Lorg/apache/log4j/Logger;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/loader/log/Log4jLog", "log", "Lorg/apache/log4j/Logger;");
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/log4j/Level", "TRACE", "Lorg/apache/log4j/Level;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/log4j/Logger", "isEnabledFor", "(Lorg/apache/log4j/Priority;)Z", false);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
...
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/loader/log/Log4jLog", "log", "Lorg/apache/log4j/Logger;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/log4j/Logger", "trace", "(Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/log4j/Logger", "trace", "(Ljava/lang/Object;Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(RETURN);
