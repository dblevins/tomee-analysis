...
public class BundleDescription$RequireBundleDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/apache/xbean/osgi/bundle/util/BundleDescription$RequireBundle", null, "org/apache/xbean/osgi/bundle/util/BundleDescription$HeaderEntry", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/osgi/bundle/util/BundleDescription$RequireBundle", "optional", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/xbean/osgi/bundle/util/BundleDescription$RequireBundle", "versionRange", "Lorg/apache/xbean/osgi/bundle/util/VersionRange;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/osgi/bundle/util/BundleDescription$RequireBundle", "optional", "Z");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/xbean/osgi/bundle/util/BundleDescription$RequireBundle", "versionRange", "Lorg/apache/xbean/osgi/bundle/util/VersionRange;");
