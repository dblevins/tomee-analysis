...
public class JsonCreatorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "com/fasterxml/jackson/annotation/JsonCreator", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "mode", "()Lcom/fasterxml/jackson/annotation/JsonCreator$Mode;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Lcom/fasterxml/jackson/annotation/JsonCreator$Mode;", "DEFAULT");
annotationVisitor0.visitEnd();
}
