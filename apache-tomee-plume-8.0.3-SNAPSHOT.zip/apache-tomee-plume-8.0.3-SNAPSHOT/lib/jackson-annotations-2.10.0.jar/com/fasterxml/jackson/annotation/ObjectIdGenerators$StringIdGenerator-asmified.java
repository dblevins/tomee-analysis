...
public class ObjectIdGenerators$StringIdGeneratorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/fasterxml/jackson/annotation/ObjectIdGenerators$StringIdGenerator", "Lcom/fasterxml/jackson/annotation/ObjectIdGenerators$Base<Ljava/lang/String;>;", "com/fasterxml/jackson/annotation/ObjectIdGenerators$Base", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/fasterxml/jackson/annotation/ObjectIdGenerators$StringIdGenerator", "<init>", "(Ljava/lang/Class;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "forScope", "(Ljava/lang/Class;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator;", "(Ljava/lang/Class<*>;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "newForSerialization", "(Ljava/lang/Object;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator;", "(Ljava/lang/Object;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<Ljava/lang/String;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generateId", "(Ljava/lang/Object;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "com/fasterxml/jackson/annotation/ObjectIdGenerators$StringIdGenerator");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/fasterxml/jackson/annotation/ObjectIdGenerators$StringIdGenerator", "generateId", "(Ljava/lang/Object;)Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
