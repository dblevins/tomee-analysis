...
public class ObjectIdGenerators$UUIDGeneratorDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "com/fasterxml/jackson/annotation/ObjectIdGenerators$UUIDGenerator", "Lcom/fasterxml/jackson/annotation/ObjectIdGenerators$Base<Ljava/util/UUID;>;", "com/fasterxml/jackson/annotation/ObjectIdGenerators$Base", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "com/fasterxml/jackson/annotation/ObjectIdGenerators$UUIDGenerator", "<init>", "(Ljava/lang/Class;)V", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "forScope", "(Ljava/lang/Class;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator;", "(Ljava/lang/Class<*>;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<Ljava/util/UUID;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "newForSerialization", "(Ljava/lang/Object;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator;", "(Ljava/lang/Object;)Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<Ljava/util/UUID;>;", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 2);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "generateId", "(Ljava/lang/Object;)Ljava/util/UUID;", null, null);
methodVisitor.visitCode();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "canUseFor", "(Lcom/fasterxml/jackson/annotation/ObjectIdGenerator;)Z", "(Lcom/fasterxml/jackson/annotation/ObjectIdGenerator<*>;)Z", null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/Object", "getClass", "()Ljava/lang/Class;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/fasterxml/jackson/annotation/ObjectIdGenerators$UUIDGenerator", "generateId", "(Ljava/lang/Object;)Ljava/util/UUID;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
