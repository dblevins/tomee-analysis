...
public class OtherTypeDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/hsqldb/types/OtherType", null, "org/hsqldb/types/Type", null);

{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC, "otherType", "Lorg/hsqldb/types/OtherType;", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/types/OtherType", "precision", "J");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/types/OtherType", "typeCode", "I");
methodVisitor.visitInsn(IRETURN);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "typeCode", "()I", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/types/OtherType", "typeCode", "I");
methodVisitor.visitInsn(IRETURN);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(GETSTATIC, "org/hsqldb/types/OtherType", "SQL_ALL_TYPES", "Lorg/hsqldb/types/Type;");
Label label1 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getOtherType", "()Lorg/hsqldb/types/OtherType;", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/hsqldb/types/OtherType", "otherType", "Lorg/hsqldb/types/OtherType;");
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/hsqldb/types/OtherType");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/hsqldb/types/OtherType", "<init>", "()V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/hsqldb/types/OtherType", "otherType", "Lorg/hsqldb/types/OtherType;");
methodVisitor.visitInsn(RETURN);
