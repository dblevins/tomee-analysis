...
public class CountUpDownLatch$SyncDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_FINAL | ACC_SUPER, "org/hsqldb/lib/CountUpDownLatch$Sync", null, "java/util/concurrent/locks/AbstractQueuedSynchronizer", null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/CountUpDownLatch$Sync", "setState", "(I)V", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/CountUpDownLatch$Sync", "getState", "()I", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/CountUpDownLatch$Sync", "getState", "()I", false);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/hsqldb/lib/CountUpDownLatch$Sync", "compareAndSetState", "(II)Z", false);
