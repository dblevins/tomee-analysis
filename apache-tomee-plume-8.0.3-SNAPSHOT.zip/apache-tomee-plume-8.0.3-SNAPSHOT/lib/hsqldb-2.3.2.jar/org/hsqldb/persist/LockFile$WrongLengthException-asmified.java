...
public class LockFile$WrongLengthExceptionDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/hsqldb/persist/LockFile$WrongLengthException", null, "org/hsqldb/persist/LockFile$BaseException", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/hsqldb/persist/LockFile;Ljava/lang/String;J)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/persist/LockFile$WrongLengthException", "length", "J");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/persist/LockFile$WrongLengthException", "length", "J");
