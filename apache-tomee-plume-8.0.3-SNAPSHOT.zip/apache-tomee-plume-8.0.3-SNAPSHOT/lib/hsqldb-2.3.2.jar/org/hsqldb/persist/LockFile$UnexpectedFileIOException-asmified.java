...
public class LockFile$UnexpectedFileIOExceptionDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/hsqldb/persist/LockFile$UnexpectedFileIOException", null, "org/hsqldb/persist/LockFile$BaseException", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/hsqldb/persist/LockFile$UnexpectedFileIOException", "reason", "Ljava/io/IOException;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/hsqldb/persist/LockFile$UnexpectedFileIOException", "reason", "Ljava/io/IOException;");
