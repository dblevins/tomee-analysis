...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/core/JohnzonJsonParserImpl", "manualNext", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JohnzonJsonParserImpl", "internalNext", "()Ljakarta/json/stream/JsonParser$Event;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED | ACC_ABSTRACT, "internalNext", "()Ljakarta/json/stream/JsonParser$Event;", null, null);
methodVisitor.visitEnd();
}
{
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JohnzonJsonParserImpl", "current", "()Ljakarta/json/stream/JsonParser$Event;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonReaderImpl", "readObject", "()Ljakarta/json/JsonObject;", false);
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JsonReaderImpl", "readArray", "()Ljakarta/json/JsonArray;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(5, 3);
methodVisitor.visitEnd();
}
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JohnzonJsonParserImpl", "getArray", "()Ljakarta/json/JsonArray;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JohnzonJsonParserImpl", "getObject", "()Ljakarta/json/JsonObject;", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"jakarta/json/stream/JsonParser$Event"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/johnzon/core/JohnzonJsonParserImpl", "getValue", "()Ljakarta/json/JsonValue;", false);
