...
public class XSURIUnmarshallerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/core/xml/schema/impl/XSURIUnmarshaller", null, "org/opensaml/core/xml/io/AbstractXMLObjectUnmarshaller", null);
...
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/opensaml/core/xml/schema/XSURI", "setValue", "(Ljava/lang/String;)V", true);
methodVisitor.visitInsn(RETURN);
