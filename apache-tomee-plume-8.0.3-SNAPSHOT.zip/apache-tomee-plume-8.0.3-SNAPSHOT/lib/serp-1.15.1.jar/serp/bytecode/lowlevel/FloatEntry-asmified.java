...
public class FloatEntryDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "serp/bytecode/lowlevel/FloatEntry", null, "serp/bytecode/lowlevel/Entry", new String[] { "serp/bytecode/lowlevel/ConstantEntry" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_value", "F", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "serp/bytecode/lowlevel/FloatEntry", "_value", "F");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "serp/bytecode/lowlevel/FloatEntry", "_value", "F");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/lowlevel/FloatEntry", "beforeModify", "()Ljava/lang/Object;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/lowlevel/FloatEntry", "afterModify", "(Ljava/lang/Object;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/lowlevel/FloatEntry", "setValue", "(F)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/visitor/BCVisitor", "enterFloatEntry", "(Lserp/bytecode/lowlevel/FloatEntry;)V", false);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "serp/bytecode/visitor/BCVisitor", "exitFloatEntry", "(Lserp/bytecode/lowlevel/FloatEntry;)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "serp/bytecode/lowlevel/FloatEntry", "_value", "F");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/io/DataOutput", "writeFloat", "(F)V", true);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
