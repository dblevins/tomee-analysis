...
public class ScaleXPointMapDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/math/ec/ScaleXPointMap", null, "java/lang/Object", new String[] { "org/bouncycastle/math/ec/ECPointMap" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/math/ec/ScaleXPointMap", "scale", "Lorg/bouncycastle/math/ec/ECFieldElement;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/math/ec/ScaleXPointMap", "scale", "Lorg/bouncycastle/math/ec/ECFieldElement;");
