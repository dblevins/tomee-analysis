...
public class ByteQueueOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER | ACC_DEPRECATED, "org/bouncycastle/crypto/tls/ByteQueueOutputStream", null, "java/io/OutputStream", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/tls/ByteQueueOutputStream", "buffer", "Lorg/bouncycastle/crypto/tls/ByteQueue;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(3, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getBuffer", "()Lorg/bouncycastle/crypto/tls/ByteQueue;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/tls/ByteQueueOutputStream", "buffer", "Lorg/bouncycastle/crypto/tls/ByteQueue;");
