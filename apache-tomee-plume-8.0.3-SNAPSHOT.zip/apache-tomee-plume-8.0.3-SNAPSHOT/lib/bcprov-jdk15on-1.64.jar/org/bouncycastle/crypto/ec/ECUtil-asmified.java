...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/crypto/ec/ECUtil", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "generateK", "(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
