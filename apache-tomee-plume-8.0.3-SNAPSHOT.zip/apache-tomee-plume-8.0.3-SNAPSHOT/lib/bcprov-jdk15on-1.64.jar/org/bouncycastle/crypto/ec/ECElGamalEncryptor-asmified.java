...
public class ECElGamalEncryptorDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/ec/ECElGamalEncryptor", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/ec/ECEncryptor" });
...
methodVisitor.visitLdcInsn("ECPublicKeyParameters are required for encryption.");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/ec/ECElGamalEncryptor", "key", "Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/ec/ECElGamalEncryptor", "random", "Ljava/security/SecureRandom;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "encrypt", "(Lorg/bouncycastle/math/ec/ECPoint;)Lorg/bouncycastle/crypto/ec/ECPair;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/ec/ECElGamalEncryptor", "key", "Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("ECElGamalEncryptor not initialised");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/ec/ECElGamalEncryptor", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/ec/ECElGamalEncryptor", "createBasePointMultiplier", "()Lorg/bouncycastle/math/ec/ECMultiplier;", false);
