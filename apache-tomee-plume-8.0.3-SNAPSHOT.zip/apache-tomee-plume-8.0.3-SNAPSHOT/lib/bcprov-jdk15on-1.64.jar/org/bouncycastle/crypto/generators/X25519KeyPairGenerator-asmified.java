...
public class X25519KeyPairGeneratorDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/generators/X25519KeyPairGenerator", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/AsymmetricCipherKeyPairGenerator" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/generators/X25519KeyPairGenerator", "random", "Ljava/security/SecureRandom;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/generators/X25519KeyPairGenerator", "random", "Ljava/security/SecureRandom;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/params/X25519PrivateKeyParameters", "<init>", "(Ljava/security/SecureRandom;)V", false);
