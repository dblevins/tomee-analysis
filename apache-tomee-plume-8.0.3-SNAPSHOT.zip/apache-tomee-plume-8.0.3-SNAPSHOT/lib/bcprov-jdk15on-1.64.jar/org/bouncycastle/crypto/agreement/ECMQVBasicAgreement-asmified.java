...
public class ECMQVBasicAgreementDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/agreement/ECMQVBasicAgreement", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/BasicAgreement" });

{
fieldVisitor = classWriter.visitField(0, "privParams", "Lorg/bouncycastle/crypto/params/MQVPrivateParameters;", null, null);
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/crypto/params/MQVPrivateParameters");
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/agreement/ECMQVBasicAgreement", "privParams", "Lorg/bouncycastle/crypto/params/MQVPrivateParameters;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/agreement/ECMQVBasicAgreement", "privParams", "Lorg/bouncycastle/crypto/params/MQVPrivateParameters;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/MQVPrivateParameters", "getStaticPrivateKey", "()Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;", false);
...
methodVisitor.visitLdcInsn("ECMQV explicitly disabled");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalStateException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/bouncycastle/crypto/params/MQVPublicParameters");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/MQVPublicParameters", "getStaticPublicKey", "()Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;", false);
...
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("ECMQV public key components have wrong domain parameters");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalStateException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/agreement/ECMQVBasicAgreement", "privParams", "Lorg/bouncycastle/crypto/params/MQVPrivateParameters;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/MQVPrivateParameters", "getEphemeralPrivateKey", "()Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/agreement/ECMQVBasicAgreement", "privParams", "Lorg/bouncycastle/crypto/params/MQVPrivateParameters;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/MQVPrivateParameters", "getEphemeralPublicKey", "()Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/MQVPublicParameters", "getStaticPublicKey", "()Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/crypto/params/MQVPublicParameters", "getEphemeralPublicKey", "()Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/agreement/ECMQVBasicAgreement", "calculateMqvAgreement", "(Lorg/bouncycastle/crypto/params/ECDomainParameters;Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;)Lorg/bouncycastle/math/ec/ECPoint;", false);
...
methodVisitor.visitTypeInsn(NEW, "java/lang/IllegalStateException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("Infinity is not a valid agreement value for MQV");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/IllegalStateException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "calculateMqvAgreement", "(Lorg/bouncycastle/crypto/params/ECDomainParameters;Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;Lorg/bouncycastle/crypto/params/ECPrivateKeyParameters;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;Lorg/bouncycastle/crypto/params/ECPublicKeyParameters;)Lorg/bouncycastle/math/ec/ECPoint;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
