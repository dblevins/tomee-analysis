...
public class DERMacData$1Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER | ACC_SYNTHETIC, "org/bouncycastle/crypto/util/DERMacData$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/bouncycastle/crypto/util/DERMacData", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/crypto/util/DERMacData$Type", "values", "()[Lorg/bouncycastle/crypto/util/DERMacData$Type;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/crypto/util/DERMacData$1", "$SwitchMap$org$bouncycastle$crypto$util$DERMacData$Type", "[I");
