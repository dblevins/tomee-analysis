...
public class CryptoExceptionDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/CryptoException", null, "java/lang/Exception", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/CryptoException", "cause", "Ljava/lang/Throwable;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/CryptoException", "cause", "Ljava/lang/Throwable;");
