...
public class ISO10126d2PaddingDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/crypto/paddings/ISO10126d2Padding", null, "java/lang/Object", new String[] { "org/bouncycastle/crypto/paddings/BlockCipherPadding" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/crypto/paddings/ISO10126d2Padding", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/crypto/paddings/ISO10126d2Padding", "random", "Ljava/security/SecureRandom;");
