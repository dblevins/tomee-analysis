...
public class SignatureUpdatingOutputStreamDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/jcajce/io/SignatureUpdatingOutputStream", null, "java/io/OutputStream", null);
...
{
methodVisitor = classWriter.visitMethod(0, "<init>", "(Ljava/security/Signature;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/io/OutputStream", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/io/SignatureUpdatingOutputStream", "sig", "Ljava/security/Signature;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/io/SignatureUpdatingOutputStream", "sig", "Ljava/security/Signature;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/security/SignatureException", "getMessage", "()Ljava/lang/String;", false);
