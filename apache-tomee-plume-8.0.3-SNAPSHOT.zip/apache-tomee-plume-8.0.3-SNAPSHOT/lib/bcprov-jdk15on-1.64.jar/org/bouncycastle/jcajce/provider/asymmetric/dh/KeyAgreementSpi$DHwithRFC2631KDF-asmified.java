...
public class KeyAgreementSpi$DHwithRFC2631KDFDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi$DHwithRFC2631KDF", null, "org/bouncycastle/jcajce/provider/asymmetric/dh/KeyAgreementSpi", null);
...
methodVisitor.visitLdcInsn("DHwithRFC2631KDF");
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/crypto/agreement/kdf/DHKEKGenerator");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/crypto/agreement/kdf/DHKEKGenerator", "<init>", "(Lorg/bouncycastle/crypto/Digest;)V", false);
