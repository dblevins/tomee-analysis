...
public class RC5$AlgParamGenDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/RC5$AlgParamGen", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameterGenerator", null);
...
methodVisitor.visitLdcInsn("No supported AlgorithmParameterSpec for RC5 parameter generation.");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/RC5$AlgParamGen", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/RC5$AlgParamGen", "random", "Ljava/security/SecureRandom;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/RC5$AlgParamGen", "createParametersInstance", "(Ljava/lang/String;)Ljava/security/AlgorithmParameters;", false);
