...
public class PBEPBKDF2$AlgParamsDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams", null, "org/bouncycastle/jcajce/provider/symmetric/util/BaseAlgorithmParameters", null);
...
{
fieldVisitor = classWriter.visitField(0, "params", "Lorg/bouncycastle/asn1/pkcs/PBKDF2Params;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams", "params", "Lorg/bouncycastle/asn1/pkcs/PBKDF2Params;");
methodVisitor.visitLdcInsn("DER");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/pkcs/PBKDF2Params", "getEncoded", "(Ljava/lang/String;)[B", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams", "isASN1FormatString", "(Ljava/lang/String;)Z", false);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams", "engineGetEncoded", "()[B", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("unknown parameter spec passed to PBKDF2 PBE parameters object.");
...
methodVisitor.visitTypeInsn(NEW, "java/security/spec/InvalidParameterSpecException");
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("PBEParameterSpec required to initialise a PBKDF2 PBE parameters algorithm parameters object");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/security/spec/InvalidParameterSpecException", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(ATHROW);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/asn1/pkcs/PBKDF2Params", "<init>", "([BI)V", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams", "params", "Lorg/bouncycastle/asn1/pkcs/PBKDF2Params;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/jcajce/provider/symmetric/PBEPBKDF2$AlgParams", "engineInit", "([B)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitLabel(label0);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("PBKDF2 Parameters");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
