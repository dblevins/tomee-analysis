...
public class X962NamedCurves$8Dump implements Opcodes {
...
classWriter.visit(V1_5, ACC_FINAL | ACC_SUPER, "org/bouncycastle/asn1/x9/X962NamedCurves$8", null, "org/bouncycastle/asn1/x9/X9ECParametersHolder", null);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("0400000000000000000001E60FC8821CC74DAEAFC1");
...
methodVisitor.visitLdcInsn("072546B5435234A422E0789675F432C89435DE5242");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/asn1/x9/X962NamedCurves", "access$000", "(Ljava/lang/String;)Ljava/math/BigInteger;", false);
methodVisitor.visitLdcInsn("00C9517D06D5240D3CFF38C74B20B6CD4D6F9DD4D9");
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/bouncycastle/asn1/x9/X962NamedCurves", "access$000", "(Ljava/lang/String;)Ljava/math/BigInteger;", false);
...
methodVisitor.visitLdcInsn("0307AF69989546103D79329FCC3D74880F33BBE803CB");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitLdcInsn("D2C0FB15760860DEF1EEF4D696E6768756151754");
