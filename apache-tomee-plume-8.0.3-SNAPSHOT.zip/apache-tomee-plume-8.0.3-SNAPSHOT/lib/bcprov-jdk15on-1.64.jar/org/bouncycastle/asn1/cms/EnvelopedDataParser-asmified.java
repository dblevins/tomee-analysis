...
public class EnvelopedDataParserDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/asn1/cms/EnvelopedDataParser", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_nextObject", "Lorg/bouncycastle/asn1/ASN1Encodable;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_originatorInfoCalled", "Z", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_seq", "Lorg/bouncycastle/asn1/ASN1SequenceParser;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_version", "Lorg/bouncycastle/asn1/ASN1Integer;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_version", "Lorg/bouncycastle/asn1/ASN1Integer;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_originatorInfoCalled", "Z");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_nextObject", "Lorg/bouncycastle/asn1/ASN1Encodable;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_seq", "Lorg/bouncycastle/asn1/ASN1SequenceParser;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/bouncycastle/asn1/ASN1SequenceParser", "readObject", "()Lorg/bouncycastle/asn1/ASN1Encodable;", true);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_nextObject", "Lorg/bouncycastle/asn1/ASN1Encodable;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_originatorInfoCalled", "Z");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNE, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "getOriginatorInfo", "()Lorg/bouncycastle/asn1/cms/OriginatorInfo;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getEncryptedContentInfo", "()Lorg/bouncycastle/asn1/cms/EncryptedContentInfoParser;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_nextObject", "Lorg/bouncycastle/asn1/ASN1Encodable;");
Label label0 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getUnprotectedAttrs", "()Lorg/bouncycastle/asn1/ASN1SetParser;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/asn1/cms/EnvelopedDataParser", "_nextObject", "Lorg/bouncycastle/asn1/ASN1Encodable;");
Label label0 = new Label();
