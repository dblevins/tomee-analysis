...
public class PublicKeyFactory$SPHINCSConverterDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_SUPER, "org/bouncycastle/pqc/crypto/util/PublicKeyFactory$SPHINCSConverter", null, "org/bouncycastle/pqc/crypto/util/PublicKeyFactory$SubjectPublicKeyInfoConverter", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/pqc/crypto/util/PublicKeyFactory$SPHINCSConverter", "<init>", "()V", false);
methodVisitor.visitInsn(RETURN);
