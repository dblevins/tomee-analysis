...
public class X509AttrCertParserDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jce/provider/X509AttrCertParser", null, "org/bouncycastle/x509/X509StreamParserSpi", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sData", "Lorg/bouncycastle/asn1/ASN1Set;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ICONST_0);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sDataObjectCount", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "currentStream", "Ljava/io/InputStream;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 1);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "readDERCertificate", "(Ljava/io/InputStream;)Lorg/bouncycastle/x509/X509AttributeCertificate;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sData", "Lorg/bouncycastle/asn1/ASN1Set;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jce/provider/X509AttrCertParser", "getCertificate", "()Lorg/bouncycastle/x509/X509AttributeCertificate;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label0);
methodVisitor.visitTypeInsn(NEW, "org/bouncycastle/x509/X509V2AttributeCertificate");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/bouncycastle/asn1/ASN1Sequence", "getEncoded", "()[B", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/x509/X509V2AttributeCertificate", "<init>", "([B)V", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(5, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getCertificate", "()Lorg/bouncycastle/x509/X509AttributeCertificate;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sData", "Lorg/bouncycastle/asn1/ASN1Set;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sDataObjectCount", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sData", "Lorg/bouncycastle/asn1/ASN1Set;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "readPEMCertificate", "(Ljava/io/InputStream;)Lorg/bouncycastle/x509/X509AttributeCertificate;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/bouncycastle/jce/provider/X509AttrCertParser", "PEM_PARSER", "Lorg/bouncycastle/jce/provider/PEMUtil;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "sDataObjectCount", "I");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "currentStream", "Ljava/io/InputStream;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "currentStream", "Ljava/io/InputStream;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jce/provider/X509AttrCertParser", "readPEMCertificate", "(Ljava/io/InputStream;)Lorg/bouncycastle/x509/X509AttributeCertificate;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/provider/X509AttrCertParser", "currentStream", "Ljava/io/InputStream;");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jce/provider/X509AttrCertParser", "readDERCertificate", "(Ljava/io/InputStream;)Lorg/bouncycastle/x509/X509AttributeCertificate;", false);
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitLdcInsn("ATTRIBUTE CERTIFICATE");
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jce/provider/PEMUtil", "<init>", "(Ljava/lang/String;)V", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/bouncycastle/jce/provider/X509AttrCertParser", "PEM_PARSER", "Lorg/bouncycastle/jce/provider/PEMUtil;");
methodVisitor.visitInsn(RETURN);
