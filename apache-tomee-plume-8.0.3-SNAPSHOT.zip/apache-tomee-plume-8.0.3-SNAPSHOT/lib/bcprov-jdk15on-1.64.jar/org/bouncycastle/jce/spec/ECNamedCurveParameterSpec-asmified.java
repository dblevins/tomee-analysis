...
public class ECNamedCurveParameterSpecDump implements Opcodes {
...
classWriter.visit(V1_5, ACC_PUBLIC | ACC_SUPER, "org/bouncycastle/jce/spec/ECNamedCurveParameterSpec", null, "org/bouncycastle/jce/spec/ECParameterSpec", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/spec/ECNamedCurveParameterSpec", "name", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/bouncycastle/jce/spec/ECParameterSpec", "<init>", "(Lorg/bouncycastle/math/ec/ECCurve;Lorg/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/bouncycastle/jce/spec/ECNamedCurveParameterSpec", "name", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/bouncycastle/jce/spec/ECNamedCurveParameterSpec", "name", "Ljava/lang/String;");
