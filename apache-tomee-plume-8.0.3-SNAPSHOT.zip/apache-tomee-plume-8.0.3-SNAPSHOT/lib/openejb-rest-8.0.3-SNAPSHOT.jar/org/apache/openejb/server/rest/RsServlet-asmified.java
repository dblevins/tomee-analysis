...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/server/rest/RsServlet", null, "jakarta/servlet/http/HttpServlet", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "servletConfig", "Ljakarta/servlet/ServletConfig;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/server/rest/RsServlet", "servletConfig", "Ljakarta/servlet/ServletConfig;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/server/rest/RsServlet", "servletConfig", "Ljakarta/servlet/ServletConfig;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "jakarta/servlet/ServletConfig", "getServletContext", "()Ljakarta/servlet/ServletContext;", true);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/server/rest/RsServlet", "jakarta/servlet/http/HttpServletRequest", "jakarta/servlet/http/HttpServletResponse", "org/apache/openejb/server/httpd/HttpRequest", "org/apache/openejb/server/httpd/HttpResponse"}, 1, new Object[] {"java/lang/Exception"});
