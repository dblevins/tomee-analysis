...
public class EJBObjectProxyHandleDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openejb/client/EJBObjectProxyHandle", null, "java/lang/Object", new String[] { "java/io/Externalizable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-8325446328982364608L));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "resolver", "Ljava/lang/ThreadLocal;", "Ljava/lang/ThreadLocal<Lorg/apache/openejb/client/EJBObjectProxyHandle$Resolver;>;", null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_TRANSIENT, "handler", "Lorg/apache/openejb/client/EJBObjectHandler;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/openejb/client/EJBObjectHandler;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/Object", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/EJBObjectProxyHandle", "handler", "Lorg/apache/openejb/client/EJBObjectHandler;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openejb/client/EJBObjectProxyHandle", "metaData", "Lorg/apache/openejb/client/ProtocolMetaData;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/EJBObjectProxyHandle", "handler", "Lorg/apache/openejb/client/EJBObjectHandler;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/EJBObjectProxyHandle", "metaData", "Lorg/apache/openejb/client/ProtocolMetaData;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/client/EJBObjectProxyHandle", "java/io/ObjectInput", Opcodes.INTEGER, Opcodes.TOP, Opcodes.INTEGER}, 2, new Object[] {label2, label2});
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitLabel(label4);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"org/apache/openejb/client/EJBObjectProxyHandle", "java/io/ObjectInput", Opcodes.INTEGER, Opcodes.TOP, Opcodes.INTEGER}, 3, new Object[] {label2, label2, Opcodes.INTEGER});
...
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/openejb/client/EJBObjectProxyHandle$Resolver");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openejb/client/EJBObjectProxyHandle", "handler", "Lorg/apache/openejb/client/EJBObjectHandler;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "org/apache/openejb/client/EJBObjectProxyHandle$Resolver", "resolve", "(Lorg/apache/openejb/client/EJBObjectHandler;)Ljava/lang/Object;", true);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/client/EJBObjectProxyHandle", "resolver", "Ljava/lang/ThreadLocal;");
methodVisitor.visitInsn(RETURN);
