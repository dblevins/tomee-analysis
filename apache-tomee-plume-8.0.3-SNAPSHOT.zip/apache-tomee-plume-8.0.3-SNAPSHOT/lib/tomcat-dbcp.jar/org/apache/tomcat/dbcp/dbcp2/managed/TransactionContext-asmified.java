...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "transactionRef", "Ljava/lang/ref/WeakReference;", "Ljava/lang/ref/WeakReference<Ljavax/transaction/Transaction;>;", null);
fieldVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/tomcat/dbcp/dbcp2/managed/TransactionRegistry;Ljavax/transaction/Transaction;Ljavax/transaction/TransactionSynchronizationRegistry;)V", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "transactionSynchronizationRegistry", "Ljavax/transaction/TransactionSynchronizationRegistry;");
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 4);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lorg/apache/tomcat/dbcp/dbcp2/managed/TransactionRegistry;Ljavax/transaction/Transaction;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "<init>", "(Lorg/apache/tomcat/dbcp/dbcp2/managed/TransactionRegistry;Ljavax/transaction/Transaction;Ljavax/transaction/TransactionSynchronizationRegistry;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitTryCatchBlock(label0, label1, label3, "javax/transaction/RollbackException");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "getTransaction", "()Ljavax/transaction/Transaction;", false);
...
Label label3 = new Label();
Label label4 = new Label();
methodVisitor.visitTryCatchBlock(label3, label4, label2, "javax/transaction/RollbackException");
Label label5 = new Label();
...
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContextListener", "javax/transaction/Transaction"}, 2, new Object[] {"org/apache/tomcat/dbcp/dbcp2/managed/TransactionContextListener", "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext"});
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContextListener", "javax/transaction/Transaction"}, 3, new Object[] {"org/apache/tomcat/dbcp/dbcp2/managed/TransactionContextListener", "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", Opcodes.INTEGER});
...
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "transactionSynchronizationRegistry", "Ljavax/transaction/TransactionSynchronizationRegistry;");
...
methodVisitor.visitFrame(Opcodes.F_APPEND,1, new Object[] {"javax/transaction/Synchronization"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "getTransaction", "()Ljavax/transaction/Transaction;", false);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext"}, 1, new Object[] {"javax/transaction/SystemException"});
methodVisitor.visitVarInsn(ASTORE, 1);
methodVisitor.visitTypeInsn(NEW, "java/sql/SQLException");
methodVisitor.visitInsn(DUP);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getTransaction", "()Ljavax/transaction/Transaction;", null, new String[] { "java/sql/SQLException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/dbcp/dbcp2/managed/TransactionContext", "transactionRef", "Ljava/lang/ref/WeakReference;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/ref/WeakReference", "get", "()Ljava/lang/Object;", false);
