...
public class AnnotationProcessor6$1Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openjpa/persistence/meta/AnnotationProcessor6$1", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openjpa/persistence/meta/AnnotationProcessor6", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$openjpa$persistence$meta$AnnotationProcessor6$TypeCategory", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/meta/AnnotationProcessor6$TypeCategory", "values", "()[Lorg/apache/openjpa/persistence/meta/AnnotationProcessor6$TypeCategory;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/persistence/meta/AnnotationProcessor6$1", "$SwitchMap$org$apache$openjpa$persistence$meta$AnnotationProcessor6$TypeCategory", "[I");
