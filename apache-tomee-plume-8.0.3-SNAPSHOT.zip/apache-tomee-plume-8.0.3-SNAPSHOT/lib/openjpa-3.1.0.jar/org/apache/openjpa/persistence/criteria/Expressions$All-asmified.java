...
public class Expressions$AllDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$All", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression<TX;>;", "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", null);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/criteria/Expressions$SubqueryExpression", "<init>", "(Ljakarta/persistence/criteria/Subquery;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$All", "e", "Lorg/apache/openjpa/persistence/criteria/SubqueryImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
