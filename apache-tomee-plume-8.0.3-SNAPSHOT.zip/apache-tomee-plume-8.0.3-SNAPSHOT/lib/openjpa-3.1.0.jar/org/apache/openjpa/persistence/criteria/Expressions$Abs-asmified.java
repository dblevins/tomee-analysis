...
public class Expressions$AbsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$Abs", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/Expressions$UnaryFunctionalExpression<TX;>;", "org/apache/openjpa/persistence/criteria/Expressions$UnaryFunctionalExpression", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$Abs", "e", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/Expressions$Abs", "getJavaType", "()Ljava/lang/Class;", false);
