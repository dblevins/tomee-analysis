...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_validatorFactory", "Ljavax/validation/ValidatorFactory;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_validator", "Ljavax/validation/Validator;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "_mode", "Ljavax/persistence/ValidationMode;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_validatorFactory", "Ljavax/validation/ValidatorFactory;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_validator", "Ljavax/validation/Validator;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/ValidationMode", "AUTO", "Ljavax/persistence/ValidationMode;");
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_mode", "Ljavax/persistence/ValidationMode;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljavax/validation/ValidatorFactory;Ljavax/persistence/ValidationMode;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/validation/AbstractValidator", "<init>", "()V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_mode", "Ljavax/persistence/ValidationMode;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/openjpa/persistence/validation/ValidatorImpl", "javax/validation/ValidatorFactory", "javax/persistence/ValidationMode"}, 0, new Object[] {});
methodVisitor.visitVarInsn(ALOAD, 1);
Label label1 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_mode", "Ljavax/persistence/ValidationMode;");
methodVisitor.visitFieldInsn(GETSTATIC, "javax/persistence/ValidationMode", "NONE", "Ljavax/persistence/ValidationMode;");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IF_ACMPEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_validatorFactory", "Ljavax/validation/ValidatorFactory;");
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNONNULL, label1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/persistence/validation/ValidatorImpl", "getDefaultValidatorFactory", "()Ljavax/validation/ValidatorFactory;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_validatorFactory", "Ljavax/validation/ValidatorFactory;");
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/validation/ValidatorImpl", "_validator", "Ljavax/validation/Validator;");
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/lib/util/J2DoPrivHelper", "validateAction", "(Ljavax/validation/Validator;Ljava/lang/Object;[Ljava/lang/Class;)Ljava/security/PrivilegedAction;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/validation/ValidatorImpl", "getValidationGroup", "(Ljava/lang/Integer;)[Ljava/lang/Class;", false);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "javax/validation/Validator", "validateProperty", "(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/util/Set;", true);
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 4);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "getDefaultValidatorFactory", "()Ljavax/validation/ValidatorFactory;", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
methodVisitor.visitJumpInsn(GOTO, label3);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/openjpa/persistence/validation/ValidatorImpl", "javax/validation/ValidatorFactory"}, 1, new Object[] {"javax/validation/ValidationException"});
methodVisitor.visitVarInsn(ASTORE, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
