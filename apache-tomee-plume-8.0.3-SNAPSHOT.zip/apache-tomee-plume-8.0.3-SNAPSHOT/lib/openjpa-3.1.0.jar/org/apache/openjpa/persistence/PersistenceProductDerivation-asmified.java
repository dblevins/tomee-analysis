...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "load", "(Ljavax/persistence/spi/PersistenceUnitInfo;Ljava/util/Map;)Lorg/apache/openjpa/lib/conf/ConfigurationProvider;", null, new String[] { "java/io/IOException" });
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/PersistenceProductDerivation", "isOpenJPAPersistenceProvider", "(Ljavax/persistence/spi/PersistenceUnitInfo;Ljava/lang/ClassLoader;)Z", false);
Label label1 = new Label();
methodVisitor.visitJumpInsn(IFNE, label1);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/persistence/PersistenceProductDerivation", "warnUnknownProvider", "(Ljavax/persistence/spi/PersistenceUnitInfo;)V", false);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "isOpenJPAPersistenceProvider", "(Ljavax/persistence/spi/PersistenceUnitInfo;Ljava/lang/ClassLoader;)Z", null, null);
methodVisitor.visitCode();
Label label0 = new Label();
Label label1 = new Label();
Label label2 = new Label();
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE | ACC_STATIC, "warnUnknownProvider", "(Ljavax/persistence/spi/PersistenceUnitInfo;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/persistence/PersistenceProductDerivation", "_loc", "Lorg/apache/openjpa/lib/util/Localizer;");
