...
public class Expressions$CastAsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$CastAs", "<Y:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<TY;>;", "org/apache/openjpa/persistence/criteria/ExpressionImpl", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_FINAL, "actual", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<*>;", null);
fieldVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Ljava/lang/Class;Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;)V", "(Ljava/lang/Class<TY;>;Lorg/apache/openjpa/persistence/criteria/ExpressionImpl<*>;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/persistence/criteria/Expressions$CastAs", "actual", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$CastAs", "actual", "Lorg/apache/openjpa/persistence/criteria/ExpressionImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/persistence/criteria/Expressions$CastAs", "getJavaType", "()Ljava/lang/Class;", false);
