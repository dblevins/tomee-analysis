...
public class Expressions$ExistsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/persistence/criteria/Expressions$Exists", "<X:Ljava/lang/Object;>Lorg/apache/openjpa/persistence/criteria/Expressions$SubqueryPredicate<TX;>;", "org/apache/openjpa/persistence/criteria/Expressions$SubqueryPredicate", null);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/persistence/criteria/Expressions$Exists", "e", "Lorg/apache/openjpa/persistence/criteria/SubqueryImpl;");
methodVisitor.visitVarInsn(ALOAD, 1);
