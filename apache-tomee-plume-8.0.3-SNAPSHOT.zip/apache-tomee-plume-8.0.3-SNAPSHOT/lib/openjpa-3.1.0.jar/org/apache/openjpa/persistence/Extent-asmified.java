...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "org/apache/openjpa/persistence/Extent", "<T:Ljava/lang/Object;>Ljava/lang/Object;Ljava/lang/Iterable<TT;>;", "java/lang/Object", new String[] { "java/lang/Iterable" });

{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getElementClass", "()Ljava/lang/Class;", "()Ljava/lang/Class<TT;>;", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT | ACC_DEPRECATED, "getDelegate", "()Lorg/apache/openjpa/kernel/Extent;", null, null);
{
