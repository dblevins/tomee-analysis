...
public class QueryImpl$CompilationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/kernel/QueryImpl$Compilation", null, "java/lang/Object", new String[] { "java/io/Serializable" });
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "memory", "Lorg/apache/openjpa/kernel/StoreQuery$Executor;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "datastore", "Lorg/apache/openjpa/kernel/StoreQuery$Executor;", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "storeData", "Ljava/lang/Object;", null, null);
fieldVisitor.visitEnd();
}
{
