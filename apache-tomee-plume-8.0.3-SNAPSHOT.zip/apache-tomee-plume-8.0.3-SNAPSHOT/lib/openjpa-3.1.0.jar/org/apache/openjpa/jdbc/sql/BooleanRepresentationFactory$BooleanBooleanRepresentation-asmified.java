...
public class BooleanRepresentationFactory$BooleanBooleanRepresentationDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/jdbc/sql/BooleanRepresentationFactory$BooleanBooleanRepresentation", "Ljava/lang/Object;Lorg/apache/openjpa/jdbc/sql/BooleanRepresentation<Ljava/lang/Boolean;>;", "java/lang/Object", new String[] { "org/apache/openjpa/jdbc/sql/BooleanRepresentation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "getRepresentation", "(Z)Ljava/lang/Boolean;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("BooleanBooleanRepresentation");
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/jdbc/sql/BooleanRepresentationFactory$BooleanBooleanRepresentation", "getRepresentation", "(Z)Ljava/lang/Boolean;", false);
methodVisitor.visitInsn(ARETURN);
