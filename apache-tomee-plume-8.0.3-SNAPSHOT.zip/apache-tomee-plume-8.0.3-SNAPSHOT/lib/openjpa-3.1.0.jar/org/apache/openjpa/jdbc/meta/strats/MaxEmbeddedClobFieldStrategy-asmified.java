...
public class MaxEmbeddedClobFieldStrategyDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", null, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedLobFieldStrategy", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "_maxSize", "I");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "getValue", "(Lorg/apache/openjpa/kernel/OpenJPAStateManager;)Ljava/lang/Object;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "field", "Lorg/apache/openjpa/jdbc/meta/FieldMapping;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "_maxSize", "I");
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "_loc", "Lorg/apache/openjpa/lib/util/Localizer;");
methodVisitor.visitLdcInsn("not-clobstring");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "field", "Lorg/apache/openjpa/jdbc/meta/FieldMapping;");
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn(Type.getType("Lorg/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy;"));
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/openjpa/lib/util/Localizer", "forPackage", "(Ljava/lang/Class;)Lorg/apache/openjpa/lib/util/Localizer;", false);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/jdbc/meta/strats/MaxEmbeddedClobFieldStrategy", "_loc", "Lorg/apache/openjpa/lib/util/Localizer;");
methodVisitor.visitInsn(RETURN);
