...
public class ConcurrentReferenceHashMap$4Dump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER | ACC_SYNTHETIC, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashMap$4", null, "java/lang/Object", null);

classWriter.visitOuterClass("org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashMap", null, null);
...
{
fieldVisitor = classWriter.visitField(ACC_FINAL | ACC_STATIC | ACC_SYNTHETIC, "$SwitchMap$org$apache$commons$collections4$map$AbstractReferenceMap$ReferenceStrength", "[I", null, null);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/collections4/map/AbstractReferenceMap$ReferenceStrength", "values", "()[Lorg/apache/commons/collections4/map/AbstractReferenceMap$ReferenceStrength;", false);
methodVisitor.visitInsn(ARRAYLENGTH);
methodVisitor.visitIntInsn(NEWARRAY, T_INT);
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openjpa/lib/util/concurrent/ConcurrentReferenceHashMap$4", "$SwitchMap$org$apache$commons$collections4$map$AbstractReferenceMap$ReferenceStrength", "[I");
