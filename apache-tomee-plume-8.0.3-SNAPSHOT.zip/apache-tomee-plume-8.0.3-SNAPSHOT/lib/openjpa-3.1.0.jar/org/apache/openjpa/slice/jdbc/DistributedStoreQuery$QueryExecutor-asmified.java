...
public class DistributedStoreQuery$QueryExecutorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/slice/jdbc/DistributedStoreQuery$QueryExecutor", "Ljava/lang/Object;Ljava/util/concurrent/Callable<Lorg/apache/openjpa/lib/rop/ResultObjectProvider;>;", "java/lang/Object", new String[] { "java/util/concurrent/Callable" });
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/slice/jdbc/DistributedStoreQuery$QueryExecutor", "query", "Lorg/apache/openjpa/kernel/StoreQuery;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/slice/jdbc/DistributedStoreQuery$QueryExecutor", "params", "[Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/slice/jdbc/DistributedStoreQuery$QueryExecutor", "range", "Lorg/apache/openjpa/kernel/StoreQuery$Range;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/slice/jdbc/DistributedStoreQuery$QueryExecutor", "call", "()Lorg/apache/openjpa/lib/rop/ResultObjectProvider;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(1, 1);
methodVisitor.visitEnd();
}
