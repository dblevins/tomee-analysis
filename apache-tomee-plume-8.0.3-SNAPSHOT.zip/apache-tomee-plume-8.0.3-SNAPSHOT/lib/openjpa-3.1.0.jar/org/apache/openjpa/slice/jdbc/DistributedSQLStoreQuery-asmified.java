...
public class DistributedSQLStoreQueryDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", null, "org/apache/openjpa/jdbc/kernel/SQLStoreQuery", null);

classWriter.visitInnerClass("org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery$UpdateExecutor", "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "UpdateExecutor", ACC_STATIC);
...
classWriter.visitInnerClass("org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery$ParallelExecutor", "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "ParallelExecutor", ACC_PUBLIC | ACC_STATIC);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "_queries", "Ljava/util/List;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "_queries", "Ljava/util/List;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "getStore", "()Lorg/apache/openjpa/jdbc/kernel/JDBCStore;", false);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "getContext", "()Lorg/apache/openjpa/kernel/QueryContext;", false);
...
methodVisitor.visitTypeInsn(NEW, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery$ParallelExecutor");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery$ParallelExecutor", "<init>", "(Lorg/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery;Lorg/apache/openjpa/meta/ClassMetaData;Z)V", false);
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {Opcodes.INTEGER, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery$ParallelExecutor", "java/util/Iterator"}, 0, null);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery$ParallelExecutor", "addExecutor", "(Lorg/apache/openjpa/kernel/StoreQuery$Executor;)V", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/openjpa/jdbc/kernel/SQLStoreQuery", "setContext", "(Lorg/apache/openjpa/kernel/QueryContext;)V", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "_queries", "Ljava/util/List;");
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/List", "iterator", "()Ljava/util/Iterator;", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC | ACC_SYNTHETIC, "access$000", "(Lorg/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery;)Ljava/util/List;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/openjpa/slice/jdbc/DistributedSQLStoreQuery", "_queries", "Ljava/util/List;");
methodVisitor.visitInsn(ARETURN);
