...
public class PCEnhancer$FlagsDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/openjpa/enhance/PCEnhancer$Flags", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "addDefaultConstructor", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "tmpClassLoader", "Z", null, null);
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PUBLIC, "enforcePropertyRestrictions", "Z", null, null);
fieldVisitor.visitEnd();
}
{
