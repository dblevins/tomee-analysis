...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomcat/jdbc/pool/DataSource", null, "org/apache/tomcat/jdbc/pool/DataSourceProxy", new String[] { "javax/sql/DataSource", "javax/management/MBeanRegistration", "org/apache/tomcat/jdbc/pool/jmx/ConnectionPoolMBean", "javax/sql/ConnectionPoolDataSource" });
...
{
fieldVisitor = classWriter.visitField(ACC_PROTECTED | ACC_VOLATILE, "oname", "Ljavax/management/ObjectName;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljavax/management/ObjectName;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljavax/management/ObjectName;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomcat/jdbc/pool/DataSource", "createObjectName", "(Ljavax/management/ObjectName;)Ljavax/management/ObjectName;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljavax/management/ObjectName;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomcat/jdbc/pool/DataSource", "oname", "Ljavax/management/ObjectName;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "createObjectName", "(Ljavax/management/ObjectName;)Ljavax/management/ObjectName;", null, new String[] { "javax/management/MalformedObjectNameException" });
methodVisitor.visitCode();
