...
public class LeafPropertyLoaderDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/bind/v2/runtime/unmarshaller/LeafPropertyLoader", null, "com/sun/xml/bind/v2/runtime/unmarshaller/Loader", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/v2/runtime/unmarshaller/LeafPropertyLoader", "xacc", "Lcom/sun/xml/bind/v2/runtime/reflect/TransducedAccessor;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/unmarshaller/LeafPropertyLoader", "xacc", "Lcom/sun/xml/bind/v2/runtime/reflect/TransducedAccessor;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/xml/bind/v2/runtime/unmarshaller/LeafPropertyLoader", "handleGenericException", "(Ljava/lang/Exception;Z)V", false);
methodVisitor.visitJumpInsn(GOTO, label4);
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESTATIC, "com/sun/xml/bind/v2/runtime/unmarshaller/LeafPropertyLoader", "handleParseConversionException", "(Lcom/sun/xml/bind/v2/runtime/unmarshaller/UnmarshallingContext$State;Ljava/lang/Exception;)V", false);
