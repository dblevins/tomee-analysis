...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "com/sun/xml/bind/v2/runtime/output/Pcdata", null, "java/lang/Object", new String[] { "java/lang/CharSequence" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "writeTo", "(Lcom/sun/xml/bind/v2/runtime/output/UTF8XmlOutput;)V", null, new String[] { "java/io/IOException" });
methodVisitor.visitEnd();
}
{
