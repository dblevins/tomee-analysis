...
public class SchemaTypeTransducerDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "<V:Ljava/lang/Object;>Lcom/sun/xml/bind/v2/runtime/FilterTransducer<TV;>;", "com/sun/xml/bind/v2/runtime/FilterTransducer", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "<init>", "(Lcom/sun/xml/bind/v2/runtime/Transducer;Ljavax/xml/namespace/QName;)V", "(Lcom/sun/xml/bind/v2/runtime/Transducer<TV;>;Ljavax/xml/namespace/QName;)V", null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "schemaType", "Ljavax/xml/namespace/QName;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "schemaType", "Ljavax/xml/namespace/QName;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "com/sun/xml/bind/v2/runtime/XMLSerializer", "setSchemaType", "(Ljavax/xml/namespace/QName;)Ljavax/xml/namespace/QName;", false);
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLabel(label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "core", "Lcom/sun/xml/bind/v2/runtime/Transducer;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "java/lang/Object", "com/sun/xml/bind/v2/runtime/XMLSerializer", "javax/xml/namespace/QName"}, 1, new Object[] {"java/lang/Throwable"});
...
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 5, new Object[] {"com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "com/sun/xml/bind/v2/runtime/XMLSerializer", "java/lang/Object", "java/lang/String", "javax/xml/namespace/QName"}, 1, new Object[] {"java/lang/Throwable"});
methodVisitor.visitVarInsn(ASTORE, 5);
methodVisitor.visitLabel(label3);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 4);
...
methodVisitor.visitJumpInsn(GOTO, label4);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 6, new Object[] {"com/sun/xml/bind/v2/runtime/SchemaTypeTransducer", "com/sun/xml/bind/v2/runtime/XMLSerializer", "com/sun/xml/bind/v2/runtime/Name", "java/lang/Object", "java/lang/String", "javax/xml/namespace/QName"}, 1, new Object[] {"java/lang/Throwable"});
