...
public class RegistryTypeDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/microprofile/metrics/annotation/RegistryType", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "type", "()Lorg/eclipse/microprofile/metrics/MetricRegistry$Type;", null, null);
{
annotationVisitor0 = methodVisitor.visitAnnotationDefault();
annotationVisitor0.visitEnum(null, "Lorg/eclipse/microprofile/metrics/MetricRegistry$Type;", "APPLICATION");
annotationVisitor0.visitEnd();
}
