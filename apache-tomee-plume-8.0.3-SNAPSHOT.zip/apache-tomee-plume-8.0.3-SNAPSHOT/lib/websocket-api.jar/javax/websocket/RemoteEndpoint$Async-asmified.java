...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ABSTRACT | ACC_INTERFACE, "javax/websocket/RemoteEndpoint$Async", null, "java/lang/Object", new String[] { "javax/websocket/RemoteEndpoint" });
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "sendText", "(Ljava/lang/String;Ljavax/websocket/SendHandler;)V", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "sendBinary", "(Ljava/nio/ByteBuffer;Ljavax/websocket/SendHandler;)V", null, null);
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "sendObject", "(Ljava/lang/Object;Ljavax/websocket/SendHandler;)V", null, null);
methodVisitor.visitEnd();
}
