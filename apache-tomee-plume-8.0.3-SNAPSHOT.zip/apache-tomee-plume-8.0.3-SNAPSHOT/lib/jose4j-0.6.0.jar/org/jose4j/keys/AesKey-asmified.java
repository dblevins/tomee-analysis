...
public class AesKeyDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/jose4j/keys/AesKey", null, "javax/crypto/spec/SecretKeySpec", null);

{
fieldVisitor = classWriter.visitField(ACC_PUBLIC | ACC_FINAL | ACC_STATIC, "ALGORITHM", "Ljava/lang/String;", null, "AES");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/jose4j/keys/AesKey", "getEncoded", "()[B", false);
