...
public class SimplePEMEncoderDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/jose4j/base64url/SimplePEMEncoder", null, "java/lang/Object", null);
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/jose4j/base64url/SimplePEMEncoder", "getCodec", "()Lorg/jose4j/base64url/internal/apache/commons/codec/binary/Base64;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_STATIC, "getCodec", "()Lorg/jose4j/base64url/internal/apache/commons/codec/binary/Base64;", null, null);
methodVisitor.visitCode();
