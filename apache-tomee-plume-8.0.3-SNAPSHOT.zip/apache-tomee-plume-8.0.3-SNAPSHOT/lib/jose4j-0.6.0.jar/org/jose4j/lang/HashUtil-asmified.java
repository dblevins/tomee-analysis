...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/jose4j/lang/HashUtil", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getMessageDigest", "(Ljava/lang/String;)Ljava/security/MessageDigest;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "getMessageDigest", "(Ljava/lang/String;Ljava/lang/String;)Ljava/security/MessageDigest;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"java/security/MessageDigest"});
methodVisitor.visitInsn(ARETURN);
...
methodVisitor.visitLdcInsn("Unable to get MessageDigest instance with ");
...
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("Unable to get a MessageDigest implementation of algorithm name: ");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
