...
public class WebBeansListenerHelperDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER | ACC_DEPRECATED, "org/apache/openejb/server/httpd/WebBeansListenerHelper", null, "java/lang/Object", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "FAKE_REQUEST", "Ljava/lang/ThreadLocal;", "Ljava/lang/ThreadLocal<Ljava/lang/Boolean;>;", null);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/openejb/server/httpd/WebBeansListenerHelper", "FAKE_REQUEST", "Ljava/lang/ThreadLocal;");
methodVisitor.visitInsn(RETURN);
