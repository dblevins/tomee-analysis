...
public class WrapDynaClass$2Dump implements Opcodes {
...
classWriter.visit(V1_6, ACC_FINAL | ACC_SUPER, "org/apache/commons/beanutils/WrapDynaClass$2", "Ljava/util/HashMap<Ljava/lang/Object;Ljava/lang/Object;>;", "java/util/HashMap", null);

classWriter.visitOuterClass("org/apache/commons/beanutils/WrapDynaClass", null, null);
...
methodVisitor.visitCode();
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/beanutils/WrapDynaClass", "access$000", "()Ljava/util/Map;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/beanutils/WrapDynaClass", "access$100", "()Ljava/util/Map;", false);
...
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/commons/beanutils/WrapDynaClass$CacheKey", "access$200", "(Lorg/apache/commons/beanutils/WrapDynaClass$CacheKey;)Ljava/lang/Class;", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/beanutils/WrapDynaClass$2", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitJumpInsn(GOTO, label0);
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_CHOP,1, null, 0, null);
