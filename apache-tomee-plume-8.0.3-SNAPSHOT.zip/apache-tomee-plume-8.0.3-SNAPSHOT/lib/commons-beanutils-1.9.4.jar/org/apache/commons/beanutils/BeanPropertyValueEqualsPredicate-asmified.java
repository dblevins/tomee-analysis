...
public class BeanPropertyValueEqualsPredicateDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", null, "java/lang/Object", new String[] { "org/apache/commons/collections/Predicate" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "<init>", "(Ljava/lang/String;Ljava/lang/Object;Z)V", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "propertyName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "propertyValue", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 3);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "ignoreNull", "Z");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "java/lang/String", "java/lang/Object", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "propertyValue", "Ljava/lang/Object;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "propertyName", "Ljava/lang/String;");
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "evaluateValue", "(Ljava/lang/Object;Ljava/lang/Object;)Z", false);
methodVisitor.visitVarInsn(ISTORE, 2);
methodVisitor.visitLabel(label1);
Label label6 = new Label();
methodVisitor.visitJumpInsn(GOTO, label6);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "java/lang/Object", Opcodes.INTEGER}, 1, new Object[] {"java/lang/IllegalArgumentException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLdcInsn("Problem during evaluation. Null value encountered in property path...");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "ignoreNull", "Z");
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("WARNING: Problem during evaluation. Null value encountered in property path...");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "java/lang/Object", Opcodes.INTEGER}, 1, new Object[] {"java/lang/reflect/InvocationTargetException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanPropertyValueEqualsPredicate", "java/lang/Object", Opcodes.INTEGER}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "evaluateValue", "(Ljava/lang/Object;Ljava/lang/Object;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 2);
Label label0 = new Label();
