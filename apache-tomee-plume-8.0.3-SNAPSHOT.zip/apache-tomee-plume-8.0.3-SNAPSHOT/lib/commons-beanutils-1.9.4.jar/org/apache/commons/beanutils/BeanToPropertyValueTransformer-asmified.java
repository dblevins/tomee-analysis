...
public class BeanToPropertyValueTransformerDump implements Opcodes {
...
classWriter.visit(V1_6, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", null, "java/lang/Object", new String[] { "org/apache/commons/collections/Transformer" });
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "<init>", "(Ljava/lang/String;Z)V", false);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitVarInsn(ALOAD, 1);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "propertyName", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ILOAD, 2);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "ignoreNull", "Z");
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanToPropertyValueTransformer", "java/lang/String", Opcodes.INTEGER}, 0, new Object[] {});
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "propertyName", "Ljava/lang/String;");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanToPropertyValueTransformer", "java/lang/Object", "java/lang/Object"}, 1, new Object[] {"java/lang/IllegalArgumentException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitLdcInsn("Problem during transformation. Null value encountered in property path...");
methodVisitor.visitVarInsn(ASTORE, 4);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "ignoreNull", "Z");
Label label7 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label7);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "log", "Lorg/apache/commons/logging/Log;");
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("WARNING: Problem during transformation. Null value encountered in property path...");
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanToPropertyValueTransformer", "java/lang/Object", "java/lang/Object"}, 1, new Object[] {"java/lang/reflect/InvocationTargetException"});
methodVisitor.visitVarInsn(ASTORE, 3);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 3, new Object[] {"org/apache/commons/beanutils/BeanToPropertyValueTransformer", "java/lang/Object", "java/lang/Object"}, 1, new Object[] {"java/lang/NoSuchMethodException"});
methodVisitor.visitVarInsn(ASTORE, 3);
methodVisitor.visitTypeInsn(NEW, "java/lang/StringBuilder");
methodVisitor.visitInsn(DUP);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false);
methodVisitor.visitLdcInsn("No property found for name [");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/beanutils/BeanToPropertyValueTransformer", "propertyName", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
