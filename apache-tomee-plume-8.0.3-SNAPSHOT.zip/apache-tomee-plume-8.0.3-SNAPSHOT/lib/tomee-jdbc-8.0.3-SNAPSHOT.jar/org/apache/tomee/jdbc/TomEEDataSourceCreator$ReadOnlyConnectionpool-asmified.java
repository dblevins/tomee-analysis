...
public class TomEEDataSourceCreator$ReadOnlyConnectionpoolDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_SUPER, "org/apache/tomee/jdbc/TomEEDataSourceCreator$ReadOnlyConnectionpool", null, "java/lang/Object", new String[] { "java/lang/reflect/InvocationHandler" });
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL, "delegate", "Lorg/apache/tomcat/jdbc/pool/PoolConfiguration;", null, null);
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/tomee/jdbc/TomEEDataSourceCreator$ReadOnlyConnectionpool", "delegate", "Lorg/apache/tomcat/jdbc/pool/PoolConfiguration;");
...
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/tomee/jdbc/TomEEDataSourceCreator$ReadOnlyConnectionpool", "delegate", "Lorg/apache/tomcat/jdbc/pool/PoolConfiguration;");
methodVisitor.visitVarInsn(ALOAD, 3);
