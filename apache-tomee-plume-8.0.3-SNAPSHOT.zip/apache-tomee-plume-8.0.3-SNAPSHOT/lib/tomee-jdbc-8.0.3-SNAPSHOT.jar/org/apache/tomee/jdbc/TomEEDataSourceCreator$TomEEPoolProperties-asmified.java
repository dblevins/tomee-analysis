...
public class TomEEDataSourceCreator$TomEEPoolPropertiesDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/jdbc/TomEEDataSourceCreator$TomEEPoolProperties", null, "org/apache/tomcat/jdbc/pool/PoolProperties", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setMinEvictableIdleTime", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/jdbc/pool/PoolProperties", "setMinEvictableIdleTimeMillis", "(I)V", false);
methodVisitor.visitInsn(RETURN);
methodVisitor.visitMaxs(4, 3);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setTimeBetweenEvictionRuns", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitTypeInsn(NEW, "org/apache/openejb/util/Duration");
methodVisitor.visitInsn(DUP);
methodVisitor.visitVarInsn(ALOAD, 1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "setXaDataSource", "(Ljava/lang/String;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomee/jdbc/TomEEDataSourceCreator$TomEEPoolProperties", "setDataSource", "(Ljava/lang/Object;)V", false);
...
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "toString", "()Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/tomcat/jdbc/pool/PoolProperties", "setDataSourceJNDI", "(Ljava/lang/String;)V", false);
methodVisitor.visitInsn(RETURN);
