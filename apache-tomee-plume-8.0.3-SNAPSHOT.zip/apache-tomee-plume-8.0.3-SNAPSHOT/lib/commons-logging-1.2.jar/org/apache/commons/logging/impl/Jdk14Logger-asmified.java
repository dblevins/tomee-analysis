...
public class Jdk14LoggerDump implements Opcodes {
...
classWriter.visit(V1_2, ACC_PUBLIC | ACC_SUPER, "org/apache/commons/logging/impl/Jdk14Logger", null, "java/lang/Object", new String[] { "org/apache/commons/logging/Log", "java/io/Serializable" });

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(4784713551416303804L));
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/impl/Jdk14Logger", "logger", "Ljava/util/logging/Logger;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/impl/Jdk14Logger", "name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/impl/Jdk14Logger", "name", "Ljava/lang/String;");
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/logging/impl/Jdk14Logger", "getLogger", "()Ljava/util/logging/Logger;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/commons/logging/impl/Jdk14Logger", "logger", "Ljava/util/logging/Logger;");
...
{
methodVisitor = classWriter.visitMethod(ACC_PROTECTED, "log", "(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/logging/impl/Jdk14Logger", "getLogger", "()Ljava/util/logging/Logger;", false);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/impl/Jdk14Logger", "name", "Ljava/lang/String;");
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/commons/logging/impl/Jdk14Logger", "log", "(Ljava/util/logging/Level;Ljava/lang/String;Ljava/lang/Throwable;)V", false);
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/commons/logging/impl/Jdk14Logger", "logger", "Ljava/util/logging/Logger;");
Label label0 = new Label();
...
methodVisitor.visitCode();
methodVisitor.visitFieldInsn(GETSTATIC, "java/util/logging/Level", "FINE", "Ljava/util/logging/Level;");
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/commons/logging/impl/Jdk14Logger", "dummyLevel", "Ljava/util/logging/Level;");
methodVisitor.visitInsn(RETURN);
