...
public class FactoryConfigurationErrorDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_SUPER, "javax/xml/stream/FactoryConfigurationError", null, "java/lang/Error", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "serialVersionUID", "J", null, new Long(-2994412584589975744L));
fieldVisitor.visitEnd();
}
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "nested", "Ljava/lang/Exception;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "javax/xml/stream/FactoryConfigurationError", "nested", "Ljava/lang/Exception;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "javax/xml/stream/FactoryConfigurationError", "nested", "Ljava/lang/Exception;");
