...
public class DocumentBuilderDump implements Opcodes {
...
classWriter.visit(V1_1, ACC_PUBLIC | ACC_SUPER | ACC_ABSTRACT, "javax/xml/parsers/DocumentBuilder", null, "java/lang/Object", null);
...
methodVisitor.visitLdcInsn("This DocumentBuilder, \"");
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "parse", "(Lorg/xml/sax/InputSource;)Lorg/w3c/dom/Document;", null, new String[] { "org/xml/sax/SAXException", "java/io/IOException" });
methodVisitor.visitEnd();
}
{
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "newDocument", "()Lorg/w3c/dom/Document;", null, null);
methodVisitor.visitEnd();
}
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_ABSTRACT, "getDOMImplementation", "()Lorg/w3c/dom/DOMImplementation;", null, null);
methodVisitor.visitEnd();
}
{
