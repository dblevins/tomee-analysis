...
public class XACMLPolicyStatementTypeImplDump implements Opcodes {
...
classWriter.visit(V1_7, ACC_PUBLIC | ACC_SUPER, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", null, "org/opensaml/saml/common/AbstractSAMLObject", new String[] { "org/opensaml/xacml/profile/saml/XACMLPolicyStatementType" });
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", "choiceGroup", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
...
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", "choiceGroup", "Lorg/opensaml/core/xml/util/IndexedXMLObjectChildrenList;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/util/ArrayList", "addAll", "(Ljava/util/Collection;)Z", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", "referencedPolicies", "Lorg/opensaml/xacml/profile/saml/ReferencedPoliciesType;");
...
methodVisitor.visitFieldInsn(GETFIELD, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", "referencedPolicies", "Lorg/opensaml/xacml/profile/saml/ReferencedPoliciesType;");
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", "prepareForAssignment", "(Lorg/opensaml/core/xml/XMLObject;Lorg/opensaml/core/xml/XMLObject;)Lorg/opensaml/core/xml/XMLObject;", false);
methodVisitor.visitTypeInsn(CHECKCAST, "org/opensaml/xacml/profile/saml/ReferencedPoliciesType");
methodVisitor.visitFieldInsn(PUTFIELD, "org/opensaml/xacml/profile/saml/impl/XACMLPolicyStatementTypeImpl", "referencedPolicies", "Lorg/opensaml/xacml/profile/saml/ReferencedPoliciesType;");
methodVisitor.visitInsn(RETURN);
