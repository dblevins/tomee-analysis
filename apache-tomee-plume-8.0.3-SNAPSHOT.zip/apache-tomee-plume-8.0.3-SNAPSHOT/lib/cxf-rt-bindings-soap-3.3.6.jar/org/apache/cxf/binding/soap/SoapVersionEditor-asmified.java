...
public class SoapVersionEditorDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/cxf/binding/soap/SoapVersionEditor", null, "java/beans/PropertyEditorSupport", null);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/cxf/binding/soap/SoapVersionEditor", "version", "Lorg/apache/cxf/binding/soap/SoapVersion;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/cxf/binding/soap/SoapVersionEditor", "version", "Lorg/apache/cxf/binding/soap/SoapVersion;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "java/beans/PropertyEditorSupport", "setAsText", "(Ljava/lang/String;)V", false);
