...
classWriter.visit(V1_8, ACC_SUPER, "jakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$4", "Ljakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeMap<[Ljava/lang/String;>;", "jakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeMap", null);

classWriter.visitOuterClass("jakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager", "getHeaderValues", "()Ljava/util/Map;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "jakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$4", "this$0", "Ljakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "jakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$4", "this$0", "Ljakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "jakarta/servlet/jsp/el/ImplicitObjectELResolver$ScopeManager$4", "getAttribute", "(Ljava/lang/String;)[Ljava/lang/String;", false);
methodVisitor.visitInsn(ARETURN);
methodVisitor.visitMaxs(2, 2);
methodVisitor.visitEnd();
}
