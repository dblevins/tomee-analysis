...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "isMutualTls", "(Ljakarta/ws/rs/core/SecurityContext;Lorg/apache/cxf/security/transport/TLSSessionInfo;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
...
methodVisitor.visitJumpInsn(IFEQ, label5);
methodVisitor.visitLabel(label6);
methodVisitor.visitFrame(Opcodes.F_FULL, 7, new Object[] {"java/lang/String", "java/lang/String", Opcodes.INTEGER, "java/lang/String", "org/apache/cxf/jaxrs/model/URITemplate", "jakarta/ws/rs/core/MultivaluedMap", "java/lang/String"}, 0, new Object[] {});
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitLabel(label1);
methodVisitor.visitInsn(IRETURN);
methodVisitor.visitLabel(label5);
