...
methodVisitor.visitMethodInsn(INVOKESTATIC, "javax/json/Json", "createBuilderFactory", "(Ljava/util/Map;)Ljavax/json/JsonBuilderFactory;", false);
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/johnzon/jaxrs/xml/WadlDocumentToJson", "builderFactory", "Ljavax/json/JsonBuilderFactory;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/johnzon/jaxrs/xml/WadlDocumentToJson", "builderFactory", "Ljavax/json/JsonBuilderFactory;");
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jaxrs/xml/WadlDocumentToJson", "createNode", "(Lorg/w3c/dom/Node;)Ljavax/json/JsonObjectBuilder;", false);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "addChildrens", "(Ljavax/json/JsonObjectBuilder;Lorg/w3c/dom/NodeList;)V", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"java/util/Map$Entry", "javax/json/JsonArrayBuilder", "java/util/Iterator"}, 0, null);
methodVisitor.visitVarInsn(ALOAD, 7);
methodVisitor.visitMethodInsn(INVOKEINTERFACE, "java/util/Iterator", "hasNext", "()Z", true);
...
{
methodVisitor = classWriter.visitMethod(ACC_PRIVATE, "createNode", "(Lorg/w3c/dom/Node;)Ljavax/json/JsonObjectBuilder;", null, null);
methodVisitor.visitCode();
...
Label label1 = new Label();
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_APPEND,3, new Object[] {"javax/json/JsonObjectBuilder", "org/w3c/dom/NamedNodeMap", Opcodes.INTEGER}, 0, null);
methodVisitor.visitVarInsn(ILOAD, 4);
methodVisitor.visitVarInsn(ALOAD, 3);
...
methodVisitor.visitMethodInsn(INVOKESPECIAL, "org/apache/johnzon/jaxrs/xml/WadlDocumentToJson", "addChildrens", "(Ljavax/json/JsonObjectBuilder;Lorg/w3c/dom/NodeList;)V", false);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 2);
methodVisitor.visitInsn(ARETURN);
