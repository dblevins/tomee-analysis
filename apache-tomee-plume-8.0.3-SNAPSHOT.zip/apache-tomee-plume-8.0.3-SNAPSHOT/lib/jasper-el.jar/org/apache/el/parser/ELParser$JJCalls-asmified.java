...
classWriter.visit(V1_8, ACC_FINAL | ACC_SUPER, "org/apache/el/parser/ELParser$JJCalls", null, "java/lang/Object", null);
...
{
fieldVisitor = classWriter.visitField(0, "first", "Lorg/apache/el/parser/Token;", null, null);
fieldVisitor.visitEnd();
}
{
...
{
fieldVisitor = classWriter.visitField(0, "next", "Lorg/apache/el/parser/ELParser$JJCalls;", null, null);
fieldVisitor.visitEnd();
}
{
