...
public class ValueExpressionLiteralDump implements Opcodes {
...
{
fieldVisitor = classWriter.visitField(ACC_PRIVATE, "valueString", "Ljava/lang/String;", null, null);
fieldVisitor.visitEnd();
}
{
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/ValueExpressionLiteral", "expectedType", "Ljava/lang/Class;");
methodVisitor.visitInsn(RETURN);
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/ValueExpressionLiteral", "valueString", "Ljava/lang/String;");
Label label0 = new Label();
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_SAME1, 0, null, 1, new Object[] {"org/apache/el/ValueExpressionLiteral"});
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitLabel(label2);
methodVisitor.visitFrame(Opcodes.F_FULL, 1, new Object[] {"org/apache/el/ValueExpressionLiteral"}, 2, new Object[] {"org/apache/el/ValueExpressionLiteral", "java/lang/String"});
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/ValueExpressionLiteral", "valueString", "Ljava/lang/String;");
methodVisitor.visitLabel(label0);
methodVisitor.visitFrame(Opcodes.F_SAME, 0, null, 0, null);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/ValueExpressionLiteral", "valueString", "Ljava/lang/String;");
...
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(INSTANCEOF, "org/apache/el/ValueExpressionLiteral");
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitTypeInsn(CHECKCAST, "org/apache/el/ValueExpressionLiteral");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/el/ValueExpressionLiteral", "equals", "(Lorg/apache/el/ValueExpressionLiteral;)Z", false);
methodVisitor.visitJumpInsn(IFEQ, label0);
methodVisitor.visitInsn(ICONST_1);
Label label1 = new Label();
methodVisitor.visitJumpInsn(GOTO, label1);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC, "equals", "(Lorg/apache/el/ValueExpressionLiteral;)Z", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 1);
Label label0 = new Label();
methodVisitor.visitJumpInsn(IFNULL, label0);
...
methodVisitor.visitLabel(label1);
methodVisitor.visitFrame(Opcodes.F_FULL, 2, new Object[] {"org/apache/el/ValueExpressionLiteral", "java/io/ObjectOutput"}, 2, new Object[] {"java/io/ObjectOutput", "java/lang/String"});
