...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_FINAL | ACC_SUPER, "org/apache/el/util/MessageFactory", null, "java/lang/Object", null);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC, "get", "(Ljava/lang/String;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
...
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/el/util/MessageFactory", "bundle", "Ljava/util/ResourceBundle;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
{
methodVisitor = classWriter.visitMethod(ACC_PUBLIC | ACC_STATIC | ACC_VARARGS, "get", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", null, null);
methodVisitor.visitCode();
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitCode();
methodVisitor.visitLdcInsn("org.apache.el.Messages");
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/el/util/MessageFactory", "bundle", "Ljava/util/ResourceBundle;");
methodVisitor.visitInsn(RETURN);
