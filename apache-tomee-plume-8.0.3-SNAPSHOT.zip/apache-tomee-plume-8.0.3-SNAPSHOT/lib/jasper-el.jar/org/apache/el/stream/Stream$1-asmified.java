...
classWriter.visitOuterClass("org/apache/el/stream/Stream", "filter", "(Ljavax/el/LambdaExpression;)Lorg/apache/el/stream/Stream;");
...
methodVisitor.visitFieldInsn(PUTFIELD, "org/apache/el/stream/Stream$1", "val$le", "Ljavax/el/LambdaExpression;");
methodVisitor.visitVarInsn(ALOAD, 0);
...
methodVisitor.visitInsn(ACONST_NULL);
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitFieldInsn(GETFIELD, "org/apache/el/stream/Stream$1", "val$le", "Ljavax/el/LambdaExpression;");
...
methodVisitor.visitInsn(ICONST_1);
methodVisitor.visitMethodInsn(INVOKESTATIC, "org/apache/el/lang/ELSupport", "coerceToBoolean", "(Ljavax/el/ELContext;Ljava/lang/Object;Z)Ljava/lang/Boolean;", false);
