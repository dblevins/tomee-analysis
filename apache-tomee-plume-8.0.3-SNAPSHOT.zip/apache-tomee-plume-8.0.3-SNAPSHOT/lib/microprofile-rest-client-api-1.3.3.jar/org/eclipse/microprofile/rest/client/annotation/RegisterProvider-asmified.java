...
public class RegisterProviderDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_ANNOTATION | ACC_ABSTRACT | ACC_INTERFACE, "org/eclipse/microprofile/rest/client/annotation/RegisterProvider", null, "java/lang/Object", new String[] { "java/lang/annotation/Annotation" });
...
annotationVisitor0.visit("value", Type.getType("Lorg/eclipse/microprofile/rest/client/annotation/RegisterProviders;"));
annotationVisitor0.visitEnd();
}
{
