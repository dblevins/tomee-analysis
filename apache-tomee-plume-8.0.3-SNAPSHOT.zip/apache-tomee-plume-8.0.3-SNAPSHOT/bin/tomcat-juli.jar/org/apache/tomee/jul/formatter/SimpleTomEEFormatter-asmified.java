...
public class SimpleTomEEFormatterDump implements Opcodes {
...
classWriter.visit(V1_8, ACC_PUBLIC | ACC_SUPER, "org/apache/tomee/jul/formatter/SimpleTomEEFormatter", null, "java/util/logging/Formatter", null);

{
fieldVisitor = classWriter.visitField(ACC_PRIVATE | ACC_FINAL | ACC_STATIC, "LN", "Ljava/lang/String;", null, null);
...
methodVisitor.visitVarInsn(ALOAD, 0);
methodVisitor.visitVarInsn(ALOAD, 1);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "org/apache/tomee/jul/formatter/SimpleTomEEFormatter", "formatMessage", "(Ljava/util/logging/LogRecord;)Ljava/lang/String;", false);
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitInsn(POP);
methodVisitor.visitVarInsn(ALOAD, 3);
methodVisitor.visitFieldInsn(GETSTATIC, "org/apache/tomee/jul/formatter/SimpleTomEEFormatter", "LN", "Ljava/lang/String;");
methodVisitor.visitMethodInsn(INVOKEVIRTUAL, "java/lang/StringBuilder", "append", "(Ljava/lang/String;)Ljava/lang/StringBuilder;", false);
methodVisitor.visitInsn(POP);
...
methodVisitor.visitFrame(Opcodes.F_FULL, 4, new Object[] {"org/apache/tomee/jul/formatter/SimpleTomEEFormatter", "java/util/logging/LogRecord", "java/lang/Throwable", "java/lang/StringBuilder"}, 1, new Object[] {"java/lang/Exception"});
methodVisitor.visitVarInsn(ASTORE, 4);
...
methodVisitor.visitFieldInsn(PUTSTATIC, "org/apache/tomee/jul/formatter/SimpleTomEEFormatter", "LN", "Ljava/lang/String;");
methodVisitor.visitInsn(RETURN);
